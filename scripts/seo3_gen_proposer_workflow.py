...
OUT = SD / "_seo3_proposer_workflow.js"
...
def main() -> int:
    briefs = json.loads((SD / "_seo3_briefs.json").read_text(encoding="utf-8"))
    jobs = []
    for b in briefs:
    ...
    js.append("  name: 'seo3-seo-proposers',")
