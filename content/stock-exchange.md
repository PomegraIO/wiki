...
description: "A stock exchange is the venue—physical or electronic—where shares of public companies are bought and sold. Major exchanges like the NYSE and Nasdaq are highly regulated marketplaces with listing requirements, trading halts, and surveillance systems. Most trading is now electronic."
keywords:
  - stock exchange
  - NYSE
  - Nasdaq
...
---
*A **stock exchange** is an organized marketplace where [stocks](/stock) of [public companies](/public-company) are bought and sold. The major exchanges — the New York Stock Exchange (NYSE), Nasdaq, the London Stock Exchange (LSE), and others — are highly regulated venues with listing requirements, trading hours, surveillance systems, and circuit breakers that halt trading during extreme moves. Trading is now almost entirely electronic, routed through order books and matching engines, though the image of the trading floor persists.*

<div class="wiki-hatnote">

For the broader network of buying and selling, see [stock market](/stock-market). For what is traded on an exchange, see [stock](/stock). For how orders are placed, see [broker](/broker).

</div>

<aside class="wiki-infobox">

<div class="wiki-infobox-title">Stock exchange — key facts</div>

<img src="https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?w=600&q=80" alt="A modern trading floor with electronic screens" />

<div class="wiki-infobox-caption">The modern stock exchange is mostly software — but the photograph still pulls toward the floor.</div>

|   |   |
|---|---|
| **What it is** | A regulated marketplace for trading shares |
| **Largest by volume** | NYSE and Nasdaq (US), LSE (UK), Tokyo Stock Exchange (Japan) |
| **Listing requirement** | Financial thresholds, governance standards, disclosure rules |
| **Trading hours** | Typically 9:30 a.m. to 4:00 p.m. local time |
| **Circuit breakers** | Halt trading if indices fall 7%, 13%, or 20% in a day |
| **Primary listing** | The main exchange where a company's shares trade |
| **Secondary listing** | Listing on a different exchange (same or different country) |
| **Regulator (US)** | Securities and Exchange Commission (SEC) |
| **Clearing and settlement** | T+2 (trade date plus two business days) |
| **Trading venues** | Mostly electronic order books; some dark pools and over-the-counter |

</aside>

## What a stock exchange does

A stock exchange is a venue—today, almost entirely electronic—that brings together buyers and sellers of [stocks](/stock) and executes trades. When you enter a buy order for 100 shares of Apple through your [broker](/broker), your order is routed to the exchange, matched with a sell order, and executed. The execution typically happens in milliseconds. The exchange does not buy or sell itself; it is a middleman that matches counterparties and ensures fair, orderly trading.
...
Major exchanges are highly regulated. In the US, the [Securities and Exchange Commission](/federal-reserve) (SEC) oversees the markets; stock exchanges also enforce their own rules, including trading halts for material news, surveillance for market manipulation, and automatic circuit breakers that halt trading during extreme moves.
...
To get a [stock](/stock) listed on a major exchange, a [public company](/public-company) must clear hurdles. The NYSE and Nasdaq have different standards, but both typically require:
...
Additionally, an exchange can halt trading in an individual [stock](/stock) if there is a material news announcement (a merger, a bankruptcy, an executive resignation), pending release of quarterly earnings, or if there is an unusual pattern suggesting market manipulation or a technical malfunction. These halts are brief and are meant to give the market time to digest information or let systems recover.

## Primary vs. secondary markets

The "stock market" actually comprises two distinct markets:

**Primary market:** Where [stocks](/stock) are first issued. When a company does an [initial public offering](/initial-public-offering) (IPO), it sells new [shares](/stock) directly to investors through an underwriter, raising capital for the company. This is the primary market—money flows to the company.

**Secondary market:** Where already-issued [stocks](/stock) change hands. When you buy Apple [stock](/stock) on Nasdaq, you are buying from another investor, not from Apple. No money flows to Apple. The secondary market is where the vast majority of trading occurs, and it is what most people mean by "the [stock](/stock) market." Exchanges operate both the primary market (IPOs are often listed here first) and the secondary market (ongoing trading).

## Fragmentation and dark pools

The term "[stock](/stock) exchange" once meant a single, centralized marketplace. Today, there are many venues:
...
For a typical retail investor, all of this fragmentation is irrelevant—your [broker](/broker) routes your order to the best available venue, and you get filled. For large institutional traders and market makers, the choice of venue is crucial.
...
- [Stock](/stock) — what exchanges trade
- [Public company](/public-company) — what lists on exchanges
- [Stock market](/stock-market) — the broader network of exchanges
- [Broker](/broker) — how you route orders to an exchange
- [Initial public offering](/initial-public-offering) — the first listing of a [stock](/stock)

### Wider context

- [Stock](/stock)-exchange index (e.g., S&P 500) — a summary of what an exchange's [stocks](/stock) are doing
- [Bull market](/bull-market) · [Bear market](/bear-market) — regimes when exchanges are rising or falling
- [Alpha](/alpha) — the edge (if any) of beating the market
- [Diversification](/diversification) — why you should hold [stocks](/stock) from many exchanges and countries
