---
title: "Bull market"
description: "A bull market is a sustained, broad rise in asset prices. It is the opposite of a bear market—a period when prices climb, confidence grows, and investors are rewarded for holding."
keywords:
  - bull market
  - market rally
  - market appreciation
...
<div class="wiki-infobox-title">Bull market — key facts</div>

<img src="https://images.unsplash.com/photo-1565514020179-026b92b84bb6?w=900&q=80" alt="The Charging Bull near Wall Street — the most photographed metaphor in finance." />

<div class="wiki-infobox-caption">The Charging Bull near Wall Street — the most photographed metaphor in finance.</div>

|   |   |
|---|---|
| **What it is** | A sustained rise in asset prices over time |
| **Opposite of** | Bear market |
| **Typical duration** | 2–10 years (widely variable) |
| **Frequency** | Roughly one every 5–7 years historically |
| **Definition** | Rise of 20% or more from a recent low |
| **Types** | Cyclical bull (within a secular bear) or secular bull |
| **Characteristics** | Rising earnings, confidence, positive momentum |
| **Investor behaviour** | Greed, FOMO, complacency about risk |
| **Common end trigger** | Overvaluation, rising rates, economic shock |
