...
description: "Disability insurance replaces income if you become unable to work due to injury or illness. It can be short-term (covers 3–6 months) or long-term (covers years until retirement or recovery)."
keywords:
...
| **Long-term disability** | Covers months to age 65; may be employer-provided or purchased individually |
| **Income replacement** | Typically 50–70% of pre-disability income |
| **Benefit waiting period** | 0–90 days (longer wait = lower premium) |
| **Definition of disability** | "Unable to do your own occupation" or "unable to do any occupation" |
| **Cost** | 1–3% of income (individual policies); often free (employer-provided) |
| **Tax treatment** | Employer-paid premiums are tax-free benefit; benefits are taxable if employer paid premium |
...
1. You report the disability to the insurance company (with medical documentation).
2. After the waiting period (e.g., 60 days), benefits begin.
3. You receive monthly payments (e.g., $3,000 if your benefit is 60% of a $5,000 salary).
4. Benefits continue while you are disabled (up to the policy term).
