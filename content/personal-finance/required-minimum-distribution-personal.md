...
description: "A required minimum distribution (RMD) is a mandatory annual withdrawal from a retirement account, beginning at age 73 for most accounts. Failing to withdraw the required amount triggers a 25% penalty."
keywords:
...
|   |   |
|---|---|
| **Start age** | 73 (changed from 72 in 2023) |
| **Accounts affected** | Traditional IRA, 401(k), 403(b), 457, SEP, SIMPLE |
| **Accounts exempt** | Roth IRA (during account owner's lifetime) |
| **Calculation** | Account balance ÷ IRS life expectancy factor |
| **Penalty for shortfall** | 25% of the amount not withdrawn |
| **Distribution must be withdrawn by** | December 31 each year |
| **First distribution** | April 1 of the year after turning 73 |
...
The calculation is:
**RMD = Account balance on prior December 31 ÷ IRS life expectancy factor**
