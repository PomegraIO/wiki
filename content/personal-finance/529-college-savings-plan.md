...
description: "A 529 plan is a state-sponsored investment account designed to help families save for education expenses. Contributions grow tax-free, and withdrawals for qualified education costs are tax-free."
keywords:
  - 529 plan
  - college savings
  - education savings
...
|   |   |
|---|---|
| **Sponsor** | State (each state runs its own program) |
| **Contribution limit** | Effectively unlimited (529s designed to cover full education cost) |
| **Gift tax exclusion** | $18,000 per person per year (superfunding: $90,000 per child) |
| **Contribution type** | After-tax (but some states offer deduction) |
| **Growth** | Tax-free |
| **Qualified withdrawal** | Tax-free for education expenses |
| **Non-qualified withdrawal** | Earnings taxed + 10% penalty; principal tax-free |
| **Age limit** | None; works for any age student |
| **Investment options** | Age-based portfolios, individual investment choices |
