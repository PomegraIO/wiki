...
description: "Formal underwriting by a lender that confirms a borrower's creditworthiness and maximum loan amount before making an offer."
keywords:
...
<div class="wiki-infobox-title">Mortgage Pre-Approval — key facts</div>

<img src="/svg/personal-finance.svg" alt="An abstract editorial mark for personal finance matters." />

<div class="wiki-infobox-caption">A binding (or near-binding) statement of borrowing power, issued after full underwriting.</div>

|   |   |
|---|---|
| **What it is** | Written commitment from a lender that you qualify for a specific loan amount and rate |
...
- [Closing Costs](/closing-costs-breakdown/) — the full list of fees due at settlement
- [Escrow Account for Taxes and Insurance](/escrow-account-mortgage/) — how your lender collects property taxes and insurance after closing
- [Title Insurance](/title-insurance/) — protection against hidden defects in ownership history
- [Debt-to-Income Ratio](/debt-to-equity-ratio/) — the key metric lenders use to evaluate borrowing capacity
- [Fixed-Rate Mortgage](/fixed-rate-mortgage-personal/) — the most common residential loan structure

### Wider context

- [Interest Rate](/interest-rate/) — the price of borrowing money
- [Credit Rating](/credit-rating/) — the score lenders use to assess default risk
- [Residential Real Estate](/residential-real-estate/) — the market for single-family homes and small multifamily properties
- [Loan Origination Fees](/loan-origination-fees/) — upfront lender charges often quoted at pre-approval
