---
title: "Assumable Mortgage: How It Works and Who Qualifies"
description: "Learn how assumable mortgages work, which loan types allow assumption, and what qualification requirements the buyer must meet to take over the seller's loan."
keywords:
  - assumable mortgage
  - assumable mortgage how it works
  - fha mortgage assumption
  - va loan assumption
  - usda loan assumption
---
...
<div class="wiki-infobox-title">Assumable Mortgage — key facts</div>

<img src="/svg/personal-finance.svg" alt="An abstract editorial mark for personal finance." />

<div class="wiki-infobox-caption">A buyer inherits the seller's mortgage terms; only eligible loan types and qualifying buyers can do this.</div>

|   |   |
|---|---|
| **What it is** | Buyer takes over seller's existing loan and remaining balance |
| **Eligible loan types** | FHA, VA, USDA; conventional mortgages typically are not assumable |
| **Key requirement** | Buyer must be credit-qualified and meet lender's underwriting standards |
| **Interest rate** | Buyer inherits the original rate (a major benefit if rates have risen) |
| **Remaining balance** | Buyer takes on the unpaid principal; seller's equity covers the gap |
| **Seller liability** | Remains liable unless lender grants a formal release (novation) |
| **Closing costs** | Assumption is cheaper than a new mortgage but still involves legal and appraisal fees |
...
- [Fixed-Rate Mortgage](/fixed-rate-mortgage-personal/) — The standard mortgage structure that is often assumable in FHA, VA, and USDA forms
...
- [Real Estate Investment Trust](/real-estate-investment-trust/) — One vehicle that may hold mortgageable property
- [Residential Real Estate](/residential-real-estate/) — The property market where assumption transactions occur
- [Debt Financing](/debt-financing/) — The loan structure underlying an assumable mortgage
- [Credit Rating](/credit-rating/) — The creditworthiness standard the assuming buyer must meet
