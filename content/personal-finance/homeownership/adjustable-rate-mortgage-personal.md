...
description: "An adjustable-rate mortgage (ARM) has an interest rate that is fixed for an initial period (3–10 years) and then adjusts annually or periodically, often resulting in higher payments over time."
keywords:
...
|   |   |
|---|---|
| **Initial rate period** | 3, 5, 7, or 10 years fixed |
| **Adjustment period** | Typically annual after initial period |
| **Initial rate** | Usually 0.5–1% lower than 30-year fixed |
| **Rate cap** | Often 2–6% per adjustment period, 5–6% lifetime |
| **Payment increase** | Can rise $200–$500+ per month when rate adjusts |
| **Risk** | High; suitable only for short-term owners |
| **Break-even** | Must sell or refinance before rate increases significantly |
...
1. **You will definitely move.** You plan to sell in 4 years; a 5/1 ARM is fine.
2. **You will definitely refinance.** You expect to refinance in 5 years before rates adjust.
3. **Interest rates are very high.** If fixed rates are 8% and ARM rates are 5%, the savings are substantial for the initial period.
...
1. **Home value staying flat or rising.** If it falls, you cannot refinance (owe more than the home is worth).
2. **Your credit score staying good.** If your score drops, refinancing is expensive or impossible.
3. **Interest rates cooperating.** If rates have risen by the time you refinance, you may not improve your situation.
