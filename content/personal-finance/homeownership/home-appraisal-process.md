...
description: "Independent valuation conducted by lenders to protect against overpaying for mortgaged property"
keywords:
  - home appraisal
  - mortgage
  - property valuation
...
| Phase | Details |
|---|---|
| **When ordered** | After purchase contract signed, before final mortgage approval |
| **Who pays** | Buyer (typically $400–600 fee; sometimes lender covers) |
| **Who performs** | Licensed, independent appraiser (not affiliated with lender or buyer) |
| **Duration** | 1–2 weeks from order to report delivery |
| **Scope** | Property inspection, comparable sales analysis, final value estimate |
| **Result** | Appraisal report with estimated fair market value |
| **If low appraisal** | Buyer can renegotiate price, increase down payment, or walk away |
| **Loan contingency** | Purchase contract typically includes appraisal contingency allowing exit if value < purchase price |
...
### Closely related
- [Mortgage Personal](/wiki/mortgage-personal/) — Lending framework in which appraisals occur
- [Home Inspection Contingency](/wiki/buyer-inspection-period/) — Related due diligence process
- [Cost Basis](/wiki/cost-basis/) — Fair market value for tax purposes, often derived from appraisals
- [Property Tax](/wiki/property-tax/) — Assessments separate from appraisals but inform value
