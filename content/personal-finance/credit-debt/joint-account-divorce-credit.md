---
title: "Joint Credit Accounts in Divorce: How to Protect Your Credit"
description: "Why divorce decrees don't release co-borrowers from joint credit liability and how to close or split accounts to safeguard both parties' credit scores."
keywords:
  - joint credit accounts divorce
  - joint credit accounts divorce credit score
  - divorce decree joint credit liability
  - co-borrower divorce liability
  - closing joint accounts divorce
image: "/svg/personal-finance.svg"
---

*A **joint credit account in divorce** creates a persistent financial entanglement: the divorce decree may assign the debt to one spouse, but the creditor still holds both signers liable. This means if one ex-spouse misses payments after the split, the other's [credit score](/credit-rating/) suffers and collections agents can pursue either party. Closing or converting joint accounts before or immediately after divorce is the only way to sever that liability.*
...
## The divorce decree's legal effect (and limits)
...
| Phase | Action |
|-------|--------|
| Before finalization | Identify all joint accounts: credit cards, auto loans, mortgages, home equity lines, bank accounts. |
| Decree signing | The judge assigns each debt and orders closure or refinancing within 30–90 days. |
...
2. **Monitor your credit reports** monthly (free at [Equifax](https://www.equifax.com/), [Experian](https://www.experian.com/), and [TransUnion](https://www.transunion.com/)). If a joint account persists, file a dispute.
...
- [Credit rating](/credit-rating/) — how lenders and credit bureaus evaluate creditworthiness
- [Debt restructuring](/debt-restructuring/) — renegotiating or consolidating debts to improve terms
- [Loan-to-value ratio](/loan-to-value-ratio/) — the leverage ratio used by lenders to assess mortgage risk
- [Co-borrower](/) — a person sharing obligation on a loan
- [Collateral](/) — an asset pledged to secure a loan

### Wider context

- [Credit cycle](/credit-cycle/) — the macroeconomic rhythm of credit expansion and contraction
- [Counterparty risk](/counterparty-risk/) — the risk that the other party to a transaction fails to perform
- [Operational risk](/operational-risk/) — the risk of loss from failure or fraud in business processes
- [Estate tax](/estate-tax/) — how divorcing spouses' estates are treated for tax purposes
