...
description: "Record of an individual's credit history compiled by credit bureaus; includes payment history, outstanding debt, and credit inquiries used for lending decisions."
keywords:
  - credit report
  - credit history
  - credit bureau
...
| Key Fact | Detail |
|---|---|
| **Primary bureaus** | Equifax, Experian, TransUnion (the "Big Three") |
| **Key data points** | Payment history (35%), amounts owed (30%), length of history (15%), new accounts (10%), account mix (10%) |
| **Score range** | 300–850 FICO; 300–900 Vantage Score |
| **Excellent threshold** | 740+ FICO; higher for jumbo mortgages |
| **Data retention** | 7 years for negative items; 10 years for bankruptcy |
| **Right to dispute** | Fair Credit Reporting Act grants consumer access and challenge rights |
| **Free access** | Once per year at AnnualCreditReport.com |
