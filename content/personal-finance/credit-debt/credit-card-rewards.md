...
description: "Credit card rewards are cashback, points, or miles earned through spending on a credit card, providing a financial incentive for card use."
keywords:
  - credit card rewards
  - cashback
  - travel points
...
*[**Credit card rewards**](/wiki/credit-card-rewards/) are incentive programs that award cardholders cash, points, or frequent-flyer miles for each dollar spent using the card. A cashback card might return 1–2% of every purchase; a travel card might award 3 miles per dollar spent on flights. Rewards are designed to encourage card adoption and usage, creating a network effect that benefits merchants through increased spending. For consumers, rewards can offset a portion of the [annual fee](/wiki/annual-percentage-rate/) and provide genuine value if the cardholder pays the full balance each month and redeems rewards efficiently.*

<aside class="wiki-infobox">

| Reward Type | Typical Rate | Redemption |
|-------------|--------------|-----------|
| Cashback | 1–5% per category | Direct credit or statement reduction |
| Points | 1–5 per dollar | Transfers, store credit, or cash |
| Travel miles | 1–5 per dollar | Flight redemption, upgrades, transfers |
| Sign-up bonus | 20,000–100,000 units | One-time offer for new cardholders |
| Category bonus | 2–5% | Higher rate on designated spending categories |
...
The true value of rewards depends on three factors: the earning rate, redemption efficiency, and the cost of funds. A 2% cashback card is valuable only if the cardholder pays the full balance each month, avoiding [interest charges](/wiki/interest-rate/). If the cardholder carries a balance at 20% APR, the 2% cashback is more than offset by the 20% interest cost—the rewards are illusory. Redemption efficiency matters too: points that expire, or that must be redeemed at unfavorable rates, lose value. Travel cards offer high earning rates on flights and hotels, but only if the cardholder actually travels and can redeem miles at favorable ratios (e.g., 1 mile per 1 cent of ticket value, not the more common 0.5 cents per mile).
...
### Closely related
- [Annual percentage rate](/wiki/annual-percentage-rate/) — The interest rate applied to unpaid credit card balances
- [Credit utilization ratio](/wiki/credit-utilization-ratio/) — The percentage of available credit in use; affects credit score
- [Interchange fee](/wiki/payment-for-order-flow/) — The fee merchants pay, which funds rewards programs
- [Sign-up bonus](/wiki/credit-rating/) — One-time incentive for new cardholders

### Wider context
- [Credit score](/wiki/credit-rating/) — Impacted by card usage and payment behavior
- [Debt consolidation](/wiki/debt-consolidation/) — Relevant for cardholders carrying revolving balances
- [Tax loss harvesting](/wiki/tax-loss-harvesting/) — Rewards differ from but are sometimes confused with tax benefits
- [Consumer credit](/wiki/credit-utilization-ratio/) — The broader ecosystem in which rewards operate
