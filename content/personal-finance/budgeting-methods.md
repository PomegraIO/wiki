...
description: "Budgeting methods are structured frameworks for allocating income to spending, saving, and debt repayment. They range from detailed line-item tracking to simple percentage-based rules."
keywords:
  - budgeting
  - budget
  - income allocation
...
|   |   |
|---|---|
| **What it is** | A framework for allocating income to spending and saving |
| **Typical tools** | Spreadsheet, app, pen and paper |
| **Time unit** | Usually monthly |
| **Key input** | Your net (after-tax) income |
| **Key output** | How much to spend in each category |
| **Common categories** | Housing, food, utilities, insurance, entertainment, savings |
| **Frequency of review** | Monthly, or when circumstances change |
| **Enforcement method** | Self-discipline, automatic transfers, spending limits |
