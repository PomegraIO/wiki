---
title: "Backdoor Roth"
description: "A backdoor Roth is a strategy for high earners to contribute to a Roth IRA by contributing to a traditional IRA (non-deductible) and immediately converting it to a Roth IRA, bypassing Roth income limits."
keywords:
  - backdoor roth
  - roth ira conversion
  - high income roth
...
|   |   |
|---|---|
| **Purpose** | Fund Roth for high earners above income limits |
| **Mechanics** | Non-deductible traditional IRA → Roth conversion |
| **Annual contribution** | $7,000 (same as normal IRA limit) |
| **Tax cost** | Usually $0 (if no other traditional IRA balances) |
| **Pro-rata rule complication** | Yes, if you have existing traditional IRA balance |
| **IRS approval** | No special approval; standard IRA rules apply |
| **Time to execute** | A few days (must be same year or very soon after) |
...
3. File Form 8606 on tax return.
