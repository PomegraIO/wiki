---
title: "Living Will"
description: "Legal document stating medical treatment preferences if you become incapacitated and unable to communicate."
keywords:
  - advance directive
  - end-of-life care
  - medical preferences
...
| Aspect | Detail |
|--------|--------|
| **Legal status** | Valid in all US states (forms vary by state) |
| **Key effect** | Legally binding instruction to physicians |
| **Triggers** | Terminal illness, persistent vegetative state, incapacity |
| **Who executes it** | You (the declarant) while mentally competent |
| **Witnesses required** | Yes, usually two (notarization varies by state) |
| **Cost** | $50–200 if using attorney; free forms online |
| **Revocation** | Can be revoked in writing anytime |
...
A living will is a set of written instructions; a [healthcare proxy](/wiki/healthcare-proxy/) (also called a healthcare power of attorney or medical power of attorney) is a person you appoint to make real-time medical decisions. They complement each other. The living will says "I do not want a ventilator"; the healthcare proxy is empowered to tell the hospital "she does not want a ventilator" if a crisis arises. If the instructions are clear, the proxy follows them. If circumstances are ambiguous, the proxy uses their judgment about what aligns with your values.
...
## Interaction with insurance and [beneficiary](/wiki/beneficiary-designation/) designations

A living will does not directly affect life insurance, [beneficiary designations](/wiki/beneficiary-designation/), or [power-of-attorney](/wiki/power-of-attorney/) documents, though the spirit is aligned. Your life insurance beneficiary designation is a separate legal document that names who receives the payout. Your [power of attorney](/wiki/power-of-attorney/) for financial matters (a different document) allows someone to manage property and bank accounts; it does not govern medical decisions.

In an [estate plan](/wiki/estate-tax/), all three documents (living will, healthcare proxy, financial power of attorney) work together. A comprehensive plan ensures medical decisions, financial management, and property distribution are all governed according to your wishes.
...
### Closely related
- [Healthcare proxy](/wiki/healthcare-proxy/) — Person authorized to make medical decisions on your behalf
- [Power of attorney](/wiki/power-of-attorney/) — Document authorizing someone to manage financial affairs
- [Beneficiary designation](/wiki/beneficiary-designation/) — Naming who inherits from insurance or retirement accounts
