...
description: "Legal proceedings to prove the validity of a will and distribute estate assets to heirs."
keywords:
...
| Step | Purpose |
|---|---|
| **Filing** | Submit will and petition to probate court |
| **Authentication** | Prove will was properly executed |
| **Inventory** | List all estate assets and their values |
| **Notice** | Notify heirs, creditors, and interested parties |
| **Debt payment** | Settle creditor claims and estate debts |
| **Tax return** | File and pay estate income and transfer taxes |
| **Distribution** | Transfer assets to beneficiaries per will |
| **Closing** | Finalize accounting and close estate |
...
The executor must file a final [income tax](/wiki/capital-gains-tax/) return for the decedent for the year of death (IRS Form 1040). The estate itself is a separate taxpayer and must file estate income tax returns (Form 1041) if it has taxable income. Additionally, if the estate exceeds the **federal [estate tax](/wiki/estate-tax/) exemption** (about $13.6 million in 2026), an [estate tax](/wiki/estate-tax/) return (Form 706) must be filed, and estate taxes are due.

State [estate tax](/wiki/estate-tax/) or [inheritance tax](/wiki/estate-tax/) may also apply. Some states impose an additional tax on transfers of property at death, separate from federal tax. The executor must ensure all returns are filed correctly and timely. Failure to file or underpayment of taxes can result in penalties and interest, which come from the estate and reduce what beneficiaries receive.
...
The [probate process](/wiki/probate-process/) can take months to years, during which the estate remains unsettled. Beneficiaries may not receive distributions until well after the death. If the estate is contentious (multiple disputes, will contests), the probate can drag on for many years. Probate avoidance planning is largely motivated by the desire to avoid this uncertainty and delay.
...
### Closely related
- [Estate Tax](/wiki/estate-tax/) — Tax on property transferred at death
- [Intestate Succession](/wiki/intestate-succession/) — Distribution when no will exists
- [Will Creation](/wiki/will-creation/) — Drafting a legally valid will
- [Trust Establishment](/wiki/trust-establishment/) — Alternative to probate
