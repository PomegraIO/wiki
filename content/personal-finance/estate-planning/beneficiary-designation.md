...
description: "Naming heirs to receive retirement accounts and insurance proceeds outside of probate."
keywords:
...
*A **Beneficiary Designation** is a contract clause naming the person (or entity) who receives the proceeds of a retirement account, insurance policy, or certain financial instruments upon the account holder's death. Unlike property left in a will, beneficiary-designated assets pass directly to the named beneficiary and bypass [probate](/wiki/probate-process/).*

<aside class="wiki-infobox">

| Aspect | Detail |
|---|---|
| **Applies To** | [401(k)](/wiki/401k-plan/), [IRA](/wiki/ira-traditional/), life insurance, annuities |
| **Legal Basis** | Contract law; supersedes will and probate |
| **Tax Treatment** | Varies: IRAs trigger income tax; insurance is tax-free |
| **Probate Avoidance** | Yes; funds pass automatically |
| **Timing** | Proceeds disbursed within weeks (vs. months for probate) |
| **Cost** | Free to designate; probate savings can be substantial |
...
### Retirement accounts
- [401(k)](/wiki/401k-plan/) plans
- [Traditional and Roth IRAs](/wiki/roth-ira/)
- [403(b) plans](/wiki/403b-plan/) (educators)
- [457 plans](/wiki/457-plan/) (government employees)
- [SEP-IRAs](/wiki/sep-ira-self-employed/) and [Solo 401(k)s](/wiki/solo-401k/)
...
Proceeds are **income tax-free** to beneficiaries under IRC §101(a). A $500k policy paid to beneficiary triggers no federal income tax. Estate tax may apply if the policy is included in the [taxable estate](/wiki/estate-tax-investor/), but income tax is not.

### Retirement account distributions
Beneficiaries must **include distributions in income** and pay ordinary income tax. A beneficiary who inherits a $500k [Traditional IRA](/wiki/ira-traditional/) must withdraw and include those amounts in taxable income.
...
If you own the policy at death, proceeds are included in your [taxable estate](/wiki/estate-tax-investor/). To avoid this, some individuals transfer policy ownership to an irrevocable [life insurance trust (ILIT)](/wiki/grantor-retained-annuity-trust/), which owns the policy (not you), so proceeds are not in your estate. This is advanced tax planning and requires careful drafting.

## Updating and validity

Beneficiary designations are **easy to change** but require formality. You must:
1. Contact the plan administrator or insurance company.
2. Complete a new beneficiary designation form (varies by provider).
3. Sign and return it.
...
Naming a qualified charity as IRA beneficiary triggers no [income tax](/wiki/corporate-income-tax/) on distributions to the charity (IRC §170). Combined with the spouse's ability to roll over, this allows tax-efficient philanthropic giving while providing for family.
...
Coordinating beneficiary designations with will provisions, trust structures, and [tax basis](/wiki/basis-step-up-inheritance/) decisions requires care. A $1 million [Traditional IRA](/wiki/ira-traditional/) inherited by your child will cost them dearly in income tax; a $1 million insurance policy passes tax-free. Sequencing withdrawals from different account types (taxable, pre-tax retirement, post-tax Roth) can substantially reduce a family's tax burden.

<div class="wiki-seealso">

### Closely related
- [401(k) Plan](/wiki/401k-plan/) — common account with beneficiary designation
- [IRA (Traditional)](/wiki/ira-traditional/) — primary retirement account
- [Roth IRA](/wiki/roth-ira/) — tax-free alternative
- [Probate Process](/wiki/probate-process/) — avoided via beneficiary designation
