...
description: "A safe withdrawal rate (SWR) is the percentage of your investment portfolio you can withdraw annually in retirement without running out of money. It is personalized based on your retirement length, portfolio composition, and risk tolerance."
keywords:
...
|   |   |
|---|---|
| **Typical range** | 3%–4.5% depending on situation |
| **30-year retirement** | Often 4% (standard four-percent rule) |
| **50-year retirement** | Often 3%–3.5% (longer duration = lower rate) |
| **Very short (10 years)** | Often 5%+ (less market risk) |
| **Calculation method** | Historical analysis, Monte Carlo simulation, or actuarial models |
| **Variables** | Retirement length, portfolio composition, inflation expectations, market valuations |
| **Review frequency** | Annually (adjust if portfolio performs significantly better or worse) |
