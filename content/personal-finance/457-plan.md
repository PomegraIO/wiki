---
title: "457 Plan"
description: "A 457 plan is a retirement account available to employees of state and local governments and some nonprofits. It allows high pre-tax contributions and unique withdrawal flexibility."
keywords:
  - 457 plan
...
|   |   |
|---|---|
| **Eligible employers** | State, local governments, some nonprofits |
| **Employee contribution limit (2024)** | $23,500 per year |
| **Catch-up (age 50+)** | Additional $7,500 per year |
| **Catch-up (final 3 years)** | Up to 2x the normal limit if allowed |
| **Employer match** | Varies by employer |
| **Contribution type** | Pre-tax (traditional) |
| **Withdrawal** | Penalty-free at separation (key advantage) |
| **RMD** | Begins at age 73 (or separation, if later) |
...
- **State government employees** (legislators, judges, administrators).
- **Local government employees** (city/county workers, teachers, police, firefighters).
- **Some nonprofit employees** ( 457(f) plans, which have different rules).

If your employer is a state or local government agency, you are likely eligible.

## 457(b) vs. 457(f)

**457(b) plans:** For most government employees. Portable to another 457(b) plan or rolled to an IRA if you leave.

**457(f) plans:** For certain highly compensated nonprofit executives. Less common, with different rules on distribution.
...
In addition to the standard $7,500 catch-up for those 50+, 457 plans allow an extra catch-up provision: in your final three years before normal retirement age, you can contribute up to twice the normal limit (up to $47,000 for 2024). This allows high savers to accelerate retirement contributions.
