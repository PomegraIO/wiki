---
title: "HSA Contribution Limits and How They Change Each Year"
description: "Learn how HSA contribution limits are set by the IRS and adjusted annually for inflation, and what self-only vs family coverage means for your cap."
keywords:
  - hsa contribution limits
  - health savings account limits
  - irs inflation adjustment
  - hsa family vs self-only
  - annual hsa limit
image: /svg/personal-finance.svg
---

*The IRS sets an annual **HSA contribution limit** for each account type, and those limits rise every year to account for inflation. Whether you can contribute $4,150 or $8,300 in a given year depends on which [health insurance](/interest-rate/) plan you enroll in—self-only coverage versus family coverage—and when the IRS publishes the next year's threshold.*

<aside class="wiki-infobox">

<div class="wiki-infobox-title">HSA Contribution Limits — key facts</div>

<img src="/svg/personal-finance.svg" alt="An abstract editorial mark for health savings." />

<div class="wiki-infobox-caption">Limits increase annually; family coverage always allows roughly double self-only.</div>

|   |   |
|---|---|
| **Who sets limits** | IRS, based on health insurance deductible benchmarks |
| **How often they change** | Annually, usually announced in late autumn |
| **Self-only 2025 limit** | $4,300 (example; subject to IRS announcement) |
| **Family 2025 limit** | $8,600 (example; subject to IRS announcement) |
| **Catch-up (age 55+)** | Add $1,000 per year |
| **Enforcement** | IRS penalties for over-contribution apply at tax time |
...
- [401k plan](/401k-plan/) — Employer retirement account with its own annual contribution limits
- [Traditional IRA](/traditional-ira/) — Individual retirement account; also has inflation-adjusted limits
- [Roth IRA](/roth-ira/) — Tax-free retirement savings; contribution limits set alongside HSA limits
- [Emergency fund](/emergency-fund/) — How to decide between HSA and regular savings for medical emergencies
- [Savings account interest compounding frequency](/savings-account-interest-compounding-frequency/) — Growing HSA balances with interest-bearing accounts

### Wider context

- [Inflation](/inflation/) — Why the IRS adjusts limits annually
- [Affordable Care Act](/interest-rate/) — Legislation that defines HSA eligibility and deductible rules
- [Marginal tax rate](/marginal-tax-rate-investor/) — How HSA pre-tax contributions reduce your tax bill
