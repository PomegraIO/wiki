...
description: "A fixed-rate mortgage is a home loan where the interest rate remains the same for the entire loan term (15, 20, or 30 years). Monthly payments never change, providing predictability and protection against rising rates."
keywords:
  - fixed-rate mortgage
  - fixed mortgage
  - home loan
...
|   |   |
|---|---|
| **Interest rate** | Fixed (same for entire 15, 20, or 30 years) |
| **Monthly payment** | Fixed and predictable |
| **Protection** | Insulated from interest rate increases |
| **Term options** | 15, 20, 30 years (sometimes 10, 40) |
| **Typical rate** | Currently 5–7% (varies with market) |
| **Upfront cost** | 2–5% of loan amount (origination, appraisal, title insurance, etc.) |
| **Prepayment** | Can pay extra principal anytime without penalty |
...
1. Lower monthly payment keeps cash available for emergencies and investing.
2. If you can afford the 15-year payment, you can pay extra on a 30-year mortgage (same effect, more flexibility).
