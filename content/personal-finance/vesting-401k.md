---
title: "Vesting (401(k))"
description: "Vesting is the process by which employer contributions to a 401(k) plan become the employee's property. Until vested, an employee who leaves forfeits unvested contributions."
keywords:
  - vesting
  - 401k vesting
...
|   |   |
|---|---|
| **What it is** | Process of earning the right to keep employer contributions |
| **Your contributions** | Always 100% vested immediately |
| **Employer match** | Subject to vesting schedule |
| **Employer non-elective** | Subject to vesting schedule |
| **Common schedule** | 3-year cliff or 5-year graded |
| **Maximum vesting period** | 3 years (cliff) or 5 years (graded) |
| **If you leave early** | Lose unvested portion (forfeiture) |
| **If you are fired** | Subject to plan rules; vesting does not change |
