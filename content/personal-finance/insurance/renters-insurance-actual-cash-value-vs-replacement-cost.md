---
title: "Actual Cash Value vs Replacement Cost in Renters Insurance"
description: "Understand how depreciation reduces payouts under Actual Cash Value coverage and why Replacement Cost coverage often provides better protection for belongings."
keywords:
...
<div class="wiki-infobox-title">ACV vs Replacement Cost — key facts</div>

<img src="/svg/personal-finance.svg" alt="An abstract editorial mark for the topic." />

<div class="wiki-infobox-caption">How your belongings are valued after a loss determines whether you can actually replace them.</div>

|   |   |
|---|---|
| **Actual Cash Value** | Insurer pays original price minus depreciation; used by budget policies |
| **Replacement Cost** | Insurer pays what an equivalent new item costs today; typically costs 10–25% more in premiums |
| **Depreciation rate** | Electronics, furniture, and clothing typically lose 10–20% of value per year |
| **Example** | A $1,200 laptop purchased 5 years ago: ACV ≈ $200–300; RCC ≈ $1,200+ for equivalent |
| **Deductible impact** | You pay the deductible first; if you have RCC, the insurer pays the remaining 100% of replacement cost |
