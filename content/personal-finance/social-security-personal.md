...
description: "Social Security is a federal insurance program that provides monthly income to retired workers, disabled workers, and surviving families. Benefits are funded by payroll taxes and are one of the largest sources of retirement income for Americans."
keywords:
  - social security
  - retirement benefit
  - payroll tax
...
|   |   |
|---|---|
| **Funding** | Payroll tax (FICA): 12.4% of wages (employer and employee) |
| **Eligibility** | 40 quarters of covered earnings (roughly 10 years of work) |
| **Full retirement age** | 67 (for those born 1960+) |
| **Earliest claim age** | 62 (with reduced benefits) |
| **Latest claim age** | 70 (with increased benefits) |
| **Average benefit** | ~$1,900/month (2024) |
| **Cost-of-living adjustment** | Annual COLA increase (tied to inflation) |
| **Taxation** | Up to 85% of benefits taxable depending on income |
