...
description: "A custodial account is a savings or investment account opened by an adult (custodian) on behalf of a minor. The minor is the beneficial owner; the custodian manages the account until the minor reaches age of majority."
keywords:
  - custodial account
  - minor account
...
|   |   |
|---|---|
| **Legal owner** | The minor (child) |
| **Account manager** | The custodian (adult) |
| **Purpose** | Savings, education, general purposes |
| **Contribution limit** | No limit (subject to gift tax for large gifts) |
| **Tax treatment** | First $1,300 of unearned income tax-free (2024); next $1,300 at child's rate; excess taxed at parent's rate (kiddie tax) |
| **Account type** | UGMA or UTMA (varies by state) |
| **Transfer age** | 18–21 (varies by state and account type) |
| **Irrevocable** | Yes; once contributed, cannot be changed |
