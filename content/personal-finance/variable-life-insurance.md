...
description: "Variable-life (VL) insurance is permanent life insurance where cash value is invested in separate accounts (like mutual funds). Death benefit and cash value fluctuate with investment performance."
keywords:
...
|   |   |
|---|---|
| **Coverage** | Entire lifetime (death benefit guaranteed minimum) |
| **Premium** | Fixed or flexible (depending on type) |
| **Cash value** | Invested in separate accounts; fluctuates with markets |
| **Death benefit** | Minimum guaranteed, but increases with strong performance |
| **Risk** | Full investment risk; cash value can decline |
| **Cost** | Similar to universal-life or higher |
| **Complexity** | High; requires understanding of investments |
| **Regulation** | Subject to securities law; requires licensing |
