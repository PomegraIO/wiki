...
description: "Year-end assessment and adjustment of personal budget based on actual spending and changed circumstances"
keywords:
  - budgeting
  - annual review
  - personal finance
...
*An **annual budget review** is a year-end ritual in which individuals or households assess their [budget](/wiki/budgeting-methods/) against actual spending, review changed circumstances (income, family status, major expenses), and adjust targets for the coming year. The review bridges the gap between theoretical budgeting and lived financial reality, capturing lessons from the past year and embedding them into forward-looking assumptions.*

<aside class="wiki-infobox">

| Stage | Focus |
|---|---|
| **1. Gather data** | Collect 12 months of actual spending from bank, credit card, and cash records |
| **2. Categorize** | Sort expenses into categories (housing, food, transport, entertainment, etc.) |
| **3. Compare** | Actual vs. budgeted; identify variances and surprises |
| **4. Analyze** | Root causes of overspending; one-time vs. recurring items |
| **5. Adjust** | Revise budget categories, emergency fund target, savings rate for next year |
| **6. Set goals** | Define savings targets, debt reduction, investment increases for the coming year |
| **7. Document** | Write down the revised budget and keep it accessible for monthly tracking |
| **Timing** | November–December; in preparation for January financial planning |
...
### Closely related
- [Budgeting Methods](/wiki/budgeting-methods/) — Frameworks for personal budgeting
- [Budget Deficit](/wiki/budget-deficit/) — Spending exceeding income (personal analog)
- [Emergency Fund](/wiki/emergency-fund/) — Savings goal within annual reviews
