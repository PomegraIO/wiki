---
title: "UGMA/UTMA"
description: "UGMA (Uniform Gifts to Minors Act) and UTMA (Uniform Transfers to Minors Act) are state laws that establish the legal framework for custodial accounts for minors."
keywords:
  - UGMA
  - UTMA
...
|   |   |
|---|---|
| **What they are** | State laws governing custodial accounts |
| **Which is newer** | UTMA (replaces UGMA in many states) |
| **Transfer age** | UGMA: 18–21; UTMA: typically 18–21 (state-specific) |
| **Asset types** | UGMA: mostly cash and securities; UTMA: any asset (real property, patents, etc.) |
| **Irrevocable** | Yes; once contributed, cannot be undone |
| **Taxation** | Kiddie tax applies (income partially taxed at parent's rate) |
| **Fee** | None; established by state law |
...
| Feature | UGMA | UTMA |
|---|---|---|
| **Transfer age** | 18–21 (state law) | 18–21 (state law; can extend to 25 if creator specifies) |
| **Asset types** | Cash, securities, insurance | Any property (real estate, business, patents, art) |
| **Flexibility** | Limited | Higher (can specify delay in transfer) |
| **Adoptability** | Older, less used now | Modern standard |
| **State availability** | Some states | Most states |
