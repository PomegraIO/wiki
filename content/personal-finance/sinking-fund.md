---
title: "Sinking Fund"
description: "A sinking fund is money set aside monthly for a known but irregular expense, so you are prepared to pay it in full when it comes due without disrupting your monthly budget."
keywords:
  - sinking fund
  - irregular expense
  - planned savings
...
For the budgeting method this fits into, see [budgeting methods](/budgeting-methods); for cash-based spending control, see [envelope budgeting](/envelope-budgeting).
...
|   |   |
|---|---|
| **What it is** | Monthly savings for a known irregular expense |
| **Time horizon** | Usually 3 months to 1 year (or more) before the expense |
| **Frequency of contribution** | Monthly or per paycheck |
| **Typical uses** | Car insurance, registration, property tax, gifts, vacation, home repairs |
| **Account type** | Separate savings account or app-tracked envelope |
| **Interest earned** | Minimal, but better than zero (use high-yield savings) |
| **Size** | Expense amount ÷ 12 (or however many months until due) |
| **Risk level** | None; these are guaranteed expenses |

</aside>

## Why sinking funds exist

Many household expenses are unavoidable but non-monthly: car insurance is due twice a year, property tax once a year, vehicle registration once a year. If you have not budgeted for these, they create a crisis when they arrive — you either use your [emergency fund](/emergency-fund) or go into debt.
...
1. **Identify irregular expenses.** Review your last 2 years of spending. What bills come up occasionally? Car insurance, registration, property tax, medical copays, gifts, holidays, home repairs, vehicle maintenance, annual subscriptions?
2. **Calculate the annual cost.** Use your actual costs from last year, or estimate based on average rates.
3. **Divide by 12.** This is your monthly allocation.
4. **Open a separate account.** A high-yield savings account dedicated to sinking funds keeps the money separated from daily spending and earns a small return (currently 4–5% annually).
5. **Automate the contribution.** Set up a recurring transfer from checking to the sinking fund account on payday. This removes the need for discipline.
...
Sinking funds are not a competing method to [budgeting methods](/budgeting-methods); they are a component of one. In [zero-based budgeting](/zero-based-budgeting), you allocate a category for "Car insurance (sinking fund)." In [envelope budgeting](/envelope-budgeting), you have an envelope for it. In the [fifty-thirty-twenty rule](/fifty-thirty-twenty-rule), irregular expenses fit somewhere in the 50% necessities or 30% wants.
...
**Raiding the sinking fund.** Treat the money as spoken for. Do not dip into the car insurance sinking fund for a fancy dinner, even if you are short on entertainment money. If you find yourself doing this, you may have a [budgeting](/budgeting-methods) problem, not a sinking fund problem.
...
- [Budgeting methods](/budgeting-methods) — where sinking funds fit
- [Zero-based budgeting](/zero-based-budgeting) — one allocation category per sinking fund
- [Envelope budgeting](/envelope-budgeting) — another way to track sinking funds
- [Emergency fund](/emergency-fund) — separate from, but related to, sinking funds

### Wider context

- [Pay yourself first](/pay-yourself-first) — prioritizing savings, including for sinking funds
- [Savings rate](/savings-rate) — sinking funds as part of overall savings
- [Lifestyle creep](/lifestyle-creep) — how sinking fund discipline prevents creep
