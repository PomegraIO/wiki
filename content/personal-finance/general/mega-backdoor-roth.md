...
description: "A mega backdoor Roth is a strategy to contribute additional funds to a Roth account beyond normal limits by using after-tax contributions to a 401(k) plan, then converting to Roth IRA."
keywords:
  - mega backdoor roth
  - after-tax 401k
  - roth conversion
...
|   |   |
|---|---|
| **Available to** | High earners with employer 401(k) plan that allows it |
| **Annual contribution potential** | $46,000+ (employee + after-tax contributions) |
| **Mechanism** | After-tax 401(k) → in-plan Roth conversion |
| **Tax consequence** | Usually none, if basis is already in the account |
| **Restrictions** | Requires plan to allow in-plan conversions and after-tax contributions |
| **Complexity** | High; requires careful execution and tax planning |
| **IRS approval** | No special approval needed, just ordinary 401(k) rules |
