...
description: "A dependent care FSA (also called a dependent care account) is an employer-sponsored account that lets employees set aside pre-tax money to pay for childcare, preschool, or adult eldercare costs."
keywords:
  - dependent care FSA
...
|   |   |
|---|---|
| **Sponsor** | Employer (must be offered as a benefit) |
| **Contribution limit (2024)** | $5,000 per year |
| **Contribution type** | Pre-tax (payroll deduction) |
| **Eligible expenses** | Childcare, preschool, day camps, eldercare |
| **Withdrawal** | Reimbursement for qualified expenses |
| **Use-it-or-lose-it** | Yes; unused funds forfeited at year-end |
| **Grace period** | Some plans allow 2.5-month extension |
| **Household income limit** | No limit (unlike child tax credit) |
...
1. **Estimate carefully.** Use last year's expenses as a baseline. Account for weeks off (holidays, summer breaks), changes in care arrangements, etc.
2. **Be conservative.** Under-estimate slightly; it is better to pay a bit out-of-pocket than lose funds.
3. **Check for grace period.** Some plans allow a 2.5-month extension or limited carryover ($660 in 2024).
