---
title: "Fifty-Thirty-Twenty Rule"
description: "The fifty-thirty-twenty rule is a budgeting formula that allocates 50% of after-tax income to necessities, 30% to discretionary wants, and 20% to savings and debt repayment."
keywords:
...
|   |   |
|---|---|
| **Format** | Percentage-based allocation formula |
| **Necessities** | 50% of after-tax income |
| **Discretionary** | 30% of after-tax income |
| **Savings and debt** | 20% of after-tax income |
| **Basis** | After-tax (net) income, not gross |
| **Time unit** | Usually monthly or annually |
| **Flexibility** | Low; the formula is fixed |
| **Best for** | Stable income, desire for simplicity |
| **Limitation** | Does not adapt to unusual expense ratios |
