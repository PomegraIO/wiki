...
description: "Whole-life insurance is permanent life insurance that covers you for your entire lifetime, with fixed premiums, guaranteed death benefit, and a cash value component that accumulates over time."
keywords:
...
|   |   |
|---|---|
| **Coverage** | Entire lifetime (to age 100–120) |
| **Premium** | Fixed; never increases |
| **Death benefit** | Guaranteed (fixed amount) |
| **Cash value** | Accumulates tax-deferred; can borrow or withdraw |
| **Cost vs. term** | 8–12 times more expensive |
| **Surrender charges** | May apply if cancelled early |
| **Dividends** | Some policies pay annual dividends (non-guaranteed) |
| **Typical buyer** | Wealthy individuals, estate planning, business |
