---
title: "Fiat Money"
description: "Fiat money is money that has value by government decree rather than being backed by a physical commodity like gold or silver."
keywords:
  - fiat money
  - fiat currency
  - legal tender
...
|   |   |
|---|---|
| **What it is** | Money without commodity backing; value by government decree |
| **Backing** | None; confidence in government and central bank |
| **Legal status** | Declared legal tender; must be accepted in payment |
| **Examples** | US dollar, euro, yen, pound (all modern currencies) |
| **History in US** | Adopted fully in 1971 when gold standard ended |
| **Inflation risk** | High if central bank creates money excessively |
| **Collapse risk** | Currency can become worthless if confidence fails |
