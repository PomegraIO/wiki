---
title: "Balance-Sheet Runoff"
description: "Balance-sheet runoff is a central bank's gradual reduction of its assets by allowing securities to mature without reinvestment, shrinking the money supply."
keywords:
  - runoff
...
|   |   |
|---|---|
| **What it is** | Non-reinvestment of proceeds from maturing securities |
| **Method** | Passive, not active sales |
| **Scale typical** | Tens to hundreds of billions per month |
| **Duration** | Years to decade-plus |
| **Effect on balance sheet** | Gradual, predictable contraction |
| **Effect on money supply** | Gradual drainage |
| **Announcement** | Usually pre-announced with a maximum monthly cap |
...
1. **Predictability.** Markets know the maximum amount of runoff each month, so they can price it in.
