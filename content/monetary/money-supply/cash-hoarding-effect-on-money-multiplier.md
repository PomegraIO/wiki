---
title: "How Cash Hoarding Reduces the Money Multiplier"
description: "Explains how cash hoarding increases the currency-to-deposit ratio, shrinking the money supply multiplier and slowing monetary expansion through the banking system."
keywords:
  - cash hoarding effect on money multiplier
  - money multiplier reduction
  - currency to deposit ratio
  - banking reserve drain
  - monetary expansion
  - m1 m2 relationship
...
<div class="wiki-infobox-title">Cash Hoarding and the Money Multiplier — key facts</div>

<img src="/svg/monetary.svg" alt="An abstract editorial mark for the topic." />

<div class="wiki-infobox-caption">Hoarding cash reduces the leverage of the banking system's money-creation engine.</div>

|   |   |
|---|---|
| **What shrinks** | The money multiplier (M2 or M3 relative to the monetary base) |
| **The driver** | Ratio of cash held outside banks to deposits inside them |
| **The mechanism** | Fewer deposits = fewer reserves to lend = less credit creation |
| **When it matters** | Financial stress, low confidence, emergency hoarding, currency substitution |
| **Typical effect on M1** | Often unchanged; M2 growth slows |
| **Typical effect on M2/M3** | Measurable slowdown in broad money expansion |
...
- [Monetary base](/monetary-base/) — The foundation of all money; understanding how cash and reserves differ
- [Reserve requirements](/reserve-requirements/) — The fraction banks must hold, setting a floor on the multiplier
- [M1](/m1/) — Currency plus demand deposits; the most liquid measure
- [Quantitative easing](/quantitative-easing/) — Central bank tool to offset multiplier collapse by adding base money
...
- [Federal Reserve](/federal-reserve/) — The institution that monitors and responds to multiplier changes

### Wider context

- [Central bank](/central-bank/) — The issuer of base money and primary architect of multiplier conditions
- [Monetary policy](/monetary-policy/) — The transmission of policy through the banking system
- [Interest rate](/interest-rate/) — The main lever for influencing hoarding versus depositing behavior
- [Inflation](/inflation/) — The output that a functioning multiplier is designed to influence
