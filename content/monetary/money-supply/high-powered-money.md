---
title: "High Powered Money"
description: "The monetary base comprised of currency in circulation and bank reserves held at the central bank."
keywords:
  - monetary base
...
*A **high-powered money**—also called the *monetary base* or *M0*—is the most fundamental layer of the [money supply](/wiki/m1/): physical currency in circulation plus [reserves](/wiki/reserve-requirements/) that [commercial banks](/wiki/central-bank/) hold at the [central bank](/wiki/federal-reserve/). It is called "high-powered" because [central banks](/wiki/central-bank/) can create it at will, and because [commercial banks](/wiki/federal-reserve/) use it as a foundation to [create](/wiki/credit-creation-mechanism/) a much larger money supply through [lending](/wiki/loan-origination-fees/).*

<div class="wiki-hatnote">See also <a href="/wiki/monetary-base/">monetary base</a> for synonymous treatment and <a href="/wiki/base-money-creation/">base money creation</a> for the mechanism.</div>

<aside class="wiki-infobox">

| Aspect | Detail |
|--------|--------|
| **Composition** | Physical currency + bank [reserves](/wiki/reserve-requirements/) at central bank |
...
3. **[Quantitative easing](/wiki/quantitative-easing/)**: Large-scale [asset](/wiki/asset-backed-security/) purchases—[Treasury](/wiki/treasury-bond/) [bonds](/wiki/bond/), [mortgage](/wiki/mortgage-backed-security/)-backed [securities](/wiki/securities-and-exchange-commission/)—expand bank [reserves](/wiki/reserve-requirements/). The Fed accumulated ~$4.5 trillion in [assets](/wiki/asset-backed-security/) after the 2008 crisis and 2020 pandemic; the high-powered money associated with those [holdings](/wiki/holding-period/) remains in the system.

In all three cases, the [central bank](/wiki/central-bank/) is expanding the [monetary base](/wiki/monetary-base/) by creating bank [reserves](/wiki/reserve-requirements/).
...
The [monetary base](/wiki/monetary-base/) is not the same as [interest rates](/wiki/interest-rate/). The [Fed](/wiki/federal-reserve/) controls both, but through different mechanisms. The [fed funds rate](/wiki/federal-funds-rate/)—the [interest rate](/wiki/interest-rate/) at which [commercial banks](/wiki/federal-reserve/) lend [reserves](/wiki/reserve-requirements/) to each other—is set by adjusting the [interest](/wiki/accrued-interest/) the [Fed](/wiki/federal-reserve/) pays on bank [reserves](/wiki/reserve-requirements/). The size of the [monetary base](/wiki/monetary-base/) is set through [open-market operations](/wiki/open-market-operations/).

In normal times, the [Fed](/wiki/federal-reserve/) targets the [fed funds rate](/wiki/federal-funds-rate/) (a relatively low number, say 2–3%) and the [monetary base](/wiki/monetary-base/) adjusts passively to whatever level is needed to keep that rate in place. In crisis or low-[rate](/wiki/interest-rate/) environments, the [Fed](/wiki/federal-reserve/) hits a [zero lower bound](/wiki/zero-lower-bound/)—rates cannot go negative without driving people to hoard cash—and pivots to controlling the [monetary base](/wiki/monetary-base/) directly through [quantitative easing](/wiki/quantitative-easing/).

## The constraint on base money expansion

A [central bank](/wiki/central-bank/) can create base money, but it cannot force it into the economy if [demand](/wiki/consumer-price-index/) is weak. This is the "[liquidity trap](/wiki/liquidity-risk/)". After 2008, the [Fed](/wiki/federal-reserve/) tripled the [monetary base](/wiki/monetary-base/) via [quantitative easing](/wiki/quantitative-easing/), but [inflation](/wiki/inflation/) remained low because [commercial banks](/wiki/federal-reserve/) and the public were not actively [borrowing](/wiki/loan-origination-fees/) and spending; they were saving. The base money was created but did not translate into [spending](/wiki/discretionary-spending-personal/).

This is why [central banks](/wiki/central-bank/) require [fiscal policy](/wiki/fiscal-policy-expansionary/) (government [spending](/wiki/budget-multiplier-effect/)) as a complement. [Monetary policy](/wiki/monetary-policy/) can provide high-powered money, but [fiscal policy](/wiki/fiscal-policy-expansionary/) must drive actual [demand](/wiki/consumer-price-index/).

## Base money and inflation

The classic argument is that [inflation](/wiki/inflation/) is "always and everywhere a monetary phenomenon"—an excess of base money [growth](/wiki/growth-option/) relative to real economic [growth](/wiki/growth-investing/). If the [Fed](/wiki/federal-reserve/) expands the [monetary base](/wiki/monetary-base/) 10% per year while [GDP](/wiki/gross-domestic-product/) grows 2%, the excess money eventually bids up [prices](/wiki/price-to-book-ratio/), creating [inflation](/wiki/inflation/).

But this is a long-term relationship. In the short run, [velocity](/wiki/currency-in-circulation/) (how fast money circulates) and [demand](/wiki/consumer-price-index/) can change, decoupling base money [growth](/wiki/growth-option/) from [inflation](/wiki/inflation/). After 2008, base money doubled, but [inflation](/wiki/inflation/) stayed low for a decade. After 2020, base money surged again, and [inflation](/wiki/inflation/) finally spiked in 2021–2022. The lag is long and variable, making [monetary policy](/wiki/monetary-policy/) prediction difficult.

## Conclusion: the root of the money supply

High-powered money is the foundation of the modern [money supply](/wiki/m1/). [Central banks](/wiki/central-bank/) create it to provide [reserves](/wiki/reserve-requirements/) that [commercial banks](/wiki/federal-reserve/) use to [lend](/wiki/loan-origination-fees/), expanding [credit](/wiki/credit-risk/) and the money supply. Understanding high-powered money and its growth is essential to predicting [inflation](/wiki/inflation/) and understanding [monetary policy](/wiki/monetary-policy/) transmission. It is the visible trace of the [central bank's](/wiki/central-bank/) power to shape the economy.
...
### Wider context
- [Federal Reserve](/wiki/federal-reserve/) — central bank creator
- [Open market operations](/wiki/open-market-operations/) — mechanism of creation
- [Quantitative easing](/wiki/quantitative-easing/) — large-scale expansion
- [Monetary policy](/wiki/monetary-policy/) — policy framework
- [Reserve requirements](/wiki/reserve-requirements/) — constraint on [lending](/wiki/loan-origination-fees/)
