...
description: "Forward guidance is a central bank's public statements about its future monetary-policy intentions, used to influence market expectations and economic behavior."
keywords:
  - forward guidance
...
This entry covers the communication strategy. For the interest rate being guided, see [federal-funds-rate-target](/federal-funds-rate-target). For the committees that issue guidance, see federal-open-market-committee.
...
|   |   |
|---|---|
| **What it is** | Central bank statements about future policy intentions |
| **Forms** | Explicit dates, thresholds, qualitative descriptions |
| **Main goal** | Influence market expectations and behavior |
| **Power** | Especially strong when rates are at zero |
| **Credibility** | Depends on central bank's track record |
| **Risk** | Overcommitment; changing guidance damages credibility |

</aside>

## Why guidance matters: expectations and economic behavior

A central bank's policy rate—the [federal funds rate](/federal-funds-rate-target) in the US—is just one number. But expectations about future rates affect the entire financial system. If markets believe the central bank will raise rates significantly in the future, longer-term [interest rates](/interest-rate) rise immediately, even if the near-term rate is unchanged. A homebuyer facing a higher expected future mortgage rate may rush to buy today. A corporation looking at higher future borrowing costs may shelve a capital project.
...
**Thresholds.** A central bank might say, "We will begin raising rates when unemployment falls below 3.5% and [inflation](/inflation) rises above 2%." This conditions policy on economic outcomes rather than a calendar date.
...
When the Federal Reserve cut short-term interest rates to zero in December 2008, it could not cut any further. But the economy remained weak. Conventional [monetary policy](/monetary-policy) had hit the floor. Forward guidance became the primary tool.
...
A decade later, when the economy had recovered and [inflation](/inflation) was falling, the Fed again turned to forward guidance. It promised to keep raising rates to counter inflation. Higher expected future rates tightened financial conditions today, before the Fed actually raised anything. Markets sold off in anticipation.
...
- [Quantitative easing](/quantitative-easing) — often accompanied by guidance
- [Federal funds rate target](/federal-funds-rate-target) — what guidance describes

### Wider context

- [Central bank](/central-bank) — the institution providing guidance
- [Interest rate](/interest-rate) — what guidance shapes expectations about
- [Inflation](/inflation) — the target guidance aims to control
- [Yield curve](/yield-curve) — shaped by guidance about future rates
- [Recession](/recession) — guidance is often deployed to prevent or manage
