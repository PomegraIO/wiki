...
description: "Temporary open-market operations are repurchase agreements in which a central bank buys securities and agrees to sell them back on a near-term date."
keywords:
  - TOMO
...
|   |   |
|---|---|
| **Also called** | Repurchase agreement, repo, overnight repo |
| **Duration** | Overnight to a few weeks |
| **Parties** | Central bank (buyer), dealer or bank (seller) |
| **What happens** | Central bank buys security, agrees to sell back later |
| **Price difference** | Implicit interest rate (the repo rate) |
| **Effect on balance sheet** | Temporary, self-reversing |
| **Primary use** | Daily money supply fine-tuning |
