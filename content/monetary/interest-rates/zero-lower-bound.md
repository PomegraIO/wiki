...
description: "The limit on how low nominal interest rates can go; when nominal rates hit zero, central banks must rely on unconventional policy tools."
keywords:
  - zero lower bound
  - ZLB
  - monetary policy
...
*The **zero lower bound** (ZLB) describes a fundamental constraint on [monetary policy](/wiki/monetary-policy/): nominal [interest rates](/wiki/interest-rate/) cannot fall below zero percent. When [central banks](/wiki/central-bank/) lower the [policy rate](/wiki/central-bank-policy-tools/) to zero and inflation remains low or negative, the real interest rate floor is set by expected [inflation](/wiki/inflation/). Below that point, traditional rate cuts become impotent, forcing policymakers to deploy unconventional tools like [quantitative easing](/wiki/quantitative-easing/).*

<aside class="wiki-infobox">

| Aspect | Detail |
|--------|--------|
| **Definition** | Nominal rates cannot sustainably go below 0% on risk-free instruments |
| **Economic rationale** | Lenders can hold cash instead of accepting negative returns |
| **Real rate floor** | -1× expected inflation (if inflation is 2%, real floor is -2%) |
| **Effective duration** | Hits when policy rate at zero and inflation still low |
| **Policy constraint** | Prevents stimulus via further rate cuts; requires alternatives |
| **Historical cases** | Japan (1999–present), USA (2008–2009, 2020–2021), Eurozone (2014–2022) |
| **Escape routes** | Forward guidance, QE, negative rates, fiscal stimulus, inflation tolerance |

</aside>

## The economic logic behind the bound

Lenders (banks, investors) will not voluntarily accept negative nominal returns on safe assets. If a [central bank](/wiki/central-bank/) sets the policy rate at −0.5%, a bank can instead withdraw cash from the central bank, earn 0% (by holding physical currency), and avoid the −0.5% loss.

This "cash floor" is why nominal rates cannot drift significantly below zero in practice, even if policymakers technically allow it. At the [Federal Reserve](/wiki/federal-reserve/), the [federal funds rate](/wiki/federal-funds-rate/) is the overnight rate at which banks lend reserves to each other. If the Fed sets the target at −0.5%, banks would prefer to settle transactions in cash, rendering the negative rate moot.
...
The [Fed](/wiki/federal-reserve/) and other central banks purchase longer-term securities ([Treasury bonds](/wiki/treasury-bond/), [mortgage-backed securities](/wiki/mortgage-backed-security/)) to lower long-term rates and inject [liquidity](/wiki/liquidity-pool/) into the financial system. QE flattens the [yield curve](/wiki/yield-curve/), compressing long-term [bond yields](/wiki/bond-yield-spread/) and encouraging investors to shift into equities or riskier assets.
...
### Negative Rates
Some central banks ([ECB](/wiki/european-central-bank/), SNB, BoJ) implemented negative policy rates (−0.1% to −0.75%), penalizing banks for holding excess reserves and incentivizing lending. Negative rates are politically contentious and logistically difficult, but have modest effectiveness in steering short-term behavior.
...
For [fixed income](/wiki/fixed-income-etf/) investors, the ZLB has profound implications:
...
### Closely related
- [Monetary policy](/wiki/monetary-policy/) — central bank tools for managing the economy
- [Interest rate](/wiki/interest-rate/) — the cost of borrowing; set by central banks
- [Quantitative easing](/wiki/quantitative-easing/) — large-scale asset purchases to inject liquidity
- [Federal funds rate](/wiki/federal-funds-rate/) — the rate set by the Federal Reserve

### Wider context
- [Negative interest rates](/wiki/negative-interest-rates/) — rates below zero; attempted policy tool
- [Deflation](/wiki/deflation/) — sustained decline in general price levels
- [Inflation targeting](/wiki/inflation-targeting/) — central bank framework for price stability
- [Liquidity trap](/wiki/liquidity-pool/) — situation where monetary policy loses effectiveness
