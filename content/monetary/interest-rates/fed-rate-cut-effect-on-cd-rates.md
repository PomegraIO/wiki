---
title: "Fed Rate Cuts and Certificate of Deposit Yields"
description: "Why CD rates fall quickly after Fed rate cuts and how banks adjust yields. Lock in rates before cuts hit."
keywords:
  - fed rate cut effect on cd rates
  - cd rates federal reserve
  - certificate of deposit yield after rate cut
  - when do cd rates fall
  - locking in cd rates before rate cut
...
<div class="wiki-infobox-title">Fed Rate Cuts and CDs — Key Facts</div>

<img src="/svg/monetary.svg" alt="An abstract editorial mark for the topic." />

<div class="wiki-infobox-caption">CDs react to rate cuts faster than most savers expect.</div>

|   |   |
|---|---|
| **Typical adjustment timeline** | Banks lower CD yields within 24–72 hours of a Fed cut announcement or implementation |
| **Why it happens** | Banks fund operations from deposit inflows; lower Fed rates reduce their own borrowing costs |
| **Lock-in window** | Savers should rate-shop and commit within hours to days before the expected cut |
| **Which CD maturities move fastest** | Shorter terms (3–6 months) often lag longer terms; no single rule |
| **Rate cuts vs. hikes** | CD yield adjustments tend to be *faster* for cuts than for hikes |
| **Key driver** | Bank competition and [interest-rate](/interest-rate/) expectations, not Fed rules |

</aside>

## Why CD Rates Fall So Quickly

When the [Federal Reserve](/federal-reserve/) lowers the [federal funds rate](/federal-funds-rate/), it reduces the overnight lending rate between banks. This is not a direct control on what banks can pay depositors—there is no legal floor or ceiling on CD rates—but it fundamentally changes the incentive. A bank that borrows short-term in the Fed funds market at a lower rate also lowers its marginal cost of funding. If two banks in the same region are competing for deposits, and one is suddenly able to fund itself cheaper, that bank can afford to offer a lower CD yield and still profit. Competition cascades. Within hours to a few days, most online banks and regional players have revised their term deposit rates downward.
...
- **Longer-term CDs** (1, 2, 3+ years) often fall *more* because long-term [interest rates](/interest-rate/) are driven by market expectations of future Fed policy, not just the current rate. A rate cut signals future easing, so long-term rates fall sharply, and banks must adjust longer-term CD yields to stay competitive.

In some cycles, the differences are subtle; in others, a 1-year CD might drop by 0.50% while a 3-month CD drops by only 0.10%. There is no universal rule. A saver who expects a rate cut should compare all available terms at multiple banks *before* the cut, then decide which maturity and which bank offers the best [yield](/dividend-yield/).
...
**Monitor Fed forecasts.** The Federal Reserve's [forward guidance](/forward-guidance/) and the [interest-rate](/interest-rate/) swap market telegraph easing before official announcements. By watching FOMC communications, you can often identify a high-probability cut weeks in advance and act accordingly.
...
- [Federal Reserve](/federal-reserve/) — The central bank that sets the Fed funds rate
- [Federal Funds Rate](/federal-funds-rate/) — The overnight interbank rate that anchors bank funding costs
- [Interest Rate](/interest-rate/) — Core concept of time value of money
- [Inflation Expectations](/inflation-expectations/) — What drives Fed rate-cut expectations
- [Money Market Fund](/money-market-fund/) — Alternative to CDs for short-term savings

### Wider context

- [Monetary Policy](/monetary-policy/) — How central banks influence the economy
- [Interest Rate Risk](/interest-rate-risk/) — General exposure to rate movements
- [Central Bank](/central-bank/) — Role of Fed and peer institutions
