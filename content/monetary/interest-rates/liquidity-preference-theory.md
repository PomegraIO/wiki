...
description: "Keynes's explanation of how money demand and supply jointly determine short-term interest rates through preference for liquid assets."
keywords:
...
<div class="wiki-infobox-title">Liquidity Preference Theory — key facts</div>

<img src="/svg/monetary.svg" alt="An abstract editorial mark for monetary economics." />

<div class="wiki-infobox-caption">Interest emerges from the preference to hold money rather than illiquid assets.</div>

|   |   |
|---|---|
| **What it is** | Keynes's model of interest-rate determination based on money supply and demand |
| **Core insight** | Interest is the premium paid to overcome reluctance to part with liquid cash |
| **Key motives** | Transactions, precautionary, speculative |
| **Central bank role** | Controls money supply to influence interest rates and economic activity |
| **Main alternative** | Classical loanable-funds theory, which emphasizes investment-savings equilibrium |
| **Time period** | Introduced in *The General Theory*, 1936 |
...
- [Monetary Policy](/monetary-policy/) — how central banks use interest rates, money supply, and other tools to manage the economy
- [Interest Rate](/interest-rate/) — the price of borrowing money and the opportunity cost of holding cash
- [Yield Curve](/yield-curve/) — the relationship between interest rates and maturity, shaped by expectations and risk premiums
- [Market Segmentation Theory](/market-segmentation-theory/) — an alternative view that different maturities trade independently without arbitrage
- [Preferred Habitat Theory](/preferred-habitat-theory/) — how investors demand yield premiums to move away from their preferred maturity
- [Central Bank](/central-bank/) — the institution that controls money supply and the policy rate

### Wider context

- [Quantitative Easing](/quantitative-easing/) — expansion of money supply when conventional rates are stuck near zero
- [Inflation](/inflation/) — the erosion of purchasing power that shapes real interest rates and speculative demand
- [Federal Reserve](/federal-reserve/) — the US central bank and principal operator of monetary policy
