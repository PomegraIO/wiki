---
title: "Quantitative Tightening: How Central Banks Shrink Their Balance Sheets"
description: "Quantitative tightening explained: the mechanics of passive runoff and active asset sales, and why balance sheet shrinkage affects financial markets differently than rate hikes."
keywords:
  - quantitative tightening balance sheet runoff
  - QT passive runoff
  - central bank balance sheet shrinkage
  - quantitative easing reversal
  - Federal Reserve portfolio reduction
...
<div class="wiki-infobox-caption">QT shrinks the central bank's footprint in credit markets, draining liquidity and shifting price discovery back to private markets.</div>

|   |   |
|---|---|
| **Main mechanism** | Passive runoff (bonds mature, not replaced) or active sales (central bank sells holdings) |
| **Effect on money supply** | Reduces it; the central bank takes cash out of the financial system |
| **Primary channel** | Reduces availability of safe collateral and drains reserves from the banking system |
| **Different from rate hikes** | Affects the long end of the yield curve more; works through collateral scarcity, not borrowing cost |
| **Timing** | Usually begins after rates have peaked; complements or follows rate tightening |
...
- [Central Bank Credibility and Its Effect on Inflation Expectations](/central-bank-credibility-inflation-expectations/) — How balance sheet actions signal the central bank's inflation commitment
- [Quantitative Easing](/quantitative-easing/) — The mirror image: how central banks expanded balance sheets to support credit and growth
- [Federal Reserve](/federal-reserve/) — The central bank executing QT and the factors influencing its pace
- [Interest Rate](/interest-rate/) — The primary tool that complements QT in tightening financial conditions
- [Monetary Policy](/monetary-policy/) — The broader framework in which QT is one tightening instrument

### Wider context

- [Yield Curve](/yield-curve/) — How QT and rate hikes reshape the relationship between short and long-term interest rates
- [Credit Risk](/credit-risk/) — How tighter financial conditions raise borrowing costs for companies and households
- [Recession](/recession/) — A potential outcome if QT is too aggressive in combination with rate hikes
- [Bond](/bond/) — The primary asset on a central bank balance sheet during QT
