---
title: "Negative Interest Rates: How Central Banks Use Sub-Zero Policy Rates"
description: "How central banks push policy rates below zero, the mechanics of negative interest rates on bank reserves and deposits, and the limits that prevent deeper cuts."
keywords:
...
<div class="wiki-infobox-title">Negative Interest Rates — how they work</div>

<img src="/svg/monetary.svg" alt="An abstract editorial mark for monetary policy." />

<div class="wiki-infobox-caption">Central banks deploy sub-zero rates to punish saving and push capital into the real economy.</div>

|   |   |
|---|---|
| **Policy mechanism** | Central bank charges banks a fee to hold excess reserves instead of paying interest |
| **Transmission channel** | Banks discourage deposits (may charge depositors) and seek loans or investments to escape the tax |
| **Practical floor** | Around −0.5% to −1.0%; deeper cuts face cash flight and bank margin squeeze |
| **Risk duration** | Extended negative rates erode bank profitability and distort asset allocation |
| **Geographic examples** | ECB (−0.5%), Swiss National Bank (−0.75%), Bank of Japan (−0.1%) |
| **Exit trigger** | Central bank raises rate back to zero when inflation recedes or emergency lifts |

</aside>

## The Paradox of Sub-Zero Rates

Conventional wisdom says interest rates can't go below zero: why would a lender pay to lend, or a depositor accept negative returns? Yet since the 2008 financial crisis, central banks in Europe, Japan, and Switzerland have pushed policy rates into negative territory. The trick is that [central banks](/central-bank/) have monopoly power over the money supply and can enforce negative rates on specific actors—even if the floor seems absurd.
...
**On the saver side:** As banks face negative returns, they reduce deposit rates and may charge customers for large balances. This encourages households and firms to move money out of bank deposits into risk assets—equities, [real estate](/residential-real-estate/), [cryptocurrencies](/cryptocurrency-exchange/)—or to simply spend. The central bank's intent is to make hoarding cash so unpleasant that capital finds its way into productive investment and consumption.
...
The **U.S. Federal Reserve** never adopted negative rates, preferring [quantitative easing](/quantitative-easing/) and forward guidance instead. The political appetite in the U.S. was never present.
...
- [Central Bank](/central-bank/) — The authority that sets policy rates and implements monetary transmission
- [Federal Reserve](/federal-reserve/) — U.S. central bank; chose quantitative easing over negative rates
- [Monetary Policy](/monetary-policy/) — The broader toolkit of which negative rates are one instrument
- [Interest Rate](/interest-rate/) — The foundational mechanism behind all central bank policy
- [Quantitative Easing](/quantitative-easing/) — Alternative stimulus when conventional rates hit zero
