...
description: "Representative money is a token or note that represents a claim on a commodity, such as a dollar bill redeemable for gold."
keywords:
...
|   |   |
|---|---|
| **What it is** | Token or certificate redeemable for a commodity |
| **Backing** | Commodity held in reserve (typically gold) |
| **Redeemability** | At a fixed rate (e.g., $35 per ounce of gold) |
| **Advantages** | Paper convenience + commodity stability |
| **Disadvantages** | Constraint on money growth; redemption runs possible |
| **Historical example** | Pre-1971 US dollar; classical gold standard |
