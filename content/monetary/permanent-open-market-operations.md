---
title: "Permanent Open-Market Operations"
description: "Permanent open-market operations are outright purchases or sales of securities by a central bank with no agreement to reverse the transaction."
keywords:
  - POMO
...
|   |   |
|---|---|
| **Also called** | Outright purchases, outright sales |
| **What happens** | Central bank buys or sells; holds the asset long-term |
| **Effect on balance sheet** | Permanent change in size and composition |
| **Counterparties** | Primary dealers, asset managers |
| **Timing** | Continuous, especially during easing or tightening cycles |
| **Reversibility** | Only through later sales or maturity runoff |
| **Duration** | Years or decades, until maturity or deliberate sale |

</aside>

## The distinction from temporary operations

When the central bank conducts a temporary operation—a repurchase agreement or **repo**—it buys a security and simultaneously agrees to sell it back on a near-term date, usually overnight or a few days later. The operation is self-reversing; the balance sheet swells for a day and then contracts again.

A permanent operation is different. The central bank buys a security with no commitment to sell it back. It will hold the asset, collect interest on it, and let it run to maturity—or sell it later if circumstances warrant. The balance sheet grows, and it stays grown. If the central bank later decides to reduce its holdings, that requires an explicit decision to sell or (more commonly) to allow securities to mature without reinvesting the proceeds.
