---
title: "Reverse Repo Facility"
description: "A reverse repo facility is a central bank's standing offer to borrow cash from financial institutions using securities as collateral, draining liquidity from the financial system."
keywords:
  - RRP
...
|   |   |
|---|---|
| **What it is** | Central bank's standing offer to borrow cash via repo |
| **Direction** | Institutions deposit cash; Fed posts collateral |
| **Duration** | Overnight or term |
| **Rate** | Fixed, typically near or below the federal funds rate target |
| **Counterparties** | Money-market funds, banks, dealers, others |
| **Collateral** | Treasury securities and other assets posted by the Fed |
| **Purpose** | Drain excess liquidity, defend interest rate floor |
