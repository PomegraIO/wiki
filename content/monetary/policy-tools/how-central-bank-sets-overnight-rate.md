---
title: "How a Central Bank Sets the Overnight Interest Rate"
description: "Learn how a central bank steers the overnight interbank interest rate through reserve supply, corridor boundaries, and open market operations to achieve its monetary policy target."
keywords:
  - how central bank sets overnight rate
  - federal funds rate mechanism
...
<div class="wiki-infobox-title">Overnight Rate Mechanism — key facts</div>

<img src="/svg/monetary.svg" alt="An abstract editorial mark for monetary policy." />

<div class="wiki-infobox-caption">Central banks steer short-term rates by managing reserve scarcity, not by issuing orders.</div>

|   |   |
|---|---|
| **What it is** | The interest rate at which banks lend reserves to each other overnight |
| **Who sets it** | The central bank (e.g., Federal Reserve, ECB) through reserve management |
| **Target rate** | Set by the central bank's policy committee (e.g., FOMC); market trades around it |
| **Key tool** | Adjusting the supply of reserves in the banking system |
| **Corridor bounds** | Upper and lower rate limits enforced by standing lending facilities |
| **Market mechanism** | Banks bid to borrow reserves; scarcity or abundance drives the rate |
| **Transmission** | Influences longer-term rates, lending standards, credit availability, and inflation |
...
- [Central Bank](/central-bank/) — The institution that sets and maintains the overnight rate corridor
- [Reserve Requirements](/reserve-requirements/) — The regulation that creates bank demand for overnight reserves
- [Quantitative Easing](/quantitative-easing/) — An extension of OMOs used when the overnight rate reaches zero
- [Yield Curve](/yield-curve/) — Longer-term rates that follow from overnight rate expectations
