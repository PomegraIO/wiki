---
title: "Interest rate"
description: "An interest rate is the price of borrowing money, expressed as a percentage per year. Central banks set short-term rates; markets set long-term rates. Interest rates ripple through all asset classes and are the foundation of financial valuation."
keywords:
  - interest rate
  - discount rate
  - nominal vs real
...
---
*An **interest rate** is the price of borrowing money, expressed as a percentage per year. If you borrow \$100 at 5% interest, you owe \$105 in a year. Interest rates are the single most important price in an economy — they determine how much it costs to borrow for a home, a car, a business expansion, or running a government. They are set by central banks at the short end and by markets at the long end, and they ripple through the value of every asset from [bonds](/bond) to [stocks](/stock) to real estate.*

<div class="wiki-hatnote">

This entry covers interest rates as a financial concept. For how the [Federal Reserve](/federal-reserve) sets rates, see central bank policy; for the relationship between interest rates and inflation, see [inflation](/inflation); for bonds and yields, see [bond](/bond).

</div>

<aside class="wiki-infobox">

<div class="wiki-infobox-title">Interest rate — key facts</div>

<img src="/svg/monetary.svg" alt="A chart of interest rates over time" />

<div class="wiki-infobox-caption">An interest rate is, at heart, just a number — but it is the number everything else hangs from.</div>

|   |   |
|---|---|
| **What it is** | Price of borrowing money, % per year |
| **Who sets it** | Central banks (short-term), markets (long-term) |
| **Key US rate** | Federal funds rate, set by the Federal Reserve |
| **Types** | Nominal (stated), real (adjusted for inflation) |
| **Effects** | Influences all borrowing costs, asset valuations |
| **Range historically** | 0–5% in normal times, wider in crises |
| **Inverse relationship** | Higher rates → lower bond prices |
| **Inflation adjustment** | Real rate ≈ nominal rate − inflation |
| **Economic phase** | Rising in expansions, falling in recessions |
...
Sometimes, particularly when the [Federal Reserve](/federal-reserve) has raised short rates aggressively, the curve **inverts** — short-term rates exceed long-term rates. An inverted curve is often a recession signal, because it reflects a market belief that short rates will fall in the future when the economy weakens.
...
This affects [bonds](/bond) directly. A [bond](/bond) paying \$50 per year for 10 years is worth less when discount rates rise. If rates rise from 3% to 5%, that bond's price falls, because investors can now buy new bonds paying 5%. Why own an old bond paying 3%?

For [stocks](/stock), the effect is indirect but powerful. The value of a stock is theoretically the present value of its future earnings. When interest rates rise, the discount rate rises, and stock prices fall. Moreover, higher rates slow economic growth, which slows earnings growth. It is a double hit.
...
Economists talk about the **natural rate of interest** — roughly, the real interest rate consistent with full employment and stable inflation. In the US, estimates of the natural rate typically range from 0.5% to 2%. It is the rate the [Federal Reserve](/federal-reserve) is aiming for in the very long run.
...
## Interest rates and the [Federal Reserve](/federal-reserve)
...
The federal funds rate is a special rate — it is the cost for banks to borrow from each other. Consumer loan rates, mortgage rates, and [bond](/bond) yields are higher, because there is **credit risk** — the risk that the borrower defaults.

The difference is the **spread**. A mortgage might be federal funds plus 2.5 percentage points. A [bond](/bond) from a risky company might be 6% when Treasury rates are 4% — a 2% spread.
...
- [Federal Reserve](/federal-reserve) — sets short-term rates
- [Bond](/bond) — prices move inversely to rates
- [Stock](/stock) — valuations sensitive to discount rate changes
- [Inflation](/inflation) — central determinant of real rates
- [Central bank](/central-bank) — the institution that sets rates
- [Yield curve](/yield-curve) — the shape of rates across maturities

### Wider context

- [Recession](/recession) — often triggered by rising rates
- [Bull market](/bull-market) · [Bear market](/bear-market) — often correlate with rate cycles
- [Compound interest](/compound-interest) — the mathematics underlying valuation
- [Diversification](/diversification) — different assets respond differently to rate changes
- [Asset allocation](/asset-allocation) — should account for interest rate environment
