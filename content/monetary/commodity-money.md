...
description: "Commodity money is money that has intrinsic value from the material it is made of, such as gold, silver, or other precious metals."
keywords:
  - commodity money
  - gold money
  - precious metals
...
|   |   |
|---|---|
| **What it is** | Money made from or backed by a valuable commodity |
| **Examples** | Gold coins, silver coins, historically salt, shells |
| **Intrinsic value** | Yes; the material is valuable outside of money use |
| **Created by** | Private mints, mining, or governments |
| **Inflation control** | Built-in; limited supply of the commodity constrains money |
| **Modern status** | Obsolete as primary money; some use as store of value |
...
1. Gold is universally valued—it can be melted down for jewelry, used in dentistry or electronics, or simply held as a store of wealth.
2. The weight and purity of the coin can be verified.
3. The coin can be divided (coins of different denominations).
4. The coin is durable and long-lasting.
