---
title: "Bond"
description: "A bond is a tradeable IOU—a promise to repay borrowed money with interest on a set schedule. Bonds have fixed coupons, a maturity date, and prices that move inversely to interest rates."
keywords:
  - bond
  - fixed income
  - debt security
...
<div class="wiki-infobox-title">Bond — key facts</div>

<img src="https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=900&q=80" alt="A bond is, at heart, a contract about money to be paid back." />

<div class="wiki-infobox-caption">A bond is, at heart, a contract about money to be paid back.</div>

|   |   |
|---|---|
| **What it is** | A debt security; a promise to repay with interest |
| **Issued by** | Governments and corporations |
| **Face value** | The principal amount (e.g., $1,000) |
| **Coupon** | The interest payment, usually semi-annual |
