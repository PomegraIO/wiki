---
title: "Prime broker"
description: "A prime broker is a full-service financial institution that provides clearing, settlement, financing (margin and securities lending), and other services to large traders and hedge funds. They enable institutions to trade large sizes with leverage."
keywords:
  - prime broker
  - prime brokerage
  - clearing
...
|   |   |
|---|---|
| **What it is** | Full-service broker for large traders and institutions |
| **Typical clients** | Hedge funds, large proprietary traders, asset managers |
| **Services** | Clearing, margin, securities lending, execution, reporting |
| **Capital** | Billions (only large banks can be prime brokers) |
| **Fees** | Much higher than retail; often bundled |
