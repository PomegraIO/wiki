---
title: "Short squeeze"
description: "A short squeeze occurs when a heavily shorted stock begins to rise, forcing short-sellers to cover (buy back) their shares, which drives the price up further, forcing more shorts to cover. The feedback loop creates an explosive rally."
keywords:
  - short squeeze
  - short selling
  - gamma squeeze
...
|   |   |
|---|---|
| **What it is** | Forced short-seller buying feedback loop |
| **Trigger** | Stock begins rising (for any reason) |
| **Mechanism** | Short-sellers cover → price rises → more covering → price higher |
| **Duration** | Can last hours, days, or weeks |
| **Price target** | Often no fundamental support; driven purely by momentum |
| **Risk** | Longs who buy at peak can lose heavily on the rebound |
