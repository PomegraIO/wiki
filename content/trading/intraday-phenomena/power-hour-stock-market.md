...
keywords:
  ...
  - 3 to 4 pm trading
  - closing auction stock exchange
---
...
<div class="wiki-infobox-title">Power Hour — key facts</div>

<img src="/svg/trading.svg" alt="An abstract editorial mark for trading." />

<div class="wiki-infobox-caption">The stock market's busiest hour combines institutional mechanics with retail behavior in a predictable window.</div>

|   |   |
|---|---|
| **Time window** | 3:00 p.m.–4:00 p.m. ET, Monday–Friday (regular session only) |
| **Volume pattern** | Typically 20–30% of daily volume; sometimes 40% in volatile markets |
| **Volatility** | Often elevated vs. midday, especially final 15 minutes |
| **Key players** | Index funds, pension funds, proprietary traders, momentum traders |
| **Market mechanics** | [Bid-ask spreads](/bid-ask-spread/) often tighten; depth may be illusory |
...
**Options expiration (Friday only)**: On Fridays, near-the-money [options](/option/) are especially sensitive to intraday moves. Traders hedge, roll, or close positions before expiration. The gamma-related hedging and volatility flows in the final hour on Fridays can be pronounced, especially on [expiration weeks](/expiration-contracts/).
...
1. **Uncertainty reduction**: Rebalancing late in the day reduces the duration of the position change. If you are exiting a $100 million position, executing it all at 3:30 p.m. means you hold the remainder of your portfolio in its new mix for only a few hours, minimizing exposure to overnight repricing.

2. **Liquidity concentration**: The final hour offers the highest total liquidity in the day for large-cap names. A trader moving $50 million across 50 names wants to do it when spreads are tightest and order book depth is highest—the close.

3. **Index timing**: Many index funds use a closing-price fill model: they calculate required trades based on the 4:00 p.m. closing prices and execute accordingly. This creates a systematic late-day flow that algorithms can anticipate.
...
The very last 15 minutes of regular trading (3:45–4:00 p.m.) often see the most dramatic moves. Volume can spike, volatility can double, and [bid-ask spreads](/bid-ask-spread/) can tighten to pennies or widen sharply depending on order flow balance.
...
- [Bid-Ask Spread](/bid-ask-spread/) — spreads tighten during power hour as depth improves
- [Momentum Investing](/momentum-investing/) — the strategy that power-hour volume sometimes amplifies
- [Closing Auction](/closing-auction/) — the mechanism that concentrates volume in the final seconds
- [Market Order](/market-order/) — how traders execute the bulk of power-hour volume
- [Option](/option/) — options hedging contributes to power-hour volatility, especially on Fridays

### Wider context

- [Stock Exchange](/stock-exchange/) — the venue that hosts power-hour trading
- [Index Fund](/index-fund/) — passive flows that drive much power-hour volume
- [Volatility Smile](/volatility-smile/) — how intraday volatility patterns like power hour affect option pricing
- [Algorithmic Trading](/algorithmic-trading/) — algorithms exploit power-hour patterns at scale
- [Market Maker Trading](/market-maker-trading/) — market makers adjust quotes in anticipation of power-hour order flow
