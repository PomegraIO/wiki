---
title: "Clearing firm"
description: "A clearing firm is a member of the clearinghouse that processes and settles trades. It acts as an intermediary between traders and the clearinghouse, managing risk and ensuring both sides of the trade fulfill their obligations."
keywords:
  - clearing firm
...
|   |   |
|---|---|
| **What it is** | Clearinghouse member that processes trades for clients |
| **Typical example** | Schwab, Fidelity, JPMorgan, Goldman Sachs (have clearing operations) |
| **Role** | Intermediary between trader and clearinghouse |
| **Responsibility** | Ensure settlement, manage counterparty risk, collect margin |
| **Capital requirement** | Must maintain sufficient capital (regulated) |
