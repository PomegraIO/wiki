...
description: "A pattern day trader (PDT) is a trader who makes four or more day trades (buy and sell of the same security within a single day) in a rolling five business day period. PDTs are subject to SEC rules requiring a minimum $25,000 account balance and margin restrictions."
keywords:
  - pattern day trader
  - PDT
  - day trading rules
...
|   |   |
|---|---|
| **Trigger** | 4 or more day trades in a rolling 5 business day window |
| **Minimum balance** | $25,000 (cash or marginable securities) |
| **Buying power limit** | 4× account equity (vs. 2× for regular margin traders) |
| **Duration** | Restrictions persist until you go 5 days without a day trade |
| **Who sets rule** | SEC and FINRA (stock markets); CME (futures) |
...
**Tuesday (next week):** 0 day trades
**Wednesday:** 0 day trades
**Thursday:** 0 day trades
**Friday:** 0 day trades (= 5 consecutive days without a day trade)
