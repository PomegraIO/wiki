---
title: "Settlement T+2"
description: "T+2 settlement means that stock trades settle (cash and shares change hands) two business days after the trade is executed. In the U.S., T+2 is the standard settlement period for most securities."
keywords:
  - T+2 settlement
  - settlement date
  - trade settlement
...
|   |   |
|---|---|
| **What it is** | Trade settles two business days after execution |
| **Current standard** | Yes, for most U.S. equities (since September 2017) |
| **Previous standard** | T+3 (before 2017) |
| **Meaning** | Buyer must have cash and seller must deliver shares by T+2 |
| **Managed by** | The National Securities Clearing Corporation (NSCC) |
