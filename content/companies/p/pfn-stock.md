---
title: "PIMCO Income Strategy Fund II (PFN)"
description: "A closed-end fund managed by PIMCO that invests in fixed-income and equity securities to generate regular income distributions, combining different asset classes for yield enhancement."
keywords:
  - closed-end fund
  - fixed income
  - dividend income
...
<table>
<tr><th>Ticker</th><td>PFN (NYSE)</td></tr>
<tr><th>Fund type</th><td>Closed-end fund</td></tr>
<tr><th>Manager</th><td>PIMCO (Pacific Investment Management Company)</td></tr>
<tr><th>Launch date</th><td>2011</td></tr>
<tr><th>Primary focus</th><td>Income generation across asset classes</td></tr>
<tr><th>Holdings</th><td>Bonds, preferred stocks, common stocks</td></tr>
<tr><th>SEC CIK</th><td>0001296250</td></tr>
</table>
</aside>

## Three income sources working together

PIMCO Income Strategy Fund II generates distributions from three sources. The first is fixed-income securities — investment-grade and high-yield [corporate bonds](/corporate-bond/), government bonds, mortgage-backed securities — which pay regular interest coupons. The second is preferred stocks, hybrid securities that pay fixed [dividends](/dividend/) before common dividends and rank ahead of [common stock](/common-stock/) in a [liquidation](/liquidation/). The third is common equities, which contribute through dividends and potential capital appreciation. This three-part approach spreads risk across asset classes while targeting income at each step. In a stable environment, the combination provides steady cash flows; in stress, bonds and preferreds provide downside protection because they rank above common stock.

## Leverage's role in boosting distributions

One defining characteristic of many PIMCO [closed-end funds](/closed-end-fund/) is their use of leverage. The fund borrows money against its holdings and invests that borrowed capital into additional securities, magnifying the portfolio size. If leverage costs are low and the underlying securities yield more than the cost of borrowing, leverage increases distributions. However, leverage also magnifies losses — in a market downturn, a leveraged fund falls further than an unleveraged one. The sustainability of a high distribution often hinges on whether leverage costs remain reasonable and whether the underlying securities keep generating expected income.
