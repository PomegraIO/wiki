---
title: "PGIM Laddered Nasdaq-100 Buffer 12 ETF (PBQQ)"
description: "An exchange-traded fund offering Nasdaq-100 stock exposure with built-in downside protection through a rotating quarterly buffer strategy, capping losses while limiting gains."
keywords:
  - nasdaq-100 ETF
  - downside protection
  - buffer strategy
...
*The **PGIM Laddered Nasdaq-100 Buffer 12 ETF** (PBQQ) gives you Nasdaq-100 stock exposure plus protection against sharp declines. Instead of holding the index stocks directly, PBQQ spreads your money across four separate ETFs, each offering a 12 percent downside buffer over a three-month period.*

<aside class="wiki-infobox">

<div class="wiki-infobox-title">PBQQ — key facts</div>

<img src="https://images.unsplash.com/photo-1526304640581-d334cdbbf45b?w=600&q=80" alt="A digital display showing financial data and stock market trends." />

<div class="wiki-infobox-caption">Buffer ETFs trade steady returns and capped gains for protection against sharp market downturns.</div>

|   |   |
|---|---|
| **What it is** | Nasdaq-100 exposure with quarterly downside buffers |
| **Issuer** | PGIM (Prudential Global Investment Management) |
| **Launched** | December 2024 |
| **Underlying exposure** | Nasdaq-100 Index stocks |
| **Strategy** | Laddered quarterly buffer funds |
| **Buffer level** | 12% downside protection per quarter |
| **Upside cap** | Varies by quarter (typically 8-12%) |
| **Expense ratio** | 0.50% annually |
| **Trading venue** | NASDAQ |
| **Structure** | Fund of four quarterly buffer ETFs |

</aside>

## What the buffer does and how it works

Think of it this way. If you own a plain Nasdaq-100 fund and the index falls 15 percent, you lose 15 percent. If it falls 5 percent, you lose 5 percent. PBQQ changes the game: the fund's structure guarantees that if the Nasdaq-100 drops up to 12 percent in any quarter, you do not lose anything. If the index falls 20 percent, you lose only 8 percent.
...
## Understanding the quarterly mechanics

Each buffer ETF runs for exactly three months, covering a specific calendar quarter. When a quarterly buffer expires, your position automatically converts or rolls into a new one for the next quarter. This is automatic—you do not have to do anything—but you should track when these rollovers occur. The cap on upside gains resets with each new quarter, reflecting current market conditions.

The exact upside cap and buffer mechanics are detailed in the quarterly prospectus updates from PGIM. Investors should read these to understand the precise terms of protection and expected returns under various market scenarios.
...
PBQQ appeals to investors who want Nasdaq-100 exposure but are anxious about market crashes and willing to trade growth for stability. It does not fit aggressive growth investors seeking maximum returns or those convinced tech stocks will decline sharply over time.

The real risks are opportunity cost (missing significant upside gains in strong bull markets), complexity (the quarterly rolling mechanics can be confusing to monitor), and duration mismatch (the three-month buffer cycles may not align with your personal investment timeline). Additionally, if the Nasdaq-100 stays flat or rises just slightly, the capped upside structure means PBQQ will underperform with minimal benefit from downside protection.
