---
title: "iShares Paris-Aligned Climate Optimized MSCI World ex USA ETF (PABD)"
description: "PABD is an ETF tracking developed-market stocks outside the US, selected and weighted to align with Paris Climate Agreement emissions-reduction targets."
keywords:
  - climate ETF
  - ESG index fund
...
The fund is issued by BlackRock's iShares division and trades on [NASDAQ](/nasdaq/) under the ticker PABD. It is a standard exchange-traded fund, not leveraged or inverse, and not an exchange-traded note. You own shares that hold the underlying stocks directly.
...
**What it costs.** The [expense ratio](/expense-ratio/) typically ranges from 0.25% to 0.35% per year. On a $10,000 position, that is $25 to $35 annually. This covers the cost of the index methodology, trading, and fund administration. It is competitive for an international climate-tilted [fund.
