---
title: "Xtrackers Cybersecurity Select Equity ETF (PSWD)"
description: "A US equity ETF tracking a curated index of publicly traded cybersecurity and information-security companies, holding large-cap, mid-cap, and smaller firms working in defense, threat prevention, and compliance technology."
keywords:
  - cybersecurity
...
<table>
<tr><th>Ticker</th><td>PSWD (NASDAQ)</td></tr>
<tr><th>Fund type</th><td>US equity ETF, thematic</td></tr>
<tr><th>Sponsor</th><td>Xtrackers (DWS)</td></tr>
<tr><th>Strategy</th><td>Cybersecurity-focused equity selection</td></tr>
<tr><th>Underlying index</th><td>ISE Cybersecurity Select Index or similar</td></tr>
<tr><th>Holdings</th><td>Software, hardware, and services firms in security</td></tr>
<tr><th>Sector mix</th><td>Primarily technology, with industrials and financials components</td></tr>
</table>
</aside>

## The rise of a security-focused theme
...
## How to research PSWD

Start with Xtrackers' fund fact sheet and prospectus to understand the exact inclusion criteria—specifically, what fraction of revenue a company must derive from security to be eligible. Request the current holdings list and review which vendors and services are represented; this tells you the fund's current exposure to different security subsegments (threat prevention, detection, response, identity, network, cloud security). Compare PSWD's performance to the broader technology sector and to cybersecurity indices from other providers to understand how the selection strategy has performed across market cycles. Review the fund's largest holdings and understand each company's business—whether it is a fast-growing specialist, a slow-growing vendor facing disruption, or a mature player with strong cash flow. Watch regulatory developments; changes to data-protection mandates or government security spending can materially shift the sector's growth trajectory.

## See also

Thematic investing, technology sector, enterprise software, information risk, business resilience, index selection, growth stocks.
