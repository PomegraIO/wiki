...
description: "Pfizer discovers, develops, and manufactures pharmaceutical and biologic medicines used to treat disease across therapeutic areas including oncology, vaccines, primary care, and specialty care, derived from a 170-year history of chemical and pharmaceutical research."
keywords:
...
Key metrics to track: revenue trends by business segment, particularly monitoring how much revenue is coming from mature, lower-margin drugs versus newer, higher-margin therapies. [Free cash flow](/free-cash-flow/) generation shows whether profits translate into actual cash. The composition of revenue (how much is blockbuster drugs, how much is specialty or oncology) indicates strategic progress. Patent expiration schedules show upcoming revenue headwinds from generic competition. Pipeline progress — drugs advancing to later-stage trials or receiving approvals — signals future revenue potential. And gross margins and [operating margins](/operating-margin/) by segment reveal pricing power and cost management.
