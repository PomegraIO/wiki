---
title: "Astoria Real Assets ETF (PPI)"
description: "Astoria Real Assets ETF invests in commodity-linked companies and real assets, providing inflation-hedging exposure through physical commodities, mining, agriculture, and energy infrastructure."
keywords:
  - real assets ETF
...
<tr><th>Ticker</th><td>PPI (NYSE Arca)</td></tr>
<tr><th>Strategy</th><td>Real assets and commodity-linked equities</td></tr>
<tr><th>Underlying exposure</th><td>Metals, energy, agriculture, infrastructure</td></tr>
<tr><th>Fund structure</th><td>Standard ETF (not leveraged, not inverse)</td></tr>
<tr><th>Investment approach</th><td>Seeks inflation protection and real return</td></tr>
</table>
</aside>
...
The fund avoids direct commodity ownership (which requires specialized custody and derivatives) and instead invests in publicly traded equity shares of the companies that extract, process, and distribute these real assets. This means the fund's value depends on both commodity prices (which drive these companies' revenues) and how efficiently the companies operate.
