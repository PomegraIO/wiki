---
title: "PennyMac Mortgage Investment Trust (PMT)"
description: "PennyMac is a residential mortgage REIT and servicer, operating in the U.S. mortgage market where it originates, services, and invests in home loans — a regional, geography-dependent player riding cycles of rates and housing."
keywords:
  - mortgage REIT
...
PennyMac Mortgage Investment Trust is a [real estate investment trust](/real-estate-investment-trust/) that earns its keep from the American residential mortgage machine. It works three main seams: originating mortgages (finding borrowers and writing loans), servicing mortgages for other lenders (collecting payments and managing escrow), and investing in mortgage-backed securities and related assets. The business is almost entirely bound to U.S. rates and the health of the American housing market, and that concentration shapes everything about it—how it makes money, where its risks live, and why a swing in the [federal funds rate](/federal-funds-rate/) ripples straight through to the bottom line.

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>PMT (NYSE)</td></tr>
<tr><th>Founded</th><td>2013</td></tr>
<tr><th>Headquarters</th><td>Westlake Village, California</td></tr>
<tr><th>Sector</th><td>Financial services / Mortgage REIT</td></tr>
<tr><th>Business model</th><td>Mortgage origination, servicing, and asset investment</td></tr>
...
Mortgage origination generates upfront fees and the gain on sale when a loan is sold off the [balance sheet](/balance-sheet/). The size of those gains depends on [interest rates](/interest-rate/) and the appetite for mortgage-backed securities. When rates are low and housing is hot, originations swell and gains are fatter. When rates rise and the market slows, originations shrink and each loan sold generates less profit. This is not a stable revenue stream; it swings hard with the housing cycle.
...
| Revenue stream | Nature | Sensitivity |
|---|---|---|
| Origination gains | Upfront, variable | Rates, housing demand |
| Servicing fees | Recurring, predictable | Loan servicing volume |
| Investment income | Portfolio yield | Interest rates, credit spreads |
