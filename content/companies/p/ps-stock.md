...
Pershing Square earns revenue principally from two sources: a fixed management fee on assets under management (typically 1.5–2% per year, though details vary by share class and investor type) and a [performance fee](/performance-fee/) or incentive allocation, usually 20% of profits above a high-water mark. The firm maintains a lean New York-based team of analysts, investors, and operations staff. It does not operate portfolio companies or manage real estate; instead, it is purely an asset manager that holds financial stakes and exercises influence through [voting rights](/voting-rights/) and public pressure.
