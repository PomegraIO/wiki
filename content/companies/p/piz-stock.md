---
title: "Invesco Dorsey Wright Developed Markets Momentum ETF (PIZ)"
description: "An exchange-traded fund applying momentum-based stock selection to developed markets — a quantitative screen that emphasizes companies with recent price strength across North America, Europe, and Asia-Pacific."
keywords:
  - momentum etf
  - developed markets
...
[Momentum investing](/momentum-investing/) operates on a simple premise: stocks that have been moving up tend to keep moving up, at least for a time. This is not because companies are fundamentally better — though some may be — but because markets move in trends, and those trends persist long enough for investors to profit from riding them. The Invesco Dorsey Wright Developed Markets Momentum ETF (ticker PIZ) applies this logic to the largest, most-developed equity markets outside the United States. Rather than buying all developed-market stocks equally, or favoring only the biggest companies, PIZ systematically selects stocks that show the strongest recent price momentum and weights them accordingly. The fund is neither a [value fund](/value-fund/) seeking cheap stocks nor a [growth fund](/growth-fund/) chasing rising earnings — it is purely a momentum play, and that focus is both its appeal and its defining limitation.

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>PIZ (NASDAQ)</td></tr>
<tr><th>Sponsor</th><td>Invesco</th>
<tr><th>Underlying index</th><td>Dorsey Wright Developed Markets Momentum Index</td></tr>
<tr><th>Geographic scope</th><td>Developed markets (Europe, Asia-Pacific, Canada)</td></tr>
<tr><th>Selection method</th><td>Momentum-based quantitative screening</td></tr>
