---
title: "Invesco Global Water ETF (PIO)"
description: "An exchange-traded fund holding water-related companies worldwide — utilities, infrastructure operators, and technology firms managing water supply and treatment across developed and emerging markets."
keywords:
  - global water etf
  - water utilities
  - water technology
...
<table>
<tr><th>Ticker</th><td>PIO (NASDAQ)</td></tr>
<tr><th>Sponsor</th><td>Invesco</td></tr>
<tr><th>Underlying index</th><td>S&P Global Water Index</td></tr>
<tr><th>Geographic scope</th><td>Developed and emerging markets worldwide</td></tr>
<tr><th>Business focus</th><td>Water utilities, infrastructure, treatment, testing</td></tr>
<tr><th>Fund type</th><td>Exchange-traded fund (ETF)</td></tr>
<tr><th>Expense ratio</th><td>Moderate for global thematic funds</td></tr>
</table>
</aside>

## The shift from developed-market water to global

The earliest water-sector ETFs, including PHO, focused almost exclusively on North American and Western European utilities — the mature, regulated, dividend-paying water systems that serve established cities and suburbs. That framework made sense at the time; these were the most liquid, accessible water stocks available to US investors. But the global water story is increasingly one of emerging markets. India, China, Southeast Asia, and the Middle East are investing trillions in new water infrastructure because their populations are growing faster and water scarcity is more acute. China operates some of the world's largest water-engineering firms; India is building entirely new water-management systems for its cities. PIO's inclusion of these emerging-market players captures a dimension of the water story that a developed-market-only fund misses.

## What PIO holds

The S&P Global Water Index draws from utilities (regulated firms that operate water systems for municipalities), equipment and engineering firms that build and maintain water infrastructure, chemical companies that treat and purify water, and technology firms that monitor and optimize water use. The holdings span geographies: large North American and European utilities sit alongside Chinese water-infrastructure firms, Indian treatment specialists, and Australian mining-adjacent water-service companies. The index is large-cap focused — it does not include small or illiquid stocks — which means it naturally weights toward bigger, more established players, but it does capture water-business activity from across the globe rather than concentrating on a single region.
...
Water is economically essential and increasingly scarce, which in theory should translate to durable demand for water-related companies. Governments fund water infrastructure, industries pay for water treatment, and consumers cannot live without it. Yet the business is often less lucrative than theory suggests. Water infrastructure, especially in developing countries, is often government-owned or government-subsidized, which can cap returns. Regulated utilities in developed markets face political pressure to keep water affordable, limiting pricing power. Technology and engineering firms serving water customers face competition and cyclical capital spending from municipalities.

That said, some segments of the water business are genuinely profitable: specialty chemical companies selling treatment products, large engineering and construction firms winning long-term infrastructure contracts, and technology firms managing water networks for industrial customers have real margins and growth. But investors in PIO are not just holding those profitable niches; they are also holding utilities that generate steady but modest returns.
...
**Concentration.** A few very large utilities often represent a significant chunk of assets. A problem at any of these major players can move the fund noticeably.
