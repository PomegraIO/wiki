---
title: "Invesco Dorsey Wright Energy Momentum ETF (PXI)"
description: "A momentum-focused ETF concentrated in energy stocks. Applies relative-strength screening to integrated oil, natural gas, renewables, and energy-services companies."
keywords:
  - energy sector
  - momentum etf
  - oil and gas
...
Liquidity is solid. PXI trades on major exchanges with decent volume, making it accessible for most investors. The [expense ratio](/expense-ratio/) is higher than a static energy index ETF but lower than a traditional actively managed energy [mutual fund](/mutual-fund/), which reflects the computational cost of momentum screening and rebalancing.

The [dividend yield](/dividend-yield/) on PXI is typically elevated because energy companies, especially integrated majors and midstream operators, generate substantial cash and distribute it to shareholders. This yield can be attractive to income-focused investors, though it is also a source of tax consequences in taxable accounts. Review the distribution schedule and tax treatment before deploying capital.
