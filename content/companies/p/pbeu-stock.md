---
title: "Portfolio Building Block European Banks Index ETF (PBEU)"
description: "An exchange-traded fund tracking the BITA European Banks Index, providing exposure to publicly listed banking institutions across developed European markets."
keywords:
  - European banks
  - financial sector
  - regional banking
...
<div class="wiki-infobox-title">PBEU — key facts</div>

<img src="https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=600&q=80" alt="A modern European bank building facade with glass and stone architecture." />

<div class="wiki-infobox-caption">European banking operates under the tightest regulatory regime globally, shaped by post-2008 reform and the structures of the banking union.</div>

|   |   |
|---|---|
| **What it is** | Exchange-traded fund tracking European bank index |
| **Issuer** | Tidal Investments LLC |
| **Launched** | 2025 |
| **Index** | BITA European Banks Index |
| **Holdings** | 55 securities |
| **Top 10 holdings** | Constitute approximately 61% of assets |
| **Expense ratio** | 0.13% annually |
| **Trading venue** | NASDAQ |
| **Fund structure** | Passive, rules-based index tracking |
...
European banks operate under the world's tightest regulatory regime, a consequence of the 2008 financial crisis and Europe's subsequent [sovereign debt](/sovereign-debt/) crises. The [Basel III](/basel-iii/) rules, implemented through the European regulatory framework and the banking union in the eurozone, impose minimum capital ratios, stress-test requirements, and restrictions on [dividend](/dividend/) payouts that are far more stringent than rules governing US or Asian banks. These constraints mean European lenders carry more excess capital than is strictly necessary for their business needs, which reduces leverage and risk but also constrains returns on equity.
...
European banks have been structurally challenged by decades of low [interest rates](/interest-rate/), which compressed lending margins and forced banks to shrink [balance sheets](/balance-sheet/). The environment also intensified competition from non-bank lenders and fintech firms, while persistent low loan growth limited opportunities to increase earnings. Banks invested heavily in cost reduction and attempted digital transformation, but these moves only partially offset structural headwinds.

Interest rates began rising in 2022, which in theory helps bank profitability by widening lending margins. However, many European banks entered that period with weak capital positions and deteriorating credit quality, so the benefit has been muted. Investors in PBEU must monitor whether rising rates translate into higher earnings or whether loan losses and shrinking loan books offset the margin expansion. Any [recession](/recession/) in Europe would quickly reverse the benefit of higher rates and could impair underlying bank assets significantly.

## Expense ratio and trading liquidity

PBEU's [expense ratio](/expense-ratio/) of 0.13 percent annually is notably low, reflecting Tidal's commitment to cost-effective index tracking and the underlying stocks' broad [market capitalization](/market-capitalization/) and reasonable trading liquidity. The fund trades on the [Nasdaq](/nasdaq/) with spreads typically tight relative to [net asset value](/net-asset-value/), though individual European bank stocks vary in tradability and liquidity.

## Who PBEU is for and the real risks

PBEU is suitable for investors seeking geographic [diversification](/diversification/) into the European financial sector and those comfortable with the cyclical nature of banking stocks and their sensitivity to interest rates, economic growth, and regulatory changes. It is not suitable as a core growth holding, as European banks have limited organic growth prospects.

The core risks are regulatory (dividends and capital can be restricted by authorities), cyclical (downturns immediately impair asset quality and earnings), and geopolitical (fragmented EU rule-making and sovereign debt risks in constituent countries). Investors should carefully monitor [European Central Bank](/european-central-bank/) policy, regulatory capital announcements, and macroeconomic conditions before building a large position in PBEU.
