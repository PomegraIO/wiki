...
The advantage for a REIT like Alpine is predictability. If lease terms are long-term with steady rent escalators and the tenant is creditworthy, the cash flows are recurring and almost indistinguishable from [bond](/bond/) coupons. The property owner bears minimal [operational risk](/operational-risk/); the tenant's financial health and ability to renew the lease are the main concerns. This model appeals to income investors who want real estate exposure without active property management and to REIT investors seeking stable distributions.
