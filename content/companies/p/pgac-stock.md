---
title: "PANTAGES CAPITAL ACQUISITION Corp (PGAC)"
description: "A special-purpose acquisition company (SPAC) incorporated to identify and merge with an operating business to take it public."
keywords:
  - SPAC
  - acquisition company
  - blank-check company
...
PANTAGES CAPITAL [ACQUISITION](/acquisition/) Corp, trading under ticker PGAC, is a blank-check company formed to pool capital and deploy it toward acquiring or merging with an operating business. Like every SPAC, PGAC itself has no business. It generates no revenue, owns no customers, builds no products. Its sole function is to serve as a shell into which an operating company will eventually move, becoming a public company in the process.
...
PGAC raised capital from retail and institutional investors at inception, most likely at ten dollars per share. Those shareholders hold redeemable [common stock](/common-stock/), meaning they can ask for their money back if they disapprove of any [merger](/merger/) announcement, or they can stay invested post-merger and see where the combined entity trades. The sponsor — PANTAGES CAPITAL's founders — holds [founder shares](/founder-shares/), which represent roughly twenty percent of the post-merger company if the deal closes. This founder share structure creates a strong incentive: if the sponsor chooses poorly or misjudges a target, those founder shares become worthless. Conversely, if the sponsor finds a genuine winner, the founder stake becomes enormously valuable.
