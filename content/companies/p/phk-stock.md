---
title: "PIMCO High Income Fund (PHK)"
description: "PIMCO High Income Fund is a closed-end fund investing in high-yield (non-investment-grade) bonds and preferred stocks, offering income-seeking investors concentrated exposure to credit risk."
keywords:
  - closed-end fund
  - high-yield bonds
  - junk bonds
...
| Attribute | Details |
|---|---|
| **Fund type** | Closed-end mutual fund (CEF) |
| **Investment focus** | High-yield bonds (below investment grade) and preferred stocks |
| **Sponsor/manager** | PIMCO (Pacific Investment Management Company), Allianz subsidiary |
| **Ticker** | PHK (NYSE) |
| **Asset class** | Fixed income / credit |
| **Distribution** | Monthly distributions; managed at a target rate |
| **Primary risk** | Credit deterioration; interest-rate sensitivity; market illiquidity |
| **SEC CIK** | 0001219360 |

PHK is a closed-end fund that distinguishes itself in a critical way: it is not an open-end [mutual fund](/mutual-fund/). [Open-end funds](/open-end-fund/) (the kind most retail investors own in 401(k)s) allow shareholders to buy and redeem shares at [net asset value](/net-asset-value/) every day. [Closed-end funds](/closed-end-fund/) issue a fixed number of shares upfront, then trade those shares on a [stock exchange](/stock-exchange/) at prices set by supply and demand — which often diverges from the underlying net asset value of the holdings. That distinction matters profoundly for PHK's economics and risk profile.

The fund's strategy is straightforward: buy [high-yield bonds](/high-yield-bond/) and [preferred stocks](/preferred-stock/), hold them, and distribute the income to shareholders. High-yield [bonds](/bond/) are issued by companies with lower [credit ratings](/credit-rating/) (typically BB and below) — the riskier end of the [corporate bond](/corporate-bond/) spectrum. They compensate investors for that risk with higher yields (interest payments) than [investment-grade bonds](/investment-grade-bond/). Preferred stocks are a hybrid instrument: they behave like bonds (fixed [dividend](/dividend/), senior to [common stock](/common-stock/) in a bankruptcy) but have some equity-like features (no maturity date, dividend reset mechanisms). The combination of high-yield bonds and preferreds appeals to income-hungry investors — pension funds, retirees, insurance companies — who need steady cash flow.
...
Risk in a high-yield fund is [credit risk](/credit-risk/) — the risk that bond issuers default or cut dividends, forcing the fund to write down holdings or reduce its distribution. High-yield bonds default at higher rates than investment-grade bonds, a mathematical fact. In good economic times, [default rates](/default-rate/) stay low and the extra yield compensates investors well. In a [recession](/recession/) or sharp [credit event](/credit-event-sovereign/) (geopolitical shocks, financial-sector stress), defaults spike, bond prices plummet, and shareholders suffer. PHK's concentration in credit-risky instruments means it amplifies both booms and downturns compared to a diversified bond portfolio.
