---
title: "Paylocity Holding Corp (PCTY)"
description: "Paylocity is a cloud-based payroll and human resources platform for mid-market businesses, built from 1998 as a horizontal HR solution and now a core fixture in workplace software."
keywords:
  - payroll software
  - human resources
  - mid-market SaaS
...
The company went public in 2014 (ticker PCTY on [NASDAQ](/nasdaq/)), at a point when the HR technology market was still wide open. Enterprise vendors like SAP and [Oracle](/orcl-stock/) dominated the megacap space; small-business providers like Gusto were just arriving. Paylocity occupied the middle ground, and it had a head start. The IPO gave it capital to accelerate product development, build out a national sales force, and pursue a series of bolt-on [acquisitions](/acquisition/) that widened its feature set and deepened its moat.
...
Paylocity competes in a field that includes large enterprise vendors (ADP, Paychex) who dominate the biggest companies and the smallest businesses, and a growing list of specialized or mid-market alternatives. [Workday](/wday-stock/), owned by its founders, targets large enterprises and has a much deeper feature set. Gusto built a simpler, more consumer-friendly platform and captured a large piece of the micro-business segment. BambooHR focused on human resources rather than payroll and took a vertical approach.
