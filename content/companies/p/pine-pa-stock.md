---
title: "Alpine Income Property Trust, Inc. (PINE-PA)"
description: "Alpine Income Property Trust is a real estate investment trust acquiring and managing single-tenant net-lease commercial properties, primarily occupied by triple-net tenants."
keywords:
  - REIT
  - net lease
...
The cost of capital determines Alpine's growth thesis. If the company can raise capital at a lower cost than the yield on the properties it acquires, it can grow and boost [earnings per share](/earnings-per-share/). If it borrows at 5 percent and buys properties yielding 6 percent, the spread is accretive. If costs rise above yields, that spread narrows and growth becomes destructive. Alpine, like all REITs, manages this mathematics continuously.

### Risks in the portfolio

The biggest risk is tenant default. A restaurant lease renewed in 2021 seemed solid at the time, but if that restaurant struggles through [inflation](/inflation/), labor costs, and changing consumer taste, it might fail to renew or pay rent on time. Alpine must underwrite these tenants carefully and maintain enough liquidity and property sales to handle defaults without cascading into financial stress. The portfolio quality reflects both the company's discipline and the luck of which tenants hit headwinds.

[Refinancing risk](/refinancing-risk/) appears when debt matures. If Alpine borrowed at 3 percent rates in 2020 and the debt comes due in 2025, the company must refinance at current rates — likely much higher. That increases the cost of capital and pressures returns. Rising [interest rates](/interest-rate/) hurt REIT valuations because they raise the [discount rate](/discount-rate/) used to value future dividends.

Single-tenant properties in secondary and [tertiary markets](/tertiary-market/) can face structural headwinds. A strip mall outside a mid-sized city may struggle as online commerce shifts retail, and Alpine's tenants may face secular pressure independent of Alpine's management. The company mitigates this by diversifying across locations and geographies, but the category risk remains.
...
Alpine competes for properties with other single-tenant REITs (W.P. Carey, Realty Income, STORE Capital, and dozens more), private investors, and insurance companies' real estate portfolios. The market for quality single-tenant net-lease properties is competitive, and [cap rates](/cap-rate/) (the initial yield on acquisition) have compressed over time as capital has flowed into the category. Alpine must either find off-market deals, deploy capital faster than competitors, or focus on undervalued niches to maintain growth.
...
Watch the acquisition yield — the cash yield at which Alpine is buying new properties — relative to what Alpine is paying for equity (the [dividend yield](/dividend-yield/) and [cost of debt](/cost-of-debt/)). When the acquisition yield is materially higher than the cost of capital, growth is accretive. When they converge or reverse, growth becomes expensive.

Monitor the tenant health through [default rates](/default-rate/) and renewal rates (the percentage of expiring leases that are renewed). A rising default rate is a warning sign. Conversely, a stable or declining default rate, with solid renewal rates, suggests the portfolio is holding up.
