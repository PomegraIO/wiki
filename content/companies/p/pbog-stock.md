---
title: "Portfolio Building Block Integrated Oil and Gas and Exploration and Production Index ETF (PBOG)"
description: "An exchange-traded fund tracking the BITA Global Oil and Gas Select Index, providing exposure to upstream oil and natural gas exploration, extraction, and production companies worldwide."
keywords:
  - oil and gas stocks
  - energy sector
...
<div class="wiki-infobox-title">PBOG — key facts</div>

<img src="https://images.unsplash.com/photo-1467092437642-7f551b298fcd?w=600&q=80" alt="An offshore oil and gas production platform in open water." />

<div class="wiki-infobox-caption">Upstream oil and gas production is capital-intensive and drives the extraction and discovery of fossil fuels worldwide.</div>

|   |   |
|---|---|
| **What it is** | Exchange-traded fund tracking global upstream energy index |
| **Issuer** | Tidal Investments LLC |
| **Index** | BITA Global Oil and Gas Select Index |
| **Fund type** | Passive, rules-based index tracking |
| **Sector focus** | Upstream oil and gas exploration and production |
| **Geographic focus** | Developed markets globally |
| **Dividend yield** | Approximately 3% annualized |
| **Expense ratio** | Low-cost passive tracking |
| **Trading venue** | NASDAQ |
| **Fund structure** | Non-diversified |
