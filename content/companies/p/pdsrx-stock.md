---
title: "Principal Real Asset Fund (PDSRX)"
description: "A mutual fund that invests in real-world assets—real estate, infrastructure, commodities, and commodities-related companies—for investors seeking returns tied to physical things rather than pure finance."
keywords:
  - mutual fund
  - real assets
  - infrastructure
...
<table>
<tr><th>Fund type</th><td>Mutual fund (actively managed)</td></tr>
<tr><th>Ticker</th><td>PDSRX</td></tr>
<tr><th>Sponsor</th><td>Principal Global Investors (Principal Financial)</td></tr>
<tr><th>Investment focus</th><td>Real assets: real estate, infrastructure, commodities, natural resources</td></tr>
<tr><th>Strategy</th><td>Long-only, diversified across multiple real-asset classes</td></tr>
<tr><th>Cost structure</th><td>Annual expense ratio; share classes vary</td></tr>
...
Principal Real Asset Fund is an [actively managed fund](/actively-managed-fund/), meaning humans at Principal Global Investors decide which real-asset holdings to buy and sell. They are looking for companies that own or operate real assets and offer a blend of current income and growth. A typical portfolio might hold REITs (which own residential, commercial, or industrial property), infrastructure operators (toll roads, water utilities), and commodities-linked companies (oil-sands producers, mining firms, agricultural commodity traders).

The fund charges an annual [expense ratio](/expense-ratio/)—a percentage of your holdings deducted each year to cover the managers' salaries, research, and administration. The specific ratio depends on which [share class](/share-class/) you buy; retail mutual-fund classes typically charge more than institutional classes. You can buy shares directly and hold them, or you can own the fund through a retirement account or as part of a larger portfolio.
...
Real assets are not without risk. Infrastructure projects depend on government support and [regulation; a](/regulation-a/) toll road's profits hinge on political willingness to maintain tolls, which can be volatile. Commodities prices swing on global supply and demand; a drought can slash agricultural values, a drilling ban can crater oil-sands stocks. Property values rise and fall with [interest rates](/interest-rate/) and the economy. A slump in any of these areas hits the fund's value.

The fund also carries management risk: the team at Principal Global Investors must pick the right real assets and time their purchases and sales well. Unlike a passive [index fund](/index-fund/) that simply holds everything in the real-asset category, an actively managed fund rises and falls on the skill of its human managers.
