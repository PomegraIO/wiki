...
description: "Plug Power manufactures hydrogen fuel cells and operates a hydrogen refueling network for forklifts, commercial vehicles, and grid storage — competing in the emerging hydrogen economy against both traditional fossil fuels and other fuel-cell technologies."
keywords:
  - hydrogen fuel cells
  - fuel-cell vehicles
  - hydrogen generation
...
<table>
<tr><th>Ticker</th><td>PLUG (NASDAQ)</td></tr>
<tr><th>Founded</th><td>1997, Latham, New York</td></tr>
<tr><th>Founder</th><td>Hal Searles, Andy Marsh (CEO)</td></tr>
<tr><th>Sector</th><td>Clean energy, fuel cells, hydrogen</td></tr>
<tr><th>Primary products</th><td>Hydrogen fuel cells; hydrogen dispensers; electrolyzer systems</td></tr>
<tr><th>Key applications</th><td>Warehouse material handling; commercial vehicle propulsion; grid storage</td></tr>
<tr><th>Business model</th><td>Equipment sales; hydrogen supply contracts; service subscriptions</td></tr>
<tr><th>SEC CIK</th><td>0001093691</td></tr>
</table>
</aside>
...
Plug's revenue comes from three sources. The first is fuel-cell systems — equipment the company manufactures or assembles and sells to customers. The most mature market is material-handling fuel cells that power forklifts inside warehouses and distribution centers. Amazon, [Walmart](/wmt-stock/), and other large logistics operators have deployed thousands of Plug fuel cells in their facilities. The customer buys the fuel cell, Plug installs it or provides it for installation, and Plug earns a one-time revenue.
...
Plug's competitors come in two categories. The first is other fuel-cell and hydrogen companies. Hydrogenics (now owned by Cummins) makes fuel-cell systems. [Bloom Energy](/be-stock/) makes solid-oxide fuel cells. A handful of other startups are working on hydrogen storage, generation, and distribution. But none of these competitors has scaled to the degree Plug has.
