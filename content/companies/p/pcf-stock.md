---
title: "High Income Securities Fund (PCF)"
description: "High Income Securities Fund is a closed-end investment company investing in discounted shares of income-focused closed-end funds and business development companies to provide high current income."
keywords:
  - closed-end fund
  - income investment
  - BDC
...
<table>
<tr><th>Ticker</th><td>PCF (NYSE)</td></tr>
<tr><th>Fund type</th><td>Closed-end management investment company</td></tr>
<tr><th>Inception</th><td>1986</td></tr>
<tr><th>Investment objective</th><td>High current income (primary); capital appreciation (secondary)</td></tr>
<tr><th>Investment minimum</th><td>At least 80% in discounted income securities</td></tr>
<tr><th>Adviser</th><td>Bulldog Investors, LLP (as of June 2024)</td></tr>
<tr><th>SEC CIK</th><td>0000810943</td></tr>
</table>
</aside>
...
Like many closed-end funds, High Income Securities can employ leverage through borrowing or preferred [share issuance](/share-issuance/) to amplify its returns. Leverage increases both potential gains and the risk of loss; if the underlying portfolio returns less than the cost of the borrowed capital, returns to common shareholders erode. The level of leverage varies with market conditions and the adviser's assessment of opportunities, so investors must monitor the [leverage ratio](/leverage-ratio-forex/) in each reporting period.
...
In November 2024, High Income Securities initiated a tender offer for its own shares at 98 percent of net asset value, allowing shareholders to exit or reduce positions at prices near intrinsic value. [Tender offers](/tender-offer/) are periodic mechanisms for closed-end funds to provide liquidity and bridge the discount between market price and net asset value.
