...
description: "PagSeguro is a Brazilian fintech company that processes payments and provides financial services to small merchants and consumers, operating in one of Latin America's largest digital-payment markets."
keywords:
  - fintech
  - payments
  - Brazil
...
<table>
<tr><th>Ticker</th><td>PAGS (NYSE)</td></tr>
<tr><th>Founded</th><td>2006, São Paulo, Brazil</td></tr>
<tr><th>Headquarters</th><td>São Paulo, Brazil</td></tr>
<tr><th>Business model</th><td>Payment processing and financial services for SMBs and consumers</td></tr>
<tr><th>Core offerings</th><td>Payment gateway, POS systems, digital wallet, lending</td></tr>
<tr><th>Geography</th><td>Brazil (primary market)</td></tr>
<tr><th>SEC CIK</th><td>0001712807</td></tr>
</table>
</aside>
...
The risks are real. Brazil's regulatory environment can shift. If the [central bank](/central-bank/) or finance ministry imposes new requirements on digital wallets or lending, PagSeguro would have to adapt, potentially at cost. [Currency risk](/currency-risk/) matters: PagSeguro earns money in Brazilian reals, but investors value it in [US dollars](/us-dollar/), so strength in the dollar hurts returns. The [concentration risk](/concentration-risk/) is also notable: Brazil is the only major market PagSeguro operates in, so the company is bet entirely on Brazilian economic growth and stability.
