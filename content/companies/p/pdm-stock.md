---
title: "Piedmont Realty Trust, Inc. (PDM)"
description: "Piedmont Realty Trust is a real-estate investment trust that owns and operates office and mixed-use properties in the US Southeast — a landlord serving corporate tenants who lease office space, primarily in Class A buildings in growth markets."
keywords:
  - REIT
  - office buildings
...
<table>
<tr><th>Ticker</th><td>PDM (NYSE)</td></tr>
<tr><th>Business type</th><td>Real-estate investment trust (office REIT)</td></tr>
<tr><th>Primary properties</th><td>Office buildings and mixed-use developments</td></tr>
<tr><th>Geographic focus</th><td>Southeastern United States</td></tr>
<tr><th>Core market tenants</th><td>Corporations, professional services, financial firms</td></tr>
<tr><th>Founding</th><td>1998</td></tr>
<tr><th>SEC CIK</th><td>0001042776</td></tr>
</table>
</aside>
...
Piedmont's tenants span corporate headquarters, regional offices of national companies, law firms, accounting practices, real-estate brokerages, and financial-services firms. No single tenant dominates the portfolio — the largest typically represents 3–5% of revenue — which spreads default risk across many companies. Leases usually run five to ten years, and rents are negotiated to include a base rate plus annual escalators (typically 2–3% per year) to protect the owner against [inflation](/inflation/).
...
Piedmont finances its operations and property [acquisitions](/acquisition/) through a combination of debt (mortgages on the properties and [corporate bonds](/corporate-bond/)) and equity raised from shareholders. As a REIT, the company is required by law to distribute at least 90% of its taxable income to shareholders as [dividends](/dividend/), which is why Piedmont shares typically yield 3–5% depending on [interest rates](/interest-rate/) and the state of the office market. That dividend is funded by the cash the properties generate minus the debt service and operating expenses. When office leasing slows or occupancy falls, the cash available for distribution shrinks.

The company's [balance sheet](/balance-sheet/) and [leverage ratio](/leverage-ratio-forex/) matter because a REIT loaded with debt becomes vulnerable to a downturn. Piedmont maintains investment-grade [credit ratings](/credit-rating/) from the major agencies, meaning lenders view the company as unlikely to default, but that requires discipline in how much debt the company takes on relative to the cash-generating capacity of the properties.
...
Anyone evaluating Piedmont should read the company's [annual report](/10-k/) and quarterly earnings releases (SEC CIK 0001042776) to track occupancy trends, average rent per square foot, and the maturity schedule of leases. Look at what percentage of leases are coming up for renewal in the next 1–3 years — a large block of expiring leases in a weak market is a material risk. Monitor the company's capital deployment: is it acquiring new properties, developing mixed-use projects, or shrinking? Look at dividend coverage — the ratio of [funds from operations](/funds-from-operations/) to the dividend — to see whether the distribution is sustainable or reliant on selling capital. The [office REIT](/office-reit/) sector as a whole is cyclical, and Piedmont's relative strength depends on the health of the Southeastern markets it serves and its success in adapting the portfolio to a world where office space is no longer assumed to fill buildings.
