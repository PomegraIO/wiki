---
title: "Portfolio Building Block World Pharma and Biotech Index ETF (PBPH)"
description: "An exchange-traded fund tracking the BITA Global Pharma and Biotech Select Index, providing exposure to worldwide pharmaceutical and biotechnology companies engaged in drug discovery and development."
keywords:
...
<div class="wiki-infobox-title">PBPH — key facts</div>

<img src="https://images.unsplash.com/photo-1576091160550-112173e7f644?w=600&q=80" alt="Laboratory scientist examining pharmaceutical compounds under magnification." />

<div class="wiki-infobox-caption">Drug discovery and development is the core of pharmaceutical and biotech company value, involving years of research, clinical testing, and regulatory approval.</div>

|   |   |
|---|---|
| **What it is** | Exchange-traded fund tracking pharma and biotech index |
| **Issuer** | Tidal Investments LLC |
| **Launched** | November 2025 |
| **Index** | BITA Global Pharma and Biotech Select Index |
| **Holdings** | Approximately 57 securities |
| **Fund type** | Passive, rules-based index tracking |
| **Inclusion criteria** | 50%+ revenue from therapeutic development |
| **Dividend yield** | Approximately 2.2% annualized |
...
PBPH holds approximately 57 securities that meet the fund's inclusion criteria—companies deriving a significant portion of revenues from therapeutic discovery, development, and commercialization. The largest positions are integrated pharmaceutical firms with substantial market capitalisation and long product histories: [Eli Lilly](/lly-stock/) and Company (specialising in metabolic disease and oncology), [Johnson & Johnson](/jnj-stock/) (consumer health, pharmaceuticals, and medical devices), [AbbVie](/abbv-stock/) (immunology and virology), Roche (diagnostics, oncology, and immunology), and [Novartis](/nvs-stock/) (oncology, immunology, and rare disease).
