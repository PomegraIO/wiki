...
Patria generates revenue through the standard operating model of an alternative asset manager: **[management fees](/management-fee/)** on assets under management and **[performance fees](/performance-fee/)** (typically 20% of profits) on fund returns. The firm raises [closed-end funds](/closed-end-fund/) with defined investment periods and target deployment timelines, then charges an annual management fee (commonly 1.5–2%) on committed or invested capital and carries a performance fee when returns exceed hurdle rates (often 8% per year).
