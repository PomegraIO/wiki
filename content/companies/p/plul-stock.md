---
title: "Leverage Shares 2X Long PLUG Daily ETF (PLUL)"
description: "PLUL is a leveraged ETF that seeks to deliver 2x daily returns on Plug Power stock, resetting its leverage position daily to amplify PLUG's gains for short-term traders and betting on hydrogen fuel cell momentum."
keywords:
  - leveraged long ETF
  - 2x PLUG
  - daily reset
...
Plug Power manufactures hydrogen fuel cell systems and operates hydrogen production and distribution infrastructure. PLUL lets traders bet on Plug Power's stock appreciation with a 2x multiplier: if PLUG moves up 1% in a day, PLUL should move up 2%. If PLUG moves down 1%, PLUL should fall 2%. The fund is for traders who expect hydrogen fuel cell adoption to accelerate over the next day or two and want that conviction amplified.

This is not an investment for buy-and-hold investors. The leverage is reset every single day, and daily rebalancing costs erode returns over weeks and months. A trader holding PLUL for a week or a month will likely capture far less than 2x the actual return of PLUG, because the math of daily resets working against choppy market moves eats into the gains.
...
The biggest trap in holding PLUL for more than a few days is volatility decay. Imagine Plug Power trades at $20, and over three days the stock goes: up 5% to $21, down 5% to $19.95, then up 5% to $20.95. The net change over three days is roughly positive 5%, but not smoothly. PLUL would have: gone up 10% on day one, down 10% on day two, and up 10% on day three. But the 10% loss on day two hits a lower base than the starting point, and the 10% gain on day three hits a base that's been knocked down. The math works out that the cumulative three-day return is less than 2x the actual return of Plug Power.

Volatility is the enemy of leveraged ETFs. The more the stock bounces around, the more daily rebalancing eats away at returns. In a smooth trending market, where Plug Power climbs steadily, PLUL performs well. In a choppy, oscillating market, PLUL underperforms a simple 2x short position would.
...
PLUL appeals to short-term traders and speculative investors. A trader might hold PLUL for a single trading session, a few hours, or a couple of days, betting on a near-term rally in hydrogen fuel cell stocks. The fund might also appeal to traders using it as a tactical tactical hedge—if you are long Plug Power and want to amplify your gains on a day when you expect a surge, you could add a small PLUL position rather than buying more PLUG directly.

PLUL is not for savers, retirees, or anyone with a long-term time horizon. Financial advisors and fiduciaries routinely caution against holding leveraged ETFs for more than a few weeks. Yet the ease of buying PLUL on any brokerage platform means many retail investors do hold it far longer, suffering losses that exceed the decline in Plug Power itself when the stock weakens.
...
Hold PLUL for a day or two if you have a specific short-term bullish thesis on Plug Power's stock. Beyond that, the costs and compounding effects work against you. The fund will issue warning documents and fact sheets explaining volatility decay with examples. Read them. They are real, not marketing exaggeration. A trader who buys PLUL expecting to ride a multi-month hydrogen fuel cell rally will almost certainly capture far less than 2x that rally's return, and may suffer a loss if the price movement is sideways.
