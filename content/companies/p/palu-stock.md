---
title: "Direxion Daily PANW Bull 2X ETF (PALU)"
description: "PALU is a leveraged ETF that aims for twice the daily return of Palo Alto Networks stock, using daily reset mechanics designed for short-term trading."
keywords:
  - leveraged ETF
  - 2x leverage
  - PANW bull
...
PALU is a leveraged exchange-traded fund that targets twice the daily return of [Palo Alto Networks](/panw-stock/) stock. If Palo Alto Networks rises 1% in a trading day, PALU aims for a 2% gain. If PANW drops 1%, PALU targets a 2% loss. The fund is issued by Direxion, a specialist in leveraged and [inverse ETF](/inverse-etf/) products, and trades on [Nasdaq](/nasdaq/) under the ticker PALU. It is not a passive [index fund](/index-fund/); it is an actively managed portfolio of derivatives and cash designed to maintain a 2-to-1 [leverage ratio](/leverage-ratio-forex/) every single trading day.
...
Day one: PANW up 10%. PALU targets up 20%. A $10,000 position becomes $12,000.
Day two: PANW down 10%. PALU targets down 20%. The $12,000 becomes $9,600.
Net: The underlying stock broke even. PALU lost 4%.

This loss compounds as volatility increases. In a stock that chops up and down over several weeks while trending flat overall, a 2x [leveraged ETF](/leveraged-etf/) will compound losses week after week. Conversely, if a stock trends strongly in one direction with minimal chop, PALU can deliver close to 2x returns. The more volatile the stock and the longer the [holding period](/holding-period/), the worse the volatility decay.
...
PALU carries an [expense ratio](/expense-ratio/) typically between 0.90% and 1.00% per year. This is significantly higher than a plain stock ETF because of the leverage, the daily rebalancing, and the operational complexity involved. For every $10,000 held over a full year, you pay roughly $90 to $100 in fees. Beyond the stated expense ratio, the fund incurs slippage and transaction costs each time it rebalances the underlying derivatives position; these costs are not listed separately but are embedded in the fund's daily performance tracking.
