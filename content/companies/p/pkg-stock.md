...
description: "Packaging Corporation of America makes corrugated cardboard boxes and containerboard for shipping — the most basic material in logistics, sold to hundreds of thousands of customers in steady volume and high bulk."
keywords:
  - packaging
...
The other lever is volume. When the U.S. economy is expanding, retailers order more goods, those goods get shipped in more boxes, and PKG's volume goes up. When the economy contracts, box shipments contract with it. The company is therefore sensitive to economic cycles, particularly to consumer spending and retail inventory. A severe [recession](/recession/) cuts box volume hard. A strong growth period lifts it. That cyclicality means PKG's earnings bounce up and down with the economy more noticeably than a software or insurance company's would.
