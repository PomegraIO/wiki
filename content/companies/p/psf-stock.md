---
title: "Cohen & Steers Select Preferred & Income Fund, Inc. (PSF)"
description: "A closed-end fund specializing in preferred and debt securities, using leverage to amplify yield. Governed by the Investment Company Act of 1940, it targets high current income through a managed portfolio of hybrid and traditional preferred stocks."
keywords:
  - closed-end fund
...
[Cohen & Steers](/cns-stock/) Select Preferred and [Income Fund](/income-fund/), Inc. is a closed-end fund that pools capital from shareholders to invest in a diversified portfolio of [preferred stocks](/preferred-stock/), hybrid-preferred securities, and corporate debt. Unlike [open-end funds](/open-end-fund/), which allow investors to buy and sell shares directly from the fund at daily [net asset value](/net-asset-value/), Cohen & Steers Select maintains a fixed number of shares that trade on public exchanges at market-determined prices — meaning shares may trade at a premium to or discount from their underlying net asset value. The fund uses structural leverage as a deliberate tool to amplify the income its portfolio generates, operating within regulatory guardrails set by the [Investment Company Act of 1940](/investment-company-act-of-1940/).

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>PSF (NYSE)</td></tr>
<tr><th>Fund Type</th><td>Closed-end fixed income fund</td></tr>
<tr><th>Launched</th><td>2010</td></tr>
<tr><th>Manager</th><td>Cohen & Steers Capital Management, Inc.</td></tr>
<tr><th>Primary Objective</th><td>High current income</td></tr>
<tr><th>Secondary Objective</th><td>Capital appreciation</td></tr>
<tr><th>Leverage Limit</th><td>Up to 33% of managed assets</td></tr>
<tr><th>SEC CIK</th><td>0001498612</td></tr>
</table>
</aside>

## The preferred securities strategy

At its core, the fund invests at least 80% of its managed assets in a global portfolio of preferred and income securities. Preferred stock is a hybrid security that sits between [bonds](/bond/) and common equity: it carries no [voting rights](/voting-rights/), but it entitles the holder to receive [dividends](/dividend/) that rank senior to common-stock dividends. Traditional preferred securities issued by banks, utilities, and industrial companies form the anchor of the portfolio. Alongside these sit hybrid-preferred instruments — securities that combine equity and debt features and offer higher yields in exchange for additional risk — and floating-rate preferred shares whose dividends adjust with market [interest rates](/interest-rate/), providing some protection against rising-rate environments.

The fund also holds a smaller allocation to investment-grade [corporate bonds](/corporate-bond/) and convertible securities with ten-year or longer maturities. These extend duration and add flexibility to respond to both market dislocations and opportunities as [credit spreads](/credit-spread/) widen or tighten. The global mandate allows the manager to invest in preferred and debt issued outside the United States, broadening the universe and capturing currency and geopolitical diversity.
...
This mechanism is transparent in the fund's reporting and exists because leverage is a regulatory option, not a loophole. The Investment Company Act explicitly allows [closed-end funds](/closed-end-fund/) to use it under prescribed safeguards; by contrast, open-end [mutual funds](/mutual-fund/) cannot employ leverage without triggering separate SEC restrictions.
...
Cohen & Steers Select operates as a [registered investment company](/registered-investment-company/) under the Investment Company Act of 1940. That law sets minimum standards for disclosures, restricts transactions with insiders, limits leverage, and requires the fund to file regular reports with the [Securities and Exchange Commission](/securities-and-exchange-commission/) including detailed portfolio holdings, [expense ratios](/expense-ratio/), and performance data. The fund's [board of directors](/board-of-directors/) includes independent directors required by law to oversee manager conflicts and fiduciary duties.

The fixed-income market in which the fund invests is itself shaped by [Federal Reserve](/federal-reserve/) policy, credit conditions, and the willingness of banks and corporations to issue new preferred and debt securities. Persistent low interest rates incentivize issuance and support valuations; rising rates compress values and can freeze issuance. Because preferred stocks have no maturity date, they behave more like equities than bonds in a rising-rate environment — falling sharply in value as the [discount rate](/discount-rate/) rises. The fund's ability to deliver returns depends not just on defaults within its portfolio but on the broader direction of credit spreads and interest rates, both variables the manager cannot control.

## How to research PSF as an investment

Prospective investors should begin with the fund's [annual report](/10-k/) filed with the SEC (CIK 0001498612), which discloses current portfolio holdings, [asset allocation](/asset-allocation/), the expense ratio, leverage details, and distribution history. The fund's website, maintained by Cohen & Steers, typically includes fact sheets, performance data, and distribution schedules. When evaluating a closed-end fund, pay attention to the current discount or premium to net asset value, the leverage level relative to its maximum allowed, the trend in credit spreads (which affect preferred-stock valuations), and the fund's distribution history relative to its underlying asset value — distributions that exceed net investment income signal that the fund is returning capital to shareholders, unsustainable in downturns. As always, past performance is not a guarantee of future results.
