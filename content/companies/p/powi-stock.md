...
description: "Power Integrations designs and sells semiconductor power-management chips used in consumer electronics, industrial equipment, and renewable energy systems worldwide."
keywords:
...
<table>
<tr><th>Ticker</th><td>POWI (NASDAQ)</td></tr>
<tr><th>Founded</th><td>1990, San Jose, California</td></tr>
<tr><th>Sector</th><td>Semiconductor design — power management</td></tr>
<tr><th>Core products</th><td>Power-conversion chips, gate drivers, power ICs</td></tr>
<tr><th>Business model</th><td>Fabless design; licensed to foundries</td></tr>
<tr><th>End markets</th><td>Consumer electronics, industrial, renewable energy</td></tr>
<tr><th>SEC CIK</th><td>0000833640</td></tr>
</table>
</aside>
...
Power Integrations occupies a specific rung in a long supply chain. Below it sits the semiconductor foundry ([Taiwan Semiconductor Manufacturing](/tsm-stock/) Company and others) that physically manufactures the chips to its specifications. Above it sit the original equipment manufacturers (OEMs) — companies like [Apple](/aapl-stock/), Dell, Qualcomm, and others — that design the actual end products (phones, computers, chargers) and purchase chips like Power Integrations' in high volumes. In between are sometimes intermediaries: power-supply makers (like Mean Well or Delta Electronics) who buy the chips and integrate them into finished power supplies, which in turn sell to system designers.
