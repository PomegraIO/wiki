---
title: "Putnam Premier Income Trust (PPT)"
description: "Putnam Premier Income Trust is a closed-end investment fund that sources income for shareholders through a diversified portfolio of bonds, preferred stocks, and other fixed-income securities, managed by Putnam Investments."
keywords:
  - closed-end fund
  - income fund
  - fixed income
...
The Putnam Premier Income Trust is a closed-end investment company, which means it raises a fixed pool of capital from investors and then buys and holds a portfolio of securities rather than continuously issuing and redeeming shares. The fund's stated purpose is to generate regular income for shareholders through investment in [bonds](/bond/), [preferred stocks](/preferred-stock/), and other fixed-income securities. Like other [closed-end funds](/closed-end-fund/), PPT trades on a [stock exchange](/stock-exchange/) (NYSE: PPT) where its share price can move independently of the underlying value of its assets — it may trade at a premium or discount to [net asset value](/net-asset-value/) depending on investor demand.

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>PPT (NYSE)</td></tr>
<tr><th>Type</th><td>Closed-end investment fund</td></tr>
<tr><th>Manager</th><td>Putnam Investments</td></tr>
<tr><th>Inception</th><td>1988</td></tr>
<tr><th>Objective</th><td>High current income</td></tr>
<tr><th>Asset class</th><td>Bonds, preferred stocks, fixed-income securities</td></tr>
<tr><th>SEC CIK</th><td>0000827773</td></tr>
</table>
</aside>
...
This dynamic also makes PPT's distribution yield somewhat misleading. A high [dividend yield](/dividend-yield/) based on share price sounds attractive, but if the fund is trading at a discount to net asset value and that discount widens, shareholders' actual total return can disappoint even if the distributions arrive on schedule.

## Risks and competitive pressures

Fixed-income markets carry duration risk — the longer the average maturity of the bonds in the portfolio, the more the share price falls when [interest rates](/interest-rate/) rise. PPT's portfolio likely spans different maturities and credit qualities, which spreads risk but also means the manager must constantly decide how much duration exposure makes sense. If rates spike unexpectedly, the value of held bonds falls.

[Credit risk](/credit-risk/) is another pressure. If the fund invests in corporate bonds or high-yield securities, a [recession](/recession/) or individual company failure can hurt performance. The preferred-stock portion of the portfolio carries its own risks: preferred shares behave partly like bonds and partly like stocks, and if interest rates rise or a company's financial health deteriorates, their prices can fall sharply.
...
Anyone interested in PPT should start with the fund's fact sheet and prospectus, available on Putnam's website, which describe the current portfolio composition, fees, and recent performance. The fund's [annual report](/10-k/) breaks down holdings and discusses the manager's outlook. Because PPT trades like a stock, you can watch its share price in real time and compare it to the fund's reported net asset value — many closed-end fund websites track the premium or discount each day.

A key metric to monitor is the distribution rate: whether the fund is paying out sustainable income from investment returns or encroaching on capital. As with any fixed-income security, watch the [Federal Reserve](/federal-reserve/)'s interest-rate environment closely; rising rates tend to pressure bond-heavy portfolios and the value of preferred shares.
