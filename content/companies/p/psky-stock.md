---
title: "Paramount Global & Skydance Media (PSKY)"
description: "Paramount is a global entertainment conglomerate producing movies, television, and streaming content — a legacy studio competing in an era where distribution and content are fracturing."
keywords:
  - entertainment
  - streaming services
...
The stock ([NASDAQ](/nasdaq/): PSKY) reflects the company's transformation from a traditional broadcaster with stable, recurring cable-advertising and retransmission-fee revenue into a streaming-first business chasing subscribers and fighting for scale in a field crowded with [Netflix](/nflx-stock/), Disney, Amazon Prime, and [Apple](/aapl-stock/).

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>PSKY (NASDAQ)</td></tr>
<tr><th>Founded</th><td>CBS: 1927; Paramount Pictures: 1912; Merged as ViacomCBS in 2019; Skydance merger completed 2024</td></tr>
<tr><th>Headquarters</th><td>New York, New York</td></tr>
<tr><th>Sector</th><td>Media and entertainment</td></tr>
<tr><th>Main business</th><td>Content production, streaming, traditional broadcast and cable</td></tr>
<tr><th>Key properties</th><td>Paramount Plus, MTV, Nickelodeon, BET, Comedy Central, Showtime, Paramount Pictures</td></tr>
<tr><th>SEC CIK</th><td>0002041610</td></tr>
</table>
</aside>
...
Key metrics to monitor: Paramount Plus subscriber count and net additions, average revenue per user, streaming segment operating income or loss (trending toward positive or worsening), total debt, and [free cash flow](/free-cash-flow/). The company's content-production spending levels and plans also matter — pulling back on production can improve short-term cash but risks subscriber churn and competitiveness.
