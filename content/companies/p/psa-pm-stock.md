---
title: "Public Storage (PSA-PM)"
description: "Public Storage operates self-storage facilities across North America, built on founder B. Wayne Hughes's philosophy of centralized operations and meticulous cost discipline — a REIT that trades consistency and market-share density for growth velocity."
keywords:
...
[Interest-rate risk](/interest-rate-risk/) is structural. The company borrows to buy properties, and when rates rise, refinancing gets expensive and the return on new acquisitions falls. A prolonged high-rate environment could slow acquisition activity and dampen growth.
...
Follow the same-store rent growth metric (rents at facilities owned more than a year, adjusted for acquisitions and dispositions) and the occupancy rate, tracked monthly. As a REIT, Public Storage is analysed using [funds from operations](/funds-from-operations/) (FFO) rather than traditional earnings, which adjusts for [depreciation](/depreciation/) and is more relevant to cash. The stock trades on the NYSE at prices set by the market for both self-storage fundamentals and broader REIT valuations.
