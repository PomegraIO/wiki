---
title: "Public Storage (PSA-PQ)"
description: "A self-storage REIT that thrives on demographic disruption — the company rents climate-controlled units to individuals and businesses, with demand that moves countercyclically to economic cycles."
keywords:
  - self-storage
  - reit
  - real estate
...
| Metric | Fact |
|---|---|
| **Business** | Own and operate self-storage facilities |
| **Revenue model** | Monthly rent per unit, ancillary products (locks, boxes, insurance) |
| **Portfolio size** | ~2,900 facilities, ~230 million sq. ft. of rentable space |
| **Geographic focus** | High-density urban and suburban markets (CA, TX, FL, NY) |
| **Occupancy range** | Typically 80–95 per cent |
| **Gross margins** | 40–60 per cent of revenues |
| **Capital structure** | REIT (required to distribute 90 per cent of taxable income) |
| **Competitive position** | 1 in 5 self-storage units in America; 2–3× larger than nearest competitor |
