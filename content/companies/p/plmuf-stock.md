---
title: "Plum Acquisition Corp. III (PLMUF)"
description: "PLMUF is the common-share ticker for Plum Acquisition Corp. III, a SPAC formed to identify and merge with an operating company using raised capital held in trust."
keywords:
  - SPAC
...
<table>
<tr><th>Ticker</th><td>PLMUF (common shares), PLMWF (warrants)</td></tr>
<tr><th>Entity type</th><td>Special Purpose Acquisition Company (SPAC)</td></tr>
<tr><th>Purpose</th><td>Identify and merge with an operating company</td></tr>
<tr><th>Capital raised</th><td>Held in trust pending business combination</td></tr>
<tr><th>Investor redemption right</th><td>Yes, if merger terms are unfavorable</td></tr>
<tr><th>Founders' incentive</th><td>Keep shares only upon successful merger close</td></tr>
<tr><th>Deadline window</th><td>Typically 2–3 years to announce and close a deal</td></tr>
<tr><th>SEC CIK</th><td>0001845550</td></tr>
</table>
</aside>

Plum [Acquisition](/acquisition/) Corp. III is a SPAC, a special category of public company formed with the sole purpose of raising capital and using it to acquire an operating business. The common shares trade under the ticker PLMUF. The structure is straightforward but laden with incentive misalignments: sponsors create a shell company, take it public, pocket cash into a trust account, and have a fixed window to find and merge with a private operating company. If the [merger](/merger/) succeeds, shareholders of the merged entity trade the resulting stock under the SPAC's ticker. If the sponsors fail to close a deal before the deadline, the capital is returned to shareholders.

The appeal of this structure to a private company is obvious: a SPAC merger offers a faster, more certain path to a public listing than a traditional [initial public offering](/initial-public-offering/), which requires underwriter roadshows, regulator approval, and [market timing](/market-timing/). A company can merge with a SPAC, become public overnight, and begin trading with less friction. The appeal to SPAC investors and sponsors is less obvious but powerful: sponsors own shares that are worthless unless the merger closes, so they are motivated to do a deal. Public investors get a chance to own shares of a soon-to-be-public company at the IPO price, rather than waiting for public trading.
...
Plum Acquisition Corp. III has raised capital and has not yet announced a [definitive merger agreement](/definitive-merger-agreement/). The common shares PLMUF trade at a price reflecting the value of the trust (roughly the capital raised per share, minus fees and sponsor [share dilution](/share-dilution/)) plus whatever premium the market assigns for the sponsors' reputation or deal-sourcing ability. The warrants PLMWF are [call options](/call-option/) on the merged entity's shares; their value depends on the merger closing and the merged company's stock price exceeding the warrant strike.
