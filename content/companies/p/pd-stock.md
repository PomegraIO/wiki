---
title: "PagerDuty, Inc. (PD)"
description: "Incident response platform helping enterprises quickly resolve operational emergencies; SaaS-based alert aggregation, on-call scheduling, and runbook automation."
keywords:
  - incident response
  - alerting platform
  - on-call management
...
| **Ticker** | PD |
| **SEC CIK** | 1568100 |
| **Business** | Incident response and on-call management platform |
...
PagerDuty operates in a field crowded with both point solutions and large incumbents. VictorOps (acquired by Splunk), BigPanda, Opsgenie (owned by Atlassian), and smaller entrants like ilert and Rootly all compete for the same customer base. Splunk and [ServiceNow](/now-stock/), with vastly larger sales forces and pre-existing enterprise relationships, have added incident management capabilities and could theoretically squeeze PagerDuty from above. Still, PagerDuty's narrower focus on the incident response loop, its platform-agnostic integration strategy, and its strong community of power users have allowed it to remain independent and maintain meaningful market share.
...
Start with the most recent [10-K](/wiki/10-k/)—it will clearly state ARR, net dollar retention, and customer count trends. Watch quarterly earnings calls for color on customer acquisition cost (CAC), payback period, and management's read on spending environment and competitive wins. The company reports remaining [performance obligation](/performance-obligation/) (RPO), which signals forward revenue visibility. Look for gross margin trends (a sign of improving unit economics or pricing power) and operating leverage (whether the company is moving toward profitability or still spending heavily on growth). 
