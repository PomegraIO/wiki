---
title: "PG&E Corp (PCG-PB)"
description: "PG&E preferred shares (PCG-PB) pay a fixed dividend but carry the risk of the California utility's wildfire liability and regulatory complexity — a higher-yield alternative to common stock for conservative income investors who understand the risks."
keywords:
  - preferred stock
  - utility dividend
  - fixed income
...
If you are looking for income, you have options: Treasury bills, investment-grade [corporate bonds](/corporate-bond/), preferred shares of stable utilities like Verizon or [Duke Energy](/duk-stock/), or riskier assets like [junk bonds](/junk-bond/) or high-dividend stocks. PCG-PB sits in the middle. It offers more yield than a Treasury bill and more than preferred shares of a low-risk utility. It carries more risk than a Treasury because PG&E is a company with business risk, and more risk than preferred of a safer utility because of California's wildfire environment. But it pays more often and with a higher rate than most bonds.

The choice depends on how much extra yield you need to accept the extra risk. If you are comfortable with the idea that California wildfires are being managed more responsibly than they were, and that PG&E will keep the dividend safe, then PCG-PB might be attractive at [current yields](/current-yield/). If you worry that the next fire season could spark another major loss and threaten the dividend, the extra yield might not be enough to compensate you.
...
Watch California news during fire season. And pay attention to whether PG&E is making progress on grid hardening — power lines being undergrounded, vegetation management improving, new safety equipment installed. The more concrete progress you see, the lower the risk that another major fire will crater the preferred. Finally, monitor interest rates. If [Federal Reserve](/federal-reserve/) policy turns toward rate cuts, PCG-PB's price should improve even if the company's fundamentals do not change.
