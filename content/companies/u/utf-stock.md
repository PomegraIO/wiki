---
title: "Cohen & Steers Infrastructure Fund Inc (UTF)"
description: "A closed-end investment fund focused on global infrastructure assets—toll roads, airports, ports, and utilities—offering dividend income from essential, capital-intensive businesses."
keywords:
...
[Cohen & Steers](/cns-stock/) [Infrastructure Fund](/pe-infrastructure-fund/) is a closed-end investment fund that pools capital from many investors to purchase a diversified portfolio of infrastructure assets and companies. The fund trades on the [New York Stock Exchange](/new-york-stock-exchange/) under the ticker UTF and distributes income to shareholders as a steady monthly dividend. Unlike a traditional open-ended [mutual fund](/mutual-fund/), Cohen & Steers is a fixed vehicle—investors buy and sell existing shares from each other rather than redemptions being created and destroyed. The portfolio holds toll road operators, airport owners, utilities, pipeline companies, energy distribution networks, and water systems, mostly in developed economies. This tilt toward the essential, durable parts of the economy—the assets that every business and household relies on but few people think much about—anchors the fund's appeal.

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>UTF (NYSE)</td></tr>
<tr><th>Founded</th><td>2002</td></tr>
<tr><th>Fund type</th><td>Closed-end fund</td></tr>
<tr><th>Primary focus</th><td>Global infrastructure assets</td></tr>
<tr><th>Distribution</th><td>Monthly dividend</td></tr>
<tr><th>Geography</th><td>Primarily developed markets</td></tr>
<tr><th>SEC CIK</th><td>0001275617</td></tr>
</table>
</aside>
