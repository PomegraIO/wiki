---
title: "Universal Token (UTKN)"
description: "Universal Token is a blockchain-based payment and decentralized finance protocol seeking to enable peer-to-peer transactions and smart contracts on a permissionless, cryptocurrency-native ledger."
keywords:
  - blockchain
  - cryptocurrency
...
This is where the ambiguity deepens. Universal Token is not a company in the traditional sense — it is a protocol and a token. There is likely a founding team, a corporate entity that incubated the protocol, and early token holders who control significant sums. The founding entity may have retained a percentage of the total token supply (a "treasury") that it can spend on marketing, development, and employee salaries. But the protocol itself has no revenue, no profit, no [balance sheet](/balance-sheet/).
