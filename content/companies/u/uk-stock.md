---
title: "Ucommune International Ltd (UK)"
description: "Flexible workspace operator across Asia-Pacific providing office solutions to freelancers, startups, and enterprises through shared facilities and managed workspaces."
keywords:
  - flexible workspace
  - coworking
...
| Revenue Source | Characteristics | Key Driver |
|---|---|---|
| Membership subscriptions | Recurring monthly/annual fees for hot-desking and dedicated seating | Member acquisition and retention |
| Private office rentals | Higher-margin space for teams seeking closed offices | Enterprise migration to flexible arrangements |
| Meeting rooms & events | Hourly or daily bookings for conference and event space | External demand and member utilization |
| Corporate services | Staffing solutions, consulting, administrative support | Enterprise customer spending; member purchasing |
| Property management | Leasing or subleasing portions of buildings | Real estate arbitrage; operating leverage |
