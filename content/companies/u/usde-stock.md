---
title: "StableCoinX Inc. (USDE)"
description: "StableCoinX is a crypto asset platform that issues and manages stablecoin tokens pegged to the US dollar, using a combination of collateral and smart contracts to maintain the peg while generating revenue through staking rewards and lending transactions."
keywords:
  - stablecoin
  - cryptocurrency
  - blockchain
...
Stablecoins depend crucially on maintaining confidence in the peg. If users lose faith that USDE will trade at one dollar, they rush to redeem it, draining collateral and breaking the peg. This is why collateral quality and transparency are essential. StableCoinX's use of Treasury bonds as backing is safer than pure crypto collateral, which can experience rapid price swings. However, Treasury bonds carry [interest-rate risk](/interest-rate-risk/) — if rates rise sharply, their market value declines. The protocol must manage this risk.
