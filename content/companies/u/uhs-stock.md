...
description: "One of the largest US hospital operators, running acute-care hospitals and a major behavioral-health facility network; faces ongoing reimbursement and regulatory scrutiny."
keywords:
  - hospital operator
  - behavioral health
  - acute care
...
The regulatory landscape is also fluid. Healthcare antitrust enforcement has become more stringent, and state-level initiatives (price controls, scope-of-practice expansions, surprise-billing rules) create compliance complexity. Changes in [Medicare](/wiki/medicare-personal/) reimbursement rates or Medicaid funding (which is state-determined) can shift profitability materially.
