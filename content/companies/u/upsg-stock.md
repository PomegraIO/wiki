---
title: "Leverage Shares 2X Long UPS Daily ETF (UPSG)"
description: "A daily-reset leveraged ETF that tracks United Parcel Service stock using a 2:1 long strategy. Amplifies UPS exposure with higher volatility decay risk; for tactical traders and sector bets, not buy-and-hold."
keywords:
  - leveraged ETF
  - daily reset
  - UPS exposure
...
UPSG is a single-stock leveraged product that wraps one ticker — United Parcel Service (UPS), the logistics and package-delivery giant — and amplifies its daily movements by a factor of two. So if UPS stock rises 1% on a given day, UPSG targets a 2% gain; if UPS falls 1%, UPSG aims to fall 2%. The mechanism is straightforward: the fund borrows money at a set rate and uses that leverage to buy more UPS shares than it could with capital alone, then rebalances daily to maintain the 2:1 ratio.

That daily rebalancing is critical. It is also the hidden cost. Because UPSG resets its leverage position each day, it is designed to track UPS's daily moves, not its cumulative long-term price path. Over months or years, this distinction matters enormously. Consider a scenario where UPS rises sharply one day and falls sharply the next, ending net-flat. A leveraged fund that reset each day would have paid the multiple in both directions — capturing 2X gains on the up move and 2X losses on the down move — and would end down overall despite the stock being flat. This decay is not a bug; it is the intended behavior of a daily-reset structure, and it becomes more severe in choppy or range-bound markets.

## Who UPSG is for and the volatility-decay trap
...
A holder of UPSG should start with the fund's prospectus, which lays out the daily-reset mechanism, the fee structure, and all the risks in explicit terms. The fact sheet breaks down the current holdings (essentially, cash and a leveraged position in UPS) and the tracking error — the gap between the fund's cumulative return and 2X the return of UPS stock.

Understanding UPSG also requires a clear-eyed view of UPS's fundamentals. The logistics industry is cyclical, sensitive to package volumes, fuel costs, and labor agreements. Anyone trading UPSG should monitor UPS's quarterly earnings, the company's capital spending, and the broader shipping and e-commerce environment. The fund is not a vehicle for passive wealth-building; it is a tool for tactical traders who have a near-term thesis on UPS and can tolerate the friction of daily rebalancing and the certainty of volatility decay in sideways markets.
