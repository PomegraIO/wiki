---
title: "ProShares Trust II (UCO)"
description: "UCO is an oil ETF that bets the price of crude will rise, holding futures contracts and rebalancing daily — a simple financial product from ProShares that lets regular people bet on energy markets without buying oil directly."
keywords:
  - commodity ETF
  - oil futures
  - crude oil
...
UCO stands for "Ultra Long [Crude Oil](/crude-oil/)." If you think the price of oil is going up, UCO is designed to profit when that happens. It trades like a stock on the [NASDAQ](/nasdaq/) under that ticker, but it is not a company. It is a financial product — a bucket of money pooled together — that ProShares, the same firm that issues volatility bets and other derivatives-based funds, manages. The bucket holds crude oil [futures contracts](/futures-contract/). When oil gets more expensive, UCO goes up. When oil gets cheaper, UCO goes down.

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>UCO (NASDAQ)</td></tr>
<tr><th>Issuer</th><td>ProShares Trust II</td></tr>
<tr><th>Fund manager</th><td>ProShares</td></tr>
<tr><th>What it tracks</th><td>Long crude oil futures</td></tr>
<tr><th>Underlying asset</th><td>West Texas Intermediate (WTI) crude futures</td></tr>
<tr><th>Rebalanced</th><td>Daily</td></tr>
...
The fund does not take a profit from the oil itself. ProShares skims the revenue by charging you a fee — the [expense ratio](/expense-ratio/), which runs roughly 0.5% to 0.7% a year, or about 5 to 7 dollars on every 1,000 dollars you invest. That fee flows to ProShares' coffers automatically every year, whether you make money or lose it. The rest of the gains or losses go to shareholders.

## What makes this different from owning oil stock

If you owned an oil company like Exxon or [Chevron](/cvx-stock/), you own a business. That business pays geologists, drill workers, ship captains, and accountants. It builds pipelines and refineries. It takes risks exploring for new reserves. It can go bankrupt or become extremely profitable depending on management, technology, and the luck of geology.

UCO owns none of that. It is a pure commodity bet. You are betting that the physical price of a barrel of crude will go up or down. You are not betting that an oil company will manage its business well. You are not getting [dividends](/dividend/) or earnings reports. You are not voting in shareholder meetings. You are betting, full stop.

## The money that funds it and the risks inside

UCO is capitalized entirely by the people who buy shares. When you buy in, you are adding to the pool. When someone sells, they are taking money out. ProShares is just the [custodian](/custodian/). The firm does not guarantee returns or put any of its own money at risk. If oil crashes and UCO falls 50%, the fund shrinks by 50%, and ProShares still collects its tiny fee on what is left.
...
The biggest risk is simple: if you think oil is going up and it goes down instead, you lose money, sometimes fast. Oil prices have jumped and crashed several times over the past two decades. If a geopolitical shock spikes the price, UCO surges. If a [recession](/recession/) kills demand and the price collapses, UCO crashes. You have no buffer — you are riding the raw commodity price, just more conveniently than you would with a futures account.
