---
title: "iShares Broad USD Investment Grade Corporate Bond ETF (USIG)"
description: "USIG is a low-cost ETF holding hundreds of investment-grade corporate bonds issued by large U.S. companies. It offers diversified corporate bond exposure with minimal fees, ideal for conservative investors seeking steady income."
keywords:
  - corporate bonds
  - investment grade
  - bond ETF
...
USIG is one of the most straightforward [bond](/bond/) funds you can buy. It holds a large basket of investment-grade [corporate bonds](/corporate-bond/) — debt issued by major U.S. companies like banks, manufacturers, utilities, and tech firms — and passes through the income they generate to shareholders. You buy a share, you own a tiny slice of hundreds of corporate bonds, and you collect [coupon payments](/coupon-payment/). No stock picking, no active management, no complexity.

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>USIG (NYSE Arca)</td></tr>
<tr><th>Sponsor</th><td>BlackRock iShares</td></tr>
<tr><th>Index tracked</th><td>Broad investment-grade corporate bond index</td></tr>
<tr><th>Holdings</th><td>Hundreds of corporate bonds, BBB– or better</td></tr>
<tr><th>Structure</th><td>Passive index ETF</td></tr>
<tr><th>Investor profile</th><td>Conservative, income-focused</td></tr>
</table>
</aside>

## What you own when you buy USIG

When you own a share of USIG, you own a claim on a diversified slice of corporate America's debt. The fund holds bonds from banks (JPMorgan, [Bank of America](/bank-of-america/)), manufacturers (Ford, 3M), energy companies, healthcare firms, and dozens of other industries. Each bond is a contract: a company promises to pay you interest (the coupon) on a fixed schedule and return the principal when the bond matures.

All of the bonds in USIG are "investment grade," which is a specific [credit rating](/credit-rating/). The major rating agencies — Moody's, Standard & Poor's, and Fitch — assign grades to debt. Investment grade means BBB– or higher on the Standard & Poor's scale. Anything below that is "high yield" or "junk," and USIG avoids it. This means the companies backing these bonds are large, stable, and unlikely to default in normal economic times. It also means the coupon payments are lower than you would get from [high-yield bonds](/high-yield-bond/), but the risk is commensurately lower too.
...
USIG holds hundreds of corporate bonds. This [diversification](/diversification/) is crucial. If the fund held only [General Motors](/gm-stock/) bonds, it would tank if GM ran into trouble. But with hundreds of bonds across dozens of industries, a problem in one company or sector does not sink the whole fund. A few defaults, which happen occasionally even in [investment-grade bonds](/investment-grade-bond/), barely move the needle when spread across such a large portfolio.
...
USIG's [expense ratio](/expense-ratio/) is low — well below the average for actively managed bond funds. You are paying [BlackRock](/blk-stock/) for the infrastructure and the daily rebalancing, but you are not paying for a manager's salary or stock-picking research. This low cost compounds over decades. A 0.5% annual fee instead of 1% might not sound dramatic, but over 30 years it matters significantly to cumulative returns.

The fund trades like a stock during market hours. You can buy or sell shares without waiting for a fund company to process a redemption, and the [bid-ask spread](/bid-ask-spread/) is typically tight. This liquidity is a real convenience compared to a traditional [mutual fund](/mutual-fund/).

## What can go wrong

Corporate bonds carry [credit risk](/credit-risk/). Even investment-grade companies can fail. A [recession](/recession/) can trigger defaults or downgrades. If USIG's holdings deteriorate significantly, the fund's value falls. This is not speculation; it is real economic risk. During the 2008 financial crisis, investment-grade corporate bonds suffered sharp losses as fear spread and credit conditions tightened.

[Interest-rate risk](/interest-rate-risk/) is the other main hazard. If the [Federal Reserve](/federal-reserve/) raises rates aggressively, USIG's price will fall, and if you must sell into that environment, you realize a loss. This risk is lower than with longer-duration [Treasury bonds](/treasury-bond/), but it is still material.

There is also [reinvestment risk](/reinvestment-risk/). When a bond in USIG matures, the fund receives the principal and reinvests it in a new bond — perhaps at a lower coupon if rates have fallen. If you own USIG for decades, the compounding of this reinvestment luck (or bad luck) shapes total returns.
...
To understand USIG, start with the fund's fact sheet, available on BlackRock's website. It shows the [current yield](/current-yield/) (the income you can expect to collect), duration, and the breakdown of holdings by industry and maturity. Compare USIG's expense ratio to other broad corporate bond funds to confirm you are getting a fair price.
