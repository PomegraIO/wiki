---
title: "Themes US R&D Champions ETF (USRD)"
description: "USRD is a thematically driven ETF that holds US companies selected for high research and development intensity and spending, targeting growth leaders in innovation-driven sectors."
keywords:
...
<table>
<tr><th>Fund sponsor</th><td>Themes ETFs / WisdomTree</td></tr>
<tr><th>Strategy</th><td>Active selection of high R&D companies</td></tr>
<tr><th>Holdings</th><td>US-listed companies, primarily large and mid-cap</td></tr>
<tr><th>Turnover</th><td>Moderate; rebalances periodically</td></tr>
<tr><th>Diversification</th><td>Broad by sector, concentrated in tech and healthcare</td></tr>
<tr><th>What it targets</th><td>Companies with sustained R&D as a strategic priority</td></tr>
</table>
</aside>
...
There is also a [recency bias](/recency-bias/) inherent in the approach. Companies can cut R&D dramatically in hard times, and R&D spending tends to be procyclical — high in booms, reduced in [recessions](/recession/). A stock's R&D intensity as of today may not reflect its R&D intensity next year. This means the portfolio composition can shift significantly when the economic cycle turns or when individual companies face margin pressure.
