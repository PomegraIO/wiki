---
title: "United States Commodity Index Funds Trust (USCI)"
description: "A commodity index fund that tracks the Dow Jones-UBS Commodity Index, rebalancing monthly to maintain fixed weights across energy, metals, and agricultural futures."
keywords:
  - commodity index
  - monthly rebalancing
  - Dow Jones index
  - systematic commodity exposure
  - diversified futures basket
  - index strategy
handwritten: true
---

United States [Commodity Index Funds](/commodity-index-fund/) Trust was created in 2007 as a vehicle for tracking the Dow Jones-UBS Commodity Index, a rules-based commodity portfolio. The fund holds [futures contracts](/futures-contract/) and rebalances monthly according to a published formula, giving investors a systematic, passive way to own a basket of commodities. Its history mirrors the broad evolution of commodity investing — from obscure and inaccessible, to mainstream, to increasingly questioned.

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>USCI (NYSEARCA)</td></tr>
<tr><th>Founded</th><td>2007</th>
<tr><th>Sponsor</th><td>United States Commodity Funds, LLC</td></tr>
<tr><th>Sector</th><td>Commodity index fund</td></tr>
<tr><th>Index tracked</th><td>Dow Jones-UBS Commodity Index</td></tr>
<tr><th>Strategy</th><td>Futures-based commodity exposure; monthly rebalancing</td></tr>
<tr><th>SEC CIK</th><td>0001479247</td></tr>
</table>
</aside>
...
The index it tracks — the Dow Jones-UBS Commodity Index — is a weighted basket of 19 futures contracts: [crude oil](/crude-oil/), [Brent crude](/brent-crude/), [heating oil](/heating-oil/), [natural gas](/natural-gas/), corn, wheat, soybeans, [soybean oil](/soybean-oil/), sugar, cocoa, coffee, copper, aluminum, zinc, nickel, gold, silver, and cattle. The index resets weights at the beginning of each month to ensure energy does not dominate through price appreciation, a practice known as excess-return weighting.

## The philosophy: systematic rebalancing

The core innovation of USCI relative to passive buy-and-hold commodity strategies is its monthly [rebalancing discipline](/rebalancing-discipline/). As commodities with high returns rise and become a larger portion of the fund, the fund sells winners and buys losers — systematically moving money from strong performers to weak ones. This approach has a long history in other asset classes, where it is known as rebalancing-induced [diversification](/diversification/).

In theory, rebalancing at fixed intervals forces investors to take profits from winners and reinvest in laggards, a form of [systematic risk](/systematic-risk/) reduction and contrarian positioning. In practice, it is a double-edged sword. Rebalancing works well in range-bound markets where prices oscillate around a mean. It works poorly in persistent trends where one commodity outperforms for years — the strategy buys strength early in a rally and sells weakness late in a collapse.

Moreover, the rebalancing occurs on a published schedule that is known to market participants. Sophisticated traders and [hedge funds](/hedge-fund/) front-run the rebalance dates, pushing prices higher just before USCI rebalances into them, then unwinding afterward. This "rebalancing slippage" is a hidden tax on the fund.

## The reality: persistent underperformance

Over the years since 2007, USCI's actual returns have lagged the index it is supposed to track by a significant and widening margin. The reasons are now well understood: roll drag (the cost of continuously selling near-term futures and buying distant ones when in [contango](/contango/)), rebalancing slippage, and the fund's [expense ratio](/expense-ratio/).

During the 2010s, the Dow Jones-UBS Commodity Index fell substantially as [central banks](/central-bank/) kept [interest rates](/interest-rate/) low and nominal growth was tepid — an environment where commodities are a poor investment. USCI, tracking that index faithfully, fell with it. Investors who bought commodity funds in 2007 were still underwater a decade later.

The 2020s brought new patterns. The COVID-19 pandemic's shock in early 2020 spiked commodity prices as supply chains broke and central banks printed money. USCI rose sharply. But then the sharp tightening of [monetary policy](/monetary-policy/) in 2022–2023 reversed much of that gain, and commodities languished again. The volatility has been extreme, and the underlying trend has been sideways to lower, exactly the environment where commodity exposure delivers the worst returns.
...
A second risk is that USCI is a commodity fund at a time when commodity funds are questioned. Some research suggests that the poor long-term performance of passive commodity [index funds](/index-fund/) is due to structural design — specifically, that the practice of holding futures contracts instead of physical commodities, and the need to roll them monthly, is inherently costly. If true, then USCI's structure is the problem, and switching to a different commodity fund would not solve it.

The third risk is currency concentration. USCI is denominated in [US dollars](/us-dollar/), so its returns depend on both commodity prices and the dollar's strength. A strong dollar headwind could suppress commodity returns even if commodity fundamentals are stable.

Finally, USCI's liquidity, while reasonable, is not infinite. In a severe commodity-market dislocation, the fund could widen its [bid-ask spread](/bid-ask-spread/) or face difficulty in executing its monthly rebalances.
