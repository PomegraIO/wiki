---
title: "UWM Holdings Corp. (UWMC)"
description: "UWM Holdings is the parent company of United Wholesale Mortgage, the largest independent mortgage lender in the United States — built from a wholesale platform into a retail mortgage powerhouse over three decades."
keywords:
  - mortgage lending
  - wholesale mortgages
...
UWM's earnings are driven by mortgage origination volume, which depends on two broad forces: housing market health and prevailing mortgage [interest rates](/interest-rate/). When rates fall, refinancing surges — existing homeowners rush to replace high-rate mortgages with lower ones, flooding the origination market. When rates rise, refinancing dries up, leaving only purchase-mortgage originations (new homes bought, not existing homes refinanced). The company thus experiences feast-or-famine cycles as interest-rate environments shift.
