---
title: "ProShares Ultra Nasdaq Cybersecurity (UCYB)"
description: "UCYB is a leveraged ETF that tracks the Nasdaq Cybersecurity Index, amplifying daily movements by 2x to capture concentrated bets on cybersecurity companies — with the trade-off of daily reset and volatility decay."
keywords:
  - cybersecurity ETF
  - leveraged ETF
...
The **ProShares Ultra [Nasdaq](/nasdaq/) Cybersecurity ETF** — ticker UCYB — is a leveraged exchange-traded fund designed to deliver twice the daily return of the Nasdaq Cybersecurity Index. It exists for investors who believe the cybersecurity sector is set to outperform and want amplified exposure to that thesis, accepting the structural costs and risks that leverage carries.

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>UCYB (NASDAQ)</td></tr>
<tr><th>Fund sponsor</th><td>ProShares</td></tr>
<tr><th>Underlying index</th><td>Nasdaq Cybersecurity Index</td></tr>
<tr><th>Strategy</th><td>2x daily leveraged</td></tr>
<tr><th>Fund type</th><td>Leveraged ETF</td></tr>
<tr><th>Tracking mechanism</th><td>Derivatives (daily reset)</td></tr>
<tr><th>Expense ratio</th><td>Qualitatively moderate for leverage class</td></tr>
</table>
</aside>

## What UCYB tracks and holds

UCYB follows the Nasdaq Cybersecurity Index, a market-cap-weighted basket of publicly traded companies classified as active participants in cybersecurity. The index includes large-cap pure-play cybersecurity vendors like [Fortinet](/ftnt-stock/), [Crowdstrike](/crwd-stock/), and [Palo Alto Networks](/panw-stock/), as well as broader tech firms with significant security operations. Because it is index-based, UCYB itself holds no securities directly; instead it uses derivatives to achieve its 2x leverage objective.
...
This daily reset is the heart of the leverage story. When an index drifts sideways or rallies sharply then falls, compounding works against a leveraged fund. A simple example: if the index gains 10 per cent then loses 10 per cent over two days (net flat), the leveraged fund will have lost money, because it captured +20 per cent on day one and -20 per cent on day two, a sequence that compounds to -4 per cent. This is volatility decay, and it is a feature of all [leveraged ETFs](/leveraged-etf/) — not a design flaw, but a mathematical inevitability that investors must understand and price in.

Over longer [holding periods](/holding-period/) — weeks or months — decay accelerates in choppy or sideways markets. UCYB is therefore a tactical position, not a core holding meant for the long term.

## Costs and how it trades

The [expense ratio](/expense-ratio/) for UCYB is moderate by leveraged-ETF standards, typically in the 0.95 to 1.1 per cent annual range, reflecting the cost of maintaining the leverage machinery. On top of the stated expense ratio sits an implicit cost from the daily reset itself: the fund must buy and sell to rebalance, which incurs [bid-ask spreads](/bid-ask-spread/) and market impact. Over volatile periods this implicit cost can exceed the stated ratio.
