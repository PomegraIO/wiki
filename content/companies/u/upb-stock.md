---
title: "Upstream Bio, Inc. (UPB)"
description: "Upstream Bio is a clinical-stage biotech company developing a single drug candidate for severe inflammatory airway diseases, betting its future on success in diseases where no good treatments currently exist."
keywords:
  - biotechnology
  - clinical trials
  - respiratory disease
...
<table>
<tr><th>Ticker</th><td>UPB (NASDAQ)</td></tr>
<tr><th>Founded</th><td>2021, Waltham, Massachusetts</td></tr>
<tr><th>Headquarters</th><td>Waltham, Massachusetts</td></tr>
<tr><th>Sector</th><td>Biotechnology</td></tr>
<tr><th>Stage</th><td>Clinical (Phase 2)</td></tr>
<tr><th>Lead program</th><td>Verekitug (TSLP antagonist)</td></tr>
<tr><th>SEC CIK</th><td>0002022626</td></tr>
</table>
</aside>
...
Read the quarterly SEC filings (10-Q) and [annual report](/10-k/) (10-K, CIK 0002022626) to understand cash burn and runway. If the company is raising [cash multiple](/cash-multiple/) times per year, it is burning money faster than expected. Watch for announcements of Phase 2 trial results—they will move the stock significantly. When results come, read the press release carefully for the actual efficacy numbers, not just the headline.
...
Upstream is worth following only if you have a high tolerance for uncertainty and can read clinical trial data. It is not a stock for someone looking for [dividends](/dividend/) or stability. It is a speculation on whether one company's science is good enough to change how doctors treat airway disease.
