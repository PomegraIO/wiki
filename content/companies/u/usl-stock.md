---
title: "United States 12 Month Oil Fund, LP (USL)"
description: "A commodity tracking fund that holds oil futures contracts designed to maintain stable exposure to the 12-month forward price of crude oil."
keywords:
  - oil futures
  - commodity fund
  - rolling contracts
...
United States 12 Month Oil Fund, LP is a passive investment vehicle that tracks the price of [crude oil](/crude-oil/) by holding a rolling basket of [futures contracts](/futures-contract/). It is designed to give investors exposure to oil-price movements without the complexity of managing futures directly, but the mechanism itself carries unusual risks that most shareholders may not fully recognize.

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>USL (NYSEARCA)</td></tr>
<tr><th>Founded</th><td>2007</td></tr>
<tr><th>Sponsor</th><td>United States Commodity Funds, LLC</td></tr>
<tr><th>Sector</th><td>Commodity tracking fund / energy</td></tr>
<tr><th>Strategy</th><td>Holds 12-month crude oil futures; rebalances monthly</td></tr>
<tr><th>Tracking target</th><td>12-month oil futures curve</td></tr>
<tr><th>Asset structure</th><td>Exchange-traded note (ETN)-like mechanism</td></tr>
<tr><th>SEC CIK</th><td>0001405528</td></tr>
</table>
</aside>
...
The price of oil depends heavily on the shape of the futures curve. When near-term contracts trade at a discount to future ones, the curve is said to be in [contango](/contango/). When you are constantly selling cheaper, nearby contracts and buying more expensive distant ones, every roll costs money. Over years of contango, these frictions can drag performance below the spot price by a meaningful margin. Conversely, when the curve inverts ([backwardation](/backwardation/)), rolling accesses cheaper future prices, which can enhance performance.
...
Returns on USL track the daily changes in the 12-month oil futures contract, less the drag from rolling, fund expenses, and any [bid-ask spreads](/bid-ask-spread/) when the fund itself is bought and sold. In a volatile oil environment, the fund can deliver sharp daily swings, both up and down. But the longer-term performance depends almost entirely on whether the oil market is in contango or backwardation during the [holding period](/holding-period/).
