---
title: "Maris Tech Ltd. (MTEKW)"
description: "MTEKW is a warrant on Maris Tech Ltd., a blank-check company formed to identify and acquire an operating business through a special-purpose acquisition merger."
keywords:
  - SPAC warrant
  - Maris Tech
  - blank-check company
...
MTEKW is a call warrant issued by [Maris Tech](/mtek-stock/) Ltd., a blank-check company, or special-purpose [acquisition](/acquisition/) vehicle. The warrant grants the holder the right to purchase one share of Maris Tech at a predetermined [strike price](/strike-price/) during a defined exercise window. Until Maris Tech identifies, negotiates, and completes a [merger](/merger/) with an operating business, the warrant is a pure derivative — its value reflecting market sentiment about the sponsor's ability to execute a successful deal.

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>MTEKW (OTC)</td></tr>
<tr><th>Instrument</th><td>Equity call warrant</td></tr>
<tr><th>Issuer</th><td>Maris Tech Ltd. (SPAC)</td></tr>
<tr><th>Underlying asset</th><td>Maris Tech Ltd. common shares</td></tr>
<tr><th>Strike price</th><td>Fixed premium to unit price</td></tr>
<tr><th>Exercise quantity</th><td>One share per warrant</td></tr>
<tr><th>Term</th><td>5–7 years from incorporation</td></tr>
<tr><th>Status</th><td>Pre-merger blank-check company</td></tr>
<tr><th>SEC CIK</th><td>0001872964</td></tr>
</table>
</aside>

## The warrant as a separate security

When Maris Tech conducted its [initial public offering](/initial-public-offering/) as a blank-check company, it sold units to investors at a fixed price. Each unit bundled a share and fractional warrants. Upon unit separation, MTEKW warrants became tradeable instruments independent of the underlying shares. This separation allows the market to value them distinctly — investors with higher risk tolerance hold only warrants, betting on leverage; conservative investors hold only the shares and forgo the leverage.

The warrant is a contract granting its holder the right to purchase, at any time before expiration, one share of Maris Tech at the strike price printed in the warrant agreement. If Maris Tech merges with a company and that company's shares rise above the strike, the warrant holder can exercise, pay the strike, and capture the difference. If the shares fall below the strike, the warrant expires worthless. This is binary: a warrant either has [intrinsic value](/intrinsic-value/) (share price minus strike), or it does not.
...
As Maris Tech approaches its deadline to announce a merger (typically 12 to 24 months from inception), warrant activity can intensify. Investors racing to position ahead of deal news may drive MTEKW higher; skeptics who doubt a deal will close on attractive terms may sell. The warrant's [time value](/time-value/) — the premium above intrinsic value — is highest when uncertainty is greatest.
