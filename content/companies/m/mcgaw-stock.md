---
title: "Yorkville Acquisition Corp. (MCGAW)"
description: "Yorkville Acquisition Corp.'s warrant securities (MCGAW) represent the right to purchase common shares in a SPAC that is merging with Trump Media & Technology Group and Crypto.com."
keywords:
  - warrant
  - SPAC
  - stock option
...
MCGAW represents the publicly-traded warrants issued by [Yorkville Acquisition](/mcga-stock/) Corp. A warrant is a derivative security — a contract that gives the holder the right to buy shares at a predetermined price within a defined time window. In the case of Yorkville's warrants, each MCGAW unit historically represented the right to purchase one share of Yorkville's [common stock](/common-stock/) at a fixed [exercise price](/exercise-price/) (typically $11.50) on or before the warrant [expiration date](/expiration-date/). Upon the [business combination](/business-combination-purchase/) with Trump Media and Crypto.com, those warrants remain outstanding, though the underlying shares are now units of the merged entity rather than Yorkville alone.

## How does the warrant mechanic work?

The holder of a warrant has no [voting rights](/voting-rights/), pays no [dividend](/dividend/), and has no claim on company assets. The warrant is purely a [call option](/call-option/) packaged as a publicly-traded security. If the stock price rises above the exercise price plus the price paid for the warrant, the warrant holder makes money by exercising (converting the warrant into a share at the fixed price and selling the share at market price, or holding the share if they believe the price will rise further). If the stock price falls below the exercise price, the warrant expires worthless — the holder's loss is capped at the initial cost of the warrant itself, but the percentage loss can be severe because warrants are typically cheaper than shares.
