...
description: "The world's largest producer of steel, operating integrated mills across Europe, the Americas, Asia, and Africa with operations in mining, pelletizing, and coal production."
keywords:
  - steel production
  - mining operations
...
Capital allocation matters. The company has historically paid [dividends](/dividend/) and bought back shares when cash is strong, but must balance this against debt reduction and the massive capex required to modernize mills and comply with environmental rules. Execution on major mill upgrades or capacity additions can miss timelines and budgets, affecting margins.
...
ArcelorMittal is a [stock](/wiki/stock/) on the [stock exchange](/wiki/stock-exchange/), and its 10-K is public through the SEC [CIK 1243429](https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&CIK=1243429). Understanding the cyclical nature, geographic mix, and integration advantage is essential to evaluating it as an investment.
