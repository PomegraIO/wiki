...
description: "Morningstar is an independent investment research and data platform founded in 1984, known for its ratings system and software tools used by financial advisors and individual investors to analyze funds, stocks, and financial plans."
keywords:
  - investment research
  - mutual fund ratings
  - financial data
...
Morningstar stands as one of the financial world's most recognisable independent research brands, built on the reputation of its rating system for [mutual funds](/mutual-fund/) and expanded over four decades into a diversified platform for investment data, analytics, and portfolio management tools. The company trades on the [NASDAQ](/nasdaq/) under the ticker MORN and serves a broad customer base ranging from retail investors to institutional money managers and financial advisors.

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>MORN (NASDAQ)</td></tr>
<tr><th>Founded</th><td>1984, Chicago, Illinois</td></tr>
<tr><th>Founder</th><td>Joe Mansueto</td></tr>
<tr><th>Sector</th><td>Financial data and research</td></tr>
<tr><th>Main business</th><td>Investment research, ratings, software</td></tr>
<tr><th>Business model</th><td>Subscription-based recurring revenue</td></tr>
<tr><th>SEC CIK</th><td>0001289419</td></tr>
</table>
</aside>
...
Morningstar is not alone in investment research. It competes directly with [FactSet Research Systems](/fds-stock/) and Refinitiv (owned by the [London Stock Exchange](/london-stock-exchange/) Group) for institutional research and data customers. On the retail side, brokerages like Fidelity, [Charles Schwab](/charles-schwab/), and interactive [brokers](/broker/) offer their own research tools, which weakens Morningstar's monopoly on advisor recommendations. Industry consolidation has also brought in competitors: the acquisition of eMoney Advisor by Orion (later acquired by [BlackRock](/blk-stock/)) and the rise of robo-advisors has nibbled at the edges of Morningstar's advisor-tools business.
