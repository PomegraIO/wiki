---
title: "MFS Intermediate Income Trust (MIN)"
description: "A closed-end fixed-income fund launched in 1988 that invests in bonds and treasuries, targeting high current income through monthly distributions—facing headwinds from fund consolidation and evolving investor preferences in the CEF landscape."
keywords:
  - closed-end fund
  - fixed income
  - bond fund
...
The fund benchmarks performance against the Barclays Intermediate U.S. Government/Credit Index, a broad measure of intermediate bond returns. MIN's actual performance versus this benchmark reflects manager skill — both in security selection and in positioning for interest-rate moves. Over a long [holding period](/holding-period/), most actively managed bond funds underperform their benchmarks net of fees, a pattern seen across the industry.

## Evaluating MIN as an investment

Prospective investors should consult the fund's latest [annual report](/10-k/) (SEC filing for CIK 0000826735) and factsheets on the MFS website. Look at the portfolio breakdown (what percentage is treasuries, what percentage is investment-grade corporates, what percentage is in less-developed countries or lower-rated credits). Review the fee structure: [management fees](/management-fee/), administrative costs, and any [performance fees](/performance-fee/). Compare the fund's yield and distribution history to peer bond CEFs and to the simple alternative of investing directly in a bond ETF.
