---
title: "Metallium Limited/ADR (MTLMY)"
description: "Australian metals and mining company with operations in laterite nickel, iron ore, and base metals; traded in US markets via American depositary receipt."
keywords: ["mining", "nickel", "metals", "Australia", "commodity", "ADR"]
---

*An [American depositary receipt](/adr/) (ADR) for a foreign miner opens an interesting discrepancy in disclosure: the company files with Australian regulators on one schedule and with the US SEC on another, and the reader must understand which filing governs which claims. **Metallium Limited (MTLMY)** operates as a mining and minerals company based in Australia but has a US-traded ADR, which means it files [annual reports](/10-k/) to the SEC while also lodging financial statements with the [Australian Securities Exchange](/australian-securities-exchange/). Reading both the 20-F (the SEC form for foreign private issuers) and the Australian filings reveals the company's true resource base, mine economics, and operational challenges in commodity extraction.*

<aside class="wiki-infobox"><table>
<tr><td>Ticker</td><td>MTLMY</td></tr>
<tr><td>Listing</td><td>OTC Markets</td></tr>
<tr><td>SEC CIK</td><td>2091028</td></tr>
<tr><td>Sector</td><td>Mining &amp; Metals</td></tr>
<tr><td>Industry</td><td>Nickel, Iron Ore, Base Metals</td></tr>
<tr><td>Type</td><td>Foreign Private Issuer (Australia)</td></tr>
</table></aside>
...
5 written: mth-stock, mtlk-stock, mtlmy-stock
