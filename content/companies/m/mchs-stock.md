---
title: "Matthews China Innovators Active ETF (MCHS)"
description: "MCHS is an actively managed ETF focused on innovative Chinese companies with competitive advantages and strong management, selected by Matthews International Capital Management's China specialists."
keywords:
  - China stocks
  - active management
  - growth stocks
...
|---|---|
| **Ticker** | MCHS (NASDAQ) |
| **Fund type** | Actively managed, no index benchmark |
| **Geographic focus** | Mainland China, Hong Kong listings |
| **Portfolio manager** | Matthews International Capital Management |
| **Investment philosophy** | Innovation, competitive moat, management quality |
| **Sector bias** | Technology, healthcare, internet, consumer |
| **Typical holdings** | 50 to 100 companies |
| **Expense ratio** | Significantly higher than passive China ETFs |
| **Structure** | Standard ETF, daily liquidity, no leverage |
