---
title: "VictoryShares WestEnd U.S. Sector ETF (MODL)"
description: "A sector-rotation ETF that dynamically weights 11 U.S. equity sectors based on relative momentum, issued by VictoryShares and designed for tactical allocation."
keywords:
  - sector rotation
  - tactical allocation
  - momentum strategy
...
VictoryShares, part of [Victory Capital](/vctr-stock/), designs and manages the underlying index methodology and sponsors the fund. MODL trades on a major U.S. exchange like any stock ETF, settling at market prices during [regular trading hours](/regular-trading-hours/). Liquidity is typically adequate for most retail and institutional traders, though [bid-ask spreads](/bid-ask-spread/) reflect the fund's asset base relative to larger, more established ETFs. The fund's [expense ratio](/expense-ratio/) is reasonable for an index-tracking product with monthly turnover and rebalancing logic embedded in the methodology.
...
MODL appeals to investors comfortable with systematic, transparent rebalancing who believe tactical sector tilts can add value in different market regimes. It suits traders or rotating-allocation strategies more than buy-and-hold investors seeking simple [diversification](/diversification/).

Anyone evaluating MODL should review the fund's actual allocations over full [market cycles](/market-cycle/)—[bull markets](/bull-market/), corrections, and sideways periods—to see whether momentum weighting added value or subtracted it once costs are accounted for. Compare its returns to a static [sector ETF](/sector-etf/) or the broader market. Examine how far the fund's sector weights drift from market weights and what happens in corrections: does the momentum strategy accelerate losses or protect? The prospectus and index methodology document from VictoryShares explain the exact scoring rules and rebalancing schedule, making the strategy transparent but also making it traceable to test yourself against historical data.
