---
title: "MGX Resources Limited/ADR (MTGRF)"
description: "Canadian mineral exploration and mining development company with US-traded OTC ADR; economic model dependent on commodity prices and permitting risk."
keywords: [adr, mining, mineral-exploration, commodity-cyclical, canadian-company]
---
...
<aside class="wiki-infobox"><table>
  <tr><th>Ticker</th><td>MTGRF</td></tr>
  <tr><th>Listing</th><td>OTC Markets (ADR)</td></tr>
  <tr><th>SEC CIK</th><td>1537543</td></tr>
  <tr><th>Sector</th><td>Materials / Mining</td></tr>
  <tr><th>Geography</th><td>Canada</td></tr>
</table></aside>
...
For a junior explorer like MGX, this creates a perverse timing risk: the company needs commodity prices to be elevated when it is ready to develop a property, but commodity cycles are unpredictable. A company that discovers a world-class deposit during a [bear market](/bear-market/) in commodities may lack the capital to develop it (because investors are risk-averse) or may be forced to sell the asset to a larger company at a discount because it cannot fund development solo.
...
MGX trades as an OTC ADR, meaning US investors own a certificate representing shares in a Canadian company. Canadian mining companies typically report in [Canadian dollars](/canadian-dollar/) and hold assets in Canada. A US investor in MTGRF faces both company-specific risk (exploration risk, [commodity risk](/commodity-risk/), permitting risk) and [currency risk](/currency-risk/) (if the Canadian dollar weakens, reported earnings in USD decline). For a company with no current revenue, currency risk is secondary — the primary risk is binary exploration risk. But if the company advances to development and begins generating revenues in Canadian dollars, currency fluctuation becomes material to net cash flow.

The OTC listing (as opposed to a [Nasdaq](/nasdaq/) or NYSE listing) also imposes a liquidity discount. Institutional investors prefer liquid exchanges; MTGRF's lack of deep trading volume likely depresses its valuation by 20–30% compared to an equivalent US-listed mining company. This is the cost of capital-market access for a junior miner without sufficient scale to list on a major exchange.
