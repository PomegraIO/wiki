---
title: "MESOBLAST LTD (MESO)"
description: "Regenerative medicine company focused on cell therapy using allogeneic stem cells to treat chronic pain, inflammation, and degenerative diseases."
keywords: ["cell therapy", "regenerative medicine", "stem cells", "allogeneic", "clinical development"]
---
...
<tr><th>Ticker</th><td>MESO</td></tr>
<tr><th>Listing</th><td>NASDAQ</td></tr>
<tr><th>SEC CIK</th><td>1345099</td></tr>
...
Biotech companies in development consume cash: clinical trials are expensive, FDA submissions require regulatory expertise, manufacturing development requires failed batches and process refinement. Mesoblast raises funds via equity offerings when the [stock](/stock/) is trading well, and may access debt or strategic partnerships to extend runway. The company must reach a milestone—approval, pivotal trial success, or a partnership deal—before cash runs out, or it will be forced to dilute shareholders with a weak offering or face bankruptcy.
...
### Closely related
- [meso-stock](/meso-stock/)
- [Regenerative Medicine](/public-company/)

### Wider context
- [Biotechnology Sector](/public-company/)
- [Clinical Trials & FDA](/securities-and-exchange-commission/)
