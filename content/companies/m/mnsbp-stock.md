---
title: "MainStreet Bancshares, Inc. (MNSBP)"
description: "MainStreet Bancshares is a small bank holding company operating community banks in Texas and the South. Its preferred shares (MNSBP) offer a fixed dividend backed by a traditional retail and commercial lending business."
keywords:
  - community bank
...
<table>
<tr><th>Ticker</th><td>MNSBP (OTC)</td></tr>
<tr><th>SEC CIK</th><td>0001693577</td></tr>
<tr><th>Headquarters</th><td>Texas</th></tr>
<tr><th>Business</th><td>Community banking (retail deposits, commercial lending)</td></tr>
<tr><th>Subsidiary banks</th><td>MainStreet Bank and affiliates</td></tr>
<tr><th>Primary markets</th><td>Texas, small regional presence</td></tr>
<tr><th>Preferred class</th><td>Series A preferred shares</td></tr>
</table>
</aside>
...
A community bank like MainStreet earns revenue primarily from the difference between what it pays depositors on savings accounts and what it charges borrowers on loans. This gap is called the net interest margin. On a typical day, MainStreet might pay depositors 0.25 percent interest on a savings account while charging a customer 6 percent on a mortgage. The difference goes toward employee salaries, rent, technology, loan losses, and profit. A bank might earn a 2 to 3 percentage-point spread on its earning assets; after overhead, the net margin shrinks to 1 to 2 percent of assets. That thin margin is why banks lend so much—to scale a small margin across a large asset base.

MainStreet also earns fee income: overdraft fees, ATM fees, loan-origination fees, wealth-management fees. These are secondary but meaningful revenue streams that diversify the business.
...
## Where does MainStreet's competitive moat come from—or does it have one?

Small regional banks compete on three things: relationship, convenience, and rate. MainStreet is embedded in its local market. A small-business owner in Texas might bank at MainStreet because the loan officer knows the business, turnaround time on decisions is fast, and there is a personal relationship. That relationship is a real source of stickiness. A customer will not switch to a national bank for a 0.1 percent higher rate on a savings account if the local bank's loan officer has been financing the customer's business for years.

Convenience also matters. MainStreet operates branches in its market. A local depositor will use the ATM, walk in to speak to a teller, and keep the account there even if another bank offers 0.5 percent more interest.

Those advantages are real but not durable. They erode if MainStreet does not stay competitive on rates, if technology lets customers bank entirely online (removing the convenience advantage), or if a national bank or another regional competitor opens branches and underbids on pricing. The moat, such as it is, depends on management staying attentive to local relationships and not letting customer service or rates fall too far behind.

## What does a preferred share in a bank holding company get you?

A preferred shareholder in MainStreet has a fixed dividend (let us say 6 or 7 percent annually, paid quarterly). Preferred holders have priority over common shareholders if the company goes into distress—they get paid before common shareholders do. But they rank behind all debt. In a severe stress scenario, the preferred dividend might be suspended, or the shares might be written down, to preserve capital for debt repayment.

Preferred shareholders do not vote on company matters and do not benefit from growth. If MainStreet has a great year and earnings rise 20 percent, preferred holders still get the same 7 percent. Common shareholders get the upside.
...
Technological disruption is a longer-term concern. Online banking, neobanks, and payment platforms could erode the retail-deposit base over time. Younger customers might not use branches and might park money in higher-yielding online banks instead.

## How would an investor evaluate MainStreet?
