---
title: "GraniteShares YieldBOOST MARA ETF (MAAY)"
description: "MAAY is a covered call ETF that holds Marathon Digital shares and sells call options against them to generate enhanced yield, targeting income-focused investors willing to cap upside for higher current returns."
keywords:
  - covered call ETF
  - income strategy
  - options overlay
...
*GraniteShares YieldBOOST MARA ETF — ticker MAAY — is a leveraged [covered call](/covered-call/) strategy wrapped in ETF form. It holds shares of Marathon Digital, the largest publicly traded [Bitcoin](/bitcoin/) miner in the United States, and simultaneously sells [call options](/call-option/) against those shares. This options overlay generates additional income beyond Marathon's [dividends](/dividend/) (if any) by capping the fund's upside in exchange for steady [option premiums](/option-premium/).*

The fund is designed for investors who already hold or want to own Marathon Digital but are willing to sacrifice some of the potential gains in exchange for a higher yield. The covered call mechanism is straightforward: the fund collects option premiums when it sells calls, and if Marathon's stock rises above the [strike price](/strike-price/) of those calls, the shares are called away and the position is rolled into a new call at a higher strike. This creates a defined ceiling on returns but produces income that compound over time if executed well.

## Understanding the core holding

MAAY's foundation is Marathon Digital Holdings, a major publicly traded cryptocurrency mining operation. Marathon operates a large fleet of ASIC miners — specialized hardware for solving Bitcoin's cryptographic puzzles — across data centers in the United States. Its revenue and profitability depend directly on Bitcoin prices, the efficiency of its hardware, and the cost of electricity. During [bull markets](/bull-market/) in Bitcoin, Marathon's stock has surged; in [bear markets](/bear-market/), it has crashed. This volatility is both the appeal and the hazard of the underlying stock.
...
The [expense ratio](/expense-ratio/) reflects the cost of managing the options strategy and administering the fund. This is not a passive buy-and-hold fund, so the fee is higher than a simple Marathon-tracking ETF would be, but lower than hiring an advisor to manage the strategy yourself.
...
Liquidity and [bid-ask spreads](/bid-ask-spread/) matter here as well. MAAY trades on the NYSE, and its spread depends on volume. In normal market conditions, spreads are tight, but in stressed markets or low-volume periods, trading costs can widen.

## Who MAAY is for and how to research it

This fund suits investors who hold Marathon Digital and want to generate additional income without selling their shares, or who believe in Marathon's long-term potential but are content with capped upside in exchange for [current yield](/current-yield/). It is not appropriate for investors who want unlimited upside or believe Marathon will rally dramatically.
