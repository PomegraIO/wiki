...
description: "Grayscale Decentraland Trust is a closed-end investment trust that holds Decentraland's MANA token, providing traditional investors exposure to a virtual-world blockchain asset without managing private keys directly."
keywords:
  - Grayscale
  - Decentraland
  - MANA token
...
<table>
<tr><th>Ticker</th><td>MANA (OTC Markets)</td></tr>
<tr><th>Trust type</th><td>Closed-end investment trust</th>
<tr><th>Underlying asset</th><td>Decentraland (MANA) tokens</td></tr>
<tr><th>SEC CIK</th><td>0001852023</td></tr>
<tr><th>Sponsor</th><td>Grayscale Investments</td></tr>
<tr><th>How it works</th><td>Holds MANA tokens; shares track token value plus trust expenses</td></tr>
<tr><th>Custody</th><td>Coinbase Custody</td></tr>
</table>
</aside>

## What the trust holds and why

The Decentraland virtual world is built on [Ethereum](/ethereum/) blockchain and relies on the MANA token as its primary currency for in-world transactions, land purchases, and creator monetization. Grayscale Decentraland Trust is a straightforward vehicle: it purchases MANA tokens and holds them in custody, issuing shares that represent a proportional stake in that holding. The trust's [net asset value](/net-asset-value/) per share moves with the underlying MANA token price, adjusted for the trust's [management fees](/management-fee/) and operating costs. Unlike buying MANA directly through an exchange, trust shareholders do not manage private keys, do not operate cryptocurrency wallets, and can hold the investment within tax-deferred accounts like [traditional IRAs](/traditional-ira/)—a structural advantage that explains why similar trusts exist for other major cryptocurrencies.
...
The broader ecosystem of crypto trusts has grown substantially. Grayscale itself sponsors trusts for [Bitcoin](/bitcoin/), Ether, and numerous altcoins. Regulatory changes, including the approval of spot Bitcoin and Ether exchange-traded funds by the U.S. [Securities and Exchange Commission](/securities-and-exchange-commission/), have created newer competitors with lower fee structures. For specialist exposures like Decentraland, the closed-end trust remains a meaningful vehicle, particularly for investors who cannot access ETFs or who prioritize holding within specific account types.

## Decentraland ecosystem and the MANA token

Decentraland is a persistent virtual world where users own parcels of digital land as [non-fungible tokens](/non-fungible-token/) (NFTs) on the Ethereum blockchain and can build, trade, and earn within that environment. MANA is the in-world currency and the [governance token](/governance-token/) of the Decentraland DAO ([decentralized autonomous organization](/decentralized-autonomous-organization/)). The token's utility is tied to the development and adoption of the Decentraland platform itself—the more actively the virtual world is developed and used, the stronger the case for holding MANA as a productive asset. Conversely, if Decentraland usage declines or competing virtual worlds capture user attention and spending, MANA demand weakens.
