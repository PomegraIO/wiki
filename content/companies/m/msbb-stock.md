---
title: "Mercer Bancorp, Inc. (MSBB)"
description: "Community bank holding company operating a network of local branches, providing deposit-taking and lending services in its regional market."
keywords: ["community bank", "retail banking", "deposits", "lending", "local market", "financial services", "regional bank"]
---
...
<tr><td>Ticker</td><td>MSBB</td></tr>
<tr><td>Listing</td><td>NASDAQ</td></tr>
<tr><td>SEC CIK</td><td>1967306</td></tr>
...
Gathered deposits are not held idle; they are deployed as loans. Mercer originates mortgages (home loans), [commercial real estate](/commercial-real-estate/) loans, [construction loans](/construction-loan/), and business lines of credit. Each loan earns interest income (spread over the cost of the deposit that funds it) and entails [credit risk](/credit-risk/) (the borrower may not repay). Mercer's loan officers assess borrower creditworthiness, collateral value, and loan structure; this human judgment is essential for small and mid-market borrowers whose credit history and cash flow do not fit standardized mortgage models.
...
Mercer's loan portfolio is deployed into the local economy it serves. Mortgages finance home purchases and improvements; commercial loans fund small retail, office, and industrial properties; business lines of [credit support](/credit-support/) working capital for local manufacturers, contractors, wholesalers, and service providers. These borrowers depend on Mercer for capital to grow, operate, or refinance existing obligations.

When Mercer approves a loan, it is betting that the borrower's business will succeed and that the collateral will retain sufficient value to cover a potential loss. The bank's downside is constrained to the loan amount (plus some [loss severity](/loss-severity/)); its upside is the interest spread earned over the loan's life. Mercer's profitability depends on approving loans with positive expected value — i.e., where the probability-weighted return exceeds the cost of capital and expected loss.
...
Mercer funds itself with customer deposits (liabilities) and shareholder capital (equity). The more capital the bank holds, the more losses it can absorb before insolvency; the less capital, the higher leverage and [return on equity](/return-on-equity/) (but also risk). Mercer's capital is funding by retaining earnings (issuing no [dividend](/dividend/) or a small one) and, periodically, raising new equity from shareholders. This is slow but does not dilute existing shareholders as much as frequent equity raises would.
...
[stock](/stock/) — [nasdaq](/nasdaq/) — [balance-sheet](/balance-sheet/) — [securities-and-exchange-commission](/securities-and-exchange-commission/)
