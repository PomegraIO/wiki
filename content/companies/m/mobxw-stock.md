---
title: "MOBIX LABS, INC. (MOBXW)"
description: "MOBXW is a warrant on MOBIX LABS, INC., a blank-check company seeking to acquire an operating business and take it public through merger."
keywords:
  - warrant
  - SPAC warrant
  - MOBIX Labs
...
<table>
<tr><th>Ticker</th><td>MOBXW (OTC)</td></tr>
<tr><th>Instrument type</th><td>Call warrant on MOBIX LABS equity</td></tr>
<tr><th>Underlying</th><td>MOBIX LABS, INC. common stock</td></tr>
<tr><th>Strike price</th><td>Fixed per warrant prospectus</td></tr>
<tr><th>Exercise rights</th><td>One share per warrant at fixed strike</td></tr>
<tr><th>Term</th><td>Typically 5–7 years from SPAC inception</td></tr>
<tr><th>Status</th><td>Pre-merger; awaiting business combination</td></tr>
<tr><th>Parent SPAC</th><td>MOBIX LABS, INC. (blank-check company)</td></tr>
</table>
</aside>
...
## Redemption and the forced exercise

When a SPAC's share price rises significantly above the warrant strike, the company typically forces redemption — a formal call of all outstanding warrants with a nominal redemption price (e.g., $0.01). Warrant holders then have a choice: exercise the warrant by paying the strike and receiving shares, or let the warrant be redeemed for pennies.

This feature introduces a tactical challenge for MOBXW holders. If the underlying MOBIX LABS share price is slightly above the strike but still weak on fundamentals, exercise creates a share the holder may not want. If the share price is much higher than the strike, redemption forces the decision at a time the company's management has chosen, not the warrant holder. Investors holding MOBXW deep in the money watch for redemption notices and plan accordingly.

## The speculator's risk-reward
