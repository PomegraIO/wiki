---
title: "Morgan Stanley Bitcoin Trust (MSBT)"
description: "An exchange-traded product launched by Morgan Stanley Investment Management that holds bitcoin directly and trades on NYSE Arca — a spot-bitcoin ETF offered by one of the world's largest investment managers."
keywords:
  - bitcoin ETF
  - cryptocurrency
  - Morgan Stanley
...
In its first week of trading, MSBT attracted more than $100 million in assets under management, making it Morgan Stanley's strongest ETF launch on record. On day one alone, it recorded approximately $34 million in trading volume and ranked in the top 1% of all ETF launches over the prior year. That reception reflects both the strong demand for bitcoin exposure and the pulling power of a household-name asset manager.
...
Bitcoin is among the highest-volatility asset classes available to retail investors. The trust's prospectus contains this explicit warning: "An investment in Morgan Stanley Bitcoin Trust is subject to a high degree of risk and heightened volatility, and is not suitable for any investor that cannot afford loss of the entire investment." This is not marketing language; it is a legal acknowledgment that bitcoin prices can move sharply and that the entire value of an investment could evaporate.
...
Multiple spot bitcoin ETFs now trade in the United States, including offerings from iShares, Fidelity, Grayscale, and others. The space has become competitive on fees, features, and brand. Morgan Stanley's advantage is distribution—the firm's existing relationships with financial advisors, retirement plan sponsors, and institutional investors give MSBT visibility and accessibility that a pure-play cryptocurrency company could not match.

The existence of multiple bitcoin ETFs also means that the specific choice of provider matters less than it once might have. An investor choosing between MSBT and iShares' IBIT is making a micro-optimization on fees and custody details; both offer straightforward exposure to the bitcoin price.

## How to Research MSBT

Start with Morgan Stanley Investment Management's official product page and the prospectus filed with the SEC (CIK 0002103612). The prospectus details the custody arrangements, the fee structure, and risk disclosures.

Monitor the trust's assets under management and trading volume over time. Sustained growth in AUM indicates that advisors and investors are comfortable using it; declining AUM or volume might signal competitive pressure or shifting sentiment toward bitcoin.

Watch the bitcoin price itself. MSBT's returns track the bitcoin price minus fees. If bitcoin appreciates 20% and MSBT's return is 19.8%, the difference is explained by fees. Larger gaps suggest operational inefficiencies worth investigating.

Finally, stay informed about regulatory developments. Any change in U.S. tax treatment of bitcoin, custody rules, or trading restrictions will flow through to how MSBT and its peers operate. Regulatory announcements are not always explicitly disclosed in the financial statements, so following SEC and regulatory news sources is prudent.

For a long-term holder, MSBT is a simple, low-cost way to gain bitcoin exposure through a regulated, well-known asset manager. For active traders, the liquidity and tight spreads make it suitable for tactical moves. The key is understanding that MSBT is bitcoin—not a stake in a company or fund that owns bitcoin, but bitcoin itself—and that the price movements and volatility that accompany that asset will follow the holder.
