---
title: "MAIA Biotechnology, Inc. (MAIA)"
description: "Clinical-stage biopharmaceutical developer focused on oncology and other therapeutic areas; SEC registered under CIK 1878313."
keywords: ["biotechnology", "drug development", "clinical trials", "oncology", "unit economics"]
---
...
<tr><td><strong>Ticker</strong></td><td>MAIA</td></tr>
<tr><td><strong>Listing</strong></td><td>US public markets</td></tr>
<tr><td><strong>SEC CIK</strong></td><td>1878313</td></tr>
<tr><td><strong>Type</strong></td><td>Biopharmaceutical development</td></tr>
<tr><td><strong>Sector</strong></td><td>Healthcare and life sciences</td></tr>
</table></aside>
...
The "unit" in MAIA's case is not a tablet or injection sold; it is a therapeutic candidate or program—a specific drug compound in development targeting a disease. Each program has a research phase (design, laboratory synthesis, animal testing), preclinical validation, Investigational New Drug (IND) application to the [Securities and Exchange Commission](/securities-and-exchange-commission/), and then Phase I, II, and III human clinical trials. Each phase costs millions, takes years, and has a defined probability of success or failure.

## Cost Structure: Burning Capital Until Approval

MAIA's expenses are heavily weighted toward research personnel, clinical trial costs (patient recruitment, monitoring, data collection), regulatory consultants, and operational overhead. Unlike a manufacturer that sells products to offset expenses, MAIA has minimal to no revenue during development. It funds operations through [initial public offerings](/initial-public-offering/), equity raises, debt, or partnership deals with larger pharmaceutical companies that license its technology or co-develop candidates.
