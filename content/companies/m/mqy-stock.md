---
title: "BlackRock MuniYield Quality Fund, Inc. (MQY)"
description: "MQY is a municipal bond closed-end fund offering tax-exempt income to US investors. BlackRock manages a portfolio weighted toward higher-quality, investment-grade municipal securities."
keywords:
  - municipal bonds
  - closed-end fund
  - tax-exempt income
...
MQY itself holds a diversified portfolio of investment-grade municipal securities — primarily those rated at least Baa by Moody's or BBB by Standard & Poor's, meaning they carry modest [credit risk](/credit-risk/). The portfolio spans issuers across the United States, with variation in maturity dates, [coupon rates](/coupon-rate/), and types of debt ([general obligation bonds](/general-obligation-bond/) backed by a municipality's tax revenue, [revenue bonds](/revenue-bond/) backed by specific project earnings, and others).

The fund operates as a closed-end investment company, meaning it issues a fixed number of shares at inception and thereafter those shares trade on an exchange like any stock. Unlike an open-ended mutual fund where you redeem shares directly from the manager, MQY shares change hands between investors on the [secondary market](/secondary-market/), which means the price can drift above or below the [net asset value](/net-asset-value/) of the underlying bond portfolio. When rates rise, existing bonds lose marked value and the fund's shares often trade at a discount to NAV; when rates fall, the reverse occurs. This dynamic is a defining feature of [closed-end funds](/closed-end-fund/) and a regular source of trading opportunity and risk.
