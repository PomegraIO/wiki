---
title: "Mereo BioPharma Group plc (MREO)"
description: "Mereo BioPharma is a clinical-stage biopharmaceutical company developing therapeutic candidates, operating with significant geographic and market positioning in rare disease and oncology."
keywords: ["Mereo BioPharma", "MREO", "clinical development", "rare disease", "oncology", "biopharmaceutical"]
---
...
<tr><th>Ticker</th><td>MREO</td></tr>
<tr><th>Listing</th><td>Nasdaq</td></tr>
<tr><th>SEC CIK</th><td>1719714</td></tr>
<tr><th>Sector</th><td>Biopharmaceuticals</td></tr>
<tr><th>Type</th><td>Clinical-Stage Development Company</td></tr>
</table></aside>

## Transatlantic Biotech Development

Mereo's geographic footprint spans two biotech hubs—the United Kingdom (where the company was founded) and the United States (its primary capital and commercial market). This transatlantic positioning reflects where therapeutic discovery and development occurs: significant biotech research and clinical infrastructure exist in both regions, and access to capital (particularly [public markets](/stock/)) and regulatory expertise is essential. The U.K. and U.S. [securities and exchange commission](/securities-and-exchange-commission/) markets provide different funding models and investor bases for early-stage biotech. Mereo's listing on [Nasdaq](/nasdaq/) signals access to U.S. institutional capital, while maintaining operations in U.K. biotech centers (Cambridge, London) allows access to academic research networks and specialized talent pools. This split geography is common among European biotech firms seeking scale beyond their home markets.

## Clinical-Stage Development Model

Mereo's business model is typical of clinical-stage biotech: the company does not yet generate revenue from approved and marketed drugs. Instead, it holds a pipeline of therapeutic candidates in clinical development (various stages of testing in human subjects) and preclinical research. Revenue is zero or near-zero; the company survives on capital raised through [public equity offerings](/initial-public-offering/), [debt](/corporate-bond/), strategic partnerships, or milestone payments from collaborators. This model means Mereo's [balance sheet](/balance-sheet/) is heavily weighted toward cash, investments, and [intangible assets](/intangible-assets/) (intellectual property, patents). The [income statement](/income-statement/) typically shows operating losses because development costs (clinical trials, regulatory compliance, manufacturing) exceed any revenue. The key metric is cash runway—how long the company's cash reserves will sustain operations before it must raise additional capital, achieve a funding milestone, or shut down.
