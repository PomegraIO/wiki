---
title: "Sprott Active Metals & Miners ETF (METL)"
description: "An actively managed ETF that invests in global mining companies and precious metals producers. Sprott's team selects gold, silver, copper, and base metals miners for potential upside in commodity cycles."
keywords:
  - mining stocks
  - precious metals
  - active management
...
METL invests in publicly traded mining firms engaged in the exploration, development, and production of precious metals — chiefly gold and silver — and industrial metals including copper, nickel, zinc, and lithium. The portfolio typically ranges from 30 to 50 holdings spread across three tiers: large-cap producers with established, generating mines on multiple continents; midcap specialists focused on a particular metal or geography; and smaller explorers and junior miners still proving ore bodies or early in the development cycle. The exact roster shifts as Sprott's analysts reassess valuations and geological prospects. Holdings span major gold-producing regions — North America, Australia, West Africa — as well as emerging mining jurisdictions in South America and Asia.
...
Holding a mining company's shares gives exposure to the company's operations as a business, not merely to the underlying commodity price. Mining companies operate with largely fixed extraction costs, so when commodity prices rise, their profit margins expand dramatically. A gold miner producing an ounce at $800 sees margin double if gold rises from $1,600 to $2,400 per ounce. This operational leverage means mining stocks can outperform a flat commodity price or, conversely, underperform badly if prices fall. The equity route also offers liquidity — shares trade continuously on an exchange — and avoids the storage, insurance, and refining costs that come with holding physical metals.
...
Start with the fund's prospectus and latest holdings list, available from Sprott. Review the composition — which metals, which geographies, and which tiers of miners (large producers versus juniors). Compare METL's one-, three-, and five-year returns against passive mining indices and other commodity funds to assess whether active management has added value. Read mining outlook reports from major banks and research firms to gauge the cyclical backdrop: are miners entering a bull or bear cycle? Lastly, clarify your own thesis. If you expect commodity prices to fall, METL will likely decline sharply, regardless of manager skill. If you expect sustained industrial demand (especially linked to energy transition metals like copper and lithium) or inflation-driven precious metals strength, METL's leverage to mining profitability becomes relevant to your allocation decision.
