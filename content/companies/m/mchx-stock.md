...
description: "Marchex transforms consumer search behavior into business intelligence for local and national brands, monetizing the semantic gap between intent and action."
keywords: ["local-search", "consumer-intent", "call-tracking", "lead-generation", "digital-advertising"]
---

*The economic story of **MARCHEX INC** (ticker MCHX, [CIK 1224133](/10-k/)) turns on a single insight: when consumers search for local services—plumbers, lawyers, restaurants—they reveal intent. That intent, captured at the moment it forms, is extraordinarily valuable because it precedes spending. Marchex exists in the narrow and durable space between consumer search behavior and merchant conversion, monetizing data about what people want to do right now.*

<aside class="wiki-infobox"><table>
<tr><td><strong>Ticker</strong></td><td>MCHX</td></tr>
<tr><td><strong>Listing</strong></td><td>Nasdaq</td></tr>
<tr><td><strong>SEC CIK</strong></td><td>1224133</td></tr>
<tr><td><strong>Sector</strong></td><td>Information Technology</td></tr>
<tr><td><strong>Industry</strong></td><td>Digital Advertising & Analytics</td></tr>
