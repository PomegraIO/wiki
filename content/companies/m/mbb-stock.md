---
title: "iShares MBS ETF (MBB)"
description: "MBB is a flagship ETF that holds a diversified portfolio of investment-grade mortgage-backed securities issued or guaranteed by US government-sponsored enterprises, offering fixed-income exposure to the housing market."
keywords:
...
When a homeowner borrows from a bank to buy a house, the bank does not hold the loan forever. Instead, it sells the mortgage to Fannie Mae or Freddie Mac, government-sponsored enterprises that aggregate thousands of mortgages, group them into pools, and issue securities backed by those pools. MBB buys these pooled securities, creating a chain: your mortgage payment goes to the bank, the bank transfers it to Fannie Mae, Fannie Mae passes it to MBB, and MBB passes it to you as a [dividend](/dividend/) payment.

This structure is efficient because it allows banks to recycle their capital into new loans instead of holding them to maturity. It also standardizes mortgages — a 30-year [fixed-rate mortgage](/fixed-rate-mortgage-personal/) is the same product whether it originates in California or Florida. This standardization makes the securities tradable and gives investors like MBB access to thousands of mortgages as one investment.
...
This diversity smooths volatility. If some regions enter [recession](/recession/) and defaults spike, other regions may remain stable. If [interest rates](/interest-rate/) fall sharply, some mortgages prepay quickly while others run their full term. The breadth of holdings means MBB does not concentrate on any single economic outcome.

The portfolio is rebalanced mechanically to stay aligned with the index, requiring no active decision-making. This simplicity translates to a low [expense ratio](/expense-ratio/) — MBB's [management fee](/management-fee/) is among the cheapest in the fixed-income fund universe.
...
This [prepayment risk](/prepayment-risk/) has made MBB more volatile than one might expect from a US government-backed security. In 2022, when the [Federal Reserve](/federal-reserve/) raised rates sharply, [extension risk](/extension-risk/) pushed MBB's price down alongside other bonds. In 2023, when rates stabilized, MBB recovered alongside the bond market.

## Practical characteristics for investors

MBB trades on the [NASDAQ](/nasdaq/) with high liquidity — the [bid-ask spread](/bid-ask-spread/) is tight, and millions of shares trade daily. This makes it one of the most accessible bond investments available. The expense ratio is a fraction of a percent, making it economical for long-term holders.
