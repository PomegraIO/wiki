...
description: "Mercury Systems is a defense contractor specializing in mission-critical electronics and subsystems—radar, signal processing, and secure communications—for military platforms and intelligence applications."
keywords:
  - defense contractor
  - defense electronics
  - signal processing
...
<table>
<tr><th>Ticker</th><td>MRCY (NASDAQ)</td></tr>
<tr><th>Founded</th><td>1981, Chelmsford, Massachusetts</td></tr>
<tr><th>Sector</th><td>Defense / Aerospace & Defense electronics</td></tr>
<tr><th>Core business</th><td>Mission-critical defense subsystems</td></tr>
<tr><th>Primary customer</th><td>U.S. Department of Defense</td></tr>
<tr><th>Business model</th><td>Fixed-price and cost-plus contracts</td></tr>
<tr><th>SEC CIK</th><td>0001049521</td></tr>
</table>
</aside>

## What does Mercury Systems actually make?

Mercury Systems does not build finished weapons or fighter jets. Instead, it supplies the electronic brains and signal-processing modules that go into them. A typical product is a rugged computer card that can be mounted in a weapons pod or a radar enclosure, hardened against electromagnetic interference and designed to operate reliably in extreme conditions—at high altitude, in vibration, across wide temperature ranges. Another is a digital signal processor that translates raw radar returns into [target](/tgt-stock/) tracks, or a cryptographic module that allows aircraft to communicate securely over military networks. These subsystems are often called open-architecture or modular systems because they slot into larger platforms that may be built by a prime contractor like [Lockheed Martin](/lmt-stock/) or [Boeing](/ba-stock/).
