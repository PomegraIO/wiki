---
title: "Morgan Stanley (MS-PI)"
description: "A global investment bank organised around three main businesses: institutional capital markets, wealth management for individuals, and asset management. Morgan Stanley shifted from pure trading toward diversified financial services after the 2008 crisis."
keywords:
  - investment banking
...
| Segment | Primary customers | Key revenue driver | Earnings character |
|---|---|---|---|
| Institutional Securities | Corporations, governments, large asset managers | Trading volumes, underwriting fees, advisory retainers | Highly cyclical; very profitable in booms, weak in downturns |
| Wealth Management | High-net-worth individuals and families | Assets under management, client transactions | Stable and recurring; less sensitive to market cycles |
| Investment Management | Institutions, pension funds, individuals | Assets under management and fees | Recurring but tied to market levels; faces indexing headwind |
...
- **Overall [return on equity](/return-on-equity/)** — this captures how efficiently the firm deploys shareholder capital across all three segments.
