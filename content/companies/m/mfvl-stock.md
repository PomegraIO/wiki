---
title: "Motley Fool Value Factor ETF (MFVL)"
description: "MFVL is a smart-beta ETF that tracks companies recommended by The Motley Fool using a three-factor value screen combining book-to-price, earnings yield, and shareholder returns."
keywords:
  - value factor
  - smart beta
  - stock selection
...
The Motley Fool, founded in the 1990s as a financial education and stock-recommendation service, developed a reputation for rigorous, contrarian stock analysis. In recent years, the firm translated its stock-picking philosophy into an index-based vehicle. MFVL launched as a way to bring that disciplined value lens to exchange-traded fund investors who wanted exposure to Fool-approved stocks without paying for active management.

The fund's universe is drawn from Fool Intelligence (the firm's analyst database) and The Motley Fool's current active recommendations. Companies must meet the fund's screening criteria and maintain adequate liquidity to be index-eligible. This approach anchors the ETF to a real, maintained editorial process rather than a purely algorithmic screen, though the index methodology itself is quantitative and rules-based.

## How the Fund Filters for Value
...
MFVL appeals to investors who believe in the value-investing philosophy and want disciplined, quantitative exposure to undervalued stocks without the cost and complexity of active management. It works best for long-term holders who can tolerate periods of underperformance relative to growth-heavy indices and who appreciate the idea of holding stocks vetted by a recognized financial analysis firm.

Investors researching MFVL should review the fund's prospectus and fact sheet, which detail the exact screening criteria and historical performance. The underlying index documentation explains the three scoring methodologies in full. Understanding The Motley Fool's editorial philosophy and how it maps into the fund's holdings will give investors confidence in whether this value lens aligns with their own investment approach.
