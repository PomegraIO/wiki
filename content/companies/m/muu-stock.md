---
title: "Direxion Daily MU Bull 2X ETF (MUU)"
description: "MUU is a daily-reset leveraged ETF delivering 2x returns of Micron Technology stock, designed for tactical traders expecting near-term strength with understanding of leverage and volatility decay risks."
keywords:
  - Direxion
  - Micron Technology
  - leveraged ETF
...
| Attribute | Details |
|---|---|
| **Fund** | Direxion Daily MU Bull 2X ETF |
| **Ticker** | MUU (NASDAQ) |
| **Sponsor** | Direxion |
| **Underlying asset** | Micron Technology Inc. stock |
| **Leverage ratio** | 2x daily reset |
| **Strategy** | Seeks 2x daily returns via derivative swaps |
| **Rebalancing** | Daily at market close |
| **Intended holding period** | Days to a few weeks, not months |
| **Primary risks** | Leverage amplification, volatility decay, concentration |
| **Suitable for** | Tactical traders, short-term directional bets, hedging |
