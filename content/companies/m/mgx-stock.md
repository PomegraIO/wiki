---
title: "Metagenomi Therapeutics, Inc. (MGX)"
description: "A precision medicine company mining microbial genomes for novel enzymes and therapeutics, betting on a secular shift toward biology-first discovery over chemistry."
keywords: ["genomics", "metagenomics", "precision medicine", "enzyme engineering", "drug discovery"]
---

*Traded on the NASDAQ under the ticker **MGX** (CIK [1785279](https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&CIK=1785279)), **Metagenomi Therapeutics, Inc.** applies computational genomics and organism engineering to discover and develop novel genetic and protein-based therapeutics. The company pursues what might be called a secular bet: as computing power, sequencing costs, and our ability to model biology computationally improve, the traditional chemistry-first pharmaceutical model becomes less advantageous relative to biology-first discovery.*

<aside class="wiki-infobox"><table>
<tr><td><strong>Ticker</strong></td><td>MGX</td></tr>
<tr><td><strong>Listing</strong></td><td>NASDAQ</td></tr>
<tr><td><strong>SEC CIK</strong></td><td>1785279</td></tr>
<tr><td><strong>Sector</strong></td><td>Biotechnology</td></tr>
<tr><td><strong>Industry</strong></td><td>Genomics and Precision Medicine</td></tr>
