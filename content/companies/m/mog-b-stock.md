...
description: "A precision motion-control manufacturer that builds motion systems for aircraft, spacecraft, and defense applications — unglamorous but indispensable to some of the world's most critical machines."
keywords:
  - aerospace motion control
  - aircraft components
  - spacecraft systems
  - defense contracting
...
<table>
<tr><th>Ticker</th><td>MOG-B (NASDAQ)</td></tr>
<tr><th>Founded</th><td>1951</td></tr>
<tr><th>Headquarters</th><td>Buffalo, New York</td></tr>
<tr><th>Sector</th><td>Aerospace and defense motion control</td></tr>
<tr><th>Main products</th><td>Actuators, control systems, motion electronics</td></tr>
<tr><th>Customer base</th><td>Defense contractors, aircraft makers, space agencies</td></tr>
<tr><th>SEC CIK</th><td>0000067887</td></tr>
</table>
</aside>
...
MOOG's revenue comes from selling motion-control systems and components to a small list of very large customers. Those customers are defense contractors (like [Lockheed Martin](/lmt-stock/), [General Dynamics](/gd-stock/), and Raytheon), major aircraft makers (Boeing and Airbus), and government agencies (NASA, the U.S. military, and space agencies of other nations). There is no consumer business. There is no direct-to-end-user sales. Everything flows through large, multi-year contracts.
