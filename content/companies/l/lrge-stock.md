---
title: "ClearBridge Large Cap Growth Select ETF (LRGE)"
description: "LRGE is an actively managed ETF holding 40–60 large U.S. companies selected for growth and reasonable valuation. Managers pick stocks rather than tracking an index."
keywords:
  - large-cap growth
  - active management
  - stock selection
...
<div class="wiki-infobox-title">LRGE — key facts</div>

|   |   |
|---|---|
| **Fund name** | ClearBridge Large Cap Growth Select |
| **Ticker** | LRGE |
| **Issuer** | Franklin Templeton (ClearBridge Investments) |
| **Approach** | Active stock selection |
| **Number of holdings** | Approximately 40–60 large U.S. companies |
| **Expense ratio** | Approximately 0.60% annually |
| **Benchmark** | Russell 1000 Growth Index |
| **Investment style** | Growth with reasonable valuation discipline |
