---
title: "Centrus Energy (LEU)"
description: "A leading US supplier of enriched uranium and nuclear fuel components; also developing high-assay low-enriched uranium (HALEU) for next-generation reactors."
keywords:
  - nuclear fuel
  - uranium enrichment
  - haleu
...
- **Founded:** 1992 (spun from USEC)
- **Headquarters:** Bethesda, Maryland
- **Business:** Enriched uranium supply; HALEU development
- **Customers:** Utilities, reactor operators, commercial entities
- **Key Products:** Low-enriched uranium (LEU); high-assay LEU (HALEU)
- **Key Locations:** Pike County, Ohio (enrichment plant)
- **Ticker:** LEU (NASDAQ)
- **SEC CIK:** 1065059
...
The company also benefits from the [nuclear-power-economics](/wiki/nuclear-power-economics/) tailwind. Growing concern about climate change has restored respectability to nuclear power, and both government and utilities are renewing interest in capacity expansion. This lifts the baseline demand for fuel and makes Centrus's current operations more valuable.

## For investors and analysts

Those tracking Centrus should look at the [10-K](/wiki/10-k/) for detail on fuel inventories, utilization rates at the Ohio plant, capital expenditure for HALEU, and government funding agreements. Watch the pace of advanced reactor deployments and any shifts in federal energy policy. Monitor feedstock (natural uranium) pricing and the pace of reactor retirements in the US fleet.
