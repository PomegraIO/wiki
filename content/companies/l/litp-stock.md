---
title: "Sprott Lithium Miners ETF (LITP)"
description: "A sector-focused ETF that tracks lithium mining and processing companies. Concentrated exposure to a critical commodity ecosystem, with volatility driven by commodity prices and mine cycles."
keywords:
  - lithium mining
  - battery materials
  - commodity exposure
...
LITP is a concentrated play on a single commodity and a single industry. If battery demand disappoints, electric-vehicle adoption slows, or a glut of new supply floods the market, the entire sector — and every holding in the fund — can fall sharply. There is no [diversification](/diversification/) into, say, other battery materials like cobalt or nickel, or into the companies that use lithium downstream.
