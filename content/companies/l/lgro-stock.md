---
title: "Level Four Large Cap Growth Active ETF (LGRO)"
description: "LGRO is an actively managed large-cap growth equity ETF offering concentrated exposure to a manager's selected portfolio of large-cap US companies believed to have secular growth drivers."
keywords:
  - large-cap growth
  - active management
  - growth stocks
...
Level Four, the sponsor of LGRO, entered this landscape as an active manager offering concentrated exposure to its best growth ideas. Rather than holding 200 large-cap stocks indexed to the market, LGRO holds perhaps 30-50 positions — the names the manager believes will drive durable shareholder returns over multi-year periods. This concentration is a bet: if the manager picks well, excess returns accrue to shareholders; if poorly, underperformance is amplified.

The fund's stated mandate is to invest in large-cap US equities with secular growth tailwinds. That typically manifests as overweight to technology, healthcare, and consumer discretionary while underweighting or avoiding financials, utilities, and other cyclical and defensive sectors. The concentration in growth sectors means LGRO's returns are correlated with whether the market is in a "growth" or "value" rotation — a meaningful risk for investors seeking broad exposure.

## The manager's process and track record

An active growth manager's edge, if it exists, comes from two places: selection skill (picking companies that will outperform) and a contrarian view of valuations (identifying growth companies trading at reasonable multiples while others pay speculative prices). LGRO's manager should publicly articulate which companies they own and why; quarterly reports and calls can reveal whether the selection is thoughtful or reactive. A manager who buys heavily into trending sectors and sells into panics is likely index-tracking with higher fees. A manager who maintains conviction in high-quality compounders even when they fall out of favor might be adding value.

Historical track records matter, but they can be misleading. A growth manager who beat the market in 2010-2020 — the era of technology dominance — may struggle in a period when value stocks outperform. Past performance is not predictive; only an understanding of the manager's process and current conviction determines whether they are likely to outperform going forward.
...
## Evolution of the growth thesis over time

The secular growth narrative has evolved since the fund's inception. In the 2000s, growth meant technology and biotech. In the 2010s, it meant tech and internet platforms. In the 2020s, it has broadened to include healthcare innovation, artificial intelligence, and other structural trends. A manager who can evolve the thesis as the world changes — recognizing when old winners have peaked and new opportunities emerge — is more likely to compound returns than one locked into a historical framework.

LGRO's current positioning reflects the manager's current view of which large-cap companies have durable growth. That view will change; the fund held different names and tilts in 2010, 2015, and 2020. An investor should understand whether recent changes reflect genuine insight into shifting growth drivers or reactive chasing of recent winners.
