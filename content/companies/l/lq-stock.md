---
title: "Simplify Tax Aware Alternatives ETF (LQ)"
description: "LQ is an actively managed ETF that blends alternative strategies with tax-aware portfolio management to minimize capital gains distributions while delivering diversified returns."
keywords:
  - tax-aware investing
  - alternatives
...
<div class="wiki-infobox-title">LQ — key facts</div>

|   |   |
|---|---|
| **Fund name** | Simplify Tax Aware Alternatives |
| **Ticker** | LQ |
| **Issuer** | Simplify ETFs |
| **Launch year** | 2020 |
| **Strategy** | Alternative strategies with tax-aware rebalancing |
| **Expense ratio** | Approximately 0.45% annually |
| **Holdings** | Long equities, options, selective hedging |
| **Tax focus** | Minimizing realized capital gains distributions |
| **Suitability** | High-earners with taxable accounts |
...
Tax efficiency is not tax elimination. The fund cannot avoid all capital gains forever. If the [stock market](/stock-market/) rallies sharply, some gains must eventually be realized. Options strategies generate distributions (usually taxed as ordinary income, not the more favorable capital-gains rate). And loss harvesting only works when there are losses to harvest — in extended [bull markets](/bull-market/), opportunities narrow.
...
To evaluate LQ, start with the prospectus and fact sheet, which explain the investment philosophy and tax-management approach. Review the fund's after-tax returns — many fund companies now publish these — against similar alternatives to see whether tax efficiency translates to real advantage. Examine the realized capital gains distributions over the past several years; a pattern of minimal distributions suggests the strategy is working. Look at the portfolio's turnover and [tax-loss harvesting](/tax-loss-harvesting/) activity as disclosed in fund reports. Finally, assess the manager's historical track record: tax efficiency adds no value without competitive gross returns.
