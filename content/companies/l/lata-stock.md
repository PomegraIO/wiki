---
title: "Galata Acquisition Corp. II (LATA)"
description: "Galata Acquisition Corp. II is a special-purpose acquisition company (SPAC) — a blank-check shell formed to identify and acquire a private company, taking it public."
keywords:
  - SPAC
...
Galata [Acquisition](/acquisition/) Corp. II is a [special-purpose acquisition company](/special-purpose-acquisition-company/) — what is commonly called a blank-check company. It was formed as a shell with no operating business, raised cash from public investors, and exists for one purpose: to identify a private company, negotiate a merger with it, and take that company public without the traditional IPO process. The name and ticker change when the merger closes; until then, LATA is an empty shell.

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>LATA (NASDAQ)</td></tr>
<tr><th>Entity type</th><td>Special-purpose acquisition company (SPAC)</td></tr>
<tr><th>Founded</th><td>2021 (approximate)</th></tr>
<tr><th>Status</th><td>Blank-check company searching for merger target</td></tr>
<tr><th>Use of capital</th><td>To acquire a private company</td></tr>
<tr><th>Time frame</th><td>Typically 18–24 months to complete business combination</td></tr>
<tr><th>SEC CIK</th><td>0002076427</td></tr>
</table>
</aside>

## Why SPACs exist

A private company takes years to prepare for a traditional [initial public offering](/initial-public-offering/): audited financials, governance, SEC filings, a roadshow to convince investors to buy the stock. The cost is tens of millions of dollars, and success is not guaranteed. A SPAC offers an alternative path.
...
The SPAC boom of 2020–2021 produced mixed results. Some [mergers](/merger/) created solid companies. Others were, frankly, disasters. The problems include:
