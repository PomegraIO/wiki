---
title: "Standard BioTools (LAB)"
description: "Standard BioTools manufactures mass cytometry and microfluidics equipment for life-science research and biopharma, enabling cell analysis at scale and precision — a specialized instrumentation player serving a global installed base."
keywords:
  - mass cytometry
  - cytof
  - microfluidics
...
<table>
<tr><th>Ticker</th><td>LAB (NASDAQ)</td></tr>
<tr><th>Founded</th><td>1999, San Francisco</td></tr>
<tr><th>Sector</th><td>Life science instruments / research tools</td></tr>
<tr><th>Flagship products</th><td>CyTOF mass cytometer; microfluidic chips</td></tr>
<tr><th>Customer base</th><td>Research institutions, biopharma, diagnostics labs</td></tr>
<tr><th>SEC CIK</th><td>1162194</td></tr>
</table>
</aside>
...
Standard BioTools faces several headwinds. The first is concentration among top-tier research institutions and pharmaceutical companies — a small number of highly sophisticated customers represent a large fraction of revenue, creating customer [concentration risk](/concentration-risk/). Loss of share to incumbents in adjacent markets (flow cytometry vendors, for instance) or displacement by emerging single-cell technologies (like spatial transcriptomics or advanced imaging) could erode the TAM. The company also depends on the research and drug-development spending of academic and pharma customers, which fluctuates with funding cycles and R&D budgets.
...
Standard BioTools should be understood as a specialized scientific-instrument play in a deep-tech niche. The [10-K filing](/wiki/10-k/) (SEC CIK 1162194) reveals the customer concentration, the consumables-driven economics, and the company's strategic bets. For investors evaluating it, the critical metrics are: the number of CyTOF systems sold and in use (installed base growth), consumables revenue per installed instrument (indicating customer adoption depth), gross margins on consumables, and operating leverage as the company scales. Watch earnings calls for color on new instrument placements, partnerships with pharma and academic centers, and progress on clinical diagnostic applications — areas where CyTOF could expand beyond research and into routine clinical labs, a much larger market.
