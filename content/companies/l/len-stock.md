---
title: "Lennar (LEN)"
description: "One of the largest U.S. homebuilders, pursuing a land-light model with integrated financial services and a spun-off land business."
keywords:
  - homebuilder
...
**CIK:** 920760  
**What it does:** Builds single-family homes and multifamily properties; offers mortgages and title insurance through subsidiaries
...
The financial services segment has its own P&L. Mortgage origination margins depend on [interest rates](/interest-rate/) and market volume. Title insurance and homeowners insurance are typically low-margin businesses but sticky: buyers are captive at closing, and the services are bundled into the overall offer.

Gross margins on homebuilding typically range from high single digits to low teens, depending on the cycle. Homebuilders are capital-intensive on a per-dollar-of-revenue basis but asset-light on a per-home basis compared to land companies. Lennar targets [return on equity](/return-on-equity/) in the low teens to mid-teens over a full cycle.
...
Lennar and its peers are also exposed to labor and material cost [inflation](/inflation/). Lumber, steel, and concrete prices have spiked unpredictably. Labor is tight in many markets, pushing wage inflation. If input costs rise faster than selling prices, margins compress. Lennar has limited pricing power in weak demand, so cost shocks hit margin hard.
...
Capital allocation priorities typically reflect the cycle. In strong markets, Lennar buys land and builds, returning modest capital to shareholders. In weak markets, it husbands cash and may reduce the [dividend](/dividend/) or buy back shares at low valuations. The Millrose spin reflected a broader shift toward returning capital and reducing leverage.
...
Key metrics to track: homes delivered (volume), average selling price, gross margin %, cash generated, return on equity, and [net debt](/net-debt/) levels. Compare these across Lennar, D.R. Horton, Toll Brothers, and regional builders to gauge competitive position and cycle strength.

The [mortgage-backed-security](/wiki/mortgage-backed-security/) market and [housing bubble](/wiki/housing-bubble-2008/) history provide useful context on systemic leverage and past crashes.
