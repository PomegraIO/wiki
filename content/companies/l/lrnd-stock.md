---
title: "NYLI U.S. Large Cap R&D Leaders ETF (LRND)"
description: "An exchange-traded fund that tracks companies with the highest research and development spending relative to revenue — a bet on capital intensity and innovation as competitive moat."
keywords:
  - R&D spending
  - innovation
  - large-cap ETF
...
*The NYLI U.S. Large Cap R&D Leaders ETF (ticker: LRND) is an exchange-traded fund that selects and weights large-capitalization U.S. companies based on the intensity of their research and development spending — that is, how much they invest in R&D as a proportion of total revenue. The fund uses this metric as a proxy for innovation capacity and long-term competitive strength, betting that companies willing to spend heavily on future products and capabilities tend to generate superior returns.*
...
The rationale rests on the idea that R&D spending reveals management's true priorities and confidence in the future. When a company commits substantial capital to research that may not pay off for years, it signals both the belief that the investment is worth making and the competitive moat strong enough to justify the expense. This contrasts with a mature commodity business where R&D adds little value and so is minimized. By weight, LRND holds companies that have chosen to compete on innovation rather than cost-cutting.
...
Anyone considering LRND should start with the fund's prospectus and fact sheet, which detail the exact methodology for R&D calculation, the rebalancing schedule, the list of current holdings, and the expense ratio. These documents lay out what the fund is actually tracking and owning, and they clarify any index definitions. Morningstar and similar fund research sites publish independent analysis of the fund's performance, peer comparison, and historical tracking error.

An investor should also look at the underlying index definition — what companies qualify, how R&D spending is measured, and how it is weighted. R&D can be reported differently across companies (some expense it, some capitalize and amortize), so understanding the fund's methodology matters. Finally, comparing LRND to other large-cap growth or innovation-themed ETFs clarifies whether this specific angle on R&D intensity offers better risk-adjusted returns or simply reflects a different flavor of sector concentration. Index and fund fact sheets are the primary sources here, along with performance data from the fund sponsor and independent mutual-fund tracking platforms.
