---
title: "Themes US Cash Flow Champions ETF (LGCF)"
description: "LGCF is an equity ETF that selects US large-cap companies with strong cash flows and dividend-paying track records, emphasizing firms that consistently return cash to shareholders."
keywords:
  - dividend stocks
  - cash flow
  - large-cap
...
<table>
<tr><th>Ticker</th><td>LGCF</td></tr>
<tr><th>Fund type</th><td>Actively managed large-cap equity ETF</td></tr>
<tr><th>Sponsor</th><td>Themes Capital</td></tr>
<tr><th>Universe</th><td>US large-cap equities</td></tr>
<tr><th>Selection criteria</th><td>Strong free cash flow, dividend consistency, capital allocation discipline</td></tr>
<tr><th>Typical holdings</th><td>40–60 stocks, concentrated in cash-generative sectors</td></tr>
<tr><th>Sector tilt</th><td>Financials, utilities, consumer staples, energy (dividend-paying sectors)</td></tr>
</table>
</aside>
...
A company that has raised its dividend for 20 consecutive years tells an investor something powerful: the board and management have consistently prioritized shareholder distributions, capital discipline has held, and the business model is robust enough to fund rising payouts through cycles. LGCF favors such histories. This creates a natural selection bias toward stable, low-volatility sectors and away from cyclical, high-growth firms that cannot sustain rising distributions through downturns.

The tradeoff is lower capital appreciation but steadier income. A dividend aristocrat — a company raising its dividend for 25 years straight — typically trades at moderate valuations and delivers steady total return through the combination of income and modest price appreciation.
...
Because LGCF tilts toward defensive, dividend-paying sectors, it typically exhibits lower volatility than the broad market in normal periods. In down markets, it can still suffer; dividends do not shield from valuation compression. In 2022, when rising interest rates hurt all equities, dividend stocks sold off alongside growth stocks. But the income cushions some of the pain; a 20% stock-price decline coupled with a 3% dividend yield nets to a smaller total return loss than the stock alone would suggest.
...
## How to research LGCF

Start with the prospectus and fact sheet for the selection methodology and current holdings. The fund should disclose its free-cash-flow metrics, dividend-growth track records, and sector weights. Compare the fund's historical yield and total return net of fees to a broad large-cap dividend index and to a simple buy-and-hold portfolio of the largest dividend aristocrats. Review the fund's sector composition and ask whether the tilt toward financials, utilities, and consumer staples aligns with your views on those sectors' valuations. Finally, audit the dividend-income tax consequences in a taxable account and determine whether the after-tax return justifies the vehicle.
