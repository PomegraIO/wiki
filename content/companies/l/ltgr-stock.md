---
title: "Long Table Growth Corp. (LTGR)"
description: "A special-purpose acquisition company or development-stage investment holding company with exposure to growth-stage businesses."
keywords: ["SPAC", "special-purpose acquisition company", "investment holding", "growth capital", "business combination"]
---

*Special-purpose [acquisition](/acquisition/) companies have evolved from blank-check vehicles into alternative paths for bringing private businesses to public markets. The traditional [initial-public-offering](/initial-public-offering/) required expensive underwriting, extended road shows, and acceptance of lengthy lockup periods for founders and insiders. A [special-purpose-acquisition-company](/special-purpose-acquisition-company/) offers speed: a shell company merges with an operating business, and shareholders vote, completing the listing in months rather than years. **Long Table Growth Corp. (LTGR)** exemplifies this model—a capital pool assembled to identify and merge with a private growth-stage business.*

<aside class="wiki-infobox"><table>
<tr><td>Ticker</td><td>LTGR</td></tr>
<tr><td>Listing</td><td>NASDAQ</td></tr>
<tr><td>SEC CIK</td><td>2104177</td></tr>
<tr><td>Sector</td><td>Special Purpose Acquisition</td></tr>
...
The deployment timeline matters: capital sitting in escrow for years dilutes returns due to [time value](/time-value/), and interest earned on escrow balances is typically modest. Sponsors are incentivized to close a merger quickly. Slower closures benefit shareholders (more time to assess targets and negotiate terms) but punish sponsors through opportunity cost and fee drag.
...
Most SPACs target one of a handful of sectors: software and cloud (valued on [revenue multiples](/revenue-multiple/) and growth rates), consumer and retail (dependent on brand and omnichannel execution), industrials and manufacturing (cyclical and capital intensive), or financial services (regulated and relationship driven). Each sector carries distinct operating risks and capital requirements.

## Valuation and Dilution Mechanics

SPAC [mergers](/merger/) involve three valuation steps. First, the target company is valued at a negotiated [enterprise-value](/enterprise-value/) representing the sponsors' and the SPAC's joint assessment of future cash generation. Second, shareholders vote whether to redeem their SPAC shares for the escrowed capital, typically valued at [net asset value](/net-asset-value/) (close to $10 per share). Third, the post-merger entity issues shares to the target's former owners. 
...
For sponsors, a SPAC is a capital-efficient way to profit from deal-making and minority equity stakes in growth businesses without running an operating company. Sponsors earn [management fees](/management-fee/) on the SPAC capital, transaction fees for sourcing targets, and appreciation of founder shares post-merger. If three out of five SPAC deals generate positive returns for shareholders, the sponsor's track record supports raising the next SPAC fund and charging higher fees.
