---
title: "Capital One Financial Corp. (COF-PI)"
description: "Capital One is a diversified consumer-finance lender headquartered in Richmond, Virginia, built at scale through credit cards, auto loans, and retail banking — one of the largest issuers of credit in North America."
keywords:
  - credit card issuer
  - auto lending
  - consumer finance
...
<table>
<tr><th>Ticker</th><td>COF-PI (preferred shares)</td></tr>
<tr><th>Parent Company</th><td>Capital One Financial Corp.</td></tr>
<tr><th>Headquarters</th><td>Richmond, Virginia</td></tr>
<tr><th>Founded</th><td>1988</td></tr>
<tr><th>Sector</th><td>Consumer finance / banking</td></tr>
<tr><th>Main Products</th><td>Credit cards, auto loans, retail banking</td></tr>
<tr><th>SEC CIK</th><td>0000927628</td></tr>
</table>
</aside>
...
First, scale allows Capital One to absorb credit losses that would bankrupt a smaller player. Consumer credit cards are inherently risky assets — a portion of balances will never be paid back, and that loss rate tends to rise sharply during [recessions](/recession/). A large portfolio spreads this risk across millions of independent borrowers in different regions and income brackets, smoothing outcomes. A card issuer with ten million customers sees those losses as a predictable cost of business; an issuer with one hundred thousand customers sees them as dramatic volatility.

Second, scale creates a lower cost of funding. Capital One funds its card portfolio through deposits (gathered through its retail banking subsidiary) and wholesale borrowing in capital markets. The company's size and established [credit rating](/credit-rating/) mean it can borrow at rates available only to the largest, safest borrowers. A smaller card issuer would pay meaningfully more to fund the same loan, eroding profitability.
...
The card segment's profitability is heavily dependent on interest-rate levels. When the [Federal Reserve](/federal-reserve/) keeps rates high, cardholders pay more interest on unpaid balances, and Capital One's net interest margin (the difference between what it earns on loans and what it pays on deposits) widens. When rates are low or falling, cardholders pay less, and margins compress.
