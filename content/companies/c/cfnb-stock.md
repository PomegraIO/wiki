...
CFNB funds equipment purchases through debt (bonds, bank lines) and equity capital. The ratio of debt to equity determines [financial leverage](/balance-sheet/) and ROE. Higher leverage increases ROE for shareholders (the same earnings are divided among fewer shares of equity) but increases financial risk (fixed debt obligations must be met even in downturns). If CFNB cannot generate cash from leases, it must pay down debt, reducing the asset base and profitability.
...
### Closely related
[Equipment Finance & Leasing Markets](/stock-exchange/), [CFBK Stock](/cfbk-stock/)

### Wider context
[Asset-Backed Securitization](/bond/), [Credit Cycles & Default Risk](/income-statement/), [Small Business Financing](/securities-and-exchange-commission/)
