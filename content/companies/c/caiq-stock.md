---
title: "Calamos Nasdaq Autocallable Income ETF (CAIQ)"
description: "A structured ETF that holds Nasdaq tech stocks while systematically selling call options against them, generating income and capping returns within a bounded range."
keywords:
  - option writing etf
...
*The Calamos [Nasdaq](/nasdaq/) Autocallable [Income ETF](/income-etf/) is a blend of two financial instruments: a core holding in large-cap tech stocks from the Nasdaq-100 index, combined with a systematic sale of [call option](/call-option/) contracts. This married position is designed to harvest a stream of income from [option premiums](/option-premium/) while capping the upside if tech stocks surge, converting the potential for unlimited gains into a more predictable return stream bounded at an upper level.*

## The equity sleeve

CAIQ begins with Nasdaq-100 stocks — the one hundred largest non-financial companies on Nasdaq, heavily weighted toward technology, consumer discretionary, and communication names. These are companies like [Apple](/aapl-stock/), [Microsoft](/msft-stock/), Amazon, [Nvidia](/nvda-stock/), Meta, and [Tesla](/tsla-stock/). The fund holds the stocks directly or through a proxy, so it captures their price appreciation and any [dividends](/dividend/) they pay. On a rising day in tech stocks, CAIQ rises alongside the index.
