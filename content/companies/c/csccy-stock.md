---
title: "Capstone Copper Corp./ADR (CSCCY)"
description: "Capstone Copper is a Canadian mining company operating copper mines in Arizona, Mexico, and Chile, with a portfolio focused on low-cost production and expansion through the Mantoverde project."
keywords:
  - copper mining
  - pinto valley mine
  - cozamin mine
...
Capstone Copper is a Vancouver-based mining company operating four copper assets across the Americas: Pinto Valley in Arizona (USA), Cozamin in Zacatecas (Mexico), Mantos Blancos in Antofagasta (Chile), and a 70% stake in Mantoverde in Atacama (Chile). The company also owns the fully permitted Santo Domingo copper-iron-gold project in Chile. Shares trade on the [Toronto Stock Exchange](/toronto-stock-exchange/) as CS and via [American depositary receipt](/adr/) as CSCCY. The business is built on a disciplined [acquisition](/acquisition/) and operational-optimization philosophy: find producing mines with room for cost improvement, buy them, run them efficiently, and deploy surplus cash toward the next acquisition or toward developing a major new resource like Santo Domingo.

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>CS (TSX); CSCCY (OTC)</td></tr>
<tr><th>Headquarters</th><td>Vancouver, British Columbia</td></tr>
<tr><th>Major assets</th><td>Pinto Valley (Arizona), Cozamin (Mexico), Mantos Blancos (Chile), Mantoverde (Chile)</td></tr>
<tr><th>Development project</th><td>Santo Domingo (Chile) — fully permitted</td></tr>
<tr><th>Production profile</th><td>Multi-jurisdictional, low-cost open-pit and underground operations</td></tr>
<tr><th>Strategic focus</th><td>Operational excellence and disciplined capital deployment</td></tr>
<tr><th>SEC CIK</th><td>0002075918</td></tr>
</table>
</aside>
