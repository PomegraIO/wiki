---
title: "Pacer US Small Cap Cash Cows Growth Leaders ETF (CAFG)"
description: "A small-cap equity ETF selecting profitable companies with growing revenue, using quantitative screening for free cash flow and strong revenue growth."
keywords:
  - small-cap etf
  - cash flow investing
...
## What the fund selects for

CAFG begins with the Morningstar US Small Cap Index, which represents the smallest two thousand or so publicly traded American companies. From that universe, it applies a three-part filter. First, it selects only companies with positive free cash flow — cash left after capital expenditure, not merely accounting profit. Second, it ranks them by revenue growth, preferring companies that are expanding. Third, it weights by profitability, giving more positions to firms with higher returns on invested capital.
