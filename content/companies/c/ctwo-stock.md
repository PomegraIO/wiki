---
title: "COTWO Advisors Physical European Carbon Allowance Trust (CTWO)"
description: "A passive trust that holds EU carbon allowances as physical assets, offering investors a way to gain exposure to European climate policy pricing without derivatives or leverage."
keywords:
  - carbon allowances
  - EU ETS
...
As of early 2026, CTWO reported roughly $1.6 million in net assets, making it a micro-cap fund by any standard. That small size creates two challenges. First, the [bid-ask spread](/bid-ask-spread/) on the shares — the difference between buying and selling prices — may be wider than on larger, more-liquid funds, which increases the real cost of entry and exit. Second, regulatory changes or market developments could make the fund economically unviable if expenses consume the asset base, forcing [liquidation](/liquidation/) at potentially unfavourable times.
