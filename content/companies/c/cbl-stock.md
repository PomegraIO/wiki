---
title: "CBL & Associates Properties (CBL)"
description: "A REIT owning regional shopping malls and shopping centers, headquartered in Chattanooga, Tennessee. Emerged from Chapter 11 bankruptcy in 2022."
keywords:
  - reit
  - retail real estate
  - shopping malls
...
- **Business:** Regional shopping malls and shopping centers
- **SEC CIK:** 910612
</aside>
...
CBL's revenue model depends on several key drivers:

- **Base rents** from long-term tenant leases form the foundation, typically covering triple-net expense structures in which tenants reimburse the landlord for property taxes, insurance, and common area maintenance (CAM).
- **Percentage rents** capture a small share of tenant sales above negotiated thresholds, providing exposure to retail sales trends for growing merchants.
- **Occupancy and rental rate trends** directly influence profitability; higher occupancy allows for rate increases while filling vacant space.
- **Tenant mix quality** matters significantly; national retailers and essential services (groceries, pharmacies, fitness) provide stability, while weak anchor tenants and empty department store boxes drag on value.

The company faces structural headwinds shared across mall REITs: secular retail decline, acceleration of online shopping, oversupply of retail space in certain markets, and a tenant base under permanent margin pressure. Discretionary retail and apparel categories, which historically anchored malls, have contracted severely. CBL's strategy has pivoted toward essential retail and mixed-use development, adding residential and office components to existing properties and focusing on lifestyle centers and necessity-based shopping rather than pure enclosed malls.
...
**Tenant dependencies:** A small number of major tenants generate a disproportionate share of rent. Loss of a major anchor can trigger a cascade of co-tenant failures as traffic declines.
...
**Retail bankruptcy cycle:** If major national retailers continue contraction or bankruptcy (department stores, apparel chains), CBL faces further occupancy losses.

| Property Type | Approximate Count | Revenue Driver | Market Position | Risk Level |
|---|---|---|---|---|
| Regional malls (enclosed) | 20-25 | Anchor rents, common area | Declining category | High |
| Open-air shopping centers | 20-25 | Necessity/essential retail | More resilient | Moderate |
| Lifestyle/mixed-use (post-renovation) | 5-10 | Diversified tenancy | Growing focus | Lower |

## Strategic Direction and Investment Thesis

Post-emergence, CBL is pursuing a selective capital allocation strategy: investing in underperforming properties with repositioning potential, selling assets in terminal decline, and focusing on necessity-driven retail. The company has emphasized grocery-anchored and essential-service properties, which have proven more resilient than discretionary retail.

The fundamental investment thesis is a value-based turnaround: a company with depressed asset values and low-cost capital post-emergence can generate outsized returns if retail stabilizes and the company can drive occupancy and rate growth. However, structural secular decline in malls remains a headwind, and macroeconomic pressure on consumer spending presents near-term uncertainty.
