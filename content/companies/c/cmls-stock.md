---
title: "Cumulus Media Inc (CMLS)"
description: "Large-scale US radio broadcaster; capital structure dominated by debt from legacy leveraged buyouts; complex capital allocation balancing debt service with broadcasting investment."
keywords: [radio broadcaster, media, debt-heavy capital structure, broadcasting, leverage]
---

*Cumulus Media is one of the largest radio broadcasters in the United States, operating hundreds of stations across dozens of major and [secondary markets](/secondary-market/). The company's capital structure is heavily leveraged—a legacy of the 2011–2013 [leveraged buyout](/leveraged-buyout/) (LBO) that took the company private and assembled a national radio portfolio. Cumulus returned to public markets in 2013, carrying significant debt alongside a broadcasting business generating steady but declining cash flows.*

<aside class="wiki-infobox"><table>
<tr><td><strong>Ticker</strong></td><td>CMLS</td></tr>
<tr><td><strong>Listing</strong></td><td>NASDAQ</td></tr>
<tr><td><strong>SEC CIK</strong></td><td>1058623</td></tr>
<tr><td><strong>Sector</strong></td><td>Media & Entertainment — Radio Broadcasting</td></tr>
<tr><td><strong>Type</strong></td><td>Public corporation</td></tr>
</table></aside>

## The LBO Legacy: Debt Structure and Burden

Cumulus Media's balance sheet is dominated by debt accumulated during the LBO. Multiple [tranches](/tranche/) of term loans and unsecured notes, incurred to finance the 2011 purchase and subsequent [acquisitions](/acquisition/), carry maturity dates stretching into the 2030s. Annual interest expense runs $200M+, consuming a substantial portion of operating earnings ([EBITDA](/ebitda/) typically $500–700M). This high leverage constrains dividend capacity, limits M&A flexibility, and increases [refinancing risk](/refinancing-risk/) if cash flows deteriorate.
...
Cumulus' lending agreements are secured by first liens on most operating assets and include financial covenants tied to [leverage ratios](/leverage-ratio-forex/). The company must maintain [net debt-to-EBITDA](/net-debt-to-ebitda/) below stated thresholds (typically 3.5–4.0x). Covenant compliance depends on sustaining advertising revenue and managing costs tightly. Any significant revenue decline—from macroeconomic [recession](/recession/) or secular radio decay—risks covenant breach, triggering defaults and potentially forcing asset sales or restructuring.
...
[Share buybacks](/share-buyback/) are essentially nonexistent. The company lacks the cash flexibility to repurchase shares while managing debt service and capital spending. Equity value appreciation depends on debt reduction and EBITDA growth—neither of which is assured in a secular decline in traditional radio.
...
Cumulus' [market-capitalization](/market-capitalization/) typically reflects the residual equity value after debt claims. With [net debt](/net-debt/) often exceeding $1.5B and equity market cap in the $500M–$800M range, the equity is thin relative to debt. This structure means that equity investors benefit materially from debt reduction but suffer sharply if cash flows decline or refinancing fails.
