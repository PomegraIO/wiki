...
description: "A community bank holding company serving the Southern Tier region of New York and Northern Pennsylvania with retail and commercial banking services."
keywords: ["community bank", "regional bank", "retail banking", "commercial lending", "New York"]
---
...
<tr><td>Ticker</td><td>CHMG</td></tr>
<tr><td>Listing</td><td>NASDAQ</td></tr>
<tr><td>SEC CIK</td><td>763563</td></tr>
...
Chemung Financial's response was to remain focused on its geographic and customer niche while modernizing operations. The bank invested in technology (automated lending systems, online banking) while maintaining the local relationships. It also grew through [acquisition](/acquisition/) — purchasing other small banks in neighboring regions, which expanded the geographic footprint and brought in new customer relationships. This growth-by-acquisition was partly a response to stagnation in organic growth: as the local market matured and younger generations moved away, the bank needed to expand territory to maintain growth.

## The Deposit Base and Funding Model

Community banks are traditionally deposit-funded — they rely on checking accounts, savings accounts, and [money market accounts](/money-market-account/) from local depositors rather than on wholesale funding or national deposit markets. This is both a strength and a vulnerability. The strength is that deposits can be stable and relatively low-cost if the bank is trusted and embedded in the community. The vulnerability is that in a rising interest-rate environment, depositors can move to higher-yielding alternatives ([money market funds](/money-market-fund/), [Treasury bills](/treasury-bill/), bonds), and the bank must raise deposit rates to compete. When the [cost of deposits](/balance-sheet/) rises, net interest margin declines.
