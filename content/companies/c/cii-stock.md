---
title: "BlackRock Enhanced Large Cap Core Fund, Inc. (CII)"
description: "CII is a closed-end investment fund holding large-capitalization U.S. equities enhanced with covered-call strategies to generate yield, distributing income and gains to shareholders."
keywords:
  - closed-end fund
  - large-cap equities
  - covered calls
...
**What does [BlackRock](/blk-stock/) Enhanced Large Cap Core Fund actually do?**

CII is a closed-end fund that holds a portfolio of large-cap U.S. stocks selected for quality and value, and supplements that with an option-writing strategy ([covered calls](/covered-call/)) to enhance income. The fund buys and holds the stock, writes [call options](/call-option/) against its positions, collects the premium from those options, and distributes the resulting income and capital gains to shareholders. The covered-call strategy generates extra cash flow, which allows CII to pay a higher distribution than a simple buy-and-hold [index fund](/index-fund/) would, but at the cost of capping the upside on particularly strong moves in the underlying stocks.

**Why would a shareholder want income from covered calls rather than [dividends](/dividend/) alone?**
...
**How does this perform in bull and [bear markets](/bear-market/)?**
