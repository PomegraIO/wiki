---
title: "ChampionsGate Acquisition Corp (CHPG)"
description: "ChampionsGate Acquisition Corp is a blank-check company that raised $74.75 million in its May 2025 IPO and is searching for a business to acquire and merge with."
keywords:
  - SPAC
  - blank check company
  - acquisition
...
ChampionsGate [Acquisition](/acquisition/) Corp is a blank-check company. This means the company has no operating business. Instead, it raised money from investors and will use that money to find another company—called the target—to buy or merge with. If you bought shares in ChampionsGate, you are betting that the people running it will find a good target at a good price.
...
The company is set up as a holding company incorporated in the Cayman Islands, which is common for blank-check vehicles. The shares trade on the [Nasdaq](/nasdaq/) under the ticker CHPG.
...
If you own ChampionsGate shares, you have a few things that could happen. First, the company could announce a target and propose a [merger](/merger/). Shareholders would then vote on whether to accept the deal or ask for their money back—this is called redemption. If enough shareholders vote no, the deal may not proceed. If it does, your shares convert into shares of the new combined company.
