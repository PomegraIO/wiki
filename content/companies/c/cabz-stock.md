---
title: "Roundhill Robotaxi, Autonomous Vehicles & Technology ETF (CABZ)"
description: "CABZ is an actively managed ETF providing equity exposure to robotaxi and autonomous vehicle companies, from sensor manufacturers and software developers to ride-hailing platforms deploying self-driving fleets."
keywords:
  - robotaxi
  - autonomous vehicles
  - self-driving cars
...
The fund launched at a moment of genuine excitement about robotaxis becoming a transportation reality rather than a speculative future, but that narrative can easily reverse if a high-profile robotaxi accident occurs, regulators slow permitting, or operating costs prove higher than expected. CABZ's concentrated bet on a narrow, capital-intensive theme means its returns will be far more volatile than the broader [stock market](/stock-market/), and it can move sharply down as well as up.

## Investment approach and costs

Roundhill's team manages the fund actively rather than tracking an index, allowing them to shift weightings and holdings as the autonomous vehicle landscape evolves. The fund's 0.59 percent [expense ratio](/expense-ratio/) is reasonable for an actively managed [equity ETF](/equity-etf/) but not cheap. The fund trades like a standard equity ETF on the [stock exchange](/stock-exchange/) and supports options trading, which is useful for investors wanting to hedge or structure positions.
