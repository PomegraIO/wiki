...
description: "ConocoPhillips is an independent oil and natural gas company built through a century of exploration, acquisition, and consolidation, extracting and producing crude oil, natural gas, and liquefied natural gas from reserves across Alaska, the Lower 48, Europe, Asia, and Australia."
keywords:
  - oil and gas
...
Key metrics to track: production volumes and trends in each region, which indicate whether the company is growing, flat, or declining. Realized prices (the actual prices the company received for its oil and gas) relative to global benchmarks show whether the company is capturing value. Operating costs per unit of production reveal whether efficiency is improving. [Free cash flow](/free-cash-flow/) generation and capital spending allocation show whether the company is disciplined with capital. Reserve replacement ratios indicate whether the company is finding and developing new reserves to replace what it produces. And commentary on political risk, sanctions impacts, and regulatory headwinds in key producing regions affects the forward outlook for the business.
