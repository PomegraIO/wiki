---
title: "Carnival Corp Ltd (CCL)"
description: "Carnival is the world's largest cruise operator by fleet and passenger capacity, operating multiple cruise lines with ships of varying size and price point."
keywords:
  - cruise industry
  - vacation travel
  - leisure hospitality
...
<table>
<tr><th>Ticker</th><td>CCL (NYSE)</td></tr>
<tr><th>Domicile</th><td>UK/Panama (dual-listed)</td></tr>
<tr><th>Founded</th><td>1972 (Carnival Cruise Line); 2011 (current corporate form after merge)</td></tr>
<tr><th>Primary brands</th><td>Carnival, Princess, Holland America, Cunard, Costa, AIDA, Seabourn, P&O Cruises, others</td></tr>
<tr><th>Business model</th><td>Ship ownership & leisure passenger operations</td></tr>
<tr><th>Fleet scale</th><td>Approximately 100+ vessels globally</td></tr>
<tr><th>SEC CIK</th><td>0000815097</td></tr>
</table>
</aside>
...
Operating costs are dominated by fuel (a major input cost that varies with oil prices), crew wages and benefits, port fees, ship maintenance and dry-dock (expensive periodic overhauls), [depreciation](/depreciation/) and [amortization](/amortization/) of the vessel fleet, and general overhead.
...
Within that duopoly, Carnival has an edge in lower-end, mass-market cruising (the Carnival, Holland America, and Costa brands [target](/tgt-stock/) middle-income families and retirees), while Royal Caribbean specializes in newer, larger, more upscale vessels. This positioning matters: during [recessions](/recession/), the mass-market segment (Carnival's core) can be particularly vulnerable as discretionary spending contracts.
...
Carnival's debt burden is a defining feature of its financial structure. Before the pandemic, the company operated with debt levels typical of mature cruise operators. The pandemic debt spike, combined with meager profitability in 2021–2022, left the company with a [leverage ratio](/leverage-ratio-forex/) (debt-to-EBITDA) far above historical norms. Management has prioritized debt reduction over [dividends](/dividend/), suspending the dividend during and after the pandemic and only gradually resuming capital returns as profitability improved.
