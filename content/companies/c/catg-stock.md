---
title: "Leverage Shares 2X Long CAT Daily ETF (CATG)"
description: "CATG is a leveraged exchange-traded product that aims to deliver twice the daily return of Caterpillar stock, using derivatives and debt to amplify price swings."
keywords:
  - leveraged ETF
  - daily reset
  - Caterpillar stock
...
CATG tracks a single underlying: [Caterpillar](/cat-stock/) Inc. stock. It does not own Caterpillar shares directly. Instead, it uses [futures contracts](/futures-contract/), swaps, and margin debt to construct a position that targets a 2:1 [leverage ratio](/leverage-ratio-forex/). On a day when Caterpillar rises 2%, CATG aims to rise 4%. On a day it falls 3%, CATG aims to fall 6%. The leverage is reset daily, which means the fund recalibrates its derivatives position at the close of each trading day.
