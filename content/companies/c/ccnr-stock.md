---
title: "ALPS/CoreCommodity Natural Resources ETF (CCNR)"
description: "CCNR is a diversified natural resources ETF tracking companies engaged in extraction, processing, and distribution of oil, gas, metals, and agricultural commodities."
keywords:
  - natural resources
  - commodity exposure
  - energy stocks
...
Mining companies discover metallic ore deposits, extract the ore, and transform it into finished metals traded globally. This includes copper, gold, silver, [iron ore](/iron-ore/), lithium, cobalt, nickel, and dozens of others. Gold miners are often viewed as portfolio diversifiers because gold prices tend to move independently of stocks and even inversely during financial stress. Industrial metals miners—copper, cobalt, lithium—are tightly tied to manufacturing demand and economic growth.
...
CCNR is a passive, index-tracking ETF holding a portfolio of natural resources companies designed to mirror a published index. The index construction typically weights companies by [market capitalization](/market-capitalization/), so larger producers carry higher weight than smaller ones. Because the fund is passively managed, the [expense ratio](/expense-ratio/) is low—covering only the cost of holding and rebalancing the portfolio, not active stock selection.

The fund trades on an exchange and can be bought or sold any trading day at prices close to its underlying [net asset value](/net-asset-value/). Liquidity is generally solid, allowing investors to enter and exit without unusual spreads.
