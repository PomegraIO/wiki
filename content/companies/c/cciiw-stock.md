---
title: "Cohen Circle Acquisition Corp. II (CCIIW)"
description: "Cohen Circle Acquisition Corp. II is a blank-check acquisition company (SPAC) with warrant units outstanding, seeking a merger target to acquire."
keywords:
  - SPAC
...
[Cohen Circle Acquisition Corp. II](/ccii-stock/) (OTC: CCIIW) is a special purpose [acquisition](/acquisition/) company — often called a SPAC or blank-check company — and the ticker represents warrant units issued as part of a shell company structure designed to identify, merge with, and take public a private operating business. The prevalence of SPACs reveals something fundamental about how capital seeks scale: a traditional [initial public offering](/initial-public-offering/) requires an operating company to be mature enough to pass regulatory scrutiny, hire underwriters, and market shares to thousands of investors. A SPAC inverts the process. Capital is raised first (from institutional and retail investors) into a shell company, the shell then hunts for a target, and the [merger](/merger/) serves as the back-door listing. This structure has advantages and stubborn disadvantages.

<aside class="wiki-infobox">
<table>
<tr><th>Ticker (warrant)</th><td>CCIIW (OTC Markets)</td></tr>
<tr><th>Company type</th><td>Special Purpose Acquisition Company (SPAC)</td></tr>
<tr><th>Status</th><td>Seeking merger target or combination</td></tr>
<tr><th>Domicile</th><td>Delaware (typical for SPACs)</td></tr>
<tr><th>Purpose</th><td>Acquire and take public a private operating company</td></tr>
<tr><th>SEC CIK</th><td>0002064683</td></tr>
<tr><th>Capital raised</th><td>Via public offering of units (common stock + warrants)</td></tr>
</table>
</aside>

## What is a SPAC and how does it work?

A SPAC is a publicly traded shell company with cash but no operating business. It raises capital by selling units to public investors — each unit typically containing one common share, one warrant (a right to buy shares at a set price), and sometimes a fractional right to additional warrants or [preferred stock](/preferred-stock/). The founders and sponsors retain a smaller number of shares (the "[founder shares](/founder-shares/)") at minimal cost as their skin in the game.
...
SPAC investors should monitor the merger timeline carefully. As the SPAC approaches its deadline to find a target, leverage shifts in the sponsors' favour — they have an incentive to complete *any* merger to keep the company public (versus liquidating). Investors have [redemption rights](/redemption-rights-equity/) before the merger closes (the ability to cash out their shares at trust-account value), which creates a discipline mechanism, but redemption itself can undermine the merger's economics by forcing the sponsors to raise more capital.

The warrant component specifically becomes more valuable if and when the merger target performs well post-closing. Investors in CCIIW are holding a [call option](/call-option/) on that future success. The key numbers to track are the target's disclosed financials, the terms of the merger agreement (what dilution is imposed on existing shareholders and warrant holders), and any lock-up or sponsor-aligned terms that might conflict with public shareholders' interests.
