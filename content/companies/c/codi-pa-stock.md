---
title: "Compass Diversified Holdings Series A Preferred (CODI-PA)"
description: "Compass Diversified preferred shares represent a fixed-income claim on the holding company, paying a stated dividend ahead of common equity but subordinate to debt."
keywords:
  - preferred stock
  - fixed income
  - dividend priority
...
<table>
<tr><th>Ticker</th><td>CODI-PA (NASDAQ)</td></tr>
<tr><th>Security type</th><td>Preferred stock</td></tr>
<tr><th>Claim on assets</th><td>Ahead of common; behind debt</td></tr>
<tr><th>Dividend</th><td>Stated fixed rate, paid quarterly</td></tr>
<tr><th>Parent company</th><td>Compass Diversified Holdings</td></tr>
<tr><th>SEC CIK (parent)</th><td>0001345126</td></tr>
</table>
</aside>
...
Compass raises capital in layers. At the bottom are the equity holders—the common shareholders. Above them sit the preferred shareholders. At the top, senior to all equity, are the debt holders: banks providing loans or bondholders who have lent money to the holding company. Each layer has different economics and different claims on the cash.

The company uses these different tools strategically. When acquisition opportunities are plentiful and the company wants to maintain leverage flexibility, it might issue preferred shares to raise capital without increasing debt. When market conditions are favorable, it might issue common stock. When the company is conserving capital, it might simply retain earnings and buy back its own shares.

## Comparing CODI-PA to the common stock

The common stock, CODI, offers a higher potential yield and upside if the holding company grows earnings faster than it grows distributions. But it also carries the full downside if acquisitions disappoint or cash generation falls. CODI-PA offers a fixed, stated dividend that is senior to the common, providing more cushion if the business deteriorates—but it sacrifices upside. If Compass thrives and cash generation accelerates, preferred shareholders don't directly benefit; they continue to receive their fixed dividend while the common stock soars.

For a conservative income investor, the preferred shares represent a middle ground. They are easier to understand than the complexity of owning fractional stakes in Compass's portfolio of unrelated businesses, and they offer more safety than common equity. They trade more like bonds than like stocks, though they lack the maturity certainty of an actual bond.

## How to track CODI-PA

The yield is the primary metric. Calculate it as the stated annual dividend divided by the share price. If you own or are considering the shares, monitor the company's cash distribution from its subsidiaries and the company's debt levels. If cash generation weakens or debt rises, the company might be tempted to suspend the preferred dividend to preserve capital.

Watch for calls. If interest rates fall significantly, the company might redeem the shares and replace them with a lower-rate preferred series. Read the prospectus to understand the call date and call price.

Finally, track the parent company's fundamentals. Because the preferred shares are claims on Compass's cash, understanding how many of the portfolio companies are generating strong cash, whether the company is finding good acquisition opportunities, and whether its strategy is working is essential to assessing the safety of the preferred dividend.
