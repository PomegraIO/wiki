---
title: "Concourse Capital Focused Equity ETF (CCFE)"
description: "An actively managed equity ETF holding a concentrated portfolio of U.S. large-cap stocks selected by Concourse Capital Management—a small-number approach to mega-cap investing."
keywords:
...
*A **focused [equity ETF](/equity-etf/)** is an [actively managed fund](/actively-managed-fund/) holding a deliberately small number of carefully chosen large-cap stocks, betting that deep conviction in a curated list of companies outweighs the safety of owning hundreds of names.*
...
The fund discloses its holdings regularly, usually daily, so you can see exactly what Concourse owns at any moment. That transparency is a strength of the ETF structure—unlike a [mutual fund](/mutual-fund/) that might update holdings quarterly or annually, an ETF can show you the full picture nearly in real time.
...
Beyond volatility, the core risk is selection error. Even experienced investors misjudge valuations, miss business deterioration, or misidentify catalysts. With only 50 to 80 holdings, bad calls are not hidden by [diversification](/diversification/).
