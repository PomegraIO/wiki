---
title: "WisdomTree China ex-State-Owned Enterprises Fund (CXSE)"
description: "CXSE is an equity fund tracking publicly traded Chinese companies while excluding state-owned enterprises, offering exposure to China's private sector and avoiding direct government entities."
keywords:
  - China equity
  - emerging markets
...
<div class="wiki-infobox-title">CXSE — key facts</div>

|   |   |
|---|---|
| **What it tracks** | Chinese publicly listed companies, excluding state-owned enterprises |
| **Underlying index** | WisdomTree China ex-SOE Index |
| **Fund type** | Equity ETF |
| **Expense ratio** | Modest, typical of equity ETFs (exact rate varies) |
| **Trading** | US exchanges (like a stock) |
| **Main sectors** | Technology, discretionary consumer, financials (varies by holdings) |
| **Primary risk** | China regulatory, geopolitical tensions, currency |
| **Benchmark currency** | US dollar (though underlying stocks trade in yuan) |
