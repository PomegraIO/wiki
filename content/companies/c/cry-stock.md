---
title: "GraniteShares YieldBOOST CRCL ETF (CRY)"
description: "A covered-call ETF tracking the Nasdaq-100 with systematic call selling to enhance current yield — trading the upside cap for higher income in flat to rising markets."
keywords:
  - covered call
  - yield enhancement
  - nasdaq-100
...
*The **GraniteShares YieldBOOST CRCL ETF** (ticker CRY) is a covered-call strategy fund that tracks the Nasdaq-100 index while systematically selling [call options](/call-option/) against its holdings to generate extra income — transforming a growth-oriented index into a yield-producing vehicle for investors willing to cap their upside.*

> "Upside in exchange for current income." That is the fundamental trade a covered-call fund makes.

The Nasdaq-100 is the hundred largest non-financial companies on the [Nasdaq](/nasdaq/) exchange — a concentration of technology, consumer, and biotech heavyweights like [Apple](/aapl-stock/), [Microsoft](/msft-stock/), [Tesla](/tsla-stock/), and [Nvidia](/nvda-stock/). By itself it is a growth index; it does not prioritise [dividend](/dividend/) income. The Nasdaq-100 throws off modest yields (often below 1 per cent), which makes it less attractive to investors hunting for current cash flow.

The YieldBOOST strategy addresses that shortfall by selling call options on the Nasdaq-100 holdings systematically. For each stock in the index, GraniteShares writes [covered calls](/covered-call/) — options that obligate the fund to sell shares at a predetermined [strike price](/strike-price/) if the stock rises above that level. Investors who buy the fund receive the proceeds from selling those calls as additional yield. In a flat or modestly rising market, this mechanism can double or even triple the fund's annual yield compared to owning the naked index.
...
GraniteShares is a subsidiary of Granite Point Capital, an asset-management and investment firm. The fund has been structured as a straightforward ETF — it trades on an exchange like any other fund, with intraday pricing and tight [bid-ask spreads](/bid-ask-spread/) — rather than as a [closed-end fund](/closed-end-fund/), which gives it lower fees and more liquidity.

The fund's [expense ratio](/expense-ratio/) is modest for the strategy it pursues. Because the covered-call overlay requires active management and option expertise, CRY costs more to operate than a passive Nasdaq-100 tracker, but less than many actively managed equity funds. The fund holds all 100 stocks in the underlying index, so it is broadly diversified across the constituents, although the Nasdaq-100 itself is concentrated — the top ten holdings typically make up nearly half the index's weight, so a downturn in mega-cap tech ripples through the fund's entire portfolio.
