---
title: "Central Pattana Public Company Limited (CTPUF)"
description: "Thailand's largest shopping mall operator and property developer, listed on the Stock Exchange of Thailand and trading via ADR in the US — a real estate company grown from Bangkok mall owner to regional mixed-use developer riding Thailand's consumer cycles."
keywords:
  - shopping malls
  ...
  - emerging markets cyclicality
handwritten: true
---

Central Pattana is Thailand's largest operator of shopping malls and mixed-use developments, and one of the country's most recognizable property companies. The company began as a single mall developer and has grown into a regional property operator with a portfolio of malls, office buildings, residential projects, and entertainment venues spread across Bangkok and major Thai cities. It trades on the [Stock Exchange](/stock-exchange/) of Thailand as CPN and via [American Depositary Receipt](/adr/) in the US as CTPUF. The company's fortune is tied directly to Thai consumer confidence, tourism, and urban development cycles — making it a pure play on Thailand's boom-and-bust economic patterns.

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>CTPUF (OTC/ADR)</td></tr>
<tr><th>Listed</th><td>Stock Exchange of Thailand (CPN)</td></tr>
<tr><th>Sector</th><td>Real estate / retail property</td></tr>
<tr><th>Primary business</th><td>Shopping malls, mixed-use developments</td></tr>
<tr><th>Founded as operator</th><td>1980s, expanded through 1990s-2000s</td></tr>
<tr><th>Geography</th><td>Bangkok and regional Thai cities</td></tr>
<tr><th>SEC CIK</th><td>0001551468</td></tr>
</table>
</aside>
...
Central Pattana files with the Stock Exchange of Thailand and issues Thai-language financial statements and [annual reports](/10-k/). For English-language information, the company publishes investor-relation materials on its website and the ADR depositary (usually Citibank or a similar [custodian](/custodian/)) provides English translations of key filings. The SEC filing from its CIK (0001551468) may include limited detail, as Thai companies often provide less granular disclosure than US companies. Key metrics to watch include occupancy rates by property, tenant composition and average rents, capital expenditure plans, and the health of the Thai property market and consumer spending. Tourism arrivals to Bangkok and Thailand are a [leading indicator](/leading-indicator/) of Central Pattana's retail tenant performance and premium-space utilization.
