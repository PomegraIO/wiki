---
title: "Clough Hedged Equity ETF (CBLS)"
description: "CBLS is an actively managed ETF that holds US large-cap equities while using put-option strategies to hedge downside risk, aiming to reduce portfolio volatility while capturing gains."
keywords:
  - hedged equity
  - put options
  - downside protection
...
CBLS is an attempt to square a circle that has frustrated investors for decades: own stocks and participate in [bull markets](/bull-market/), but walk away with less damage when the market falls hard. The fund achieves this by holding a portfolio of US large-cap equities — household names like technology, healthcare, and industrial companies — while simultaneously purchasing [put options](/put-option/) on those holdings or on a broad equity index. A put is an option contract that rises in value when the underlying stock or index falls. By owning puts, the fund pays a known cost (the [option premium](/option-premium/)) in exchange for a payment later if prices tank.

The hedge is not free. The fund pays ongoing premiums for put protection, which comes out of returns in calm markets. When the [stock market](/stock-market/) is flat or rising steadily, those premiums drag on performance compared to an unhedged large-cap fund. The closer investors look at quiet years, the more the drag is visible — perhaps 0.5% to 1% per year, depending on [implied volatility](/implied-volatility/) and the specificity of the hedging program. The real value shows up in corrections: when large-cap equities fall 15%, an unhedged fund falls 15%. CBLS may fall only 8% or 10%, because the puts appreciate and offset some of the stock losses. In extreme [bear markets](/bear-market/), the hedge is worth multiples of the annual premium cost, but such extremes arrive infrequently.
