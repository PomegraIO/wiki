---
title: "Global X S&P 500 Christian Values ETF (CHRI)"
description: "CHRI holds the 500 largest U.S. companies but excludes those involved in abortion services, contraception, gambling, alcohol, tobacco, weapons, and other practices the fund identifies as conflicting with Christian ethics."
keywords:
...
*Global X S&P 500 Christian Values ETF (CHRI) is an exchange-traded fund that owns a filtered version of the S&P 500, excluding companies whose business practices conflict with explicitly defined Christian ethical principles — a values-screened [index fund](/index-fund/) that lets investors hold broad U.S. large-cap stocks without ownership of specific sectors and companies.*

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>CHRI (NASDAQ)</td></tr>
<tr><th>Sponsor</th><td>Global X (Mirae Asset subsidiary)</td></tr>
<tr><th>Index tracked</th><td>Global X S&P 500 Christian Values Index</td></tr>
<tr><th>Universe</th><td>S&P 500 constituents (after ethical screens)</td></tr>
<tr><th>Excluded sectors/practices</th><td>Abortion services, contraception, alcohol, tobacco, gambling, weapons, cannabis, pornography</td></tr>
<tr><th>Weighting method</th><td>Market capitalization (of filtered constituents)</td></tr>
<tr><th>Liquidity</th><td>Good; trades with reasonable spreads on secondary markets</td></tr>
<tr><th>Size relative to S&P 500</th><td>Smaller and more concentrated; fewer holdings</td></tr>
</table>
</aside>
...
The fund's [expense ratio](/expense-ratio/) is modest — slightly higher than a basic [S&P 500 index](/sp-500-index/) ETF to cover the ongoing costs of screening, research, and rebalancing, but not dramatically so. The fund trades on the [NASDAQ](/nasdaq/) with good liquidity and tight [bid-ask spreads](/bid-ask-spread/). Turnover is driven by the underlying S&P 500 index's changes and by any shifts in which companies meet the Christian values criteria.
