---
title: "Critical Metals Corp. (CRML)"
description: "A mineral exploration and development company focused on identifying and acquiring rare-earth and critical-mineral deposits to supply the battery and renewable-energy supply chains."
keywords: ["minerals", "rare earths", "extraction", "battery materials", "supply chain"]
---

*The global energy transition is reshaping mineral demand in ways that few companies are positioned to exploit. While [Tesla](/tsla-stock/) and other manufacturers race to build electric vehicles and renewable energy installations, the upstream question of where the raw materials originate remains fragmented and geographically uncertain. **Critical Metals (CRML)** sits at that intersection, part of the junior exploration and development sector that searches for economic deposits of elements essential to decarbonization—cobalt, nickel, lithium, and rare earths—in regions where mining is politically feasible and geologically prospective. The company's value lies not in extraction operations (it does not yet have a producing mine) but in the land position, the geological knowledge, and the optionality to develop or partner if market conditions align.*

<aside class="wiki-infobox"><table>
<tr><td><strong>Ticker</strong></td><td>CRML</td></tr>
<tr><td><strong>Listing</strong></td><td>OTC Markets / Small-cap</td></tr>
<tr><td><strong>SEC CIK</strong></td><td>1951089</td></tr>
<tr><td><strong>Sector</strong></td><td>Materials / Natural Resources</td></tr>
...
### Closely related
- [Commodity Markets](/stock/) (pricing and supply dynamics)
- [Mining and Extraction Industry](/stock-exchange/) (broader sector context)
- [Rare-Earth Elements](/public-company/) (strategic importance and supply constraints)

### Wider context
- [Energy Transition Economics](/balance-sheet/) (long-term demand drivers)
- Geopolitical Risk in Supply Chains (regulatory and political uncertainty)
