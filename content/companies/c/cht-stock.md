---
title: "Chunghwa Telecom Co., Ltd. (CHT)"
description: "Chunghwa Telecom is Taiwan's largest integrated telecommunications operator, providing mobile, fixed-line broadband, and information technology services to consumers and enterprises."
keywords:
  - taiwan telecom
  - mobile operator
  - broadband provider
...
| Aspect | Detail |
|---|---|
| **Country** | Taiwan (headquarters: Taipei) |
| **Market position** | Largest integrated telecom operator in Taiwan |
| **Founded** | 1996 (as a privatized company); heritage operations date to 1901 |
| **Listing** | Taiwan Stock Exchange (symbol 2412); NYSE ADR (symbol CHT) |
| **Main services** | Mobile, fixed-line, broadband, ICT/cloud services |
| **Key milestone** | First operator in Taiwan to launch 5G (June 2020), LTE (May 2014) |
