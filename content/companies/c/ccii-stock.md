---
title: "Cohen Circle Acquisition Corp. II (CCII)"
description: "Cohen Circle Acquisition Corp. II is a blank-check company (SPAC) sponsored by the Cohen family; it was formed to identify and acquire a promising private business to merge with publicly."
keywords:
  - SPAC
  - blank-check company
...
Cohen Circle [Acquisition](/acquisition/) Corp. II is a special purpose acquisition company, more commonly known as a SPAC or blank-check company. Like all SPACs, it was incorporated for a single purpose: to raise capital from public investors and use that capital to acquire a private company, bringing the target into public markets through a [merger](/merger/) rather than a traditional [initial public offering](/initial-public-offering/).

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>CCII (public markets)</td></tr>
<tr><th>Type</th><td>Special purpose acquisition company (SPAC)</td></tr>
<tr><th>Sponsor</th><td>Cohen Circle</td></tr>
<tr><th>Purpose</th><td>Identify and acquire a private operating company</td></tr>
<tr><th>Capital structure</th><td>Public shares + sponsor equity + warrants</td></tr>
<tr><th>Transaction status</th><td>Seeking merger target</td></tr>
...
Cohen Circle Acquisition Corp. II was established as a blank-check company — a shell corporation with no operating business, formed solely to raise public capital for an acquisition. The company held an initial public offering in which investors bought shares and received warrants ([call options](/call-option/) on additional shares at a fixed price). The capital raised was held in a trust, available for use only when and if the SPAC identified a target company and announced a merger.
