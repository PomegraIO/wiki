---
title: "Leverage Shares 2X Long CRWV Daily ETF (CRWG)"
description: "CRWG is a leveraged ETF tracking twice the daily moves of CrowdStrike, the endpoint-security and threat-intelligence leader — a single-stock instrument built for tactical traders with near-term bullish conviction."
keywords:
  - leveraged ETF
  - daily reset
  - CRWG
...
On a day when CRWD rises, CRWG targets a move twice as large. Fall 1%, CRWG falls 2%. Rise 3%, CRWG rises 6%. The leverage is reset each night, which means the fund "forgets" any prior days' performance and starts fresh with a 2X exposure to the next day's move. This design works precisely as advertised for single-session trades. It breaks down over weeks or longer.

## Volatility decay: mathematical and inevitable

Suppose CRWD drops 15% in a sharp correction, then recovers 18% a week later. It ends modestly higher overall. CRWG drops 30% during the correction, then gains 36% on the recovery, for a net gain of roughly 2.4% — much better than the flat outcome of the stock, but the leverage has done heavy lifting both ways. Now imagine instead CRWD chops sideways: up 2%, down 2%, up 1%, down 1.5% over four days, ending up 1.5% total. CRWG, rebalancing each night, lags that 3X return (1.5% × 2) and may end up ahead by only 2.5% instead of 3%, eroding 0.5 percentage points from what a naive leverage assumption would predict.

Volatility decay is not failure; it is how the mathematics of daily rebalancing works. The higher the realized volatility of CRWD, the more severe the drag. Cybersecurity stocks can be volatile, especially around earnings or after major geopolitical cyber incidents.
...
Read CRWG's fact sheet and prospectus for the exact rebalancing formula and the types of derivatives in use. Track CRWG's daily returns against 2X of CRWD's returns over a one-week and one-month period; consistent underperformance signals high volatility. Research CrowdStrike's competitive position — its endpoint-detection market share, customer concentration, pricing power, and product roadmap — because CRWG is ultimately a concentrated bet on that one company.

CRWG is a tactician's tool, not a wealth-building vehicle. Use it with a clear thesis, a defined time horizon, and a stop-loss. Anything longer than a few weeks is playing with fire.
