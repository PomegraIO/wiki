---
title: "Carisma Therapeutics Inc. (CARM)"
description: "Clinical-stage cell therapy company engineering allogeneic natural killer and T cells for solid tumors and hematologic cancers."
keywords: ["allogeneic cell therapy", "natural killer cells", "off-the-shelf immunotherapy", "clinical oncology"]
---
...
<tr><td><strong>Ticker</strong></td><td>CARM</td></tr>
<tr><td><strong>Listing</strong></td><td>NASDAQ</td></tr>
<tr><td><strong>SEC CIK</strong></td><td>1485003</td></tr>
<tr><td><strong>Sector</strong></td><td>Biotechnology</td></tr>
<tr><td><strong>Industry</strong></td><td>Cell Therapy and Immunotherapy</td></tr>
...
Carisma's founding and early evolution coincided with growing recognition across the cell therapy field that manufacturing was a critical constraint. As CAR-T therapies expanded beyond Juno and [Novartis](/nvs-stock/) to include additional companies and indications, the bottleneck became more acute. Carisma's allogeneic pivot offered a differentiated answer to a real scaling problem. Other companies pursued similar strategies, but Carisma's specific engineering approach and focus on indications where early data looked promising carved out a niche. The company's trajectory depends on whether its engineered allogeneic cells prove clinically superior or at least equivalent to existing therapies—and whether manufacturing and costs actually achieve the scalability advantage that motivated the company's founding choice.

<div class="wiki-seealso">
### Closely related
- [Cell therapy manufacturing and regulatory pathways](/securities-and-exchange-commission/)
- [Natural killer cells and engineered immunotherapy](/stock/)
- [Allogeneic versus autologous therapies](/public-company/)

### Wider context
- [Immunotherapy in hematologic and solid tumors](/10-k/)
- [Clinical trial design for rare cancers](/stock-exchange/)
- [Biotechnology capital and funding models](/dividend/)
</div>
