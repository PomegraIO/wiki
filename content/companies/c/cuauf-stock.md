---
title: "C3 Metals Inc. (CUAUF)"
description: "A mineral exploration company focused on nickel and copper deposits, trading over-the-counter with exposure to commodity price cycles and exploration risk."
keywords: ["mineral exploration", "nickel", "copper", "over-the-counter", "junior miner", "commodity exposure"]
---
...
<tr><td><strong>Ticker</strong></td><td>CUAUF</td></tr>
<tr><td><strong>Exchange</strong></td><td>OTC (Over-the-Counter)</td></tr>
<tr><td><strong>SEC CIK</strong></td><td>1737319</td></tr>
<tr><td><strong>Sector</strong></td><td>Materials</td></tr>
<tr><td><strong>Industry</strong></td><td>Mineral Exploration</td></tr>
<tr><td><strong>Type</strong></td><td>Junior Mining Company</td></tr>
</table></aside>
...
The embedded economics are asymmetric. If C3 discovers a world-class nickel deposit when nickel prices are in the doldrums, the discovery still has [intrinsic value](/intrinsic-value/)—there is ore in the ground. But the financing and acquisition environment will be harsh, and the company may be forced to sell the asset at a discount to intrinsic value. Conversely, a marginal discovery made when commodity prices are elevated may attract inflated valuations. A disciplined investor recognizes this timing risk and avoids buying junior mining equity purely because metals are in a [bull market](/bull-market/).
...
CUAUF trades on the [over-the-counter market](/over-the-counter-market/), not on a major exchange like [NASDAQ](/nasdaq/) or NYSE. OTC stocks typically have wider [bid-ask spreads](/stock/), lower daily trading volumes, and less analyst coverage. This creates [liquidity risk](/liquidity-risk/): if an investor owns a significant stake and needs to exit, they may face a sharp discount to the theoretical [fair value](/fair-value/) to find a buyer, or may need to execute the sale over days to avoid moving the price dramatically. OTC trading also invites promotional schemes and less rigorous disclosure practices, though C3, as an SEC registrant, is subject to periodic reporting requirements.
