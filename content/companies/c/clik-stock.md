---
title: "Click Holdings Ltd. (CLIK)"
description: "Digital marketing and affiliate-platform company monetizing traffic aggregation and lead routing, primarily serving the gaming and betting verticals."
keywords: ["digital marketing", "affiliate", "lead generation", "gaming", "commission-based", "performance marketing"]
---

*Click Holdings Ltd. (CLIK) is a digital marketing and affiliate-network company that aggregates internet traffic—primarily from gaming, betting, and iGaming channels—and routes it to merchant customers, earning a commission (or CPA: cost-per-action basis) for each qualified lead, sign-up, or deposit. The core unit is a single click or conversion: CLIK's cost to acquire or serve that traffic from publishers, its quality (the probability the routed user converts at the merchant), and the margin between what the merchant pays per conversion and CLIK's [acquisition](/acquisition/) cost.*

<aside class="wiki-infobox"><table>
<tr><td>Ticker</td><td>CLIK</td></tr>
<tr><td>Listing</td><td>NASDAQ</td></tr>
<tr><td>SEC CIK</td><td>2020027</td></tr>
<tr><td>Sector</td><td>Technology/Digital Marketing</td></tr>
<tr><td>Industry</td><td>Internet Services</td></tr>
...
### Closely related
- [CLGN (CollPlant)](/clgn-stock/) — Technology licensing with upfront and milestone components
- [CLMB (Climb Global)](/clmb-stock/) — Reseller and platform-aggregation model

### Wider context
- [/earnings-per-share/](/earnings-per-share/) — How affiliate-network revenue translates to EPS
- [/free-cash-flow/](/free-cash-flow/) — Working capital timing in CPA models
- [/10-k/](/10-k/) — Disclosure of vertical concentration and merchant dependencies
