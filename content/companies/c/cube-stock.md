...
description: "CubeSmart operates a network of self-storage facilities across North America, renting climate-controlled and standard storage units by the month to individuals and small businesses—a real-estate investment trust with recurring tenant revenue and operational leverage."
keywords:
  - self-storage
  - reit
  - real estate
...
*CubeSmart is the second-largest operator of self-storage facilities in the United States, trading on the [stock exchange](/stock-exchange/) as CUBE. It is structured as a real-estate investment trust — a REIT — which means it owns or controls the real property directly and collects rent from tenants who lease individual units by the month. The company also manages facilities owned by third parties, earning [management fees](/management-fee/) on properties it does not own outright.*

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>CUBE (NYSE)</td></tr>
<tr><th>Founded</th><td>1998 as CubeSmart; REIT since 2004</td></tr>
<tr><th>Business model</th><td>Real-estate investment trust; owns and operates self-storage facilities</td></tr>
<tr><th>Primary revenue</th><td>Monthly rent from self-storage units; management fees from third-party properties</td></tr>
<tr><th>Tenant base</th><td>Residential customers, small businesses, and seasonal renters</td></tr>
<tr><th>Geographic presence</th><td>United States and Canada</td></tr>
<tr><th>SEC CIK</th><td>0001298675</td></tr>
</table>
</aside>
...
Operating expenses include property taxes (which vary widely by jurisdiction and market), insurance, labour (security, maintenance, cleaning), utilities (for climate control in certain units), and advertising to attract tenants. A well-run facility can achieve [operating margins](/operating-margin/) of 50 percent or higher, because once a customer is in a unit, the cost to maintain that occupancy is mostly wages and utilities. The profit is then available to service debt (if the property is leveraged), pay [dividends](/dividend/) (as a REIT must), and reinvest.
...
The company funds growth and [acquisitions](/acquisition/) with a mix of [retained earnings](/retained-earnings/), debt (mortgages on properties), and equity issuance. Most [self-storage REITs](/self-storage-reit/) operate with modest [leverage ratios](/leverage-ratio-forex/) (debt to [EBITDA](/ebitda/) in the range of 3x to 5x) to maintain access to capital markets and preserve financial flexibility. During periods of high [interest rates](/interest-rate/), debt service costs rise, which can pressure dividends if occupancy or rent growth does not offset the increase.

## Occupancy, pricing power, and competition

Self-storage occupancy moves with the broader economy. During growth periods (low unemployment, rising home turnover), occupancy expands and rent can rise. During [recessions](/recession/), occupancy often holds up well — people still need storage — but rent growth stalls and sometimes falls as operators compete for tenants. The sector has consolidated around a handful of major players (CubeSmart, [Public Storage](/psa-stock/), Life Storage, and a handful of others), which means pricing power is shared among them rather than truly competitive.
...
Anyone evaluating CubeSmart should start with its annual 10-K (CIK 0001298675), which details the portfolio by region, occupancy trends, and average unit rents. The quarterly earnings reports show the trend in same-store [net operating income](/net-operating-income/) — a measure of profitability on the existing property base before debt service — and management's commentary on pricing power and customer trends.

Key metrics to watch include occupancy (higher is better), average unit rent (should grow at or above [inflation](/inflation/)), and same-store NOI growth (the measure of operational performance on comparable properties). The dividend yield and [payout ratio](/payout-ratio/) indicate how much cash the company is returning relative to what it earns. Debt levels and interest coverage show financial stability.
