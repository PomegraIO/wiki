---
title: "Capri Holdings Ltd (CPRI)"
description: "A multinational fashion conglomerate controlling heritage luxury and contemporary brands, competing on brand equity and global distribution."
...
<tr><td><strong>SEC CIK</strong></td><td>1530721</td></tr>
<tr><td><strong>Sector</strong></td><td>Consumer Discretionary</td></tr>
<tr><td><strong>Industry</strong></td><td>Luxury Apparel & Accessories</td></tr>
<tr><td><strong>Type</strong></td><td>Multinational Fashion Conglomerate</td></tr>
</table></aside>
...
Capri is a [publicly listed company](/public-company/) traded on the [New York Stock Exchange](/nasdaq/) under ticker CPRI, with comprehensive SEC disclosures available via [CIK 1530721](/securities-and-exchange-commission/). Investors should examine the [10-K](/10-k/) for segment breakdowns showing which brands are growing, [gross margins](/gross-profit-margin/) by brand, and inventory levels. Luxury goods companies often carry elevated inventory (especially seasonal goods), so inventory trends are a key early warning signal of demand stress. Additionally, examining comparable [earnings-per-share](/earnings-per-share/) trends across other luxury conglomerates (LVMH, Richemont, Kering) provides context for Capri's relative performance and cyclicality exposure.

<div class="wiki-seealso">
### Closely related
- [/cpri-stock/](/cpri-stock/)
- /luxury-goods-sector/
- /brand-equity/
