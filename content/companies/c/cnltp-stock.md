---
title: "Connecticut Light & Power Company (CNLTP)"
description: "Connecticut Light & Power operates as a regulated electricity distribution utility, delivering power to residential and commercial customers across Connecticut under state regulatory oversight that determines rates and acceptable returns."
keywords:
  - utility regulation
  - power distribution
  - Connecticut
...
|   |   |
|---|---|
| **Business type** | Regulated electric utility (distribution only) |
| **Franchise territory** | Connecticut, United States |
| **Main revenue source** | Residential and commercial electricity delivery |
| **Regulator** | Connecticut Public Utilities Regulatory Authority (PURA) |
| **Rate base growth** | Tied to capital investment approved by regulator |
| **Return on equity** | Typically 8-10% (set by regulator) |
| **SEC CIK** | 0000023426 |
...
Connecticut Light & Power's costs fall into several categories. Purchased power (wholesale electricity) is typically the largest cost category and is passed through to customers via an adjustment clause, so it does not directly compress the utility's margin. Operating costs include labor (linemen, engineers, customer service, management), vehicle and equipment maintenance, tree trimming (to prevent outages), and administrative expenses. These are spread across the kilowatt-hours delivered, so operational efficiency (fewer workers per megawatt-hour served, better asset utilization) improves margin.

Capital costs are the defining feature. The company must own and maintain thousands of miles of power lines, poles, transformers, and substations across Connecticut. These assets are expensive and long-lived, so the company invests billions in them and depreciates them over decades. The regulator allows the company to earn a return on this invested capital (the "rate base"), so larger capital investment means larger allowed profit in dollar terms. This creates an incentive to invest in the grid, which is good for reliability and long-term growth but can lead utilities to over-invest if not carefully monitored.
...
Connecticut Light & Power faces ongoing pressure to upgrade its distribution network to support new technologies: distributed rooftop solar, battery storage, electric vehicle charging, and other forms of distributed energy. These require significant capital investment in grid control systems, advanced metering, and two-way power flow capability. The company must also interconnect these resources safely and maintain grid stability. The regulator typically allows the company to earn a return on these "grid modernization" investments, but the outcome is far from certain—a regulator could decide that the costs are unreasonable or that the benefits to customers do not justify the investment.
