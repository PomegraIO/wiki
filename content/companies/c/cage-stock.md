...
CAGE tracks the MerQube US Large-Cap Vol Advantage Autocallable Growth Index, which targets a 1.3 beta to the S&P 500—meaning the fund is designed to move 30 percent more than the broad market in both directions. The fund gains this exposure synthetically through a [total return swap](/total-return-swap/), a derivative contract between Calamos and a counterparty where Calamos receives returns matching the autocallable index and pays [SOFR](/sofr/) plus 10 basis points.
...
The fund's net [expense ratio](/expense-ratio/) is 0.74 percent, reasonable for a synthetic structured product but higher than a simple equity [index fund](/index-fund/). The structure itself is complex; readers should ensure they understand autocallables and synthetic derivatives before committing capital to CAGE.
