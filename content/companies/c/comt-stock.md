---
title: "iShares GSCI Commodity Dynamic Roll Strategy ETF (COMT)"
description: "A commodity futures index fund tracking the Goldman Sachs Commodity Index across energy, metals, and agriculture, using a dynamic rolling strategy to manage contango and backwardation costs."
keywords:
  - commodity ETF
  - futures index
...
<div class="wiki-infobox-title">COMT — key facts</div>

| Aspect | Detail |
|--------|--------|
| **Tracks** | Goldman Sachs Commodity Index (GSCI) |
| **Components** | Crude oil, natural gas, gold, copper, corn, wheat, soybeans, and others |
| **Structure** | Commodity futures ETF |
| **Issuer** | BlackRock (iShares brand) |
| **Rebalancing** | Dynamic roll strategy; adjusts rolling dates based on futures curve shape |
| **Monthly rebalancing** | Maintains production-weighted index composition |
| **Expense ratio** | Approximately 0.70–0.75% annually |
| **Trading** | Major exchange-traded vehicle with solid liquidity |
