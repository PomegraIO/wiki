...
Key metrics to watch include [net interest margin](/wiki/net-interest-margin/) (the spread between lending and deposit rates, which is central to profitability), [loan-to-deposit ratio](/wiki/loan-to-deposit-ratio/) (a measure of how much of the funding base is deployed into earning assets), and [nonperforming loan ratio](/wiki/nonperforming-loan/) (a leading indicator of credit stress). The company's stress test results, released annually, show how much capital it could lose in a severe downturn and inform the minimum capital it must maintain.
