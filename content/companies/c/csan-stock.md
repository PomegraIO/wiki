...
description: "Brazilian multinational with operations spanning fuel distribution, sugar and ethanol production, logistics, and commodity trading; a vertically integrated industrial player across energy and agriculture."
keywords: ["Cosan", "CSAN", "Brazil", "ethanol", "sugar", "fuel distribution", "logistics"]
---
...
Cosan's operational calendar is driven by the sugarcane harvest, which runs roughly April to November in the southern hemisphere. During crush season, mills run continuously, thousands of trucks move cane, and working capital swings sharply. In the off-season, mills undergo maintenance, the company refines strategy, and cash flows are leaner. This seasonality shapes financial planning—capital expenditures, debt management, and [dividend](/dividend/) policy must all account for lumpy harvest cycles and uneven cash generation.

## Geographic Dependence and Currency Exposure

The company's dominance in Brazil is its greatest strength and its [concentration risk](/concentration-risk/). Nearly all mills, plantations, and a large share of its fuel network sit in Brazil. The company earns revenue in [Brazilian reals](/brazilian-real/) and faces currency exposure when exporting ethanol (priced in dollars) or importing fuel. Severe currency [depreciation](/depreciation/) against the dollar hurts ethanol export margins; currency appreciation makes fuel imports expensive. Cosan must decide how much of its commodity exposure to hedge, a decision that shapes quarterly and annual volatility.
