---
title: "CalciMedica, Inc. (CALC)"
description: "Biotech firm developing therapeutics for acute kidney injury and cardiovascular conditions by targeting calcium-signaling dysregulation in cell membranes."
keywords: [biotech, acute kidney injury, cardiovascular, drug development, clinical stage, cell signaling]
---

*[CalciMedica, Inc.](/calc-stock/) (CALC) is a clinical-stage biopharmaceutical company focused on discovering and developing drugs that modulate calcium signaling in human cells, with lead programs aimed at acute kidney injury and ischemic cardiovascular disease. The company's approach rests on a hypothesis that abnormal calcium flows across cell membranes drive tissue injury in these conditions.*

<aside class="wiki-infobox"><table>
<tr><td>Ticker</td><td>CALC</td></tr>
<tr><td>Listing</td><td>NASDAQ</td></tr>
<tr><td>SEC CIK</td><td>1534133</td></tr>
...
As a clinical-stage [public company](/public-company/), CalciMedica relies on [equity](/common-stock/) financing, periodic capital raises, and potential grant funding to support R&D. The company's [balance sheet](/balance-sheet/) reflects typical biotech profiles: limited to no product revenue, operating losses, and cash burn to fund its pipeline. Investors in CalciMedica are essentially betting on the validity of the calcium-signaling hypothesis and the company's ability to reach clinical milestones without running out of money. [Public equity](/stock/) markets value such firms on a mix of mechanism novelty, management track record, and estimated runway to next value-inflection event (typically a Phase 2 interim data readout).

The company's [market capitalization](/market-capitalization/) fluctuates with clinical announcements, competitive developments, and broad biotech sentiment. No [dividend](/dividend/) is expected; the financial model assumes reinvestment or future M&A.
...
- /biopharmaceutical/ (if available)
