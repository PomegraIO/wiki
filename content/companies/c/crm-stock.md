...
description: "Salesforce builds cloud-based software for customer relationship management, marketing, sales, and service — helping businesses of all sizes organize their customer interactions and automate workflows."
keywords:
...
<table>
<tr><th>Ticker</th><td>CRM (NYSE)</td></tr>
<tr><th>Founded</th><td>1999, San Francisco, California</td></tr>
<tr><th>Founder</th><td>Marc Benioff, Parker Harris</td></tr>
<tr><th>Sector</th><td>Enterprise software and cloud services</td></tr>
<tr><th>Core product</th><td>Salesforce CRM</td></tr>
<tr><th>Business model</th><td>Recurring cloud software subscriptions</td></tr>
<tr><th>SEC CIK</th><td>0001108524</td></tr>
</table>
</aside>
...
Salesforce's annual 10-K (SEC CIK 0001108524) breaks revenue by product (CRM, Service Cloud, Marketing Cloud, Commerce Cloud, Tableau) and by geography. It provides detail on subscription revenue, which is the most important component of the business. The company reports several key metrics in its quarterly earnings reports: remaining [performance obligations](/performance-obligation/) (the unrecognized value of signed contracts, which signals future revenue), net retention rate (whether customers are expanding spending), and calculated churn rates.

Key metrics worth tracking: annual recurring revenue (ARR), which represents the subscription revenue the company expects to collect over a year — this grows with new customer acquisition and net expansion within existing customers. Free [cash flow conversion](/cash-flow-conversion/), showing whether the company is turning revenue into actual cash. [Operating margin](/operating-margin/) trends, which reveal whether the company is becoming more efficient or investing heavily in growth. [Deferred revenue](/deferred-revenue/) and remaining performance obligations provide visibility into future revenue. And qualitative commentary on customer wins, churn, and competitive dynamics helps you assess whether the underlying business is accelerating or facing headwinds.
