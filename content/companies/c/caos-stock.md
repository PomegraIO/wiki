---
title: "Alpha Architect Tail Risk ETF (CAOS)"
description: "CAOS is a specialized ETF that aims to profit from or hedge against extreme market downturns by holding out-of-the-money put options and other tail-hedging instruments alongside equities."
keywords:
  - tail risk hedge
  - put options
  - portfolio insurance
...
*A **[tail risk](/tail-risk/) hedge** attempts to profit from or protect against rare, catastrophic market events — the extreme left side of the return distribution where truly devastating losses occur. The Alpha Architect Tail Risk ETF (CAOS) embodies this by holding a core equity portfolio alongside [put options](/put-option/) and other crisis-protection instruments, allowing investors to sleep through volatility spikes that would otherwise trigger panic.*

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>CAOS (NASDAQ)</td></tr>
<tr><th>Fund sponsor</th><td>Alpha Architect</td></tr>
<tr><th>Fund type</th><td>Active ETF with derivatives overlay</td></tr>
<tr><th>Strategy</th><td>Tail-risk hedging using options</td></tr>
<tr><th>Underlying exposure</th><td>U.S. equities + protective puts</td></tr>
<tr><th>Management</th><td>Rules-based, systematic</td></tr>
</table>
</aside>
