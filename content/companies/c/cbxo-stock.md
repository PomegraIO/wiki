---
title: "Calamos Bitcoin 90 Series Structured Alt Protection ETF – October (CBXO)"
description: "A structured Bitcoin ETF with monthly resets aligned to October. Part of Calamos' series of derivative-based Bitcoin products designed for investors seeking price exposure paired with built-in downside caps."
keywords:
  - bitcoin
  - structured ETF
  - downside protection
...
When Bitcoin emerged from near-zero value to thousands of dollars per coin, then tens of thousands, the asset attracted serious money. Yet even as institutional investors acknowledged Bitcoin's role in a portfolio, they discovered they could not simply buy Bitcoin directly. Their risk policies, their client risk tolerance, or their regulatory constraints demanded something more structured. Spot Bitcoin holdings had no built-in guardrails; spot Bitcoin ETFs, when they arrived, tracked Bitcoin but offered no protection. For sophisticated investors accustomed to option-based insurance or liability-matching strategies, unadorned Bitcoin was unsatisfying.

This gap is what structured Bitcoin products address. Calamos, as an asset manager with deep experience in derivatives and structured solutions, recognized the opportunity and built a series of products that layered protective mechanics onto Bitcoin exposure. The family of funds—differentiated by protection levels (80, 90 series) and reset schedules (January, April, October)—represents an effort to offer a menu of risk profiles for different investor appetites.
...
CBXO exists in a landscape now crowded with Bitcoin derivatives. Spot Bitcoin ETFs have proliferated since regulatory approvals in major markets, and they offer simplicity and low costs. Futures-based Bitcoin ETFs exist for investors seeking leveraged or inverse exposure. Calamos' structured approach sits in a specific niche: for investors who want positive Bitcoin exposure, moderate costs, and explicit downside protection that reduces volatility. It is not the cheapest option (spot Bitcoin ETFs cost less), and it is not the simplest (that is spot Bitcoin). It is a middle path, acceptable to investors who have made peace with the trade-offs.
...
For researchers evaluating CBXO today, the key steps remain the same: read the prospectus to understand the exact mechanics, study the fact sheet to see all costs, look at the actual calendar returns in volatile and quiet markets, and decide whether the protection profile is worth the price in the context of your broader portfolio strategy.
