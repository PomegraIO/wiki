---
title: "Congress Intermediate Bond ETF (CAFX)"
description: "CAFX is an actively managed bond ETF holding investment-grade US fixed-income securities, targeting a three- to five-year duration to capture yield while limiting exposure to interest rate changes."
keywords:
  - intermediate bonds
  - fixed income
...
<img src="https://images.unsplash.com/photo-1590283603385-9b6a9d5b3f56?w=600&q=80" alt="Bond certificates and financial charts with upward trend lines" />

<div class="wiki-infobox-caption">Intermediate-term bonds provide yield with manageable sensitivity to interest rate moves.</div>

| **What it is** | Actively managed investment-grade bond ETF |
|---|---|
| **Sponsor** | Congress Asset Management Company, LLP |
| **Ticker** | CAFX |
| **Launched** | September 2024 |
| **Expense ratio** | 0.35% |
| **Benchmark** | Bloomberg US Intermediate Govt/Credit Index |
| **Distribution** | Monthly income; annual capital gains |
