---
title: "CITY HOLDING CO (CHCO)"
description: "CITY HOLDING CO is a regional bank holding company trading as CHCO, with operations primarily in the mid-Atlantic and Appalachian regions."
...
Bank deposits are optionally sticky. During calm periods, customers keep deposits with their local bank. During stress—whether firm-specific (concerns about the bank's solvency) or industry-wide (perceived weakness in smaller banks)—depositors move cash to larger, perceived-safer banks. CITY HOLDING faced this risk acutely in 2023-2024 when regional banks faced deposit runs. Although CHCO did not face the acute stress of Silicon Valley Bank or Signature Bank, smaller regional banks always face the risk that a crisis elsewhere in the region or sector triggers depositor anxiety about their own bank.

If CHCO experiences significant deposit outflows, it must replace funding at higher rates, further compressing NIM. And if the outflows coincide with a rising-rate environment, the opportunity cost of holding cash (rather than deploying it in loans) rises. The bank then faces a choice: hold excess liquidity and suffer negative returns, or raise rates on deposits to compete for funding and further erode margins.
...
Regional banks face ongoing regulatory capital requirements that consume earnings. If CHCO's [return-on-equity](/return-on-equity/) (ROE) is constrained by having to hold more capital to meet regulatory buffers, shareholders get less benefit from any earnings growth. Larger banks can leverage their capital base more efficiently due to scale; smaller banks cannot. This is a structural disadvantage that CHCO cannot escape.

Additionally, if regulators become more stringent about regional bank oversight (in response to stress elsewhere in the sector), CHCO may face higher compliance costs and tighter constraints on lending or investments, further dampening ROE.

## The Dividend and Capital Return Risk

Many investors buy regional bank stocks for the [dividend](/dividend/). But dividends are the first cut if earnings weaken or if the bank faces capital constraints. CITY HOLDING's dividend is sustainable only if net interest income remains stable and loan losses remain contained. A recession that hits unemployment or real estate values would likely force a dividend cut, which is why bank stocks fall hard during downturns—not just from lower earnings, but from dividend disappointment.
