...
For long-term investors, the company's debt-to-EBITDA ratio and interest coverage are material to monitoring solvency and financial flexibility in a downturn. The [return on assets](/wiki/return-on-assets/) is often depressed by seasonal working-capital swings and is better evaluated on a through-cycle basis. Competitive intensity in airport locations and the trajectory of ride-sharing adoption will also shape returns; if ride-sharing eliminates a material portion of short-trip rentals, Avis Budget's profit model will be pressured.
