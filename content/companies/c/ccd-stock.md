---
title: "Calamos Dynamic Convertible & Income Fund (CCD)"
description: "A closed-end fund managed by Calamos Investments that invests in convertible securities and dividend-paying stocks, seeking total return through a mix of income and capital appreciation."
keywords:
  - closed-end fund
...
Calamos Dynamic Convertible & [Income Fund](/income-fund/) trades on the [NASDAQ](/nasdaq/) under the ticker CCD. Think of it as a fund that buys two types of securities: [convertible bonds](/convertible-bond/) (debt that can turn into stock) and regular dividend-paying stocks, betting that this combination will generate both regular income and the potential for share-price appreciation. Calamos Investments, the manager, has spent decades specializing in convertible securities.

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>CCD (NASDAQ)</td></tr>
<tr><th>Fund type</th><td>Closed-end fund</td></tr>
<tr><th>Manager</th><td>Calamos Investments</td></tr>
<tr><th>Launch date</th><td>2003</td></tr>
<tr><th>Focus</th><td>Convertible securities and dividend stocks</td></tr>
<tr><th>Objective</th><td>Income and total return</td></tr>
<tr><th>SEC CIK</th><td>0001602584</td></tr>
</table>
</aside>

## What convertible bonds are

A convertible bond is a hybrid security. On the surface, it looks like a regular bond: a company borrows money and promises to pay you interest every year, then repay the principal at a set date. But this bond comes with a special feature: if the company's stock shoots up in value, you get the option to convert the bond into a fixed number of shares instead of taking back your money. If the stock price goes nowhere, you still collect your interest and get your principal back. This unusual combination makes convertible [bonds](/bond/) attractive to investors who want income like a bondholder but also participation if the company does really well.
