---
title: "VictoryShares US Small Cap High Div Volatility Wtd ETF (CSB)"
description: "A small-cap dividend ETF that tilts toward higher-yielding, lower-volatility stocks — combining dividend focus with a measure of downside dampening."
keywords:
  - small cap
  - dividend yield
  - low volatility
...
*The **VictoryShares US Small Cap High Div Volatility Wtd ETF** (ticker CSB) invests in US small-capitalisation companies that pay [dividends](/dividend/) and exhibit lower price volatility, weighting the portfolio inversely by volatility — so smaller, steadier dividend payers carry more weight.*
