---
title: "Central Pattana Public Co Limited/ADR (CPNNF)"
description: "Thai real-estate developer and shopping-mall operator; balance sheet dominated by property assets and secured debt against physical real estate."
keywords: ["real estate", "property", "shopping mall", "Thailand", "balance sheet", "fixed assets"]
---

*A Thai real-estate operator whose entire business is real property—shopping centers, office complexes, mixed-use developments—**Central Pattana Public Co Limited** (ticker **CPNNF**, [American Depositary Receipt](/adr/) form) is a balance-sheet story reduced to land, buildings, and the secured debt issued against them. The firm's financial health is the ratio of property value to debt service.*

<aside class="wiki-infobox"><table>
<tr><td>Ticker</td><td>CPNNF</td></tr>
<tr><td>Listing</td><td>OTC (ADR)</td></tr>
<tr><td>SEC CIK</td><td>1551468</td></tr>
<tr><td>Sector</td><td>Real Estate</td></tr>
<tr><td>Industry</td><td>Property Development & Retail</td></tr>
<tr><td>Type</td><td>Real Estate Investment & Operations</td></tr>
</table></aside>

## Property as the Core Asset

Central Pattana is not a landlord taking a small fee; it is a substantial property owner and operator. The balance sheet asset side is dominated by real estate at cost (or [fair value](/fair-value/), depending on accounting policy), [depreciation](/depreciation/) adjustments, and the land and building accounts. In Thailand, as in most markets, property is typically the biggest line item—not inventory, not cash, not intangibles. A single shopping center can carry a $200 million asset value. Central Pattana operates multiple properties; the consolidated asset base is substantial.
...
Look for revaluation gains or losses in the equity section or in footnotes. Thailand's accounting standards allow property revaluation; understand whether Central Pattana uses [cost basis](/cost-basis/) or fair value.
...
### Closely related
- [/balance-sheet/](/balance-sheet/) — structure for asset-heavy industries
- [/real-estate-investment-trust/](/real-estate-investment-trust/) — similar business model comparison
- [/corporate-bond/](/corporate-bond/) — debt issuance by real-estate operators
- [/cpop-stock/](/cpop-stock/) — contrast with entertainment/media balance sheet

### Wider context
- [/10-k/](/10-k/) — property schedules and management discussion
- [/enterprise-value/](/enterprise-value/) — valuation of asset-intensive businesses
- [/return-on-equity/](/return-on-equity/) — efficiency of capital in property operations
</div>
