...
description: "Cboe is a global operator of derivatives exchanges and markets—platforms where traders buy and sell options, futures, and other derivatives, and the company profits from transaction fees and market data."
keywords:
...
Cboe Global Markets operates electronic exchanges and trading platforms where professional traders, [market makers](/market-maker-trading/), and institutions buy and sell derivatives—primarily options and [futures contracts](/futures-contract/). An options exchange is a venue where traders agree on prices for the right (but not the obligation) to buy or sell an underlying asset like a stock or an index at a future date. A futures exchange is where traders lock in prices for future delivery of commodities, financial instruments, or indices. Cboe operates the world's largest options exchange (Cboe Options Exchange, or CBOE), major [derivatives exchanges](/derivatives-exchange-crypto/) in several countries, and a range of specialised venues for different asset classes. It also acquired large data and analytics businesses and volatility index products that have become central to how traders hedge and manage risk.
...
The structure of trading itself has changed dramatically in recent decades. Pit trading—where [brokers](/broker/) and market makers shouted orders at one another on an exchange floor—has been replaced almost entirely by electronic trading, where orders are submitted through computer networks and executed in milliseconds. This electronic structure has lowered costs and improved execution, but it has also created new risks: [algorithmic trading](/algorithmic-trading/), [high-frequency trading](/high-frequency-trading/), and the potential for flash crashes where prices move in unexpected directions with no clear reason. Regulators have responded with [circuit breakers](/circuit-breaker/) and [trading halts](/trading-halts/) that pause markets if prices move too quickly, and with rules aimed at preventing market manipulation.
