---
title: "Celularity Inc (CELU)"
description: "Biotechnology company developing allogeneic cell and gene therapies for cancer and inflammatory diseases."
keywords: ["cell therapy", "immunotherapy", "biotechnology", "clinical development", "cell medicine"]
---
...
<tr><td>Ticker</td><td>CELU</td></tr>
<tr><td>Listing</td><td>Nasdaq</td></tr>
<tr><td>SEC CIK</td><td>1752828</td></tr>
<tr><td>Sector</td><td>Healthcare</td></tr>
<tr><td>Industry</td><td>Biotechnology - Cell Therapy</td></tr>
<tr><td>Type</td><td>Public Biopharmaceutical Company</td></tr>
</table></aside>
...
Celularity's investors are implicitly betting that at least one of the company's therapies will reach approval and generate sufficient [royalty](/dividend/) income or upfront licensing payments to justify the cumulative R&D investment and capital burn to date. Until that point, Celularity operates at a loss, generating no revenue and accumulating debt or depending on dilutive equity raises.

<div class="wiki-seealso">

### Closely related

- [celz-stock](/celz-stock/) — Regenerative medicine company with related therapeutic approach
- [ceco-stock](/ceco-stock/) — Manufacturing-focused company with different input and customer relationships

### Wider context

- [securities-and-exchange-commission](/securities-and-exchange-commission/) — CELU's regulatory pathway for cell therapy approval
- [balance-sheet](/balance-sheet/) — Critical indicator of Celularity's cash runway and financing needs
- [common-stock](/common-stock/) — Structure of CELU's equity and dilution from clinical-stage capital raises
