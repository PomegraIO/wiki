---
title: "Calamos Bitcoin 90 Series Structured Alt Protection ETF - July (CBXY)"
description: "An exchange-traded fund tracking a structured strategy that aims for bitcoin upside with downside protection through options overlays, resetting monthly."
keywords:
  - bitcoin ETF
  - structured products
  - downside protection
...
The Calamos [Bitcoin](/bitcoin/) 90 Series Structured Alt Protection ETF—ticker CBXY—wraps bitcoin exposure in a framework designed to blunt downturns while keeping most of the gains. It tracks a structured note strategy that uses options to cap downside risk, rolling the protection monthly. Unlike a plain bitcoin fund, which swings with the asset's wild volatility, this one tries to narrow the floor and ceiling of what you can win or lose in any given month.
...
[Concentration risk](/concentration-risk/) is acute. Structured notes are only as good as the issuer. Calamos is a long-running asset manager, but if the issuer runs into trouble, your notes become unsecured claims on a failing firm, and recovery is uncertain.
