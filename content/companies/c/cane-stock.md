---
title: "Teucrium Sugar Fund (CANE)"
description: "An ETN tracking the price of crude and refined sugar futures, offering direct commodity exposure to global sugar markets for investors hedging or speculating on sugar prices."
keywords:
  - commodity ETN
  - sugar futures
  - commodity exposure
...
<table>
<tr><th>Ticker</th><td>CANE (NYSEARCA)</td></tr>
<tr><th>Issuer</th><td>Teucrium Financial LLC / Société Générale</td></tr>
<tr><th>Fund type</th><td>Exchange-traded note (ETN)</td></tr>
<tr><th>Underlying</th><td>ICE Cane Sugar Futures (crude and refined blend)</td></tr>
<tr><th>Asset class</th><td>Agricultural commodity</td></tr>
<tr><th>Rebalancing</th><td>Daily roll forward</td></tr>
<tr><th>Expense ratio</th><td>Typically 0.40% to 0.50% annually</td></tr>
</table>
</aside>
...
Any commodity fund holding a rolling futures position faces a fundamental mechanical risk called [contango](/contango/) decay. Contango occurs when longer-dated futures contracts trade at a higher price than near-term contracts—a normal state when carrying costs (storage, insurance, financing) are positive and expected. When CANE rolls its position (selling near-term contracts and buying longer-dated contracts), it sells at a lower price and buys at a higher price, crystallising a loss each roll.
...
[Backwardation](/backwardation/)—the inverse, where near-term prices exceed deferred prices—reverses the dynamic and can amplify gains, but backwardation in agricultural commodities tends to be temporary, appearing during supply shocks or seasonal stress.

## Who holds CANE and why

CANE serves three main investor types. First are commodity traders and hedgers—farmers, sugar refiners, and confectionery manufacturers who use the fund or underlying futures to lock in prices for their operations. Second are allocators building commodity [diversification](/diversification/) in their portfolios, treating sugar as a non-correlated asset class. Third are speculators betting that sugar prices will rise, seeking leveraged upside exposure to price moves.
...
Anyone considering CANE should start by understanding its prospectus (available from Teucrium and SEC filings) and recent fact sheet, which disclose the current holdings, [expense ratio](/expense-ratio/), and the mechanics of the roll strategy. Comparing CANE's price performance against spot sugar prices (the ICE Cane Sugar Index or equivalent benchmarks) over one, three, and five-year periods reveals the cumulative impact of contango. If spot prices rose but CANE fell, contango decay is the likely culprit.
