---
title: "CONMED Corp (CNMD)"
description: "CONMED is a medical device manufacturer producing surgical instruments, monitoring systems, and patient care equipment used in operating rooms and hospitals, with manufacturing facilities and customer relationships across multiple geographies."
keywords:
...
<table>
<tr><th>Ticker</th><td>CNMD (NASDAQ)</td></tr>
<tr><th>SEC CIK</th><td>816956</td></tr>
<tr><th>Sector</th><td>Healthcare / Medical Devices</td></tr>
<tr><th>Industry</th><td>Surgical instruments & monitoring equipment</td></tr>
<tr><th>Business Model</th><td>Manufacturing + distribution of surgical products</td></tr>
<tr><th>Primary Markets</th><td>United States, Europe, international</td></tr>
</table>
</aside>
...
Key metrics include revenue by segment, gross margin by segment, [free cash flow](/free-cash-flow/) from operations (important in a business with working capital needs), [return on invested capital](/return-on-equity/), capital expenditure as a percentage of revenue, and customer concentration (what percentage of revenue comes from the top 10 customers). Monitor new product approvals and pipeline activity, and watch for any product recalls or regulatory issues that could disrupt operations.
