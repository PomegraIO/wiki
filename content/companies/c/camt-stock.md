...
description: "CAMTEK is an Israeli semiconductor equipment manufacturer that produces automated visual inspection systems and yield-enhancement software for semiconductor and printed circuit board manufacturers worldwide."
keywords:
...
<table>
<tr><th>Ticker</th><td>CAMT (NASDAQ)</td></tr>
<tr><th>Founded</th><td>1997</td></tr>
<tr><th>Headquarters</th><td>Migdal HaEmek, Israel</td></tr>
<tr><th>Sector</th><td>Semiconductor equipment manufacturing</td></tr>
<tr><th>Primary products</th><td>Automated optical inspection systems, yield software</td></tr>
<tr><th>Business model</th><td>Equipment sales, software licenses, service and support</td></tr>
<tr><th>SEC CIK</th><td>0001109138</td></tr>
</table>
</aside>

CAMTEK emerged in the late 1990s as a small Israeli tech startup focused on automated visual inspection — the use of cameras, algorithms, and machine learning to examine semiconductor wafers and circuit boards for defects that are invisible to the human eye or too numerous to inspect manually. As semiconductor fabs grew larger and processes became more complex, the need for automated, real-time defect detection became non-negotiable. CAMTEK developed proprietary algorithms and built integrated inspection systems that could scan an entire wafer, identify deviations from the [target](/tgt-stock/) design, and feed that information back to manufacturing engineers to improve yields. Over two decades, the company evolved from a single-product shop into a suite-based supplier of hardware and software tools that address the full workflow of defect detection, analysis, and yield management.
