---
title: "Columbus Acquisition Corp. (COLAR)"
description: "Warrant issued by Columbus Acquisition Corp., a Cayman Islands-based SPAC. Like all SPAC warrants, it gives holders the right to buy shares at a fixed price in the future."
keywords:
  - SPAC warrant
...
Columbus [Acquisition](/acquisition/) Corp. is a blank-check company. That means it has no business. It exists to find a private company, buy it, and make it public. The company raised money in 2024 and gave investors units. Each unit had a share, a warrant, and the right to get their $10 back if they didn't like the deal.

The warrant part is COLAR. It is now trading on its own.

<aside class="wiki-infobox">
<table>
<tr><th>What it is</th><td>A right to buy Columbus Acquisition shares at a fixed price</td></tr>
<tr><th>Ticker</th><td>COLAR (NASDAQ)</td></tr>
<tr><th>Exercise price</th><td>Set when the IPO happened</td></tr>
<tr><th>Underlying company</th><td>Columbus Acquisition Corp.</td></tr>
<tr><th>Location</th><td>Cayman Islands (registered there)</td></tr>
<tr><th>SEC CIK</th><td>0002028201</td></tr>
</table>
</aside>
...
If Columbus shares hit $15, your warrant is worth at least $3 ($15 minus the $12 [exercise price](/exercise-price/)). You could exercise it, paying $12 to get a share that is now worth $15. You make $3 per warrant.
...
When Columbus announces a [merger](/merger/) with a real company, COLAR's value changes. Now it is partly based on whether people think that target company will do well. If the target looks strong, COLAR's price climbs. If people worry about it, COLAR's price falls.
...
[Market makers](/market-maker-trading/) and traders buy and sell COLAR to profit on the spread between these factors and where they think prices should be. If Columbus shares jump up, COLAR usually jumps up too, but not by the same amount — the percentage gain is usually bigger for the warrant because it is leverage. The opposite happens when shares fall.
...
At some point, COLAR will either be exercised or it will expire. If you exercise, you pay the exercise price (say, $12) and get one share of Columbus. If you do not exercise before the [expiration date](/expiration-date/) — usually five to seven years after the IPO — the warrant is worthless and you get nothing.
