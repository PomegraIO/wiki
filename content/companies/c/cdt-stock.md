...
The capital structure disclosed in quarterly and annual filings shows the allocation between trust account balances (held in restricted instruments for investor protection) and working capital available for transaction fees, legal expenses, and operational overhead. CDT must file [10-k](/10-k/) annual reports and 10-q interim filings disclosing the balance sheet, detailing the trust account, identifying any fees or transfers, and explaining management's progress in identifying merger targets. These documents signal the firm's burn rate, the time remaining under the original charter before liquidation becomes mandatory, and any material negotiations underway.
