...
description: "Aerospace/defense and industrial motion control supplier descended from aviation pioneers. Produces actuation systems, electronics, and specialized industrial equipment."
keywords:
...
**Ticker:** CW (NYSE)  
**Sector:** Aerospace & Defense / Industrial Equipment  
**Founded:** 1929 (through merger of Curtiss Aeroplane and Wright Aeronautical)  
**Business:** Motion control systems, aerospace/defense electronics, industrial equipment  
**SEC CIK:** 26324  
**Key Markets:** Aircraft, defense platforms, oil & gas, power generation
</aside>
...
This shift from builder to supplier was neither accident nor decline, but strategic repositioning. As aircraft design became dominated by larger integrators ([Boeing](/ba-stock/), Lockheed, etc.), Curtiss-Wright developed deeper expertise in specific mission-critical subsystems. The company now derives the majority of its revenue not from selling complete aircraft, but from supplying the actuation, electronics, and control systems that make modern aircraft and weapons systems function. This specialization has proven durable and defensible.
...
The [10-K](/wiki/10-k/) filing is essential. Look for segment revenue trends, gross margins by division, backlog composition, and customer concentration (defense typically shows heavy reliance on a few major platform builders). The company reports backlog and book-to-bill ratios, useful indicators of forward demand.
