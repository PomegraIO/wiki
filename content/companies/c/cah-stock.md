...
description: "Healthcare distributor and provider of pharmaceutical, medical product, and specialty services to hospitals, pharmacies, and clinicians across North America."
keywords:
...
On regulatory filings ([10-K](/wiki/10-k/)), track pharmaceutical distribution volumes and pricing trends (GAAP revenue growth vs. price/volume mix), gross margins by segment, and cash flow from operations. Generic drug penetration and specialty pharmacy growth rates reveal structural shifts. Watch also for changes in relationship with major customers (hospital chains, large pharmacy chains) and any contract wins or losses.

Cardinal's [stock](/wiki/stock/) performance reflects both the stability of healthcare logistics (recurring, essential revenue) and vulnerability to healthcare reform, PBM consolidation, and pricing pressure. The company trades at a moderate valuation given steady cash generation but tempered growth and regulatory/[legal risks](/legal-risk/). Debt levels matter because the company has used leverage to fund acquisitions; monitor [debt-to-EBITDA](/wiki/debt-to-ebitda-ratio/) and interest coverage. Cash [dividends](/dividend/) and share repurchases are important to total shareholder return, funded from operating cash flow.

Key financial metrics to monitor: revenue growth (slow, often mid-single-digit), gross margin (trending down due to pricing pressure), [operating margin](/operating-margin/), free [cash flow conversion](/cash-flow-conversion/), and [return on invested capital](/return-on-invested-capital/). The business generates steady cash but growth is limited without M&A or market share gains. A [recession](/recession/) affects volume (fewer procedures, less medication use) but Cardinal's position in the supply chain provides some insulation; people still take essential medications even in downturns.
