---
title: "Sprott Copper Miners ETF (COPP)"
description: "COPP is an exchange-traded fund that tracks a global portfolio of copper mining companies across the size spectrum, from producers to developers to junior explorers."
keywords:
  - copper mining
  - mining equities
  - commodity exposure
...
Mining companies exist on a development spectrum. At one end sit the majors and mid-tiers: BHP, [Rio Tinto](/rtntf-stock/), Freeport-McMoRan, Antofagasta, and Southern Copper. These are large, capital-intensive operations that produce steady streams of ore, generate cash, pay [dividends](/dividend/), and are scrutinized like any other blue-chip industrial. Their stock prices track ore grades, operating costs, and copper prices, but they rarely move more than 20% in a year because production is visible years ahead.
...
COPP includes all three tiers, with the exact weighting depending on [market capitalizations](/market-capitalization/) and the fund manager's selections. The result is a portfolio that is less volatile than COPJ but still tied to the copper cycle. When copper demand rises and capital is abundant, development and junior stocks in the fund may drive outsized gains. When copper falls or capital flees, the portfolio will still suffer because even large producers see margins compress.

## Who sponsors COPP and how it works

Sprott Asset Management created and manages COPP. The fund is a registered exchange-traded fund, not a [closed-end fund](/closed-end-fund/) or a commodity pool, which means it is transparent, liquid, and regulated like any other ETF. It holds actual equity shares, not derivatives, futures, or streaming contracts.
...
COPP typically carries an [expense ratio](/expense-ratio/) between 0.5% and 0.8%, reflecting the lower trading costs of larger, more liquid constituent stocks compared to juniors. A $100,000 position costs roughly $500–$800 in fees annually.

The fund trades on a US exchange and is liquid enough for retail investors. Shares can be bought and sold during market hours without the wide [bid-ask spreads](/bid-ask-spread/) that plague less-liquid funds. The fund's trading volume is usually sufficient to enter and exit positions at prices close to the underlying NAV.
...
The fund is not leveraged, so there is no daily reset decay. But it is still cyclical, and a multi-year [bear market](/bear-market/) in commodities can cut the fund's value in half or more. Investors in COPP need conviction about long-term copper demand and the patience to hold through drawdowns.
...
COPP suits investors who want broad exposure to copper mining but prefer less extreme volatility than junior-focused funds. It is a natural fit for portfolios that want to bet on long-term copper demand from clean energy, electrification, and manufacturing growth, but want to own a managed basket rather than individual stocks. It also works for investors who want commodity exposure but prefer equity upside to [futures contracts](/futures-contract/) or [commodity ETFs](/commodity-etf/) that track prices directly.
