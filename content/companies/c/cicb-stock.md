---
title: "CION Investment Corp (CICB)"
description: "Closed-end business-development company (BDC) providing debt and equity financing to small and middle-market businesses; publicly traded with externally managed portfolio."
keywords:
...
- Be a closed-end fund, meaning shares are issued once and then trade on exchanges; no daily creation/redemption like an open-end [mutual fund](/mutual-fund/).
...
CION provides both loans and equity. A typical deal structure might pair a senior loan (backed by assets, with first claim on cash) with a junior or mezzanine loan (second claim, higher interest rate), plus an equity co-investment that gives CION upside if the portfolio company succeeds. The mix of debt and equity varies by deal and market conditions.

## How CION Makes Money
...
**Leverage risk:** BDCs can borrow up to roughly 1:1 against equity (a 2x leverage ratio). This amplifies returns but also amplifies losses. If CION's portfolio declines 20% in value, a 2x levered portfolio loses 40% of equity value. In a [recession](/recession/), portfolio company defaults can spike, realized losses mount, and leverage becomes a liability.

**Portfolio company [credit risk](/credit-risk/):** CION's investments are in private companies without the scale, stability, or financial reporting transparency of public firms. A portfolio company may underperform, struggle to refinance debt, or fail outright. CION has limited visibility into operations and minimal control; it is a lender or minority shareholder, not a manager.
...
Read CION's quarterly fact sheets and [10-K](/10-k/) filings, which disclose portfolio composition, asset quality metrics (non-accruals, defaults, valuations), leverage ratios, and realized and unrealized gains. Monitor the net asset value (NAV) per share and the discount or premium of the stock price to NAV; trading at a steep discount to NAV may indicate market concern about asset quality or dividend sustainability. Watch the quarterly earnings call for commentary on deal flow, credit quality, and outlook for the dividend. Compare CION's dividend yield and NAV per share trend to peers to assess relative performance. Track interest rate environments; rising rates typically compress BDC spreads and pressure stock prices. Finally, monitor news on the healthcare, technology, and industrial sectors where CION invests; sector-specific downturns can cascade into portfolio losses.

## The BDC Investor Profile

BDC investors typically seek higher current income than available from bonds or dividend stocks, accepting higher risk in exchange. The typical CION shareholder is an income-focused investor, often in a non-tax-advantaged account (BDCs pass through investment income, creating tax complexity in IRAs but not a fundamental drag). Institutional investors, insurance companies, and endowments also hold BDCs as part of a diversified portfolio. However, BDCs are not stable, capital-preservation vehicles; they are risk assets whose values fluctuate based on credit conditions, interest rates, and the health of the private companies in their portfolios.
