...
Anyone investigating Carrier should start with the company's annual 10-K filing (SEC CIK 0001783180), which breaks down revenue by segment and geography and details the pension and environmental liabilities that weigh on the [balance sheet](/balance-sheet/). The quarterly earnings calls reveal management's confidence in the strength of new orders — a leading indicator of future revenue — and provide color on how regions are performing.
