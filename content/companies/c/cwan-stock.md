...
description: "Clearwater Analytics provides software and analytics services for asset owners, helping them manage and analyze the performance of large portfolios of securities, real estate, and private investments."
keywords:
...
Clearwater Analytics is a software-as-a-service (SaaS) company that serves a specific and valuable niche: large institutions that own billions of dollars in investments—pension funds, insurance companies, endowments, and family offices—need to track, measure, and analyze the performance of those portfolios. Clearwater provides the platform on which they do that work. The company went public in 2021 and trades on NYSE under the ticker CWAN.

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>CWAN (NYSE)</td></tr>
<tr><th>Founded</th><td>2004</td></tr>
<tr><th>Headquarters</th><td>Boise, Idaho</td></tr>
<tr><th>Sector</th><td>Software / financial services technology</td></tr>
<tr><th>Core offering</th><td>Investment analytics and reporting platform</td></tr>
<tr><th>Customer base</th><td>Pension funds, insurance companies, endowments, family offices</td></tr>
<tr><th>Business model</th><td>Subscription SaaS, asset-based pricing</td></tr>
<tr><th>SEC CIK</th><td>0001866368</td></tr>
</table>
</aside>
...
Clearwater was founded in 2004 by Tom Liston as a analytics service specifically for institutional investors. The founding insight was that this data problem was universal among large asset owners but that no incumbent financial software company had built a solution tailored to it well. The company spent its first 15 years growing quietly as a private company, signing up major pension funds, insurance companies, and endowments as subscribers.

The business model is subscriptions: a client pays Clearwater a recurring fee, usually scaled by the amount of assets under management or the number of holdings in the portfolio. This creates recurring, relatively predictable revenue. Once a large institution adopts Clearwater, switching to a competitor is disruptive and expensive because the system has become embedded in how the investment team works.

The company expanded by adding new data integrations (connecting to more custodians and asset managers), adding new types of analytics (performance attribution, risk measurement, peer benchmarking), and extending its customer base geographically, particularly into Europe and Asia. By the time Clearwater went public in early 2021, it had several thousand client organizations and managed analytics for trillions of dollars in assets.

## How Clearwater makes money

Revenue comes from subscription fees charged to asset-owner clients, typically based on the value of assets managed on the platform or the number of accounts or holdings. A large pension fund managing 30 billion dollars would pay more than a smaller endowment managing 500 million. The model is predictable because once a client is signed up, they tend to renew their subscription year after year.
...
Clearwater competes against legacy financial software vendors (firms that built institutional investment systems years or decades ago and have slowly modernized them), newer fintech competitors, and, honestly, spreadsheets. Many asset managers build custom solutions or rely on combinations of tools from multiple vendors, creating data silos and manual work that Clearwater's integrated approach avoids.
...
The company also faces the typical SaaS scaling challenge: as it grows, maintaining the quality of customer support and data integration becomes harder. Adding too many new features too quickly can create bugs and performance issues that hurt customer satisfaction.

## How to research Clearwater Analytics

Begin with the most recent 10-K filing (SEC CIK 0001866368), which provides a detailed description of the product, the market, and the customer base. Look at the revenue breakdown by geography and customer segment to understand which parts of the business are growing fastest.
