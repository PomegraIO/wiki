---
title: "COHU INC (COHU)"
description: "Semiconductor test-equipment manufacturer serving the semiconductor industry's maturation and complexity cycle, from wafer probing to final test."
keywords: ["semiconductor", "testing", "equipment", "manufacturing", "industrial"]
---

*[COHU INC](/cohu-stock/) has operated in the unglamorous, capital-intensive world of semiconductor test equipment—the machinery that validates whether chips work before they ship. The company stands at a midlife inflection point: mature enough to have survived decades of industry consolidation, yet facing headwinds as chip fabrication itself concentrates among a handful of mega-foundries.*

<aside class="wiki-infobox"><table>
<tr><td>Ticker</td><td>COHU</td></tr>
<tr><td>Listing</td><td>NASDAQ</td></tr>
<tr><td>SEC CIK</td><td>21535</td></tr>
<tr><td>Sector</td><td>Semiconductors & Equipment</td></tr>
<tr><td>Industry</td><td>Test Equipment</td></tr>
...
COHU occupies a precarious middle ground. It is large enough to serve a real, enduring need—no chipmaker can test without handling equipment—but too small to be indispensable to the largest customers. It is mature enough to generate [cash flow](/free-cash-flow/) and pay attention to [earnings](/earnings-per-share/), yet not so mature that it commands pricing power. Its growth is pinned to the semiconductor capex cycle, which is lumpy and competitive.
...
As a [public company](/public-company/) with a modest [market capitalization](/market-capitalization/), COHU must balance reinvestment in R&D (essential to keep pace with chip-technology advances) against cash returns to shareholders via [dividends](/dividend/) or [share buybacks](/share-buyback/). Most semiconductor-equipment companies operate on thin but consistent margins. COHU's [balance sheet](/balance-sheet/) reflects decades of operation: manageable [debt](/corporate-bond/) levels, modest leverage, and sufficient working capital to fund operations and modest growth.
...
### Closely related
- [COHU](/cohu-stock/) — Semiconductor equipment and handler technology
- [Semiconductor](/stock/) — Industry overview

### Wider context
- [10-K](/10-k/) — Annual SEC filing for detailed financials and risk factors
- [Public Company](/public-company/) — How listed firms disclose and operate
- [Free Cash Flow](/free-cash-flow/) — Key metric for mature industrials
- [Return on Equity](/return-on-equity/) — Profitability measure for capital-intensive businesses
</div>
