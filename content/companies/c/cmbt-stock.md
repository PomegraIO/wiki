---
title: "CMB.TECH NV (CMBT)"
description: "CMB.TECH is a data-infrastructure and blockchain-services company specializing in cryptocurrency mining, blockchain development, and distributed computing networks for enterprise and emerging-market applications."
keywords:
...
<table>
<tr><th>Ticker</th><td>CMBT (NASDAQ)</td></tr>
<tr><th>Headquarters</th><td>Netherlands (NV structure)</td></tr>
<tr><th>Founded</th><td>2014 (approximate origins)</td></tr>
<tr><th>Primary operations</th><td>Cryptocurrency mining; blockchain development</td></tr>
<tr><th>Focused markets</th><td>Emerging markets; enterprise blockchain solutions</td></tr>
<tr><th>Revenue streams</th><td>Mining operations; software licensing; hosting services</td></tr>
<tr><th>SEC CIK</th><td>0001604481</td></tr>
</table>
</aside>
...
Cryptocurrency mining is commoditized in developed markets where electricity is expensive and competition is fierce, but CMB.TECH has positioned itself to operate in regions where electricity costs or infrastructure allow for profitable operations. The company sources and deploys application-specific integrated circuits (ASICs) optimized for proof-of-work validation—the computational algorithm most prominently used by [Bitcoin](/bitcoin/) and [Ethereum](/ethereum/) (before its transition to proof-of-stake). As the Bitcoin and Ethereum networks validate transactions, miners compete to earn block rewards and transaction fees, making the business fundamentally dependent on cryptocurrency prices and the network's hashrate difficulty.
