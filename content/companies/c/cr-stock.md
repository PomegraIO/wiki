...
description: "Crane Co manufactures engineered products across fluid handling, aerospace & electronics, and payment systems — a diversified industrial with strong positions in niche, regulated markets."
keywords:
...
<table>
<tr><th>Ticker</th><td>CR (NYSE)</td></tr>
<tr><th>Founded</th><td>1855, Stamford, Connecticut</td></tr>
<tr><th>Sector</th><td>Diversified industrial manufacturing</td></tr>
<tr><th>Business segments</th><td>Fluid Handling, Aerospace & Electronics, Payment & Merchandising</td></tr>
<tr><th>SEC CIK</th><td>1944013</td></tr>
</table>
</aside>
...
Investors researching Crane should begin with its annual [10-K filing](/wiki/10-k/) (SEC CIK 1944013), which details revenue by segment, discusses market conditions, and lays out the company's strategic priorities. The quarterly earnings calls are valuable for understanding the trajectory of each segment, especially the shift in Payment & Merchandising and the health of aerospace and energy markets. Attention to [free cash flow](/wiki/free-cash-flow/) generation and [capital allocation](/wiki/capital-allocation/) — whether the company is investing in growth, returning capital via [dividends](/wiki/dividend/) and buybacks, or pursuing acquisitions — reveals management's confidence in the business. Crane has historically been a [dividend](/wiki/dividend/) payer, and the steadiness of that return alongside operational performance provides a frame for assessing shareholder value creation. Like any [stock](/wiki/stock/), Crane trades on the public market at prices set by supply and demand, reflecting estimates of future earnings, cash flow, and strategic position.
