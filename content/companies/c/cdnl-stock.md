---
title: "Cardinal Infrastructure Group Inc. (CDNL)"
description: "An infrastructure and asset management firm specializing in infrastructure projects and portfolio operations with geographic focus on North American assets."
keywords: ["infrastructure", "asset management", "project development", "North America", "CIK 2079999"]
---
...
Infrastructure projects require large capital investments. Cardinal's ability to finance projects depends on accessing capital markets that value infrastructure assets. Some capital sources are geographically concentrated or have preferences for specific regions. Pension funds and insurance companies investing in infrastructure may have mandates to favor projects in specific states or regions. International capital sources (Canadian pension funds, Australian superannuation, European [infrastructure funds](/pe-infrastructure-fund/)) may have geographic mandates or preferences. Cardinal must position itself to attract capital from these sources for specific projects. A toll road in Texas may appeal to investors with North American mandates; a water treatment facility in a rural area may appeal only to local or patient capital sources. The firm's ability to access favorable financing terms is geographically variable.
