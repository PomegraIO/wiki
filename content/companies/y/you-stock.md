...
description: "Biometric identity company operating airport expedited security and B2B identity verification platforms, with growing revenue from consumer memberships and enterprise services."
keywords:
...
| Revenue Source | Description | Growth Driver | Recurrence | Risk Profile |
|---|---|---|---|---|
...
[10-K](/wiki/10-k/) — SEC annual report; check for segment disclosures and risk factors.
