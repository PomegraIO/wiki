---
title: "Yext, Inc. (YEXT)"
description: "A digital-presence management software company that helps enterprise brands maintain consistent, searchable business information across search engines, maps, and AI assistants, expanded by the acquisition of Hearsay to include regulatory compliance for financial services."
keywords:
...
Yext is a software company that solves a deceptively complex problem: making sure a business's official information (address, hours, phone number, product catalog, reviews, offers) stays accurate and consistent everywhere customers might search for it. In an era where the same business data scatters across Google, [Apple](/aapl-stock/) Maps, Bing, Amazon Alexa, ChatGPT, and dozens of other search and AI systems, this mission has become central to enterprise marketing. Yext's core product is a platform where a brand manages its information once, then distributes it — rules, corrections, and all — to all the places where that data appears. The company went public on the NYSE in 2012 (ticker YEXT) and has positioned itself as the "operating system for modern customer identity," particularly after acquiring Hearsay, a compliance-first software vendor serving the regulated financial services industry.

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>YEXT (NYSE)</td></tr>
<tr><th>Founded</th><td>2006, New York City</td></tr>
<tr><th>Founder</th><td>Howard Lerman</td></tr>
<tr><th>Sector</th><td>Software / digital presence management / enterprise SaaS</td></tr>
<tr><th>Core product</th><td>Yext Platform (information management & distribution)</td></tr>
<tr><th>Business model</th><td>Subscription SaaS with usage-based components</td></tr>
<tr><th>Major acquisition</th><td>Hearsay (2023, compliance-focused software for financial services)</td></tr>
<tr><th>SEC CIK</th><td>1614178</td></tr>
</table>
</aside>
...
**Price competition from integrated platforms**: [Salesforce](/crm-stock/), HubSpot, [Adobe](/adbe-stock/), and other all-in-one marketing platforms are adding listing management and location features to their suites. For customers who already use Salesforce, adding location management as a Salesforce module is cheaper than a separate Yext contract. This trend threatens Yext's pricing power for mid-market and smaller enterprise deals.
...
Start with the company's [10-K filing](/wiki/10-k/) (SEC CIK 1614178), which breaks out revenue by segment (legacy Yext vs. Hearsay post-acquisition) and geographic region, and lays out the customer concentration and retention metrics. Key metrics to watch:
