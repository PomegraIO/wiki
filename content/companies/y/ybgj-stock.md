---
title: "Yubo International Biotech (YBGJ)"
description: "A small China-based biotechnology company focused on stem-cell research and wellness products, trading on OTC markets with limited public disclosures."
keywords:
  - biotech
  - stem cell therapy
  - china
...
The specifics of Yubo's revenue streams are not well-documented in public filings, which is typical for OTC-listed companies that have minimal SEC filing obligations. The company likely generates income through some combination of product sales (whether stem-cell-derived therapeutics, wellness supplements, or both), licensing arrangements, or consulting and research contracts. Without detailed quarterly or annual disclosures, it is difficult to know which segment drives the business or how profitable operations actually are.

This opacity is itself a risk signal. Investors in larger biotech firms can track revenue by product line, understand cash burn rates, and monitor the pipeline of drugs in development. With a micro-cap OTC stock, that visibility rarely exists, and claims about the company's prospects often rest on press releases or promotional materials rather than audited results.
...
**Currency and geopolitical exposure:** Any operations or revenue streams based in mainland China carry exposure to currency movements (the yuan versus the dollar), capital controls, and geopolitical tension. Regulatory changes or sanctions in either the U.S. or China could quickly undermine the business case.
...
- **An explanation of how the company is valued** relative to its actual earnings, cash flow, or measurable assets.

Very few OTC companies, let alone small biotech firms, provide this level of disclosure voluntarily. When they do not, the default assumption should be skepticism rather than hope.

## Research notes

Yubo's [10-K filing](/wiki/10-k/) with the SEC (CIK 895464) is the official starting point for any research, though OTC companies often file sparse or incomplete disclosures. Trade publications covering Chinese biotech, if available, may offer additional color on the company's positioning within China's regenerative medicine sector. Any press releases, investor presentations, or product claims should be evaluated against clinical evidence — a company's own marketing is not a reliable source of truth, particularly in a field where stem-cell products are heavily promoted for off-label or unproven uses.

The broader stem-cell market includes legitimate pharmaceutical and biotech companies (many on major exchanges) pursuing real therapies. Distinguishing between those efforts and speculative micro-cap plays is essential. For Yubo specifically, the OTC listing, limited disclosures, and opaque operations suggest this is a speculative holding suitable only for investors who can afford to lose their entire stake and who understand the specific risks of Chinese biotech companies trading in lightly-regulated U.S. markets.
