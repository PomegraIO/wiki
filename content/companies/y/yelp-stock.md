---
title: "Yelp (YELP)"
description: "An online discovery platform connecting consumers with local businesses through user-generated reviews, ratings, and search functionality, primarily monetized via advertising sold to business listings."
keywords:
  - local business reviews
  - consumer discovery
  - restaurant and services marketplace
...
- **Revenue growth rate**: Yelp's core advertiser revenue is the barometer of health in its [primary market](/primary-market/). Sustained growth in paid subscriptions and average revenue per advertiser (ARPU) signals pricing power and market share gains.
- **[Free cash flow](/free-cash-flow/) and profitability**: After years of negative or thin margins, Yelp has achieved positive operating leverage. The company is now focused on free cash flow generation and shareholder returns ([dividends](/dividend/) and buybacks). Tracking [operating margins](/operating-margin/) and cash conversion is critical to assessing sustainable profitability.
...
Yelp's [10-K](/wiki/10-k/) filing, published annually on the SEC's EDGAR database, provides a comprehensive breakdown of revenue by segment, geographic region, and key operating metrics. The filing also details competitive risks, customer concentration (top 10 or 20 advertisers' share of revenue), and regulatory developments.
