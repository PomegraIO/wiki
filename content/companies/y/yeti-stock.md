...
A reader examining YETI should scrutinize the [10-K](/wiki/10-k/) for segment breakdown (DTC versus wholesale revenue), gross margin trends, and inventory levels. Premium lifestyle brands can be vulnerable to overstock if they misjudge demand or flood the wholesale channel. Watch for customer acquisition cost (CAC) in DTC—higher digital marketing spend to acquire each new customer erodes the margin advantage of that channel. Wholesale growth rates tell you whether retail partners are gaining shelf space and selling through effectively.
