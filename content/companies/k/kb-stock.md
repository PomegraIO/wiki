...
description: "KB Financial Group is South Korea's largest banking group by assets, holding three major commercial banks and a network spanning consumer, corporate, and investment banking across the Korean economy."
keywords:
  - korean banking
  - consumer banking
  - commercial banking
...
<table>
<tr><th>Ticker</th><td>KB (Korea Exchange)</td></tr>
<tr><th>Parent Company</th><td>KB Financial Group Inc.</td></tr>
<tr><th>Founded</th><td>Kookmin Bank (1963); KB Financial Group (2001)</td></tr>
<tr><th>Headquarters</th><td>Seoul, South Korea</td></tr>
<tr><th>Sector</th><td>Banking and financial services</td></tr>
<tr><th>Core Brands</th><td>Kookmin Bank, Korea Development Bank, KB Kbank</td></tr>
<tr><th>Business Model</th><td>Diversified banking (consumer, commercial, investment, wealth)</td></tr>
<tr><th>SEC CIK</th><td>1445930</td></tr>
</table>
</aside>
...
Net interest income — the spread between what KB pays depositors and what it collects from borrowers — remains the largest revenue driver. Kookmin Bank in particular is a deposit-gathering powerhouse: Korean households, fearing [inflation](/inflation/) and seeking safety, have historically maintained high [savings rates](/savings-rate/), and Kookmin is often the first or primary bank for millions of Korean families. The retail deposit base provides a large, relatively stable funding source for consumer loans (mortgages, auto loans, credit cards) and corporate lending. Mortgage lending, in particular, has been a significant profit center, especially in Seoul and other major urban markets where property values are high. Corporate lending serves everything from small and mid-market businesses to large [chaebol](/wiki/chaebol/) (Korean family-owned conglomerates) needing working capital or term financing.
...
Profitability and [return on equity](/return-on-equity/) have been solid but compressed by competition, regulation on lending rates, and the low-rate environment that defined much of the 2010s and 2020s. KB's market share and pricing power are strong in Korea, but growth is inherently capped by the size and maturity of the domestic economy.
...
Net interest margins have trended downward over the past decade, squeezed by [central bank](/central-bank/) interest rate policy, competition on deposit rates as banks fight for deposit market share, and structural shifts in how Koreans invest (wealth migration from deposits into equities and alternative assets). Mortgage lending, a longtime profit center, faces periodic regulatory clamps to cool the property market and address household debt levels — Korea's household [debt-to-GDP ratio](/debt-to-gdp-ratio/) is among the world's highest. Tightening rules on loan-to-value ratios or debt-service coverage for mortgages can crimp volume and margins in that segment.

Asset quality has also been tested. [Recessions](/recession/) and [credit events](/credit-event-sovereign/) — like the 2008 global financial crisis, the 2015 credit crisis driven by leveraged household borrowing, and various corporate bankruptcies — have forced loan loss provisions and write-downs. Going forward, slowing growth, aging population, and geopolitical tensions (particularly around China and North Korea) add macroeconomic uncertainty.
...
The group maintains strong capital ratios (a requirement of regulators and critical for banking stability) and has historically paid modest [dividends](/dividend/). [Share buybacks](/share-buyback/) have been limited, reflecting the large public shareholder base and regulatory preference for capital conservation.

## How to research KB Financial Group

Start with the company's annual report and regulatory filings with the Financial Supervisory Service (FSS) of South Korea, which are analogous to [10-K filings](/wiki/10-k/) in the United States. The group releases both English-language summaries and detailed Korean-language financial statements. Look for trends in net interest margin, the evolution of the loan portfolio (what proportion is mortgages, corporate, consumer finance), loan loss provisions relative to the credit cycle, deposit growth, and the efficiency ratio (operating costs divided by revenue). Korean bank stocks trade on the [Korea Exchange](/korean-exchange/); international investors can access KB shares through [ADRs](/wiki/adr/) or direct access to the exchange.
