---
title: "KURA SUSHI USA, INC. (KRUS)"
description: "A sushi restaurant chain with a focus on conveyor-belt (kaiten) service model, targeting casual diners across the western United States."
keywords: ["restaurants", "sushi", "casual dining", "kaiten sushi", "growth"]
---
...
<tr><td><strong>Ticker</strong></td><td>KRUS</td></tr>
<tr><td><strong>Listing</strong></td><td>US public equity</td></tr>
<tr><td><strong>SEC CIK</strong></td><td>1772177</td></tr>
...
<tr><td><strong>Type</strong></td><td>Restaurant chain operator</td></tr>
</table></aside>
...
To understand KRUS, focus on same-store sales (revenue at locations open more than one year), new-unit counts (openings and closures), and per-unit profitability (revenue and profit per location). These figures live in the [10-K](/10-k/) and quarterly earnings calls. Also watch management commentary on labor costs, food pricing, and consumer traffic trends. A chain growing units but with declining same-store sales is cannibalizing existing locations, which is a red flag.

<div class="wiki-seealso">

### Closely related
- [krtl-stock](/krtl-stock/) — another restaurant holding company with different brands and structure
- [public-company](/public-company/) — how KRUS's disclosure obligations work

### Wider context
- [10-k](/10-k/) — where to find detailed operating metrics and risks
- [return-on-equity](/return-on-equity/) — how efficiently KRUS deploys capital
- [earnings-per-share](/earnings-per-share/) — the per-share profit that drives stock valuation
