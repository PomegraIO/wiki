---
title: "Knightscope, Inc. (KSCP)"
description: "A hardware and software company that designs and operates autonomous security robots for indoor and outdoor perimeter surveillance."
keywords: ["robotics", "security", "autonomous systems", "technology", "hardware"]
---
...
<tr><td><strong>Ticker</strong></td><td>KSCP</td></tr>
<tr><td><strong>Listing</strong></td><td>US public equity</td></tr>
<tr><td><strong>SEC CIK</strong></td><td>1600983</td></tr>
<tr><td><strong>Sector</strong></td><td>Technology</td></tr>
<tr><td><strong>Industry</strong></td><td>Hardware & Robotics</td></tr>
<tr><td><strong>Type</strong></td><td>Manufacturer & service provider</td></tr>
</table></aside>
...
Read KSCP's [10-K](/10-k/) to understand deployed robot counts, subscription retention rates, customer acquisition cost, and gross margins. Watch for manufacturing capacity, supply-chain challenges, and backlog (how many orders are pending). These metrics predict whether the company can sustain growth and when it might achieve profitability.

<div class="wiki-seealso">

### Closely related
- [krt-stock](/krt-stock/) — another hardware-oriented public company
- [krus-stock](/krus-stock/) — consumer-facing business with recurring fees

### Wider context
- [public-company](/public-company/) — how KSCP discloses performance and risks
- [enterprise-value](/enterprise-value/) — valuation of a growth-stage hardware company
- [free-cash-flow](/free-cash-flow/) — the cash KSCP generates after capital investment
