---
title: "Knowledge Atlas Technology Joint Stock Co Limited/ADR (KATJF)"
description: "A Vietnamese data analytics and software services company accessible to US investors via American Depositary Receipt; SEC filing CIK 2109545."
keywords: ["Vietnam", "software", "data analytics", "ADR", "emerging markets", "IT services"]
---

*[Knowledge Atlas Technology Joint Stock Co Limited](/katjf-stock/) (KATJF) is a Southeast Asian technology and data analytics firm that trades in the United States through an [American Depositary Receipt](/katjf-stock/) structure. Based in Vietnam, the company serves regional and international clients seeking data insights and custom software development, operating in a market where labor costs are lower than in North America but technical talent pools are increasingly competitive and global.*

<aside class="wiki-infobox"><table>
<tr><td>Ticker</td><td>KATJF</td></tr>
<tr><td>Listing</td><td>OTC Markets</td></tr>
<tr><td>SEC CIK</td><td>2109545</td></tr>
<tr><td>Sector</td><td>Technology &amp; Software Services</td></tr>
<tr><td>Industry</td><td>Data Analytics / IT Consulting</td></tr>
<tr><td>Type</td><td>Public Company (ADR)</td></tr>
</table></aside>

## ADR Structure and Access

Knowledge Atlas exists in dual form: a private company incorporated in Vietnam, and a public [American Depositary Receipt](/adr/) ([ADR](/katjf-stock/)) traded in the US. This structure allows US investors to buy shares without navigating Vietnamese stock-exchange regulations, currency conversions, or custodial complexity. The [ADR](/katjf-stock/) issuer holds shares on behalf of US holders and handles [dividends](/dividend/) and voting proxies. Structurally, it's a bridge—for the company, a way to tap US capital; for the investor, a way to gain Vietnam exposure without the friction of direct Hanoi or Ho Chi Minh City market access.

Trading on OTC markets, the [ADR](/katjf-stock/) has limited liquidity compared to major-exchange software names. This means wide [bid-ask spreads](/bid-ask-spread/) and infrequent trading. Investors in Knowledge Atlas must be comfortable with position illiquidity—you might own the shares but struggle to exit quickly without moving the price against you. The [ADR](/katjf-stock/) structure also introduces exchange-rate risk; revenue earned in Vietnamese dong fluctuates against the dollar, and that volatility flows through to reported earnings.
