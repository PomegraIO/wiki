---
title: "Katapult Holdings, Inc. (KPLT)"
description: "Fintech lender specializing in lease-to-own financing for appliances, furniture, and electronics through a digital-first platform."
keywords: ["fintech", "consumer lending", "lease-to-own", "BNPL alternative", "retail partnership"]
---
...
Katapult's reliance on merchant relationships and consumer credit quality exposed it to several structural headwinds. A [recession](/recession/) that reduced [discretionary spending](/discretionary-spending/) on furniture and appliances would immediately weaken origination volumes. Economic downturns also raised [default rates](/default-rate/) on outstanding leases, compressing returns. The company's funding model—reliant on capital providers' appetite for lease receivables—could tighten if [interest rates](/interest-rate/) spiked or investor risk appetite shrank. Regulatory scrutiny of alternative lending and lease-to-own practices was a longer-term consideration; any tightening of disclosure rules or payment-plan restrictions could reshape the economics of the sector. Additionally, larger fintech lenders or established retailers could replicate Katapult's platform or in-source competing solutions.
