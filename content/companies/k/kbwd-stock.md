---
title: "Invesco KBW High Dividend Yield Financial ETF (KBWD)"
description: "A passive index fund holding 42 high-dividend financial companies — banks, insurance firms, business development corporations, and mortgage REITs — that prioritizes income over growth."
keywords:
  - dividend ETF
  - financial sector
  - high yield
...
<table>
<tr><th>Ticker</th><td>KBWD (NASDAQ)</td></tr>
<tr><th>Issuer</th><td>Invesco</td></tr>
<tr><th>Fund type</th><td>Passive dividend-focused ETF</td></tr>
<tr><th>Underlying index</th><td>KBW Nasdaq Financial Sector Dividend Yield Index</td></tr>
<tr><th>Holdings</th><td>42 financial companies</td></tr>
<tr><th>Expense ratio</th><td>0.35% annually</td></tr>
<tr><th>Typical yield</th><td>5–7% (higher than broad financials)</td></tr>
</table>
</aside>

## Why filter for dividend payers

Financial companies generate income naturally. Banks earn the spread between deposit rates and lending rates, and they return part of that profit as dividends. Insurance companies collect premiums, invest them, and distribute earnings to shareholders. Business development corporations are required by law to distribute at least 90 per cent of earnings, creating high-yield vehicles by design. Mortgage real estate investment trusts buy pools of mortgages and pass the interest through to shareholders.

KBWD applies a dividend lens to this universe. Instead of owning all the major banks in the sector, it owns 42 financial companies chosen because their dividend yields rank above average. This filters out fintech firms that reinvest all earnings back into growth, and it biases heavily toward mature, income-focused franchises.

The result is a fund engineered for cash flow, not capital appreciation. Investors buying KBWD are trading long-term growth potential for current income.
...
KBWD is engineered for income, not long-term capital appreciation. The high dividend payout means most of your return comes as taxable distributions rather than untaxed capital gains. For investors in taxable accounts, this creates a significant tax drag: you pay ordinary income tax on dividends every year, which reduces your long-term after-tax returns compared with a fund that grows primarily through appreciation.

For tax-advantaged accounts like IRAs or 401(k)s, this tax drag disappears; you capture the income without annual tax bills. KBWD is therefore far more suitable for sheltered accounts than for taxable ones.
...
Read the factsheet to see the current 42 holdings and the reported dividend yield. Check the prospectus for the underlying index methodology — specifically, how the index selects for dividends, how often it rebalances, and what rules govern concentration. Watch mortgage rates and economic forecasts; KBWD will react sharply to changes in either. Monitor news about the specific mortgage REITs and regional banks in the top holdings, because their announcements of dividend cuts or loan losses flow directly to the fund's price and income.

Compare KBWD's total return — not just its yield — against a general bank ETF like KBWB over multiple years. Over full [market cycles](/market-cycle/), a high-dividend financial fund may underperform a diversified all-market fund as interest rates rise or [credit cycles](/credit-cycle/) shift. Understand whether you are truly building wealth or simply converting capital into current income.
