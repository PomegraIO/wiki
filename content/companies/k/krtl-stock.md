...
Consult KRTL's most recent [10-K](/10-k/) filing to learn the exact brands owned, the split between company-operated and franchised units, same-store sales trends, and customer demographics. Unit count, average unit volume (sales per location), and franchisee profitability are the metrics that predict KRTL's future.

<div class="wiki-seealso">

### Closely related
- [krus-stock](/krus-stock/) — another restaurant company, differently structured
- [krt-stock](/krt-stock/) — manufacturer of equipment used in the restaurant industry

### Wider context
- [public-company](/public-company/) — regulatory obligations of the holding company structure
- [enterprise-value](/enterprise-value/) — how the market values a restaurant chain
- [dividend](/dividend/) — whether KRTL returns cash to shareholders
