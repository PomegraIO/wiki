---
title: "KB Home (KBH)"
description: "A large US homebuilder known for build-to-order homes and serving first-time and move-up homebuyers across major markets."
keywords:
  - homebuilder
  - build-to-order
...
The financial services segment, much smaller, provides loans and insurance products to buyers. It's not a separate lending business but a support arm: helping customers navigate mortgages and [title insurance](/title-insurance/) rounds out KB Home's service to the home buyer and reinforces the transaction.
...
KB Home competes with national builders like Lennar, PulteGroup, and D.R. Horton, plus smaller regional and local builders. The industry is fragmented—no single company owns more than roughly 10% of US [housing starts](/housing-starts/)—which means KB Home must compete on brand, service, location, and price within its segment.
...
Gross margins on home sales are a [leading indicator](/leading-indicator/) of health. Widening margins signal strong demand and pricing power; narrowing margins warn of cost pressures or demand softness.
