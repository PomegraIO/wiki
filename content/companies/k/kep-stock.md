---
title: "Korea Electric Power (KEP)"
description: "South Korea's vertically integrated state-controlled utility managing 90% of the nation's electricity generation, transmission, and distribution across coal, nuclear, and renewables capacity."
keywords:
  - korean utility stocks
  - state-owned enterprises
  - nuclear power generation
  - power transmission monopoly
...
Understanding KEPCO requires accepting that it is not purely a commercial entity. A [10-K](/wiki/10-k/) analysis of a typical U.S. utility will not fully transfer. Instead, investors benefit from reading government energy policy documents, understanding South Korea's industrial policy and export competitiveness priorities, and tracking political cycles and pension-reform debates that affect the company's cost structure and strategic flexibility. The [stock](/wiki/stock/) price often reflects these macro and political drivers more than discrete operational improvements.
