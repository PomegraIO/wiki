---
title: "Joint Stock Co Kaspi.kz (KSPI)"
description: "Kaspi.kz is a Kazakhstani financial services and e-commerce platform providing payments, lending, insurance, and online shopping across Central Asia."
keywords:
  - Kazakhstan
  - fintech
  - payments
...
<table>
<tr><th>Ticker</th><td>KSPI (NASDAQ)</td></tr>
<tr><th>Headquarters</th><td>Almaty, Kazakhstan</td></tr>
<tr><th>Founded</th><td>2000 (as a payments company); fintech platform built from 2015 onward</td></tr>
<tr><th>Business focus</th><td>Integrated financial services and e-commerce</td></tr>
<tr><th>Core offerings</th><td>Payments, lending, insurance, marketplace</td></tr>
<tr><th>Primary market</th><td>Kazakhstan; expanding to Kyrgyzstan and other Central Asian countries</td></tr>
<tr><th>Listing</th><td>NASDAQ, IPO December 2020</td></tr>
<tr><th>SEC CIK</th><td>0001985487</td></tr>
</table>
</aside>
...
The real risks are different. First, traditional banks are increasingly digitising and might launch competitive apps. Second, if Central Asian governments tighten regulation around consumer lending, particularly around [interest rates](/interest-rate/) (Kazakhstan has occasional populist pressure to [cap rates](/cap-rate/)), Kaspi's highest-margin business would shrink. Third, expansion into new countries is slower and more challenging than growth in the home market; the company is investing heavily and seeing losses from international operations. Fourth, macroeconomic stress in Kazakhstan — a [recession](/recession/), a currency crisis, a decline in oil revenues — could sharply reduce consumer spending, lending demand, and transaction volumes.

## How to research Kaspi.kz

Investors should begin with the 10-K (SEC CIK 0001985487), which breaks revenue by segment (payments, lending, marketplace, insurance, other services), discloses loan portfolio composition and credit-loss rates, and details the regulatory environment and [concentration risk](/concentration-risk/) (Kaspi's exposure to a small country and currency). Quarterly earnings calls reveal user growth trends, transaction volumes, credit metrics, and the pace and profitability of international expansion.
