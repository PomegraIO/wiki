---
title: "KraneShares 2x Long BABA Daily ETF (KBAB)"
description: "A leveraged daily-reset ETF that aims to deliver twice the daily return of Alibaba Group's stock, intended for tactical bets rather than buy-and-hold investing."
keywords:
  - leveraged ETF
  - Alibaba
  - daily reset
...
<table>
<tr><th>Ticker</th><td>KBAB (NASDAQ)</td></tr>
<tr><th>Issuer</th><td>KraneShares</td></tr>
<tr><th>Fund type</th><td>Leveraged ETF (daily reset)</td></tr>
<tr><th>Underlying</th><td>Alibaba Group (BABA)</td></tr>
<tr><th>Leverage ratio</th><td>2x daily</td></tr>
<tr><th>Expense ratio</th><td>Active (reflects leverage and trading)</td></tr>
<tr><th>Best for</th><td>Tactical, short-term positions</td></tr>
</table>
</aside>

## The underlying holding: Alibaba
...
The consequences of daily rebalancing become stark in any environment where price moves up and down, rather than in one direction. Consider a hypothetical: BABA opens at $100 and rises 10 per cent to $110, then falls 10 per cent to $99. A non-leveraged investor holding BABA ends at $99, down 1 per cent. The fund KBAB, rebalancing daily, experiences 20 per cent gain on day one (roughly arriving at $120), then 20 per cent loss on day two (arriving at roughly $96). The leveraged fund ends down 4 per cent, worse than the underlying stock's 1 per cent loss.

This effect — leveraged funds degrading in value despite the underlying asset recovering to near its starting point — is called volatility decay. It is not a flaw in the fund's mechanism; it is an inherent property of daily rebalancing. KBAB is not suitable for investors with multi-week or multi-month holding periods. The fund is priced for active daily or intraday traders betting on directional moves in Alibaba over hours or days, not weeks or years.
...
Alibaba Group itself faces regulatory scrutiny from both Chinese and American authorities. The Chinese government has intervened in the company's business practices and structure, creating ongoing uncertainty around operational freedom and strategic direction. In the United States, regulatory pressure on Chinese companies listed in American markets creates legal and political headwinds. These risks apply directly to KBAB: any significant adverse regulatory action affecting BABA is amplified 2x in the leveraged fund.

Alibaba is also subject to geopolitical tension between the US and China, which can swing investor sentiment around Chinese tech stocks unpredictably. The leverage in KBAB means these sentiment swings hit harder and faster.
