---
title: "KraneShares Global Humanoid Robotics and Physical AI Index ETF (KOID)"
description: "KOID tracks companies globally involved in humanoid robotics and physical AI — including robot manufacturers, robotics software platforms, and AI systems designers — betting on the emergence of autonomous machines as a new asset class."
keywords:
  - humanoid robotics
  - physical AI
  - automation
...
KOID is a thematic exchange-traded fund that bets on an emerging corner of the economy: companies making humanoid robots and physical artificial intelligence systems. It holds manufacturers like Boston Dynamics, software platforms that power robotic systems, chip makers supplying AI acceleration, and industrial-automation firms expanding into more autonomous territory. The fund is a concentrated bet on a technology that is still largely experimental — humanoid robots are not yet mass-manufactured, their economics are unproven, and their market opportunity is theoretical rather than realized.

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>KOID (NASDAQ)</td></tr>
<tr><th>Issuer</th><td>KraneShares</td></tr>
<tr><th>Structure</th><td>Thematic equity ETF</td></tr>
<tr><th>Strategy</th><td>Global exposure to humanoid robotics and physical AI</td></tr>
<tr><th>Holdings</th><td>Typically 30–50 companies across geographies and supply chains</td></tr>
<tr><th>Expense ratio</th><td>Approximately 0.80% annually</td></tr>
<tr><th>Focus</th><td>Robotics manufacturers, software, AI chips, automation systems</td></tr>
</table>
</aside>

## What is physical AI and why KOID exists
...
The bull case for KOID rests on a simple premise: if humanoid robots ever become economically viable at scale, they will disrupt enormous sectors — manufacturing, logistics, agriculture, healthcare, and defense. A robot that can perform general manual work, or be trained to do so, could become as transformative as steam power. Companies positioned along that value chain could see exponential growth.

The bear case is equally simple: humanoid robots remain far from that viability. Current prototypes are slow, fragile, require constant human oversight, and cost far more to deploy than hiring human workers. The economics are terrible. We do not yet know whether the technology can ever become cheap and reliable enough to be economical at scale. Investors betting on KOID are betting on a "maybe" — a technology that might never reach mass adoption.

This uncertainty is reflected in KOID's volatility. Positive developments in robotics AI get hyped. Setbacks or moments of regulatory concern (around labor displacement, for instance) can trigger sell-offs. The fund is appropriate only for investors with high risk tolerance and long time horizons.
...
Finally, track policy and labor discussions around automation. Governments are beginning to grapple with labor displacement and robot taxation. Regulatory changes could accelerate or impede deployment. An investor in KOID should stay alert to these broader conversations, not just to stock prices.
