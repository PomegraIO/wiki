...
The fund is issued by Leverage Shares, a London-based firm, and trades on [NASDAQ](/nasdaq/). The [expense ratio](/expense-ratio/) is modest—typical for a specialized [equity ETF](/equity-etf/)—but that headline fee is irrelevant compared to the structural cost of daily rebalancing. The real cost is implicit in the fund's [net asset value](/net-asset-value/), built into the derivative contracts and the daily reset mechanics.
