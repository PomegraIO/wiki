---
title: "Leverage Shares 2X Long NET Daily ETF (NETG)"
description: "A daily-reset leveraged ETF delivering twice the daily return of Cloudflare stock, using derivatives for tactical trading only. Designed for traders with very short time horizons and high volatility tolerance."
keywords:
  - leveraged ETF
...
The daily reset is both the fund's feature and its critical flaw. It keeps leverage fresh for short-term traders. It also creates a mathematical erosion over time called volatility decay. Imagine Cloudflare trades up 5 percent on Monday and down 5 percent on Tuesday, ending where it started. NETG gains 10 percent on Monday. On Tuesday, NETG rebalances at the higher price and loses 10 percent on that larger base. Two days later, NETG is down even though NET is flat. The stock could bounce sideways all month while NETG slowly bleeds. The longer the [holding period](/holding-period/) and the choppier the stock, the worse the drag.

The fund is issued by Leverage Shares, a London-based firm, and trades on [NASDAQ](/nasdaq/). The [expense ratio](/expense-ratio/) is modest—typical for a specialized [equity ETF](/equity-etf/)—but that headline fee is irrelevant compared to the structural cost of daily rebalancing. The real cost is implicit in the fund's [net asset value](/net-asset-value/), built into the [derivative contracts](/derivative-contract/) and the daily reset mechanics.
