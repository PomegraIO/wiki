...
description: "NSA is a real estate investment trust that owns and operates self-storage facilities across the United States — a network of local climate-controlled and non-climate-controlled units rented month-to-month to individuals and small businesses."
keywords:
  - self-storage REIT
...
Self-storage demand is tied to residential moves, which correlate with economic confidence and interest rates. High mortgage rates and declining affordability reduce household moves and dampen demand for storage. Conversely, economic booms and low-rate environments drive more moves and more demand. NSA's occupancy and pricing power thus move with economic cycles, though the company is less sensitive to deep [recessions](/recession/) than retailers or [commercial real estate](/commercial-real-estate/) because storage is countercyclical in some ways: recessions drive people to downsize homes and store belongings rather than discard them.
...
Key metrics to track include occupancy rates by segment, average monthly rent, and [leverage ratios](/leverage-ratio-forex/). Because NSA is a REIT with high dividend payouts, the sustainability of the dividend depends on cash flow from operations growing faster than the [cost of debt](/cost-of-debt/). Watch for management commentary on new development, acquisitions, and pricing power in different markets — these signal the company's confidence about demand and its ability to raise rates.
