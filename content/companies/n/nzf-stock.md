---
title: "Nuveen Municipal Credit Income Fund (NZF)"
description: "A closed-end fund investing in municipal bonds rated below investment grade, seeking higher income than traditional municipal bond funds by taking on credit risk."
keywords:
  - closed-end fund
  - municipal bonds
...
<table>
<tr><th>Ticker</th><td>NZF (NYSE)</td></tr>
<tr><th>Fund type</th><td>Closed-end fund</td></tr>
<tr><th>Investment focus</th><td>Below-investment-grade municipal bonds</td></tr>
<tr><th>Primary objective</th><td>Current income and total return</td></tr>
<tr><th>Tax treatment</th><td>Federal tax-exempt income (often state-exempt)</td></tr>
<tr><th>Underlying assets</th><td>Municipal bonds of lower-rated issuers</td></tr>
<tr><th>SEC CIK</th><td>0001137887</td></tr>
</table>
</aside>
...
Start with the fund's annual and semi-annual reports, available from the fund manager or the SEC. Those reports disclose the entire bond portfolio (which specific issuers and states are represented), the ratings distribution (how many bonds are rated CCC versus B versus BB, for instance), the duration (a measure of interest-rate sensitivity), and the [expense ratio](/expense-ratio/). The reports also show historical distributions and the fund's performance relative to a benchmark.
