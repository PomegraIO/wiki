---
title: "Direxion Daily NFLX Bull 2X ETF (NFXL)"
description: "NFXL is a leveraged ETF that aims to deliver twice the daily return of Netflix stock. It uses derivatives and daily rebalancing to track NFLX with 2X leverage for tactical traders."
keywords:
  - leveraged ETF
  - Netflix
  - NFLX
...
**Why single-stock leverage fails over time.** Because single stocks are unpredictable and volatile. A diversified fund using 2X leverage on 100 stocks can hope the volatility of one stock offsets another; a fund using 2X leverage on one stock is doubling its exposure to that one stock's idiosyncratic noise. The probability that the noise helps you is low.

**The only honest use.** A trader who has high conviction that Netflix will move sharply upward in the next few days, who understands the risks and can bear a 20% loss if wrong, and who has done the homework. Everyone else is gambling.

**How to research NFXL.** Read the prospectus for the swap terms and the fee. Compare NFXL's daily returns to Netflix's own returns over a week or a month and watch the decay appear. If Netflix is flat or up slightly, NFXL almost certainly shows a loss. That is not a bug; it is the proof of how expensive leverage is. If Netflix is in a strong uptrend, NFXL will outperform, but the second the trend breaks, the leverage works in reverse. The only way to win with NFXL is to enter, capture a directional move, and exit before volatility and decay take the returns back. Holding it longer than a few weeks is fighting an algebraic headwind.
