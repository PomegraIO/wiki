---
title: "News Corp (NWSLL)"
description: "News Corp is a diversified media company that evolved from a newspaper empire into a portfolio spanning cable television, publishing, digital properties, and financial information services."
keywords:
  - media company
  - cable television
  - publishing
...
Begin with the company's annual 10-K filing, which breaks down revenue by segment and reveals which parts are growing and which are in decline. Watch the cash flow and [free cash flow](/free-cash-flow/): does the company generate surplus cash after capital expenditures, or is it drawing down [balance sheet](/balance-sheet/) resources? Check the debt levels and interest coverage—if debt is rising while revenue is stagnating, that is a warning.
...
The regulatory and legal environment also matters. Ongoing investigations or legislative threats to media ownership concentration could force [divestitures](/divestiture/) or impose restrictions on cross-ownership that limit News Corp's competitive advantages.
