---
title: "NEXTNAV INC. (NN)"
description: "NextNav is a positioning technology company developing terrestrial GPS alternatives using low-band spectrum. Holds FCC licenses for 900 MHz spectrum and offers services including Pinnacle altitude data and TerraPoiNT location networks, alongside development of 5G-based positioning technology."
keywords:
  - positioning system
  - spectrum licenses
  - gps alternative
...
The 10-K filing reveals the company's cash burn and capital structure. The SEC filing also documents partnerships and licensing agreements. Given the company's early stage and technical complexity, [10-K](/wiki/10-k/) documents are essential to understanding deployment timelines and burn rates. NextNav must eventually prove that regulatory licenses and engineering capability can translate into paying customers; so far, that proof remains ahead of the company, not behind it.
