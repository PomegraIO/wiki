---
title: "Netscout Systems Inc. (NTCT)"
description: "Netscout Systems develops software for network monitoring, performance management, and cybersecurity—a software and services company serving enterprises and service providers with visibility into complex IT environments."
keywords:
  - network monitoring
...
The APM segment faces particular cyclicality around enterprise IT spending. In [recessions](/recession/), customers cancel subscriptions or defer purchases; in expansions, they adopt and expand. The market has matured in recent years, with competitors including Dynatrace, [Datadog](/ddog-stock/), Elastic, and others. Netscout's competitive position is respectable but not dominant; it shares the market with specialist pure-plays and with bundled offerings from cloud giants like Amazon Web Services and [Microsoft](/msft-stock/) Azure.
...
Netscout has transitioned from a perpetual-license software vendor (which had lumpy [revenue recognition](/revenue-recognition/)) to a subscription and SaaS mix, which provides more predictable revenue and cash flow. As a software company, gross margins are high—typically in the 60–75% range after accounting for infrastructure and support costs. [Operating margin](/operating-margin/) depends on how aggressively the company spends on sales and R&D; Netscout invests substantially in both to maintain competitiveness.

The company generates positive [free cash flow](/free-cash-flow/) and has a history of returning capital to shareholders via buybacks and [dividends](/dividend/). In growth mode, Netscout might reinvest cash in [acquisition](/acquisition/) and R&D; in slower-growth periods, the company can return more to shareholders.
