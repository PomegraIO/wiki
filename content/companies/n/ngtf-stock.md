---
title: "NightFood Holdings, Inc. (NGTF)"
description: "NightFood Holdings is a consumer goods company focused on nighttime snacking products designed to satisfy cravings with lower sugar and calorie content, funded through private placements and equity issuance."
keywords:
  - snack foods
  - consumer goods
  - nighttime nutrition
...
<table>
<tr><th>Ticker</th><td>NGTF (OTC Markets)</td></tr>
<tr><th>Founded</th><td>2012</td></tr>
<tr><th>Sector</th><td>Consumer goods / specialty foods</td></tr>
<tr><th>Primary products</th><td>Nighttime snack foods, particularly ice cream</td></tr>
<tr><th>Distribution model</th><td>Retail partners and direct-to-consumer channels</td></tr>
<tr><th>Funding model</th><td>Private placements, equity issuance, operational cash flow</td></tr>
<tr><th>SEC CIK</th><td>0001593001</td></tr>
</table>
</aside>
...
The company has historically funded operations through equity issuance — [private placements](/private-placement/) to angel investors, early-stage funds, and small institutions willing to back a consumer-brand concept. Each financing round dilutes existing shareholders but provides cash to fund growth. The typical structure is convertible securities ([preferred stock](/preferred-stock/) or convertible debt) that give investors downside protection and preferred [liquidation](/liquidation/) rights while providing capital at lower dilution than straight equity.
...
This is why the market for small consumer-goods companies is sparse. Most do not achieve positive unit economics at scale; they remain dependent on continued [equity financing](/equity-financing/) to stay alive, and investors eventually lose patience. The companies that survive are those that either find a profitable formula and scale it deliberately, or build enough brand loyalty that customers will seek them out rather than retailers having to push them.
