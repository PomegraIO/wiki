---
title: "NexPoint Diversified Real Estate Trust (NXDT-PA)"
description: "NexPoint Diversified Real Estate Trust is a closed-end real estate fund holding diversified commercial and residential properties, trading at prices driven more by interest-rate cycles and credit conditions than by underlying property values."
keywords:
...
[NexPoint Diversified Real Estate](/nxdt-stock/) Trust is a closed-end [mutual fund](/mutual-fund/) — a fixed pool of capital managed by an investment team — that buys and holds real estate assets. Unlike an [open-end fund](/open-end-fund/) where investors can ask for their money back at any time, or a traditional REIT that can issue and redeem shares, a [closed-end fund](/closed-end-fund/) locks in its investor base and deploys that capital into a portfolio of assets. In NexPoint's case, those assets are a mix of office buildings, apartment complexes, retail properties, industrial warehouses, and land in the United States. The fund's job is to collect rent from tenants, pay operating expenses and debt service, and return the remainder to shareholders as a [dividend](/dividend/). The share price of a closed-end fund moves independently of the underlying [net asset value](/net-asset-value/) — sometimes trading at a premium, often at a discount — making it a vehicle driven as much by credit conditions and interest-rate sentiment as by the quality of the real estate inside.

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>NXDT-PA (NYSE), NXDT (common)</td></tr>
<tr><th>Fund type</th><td>Closed-end diversified real estate fund</td></tr>
<tr><th>Founded</th><td>1989 as Nexpoint Advisors; restructured multiple times</td></tr>
<tr><th>Asset class</th><td>Commercial and residential real estate in the United States</td></tr>
<tr><th>Management</th><td>NexPoint Advisors L.L.C.</td></tr>
...
The portfolio is held as diversified real estate across multiple property types: office buildings in urban and suburban markets; multi-family residential (apartment complexes and mixed-use buildings); retail (including shopping centers and standalone commercial spaces); industrial properties (warehouses, fulfillment centers, logistics facilities); and some undeveloped land. This [diversification](/diversification/) is intentional: it spreads risk across different property types and geographies and reduces exposure to any single market or asset type.
...
The most important dynamic for understanding a closed-end [real estate fund](/real-estate-fund/) is that its share price is not simply a reflection of the value of the underlying real estate. The price is driven also by [interest rates](/interest-rate/), by credit conditions, and by investor sentiment about real estate as an asset class. This creates the possibility of trading at a premium to or at a discount from the net asset value.
...
This discount-to-net-asset-value has swung wildly over NexPoint's history. In boom times, the fund has traded above its asset value. In [recessions](/recession/) or periods of rising rates, it has traded at 20, 30, or even steeper discounts. A shareholder who bought at a steep discount and then rode out a recovery until sentiment improved could have realized a large gain without the properties themselves changing in value — just the willingness of the market to pay for the stream of cash they generate.
