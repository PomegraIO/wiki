---
title: "Virtus Convertible & Income Fund (NCV)"
description: "A closed-end fund that invests primarily in convertible securities and dividend-paying equities, seeking total return through both capital appreciation and income distribution."
keywords:
  - closed-end fund
...
Virtus Convertible & [Income Fund](/income-fund/) is a closed-end fund managed by [Virtus Investment Partners](/vrts-stock/) that targets investors seeking both regular income and potential capital appreciation. Unlike [mutual funds](/mutual-fund/), [closed-end funds](/closed-end-fund/) issue a fixed number of shares that trade on an exchange like stocks, with their price determined by market supply and demand rather than their [net asset value](/net-asset-value/). The fund invests in a mix of convertible securities and dividend-paying stocks, aiming to provide shareholders with steady distributions while preserving capital.

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>NCV (NASDAQ)</td></tr>
<tr><th>Fund type</th><td>Closed-end fund</td></tr>
<tr><th>Manager</th><td>Virtus Investment Partners</td></tr>
<tr><th>Sector focus</th><td>Convertibles and dividend equities</td></tr>
<tr><th>Distribution policy</th><td>Monthly</td></tr>
<tr><th>SEC CIK</th><td>0001214935</td></tr>
</table>
</aside>

## What does the fund actually own?

The portfolio is built around two core components. Convertible securities are bonds that can be exchanged into a company's stock under specified conditions, offering investors both the downside protection of debt and the upside potential of equity participation. Equities in the portfolio are typically chosen for stable, recurring [dividend](/dividend/) payments rather than growth prospects. This pairing allows the fund to target income streams from multiple sources: [coupon payments](/coupon-payment/) from convertibles, [dividend yields](/dividend-yield/) from stocks, and potential capital gains if convertible securities are converted or appreciated.
...
Many closed-end funds use leverage as a strategic tool. Virtus Convertible & Income Fund may borrow money at relatively low [interest rates](/interest-rate/), then invest that borrowed capital in higher-yielding securities. In [bull markets](/bull-market/), this amplifies gains; in downturns, it amplifies losses. Leverage also introduces [refinancing risk](/refinancing-risk/): if credit markets tighten, the cost of maintaining the leverage can rise sharply, which may force the fund to reduce its leverage or cut distributions. The [leverage ratio](/leverage-ratio-forex/) and its terms are disclosed in the fund's prospectus and periodic reports.
...
The fund trades on [NASDAQ](/nasdaq/), and like any closed-end fund share, its price fluctuates daily. Understanding the difference between the share price and the underlying net asset value is essential for buy-and-hold investors — a discount to NAV at purchase can enhance long-term returns, while paying a premium at the outset reduces them.
