---
title: "NewtekOne, Inc. (NEWT)"
description: "A small-cap business development company that lends to small and mid-sized businesses, operating as a publicly traded manager of a diversified credit portfolio with recurring fee income."
keywords:
...
NewtekOne trades on the [NASDAQ](/wiki/nasdaq/) under the ticker NEWT and belongs to a particular category of investment vehicles that few retail investors fully understand: a [business development company](/business-development-company/), or BDC. Unlike a [mutual fund](/mutual-fund/), which owns publicly traded securities, or a closed-end [bond](/bond/) fund, which owns traded debt, a BDC holds illiquid, non-traded investments — typically loans and equity stakes in private companies — and operates as a regulated investment vehicle that must distribute most of its income to shareholders.

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>NEWT (NASDAQ)</td></tr>
<tr><th>Founded</th><td>1998, as Newtek Business Services</td></tr>
<tr><th>Sector</th><td>Alternative asset management / BDC</td></tr>
<tr><th>Focus</th><td>Loans and investments in small and mid-market companies</td></tr>
<tr><th>Distribution policy</th><td>Quarterly</td></tr>
<tr><th>SEC CIK</th><td>0001587987</td></tr>
</table>
</aside>
...
The recurring income comes from interest on loans and fee revenue from arrangement, origination, and management of those loans. A loan made to a manufacturing company or a professional services firm might carry a base [interest rate](/interest-rate/) plus a fee that NewtekOne collects upfront or over time. The company also earns income on any equity stakes it holds — distributions from successful portfolio companies or eventual sale proceeds when those companies are acquired or grown to exit.

Portfolio quality is the central risk variable. When the economy is strong, borrowers service their debt, exits are easier, and equity investments appreciate. In a [recession](/recession/), loan losses accelerate, equity valuations compress, and distributions must be cut. NewtekOne's portfolio is more diversified than a single-lender BDC (some competitors focus on specific industries like technology or healthcare), which provides some insulation but not immunity.

## The structural mechanics and shareholder experience

Because a BDC holds illiquid, non-traded assets, the company publishes quarterly estimates of the [fair value](/fair-value/) of its portfolio — a practice that creates visible volatility in the share price as valuations are marked up and down. This "mark-to-market" reporting creates the peculiar dynamic that a BDC's share price can swing based on management's estimate of a private loan's fair value, which is inherently difficult to pin down. That uncertainty creates a wider range between where the shares trade and where management says they are worth.

BDCs are also permitted to borrow money — they often operate with [leverage ratios](/leverage-ratio-forex/) (total debt to equity) between 0.5 and 1.5 times. That leverage magnifies returns when things go well but amplifies losses in a downturn. NewtekOne's management has run a more conservative leverage profile than some competitors, which translates to lower distributions but also lower downside risk.
