---
title: "Virtus Convertible & Income Fund II (NCZ)"
description: "Virtus Convertible & Income Fund II is a closed-end fund investing in convertible bonds and preferred stocks, targeting income with equity upside through instruments that blend debt and equity characteristics."
keywords:
  - closed-end fund
  - convertible bonds
  - preferred stocks
...
<table>
<tr><th>Ticker</th><td>NCZ (NYSE)</td></tr>
<tr><th>Fund type</th><td>Closed-end fund (CEF)</td></tr>
<tr><th>Manager</th><td>Virtus Investment Partners</th></tr>
<tr><th>Focus</th><td>Convertible bonds and preferred stock</td></tr>
<tr><th>Yield profile</th><td>Income plus equity upside potential</td></tr>
<tr><th>SEC CIK</th><td>0001227857</td></tr>
</table>
</aside>

## What are convertible bonds and preferred stocks?
...
## Why NCZ exists and what it does

The convertible and preferred markets are large but fragmented. Investors who want exposure to both assets — or who want to rotate tactically between them — need a specialist. NCZ provides that. It holds a portfolio of hundreds of convertible bonds and preferred stocks, diversified across dozens of issuers, sectors, and credit qualities. It distributes the cash flow (coupons and dividends) monthly and aims to grow the value of the underlying holdings over time.

As a closed-end fund, NCZ issues a fixed number of shares that trade at market prices — which can differ from the fund's [net asset value](/net-asset-value/). If investors are confident about convertible and preferred markets, NCZ trades at a premium; if they are fearful, it trades at a discount. This dynamic, which does not exist for [open-end funds](/open-end-fund/), is a feature and a risk.
...
## The role of leverage and structure

Many convertible and preferred funds, including [closed-end funds](/closed-end-fund/) like NCZ, use leverage — they borrow against their holdings to buy more securities and amplify returns. In a stable market, this works well because the interest cost is lower than the yield on the holdings. But leverage magnifies losses in a downturn, and forced selling in a panic can hurt share prices badly.

## How to research and monitor NCZ

Start with the fund's monthly or quarterly fact sheet and semi-annual report. Look at the composition: what percentage of the portfolio is convertibles versus preferreds, and what is the credit quality breakdown (how many investment-grade, how many sub-investment-grade, how many unrated)? Examine the top ten holdings to see if there is [concentration risk](/concentration-risk/).
