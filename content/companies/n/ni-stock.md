...
description: "A major regulated utility company serving gas and electric customers across the Midwest and mid-Atlantic, operating Columbia Gas and NIPSCO divisions."
keywords:
  - utility
  - natural gas
  - electric utility
...
Start with NiSource's [10-K](/wiki/10-k/) annual filing with the SEC (CIK 1111711). The 10-K details the company's two segments, capital investments, regulatory proceedings in each state, and the long-term outlook for rates and customer growth. Pay particular attention to:
