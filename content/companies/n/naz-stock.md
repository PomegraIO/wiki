---
title: "Nuveen Arizona Quality Municipal Income Fund (NAZ)"
description: "NAZ is a closed-end mutual fund that invests in Arizona municipal bonds exempt from federal and state income taxes, offering tax-advantaged yield to residents in high-tax states—a structured fund with defined capital structure and persistent discount or premium to net asset value."
keywords:
  - municipal bonds
  - closed-end fund
  - tax-exempt income
...
<table>
<tr><th>Ticker</th><td>NAZ (NYSE)</td></tr>
<tr><th>Fund type</th><td>Closed-end municipal bond fund</td></tr>
<tr><th>Issuer</th><td>Nuveen Investments</td></tr>
<tr><th>Objective</th><td>Tax-exempt income from Arizona municipal securities</td></tr>
<tr><th>Tax status</th><td>Exempt from federal income tax; exempt from Arizona state tax</td></tr>
<tr><th>Structure</th><td>Fixed number of shares; trades at price set by market supply and demand</td></tr>
<tr><th>SEC CIK</th><td>0000892992</td></tr>
</table>
</aside>

## What a Closed-End Fund Is and Why NAZ Exists

A [closed-end fund](/closed-end-fund/) is a pool of securities managed by a professional manager and packaged into a fixed number of shares that trade on an exchange. That last part — fixed number of shares — distinguishes it from a [mutual fund](/mutual-fund/), where new shares can be created or redeemed daily at a price tied directly to the fund's underlying [net asset value](/net-asset-value/). With NAZ, the number of shares is fixed; new investors do not prompt the creation of new shares, and exiting investors simply sell their shares to other investors at whatever price the market will bear. That creates a sometimes-large gap between the fund's net asset value (the calculated per-share value of its underlying bonds) and the actual market price of NAZ shares — a discount or premium that can be material.
