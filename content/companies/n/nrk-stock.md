---
title: "Nuveen New York AMT-Free Quality Municipal Income Fund (NRK)"
description: "A closed-end fund that pools investor money to buy high-quality municipal bonds exempt from federal and New York state taxes, distributing the income monthly."
keywords:
  - closed-end fund
  - municipal bonds
  - tax-exempt income
...
Nuveen New York AMT-Free Quality Municipal [Income Fund](/income-fund/) trades on the [New York Stock Exchange](/new-york-stock-exchange/) under the ticker NRK and exists to do one concrete thing: buy a portfolio of [municipal bonds](/municipal-bond/) that are exempt from federal income tax and New York state and local taxes, then pass the income from those [bonds](/bond/) through to its shareholders monthly. It is a closed-end [mutual fund](/mutual-fund/), which means the number of shares outstanding is fixed rather than expanding or shrinking as investors come and go. The share price floats with the market; the fund's underlying asset value (its [net asset value](/net-asset-value/), or NAV) is what it actually owns in bonds. The gap between share price and NAV is where speculation enters — shareholders can pay more or less than the fund's true holdings are worth, depending on whether other buyers are eager or reluctant.
