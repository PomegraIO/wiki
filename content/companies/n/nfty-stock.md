---
title: "First Trust India Nifty 50 Equal Weight ETF (NFTY)"
description: "NFTY is a passive ETF that holds the 50 largest Indian companies but weights them equally instead of by market capitalization. It offers exposure to India's largest and most liquid firms."
keywords:
  - equal weight
  - India
  - Nifty 50
...
Most indexes, including the Nifty 50 itself when used as a benchmark, are capitalization-weighted. This means the largest companies (by total market value) have the largest influence on the index's movements. India's index is dominated by mega-cap companies, so the top 10 holdings might represent 40% or more of the index's weight.

Equal weighting assigns the same dollar amount to each of the 50 companies, regardless of size. This means the tenth-largest company has the same influence as the fiftieth-largest. Equal weighting amplifies exposure to smaller components of the index (though still large by absolute standards) and reduces dependence on the mega-cap leaders. This matters in practice: if mega-cap financial stocks underperform and mid-size industrials rally, an equal-weight portfolio will benefit more from that rotation than a cap-weighted one.

Equal weighting also introduces systematic rebalancing. As the stocks drift in price, the weights drift out of alignment. Maintaining equal weight requires regularly selling winners and buying losers — a contrarian discipline that works well in mean-reverting markets but can drag performance in strong trending markets. Over time, this rebalancing can either add or subtract from returns depending on market conditions.

### What does NFTY actually hold?

NFTY holds common shares in all 50 components of the [Nifty 50 index](/nifty-50-index/), held in equal dollar amounts. The portfolio is dominated by Indian financial services (major banks, insurance companies, and financial conglomerates), information-technology services firms, energy companies, and manufacturing. Sector [diversification](/diversification/) is the result of the Nifty 50's own composition, which mirrors India's economy. There are no [bonds](/bond/), no derivatives, and no non-Indian holdings — this is a pure play on large-cap India.
...
Read the fund's prospectus and fact sheet for the exact list of 50 holdings and their weights, the fee structure, and the historical rebalancing frequency. Track the performance difference between NFTY and a simple cap-weighted Nifty 50 ETF over a full [market cycle](/market-cycle/) to see whether equal weighting has added value or cost you money. Monitor currency movements: when the rupee weakens, your dollar-based returns are reduced. Review what you already own: if your portfolio is already concentrated in tech or financials from US or global holdings, adding an India equal-weight fund may be redundant. Finally, consider India's position in your overall portfolio — whether you need Asia exposure, and whether India deserves a dedicated allocation or can be accessed more cheaply through a broad emerging-markets fund.
