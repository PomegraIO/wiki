---
title: "Netcapital Inc. (NCPLW)"
description: "Netcapital operates a crowdfunding platform connecting accredited and non-accredited investors with early-stage companies and alternative assets, functioning as a marketplace for private securities and emerging investment opportunities."
keywords:
  - crowdfunding
  - private equity
...
Netcapital is an online investment platform that enables individuals to fund and invest in early-stage companies, real estate projects, and other alternative assets that were historically available only to institutions or wealthy investors. The company operates primarily as a marketplace connecting capital providers—both [accredited investors](/accredited-investor/) and, in certain offerings, non-accredited retail investors—with entrepreneurs and project developers seeking growth capital or [acquisition](/acquisition/) financing. The business sits at the intersection of fintech, crowdfunding, and alternative finance, areas that are lightly regulated but rapidly evolving as the [Securities and Exchange Commission](/securities-and-exchange-commission/), state regulators, and Congress refine rules around retail access to private securities.

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>NCPLW (NASDAQ)</td></tr>
<tr><th>Founded</th><td>2013</td></tr>
<tr><th>Headquarters</th><td>New York, New York</td></tr>
<tr><th>Business model</th><td>Marketplace platform; transaction fees and advisory services on deals</td></tr>
<tr><th>Regulatory framework</th><td>Regulation A and Regulation CF (SEC rules for capital raising)</td></tr>
<tr><th>Primary revenue</th><td>Transaction fees on offerings; advisory and professional-services fees</td></tr>
<tr><th>SEC CIK</th><td>0001414767</td></tr>
</table>
</aside>

## The crowdfunding marketplace: connecting capital to early-stage ventures

Netcapital's core offering is the ability for entrepreneurs to raise capital directly from a broad investor base using standardized SEC-approved exemptions from the usual public-offering rules. The most important of these exemptions is [Regulation Crowdfunding](/regulation-cf/), which allows companies to raise up to 5 million dollars in a 12-month period from an unlimited number of individual investors (each capped in how much they may invest, depending on income). A second avenue is [Regulation A](/regulation-a/), which permits slightly larger "mini" public offerings with greater investor protections and higher limits. These regulatory pathways democratize capital formation: a startup that cannot attract venture capital or bank debt can pitch its business on Netcapital's platform and accumulate capital from thousands of small investors.
...
The second major risk is regulatory. Crowdfunding and alternative investment regulations have evolved considerably since the [JOBS Act](/jobs-act/) of 2012 introduced Reg CF, but they remain in flux. The SEC, state regulators, and Congress could tighten rules around who can invest, how much they can invest, what disclosures are required, or what platforms must do to safeguard against fraud. A significant regulatory change—such as lower limits on non-accredited investor participation or higher compliance costs—could shrink Netcapital's addressable market or compress margins.
