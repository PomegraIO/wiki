---
title: "Direxion Daily NFLX Bear 1X ETF (NFXS)"
description: "An inverse exchange-traded fund that seeks to deliver the opposite of Netflix's daily performance, designed for tactical bearish bets or hedging against downside in the streaming giant."
keywords:
  - inverse ETF
  - hedging
  - Netflix
...
<table>
<tr><th>Ticker</th><td>NFXS (NASDAQ)</td></tr>
<tr><th>Sponsor</th><td>Direxion Shares</td></tr>
<tr><th>Underlying</th><td>Netflix Inc. (NFLX)</td></tr>
<tr><th>Strategy</th><td>Inverse daily rebalancing</td></tr>
<tr><th>Leverage</th><td>-1X (daily reset)</td></tr>
<tr><th>Suitable for</th><td>Tactical hedges, not long-term holdings</td></tr>
</table>
</aside>
...
Inverse funds operate with a critical structural feature: they rebalance every day. NFXS holds a portfolio of short positions in Netflix that it resets at the close of each trading day to maintain its -1X exposure. This daily reset mechanism creates a subtle but powerful mathematics. In volatile, sideways markets, even if Netflix ends at the same price after a week, NFXS will have lost value relative to a simple one-week short because of the compounding effect of daily rebalancing across up-and-down swings.

Consider a simplified example. If Netflix rises 5% on Monday, then falls 5% on Tuesday, it ends at the same price after both days. A static short bet would break even. But NFXS loses 5% on Monday (when Netflix rises), then gains only 4.75% on Tuesday (because the 5% decline applies to a lower position baseline after Monday's loss). Over longer periods, the decay accelerates. Sideways and volatile markets are enemies to inverse funds; prolonged, one-directional downtrends are their natural habitat.

This characteristic makes NFXS dangerous as a multi-month or multi-year hedge. The decay will erode value even if the directional thesis eventually proves correct. Investors who hold inverse funds for extended periods often discover they have lost money even when the underlying asset declined because of this mathematically inevitable drift.
...
Investors considering NFXS should read the fund's prospectus and fact sheet, available on the Direxion website and through the SEC's EDGAR system. These documents explain the daily reset mechanism, the expense ratio, and the risks specific to inverse funds. The prospectus will also clarify the fund's permitted use of derivatives and its counterparty relationships.

Watch the daily performance and volatility of Netflix shares. If Netflix moves 2–3% per day, NFXS is functioning roughly as intended. If Netflix is in a long, steady decline, NFXS will deliver returns—but watch for the decay mathematics. Compare NFXS performance over a two-week period to what a simple Netflix short would have returned, or what a Netflix put option would have paid, to understand the real cost of daily rebalancing in your specific market conditions.

Use NFXS only for known, short-term tactical positions with a defined exit date tied to a specific event or market view. Treat any position held longer than two weeks as likely to underperform due to decay.
