---
title: "First Trust Indxx NextG ETF (NXTG)"
description: "NXTG is a thematic ETF holding a diversified portfolio of companies positioned to benefit from next-generation wireless networks (5G, 6G infrastructure, networking hardware, spectrum)."
keywords:
  - thematic etf
  - 5g
  - telecommunications
...
| **Index** | Indxx NextG Index |
| **Holdings** | Roughly 60–80 companies |
| **Focus** | 5G and next-generation wireless infrastructure and equipment |
| **Expense ratio** | ~0.70% annually (typical for thematic ETFs) |
| **Rebalancing** | Quarterly |
| **Liquidity** | Moderate; traded on NASDAQ |
