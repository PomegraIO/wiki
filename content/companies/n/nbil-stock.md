---
title: "GraniteShares 2x Long NBIS Daily ETF (NBIL)"
description: "A leveraged exchange-traded fund that tracks the Nasdaq Biotechnology Index with 2x daily rebalancing, designed for short-term tactical positions in biotech; carries leverage decay risk over longer holding periods."
keywords:
  - leveraged ETF
  - biotech
  - daily rebalancing
...
Here lies the mathematical trap. Daily rebalancing of leveraged positions creates what is known as volatility decay or leverage decay — a persistent drag on long-term returns in choppy or oscillating markets.

A simplified example: suppose NBIS is at 100, rises 10% to 110, then falls 10% back to 99. The index is down 1%. NBIL, rebalancing daily, gains 20% on day one (100 to 120), then loses 20% on day two (120 to 96). The fund is down 4%, while the underlying index is down 1%. This gap widens as the number of oscillations increases and as volatility spikes. Over a month of typical market chop, leverage decay can erode 5% to 15% of capital, depending on the magnitude of daily swings.

The prospectus warns about this explicitly. It is not a bug — it is the inevitable consequence of compounding daily leverage. Holding NBIL for longer than a few days is almost certainly a mistake for investors with a medium-term thesis; they should hold the unleveraged NBIS benchmark instead.

## Sector concentration and swing risk

Biotech is one of the most volatile equity sectors. Companies in the space dedicate 20–35% of revenue to research, face long regulatory timelines, and often have binary outcomes on key approvals. A single clinical trial result can move an individual holding by 20% or 30%. The index reflects this: it swings far more than the broader market.

When you layer 2x leverage onto a volatile sector, the daily price moves become acute. NBIL can swing 10% or more on a single day when biotech sentiment shifts. This is appropriate for traders managing intraday or overnight risk; it is unsuitable for anyone treating the fund as a longer-term sector exposure.
