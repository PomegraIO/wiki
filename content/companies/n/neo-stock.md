...
description: "A specialized clinical laboratory providing cancer genetic and molecular testing services to oncologists, hospitals, and pharmaceutical companies."
keywords:
  - cancer diagnostics
  - molecular pathology
  - clinical genomics
...
**Ticker** NEO (NASDAQ)  
**Founded** 1997 (as NeoGenomics, Inc.)  
**Sector** Healthcare — Clinical Laboratory Services  
**What it does** Oncology-focused cancer genetics and molecular testing  
**Key service lines** Hematologic malignancy testing, solid tumor testing, companion diagnostics  
**SEC CIK** 1077183  
...
NeoGenomics is not alone in the oncology testing space. [Quest Diagnostics](/dgx-stock/) and LabCorp—two massive national clinical laboratory networks—both offer cancer genomics services, though often through specialized units or [acquisitions](/acquisition/). Ambry Genetics and [Myriad Genetics](/mygn-stock/) are also major players in cancer genetic testing. The market is fragmented and competitive on price, turnaround time, and assay comprehensiveness.
