---
title: "Annaly Capital Management Inc. (NLY-PI)"
description: "Annaly is a mortgage real estate investment trust that buys mortgage-backed securities and funds them with debt, profiting from the interest-rate spread between what it borrows and what it earns."
keywords:
  - mortgage REIT
  - mortgage securities
  - interest rates
...
<table>
<tr><th>What it does</th><td>Buys mortgage-backed securities and funds them with cheap debt</td></tr>
<tr><th>What it owns</th><td>Mostly agency mortgage bonds (Fannie Mae, Freddie Mac, Ginnie Mae)</td></tr>
<tr><th>How it makes money</th><td>Spread between borrowing cost and bond yield</td></tr>
<tr><th>Where it's listed</th><td>NYSE under ticker NLY-PI</td></tr>
<tr><th>Founding</th><td>1997</td></tr>
<tr><th>Tax structure</th><td>REIT — must distribute most income as dividends</td></tr>
...
Size also comes with a downside: Annaly is now so large that there is not much room to grow. The mortgage market itself is a fixed size — it grows and shrinks, but Annaly cannot expand faster than mortgages grow without stealing market share from someone else. The company is essentially sitting on most of what it can reasonably own.
...
The company has survived multiple rate shocks and kept its footing. But there is a limit to how much dislocation Annaly can absorb without damage.

## What Annaly is not: a brand, a network, or a secret sauce

Annaly is not protected by brand loyalty, network effects, or proprietary technology. The mortgage-backed securities that Annaly owns are standardized, transparent, and traded in a huge public market. Anyone can buy the same bonds that Annaly buys, at the same price. The advantage Annaly has is scale and the ability to borrow cheaply. But advantage is not the same as moat. A new entrant with enough capital can, in principle, do exactly what Annaly does.

Competition in the mortgage REIT space is fierce. Insurance companies, pension funds, foreign banks, and smaller mortgage REITs all bid for the same bonds. The market is not growing — new mortgages originate and old mortgages get paid off, but the total size is not expanding at 15 percent a year. This means Annaly grows only if other mortgage REITs shrink, or if overall mortgage volumes grow. Neither is a reliable tailwind.

## The dividend, the hook
