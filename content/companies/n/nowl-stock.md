---
title: "GraniteShares 2x Long NOW Daily ETF (NOWL)"
description: "A leveraged daily-reset ETF that amplifies Nasdaq-100 movements by 2x, designed for short-term traders; carries volatility decay risk and unsuitable for buy-and-hold investing."
keywords:
  - leveraged ETF
  - daily reset
  - Nasdaq-100
...
## The volatility decay penalty

When markets oscillate — climbing, then falling, then climbing again — the leverage amplifies both moves. The crucial asymmetry is that percentage losses on a leveraged position hurt more than corresponding gains help. Start with $1,000 in NOWL. On day one, the Nasdaq-100 falls 10 percent; NOWL falls 20 percent, leaving $800. On day two, the index rises 10 percent; NOWL rises 20 percent — but 20 percent of $800 is $160, leaving $960. The index returned to within 1 percent of its starting level (100 down to 90, then back to 99), yet the fund surrendered 4 percent of capital. This pattern, called volatility decay or variance drag, becomes more severe when markets are choppy and less of an issue in sustained, one-directional moves.

Over longer periods — months or years — this mathematical drag typically overwhelms any simplistic expectation that 2x leverage should deliver 2x the return. A reader can verify this by comparing NOWL's performance over trailing three-year or five-year windows against twice the Nasdaq-100's return over the same periods. The difference is volatility decay.
