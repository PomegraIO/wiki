...
**Refined Products Distribution** rounds out the operating portfolio. The company operates wholesale branded fuel terminals and distributes branded gasoline, diesel, and fuel oil to retail partners. This segment provides geographic [diversification](/diversification/) but can be margin-compressed in competitive markets; it also carries exposure to refined-product crack spreads (the margin between crude input and refined-product output), which can narrow sharply.
