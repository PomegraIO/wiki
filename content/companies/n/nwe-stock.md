---
title: "NorthWestern Energy Group, Inc. (NWE)"
description: "NorthWestern Energy operates regulated electric and natural gas utilities across Montana, South Dakota, and Nebraska — a capital-intensive, rate-regulated regional utility dependent on steady rate recovery and vulnerable to commodity cost shocks."
keywords:
  - electric utility
  - natural gas utility
  - regulated utility
...
NorthWestern Energy is a regulated utility company that generates, transmits, and distributes electricity and [natural gas](/natural-gas/) to customers in Montana, South Dakota, and Nebraska. It is a classic regulated monopoly — the company owns and operates the infrastructure in its service territories and cannot be competed with on price (prices are set by state regulatory commissions), but in exchange is granted a defined service territory and a right to recover costs and earn a regulated [return on invested capital](/return-on-invested-capital/). The shares ([NASDAQ](/nasdaq/): NWE) trade as a defensible but unexciting infrastructure holding, valued on the [dividend yield](/dividend-yield/) and the predictability of regulated earnings.

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>NWE (NASDAQ)</td></tr>
<tr><th>Founded</th><td>1913, originally Montana Power Company</td></tr>
<tr><th>Headquarters</th><td>Billings, Montana</td></tr>
<tr><th>Sector</th><td>Utilities / regulated infrastructure</td></tr>
<tr><th>Business</th><td>Electric and natural gas generation, transmission, and distribution</td></tr>
<tr><th>Service territories</th><td>Montana, South Dakota, Nebraska</td></tr>
<tr><th>Business model</th><td>Rate-regulated utility earning a Commission-approved return on rate base</td></tr>
<tr><th>SEC CIK</th><td>0001993004</td></tr>
</table>
</aside>
...
Through the 2000s and 2010s, NorthWestern rebuilt by acquiring or consolidating with other utilities. It now operates three main utilities: Montana Power (electric and gas in Montana), Northwestern Energy Company (primarily electric in South Dakota), and Black Hills Power (primarily electric in South Dakota and Nebraska). This portfolio of utilities in three states gives the company more geographic and weather [diversification](/diversification/) than it had as a pure Montana company, but it also makes the company more complex to manage and more dependent on navigating regulatory environments in multiple states.
...
Monitor quarterly earnings for growth in the rate base (which drives earnings growth) and trends in the [dividend](/dividend/). Utilities are valued partly on dividend yield, so dividend safety is important. Watch for any regulatory setbacks (rate case rejections, investment disallowances) that signal changing sentiment toward the company.
