---
title: "GraniteShares 2x Long NVDA Daily ETF (NVDL)"
description: "A daily-reset leveraged ETF that targets twice Nvidia's daily movement, amplifying gains during bull markets but exposing holders to significant decay in volatile or declining markets."
keywords:
  - leveraged ETF
  - 2x long
  - NVDA
...
The most insidious cost of leverage is volatility decay. Suppose Nvidia trades in a tight range: up two percent one day, down two percent the next day, repeating for several weeks. After a cycle of that volatility, the stock ends where it started, but the leveraged fund has suffered cumulative losses.
