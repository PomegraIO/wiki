---
title: "Newbury Street II Acquisition Corp (NTWO)"
description: "A $172.5 million SPAC launched in late 2024 by executives from Turner Sports and Sunderland Capital, hunting for a high-quality acquisition target with no announced industry focus."
keywords:
  - SPAC
  - blank-check company
  - Turner Sports
...
Newbury Street II [Acquisition](/acquisition/) Corp. is a classic SPAC: incorporated in Delaware, raised capital in a public offering, and is now using that capital to search for an operating company to acquire. The sponsor brings a track record of transaction experience and industry knowledge, but no predetermined target or sector. Where some SPACs declare a geographic focus (Latin America), an industry (energy transition), or a company type (fintech), Newbury Street II has kept its options deliberately open, betting that the sponsors' judgment will find an attractive opportunity wherever it appears.

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>NTWO (NASDAQ)</td></tr>
<tr><th>Founded</th><td>2021, Delaware</td></tr>
<tr><th>IPO date</th><td>November 4, 2024</td></tr>
<tr><th>IPO size</th><td>$172.5 million (17.25 million units)</td></tr>
<tr><th>Chairman</th><td>Matthew Hong (former COO, Turner Sports)</td></tr>
<tr><th>CEO</th><td>Thomas Bushey (founder and CEO, Sunderland Capital)</td></tr>
<tr><th>Trust account</th><td>Approximately $181–182 million</td></tr>
<tr><th>SEC CIK</th><td>0002028027</td></tr>
</table>
</aside>
...
Investors should monitor the company's quarterly SEC filings (particularly the 10-K [annual report](/10-k/) filed in late 2024 and subsequent 10-Qs) for trust account disclosures and any press releases announcing a proposed merger target. Once a target is announced, the [proxy statement](/proxy-statement/) filed with the SEC becomes the critical document—it contains the target company's audited financials, risk factors, management bios, and projections. Comparing those projections to subsequent actual performance is essential for evaluating whether the deal met expectations.