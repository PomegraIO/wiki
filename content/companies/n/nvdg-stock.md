---
title: "Leverage Shares 2X Long NVDA Daily ETF (NVDG)"
description: "A daily-reset leveraged ETF that aims to deliver twice Nvidia's daily gain, designed for tactical long positions but exposing holders to volatility decay in sideways or falling markets."
keywords:
  - leveraged ETF
  - 2x long
  - NVDA
...
The cost of leverage varies with short-term interest rates. When the [Federal Reserve](/federal-reserve/) holds rates high, borrowing money is expensive, and the drag from leverage interest grows. A holder of NVDG during a period of elevated rates bears a higher financing cost than someone holding the same fund during a period of low rates. This is a passive drag that has nothing to do with Nvidia's business or stock momentum.
...
NVDG trades on a [stock exchange](/stock-exchange/) and replicates most of the [bid-ask spreads](/bid-ask-spread/) and liquidity of Nvidia itself. The expense ratio is above-average for an ETF because of the leveraged structure and daily rebalancing. The fund pays no [dividend](/dividend/).
