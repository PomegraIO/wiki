---
title: "Newmont Corp /DE/ (NEMCL)"
description: "Newmont is the world's largest gold producer by output, operating mines across multiple continents and generating steady cash flow from a diversified asset base of producing operations."
keywords:
  - gold mining
  - precious metals
  - mining operations
...
<table>
<tr><th>Ticker</th><td>NEMCL (NYSE), NGD (TSX)</td></tr>
<tr><th>Founded</th><td>1921 (as Newmont Mining); current form post-2019 merger</td></tr>
<tr><th>Headquarters</th><td>Denver, Colorado</td></tr>
<tr><th>Sector</th><td>Precious metals mining</td></tr>
<tr><th>Primary commodity</th><td>Gold, with copper as secondary product</td></tr>
<tr><th>Geographic presence</th><td>North America, South America, Australia, Ghana, and other regions</td></tr>
<tr><th>Business model</th><td>Mine operation, mineral processing, commodity sales</td></tr>
<tr><th>SEC CIK</th><td>0001164727</td></tr>
</table>
</aside>
...
Gold mining is capital-intensive and cyclical. A new mine takes years to develop, requires tens of millions or billions of dollars in upfront investment, and then produces gold for 10–30 years depending on ore grades and mining rates. Once operating, a mine is largely fixed-cost: you must pay for the equipment, staff, and energy whether commodity prices are high or low, so a sharp decline in gold prices can turn a profitable mine into a loss-making operation.

## Copper and byproduct revenue

Several of Newmont's mines produce copper alongside gold — a valuable secondary product. Copper prices are often negatively correlated with gold (in periods of economic weakness, investors flock to gold's safety and copper demand falls), so the mix diversifies Newmont's revenue. However, copper is typically a lower-margin byproduct rather than the primary extraction target, so copper prices do not drive Newmont's earnings the way gold does.

## The supply chain of mining

Newmont's upstream dependencies are geological and regulatory. The company depends on its exploration teams identifying new ore bodies within or adjacent to existing mining areas, extending the life of mines and supporting replacement of ore processed. Exploration is ongoing; without it, ore reserves deplete and mines eventually shut down. Newmont also depends on mining licenses and permits granted by governments — a mine can be halted if a permit is revoked or renewal is denied due to environmental concerns, labor disputes, or political changes.
...
## Mining efficiency and capital discipline

Newmont's competitive position depends on operational efficiency and cost discipline. The company with the lowest all-in cost per ounce can profitably operate mines that competitors must shut down during low-price periods. Newmont has invested in automation, process optimization, and organizational efficiency to maintain low costs. The company also manages risk through hedging strategies and disciplined capital allocation — evaluating new mine development projects carefully and rejecting opportunities with insufficient returns relative to capital deployed.
...
Understanding Newmont requires tracking three streams. First, gold prices: the spot price sets the revenue ceiling and floor, so any analysis of Newmont must bracket how the business performs across a range of gold-price scenarios. Second, mine-by-mine production and costs: Newmont discloses this in investor presentations and SEC filings, allowing you to assess which mines are performing well and which are facing headwinds. Third, project pipeline and capital allocation: the company regularly discusses development projects (new mines or mine expansions), their timeline, expected capital cost, and prospective returns. The quality and timing of these projects determine whether Newmont's production will grow or decline over the next decade.
