---
title: "PGIM S&P 500 Buffer 12 ETF - April (APRP)"
description: "A buffer fund that wraps the S&P 500 with options-based downside protection and upside capping, designed to reduce equity volatility while maintaining core market exposure."
keywords:
  - buffer ETF
  - downside protection
  - S&P 500
...
PGIM Investments, the investment-management arm of [Prudential Financial](/pru-stock/), launched APRP to offer institutional and retail investors a defined-outcome product based on the S&P 500. Rather than invent a new index or proprietary methodology, the fund relied on a straightforward options collar: it holds the S&P 500 or equivalent index futures, buys [protective puts](/protective-put/) at a strike 12% below the starting level, and sells [call options](/call-option/) at a strike somewhere above that start price. The puts establish a floor (losses are capped at 12%); the sold calls establish a ceiling (gains are capped at some agreed level).
...
APRP trades on an exchange like any ordinary ETF, with intraday [price discovery](/price-discovery/) and arbitrage keeping its [net asset value](/net-asset-value/) close to its [fair value](/fair-value/). The fund's composition is transparent: it holds S&P 500 constituents or index futures, plus the options. Twice yearly (in April and as needed in October), PGIM rebalances and resets the options layer. When the reset comes, the old protective puts expire worthless or in-the-money (if breached), and new puts are written 12% below the new reference level. Similarly, new calls are written at the new environment's [implied volatility](/implied-volatility/) and strike levels.
...
APRP's [expense ratio](/expense-ratio/) is quoted on PGIM's fact sheets and is typical for a structured ETF—higher than a plain [S&P 500 index](/sp-500-index/) fund, lower than most actively managed strategies. There is no leverage, so no daily decay. The fund does not generally pay a yield [dividend](/dividend/), because the collateral is in equities and the [option collar](/option-collar/) caps gains; PGIM's structure tends to distribute any premium income back into the fund rather than paying it out. This differs from income-focused barriers or barrier funds, where the short calls are specifically sold to harvest income.

The trade-off is stark: in a strong [bull market](/bull-market/), APRP lags meaningfully because of the capped upside. In a sharp [bear market](/bear-market/), APRP outperforms because the 12% buffer prevents losses below that level. In sideways or modestly bullish markets, the buffer barely matters and APRP moves almost with the index. Decades of backtest data from index-option overlays suggest that over very long periods, this trade (giving up some upside to cap downside) is roughly break-even or slightly negative in terms of total return—the protection is paid for in foregone gains. But for an investor whose utility function strongly prefers knowing the maximum loss, the structure has psychological and portfolio-planning value independent of raw return math.
