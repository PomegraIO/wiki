---
title: "Alpha Star Acquisition Corp (ALSWF)"
description: "Alpha Star Acquisition Corp (ALSWF is the warrant symbol) is a shell company raising capital for a merger; warrant holders bet on OU XDATA deal completion and post-merger stock appreciation."
keywords:
  - SPAC warrant
  - leverage
  - call option
...
Alpha Star [Acquisition](/acquisition/) Corp, a Cayman Islands entity trading on OTC Markets under four symbols (ALSAF for [common stock](/common-stock/), ALSUF for units, ALSTF for rights, and ALSWF for warrants), is structured to accommodate different investor risk appetites through multiple security classes. Each class represents a different claim on the SPAC's assets and a different bet on whether the [merger](/merger/) will succeed.

## Common shares and the trust account

The backbone of Alpha Star is the common stock (ALSAF symbol). When the SPAC conducted its [initial public offering](/initial-public-offering/), investors purchased units, which typically bundle one common share and a warrant (or a fraction of a warrant). That capital was deposited into a trust account and remains there, largely untouched, until the merger closes or the deadline passes. The common shareholder holds the most senior claim: if the merger fails and the trust is liquidated, common shareholders recover their pro-rata portion of the trust first. If the deal succeeds, common shareholders own a stake in the merged company.
...
Units (ALSUF symbol) combine one common share and one warrant in a single trading vehicle. Units are the form in which the SPAC originally sold shares to the public. After listing, units typically separate into their constituent parts—shares and warrants trade independently—but some shareholders hold units and let [brokers](/broker/) handle the splitting automatically. Units are convenient for small investors who want both the upside (the warrant) and the base claim (the common share) in a single purchase.
...
Warrants (ALSWF symbol) are the leverage instrument. Each warrant grants the holder the right to purchase one share of the merged company at a predetermined [strike price](/strike-price/) (typically $11.50 for classic SPAC warrants, though terms vary). Warrants have no value if the merger fails; they are worthless in [liquidation](/liquidation/). They have value only if the merger succeeds and the stock price rises above the strike price.
