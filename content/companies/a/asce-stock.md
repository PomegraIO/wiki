---
title: "Allspring SMID Core ETF (ASCE)"
description: "Allspring SMID Core ETF holds mid-sized and small-to-mid-cap companies, offering diversified equity exposure to the middle of the market outside mega-cap tech."
keywords:
  - SMID cap ETF
  - small-cap investing
  - mid-cap stocks
...
<table>
<tr><th>Ticker</th><td>ASCE</td></tr>
<tr><th>Issuer</th><td>Allspring Funds (Voya Financial)</td></tr>
<tr><th>Structure</th><td>Exchange-traded fund</td></tr>
<tr><th>Size focus</th><td>SMID-cap (small and mid-cap)</td></tr>
<tr><th>Index tracked</th><td>Market-cap-weighted SMID-cap index</td></tr>
<tr><th>Holdings</th><td>Approximately 400–600 companies</td></tr>
<tr><th>Fee</th><td>Low annual expense ratio</td></tr>
</table>
</aside>
...
Most investors know about large-cap stocks — the 500 largest companies in the U.S., for example, form the S&P 500. Those 500 names are easy to follow, widely held, and usually fairly liquid. Many investors also own small-cap funds, which capture the smallest publicly traded companies. But the SMID range — companies with market capitalizations in the low billions to tens of billions — is often overlooked.

That middle ground matters because it includes some of the fastest-growing companies that have graduated from the small-cap world but not yet joined the mega-cap club. These firms often have more runway to expand than established large-caps, and they are still small enough that individual management decisions or new products can move the needle meaningfully. They are also under-researched compared to mega-caps, so skilled stock pickers sometimes find mispricings. ASCE's passive approach means you get that exposure — the good and the bad — without paying for active management.
