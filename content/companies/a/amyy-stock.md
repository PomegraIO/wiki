---
title: "GraniteShares YieldBOOST AMD ETF (AMYY)"
description: "An ETF holding AMD stock that uses an options overlay to boost current income, trading potential price upside for higher dividend-like distributions."
keywords:
  - covered call
  - options overlay
  - yield enhancement
...
AMYY is pitched at income-oriented shareholders who own AMD and want higher current distributions, or who believe AMD will trade in a range without making dramatic moves upward. If you are bullish on AMD over a long period but willing to forego the upside above a certain level in exchange for higher current income, AMYY makes that trade for you automatically. It is a substitute for manually selling calls yourself, removing the operational burden of rolling strikes monthly.

The fund appeals most to investors in a lower tax bracket (or in tax-advantaged accounts) and retirees seeking quarterly or monthly cash, though many use it tactically when they expect low volatility in AMD.
...
An investor seeking income from AMD has several paths: hold AMD stock directly and sell calls themselves; buy a non-leveraged AMD ETF like AMD-tracking index products; or use AMYY for hands-off implementation. Direct call selling gives maximum flexibility and potentially lower costs if you are active. AMYY offers simplicity at the cost of slightly higher fees and less frequent adjustment (monthly versus weekly or daily if you manage it yourself).

## How to research AMYY

Start with the fund's prospectus and fact sheet, which show the historical premium collected, the typical call strike as a percentage above spot, and the distribution history. Review the fund's performance against plain AMD stock and against its own stated objective (the AMD stock price plus the average monthly call premium). Ask: are the distributions coming from actual call premiums, or is the fund eating into principal? The answer should be transparent in the fund's quarterly filings and fact sheets. Most importantly, run the math: if AMD has historically rallied 20% per year, and the call strikes cap you at 5% above current price each month, what is your expected return after missing the upside? If that math works, AMYY fits. If not, a direct position may be more suitable.
