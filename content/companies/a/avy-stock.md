...
description: "Global manufacturer of pressure-sensitive materials, labeling, and packaging solutions serving retail, logistics, and industrial markets with RFID and intelligent labeling technology."
keywords:
  - materials science
  - label printing
  - supply chain
...
The company has a long history of bolt-on [acquisitions](/acquisition/), typically in adjacencies: fastener specialists, specialty tape makers, digital printing software companies, and RFID vendors. This M&A approach broadens the portfolio and extends reach into adjacent end-markets without requiring greenfield investment. The financial profile has historically been stable: single-digit growth in mature segments offset by mid-to-high teens growth in intelligent labeling; stable [cash flow](/wiki/cash-flow-statement/) that funds the [dividend](/dividend/) and modest [share buybacks](/share-buyback/).
