---
title: "Avantis Inflation Focused Equity ETF (AVIE)"
description: "An exchange-traded fund designed to provide equity exposure and inflation protection by overweighting companies with pricing power and real asset holdings."
keywords:
  - inflation hedge
  - equity ETF
...
But the trade-off is that in periods of low inflation or [deflation](/deflation/), those characteristics might not help, and they could hurt. A utility or pipeline company that is great for inflation protection might underperform in a [disinflation](/disinflation/) period when growth and earnings stability come to the fore. AVIE is not a hedge you turn on and off; it is a long-term structural tilt toward characteristics that have historically done better in inflationary regimes.

## Costs and risks

AVIE's [expense ratio](/expense-ratio/) is modest, reflecting its index-based systematic approach. The fund does not employ stock-pickers; the holdings are determined by the inflation-protection criteria applied consistently.
