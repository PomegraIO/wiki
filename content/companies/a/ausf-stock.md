---
title: "Global X Adaptive U.S. Factor ETF (AUSF)"
description: "AUSF is a rules-based factor ETF that dynamically rotates exposure between value, growth, and momentum factors based on market conditions, aiming to harvest risk premiums across market cycles."
keywords:
  - factor investing
  - smart beta
  - value investing
...
<div class="wiki-infobox-title">AUSF — key facts</div>

<img src="https://images.unsplash.com/photo-1611974789855-9e51c17a9797?w=600&q=80" alt="A stylised graph showing multiple trend lines diverging and reconverging over time." />

<div class="wiki-infobox-caption">Factor rotation attempts to capture the best-performing investment style as market regimes shift.</div>

|   |   |
|---|---|
| **What it is** | Actively managed, rules-based factor ETF |
| **Universe** | U.S. large-cap stocks (500–600 holdings) |
| **Factors tracked** | Value, growth, momentum (dynamic weighting) |
| **Sponsor** | Global X |
| **Rebalancing** | Monthly or quarterly based on factor signals |
| **Expense ratio** | Mid-range for active/smart-beta products |
| **Turnover** | Moderate to high due to factor rotation |
| **Liquidity** | Trades on exchange; daily NAV publication |
