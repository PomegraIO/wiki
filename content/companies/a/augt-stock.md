---
title: "AllianzIM U.S. Large Cap Buffer10 Aug ETF (AUGT)"
description: "An AllianzIM fund tracking the Russell 1000 with 10% annual downside protection through an options overlay that resets in August — suited for conservative equity investors seeking stability."
keywords:
  - buffer ETF
  - Russell 1000
  - Allianz
...
The buffer is enforced through options. AllianzIM buys [put options](/put-option/) on the Russell 1000 Index, which act as insurance that protects you against losses beyond 10%. To pay for those puts, the fund sells [call options](/call-option/), which cap your gains. The options reset every August, so the fund is rebooked and repriced at that time. A new 12-month period begins, and the buffer and cap are set for the next year. This structure is why the fund's name includes "Aug" — August is the reset month.

The Russell 1000 itself is a broad index of the largest U.S. corporations. It includes the mega-caps like [Apple](/aapl-stock/) and [Microsoft](/msft-stock/) but also thousands of smaller large-cap stocks that many investors never think about. This breadth is a strength; your fund is not betting on one sector or size class. The Russell 1000 has historically tracked very closely to the performance of the S&P 500 over long periods, though the Russell 1000 includes more small-cap representation and is slightly less concentrated in the largest few companies.
...
The [expense ratio](/expense-ratio/) is higher than a plain Russell 1000 [index fund](/index-fund/), because the options overlay is not free. However, it is modest relative to the value of the protection. In a severe [bear market](/bear-market/) year, a 15% swing between your portfolio and the unhedged index (the difference between a 25% loss and a 10% loss) can be worth years of extra fees. Conversely, in a strong [bull market](/bull-market/) year, the cap costs you dearly, and you will wish you owned the unhedged fund.

AUGT trades like any other ETF on a [stock exchange](/stock-exchange/). You can buy it in a brokerage account, hold it in a retirement account, and it settles in one day. The fund is transparent; the underlying holdings (the Russell 1000 companies) are public, and the buffer and cap percentages are published before each August reset. There is no mystery or complexity hidden from you.
