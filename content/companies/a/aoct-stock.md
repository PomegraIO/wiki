---
title: "Innovator Equity Defined Protection ETF - 2 Yr to October 2026 (AOCT)"
description: "A structured ETF that provides downside protection on the S&P 500 while capping upside, with principal protected through October 2026, resetting annually."
keywords:
  - structured note
  - downside protection
  - defined outcome
...
<table>
<tr><th>Ticker</th><td>AOCT (NYSE Arca)</td></tr>
<tr><th>Issuer</th><td>Innovator ETFs</th></tr>
<tr><th>Underlying index</th><td>S&P 500</td></tr>
<tr><th>Protection feature</th><td>Principal protected through Oct 2026</td></tr>
<tr><th>Fund type</th><td>Defined-outcome ETF</td></tr>
<tr><th>Reset date</th><td>October 16, 2026</td></tr>
<tr><th>Structure</th><td>Options-based strategy</td></tr>
</table>
</aside>
...
On October 16, 2026, the current protection period expires and a new one begins. Holders of AOCT at that moment will roll into a new defined-outcome ETF with a new two-year protection window — the details of the cap and floor will be reset based on market conditions at that time. If you do not like the terms of the new period, that is the natural exit point. If you want to stay, you simply hold the newly reset fund. This is why the prospectus and fact sheet are dated by reset period: the fund's terms only hold until October 2026, and investors should plan accordingly.
...
The first risk is obvious: if you sell before October 2026, you lose the protection promise. The fund's price moves daily, and if equities have fallen sharply, AOCT might trade below your purchase price (though not below the promised floor on the reset date). Selling into a down market locks in that loss rather than waiting for the protection to activate.
...
## How to research AOCT

Start with Innovator ETFs' prospectus and fact sheet for AOCT, which spell out the current cap, the floor, the reset date, and the holdings (the mix of options and cash that implements the strategy). The prospectus is the definitive source for the mechanics and the risks. Cross-reference it against plain index-fund alternatives — how much upside are you trading away for that downside protection, and is the trade-off worth your circumstances?

For investors considering defined-outcome funds generally, it is worth stepping back and asking what specific risk event you are hedging against. If it is a two-year time horizon and a major crash in equities, AOCT is designed for that. If it is unease about volatility in general, or a long-term investing horizon, different solutions might be more appropriate. The strength of a defined-outcome ETF is that it is explicit and simple; the challenge is that simplicity can mask the opportunity cost of the cap.
