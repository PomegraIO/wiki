---
title: "Direxion Daily ADBE Bull 2X ETF (ADBU)"
description: "ADBU is a daily-reset leveraged ETF that tracks Adobe's stock with 2x magnification, designed for traders betting on near-term gains; it experiences volatility decay over longer holding periods."
keywords:
  - leveraged ETF
...
*Direxion Daily ADBE Bull 2X ETF (ticker ADBU) is a leveraged exchange-traded fund that tracks the stock of [Adobe](/adbe-stock/) Inc. with 2x daily magnification. It seeks to deliver twice the daily return of the underlying Adobe share, making it a tool for traders and speculators betting on strong near-term upward moves in the stock, not a buy-and-hold investment.*

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>ADBU (NYSE Arca)</td></tr>
<tr><th>Issuer</th><td>Direxion Shares</td></tr>
<tr><th>Underlying</th><td>Adobe Inc. (ADBE)</td></tr>
<tr><th>Structure</th><td>Daily-reset leveraged ETF</td></tr>
<tr><th>Leverage ratio</th><td>2x (twice daily return)</td></tr>
<tr><th>Objective</th><td>Track Adobe's daily performance at 2x magnification</td></tr>
<tr><th>Investor profile</th><td>Short-term traders only</td></tr>
</table>
</aside>

## What ADBU actually tracks

ADBU holds a portfolio of Adobe stock and financial instruments — primarily derivatives such as swap agreements or futures — designed so that on any given day, the fund's [net asset value](/net-asset-value/) moves roughly twice as far as Adobe shares move. If Adobe rises 1%, ADBU targets a 2% gain. If Adobe falls 1%, ADBU targets a 2% loss. The fund's daily rebalancing keeps this 2x ratio in place, which is where the critical flaw in holding leveraged products long term emerges.
