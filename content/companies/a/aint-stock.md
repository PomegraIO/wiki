---
title: "FINQ Dollar Neutral U.S. Large Cap AI-Managed Equity ETF (AINT)"
description: "AINT is an actively managed exchange-traded fund using artificial intelligence to select large-cap U.S. stocks while hedging currency risk, designed for investors seeking AI-driven stock picks with no foreign-exchange exposure."
keywords:
...
<table>
<tr><th>Ticker</th><td>AINT (NASDAQ)</td></tr>
<tr><th>Fund type</th><td>Active ETF (AI-selected, hedged)</td></tr>
<tr><th>Sponsor</th><td>FINQ</td></tr>
<tr><th>Focus</th><td>U.S. large-cap stocks</td></tr>
<tr><th>Strategy</th><td>AI-driven selection with dollar-neutral hedge</td></tr>
<tr><th>Management</th><td>Algorithmic stock selection with active hedging</td></tr>
<tr><th>Best for</th><td>International investors; those wanting AI picks without currency risk</td></tr>
</table>
</aside>
...
### What portfolio does it hold?

AINT does not disclose a static holdings list because the portfolio changes as the models update. Holdings are published regularly on the fund's website or in regulatory filings, but they represent a snapshot in time. Because the focus is on large-cap U.S. stocks, the fund will likely hold recognizable household names and mega-cap technology and industrial companies. The exact weightings and which names are over- or underweighted relative to the overall large-cap universe depend on the algorithm's current signals.
...
International investors are the primary beneficiary. A European or Japanese investor holding AINT gets algorithmic stock selection — exposure to what the AI system thinks are the best U.S. large-cap stocks — without having to worry about the dollar moving against their home currency. A U.S. investor could buy AINT, but they would be paying for a currency hedge they do not need, making a simpler U.S. large-cap fund or a non-hedged AI-managed large-cap fund more economical.

### Has the AI approach worked?

This is the critical question. Any investor considering AINT should examine its historical performance against appropriate benchmarks — typically the S&P 500 or the Nasdaq-100, adjusted for the cost of the currency hedge. Has AINT outperformed after fees? By how much? Has the outperformance been consistent through different market conditions, or has the algorithm underperformed significantly in some periods? If the fund has lagged a simple passive large-cap index after accounting for fees and hedging costs, that suggests the algorithmic approach has not added value in this instance.
