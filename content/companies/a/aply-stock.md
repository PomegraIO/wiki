---
title: "YieldMax AAPL Option Income Strategy ETF (APLY)"
description: "APLY is an income-generating ETF that owns Apple shares and sells call options against them, aiming to capture Apple's dividend-like income from option premiums while capping upside gain."
keywords:
  - Apple
  - covered call
  - options strategy
...
YieldMax AAPL Option Income Strategy ETF (APLY) owns [Apple](/aapl-stock/) shares and systematically sells [call options](/call-option/) against that position, harvesting the premium from those options to generate income. The strategy is known as a [covered call](/covered-call/): you own the stock and rent out the right to someone else to buy it at a higher price. The buyer of the call pays you now for that privilege, and you keep the cash regardless of what happens to Apple later. It is an income play, and like all income strategies, it comes with a crucial tradeoff — capped upside in exchange for steady cash flow.

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>APLY (NASDAQ)</td></tr>
<tr><th>Fund type</th><td>Exchange-traded fund (options-based)</td></tr>
<tr><th>Sponsor</th><td>YieldMax</td></tr>
<tr><th>Underlying</th><td>Apple Inc. (AAPL)</td></tr>
<tr><th>Core strategy</th><td>Covered call writing</td></tr>
<tr><th>Distribution model</th><td>Monthly income distributions</td></tr>
<tr><th>Objective</th><td>Apple exposure plus option premium harvesting</td></tr>
<tr><th>Best for</th><td>Income-focused investors, lower volatility tolerance</td></tr>
</table>
</aside>

The structure is straightforward. APLY holds Apple shares — the full number of shares needed to cover all the calls it sells. Each month the fund sells call options with an [expiration date](/expiration-date/) typically three to six weeks out at a [strike price](/strike-price/) set above where Apple currently trades. Buyers pay a premium for these calls, and YieldMax collects that premium and distributes it to shareholders as income. As the options expire, the fund repeats the process, selling new calls and pocketing fresh premiums.
...
YieldMax charges an annual [expense ratio](/expense-ratio/) for managing the fund and executing the options strategy. That fee is in addition to any [bid-ask spread](/bid-ask-spread/) when you buy or sell the ETF shares themselves. The overall costs are moderate compared to [actively managed funds](/actively-managed-fund/) but above what you would pay for a plain Apple ETF.
...
[Concentration risk](/concentration-risk/) also runs the other direction: the option premium income may dry up if Apple becomes very stable and low-volatility. Premiums depend on the market pricing in potential Apple price movement; in a period of prolonged calm, those premiums shrink, and the strategy's income falls.
...
Watch the fund's historical performance to confirm it behaves as expected: delivering steady income with modest gains in [flat markets](/flat-market/) and capped gains or modest losses when Apple rises or falls sharply.
