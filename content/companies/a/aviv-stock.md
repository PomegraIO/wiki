---
title: "Avantis International Large Cap Value ETF (AVIV)"
description: "AVIV is an equity fund tracking a rules-based index of large-cap value stocks in developed markets outside the U.S., emphasizing valuation metrics like price-to-book."
keywords:
...
To evaluate whether AVIV belongs in a portfolio, an investor should read the [fund prospectus](/fund-prospectus/), examine the historical performance during periods when value underperformed (to confirm they can tolerate the drawdowns), and clarify their belief in the [value premium](/value-premium/) itself. The fund's recent holdings are disclosed regularly, and comparing them to an international market-cap index shows how much the value tilt is currently tilting in response to market valuations.
