---
title: "First Trust Active Factor Small Cap ETF (AFSM)"
description: "AFSM is an actively managed ETF that uses quantitative factors to select U.S. small-cap stocks, aiming to outperform through disciplined factor tilts and human oversight rather than passive index tracking."
keywords:
  - small cap
  - active management
  - factor investing
...
*An **actively managed ETF** is an exchange-traded fund where a team of managers makes discrete buy and sell decisions rather than tracking a fixed index, charging a fee for the effort and accepting the risk that their selections may underperform.*
...
AFSM appeals to investors who believe that small-cap companies offer a source of alpha — excess returns above what a simple passive index would deliver — and who trust First Trust's specific screening methodology. Small-cap stocks are less efficiently priced than large caps, in theory, which creates opportunities for skilled managers. But small-cap investing is also more expensive to implement (each trade costs more as a percentage of holdings) and more volatile, so conviction matters.

The fund is also attractive to investors who want to tilt their small-cap allocation toward factors like value and quality, rather than accepting the broad-market weight that an index fund would impose. If you believe value stocks will outperform over your investment horizon, AFSM offers a way to overweight them without running a separate account or managing multiple ETFs.
...
Anyone considering AFSM should review First Trust's fact sheet and prospectus, which lay out the specific factors and screening criteria the fund uses. The fund's regulatory filings are public and will show the actual portfolio holdings — a good way to understand whether the selection philosophy aligns with your own views. Compare AFSM's expenses and historical returns to passive small-cap index ETFs and to other active small-cap managers. Over a 5 to 10-year window, you should be able to assess whether the manager's factor discipline and stock selection have added value relative to a simple, cheaper index fund.