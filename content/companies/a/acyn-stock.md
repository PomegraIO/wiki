---
title: "FT Vest Laddered Autocallable Barrier & Income ETF (ACYN)"
description: "ACYN is an ETF tracking structured notes—autocallable securities tied to equity indexes—designed to deliver income through a laddered maturity structure and a portfolio of complex derivatives."
keywords:
...
Autocallables promise higher income than conventional bonds of similar credit quality, but that higher coupon comes with the barrier risk: the possibility of principal loss. In a volatile or declining equity market, investors face the choice between receiving steady income while their note sits deep below a barrier (approaching maturity with no call trigger) or absorbing losses if the underlying index remains depressed at maturity. This is not a free lunch; the higher yield compensates for the tail risk.

## Who invests in autocallable funds

ACYN appeals to income-focused investors willing to accept equity-linked downside risk in exchange for higher coupons than bonds and who believe equity indexes will remain above barriers over a multi-year horizon. This includes some retirees, conservative portfolios seeking yield enhancement, and institutions managing fixed-income sleeves that require regular cash flow. It is less suitable for those uncomfortable with barrier notes' complexity, credit risk, or who expect significant equity market weakness.
