---
title: "Centurion Acquisition Corp. (ALFUU)"
description: "A blank-check acquisition vehicle launched in 2024, seeking a merger with a technology company in gaming, cybersecurity, AI, or deep tech — itself a shell with no operations until a deal closes."
keywords:
  - SPAC
...
[Centurion Acquisition](/alf-stock/) Corp. is a Special Purpose [Acquisition](/acquisition/) Company, or SPAC — a legally inert investment vehicle created for the sole purpose of acquiring and merging with an operating company. It was founded in 2024 with no business of its own, no revenue, no products, and no employees beyond a [board of directors](/board-of-directors/) and an administrative skeleton. Its entire reason for existing is to hunt for, negotiate with, and absorb a private technology firm, at which point the shell dissolves and the absorbed company becomes the newly public entity. Until that [merger](/merger/) closes — if it ever does — Centurion is, by design, a dormant wallet.

## From IPO to search

Centurion filed for its [initial public offering](/initial-public-offering/) in May 2024 and priced at $10 per unit in June, raising $250 million gross. Each unit consisted of one Class A ordinary share and half a warrant exercisable at $11.50 per share. By August 2024, the underlying shares and warrants began trading separately on [Nasdaq](/nasdaq/) under the symbols ALF and ALFUW, stripping away the linked unit structure and leaving investors free to hold pieces rather than whole packages.
