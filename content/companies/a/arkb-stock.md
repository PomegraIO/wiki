---
title: "Ark 21Shares Bitcoin ETF (ARKB)"
description: "A US-listed bitcoin exchange-traded fund sponsored by ARK Invest and run by 21Shares, offering direct spot bitcoin exposure with low fees and significant assets under management."
keywords:
  - bitcoin ETF
  - spot bitcoin
  - ARK Invest
...
<table>
<tr><th>Ticker</th><td>ARKB (NASDAQ)</td></tr>
<tr><th>Sponsor</th><td>ARK Invest</td></tr>
<tr><th>Operator</th><td>21Shares AG</td></tr>
<tr><th>Asset type</th><td>Spot bitcoin</td></tr>
<tr><th>Launched</th><td>2023</td></tr>
<tr><th>Structure</th><td>Passively managed trust</td></tr>
<tr><th>SEC CIK</th><td>0001869699</td></tr>
</table>
</aside>
...
A bitcoin ETF has minimal recurring costs beyond custody and insurance. It does not need to employ analysts, traders, or strategists. It does not research companies or time markets. The fixed costs per unit of assets decline steeply as the fund grows. The largest bitcoin ETFs achieve enormous scale, which allows them to charge lower fees and still generate healthy revenue for the operator.

That growth-through-scale dynamic means that early bitcoin ETF operators with large, established funds have significant advantages. Funds with billions of dollars in assets can charge lower fees, which attracts more capital, which lowers unit costs further. An ETF with modest assets might struggle to sustain operations if fees are too high to attract investors. ARKB's position as a top-tier bitcoin ETF by assets gives it the critical mass to run profitably at competitive fees.

## What matters for shareholders

For investors considering ARKB, the core question is the custody and safety of the underlying bitcoin. The fund publishes regular attestations from custodians confirming that the bitcoin is held on behalf of shareholders. Regulatory risk is a secondary but real concern: any change in US law or SEC policy regarding cryptocurrency could alter the tax treatment, permissibility, or operational costs of holding the fund.

The fee structure determines the performance drag relative to owning bitcoin directly. A lower fee compounds into meaningful advantage over decades. Because the fund aims to track spot bitcoin with no active strategy, comparing its fee to those of competitors and to the direct-custody alternative is the main analytical work a prospective owner should undertake.

A bitcoin ETF's utility to a portfolio depends on whether the investor believes bitcoin itself has a place in a diversified holding, a question beyond the scope of the fund itself. The fund's job is to deliver what it promises: trustworthy access to physical bitcoin, low fees, and a price that moves in line with the underlying asset.
