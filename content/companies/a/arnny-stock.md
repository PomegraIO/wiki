...
The core business divides into three segments: insurance operations (the bulk of revenue), which include motor, property, and liability coverage; life insurance and pensions; and the consumer-facing health insurance arm. ASR derives income from insurance premiums, investment returns on its policy reserves, and fee-based services. Like most European insurers, the company faces persistent pressure from low [interest rates](/interest-rate/), competitive premium markets, and regulatory capital requirements. Its strength lies in customer relationships, brand heritage, and a diversified portfolio of risks across geographies and product lines.
