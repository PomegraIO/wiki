---
title: "AOT Software Platform ETF (AOTS)"
description: "AOTS tracks software development platforms and tools that power modern application creation, offering exposure to mid-cap software infrastructure companies focused on developer workflows."
keywords:
...
The AOT Software Platform ETF tracks companies whose software platforms and tools form the foundation of modern application development. Rather than betting on any single software giant, AOTS offers a diversified basket of mid-cap firms whose products shape how developers build, test, deploy, and manage applications in production — from code repositories and continuous-integration pipelines to containerization platforms and infrastructure automation.
...
A prospective investor should start with the fund's fact sheet, which lists the current holdings, the target index the fund tracks, and its tracking error — the difference between the fund's returns and the underlying index. Reading the prospectus reveals the fund's investment mandate and any fees beyond the expense ratio. Reviewing the composition of the underlying index shows whether the fund's thematic focus actually delivers the exposure claimed. Over time, watching the fund's holdings and the sector composition reveals whether the platform-focused thesis is holding up and whether the fund is capturing genuine growth in software infrastructure.
