...
description: "AGG tracks the entire U.S. investment-grade bond market — government, corporate, mortgage — making it the closest thing to owning 'the' U.S. bond market as a single holding, and the largest fixed-income ETF globally by assets under management."
keywords:
  - bond index
  - aggregate bond
  - fixed income
...
The fund's [expense ratio](/expense-ratio/) is 0.03% annually — negligible. That low cost reflects BlackRock's economies of scale and the straightforward nature of index replication. The tax efficiency is strong, partly because the index is broad enough that maturity flows and security substitution can happen without forcing large, distributed gains into shareholders' hands. For long-term holders, AGG's turnover is modest.

Risks are straightforward and familiar to any bond investor. When [interest rates](/interest-rate/) rise, bond prices fall, and AGG's value declines. The duration of AGG — a measure of interest-rate sensitivity — is moderate relative to a long-bond fund but higher than a short-term Treasury fund. The mortgage-backed securities in AGG carry [prepayment risk](/prepayment-risk/): when rates fall and homeowners refinance their mortgages, those securities are repaid early, and the fund is forced to reinvest at lower yields. [Credit risk](/credit-risk/) is low; nearly 100% of holdings are investment grade or backed by government guarantees. But should a significant number of corporate issuers fall into distress, AGG would absorb those losses.

[Inflation](/inflation/) is a subtler risk. Because AGG holds fixed-rate bonds, inflation erodes their purchasing power. In a low-inflation environment, AGG delivers its promised return. In sustained high inflation, real returns turn negative.
