---
title: "Avantis Emerging Markets Value ETF (AVES)"
description: "An exchange-traded fund tracking a value-tilted index of emerging-market stocks, designed to capture the returns of developing economies at a lower cost than traditional broad-based emerging-market funds."
keywords:
  - emerging markets
  - value investing
  - emerging market ETF
...
AVES is a traditional exchange-traded fund, not a leveraged or inverse product. It trades on a [stock exchange](/stock-exchange/) like any other ETF or stock, meaning investors can buy and sell shares throughout the trading day at market prices. The fund is funded entirely by the investors who own it — unlike a [hedge fund](/hedge-fund/), there is no separate capital source or fee tier. When someone buys a share of AVES, that money flows in; when they sell, the money flows out.

The fund's total [expense ratio](/expense-ratio/) — the annual fee expressed as a percentage of assets — is modest, reflecting its indexed, low-touch design. Because the fund is not paying a team of active stock-pickers, [management fees](/management-fee/) are a fraction of what an actively managed emerging-market fund would charge. The fund will occasionally rebalance its holdings to maintain its value tilt and to track its underlying index, which generates some trading costs.

## The real risks in emerging-market value

Emerging markets carry inherent risks that developed markets do not. [Currency volatility](/currency-volatility/) is the most immediate: if you are a U.S.-dollar investor, the returns of a Brazilian or Indian stock are buffeted both by the local stock price and by the strength or weakness of the [Brazilian real](/brazilian-real/) or [Indian rupee](/indian-rupee/) against the dollar. A stock can go up while the currency goes down, eroding your gain, or vice versa. AVES does not hedge this [currency risk](/currency-risk/) — it passes that volatility through to the investor.
...
For context on emerging markets themselves, the [MSCI Emerging Markets Index](/msci-emerging-markets-index/) is the benchmark most investors use to measure the health and returns of the broader emerging-market asset class. Understanding how AVES performs relative to that benchmark, and relative to other emerging-market value ETFs, provides a sense of whether the fund's value tilt is working as intended.

Finally, investors should monitor the macroeconomic picture in key emerging markets — Chinese growth, Indian policy shifts, Brazilian [interest rates](/interest-rate/) — as these drive long-term returns more than any fund mechanic does. The emerging-market opportunity set is always changing, and what makes emerging-market value attractive in one decade may not be true in the next.
