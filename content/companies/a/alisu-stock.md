---
title: "Calisa Acquisition Corp (ALISU)"
description: "Calisa Acquisition Corp warrants (ALISU) represent the right to purchase common shares of this OTC-listed SPAC, offering leverage to the underlying acquisition play."
keywords:
  - SPAC warrants
  - warrant pricing
  - leverage
...
ALISU are warrants issued by [Calisa Acquisition](/alis-stock/) Corp, a blank-check company trading on the OTC Markets. A warrant is a contract conferring the right to purchase a fixed number of shares at a fixed price (the strike or [exercise price](/exercise-price/)) on or before a set [expiration date](/expiration-date/). Calisa's warrants are linked to the same acquisition-driven thesis as the company's common equity, but with added leverage and distinct risk characteristics.

## Warrant mechanics and the leverage play

When a SPAC issues units in its initial offering, those units typically bundle a share of [common stock](/common-stock/), a warrant (or fractional warrant), and sometimes a right to a small amount of cash. Calisa's warrants work like [call options](/call-option/): the holder pays an exercise price to acquire one or more shares of Calisa common stock at a future point. If the common stock rises substantially, the warrant becomes more valuable, since it now represents the right to buy the stock below its current market price. That embedded leverage is what attracts speculators: a $1 warrant on a $5 stock has 5:1 leverage if the stock doubles to $10, assuming the warrant's exercise price was $5 or lower.

Conversely, leverage cuts both ways. If Calisa's common stock falls, the warrant can become worthless if the [strike price](/strike-price/) is far above the market price and there is little time to expiration. Many SPAC warrant holders have learned this painfully in recent years as SPACs failed to execute deals or merged with disappointing targets.

## Pricing and the path to exercise

ALISU warrants trade on the OTC Markets, and their price reflects several factors: the value of the underlying common stock, the distance between the current price and the strike price, the time remaining until expiration, and investor sentiment toward SPACs and Calisa specifically. Early in a SPAC's life, warrants typically trade at a modest premium to their [intrinsic value](/intrinsic-value/)—the difference between the stock price and the strike—because there is [time value](/time-value/) and some speculative buying. As a SPAC approaches its deadline without a deal, warrant prices often compress sharply, since the probability of a [merger](/merger/) justifying a large stock move declines.
