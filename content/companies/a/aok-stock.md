---
title: "iShares Core 30/70 Conservative Allocation ETF (AOK)"
description: "A conservative asset-allocation ETF holding 30% stocks and 70% bonds, designed for investors near or in retirement who need income and stability."
keywords:
...
<table>
<tr><th>Ticker</th><td>AOK (NYSE Arca)</td></tr>
<tr><th>Issuer</th><td>iShares (BlackRock)</td></tr>
<tr><th>What it holds</th><td>30% stocks, 70% bonds</td></tr>
<tr><th>Best for</th><td>Retirees and cautious investors</td></tr>
<tr><th>Fund type</th><td>All-in-one allocation ETF</td></tr>
<tr><th>Automatic rebalancing</th><td>Quarterly</td></tr>
<tr><th>Annual fee</th><td>Approximately 0.20%</td></tr>
</table>
</aside>
...
You pay about 0.20% per year. On $500,000 in AOK, that is $1,000 annually. For a retiree, that is a tiny price to pay for having a machine that automatically balances your portfolio without any thought or stress.

AOK also produces very little in the way of taxable distributions. The index funds that make up the fund do not churn their holdings, so there are no big capital-gains payouts at the end of the year. If you hold the fund in a retirement account (an IRA or 401k), taxes are irrelevant anyway, but even in a regular account, AOK is tax-efficient.
...
Read the fact sheet and prospectus from iShares, which show exactly what the fund holds and how it works. The prospectus is important because it spells out the rebalancing rule — when and how often the fund resets to 30/70. For a conservative investor, that level of detail provides peace of mind.

Look at the underlying index funds that AOK uses. They are all major index funds with decades of history, so there are no surprises there. If you wanted to own the exact same portfolio yourself without buying one fund, you could buy five separate index ETFs — but AOK saves you the effort and the rebalancing work. For most people, that convenience is worth the tiny fee.
