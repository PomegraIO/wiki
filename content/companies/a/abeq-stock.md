---
title: "Absolute Select Value ETF (ABEQ)"
description: "ABEQ is a concentrated value ETF holding approximately 40 US stocks selected for deep value characteristics — low price-to-book, high dividend yield, and strong profitability metrics."
keywords:
  - value ETF
  - deep value
  - dividend yield
...
<div class="wiki-infobox-title">ABEQ — key facts</div>

| | |
|---|---|
| **What it holds** | Approximately 40 US stocks trading at deep value |
| **Selection criteria** | Low valuations, high yields, strong fundamentals |
| **Portfolio size** | Concentrated; each holding typically 1–3% of assets |
| **Expense ratio** | Moderate relative to active value strategies |
| **Typical holdings** | Companies in financials, energy, industrials, utilities |
| **Risk profile** | Higher concentration and cyclicality than broad indexes |

</aside>

ABEQ takes a disciplined, rules-based approach to deep [value investing](/value-investing/). Rather than a fund manager's subjective picks, the ETF applies quantitative screens to select stocks that are trading at significant discounts to what they might reasonably be worth. The typical ABEQ holding is a company with a low [price-to-book ratio](/price-to-book-ratio/) (suggesting the market has marked it down hard), a high [dividend yield](/dividend-yield/) (because the stock price is depressed), and solid profitability numbers (suggesting the value is real, not a value trap). The fund holds roughly 40 such stocks, each weighted by [market capitalization](/market-capitalization/) within that selected group.
