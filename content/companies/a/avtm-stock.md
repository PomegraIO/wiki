---
title: "Avantis Total Equity Markets ETF (AVTM)"
description: "AVTM is a broad U.S. market ETF holding stocks of all sizes and applying a value tilt, combining comprehensive equity coverage with a factor overlay."
keywords:
  - total market ETF
  - value factor
  - all-cap equity
...
The [expense ratio](/expense-ratio/) is around 0.20% per year, covering the screening, rebalancing, and overhead of a quantitative fund managing thousands of positions. This is well below the cost of a typical active manager but slightly above the cheapest passive total-market index funds, a fair premium for the value-tilt overlay. The fund trades with reasonable volume and liquidity on [NASDAQ](/nasdaq/), and shares can be bought or sold at transparent market prices throughout the trading day.

Owning all of America's public companies means AVTM captures the full [dividend](/dividend/) flows across the market. The fund is moderately tax-efficient, though it is not as optimized for taxes as some passive funds that deliberately suppress turnover to avoid triggering capital gains.
