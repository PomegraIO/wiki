---
title: "Defiance Daily Target 2x Long AVAV ETF (AVXX)"
description: "AVXX is a leveraged daily-reset ETF that aims for 2x the daily return of Teledyne Technologies, the aerospace and industrial-systems company; it is intended only for tactical, same-day or next-day trades, not long-term holding."
keywords:
  - leveraged ETF
  - daily reset
  - Teledyne
...
For multi-day or multi-week holding, this decay becomes severe. AVXX is not designed for that timeframe and should not be used that way.
...
The fund's prospectus and fact sheet, available on the Defiance ETF website, explain the daily reset mechanism and the risks of leverage decay. Read these carefully before opening a position. The prospectus also lists all holdings and explains the use of derivatives (futures and swaps) that create the leverage.

For understanding Teledyne, the underlying stock, consult the company's annual 10-K filing (SEC CIK 0000086521) and earnings reports. Understand what Teledyne does, what markets it serves, and what moves its stock price.

Day traders using AVXX should monitor Teledyne's daily price action, intraday volatility, and any news that might affect the stock during a trading session. Holdings longer than a day require explicit acceptance of the fact that volatility decay will chip away at your position regardless of which direction the stock moves.
