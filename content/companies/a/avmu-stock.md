---
title: "Avantis Core Municipal Fixed Income ETF (AVMU)"
description: "AVMU is a broad, investment-grade municipal bond fund that holds tax-exempt debt issued by U.S. states and local governments. Sponsored by American Century Investments, it offers tax-free income to U.S. residents and targets modest tracking error versus its index."
keywords:
  - municipal bonds
  - tax-exempt income
  - American Century
...
AVMU (Avantis Core Municipal Fixed [Income ETF](/income-etf/)) is a fund that invests in [municipal bonds](/municipal-bond/) — debt securities issued by U.S. states, cities, and other local authorities to finance public infrastructure, schools, and services. The fund is sponsored by American Century Investments and listed on the [NASDAQ](/nasdaq/) under ticker AVMU. For U.S. residents in higher tax brackets, municipal [bonds](/bond/) are attractive because the interest income they generate is exempt from federal income tax and, in many cases, from state and local tax as well.

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>AVMU</td></tr>
<tr><th>Fund type</th><td>Exchange-traded fund (ETF)</td></tr>
<tr><th>Sponsor</th><td>American Century Investments</td></tr>
<tr><th>Index tracked</th><td>Avantis Core Municipal Bond Index</td></tr>
<tr><th>Focus</th><td>Investment-grade municipal bonds</td></tr>
<tr><th>Tax treatment</th><td>Federal tax-exempt income (mostly)</td></tr>
<tr><th>Listed on</th><td>NASDAQ</td></tr>
</table>
</aside>
...
However, the trade-off is lower nominal yield. Because of the tax advantage, municipal bonds trade at lower yields than corporate bonds of equivalent credit quality. Additionally, bond prices move inversely to [interest rates](/interest-rate/): when rates rise, bond prices fall, and vice versa. An investor who buys AVMU and must sell before the bonds mature may realize a loss if rates have risen in the interim. This [interest-rate risk](/interest-rate-risk/) is built into any bond fund.

## Costs and credit quality

AVMU has a modest [expense ratio](/expense-ratio/) appropriate for a passive, index-tracking fund, as it does not employ active managers making security selections. The fund trades on the NASDAQ, so it can be bought and sold at market prices throughout the day.
