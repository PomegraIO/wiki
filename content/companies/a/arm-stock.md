...
ARM isn't a chip manufacturer—it's the architect. Founded in Cambridge in 1990 as a joint venture between Acorn Computers and [Apple](/aapl-stock/), the company licenses its CPU designs to whoever wants to build processors. That simple model turns out to be tremendously valuable. You find ARM architecture in iPhones, Android phones, Qualcomm Snapdragon chips, Apple Silicon Macs, servers, automotive systems, IoT devices, and countless embedded processors. Not the designs themselves—those are proprietary and sold at premium licensing fees—but the fundamental instruction set and core technology that chipmakers build around.
