---
title: "Allspring Income Plus ETF (AINP)"
description: "AINP is an active exchange-traded fund designed to generate income from a diversified portfolio of dividend-paying stocks and income-producing securities, using options strategies to enhance yield."
keywords:
  - dividend income
  - options strategies
  - covered calls
...
*The **Allspring Income Plus ETF** (AINP) is an [actively managed fund](/actively-managed-fund/) designed to deliver income to investors through a combination of dividend-paying stocks, [bonds](/bond/), and options strategies. Rather than holding a static portfolio of [dividend](/dividend/) stocks alone, the fund's managers tactically select securities and use techniques like [covered calls](/covered-call/) — selling [call options](/call-option/) against the stocks they own — to enhance yield beyond what [ordinary dividends](/ordinary-dividend/) would provide.*

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>AINP (NASDAQ)</td></tr>
<tr><th>Fund type</th><td>Active ETF (income-focused)</td></tr>
<tr><th>Sponsor</th><td>Allspring Funds</td></tr>
<tr><th>Strategy</th><td>Dividend stocks + bonds + covered call options</td></tr>
<tr><th>Objective</th><td>Maximize current income for shareholders</td></tr>
<tr><th>Management</th><td>Active; tactical allocation across asset classes</td></tr>
<tr><th>Best for</th><td>Income-seeking investors; retirees; low-volatility preference</td></tr>
</table>
</aside>

The need for current income from investments shapes how millions of investors approach the market. Retirees, pension funds, insurance companies, and other holders require regular cash flow from their portfolios. In an environment of low [interest rates](/interest-rate/) on savings accounts and money-market funds, the pressure to find income pushes investors toward dividend-paying stocks and bonds. AINP is built on the premise that active management can identify the best sources of income and combine them in ways that generate more cash flow than a passive basket of dividends alone would produce.

The fund holds a diversified mix of securities selected by Allspring's portfolio managers. Dividend-paying stocks form the core — large-cap companies with histories of steady payouts, smaller companies with higher yields, and international equities if managers see opportunities. The fund also holds fixed-income securities: bonds, [preferred stocks](/preferred-stock/), and convertible securities that offer regular coupons and income. The weighting between stocks and bonds shifts based on managers' views of relative value and market conditions — in some periods the fund may be heavily weighted to equities, in others more defensive with more bonds.

What distinguishes AINP from a simple dividend-stock [index fund](/index-fund/) or a [balanced fund](/balanced-fund/) is the use of covered-call options strategies. When the fund holds a stock, the managers may sell call options against that holding — allowing someone else the right to buy the stock at a set price. The buyer of the call pays the fund a premium upfront. That premium is immediate income. If the stock rises above the [strike price](/strike-price/) and the call is exercised, the fund delivers the shares and earns the profit on the sale. If the stock stays below the strike, the call expires worthless and the fund keeps the shares and the premium. This strategy generates additional income but comes with a trade-off: if the underlying stock rallies sharply, the call cap means the fund misses some upside. The covered call is income optimization at the expense of capital appreciation.
