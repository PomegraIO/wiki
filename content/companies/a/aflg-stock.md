---
title: "First Trust Active Factor Large Cap ETF (AFLG)"
description: "AFLG is an actively managed ETF that picks large-cap U.S. stocks using a quantitative factor-based strategy, aiming to outperform the broad market by favoring companies with specific financial characteristics."
keywords:
  - factor investing
  - large-cap stocks
  - active management
...
Most stock funds fall into two categories. Passive [index funds](/index-fund/) own everything in their chosen market in proportion to market weight — huge positions in the biggest companies, tiny positions in smaller ones. Active funds hire stock pickers who study companies and decide which ones look attractive.

AFLG takes a middle path. It is technically active — a team manages it — but instead of analysts arguing over individual stocks, the fund applies a rules-based system. It looks at metrics like the [price-to-earnings ratio](/price-to-earnings-ratio/), [earnings quality](/earnings-quality/), and [dividend yield](/dividend-yield/), and it favors stocks that score well on these measures. It is active stock selection, but run by mathematics rather than human intuition.
...
AFLG shares trade on the [NASDAQ](/nasdaq/) [stock exchange](/stock-exchange/) like any stock. Investors can buy or sell during market hours, and the fund handles the mechanics of creating and redeeming shares in the background. The [expense ratio](/expense-ratio/) is higher than a passive index fund — active management requires people and systems — but typically lower than a traditional [mutual fund](/mutual-fund/) with human stock pickers.
...
The risk is that the specific factors First Trust has chosen simply do not outperform. [Systematic investing](/systematic-investing/) in factors has worked historically, but past performance is not guaranteed. Market conditions change, and a factor that worked for decades can suddenly underperform.
