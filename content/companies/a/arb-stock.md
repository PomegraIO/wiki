---
title: "AltShares Merger Arbitrage ETF (ARB)"
description: "ARB is a specialised ETF that bets on the successful completion of announced corporate mergers and acquisitions, holding stock positions in target companies at a discount to their merger consideration."
keywords:
  - merger arbitrage
  - ETF
  - deal risk
...
ARB is an exchange-traded fund that invests in an unusual corner of the [stock market](/stock-market/): companies that are the targets of announced takeovers. When a larger company publicly commits to acquiring a smaller one at a stated price — say Company A agrees to buy Company B for $50 per share — the target's stock trades just below that price, reflecting the risk that the deal might fail to close. [Merger arbitrage](/merger-arbitrage-definition/) funds profit from that gap by buying the target company's shares and holding them until the [merger](/merger/) closes, pocketing the spread if everything goes as announced. ARB aggregates dozens of such positions, seeking to turn uncertainty into steady, low-volatility returns.
...
[Concentration risk](/concentration-risk/) also emerges during periods of high deal activity. When many large acquisitions are announced simultaneously, ARB's portfolio might have substantial exposure to one sector or one large position. A broad regulatory shift affecting multiple deals — say, a change in antitrust enforcement policy — could hit many positions at once, eroding [diversification](/diversification/) benefits.
...
ARB charges an annual [expense ratio](/expense-ratio/) tied to the costs of its research, monitoring, and trading across dozens of active deal positions. The fees are higher than those of passive [index funds](/index-fund/), reflecting the active management required to identify deals, estimate risks, and monitor progress toward closing. The fund's liquidity, like most large ETFs, is strong; investors can trade shares throughout the day, though trading volume is typically lower than for broad-market ETFs.
