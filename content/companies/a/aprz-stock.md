---
title: "TrueShares Structured Outcome (April) ETF (APRZ)"
description: "APRZ is a defined outcome ETF tracking an index of 40 U.S. large-cap stocks, offering annual resets each April with asymmetrical return mechanics designed to capture moderate gains while limiting losses."
keywords:
  - defined outcome
...
<table>
<tr><th>Ticker</th><td>APRZ (NASDAQ)</td></tr>
<tr><th>Fund Type</th><td>Defined outcome ETF</td></tr>
<tr><th>Manager</th><td>Toroso Investments</td></tr>
<tr><th>Underlying Index</th><td>Nasdaq-100 Large Cap Select 40</td></tr>
<tr><th>Outcome Period</th><td>April to April (annual reset)</td></tr>
<tr><th>Structure</th><td>Long equity with embedded put and call options</td></tr>
<tr><th>Expense Ratio</th><td>~0.75% annually</td></tr>
</table>
</aside>

The core idea behind a structured outcome ETF is the acceptance of constraint for clarity. Traditional [mutual funds](/mutual-fund/) and [index funds](/index-fund/) offer no boundaries. The market is the market — gains and losses flow freely to shareholders. A structured outcome fund instead enters a contract with shareholders: the fund holds 40 large-cap stocks and options positions that together create a visible, predictable floor and ceiling for returns within a 12-month period. That predictability is what the name "defined outcome" captures. Investors know in advance that if the underlying index returns 30%, they will not participate fully; equally, if it returns negative 25%, they will not suffer the full loss.

APRZ targets the Nasdaq-100 Large Cap Select 40, a subset of 40 stocks from the larger [Nasdaq](/nasdaq/) 100 universe, weighted toward the largest and most liquid names in the technology and consumer sectors. The composition is not static; the [index committee](/index-committee/) rebalances periodically to ensure it reflects current large-cap leadership. The fund holds actual positions in those 40 stocks, weighted according to the index's published rules. Alongside those equity positions, the fund holds options contracts — specifically, [put options](/put-option/) it has purchased to protect against large declines, and [call options](/call-option/) it has sold to cap its upside.
...
What makes the structure work is that Allianz, the financial institution behind the fund, can purchase [protective puts](/protective-put/) at the beginning of the period when the cost is known and can sell calls to fund those puts. The sale of the calls (in effect, agreeing to let someone else capture upside beyond a certain threshold) generates income that helps pay for the puts. The difference between what the puts cost and what the calls bring in is reflected in the 0.75% annual [expense ratio](/expense-ratio/) and in the specific cap and floor figures published at the start of each outcome period.

Over the outcome period, the fund does not need to rebalance or trade. It simply holds the 40 stocks and lets the options mature. [Dividends](/dividend/) from the stocks flow into the fund and are credited to shareholders. At the end of April, the outcome period closes, the return is calculated, shareholders are credited with their gain or loss (within the bounds), and the fund returns to cash or holds the 40 stocks until a new outcome period begins. A new contract is then struck for the next 12 months with a new set of bounds based on the then-current state of markets.
