---
title: "FT Vest U.S. Equity Max Buffer ETF - April (APXM)"
description: "APXM is a defined outcome ETF tracking 50 large-cap U.S. stocks with annual resets each April, offering maximum protection against the first 15% of losses in exchange for capped upside around 12% per year."
keywords:
  - defined outcome ETF
  - buffer strategy
  - downside protection
...
<table>
<tr><th>Ticker</th><td>APXM (NASDAQ)</td></tr>
<tr><th>Fund Type</th><td>Defined outcome ETF</td></tr>
<tr><th>Manager</th><td>Foreside Financial Services</td></tr>
<tr><th>Underlying Index</th><td>Solactive U.S. Large Cap Select 50</td></tr>
<tr><th>Outcome Period</th><td>April to April (annual reset)</td></tr>
<tr><th>Downside Cap</th><td>15% maximum loss</td></tr>
<tr><th>Upside Cap</th><td>Approximately 12% gain</td></tr>
<tr><th>Expense Ratio</th><td>~0.72% annually</td></tr>
</table>
</aside>
...
**What changed this year.** The fund's inception was 2023, so history is limited. Early iterations of [buffer funds](/buffer-fund/) operated under different volatility regimes than today. The structures that seemed expensive in 2022 (when volatility spikes made options costly) may be cheap in 2024 or 2025 if volatility normalizes. Every annual reset reprices the buffer and cap. Investors should expect the 12% cap and 15% floor to shift meaningfully depending on [implied volatility](/implied-volatility/) at the next reset date.

**The concentration play.** Fifty stocks is tighter than a total-market index (3,000+) but broader than a true concentrated fund (20–30). APXM is diversified enough to avoid single-stock [tail risk](/tail-risk/), concentrated enough that the top holdings — technology, consumer discretionary, financials — dominate returns. A [diversification](/diversification/) benefit exists, but it is not the full cushion of a 500-stock index.

**[Dividends](/dividend/), taxes, and compounding.** The 50-name index typically carries a [dividend yield](/dividend-yield/) in the 1.5% to 2.5% range. That income flows into APXM and is credited to shareholders. The annual reset means that dividend compounding is interrupted — at the end of April, any past growth is locked in, and the new period begins with fresh reset mechanics. Reinvested dividends do not compound across outcome periods in the same way they would in a traditional fund.
