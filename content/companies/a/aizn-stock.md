---
title: "Assurant, Inc. (AIZN)"
description: "Assurant is an insurance and warranty services company that protects consumer electronics, appliances, and connected devices against accidental damage, loss, and theft—a diversified insurer focused on mobile device protection."
keywords:
  - insurance
...
<table>
<tr><th>Ticker</th><td>AIZN (NYSE)</td></tr>
<tr><th>Founded</th><td>1892, Detroit, Michigan (founding entity)</td></tr>
<tr><th>Current form</th><td>2004 (spun from Assurant Specialty Holdings)</td></tr>
<tr><th>Sector</th><td>Insurance, warranty services</td></tr>
<tr><th>Primary focus</th><td>Mobile device and appliance protection</td></tr>
<tr><th>Business model</th><td>Recurring premiums, claims management</td></tr>
<tr><th>SEC CIK</th><td>0001267238</td></tr>
</table>
</aside>
...
The recurring nature of the premium stream is the draw for investors. Unlike a casualty insurer that might sell a homeowner's policy once every few years, Assurant collects device-protection premiums every month from millions of customers. Churn (customers dropping their plans) is an issue, but [acquisition](/acquisition/) through the carrier channel is steady and customer-friendly—it is sold at the point of purchase, often pre-selected, and the friction to enroll is low.
...
Finally, the rise of manufacturer programs and extended warranties built directly into phones ([Apple](/aapl-stock/) Care+, Samsung Care+) has created a competing channel that Assurant does not control. Customers choosing a manufacturer program might not buy a separate carrier plan.
