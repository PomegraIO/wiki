---
title: "abrdn Ultra Short Municipal Income Active ETF (AMUN)"
description: "An actively managed ETF that invests in short-maturity municipal bonds, generating tax-exempt interest income for investors in high federal tax brackets."
keywords:
  - municipal bonds
  - active ETF
  - tax-exempt income
...
| Item | Value |
|------|-------|
| **Sponsor** | abrdn (formerly Aberdeen Standard Investments) |
| **Underlying assets** | U.S. municipal bonds, short maturity |
| **Investment objective** | Tax-exempt income with limited interest-rate sensitivity |
| **Bond duration** | Ultra-short (typically 1–2 years weighted average maturity) |
| **Tax status** | Federal income-tax-exempt distributions |
| **Management style** | Active selection (not index-tracking) |
| **Suitable for** | High-income investors in taxable accounts |

</aside>

abrdn Ultra Short Municipal Income [Active ETF](/active-etf/) (AMUN) is an exchange-traded fund that invests in short-maturity U.S. [municipal bonds](/municipal-bond/) with the dual objectives of generating income and minimizing the volatility that comes with longer-dated fixed-income securities. The fund is actively managed—meaning a portfolio manager makes discretionary decisions about which specific [bonds](/bond/) to buy and sell—rather than tracking a passive index. AMUN is designed for taxable investors in high federal income tax brackets who value the tax-exempt status of municipal bond interest income and prefer the relative stability of short-maturity bonds over longer-duration debt.
...
AMUN charges an annual [expense ratio](/expense-ratio/) (a percentage of assets) for active management, custody, and fund operations. Actively managed municipal [bond ETFs](/bond-etf/) typically charge 0.35% to 0.65% annually. This is higher than passive municipal bond index ETFs, which charge 0.20% or less, but lower than traditionally structured active municipal bond [mutual funds](/mutual-fund/). The exact fee should be verified in the prospectus.
