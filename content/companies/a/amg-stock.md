---
title: "AFFILIATED MANAGERS GROUP, INC. (AMG)"
description: "Investment manager holding company that owns and operates a global network of semi-independent boutique advisors across equities, alternatives, and wealth management."
keywords:
...
**Affiliated Managers Group is an asset management company that builds its business by buying pieces of other asset managers.** Unlike BlackRock or Vanguard—which are monolithic—AMG is more like a holding company for boutique investment shops. It buys majority or significant minority stakes in independent advisors, lets them keep their own names and investment approach, and pockets a share of the [management fees](/management-fee/) they generate. That decentralized structure is the core idea: you get the [diversification](/diversification/) of owning multiple strategies and teams without the bureaucracy of forcing them all into one uniform machine.

The company makes money from management fees on assets under management at its subsidiary firms. When clients own funds or accounts managed by an AMG-owned advisor, the advisor collects a fee and AMG takes its percentage. [Performance fees](/performance-fee/) from [hedge funds](/hedge-fund/) and private equity vehicles add margin and boost profits in good years. The business is scalable—as AUM grows, margins improve because AMG can spread overhead. But it's also cyclical: a [bear market](/bear-market/) shrinks portfolio values and fees, and poor performance at any major subsidiary can trigger client redemptions.
...
- Equity and fixed-income [mutual fund](/mutual-fund/) platforms
