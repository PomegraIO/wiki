---
title: "Ameren Illinois Co (AILLI)"
description: "A regulated utility providing electricity and natural gas to approximately three million customers across central and southern Illinois, operating under state-determined rates and cost structures."
keywords:
  - utility
  - electricity
  - natural gas
...
<table>
<tr><th>Ticker</th><td>AILLI (OTC)</td></tr>
<tr><th>Parent Company</th><td>Ameren Corporation</td></tr>
<tr><th>Service Area</th><td>Central and southern Illinois</td></tr>
<tr><th>Customers Served</th><td>Approximately 3 million (electricity and gas)</td></tr>
<tr><th>Business Model</th><td>Regulated utility with cost-plus rate recovery</td></tr>
<tr><th>SEC CIK</th><td>0000018654</td></tr>
<tr><th>Primary Revenue Driver</th><td>Regulated utility rates, volume-driven and weather-sensitive</td></tr>
</table>
</aside>

## What Ameren Illinois does

[Ameren Illinois](/ailih-stock/) is a regulated electric and natural-gas utility serving approximately three million customers across central and southern Illinois, from the St. Louis region north to suburban Chicago. The company operates the physical infrastructure — poles, wires, transformers, gas pipes, and distribution networks — that deliver electricity and [natural gas](/natural-gas/) into homes and businesses. Ameren Illinois does not generate the electricity it sells (that comes from power plants operated by the parent company, Ameren Corporation, or purchased from external generators); it owns and maintains the distribution network and the customer relationship, collecting revenues by charging end users for the privilege of using that infrastructure to receive electrons and gas molecules.
...
Ameren Illinois's revenue comes almost entirely from utility rates charged to residential, commercial, and industrial customers. The company earns money by recovering its costs of operation — salaries, equipment maintenance, [depreciation](/depreciation/), interest on debt — plus a regulated return on the capital (equity and debt) it has invested in the business. A typical regulated utility in Illinois recovers its costs through a rate structure that includes a fixed charge per customer and a variable charge per unit of electricity or gas consumed. The fixed charge ensures revenue stability; the variable charge ties revenue to consumption.
...
The company's largest risks are regulatory — an unfavourable rate decision, tightening of the allowed return on equity, or a major accident or service failure that triggers political backlash. Weather extremes can also disrupt operations and require costly emergency repairs. And like all utilities, Ameren Illinois is exposed to the cost of capital — if [interest rates](/interest-rate/) rise sharply, the company's [cost of debt](/cost-of-debt/) increases, squeezing margins unless the regulator approves a rate increase.
