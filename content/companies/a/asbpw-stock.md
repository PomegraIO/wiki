---
title: "Aspire Biopharma Holdings, Inc. (ASBPW)"
description: "Aspire Biopharma develops sublingual drug delivery technology and markets Instaprin aspirin, with warrants from its 2025 SPAC merger trading on Nasdaq."
keywords:
  - sublingual delivery
  - aspirin
  - biopharmaceutical
...
Aspire Biopharma completed its [business combination](/business-combination-purchase/) with PowerUp Acquisition Corp. in February 2025, with the merged company beginning trading under the new tickers ASBP ([common stock](/common-stock/)) and ASBPW (public warrants) on [Nasdaq](/nasdaq/). The transaction raised approximately $3.8 million in net proceeds from PowerUp's trust account and a concurrent [private placement](/private-placement/)—a modest sum for a pharmaceutical company. The total includes funds remaining in PowerUp's trust and a PIPE (private investment in public [equity) financing](/equity-financing/), where existing investors or new strategic investors bought shares in the combined entity.
...
Aspire's public warrants (ASBPW) are [call options](/call-option/) on the company's common stock, exercisable at a preset price. Like any warrant from a SPAC merger, they represent a bet on whether the combined company will grow into something valuable. The warrant holder is betting that Aspire will successfully commercialize Instaprin, extend the sublingual platform to multiple drug classes, and become a profitable or acquired company trading above the warrant's [strike price](/strike-price/). In the life sciences space, this is a high-variance bet—many biotech companies fail in clinical development or never achieve commercial traction despite strong initial premises. Success requires not just good science, but also regulatory navigation, manufacturing scale-up, and market adoption.
