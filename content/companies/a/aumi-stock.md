---
title: "Themes Gold Miners ETF (AUMI)"
description: "An actively managed exchange-traded fund that holds a concentrated portfolio of global gold-mining equities, combining major producers with junior explorers through a thematic investment approach."
keywords:
  - gold mining
  - commodity ETF
  - active management
...
AUMI is a straightforward exchange-traded fund trading on [NYSE Arca](/nyse-arca/). It opens throughout the trading day at prices set by buy and sell orders, offering [intraday liquidity](/intraday-liquidity/), unlike a traditional [mutual fund](/mutual-fund/) priced once per day at [net asset value](/net-asset-value/).

As an [actively managed fund](/actively-managed-fund/), AUMI charges an [expense ratio](/expense-ratio/) higher than a passive gold-miner tracker would. The active team's research, stock-selection decisions, and fund operations [carry cost](/carry-cost-forex/), visible in the fund's published expense ratio. That fee premium is justified by Themes only if the active picks outperform the passive alternative after costs — a bet on skill that the data supports unevenly across the active-management industry.

The fund typically does not distribute significant income, because most gold miners reinvest cash into exploration and development rather than paying [dividends](/dividend/) to shareholders.
...
Benchmarking is essential. The Philadelphia Gold and Silver Index and the NYSE Arca Gold Miners Index provide performance yardsticks. Compare AUMI's rolling returns — one-year, three-year, five-year — against these benchmarks to assess whether the active [management fee](/management-fee/) is producing outperformance or lagging.
