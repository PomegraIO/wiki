---
title: "Avantis International Equity ETF (AVDE)"
description: "AVDE is a broad developed-markets equity fund using a systematic value and quality overlay to construct a diversified portfolio of non-US stocks."
keywords:
...
AVDE suits investors seeking core international equity exposure with a systematic tilt toward value and quality — those who want to overweight cheaper, more profitable companies globally without abandoning diversification. It is also useful for investors who own a separate emerging-markets fund and want developed-market exposure tilted toward factors they believe will outperform over the long term.

To evaluate the fund, start with its prospectus and fact sheet on the American Century Investments website, which detail the index construction rules and historical methodology changes. Review the top 10 holdings and sector breakdown to confirm the geographic and sector mix aligns with your expectations. Compare the fund's trailing returns and tracking error (the degree to which it diverges from the index) against peer broad-developed-markets funds and against a simple market-cap-weighted alternative such as VXUS. Check the fund's historical factor tilts by consulting American Century's documentation on valuation and quality rankings.

For ongoing monitoring, watch the fund's expense ratio relative to alternatives, any changes to the underlying index methodology announced by the sponsor, and the broader factor performance environment — whether value and quality factors are in favor or out of favor relative to growth.
