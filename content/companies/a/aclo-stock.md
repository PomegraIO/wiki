---
title: "TCW AAA CLO ETF (ACLO)"
description: "An exchange-traded fund offering exposure to senior-secured tranches of collateralized loan obligations, focusing on AAA-rated credit quality."
keywords:
  - ETF
...
*A **[collateralized loan obligation](/collateralized-loan-obligation/)** is a financial instrument that bundles together corporate loans and sells them as securities to investors. The TCW AAA CLO ETF buys the safest [tranches](/tranche/) of these CLO securities — the first-in-line shares that get paid before others and carry the highest [credit ratings](/credit-rating/). It is a bet on the loan market filtered through credit quality, offering higher yield than government [bonds](/bond/) but with more complexity and different risks.*

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>ACLO (NYSE Arca)</td></tr>
<tr><th>Issuer</th><td>TCW Investment Management</td></tr>
<tr><th>Holdings</th><td>AAA-rated CLO securities, primarily senior-secured tranches</td></tr>
<tr><th>Strategy</th><td>Credit strategy focused on highest-quality CLO debt</td></tr>
<tr><th>Underlying collateral</th><td>Syndicated corporate loans and leveraged loans</td></tr>
<tr><th>Yield component</th><td>Interest paid on underlying loans plus CLO mechanics</td></tr>
<tr><th>Interest-rate sensitivity</th><td>Moderate; higher rates can compress CLO economics</td></tr>
</table>
</aside>

## What is a CLO and why do they exist?

A CLO pools together corporate loans — typically leveraged loans made to mid-market companies or to companies that are heavily indebted — and repackages them into securities sold to investors. A bank originates a loan to a borrower, then sells it into the CLO; the CLO bundles perhaps 100–200 such loans and carves them into tranches. The senior-most tranche (AAA-rated) gets paid first; below it sit mezzanine and equity tranches that absorb losses if loans default. Investors in the top tranche earn interest on the loans but are protected by the cushion below them. The bank, freed from holding the loan on its [balance sheet](/balance-sheet/), gets to originate more business. The loan originator earns fees. And investors get yield.
...
Each underlying leveraged loan in a CLO pays interest at a floating rate, typically tied to the London Interbank Offered Rate ([LIBOR](/libor/)) or the Secured Overnight Financing Rate ([SOFR](/sofr/)). The interest flows through the CLO structure to each tranche according to its seniority. The AAA senior tranche is paid its coupon from that loan interest, after fees to servicers and other CLO operators are deducted. The remaining yield goes to lower tranches. ACLO's distributions come from those [coupon payments](/coupon-payment/), which flow through and out to shareholders as regular income.

When [interest rates](/interest-rate/) rise, the floating-rate loans pay more, so the yield on ACLO increases in theory. However, in practice, rising rates often accompany economic worry, which increases default risk and can create other pressures on CLO valuations. The net effect depends on whether the rate increase is seen as tightening due to strong growth (good for loans) or [recession](/recession/) fears (bad for loans).

## What are the real risks of CLO investing?

**[Credit risk](/credit-risk/).** If the underlying corporate borrowers face economic stress and defaults rise sharply — think a severe recession or a specific industry downturn hitting many CLO borrowers at once — losses cascade down the CLO's capital stack. The AAA tranche has a buffer, but it is not infinite. A truly catastrophic default environment could impact even senior securities.

**[Liquidity risk](/liquidity-risk/).** CLO securities are not as liquid as [Treasury bonds](/treasury-bond/) or investment-grade [corporate bonds](/corporate-bond/). In a market stress, trading volume can evaporate, and investors may not be able to exit their positions without taking a significant haircut. ACLO, as an ETF, offers some wrapping of that illiquidity into a more liquid ETF shell, but the underlying securities are inherently less liquid than many alternatives.

**[Interest-rate risk](/interest-rate-risk/).** When interest rates rise, bond prices fall. AAA CLO securities carry less duration (interest-rate sensitivity) than long-term bonds, but they are not immune. A sharp rate increase could mark CLO securities down in value, at least temporarily.
...
**[Call risk](/call-risk/).** Many CLO senior tranches can be called and redeemed early if prepayments of underlying loans surge. In a falling-rate environment, borrowers refinance, loans prepay, and ACLO may be forced to reinvest proceeds at lower rates.

## What metrics should I watch?

Before investing, check the prospectus and fact sheet for the underlying CLO holdings, their vintage years (older CLOs from the early 2010s have longer loss histories), and the average recovery rates if defaults occur. Look at the fund's duration and interest-rate sensitivity to understand how rate moves would affect the NAV. Watch the loan market's health — are defaults rising or falling? Are issuers refinancing easily, or tightening [credit spreads](/credit-spread/)? These trends affect both the income yield and the capital preservation of the fund.
