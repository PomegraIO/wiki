---
title: "Aptus Drawdown Managed Equity ETF (ADME)"
description: "ADME is an ETF that holds U.S. large-cap stocks but actively manages its portfolio to reduce losses during downturns, aiming to recover faster after market declines."
keywords:
  - equity ETF
  - drawdown management
  - downside protection
...
<table>
<tr><th>Ticker</th><td>ADME (NYSE Arca)</td></tr>
<tr><th>Issuer</th><td>Aptus</td></tr>
<tr><th>Underlying</th><td>U.S. large-cap equities</td></tr>
<tr><th>Strategy</th><td>Actively managed; reduces equity exposure in downturns</td></tr>
<tr><th>Defense mechanism</th><td>Dynamic allocation between stocks and cash/bonds</td></tr>
<tr><th>Investor profile</th><td>Risk-aware; willing to trade some upside for downside protection</td></tr>
<tr><th>Expected outcome</th><td>Lower volatility; smaller drawdowns; slower recovery than pure stocks</td></tr>
</table>
</aside>
...
Many investors say they can tolerate the ups and downs of stocks. In reality, big drawdowns break people. They sell at the bottom, lock in losses, and never recover. ADME exists for those people — not as insurance, but as a way to reshape the experience. A fund that falls 18% instead of 30% is easier to live with. The smaller decline might mean you do not panic-sell, which means you stay invested for the recovery. That behavioral benefit alone can make the fee worthwhile over a long period.

## Who this suits and who it doesn't

ADME fits advisers working with nervous clients who have been hurt before and want equity exposure but cannot stomach 40% declines. It suits people saving for near-term goals who need some growth but cannot risk major losses. It does not suit young investors with decades until retirement or anyone pursuing the maximum possible return.

Prospective investors should read the fund's factsheet carefully to understand what signals trigger the portfolio adjustments and how often rebalancing occurs. Different versions of this strategy can vary meaningfully in execution. Some will be more aggressive in cutting equity exposure; others will stay mostly invested. The name "drawdown managed" tells you the aim; the fine print tells you how aggressive the management actually is.
