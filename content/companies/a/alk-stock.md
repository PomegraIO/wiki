...
description: "Alaska Air Group operates a regional airline serving the Pacific Northwest and West Coast with point-to-point routes and a focus on operational efficiency and customer service."
keywords:
  - regional airline
  - west coast carrier
...
Investors monitor the [company's 10-K](/wiki/10-k/) filings for several metrics: available seat miles (ASM), load factor (percentage of seats filled), cost per available seat mile (CASM), and fuel hedging policy. Alaska's smaller scale and focused network also mean that major disruptions—whether labor strikes, operational outages, or regional recession—hit a smaller absolute revenue base than at the legacies. As with all airlines, the company's ability to raise prices, manage growth, and absorb costs will ultimately depend on [public company](/wiki/public-company/) discipline in execution and macroeconomic tailwinds in leisure and business travel.
