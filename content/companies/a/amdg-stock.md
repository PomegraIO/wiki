---
title: "Leverage Shares 2X Long AMD Daily ETF (AMDG)"
description: "A 2x leveraged ETF that amplifies AMD stock's daily moves — for traders with short-term bullish views, not for buy-and-hold investors due to decay from daily rebalancing."
keywords:
  - leveraged ETF
  - 2x leverage
  - AMD daily
...
<table>
<tr><th>Ticker</th><td>AMDG (NYSE Arca)</td></tr>
<tr><th>Sponsor</th><td>Leverage Shares</td></tr>
<tr><th>Objective</th><td>2x daily performance of AMD stock</td></tr>
<tr><th>Leverage</th><td>2X long (daily reset)</td></tr>
<tr><th>Underlying</th><td>AMD Inc. (NASDAQ: AMD)</td></tr>
<tr><th>Expense ratio</th><td>Typically 0.95% annually</td></tr>
<tr><th>Rebalancing</th><td>Daily after market close</td></tr>
</table>
</aside>
...
Reverse the order — down 5% on day one, up 4% on day two, up 3% on day three — and the math inverts. AMD stock ends at 1.0206, or 2.06% gain. The 2x fund compounds -10%, +8%, +6% and ends at 1.0186, or 1.86% gain. Despite the same three moves, the leveraged fund underperformed by 0.2 percentage points, because the large drawdown hit first, cutting the fund's assets in half, and the subsequent recoveries could not fully compound back to break-even.

This phenomenon is called volatility decay, and it is the price paid for daily rebalancing. The longer the holding period and the more volatile the stock, the more severe the decay becomes. In a sideways market where AMD oscillates between gains and losses without trending, the decay is particularly punishing — the daily resets mean the fund loses value even if AMD ends the month at exactly the same price it started.
...
The fund trades on [NYSE Arca](/nyse-arca/) with good liquidity during regular market hours. [Bid-ask spreads](/bid-ask-spread/) are typically tight, making it easy and inexpensive to enter or exit intraday or across a few days. The tight spreads make AMDG attractive for day traders and short-term swing traders who want to amplify a bullish near-term bet without the friction of borrowing AMD shares to create leverage manually.
...
For buy-and-hold investors with a multi-month or multi-year bullish view on AMD, the mathematics are unambiguous: buying AMD stock directly or holding an unleveraged technology-sector ETF will outperform AMDG on an after-decay basis. The daily reset mathematics are not intuitive, and they have cost many retail investors real money when they purchased a leveraged ETF as a long-term bullish bet, unaware that the leveraged fund's returns could lag significantly even in rising markets. A trader considering AMDG should read Leverage Shares' prospectus in full and understand that this product is designed for hours or days of holding, not weeks or months.
