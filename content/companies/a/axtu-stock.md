---
title: "T-REX 2X Long AXTI Daily Target ETF (AXTU)"
description: "2X leveraged daily-reset ETF tracking Axis Communications—a single-stock fund that amplifies gains and losses by design, resetting daily to maintain its leverage target."
keywords:
  - leveraged etf
  - single stock etf
  - axis communications
...
| **What it is** | 2X leveraged daily-reset ETN tracking AXTI |
|---|---|
| **Underlying** | Axis Communications (ticker AXTI) |
| **Leverage** | 2X (aims for 2% gain per 1% move in AXTI) |
| **Issuer** | Direxion (through subsidiary T-REX) |
| **Structure** | Exchange-traded note; daily reset |
| **Expense ratio** | ~0.95% (leveraged ETN level) |
| **Trading** | NASDAQ: AXTU |
| **Best for** | Directional traders with short time horizons |
