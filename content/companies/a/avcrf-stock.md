---
title: "Avricore Health Inc. (AVCRF)"
description: "Pharmacy diagnostics company turning retail pharmacies into point-of-care testing hubs via HealthTab platform technology."
keywords:
  - pharmacy innovation
...
The business model relies on two revenue engines: hardware and recurring testing services. Pharmacies pay to install the system, and then Avricore earns ongoing margins from supplies, test kits, and platform fees as pharmacies run diagnostics. The company signed a pilot agreement with Shoppers Drug Mart, one of Canada's largest pharmacy chains, which signals interest from major players in the [pharmacy sector](/wiki/pharmacy-reit/). The Canadian roots (headquartered in Vancouver, British Columbia) matter for regulatory approval and market entry, though the OTC listing exposes the company to U.S. retail investors.
