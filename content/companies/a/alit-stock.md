...
The company was founded in its current form through a 2021 SPAC [merger](/merger/) (Foley Trasimene [Acquisition](/acquisition/) Corp acquired Alight Group Holdings), which brought it to public markets and accelerated platform consolidation. Today it operates from Lincolnshire, Illinois, and reports to SEC as CIK 1809104. Its ticker, ALIT, trades on the [New York Stock Exchange](/new-york-stock-exchange/), marking it as a core infrastructure play in the multi-trillion-dollar employee benefits ecosystem rather than a niche software vendor.
