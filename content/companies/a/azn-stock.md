...
The company also navigates capital allocation decisions—returning cash via [dividends](/dividend/) and buybacks versus funding acquisition-driven growth, or internal R&D expansion. These trade-offs shape long-term returns and influence the stock's total-return profile ([dividend yield](/dividend-yield/) plus capital appreciation).
