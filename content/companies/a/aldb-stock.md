---
title: "Aptus Laddered Deep Buffer ETF (ALDB)"
description: "A structured equity ETF that combines a laddered collar strategy with defined upside participation, designed to provide limited downside exposure with capped but meaningful upside in equity markets."
keywords:
  - buffer ETF
  - structured strategy
  - collar strategy
...
<div class="wiki-infobox-title">Aptus Laddered Deep Buffer ETF — key facts</div>

|   |   |
|---|---|
| **Ticker** | ALDB (NASDAQ) |
| **Issuer** | Aptus Capital Advisors |
| **Fund type** | Structured equity ETF |
| **Underlying strategy** | S&P 500 with collar and buffer strategy |
| **Buffer level** | Laddered; varies by tranche/period |
| **Upside cap** | Participation limit (varies by annual period) |
| **Structure** | Diversified options overlay on equity core |
| **Rebalancing** | Annual reset of option positions |

</aside>

## Core mechanics: The equity plus options overlay

ALDB holds a portfolio of stocks designed to track the broad market (usually the S&P 500 or a similar index). On top of that equity core, it sells upside [call options](/call-option/) and buys downside [put options](/put-option/) in a pattern designed to limit losses when stocks fall and cap gains when stocks rise. This is a variant of a "collar" strategy—where the put protects against catastrophic loss and the sold call caps gains—but with specific twists suited to the fund's stated investment policy.

The "laddered" element means the protection and cap structure may vary across different [tranches](/tranche/) or time periods within the fund's year. Rather than a single uniform buffer and cap, there may be multiple bands of protection, each with its own parameters. The "deep buffer" indicates that the protective floor is substantial—typically 15% or more—meaning the fund absorbs a significant market drawdown before investors experience losses.
