...
Atlanticus's advantage lies in three places. First, it has built relationships with dozens of bank partners and retail chains that issue branded cards. Once a retailer signs on with Atlanticus, switching to a competitor is disruptive and costly, so these relationships tend to be sticky. Second, the company has proprietary data on millions of underserved borrowers: credit histories, payment patterns, default correlations. That data feeds its machine learning models, which improve over time. Third, the company has operated in this segment for nearly 30 years, through multiple credit cycles, and has learned where the risk is and how to price for it.
