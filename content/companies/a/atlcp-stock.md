---
title: "Atlanticus Holdings Corp (ATLCP)"
description: "Atlanticus operates a financial technology platform connecting underserved consumers with bank partners to issue credit cards and auto loans, using machine learning and data to manage credit risk at scale."
keywords:
...
<table>
<tr><th>Ticker (common)</th><td>ATLC (NYSE)</td></tr>
<tr><th>Ticker (preferred shares)</th><td>ATLCP, ATLCZ, ATLCY (and others)</td></tr>
<tr><th>Founded</th><td>1996, Atlanta, Georgia</td></tr>
<tr><th>Sector</th><td>Fintech / consumer credit</td></tr>
<tr><th>Business model</th><td>Credit servicing and loan origination; bank partnerships</td></tr>
<tr><th>Managed receivables</th><td>Billions of dollars across credit card and auto loans</td></tr>
<tr><th>SEC CIK</th><td>0001464343</td></tr>
</table>
</aside>
...
The auto finance segment is different but simpler. Atlanticus buys loans that independent dealers have already made to used-car buyers — typically people with poor credit or no credit history who need a car for work. It also provides floor-plan financing, which lets dealers borrow against their inventory. These loans are typically short-term and high-interest, reflecting the risk and the cost of servicing borrowers with erratic payment patterns.

## How it makes money

Atlanticus' revenue comes from servicing fees, net interest income on loans it holds, and investment income. The bulk is servicing fees from its bank partners: for every dollar of credit card receivables the company services, it earns a spread that varies with the partner and the product. The managed receivables base — the total balance of cards and loans being serviced or held — is the key metric. More receivables means more fee income. In recent years the company has managed billions of dollars in receivables and serves more than 20 million consumers.
...
## The moat: data and relationships

Atlanticus's advantage lies in three places. First, it has built relationships with dozens of bank partners and retail chains that issue branded cards. Once a retailer signs on with Atlanticus, switching to a competitor is disruptive and costly, so these relationships tend to be sticky. Second, the company has proprietary data on millions of underserved borrowers: credit histories, payment patterns, default correlations. That data feeds its machine learning models, which improve over time. Third, the company has operated in this segment for nearly 30 years, through multiple [credit cycles](/credit-cycle/), and has learned where the risk is and how to price for it.

The underserved market itself is durable. People with thin credit histories, recent bankruptcies, or bad scores still need credit for emergencies, for clothing and furniture, and for used cars. Banks will not serve them directly; they rely on fintech intermediaries like Atlanticus to do the origination and servicing. That creates a structural reason Atlanticus exists.
...
## How to research Atlanticus

Start with the company's most recent 10-K filing (SEC CIK 0001464343), which breaks down managed receivables by product (credit cards, auto loans), shows funding sources, and lists risk factors. Pay attention to the composition of bank partners — concentration is a warning sign. Watch managed receivables growth and any significant changes in servicing fees per dollar of receivables. Also track securitization volume: a slowdown might signal funding pressure.

The quarterly earnings calls are where management discusses origination trends, partner wins and losses, and changes in credit quality. Listen for remarks about regulatory pressure or proposed interest-rate caps, which would matter far more than a few basis points of margin. Watch the yield on the auto loan portfolio and the loss rates; they reveal whether the company is underpricing risk or managing it well. As with any single security, shares of Atlanticus trade on an exchange at prices set by the market, and nothing here is a recommendation to buy or sell.
