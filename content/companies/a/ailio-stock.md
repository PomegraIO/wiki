---
title: "Ameren Illinois Co. (AILIO)"
description: "Regulated utility providing electricity and natural gas to central Illinois; subsidiary of Ameren Corporation with stable, rate-regulated cash flows driven by fixed-asset base."
keywords:
  - regulated utility
...
|-------|-------|
| Ticker | AILIO |
| Exchange | OTC (subsidiary, not publicly listed separately) |
| Parent Company | Ameren Corporation (NYSE: AEE) |
| Founded | 2007 (current form, via acquisition) |
| Sector | Utilities - Electricity & Natural Gas |
| Primary State | Illinois |
| SEC CIK | 18654 |
| Service Territory | Central and northern Illinois (~1.2 million customers) |
| Service Type | Regulated utility monopoly |
| Business Model | Rate-regulated, asset-based revenue |

</aside>

[Ameren Illinois](/ailih-stock/) is a regulated utility with a straightforward but capital-intensive business: it owns and operates the electricity and [natural gas](/natural-gas/) distribution networks serving roughly 1.2 million customers across central and northern Illinois. Unlike companies that compete on price, quality, or innovation, Ameren Illinois operates under a monopoly franchise—customers in its service territory have no choice of electricity provider or natural gas supplier. Instead, utility revenue and profit are determined by regulatory approval and rate-setting processes. The company submits requests to the Illinois Commerce Commission to recover its costs of operation plus an allowable return on its invested capital. This regulatory environment makes utilities among the most predictable and visible cash-flow businesses in the market, but it also constrains upside and creates unique risks.
...
Start with Ameren Corporation's annual 10-K and quarterly 10-Qs (SEC CIK 0000018654), which break down results by subsidiary segment. Ameren Illinois (the electric and gas utility) is typically reported as one or more segments. The filings detail rate-base growth, capital expenditure plans, [operating margins](/operating-margin/), and any pending regulatory proceedings. Pay attention to the "Business" section, which describes pending rate cases and anticipated rate increases—these signal management's confidence in regulatory recovery.
...
Compare Ameren's [dividend yield](/dividend-yield/) and [payout ratio](/payout-ratio/) to peers in the utility sector and to Treasury yields. A widening spread between utility dividend yields and Treasury yields suggests the market is demanding higher compensation for regulatory or [operational risk](/operational-risk/). A narrowing spread suggests utilities are becoming more attractive relative to risk-free assets.
