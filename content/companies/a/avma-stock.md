---
title: "Avantis Moderate Allocation ETF (AVMA)"
description: "AVMA is a diversified fund holding both stocks and bonds in a fixed allocation designed for investors seeking moderate long-term growth with regular rebalancing."
keywords:
  - asset allocation
  - stocks and bonds
  - moderate portfolio
...
Avantis Moderate Allocation ETF is one fund that holds what would otherwise take four or five: a mix of U.S. stocks, international stocks, and [bonds](/bond/) held in a fixed target allocation, rebalanced regularly to stay true to that mandate. AVMA trades on the [NASDAQ](/nasdaq/) and is designed for investors who want simplified, diversified exposure without needing to buy multiple funds or make allocation decisions themselves.
...
The fund's [expense ratio](/expense-ratio/) reflects the cost of holding multiple underlying exposures and executing rebalancing, but it is still low compared to hiring a financial advisor to manage a similar portfolio manually. Over time, the combination of systematic underlying funds and automatic rebalancing means the total cost is competitive with most [balanced funds](/balanced-fund/) or [target-date funds](/target-date-fund/), which do broadly similar work.

Geographic [diversification](/diversification/) is built in. By holding international stocks (primarily developed markets), AVMA reduces the risk of being overexposed to U.S. economic conditions alone. When the U.S. underperforms, international holdings can provide some cushion. The bond portion provides cushioning during equity downturns — historically, when stocks fall, bonds often rise, creating a natural hedge within a single fund.

[Currency risk](/currency-risk/) is present in the international equity portion; fluctuations in exchange rates will add noise to returns for U.S.-based investors. [Interest-rate risk](/interest-rate-risk/) is embedded in the bond holdings; rising rates will reduce bond values. Neither of these risks can be escaped — they are structural to owning global assets — but they are moderated by the diversification within the fund.
