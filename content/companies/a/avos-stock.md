---
title: "Avos Global Equities ETF (AVOS)"
description: "A global dividend-focused ETF tracking companies with sustainable dividend growth across developed and emerging markets, managed for both income and capital appreciation."
keywords:
  - global dividend ETF
  - dividend growth
  - multi-country equities
  - income investing
...
| Key fact | Details |
|---|---|
| **Fund type** | Dividend-focused global equity ETF |
| **Market focus** | Developed and emerging markets worldwide |
| **Investment thesis** | Dividend-paying companies with track records of raising dividends |
| **Structure** | Standard ETF (not leveraged, not inverse) |
| **Trades on** | Exchange like any stock or ETF |
| **Typical expense ratio** | Modest annual fee as a percentage of assets |
| **Best for** | Income-oriented investors, dividend growth enthusiasts |
...
The quarterly or annual dividends paid by AVOS are passed through to fund shareholders. If the fund is held in a taxable brokerage account, those dividends are taxable income in the year received — a trade-off for getting the cash. In a tax-deferred account (an IRA or 401k), dividends accumulate without triggering tax until withdrawal. Tax-conscious investors should understand the fund's dividend-yield profile and how dividends fit into their broader tax picture.
...
Start with the fund's prospectus and factsheet (available from the issuer or through any brokerage platform), which disclose the exact screening criteria, the holdings, and the fee structure. Understand the underlying index or selection process — what constitutes "dividend growth" in this fund's definition, and whether that matches your own philosophy. Look at the historical yield (the annual dividend as a percentage of share price) and how it compares to other dividend-focused funds or to the broad market. Check the top holdings to see the kinds of companies the fund owns. And consider whether you are more interested in current income or in the compound returns that reinvested dividends can provide over decades.
