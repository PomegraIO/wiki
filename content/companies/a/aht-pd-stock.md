---
title: "Ashford Hospitality Trust Inc (AHT-PD)"
description: "Ashford Hospitality Trust is a real estate investment trust that owns and operates hotel properties across the United States—the business of collecting room revenue and managing the daily costs of running the hotels."
keywords:
  - hotel REIT
...
<table>
<tr><th>Ticker</th><td>AHT-PD (NYSE)</td></tr>
<tr><th>Founded</th><td>2003</td></tr>
<tr><th>Headquarters</th><td>Frisco, Texas</td></tr>
<tr><th>Sector</th><td>Real estate / hospitality</td></tr>
<tr><th>Business</th><td>Hotel ownership and operations</td></tr>
<tr><th>Portfolio</th><td>Hundreds of properties across the US</td></tr>
<tr><th>Key metric</th><td>Revenue per available room (RevPAR)</td></tr>
<tr><th>SEC CIK</th><td>0001232582</td></tr>
</table>
</aside>

## Where the money comes from

A dollar of Ashford's revenue comes almost entirely from hotel room bookings. When a guest pays 150 dollars for a night in one of Ashford's hotels, that is the primary revenue stream. Some properties generate a bit of extra money from food and beverage sales, parking, or other ancillary services, but the bulk is room revenue.

What does it cost to earn that dollar? The costs are surprisingly straightforward. Pay the staff—front desk clerks, housekeeping, maintenance workers, managers. Pay for utilities—electricity, water, heating. Pay for supplies—bed linens, soap, cleaning materials. Pay property taxes and insurance. Maintain the building. Make major repairs when needed. These are operating costs that occur every day, whether the hotel is full or half-empty.

On top of those daily costs, the company must service debt. Most hotels are financed with loans, so Ashford's properties carry mortgages that must be paid. And the company must maintain and occasionally upgrade the buildings to keep them competitive. A 20-year-old hotel that is not refreshed looks tired, and guests will book elsewhere. Capital spending to update rooms, renovate common areas, and replace aging systems is a constant requirement.

## The economics depend on occupancy and price

Here is the key insight: once the building and its staff exist, most costs stay roughly the same whether 50 guests stay or 95 guests stay. But revenue scales with occupancy. A hotel with high occupancy rates and high nightly rates will have strong revenue relative to costs. A hotel with low occupancy or low rates will struggle to cover fixed costs.

The industry calls this number RevPAR: revenue per available room. It combines occupancy (what percentage of rooms are booked each night) and the average nightly rate guests pay. A hotel with 80% occupancy at 120 dollars a night has a RevPAR of 96 dollars (0.80 times 120). A hotel with 50% occupancy at 150 dollars has a RevPAR of 75 dollars. The first hotel is generating more revenue from the same building and staff.

Ashford's profit depends on the RevPAR of its portfolio, the efficiency of its operations, and the amount of debt it carries. A portfolio with high-RevPAR properties in desirable locations will generate strong cash flow. A portfolio full of low-RevPAR properties in weak markets will struggle. And a company carrying heavy debt becomes fragile if RevPAR declines.
...
A hotel is a capital-intensive asset. Buying and maintaining a portfolio of hundreds of hotels requires steady investment. Ashford funds this through cash flow, asset sales, debt, or equity issuance. The company's capital structure—how much debt versus equity it carries—is crucial. Higher leverage amplifies returns when business is strong but magnifies risk when business softens. Lower leverage is safer but may leave the company unable to invest in growth or upgrade properties.
