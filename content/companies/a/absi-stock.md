...
For a decade, Absci remained private, refining its algorithms and establishing credibility with major [pharmaceutical](/wiki/stock/) partners. Collaborations with [Moderna](/mrna-stock/) and [AstraZeneca](/azn-stock/) validated the market's appetite for computational antibody design. By the late 2010s, AI-driven drug discovery had become a recognized category in biotech, and Absci's years of domain-specific engineering gave it structural advantages over startups founded later with only machine learning expertise and no grounding in protein biology.
