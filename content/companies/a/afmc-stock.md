---
title: "First Trust Active Factor Mid Cap ETF (AFMC)"
description: "AFMC is an actively managed ETF selecting mid-cap U.S. stocks based on quantitative factors, targeting companies with profitable fundamentals and attractive valuations in the 500-billion to 10-billion market-cap range."
keywords:
  - mid-cap stocks
  - factor investing
...
AFMC works for investors who believe in factor-based stock picking, want exposure to mid-cap growth potential, and have a time horizon of several years or longer. It is a satellite position in a larger portfolio, not a core holding. Someone building a diversified portfolio might own a broad stock index for the core, then use AFMC as an active bet on mid-cap fundamentals.

The fund also appeals to investors skeptical of passive indexing who want a rules-based alternative to paying a human stock picker. Factor systems are systematic, emotionless, and transparent. If the factors work, they should deliver results. If they do not, at least the investor knows what went wrong: the factors simply did not predict returns in that environment.
...
AFMC is not a buy-and-forget fund. It is a deliberate, active bet on mid-cap factors. Investors should check in occasionally and ask whether the bet still makes sense given their goals.
