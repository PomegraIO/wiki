---
title: "Tradr 2X Long AAOI Daily ETF (AAOX)"
description: "AAOX is a 2x leveraged daily-reset ETF tracking the Roundhill Applied AI ETF, using derivatives and daily rebalancing to amplify returns for short-term traders, with compounding risks for longer holding periods."
keywords:
  - leveraged ETF
  - 2x daily reset
  - applied AI
...
<table>
<tr><th>Ticker</th><td>AAOX</td></tr>
<tr><th>Issuer</th><td>Tradr</td></tr>
<tr><th>Underlying index</th><td>Roundhill Applied AI ETF (AAOI)</td></tr>
<tr><th>Multiplier</th><td>2x daily</td></tr>
<tr><th>Rebalancing</th><td>Daily, at close of each trading session</td></tr>
<tr><th>Expense ratio</th><td>Higher than standard ETFs; costs absorbed daily</td></tr>
<tr><th>Trading style</th><td>Intraday and short-term tactical positioning</td></tr>
<tr><th>Primary risk</th><td>Volatility decay erodes returns on multi-day holds</td></tr>
</table>
</aside>
...
**Intraday and short-term edge:** AAOX excels when a trader has conviction about a single day's or a few days' move. If the trader is right and AAOI rises 2%, AAOX should be up roughly 4%, minus the daily costs. The leverage here is a pure amplifier of correct bets.

**Rebalancing and rollover costs:** Every evening, Tradr must sell the derivative contracts that tracked the morning's move and buy fresh ones to reset for the next day. The bid-ask spreads, financing rates, and potential slippage on that rollover add up. These costs are invisible to the trader but consistent; they are the water that slowly empties any pool of capital.

**Volatility decay in sideways markets:** A sideways week — where AAOI drifts up and down but ends where it started — hammers AAOX. The daily resets lock in losses from the down days while erasing gains from the up days, and the fund drifts lower even though the underlying sits flat. This is the most insidious risk for traders who enter with a view for "a few days" and then wait, hoping.

**Leverage amplifies losses symmetrically:** Just as a 2% gain becomes 4%, a 2% loss becomes 4%. A sudden 10% crash in AAOI (rare but possible during sector turmoil) becomes a 20% loss in AAOX. In leveraged funds, catastrophic days are twice as catastrophic.

## AAOI itself: what you are levering

AAOX's amplification depends on AAOI's own movement. AAOI is a non-leveraged ETF tracking companies and securities in the artificial intelligence sector — ranging from chip designers to software platforms to infrastructure. AAOI itself is volatile, swinging on earnings, funding announcements, and sentiment shifts in the AI industry. By leveraging an already-volatile sector, AAOX becomes highly sensitive to large moves, both up and down. Traders who own AAOX but lack conviction about the applied AI sector's near-term direction should not own it at all.
...
## How to understand AAOX's real costs
