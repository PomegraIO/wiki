---
title: "Angel Oak High Yield Opportunities ETF (AOHY)"
description: "AOHY is an active high-yield bond fund holding distressed debt, bank loans, and structured credit with concentrated thematic positioning and embedded illiquidity risks."
keywords:
  - high yield bonds
  - distressed debt
  - credit risk
...
**The macro environment matters.** AOHY's returns are tightly coupled to [credit cycle](/credit-cycle/) dynamics. During periods when corporate debt is repriced lower and default expectations spike — typically during [recessions](/recession/) or market shocks — distressed bonds become scarce but bargains emerge. AOHY can deliver outsized gains in the recovery that follows because it holds the bonds that fell furthest and thus have the most to gain when sentiment reverts. Conversely, during late-cycle booms when credit spreads compress and investors treat [junk bonds](/junk-bond/) as risk-free, AOHY's edge shrinks because the deep-value opportunities disappear and broad high-yield indices offer similar returns with less [concentration risk](/concentration-risk/).

**The measurement problem.** Angel Oak publishes credit quality metrics and [default rates](/default-rate/), but reading these requires care. A fund holding 198 bonds mostly rated below investment grade will naturally experience defaults; the question is whether the underlying credit research was sound and the pricing reflected that probability. A 3–4 per cent annual default rate is normal for distressed-focused funds; a spike above that signals either poor positioning, a cyclical downturn, or both. Review not just yield, but the maturity profile: bonds maturing in the next 1–2 years carry less uncertainty than those maturing in 5+ years, where company fundamentals and market conditions remain unknowable.
