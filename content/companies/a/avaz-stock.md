---
title: "2x Avalanche ETF (AVAZ)"
description: "AVAZ is a leveraged ETF providing 2x daily exposure to Avalanche, a blockchain platform for decentralized applications. It amplifies gains and losses daily."
keywords:
  - leveraged ETF
  - cryptocurrency
  - blockchain
...
<div class="wiki-infobox-title">AVAZ — key facts</div>

<img src="https://images.unsplash.com/photo-1621761191319-c6fb62b69a91?w=600&q=80" alt="Lines of computer servers with blinking lights, photographed from below against a dark background." />

<div class="wiki-infobox-caption">Leveraged funds reset their positions every trading day, making them tools for short-term bets rather than long-term holdings.</div>

|   |   |
|---|---|
| **What it is** | 2x leveraged ETF on Avalanche blockchain token |
| **Underlying** | Avalanche (AVAX) cryptocurrency token |
| **Leverage** | 2x daily returns (reset each day) |
| **Sponsor** | Source (or similar cryptocurrency ETF issuer) |
| **Structure** | Leveraged ETF using borrowing and derivatives |
| **Daily reset** | Rebalances daily; not intended for long-term hold |
| **Expense ratio** | High (reflects leverage costs and active rebalancing) |
| **Volatility** | Extreme; tracks cryptoasset price moves with 2x amplification |
