---
title: "American Customer Satisfaction Index ETF (ACSI)"
description: "An exchange-traded fund tracking publicly listed companies ranked highest on the American Customer Satisfaction Index, a unique quality-of-service screen applied to broad U.S. equities."
keywords:
...
*The **American Customer Satisfaction Index ETF** (ACSI) is an exchange-traded fund that selects U.S.-listed companies based on their customer satisfaction scores. Rather than sorting by conventional metrics like price-to-earnings or [dividend yield](/dividend-yield/), the fund weights holdings toward firms that score highest on customer experience measurement, offering a distinctive quality angle on the broader market.*

<aside class="wiki-infobox">
<table>
<tr><th>What it is</th><td>Exchange-traded fund tracking customer-satisfaction-scored companies</td></tr>
<tr><th>Underlying screen</th><td>American Customer Satisfaction Index (ACSI) rankings</td></tr>
<tr><th>Coverage</th><td>Broad U.S. equities across sectors</td></tr>
<tr><th>Fund structure</th><td>Plain ETF, no leverage or inverse mechanics</td></tr>
<tr><th>Methodology</th><td>Passive tracking of screened index</td></tr>
<tr><th>Primary risk</th><td>Concentration in high-satisfaction sectors; tracking error from screening</td></tr>
</table>
</aside>
...
The American Customer Satisfaction Index measures customer experience across the U.S. economy through regular, statistically rigorous surveys. It covers airlines, automotive, banking, broadband, cable and satellite television, cellular, email/search, financial brokerage, gas utilities, grocers, health insurance, hotels, investment [brokers](/broker/), online retail, package delivery, pharmaceuticals, rental cars, restaurants, spirits and wine, supermarkets, and telecommunications — essentially major industries where customer experience is meaningful and measurable.
