---
title: "Allspring Ultra Short Municipal ETF (AUSM)"
description: "AUSM is a bond ETF holding short-term municipal bonds exempt from federal income tax, targeting investors seeking stable income with minimal interest-rate risk."
keywords:
  - municipal bonds
  - short-term bonds
  - tax-exempt income
...
*The **Allspring Ultra Short Municipal ETF** (ticker AUSM) is an ETF focused on [municipal bonds](/municipal-bond/) with very short maturities, targeting investors who want tax-advantaged income with minimal exposure to the rising [interest rates](/interest-rate/) that can erode [bond](/bond/) prices.*

<aside class="wiki-infobox">

<div class="wiki-infobox-title">AUSM — key facts</div>

<img src="https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=600&q=80" alt="A municipal building facade showing classical architecture and weathered stonework." />

<div class="wiki-infobox-caption">Municipal bonds fund public works from water systems to schools; ultra-short versions prioritise stability over yield.</div>

|   |   |
|---|---|
| **What it is** | ETF of short-term tax-exempt bonds |
| **Holdings** | Municipal bonds with typical maturity of 1–3 years |
| **Tax status** | Interest income exempt from federal income tax |
| **Sponsor** | Allspring (formerly Voya) |
| **Typical yield** | Low single-digit; varies with rates and credit spreads |
| **Duration** | Very low (0.5–2 years typical); immune to long-rate moves |
| **Expense ratio** | Reasonable for municipal bond funds |
| **Trading** | Daily liquidity on exchange; NAV updated at close |
...
AUSM narrows the universe further: it holds only short-term municipal bonds, typically with remaining maturities of one to three years. This extreme shortness achieves two things. First, it nearly eliminates [interest-rate risk](/interest-rate-risk/) — the risk that rising rates erode the price of longer-dated bonds. A fund holding 30-year bonds can see double-digit losses if rates rise sharply; a fund holding one-year bonds will see only tiny losses. Second, short-dated bonds carry less [credit risk](/credit-risk/), because they mature soon and the issuer must repay; a 30-year bond is vulnerable to decades of potential issuer distress, while a one-year bond is not.
...
This is most valuable during periods of economic uncertainty or rising rate expectations. If the [Federal Reserve](/federal-reserve/) is expected to raise rates, longer bonds are vulnerable to swift price declines. Short-dated bonds suffer much less. But if rates are expected to fall or stay flat, the yield sacrifice becomes painful — the investor gets 2% when they could have had 4% in a longer bond, and then rates fall and the longer bond rallies 5%, multiplying the regret.

## Credit risk in municipal bonds

Municipal bond issuers vary wildly in creditworthiness. A [general obligation bond](/general-obligation-bond/) backed by New York State's tax base is far safer than a [revenue bond](/revenue-bond/) from a struggling rural water district. AUSM likely weights its holdings toward the creditworthy end of the spectrum, though the prospectus specifies the exact approach.
