---
title: "Associated Banc-Corp (ASBA)"
description: "Associated Banc-Corp is a Wisconsin-based regional bank holding company serving the upper Midwest with commercial, retail, and specialty finance segments. A consolidator navigating merger pressures and digital transformation."
keywords:
  - regional bank
  - wisconsin
  - commercial lending
...
<table>
<tr><th>Ticker</th><td>ASBA (NASDAQ)</td></tr>
<tr><th>Founded</th><td>1882, Neenah, Wisconsin</td></tr>
<tr><th>Headquarters</th><td>Green Bay, Wisconsin</td></tr>
<tr><th>Sector</th><td>Regional banking</td></tr>
<tr><th>Primary business</th><td>Commercial and retail banking, specialty finance</td></tr>
<tr><th>Service region</th><td>Upper Midwest (Wisconsin, Illinois, Minnesota, Indiana)</td></tr>
<tr><th>SEC CIK</th><td>0000007789</td></tr>
</table>
</aside>

## What is Associated Banc-Corp?

Associated Banc-Corp is a holding company, not a bank itself—the operating bank is Associated Bank, through which the parent executes its lending and deposit-taking business. Like most regional bank holding companies, Associated holds the parent equity capital, oversees compliance and risk management, and may own non-bank financial subsidiaries. The company operates roughly 200 branches across its Midwest footprint and serves customers ranging from agricultural operations and small businesses to larger [commercial real estate](/commercial-real-estate/) investors and mid-market companies. This regional concentration, common among banks of its size, creates both advantage and exposure: the company knows its territory deeply, but economic weakness concentrated in the Midwest hits harder than a nationally diversified franchise would.

## How does Associated actually make its money?

Like all banks, Associated generates revenue from two main sources: the spread between what it pays on deposits and what it earns on loans (net interest margin), and fees from services, lending advisory, and other non-interest-bearing activities. Net interest margin has been the larger contributor, though it compressed significantly as the [Federal Reserve](/federal-reserve/) held [interest rates](/interest-rate/) near zero through much of the 2020s and then raised them abruptly, forcing banks to pay more on deposits to retain them while adjusting loan rates lagged. The bank's loan portfolio spans commercial and industrial lending, commercial real estate (a large slice, typical of Midwest regional banks), consumer installment loans, and home mortgages. A notable slice of the company's specialty finance business comes from Associated Finance, which originates indirect auto loans through dealer networks—this segment is higher-yielding but carries higher [credit risk](/credit-risk/) than prime mortgage or commercial lending.
