---
title: "Astrana Health, Inc. (ASTH)"
description: "Physician-centric healthcare management company operating an integrated delivery platform delivering primary care, specialty care, and value-based services across the U.S."
keywords:
  - astrana health
  - healthcare delivery
  - value-based care
...
Unlike traditional fee-for-service medicine, Astrana operates primarily under capitated contracts with [Medicare Advantage plans](/wiki/medicare-advantage/), Medicaid health plans, and employer groups, accepting predictable per-member-per-month payments rather than variable per-visit reimbursement. This model incentivizes preventive care, efficient referral patterns, and better outcomes—because managing patient health costs the company less and improves member retention. The company's revenue base depends on maintaining satisfied patients, lowering utilization of expensive hospital care, and delivering services within contracted payment envelopes.
...
Related: [Medicare Advantage](/wiki/medicare-advantage/), [physician groups](/wiki/physician-group/), [healthcare integration](/wiki/healthcare-integration/)
