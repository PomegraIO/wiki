---
title: "Alternative Access First Priority CLO Bond ETF (AAA)"
description: "AAA is an ETF that gives investors access to collateralized loan obligations, specifically AAA-rated tranches of CLO structures — senior, lower-risk securities built from portfolios of leveraged corporate loans."
keywords:
  - CLO
...
AAA offers investors access to a specialized corner of the credit market: the senior [tranches](/tranche/) of [collateralized loan obligations](/collateralized-loan-obligation/), known as CLOs. These are complex securitized structures built from portfolios of leveraged corporate loans, and the AAA-rated pieces at the top of the capital stack are among the safest income-bearing securities available outside government [bonds](/bond/).
...
The yield on AAA CLO tranches is typically 150 to 300 basis points above equivalent-maturity [Treasury bonds](/treasury-bond/), depending on credit conditions and the specific CLO's creditworthiness. That spread compensates for the complexity, the illiquidity of holding individual CLO stakes, and the [tail risk](/tail-risk/) that something goes catastrophically wrong. In normal times, the credit loss rates on AAA CLO tranches are vanishingly small — single-digit basis points annually. In severe [recessions](/recession/) or credit crises, the losses can spike, but the structure's safety buffer means that even in the 2008 financial crisis, many AAA CLO pieces survived intact while the lower tranches were wiped out.
...
Finally, there is [correlation risk](/correlation-risk/) in the underlying loans. The loans in any given CLO are often concentrated in a few industries, geographies, or sponsor firms. In a downturn that hits those sectors hard, losses can be concentrated rather than diversified.
...
The starting point is AAA's prospectus and fact sheet, which disclose the fund's strategy and current holdings at the CLO level. The fund's website typically provides a breakdown of the underlying CLOs, the leverage and quality of the loans in each, and the amount of overcollateralization protecting the AAA tranches. Moody's and S&P publish monitoring reports on CLO performance, including [default rates](/default-rate/) and recovery rates by vintage and sector. Third-party providers like LCD (part of [S&P Global](/spgi-stock/)) and Refinitiv track the leveraged-loan and CLO markets in detail. Articles in credit-focused publications like CreditFlux and LPC intelligence services provide context on CLO issuance, valuation, and risk.
