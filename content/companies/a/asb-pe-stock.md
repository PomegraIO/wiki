---
title: "Associated Banc-Corp (ASB-PE)"
description: "ASB-PE is a perpetual preferred equity issued by Associated Banc-Corp, ranking senior to common stock but subordinate to debt. Fixed yield, no maturity date, callable by issuer—a debt-like instrument with equity features."
keywords:
  - preferred stock
  - perpetual preferred
  - regional bank
...
ASB-PE is a [perpetual preferred stock](/perpetual-preferred/) issued by Associated Banc-Corp. It sits in the capital structure between senior debt and common equity—subordinated to [bonds](/bond/) and bank deposits, senior to common shares. Holders receive a fixed [dividend](/dividend/) stream in perpetuity (or until the issuer calls the shares, which they can do after a certain date). The preferred trades on [secondary markets](/secondary-market/) just as [common stock](/common-stock/) does, but its economics and tax treatment differ sharply from common shares.
...
ASB-PE behaves more like a bond than a stock in daily trading. Its price moves inversely with [interest rates](/interest-rate/)—when rates rise, perpetual preferreds fall in value because the fixed dividend becomes less attractive relative to what new issuances yield. Conversely, when rates fall, the share price tends to appreciate. This makes perpetual preferreds duration-sensitive in a way common stock is not. They also have less upside if the company's fundamentals improve; the dividend is fixed, so the holder does not participate in earnings growth the way a common-stock owner does.

The issuer has optionality. Associated can call ASB-PE after the stated date—usually at [par value](/par-value/)—if it chooses. This creates "[negative convexity](/negative-convexity/)": if rates fall sharply and the preferred appreciates, the issuer is incentivised to call it, capping the holder's gain. Conversely, if rates rise and the preferred falls, the issuer will not call, leaving the holder with a loss. This asymmetry is why perpetual preferreds yield more than bonds of equivalent credit quality.
