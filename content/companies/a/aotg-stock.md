---
title: "AOT Growth and Innovation ETF (AOTG)"
description: "AOTG is an actively managed growth equity fund targeting companies positioned for long-term innovation trends, with global developed-market scope and concentrated thematic positioning."
keywords:
  - growth ETF
  - innovation themes
  - active management
...
<div class="wiki-infobox-title">AOT Growth and Innovation — key facts</div>

<img src="https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=600&q=80" alt="A computer screen displaying ascending stock price trends in green, with financial charts and data visualization." />

<div class="wiki-infobox-caption">Active growth managers bet that disciplined stock selection can identify companies riding structural trends before broader markets do.</div>

| | |
|---|---|
| **Fund sponsor** | AOT Investments |
| **Ticker** | AOTG (NYSE Arca) |
| **Strategy** | Active stock selection based on innovation themes |
| **Geographic scope** | Developed markets; primarily U.S. |
| **Typical holdings** | 30–60 concentrated positions |
| **Sector emphasis** | Technology, healthcare, industrials, discretionary |
| **Expense ratio** | ~0.7–0.8% annually |
| **Distributions** | Minimal; reinvested growth |
