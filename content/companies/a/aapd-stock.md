---
title: "Direxion Daily AAPL Bear 1X ETF (AAPD)"
description: "A 1x inverse ETF that tracks the opposite of Apple stock price movement; designed for bearish tactical trades, not market hedges or buy-and-hold positions."
keywords:
  - inverse ETF
  - Apple stock
  - bearish exposure
...
There are two main use cases. The first is tactical bearish trading — an investor who believes Apple is overvalued or is due for a near-term pullback can buy AAPD to express that view without needing a brokerage account that allows short-selling or options trading. The second is hedging. A portfolio heavily weighted toward Apple — whether because an employee holds vested stock or a manager has a large position — can buy AAPD as a temporary brake, offsetting some downside risk during periods of concern without selling the underlying shares.

The critical word in both cases is "tactical" or "temporary." AAPD is not a buy-it-forever position. It is a tool for short-term, explicit bearish bets.

## What breaks this fund?
