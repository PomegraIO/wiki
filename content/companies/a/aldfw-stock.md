---
title: "Aldel Financial II Inc. (ALDFW)"
description: "Aldel Financial II is a blank-check holding company and the second SPAC vehicle formed by Robert Kauffman, former Fortress Investment Group co-founder. It targets a business combination in financial services or asset-based finance between $1 billion and $5 billion in market value; the core risk is execution—finding a target, negotiating terms, and managing shareholder redemptions through closing."
keywords:
  - SPAC
  - blank-check company
  - financial services
...
[Aldel Financial II](/aldf-stock/) Inc. is a special purpose [acquisition](/acquisition/) company (SPAC)—a blank-check vehicle formed to identify, pursue, and complete a [business combination](/business-combination-purchase/) ([merger](/merger/), acquisition, or similar transaction) with one or more operating companies. The company was founded in 2024 and formally began trading on [Nasdaq](/nasdaq/) in December 2024 after closing its [initial public offering](/initial-public-offering/) at $230 million (including full exercise of the underwriters' over-allotment option). Units trade under the symbol ALDFU; after separation, the Class A ordinary shares trade as ALDF and the warrants as ALDFW.
