---
title: "ARS Core Equity Portfolio ETF (ACEP)"
description: "ACEP is an actively managed ETF investing in large-cap U.S. equities, run by ARK Funds with daily transparency, low turnover, and a value-and-quality selection discipline."
keywords:
  - active ETF
  - large-cap value
  - quality investing
...
## The selection lens: value and quality, not deep contrarian
...
Disclosing holdings daily is unusual and useful. It lets investors understand what the managers actually own at any moment, spot emerging themes they are betting on, and monitor turnover in real time. It creates a natural accountability: the manager cannot hide bad positions or quietly shift strategy. Some professional investors treat daily holdings disclosures as research signals themselves, watching which stocks flow into or out of a talented manager's portfolio and using that as a hint about the manager's thinking.

This transparency also means there is nowhere to hide. Bad picks show up immediately. There is no quarterly smoothing or narrative control. If the fund loses money, everyone knows why—they can see the positions and track the market's moves against them.

## Manager risk and sector bets
...
Read the fund's fact sheet to understand the current portfolio composition and expense structure. Visit the daily holdings disclosure on the ARK website and examine the top ten positions to get a feel for what the manager believes in right now. Track the fund's returns against a suitable large-cap benchmark (the S&P 500 or Russell 1000) over rolling 3-year and 5-year periods to see whether active management has added value. A single year or quarter proves nothing; years-long trends mean something.

Pay attention to any significant personnel changes on the investment team. If the lead manager departs, that is a signal worth acting on. Watch the portfolio turnover in quarterly reports: if it is creeping up, the strategy is shifting. And be honest about your own conviction: if you cannot articulate why the managers' bets are smarter than an index, owning the fund means you are betting on manager skill. That is a valid bet, but it is important to know what you are betting on.
