---
title: "Goldman Sachs Physical Gold ETF (AAAU)"
description: "Goldman Sachs Physical Gold ETF is an exchange-traded fund holding allocated physical gold bullion, offering direct commodity exposure through a securities-trading interface rather than gold futures or mining stocks."
keywords:
  - physical gold ETF
  - gold ETF
  - commodity exposure
...
<table>
<tr><th>Ticker</th><td>AAAU (NYSE ARCA)</td></tr>
<tr><th>Sponsor</th><td>Goldman Sachs Funds</td></tr>
<tr><th>Underlying asset</th><td>Physical gold bullion</td></tr>
<tr><th>Sector</th><td>Commodities / alternative assets</td></tr>
<tr><th>Business model</th><td>Commodity trust</td></tr>
<tr><th>Custody</th><td>Allocated to custodians in London, Zurich, New York</td></tr>
<tr><th>SEC CIK</th><td>0001708646</td></tr>
</table>
</aside>
...
Downstream, the ETF serves investors seeking gold exposure without operational complexity. They trade shares on the exchange during market hours, can hold the position in a retirement account or regular brokerage account, and can liquidate on a day's notice without minimum [holding periods](/holding-period/). The fund stands ready to redeem shares for bullion in institutional quantities for [authorized participants](/authorized-participant/), which arbitrage the relationship between the share price and the value of the underlying gold, keeping the ETF's market price tightly aligned with the [net asset value](/net-asset-value/).

## How the fund operates and makes money for shareholders

The ETF has no business model in the traditional sense — it generates no revenue and makes no profits. Instead, it is a conduit. Shareholders own the bullion; Goldman Sachs and its appointed custodians hold and administer it. The only movement of value is negative: the fund charges an annual [expense ratio](/expense-ratio/) to cover custodial fees, insurance, auditing, and administrative costs. These fees are paid out of the bullion holdings, so they reduce the ounces-per-share over time. An investor in AAAU is effectively bearing those costs as a drag on performance relative to owning bullion outright.

The fund can only accrue or lose value as the price of gold moves. Because it holds only gold (no derivatives, no lending programs, no ancillary revenue), its total return is entirely dependent on bullion's price appreciation or [depreciation](/depreciation/) over the holding period, less the annual fees.

Gold is a non-yielding asset. Unlike a stock, which may pay [dividends](/dividend/), or a [bond](/bond/), which pays interest, gold pays nothing while held. It is purchased on the theory that its value will rise, either because scarcity drives up its price or because it serves as a hedge against [inflation](/inflation/), currency debasement, or financial crisis. From a financial perspective, this is crucial: gold does not generate cash flow, so its valuation has no [earnings multiple](/earnings-multiple/) or yield to anchor it. Its price is driven by sentiment, central-bank buying and selling, mining supply, jewelry demand, and fear or risk-off episodes in financial markets.
...
Gold trades continuously on global markets — the London Bullion Market in morning trading, then COMEX futures in New York, and 24-hour [over-the-counter markets](/over-the-counter-market/). The AAAU share price tracks these; the fund calculates its net asset value based on the London afternoon fixing (or similar transparent price benchmarks), and the shares trade on an exchange where [market makers](/market-maker-trading/) provide liquidity around that value.

The main risk to AAAU investors is gold price volatility. Because gold does not generate cash flow, its price can swing sharply on sentiment shifts. A sudden loss of confidence in [central banks](/central-bank/), expectations of inflation, or a financial crisis can drive sharp rallies; [recession](/recession/) fears or rising [real interest rates](/real-interest-rate/) can trigger sharp declines. An investor buying AAAU is betting on gold's future direction.

Regulatory and geopolitical risks also exist. Changes in how the IRS taxes gold holdings, rules governing [commodity ETFs](/commodity-etf/), or international sanctions on gold could alter the fund's operating environment. A major war or sudden shift in central-bank gold policy could move gold's price in unexpected ways.
