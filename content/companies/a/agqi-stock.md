---
title: "First Trust Active Global Quality Income ETF (AGQI)"
description: "AGQI is an actively managed ETF that seeks to build a global equity portfolio tilted toward high-quality companies with strong income characteristics. The fund uses fundamental analysis to select stocks paying dividends or generating other cash returns."
keywords:
  - dividend ETF
  - global equities
  - active management
...
<table>
<tr><th>Ticker</th><td>AGQI (NASDAQ)</td></tr>
<tr><th>Sponsor</th><td>First Trust Advisors</td></tr>
<tr><th>Fund type</th><td>Exchange-traded fund (ETF), actively managed</td></tr>
<tr><th>Strategy</th><td>Global dividend equities, quality-focused</td></tr>
<tr><th>Holdings approach</th><td>Global equities tilted toward dividend payers</td></tr>
<tr><th>Expense ratio</th><td>Qualitatively moderate (active management premium)</td></tr>
<tr><th>Liquidity</th><td>High; trades on NASDAQ</td></tr>
</table>
</aside>
...
Rebalancing is also tactical. Rather than mechanically rebalancing to fixed weights on a calendar date, the managers can adjust the portfolio more dynamically — trimming winners that have become expensive, adding to depressed sectors when value appears, and rotating between regions based on their assessment of relative attractiveness. This flexibility is part of the appeal of active management; the downside is that it also introduces the risk of poor timing or bad judgment.

## Income generation and the role of dividends

The fund pursues income through dividends — cash payments companies make to shareholders — but also through buybacks and other forms of capital return. A company that buys back its own shares reduces the share count; existing shareholders own a larger slice of the same business, which is economically equivalent to a dividend for those who do not sell. Some high-quality companies favor buybacks over dividends for tax or strategic reasons, and AGQI includes them because the economic benefit to shareholders is similar.

The income component is steady but not fixed. Dividends can be cut if a company's earnings fall or if management changes its capital-allocation policy. The fund does not guarantee any specific yield. What it does is tilt the selection toward companies with strong track records of returning cash, which statistically have lower cut risk than dividend payers as a class.
...
An investor considering AGQI should read the fund's prospectus and fact sheet to understand the selection criteria, the current holdings, and the expense ratio. The fund's performance history — how it has done relative to a dividend-paying global index or a broad global equity index — offers one lens, though past performance does not ensure future results. Looking at the actual holdings reveals what kinds of companies the managers are drawn to, whether they concentrate in specific sectors or countries, and how the portfolio responds to market shifts.

The fund is also worth comparing to alternatives. A low-cost, index-tracking global dividend ETF might underperform in some periods if AGQI's managers make good stock-picking calls, but it will outperform in periods when they do not. The decision between active and passive global dividend exposure is ultimately about whether an investor believes First Trust's team can beat the market net of fees — a bet on skill that no one can guarantee in advance.
