---
title: "Tradr 2X Long ASTS Daily ETF (ASTX)"
description: "A 2x leveraged daily ETF tracking ASTS (Axiom Space Inc.), doubling the daily gains of the stock — useful for traders betting on near-term rises but vulnerable to volatility decay for longer-term holders."
keywords:
  - leveraged ETF
  - daily reset
  - ASTS
...
The fund trades with tight bid-ask spreads and high liquidity, so getting in and out costs little. The [expense ratio](/expense-ratio/) is slightly elevated — typically 0.5 to 0.6 percent annually — to cover the cost of maintaining leverage. The prospectus is explicit that ASTX "seeks daily leveraged returns" and is "not intended for long-term investors." That language is not marketing hyperbole; it is a direct statement about the fund's mechanics and design limitations.
