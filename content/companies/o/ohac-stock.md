---
title: "Oceanhawk Acquisition Corp. (OHAC)"
description: "Oceanhawk Acquisition Corp. is a blank-check company backed by Oceanhawk, a private investment firm with 25+ years of commodity and energy-sector expertise, seeking acquisition targets in capital-intensive industries."
keywords:
  - SPAC
  - blank-check company
  - commodity sectors
...
Oceanhawk [Acquisition](/acquisition/) Corp. emerged from a deliberate strategy by its parent firm, Oceanhawk, a private investment platform with deep roots in commodity-driven, capital-intensive sectors. The company began its public journey in May 2026, when it priced an [initial public offering](/initial-public-offering/) of 16 million units at ten dollars each, upsizing from an initial plan and ultimately raising 184 million dollars after the underwriters exercised their full over-allotment option.

The structure reflects the modern SPAC model. Each unit consisted of one Class A ordinary share and the right to receive one-quarter of one Class A ordinary share upon the consummation of an initial [business combination](/business-combination-purchase/). That fractional-share-per-unit design is deliberate: it gives sponsors additional flexibility in negotiating [mergers](/merger/) without diluting the original shareholders as heavily as a more rigid structure would. The units began trading on [Nasdaq](/nasdaq/) under OHACU on May 21, 2026, and would separate into their component shares (OHAC) and warrants (OHACW) once trading opened on those individual securities.
