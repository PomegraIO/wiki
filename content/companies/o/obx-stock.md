---
title: "Gazelle Parent, Inc. (OBX)"
description: "Gazelle Parent is a newly listed shell company serving as the merger vehicle for Obsidian Therapeutics and Galera Therapeutics, combining cell and small-molecule cancer therapies under the ticker OBX."
keywords:
  - gazelle parent
  - obx ticker
  - obsidian therapeutics
  - galera therapeutics
  - cancer therapy merger
  - til cell therapy
handwritten: true
---
...
As a shell company in transition, Gazelle Parent carries no meaningful operations or revenue. Its worth is purely the sum of the two operating companies it will house. Reading the [10-K](/wiki/10-k/) and merger proxy will show the detailed financial position of both predecessors; clinical trial sites and patient enrollment numbers are often disclosed in SEC filings and company press releases.
