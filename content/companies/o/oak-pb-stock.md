---
title: "Brookfield Oaktree Holdings, LLC (OAK-PB)"
description: "A preferred share class in Brookfield's global alternative asset management business, combining Oaktree's credit expertise with Brookfield's infrastructure and private equity operations."
keywords:
...
Brookfield Oaktree generates revenue from two sources: management fees and [performance fees](/performance-fee/). Management fees are recurring and relatively predictable. They arrive as a percentage of assets under management each year, regardless of whether those assets grew or shrank. In [bull markets](/bull-market/), AUM grows both from investment gains and from new capital raised, and fees grow automatically. In [bear markets](/bear-market/), investment losses shrink AUM, fees decline, and the firm may struggle to raise new capital for new funds.

Performance fees — carry, in industry parlance — are the outsized profit opportunity but also the source of earnings volatility. When portfolio companies sold by a [private equity fund](/private-equity-fund/) realize large gains, or when distressed securities appreciate, Oaktree captures 20 percent of that gain above a defined hurdle. In boom years, carry can double or triple reported earnings. In down years, carry vanishes entirely.
...
The preferred shareholders in OAK-PB have no control over these operational decisions. Brookfield owns the majority, and the firm's leadership (including Marks and Karsh in their roles) makes strategic allocation decisions. Preferred [dividends](/dividend/) depend on the earnings that flow from those decisions.
