---
title: "Osprey Polkadot Trust (ODOT)"
description: "Osprey Polkadot Trust is a closed-end investment vehicle that holds Polkadot tokens directly, offering investors an alternative to buying cryptocurrency on an exchange."
keywords:
  - polkadot
...
Cryptocurrency markets are highly volatile, and the price of Polkadot tokens can experience large swings based on technology developments, regulatory changes, and broader sentiment shifts. Investors in ODOT are entirely exposed to that volatility; the trust structure itself offers no hedging or mitigation of price risk. Additionally, a gap between the share price and the underlying token value (the premium or discount mentioned above) introduces an additional layer of price risk unique to the closed-end structure. If you buy ODOT at a high premium and share demand dries up, you may suffer losses even if the underlying tokens hold their value.

The regulatory landscape for cryptocurrency holdings is evolving, and changes in how regulators treat crypto assets could affect the trust's operation and the value of its holdings.

## How to research Osprey Polkadot Trust

The best starting point is the trust's SEC filing (CIK 0001857629), which discloses the trust's structure, fees, and holdings. The prospectus explains the closed-end fund mechanics and the risks of holding cryptocurrency through this vehicle. Tracking the current value of Polkadot tokens on major exchanges provides context for the trust's underlying value; comparing that value to ODOT's share price will show whether the shares trade at a premium or discount on any given day.
