---
title: "Oxford Lane Capital Corp. (OXLCZ)"
description: "Oxford Lane Capital's Series D preferred shares represent the fund's structured debt hierarchy, receiving fixed distributions senior to common equity while remaining subordinate to the fund's senior debt obligations."
keywords:
  - preferred shares
  - closed-end fund
  - CLO equity
...
The Series D Cumulative Redeemable Perpetual Preferred Shares of [Oxford Lane Capital](/oxlc-stock/) are the middle rung of a three-tier capital stack. Unlike the [common stock](/common-stock/) OXLCP, which floats with the performance of the underlying [collateralized loan obligation](/collateralized-loan-obligation/) portfolio, OXLCZ comes with a specified distribution rate and preferential treatment in any [liquidation](/liquidation/) or redemption. The security represents an attempt to attract more conservative income investors who are willing to accept lower yields in exchange for priority claim on the fund's assets.

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>OXLCZ (NASDAQ)</td></tr>
<tr><th>Parent fund</th><td>Oxford Lane Capital Corp.</td></tr>
<tr><th>Security type</th><td>Perpetual preferred shares</td></tr>
<tr><th>Payment priority</th><td>Above common, below senior notes</td></tr>
<tr><th>Distribution</th><td>Fixed rate, cumulative</td></tr>
<tr><th>SEC CIK</th><td>0001495222</td></tr>
</table>
</aside>

## From common stock to preferred capital (the need for diversified funding)

When Oxford Lane Capital began operations in 2007, it raised capital in the simplest way: issuing common shares to investors seeking high yield from CLO equity exposure. As the fund grew and its managers wanted to scale the business, they faced a capital constraint. Common shareholders demanded high yields, but the underlying CLO equity [tranches](/tranche/) offered only so much cash. To fund additional CLO investments, management needed capital that did not require such fat yields but was senior enough to appeal to risk-averse investors.
