---
title: "Oxford Square Capital Corp. (OXSQG)"
description: "Oxford Square Capital is a closed-end investment company that evolved from early 2000s formation to become a significant middle-market debt investor, adapting its strategy through credit cycles and interest-rate regimes."
keywords:
  - investment company history
  - closed-end fund
  - business development company
  - credit strategy evolution
...
<table>
<tr><th>Ticker</th><td>OXSQG (NASDAQ)</td></tr>
<tr><th>Established</th><td>Early 2000s</td></tr>
<tr><th>Business model evolution</th><td>From formation through multiple credit cycles</td></tr>
<tr><th>Primary strategy</th><td>Middle-market secured debt investing</td></tr>
<tr><th>Regulatory status</th><td>Closed-end investment company</td></tr>
<tr><th>Strategic focus</th><td>Adaptation to market cycles</td></tr>
...
The post-crisis period from 2009 onward saw an environment of extremely low [interest rates](/interest-rate/) as [central banks](/central-bank/) attempted to stimulate the economy. For a yield-generating strategy like Oxford Square's, this created a real challenge: borrowing costs fell, spreads compressed, and competition for deals became intense. Investors hungry for yield competed aggressively, and lenders found themselves forced to accept tighter margins or to move into riskier structures to maintain return targets. The company had to navigate these shifting incentives carefully, balancing the pressure to deploy capital with the discipline to underwrite only credits that justified the risk.

## The middle years and shifting cycles

Through the mid-2010s, Oxford Square operated in a more normalized environment. Interest rates remained low but stable, the economy recovered gradually, and companies refinanced and grew. The fund could originate loans to growing mid-market businesses, earn steady interest income, and look for capital appreciation as portfolio companies matured. The portfolio began to stabilize, and the [dividend](/dividend/) available to shareholders became more predictable.
...
Beginning in 2022, the [Federal Reserve](/federal-reserve/) embarked on a historically rapid interest-rate hiking cycle in response to [inflation](/inflation/). Higher rates posed a complex challenge for Oxford Square. On the positive side, new loan originations could carry higher interest rates, improving the yield on new capital deployed. On the negative side, rising rates pressured some borrowers' cash flows and increased default risk. Additionally, the portfolio's existing loans — whether fixed-rate or floating-rate — faced valuation pressures as the market's required yields increased.
...
Understanding Oxford Square's evolution requires reading its historical [annual reports](/10-k/) alongside recent documents to observe how the portfolio has shifted over time, how the company's investment criteria have evolved, and how various credit cycles have affected performance. The SEC filings (CIK 0001259429) provide the foundation: detailed portfolio listings, performance metrics, credit statistics, and management commentary.

Key indicators to track include the weighted-average yield and spread on the loan portfolio, [default rates](/default-rate/) and recovery rates by vintage, the percentage of portfolio invested by industry and by original lender, and the composition of new loan originations relative to historical averages. These metrics reveal whether the company is maintaining discipline or stretching to generate returns, and how the portfolio is positioned for the credit environment ahead.
