---
title: "Militia Long/Short Equity ETF (ORR)"
description: "An actively managed fund that holds long positions in undervalued stocks and short positions in overvalued peers, using relative value judgments to profit independent of market direction."
keywords:
  - long/short equity
  - hedge fund strategy
  - active management
...
Monthly or quarterly holdings files disclose the long and short portfolio. Unlike passive index trackers, where security composition follows a predetermined formula, ORR rotates holdings based on the manager's valuation forecasts. There is no rulebook; there is only judgment.
...
## Specific risks: short squeezes and borrowed stock constraints

The core hazard of any long/short fund is reliance on the manager's forecasting ability. If valuations do not mean-revert as predicted—if the stocks thought cheap remain cheap and those thought expensive remain expensive—the fund underperforms.

The short book presents particular hazards. If many long/short funds have shorted the same overvalued name and that stock rallies sharply (driven by a takeover, technical reversal, or sentiment shift), the pressure to cover can accelerate the move, inflicting losses simultaneously across the industry. The fund also faces borrow constraints: stocks that are expensive or impossible to borrow for short selling may be recalled by lenders, forcing the fund to unwind the position at an unfavourable time. This is especially acute in stocks held by few shareholders or in periods of high short interest across the market.

Returns in a strongly rising market are also capped. If equity indices rally and stay elevated, the shorts become a drag rather than a hedge, and ORR will lag a simple long-only fund holding the same names without the short offset.

## Who this fund is for and how to research it

Militia Long/Short is suited to investors who understand the strategy and accept that returns may not correlate with equity markets—who view it as a satellite position rather than a core holding. It appeals to those aiming to reduce portfolio volatility or diversify away from pure market beta.
