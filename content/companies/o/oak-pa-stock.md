---
title: "Brookfield Oaktree Holdings, LLC (OAK-PA)"
description: "An alternative asset manager built from Brookfield's 2019 acquisition of majority control of Oaktree Capital Management; OAK-PA preferred shares represent a stake in a firm managing roughly $475 billion across credit, equity, and real estate."
keywords:
...
<table>
<tr><th>Ticker</th><td>OAK-PA (NYSE)</td></tr>
<tr><th>Security type</th><td>Preferred shares in Brookfield Oaktree Holdings</td></tr>
<tr><th>Formed</th><td>2019 (Brookfield acquisition of Oaktree)</td></tr>
<tr><th>Sector</th><td>Asset management / alternative investments</td></tr>
<tr><th>AUM</th><td>~$475 billion (combined Brookfield and Oaktree)</td></tr>
<tr><th>Fee-related revenue</th><td>~$2.5 billion annually</td></tr>
<tr><th>Key leadership</th><td>Howard Marks (Co-Chair), Bruce Karsh (Co-Chair/CIO), Jay Wintrob (CEO)</td></tr>
<tr><th>SEC CIK</th><td>0001403528</td></tr>
</table>
</aside>
...
## The 2019 Brookfield acquisition and the new structure

Brookfield Asset Management, itself a $600 billion-plus asset manager focused on infrastructure, renewable energy, and private equity, saw in Oaktree a complement to its existing business. In September 2019, Brookfield completed its acquisition of 61.2 percent of Oaktree, valuing the firm and combining it with Brookfield's own alternative investment businesses under the umbrella of Brookfield Oaktree Holdings.

The structure preserved Oaktree's operational independence: Howard Marks and Bruce Karsh retained operating control, and the firm continued to run as a distinct entity with its own investment teams, decision-making processes, and culture. This approach — acquisition with operational autonomy — is common in the asset management industry, where talented investment teams are easily poached if they feel their independence is threatened.

The combined entity now manages approximately $475 billion across several major buckets: Oaktree's credit and special situations funds, Brookfield's private equity and [infrastructure funds](/pe-infrastructure-fund/), and complementary real estate investing. The combined firm generates roughly $2.5 billion of annual fee-related revenues, making it one of the largest alternative managers globally.

## How the business makes money

Brookfield Oaktree generates revenue primarily from [management fees](/management-fee/) charged on assets under management. Typically, alternative managers charge 1.5 to 2.5 percent annually on the assets in their funds, with fees declining modestly on larger funds. The firm also collects [performance fees](/performance-fee/) (often called "carry"), which are typically 20 percent of investment profits above a defined [hurdle rate](/hurdle-rate/). These carry economics are the driver of outsized returns for the firm in good years.
...
Brookfield Oaktree competes against other large alternative asset managers: [Apollo Global Management](/apo-stock/) (which also evolved from a credit specialist into a diversified alternative manager), [Ares Management](/ares-stock/), [KKR](/kkr-stock/), The [Carlyle Group](/carlyle-group/), Blackstone, and others. This is a ruthlessly competitive industry where brands matter significantly because institutional investors manage billions and entrust it only to firms they believe have superior investment processes and track records.
...
**Fee rates.** As competition increases and investors demand more for their capital, fee rates can compress. A shift from an average of 2.0 percent to 1.8 percent across a $475 billion portfolio is a $1 billion annual revenue headwind.

**Carry realization.** In good years, performance fees can be substantial. In bad years, they vanish. Understanding the sensitivity of earnings to the performance of the firm's funds is important.

**Client concentration.** If a few large institutional investors account for most AUM, and one decides to redeem, the impact is severe. The firm does disclose concentrations in regulatory filings.

Risks to the business include macroeconomic downturn (which typically pressures valuations in private equity and credit portfolios), regulatory change affecting asset manager operations or leverage, and key-person departure (the loss of Howard Marks or another senior leader could rattle investors).
...
Understand Brookfield's ownership stake and any consolidation incentives. Is Brookfield comfortable with the current structure indefinitely, or is there eventual pressure to deepen integration or simplify the holding?

Finally, read Howard Marks's publicly available memos on investing and the market. They are not direct guidance on the firm's future, but they reveal the investment philosophy and how management thinks about risk and opportunity. Changes in tone or emphasis can signal shifts in conviction about markets.

Because this is primarily an institutional capital markets business, public information is limited compared to consumer-facing companies. Much of what drives the business — specific fund performance, investor appetite, dealflow quality — is disclosed only to investors in the funds themselves. The public shareholder of OAK-PA has a view on the consolidated earnings power of the business but less transparency into the day-to-day drivers of value.
