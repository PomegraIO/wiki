---
title: "Outset Medical, Inc. (OM)"
description: "Medical technology company building integrated hemodialysis systems and consumables to simplify dialysis treatment across hospitals, clinics, and homes."
keywords:
  - dialysis
...
|---|---|---|
| **Tablo Consoles** | Hardware sales of Tablo hemodialysis units | Capital deployment; one-time revenue per site; lower margin than consumables |
| **Tablo Consumables** | Cartridges, filters, and disposables for treatment | Recurring; required for each dialysis session; high incremental margin |
| **Data and Services** | Analytics platform, EMR integration, patient monitoring | Subscription-based; supportive of system adoption; modest but growing |
