---
title: "Bank of Montreal Oil Warrant Unit (OILU)"
description: "Bank of Montreal Oil Warrant Unit (OILU) is a structured product combining Bank of Montreal common equity with embedded warrants, designed to provide leveraged exposure to BMO with downside participation."
keywords:
  - structured products
  - warrants
  - leverage
...
<table>
<tr><th>Issuer</th><td>Bank of Montreal</td></tr>
<tr><th>Security type</th><td>Structured warrant unit</td></tr>
<tr><th>Components</th><td>Share + embedded warrant (common format)</td></tr>
<tr><th>Trades on</th><td>TSX Venture, OTC markets</td></tr>
<tr><th>Parent CIK</th><td>0000927971</td></tr>
<tr><th>Primary function</th><td>Leveraged BMO exposure</td></tr>
<tr><th>Investor profile</th><td>Sophisticated, directional, leverage-tolerant</td></tr>
<tr><th>Risk characteristics</th><td>Time decay, leverage amplification</td></tr>
</table>
</aside>

Structured products are hybrids that combine multiple securities into a single package. OILU is a unit, typically consisting of one share of Bank of Montreal [common stock](/common-stock/) bundled with a fractional or whole warrant that gives the holder the right to purchase additional Bank of Montreal shares at a specified [strike price](/strike-price/). By packaging them together, issuers create a security that offers enhanced exposure to the bank's stock price movement while allowing the components to be separated and traded independently after issuance.
