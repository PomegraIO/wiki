---
title: "OFS Capital Corp (OFSSO)"
description: "OFS Capital is a closed-end investment company and Business Development Company that lends to small and mid-sized enterprises, generating returns primarily through debt interest and fee income rather than stock appreciation."
keywords:
...
OFS Capital Corporation is a [Business Development Company](/business-development-company/) (BDC) that functions as a private credit lender to small and mid-sized enterprises. As a BDC, it is bound by specific regulatory requirements: it must invest at least seventy percent of assets in eligible portfolio companies, it pays out nearly all earnings as distributions to shareholders, and it is a [closed-end fund](/closed-end-fund/) (shares do not trade based on underlying [net asset value](/net-asset-value/), but rather on what the market will pay on any given day). Unlike a traditional bank, OFS Capital finances companies that might find it harder to borrow from conventional sources—often because they are too small, have limited credit history, or are in transition (being acquired, refinanced, or restructured).

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>OFSSO (NASDAQ)</td></tr>
<tr><th>Structure</th><td>Business Development Company (BDC), closed-end fund</td></tr>
<tr><th>Headquarters</th><td>New York, New York</td></tr>
<tr><th>Sector</th><td>Alternative lending / specialty finance</td></tr>
<tr><th>Core business</th><td>Debt lending to middle-market and small enterprises</td></tr>
<tr><th>Business model</th><td>Interest income, fees, occasional equity upside</td></tr>
...
**[Concentration risk](/concentration-risk/)** is another factor. If the portfolio becomes too concentrated in one borrower, industry, or type of loan, a downturn in that sector hits the company's returns disproportionately. OFS Capital manages this through [diversification](/diversification/), but the lower-middle-market is still smaller than the large-cap space, and concentration is a real risk.
...
Start with the most recent annual and quarterly reports, which detail the loan portfolio composition (industries, loan sizes, borrower types). Watch the non-accrual rate (the percentage of loans that are past due or in trouble) and the provision for loan losses. The [dividend](/dividend/) coverage ratio—whether distributable earnings are sufficient to cover the stated distribution, or whether the distribution is paying out a return of capital—is crucial. If the BDC is returning capital rather than earnings, that is ultimately unsustainable.

The 10-K (SEC CIK 0001487918) details each significant borrower and the loan terms, which helps you understand concentration risk. Track the [leverage ratio](/leverage-ratio-forex/) (debt to equity) and the spreads the company is earning on new loans (if spreads are narrowing because of increased competition, that is a pressure on future returns).
