---
title: "VanEck Merk Gold ETF (OUNZ)"
description: "A physically backed gold exchange-traded fund that holds physical gold bars in vault storage and allows investors to trade shares and redeem physical gold."
keywords:
  - gold ETF
  - physical gold
  - VanEck
...
<table>
<tr><th>Ticker</th><td>OUNZ (NYSE Arca)</td></tr>
<tr><th>Sponsor</th><td>VanEck</td></tr>
<tr><th>Fund type</th><td>Exchange-traded trust</td></tr>
<tr><th>Underlying asset</th><td>Physical gold bars</td></tr>
<tr><th>Annual sponsor fee</th><td>0.25%</td></tr>
<tr><th>Redemption</th><td>Physical gold delivery available</td></tr>
<tr><th>SEC CIK</th><td>0001546652</td></tr>
<tr><th>Established</th><td>2014</td></tr>
</table>
</aside>
...
The trust is structured so that shareholders can request redemption of shares in exchange for physical gold, subject to minimum redemption amounts and availability. This redemption feature is a genuine differentiator in the ETF landscape; most [gold funds](/gold-fund/) offer only cash redemption. The ability to take physical delivery creates an arbitrage mechanism that theoretically prevents the fund from trading significantly above or below the underlying gold value, though in practice the minimum redemption size and logistical costs create a band of acceptable deviation.

## Costs and Efficiency

The fund charges a sponsor fee of 0.25% per annum — a modest rate by ETF standards, though the precise annual costs also include insurance, vault storage, and assay fees for verifying gold purity. Because the fund holds physical bullion rather than equities or derivatives, its expense structure is simpler than more complex commodity vehicles. The low fee and physical backing make OUNZ attractive to investors who view gold primarily as a store of value or a portfolio diversifier rather than as a leveraged bet on commodity prices.

Investors should note that the share price tracks the spot price of gold adjusted for the fund's costs. Gold trades continuously in international markets, so OUNZ share prices will fluctuate in tandem with gold's global price movements. Physical delivery introduces logistical complexity — delivery can take weeks, requires transportation and insurance, and works best for large redemptions where the transaction costs are justified.
...
The fund's annual 10-K filing (SEC CIK 0001546652) discloses the quantity and purity of gold held, the custodians and storage locations, annual fees, and changes in assets. Investors should review the prospectus to understand redemption procedures, minimums, and timelines, as well as any restrictions on delivery. The fund publishes regular fact sheets showing the amount of gold per share and the current fund assets. Gold's historical price is widely tracked; viewing the long-term price chart against OUNZ's share price will show how closely the fund tracks the underlying commodity. As with any fund, comparing OUNZ's fee structure and physical backing model to alternative gold investment vehicles — including futures, miners' stocks, and other gold ETFs — helps frame the choice for the intended use case.
