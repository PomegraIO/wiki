...
description: "Oracle is the enterprise database and cloud-software company behind the systems that power the back offices of most large corporations — a legacy monopoly in data management that is racing to build a cloud infrastructure business."
keywords:
  - database software
  - cloud computing
  - enterprise software
...
<table>
<tr><th>Ticker</th><td>ORCL (NYSE)</td></tr>
<tr><th>Founded</th><td>1977, Redwood City, California</td></tr>
<tr><th>Founders</th><td>Larry Ellison, Bob Miner, Ed Oates</td></tr>
<tr><th>Sector</th><td>Enterprise software / cloud computing</td></tr>
<tr><th>Core product</th><td>Oracle Database</td></tr>
<tr><th>Business model</th><td>Software licenses + cloud services + subscriptions</td></tr>
<tr><th>SEC CIK</th><td>0001341439</td></tr>
</table>
</aside>
...
For most of its history, Oracle made money by selling perpetual licenses to its software — once you paid for the right to use a product, you owned that right. The company charged separately for the right to update and receive support, a contract called maintenance that typically ran 15–20 percent of the license fee per year. That model was spectacularly profitable: once a large customer installed Oracle software, the marginal cost of another customer using the same software was almost zero, yet the company could charge them a full license fee. For decades this was the envy of the software world.

The business model has been slowly shifting toward subscriptions and cloud services. Oracle pushes customers toward "cloud first" offerings where they rent computing power and software on demand rather than buying a permanent license. The company bundles database, applications, and infrastructure into subscription packages, which spreads revenue over many years rather than front-loading it in a single large payment. This transition has been contentious — longtime customers accustomed to predictable license costs now face the prospect of higher bills and mandatory migrations to the cloud. Yet for Oracle, the shift is strategically necessary because cloud-delivered software is harder to leave once installed and generates more durable revenue streams.
...
The bet is that database and business-process workloads remain Oracle's territory and that those workloads are valuable enough to matter. That bet is not obviously wrong, but it is also not proven — Oracle's cloud business remains far smaller than AWS or Azure, and it faces the headwind that the most sophisticated customers are multi-cloud, spreading workloads across providers to avoid lock-in.
...
The company has made several strategic moves to stay central to enterprise software. The acquisition of NetSuite (a cloud ERP platform) and its integration into Oracle's cloud suite aimed to build an end-to-end offering that could compete with SAP and Microsoft. The rollout of Autonomous Database — versions that use machine learning to handle routine tuning and patching — is an attempt to keep Oracle relevant to the cloud era by automating the work that once justified high-touch database administration costs.

The company has also moved into infrastructure and platform services beyond the database, trying to build a fuller cloud offering. Yet this remains a slower-growing business with thin margins compared to legacy software licensing, and the transition is pulling Oracle in two directions at once: maintaining the cash flows from existing on-premises customers while investing heavily to compete in a world where they may not need Oracle at all.

## How to research Oracle as an investment
