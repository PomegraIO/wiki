---
title: "Empire State Realty OP, L.P. (OGCP)"
description: "Empire State Realty Trust is a REIT that owns premier office and retail properties in New York and other major US metro areas, built from the legacy of historical real estate investors."
keywords:
...
However, the business model and market dynamics shifted. The 2017 tax reform (the Tax Cuts and [Jobs Act](/jobs-act/)) weakened the value of real estate as a tax shelter, reducing demand for some trophy assets. More significantly, the 2020 pandemic radically altered office work patterns. Remote work, flex arrangements, and the shift of tech hiring to lower-cost cities all pressured Manhattan office occupancy and rent growth. By 2023–2024, Manhattan's office market was struggling with historic levels of vacancy and slow rent growth in Class B and C buildings.
