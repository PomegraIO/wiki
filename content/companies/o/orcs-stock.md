---
title: "Direxion Daily ORCL Bear 1X ETF (ORCS)"
description: "ORCS is a leveraged inverse ETF that aims to profit from daily declines in Oracle stock by moving in the opposite direction of ORCL prices."
keywords:
  - inverse ETF
  - Oracle
  - daily volatility
...
That one-to-one inverse move is what the 1X means in the name. Direxion also sponsors ORCU, a product that aims to move in the opposite direction but at twice the daily move—a 2X inverse product. ORCS sticks to a simpler 1X bet: straight opposition, no leverage beyond the short position itself.

The fund is rebalanced every trading day. At the close of each day, the fund's manager adjusts the short position so that the fund is set up again to deliver minus one times Oracle's next daily move. This daily reset is crucial to understanding both how the fund works and what can go wrong with it. If Oracle gains 5% over three days, a 1X inverse fund will lose roughly 5% total—the daily resets add up. But if Oracle falls 5% and then gains 5% back, a 1X inverse fund will not be flat; it will have lost a small amount because of the way leverage compounds when prices swing.
...
Anyone considering ORCS should read its prospectus carefully, understand the daily-reset mechanism, and be clear about their time horizon. Inverse funds are powerful but confusing. They work as advertised for hours or days. Beyond that, mathematics works against you.
