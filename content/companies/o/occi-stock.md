...
description: "OFS Credit Company is a business development company specializing in debt and equity investments in middle-market private companies, seeking to generate returns by assessing and funding loans where banks have stepped back."
keywords:
...
Start with OFS's quarterly reports and [annual report](/10-k/) (SEC CIK 0001716951), which disclose the detailed portfolio — the names of each borrower, the amount lent, the interest rate, and the maturity date. Understand the credit quality of the portfolio: what percentage of loans are in "good standing" versus on non-accrual (in trouble) versus already defaulted. Watch the portfolio yield — the average interest rate across all loans — which indicates what OFS is earning and where yields are trending relative to borrowing costs.

Monitor the [debt-to-equity ratio](/debt-to-equity-ratio/), which shows how much leverage OFS is using, and the [interest coverage ratio](/interest-coverage-ratio/), which indicates whether the company's earnings are sufficient to cover interest payments on its borrowings. Pay close attention to the portfolio turnover and new loan originations: is the portfolio stagnant, or is OFS actively deploying capital and refreshing its holdings?
