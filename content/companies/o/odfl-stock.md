...
description: "Old Dominion operates a large, unionized less-than-truckload freight network covering North America, balancing service density with pricing power in a fragmented industry."
keywords:
  - less-than-truckload
...
The model is capital-intensive — you need trucks, trailers, terminals, and handling equipment — and operationally complex. Every shipment has an origin, intermediate handling points, and a destination; every mile costs fuel, labor, and maintenance. Revenue per shipment is modest, so margins depend on efficiency: fill the trucks full, route them intelligently, minimize empty backhauls, keep drivers busy and satisfied, and manage the labor force disciplined. A percentage-point drop in [labor productivity](/labor-productivity/) or a spike in diesel fuel can ripple directly to profit.
