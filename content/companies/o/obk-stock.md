---
title: "Origin Bancorp, Inc. (OBK)"
description: "Louisiana-based bank holding company operating retail and commercial banking franchises across Louisiana and Mississippi, with deposit-heavy model and relationships-driven lending."
keywords:
  - regional bank
  - louisiana banking
  - mississippi bank
...
Origin Bancorp is a mid-sized, Louisiana-based bank holding company that operates a network of community banks across Louisiana and Mississippi. The company sits at the intersection of retail deposit gathering and relationship-based commercial lending, a positioning that has proven resilient through economic cycles yet leaves it exposed to rate compression and competitive pressures from larger institutions.

## The Business Today

Origin controls approximately $16 billion in assets through its principal subsidiary, Origin Bank. The company operates roughly 80 banking offices across Louisiana and Mississippi, concentrated in population centers like Baton Rouge and surrounding markets where it has built long-standing relationships with both consumer and small-to-mid-market commercial customers. This is fundamentally a deposit-gathering and lending engine: the bank's revenue comes primarily from net interest income (the spread between loan rates and deposit costs) plus modest fee income from deposit products and lending services.

The retail side of Origin's book consists of conventional mortgages, consumer installment loans, and deposit accounts from individuals and small families. On the commercial side, the bank targets owner-operated businesses, agricultural producers, and light manufacturing—customers for whom a local branch and decision-maker matter. This relationship-oriented positioning is central to Origin's franchise: its survival depends not on trading prowess or advanced fintech but on maintaining sticky customer relationships and credit discipline.
...
|-----------|-----------------|
| **Asset Base** | ~$16 billion in total assets; balance sheet reflects typical community bank composition. |
| **Deposits** | Primary funding source; 80%+ loan-to-deposit ratio; subject to competition on rate and convenience. |
| **Loan Portfolio** | Diversified across commercial real estate, agricultural, consumer, and residential mortgage; concentrated in Louisiana and Mississippi. |
| **Net Interest Margin (NIM)** | Typically 3.5–4.2% depending on rate environment; compressed when Fed cuts rates or curves flatten. |
| **Efficiency Ratio** | Usually 55–65%; reflects branch network and salaries; improves modestly with scale or technology adoption. |
| **Return on Assets (ROA)** | Historically 0.8–1.2% in normal conditions; falls sharply if credit quality deteriorates or rates decline steeply. |
| **Capital Ratios** | Well above regulatory minimums; typical Tier 1 ratio 11–13% allows for modest dividend and buybacks. |
...
Start with the [10-K](/wiki/10-k/) filing, which lays out loan portfolio composition, deposit sources, and interest rate sensitivity. Pay attention to the quarterly net interest margin and any discussion of funding pressures.

The Allowance for Credit Losses (ACL) and nonaccrual loan rates tell you how management assesses credit risk. Look for trends: if the allowance is rising despite stable credit metrics, management is bracing for deterioration.

Compare deposit growth to peers and note pricing pressure—widening rate spreads on deposit accounts signal competitive strain. Monitor loan growth rates relative to regional GDP: if the bank is outpacing regional growth significantly, it may be taking incremental risk to drive volume.
