---
title: "Transcontinental Realty Investors (TCI)"
description: "A publicly traded real estate company owning residential and commercial properties, controlled by the American Realty Investors group."
keywords:
  - real estate
...
The ostensible benefit is access to the property income stream without being on the deed. TCI collects rents, pays operating costs, and distributes some portion to shareholders as dividends. For a retail investor without capital to buy real estate directly—or who values liquidity—buying TCI shares offers exposure to [residential](/wiki/residential-real-estate/) and [commercial property](/wiki/commercial-real-estate/) income. 

The downside is transparency and optionality. The controlling shareholders set policy unilaterally. If they decide to retain cash, hold off selling profitable properties, or pursue a [merger](/merger/), public shareholders follow along without a meaningful vote. This is not unique to TCI, but it is pronounced in companies with thin [float](/wiki/stock-float/) and family control.

## Is TCI a [REIT](/wiki/real-estate-investment-trust/)?

No. It is a [real estate](/wiki/residential-reit/) operating company taxed as a C corporation. That tax structure allows the parent—and by extension, the controlling shareholders—more flexibility in keeping capital inside the firm rather than mandating payouts. For public shareholders, it means less reliable [dividend yield](/dividend-yield/) and more reinvestment of profits at the discretion of management.

## What risks come with this structure?

**Thin float.** Transcontinental has a small [public float](/float/)—few shares held by the investing public relative to the controlling stake. Thin floats create liquidity challenges: a shareholder wanting to exit a meaningful position may face wide [bid-ask spreads](/wiki/bid-ask-spread/) and limited buyers, making it hard to sell without moving the price substantially. This is less of a concern for someone buying a handful of shares, but it reflects the reality that the public [stock market](/stock-market/) isn't necessarily an efficient exit for this holding.
