...
description: "Tetra Tech is an engineering and consulting firm focused on water, environment, and infrastructure across the public and private sectors, with a particular strength in water management and environmental remediation."
keywords:
...
Tetra Tech is an engineering and consulting company that designs infrastructure, remediates environmental damage, treats and distributes water, and advises governments and corporations on adapting to climate risks. The company emerged from the intersection of two major trends: the world's growing population requiring more reliable water and sanitation, and the need to clean up decades of industrial contamination and manage climate-driven water stress. Unlike the megacap engineering firms that work on everything from oil refineries to shopping malls, Tetra Tech has doubled down on water, environment, and resilience—a strategic focus that has proven prescient as governments and utilities pour capital into water security and environmental protection.

## From startup to water-sector specialist
...
## The current business: segments and revenue streams

Tetra Tech's business can be understood in several overlapping segments. Government services represents roughly 40% of revenue: the U.S. Environmental Protection Agency, the Army Corps of Engineers, the Department of Defense, state environmental agencies, and other public-sector clients contract with Tetra Tech for environmental assessments, water-system design, remediation, and climate-adaptation planning. These are long-term, recurring relationships; the firm has been advising the EPA for decades.

Water and environment represents another substantial portion: designing and building water-treatment plants, water-distribution systems, and wastewater infrastructure. This work is both consulting (designing systems, leading studies) and, increasingly, through subsidiaries and joint ventures, construction management and operations. The company also advises water utilities on conservation, asset management, and climate adaptation.

International development is a growing segment. The World Bank, Asian Development Bank, and bilateral development agencies contract Tetra Tech to design and implement water, sanitation, and environmental projects in Africa, South Asia, and elsewhere. These projects are often bundled: engineering design, environmental and social assessments, procurement support, and construction supervision.

Private-sector clients—mining companies, oil and gas operators, utilities, and corporations facing environmental liabilities or sustainability obligations—represent a meaningful and growing part of revenue. Companies hire Tetra Tech to assess contaminated sites, design remediation, manage ongoing operations, or advise on climate risks to their infrastructure and supply chains.
...
Start with the 10-K filing (SEC CIK 0000831641) to understand the revenue mix by segment and geography, the profit margins by business line, and the contract backlog. The backlog is crucial: it shows how much revenue is already committed or likely to be awarded, which reduces uncertainty and supports forward planning.
