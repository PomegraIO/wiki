---
title: "21Shares Polkadot ETF (TDOT)"
description: "An exchange-traded fund that tracks the price of Polkadot, a blockchain protocol designed to link independent cryptocurrency networks into a single unified system."
keywords:
...
21Shares is a cryptocurrency asset manager owned by Amun AG, a Swiss firm that has assembled one of the largest families of crypto ETPs (exchange-traded products). TDOT is typically structured as an exchange-traded note, or ETN—a form of debt security that mimics the behaviour of an ETF but carries additional [counterparty risk](/counterparty-risk/) because it is an unsecured obligation of the issuer rather than a direct claim on underlying assets held in custody.

The fund trades on public [stock exchanges](/stock-exchange/) (chiefly the [Nasdaq](/nasdaq/) in the United States), and shares can be bought and sold during normal market hours like any other security. This structure avoids the friction and custody complexity of buying cryptocurrency directly from an exchange, and it is compatible with regular brokerage accounts and retirement accounts that do not permit direct crypto holdings.

## What does it cost?

ETNs tracking single cryptocurrencies typically charge annual [expense ratios](/expense-ratio/) in the range of 0.20% to 0.50%, and TDOT falls within that range. For an investor committed to holding Polkadot for a long period, this annual cost is material but modest. Investors should verify the current expense ratio with their [broker](/broker/), as these figures can change.

The fund's liquidity varies with trading volume. On active days, [bid-ask spreads](/bid-ask-spread/) are tight; during quieter periods, they widen. Like any single-token fund, TDOT is relatively concentrated and illiquid compared to a broad cryptocurrency [index fund](/index-fund/) or a traditional equity index fund.

## What are the real risks?

Because TDOT owns only Polkadot and not a diversified basket of cryptocurrencies, its value is entirely dependent on the fate of that single network. Polkadot competes with other protocols aimed at interoperability, and the network's adoption and utility are unproven relative to more established blockchains like [Bitcoin](/bitcoin/) and [Ethereum](/ethereum/). If Polkadot loses favour in the market or faces technical setbacks, the token's price could fall sharply, and there is no [diversification](/diversification/) to cushion that decline.

Cryptocurrency markets are also notoriously volatile. Price swings of 20% or more within a few weeks are not unusual, and investors should expect TDOT to be far more volatile than a typical [equity ETF](/equity-etf/). Additionally, ETNs carry [credit risk](/credit-risk/)—if the issuer faces financial distress, the value of the note can be impaired even if the underlying asset holds its price.
