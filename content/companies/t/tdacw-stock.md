---
title: "Translational Development Acquisition Corp. (TDACW)"
description: "The public warrant component of Translational Development Acquisition Corp., exercisable into shares at a fixed strike price upon or after the close of a SPAC merger. Issued as part of the unit offering."
keywords:
  - SPAC warrant
  - warrant exercise
  - leverage instrument
...
<table>
<tr><th>Ticker</th><td>TDACW (NASDAQ)</td></tr>
<tr><th>Underlying</th><td>Translational Development Acquisition Corp.</td></tr>
<tr><th>Instrument type</th><td>Warrant (call option)</td></tr>
<tr><th>Issued as part of</th><td>Unit (common share + warrant)</td></tr>
<tr><th>Exercise mechanics</th><td>Cash or cashless at holder's option</td></tr>
<tr><th>Expiration</th><td>Typically 5 years from merger close</td></tr>
...
A warrant is an instrument that grants the holder the right (but not the obligation) to purchase a share of stock at a predetermined price, called the strike price, at any time up to and including an [expiration date](/expiration-date/). In the SPAC context, warrants are issued as sweetener to attract IPO investors: a SPAC unit bundled one share of common stock with one [warrant, offering](/warrant-offering/) the buyer participation in an eventual [merger](/merger/) at a fixed entry point plus the chance to profit if the merged company's shares rise above the strike.
