---
title: "GraniteShares YieldBOOST TSLA ETF (TSYY)"
description: "A single-stock ETF that holds Tesla shares and generates yield through a covered-call strategy, aiming to enhance returns in a range-bound market while capping upside."
keywords:
  - options strategies
  - covered call
  - single-stock ETF
...
TSYY is a straightforward financial instrument: it holds [Tesla](/tsla-stock/) stock and sells [call options](/call-option/) against those holdings to generate income. The resulting distributions come from Tesla [dividends](/dividend/) (historically minimal) plus the [option premiums](/option-premium/) GraniteShares collects. Like all covered-call funds, TSYY profits in sideways or gently rising markets but forgoes gains when Tesla surges sharply higher. It appeals to income-focused investors willing to trade unlimited upside for enhanced yield.

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>TSYY (NYSE Arca)</td></tr>
<tr><th>Fund sponsor</th><td>GraniteShares</td></tr>
<tr><th>What it holds</th><td>Tesla Inc. stock (single-stock ETF)</td></tr>
<tr><th>Strategy</th><td>Covered call options overlay, monthly</td></tr>
<tr><th>Objective</th><td>Income enhancement on Tesla holding</td></tr>
<tr><th>Distribution frequency</th><td>Monthly</td></tr>
<tr><th>Who it suits</th><td>Income-focused Tesla holders with limited upside expectations</td></tr>
</table>
</aside>
