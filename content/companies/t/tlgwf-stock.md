---
title: "TLGY Acquisition Corp (TLGWF)"
description: "TLGY Acquisition Corp is a blank-check company formed to identify and acquire an operating business, holding assets and seeking a merger partner."
keywords:
  - blank-check company
  - SPAC
  - acquisition vehicle
...
TLGY [Acquisition](/acquisition/) Corp is a [special-purpose acquisition company](/special-purpose-acquisition-company/) (SPAC), also known as a blank-check company. It was formed for the explicit purpose of identifying and acquiring an operating business, at which point it would combine with that target, retire its SPAC status, and become whatever the acquired business is. Until that [merger](/merger/) happens, TLGY holds capital that shareholders contributed, along with the cash raised from a public offering, and pursues potential acquisition targets.

The economic model of a SPAC is straightforward but constrained. Shareholders and the sponsor (the founders and promoters who initiated the SPAC) commit capital to buy a business. The SPAC must complete a [business combination](/business-combination-purchase/) within a specified window (typically two to three years from inception) or liquidate and return capital to investors. If a merger is announced and closes, shareholders in the original SPAC become shareholders in the newly merged company. If no deal happens before the deadline, investors get their money back plus any interest earned on the trust account.
...
Investors who bought the original shares get [redemption rights](/redemption-rights-equity/): if they dislike the announced merger, they can redeem their shares for cash at [net asset value](/net-asset-value/), typically staying very close to the original purchase price. This is a crucial feature because it means early shareholders have a safety valve if a bad deal is announced — they can exit near their [cost basis](/cost-basis/). The sponsor, however, typically gives up their shares as collateral if too many shareholders redeem, so they are incentivized to propose deals that convince shareholders to stay invested.

## The SPAC landscape

TLGY is one of thousands of SPACs that have been formed in recent years. The structure became a popular alternative to traditional [initial public offerings](/initial-public-offering/) (IPOs) for companies seeking to go public, because a SPAC merger can be faster and more predictable than an IPO roadshow. However, SPAC performance has been mixed: while some have acquired successful operating companies that went on to strong public market returns, others have completed mergers with businesses that subsequently struggled or failed.
