---
title: "Tutor Perini Corp (TPC)"
description: "A diversified construction and engineering services company that builds major infrastructure, civils, and building projects across North America, managing complex project delivery from bid to completion."
keywords:
  - construction
  - engineering
  - infrastructure
...
Tutor Perini's profitability depends almost entirely on the accuracy of its bids and its execution discipline. When the company bids on a job, it estimates the cost to complete (materials, labor, equipment, subcontractor fees, [overhead allocation](/overhead-allocation/)) and adds a markup for profit. If actual costs come in below the bid, the project is profitable. If costs exceed the bid — because of labor shortages, material [inflation](/inflation/), site conditions that prove harder than expected, or misestimation — the project is unprofitable or barely breaks even.
...
That debt load creates financial risk: if a major project becomes unprofitable, losses consume cash and equity. If multiple projects are troubled at once, the company can face a [liquidity crisis](/liquidity-crisis/). Management's track record in managing working capital and maintaining discipline on job profitability is central to the assessment of financial stability.
