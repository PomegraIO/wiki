---
title: "TTM Technologies Inc. (TTMI)"
description: "TTM Technologies manufactures printed circuit boards and radio-frequency components, serving semiconductor, telecommunications, and aerospace customers worldwide."
keywords:
...
There is also a long-term question about whether advanced electronics manufacturing will remain a viable standalone business. Many of TTM's customers are integrating more of the supply chain internally — [Apple](/aapl-stock/), Samsung, and other device makers increasingly design their own components rather than outsourcing. In aerospace and defence, primes like [Boeing](/ba-stock/) and Lockheed increasingly control more of their supply chains. This does not eliminate the market for specialist manufacturers like TTM, but it does mean the addressable market may be shrinking at the high end, even as new applications (electric vehicles, renewable-energy systems, 5G infrastructure) create demand.
