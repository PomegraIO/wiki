---
title: "21Shares Active Crypto ETF (TKNS)"
description: "An actively managed cryptocurrency ETF from 21Shares allocating across Bitcoin, Ethereum, and other digital assets. The first crypto ETF with professional active management rather than passive indexing."
keywords:
  - crypto ETF
  - active management
  - digital assets
...
<table>
<tr><th>Ticker</th><td>TKNS (NASDAQ)</td></tr>
<tr><th>Sponsor</th><td>21Shares AG</td></tr>
<tr><th>Fund type</th><td>Actively managed cryptocurrency ETF</td></tr>
<tr><th>Launch date</th><td>May 2026</td></tr>
<tr><th>Asset allocation</th><td>80% minimum in digital assets</td></tr>
<tr><th>Core holdings</th><td>Bitcoin, Ethereum, diversified altcoins</td></tr>
<tr><th>Expense ratio</th><td>1.05% (reflects active management and custody)</td></tr>
</table>
</aside>
...
TKNS's managers conduct ongoing research on crypto market valuations, on-chain metrics, regulatory developments, and macroeconomic trends. They then adjust the portfolio's allocation across Bitcoin, Ethereum, and smaller altcoins based on their assessment of which assets offer the best risk-return profile at any given time. The premise is that crypto markets are inefficient enough that skilled managers can identify pockets of value and avoid sharp downturns by reducing exposure preemptively.

This flexibility contrasts sharply with passive spot ETFs, which are locked into their mandates. A Bitcoin spot fund holds Bitcoin, period; if Bitcoin drops 40 percent, it falls too. TKNS's managers could reduce Bitcoin exposure if they believe a downturn is likely, or increase it if they see upside. If their calls prove right, the fund outperforms passive alternatives; if they prove wrong, TKNS underperforms.

## Structure and access

TKNS trades on the NASDAQ like any other ETF—shares are bought and sold during regular market hours at market prices. There is no minimum investment, no lockup period, and the tax reporting follows standard ETF treatment. This eliminates a historical friction point: investors who wanted crypto exposure but preferred the simplicity and custody convenience of a standard ETF rather than opening an account on a specialized crypto exchange or managing a private digital wallet now have a conventional vehicle.

The fund relies on 21Shares' custody and trading infrastructure, built over nine years of operating crypto indices. This backend is secure but not transparent to the retail investor; you trust 21Shares' operational competence when you own TKNS.
