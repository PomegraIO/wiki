...
description: "Tyler Technologies is the leading software vendor serving local and state governments across North America, providing enterprise systems for courts, budgeting, permitting, property assessment, and other core municipal functions."
keywords:
  - government software
  - enterprise systems
...
The competitive moat is deep but not infinite. A startup with superior technology and a focused product could, in theory, enter a particular niche and win with a better, more modern solution. More likely, a larger competitor like [Salesforce](/crm-stock/) or [Microsoft](/msft-stock/) could decide to target local government and leverage their broader platform. So far, neither has happened with enough force to unseat Tyler in its core markets, but the risk is real. Tyler's software is not as modern as some newer competitors' software; some of it was built decades ago and shows its age. The company is investing in modernizing its architecture and moving toward the cloud, but these transitions take time and capital.
