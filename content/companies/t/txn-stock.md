...
description: "Texas Instruments makes semiconductor chips and analog components used in everything from smartphones to cars to power systems. A global equipment supplier with decades of market dominance."
keywords:
  - semiconductors
  - analog chips
  - microcontrollers
...
Texas Instruments is a semiconductor company that makes the chips and components inside virtually every electronic device you use. The company is based in Dallas, and its shares trade on [NASDAQ](/nasdaq/) under the ticker TXN. Unlike the flashy chip makers you might have heard of, TI (as it's often called) is invisible — but it is everywhere. Your phone has TI chips. Your car has TI chips. Power supplies, televisions, industrial equipment, medical devices — they all probably have Texas Instruments components inside. The company makes two main kinds of semiconductor products: analog chips and embedded processors. Both kinds are crucial to how modern electronics work.

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>TXN (NASDAQ)</td></tr>
<tr><th>Founded</th><td>1930 (as Geophysical Service Inc.), renamed Texas Instruments in 1951</td></tr>
<tr><th>Headquarters</th><td>Dallas, Texas, United States</td></tr>
<tr><th>Sector</th><td>Semiconductors / Electronics</td></tr>
<tr><th>Main products</th><td>Analog chips, embedded processors, microcontrollers</td></tr>
<tr><th>Key markets</th><td>Mobile, automotive, industrial, consumer electronics</td></tr>
<tr><th>SEC CIK</th><td>0000097476</td></tr>
</table>
</aside>

## What Texas Instruments actually does

Think of TI as a component supplier. Engineers at big device makers — [Apple](/aapl-stock/), Samsung, [Tesla](/tsla-stock/), Siemens, whoever — need certain chips to do specific jobs in their products. A smartphone needs a power-management chip that regulates voltage to different parts of the circuit. A car needs dozens of controllers for the engine, transmission, and safety systems. An industrial machine needs analog chips that process sensor data from temperature, pressure, or vibration monitors. TI makes chips for all of these jobs.
