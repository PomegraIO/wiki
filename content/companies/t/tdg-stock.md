---
title: "TransDigm Group (TDG)"
description: "Designer and producer of engineered aerospace components with heavy aftermarket exposure and high margins, known for acquisition-driven growth and financial leverage."
keywords:
  - aerospace parts
...
- **Ticker:** TDG
- **Exchange:** NYSE
- **Sector:** Aerospace & Defense; Parts & Components
- **Founded:** 1987
- **Headquarters:** Cleveland, Ohio
- **Core Business:** Aerospace components, controls, and specialized fasteners
- **SEC CIK:** 1260221
...
This leverage on acquired companies—extracting cost and margin simultaneously—has been extraordinarily effective. It is a private-equity-style play embedded in a public company. The leverage itself became financial as well; the company has financed [acquisitions](/acquisition/) heavily with debt, a fact that became increasingly visible during market downturns (as it did during the COVID-19 pandemic when commercial aviation contracted sharply) and a structural feature of the capital structure.
...
TransDigm's financials reflect the operational and financial leverage embedded in its model. Gross margins on sole-source aftermarket parts regularly exceed 70%; even OE margins run 30-50%. [Operating margins](/operating-margin/) are high (often 25%+ [EBITDA](/ebitda/) multiples), and the company has historically returned substantial cash to shareholders via [dividends](/dividend/) and buybacks. However, debt is a material feature of the [balance sheet](/balance-sheet/). The company has financed acquisitions with leverage that is neither light nor extreme by industrial standards, but it does create sensitivity to operational downturns and [refinancing risk](/refinancing-risk/).
