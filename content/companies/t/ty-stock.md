---
title: "Tri-Continental Corporation (TY)"
description: "One of America's oldest closed-end equity investment funds, founded in 1929 and managed by Columbia Threadneedle. TY trades at a premium or discount to NAV."
keywords:
  - closed-end fund
  - equity investment
  - discount to nav
...
Tri-Continental Corporation is a [closed-end fund](/wiki/closed-end-fund/) that invests primarily in stocks of U.S. and foreign companies. Founded in 1929, it ranks among the oldest continuously operating equity investment funds in America. The fund is managed by Columbia Threadneedle Investments, a subsidiary of Hellman & Friedman. Common shares trade on the [New York Stock Exchange](/new-york-stock-exchange/) under the ticker TY, giving it the liquidity and accessibility of a public stock even though its underlying holdings are a diversified portfolio of equities.

## How does the closed-end structure differ from open-end funds?

Unlike open-end [mutual funds](/mutual-fund/), which issue and redeem shares daily at [net asset value](/wiki/net-asset-value/), Tri-Continental has a fixed number of shares outstanding. Investors buy and sell existing shares on the [stock exchange](/stock-exchange/) rather than buying new shares directly from the fund or redeeming them back to the fund. This structure has two important practical consequences: the fund trades continuously throughout the trading day (like a stock), and its share price can diverge from the underlying [net asset value](/wiki/net-asset-value/) of its holdings—trading at a premium or discount depending on supply and demand for shares.
