---
title: "TDG Gold Corp. (TDGGF)"
description: "TDG Gold is an exploration and development-stage precious metals company focused on identifying and advancing gold properties toward production in select jurisdictions."
keywords:
  - gold exploration
...
TDG Gold Corp. is a mineral exploration and development company working to discover and advance gold deposits toward production. The company operates as a junior miner — a category populated by hundreds of exploration firms that spend years and millions of dollars hunting for deposits before a single ounce of ore is ever extracted. The business model is straightforward in concept but precarious in execution: identify prospective land, stake claims, conduct geological and geochemical surveys, drill to confirm the presence and scale of mineralization, and, if successful, advance a project toward a mine. If the deposit proves too small, too low-grade, or too costly to develop, the project is abandoned and the capital is lost.

The exploration stage is long and uncertain. A junior gold explorer might drill hundreds of holes over years across multiple properties before identifying a single deposit worthy of further investment. Many exploration companies never advance to a major discovery. Those that do face a second gauntlet: the transition from exploration through feasibility studies toward actual mine development and operation — stages that demand tens or hundreds of millions of additional capital and carry their own technical, financial, and permitting risks.
...
Exploration companies are inherently capital-intensive and pre-revenue. Until and unless a deposit is developed into a producing mine, the company generates no revenue and must burn through cash to fund exploration work. This places exploration companies in a perpetual search for capital. A significant drop in equity prices, a tightening of credit markets, or a prolonged collapse in gold prices can starve an exploration company of funding and force it to cut programs or abandon properties.

The burn rate — the annual cash spent on exploration — determines how long a company can operate before needing fresh capital. A junior explorer spending $5–10 million annually can run for only a few years on a single financing round. This creates pressure to demonstrate discovery success on a regular schedule, to attract the next round of investors.
