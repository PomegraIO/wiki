---
title: "Tavia Acquisition Corp. (TAVIR)"
description: "TAVIR represents the rights component of Tavia Acquisition Corp., a SPAC. Rights entitle holders to receive fractional shares upon successful business combination."
keywords:
  - SPAC rights
  - warrant equivalent
  - dilution
...
<table>
<tr><th>Ticker</th><td>TAVIR — NASDAQ (rights only)</td></tr>
<tr><th>What it is</th><td>Right to receive 0.1 ordinary shares per right upon business combination</td></tr>
<tr><th>Issued</th><td>December 2024</td></tr>
<tr><th>IPO size</th><td>11.5 million units, each with one right</td></tr>
<tr><th>Conversion ratio</th><td>1 right = 0.1 shares of merged entity</td></tr>
<tr><th>Exercise</th><td>Automatic upon merger; no action required from holder</td></tr>
<tr><th>Related instrument</th><td>TAVIU (unit), TAVI (share), BNZIW (warrant, similar but different company)</td></tr>
</table>
</aside>
...
The purpose of the right structure is to give Tavia extra capital to deploy in the merger. The IPO raises capital on the assumption that part of it will support the merged company's operations. By bundling a right with each share, Tavia effectively issues additional equity that becomes active only after the merger completes. This increases the total share count of the combined company but gives management more capital to work with and gives public investors a way to increase their position at the IPO price.
...
## Risks and assumptions embedded in the rights
...
## Comparing rights to other SPAC instruments

Rights are one of several ways a SPAC can raise capital and align incentives. Warrants (a similar but distinct instrument, seen in companies like Banzai International's BNZIW ticker) give the holder the right to buy shares at a fixed price at any future date — a more traditional option structure. Rights are different: they are automatically exercised and do not require the holder to pay an additional purchase price. Understanding which instrument a particular SPAC issued is important to evaluating the capital structure and the dilution that will occur if the merger closes.
