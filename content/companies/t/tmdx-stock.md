...
description: "TransMedics makes organ-transport systems that keep transplant organs alive outside the body, using controlled perfusion instead of cold storage — a critical piece of infrastructure in the transplant supply chain."
keywords:
  - organ transplant
  - medical devices
  - cardiac surgery
...
<table>
<tr><th>Ticker</th><td>TMDX (NASDAQ)</td></tr>
<tr><th>Founded</th><td>1998, Andover, Massachusetts</td></tr>
<tr><th>Sector</th><td>Medical devices; organ transplantation</td></tr>
<tr><th>Core product</th><td>Organ Care System (portable organ perfusion)</td></tr>
<tr><th>Business model</th><td>Device sales plus recurring service contracts</td></tr>
<tr><th>SEC CIK</th><td>0001756262</td></tr>
</table>
</aside>

## The supply crisis that shaped the business

The transplant industry faces a stark equation: far more patients need organs than donors provide. In the United States, over 90,000 people are on the waiting list for a kidney, heart, or liver. Thousands die every year before a match arrives. For those who do receive an organ, time is everything. The moment a heart stops beating in the donor, the clock starts. Doctors have roughly four to six hours to transplant it, or the tissue damage becomes irreversible. That window shrinks even further for livers — maybe eight to twelve hours with [cold storage](/cold-storage-crypto/). Geography adds another layer of cruelty: a perfect match might be in another state, unreachable in time.
