---
title: "Target Hospitality Corp. (TH)"
description: "Operator of modular accommodations and hospitality services for oil and gas workers, military, and disaster relief clients in the United States."
keywords:
  - modular housing
...
The company's footprint extends beyond energy. Government agencies, particularly the U.S. military, use modular accommodations for overseas bases, stateside camps, and training grounds. Natural disaster scenarios—hurricanes, wildfires, floods—create sudden demand for rapid-deployment housing, and Target can position units to serve recovery and rebuilding efforts. This [diversification](/diversification/) across energy, defense, and disaster relief means no single sector dominates the revenue base entirely, though oil and gas has historically represented the largest share.
