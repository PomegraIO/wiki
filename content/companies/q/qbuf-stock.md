---
title: "Innovator Nasdaq-100 10 Buffer ETF Quarterly (QBUF)"
description: "QBUF is a structured equity ETF that holds the Nasdaq-100 index with a quarterly-reset buffer strategy protecting against losses up to 10 per cent per quarter — designed for income-conscious investors who accept reduced upside for peace of mind against tail risk."
keywords:
  - buffer ETF
  - quarterly reset
  - Nasdaq-100
...
The [expense ratio](/expense-ratio/) includes not only the fund's operational costs but also the cost of the options hedges themselves. In periods of low volatility, that hedge cost is modest and may represent good value. In periods of high volatility — when [protective puts](/protective-put/) are expensive — the hedge cost rises, and future buffers may narrow slightly. An investor should expect the buffer terms to vary somewhat over time as option pricing shifts.
