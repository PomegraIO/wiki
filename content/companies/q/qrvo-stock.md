...
description: "Qorvo designs and manufactures radio frequency semiconductors for mobile phones, wireless infrastructure, and defense systems — a specialist chip company serving the communications ecosystem."
keywords:
  - RF semiconductors
...
Qorvo was formed in 2015 through the [merger](/merger/) of RFMD (RF Micro Devices) and TriQuint Semiconductor — two long-established RF chip companies that decided their markets had consolidated enough that combining was strategically necessary to survive. The merger created the largest independent RF semiconductor company in the world. Post-merger integration was complicated, but the combined entity inherited engineering talent and customer relationships from both predecessors, giving it a broad portfolio spanning power amplifiers, filters, switches, and integrated modules.
