---
title: "Quince Therapeutics (QNCX)"
description: "Clinical-stage biotech developing gene therapy and small-molecule treatments for ataxia-telangiectasia and other rare genetic diseases."
keywords:
...
| Program | Target Indication | Stage | Modality |
|---------|-------------------|-------|----------|
| Lead Program | Ataxia-Telangiectasia (A-T) | Clinical/IND Phase | Gene Therapy or Small-Molecule |
| Secondary Programs | Other Rare Genetic Diseases | Preclinical/Early | Small-Molecule or Gene Therapy |
...
The relevant SEC filing to monitor is the [10-K](/wiki/10-k/) once the company goes public, which will provide detailed financial status, pipeline description, and risk factors. Until then, press releases and clinical trial registries (ClinicalTrials.gov) are the primary public windows into progress.
