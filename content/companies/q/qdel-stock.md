...
Key performance metrics to track: reagent volume per installed analyzer (tests per instrument per day), gross margin by segment, and free [cash flow conversion](/cash-flow-conversion/). Diagnostics companies often trade on cash generation and [dividend](/dividend/) capacity. QuidelOrtho also matters to investors interested in consolidation in healthcare services—whether it remains independent, partners, or becomes an acquisition [target](/tgt-stock/).
