---
title: "QuidelOrtho (QDEL)"
description: "In vitro diagnostics company formed by Quidel's acquisition of Ortho Clinical Diagnostics, spanning point-of-care rapid tests, lab immunoassay, clinical chemistry, transfusion medicine, and molecular diagnostics."
keywords:
  - quidel
...
- **What it makes:** In vitro diagnostic tests and systems across point-of-care, laboratory immunoassay, clinical chemistry, blood transfusion typing, and molecular analysis
- **Founded:** 1979 (Quidel); merged with Ortho Clinical Diagnostics in 2024
...
**Molecular diagnostics** testing, expanded by [acquisitions](/acquisition/) and organic development, includes nucleic acid testing for infectious disease and genetic markers—an increasingly important category as molecular methods penetrate deeper into routine testing.
...
The diagnostics industry faces persistent headwinds. Hospital laboratory volumes track with patient admission patterns and testing intensity, making the business cyclical and vulnerable to [recession](/recession/) or healthcare consolidation. Routine testing volumes compressed during COVID and have not fully recovered in some categories.
...
Key performance metrics to track: reagent volume per installed analyzer (tests per instrument per day), gross margin by segment, and free [cash flow conversion](/cash-flow-conversion/). Diagnostics companies often trade on cash generation and [dividend](/dividend/) capacity. QuidelOrtho also matters to investors interested in consolidation in [healthcare services](/hcsg-stock/)—whether it remains independent, partners, or becomes an acquisition target.
