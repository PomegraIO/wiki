---
title: "QT IMAGING HOLDINGS, INC. (QTI)"
description: "A medical device company developing 3D breast imaging systems using ultrasound tomography, publicly traded on NASDAQ as of January 2026."
keywords:
  - medical imaging
...
The 2026 public offering raised approximately $10 million in gross proceeds and followed the company's January 2026 uplisting from the OTCQB Venture Market to the [NASDAQ](/nasdaq/) Capital Market under the ticker QTI—a significant validation event for a medical device company still in early commercial deployment. The uplisting reflects increasing institutional interest and tighter liquidity, allowing the company to access broader investor bases and capital markets. Cash on hand at year-end 2025 stood at $10.5 million, up substantially from $1.2 million a year prior, bolstering the [balance sheet](/balance-sheet/) for continued manufacturing and market expansion.
