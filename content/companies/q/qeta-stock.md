---
title: "Quetta Acquisition Corp (QETA)"
description: "A blank-check company formed to acquire and merge with an operating business — a special-purpose acquisition vehicle seeking to identify and combine with a private company to take it public."
keywords:
  - SPAC
  - blank-check company
  - acquisition
...
The warrants are a separate piece: they give holders the right to buy shares at a [strike price](/strike-price/), usually $11.50. If the merged company's stock trades well above that level, warrants become valuable. If it trades below, warrants expire worthless. Warrant holders face asymmetric risk — they can lose everything but cannot profit beyond the strike minus the cost paid.
