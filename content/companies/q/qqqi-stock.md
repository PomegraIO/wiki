---
title: "NEOS Nasdaq 100 High Income ETF (QQQI)"
description: "QQQI is an exchange-traded fund based on the Nasdaq 100 that prioritizes yield by selling options and tilting toward dividend-paying stocks within the index."
keywords:
  - ETF
  - Nasdaq 100
  - income strategy
...
The NEOS [Nasdaq](/nasdaq/) 100 High [Income ETF](/income-etf/) (ticker QQQI) emerged as a response to investor demand for income strategies built on the Nasdaq 100's growth foundation. Created as a sibling to NEOS's covered-call funds, QQQI marries long exposure to the Nasdaq 100 with both [dividend yield](/dividend-yield/) tilting and systematic [call option](/call-option/) sales to generate above-market income.

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>QQQI (NYSE Arca)</td></tr>
<tr><th>Sponsor</th><td>NEOS (previously known as WisdomTree in some vintage offerings)</td></tr>
<tr><th>Underlying index</th><td>Nasdaq 100</td></tr>
<tr><th>Fund type</th><td>Equity ETF with yield enhancement</td></tr>
<tr><th>Primary strategies</th><td>Covered calls + dividend tilt</td></tr>
<tr><th>Target distribution</th><td>Monthly (approximately 10-12% targeted yield range, market-dependent)</td></tr>
<tr><th>Structure</th><td>Standard ETF with active option overlay</td></tr>
</table>
</aside>

## The origins: filling a gap in growth-stock income

The Nasdaq 100 has historically been viewed as a growth-focused index that pays low [dividends](/dividend/). Many of the largest technology companies in the index — [Apple](/aapl-stock/), [Microsoft](/msft-stock/), Meta, [Nvidia](/nvda-stock/) — either pay no dividends or pay modestly relative to their [market cap](/market-capitalization/). This posed a challenge for income-focused investors: the best growth prospects lived in an asset class that generated little cash return.
...
The combination targets a distribution yield in the double-digit percentage range — roughly 10 to 12 percent annually in normal conditions, though this varies with market volatility and option pricing. This is substantially higher than the Nasdaq 100's dividend yield, and it comes from the [option premium](/option-premium/) component.

## The income-generation mechanics and risks

The distributions are not a free lunch. They come from two sources: the modest dividends paid by the underlying Nasdaq 100 stocks, plus the realized gains from options that expire without being called away. When a call expires worthless, the premium is pocketed and distributed. When the stock price rises above the strike and the call is exercised, the fund sells the stock at the [strike price](/strike-price/), realizing a capped gain.
