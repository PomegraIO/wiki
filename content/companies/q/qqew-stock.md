---
title: "First Trust Nasdaq-100 Select Equal Weight ETF (QQEW)"
description: "An exchange-traded fund holding all 100 Nasdaq stocks, but with each one given equal weight rather than sizing by market value — a way to own tech without mega-cap concentration."
keywords:
  - ETF
  - Nasdaq-100
  - equal weight
...
<div class="wiki-infobox-title">QQEW — the basics</div>

|   |   |
|---|---|
| **What it holds** | Nasdaq-100 stocks, equal-weighted |
| **Number of stocks** | 100 |
| **Weight per stock** | 1 percent each (before rebalancing) |
| **Rebalancing** | Quarterly |
| **Sponsor** | First Trust |
| **Expense ratio** | Low-to-moderate; typically 0.20–0.35% |
| **Trading** | NASDAQ; liquid, tight spreads |
| **Good for** | Investors who want to own tech without mega-cap dominance |
