---
title: "Invesco QQQ Income Advantage ETF (QQA)"
description: "An exchange-traded fund holding the Nasdaq-100 with a systematic covered-call options strategy layered on top, designed to generate regular income distributions in exchange for capped upside."
keywords:
  - ETF
  - Nasdaq-100
  - covered call
...
<div class="wiki-infobox-title">QQA — strategic components</div>

|   |   |
|---|---|
| **Core holdings** | Nasdaq-100 stocks, market-cap weighted |
| **Options overlay** | Systematic covered calls |
| **Call strike** | Predetermined levels, usually slightly out of the money |
| **Rebalancing** | Monthly call rolls; quarterly stock rebalancing |
| **Distribution** | Monthly income, funded by option premiums |
| **Expense ratio** | Low-to-moderate; typically 0.50–0.75% |
| **Suitable for** | Income-focused investors, neutral-to-cautious on tech growth |
| **Tax treatment** | Distributions taxed as ordinary income |

</aside>

## The Nasdaq-100 foundation

At its base, QQA holds the same 100 stocks in the same weights as a standard Nasdaq-100 index fund. The portfolio is dominated by its largest constituents — a handful of mega-cap technology companies make up roughly 40 percent of the fund by themselves. This Nasdaq-100 core is rebalanced quarterly, just like any standard index fund. The stocks themselves have not changed; the innovation is in how the fund generates income from them.
...
QQA is explicitly not designed for investors who want maximum exposure to technology-sector growth. It is designed for those who want Nasdaq-100 exposure but are comfortable trading growth upside for regular monthly income, or who are close enough to retirement that the monthly distributions matter more to them than potential capital appreciation.

## Rebalancing rhythm and tax considerations

The fund rebalances its stock holdings quarterly, in line with the underlying Nasdaq-100 index. The call options are rolled monthly, creating a monthly cash flow in the form of option premiums.
...
QQA is a tool for a specific investor profile. You want exposure to the Nasdaq-100's dominant large-cap technology and communications companies. You do not expect them to soar over the next few years. You want monthly cash distributions you can spend or reinvest. You are comfortable with capped upside in exchange for steady income. And you either plan to hold the fund in a retirement account or you are aware of and accepting the tax implications of ordinary-income distributions.

For growth-oriented investors with a long time horizon, the cost of capped upside usually outweighs the monthly distributions. The strategy is not wrong — it simply optimizes for a different outcome than pure growth.
