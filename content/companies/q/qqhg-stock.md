---
title: "Invesco QQQ Hedged Advantage ETF (QQHG)"
description: "An ETF that tracks the Nasdaq-100 while hedging away downside risk through listed options, aiming to reduce volatility at the cost of capped upside."
keywords:
  - nasdaq-100 etf
  - downside hedging
  - protective call
...
## The hedge in practice

The exact structure of the collar — how far above and below the current index level the call and put strikes sit, and whether they are reset monthly, quarterly, or at longer intervals — determines how much upside is given away and how much downside is protected. Invesco adjusts these periodically. This is not a constant, passive holding like a standard index fund; it requires active monitoring and rebalancing of the options layer.

The practical consequence is that in years when the Nasdaq-100 surges 30% or more, QQHG will lag. In years when it falls 20%, QQHG may hold up better — but neither outcome is guaranteed, and the exact amount of protection or opportunity cost depends on where Invesco places the strikes at any given time.
...
QQHG appeals to investors with a Nasdaq-100 conviction who believe tech and growth will outperform but who want to reduce the stomach-turning volatility of holding unhedged exposure. It also suits portfolios where an investor already owns a considerable equity position and wants to layer on technology exposure with a risk dampener. It is not for buy-and-hold investors seeking maximum long-term upside, nor for traders looking to capture a rally in full.

Investors researching QQHG should read the fund's prospectus carefully to understand the exact collar structure at the time of purchase and how often it resets. Check the current strike prices and rebalancing schedule, and be aware that changes to the options layer will shift the risk-return profile. The Invesco website and the fund's factsheet provide the current hedge parameters. As with all leveraged, inverse, or structurally complex funds, understand the mechanism before buying — the hedge is not free, and the terms matter.
