---
title: "Quad/Graphics, Inc. (QUAD)"
description: "Quad/Graphics is a large printing and marketing services company providing print production, direct mail, logistics, and creative solutions to consumer brands, retailers, and publishers."
keywords:
  - commercial printing
  - direct mail
  - catalog printing
...
<table>
<tr><th>Ticker</th><td>QUAD (NYSE)</td></tr>
<tr><th>Founded</th><td>1971</td></tr>
<tr><th>Founder</th><td>Harry V. Quadracci</td></tr>
<tr><th>Headquarters</th><td>Sussex, Wisconsin</td></tr>
<tr><th>Annual Revenue</th><td>~$3 billion</td></tr>
<tr><th>Facilities</th><td>33 manufacturing and distribution centers</td></tr>
<tr><th>Major Clients</th><td>Adidas, CVS, Geico, GM, L.L.Bean, Toyota, others</td></tr>
<tr><th>Business Lines</th><td>Print, direct mail, catalogs, logistics, creative services</td></tr>
<tr><th>SEC CIK</th><td>0001481792</td></tr>
</table>
</aside>
...
**Direct Mail and Promotional Materials** — Quad produces direct mail pieces, catalogs, flyers, brochures, and inserts that retailers and consumer brands distribute to customers. This is a massive business; thousands of retailers and e-commerce companies use printed materials as a primary customer [acquisition](/acquisition/) and engagement channel.
...
The 10-K filing (SEC CIK 0001481792) provides segment revenue, detailing the breakdown between print and services and identifying the company's largest customers ([concentration risk](/concentration-risk/)). Pay particular attention to customer concentration — if a small number of customers represent a large share of revenue, losing one of them would be materially damaging.

Watch the gross margin trend across quarters; if it is declining while revenue is stable, it suggests either pricing pressure (customers demanding discounts) or cost [inflation](/inflation/) that Quad cannot pass through. Operating leverage is another key metric; as revenue grows, does operating income grow faster (good) or at the same rate or slower (indicating cost problems)?

The company's capital expenditure and [depreciation](/depreciation/) are also revealing. Printing is capital-intensive; Quad must continuously invest in new presses and equipment or fall behind technologically. Watch whether the company is maintaining capital intensity or whether it is underinvesting (which would suggest management is pessimistic about long-term print demand).
