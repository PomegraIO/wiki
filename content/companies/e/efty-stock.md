---
title: "Etoiles Capital Group Co., Ltd (EFTY)"
description: "A Hong Kong-based financial services and investment firm engaged in capital markets activities and asset management."
...
<tr><td><strong>CIK</strong></td><td>2058349</td></tr>
<tr><td><strong>Listing</strong></td><td>US Public</td></tr>
<tr><td><strong>Sector</strong></td><td>Financial Services</td></tr>
<tr><td><strong>Industry</strong></td><td>Investment & Capital Markets</td></tr>
<tr><td><strong>Type</strong></td><td>Investment Firm / Asset Manager</td></tr>
</table></aside>
...
Gross profit on trading is the spread or gain — the difference between purchase and sale price. But it is not net profit. Etoiles Capital must pay brokerage commissions (typically 0.05–0.15% of transaction value), financing costs if the position is leveraged (margin debt at prevailing rates), and market impact if the position is large enough to move the market.

A $50 million position purchased over three months and sold over the next three months might generate $2 million in gross spread (4%). Against that, Etoiles Capital pays $50,000–$150,000 in commissions and bid-ask slippage, $200,000 in financing costs if the position was 50% leveraged, and incurs the opportunity cost of capital. Net profit might be $1.5 million, or 3% of capital deployed.
...
## Hong Kong Market Dynamics and Regulatory Context

Etoiles Capital's unit economics are contextual to Hong Kong's regulatory environment and market structure. The Hong Kong Securities and Futures Commission (SFC) regulates investment advisors and asset managers. License costs, audit requirements, and compliance infrastructure are non-trivial fixed costs for any firm operating there.

Hong Kong's capital markets are sophisticated and competitive: large hedge funds, global asset managers, and local competitors all vie for the same deal flow and client assets. Etoiles Capital must differentiate — whether through superior returns, specialist expertise (say, China-focused equities or restructuring situations), or relationship depth — to justify taking capital and paying 1–2% fees to a relatively small local manager.

## Scale and Consolidation Dynamics

Small asset managers under $500 million AUM face structural headwinds: fees do not cover infrastructure costs, performance needs to be exceptional to compensate for small scale, and sophisticated clients (institutions, ultra-high-net-worth individuals) prefer larger, more established managers.

Etoiles Capital's unit economics improve significantly if it grows AUM past $1 billion, at which point fees support a full investment team, comprehensive research, and marketing presence. If it cannot scale, it may be a target for acquisition by a larger asset manager seeking to add Hong Kong presence or AUM.
...
### Closely related
- [/stock/](/stock/) — EFTY is a public [stock](/stock/)
- [/common-stock/](/common-stock/) — EFTY equity held by shareholders
- [/10-k/](/10-k/) — Annual filing detailing EFTY's revenue streams and AUM
- [/mutual-fund/](/mutual-fund/) — Related to EFTY's asset management business

### Wider context
- [/securities-and-exchange-commission/](/securities-and-exchange-commission/) — Overseas regulator; EFTY files with the SEC as a foreign issuer
- [/stock-exchange/](/stock-exchange/) — Exchange on which EFTY is listed
</div>
