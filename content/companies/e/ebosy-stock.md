---
title: "EBOS Group Limited (EBOSY)"
description: "EBOS Group is a pharmaceutical and healthcare-product distributor and software provider, serving hospitals, pharmacies, and clinics across Australia, New Zealand, and Europe — a mission-critical middleman in healthcare supply."
keywords:
...
<table>
<tr><th>Ticker</th><td>EBOSY (OTCPK, ADR)</td></tr>
<tr><th>Headquarters</th><td>Auckland, New Zealand</td></tr>
<tr><th>Founded</th><td>2011 (merger of Ebos and Ascentia)</td></tr>
<tr><th>Sector</th><td>Healthcare / Distribution</td></tr>
<tr><th>Main operations</th><td>Pharmaceutical distribution, healthcare logistics, software</td></tr>
<tr><th>Business model</th><td>Distribution margin + software licensing and services</td></tr>
<tr><th>SEC CIK</th><td>0001533082</td></tr>
</table>
</aside>

### What does EBOS actually distribute?

EBOS moves three main categories of healthcare products: prescription pharmaceuticals (from manufacturers to pharmacies and hospitals), over-the-counter medicines and supplements, and medical devices and consumables (bandages, syringes, surgical packs). It is not a retailer; it does not sell to consumers. Instead, it sits between manufacturers ([Pfizer](/pfe-stock/), GSK, [Novartis](/nvs-stock/)) and dispensers (pharmacies, hospitals, clinics). When a pharmacist fills a prescription, the medicine often came through an EBOS warehouse. When a hospital restocks its operating theatre, the surgical packs likely passed through EBOS. The company has regional distribution centers in Australia and New Zealand, and increasingly in the United Kingdom and Europe, from which it delivers to thousands of customer locations daily.
