...
description: "ESCO Technologies is an industrial manufacturer serving defense, aerospace, and industrial customers with filtration products, power management systems, and contract manufacturing. An engineered-products company with long customer relationships."
keywords:
...
<table>
<tr><th>Ticker</th><td>ESE (NASDAQ)</td></tr>
<tr><th>Founded</th><td>1990</td></tr>
<tr><th>Headquarters</th><td>St. Louis, Missouri</td></tr>
<tr><th>Sector</th><td>Industrial manufacturing / defense products</td></tr>
<tr><th>Primary business</th><td>Filtration, power management, contract manufacturing</td></tr>
<tr><th>Main customers</th><td>Boeing, Lockheed Martin, Northrop Grumman, industrial OEMs</td></tr>
<tr><th>Manufacturing</th><td>Multiple plants across North America</td></tr>
<tr><th>SEC CIK</th><td>0000866706</td></tr>
</table>
</aside>

## Filtration and environmental control

ESCO's filtration business is the largest segment by revenue. The company designs and manufactures filtration systems and components for aircraft environmental-control systems, ground vehicles, and industrial equipment. An aircraft engine needs clean air and fuel to operate reliably. Ground vehicles moving through dust, sand, or arctic conditions need to protect hydraulic systems, engines, and avionics from contamination. ESCO supplies the filtration units and integrated systems that keep these critical components clean.
...
The second major business manufactures power-conditioning equipment and electronic components: power supplies for military radar and communication systems, conditioning units that shape electrical power for sensitive avionics, and custom electronic assemblies. These products sit in the backbone of modern weapon systems — they do not shoot or fly, but they make sure the systems that do are powered cleanly and reliably.

Military platforms are designed for multi-decade service lives. A radar system installed in a military aircraft in 2010 might still be flying in 2040. Over those decades, the power-supply unit must be serviceable, reliable, and compatible with upstream and downstream systems. ESCO's expertise is in designing power systems that meet those exacting requirements and then supporting them through the life cycle. That creates durable customer relationships: once qualified on a program, the company often becomes the sole source for life-of-program, with little competitive pressure on price.
...
ESCO's customer base is highly concentrated: Boeing and Lockheed Martin likely represent a large share of revenue. This concentration creates customer power — the primes can demand price concessions, and the loss of a major program is material risk. The company is therefore closely tied to the health of its biggest customers and the platforms they build.

Platform programs are long-cycle. Boeing takes years to develop a new aircraft, years to ramp production, and then operates for decades. Lockheed Martin manages platforms that are in service with the military for 40+ years. ESCO's revenue is therefore tied to the maturity of these programs. A ramping platform drives growing demand; a maturing platform stabilizes; and eventually a program retires or is replaced, and ESCO must win on the next-generation successor or face headwind.
...
ESCO is exposed to the health of U.S. defense spending and the allocation between platforms. Bipartisan political support for defense spending has been consistent, but within that budget, choices about which platforms get funding create winners and losers. A shift in how the Pentagon allocates between aircraft, missiles, vehicles, and ships can meaningfully affect ESCO's mix. A major new platform win is upside; a major customer platform retirement is downside.

## How to research ESCO Technologies
