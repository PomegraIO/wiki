---
title: "ProShares Equities for Rising Rates ETF (EQRR)"
description: "An actively managed ETF that adapts its stock holdings as interest rates change, tilting toward companies expected to benefit from higher rates and away from those that suffer. Offered by ProShares."
keywords:
...
*The ProShares Equities for Rising Rates ETF (ticker EQRR) is an [actively managed fund](/actively-managed-fund/) built to shift its stock portfolio in response to changes in [interest rates](/interest-rate/). Rather than hold a fixed basket of companies, it weights its positions toward stocks the manager believes are positioned to benefit when rates rise and away from those expected to struggle—a direct tactical bet on the rate environment rather than a passive sector bet.*
...
As an actively managed ETF, EQRR carries an expense ratio meaningfully higher than a passive large-cap [index fund](/index-fund/) but comparable to other actively managed equity funds. Shareholders pay this annual fee whether the manager's bets pay off or not.

The fund trades on a major US exchange during standard market hours, so it can be bought and sold at intraday prices like a stock. This is one advantage of the ETF wrapper over a traditional [mutual fund](/mutual-fund/); an investor can exit at any time during the trading day rather than waiting until the market close. The fund aims to be liquid, given its focus on large-cap holdings, though trading volume and [bid-ask spreads](/bid-ask-spread/) can fluctuate.
