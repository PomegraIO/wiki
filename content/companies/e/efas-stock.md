---
title: "Global X MSCI SuperDividend EAFE ETF (EFAS)"
description: "A dividend-focused ETF holding large-cap dividend-paying companies in developed markets outside the United States and Canada, selected from the MSCI EAFE SuperDividend Index."
keywords:
  - dividend yield
  - EAFE
  - developed markets
...
EFAS is a dividend-focused exchange-traded fund issued by Global X and managed according to the MSCI EAFE SuperDividend Index. The fund holds large-cap, developed-market equities primarily from Europe, Australia, and the Far East — names that pay high [dividends](/dividend/) relative to their share price.

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>EFAS (NASDAQ)</td></tr>
<tr><th>Fund family</th><td>Global X Funds</td></tr>
<tr><th>Index</th><td>MSCI EAFE SuperDividend</td></tr>
<tr><th>Geographic focus</th><td>Developed markets: Europe, Australia, Japan, Singapore</td></tr>
<tr><th>Strategy</th><td>High-dividend large-cap equities</td></tr>
<tr><th>Structure</th><td>Fully replicated ETF</td></tr>
<tr><th>Key characteristic</th><td>Elevated dividend yield relative to broad EAFE</td></tr>
</table>
</aside>
...
EFAS is a fully replicated ETF. It owns the actual shares of the index constituents rather than using derivatives or a representative sample. The fund trades on the [NASDAQ](/nasdaq/) during regular market hours; liquidity is solid, and the [bid-ask spread](/bid-ask-spread/) is typically tight for an international fund.

The [expense ratio](/expense-ratio/) is moderate for an actively curated, factor-based ETF. The fund's turnover is higher than a pure passive tracker because the index rebalances to maintain its dividend tilt, and dividend-paying stocks themselves churn as companies change their payout policies or move in and out of the high-yielding cohort.

An investor must also bear [currency risk](/currency-risk/). Holdings are denominated in euros, [British pounds](/british-pound/), [Australian dollars](/australian-dollar/), yen, and other developed-world currencies. EFAS does not hedge currency, so a [US dollar](/us-dollar/) investor's returns include the performance of those currencies against the dollar. Periods of dollar strength will dampen gains; periods of dollar weakness will amplify them.

## The appeal and the trade-off

For income-focused investors, the draw is straightforward: EFAS generates higher periodic dividend income than a plain EAFE [index fund](/index-fund/) would. That income is derived from companies' earnings, not from the fund's principal, so it represents a real economic return rather than capital depletion. The tax treatment is favorable in many situations ([qualified dividends](/qualified-dividend/) receive preferential tax rates in the United States if held long enough), though this depends on an investor's circumstances.

The trade-off is [concentration risk](/concentration-risk/) and valuation. By selecting the highest-yielding stocks, the index overweights value and underweights growth. That can mean missing out during periods when growth stocks outperform, and it can result in a portfolio more sensitive to interest-rate and [inflation](/inflation/) shocks. High [dividend yields](/dividend-yield/) can also sometimes signal distressed companies cutting their dividend soon, so selecting purely on yield alone introduces some risk of capital loss.
...
The index selection process, while transparent, can be mechanical and backward-looking. High yield today may reflect financial distress rather than sustainable competitive strength. Investors should not assume that high [current yield](/current-yield/) signals safety or durability.
