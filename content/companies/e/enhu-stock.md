---
title: "iShares Enhanced Large Cap Core Active ETF (ENHU)"
description: "ENHU is an actively managed U.S. equity ETF selecting large-cap stocks based on quality and value criteria, concentrating the portfolio to reflect the manager's conviction."
keywords:
  - U.S. large cap
  - active management
  - core equity
...
**Selection criteria.** The manager screens for two linked characteristics: quality (stable earnings, strong [balance sheets](/balance-sheet/), consistent returns on capital, sustained pricing power) and value (reasonable prices relative to fundamentals — [earnings yields](/earnings-yield/), book value, cash-flow multiples). Both concepts have deep historical roots in equity investing. ENHU bundles them into a core strategy, overweighting stocks the manager judges superior and underweighting or avoiding those judged unattractive. This is deliberate departure from market-cap weighting.

**[Concentration risk](/concentration-risk/).** ENHU holds its largest positions more heavily than a broad market-cap index would. The top ten holdings typically represent 25–30% of assets, but they are different companies than the S&P 500's top ten, and they are overweighted relative to their [market cap](/market-capitalization/). Result: the manager's best ideas drive returns more than in a passive fund, but individual stock moves swing the fund harder. When top holdings lag, [diversification](/diversification/) offers little shelter. When they outperform, gains amplify.
...
**Costs and the active-management wager.** ENHU's [expense ratio](/expense-ratio/) exceeds passive large-cap alternatives because the manager conducts fundamental research and rebalances actively. The issuer argues outperformance covers the cost. Skeptics note that beating a broad U.S. equity index persistently is difficult; many years exist when quality lags pure growth, or when mega-cap technology and momentum stocks — outside the fund's criteria — drive the market. The manager must have conviction the fee gap closes through genuine edge.

**Trading and liquidity.** The fund trades like any ETF on [stock exchanges](/stock-exchange/) during market hours. [Bid-ask spreads](/bid-ask-spread/) are typically tight given its asset base and trading volume. [Position sizing](/position-sizing/) differs from market-cap weighting, sometimes creating mispricings the manager can exploit, sometimes working against the fund when the market diverges from the manager's views.

**Interest-rate sensitivity.** This is a domestic U.S. equity fund — no [currency risk](/currency-risk/). But large-cap stocks respond sharply to [interest rates](/interest-rate/) and economic health. Rising rates compress valuations and often favour quality over growth; falling rates typically benefit growth stocks. [Sector rotation](/sector-rotation/) effects matter, and flows between equities and [bonds](/bond/) ripple through fund performance.
