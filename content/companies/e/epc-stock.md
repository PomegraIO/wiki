...
description: "A manufacturer and seller of personal care consumer brands including razors, shaving products, and grooming goods, traded on the NYSE."
keywords: ["consumer staples", "razor blades", "shaving", "grooming", "personal care brands", "branded consumer goods"]
---
...
<tr><td><strong>Ticker</strong></td><td>EPC</td></tr>
<tr><td><strong>Listing</strong></td><td>NYSE</td></tr>
<tr><td><strong>SEC CIK</strong></td><td>1096752</td></tr>
<tr><td><strong>Sector</strong></td><td>Consumer Staples</td></tr>
<tr><td><strong>Industry</strong></td><td>Personal care products</td></tr>
...
This is a middleman challenge: the company must balance retail partner relationships (offering competitive terms) against consumer brand maintenance (holding price and margins). Too much discounting erodes [gross profit margins](/gross-profit-margin/); too little risks losing shelf space to competitors or private-label alternatives. Edgewell must also guard against retailers' own brand offerings — many supermarkets now sell in-house razor or shaving gel brands at lower prices, directly competing for the customer's dollar.
...
Consumer staples companies live on [operating margins](/operating-margin/) — the spread between sales and the cost of goods, distribution, and marketing. Edgewell's margins are moderate: manufacturing and retail structure do not allow luxury pricing. The company must achieve scale (high unit volume) to support overhead. A decline in volume-per-store or total outlets hits margins hard because fixed costs (factories, distribution, marketing) do not drop proportionally.
...
### Closely related
- [/epac-stock/](/epac-stock/) (peer company, industrial consumer goods)
- [/eols-stock/](/eols-stock/) (peer company, different sector)
