---
title: "EGH Acquisition Corp. (EGHAR)"
description: "A blank-check company unit structured to raise capital for identifying and acquiring an operating business, combining common shares and warrant rights."
keywords:
  - acquisition company
  - SPAC unit
  - capital structure
  - blank-check formation
  - merger vehicle
  - warrant structure
handwritten: true
---
...
<table>
<tr><th>Structure</th><td>Blank-check acquisition company</td></tr>
<tr><th>Security type</th><td>Acquisition company unit</td></tr>
<tr><th>Common share ticker</th><td>EGHA</td></tr>
<tr><th>Warrant ticker</th><td>EGHAW</td></tr>
<tr><th>Purpose</th><td>Identify and merge with an operating business</td></tr>
<tr><th>SEC CIK</th><td>0002052547</td></tr>
</table>
</aside>
...
The unit structure bundles one share and one warrant together at an offering price, making the initial investment more attractive than a simple share purchase might be. A unit priced at $10 might consist of one share worth roughly $10 and a warrant that provides no immediate value but may become valuable later. This bundling allows the underwriters and SPAC sponsors to market the offering as a multi-component investment rather than just a speculative shell, broadening potential investor interest. Once the trust account is open (after a merger closes or on a specified date if no redemptions are processed), the units separate into common shares (EGHA) and warrants (EGHAW), which can trade independently.
...
Once a target is identified and a merger agreement is negotiated, the proposed deal is submitted to shareholders for a vote. Shareholders have the right to redeem their shares — to exchange them for cash from the trust account — rather than vote in favor of the merger. This redemption right is central to the SPAC structure: it allows shareholders who dislike the proposed deal to exit at the original offering price (minus any trust account dilution from sponsor fees), rather than being forced to hold shares in the merged company. If redemptions are heavy, the merged company may emerge from the merger with significantly less capital than was raised in the original IPO.
...
Before a merger is announced, the main indicator of sponsor quality is their track record with prior SPACs or acquisition experiences, which is available in SEC filings and through financial databases. The trust account size (disclosed in the prospectus) and the sponsor's founder-share stake (also disclosed) reveal their skin in the game. Once a merger target is announced, the focus shifts to evaluating the target company's business, market, competitive position, and valuation — essentially, assessing whether the acquisition is being made at a fair price relative to the merged company's growth prospects and risk profile.
