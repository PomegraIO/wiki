---
title: "Sophus Capital Emerging Market Small Cap ETF (EMSC)"
description: "A small-cap emerging-market ETF tracking smaller public companies in developing economies, offering concentrated growth exposure and higher volatility than large-cap peers."
keywords:
  - emerging markets
  - small-cap stocks
  - ETF
...
## Origin: The case for smaller emerging-market companies
...
<table>
<tr><th>Ticker</th><td>EMSC</td></tr>
<tr><th>Sponsor</th><td>Sophus Capital</td></tr>
<tr><th>Asset class</th><td>Equity — small-cap emerging markets</td></tr>
<tr><th>Market-cap range</th><td>Below several billion dollars per company</td></tr>
<tr><th>Strategy</th><td>Passive index, small-cap weighted</td></tr>
<tr><th>Number of holdings</th><td>50–200 typical range</td></tr>
<tr><th>Structure</th><td>Standard ETF, non-leveraged</td></tr>
<tr><th>Liquidity profile</th><td>Lower than large-cap; wider spreads</td></tr>
</table>
</aside>
...
## Current composition and concentration
...
Begin with the prospectus on Sophus Capital's website. It should clearly define what constitutes small-cap in emerging markets — typically a market-cap range — and explain the index construction methodology.

Second, examine the holdings list and the geographic and sectoral weights. Is the portfolio truly diversified across countries, or is it tilted heavily toward China or India? Is it evenly distributed across sectors, or are there large positions in one or two? The concentration level reveals how much company-specific risk you are taking.

Third, assess the fund's liquidity. Check the daily trading volume on major exchanges and the bid-ask spread. A fund with consistent volume and tight spreads is easier to trade; a fund with sporadic volume or wide spreads can be expensive to enter and exit.

Fourth, track performance over multiple market cycles. Small-cap emerging-market funds will underperform dramatically in risk-off periods and may outperform sharply in risk-on periods. A fund's long-term record tells you whether the outperformance in good times has exceeded the underperformance in bad times.

Finally, stay alert to the fund's rebalancing activity. Frequent trading to maintain the index can increase costs; infrequent rebalancing can allow drift. The prospectus should disclose the rebalancing schedule and any tax consequences for shareholders.
