---
title: "Eureka Acquisition Corp (EURKR)"
description: "A blank-check company (SPAC) that raised $50 million in its July 2024 IPO to identify and acquire or merge with an operating business in any industry or market."
keywords:
  - SPAC
  - blank check company
  - acquisition vehicle
...
Eureka's public offering consisted of 5 million units, each priced at USD 10.00, for total gross proceeds of USD 50 million. Each unit comprises one Class A ordinary share and one right. The Class A shares represent voting equity in Eureka, while the rights represent a claim on [fractional shares](/fractional-shares/) that vest upon completion of an initial business combination.
