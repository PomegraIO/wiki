---
title: "Ellington Financial Inc. (EFC-PB)"
description: "Ellington Financial is a mortgage real estate investment trust (REIT) that originates, buys, and invests in residential and commercial mortgage assets and mortgage-backed securities, capturing yield through financing and arbitrage strategies."
keywords:
  - mortgage REIT
...
<table>
<tr><th>Ticker</th><td>EFC-PB (NYSE)</td></tr>
<tr><th>Founded</th><td>2004</td></tr>
<tr><th>Headquarters</th><td>New York, New York</td></tr>
<tr><th>Parent / Sponsor</th><td>Ellington Management Group</td></tr>
<tr><th>Structure</th><td>Mortgage REIT; required to distribute 90% of net income</td></tr>
<tr><th>Primary assets</th><td>Residential and commercial mortgage loans and mortgage-backed securities</td></tr>
<tr><th>Business model</th><td>Mortgage origination, acquisition, and servicing; capital arbitrage</td></tr>
<tr><th>SEC CIK</th><td>0001411342</td></tr>
</table>
</aside>

## Building the mortgage-origination platform (2004–2010)

In its early years, Ellington Financial was primarily a buyer of mortgage assets in the [secondary market](/secondary-market/). The company raised capital from institutional investors and used it to purchase residential mortgage-backed securities and occasionally whole residential mortgage loans. [Mortgage REITs](/mortgage-reit/), by nature, are inherently leveraged; a typical mortgage REIT might use 3 to 4 dollars of borrowed capital for every dollar of equity, amplifying both returns and risks.
...
The company's quarterly 10-Q and annual 10-K filings (SEC CIK 0001411342) break down the composition of the mortgage portfolio—how much is held as whole loans, how much as mortgage-backed securities, the loan-to-value ratios, and the [delinquency](/delinquency/) rates. Watch the market value of the investment portfolio versus book value; widening discounts indicate stress. The earnings report should detail origination volumes, origination margins, and how much new capital is being deployed into [acquisitions](/acquisition/) versus how much is being run off.

Key metrics to monitor are the yield earned on the portfolio, the cost of funding, and the net interest margin after accounting for both interest and non-interest expenses. When net margin compresses below a certain level—typically 1 to 2 percent of assets—the company cannot support distributions at historical levels. Also watch the company's [leverage ratio](/leverage-ratio-forex/) (assets divided by equity) and its access to repo funding; in stress scenarios, repo markets can freeze, and a highly leveraged mortgage REIT can face a [liquidity crisis](/liquidity-crisis/). Management commentary on the mortgage market, rate expectations, and origination pipelines is also essential context.
