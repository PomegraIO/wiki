---
title: "Eaton Vance Limited Duration Income Fund (EVV)"
description: "EVV is a closed-end fund managed by Eaton Vance (part of Morgan Stanley Investment Management) that invests in fixed-income securities to generate current income with controlled interest-rate risk."
keywords:
  - closed-end fund
  - fixed income
  - bond fund
...
<table>
<tr><th>Ticker</th><td>EVV (NYSE)</td></tr>
<tr><th>Founded</th><td>May 2003</td></tr>
<tr><th>Manager</th><td>Eaton Vance Management (Morgan Stanley Investment Management)</td></tr>
<tr><th>Fund type</th><td>Closed-end fixed-income fund</td></tr>
<tr><th>Investment focus</th><td>Floating-rate loans, mortgage-backed securities, corporate bonds</td></tr>
<tr><th>SEC CIK</th><td>0001222922</td></tr>
</table>
</aside>
...
Returns to a closed-end fund shareholder come from two sources: the income distributions paid monthly or quarterly from bond coupons and loan interest, and changes in the share price. Many closed-end bond funds are structured to pay out substantially all of their net investment income each quarter, so shareholders receive regular cash returns. However, because the share price floats, the total return (distributions plus share-price change) can diverge from the fund's underlying portfolio performance. In periods of market stress or loss of confidence in fixed-income assets, a bond fund's shares might trade at a steep discount to the underlying value of its holdings, amplifying losses. Conversely, in periods of excess demand for yield, shares can trade at a premium.
...
EVV is typically held by individual investors seeking monthly income and moderate credit exposure, and by institutional accounts including foundations and endowments where the predictable income stream complements long-term holdings. The fund is most attractive when market conditions are stable or when rates are expected to fall (which would boost fixed-income valuations), and least attractive when [credit spreads](/credit-spread/) are widening or when the Fed is tightening rates rapidly (which can cause both income volatility and share-price declines for floating-rate portfolios).

Because EVV is a closed-end fund, its shares can trade at significant premiums or discounts to net asset value. Disciplined shareholders can exploit these discrepancies, buying when shares trade at a discount and selling when the premium widens. The trade-off is that closed-end funds are less liquid than open-end mutual funds — the [secondary market](/secondary-market/) for EVV is smaller, which can widen [bid-ask spreads](/bid-ask-spread/).

## How to follow Eaton Vance Limited Duration Income Fund

Read the fund's annual shareholder report (Form N-CSRS) filed with the SEC, which discloses portfolio holdings, performance, and management commentary. Monitor the monthly or quarterly distribution amounts — growth or decline in distributions signals whether the fund's portfolio income is rising or falling. Track the fund's share price relative to its published net asset value; when the discount or premium widens, it often signals investor sentiment shifts. For passive income seekers, the fund's distribution history and [current yield](/current-yield/) are the starting point; for active traders, the discount-to-NAV pattern offers a technical edge.
