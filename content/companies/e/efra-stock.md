---
title: "iShares Environmental Infrastructure and Industrials ETF (EFRA)"
description: "An ETF holding global companies that build and operate environmental infrastructure, including renewable energy, water treatment, waste management, and pollution-control technology."
keywords:
...
EFRA is an exchange-traded fund managed by BlackRock's iShares division that holds companies across three themes: renewable energy producers and equipment makers, water treatment and recycling firms, and pollution-control and environmental remediation specialists. The fund tracks the MSCI Global Environment Select Socially Responsible Index.

> "Infrastructure that solves — not just infrastructure that delivers."

The portfolio reflects that framing. It is not simply utilities; it is companies making choices to shift away from fossil fuels or solving environmental problems. A traditional electric utility in that index might be one that is rapidly adding renewables and retiring coal plants. A capital equipment maker might specialize in solar panels, wind turbines, or water purification systems. A waste management company might focus on recycling and resource recovery. The unifying thread is investment in environmental outcomes, not just exposure to the energy or infrastructure sectors broadly.
...
The index selection process — screening for environmental and social responsibility — can be subjective. A company's inclusion depends on meeting criteria defined by MSCI, and those criteria evolve. What counts as "environmental infrastructure" or whether a company is "transitioning" toward sustainability can be debated, introducing selection risk.

Valuation risk is significant. Environmental and renewable-energy companies often trade at premium valuations relative to traditional utilities or energy firms because they are seen as growth plays. If that premium compresses, valuations can fall sharply even if the underlying fundamentals remain intact.
