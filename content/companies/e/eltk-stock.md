---
title: "ELTEK LTD (ELTK)"
description: "Israeli power supply and energy conversion systems manufacturer; OTC-quoted electronics producer serving industrial and telecommunications markets."
...
<tr><td>SEC CIK</td><td>1024672</td></tr>
<tr><td>Sector</td><td>Industrials</td></tr>
<tr><td>Industry</td><td>Electronics & Power Systems</td></tr>
<tr><td>Type</td><td>Israeli Public Corporation</td></tr>
</table></aside>

## Manufacturing Overhead and Asset Utilization in Electronics Production

Eltek manufactures industrial power supplies, uninterruptible power systems (UPS), and energy conversion products sold to telecommunications carriers, data centers, and industrial customers. The company's balance sheet reflects a manufacturing business with factories, production tooling, component inventory, and work-in-process goods at various stages of assembly.

For an electronics manufacturer operating in Israel, where labor and energy costs are higher than in low-cost manufacturing regions, the balance sheet must demonstrate that asset utilization is efficient enough to sustain competitive margins. Fixed manufacturing overhead—factory rent or ownership, maintenance, utilities, and line supervision—is allocated to each unit produced. If Eltek's factories operate at 70% capacity, the overhead cost per unit is high; at 90% capacity, overhead is spread over more units and competitive pricing power improves.

## Inventory Composition and Obsolescence Risk

Eltek's inventory divides into three pools: raw materials (components purchased from suppliers), work-in-process (units on assembly lines), and finished goods (products ready to ship). For a power supply manufacturer, the raw materials—semiconductors, transformers, capacitors, circuit boards—can represent 40–50% of total inventory value.

Electronics components have finite shelf lives. Capacitors, for instance, can lose capacitance over years even if unused; semiconductors face supply constraints and technological obsolescence (newer versions make old stock less competitive). The balance sheet carries inventory at the lower of cost or estimated market value, but "market value" for specialized electronic components is often estimated rather than observed through actual transactions. A company with six months or more of inventory on hand faces markdowns if customer demand shifts or technology advances.

## Capital Intensity of Tooling and Assembly Lines
...
Eltek buys components from suppliers on net-30 or net-45 terms, assembles them into finished products, and invoices customers on net-30 to net-60 terms (sometimes longer for government or utility customers). The operating cycle—the time from when cash is paid for materials until customer cash arrives—can stretch to 90–120 days.

If Eltek grows revenue 20% year-over-year, the working capital required to support that growth grows 20% as well. Without access to credit or strong cash generation from operations, fast growth becomes self-limiting. The balance sheet must show whether the company finances working capital through operations, through available credit lines, or through customer prepayments (which would reduce receivables).
...
## Competitive Position and Asset Quality

A balance-sheet approach to Eltek asks whether the assets shown—factories, tooling, inventory—are competitive assets or legacy drag. A modern, efficient power supply factory is an asset; an aging facility with outdated equipment is a liability disguised as an asset. The 10-K's narrative section and management discussion provide clues to asset quality; specific depreciation rates and capital intensity ratios reveal the underlying story.
