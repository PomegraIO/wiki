---
title: "Evotec SE (EVO)"
description: "A German-listed drug-discovery and development company serving pharma clients on a contract basis; dependent on customer funding, competitive on pricing, and vulnerable to pharma-industry consolidation."
keywords: ["contract research", "drug discovery", "pharmaceutical services", "outsourcing", "biotechnology"]
---
...
<tr><td>Ticker</td><td>EVO</td></tr>
<tr><td>Listing</td><td>NASDAQ</td></tr>
<tr><td>SEC CIK</td><td>1412558</td></tr>
<tr><td>Sector</td><td>Pharmaceutical Services / CRO</td></tr>
<tr><td>Type</td><td>Contract research organization</td></tr>
</table></aside>

## The Contract Model and Its Limits

Evotec operates as a service provider to the pharmaceutical industry. Large pharma companies, facing pressure to expand pipelines while controlling internal R&D costs, outsource portions of discovery and early-stage development to CROs like Evotec. The company maintains laboratories, staff, and proprietary tools, and charges clients on a per-project basis (fixed-fee contracts, cost-plus arrangements, or milestone-based fees). Evotec also generates [revenue](/stock/) from equity stakes in spin-out companies and milestone payments tied to client product approvals.
...
### Closely related
- [Charles River Laboratories (CRL)](/crl-stock/)
- [ICON (ICLR)](/iclr-stock/)
- Syneos Health (SYEO)
