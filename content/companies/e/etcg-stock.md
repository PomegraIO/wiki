...
description: "A closed-end trust that holds Ethereum Classic cryptocurrency and allows investors to gain exposure via a traditional brokerage account, without directly holding the asset."
keywords:
  - ethereum classic
...
Conversely, holding the trust is not equivalent to holding the underlying asset perfectly. The premium or discount to NAV is real money; if you buy at a large premium and the premium collapses, you lose that cushion. The annual fee, whilst modest in percentage terms, compounds over decades. And there is the [counterparty risk](/counterparty-risk/): investors trust that Grayscale maintains secure custody and that the trust will not be sued, frozen, or otherwise impaired. Direct holders of Ethereum Classic bear no such risk.
