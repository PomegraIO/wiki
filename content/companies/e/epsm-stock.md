---
title: "Epsium Enterprise Ltd (EPSM)"
description: "Enterprise software and solutions provider specializing in supply-chain visibility, logistics optimization, and inventory-management systems for mid-market and large enterprises."
...
Epsium's 10-K (CIK 1883437) should disclose: total bookings and remaining [performance obligations](/performance-obligation/) (RPO), customer concentration (percentage of revenue from top 10 customers), customer acquisition cost (CAC) and lifetime value (LTV), and retention rates (what percentage of customers renew annually). For multi-stream revenue models, the 10-K separates license revenue, services revenue, and maintenance revenue, revealing which segments are growing. Key operating metrics include R&D as a percentage of revenue (higher for innovative companies, lower for mature ones), sales and marketing efficiency, and gross margin (which should be 50%+ for software). Cash flow metrics—operating cash flow, free cash flow, and cash conversion—indicate whether the business is sustainable or reliant on continuous equity dilution.

<div class="wiki-seealso">

### Closely related
- [/eprx-stock/](/eprx-stock/) — Peer company in adjacent technology sectors
- [/epow-stock/](/epow-stock/) — Comparative reference in specialized industrial software
