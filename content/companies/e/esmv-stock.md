---
title: "iShares ESG Optimized MSCI USA Min Vol Factor ETF (ESMV)"
description: "ESMV is an exchange-traded fund tracking a diversified U.S. equity index optimized for low volatility and screened for environmental, social, and governance considerations—designed to reduce portfolio swings while excluding companies flagged for ESG concerns."
keywords:
  - ESG investing
  - minimum volatility
  - factor investing
...
Because it tracks an index, ESMV is a [passively managed fund](/passively-managed-fund/). It does not employ active stock-pickers making bets on which companies will outperform; instead, it simply holds the index constituents in their designated weights and rebalances periodically as the index itself changes. This passive approach keeps costs low and trading activity minimal.
...
ESMV carries an [expense ratio](/expense-ratio/) in the range of 0.20% to 0.25% annually (exact figures are published in the fund's prospectus). This is modest by active-fund standards but slightly higher than the cheapest broad market ETFs, which reflects the cost of the ESG screening overlay and the volatility optimization. The fund trades with tight spreads on the NASDAQ, meaning buy-sell quotes are close together and liquidity is excellent, so investors can enter and exit the position efficiently.
