...
Anyone evaluating Eagle Point should review the company's quarterly reports and annual proxy statements filed with the SEC (CIK 0001604174), which disclose the composition of the portfolio, the weighted average coupon (the interest rate the portfolio is earning), and the [leverage ratio](/leverage-ratio-forex/). Track the distribution rate relative to the NAV — if distributions are consistently exceeding the portfolio's earnings, they may be unsustainable, drawing down the fund's capital rather than just passing through income. Pay attention to credit losses and prepayment speeds in the underlying mortgage pools; prepayments return capital early when interest rates fall, forcing the fund to reinvest at lower yields. Finally, monitor the premium or discount at which shares trade relative to NAV, and follow commentary from management about the direction of interest rates and credit conditions, since both drive the value of mortgage securities.
