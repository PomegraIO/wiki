---
title: "Eagle Point Credit Company Inc. (ECCV)"
description: "Eagle Point Credit is a specialty finance company focused on mortgage-backed securities and middle-market business loans, structured as a closed-end management investment company generating income for shareholders through a portfolio of non-agency debt instruments."
keywords:
...
[Eagle Point Credit](/ecc-stock/) Company operates as a closed-end management investment company whose business is the careful assembly of mortgage-backed securities and business loans into a portfolio designed to generate steady income for its shareholders. Registered as an investment company under the [Investment Company Act of 1940](/investment-company-act-of-1940/), it pursues a strategy of investing in non-agency mortgage-backed securities and middle-market business loans, buying assets that often trade at discounts to [par value](/par-value/) and collecting the interest and principal payments that flow through them.

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>ECCV (NYSE)</td></tr>
<tr><th>Founded</th><td>2014</td></tr>
<tr><th>Company Type</th><td>Closed-end management investment company</td></tr>
<tr><th>Sector</th><td>Finance / specialty lending</td></tr>
<tr><th>Primary Focus</th><td>Non-agency mortgage-backed securities</td></tr>
<tr><th>Business Model</th><td>Portfolio income from debt instruments</td></tr>
<tr><th>SEC CIK</th><td>0001604174</td></tr>
</table>
</aside>

## What kind of company is Eagle Point, and how does it make money?

Eagle Point is a mortgage-credit specialist structured as a [closed-end fund](/closed-end-fund/). Unlike an open-end [mutual fund](/mutual-fund/) where investors can buy or sell shares daily at [net asset value](/net-asset-value/), a closed-end fund issues a fixed number of shares that trade on an exchange like any stock. Investors come to Eagle Point for monthly or quarterly distributions that stem from the cash its portfolio generates — principally interest payments and principal repayments from its holdings in non-agency mortgage-backed securities and business loans.

The core revenue source is straightforward: Eagle Point buys debt securities (primarily residential and [commercial mortgage-backed securities](/commercial-mortgage-backed-securities/) that were not issued or guaranteed by government-sponsored enterprises like [Fannie Mae](/fannie-mae/) or [Freddie Mac](/freddie-mac/)) and collects the interest and principal flows they produce. These non-agency securities typically offer higher yields than agency mortgage-backed securities because they carry [credit risk](/credit-risk/) — the mortgages underlying them are less protected by government backing, so investors demand more return to compensate. Eagle Point's management team evaluates these securities, judges which ones offer attractive value relative to their embedded risks, and constructs a portfolio intended to throw off reliable cash income.

The economics depend critically on the purchase price. If Eagle Point buys a [mortgage-backed security](/mortgage-backed-security/) trading at 90 cents on the dollar, the yield it collects is higher than it would be if it had paid par value. But securities trade at discounts for a reason — often because there is uncertainty about how many loans will default, or concern that borrowers will refinance when [interest rates](/interest-rate/) fall, returning capital early. Navigating that trade-off between yield and risk is the core investment task.
...
Eagle Point's geographic exposure tilts toward the mortgage markets where it finds the most compelling opportunities. Non-agency mortgage-backed securities are not evenly distributed — they concentrate in regions where borrowers and lenders faced credit constraints after 2008. Securities originated in areas with strong borrower credit and substantial [equity cushions](/equity-cushion/) may offer less [yield pickup](/yield-pickup/) than the same-era securities from regions where credit was tighter. The management team has to decide whether to concentrate in high-yielding pockets — potentially taking on correlated regional risk — or diversify across geographies at the cost of lower average yields.

## What to watch when researching Eagle Point

Anyone evaluating Eagle Point should review the company's quarterly reports and annual [proxy statements](/proxy-statement/) filed with the SEC (CIK 0001604174), which disclose the composition of the portfolio, the weighted average coupon (the interest rate the portfolio is earning), and the [leverage ratio](/leverage-ratio-forex/). Track the distribution rate relative to the NAV — if distributions are consistently exceeding the portfolio's earnings, they may be unsustainable, drawing down the fund's capital rather than just passing through income. Pay attention to credit losses and [prepayment speeds](/prepayment-speed/) in the underlying mortgage pools; prepayments return capital early when interest rates fall, forcing the fund to reinvest at lower yields. Finally, monitor the premium or discount at which shares trade relative to NAV, and follow commentary from management about the direction of interest rates and credit conditions, since both drive the value of mortgage securities.
