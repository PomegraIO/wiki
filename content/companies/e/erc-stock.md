---
title: "Allspring Multi-Sector Income Fund (ERC)"
description: "Allspring Multi-Sector Income Fund is a closed-end fund that invests in bonds, preferred stocks, and other fixed-income securities across multiple sectors to deliver regular distributions to shareholders."
keywords:
  - closed-end fund
  - fixed-income
  - preferred stocks
...
Allspring Multi-Sector [Income Fund](/income-fund/) (ERC) is a closed-end fund — a managed investment vehicle that pools shareholder capital into a fixed portfolio of [bonds](/bond/), [preferred stocks](/preferred-stock/), and other income-bearing securities, then trades on an exchange like a stock. Unlike a [mutual fund](/mutual-fund/), which issues and redeems shares at [net asset value](/net-asset-value/), a closed-end fund issues a set number of shares that trade on the open market at whatever price buyers and sellers agree to pay. The fund's job is simple: buy income-producing securities, collect interest and [dividends](/dividend/), and pass most of that cash to shareholders on a regular monthly or quarterly schedule.

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>ERC (NYSE)</td></tr>
<tr><th>Fund type</th><td>Closed-end fund</td></tr>
<tr><th>Asset class</th><td>Fixed income, preferred stocks</td></tr>
<tr><th>Strategy</th><td>Multi-sector income generation</td></tr>
<tr><th>Payout</th><td>Regular distributions to shareholders</td></tr>
<tr><th>Exchange</th><td>New York Stock Exchange</td></tr>
<tr><th>SEC CIK</th><td>0001227073</td></tr>
</table>
</aside>

## What is a closed-end fund and how does it differ from mutual funds?

A closed-end fund is a distinct form of investment vehicle. When a mutual fund launches, it issues shares to investors and keeps accepting new money; when someone wants to exit, they redeem shares at net asset value. A closed-end fund, by contrast, issues a fixed number of shares once, usually at launch. Those shares then trade on an exchange — just like stocks — at prices set by supply and demand. If the fund's assets grow more valuable but there are no new shares being created, the price per share can rise above the underlying net asset value. Conversely, if investors become pessimistic about the fund's prospects, the shares can trade at a discount to net asset value. This trading at a premium or discount to underlying value is unique to [closed-end funds](/closed-end-fund/) and creates both opportunity and risk for investors.

## What does Allspring Multi-Sector Income Fund actually hold?

The fund invests across multiple fixed-income sectors. A typical portfolio includes [corporate bonds](/corporate-bond/) from investment-grade and below-investment-grade (high-yield) companies, government and agency bonds, preferred stocks from banks and utilities, and sometimes loans to lower-quality borrowers. The "multi-sector" label means the fund does not specialize in one type of bond but spreads capital across several to diversify risk. By holding securities from different industries and credit qualities, the fund aims to capture higher yields than a portfolio of only [Treasury bonds](/treasury-bond/) or only investment-grade corporate bonds, while reducing the risk of owning only [high-yield bonds](/high-yield-bond/).
