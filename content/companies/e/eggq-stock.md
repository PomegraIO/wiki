---
title: "NestYield Visionary ETF (EGGQ)"
description: "An actively managed ETF holding growth-oriented companies selected for their innovation, profitability, and competitive moats, managed by NestYield."
keywords:
  - growth equity
  - active management
  - ETF
...
EGGQ is an actively managed exchange-traded fund issued by NestYield. Unlike index-tracking funds, it is managed by a portfolio team that selects individual stocks based on proprietary research rather than passively replicating a published benchmark. The fund targets companies with sustainable competitive advantages and the capacity to grow earnings over multi-year periods.

## The investment approach and mandate
...
The "Visionary" brand suggests the fund favors companies with strong competitive advantages and transformative potential, not just cheap stocks or index constituents. That can mean higher valuations than a passive fund would accept, in exchange for the belief that earnings growth will justify the price over time. During periods when growth is out of favor and value is cheap, such a fund can lag.

The fund is not a day-trading vehicle or a market-timing tool. It is intended for long-term investors who believe in the managers' ability to select companies that will outperform over years, and who accept the volatility and occasional underperformance that comes with active, growth-oriented investing.
...
For an investor considering EGGQ, the decision hinges on whether the managers' stock-picking track record is compelling enough to justify the active fee, and whether the fund's growth tilt aligns with the investor's overall portfolio strategy. Active management can deliver outperformance, but it requires conviction in the team's ability and tolerance for periods of underperformance.
