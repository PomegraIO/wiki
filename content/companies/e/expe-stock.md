...
description: "Expedia Group operates a portfolio of online travel agencies and travel-technology platforms that connect travellers with flights, hotels, car rentals, and experiences worldwide, earning revenue primarily from commissions and advertising."
keywords:
...
|---|---|
| **Ticker** | EXPE (NASDAQ) |
| **Founded** | 1996 (as a Microsoft spin-off; Expedia Inc. in 1999) |
| **Headquarters** | Seattle, Washington |
| **Sector** | Online travel and hospitality |
| **Primary Brands** | Expedia, Hotels.com, Vrbo, Cruises.com, Trivago |
| **Business Model** | Commission on bookings + advertising revenue |
| **SEC CIK** | 0001324424 |

</aside>

Expedia's story is intertwined with the transformation of travel from an offline, agent-driven business to a direct-booking, algorithmic market. When Expedia launched in 1996 as a [Microsoft](/msft-stock/) online service, hotel reservations were still largely made by calling a hotel directly or using a travel agent. The rise of the internet and the shift in consumer behavior toward booking their own trips created a massive new market, and Expedia capitalized on it by building a simple, searchable inventory of properties and flights and making it easy for consumers to compare and book all at once. Over three decades, the company has evolved from a pure-play consumer website into a technology platform that powers bookings for partners and supplies travel data to third-party sites.
