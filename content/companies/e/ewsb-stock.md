---
title: "EWSB Bancorp, Inc. /MD/ (EWSB)"
description: "NASDAQ-listed community bank chartered in Maryland, capitalized through equity and deposits, focused on maintaining regulatory capital requirements and generating returns through net interest margins and fee income."
keywords: [community bank, NASDAQ, capital requirements, bank equity, deposits, net interest margin]
---

*The capital structure of **EWSB Bancorp, Inc. /MD/ (EWSB)** is inseparable from banking regulation. Unlike most public companies, banks cannot simply maximize debt or minimize [shareholders' equity](/balance-sheet/) because regulators mandate minimum capital ratios. This constraint shapes everything: how much the bank can lend, how much interest spread it needs to earn, how it can return capital to owners, and even which markets it can enter. Reading EWSB's balance sheet is reading the regulatory walls that contain it.*

<aside class="wiki-infobox"><table>
<tr><td>Ticker</td><td>EWSB</td></tr>
<tr><td>Listing</td><td>NASDAQ</td></tr>
<tr><td>SEC CIK</td><td>2013792</td></tr>
<tr><td>Sector</td><td>Financials</td></tr>
<tr><td>Industry</td><td>Regional & Community Banks</td></tr>
...
The core profit for EWSB comes from the gap between the interest it pays on deposits and the interest it earns on loans. If deposits cost 2% annually and loans yield 6%, the [net interest margin](/operating-margin/) is 4 percentage points. On $900 million in loans, that is $36 million in gross interest profit.
...
The bank's loan-loss reserves are also relevant: [shareholders' equity](/balance-sheet/) is reduced by estimated losses on bad loans. If EWSB's loans are souring (more defaults, lower recovery rates), the allowance for loan losses grows, reducing [earnings](/income-statement/) and capital ratios.

## Profitability and Retained Earnings

For a mature, profitable community bank, the path to capital growth is profitability. Each year, EWSB generates net income (after all expenses, loan losses, and taxes). Some of that income is distributed as [dividends](/dividend/); the rest is retained. Retained earnings grow [shareholders' equity](/balance-sheet/), which increases the bank's regulatory capital and growth capacity.

A bank with 12% [return on equity](/return-on-equity/) can grow its equity by 12% annually (if it retains 100% of earnings) or by 6% (if it distributes half as [dividends](/dividend/)). The bank's growth is thus capped by its profitability unless it raises additional [equity capital](/stock/).
