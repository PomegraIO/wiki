---
title: "Emera Incorporated (ERRAF)"
description: "Emera is a North American utility holding company that owns and operates regulated electric and gas distributors across Canada and the Caribbean, generating steady earnings from essential infrastructure."
keywords:
  - electric utility
  - natural gas
  - regulated utilities
...
Emera Incorporated is a holding company that owns and operates regulated electric and [natural gas](/natural-gas/) utilities across eastern Canada and the Caribbean. Its largest subsidiary, Nova Scotia Power, provides electricity to most of Nova Scotia; other utilities serve customers in New Brunswick, Prince Edward Island, and island nations across the Caribbean including Barbados, The Bahamas, and Jamaica. Like most regulated utilities, Emera operates in a sheltered business with predictable demand, stable cash flows, and returns shaped by government oversight rather than raw competition. That regulatory environment makes Emera's earnings forecastable and its [dividend](/dividend/) attractive to conservative investors, but it also caps growth and ties the company tightly to regulators' willingness to allow rate increases.

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>ERRAF (OTC)</td></tr>
<tr><th>Parent Listing</th><td>EMA (Toronto Stock Exchange)</td></tr>
<tr><th>Headquarters</th><td>Halifax, Nova Scotia, Canada</td></tr>
<tr><th>Sector</th><td>Regulated utilities (electric and gas)</td></tr>
<tr><th>Flagship Business</th><td>Nova Scotia Power (electricity distribution)</td></tr>
<tr><th>Geographic Reach</th><td>Eastern Canada and the Caribbean</td></tr>
<tr><th>SEC CIK</th><td>0001127248</td></tr>
</table>
</aside>
