...
The core unit economics are: the cost of electricity purchased plus the cost of operating the charger and network divided by the total kWh delivered over a period. A charger's profitability depends heavily on utilization—how many hours per day it is actively charging. A charger in heavy use can generate strong margins; a charger with low utilization cannot recover its fixed costs (the [depreciation](/depreciation/) and maintenance of the equipment and location lease). EVgo's network includes chargers in varied locations: high-traffic corridors between cities, urban centers, retail parking lots. Utilization varies widely, and company profitability is the average across the network. Factors driving utilization include EV adoption rates (more EVs means more demand for charging), density of competing chargers, and the convenience of the location.
