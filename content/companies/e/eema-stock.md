---
title: "iShares MSCI Emerging Markets Asia ETF (EEMA)"
description: "A passively managed ETF tracking large- and mid-cap companies across developing Asian economies including China, India, Taiwan, South Korea, and Southeast Asia via the MSCI Emerging Markets Asia Index."
keywords:
  - emerging markets
  - asia
  - ETF
...
The fund trades on the [NASDAQ](/nasdaq/), so it can be bought and sold in real time during market hours at prices that move with the underlying basket. [Bid-ask spreads](/bid-ask-spread/) are typically tight; daily volume is substantial. An investor can hold EEMA as a single line item in a brokerage account and gain exposure to a diversified slice of developing Asia without researching or picking individual companies.
