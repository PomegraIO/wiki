...
As a lead-generation platform, EverQuote is not capital-intensive in the traditional sense: it requires no physical infrastructure, inventory, or manufacturing. However, it is customer-acquisition-intensive. To grow, the company must spend aggressively on marketing, and that spend is expensed immediately rather than capitalized. This means that [free cash flow](/free-cash-flow/) can lag net income if the company is in a growth phase (spending more than revenue), or can exceed it if the company is harvesting existing traffic and reinvesting modestly. The company has experimented with returning capital via [dividends](/dividend/) or buybacks, but leverage and cash position remain the constraining factors. As a platform play, EverQuote is structurally unlikely to generate the free-cash-flow multiples of more capital-light businesses like pure software; it remains a customer-acquisition business with inherent CAC-to-LTV dynamics.
...
- [/evfm-stock/](/evfm-stock/)
- [/evgo-stock/](/evgo-stock/)
</div>
