---
title: "VanEck Video Gaming and eSports ETF (ESPO)"
description: "ESPO tracks companies in video gaming and competitive esports—both hardware makers and game publishers, streaming platforms, and esports operators. A thematic ETF betting on entertainment and cultural shifts toward interactive media."
keywords:
  - video gaming
  - esports
  - entertainment
...
ESPO is a thematic exchange-traded fund betting on the growth of video gaming and competitive esports. The fund holds a portfolio of companies that generate revenue from gaming hardware, game publishing, streaming infrastructure, tournament operations, and ancillary services. Sponsored by VanEck, it trades under the ticker ESPO and appeals to investors who see the shift toward interactive entertainment as a long-term structural trend.
...
Research typically starts with the VanEck website, which publishes the full holdings list, the methodology for determining what counts as gaming-and-esports revenue, and historical performance. Gaming industry research reports, stock analysts covering game publishers and hardware makers, and esports league sponsorship data all provide context for the sector. Following announcements about new game releases, hardware upgrades, or tournament viewership can help frame whether ESPO's price reflects existing trends or is pricing in new growth. As with any single-sector fund, it is most useful not as a core portfolio holding but as an expression of a specific conviction about an industry's trajectory.
