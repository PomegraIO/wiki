...
description: "A community bank holding company operating primarily in the St. Louis, Kansas City, and Springfield regions, earning revenue from net interest margins and fee-based services."
keywords: ["EFSC", "community bank", "net interest margin", "deposits", "commercial lending", "St. Louis banking"]
---

*Enterprise Financial Services Corp (EFSC) operates a community bank focused on commercial and consumer lending in the central United States. Its core unit economics rest on the gap between what it pays depositors and what it charges borrowers — the net interest margin — supplemented by modest fee income from deposits and loan services.*

<aside class="wiki-infobox"><table>
<tr><td><strong>Ticker</strong></td><td>EFSC</td></tr>
<tr><td><strong>CIK</strong></td><td>1025835</td></tr>
<tr><td><strong>Listing</strong></td><td>US Public</td></tr>
<tr><td><strong>Sector</strong></td><td>Financial Services</td></tr>
<tr><td><strong>Industry</strong></td><td>Banking / Community Bank</td></tr>
<tr><td><strong>Type</strong></td><td>Bank Holding Company</td></tr>
</table></aside>

## The Spread: A Banker's Core Transaction

Every dollar EFSC lends originates from deposits it holds or wholesale funding it purchases. A simple transaction: accept a $100,000 deposit from a customer at 0.5% annual interest, lend $100,000 to a small business at 6.5% interest. The spread — 6% — is the bank's gross earnings before credit losses and operating costs.
...
## Fee Income: The Secondary Engine

Beyond spread, EFSC earns fees: overdraft fees ($25–$35 per incident), account maintenance ($8–$15 per month on some products), wire transfer fees ($15–$25), and service charges on loan servicing and referrals. In aggregate, these might represent 15–25% of a community bank's total revenue.

For EFSC, fee income is important but secondary. A large deposit base of 100,000 consumer accounts at an average of $10 per account per year in fees generates $1 million revenue. But that same $1 billion in deposits, loaned out at a 3.8% margin, yields $38 million in gross interest income. The lever is spread, not fees.
...
EFSC must cover operating costs: branch staff, loan officers, IT systems, compliance, and deposits insurance. These costs are largely fixed regardless of asset size. A $5 billion asset community bank has only slightly higher headquarters overhead than a $3 billion bank. This creates operating leverage: each incremental $1 billion in loans and deposits (earning spread and generating some fee income) requires minimal additional fixed cost, so marginal net income is high.

Conversely, if EFSC shrinks (loan portfolio declines, deposits flee), fixed costs do not shrink proportionally, and margins compress.

## Return on Equity: Where Spread Converts to Shareholder Value
...
### Closely related
- [/stock/](/stock/) — EFSC shares trade on a public exchange
- [/common-stock/](/common-stock/) — The equity EFSC shareholders hold
- [/10-k/](/10-k/) — EFSC's annual filing details its loan portfolio, deposit base, and net interest income
- [/balance-sheet/](/balance-sheet/) — Shows EFSC's assets (loans), liabilities (deposits), and equity

### Wider context
- [/securities-and-exchange-commission/](/securities-and-exchange-commission/) — Regulator overseeing EFSC's filings
- [/stock-exchange/](/stock-exchange/) — Marketplace where EFSC stock trades
</div>
