---
title: "Evaxion A/S (EVAX)"
description: "Danish immunotherapy biotech using AI-driven platform to design personalized cancer vaccines and immuno-oncology treatments."
keywords:
  - biotech
  - cancer vaccines
  - immunotherapy
...
Evaxion is pre-revenue and cash-negative, requiring ongoing [equity](/stock/) financing to fund clinical trials and R&D. The company raised capital via NASDAQ IPO, venture funding, and strategic partnerships (such as agreements with pharma partners to co-develop certain programs). Each clinical trial costs tens of millions and spans years; Evaxion's [balance sheet](/balance-sheet/) reflects a classic biotech burn pattern. The company has publicly disclosed capital needs and runway, but runway extensions depend on successful interim trial data or partnership deals that provide milestone payments and upfront capital. Clinical failures (a program missing efficacy endpoints or encountering safety issues) would accelerate cash depletion and force down-rounds or asset sales.
