...
description: "Industrial motion and position sensor manufacturer; micro-cap NASDAQ-listed US producer serving machinery and automation markets."
keywords: ["industrial sensors", "NASDAQ", "manufacturing", "automation equipment", "motion sensors"]
---

*Read **ELECTRO SENSORS INC** (ELSE) through its capital structure and the fixed assets that define it as an industrial manufacturer—the tooling, assembly lines, inventory of specialty components, and the working capital cycle that links customer orders to cash collection.*

<aside class="wiki-infobox"><table>
<tr><td>Ticker</td><td>ELSE</td></tr>
<tr><td>Listing</td><td>NASDAQ</td></tr>
<tr><td>SEC CIK</td><td>351789</td></tr>
<tr><td>Sector</td><td>Industrials</td></tr>
<tr><td>Industry</td><td>Electronic Components & Sensors</td></tr>
<tr><td>Type</td><td>US Public Corporation</td></tr>
</table></aside>

## Asset Base: The Maker's Balance Sheet
...
Small industrial suppliers often struggle with customer concentration. If Electro Sensors' top ten customers account for 60% or more of sales, the balance sheet's accounts receivable line may reflect a few very large invoices. The aging of receivables—how many days past due customer invoices are outstanding—is disclosed in the 10-K. A company with customers that pay reliably shows receivables aging of 30–40 days; one with 60-day-past-due amounts is either extending credit strategically (risky for a small company) or collecting poorly (worse).
...
The 10-K footnotes detail contingencies—pending litigation, warranty obligations, or customer refund rights—that do not yet appear as liabilities on the balance sheet but may materialize. For Electro Sensors, product liability is a real risk: if a sensor fails and leads to machinery damage, a lawsuit could impose six-figure or seven-figure costs. The balance sheet may carry a warranty reserve, but if the reserve is too low, the company faces an unexpected hit to equity.

## Scale and Sustainability

Electro Sensors is a true micro-cap, likely with under $50 million in annual revenue. At that scale, the balance sheet must be lean: minimal corporate overhead, no extravagant capital spending, and careful management of customer credit. A balance-sheet-first view asks whether the assets shown are being fully deployed to generate revenue, or whether the company is carrying excess capacity and hidden inefficiency.

The key metric is asset turnover—annual revenue divided by total assets. A sensor manufacturer turning assets over 2–3 times per year (revenue is 2–3x total assets) is typical; one with 1x or lower is either capital-intensive or inefficient. For Electro Sensors, an improvement in asset turnover while holding debt flat signals operational leverage and genuine progress.
