---
title: "enCore Energy Corp. (EU)"
description: "A US-based in-situ recovery uranium producer focused on domestic production in high-grade deposits across the American West."
keywords:
  - uranium mining
  - in-situ recovery
  - energy sector
...
Regulatory approval is non-negotiable and sometimes unpredictable. Wyoming, where many enCore projects are sited, is politically sympathetic to resource development, but final permits must satisfy state and federal environmental and water-quality standards. In-situ recovery raises technical regulatory questions about aquifer restoration and chemical management that differ from conventional mining, and agencies continue refining their evaluation criteria. Any permit denial or material delay would compound [execution risk](/execution-risk/).
