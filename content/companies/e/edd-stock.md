---
title: "Morgan Stanley Emerging Markets Domestic Debt Fund, Inc. (EDD)"
description: "EDD is a closed-end fund that invests in local-currency bonds issued by emerging-market governments and corporations, offering dollar-based investors exposure to emerging-market debt without currency hedging."
keywords:
  - emerging markets
  - fixed income
  - closed-end fund
...
<table>
<tr><th>Ticker</th><td>EDD (NASDAQ)</td></tr>
<tr><th>Fund type</th><td>Closed-end fund</td></tr>
<tr><th>Manager</th><td>Morgan Stanley Investment Management</td></tr>
<tr><th>Sector</th><td>Fixed income / emerging markets</td></tr>
<tr><th>Primary holdings</th><td>Local-currency emerging-market bonds</td></tr>
<tr><th>Key feature</th><td>Unhedged currency exposure</td></tr>
<tr><th>SEC CIK</th><td>0001388141</td></tr>
</table>
</aside>
...
Understanding EDD requires checking three things regularly: the fund's net asset value per share and the market price at which shares trade, which reveals whether the fund trades at a premium or discount to its holdings. That information typically appears in financial data sources and on the fund manager's website. The fund's holdings document, updated regularly, shows which countries and which specific bonds make up the portfolio. And any investor should understand the currency composition — what percentage of holdings are in each currency, since that drives much of the total return.

The annual prospectus and the fund's quarterly reports, filed with the SEC, outline the investment strategy, the fee structure, and the risks. Because EDD is a closed-end fund, it also pays out distributions, and tracking the frequency and amount of those distributions helps assess whether the fund is delivering the income an investor expects.
