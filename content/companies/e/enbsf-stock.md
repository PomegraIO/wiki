---
title: "Enbridge Inc (ENBSF)"
description: "Enbridge operates North America's largest crude oil pipeline network and serves millions through natural gas utilities and renewable assets — a regulated energy infrastructure backbone generating steady, recurring revenue."
keywords:
...
<table>
<tr><th>Ticker</th><td>ENBSF (OTC); ENB (TSX)</td></tr>
<tr><th>Headquarters</th><td>Calgary, Alberta</td></tr>
<tr><th>Founded</th><td>1949</td></tr>
<tr><th>Primary business</th><td>Crude oil pipelines, natural gas utilities, energy distribution</td></tr>
<tr><th>Major asset</th><td>Mainline pipeline system (crude oil, 19,000+ miles)</td></tr>
<tr><th>Revenue model</th><td>Regulated tariffs and utility rates</td></tr>
<tr><th>Geographic footprint</th><td>Canada (Alberta, BC, Ontario, Quebec) and U.S. (Midwest, Gulf Coast)</td></tr>
<tr><th>SEC CIK</th><td>0000895728</td></tr>
</table>
</aside>

## The core business: moving crude and serving customers

Enbridge's foundation rests on two pillars: pipeline transportation and utility distribution. The **Liquids Pipelines** segment operates the largest crude oil and liquids infrastructure on the continent, transporting more than 3 million barrels per day through systems that span from Alberta and Saskatchewan to U.S. Midwest refineries and the Gulf Coast. The company's flagship Mainline system, which has evolved since its founding in 1949 as Interprovincial Pipe Line, remains one of the most critical energy conduits in North America.

Complementing this, the **Gas Distribution** segment serves approximately 2 million customers through utilities in Ontario, Quebec, and across U.S. Midwest states. These utilities provide natural gas for heating, cooking, and industrial processes, operating under regulatory frameworks that ensure reliable service and fair returns on capital invested.

## Revenue and the advantage of scale
...
| Segment | Business | Revenue driver | Outlook |
|---|---|---|---|
| Liquids Pipelines | Crude oil and condensate transportation | Tariffs per barrel; throughput volume | Dependent on drilling activity; long-term demand uncertain |
| Gas Distribution | Natural gas utilities serving retail customers | Regulated utility rates | Steady; tied to customer base and heating degree-days |
| Energy Services | Trading, optimization, and marketing | Spreads on volume movement | Modest; supports larger infrastructure business |
| Renewable Energy | Wind, solar, and hydroelectric assets | Power sales and capacity payments | Growing but small relative to legacy business |
