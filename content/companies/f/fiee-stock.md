---
title: "FiEE, Inc. (FIEE)"
description: "A specialized finance and payments company focused on fractional-fee lending and installment financing, with a balance sheet composed primarily of consumer receivables and debt-financed operations."
keywords: ["fintech lending", "consumer finance", "installment payments", "receivables finance", "debt leverage"]
---

*The **FiEE, Inc. (FIEE)** balance sheet is an inversion of traditional banking: instead of owning branches and deposits, it owns consumer receivables—promissory notes from borrowers—and funds them with debt. The business is the gap between what it pays for capital and what borrowers pay for loans.*

<aside class="wiki-infobox">
<table>
<tr><td>Ticker</td><td>FIEE</td></tr>
<tr><td>Listing</td><td>NASDAQ</td></tr>
<tr><td>SEC CIK</td><td>1467761</td></tr>
<tr><td>Sector</td><td>Financial Services</td></tr>
<tr><td>Industry</td><td>Consumer Finance</td></tr>
<tr><td>Type</td><td>Lending Company</td></tr>
</table>
</aside>
...
FiEE originates loans through multiple channels: direct-to-consumer platforms (web, app), employer partnerships (advances on wages), payroll integrations, and point-of-sale partnerships (at checkout). Each channel has distinct acquisition costs and borrower quality. Direct channels may have higher acquisition costs but simpler servicing; employer partnerships may offer stickier customers but require revenue sharing.

The balance sheet grows only if originations exceed payoffs and defaults. A contraction in any origination channel—say, a major employer partnership ending—directly shrinks the receivables asset base and forces either debt payoff or asset sales. This differs fundamentally from a bank, which can shrink slowly through deposit outflows; FiEE's balance sheet has less flexibility.
