---
title: "Fidelity Disruptive Automation ETF (FBOT)"
description: "FBOT is Fidelity's actively managed fund betting on the automation and robotics wave — a curated portfolio of about 56 companies building or benefiting from machine intelligence and robotic systems across industries."
keywords:
  - thematic ETF
  - automation
  - robotics
...
<tr><th>Launch</th><td>Actively managed (no target index)</td></tr>
<tr><th>Holdings</th><td>Approximately 56 stocks</td></tr>
<tr><th>Strategy</th><td>Automation & robotics companies</td></tr>
<tr><th>Management approach</th><td>Fundamental research, curated selection</td></tr>
<tr><th>Traded on</th><td>NASDAQ (liquid, standard spreads)</td></tr>
<tr><th>Rebalance</th><td>Ongoing by portfolio managers</td></tr>
</table>
</aside>
...
It is ill-suited for passive index investors wanting [diversification](/diversification/) or for those with low risk tolerance. The concentrated portfolio and active management also mean a higher [expense ratio](/expense-ratio/) than a broad passively indexed ETF.

## Research path

Start with Fidelity's prospectus, fact sheet, and current holdings list. The prospectus lays out the investment criteria and management approach; the holdings list shows which companies Fidelity is backing. Compare FBOT's performance and volatility over multiple [market cycles](/market-cycle/) to both broad equity indices and to other automation-focused funds to understand where it sits on the risk spectrum. Monitor Fidelity's commentary on the automation sector and watch for large portfolio shifts, which signal whether the team's conviction is shifting.
