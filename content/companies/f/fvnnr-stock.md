---
title: "Future Vision II Acquisition Corp. (FVNNR)"
description: "FVNNR represents the separable rights issued as part of Future Vision II Acquisition Corp.'s SPAC units, allowing investors to trade partial ownership claims independent of the underlying shares."
keywords:
  - SPAC
  - warrant
  - rights
...
FVNNR is a derivative security created from the decomposition of FVNNU units, representing the right to receive fractional ordinary shares of Future Vision II [Acquisition](/acquisition/) Corp. When Future Vision II completed its [initial public offering](/initial-public-offering/) in September 2024, each unit bundled together one ordinary share and one-tenth of a right to receive an additional ordinary share upon a successful [business combination](/business-combination-purchase/). Beginning in November 2024, the company permitted unitholders to elect separate trading of these components: the shares trade under the symbol FVN, the rights trade under the symbol FVNNR, and the original bundled units continue to trade under FVNNU.

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>FVNNR (NASDAQ)</td></tr>
<tr><th>Underlying Security</th><td>Future Vision II Acquisition Corp. ordinary shares</td></tr>
<tr><th>Right Type</th><td>Fractional right (0.1 per unit)</td></tr>
<tr><th>Separation Date</th><td>November 2024</td></tr>
<tr><th>Exercise Mechanism</th><td>Automatic upon business combination</td></tr>
<tr><th>Parent Company</th><td>Future Vision II Acquisition Corp.</td></tr>
<tr><th>SEC CIK</th><td>0002010653</td></tr>
</table>
</aside>

## Origins in the SPAC Unit

The history of FVNNR begins with the structure of the SPAC unit itself. When a SPAC raises capital through an initial public offering, it typically issues units to make the investment more attractive to retail and institutional buyers. A single unit at ten dollars per share represents a bundle of a share plus a sweetener—historically, a warrant or a fraction thereof. The warrant or right is a [call option](/call-option/) on the [common stock](/common-stock/), exercisable at a fixed price once the SPAC merges with an operating company. Future Vision II's architects chose to include one-tenth of a right per unit, rather than, say, a full warrant, in order to fine-tune the leverage profile and appeal to investors with different risk tolerances.
