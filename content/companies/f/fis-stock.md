...
description: "Major fintech company providing core banking, payments, capital markets software and processing to banks, financial institutions, and businesses worldwide."
keywords:
  - fintech
  - banking software
  - payments processing
...
The company faces competition, but the market is largely divided by segment. In core banking, FIS competes primarily with [Jack Henry & Associates](/jkhy-stock/) (smaller, focused on smaller banks) and private enterprise vendors like Temenos. In payments, the competitive landscape is more fragmented and includes [Visa](/v-stock/), [Mastercard](/ma-stock/), and various specialized processors. In capital markets, Bloomberg, FactSet, and niche platforms compete for trading and analytics business. No single competitor matches FIS's breadth.
