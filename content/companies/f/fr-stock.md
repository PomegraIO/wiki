...
description: "First Industrial Realty Trust is a real-estate investment trust owning and leasing industrial and logistics properties in the United States, focused on warehouse and distribution facilities."
keywords:
...
<table>
<tr><th>What it is</th><td>A publicly traded real-estate investment trust (REIT) owning industrial properties</td></tr>
<tr><th>Asset class</th><td>Warehouse, distribution, and industrial buildings</td></tr>
<tr><th>Geographic focus</th><td>United States, concentrated in major logistics hubs</td></tr>
<tr><th>Primary revenue</th><td>Rent paid by tenants occupying the properties</td></tr>
<tr><th>Business model</th><td>Own land and buildings, lease to industrial/logistics operators</td></tr>
<tr><th>Dividend strategy</th><td>REITs distribute most taxable income to shareholders as dividends</td></tr>
<tr><th>SEC CIK</th><td>0000921825</td></tr>
</table>
</aside>

First Industrial Realty Trust owns industrial real estate—warehouses, distribution centers, manufacturing facilities, and logistics parks—across the United States and leases them to tenants who operate the businesses inside. The company is structured as a real-estate investment trust, or REIT, which means it must distribute the bulk of its income to shareholders as [dividends](/dividend/) rather than retaining it. In return, REITs do not pay federal income tax at the corporate level; they are conduits that pass through income to unitholders, who pay tax on their share.
...
Competition in the REIT space is intense. Other large [industrial REITs](/industrial-reit/)—[EastGroup Properties](/egp-stock/), Rexford Industrial, [Terreno Realty](/trno-stock/), and others—compete for the same tenants and properties. The industry has consolidation dynamics: larger REITs can spread costs across bigger portfolios and often trade at lower yields, making it easier to raise capital. Smaller REITs must work harder to compete. Additionally, institutional investors (pension funds, insurance companies, sovereign wealth funds) have emerged as direct competitors for industrial real estate, as the asset class has become mainstream.

To understand First Industrial, investors should review the 10-K filing (SEC CIK 0000921825) to examine the lease portfolio: which tenants occupy which properties, the size and duration of each lease, and the rent per square foot. Quarterly reports reveal occupancy, rent-growth trends, and acquisitions. The REIT's [dividend yield](/dividend-yield/), [leverage ratios](/leverage-ratio-forex/), and interest-coverage trends are relevant to assessing the margin of safety. As with any REIT, the question is whether the rent growth and property-value appreciation will exceed [inflation](/inflation/) and provide steady dividend returns to shareholders, or whether changing supply-chain patterns, a recession, or rising [cap rates](/cap-rate/) will compress valuations.
