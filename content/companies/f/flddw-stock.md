---
title: "Fold Holdings, Inc. (FLDDW)"
description: "Fold Holdings operates a digital rewards platform that incentivizes customers with cryptocurrency or cash rebates for everyday spending through partner merchants."
keywords:
  - fintech
  - rewards program
  - cryptocurrency
...
<table>
<tr><th>Ticker</th><td>FLDDW (OTC)</td></tr>
<tr><th>Business</th><td>Digital rewards and loyalty platform</td></tr>
<tr><th>Revenue sources</th><td>Transaction fees, merchant partnerships, reward costs</td></tr>
<tr><th>Primary rewards</th><td>Bitcoin and other cryptocurrency, cashback</td></tr>
<tr><th>Model</th><td>Intermediary between merchants, networks, and customers</td></tr>
<tr><th>SEC CIK</th><td>0001889123</td></tr>
</table>
</aside>

The rewards business has long been dominated by credit-card issuers and loyalty programs run by merchants themselves. Those programs offer miles, points, or cashback — small percentages of spending that give customers a reason to use a particular card or shop at a particular store. Fold exists in that ecosystem, but with a difference: it wraps the rewards layer in a standalone app that aggregates partners, and it offers cryptocurrency — particularly [bitcoin](/bitcoin/) — as the primary reward medium.

At its core, Fold operates at the intersection of three industries: fintech, rewards networks, and cryptocurrency adoption. The proposition to customers is simple: link your payment methods into the Fold app, shop through Fold's partner merchants or networks, and earn bitcoin or cash instead of points or miles. The proposition to merchants is [acquisition](/acquisition/) and retention: Fold brings customers who are motivated specifically by the reward structure and are willing to choose one merchant or network over another to maximize their earnings.

The revenue model rests on two legs. First, the company takes a portion of the transaction fees that payment networks (Visa, [Mastercard](/ma-stock/), and others) charge merchants for processing payments. These network fees are typically a small percentage of the transaction value — less than two percent — and Fold captures a portion of them through its partnerships. Second, the company benefits from merchant partnerships: brands pay Fold to have their offers featured prominently in the app, to access the customer base, or to run promotional campaigns. Together, these flows need to exceed the cost of the rewards paid out to customers and the operational expenses of running the platform.
