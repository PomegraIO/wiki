---
title: "Fidelity National Financial, Inc. (FNF)"
description: "Fidelity National Financial is a title-insurance and settlement-services company that processes millions of real-estate transactions annually, generating recurring revenue from a fixed cost base."
keywords:
  - title insurance
...
FNF's immediate rivals are [Old Republic International](/ori-stock/) and [Assured Guaranty](/ago-stock/), both title insurers, plus a set of regional and local title companies that remain fragmented. National consolidation has given FNF and Old Republic a duopoly over perhaps three-quarters of the U.S. market by premium volume, which is a genuine advantage—customers prefer a single national platform to coordinating across dozens of local ops.

The regulatory environment is the true constraint. State insurance commissioners regulate title-policy pricing in most jurisdictions, which limits the price increases FNF can push through even when it has pricing power. Loan-origination regulations (Dodd-Frank, TRID, Qualified Mortgage rules) also shape FNF's mortgage-services business. These rules do not change often, but when they do they ripple through the entire operation. Regulators are also sensitive to title-company concentration—any [merger](/merger/) with Old Republic would face genuine antitrust risk—so FNF's path to growth is organic, not via consolidation.
