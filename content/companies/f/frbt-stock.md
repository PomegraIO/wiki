---
title: "Forbright, Inc. (FRBT)"
description: "US-listed company focused on sustainable finance and environmental lending, filing as FRBT with SEC CIK 1925062."
keywords: [sustainable finance, environmental lending, green banking, ESG investing, community development finance, climate solutions, impact investing]
---
...
<tr><td>Ticker</td><td>FRBT</td></tr>
<tr><td>Listing</td><td>US public markets</td></tr>
<tr><td>SEC CIK</td><td>1925062</td></tr>
<tr><td>Sector</td><td>Finance</td></tr>
<tr><td>Industry</td><td>Environmental Banking & Green Finance</td></tr>
<tr><td>Type</td><td>Public company</td></tr>
</table></aside>

## Why Environmental Finance Is Neither Pure Cyclical Nor Pure Structural

Forbright's business model sits in a peculiar economic position. On the surface, lending secured by renewable energy assets, green buildings, or pollution-control equipment appears countercyclical or structural—capital flowing toward problems that worsen during [recessions](/recession/) (climate risk, energy cost [inflation](/inflation/), regulatory tightening). Yet Forbright's fortunes depend on two factors that oscillate quite differently. First, the availability and cost of capital to Forbright itself fluctuates with macroeconomic conditions and [credit cycles](/credit-cycle/); a lending business that funds long-dated assets must access money markets that freeze during financial stress. Second, demand for environmental solutions does shift with economic sentiment and policy: venture into renewables, retrofit buildings, or develop sustainable supply chains primarily when corporate [balance sheets](/balance-sheet/) are healthy and governments fund climate initiatives. Forbright cannot isolate itself from the [business cycle](/business-cycle/), no matter how noble its purpose.
...
### Closely related
- [REIT fundamentals](/real-estate-investment-trust/)
- [Green bonds and environmental finance](/bond/)
- [How to read a 10-K](/10-k/)

### Wider context
- [Stock exchanges and public listings](/stock-exchange/)
- [Return on equity](/return-on-equity/)
- [Earnings and cash flow](/earnings-per-share/)
</div>
