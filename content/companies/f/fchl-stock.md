---
title: "Fitness Champs Holdings Ltd (FCHL)"
description: "Small fitness club chain operator; unit economics driven by per-member monthly fees, facility overhead, and member churn and acquisition costs."
keywords: ["fitness industry", "gym operations", "member retention", "unit economics", "recurring revenue"]
---

*A fitness chain operator with a small but defined footprint, **Fitness Champs Holdings Ltd (FCHL)** (CIK [2023796](https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&CIK=0002023796)) earns revenue by selling monthly or annual memberships and retaining members over time. The unit economics of a gym are governed by a straightforward equation: monthly membership fee per member minus the allocated cost of facility operation, equipment [depreciation](/depreciation/), and labor, spread across the size of the active member base. A gym that charges $50 per month, operates at a cost of $15,000 per month, needs 300 members to break even—and profits when it keeps those members and adds more.*

<aside class="wiki-infobox"><table>
<tr><td>Ticker</td><td>FCHL</td></tr>
<tr><td>Listing</td><td>OTC Markets</td></tr>
<tr><td>SEC CIK</td><td>2023796</td></tr>
<tr><td>Sector</td><td>Consumer Discretionary</td></tr>
<tr><td>Industry</td><td>Health & Fitness Services</td></tr>
<tr><td>Type</td><td>Fitness Club Operator</td></tr>
</table></aside>
...
### Closely related
- [/fchs-stock/](/fchs-stock/) — Another consumer services operator with recurring revenue model
- [/fcuv-stock/](/fcuv-stock/) — Comparison to non-subscription revenue model

### Wider context
- [/stock/](/stock/) — Equity valuation for subscription businesses
- [/operating-margin/](/operating-margin/) — How facility leverage affects profitability
- [/free-cash-flow/](/free-cash-flow/) — Cash conversion in capital-intensive expansions
- [/return-on-equity/](/return-on-equity/) — Return expectations for re-invested acquisition spending
