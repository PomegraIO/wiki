---
title: "FIDELITY D & D BANCORP INC (FDBC)"
description: "Community bank holding company; unit economics driven by net interest margin between deposit costs and loan yields, adjusted for loan loss provisions and operating expense ratios."
...
<tr><td>SEC CIK</td><td>1098151</td></tr>
...
The magnitude of this margin is sensitive to the interest rate environment. In a low-rate environment (such as 2021–2022 in the U.S.), deposit competition is muted and many banks pay near-zero interest on deposits, while loan yields are also compressed. The NIM may be healthy even in low absolute rates. In a rising-rate environment, deposit rates rise as depositors demand higher returns, and loan rates may lag; NIMs compress. A sudden deposit outflow (such as the regional banking stress in 2023) forces a bank to pay higher rates or lose deposits, further compressing margins until loan yields catch up.
...
A bank's operating expenses—salaries, technology, branch rent, compliance, loan servicing—create a cost base that must be covered by net interest income. The expense ratio is expressed as a percentage of assets or revenue. A bank with $500 million in assets and $8 million in annual operating expenses has an expense ratio of 1.6% ($8M / $500M).

The leverage effect is powerful: if a community bank grows assets from $500 million to $750 million by originating new loans and winning deposits, and if operating expenses grow only 10% (due to process improvement or technology leverage), the expense ratio drops from 1.6% to 1.07%, significantly boosting net profitability. Conversely, if assets shrink (due to loan runoff or deposit outflows) and expenses do not decline proportionally, the expense ratio rises, compressing returns.
...
### Closely related
- [/fchs-stock/](/fchs-stock/) — Comparison to non-financial business model with different unit economics
- [/fchl-stock/](/fchl-stock/) — Recurring revenue comparison to bank deposit stickiness

### Wider context
- [/balance-sheet/](/balance-sheet/) — How banks structure assets, liabilities, and capital
- [/income-statement/](/income-statement/) — Net interest income and provision expense in banking
- /net-interest-margin/ — Core profitability metric for banks
- [/return-on-equity/](/return-on-equity/) — How capital constraints affect bank profitability
- /risk-management/ — Credit losses and provisioning in lending
- [/common-stock/](/common-stock/) — How bank equity investors are affected by leverage and capital rules
