...
Key metrics to track: adjusted operating earnings (reported separately from GAAP earnings to isolate the operating business from investment gains and losses), [return on equity](/return-on-equity/) (constrained by capital requirements), and the level of statutory capital and risk-based capital ratios (which determine [dividend](/dividend/) and buyback capacity). Competitor comparisons are useful—Voya Financial, Reinsurance Group of America, and Assurant offer different product mixes but reveal how pricing and spread dynamics vary across the insurance spectrum.
