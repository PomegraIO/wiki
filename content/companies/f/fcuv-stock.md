---
title: "FOCUS UNIVERSAL INC. (FCUV)"
description: "Small technology and electronics company; unit economics dependent on per-unit manufacturing cost, wholesale or retail markup, and inventory turnover velocity."
keywords: ["electronics manufacturing", "technology products", "unit cost structure", "inventory management", "distribution model"]
---

*A small-cap technology and manufacturing company, **FOCUS UNIVERSAL INC. (FCUV)** (CIK [1590418](https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&CIK=0001590418)) operates on the economics of producing and distributing electronic products or components. The unit-level profitability of such a company is determined by the spread between the cost to manufacture or acquire a unit, the price at which it can be sold, and the efficiency with which units move from inventory to customer. A product that costs $10 to source or manufacture but sells for $25 wholesale creates a unit margin of $15 before operating overhead; profitability depends on how many units the company sells and how quickly it turns inventory.*

<aside class="wiki-infobox"><table>
<tr><td>Ticker</td><td>FCUV</td></tr>
<tr><td>Listing</td><td>OTC Markets</td></tr>
<tr><td>SEC CIK</td><td>1590418</td></tr>
<tr><td>Sector</td><td>Information Technology</td></tr>
<tr><td>Industry</td><td>Electronics & Manufacturing</td></tr>
<tr><td>Type</td><td>Electronics Company</td></tr>
</table></aside>
...
### Closely related
- [/fchdf-stock/](/fchdf-stock/) — Comparison to capital-intensive commodity production
- [/fchs-stock/](/fchs-stock/) — Services company with different throughput model

### Wider context
- [/gross-profit-margin/](/gross-profit-margin/) — How product COGS and pricing determine profitability
- [/operating-margin/](/operating-margin/) — Fixed overhead allocation in manufacturing
- [/balance-sheet/](/balance-sheet/) — Inventory and working capital management
- [/free-cash-flow/](/free-cash-flow/) — How inventory turnover affects cash generation
- [/return-on-equity/](/return-on-equity/) — Capital efficiency in manufacturing operations
