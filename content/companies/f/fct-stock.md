---
title: "FIRST TRUST SENIOR FLOATING RATE INCOME FUND II (FCT)"
description: "First Trust Senior Floating Rate Income Fund II is a closed-end fund focused on senior secured floating-rate corporate loans, seeking high current income through exposure to the leveraged lending market."
keywords:
  - floating rate loans
  - closed-end fund
  - senior secured debt
...
First Trust Senior Floating Rate [Income Fund](/income-fund/) II is a closed-end fund dedicated to investing in senior secured floating-rate loans made to private companies. It is one of a family of similar funds from First Trust Advisors, all designed to capture the income that comes from the floating-rate debt market — a corner of the credit world where [interest rates](/interest-rate/) adjust with market conditions rather than fixing at a set percentage for the life of the loan.

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>FCT (NYSE)</td></tr>
<tr><th>Fund Type</th><td>Closed-end fund (fixed income)</td></tr>
<tr><th>Manager</th><td>First Trust Advisors L.P.</td></tr>
<tr><th>Investment Focus</th><td>Senior secured floating-rate loans</td></tr>
<tr><th>Primary Objective</th><td>High current income</td></tr>
<tr><th>Secondary Objective</th><td>Capital preservation</td></tr>
<tr><th>SEC CIK</th><td>0001282850</td></tr>
</table>
</aside>

## The emergence of first trust and the floating-rate fund family

First Trust Advisors L.P., based in Chicago, grew to become a major asset manager by launching dozens of specialized [closed-end funds](/closed-end-fund/) aimed at different income segments. The floating-rate loan space became an increasingly important product line as the asset class matured. Senior secured floating-rate loans — loans made to private and mid-market companies that sit at the top of the capital structure, backed by collateral, with interest rates that move with benchmark rates like [SOFR](/sofr/) — offered attractive yields in environments where fixed-rate [bonds](/bond/) carried lower returns.
