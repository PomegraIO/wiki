---
title: "Fidelity Ethereum Fund (FETH)"
description: "Fidelity Ethereum Fund is a spot Ethereum exchange-traded fund offering direct exposure to Ethereum's price performance, managed by Fidelity Investments."
keywords:
  - ethereum ETF
  - spot ethereum
...
Fidelity's reputation and custody capabilities are the competitive advantage. Fidelity Crypto, a division of the firm, has been providing institutional custody for digital assets for years. That operational and technical experience gives Fidelity credibility in securing Ethereum for the fund.

## The business model and fee structure

FETH's economics follow the same pattern as other ETFs. The fund charges an annual management fee — typically around 0.25 percent or lower — which covers custodial costs, operational expenses, regulatory compliance, and Fidelity's profit margin. Assets under management scale the fee revenue directly: a $10 billion fund at 0.25 percent annual fee generates $25 million in annual revenue for Fidelity.
...
Ethereum's price volatility is substantial. FETH shares will experience price swings of 5 to 20 percent or more within months or even weeks, driven by technical developments on the network, competitive threats from other blockchains, regulatory announcements, and the broad sentiment cycle around cryptocurrency.
...
An investor in FETH is not primarily investing in Fidelity or in the fund structure; they are investing in Ethereum. The key question is whether Ethereum belongs in a portfolio, not whether FETH is the right Ethereum vehicle.

That said, review FETH's fee structure against competitor offerings. IBIT and EETH (BlackRock's Ethereum ETF) should charge roughly similar fees; any significant difference is a reason to question one product's cost structure.

Understand Ethereum's network activity and use cases. Examine on-chain metrics like daily active addresses, transaction volumes, and the types of applications and users active on the network. Are more applications being built? Are existing applications seeing growing usage? These are not direct valuation metrics, but they inform whether Ethereum's utility is expanding or contracting.

Monitor Ethereum's competitive position. How are Solana, Polygon, and other alternative blockchains performing? Are developers and capital flowing toward or away from Ethereum? Network effects are Ethereum's primary moat; if that moat is eroding, the long-term value proposition weakens.

Finally, understand Ethereum's technical roadmap. The protocol undergoes periodic upgrades that can affect transaction speed, fees, and supply dynamics. Major upgrades are public and telegraphed well in advance; understand what changes are coming and how they might affect the network's competitiveness.
