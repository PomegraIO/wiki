---
title: "FingerMotion, Inc. (FNGR)"
description: "A technology services company providing payment processing and software platforms to merchants in developing markets, particularly in Asia."
keywords: [fintech, payment-processing, merchant-services, Asia, software, mobile-payments, emerging-markets]
---
...
The economics are potentially high-margin. If FingerMotion processes one million dollars in transactions in a month and charges a 2 percent fee, it earns $20,000 in that month from that revenue stream. As transaction volumes scale, [gross-profit-margin](/gross-profit-margin/) can exceed 60 percent because the marginal cost of processing an additional transaction is tiny.
...
### Closely related
- [/fnko-stock/](/fnko-stock/) — a different fintech, similar scale
- [/fnctf-stock/](/fnctf-stock/) — another technology services company

### Wider context
- [/stock](/stock/) — how to research public equities
- [/10-k](/10-k/) — reviewing risk disclosures and business model in annual filings
- [/free-cash-flow](/free-cash-flow/) — assessing whether a company generates cash
