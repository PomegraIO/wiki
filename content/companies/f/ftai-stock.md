...
description: "FTAI Aviation is a specialised equipment leasing and component services company focused on the commercial aircraft sector—a long-cycle business that thrives when carriers need capital-efficient alternatives to ownership."
keywords:
  - aircraft leasing
  - aviation parts
  - operating leases
...
<table>
<tr><th>Ticker</th><td>FTAI (NASDAQ)</td></tr>
<tr><th>Sector</th><td>Aviation services / equipment leasing</td></tr>
<tr><th>Business model</th><td>Operating leases + component services</td></tr>
<tr><th>Primary customer base</th><td>Commercial airlines globally</td></tr>
<tr><th>Asset class</th><td>Aircraft, engines, parts, related equipment</td></tr>
<tr><th>Revenue source</th><td>Lease payments, parts sales, maintenance agreements</td></tr>
<tr><th>SEC CIK</th><td>0001590364</td></tr>
</table>
</aside>
...
Beyond traditional leasing, FTAI owns and operates a substantial fleet of out-of-service aircraft—planes that have been retired from revenue service but retain residual value. These aircraft are stored, dismantled for components, or readied for [secondary markets](/secondary-market/) (cargo operators, government or private use, or less-developed carriers willing to buy older equipment). This segment is countercyclical to new-aircraft leasing: when airlines are strong and fleets are busy, stored aircraft are worth less as spare material; when demand weakens and fleets shrink, the backlog of stored planes becomes valuable for parts and for conversion into cargo service.
...
The industry also depends on access to capital. When [credit spreads](/credit-spread/) widen or debt markets tighten, lessors find it harder and more expensive to finance new aircraft [acquisitions](/acquisition/). FTAI must manage the maturity wall—balancing the timing of debt maturities against forecast cash generation and fleet opportunities.
...
Key metrics frame the lessor's health: the ratio of debt to [EBITDA](/ebitda/) (showing leverage relative to cash generation), the percentage of revenue from top-ten customers ([concentration risk](/concentration-risk/)), average lease duration (longer is more stable), and the fair-value estimates of the stored fleet and engines awaiting sale or parts harvesting. A high percentage of revenue from a few large carriers signals [counterparty risk](/counterparty-risk/); a balanced portfolio across geographies and airline creditworthiness is a sign of prudent underwriting. The company's book value per share reflects the net assets (aircraft less debt), and [price-to-book multiples](/price-to-book-multiple/) show how the market values the residual risks that pure accounting figures don't capture.
