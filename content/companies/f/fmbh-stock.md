...
description: "A regional bank holding company spanning Illinois and Missouri, evolved through acquisitions from a single-market community bank into a multi-state operator."
keywords: ["regional bank", "Illinois", "Missouri", "bank holding", "FMBH", "community banking"]
---
...
<tr><td><strong>Ticker</strong></td><td>FMBH</td></tr>
<tr><td><strong>Listing</strong></td><td>Public</td></tr>
<tr><td><strong>SEC CIK</strong></td><td>700565</td></tr>
...
This strategy had clear economic logic: it allowed FIRST MID to grow without proportionally increasing corporate overhead. A single accounting department, loan-review function, and management team could oversee deposits and assets across multiple markets more efficiently than each market could have operated independently. Geographic [diversification](/diversification/) also reduced [concentration risk](/concentration-risk/)—if one community faced economic stress, the broader company's portfolio was not devastated.

The [acquisitions](/acquisition/) also allowed FIRST MID to achieve scale advantages relative to single-market banks. A chain of ten small-town banks operating with unified systems and centralized management could negotiate better terms with technology vendors, reduce per-employee [expense ratios](/expense-ratio/), and attract capital at lower cost than any of the ten operating independently. By the early 2000s, FIRST MID had become a recognizable mid-sized regional bank with billions in assets and dozens of branch locations.
...
The company's survival depends on maintaining a disciplined focus on profitable lending, careful credit management, and retention of deposits in its markets. The 10-K disclosures reveal how management navigates these constraints: through careful monitoring of loan-loss reserves, discipline on nonperforming assets, and cost management. The company's [return-on-equity](/return-on-equity/) must be scrutinized in context of [operating-margin](/operating-margin/) and [capital ratios](/balance-sheet/)—if the company is earning acceptable returns despite structural headwinds, it suggests astute management; if returns are compressed, the company may be struggling to justify its independent existence.
