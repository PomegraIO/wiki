---
title: "Cohen & Steers Closed-End Opportunity Fund, Inc. (FOF)"
description: "A closed-end fund managed by Cohen & Steers that invests in a diversified portfolio of closed-end funds and other securities, seeking total return through both income and capital appreciation."
keywords:
  - closed-end fund
  - fund of funds
  - diversification
...
|---|---|
| **Ticker** | FOF (NASDAQ) |
| **Manager** | Cohen & Steers Capital Management |
| **Fund type** | Closed-end fund (fund of funds) |
| **Primary holdings** | Other closed-end funds |
| **Distribution policy** | Monthly distributions |
| **SEC CIK** | 0001375340 |
| **Strategy** | Multi-strategy closed-end fund allocation |
...
Like many closed-end funds, FOF may use borrowing to amplify its purchasing power. This leverage is typically modest — perhaps 25 to 35 percent — but it does increase both potential gains and downside risk. During market stress, leverage can force portfolio adjustments as lenders demand more collateral or [interest rates](/interest-rate/) on borrowed funds spike. The terms of any borrowing are disclosed in the fund's documents.

The fund's risk profile is modulated by the kinds of closed-end funds it holds. An allocation heavy in equity funds carries more volatility than an allocation tilted toward bond funds; an allocation including commodity or [real estate funds](/real-estate-fund/) adds different sources of risk and return. Understanding the fund's current exposure requires examining its holding breakdown in its latest factsheet or [annual report](/10-k/).

## Researching this fund

To understand FOF's prospects, investors should review the fund's latest factsheet and annual report, which detail the underlying closed-end fund holdings and their weightings. Look at the composition of those holdings — how much equity exposure, bond exposure, alternatives, and real estate does the fund have indirectly? Review the current premium or discount to NAV and understand whether that valuation is rich or cheap relative to historical norms. The fund's [expense ratio](/expense-ratio/), including the underlying fees embedded in the closed-end funds it holds, should be weighed against the benefit of having a professional team do the closed-end fund selection. Finally, track the distribution rate and ask whether it is sustainable given the underlying yields available or whether it relies on [capital gains distributions](/capital-gains-distribution/) or return of principal.
