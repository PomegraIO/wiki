---
title: "YieldMax Dorsey Wright Featured 5 Income ETF (FEAT)"
description: "FEAT is an income-focused ETF that holds five large-cap dividend-paying stocks, selected using a proprietary methodology. It seeks to generate yield while managing downside risk through its featured-stock strategy."
keywords:
  - dividend income
  - income stocks
  - large-cap
  - featured stock strategy
  - dorsey wright
  - yield
handwritten: true
---
...
<table>
<tr><th>Ticker</th><td>FEAT (BATS)</td></tr>
<tr><th>Fund sponsor</th><td>YieldMax</td></tr>
<tr><th>Strategy partner</th><td>Dorsey Wright and Partners</td></tr>
<tr><th>Inception</th><td>2018</td></tr>
<tr><th>Type</th><td>Equity ETF</td></tr>
<tr><th>Portfolio structure</th><td>Exactly five large-cap stocks</td></tr>
<tr><th>Selection criterion</th><td>Dividend income and quality factors via Dorsey Wright methodology</td></tr>
</table>
</aside>
...
FEAT's core purpose is to generate income. The fund's five holdings are selected specifically because they pay meaningful dividends, and the equal weighting ensures that each contributes equally to the portfolio's yield. For investors seeking a liquid, diversified way to hold dividend-paying stocks, the concentrated structure offers simplicity: there is no need to monitor dozens of positions or worry about which dividend stocks to overweight or underweight.
...
FEAT is suited to income-focused investors — retirees, near-retirees, and others seeking quarterly cash flows — who want a simple, transparent, actively curated portfolio rather than a hands-on stock-picking exercise. The ultra-concentrated structure appeals to investors who trust the Dorsey Wright methodology and prefer concentrated bets over broad diversification.
