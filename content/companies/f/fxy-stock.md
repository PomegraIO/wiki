---
title: "Invesco CurrencyShares Japanese Yen Trust (FXY)"
description: "FXY is an exchange-traded fund tracking the Japanese yen against the US dollar, letting investors own yen exposure through a stock-exchange-traded vehicle without entering the forex market."
keywords:
  - Japanese yen
  - currency ETF
  - foreign exchange
...
A professional forex trader can buy and sell yen directly through a currency dealer, often with leverage and without holding physical deposits. That is more complex and requires a special account. FXY exists for investors who want straightforward stock-exchange access to yen exposure. The trade-off is that FXY charges a small [management fee](/management-fee/) and may trade at a slight premium or discount to its net asset value, whereas a direct forex transaction has only a [bid-ask spread](/bid-ask-spread/).
...
Tracking the yen's movements requires watching three things: interest-rate expectations in Japan and the US, the health of Japanese export demand and the global economic cycle, and geopolitical news from East Asia. The [Federal Reserve](/federal-reserve/) and the [Bank of Japan's](/bank-of-japan/) announcements move FXY most decisively. Reading economic news about Japan's manufacturing activity, exports, and any statements from the Bank of Japan about [monetary policy](/monetary-policy/) will provide context for the fund's price.

As with any single security, FXY shares trade at prices set by supply and demand on the [stock exchange](/stock-exchange/), and nothing here is a recommendation to buy or sell — only an explanation of why investors hold yen and what moves its value.
