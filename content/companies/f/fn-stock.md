---
title: "Fabrinet (FN)"
description: "Fabrinet is a Singapore-based optical and electronic subsystems manufacturer supplying hyperscalers and networking equipment makers with pluggable transceivers and complex assemblies for data center and telecommunications infrastructure."
keywords:
  - optical subsystems
...
Unlike a fabless chipmaker, Fabrinet runs actual factories. It operates manufacturing plants across multiple geographies to reduce [concentration risk](/concentration-risk/) and to stay close to customers and suppliers. The company has invested heavily in advanced manufacturing technologies — precision molding, automated assembly, optical testing, and packaging capabilities that rival some semiconductor contract manufacturers. This capital intensity means that when utilization is high, the company generates strong cash flow. When utilization drops, fixed costs become an anchor.
...
Start with the [10-K filing](/wiki/10-k/) (CIK 1408710), which discloses revenue by customer and region, [operating margins](/operating-margin/), and capital expenditure plans. Watch quarterly earnings calls for commentary on order trends, customer inventory levels, and gross margin trajectory. Key metrics include revenue growth (a proxy for capex cycles at hyperscalers), gross margin (a sign of pricing power and competition), and [free cash flow](/wiki/free-cash-flow/) conversion (a measure of how effectively capital is being deployed).
