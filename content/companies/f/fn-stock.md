...
Start with the [10-K filing](/wiki/10-k/) (CIK 1408710), which discloses revenue by customer and region, operating margins, and capital expenditure plans. Watch quarterly earnings calls for commentary on order trends, customer inventory levels, and gross margin trajectory. Key metrics include revenue growth (a proxy for capex cycles at hyperscalers), gross margin (a sign of pricing power and competition), and [free cash flow](/wiki/free-cash-flow/) conversion (a measure of how effectively capital is being deployed).
