---
title: "First Trust Mid Cap Core AlphaDEX Fund (FNX)"
description: "A mid-cap blend ETF using AlphaDEX methodology to select stocks with strong fundamental qualities across both value and growth characteristics. Offers broad exposure to mid-caps with systematic factor tilt."
keywords:
  - mid-cap blend
...
A core approach makes sense for investors who believe the best mid-cap opportunities do not cluster neatly into either the value or growth camp. Some companies may be trading at a discount to book value (value signal) while simultaneously growing revenue faster than peers (growth signal), scoring well on both dimensions. Others may be fairly valued but operationally strong. By rating all stocks fairly and capturing both types, FNX casts a wider net than a value-only or growth-only fund, which intentionally ignores entire categories of stocks. This breadth is valuable in mid-caps, where the boundary between value and growth is often fuzzy rather than clear-cut.
...
Begin by examining the fund fact sheet, which discloses the current top holdings, sector allocation, and composite valuation metrics of the portfolio. Compare FNX's holdings and performance to its stated benchmark (the Nasdaq AlphaDEX Mid Cap Core Index), to cap-weighted mid-cap alternatives like the Russell Mid Cap Index, and to other factor-based mid-cap funds. Track whether FNX has delivered the outperformance the AlphaDEX philosophy promises, keeping in mind that past results do not guarantee future returns. The prospectus details the full methodology and risks. For broader context on mid-cap stocks generally, reviewing the composition of the NASDAQ US 600 Mid Cap Index itself provides useful perspective.
