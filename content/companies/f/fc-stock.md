---
title: "FRANKLIN COVEY CO (FC)"
description: "A leadership and productivity training company serving organizations globally through training, coaching, and assessment tools in personal and professional development."
keywords:
...
Franklin Covey's business relies on sustained demand for organizational training and development from large employers. Several [execution risks](/execution-risk/) are worth noting. First, the training and facilitation model is labor-intensive; scaling requires continuous investment in trainer recruitment, certification, and capacity management. Second, the company must balance high-margin software revenue (with lower customer [acquisition](/acquisition/) friction) against the slower, relationship-driven sales cycle of large enterprise training contracts. Third, economic downturns or cost-cutting pressure can quickly reduce corporate training budgets, making the business somewhat cyclical despite its strong positioning.
