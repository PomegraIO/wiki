---
title: "First Trust Managed Municipal ETF (FMB)"
description: "FMB is a broad municipal-bond ETF tracking investment-grade tax-exempt debt issued across U.S. states and municipalities, designed for investors seeking regular income with federal tax advantages."
keywords:
  - municipal bonds
  - muni ETF
  - tax-exempt income
...
Municipal bonds offer a distinctive feature in U.S. tax law: interest income is exempt from federal income tax, and often from state and local tax if the bondholder lives in the issuing state. This tax shelter has made munis perennially attractive to investors in higher tax brackets. For such investors, the after-tax yield on a muni bond often exceeds that of a comparable taxable bond, even if the muni's stated yield appears lower. FMB targets investors seeking regular income who value this tax efficiency — typically those with substantial federal tax liability and no particular reason to own munis from only one state.

## Structure and how it trades

FMB is a passively managed ETF that trades on a [stock exchange](/stock-exchange/) ([NASDAQ](/nasdaq/)) and can be bought and sold throughout the trading day at market prices, unlike closed-end muni funds or individual bonds which can be less liquid. It holds dozens or hundreds of individual municipal bonds, each with its own maturity and credit characteristics. The fund's share price moves daily with the market value of its holdings, influenced by changes in prevailing [interest rates](/interest-rate/), credit conditions, and the risk appetite of fixed-income investors more broadly. Its [expense ratio](/expense-ratio/) is competitive — less than most actively managed muni funds and far less than the [implicit trading costs](/implicit-trading-costs/) of assembling a comparable bond portfolio through a [broker](/broker/).

## Portfolio characteristics and duration

FMB is an intermediate-duration fund, meaning its weighted-average maturity and duration fall in the mid-range of the fixed-income spectrum — typically between three and seven years. This positioning balances the benefit of higher yields (which come from longer-duration bonds) against the volatility that comes from being highly sensitive to interest-rate moves. As interest rates rise, the fund's price falls, and vice versa. The specific duration at any moment depends on how the manager aligns the portfolio; the prospectus discloses this key measure.
...
The prospectus is the first document to read — it discloses the fund's objective, permitted holdings, fee structure, and how the manager approaches allocation. The fund's fact sheet, updated monthly, shows the current average quality, duration, yield, and sector composition. Holdings reports show which specific bonds are in the fund at any moment. Investors can compare FMB's performance against other muni ETFs or against muni bond indices to see whether the fund's approach has delivered competitive results. Given that municipal bonds trade less frequently and less transparently than equities, the fund's published yield and past returns are less predictive than they might be for other bond funds, but they offer a useful starting point. Those seeking tax-exempt income or exposure to the muni market should consult their tax adviser about the appropriateness of the investment given their specific situation.
