---
title: "First Trust Multi Cap Value AlphaDEX Fund (FAB)"
description: "ETF holding large-cap and mid-cap stocks selected for low valuations but screened through an algorithmic filter to avoid value traps; blends classic value investing with momentum and quality screens."
keywords:
  - value stocks
  - factor investing
  - AlphaDEX algorithm
...
Because every stock in FAB shares the "value" characteristic, the fund carries what is called factor risk. When the market loves value, FAB does well. When growth dominates, as happened consistently from 2010 to 2020, FAB lags for years. This is not a company-specific risk that [diversification](/diversification/) solves; it is a structural bet on a style of stocks.
...
FAB holds broadly traded, liquid stocks, so the ETF itself trades with reasonable [bid-ask spreads](/bid-ask-spread/). The [expense ratio](/expense-ratio/) is modest for a factor-based fund but higher than a plain index tracker.
