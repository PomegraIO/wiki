---
title: "Federal Home Loan Mortgage Corp (FMCKK)"
description: "Freddie Mac preferred equity from the 2009 restructuring, now tracking the GSE's capital trajectory and conservatorship status rather than pure earnings power."
keywords:
  - Freddie Mac
  - GSE conservatorship
  - preferred equity
...
Freddie Mac moves mortgages. Every quarter, it buys billions in loans from lenders, packages them as securities, and guarantees the timely payment of principal and interest to investors. The guarantee is implicit federal backing—investors rely on the government's commitment to the secondary mortgage market. For this, Freddie Mac charges a guarantee fee, typically in basis points.

The profit centre is thin. Guarantee fees have been tight for years. Net interest margins compress in low-rate environments. The company holds mortgages on its balance sheet, earning the spread between what it pays for funds and what borrowers pay on the loans. When mortgage rates rise sharply, refinancings fall, and the company's portfolio becomes weighted toward older, lower-yielding mortgages. When rates fall, borrowers refinance, and the portfolio resets upward—but refinancings also depress origination volume.

Freddie Mac's employees and operations are real. The company has servicing businesses, loan officers, technology infrastructure, risk management teams. Expenses are substantial. Non-performing loans require active management. But the credit side—the actual risk that a borrower defaults and Freddie Mac absorbs the loss—is almost entirely absent. Agency guarantees backstop nearly everything. The enterprise's business is managing timing, volume, and spreads, not managing default risk.
...
## The governance ambiguity

Will Freddie Mac ever exit conservatorship? The question has hung for over 15 years. Regulators and Congress have not resolved it. Political actors have conflicting incentives—some want to wind down the GSEs, others want to maintain the government's role in housing finance. The preferred shares assume some normalisation occurs: either Freddie Mac is privatised (unlikely), returned to ordinary corporate governance (possible), or granted explicit permanent charter with revised terms (speculative).

Any of these scenarios reshapes the risk profile. Until Congress acts, FMCKK trades on uncertainty rather than on explicit business fundamentals.
...
The enterprise itself is resilient: housing markets persist, mortgages must be financed, and Freddie Mac's operational capability is mature. But the preferred shares are a bet on regulatory normalisation and policy continuity rather than on mortgage-market fundamentals.
