---
title: "First Trust Large Cap Value AlphaDEX Fund (FTA)"
description: "FTA applies value-and-momentum screening to large-cap US stocks, targeting profitable, reasonably priced companies with positive forward signals across economic cycles."
keywords:
  - large-cap value
  - alphadex
  - etf
...
**Cyclical behavior.** Large-cap value stocks move differently across cycles than growth. In expansions when rates are rising and [inflation](/inflation/) is visible, value typically outperforms because investors prize tangible cash flow over promises. A bank earning strong returns on equity and paying [dividends](/dividend/) looks attractive when a software stock trades for 80 times sales with no earnings. But in reflation rallies or rate-cut cycles, growth rotates back in favor, and FTA lags. The momentum component helps: a stock moving from unloved to re-rated captures some of that transition earlier than a pure-value screen.
...
**Costs and structure.** [Expense ratios](/expense-ratio/) typically run 0.60% to 0.75%, higher than a passive large-cap index but cheaper than more active strategies. The screening and rebalancing are systematic, not stock-picker discretion. Large-cap stocks trade constantly; FTA settles quickly with tight spreads. [Position sizing](/position-sizing/) is straightforward for most investors.
