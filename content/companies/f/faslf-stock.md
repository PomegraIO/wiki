---
title: "First Andes Silver Ltd. (FASLF)"
description: "First Andes Silver Ltd. is a mineral exploration and mining company filing with the SEC under CIK 1731854, focused on silver and related precious-metal assets."
keywords: ["mining", "silver", "mineral exploration", "precious metals", "junior mining"]
---

*[**First Andes Silver Ltd.**](/faslf-stock/) (FASLF) is a mineral exploration and precious-metals company engaged in the identification, [acquisition](/acquisition/), and development of silver and related mining projects. Filing with the [Securities and Exchange Commission](/securities-and-exchange-commission/) under CIK 1731854, the company operates as a junior miner or exploration-stage enterprise, meaning it does not currently generate material revenue from mining operations. Analysis of First Andes requires understanding exploration-stage mining economics, the path from exploration to production, and commodity-price exposure.*

<aside class="wiki-infobox"><table>
<tr><td>Ticker</td><td>FASLF</td></tr>
<tr><td>Listing</td><td>OTC Markets</td></tr>
<tr><td>SEC CIK</td><td>1731854</td></tr>
<tr><td>Sector</td><td>Materials / Mining</td></tr>
<tr><td>Industry</td><td>Precious Metals Exploration / Mining</td></tr>
...
Junior mining companies are often valued not on earnings (they don't earn) but on [net asset value](/net-asset-value/) (NAV) of their exploration properties. The NAV is typically calculated by estimating the resources (mineral ounces) in each project, multiplying by a commodity price, and discounting by a risk factor. A project with 10 million ounces of silver at $25/oz has a raw value of $250 million, but junior miners typically trade at a significant discount to NAV (30–70%) to reflect [execution risk](/execution-risk/), funding risk, and market illiquidity. Analysts sometimes calculate a "risk-adjusted NAV" by discounting each project based on its development stage and risk profile. Without doing such a calculation yourself, at minimum understand: what is the implied per-ounce value the market is assigning to First Andes' resources? If the company trades at a very deep discount to comps, that may signal opportunity or hidden risk.
