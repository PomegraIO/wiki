---
title: "GraniteShares YieldBOOST META ETF (FBYY)"
description: "FBYY sells call options against Meta Platforms stock to generate weekly income distributions. Investors trade upside potential for enhanced yield in a strategy designed for sideways markets, not rallies."
keywords:
  - covered call
  - options strategy
  - income generation
...
FBYY packages that trade-off into a weekly-distribution format. GraniteShares holds [Meta Platforms](/meta-stock/) shares and systematically sells [call options](/call-option/) against them, collecting [option premiums](/option-premium/) that flow to investors as regular income. The strategy is transparent and mechanical: own the stock, sell calls on a schedule, pocket the premium, distribute the proceeds, repeat. It appeals to investors who own META but prefer cash in hand over the possibility of explosive gains.

## The mechanics

The fund holds actual Meta shares — no leverage, no derivatives — creating a long equity position. Against that position, it writes (sells) call options, typically with [strike prices](/strike-price/) above the current market price and [expiration dates](/expiration-contracts/) a few weeks or three months out. Buyers of those calls pay the fund a premium — say, $2 per share on a $400 stock. That premium is real cash. The fund pockets it.
...
FBYY's total return to shareholders comes from two sources: the [dividend](/dividend/) META itself pays, plus the option premiums collected. Combined, that yield can exceed META's standalone dividend by a meaningful margin. The trade is explicit: accept a cap on upside gains in exchange for enhanced current income.

In range-bound or declining markets, [covered calls](/covered-call/) shine. A sideways-trading META combined with steady call premiums creates reliable income while the stock itself generates little price appreciation. The premium cushions losses on down days. But in a strong [bull market](/bull-market/), FBYY systematically lags. The fund's shares get called away at the strike, leaving investors to watch the stock continue higher without them.
...
FBYY trades on [NASDAQ](/nasdaq/) with adequate liquidity typical of GraniteShares' products. The [expense ratio](/expense-ratio/) covers the administrative machinery of rolling the calls and managing distributions. The prospectus specifies the call-selection rules — what strike levels, what expiration cycles, how the fund decides when to roll versus let calls expire.
