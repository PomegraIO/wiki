...
Fastly competes in a market where [CDN](/stock/) is increasingly commoditized. Competitors include Akamai (a legacy [CDN](/stock/) giant with dominant market share in media and critical infrastructure), Cloudflare (a younger, growth-focused competitor with edge compute ambitions of its own), Amazon's CloudFront (bundled with [AWS](/stock/) and available to any customer on Amazon's platform), and Google Cloud CDN. Each competitor operates at a different scale and targets different customer segments.
