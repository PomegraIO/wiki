---
title: "First Trust Alternative Absolute Return Strategy ETF (FAAR)"
description: "ETF that uses hedging and alternative investments to chase positive returns regardless of stock-market direction, modeled on hedge-fund tactics but packaged for retail investors in an exchange-traded wrapper."
keywords:
  - absolute return
...
<table>
<tr><th>Ticker</th><td>FAAR (NASDAQ)</td></tr>
<tr><th>Sponsor</th><td>First Trust</td></tr>
<tr><th>What it does</th><td>Hedged, diversified bets across multiple asset classes</td></tr>
<tr><th>Strategy type</th><td>Alternative / absolute return</td></tr>
<tr><th>How it trades</th><td>Exchange-traded; buy and sell during market hours</td></tr>
<tr><th>Who runs it</th><td>Active manager making tactical asset and position calls</td></tr>
</table>
</aside>

## The absolute-return idea made simple
...
Hedge funds charge huge fees — 2 percent of assets plus 20 percent of profits — partly because generating absolute returns is genuinely difficult. The manager has to be right not just on direction but on magnitude and timing. If you think interest rates will rise, you need to be right about how much they rise, by when, and which bonds will suffer most.

FAAR has tried to bring this to retail investors at lower cost. The expense ratio is higher than a 500-fund, but far lower than a hedge fund. The trade-off is that FAAR is constrained compared to a true hedge fund. It cannot use as much leverage. It cannot short-sell as freely. It cannot use as many exotic derivatives.
...
Liquidity is a third risk. The underlying holdings — currency forwards, commodity contracts, less-liquid bonds — trade in specialist markets with wider spreads than large-cap stocks. In a panic, if many investors try to leave FAAR at the same time, the fund might struggle to meet redemptions smoothly.
