---
title: "FATE Therapeutics Inc (FATE)"
description: "Clinical-stage cell therapy company engineering natural killer cells to treat cancer, with manufacturing centered on allogeneic, off-the-shelf production."
keywords:
  - NK cells
  - cell therapy
...
The company's own manufacturing footprint likely consists of controlled bioreactor systems, automated wash and processing equipment, and analytical laboratories for release testing. As clinical trials advance, FATE will either expand these facilities in-house or contract with specialized cell therapy manufacturers. Outsourced manufacturing reduces capital burden but introduces [execution risk](/execution-risk/); the manufacturer's yield, timeline, and quality become FATE's constraints. Integrated manufacturers (those who make their own cell products and licenses) often insource manufacturing to own the cadence; FATE's path to vertical integration is not evident in its filings, suggesting reliance on external partners.
...
Clinical development is capital-intensive. FATE funds operations through equity offerings and strategic partnerships. The company's [balance sheet](/balance-sheet/) carries no significant revenue, only R&D spending, regulatory affairs, manufacturing, and G&A overhead. As trials advance and manufacturing scales, cash burn increases. Many clinical-stage biotech firms fail to raise adequate capital at critical junctures, forcing a fire sale or dissolution. FATE's access to capital depends on trial progress and investor confidence in the allogeneic NK platform's commercial potential.
...
### Closely related
- [FATE Therapeutics peer NK cell developers](/stock/)
- [CAR-T cell therapy economics](/stock/)

### Wider context
- Biotechnology
- [Cancer immunotherapy](/stock/)
- [Clinical trial phases](/10-k/)
- [Cell manufacturing and GMP](/stock/)
</div>
