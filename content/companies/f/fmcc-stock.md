---
title: "FEDERAL HOME LOAN MORTGAGE CORP (FMCC)"
description: "A government-sponsored enterprise backed by federal guarantee, funding mortgage portfolios through agency debt and servicing a secondary market that bridges borrowers and capital."
keywords: ["FMCC", "Freddie Mac", "mortgage", "GSE", "capital structure", "debt"]
---

*The capital structure of **FEDERAL HOME LOAN MORTGAGE CORP (FMCC)**, more commonly called [Freddie Mac](/freddie-mac/), is unlike any listed company. It exists within a federal guarantee: it borrows against the implicit backing of the U.S. government to fund a portfolio of residential mortgages, managing [credit risk](/credit-risk/) and [interest-rate risk](/interest-rate-risk/) on behalf of the secondary mortgage market. Its obligations to the Treasury, its equity position, and its access to capital all flow from that franchise.*

<aside class="wiki-infobox"><table>
<tr><td><strong>Ticker</strong></td><td>FMCC</td></tr>
<tr><td><strong>Listing</strong></td><td>OTC Markets</td></tr>
<tr><td><strong>SEC CIK</strong></td><td>1026214</td></tr>
<tr><td><strong>Sector</strong></td><td>Financial Services</td></tr>
<tr><td><strong>Type</strong></td><td>Government-Sponsored Enterprise</td></tr>
</table></aside>
...
FMCC funds its mortgage portfolio primarily through debt—both [bonds](/bond/) guaranteed by the enterprise itself and by structured securities backed by underlying mortgages. The enterprise issues billions in debt each year, tapping capital markets for funding. The implicit federal guarantee allows it to borrow at yields attractive to institutional investors who are otherwise risk-averse, such as pension funds, foreign [central banks](/central-bank/), and insurance companies.

The debt structure is layered. FMCC issues secured debt backed by mortgage collateral and unsecured debt backed by the enterprise's own credit. In principle, mortgages should pay down the secured debt as homeowners make payments. In practice, when mortgage performance weakens, losses flow to the equity holders (initially shareholders, then the government). This ordering—mortgagees are paid first, then [bondholders](/bond/), then equity—is standard in mortgage markets but inverted relative to corporate debt hierarchies.
...
The enterprise's capital—ostensibly its equity—exists to absorb cumulative losses that exceed reserves. In theory, if losses mount, capital is depleted, and FMCC must be recapitalized by the Treasury. This happened in practice during the 2008 financial crisis, when housing defaults spiked and FMCC's capital was negative; the Treasury injected hundreds of billions to keep the enterprise afloat. From that crisis forward, FMCC has operated under a conservatorship, with the Treasury holding [senior preferred stock](/senior-preferred/) and FMCC required to pay [dividends](/dividend/) to the Treasury from earnings.

## Equity Position and Dividend Constraints

Before the crisis, FMCC was formally a [stock](/stock/) company with [common stock](/common-stock/) and shareholders entitled to dividends. After the 2008 collapse and the Treasury rescue, the enterprise's equity is heavily complicated. The Treasury owns [preferred stock](/preferred-stock/) with priority over common shareholders for any remaining earnings or assets. Common shareholders receive very limited claims on earnings, as the enterprise directs cash to reduce the Treasury's preferred-stock holdings.
...
FMCC's portfolio of mortgages exposes the enterprise to multiple risks: credit risk (borrowers default), [prepayment risk](/prepayment-risk/) (borrowers pay early when rates drop, locking in low-yield mortgages), and interest-rate risk (the [fixed-rate mortgages](/fixed-rate-mortgage-personal/) in the portfolio decline in value when rates rise). Managing these risks requires active hedging—using [derivatives](/bond/) and other instruments to offset exposure.

The enterprise maintains a sophisticated hedging program that offsets much of its interest-rate risk, protecting both the mortgage portfolio and the debt outstanding. But hedging is not perfect; [basis risk](/basis-risk/) and transaction costs ensure that some risk remains. In periods of extreme rate volatility or credit stress, the hedges can fail to perform as expected, and FMCC must absorb losses.
...
- [fmfc-stock](/fmfc-stock/)

### Wider context
- [bond](/bond/)
- [public-company](/public-company/)
- [balance-sheet](/balance-sheet/)
- [mortgage-backed-securities](/bond/)
</div>
