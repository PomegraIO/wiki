---
title: "Shift4 Payments, Inc. (FOUR-PA)"
description: "Shift4 Payments processes payment transactions for hotels, restaurants, and entertainment venues, competing against legacy payment processors and fintech upstarts by offering integrated software and superior customer service."
keywords:
  - payment processing
...
| Field | Detail |
|---|---|
| **Ticker** | FOUR (NYSE); FOUR-PA (preferred shares) |
| **Headquarters** | Atlanta, Georgia |
| **Sector** | Financial services / payment processing |
| **Primary markets** | Hospitality, entertainment, retail |
| **Business model** | Transaction fees, software subscriptions |
| **Competitive position** | Mid-market leader, integrated POS/payments |
| **SEC CIK** | 0001794669 |
