...
The [free-cash-flow](/free-cash-flow/) generation — earnings plus depreciation minus capital expenditure and working-capital changes — is the true measure of shareholder value creation in this lifecycle stage. A company that generates strong free cash flow can return capital, invest in R&D, or pursue acquisitions. One that generates weak cash flow must choose between these options, often resulting in stagnant or declining returns to shareholders.
