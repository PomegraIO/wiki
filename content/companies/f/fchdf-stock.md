---
title: "Fairchild Gold Corp. (FCHDF)"
description: "Small-cap mineral exploration and development company focused on gold projects in Canada; unit economics hinge on ore grades, processing costs, and commodity price spreads."
keywords: ["gold mining", "mineral exploration", "unit economics", "commodity extraction", "junior miner"]
---

*A small, exploration-stage gold company with assets in Canada, **Fairchild Gold Corp. (FCHDF)** (CIK [2048847](https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&CIK=0002048847)) operates on the premise that a well-defined mineral deposit with a favorable per-ounce extraction margin can be developed into an economic mine. The path from prospecting to production spans years and billions of dollars in capital, and the company's viability rests entirely on whether the ore grade, geological continuity, and processing cost structure justify bringing a property into production.*

<aside class="wiki-infobox"><table>
<tr><td>Ticker</td><td>FCHDF</td></tr>
<tr><td>Listing</td><td>OTC Markets</td></tr>
<tr><td>SEC CIK</td><td>2048847</td></tr>
<tr><td>Sector</td><td>Energy & Commodities</td></tr>
<tr><td>Industry</td><td>Metal & Mineral Exploration</td></tr>
<tr><td>Type</td><td>Development-Stage Exploration Company</td></tr>
</table></aside>
...
### Closely related
- [/fcuv-stock/](/fcuv-stock/) — Another small-cap exploration-stage firm with different sector and asset base
- [/fdbc-stock/](/fdbc-stock/) — Publicly listed banking comparison for capital-raising perspective

### Wider context
- [/stock/](/stock/) — Overview of equity structures and risk
- [/balance-sheet/](/balance-sheet/) — How exploration firms present assets and liabilities
- [/free-cash-flow/](/free-cash-flow/) — Why pre-revenue explorers have negative FCF
- [/enterprise-value/](/enterprise-value/) — Valuation method for resource companies
