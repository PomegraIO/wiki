---
title: "First Trust China AlphaDEX Fund (FCA)"
description: "FCA uses First Trust's AlphaDEX rules-based screening to select Chinese small- and mid-cap stocks showing value and momentum. It bets that overlooked companies in less-liquid markets offer pricing inefficiencies worth exploiting."
keywords:
  - china equities
  - small-cap stocks
  - value and momentum
...
The fund's performance depends critically on whether AlphaDEX's screening proves predictive in the Chinese market. Review First Trust's documentation on the system, examine the portfolio's composition and performance over complete [market cycles](/market-cycle/), and assess whether the returns have justified the 0.80 percent fee and the underlying risks.
