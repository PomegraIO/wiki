---
title: "FAIRFAX FINANCIAL HOLDINGS LTD (FRFHF)"
description: "Fairfax Financial is a Canadian insurance and reinsurance holding company that underwrites property, casualty, and specialty insurance globally, with a portfolio of operating subsidiaries and significant holdings in equities."
keywords:
  - insurance
  - reinsurance
...
The holding company structure, while it offers diversification, also creates complexity. Each insurance subsidiary operates under different regulatory regimes (Bermuda, Canada, United Kingdom, Asia, etc.), and each is subject to [capital adequacy](/capital-adequacy/) rules and solvency requirements set by local regulators. Managing capital across a global portfolio of regulated insurers requires sophisticated financial and operational management and creates administrative costs.
