---
title: "MarketDesk Focused U.S. Momentum ETF (FMTM)"
description: "FMTM is an actively managed equity ETF focusing on U.S. stocks exhibiting strong price momentum, managed by MarketDesk and designed for investors seeking exposure to stocks with positive technical trends."
keywords:
  - momentum investing
...
Early versions of momentum strategies in the 1990s and 2000s benefited from very favorable regimes — extended [bull markets](/bull-market/) where the recent winners kept winning. The strategy faced severe tests during market reversals, notably in 2009 and early 2020, when momentum stocks collapsed faster than the broad market as investors fled the names that had led on the way up. More recently, the rise of passive investing and [algorithmic trading](/algorithmic-trading/) has changed the price-action dynamics that momentum strategies once exploited: momentum signals can now crowd faster and reverse just as quickly.
