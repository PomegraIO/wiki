---
title: "GraniteShares 2x Long META Daily ETF (FBL)"
description: "FBL is a daily-reset leveraged ETF that seeks 2x exposure to Meta Platforms stock using derivatives. A tool for tactical positions, not holding periods — leverage compounds losses equally to gains."
keywords:
  - leveraged ETF
  - daily reset
  - Meta Platforms
...
Daily reset mechanics create a structural problem: volatility decay. Suppose META trades sideways over a week, rising 5 percent one day, falling 4 percent the next, rising 3 percent, and so on. On a simple 2x leveraged bet, that week's path would drag the fund's cumulative gain below the 2x multiple of META's actual price return. The more volatile the underlying, the sharper the drag. This is not risk; it is a mathematical property baked into the structure. Over [holding periods](/holding-period/) measured in weeks or months, an investor holding FBL can underperform 2x META exposure simply because the daily rebalancing is forced to lock in losses and rebuild leverage on rally days.

Equally, leverage works both ways. A single down day moves the fund in proportion — a 5 percent drop in META translates to a 10 percent loss in FBL. Over multiple down days, the losses compound. An investor who bought FBL at the top of a bull move and held it through a 30 percent correction in META would face a 60 percent loss.
