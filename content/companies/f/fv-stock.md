---
title: "First Trust Dorsey Wright Focus 5 ETF (FV)"
description: "FV is an actively managed ETF that holds a concentrated portfolio of up to five stocks selected by the Dorsey Wright research process — a quality-focused strategy emphasizing fundamental strength and relative value."
keywords:
...
| Aspect | Detail |
|---|---|
| **Fund type** | Actively managed ETF (not index-tracking) |
| **Strategy** | Concentrated quality value; fundamental stock selection |
| **Typical holdings** | Up to five stocks, large-cap U.S. equities |
| **Manager** | First Trust (with Dorsey Wright research) |
| **Rebalancing** | Periodic, driven by manager selection |
| **Trading** | Stock exchange (ticker FV, typically on an exchange) |
| **Time horizon** | Medium to long-term positions |
...
## Why concentrate so heavily?

The argument for concentration is straightforward: if a manager can identify five stocks that are genuinely superior to others available, owning only those five amplifies outperformance. Spreading capital across 100 mediocre choices dilutes the benefit of the best ideas. Dorsey Wright's view is that disciplined research and quality filters allow them to have high conviction in a small number of positions.

The counterargument is equally straightforward: even skilled managers are wrong sometimes, and a mistake is far more costly in a five-stock fund than in a diversified portfolio. A single earnings miss or unexpected competitive shift in one company causes real damage. Over long periods, many funds with concentrated approaches underperform due to unavoidable bad luck or an analyst call that missed the mark.
...
The most obvious risk is single-company risk: any major adverse event affecting one of the five holdings creates significant drag on the entire fund. Earnings misses, leadership changes, regulatory problems, or shifts in competitive dynamics cascade directly into the fund's value. There is no buffer of other holdings to offset the impact.

A second risk is manager risk. If the Dorsey Wright process loses efficacy — if their edge in stock selection narrows or disappears — FV's returns may lag both the broad market and other actively managed alternatives. Investors should monitor the fund's returns relative to a broad benchmark and relative to its own strategy's track record before it was offered as an ETF.
