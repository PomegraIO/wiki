---
title: "ZTO Express (ZTOEF)"
description: "A Chinese last-mile delivery network that dominates parcel routing through a franchise model, where franchisees bear capital costs and ZTO takes a per-package fee in a thin-margin, high-velocity business."
keywords:
  - express delivery
  - logistics
  - last-mile delivery
...
<table>
<tr><th>Ticker</th><td>ZTOEF (Pink Sheets, US-traded)</td></tr>
<tr><th>Listed</th><td>2016, via reverse merger</td></tr>
<tr><th>Headquarters</th><td>Shanghai, China</td></tr>
<tr><th>Sector</th><td>Logistics and parcel delivery</td></tr>
<tr><th>Business model</th><td>Hub-and-spoke network operated by franchisees</td></tr>
<tr><th>Revenue driver</th><td>Per-package fees on completed deliveries</td></tr>
<tr><th>SEC CIK</th><td>0001677250</td></tr>
</table>
</aside>
...
The second risk is margin compression from rising labour and fuel costs. Wages in China have climbed for years, and wage pressures are strongest in delivery and logistics, where labour is the main input. Fuel costs are global and cyclical. A sustained [inflation](/inflation/) in either input erodes both ZTO's and its franchisees' margins, and if franchisees become unprofitable, the network can fragment as operators leave the business.
...
Key metrics include cost per parcel, franchisee profitability (a canary for network health), and market-share data from industry surveys. The company's [free cash flow](/free-cash-flow/) is a function of volume and margin, so any dislocation between volume growth and cash growth signals operational deterioration. ZTO's business is straightforward — high volume, low margin, efficient scale — and that simplicity is also its constraint. There is no way to grow earnings significantly except by growing parcels or cutting costs.
