...
description: "Cloud-native security company providing zero-trust network access and threat protection through a global cloud platform, serving enterprises globally."
keywords:
  - cloud security
...
| **What it does** | Cloud-native security platform for zero-trust network access, threat prevention, and data protection |
...
This positioning has given Zscaler a structural advantage. As organizations have migrated applications to AWS, [Microsoft](/msft-stock/) Azure, Google Cloud, and SaaS platforms like [Salesforce](/crm-stock/) and Microsoft 365, the old approach of funneling all traffic back through an on-premises security appliance becomes untenable. Zscaler offers an alternative: a cloud-based gateway that sits between users and the internet (and cloud destinations), inspecting traffic in real time and enforcing policy without requiring the appliance to be on-premises or the user to be on a VPN.
