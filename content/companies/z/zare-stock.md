---
title: "Ares Real Estate Income Trust Inc. (ZARE)"
description: "Ares Real Estate Income Trust is a closed-end, non-traded real estate investment trust that invests primarily in commercial real estate properties across the United States, seeking to generate steady income and return capital to investors."
keywords:
...
<table>
<tr><th>Ticker</th><td>ZARE (non-traded)</td></tr>
<tr><th>Structure</th><td>Closed-end, non-traded REIT</td></tr>
<tr><th>Sponsor</th><td>Ares Management Corporation</td></tr>
<tr><th>Inception</th><td>2014</td></tr>
<tr><th>Investment focus</th><td>Commercial real estate</td></tr>
<tr><th>Revenue source</th><td>Rents from property tenants</td></tr>
<tr><th>SEC CIK</th><td>0001327978</td></tr>
</table>
</aside>
...
In reality, this structure also creates a set of risks that traded REITs do not face: illiquidity, agency risk (the sponsor might prioritize its fees over shareholder returns), and NAV uncertainty (properties are appraised, not market-priced, so valuation is less transparent).
...
Ares REIT's properties are screened and managed by Ares' real estate team. The fund typically buys diversified properties—not just office, not just apartments, but a mix aimed at spreading risk. Each property is selected for its cash flow and potential for value appreciation through improvement or market recovery.
...
Non-traded REITs have experienced mixed results. Some have delivered reasonable returns to shareholders while others have disappointed. The problem is lack of transparency. Property valuations are based on appraisals by third parties, but appraisals lag the market and can be optimistic. It is not until a property is actually sold that investors learn whether the stated NAV was real or wishful.
