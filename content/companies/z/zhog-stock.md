---
title: "F/m Opportunistic Income ETF (ZHOG)"
description: "An exchange-traded fund investing in U.S. equities with a focus on dividend yield and income generation, targeting investors who want monthly distributions from a diversified stock portfolio without the constraints of fixed-dividend-only screens."
keywords:
  - dividend ETF
  - income fund
  - equity income
...
The fund uses "opportunistic" to signal flexibility in its selection process — the manager is not confined to companies meeting rigid dividend-yield thresholds, but instead evaluates each holding for its potential to deliver cash to shareholders through dividends, share repurchases, or other mechanisms. The monthly distribution schedule (where available) is a practical feature for investors seeking regular cash flow rather than a mathematical guarantee of yield.

</div>

> Income is only half the story; the other half is whether the company survives and prospers long enough to pay you more next year.

The fund's underlying thesis is that a portfolio of opportunistically selected dividend payers — companies whose boards are committed to returning cash and whose business models sustain that capacity — can generate a meaningful income stream while still participating in long-term capital appreciation. This differs from a pure high-yield screener, which often captures mature, slow-growth businesses or companies under financial stress. ZHOG instead favours companies with durable competitive advantages that happen to pay dividends generously.

## Construction and selection philosophy

The fund does not pursue a rules-based, mechanical approach. Rather, the sponsor evaluates candidates on dividend sustainability, growth trajectory, and underlying business quality. A company with a 4 per cent yield that is growing its dividend mid-single digits and faces no near-term earnings pressure is a different opportunity from a company with a 6 per cent yield that is cutting capital investment to sustain the payout.

This flexibility comes at a cost: the fund's composition can differ significantly from other income-focused competitors. ZHOG may hold fewer healthcare-sector stocks and more financial-sector stocks in one period, or tilt toward industrial cyclicals over consumer staples in another, depending on which companies the sponsor judges offer attractive dividend opportunity at that time.
