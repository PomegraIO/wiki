---
title: "Zoomcar Holdings (ZCAR)"
description: "An India-centric peer-to-peer vehicle-sharing marketplace connecting private car owners with short-term renters. An early-stage, pre-profitability platform business cash-burning as it expands operations."
keywords:
...
<table>
<tr><th>Ticker</th><td>ZCAR (NASDAQ)</td></tr>
<tr><th>Founded</th><td>2013, Bangalore, India</td></tr>
<tr><th>Business model</th><td>Peer-to-peer vehicle marketplace, commission-based</td></tr>
<tr><th>Primary market</th><td>India (urban centers)</td></tr>
<tr><th>SEC CIK</th><td>1854275</td></tr>
<tr><th>Status</th><td>Public (SPAC merger 2021); pre-profitability</td></tr>
</table>
</aside>
...
Finally, understand the capital situation. How much cash does the company have on its [balance sheet](/wiki/balance-sheet/)? At the current burn rate, how many quarters or years of runway remain? Is the company approaching profitability, or will it need to raise capital again (and if so, at what cost to current shareholders)? For early-stage marketplace businesses, capital and time are the scarcest resources, and investors should know how much of each Zoomcar has left.
