---
title: "DirectBooking Technology (ZDAI)"
description: "DirectBooking Technology is a Hong Kong-based travel technology company building AI-powered hotel booking systems and supply-chain solutions for the lodging industry."
keywords:
  - hotel booking
  - travel technology
  - ai-native platform
...
DirectBooking Technology Co., Ltd. ([NASDAQ](/nasdaq/): ZDAI) is a Hong Kong-based company focused on digital infrastructure and AI-powered solutions for the hotel and travel industry. The company trades publicly but remains young and smaller in scale compared to established hospitality tech giants — a technology player attempting to build a new kind of hotel booking platform centered on artificial intelligence rather than the commission-heavy intermediary model that has dominated online travel for two decades.
