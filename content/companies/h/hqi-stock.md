...
description: "A staffing and workforce solutions company providing contingent labor to businesses across multiple industries, built on franchise-model operations and decentralized entrepreneurship."
keywords: [staffing, workforce-solutions, temporary-labor, franchising, employment-services]
---
...
HireQuest's revenue comes from the spread between what customers pay for workers and what the workers themselves earn. If a customer pays HireQuest $20 per hour for a worker, and the worker earns $15 per hour, the $5-per-hour spread (roughly 33% [gross margin](/gross-profit-margin/)) flows to the franchisee and ultimately to corporate. Scaling this model depends on volume—placing thousands of workers across hundreds of branches, each generating modest per-placement margins but creating large aggregate [cash flows](/free-cash-flow/) over time.
...
However, staffing is a low-margin, high-volume business. Margins depend on efficient matching and predictable worker-to-customer ratios. A staffing firm's [operating margin](/operating-margin/) typically ranges from 3 to 7 percent—thin enough that operational inefficiency or customer churn can quickly erase profitability.
