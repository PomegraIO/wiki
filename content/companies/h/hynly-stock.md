---
title: "Hydro One Ltd (HYNLY)"
description: "Hydro One is Canada's largest electricity transmission and distribution company, a regulated utility providing power to millions of customers across Ontario through a monopoly franchise constrained by the regulatory power granted to the Ontario Energy Board."
keywords:
  - electric utility
...
<table>
<tr><th>Ticker</th><td>HYNLY (OTC Markets); TSE: H (primary listing)</td></tr>
<tr><th>Business</th><td>Electricity transmission and distribution</td></tr>
<tr><th>Operating territory</th><td>Ontario and parts of the northeastern United States</td></tr>
<tr><th>Structure</th><td>Regulated monopoly utility; publicly traded company</td></tr>
<tr><th>Regulator</th><td>Ontario Energy Board (primary); state regulators in U.S.</td></tr>
<tr><th>SEC CIK</th><td>0001712356</td></tr>
</table>
</aside>

## The regulated monopoly model

Hydro One operates under a regulated monopoly licence. The company has the exclusive right — within its franchise territory — to build and operate the distribution lines that deliver electricity to homes and businesses. No competitor is allowed to offer an alternative service to those customers. In return for this monopoly, the company accepts strict regulation.

The Ontario Energy Board (and U.S. regulators in the smaller American portions of the system) determine the rates that Hydro One is allowed to charge. The regulator approves a tariff structure that is supposed to allow the utility to recover its costs and earn a fair return on the capital it has invested in the business. This is the fundamental bargain of utility regulation: investors accept a capped return on their equity, in exchange for a predictable, stable business without competition.

Because rates are regulated, Hydro One cannot simply decide to raise prices when costs rise. Instead, it must file a rate application with the regulator, demonstrating why a rate increase is justified. The regulator will hold hearings, receive testimony from customer groups and other interested parties, and then approve a rate increase (or a smaller or larger one than requested). This process takes months and introduces regulatory risk: the company does not know for certain what rates will be approved, and if the regulator denies a requested increase, profitability suffers.

## The capital intensity of distribution
...
One attraction of utility stocks is the predictability of revenue. Because Hydro One is a monopoly with little price elasticity (customers cannot easily reduce their electricity consumption or switch providers), and because electricity demand follows demographic and economic trends that are relatively stable, the company's annual revenue is forecast with reasonable accuracy.
...
One significant tailwind for Hydro One is the broader trend toward grid modernisation and electrification. Governments are investing heavily in electricity infrastructure to support the transition away from fossil fuels. This creates demand for distribution capacity and could justify large capital programs. The regulator, if supportive, can allow Hydro One to recover these investments through rates.

However, regulatory risk is real. Canadian and U.S. regulators are increasingly scrutinising utility profits and sometimes questioning whether utilities are investing capital efficiently. Some regulators have capped the allowed return on equity at levels lower than utilities have historically earned, squeezing profitability.
