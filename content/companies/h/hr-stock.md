---
title: "Healthcare Realty Trust Inc (HR)"
description: "Healthcare Realty Trust is a real estate investment trust focused on owning and leasing medical office buildings and outpatient surgery centers, capturing stable recurring rent from healthcare providers across the United States."
keywords:
  - REIT
...
<table>
<tr><th>Ticker</th><td>HR (NYSE)</td></tr>
<tr><th>Founded</th><td>1992, Nashville, Tennessee</td></tr>
<tr><th>Sector</th><td>Real estate investment trust (REIT) — healthcare</td></tr>
<tr><th>Focus</th><td>Medical office and surgical facility ownership</td></tr>
<tr><th>Business model</th><td>Lease medical properties; distribute taxable income</td></tr>
<tr><th>SEC CIK</th><td>0001360604</td></tr>
</table>
</aside>

## The practical business of owning where doctors work

Healthcare Realty acquires, develops, and manages office buildings and outpatient surgery centers, then leases them to physicians, hospital systems, and standalone operators. The properties are spread across the United States, anchored by long-term leases that commit tenants to fixed rent payments over 5, 10, or even 15 years. [Inflation](/inflation/) escalators embedded in most leases mean the rent typically rises by 2% to 3% annually without the landlord having to renegotiate—a critical feature when inflation erodes the value of fixed-income investments.
...
As a REIT, Healthcare Realty must distribute at least 90% of taxable income to shareholders as a dividend, making it a vehicle primarily for income rather than capital appreciation. This structure offers tax advantages to the firm—REITs pay no [corporate income tax](/corporate-income-tax/) at the entity level—but it means nearly all cash generated flows to shareholders rather than being retained for growth. The company finances growth through debt and new equity issuance.

The dividend is therefore central to the investment thesis. Its stability depends on the occupancy rate (how full the properties are), the creditworthiness of the tenant base, and management's ability to reinvest proceeds from property sales into new, accretive [acquisitions](/acquisition/). Rising [interest rates](/interest-rate/) increase the [cost of debt](/cost-of-debt/), which can pressure margins if rents do not keep pace.
...
Interest-rate sensitivity is real. Since REITs are typically financed with debt and must pay out most cash as [dividends](/dividend/), rising rates simultaneously increase borrowing costs and make [bonds](/bond/) more attractive relative to dividend-paying stocks, creating a double headwind.

## Researching Healthcare Realty as an investment

Start with the company's annual 10-K filing (SEC CIK 0001360604), which details the property portfolio, tenant creditworthiness, lease expiration schedule, and capital structure. Pay attention to the lease-expiration calendar—a cliff of expirations in a single year increases vacancy risk if tenants do not renew. Watch the occupancy rate quarter to quarter; it is the clearest read on whether the business is expanding or contracting. Monitor same-store growth in [net operating income](/net-operating-income/), which isolates the performance of existing properties from the noise of acquisitions and dispositions. And track the [payout ratio](/payout-ratio/)—the dividend as a percentage of taxable income. A ratio above 90% leaves no room for hiccups; sustained ratios below 80% suggest potential for dividend growth.

The quarterly earnings call offers management commentary on tenant health, recent lease negotiations, and capital deployment. For context on healthcare real estate as a sector, check the NAREIT (National Association of [Real Estate Investment Trusts](/real-estate-investment-trust/)) indexes and peer performance, especially against other healthcare-focused REITs, to see whether Healthcare Realty is trading at a premium or discount to the broader category. The business is straightforward once you understand that a REIT is a landlord paying out most of what it collects as rent; the quality of that business turns on the credit and stability of the tenants and the flexibility of the lease terms.
