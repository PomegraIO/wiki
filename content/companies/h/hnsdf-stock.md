---
title: "Hensoldt AG/ADR (HNSDF)"
description: "German defense and aerospace company traded via ADR, filed under SEC CIK 1856488."
keywords: ["defense", "aerospace", "Germany", "ADR", "sensors", "military", "SEC filing"]
---

*Defense procurement and aerospace manufacturing are concentrated among a small number of globally-listed firms, many foreign-incorporated and trading in the US via [American Depositary Receipts](/stock/). **HENSOLDT AG/ADR (HNSDF)**, registered with the [SEC](/securities-and-exchange-commission/) under [CIK 1856488](/10-k/), is a German defense-electronics and sensor manufacturer whose filings introduce both the complexity of foreign [public company](/public-company/) disclosure and the unique dynamics of the defense-industrial base.*

<aside class="wiki-infobox"><table>
<tr><td><strong>Ticker</strong></td><td>HNSDF</td></tr>
<tr><td><strong>Listing</strong></td><td>NASDAQ</td></tr>
<tr><td><strong>SEC CIK</strong></td><td>1856488</td></tr>
<tr><td><strong>Sector</strong></td><td>Industrials</td></tr>
<tr><td><strong>Industry</strong></td><td>Aerospace & Defense</td></tr>
<tr><td><strong>Type</strong></td><td>ADR (Foreign Private Issuer)</td></tr>
</table></aside>

## Foreign private issuer status and streamlined SEC reporting

Hensoldt AG is a German corporation; its [NASDAQ](/nasdaq/)-listed ADRs give US investors exposure to the firm without owning shares directly. As a "foreign private issuer," Hensoldt files annual Form 20-F (or equivalent 10-K/A) with the SEC [CIK 1856488](/10-k/), rather than the quarterly 10-Q filings that US [public companies](/public-company/) submit. The 20-F is filed annually within specified deadlines and provides audited financials, MD&A, and risk disclosures. The firm must disclose in English and reconcile its accounting (IFRS, used in Germany and Europe) to US GAAP if material differences exist. The [depositary bank](/depositary-bank/)—typically [Bank of New York Mellon](/bk-stock/) or similar—holds underlying shares and issues ADRs representing a fixed ratio of German shares. Shareholders voting on corporate matters (board elections, [mergers](/merger/)) vote through the depositary, a process disclosed in [proxy statements](/proxy-statement/) and ADR prospectuses. Currency conversion (euro to US dollar) affects reported results and [dividends](/dividend/); the 20-F discloses the exchange rates used for financial consolidation.
