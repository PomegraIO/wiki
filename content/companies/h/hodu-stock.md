---
title: "Direxion Daily HOOD Bull 2X ETF (HODU)"
description: "A leveraged ETF that amplifies daily price movements of Robinhood Markets stock by 2x using derivatives and daily rebalancing, designed strictly for short-term tactical trading."
keywords:
  - leveraged ETF
  - Robinhood Markets
  - 2x leverage
...
<div class="wiki-infobox-title">HODU — Key facts</div>

|   |   |
|---|---|
| **What it is** | 2x daily leveraged ETF tracking Robinhood Markets (HOOD) |
| **Issuer** | Direxion Shares (Rafferty Asset Management) |
| **Leverage mechanism** | Derivatives (futures, swaps, options) rebalanced daily |
| **Traded on** | NASDAQ |
| **Expense ratio** | Approximately 0.95% annually (high, typical for leveraged single-stock ETFs) |
| **Objective** | 2x daily return of HOOD price movement |
| **Primary use case** | Short-term tactical trading (days to weeks), not long-term holding |
...
As Robinhood's public stock emerged, and with the broader expansion of leveraged single-stock ETF offerings, Direxion introduced HODU — a 2x bull (long) leveraged ETF on HOOD. The product appealed to traders making tactical bullish bets on Robinhood's stock within short time horizons, seeking to amplify daily price swings without managing margin accounts or derivative positions manually. HODU became a venue for leveraged trading on one of the most followed and volatile stocks in the retail trader ecosystem.
...
Daily rebalancing creates a phenomenon called volatility decay, an inescapable consequence of leveraged investing in volatile assets. A simple example illustrates it: suppose HOOD closes at 100 on day one. On day two, it rises 10% to 110. On day three, it falls 9.1% back to 100, where it started. A direct holder of HOOD breaks even over the three days. But a 2x leveraged holder faces a different path. On day two, up 20% (2x 10%) to 120. On day three, down 18.2% (2x 9.1%), which is 18.2% off a base of 120, equaling 98. The leveraged investor ends at 98, having lost 2% despite the underlying stock returning to its starting point.

This decay is not a bug or a market malfunction; it is the mathematical consequence of rebalancing leverage daily when the underlying asset is volatile. The more volatile HOOD is, the faster the decay accelerates. A stock that experiences normal daily swings — oscillating up and down by 1–2% daily — will erode a 2x leveraged position's value by several percentage points per week, compounded over time. Over months, volatility decay can wipe out even a modestly positive underlying stock move.
