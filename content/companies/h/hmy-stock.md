---
title: "Harmony Gold Mining Co Ltd (HMY)"
description: "Harmony is a mid-tier gold miner with operations across South Africa and Africa, focused on lower-cost production and free cash generation from mature underground mines."
keywords:
  - gold mining
  - South Africa
  - underground mining
...
<table>
<tr><th>Ticker</th><td>HMY (multiple exchanges)</td></tr>
<tr><th>Founded</th><td>1950, South Africa</td></tr>
<tr><th>Sector</th><td>Precious metals mining</td></tr>
<tr><th>Primary commodity</th><td>Gold</td></tr>
<tr><th>Operating regions</th><td>South Africa, Ghana, Australia</td></tr>
<tr><th>Business model</th><td>Mine and sell gold at spot prices</td></tr>
<tr><th>SEC CIK</th><td>0001023514</td></tr>
</table>
</aside>

## Gold from deep shafts and open pits

Harmony's roots run to South Africa, where it has operated underground mines in the Witwatersrand region for decades. Deep underground gold mines are complex: they go thousands of meters down, face heat and water, and require constant investment just to maintain access to ore. This is different from an open-pit operation where you can shovel material from the surface. Underground mines are expensive to run, but if the deposit is rich enough and deep enough, they can produce gold for years at a time.

The company's portfolio includes deep underground shafts, some of which have operated for generations, alongside newer operations in Ghana and an Australian mine acquired from another company. Each operation is its own little world: different ore grades, different costs, different mine lives. Some are very mature; others are still ramping up. The portfolio itself is the strategy — not betting everything on one mine or one country, but spreading the production across several assets so that problems in one place do not sink the whole ship.

## How a gold miner actually makes money
...
Operating deep underground mines is harder than surface mining. Every thousand meters of depth adds cost and risk — more heat, more water to pump out, longer travel times for workers and equipment. Harmony's oldest operations are among the deepest in the world. There is a physical limit to how deep you can economically mine; past a certain point, the infrastructure costs exceed the value of the ore. Some of Harmony's shafts are approaching that line, which means the company is always balancing: keep mining a productive shaft that is getting expensive, or shift capital to newer mines with lower costs per ounce.

The South African mines also sit in a high-cost country. Labor is unionized, electricity is supplied by a state utility that has struggled with reliability, and regulatory compliance is strict. These are real burdens compared to mining in some other jurisdictions. But South Africa has deep, rich ore bodies that have not run out yet, and decades of infrastructure to support mining. The math still works if you run it efficiently.
...
Gold mining faces regulatory risk — environmental rules, labor rules, and the threat of nationalization or confiscatory taxes in countries where mineral wealth sits. South Africa is a stable democracy, but any government can raise taxes on mining companies or restrict their ability to export the metal. Ghana and Australia have their own regulatory flavors. Harmony cannot control these risks; it can only adapt and hedge its bets across multiple countries.

There is also replacement risk: as ore bodies deplete, the company must find or acquire new ones to keep production steady. Exploration is expensive and uncertain. A company that stops finding or buying new mines will eventually shrink. Finally, like any company with deep operations, Harmony faces operational hazards — equipment failure, safety incidents, and the simple challenge of managing thousands of workers in difficult conditions. A major accident can halt production and create massive costs, even if the mine itself is profitable.
