...
description: "HSBC is one of the world's largest banks, with a global footprint and a long history as a merchant bank rooted in Asian trade — a universal bank managing enormous complexity across multiple geographies and regulatory regimes."
keywords:
  - global banking
  - investment banking
  - wealth management
...
HSBC is a high-dividend-yield, capital-return story — an income stock for investors comfortable with banking risk and accepting that growth will be slow. The 10-K (SEC CIK 0001089113) lays out the bank's business segments, capital ratios, deposit and loan trends, and detailed risk disclosures. Any investor should track several metrics: the net interest margin (the spread the bank earns on its loan book), the [cost-to-income ratio](/cost-income-ratio/) (a proxy for efficiency), the non-performing loan ratio (an early warning sign of credit deterioration), and the capital ratios (which determine how much the bank can return to shareholders).
