---
title: "Hines Global Income Trust, Inc. (HGIT)"
description: "Hines Global Income Trust is a real estate investment trust that owns and operates a portfolio of income-producing commercial properties across multiple geographic regions and property types, distributing rental income to shareholders."
keywords:
...
<table>
<tr><th>Ticker</th><td>HGIT (OTC)</td></tr>
...
<tr><th>Geographic Scope</th><td>Global / multi-regional</td></tr>
<tr><th>Property Types</th><td>Office, industrial, retail, hospitality</td></tr>
<tr><th>Revenue Source</th><td>Rental income and property operations</td></tr>
<tr><th>SEC CIK</th><td>0001585101</td></tr>
</table>
</aside>

## Office real estate — the anchor segment
...
The industrial segment is not risk-free. Construction has ramped up significantly as investors have chased industrial yields, which may eventually lead to oversupply in some markets. Transportation costs and fuel prices affect tenant profitability, which could ripple through to rents. But for the moment, the industrial market remains one of the stronger real estate categories.

## Retail properties — the challenged segment

HGIT's retail holdings face the same structural headwinds as the broader retail real estate market. E-commerce has reduced foot traffic and tenant demand for physical space. Department stores have contracted, traditional retailers have shuttered locations, and rents have come under pressure in all but the highest-quality retail locations.

Shopping centers and retail strips anchored by essential services — grocery stores, drugstores, fitness facilities, restaurants, healthcare providers — have held up better than those focused on traditional merchandise retail. Convenience and necessity-driven retail generates regular customer traffic and rent payment. But commodity retail malls and shopping strips focused on general merchandise have suffered meaningful losses. HGIT's retail segment performance depends on what fraction of the portfolio is anchored by necessity tenants versus discretionary retail.
...
## Geographic diversification as a risk controller
...
Anyone evaluating Hines Global Income Trust should begin with the annual 10-K filing (SEC CIK 0001585101) and quarterly reports, which disclose the portfolio composition by property type and geography, occupancy rates, lease expiration schedule, and debt maturity. Pay particular attention to which segments are driving earnings and which are lagging. Watch occupancy rates and rent trends within each segment — are industrial rents still rising while office rents decline?

Track the percentage of revenue coming from each geographic region and property type. High concentration in a single region or a weak segment creates vulnerability. Monitor the lease expiration schedule to understand what portion of revenue must be re-leased in coming years, and at what rental rates in the current market. Follow interest rate trends and refinancing activity closely, since rising rates directly compress REIT profitability. Finally, pay attention to distribution coverage — the ratio of operating cash flow to distributions paid — to assess whether current distributions are sustainable or if management is drawing down capital or relying on property sales to maintain them.
