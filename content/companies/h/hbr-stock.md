---
title: "Canary HBAR ETF (HBR)"
description: "HBR holds actual HBAR tokens, the utility token of the Hedera Hashgraph distributed ledger network, via spot ETF structure with regulated custody."
keywords:
  - Hedera Hashgraph
  - HBAR token
  - cryptocurrency ETF
...
HBR is a spot exchange-traded fund that holds actual HBAR tokens, the native [utility token](/utility-token/) of the Hedera Hashgraph public [distributed ledger](/distributed-ledger/) network. The fund launched on [Nasdaq](/nasdaq/) on October 28, 2025, becoming the third cryptocurrency to gain spot ETF approval in the United States, following [Bitcoin](/bitcoin/) and [Ethereum](/ethereum/).
...
The fund itself is straightforward in structure. HBR holds actual HBAR tokens in custody with regulated [custodians](/custodian/), BitGo and Coinbase Custody, rather than holding derivatives or [futures contracts](/futures-contract/). This distinction matters: a spot ETF owns the underlying asset and delivers it to you (in settlement, or via [authorized participants](/authorized-participant/)), whereas a futures-based or synthetic fund tracks the price indirectly through derivatives. Because HBR is a spot fund, it offers direct price exposure to HBAR.
