...
Monitor debt covenants and refinancing schedules. Many REITs have mortgage maturities clustered in future years; if rates stay elevated, refinancing costs can be painful. Check the balance sheet for loan-to-value (LTV) ratio and [interest coverage ratios](/interest-coverage-ratio/), which indicate financial flexibility and default risk.
