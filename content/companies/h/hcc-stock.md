---
title: "Warrior Met Coal (HCC)"
description: "US producer of premium metallurgical coking coal mined in Alabama and exported globally to the steel industry; a focused commodity play in capital-intensive mining."
keywords:
  - metallurgical coal
  - coking coal
  - mining
...
| Segment | Character | Notes |
|---------|-----------|-------|
| Hard Coking Coal (HCC) | Primary | High-quality, low-sulfur; the majority of output and premium pricing |
| Semi-Soft and Blended Coal | Secondary | Lower grade, sold at discount; blended with HCC for customer needs |
| Contract Sales | ~70–80% of volume | Multi-year agreements with large steelmakers; more stable, lower price volatility |
| Spot Sales | ~20–30% of volume | Sold on short-term benchmarks; captures upside in strong demand, exposes downside in weak demand |
| Geographic Markets | Diversified | Europe (~40%), Asia (~35%), North America (~25%); subject to shift with tariffs and supply disruptions |
