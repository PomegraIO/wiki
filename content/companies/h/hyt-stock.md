---
title: "BlackRock Corporate High Yield Fund, Inc. (HYT)"
description: "BlackRock Corporate High Yield Fund is a closed-end mutual fund that buys high-yield (junk) bonds and distributes the income to shareholders. It is essentially a professionally managed basket of risky corporate debt."
keywords:
  - high-yield bonds
  - junk bonds
  - closed-end fund
...
[BlackRock](/blk-stock/) Corporate High Yield Fund, Inc. trades on the [New York Stock Exchange](/new-york-stock-exchange/) under the ticker HYT and is a closed-end investment company focused on high-yield [corporate bonds](/corporate-bond/). To understand what it does, think of it this way: [bonds](/bond/) are debts that companies issue to raise money, and [high-yield bonds](/high-yield-bond/) are the debts issued by companies with lower [credit ratings](/credit-rating/) or higher risk. These bonds pay higher [interest rates](/interest-rate/) (yields) than safer corporate bonds because investors are accepting more risk — the company might default and investors could lose part or all of their principal. BlackRock's HYT fund buys a diversified portfolio of these high-yield bonds and distributes the income (the interest payments) to shareholders, along with capital gains or losses as the bonds appreciate or depreciate in value.

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>HYT (NYSE)</td></tr>
<tr><th>Fund type</th><td>Closed-end mutual fund</td></tr>
<tr><th>Manager</th><td>BlackRock Advisors LLC</td></tr>
<tr><th>Primary holding</th><td>High-yield (junk) corporate bonds</td></tr>
<tr><th>Objective</th><td>High current income and capital appreciation</td></tr>
<tr><th>Investor base</th><td>Individual income-seeking investors, institutions seeking yield</td></tr>
<tr><th>SEC CIK</th><td>0001222401</td></tr>
</table>
</aside>

[Closed-end funds](/closed-end-fund/) are distinct from the open-end [mutual funds](/mutual-fund/) that most retail investors own. With an [open-end fund](/open-end-fund/), you can buy or sell shares at the fund's [net asset value](/net-asset-value/) (NAV) — the total value of its holdings divided by the number of shares outstanding. With a closed-end fund, the number of shares is fixed, and shares trade on an exchange like stock does, so their price can drift above or below the underlying NAV. That discount or premium, though small, means a buyer might get a bargain or overpay depending on market sentiment.
