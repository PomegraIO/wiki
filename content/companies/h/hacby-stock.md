...
Japanese regional banks operate under strict regulatory capital requirements set by Japan's Financial Services Agency. These rules dictate how much capital the bank must hold relative to its risk-weighted assets. Hachijuni must maintain a minimum capital ratio; if it falls short, the bank must either raise capital or shrink its [balance sheet](/balance-sheet/). Given the challenging operating environment, raising capital is difficult — the shares have not offered compelling returns. Shrinking is the path many regional banks have taken.
...
Key metrics to track: total deposits and their trend, the loan-to-deposit ratio, the interest-rate spread (net interest margin), nonperforming-loan ratio and trend, [capital adequacy](/capital-adequacy/) ratio, [return on equity](/return-on-equity/), and fee-income as a percentage of total revenue. Watch population trends in Nagano and neighboring prefectures — these are leading indicators of long-term deposit and loan demand. The quarterly earnings calls (available in Japanese; summaries sometimes appear in English) discuss management's strategy for adapting to demographic decline and the competitive landscape.
