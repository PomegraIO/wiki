---
title: "Hemnet Group AB/ADR (HEMNF)"
description: "Swedish real estate digital marketplace and listings portal, operating across Nordic housing markets."
keywords: ["Hemnet", "real estate", "Nordic", "digital marketplace", "property listings", "housing market"]
---

*In the Nordic [residential real estate](/residential-real-estate/) market, **Hemnet Group AB/ADR (HEMNF)** functions as the dominant digital gateway—a listings and transaction facilitator where the majority of Swedish, Norwegian, and Danish property sales originate. The company captures value as housing markets increasingly transitioned online, anchoring its position in a region where digital adoption and high property values align.*

<aside class="wiki-infobox"><table>
<tr><td>Ticker</td><td>HEMNF</td></tr>
<tr><td>Listing</td><td>OTC Markets (ADR)</td></tr>
<tr><td>SEC CIK</td><td>1915760</td></tr>
<tr><td>Sector</td><td>Real Estate & Digital Services</td></tr>
<tr><td>Industry</td><td>Online Classifieds & Marketplace</td></tr>
<tr><td>Type</td><td>Digital Platform Operator</td></tr>
</table></aside>
...
Gross margins are high once the platform reaches scale; incremental listings cost little to serve. However, customer [acquisition](/acquisition/) and retention among brokers involves ongoing sales efforts and relationship management. The company is not a pure-software platform but rather a transaction-dependent service where profitability correlates directly to market activity. In [recessions](/recession/) or periods of high interest rates, transaction volumes decline and Hemnet's revenue contracts.
...
- [Real estate markets](/stock/)

### Wider context
- [Digital marketplaces and network effects](/stock/)
- [European tech companies](/public-company/)
- [Housing and macroeconomic cycles](/stock/)
