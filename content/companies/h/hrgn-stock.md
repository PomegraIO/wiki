---
title: "Harvard Apparatus Regenerative Technology, Inc. (HRGN)"
description: "Biotech firm focused on regenerative medicine and tissue engineering, capital-light in model but dependent on equity financing and partnership revenues as a pre-commercial stage company."
keywords: [regenerative medicine, biotech, tissue engineering, harvard apparatus, equity financing, licensing]
---

*Harvard Apparatus Regenerative Technology, Inc.—trading as **HRGN**—is a tissue-engineering and regenerative-medicine company born from the Harvard Apparatus lineage and devoted to developing therapies and implantable technologies for musculoskeletal and soft-tissue repair. Unlike mature pharmaceutical or medical-device firms, HRGN operates a capital-light R&D engine financed almost entirely through [equity](/stock/), corporate partnerships, and licensing revenue, with no intention of near-term profitability.*

<aside class="wiki-infobox"><table>
<tr><td>Ticker</td><td>HRGN</td></tr>
<tr><td>Listing</td><td>NASDAQ</td></tr>
<tr><td>SEC CIK</td><td>1563665</td></tr>
<tr><td>Sector</td><td>Biotechnology</td></tr>
<tr><td>Industry</td><td>Regenerative Medicine & Tissue Engineering</td></tr>
<tr><td>Type</td><td>Public biotech; pre-commercial stage</td></tr>
</table></aside>
...
HRGN burns cash monthly on salaries, lab reagents, equipment, and clinical-trial costs. It does not generate revenue sufficient to cover operating expenses and therefore lives on its cash balance. The company discloses its cash and equivalents in SEC filings and, implicitly, its cash-burn rate—the months of runway visible in its balance sheet. Strategic milestones (such as achieving proof-of-concept in a tissue-engineering target or securing a partnership) can extend runway or refresh capital resources, but near-term, HRGN operates under the constraint of its available cash. The business model expects multiple capital raises over the next five to ten years as the company progresses through development stages.
...
HRGN's long-term capital structure is fungible in a sense: the company could be acquired for cash and stock, at which point the acquirer's balance sheet and financing structure would subsume HRGN's. This is an understood exit path in biotech. An acquirer would inherit HRGN's technology, facilities, and development pipeline, and would integrate the company into its own capital structure—potentially retiring the public equity and consolidating the subsidiary into a debt-financed parent structure. Until such an exit, HRGN remains an independent equity-funded entity.
...
If HRGN successfully develops a therapies and gains regulatory approval, commercialization would generate revenue. At that point, the company's capital structure could evolve: it might refinance into debt, initiate a dividend, or repurchase shares. Until then, it operates in the equity-funding phase, a paradigm where all capital comes from shareholders and balance sheet strength is measured in months of runway, not ratios of debt to assets.
