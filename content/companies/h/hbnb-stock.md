...
Foreign exchange exposure is material if HBNB operates properties outside the United States. A resort in Mexico or Costa Rica generates revenue in local currency, but HBNB reports earnings in [U.S. dollars](/us-dollar/). If the Mexican peso weakens, U.S.-dollar revenue declines even if room night sales are steady. Hedging [currency risk](/currency-risk/) requires derivatives or local-currency debt, adding cost.
