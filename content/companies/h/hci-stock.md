---
title: "HCI Group (HCI)"
description: "Florida-based insurance holding company blending homeowners' property insurance with an insurance-technology platform (TypTap) and real-estate holdings."
keywords:
...
|-------|-------|
| **Ticker** | HCI |
| **Exchange** | [NYSE](/wiki/stock-exchange/) |
| **CIK** | 1400810 |
| **Sector** | Insurance |
| **Founded** | 2006 |
| **Headquarters** | Tampa, FL |
| **What it does** | Homeowners' insurance; insurance-technology platform (TypTap); real-estate investments |

</aside>

HCI Group operates at an unusual intersection for an insurer: property insurance underwriting, software-as-a-service distribution, and real-estate ownership. The company was born during Florida's insurance consolidation wave in the mid-2000s, and over nearly two decades it has assembled a foothold in the state's fiercely competitive homeowners' market while building a parallel technology play aimed at reaching insurance agents digitally.
...
For equity investors, HCI is a small-cap, Florida-focused property insurer with a technology venture in its portfolio. The stock trades on the [NYSE](/wiki/stock-exchange/) and is exposed to insurance underwriting cycles, catastrophe risk, and technology speculation in equal measure. The 10-K is the essential document: review loss ratios, combined ratios, reserve adequacy, investment portfolio composition, and reinsurance arrangements to understand what earnings power is sustainable. Watch premium growth, loss frequency and severity data, and management commentary on TypTap adoption and burn rate.

The company is best understood through multiple lenses: a cyclical insurer trading on book value and loss-ratio trends, and a technology experiment trading on adoption and path to profitability. Volatility is expected.
