---
title: "Harvard Ave Acquisition Corp (HAVAR)"
description: "A blank-check company with a common-stock ticker, exemplifying the SPAC equity structure and shareholder redemption rights in acquisition vehicles."
keywords:
  - SPAC
  - blank-check company
  - shareholder rights
...
Harvard Ave [Acquisition](/acquisition/) Corp exists solely as a legal and financial vehicle to raise public capital for the purpose of acquiring an operating company whose identity is unknown at the time of the [initial public offering](/initial-public-offering/). The HAVAR ticker represents the [common stock](/common-stock/) security issued to public shareholders, distinct from the warrant and unit securities that accompanied it in the original capital-raising round.
...
Harvard Ave is a corporate shell created, capitalized, and governed entirely for the purpose of acquiring another company. Until that acquisition is consummated, it has no operations, no employees, no customers, and no revenue-generating business. Its only assets are the cash in trust and the right to negotiate and pursue a combination. Its only liabilities are the [management fees](/management-fee/) and legal costs incurred in the search process. The common stock, HAVAR, is a claim on that shell — and crucially, on the [redemption rights](/redemption-rights-equity/) and voting power that shareholder ownership confers. Investors examining the 10-K filing (SEC CIK 0002042460) will find detailed disclosure about the trust account balance, the uses of capital to date, and any proposed business combination pending shareholder approval.
