---
title: "Jewett Cameron Trading Co Ltd (JCTC)"
description: "A Pacific Northwest–based distributor and manufacturer of outdoor products, control systems, and fencing with substantial inventory-driven operations."
keywords: [distribution, inventory, manufacturing, outdoor products, working capital, regional]
---

*Jewett Cameron Trading Co (JCTC) exemplifies a balance-sheet–driven manufacturer and distributor whose core financial challenge is inventory management and efficient deployment of working capital. The company's health is inseparable from how much stock it carries, how quickly it turns that stock, and how well it manages the lag between purchasing and sale.*

<aside class="wiki-infobox"><table>
<tr><td>Ticker</td><td>JCTC</td></tr>
<tr><td>Listing</td><td>NASDAQ</td></tr>
<tr><td>SEC CIK</td><td>885307</td></tr>
<tr><td>Sector</td><td>Industrials</td></tr>
<tr><td>Industry</td><td>Distribution / Manufacturing</td></tr>
<tr><td>Type</td><td>Outdoor products distributor and manufacturer</td></tr>
</table></aside>

## Inventory and Working Capital Structure

The Jewett Cameron balance sheet is dominated by inventory—products in warehouses, distribution centers, and retail locations awaiting sale. For a distributor-manufacturer of outdoor fencing, gates, and associated products, inventory is not a liability but the primary productive asset. The size and composition of that inventory relative to [sales](/income-statement/) reflects both demand strength and management's confidence in future turnover.

Inventory turnover—cost of goods sold divided by average inventory—reveals how efficiently the company converts stock into cash. A high turnover signals strong demand and tight inventory management; a low turnover indicates excess stock, potential obsolescence risk, or weakening sales. For JCTC's category of products, seasonal demand (heavier in spring and early summer in the Pacific Northwest) creates inventory bulges that must be managed across quarters.
