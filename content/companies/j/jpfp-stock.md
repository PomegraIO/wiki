---
title: "JPMorgan Managed Futures Plus ETF (JPFP)"
description: "A diversified fund tracking systematically managed futures across commodities, bonds, and equities — designed for tactical allocation and downside protection."
keywords:
  - managed futures
  - diversification
  - commodity exposure
...
Managed futures strategies, and this fund in particular, appeal to investors for their historical tendency to rise when stocks and bonds are falling together — what portfolio managers call a "diversifying asset class." In market downturns driven by panic or [inflation surprises](/inflation-surprise/), trend-following strategies have often captured gains in commodities and defensively positioned bonds and equities, offsetting broader portfolio losses. That non-correlation is the entire thesis.
...
As an [actively managed fund](/actively-managed-fund/), JPFP charges an [expense ratio](/expense-ratio/) reflecting the cost of maintaining systematic trading infrastructure and rebalancing the futures portfolio daily. This is higher than a passive equity index ETF but reflects genuine operational costs. The fund trades on an exchange during regular hours, so investors can buy or sell shares at the market price throughout the trading day; liquidity is generally adequate for most investors, though intraday [bid-ask spreads](/bid-ask-spread/) can widen during market stress.

## Real risks and constraints

Managed futures strategies can underperform significantly in extended [bull markets](/bull-market/), especially when trends are weak and short-lived. A fund that sells rallies prematurely and holds too much cash-like positions misses out when the rally extends. Conversely, in truly trending markets the strategy can add real value by staying in trends longer than traditional buy-and-hold.

The use of futures introduces leverage — the ability to control larger positions than the fund's asset base alone would permit — which amplifies both gains and losses. A small adverse move in one of the fund's futures positions can cause a large percentage decline in the fund's share price. Additionally, futures contracts have an [expiration date](/expiration-date/); the fund must continuously roll expiring contracts into new ones, and the costs and mispricing around that rollover can eat into returns.

Concentration in trend-following is another hidden risk. If JPFP's index uses the same momentum signals that every other rules-based trend fund uses, then the fund's returns will converge toward other trend-following products. That convergence reduces the [diversification](/diversification/) benefit; everyone rushes to the same exits at once.
