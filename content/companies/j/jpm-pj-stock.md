---
title: "JPMorgan Chase & Co. (JPM-PJ)"
description: "JPMorgan Chase is the largest bank in the United States, operating through investment banking, wealth management, and consumer lending — a diversified financial conglomerate with few peers in scale or market reach."
keywords:
  - banking
  - investment banking
  - wealth management
...
[JPMorgan Chase](/jpmorgan-chase/) is the United States' largest bank by assets, a universal financial services firm spanning investment banking, asset management, and retail consumer lending. Its operations stretch across more than a hundred countries, and its [balance sheet](/balance-sheet/) is bigger than the GDP of most nations. Yet despite its size, the franchise remains one of the market's most profitable, year after year — not because of any single moat, but because it is *everywhere* in finance and does most of it well.

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>JPM (NYSE)</td></tr>
<tr><th>Founded</th><td>2000 (Chase Manhattan Bank, 1799)</td></tr>
<tr><th>CEO</th><td>Jamie Dimon</td></tr>
<tr><th>Headquarters</th><td>New York, New York</td></tr>
<tr><th>Sector</th><td>Financial services / banking</td></tr>
<tr><th>Primary segments</th><td>Corporate & Investment Bank, Wealth Management, Consumer & Community Banking</td></tr>
<tr><th>SEC CIK</th><td>0000019617</td></tr>
</table>
</aside>

## A sprawling franchise built from merger and acquisition

[JPMorgan Chase](/jpm-stock/) is less a single bank than a holding company that acquired its way to dominance. The modern firm traces to the 2000 [merger](/merger/) of Chase Manhattan Bank (itself a 1955 combination of Chase Bank and Manhattan Company, the latter founded in 1799) and J.P. Morgan, the investment bank. The merger created a powerhouse, and over the two decades that followed Jamie Dimon, elevated to CEO in 2005, steered a sequence of [acquisitions](/acquisition/) — Washington Mutual's deposits during the financial crisis, Bear Stearns (a failed investment bank) in 2008, and regional banks during downturns — to build what is now the largest financial institution in the United States by total assets.

The resulting structure is almost aggressively diverse. JPMorgan Chase operates a consumer bank that competes with regional players and online competitors on deposit-taking and retail lending. It runs a full-service investment bank that underwrites stock and [bond](/bond/) offerings, advises on mergers, and trades securities. It manages trillions of dollars of investment assets for wealthy clients and institutions. It runs a credit-card franchise that rivals Visa and [Mastercard](/ma-stock/) in volume. It operates a massive mortgage business. And it manages corporate payments systems that process flows of cash between companies every day.
...
**Corporate and Investment Bank** (CIB) is the investment banking and trading arm. It earns fees for underwriting stocks and bonds, advising corporations on mergers and strategy, and trading fixed income, currencies, commodities, and equities on behalf of clients and the bank's own account. This business is cyclical — booming when markets are open and companies are willing to pay for capital-raising advice, contracting when the economy tightens and dealmaking dries up. Trading revenue is volatile, swinging sharply on geopolitical surprises and shifts in [interest rates](/interest-rate/). But CIB is also enormously profitable in strong years; the bank's competitive position in investment banking and [prime brokerage](/prime-brokerage-venue/) (lending cash and securities to [hedge funds](/hedge-fund/) and other traders) is unmatched in the United States.
...
Yet size also brings constraints. The bank is heavily regulated by the [Federal Reserve](/federal-reserve/) and the [Office of the Comptroller of the Currency](/office-of-the-comptroller-of-the-currency/), required to hold far more capital than it would otherwise choose. It faces limits on how much risk it can take with its own money, ostensibly to prevent another financial crisis. Every decade or so, the Fed stress-tests the largest banks with hypothetical economic disasters and requires them to set aside capital buffers against those scenarios. And the bank's sheer prominence makes it a target for regulatory scrutiny — any serious banking problem or scandal is amplified by the fact that JPMorgan is "systemically important," meaning its failure could cascade through the financial system.

## The competitive position

JPMorgan Chase's main competitors fall into several buckets. In investment banking and capital markets, it competes against [Goldman Sachs](/goldman-sachs/), [Morgan Stanley](/morgan-stanley/), and [Bank of America's](/bank-of-america/) investment banking division. In wealth management, it competes against smaller wealth managers and independent advisors, as well as against financial advisors at Vanguard and Fidelity. In consumer banking, it competes against regional banks, credit unions, online banks, and other superregional banks like Bank of America and [Wells Fargo](/wells-fargo/). In credit cards, it competes against [American Express](/axp-stock/), Capital One, and the card programs run by other banks.
...
Key metrics: the net-interest margin (the gap between what the bank earns on its loans and what it pays on deposits), [return on equity](/return-on-equity/) (whether the company is earning a reasonable return on shareholder capital given the risks), and the ratio of credit losses to outstanding loans (whether the loan portfolio is deteriorating). The loan-to-deposit ratio tells you whether the bank is collecting cheap deposits or having to pay up. And watching competitor earnings alongside JPMorgan's reveals whether the entire sector is under pressure or whether JPMorgan is outperforming its peers.
