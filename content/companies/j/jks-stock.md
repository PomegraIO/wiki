...
The starting point for any deep investigation of JinkoSolar is its [10-K filing](/wiki/10-k/) with the U.S. Securities and Exchange Commission, though the company files Form 6-K instead (the form used by foreign private issuers). These filings describe the company's business segments, capital expenditures, competitive position, and principal risks in detail. A reader should pay particular attention to the company's gross margin trends, capacity utilization rates, polysilicon cost assumptions, and geographic revenue breakdowns.
