...
description: "JPMorgan Chase is the largest US bank by assets — a diversified franchise spanning consumer banking, wholesale banking, and wealth management, with systematic importance to the financial system and persistent regulatory pressure."
keywords:
  - commercial banking
  - investment banking
  - wealth management
...
<tr><th>Founded</th><td>2000 (current entity); roots to 1799</td></tr>
<tr><th>Headquarters</th><td>New York City</td></tr>
<tr><th>Sector</th><td>Diversified banking and financial services</td></tr>
<tr><th>Primary divisions</th><td>Consumer & Community Banking, CIB, Commercial Banking, AWM</td></tr>
<tr><th>SEC CIK</th><td>0000047709</td></tr>
</table>
</aside>
...
JPMorgan Chase has endured waves of regulatory action, fines, and public criticism over the past decade. The bank has paid billions to settle allegations related to mortgage-backed securities, [LIBOR manipulation](/wiki/libor/), forex trading, and other violations. Each fine weakens the bank's reputation and tightens constraints on its business, yet JPM has consistently absorbed these blows without existential damage, a testament to both its size and the reluctance of regulators to let a SIFI actually fail.
...
Second is institutional relationships. Fortune 500 CEOs, government finance ministers, and ultra-high-net-worth individuals have banked with JPM (or its predecessors) for decades. The switching costs — moving all your loans, treasury operations, and wealth management to another bank — are so high that most never do. This franchise lock-in is as real as [Apple](/aapl-stock/)'s ecosystem but less visible to the public.
