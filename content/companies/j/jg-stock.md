---
title: "Aurora Mobile Ltd (JG)"
description: "Chinese mobile services and cloud computing company providing push notifications, analytics, and enterprise mobility solutions across Asia-Pacific."
keywords:
  - mobile-services
  - push-notifications
  - chinese-technology
...
| Service Line | Revenue Nature | Typical Customer |
|---|---|---|
| Push Notification Service | Per-message or subscription tiers | Mobile app developers, game studios |
| Mobile Analytics & Data Services | SaaS subscriptions, data volume fees | Growth-stage tech companies, enterprise IT |
| Cloud Services (MCS) | Managed services, migration consulting | Enterprise customers moving to cloud |
| Developer Tools & SDKs | Licensing, premium feature access | Independent developers, smaller studios |
