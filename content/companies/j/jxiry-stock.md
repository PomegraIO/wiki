---
title: "Jiaxin International Resources Investment Limited/ADR (JXIRY)"
description: "Hong Kong-listed minerals investment company funding exploration and resource development projects across Asia; US-traded ADR of an exploration-stage holding company."
keywords: ["mineral exploration", "resources investment", "mining development", "Hong Kong listing", "capital formation"]
---

*Jiaxin International Resources Investment Limited, trading as **JXIRY** via [American Depositary Receipt](/adr/), is a resources investment company incorporated in Hong Kong. The firm identifies, funds, and develops mineral exploration and mining projects across Southeast Asia, Mongolia, and adjacent regions, holding equity stakes in projects ranging from early-stage exploration to advanced development. **JXIRY** functions as a project financier and equity sponsor — raising capital from investors, deploying it into projects, and returning value through project completion or exit. Its capital structure is built around project-based financing, equity dilution, and the long time horizons required by mineral discovery and mine development.*

<aside class="wiki-infobox"><table>
<tr><td>Ticker</td><td>JXIRY</td></tr>
<tr><td>Listing</td><td>OTC Markets (US); Hong Kong Stock Exchange (HK)</td></tr>
<tr><td>SEC CIK</td><td>2128458</td></tr>
<tr><td>Sector</td><td>Basic Materials</td></tr>
<tr><td>Industry</td><td>Mineral Exploration & Development</td></tr>
<tr><td>Type</td><td>Public (Hong Kong), ADR (US)</td></tr>
</table></aside>
...
**JXIRY** negotiates the project-debt structure to preserve optionality: if a project becomes uneconomic, the company can walk away without guaranteeing project-level debt. However, lenders demand either **JXIRY** guarantees or higher [interest rates](/interest-rate/) in exchange. The company balances these trade-offs on a project-by-project basis.
...
### Closely related
- [public-company](/public-company/) capital formation structures
- [enterprise-value](/enterprise-value/) and portfolio approach
- Understanding risks via [balance-sheet](/balance-sheet/) cash position

### Wider context
- [securities-and-exchange-commission](/securities-and-exchange-commission/) disclosures in [10-k](/10-k/)
