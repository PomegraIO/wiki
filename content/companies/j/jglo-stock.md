---
title: "JPMorgan Global Select Equity ETF (JGLO)"
description: "JPMorgan Global Select Equity ETF actively selects large-cap companies across developed and emerging markets, filtering for quality, growth, and financial strength."
keywords:
  - global equities
  - active management
...
*The **JPMorgan Global Select [Equity ETF](/equity-etf/)** (JGLO) is JPMorgan Asset Management's flagship global equity vehicle—a curated portfolio of thirty to fifty large-cap companies from developed markets and major emerging economies. Not a broad world index. A focused selection based on JPMorgan's conviction about which companies offer the best combination of growth potential and financial durability.*
...
Fees run moderate for active global equity—higher than a passive world index ETF, lower than some boutique active managers. Research and trading costs are global; JPMorgan's analyst network spans the world. [Dividends](/dividend/) from holdings flow to shareholders, typically quarterly. Liquid on US exchanges, no friction on entry or exit unlike trying to directly own a diversified global stock portfolio.

Diversification reduces company-specific and country-specific risk but does not eliminate [market risk](/market-risk/). Broad equity-valuation downturns hit most holdings. Currency swings can swing returns sharply in either direction. Emerging-market exposure carries geopolitical and regulatory risk absent from developed markets.
...
To assess fit: Review current holdings and breakdown by country and sector. Understand what JGLO owns and why—JPMorgan publishes commentary. Compare performance to a broad global [index fund](/index-fund/) over three-, five-, and ten-year rolling periods. Look at the largest positions to sense JPMorgan's top conviction ideas. Read any published research on those companies or regions. Examine the prospectus for [expense ratio](/expense-ratio/), turnover, and asset base.
