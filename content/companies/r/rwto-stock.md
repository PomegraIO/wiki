---
title: "Redwood Trust Inc. 9.0% Senior Notes (RWTO)"
description: "RWTO are unsecured senior notes issued by Redwood Trust, a mortgage REIT, with a 9.0% annual coupon—higher-yield fixed income tied to residential mortgage banking performance."
keywords:
  - senior notes
  - mortgage REIT
  - fixed income
...
<table>
<tr><th>Issuer</th><td>Redwood Trust Inc. (NYSE: RWT)</td></tr>
<tr><th>Coupon rate</th><td>9.0% per annum</td></tr>
<tr><th>Payment schedule</th><td>Quarterly (Mar, Jun, Sep, Dec)</td></tr>
<tr><th>Maturity</th><td>2031</td></tr>
<tr><th>Debt type</th><td>Senior unsecured notes</td></tr>
<tr><th>Seniority ranking</th><td>Pari passu with other senior debt</td></tr>
<tr><th>Issuer SEC CIK</th><td>0000930236</td></tr>
<tr><th>Year founded</th><td>1994</td></tr>
</table>
</aside>

## The mortgage REIT model in brief

Redwood Trust operates as a specialty finance company focused on non-agency residential mortgages—loans larger than conforming limits or with credit profiles outside government-sponsored enterprise guidelines. Core revenue streams: origination fees (Sequoia and CoreVest platforms), net interest spread on held mortgages and securities, servicing fees on a serviceable portfolio exceeding $30 billion in unpaid principal balance. Earnings depend directly on origination volume, which depends on rates, credit availability, and housing demand.

RWTO holders are creditors to this business. The 9.0% coupon is paid semi-annually in advance (quarterly in arrears, actually). Unsecured means no specific collateral backs these notes—they are claims on the general assets and cash flow of the company.
...
## The mortgage portfolio and asset composition

Redwood Trust holds mortgages and mortgage-backed securities across three main categories: (1) mortgages it originated or acquired for securitization, (2) retained interests in securitizations (tranches of REIT-issued securities), and (3) opportunistic acquisitions of mortgages or securities believed to be mis-priced. The portfolio is geographically diverse across U.S., concentrated in higher-priced states (California, New York, Florida) where jumbo mortgages dominate.

Asset quality is cyclical. In favorable economic conditions and stable/declining rates, credit performance is strong and mortgage prices appreciate. In adverse conditions—unemployment spikes, rates surge, home prices weaken—credit deteriorates and marks fall. RWTQ holders take on this asset-quality risk indirectly through Redwood Trust's earnings.
...
Read Redwood Trust's 10-K (CIK 0000930236) for portfolio composition, leverage metrics, liquidity position, and segment performance. Track quarterly earnings calls for management color on origination trends, credit performance, and capital plans. Monitor mortgage origination industry data (MBA index, survey data) for macro context. Compare RWTO yield to alternatives (other mortgage REIT debt, corporates, Treasuries) to judge relative value. Understand that mortgage REITs are economically cyclical—RWTO performs well in stable/declining rate environments with healthy credit, poorly in downturns or when refinancing pressure is high.
