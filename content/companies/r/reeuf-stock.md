---
title: "Cartesian Growth Corp II (REEUF)"
description: "A SPAC (special purpose acquisition company) that failed to complete a business combination and is winding down, trading as a shell with minimal operating activity."
keywords:
  - SPAC
  - blank check company
  - shell company
...
Cartesian Growth Corporation II was created to serve a single purpose: raise capital and use it to acquire an operating business. Like most SPACs, it began as an empty shell. In May 2022, it raised roughly $230 million by listing on the [Nasdaq](/nasdaq/). That trust account — the pool of money intended to pay for a [business combination](/business-combination-purchase/) — was supposed to be deployed within two to three years to merge with or acquire a private company and take it public. That never happened. The clock has run out.
