---
title: "Rackspace Technology, Inc. (RXT)"
description: "Rackspace Technology provides managed cloud services and hybrid infrastructure solutions for enterprises — a hybrid-cloud operator helping customers optimize, migrate, and run workloads across multiple cloud platforms and on-premises data centers."
keywords:
...
The through-line from Rackspace's founding to today is adaptation. The company was not built for the cloud era, but it evolved fast enough to survive it. The IPO in August 2020 was followed by a period of aggressive cost restructuring and sales organization changes, and in 2022 the company went private again after a [acquisition](/acquisition/) by [Apollo Global Management](/apo-stock/). Now under private ownership, Rackspace can take a longer-term view, which matters in a capital-intensive, relationship-driven business where major contracts take years to develop and decades to mature.
