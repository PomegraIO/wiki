---
title: "Reading International Inc. (RDI)"
description: "Reading International operates cinemas across the US, Australia, and New Zealand while holding valuable real estate beneath many venues, creating a dual revenue stream and real-estate optionality uncommon in theater chains."
keywords:
  - cinema operator
  - real estate holdings
  - property leverage
  - theatrical exhibition
  - ancillary real estate value
handwritten: true
---
...
<table>
<tr><th>Ticker</th><td>RDI (NASDAQ)</td></tr>
<tr><th>Founded</th><td>1912, New Jersey</td></tr>
<tr><th>Sector</th><td>Movie exhibition and real estate</td></tr>
<tr><th>Operating brands</th><td>Regal Cinemas (US), Event Cinemas (Australia, New Zealand)</td></tr>
<tr><th>Primary business</th><td>Theater ownership and operation; real estate holdings</td></tr>
<tr><th>SEC CIK</th><td>716634</td></tr>
</table>
</aside>
...
This real-estate leverage was the business case for decades. A typical cinema company operates high-traffic venues that generate rent-like returns from ticket sales and concessions. When you own the land beneath a busy cinema in a desirable location, you own that rent-generating power directly, plus you own the appreciating land. When the movie [business cycles](/business-cycle/), the land stays. In favorable markets, you can develop adjacent real estate — retail, residential, office — that complements the theater. In weak spots, you can consider other uses for the land or sale-leaseback arrangements. For much of Reading's history, this optionality was real.
...
Reading's [balance sheet](/balance-sheet/) carries significant real-estate holdings, and the company has, at various times, explored monetizing them. Some venues sit on owned land that could theoretically be developed with residential, retail, or office space. Some properties have been subject to sale-leaseback arrangements, where the company sells a property and leases it back, converting illiquid real estate into cash while retaining operating control and (usually) bearing the [operational risk](/operational-risk/) and obsolescence risk of the theater.
...
Start with the annual [10-K filing](/wiki/10-k/) (SEC CIK 716634), which breaks out revenue by segment (US, Australia, New Zealand) and discusses the company's real-estate holdings and debt structure in detail. The quarterly earnings releases and management commentary on the call are essential: pay attention to attendance trends, box-office revenue per patron, concession yield, and any updates on real-estate monetization plans or debt refinancing activity.

A few metrics help frame the business. Average ticket price and concession revenue per patron-visit show whether pricing actions are holding. [EBITDA](/ebitda/) (earnings before interest, taxes, [depreciation](/depreciation/), and [amortization](/amortization/)) isolates the operating profit before the drag of debt and asset depreciation, which is meaningful for a capital-intensive business. [Debt-to-EBITDA ratio](/debt-to-ebitda-ratio/) shows the leverage picture directly. And any change in the theater circuit count or major property sales signals shifts in management's strategy.
