---
title: "Chicago Atlantic Real Estate Finance, Inc. (REFI)"
description: "Chicago Atlantic is a mortgage REIT specializing in lending to state-licensed cannabis operators, capturing the financing gap created by federal prohibition and limited competition."
keywords:
  - mortgage REIT
  - cannabis lending
  - real estate finance
...
Chicago Atlantic focuses exclusively on first mortgage loans — senior-ranked debt secured by cannabis-related real estate. This positioning is deliberate. A first mortgage has priority claim on the property if the borrower defaults, which reduces the lender's [loss severity](/loss-severity/). The company targets established operators, typically multi-state or single-state cannabis businesses with professional management, proven operating track records, and strong [balance sheets](/balance-sheet/) relative to the typical cannabis operator.
...
Chicago Atlantic, like all REITs, must distribute most of its taxable income to shareholders as [dividends](/dividend/). This is the tax trade-off of the REIT structure: the company pays no federal corporate tax as long as it distributes at least 90 percent of net income to shareholders, and shareholders pay tax on those distributions. The incentive is to maximize the spread between the [interest rate](/interest-rate/) charged to borrowers and the cost of capital the REIT raises — the difference flows to dividends.
...
The portfolio includes first mortgage loans of varying sizes. Typical loans might be $5 million to $20 million, secured by cultivation facilities, retail storefronts, or processing operations. The company underwrites to [loan-to-value ratios](/loan-to-value-ratio/) — lending perhaps 60 to 70 percent of the appraised value of the underlying real estate — to preserve a margin of safety if collateral value declines or borrower troubles emerge.

Loan performance is central to the investment thesis. If [default rates](/default-rate/) are low and loan losses are manageable, Chicago Atlantic generates the spread between its borrowing cost and its lending yield, converts most of that to dividends, and shareholders enjoy steady cash income. If defaults spike, loan loss reserves must be taken, earnings decline, and dividend capacity shrinks. The company publishes quarterly reports detailing its loan portfolio, delinquencies, and loss experience, allowing investors to track credit trends in real time.
...
Anyone studying Chicago Atlantic should begin with its quarterly reports on SEC Form 10-Q and annual 10-K filing (CIK 0001867949), both of which provide detailed portfolio breakdowns by state, borrower type, loan size, and collateral. Specific metrics to watch are the company's loan-to-value ratios, average loan size, concentration in any single state or borrower, [delinquency](/delinquency/) rates, and the trailing twelve-month yield on loans compared to the company's cost of capital.

The fundamentals of the business are straightforward: a cannabis borrower applies for a loan to buy real estate, Chicago Atlantic structures a first mortgage at a spread to its cost of capital, collects interest and principal over time, and distributes profits to shareholders. The risks are also clear: federal policy changes that legalize cannabis, state regulatory changes that harm borrower profitability, or a [recession](/recession/) that reduces cannabis consumer demand and borrower cash flow. Investors must weigh the attractive [current yields](/current-yield/) against the regulatory and policy [tail risks](/tail-risk/) inherent in being a lender to an industry operating at the margin of federal law.
