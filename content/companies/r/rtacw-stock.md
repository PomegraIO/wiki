---
title: "Renatus Tactical Acquisition Corp I (RTACW)"
description: "A blank-check acquisition vehicle whose warrant shares grant holders the right to purchase additional common stock after a business combination closes."
keywords:
  - blank-check company
  - SPAC
  - warrant instrument
...
<table>
<tr><th>Ticker</th><td>RTACW (warrant)</td></tr>
<tr><th>Entity type</th><td>Blank-check company / SPAC</td></tr>
<tr><th>Purpose</th><td>Capital raising and merger vehicle</td></tr>
<tr><th>Warrant feature</th><td>Right to purchase common stock at a set price</td></tr>
<tr><th>Sector</th><td>Capital markets / special purpose vehicle</td></tr>
<tr><th>SEC CIK</th><td>0002035173</td></tr>
<tr><th>Formation</th><td>As a blank-check vehicle with warrant units</td></tr>
</table>
</aside>

## Why warrants matter in the SPAC context
...
A blank-check company that raises $300 million, for example, typically sets aside that capital (net of fees) in a trust account. Investors in the warrant units own both the shell company and the embedded right to buy more shares. If the shell successfully merges with an operating company, the warrant becomes live — now worth money if the combined entity's stock price exceeds the strike. But warrant holders also face a choice: if the sponsor is forced to redeem a large portion of the original investment as shareholders vote against the merger, the trust account shrinks, and the combined entity may have too little capital to operate effectively.

The arithmetic is stark. Suppose a blank-check raises $300 million, proposes to acquire a company, and 80% of shareholders redeem. The remaining $60 million goes into the combined entity. Warrant holders who exercise may own 10% more of a company with only a fifth of the expected capital, a poor trade.
...
## How to research warrant-bearing blank-check companies

Start with the 10-K filing and the initial prospectus to understand the warrant strike price, exercise period (is there a long-dated exercise window or a tight deadline?), and the sponsor's incentive structure. If a merger is announced, the [proxy statement](/proxy-statement/) reveals the operating company's financials and forward projections. Pay attention to the redemption vote: a merger that faces mass shareholder redemption may leave the combined entity too thin on capital. And remember that warrant value depends entirely on the combined entity's future stock price; a warrant far out of the money is worth zero regardless of the business's fundamental strength.
