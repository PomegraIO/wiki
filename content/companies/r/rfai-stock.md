---
title: "RF Acquisition Corp II (RFAI)"
description: "RF Acquisition Corp II is a special-purpose acquisition company (SPAC) established to merge with and take public a private operating company."
keywords:
  - SPAC
...
RF [Acquisition](/acquisition/) Corp II is a blank-check company—a shell created to raise capital from public investors and subsequently merge with an operating company, taking that private business public without a traditional [initial public offering](/initial-public-offering/). RFAI was established as a SPAC vehicle and trades on the [NASDAQ](/nasdaq/) under the ticker RFAI.

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>RFAI (NASDAQ)</td></tr>
<tr><th>Company type</th><td>Special-purpose acquisition company (SPAC)</td></tr>
<tr><th>Business model</th><td>Merger vehicle / capital acquisition</td></tr>
<tr><th>Primary function</th><td>Raise capital and merge with a private operating company</td></tr>
<tr><th>SEC CIK</th><td>0002012807</td></tr>
</table>
</aside>

## What a SPAC is

A SPAC is a publicly traded shell company with no operating business. Its only asset is cash raised from public investors at the IPO. The SPAC is given a defined period—typically two years, sometimes extended—to identify a private operating company and negotiate a merger that will bring that business to the public markets. If no merger is completed within the deadline, the SPAC must return the capital to shareholders. The sponsors who formed the SPAC receive [founder shares](/founder-shares/) at minimal cost; these shares give them economic incentive to close a deal, because if the merger fails, those shares become worthless.
