...
Ryan Specialty's business model is strong when brokers and carriers benefit from its platform, when it can acquire new brokers at attractive valuations and integrate them successfully, and when the commercial insurance market is growing or stable. The company's execution risk is high — integrating acquired brokerages is difficult, and if the company overpays for [acquisitions](/acquisition/) or loses focus operationally, profitability can suffer. The economic risk is cyclical; when businesses retrench and reduce their insurance spending, commission volumes drop and technology services revenue can flatten.
