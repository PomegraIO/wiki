---
title: "RenaissanceRe Holdings Ltd. (RNR-PF)"
description: "Preferred share of Bermuda-based RenaissanceRe, the world's largest reinsurer, offering claims on fixed-rate dividends in a company that finances catastrophe risk."
keywords:
  - reinsurance
  - catastrophe risk
  - preferred stock
...
RenaissanceRe funds itself primarily through capital markets and [retained earnings](/retained-earnings/). The company collects premium payments from primary insurers and reinsureds (other reinsurers buying retro coverage) and holds that capital in float — uninvested premiums awaiting claims. At any given moment, RenaissanceRe holds billions in float, which it can invest in [bonds](/bond/), equities, or other liquid instruments to earn returns above the [risk-free rate](/risk-free-rate/). This is the second engine of reinsurance profit: premium income minus incurred losses, plus investment returns on the float.
...
For RenaissanceRe itself, preferred capital is permanent — there is no maturity date, and the company does not face a balloon payment. However, most preferred shares are callable, allowing the issuer to redeem them if [interest rates](/interest-rate/) fall and refinance at a lower cost. RNR-PF was issued at a specific rate — say, 8% on [par value](/par-value/) — and that dividend is fixed for the life of the share unless RenaissanceRe calls it.
...
Key metrics: combined ratio (losses plus expenses divided by premiums; below 100% means underwriting profit, above 100% means underwriting loss), [return on equity](/return-on-equity/) (how much profit the company is generating on its capital), [book value per share](/book-value-per-share/) (especially important for reinsurers because it reflects both underwriting and investment returns), and preferred dividend coverage (whether operating cash flow comfortably covers the preferred dividend, ideally by a multiple of 2 or more).
