---
title: "F/m Ultrashort Treasury Inflation-Protected Security (TIPS) ETF (RBIL)"
description: "RBIL tracks inflation with minimal interest-rate volatility by holding only 1–3 year Treasury TIPS. Principal adjusts for CPI; duration risk is minimal."
keywords:
  - TIPS
...
RBIL holds US Treasury TIPS maturing in one to three years — [bonds](/bond/) whose principal adjusts semiannually for the [Consumer Price Index](/consumer-price-index/). The thesis is clean: [inflation](/inflation/) matters; [interest rates](/interest-rate/) do not. A short maturity strips away duration risk, leaving only the inflation signal. [Modified duration](/modified-duration/) under one year means a one-percent rate shock costs roughly half a percent. A ten-year TIPS fund in the same scenario costs five to ten percent. RBIL sacrifices duration yield for inflation purity.

## What the fund holds and how it moves

TIPS principals reset with CPI monthly. When inflation prints 3 percent, RBIL's securities appreciate 3 percent in principal. That flows into the fund's [net asset value](/net-asset-value/) and distributions. Coupons — fixed at issuance — rise as principal rises, so payment amounts climb with inflation too.
...
RBIL's principal is protected at [par value](/par-value/) in [deflation](/deflation/); nominal losses do not occur. But if prices fall and coupons are 1 percent, your real return is negative. The short maturity limits this: principal returns within a year or two either way. Interest-rate swings are what the fund genuinely avoids. A 2 percent rate spike costs a 10-year bond 15–20 percent but costs RBIL roughly 1 percent.
...
Most bonds carry duration risk: when interest rates rise, existing bonds (which pay fixed coupons) fall in price, because new bonds paying higher coupons are now more attractive. A 10-year [Treasury bond](/treasury-bond/) might lose 10 percent of its value if interest rates jump one percentage point. TIPS are no exception; longer-duration TIPS carry the same interest-rate sensitivity as longer-dated nominal Treasuries.
...
[Credit risk](/credit-risk/) is minimal; these are US Treasury securities backed by the federal government.
