---
title: "First Trust Nasdaq Artificial Intelligence and Robotics ETF (ROBT)"
description: "An exchange-traded fund tracking companies developing and deploying artificial intelligence and robotics technologies, covering software, hardware, and industrial automation."
keywords:
...
<table>
<tr><th>Ticker</th><td>ROBT (NASDAQ)</td></tr>
<tr><th>Fund type</th><td>Thematic ETF tracking AI and robotics</td></tr>
<tr><th>Index basis</th><td>Rules-based screening for AI and robotics revenue</td></tr>
<tr><th>Geographic exposure</th><td>Global, US-heavy</td></tr>
<tr><th>Typical holdings</th><td>Software platforms, semiconductor makers, automation equipment suppliers</td></tr>
<tr><th>Main risks</th><td>Concentration in fast-moving tech, subsector disintermediation, valuation</td></tr>
<tr><th>Cost structure</th><td>Expense ratio typical of thematic tech ETFs</td></tr>
</table>
</aside>

The First Trust [Nasdaq](/nasdaq/) Artificial Intelligence and Robotics ETF (ROBT) takes a thematic approach: rather than tracking companies by geography or [market cap](/market-capitalization/), it identifies publicly listed firms that derive material revenue from artificial intelligence or robotics, then weights them in a single portfolio. The premise is straightforward — AI and robotics are enabling technologies reshaping multiple industries, and investors might want clustered exposure to that trend without hand-picking individual stocks.
