...
description: "Ferrari manufactures ultra-premium sports cars and supercars, selling to a global clientele of collectors, enthusiasts, and the ultra-wealthy."
keywords:
  - ferrari
  - luxury sports cars
...
<table>
<tr><th>Ticker</th><td>RACE (NYSE)</td></tr>
<tr><th>Founded</th><td>1947, Maranello, Italy</td></tr>
<tr><th>Founder</th><td>Enzo Ferrari</td></tr>
<tr><th>Headquarters</th><td>Maranello, Italy</td></tr>
<tr><th>Sector</th><td>Luxury automotive</td></tr>
<tr><th>Annual production</th><td>Fewer than 14,000 units</td></tr>
<tr><th>Business model</th><td>Direct sales to select clientele, branded merchandising</td></tr>
<tr><th>SEC CIK</th><td>0001648416</td></tr>
</table>
</aside>
...
Ferrari's business model rests entirely on maintaining exclusivity and commanding astronomical prices. The company limits production deliberately, keeping annual output in the low thousands. That constraint ensures that demand exceeds supply — customers must wait, and prices hold strong in the [secondary market](/secondary-market/), reinforcing the sense that a Ferrari is a valuable asset, not a rapidly depreciating consumer good.
...
Electrification also complicates the supply chain. Batteries are complex, fragile, and sourced from a handful of geographies. A naturally aspirated engine is straightforward and can be made with suppliers close to Maranello. Pivoting to electric, Ferrari must navigate battery sourcing, thermal management, and the entire supply-chain complexity that [Tesla](/tsla-stock/) navigated a decade ago. Doing so without losing the brand's handmade, artisanal appeal is a genuine challenge.
