...
Key metrics to follow include the net interest margin (which tracks the profitability of lending), [return on equity](/wiki/return-on-equity/) (measuring capital efficiency), the loan-loss provisions (a forward-looking indicator of credit quality), and capital ratios (which constrain dividend capacity). Analyst reports from investment banks and credit research firms regularly cover RBC, and the bank is heavily weighted in major Canadian equity indices.
