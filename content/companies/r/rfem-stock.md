---
title: "First Trust RiverFront Dynamic Emerging Markets ETF (RFEM)"
description: "RFEM is an actively managed emerging markets fund using dynamic rules-based allocation to tilt toward countries and sectors with favorable valuation, growth, and sentiment signals."
keywords:
  ...
  - EM equity
  - dynamic allocation
  - tactical EM exposure
handwritten: true
---

First Trust RiverFront Dynamic Emerging Markets ETF is the emerging-markets sibling of RFDI, applying the same rules-based, dynamic approach to stocks in developing countries. Rather than passively track a fixed EM index, RFEM's managers use quantitative signals to tilt the portfolio toward the emerging markets expected to deliver the best returns, based on valuation, economic momentum, and market sentiment. For investors convinced that emerging markets will outpace developed economies but skeptical of static index weighting, RFEM offers a systematically managed alternative.

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>RFEM</th></tr>
<tr><th>Sponsor</th><td>First Trust Portfolios L.P. (via RiverFront Investment Management)</th></tr>
<tr><th>Strategy</th><td>Actively managed, dynamic country and sector allocation</th></tr>
<tr><th>Fund type</th><td>Actively managed ETF</th></tr>
<tr><th>Primary focus</th><td>Emerging market equities</th></tr>
<tr><th>Geographic scope</th><td>Asia, Latin America, Eastern Europe, Middle East, Africa</th></tr>
<tr><th>Management approach</th><td>Rules-based systematic model</th></tr>
</table>
</aside>
...
RFEM holds stocks across dozens of emerging markets, from the mega-cap names in China and India to smaller companies in Vietnam, Indonesia, Brazil, Mexico, and Eastern Europe. The fund holds both the largest EM index constituents and smaller stocks that offer return potential but would not appear in a capped-weighted index. Sector exposure includes financials (typically the largest EM sector by weight), technology, consumer, energy, and industrials.

Because the portfolio is actively managed, the precise composition changes as the allocation model's signals shift. A quarterly review might see the fund increase its Mexico weighting if valuations there have fallen and economic data is improving, while trimming Thailand exposure if growth has already accelerated and valuations have expanded. This tactical rotation is the core promise of active management: to capture returns by being overweighted to markets on the upswing and underweighted to those in decline.
...
The rise of RFEM and similar dynamically managed ETFs reflects a broader shift in how investors think about active management. Rather than hiring a stock-picker to outguess markets, many now prefer systematic, rules-based approaches that quantify an allocation decision (e.g., overweight markets with cheap valuations and good growth) and execute it consistently. For EM investors, this middle-ground approach — between the simplicity of a passive index and the subjectivity of discretionary active management — appeals to those who believe EMs' structural growth will outpace developed markets but that systematic tactical allocation can reduce timing risk.

## Who RFEM is for and how to research it
