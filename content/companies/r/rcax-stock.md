---
title: "Defiance Daily Target 2x Long RCAT ETF (RCAX)"
description: "RCAX amplifies the daily returns of robotics and automation stocks with 2x leverage and daily reset mechanics. Designed for tactical traders; decay risk in sideways markets."
keywords:
  - leveraged ETF
  - robotics
  - automation theme
...
This concentration gives leverage its sharpest edge. During thematic rallies (when robots are in favour), RCAX's amplification and sector focus compound the gains. During [sector rotation](/sector-rotation/) or [recession](/recession/) (when capex budgets contract), losses are sharp.
...
This daily targeting is the critical detail. The fund does not simply hold double the amount of RCAT shares and call it a day. Instead, it rebalances daily, after market close, to reset its [leverage ratio](/leverage-ratio-forex/) to exactly 2x. If the market moved, the leverage adjusted during the day, and the fund uses derivatives (typically futures or swap contracts) to return the leverage to 2x for the next trading session.
...
The thematic focus means RCAX is concentrated in a specific story: the belief that factories, warehouses, and logistics networks will increasingly adopt robotic and automated systems, and that companies enabling that transition will benefit. It is not diversified across the full [stock market](/stock-market/) or even the full technology sector; it is a thematic bet.
...
[Liquidity risk](/liquidity-risk/) exists as well. RCAX shares must trade; if [market makers](/market-maker-trading/) withdraw or bid-ask spreads widen, an investor exiting a large position may face slippage. The underlying RCAT index is reasonably liquid, but RCAX itself is a smaller product.

Thematic [concentration risk](/concentration-risk/) is perhaps most important: the fund's value hinges entirely on the robotics-and-automation narrative staying in favor. A shift in market sentiment away from industrial robotics, a recession that stalls factory investment, or technological disappointment (autonomous systems proving harder to deploy than expected) would hurt the entire portfolio.
...
Tracking error — the difference between RCAX's actual return and double RCAT's actual return — is typically small over short periods but can accumulate over longer [holding periods](/holding-period/), especially in highly volatile markets. An investor reviewing the fund's retrospective performance should compare RCAX's return to twice the underlying RCAT index return to assess whether tracking has been tight.
