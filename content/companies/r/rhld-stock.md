---
title: "Resolute Holdings Management, Inc. (RHLD)"
description: "Resolute Holdings is a Delaware-incorporated holding company with timber and real estate operations, primarily managing timberlands in the Pacific Northwest and Southeast—a geography-dependent forest operator and land steward."
keywords:
  - timber REIT
...
<div class="wiki-infobox-title">Resolute Holdings — key facts</div>

| Attribute | Detail |
|---|---|
| **Ticker** | RHLD (TSX, OTCQX) |
| **Headquarters** | Athens, Georgia |
| **Founded** | Operations from forestry heritage; modern entity restructured over time |
| **Core business** | Timberland ownership, management, and forest products |
| **Primary regions** | Pacific Northwest, Southeast United States |
| **Business model** | Timber harvesting, land stewardship, asset sales |
| **SEC CIK** | 0002039497 |
...
Key metrics to watch: timber volumes harvested and sold (in board feet or cords); average timber price per unit; acres owned and the species composition; and the company's liquidity and debt levels. Timberland values can swing with [interest rates](/interest-rate/) (higher rates reduce the present value of future timber growth), with housing starts (the [leading indicator](/leading-indicator/) of lumber demand), and with global economic growth (which affects pulp demand). Monitor forestry publications and American Forest Products Association data to gauge supply and demand at the sector level; Resolute's results will reflect regional and timing variations of these broader trends.
