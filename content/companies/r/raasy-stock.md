---
title: "Cloopen Group Holding Ltd (RAASY)"
description: "Cloopen is a Beijing-based cloud communications provider serving Chinese enterprises with APIs, contact centers, and unified communications tools—positioned between operators and end customers."
keywords:
...
**Cloud-based contact centers** serve enterprise customer-service teams that need to manage inbound and outbound calls, chats, and tickets from a unified dashboard. These compete with established players like [Twilio](/twlo-stock/) Flex and traditional on-premises switchboard software. They require more customization than CPaaS and have higher customer lock-in: a company's entire service team relies on the platform daily, making switching expensive and disruptive.

**Cloud-based unified communications and collaboration** (UC&C) is the catch-all for internal enterprise communication—instant messaging, audio and video conferencing, and telephony. This is the most competitive segment, dominated globally by players like [Microsoft](/msft-stock/) Teams, Slack, and Zoom. In China, it competes with domestic alternatives and larger companies that can bundle UC&C into broader enterprise suites.
...
Monitor China regulatory news and any announcements of new competitors entering the UC&C or contact center space. Track Cloopen's research and development spending as a measure of product investment velocity—this company wins or loses on being faster and better than rivals, not on owning a scarce resource. Finally, watch the company's customer [acquisition](/acquisition/) cost relative to customer lifetime value, which determines whether the business can grow profitably at scale.
