---
title: "RiverNorth Opportunities Fund, Inc. (RIV-PA)"
description: "A closed-end investment fund that invests in credit opportunities and hybrid securities, trading at a discount or premium to its underlying net asset value."
keywords:
  - closed-end fund
...
[RiverNorth Opportunities](/riv-stock/) Fund, Inc. (RIV-PA) is a closed-end investment fund — a publicly traded vehicle that pools investor capital to buy and hold a fixed portfolio of securities, primarily credit instruments and hybrid securities. Like all [closed-end funds](/closed-end-fund/), it trades on an exchange (in this case, [NASDAQ](/nasdaq/)) at whatever price the market will bear, which may be substantially above or below the underlying value of its holdings — a feature that creates both opportunity and risk for the fund's shareholders.

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>RIV-PA (NASDAQ)</td></tr>
<tr><th>Type</th><td>Closed-end investment fund</td></tr>
<tr><th>Investment focus</th><td>Credit opportunities, hybrid securities, structured credit</td></tr>
<tr><th>Fee structure</th><td>Management fees plus performance-based incentives</td></tr>
<tr><th>Distribution policy</th><td>Regular monthly distributions to shareholders</td></tr>
...
The RiverNorth Opportunities Fund raises capital from investors by issuing shares, then uses that capital to purchase and hold a diversified portfolio of credit instruments — typically [bonds](/bond/), loan participations, [preferred stocks](/preferred-stock/), and more exotic hybrids. Unlike an open-ended [mutual fund](/mutual-fund/), which issues and redeems shares continuously at [net asset value](/net-asset-value/), a closed-end fund issues a fixed number of shares and trades them on an exchange like any other stock. The portfolio's value per share is calculated daily and published as net asset value (NAV), but the shares themselves trade at whatever price buyers and sellers agree upon — which may be a significant discount or premium to NAV.
