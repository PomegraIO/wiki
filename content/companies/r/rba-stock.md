...
The [10-K](/wiki/10-k/) reveals the company's segment reporting—Ritchie Bros. and IAA are still tracked separately within the company, making it possible to see the profitability and growth of each platform. Pay attention to auction volumes (number of assets sold), average transaction values, and the mix of live versus online sales. Online auctions tend to have lower commissions but higher volume.
