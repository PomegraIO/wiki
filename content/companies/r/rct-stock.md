---
title: "RedCloud Holdings (RCT)"
description: "Small technology company operating an open B2B commerce and distribution platform connecting brands, distributors, and retailers across Africa and Latin America."
keywords:
...
Publicly available financials (via its [10-K](/wiki/10-k/) filings with the SEC under [CIK 2027360](/wiki/public-company/)) show a relatively small revenue base compared to megacap software firms, but the company has invested heavily in technology and team. Like many B2B SaaS businesses targeting emerging markets, profitability lags far behind revenue, reflecting the cost of customer acquisition and the need to subsidize or absorb payment risk. The unit economics—whether an average order generates enough fee revenue to justify the cost of supporting that retailer—remain the key metric to watch.
