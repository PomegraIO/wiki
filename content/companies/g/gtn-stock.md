---
title: "GRAY MEDIA, INC (GTN)"
description: "Broadcast television network operator owning and managing TV stations across the U.S., generating revenue from local advertising and retransmission fees."
keywords: ["broadcast television", "TV stations", "local advertising", "media conglomerate", "retransmission rights"]
---

*[GRAY MEDIA, INC](/gtn-stock/) (ticker: GTN) is a [public company](/public-company/) that owns and operates a network of broadcast television stations across the United States. The company generates revenue from local and political advertising sold on its channels and from fees paid by cable and satellite providers for the right to carry its signals.*

<aside class="wiki-infobox"><table>
<tr><td>Ticker</td><td>GTN</td></tr>
<tr><td>Listing</td><td>NYSE</td></tr>
<tr><td>SEC CIK</td><td>43196</td></tr>
<tr><td>Sector</td><td>Media & Entertainment</td></tr>
<tr><td>Industry</td><td>Broadcasting</td></tr>
...
Gray Media has carried significant [debt](/bond/) from [acquisitions](/acquisition/) made during the pre-cord-cutting era when broadcast TV was still seen as a stable, cash-generative asset. That leverage became a vulnerability as advertising and total viewership declined. The company must service this debt from a shrinking cash-flow base, which creates persistent pressure on the [balance sheet](/balance-sheet/). In the past, Gray Media has struggled to refinance debt on favorable terms, and periods of rising [interest rates](/interest-rate/) create acute stress.

The company's [free cash flow](/free-cash-flow/) is consumed largely by debt service, leaving little available for capital investment in new production technology or for returning cash to shareholders. This has been a persistent challenge: the capital intensity of operating broadcast TV (production equipment, transmission infrastructure, building maintenance) competes with debt repayment for cash, and without revenue growth, the company is essentially managing a slow decline in financial returns.
...
### Closely related
- [Fox Corporation](/foxa-stock/) (larger broadcast and cable network operator)
- Paramount Global (media and content conglomerate)
- [Comcast Corporation](/cmcsa-stock/) (cable provider and retransmission customer)
