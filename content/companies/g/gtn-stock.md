...
Gray Media has carried significant [debt](/bond/) from acquisitions made during the pre-cord-cutting era when broadcast TV was still seen as a stable, cash-generative asset. That leverage became a vulnerability as advertising and total viewership declined. The company must service this debt from a shrinking cash-flow base, which creates persistent pressure on the [balance sheet](/balance-sheet/). In the past, Gray Media has struggled to refinance debt on favorable terms, and periods of rising interest rates create acute stress.
