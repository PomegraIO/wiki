...
description: "GameStop is a retailer of video games, hardware, and entertainment products, facing structural headwinds from digital distribution while attempting a transformation toward e-commerce and a broader specialty-retail footprint."
keywords:
  - video game retail
...
<table>
<tr><th>Ticker</th><td>GME (NYSE)</td></tr>
<tr><th>Founded</th><td>1984 as Software Etc.; merged with GameStop in 2000</td></tr>
<tr><th>Sector</th><td>Video game and entertainment retail</td></tr>
<tr><th>Store footprint</th><td>Physical locations in North America and international markets</td></tr>
<tr><th>Product mix</th><td>Physical games, hardware, collectibles, used merchandise</td></tr>
<tr><th>Business model</th><td>Physical retail locations plus growing e-commerce</td></tr>
<tr><th>Major disruption</th><td>Digital game distribution (Downloads, streaming services)</td></tr>
<tr><th>SEC CIK</th><td>0001326380</td></tr>
</table>
</aside>

## From growth to decline

GameStop's history is one of consolidation and expansion followed by disruption. The company was formed through the [merger](/merger/) of two mall-based game retailers, Software Etc. and GameStop (the latter originally Babbage's), in 2000, and for the next decade it was among the most successful specialty retailers in the United States. Game releases were blockbuster events — midnight launches of titles like Grand Theft Auto or Halo drew crowds to stores. The business model worked: buy physical copies of games, display them on shelves, sell them at margin, repurchase used copies at lower cost, resell them at higher prices. The used-game loop was the real profit driver because it was high-margin and repeatable.
...
The 10-K (SEC CIK 0001326380) reveals quarterly cash burn, store-closure plans, and the mix between physical and e-commerce revenue. Quarterly calls show whether merchandise mix is shifting toward higher-margin items and whether e-commerce is gaining traction. Key metrics: comparable store sales, gross margin trends, and cash position. If these inflect positive, the story changes. If decline continues, patience will erode and the stock will trade on [liquidation value](/liquidation-value/) or [acquisition](/acquisition/) likelihood rather than transformation hope.
