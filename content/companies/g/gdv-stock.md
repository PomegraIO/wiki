---
title: "Gabelli Dividend & Income Trust (GDV)"
description: "Gabelli Dividend & Income Trust is a closed-end fund managed by Gabelli Asset Management that invests in dividend-paying stocks and debt instruments."
keywords:
  - closed-end fund
  - dividend income
  - leverage
...
Gabelli [Dividend](/dividend/) & Income Trust is a closed-end investment company — a fund with a fixed number of shares that trade on an exchange like a stock — designed to generate current income and capital appreciation primarily through a portfolio of dividend-paying [common stocks](/common-stock/) and [preferred stocks](/preferred-stock/). The fund also holds [bonds](/bond/) and other debt instruments. Founded in 1988 and managed continuously by Gabelli Asset Management, it represents one of the longer-running experiments in using leverage and active stock-picking to boost yield for income-focused investors. Unlike a [mutual fund](/mutual-fund/), which redeems shares at [net asset value](/net-asset-value/), GDV's shares trade at market prices that can be significantly higher or lower than the underlying portfolio value per share — a distinction that shapes how investors should think about it.

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>GDV (NYSE)</td></tr>
...
<tr><th>Strategy</th><td>Dividend-paying stocks, preferred stocks, and bonds</td></tr>
<tr><th>Investment focus</th><td>Income generation with capital appreciation</td></tr>
