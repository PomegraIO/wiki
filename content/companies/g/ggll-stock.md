---
title: "Direxion Daily GOOGL Bull 2X ETF (GGLL)"
description: "GGLL is a leveraged exchange-traded fund providing 2x daily exposure to Google (Alphabet) shares, designed for tactical traders seeking amplified upside with heightened risk and decay."
keywords:
  - leveraged ETF
  - Google exposure
  - Alphabet
...
<table>
<tr><th>Ticker</th><td>GGLL (NASDAQ)</td></tr>
<tr><th>Fund sponsor</th><td>Direxion</td></tr>
<tr><th>Structure</th><td>Leveraged ETF, 2x daily bull</td></tr>
<tr><th>Underlying</th><td>Alphabet Inc. Class A (GOOGL)</td></tr>
<tr><th>Leverage mechanism</th><td>Daily reset via derivatives</td></tr>
<tr><th>Expense ratio</th><td>Moderate to high (~0.95%)</td></tr>
<tr><th>Target holding period</th><td>One day (intraday traders)</td></tr>
</table>
</aside>
...
Imagine Google trades for $100 one day, and GGLL costs $10 (a hypothetical ratio). Google then rises 10% to $110, so GGLL rises 20% to $12. The next day, Google falls 10% back to $99. An unleveraged investor who bought at $100 and held through both days is down 1% overall ($100 → $110 → $99), which is what the math says should happen.

But the GGLL holder has a different math. On day one they gained 20% ($10 → $12). On day two, their $12 position falls 20% to $9.60. The total return is negative 4% despite the underlying stock ending where it started.

This is volatility decay. It happens because leverage amplifies losses as well as gains, and a 20% gain followed by a 20% loss does not return to the starting point — it undershoots. The longer an investor holds GGLL, the more the decay compounds, especially in choppy or sideways markets.
...
The obvious risk is that if Google falls sharply, you lose twice as fast. A 20% decline in GOOGL means a roughly 40% loss in GGLL — real money that is hard to recover.
