...
The partnership finances its vessel [acquisitions](/acquisition/) and operating expenses through operating cash flow, debt (including a $2.8 billion revolving credit facility secured by the fleet), and periodic equity issuances. The [balance sheet](/balance-sheet/) and vessel security arrangements are disclosed in annual filings to the US [Securities and Exchange Commission](/securities-and-exchange-commission/), even though GasLog Partners qualifies as a foreign private issuer (it is not a US company).
