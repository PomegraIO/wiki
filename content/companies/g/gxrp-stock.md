---
title: "Grayscale XRP Trust ETF (GXRP)"
description: "A passively managed trust that holds XRP cryptocurrency, allowing investors to gain exposure to the token through traditional brokerage accounts without direct custodial custody."
keywords:
  - XRP
  - cryptocurrency
  - digital asset
...
<table>
<tr><th>Ticker</th><td>GXRP (NYSE Arca)</td></tr>
<tr><th>Founded</th><td>August 5, 2024</td></tr>
<tr><th>Sponsor</th><td>Grayscale Investments</td></tr>
<tr><th>Asset Class</th><td>Cryptocurrency (XRP)</td></tr>
<tr><th>Fund Type</th><td>Passive trust, not registered under 1940 Investment Company Act</td></tr>
<tr><th>Listing Date</th><td>November 24, 2025 (uplisted to ETP)</td></tr>
<tr><th>SEC CIK</th><td>0002037427</td></tr>
</table>
</aside>
...
This structure is not new. Grayscale operates several such trusts, including for [Bitcoin](/bitcoin/) and [Ethereum](/ethereum/), and the model predates the recent explosion of cryptocurrency spot exchange-traded funds. The key distinction is regulatory: GXRP is not registered under the [Investment Company Act of 1940](/investment-company-act-of-1940/), which means it does not face the same oversight, reporting, and protective requirements as a [mutual fund](/mutual-fund/) or registered ETF. This has legal and practical implications, most notably around redemption and disclosure rules, but it also allows the fund to operate with a simpler structure and lower operational friction.

## Holdings and concentration

The fund holds XRP and nothing else — a single-asset fund, so any performance or volatility is entirely attributable to XRP's price movement. As of the fund's recent filings, Grayscale reports that GXRP holds approximately 0.20% of all XRP in circulation, a meaningful position but not a dominant one given the decentralised nature of the blockchain and the substantial holdings by other [custodians](/custodian/), institutions, and retail investors worldwide.
...
GXRP's own SEC filings (CIK 0002037427) disclose the trust's assets, expenses, and the fund's change in status from [private placement](/private-placement/) to public ETP. Investors should review the prospectus carefully to understand the trust's structure, fee model, and the specific risks of holding XRP through this vehicle rather than another vehicle or directly. The fund's trading volume and spreads on the [secondary market](/secondary-market/) are also worth observing, as they determine the real cost of entry and exit.
