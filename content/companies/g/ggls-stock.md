---
title: "Direxion Daily GOOGL Bear 1X ETF (GGLS)"
description: "GGLS is an inverse ETF tracking the opposite of Alphabet Inc., giving traders bearish exposure without short-selling — daily reset mechanics create decay risk on longer holdings."
keywords:
  - inverse ETF
  - bearish exposure
  - Alphabet hedge
  - daily reset
  - volatility decay
  - short position alternative
handwritten: true
---

*The **Direxion Daily GOOGL Bear 1X ETF** (ticker GGLS) is an inverse exchange-traded fund that moves in the opposite direction of [Alphabet](/googl-stock/) Inc. stock — if Google falls, GGLS rises, and vice versa. It exists to give traders and hedgers a simple alternative to short-selling: a way to bet against Alphabet without borrowing shares or facing unlimited upside loss.*

Shorting a stock is conceptually straightforward but practically demanding. You borrow shares from a [broker](/broker/), sell them at today's price, and hope to buy them back cheaper later, pocketing the difference. The catch is that the broker charges a borrowing fee, the lender can demand the shares back at any time, and if the stock rallies, your losses are theoretically unlimited. [Inverse ETFs](/inverse-etf/) like GGLS avoid all that friction. They hold no borrowed shares. Instead, they use derivatives — swaps, puts, and other instruments — to create a portfolio that rises when Alphabet falls.
...
This makes GGLS useful only for short-term tactical hedges. A portfolio manager worried about a sharp near-term drop in Alphabet might buy GGLS for a week, knowing that it will cushion a sudden decline. A trader expecting Google to trade lower this month might use GGLS as a convenient short substitute. Both scenarios involve [holding periods](/holding-period/) measured in days, not months. Neither relies on GGLS to compound value over a long cycle.
