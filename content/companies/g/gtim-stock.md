---
title: "Good Times Restaurants Inc. (GTIM)"
description: "Good Times Restaurants operates a small chain of casual-dining establishments, positioned in the value chain between food suppliers and consumers seeking affordable, straightforward dining in secondary markets."
...
<tr><th>SEC CIK</th><td>825324</td></tr>
<tr><th>Sector</th><td>Food Service / Hospitality</td></tr>
...
GTIM funds itself through [equity](/common-stock/) and [debt](/corporate-bond/) to finance growth (new locations) and to cover losses during downturns. The company's profit and loss ultimately reflects the aggregate health of its locations. If most locations are profitable and traffic is stable or growing, GTIM is profitable. If economic conditions weaken, traffic declines, or competition intensifies, margins compress and GTIM may slide into loss. The company has limited operating leverage; fixed costs (corporate overhead, field support) must be covered even if sales decline. GTIM's [balance sheet](/balance-sheet/) and [income statement](/income-statement/) will reflect the steady-state profitability of its current portfolio of locations and the near-term pipeline of new openings.

<div class="wiki-seealso">

### Closely related
- [/gtlb-stock/](/gtlb-stock/) — illustrates asset-light, software-driven value chains versus GTIM's capital-intensive operations
- [/gtic-stock/](/gtic-stock/) — both operate in niche market positions with modest scale
