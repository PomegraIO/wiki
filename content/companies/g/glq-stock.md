---
title: "Clough Global Equity Fund (GLQ)"
description: "Clough Global Equity Fund is a closed-end mutual fund investing primarily in global stocks, with particular focus on non-US markets and valuation-oriented stock selection."
keywords:
  - closed-end fund
  - global equities
...
As a closed-end fund, GLQ trades on an exchange, and its shares are bought and sold by investors. The fund itself has expenses: [management fees](/management-fee/) paid to Clough Investment Advisors, custody costs, administrative costs, and if the fund uses leverage, interest on borrowed money. These costs reduce net returns to shareholders.

The [board of directors](/board-of-directors/) appoints the investment manager and oversees fees and performance. Unlike an [open-end fund](/open-end-fund/), shareholders of closed-end funds generally cannot easily redirect assets to a different manager — redemption at net asset value is not available.
