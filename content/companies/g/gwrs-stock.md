...
description: "A water utility and infrastructure company serving Arizona municipalities and agricultural customers, with capital-intensive physical assets and regulated pricing structures."
keywords: [water utility, infrastructure, Arizona, regulated utility, municipal water]
---

*Regulated water utilities are fundamentally about what they own: treatment plants, distribution lines, reservoirs, wells, and pipelines. For **Global Water Resources, Inc. (GWRS)**, these tangible assets dominate the [balance sheet](/balance-sheet/) and constrain the business model. What the company owns determines what it can sell; how it financed those assets determines what it earns; and the regulatory framework that governs its service territories sets the [return on equity](/return-on-equity/) allowed by law.*

<aside class="wiki-infobox"><table>
<tr><td>Ticker</td><td>GWRS</td></tr>
<tr><td>Listing</td><td>NASDAQ</td></tr>
<tr><td>SEC CIK</td><td>1434728</td></tr>
<tr><td>Sector</td><td>Utilities</td></tr>
<tr><td>Industry</td><td>Water & Wastewater</td></tr>
...
For Global Water Resources, reported net income (after depreciation) understates true earnings power. The cash statement will show that depreciation (a non-cash charge) is a large add-back to net income, revealing the true cash generation capacity. Investors in regulated utilities often use metrics like [funds from operations](/funds-from-operations/) (net income plus depreciation) to assess distributions and growth capacity.
