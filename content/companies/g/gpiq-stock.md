---
title: "Goldman Sachs Nasdaq-100 Premium Income ETF (GPIQ)"
description: "GPIQ holds Nasdaq-100 tech and growth stocks while selling call options against them to generate income. A covered-call ETF that trades income for upside."
keywords:
  - Nasdaq-100
  - covered call
  - income ETF
...
Tech stocks move faster than dividend-paying utilities. But what if you owned tech stocks and also got paid for that ownership, like a [dividend](/dividend/) stock? That is the idea behind the [Goldman Sachs](/goldman-sachs/) Nasdaq-100 Premium [Income ETF](/income-etf/) (ticker GPIQ). It holds the stocks in the Nasdaq-100 index but sells [call options](/call-option/) against those holdings to generate income. You get the upside of owning tech companies, but with a cap on how much you can profit.

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>GPIQ (NASDAQ)</td></tr>
<tr><th>Sponsor</th><td>Goldman Sachs</td></tr>
<tr><th>Fund type</th><td>Covered-call ETF</td></tr>
<tr><th>Index</th><td>Nasdaq-100</td></tr>
<tr><th>Strategy</th><td>Hold stocks, sell monthly call options</td></tr>
<tr><th>Expense ratio</th><td>Low to modest</td></tr>
<tr><th>Income distribution</th><td>Monthly</td></tr>
<tr><th>Liquidity</th><td>Good; reasonable bid-ask spreads</td></tr>
</table>
</aside>

## What the Nasdaq-100 is and why it matters

The Nasdaq-100 is a list of the largest 100 companies traded on the [Nasdaq](/nasdaq/) [stock exchange](/stock-exchange/), mostly technology and growth companies. It includes the household names: [Apple](/aapl-stock/), [Microsoft](/msft-stock/), Amazon, Google, [Tesla](/tsla-stock/), and others. If you own a technology-focused [index fund](/index-fund/), you own these stocks. GPIQ owns them too. But GPIQ does something extra: it sells call options on those stocks.

## How a covered call works

A call option is a bet on a stock price. When you own a stock, you can sell the right to buy it from you at a fixed price. For example, if you own Apple stock trading at 150 dollars, you can sell someone the right to buy it from you at 160 dollars next month. You get paid money upfront for that right (called the premium). If Apple stays below 160 dollars, the option expires worthless, you keep the premium and the stock, and you do it all over again next month. If Apple rises above 160 dollars, the buyer of the option exercises it, pays you 160 dollars per share, and you hand over the stock. You miss the gains above 160 dollars, but you already got paid the [option premium](/option-premium/), so your total return is capped at the premium plus the 160-dollar price.
...
- You have a long time horizon and can stomach the fact that you will lag in big [bull markets](/bull-market/).
...
GPIQ trades on the NASDAQ at market prices. The [expense ratio](/expense-ratio/) is low to modest — it is not free to run an options program, but it is cheaper than hiring an active stockpicker to manage the fund.
...
Finally, there is [reinvestment risk](/reinvestment-risk/). If you receive monthly distributions but do not reinvest them, you are slowly moving to a lower ownership stake. You will miss out on the compounding power of leaving the income invested.
...
It is not for growth investors or anyone young enough to take full [market risk](/market-risk/). If that is you, owning the Nasdaq-100 directly (through QQQ or another basic tech ETF) will serve you better over decades.
