---
title: "Great Elm Capital Corp. (GECCG)"
description: "GECCG is a senior secured note issued by Great Elm Capital Corp, a BDC that invests in middle-market secured debt and specialty finance equity, generating income across credit cycles."
keywords:
  - BDC
  - secured debt
...
[Great Elm Capital](/gecc-stock/) Corp. is a closed-end investment company regulated as a [business development company](/business-development-company/) that has elected to be taxed as a regulated investment company. The 7.75% senior notes due December 2030, traded on [NASDAQ](/nasdaq/) under the ticker GECCG, represent claims on the company's cash flows and assets. To understand these notes, one must first understand the parent company and what it does with investor capital.

<aside class="wiki-infobox">
<table>
<tr><th>Issuer</th><td>Great Elm Capital Corp.</td></tr>
<tr><th>Security type</th><td>Senior secured notes</td></tr>
<tr><th>Maturity</th><td>December 2030</td></tr>
<tr><th>Coupon rate</th><td>7.75%</td></tr>
<tr><th>Ticker</th><td>GECCG (NASDAQ)</td></tr>
<tr><th>Sector</th><td>Specialty finance / lending</td></tr>
...
The [coupon rate](/coupon-rate/) on GECCG reflects the market's view of the risk when the notes were issued. Whether that rate is attractive now depends on current [credit spreads](/credit-spread/) available on comparable securities and the near-term outlook for the company's earnings stability. As with any corporate debt, the market prices these notes moment by moment; nothing in their current rate or price is a forecast or a recommendation.
