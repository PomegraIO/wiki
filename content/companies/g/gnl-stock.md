---
title: "Global Net Lease, Inc. (GNL)"
description: "A real estate investment trust acquiring and leasing single-tenant commercial properties globally, generating revenue through long-term tenant leases at fixed or inflation-adjusted rates."
keywords: ["REIT", "net lease", "commercial real estate", "single-tenant", "recurring revenue"]
---
...
GNL is highly leveraged — like most REITs, it finances acquisitions with a mixture of debt and equity, often 60–70% debt. The company's debt costs are reflected in its cost of capital; when [interest rates](/interest-rate/) rise, GNL's debt becomes more expensive to refinance, squeezing the cap-rate spread.

This creates a structural vulnerability: if GNL borrows at 4% to acquire a property yielding 6%, the spread seems healthy. But if rates rise to 6% before the debt matures, refinancing at a higher cost erodes that spread. Long-term debt with staggered maturities reduces refinancing shock, but GNL must still manage a [balance sheet](/balance-sheet/) maturity ladder and monitor [interest-rate risk](/interest-rate-risk/).
