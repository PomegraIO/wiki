---
title: "iShares GNMA Bond ETF (GNMA)"
description: "An ETF holding a portfolio of Government National Mortgage Association mortgage-backed securities, offering fixed-income exposure backed by U.S. government guarantee."
keywords:
...
|---|---|
| **Fund type** | Bond ETF (Mortgage-Backed Securities) |
| **Underlying assets** | GNMA mortgage-backed securities |
| **Sponsor** | BlackRock iShares |
| **Issuer guarantee** | U.S. Government (GNMA) |
| **Typical maturity** | 1–10 years (pools of mortgages) |
| **Interest rate sensitivity** | Moderate to high |
| **Credit risk** | Minimal (government-guaranteed principal) |
| **Prepayment risk** | Significant (mortgagors refinance when rates fall) |
...
To research GNMA, examine the prospectus to understand the composition of the underlying mortgage pools, their weighted average maturity, and the [coupon rates](/coupon-rate/). Track the fund's [current yield](/current-yield/) and compare it against Treasury bonds of similar maturity to gauge the incentive structure.
...
Finally, know that GNMA's performance is driven more by interest rate movements than by any [credit event](/credit-event-sovereign/) or macroeconomic surprise unrelated to rates. Investors using GNMA are implicitly positioning on their view of [Federal Reserve](/federal-reserve/) policy and long-term interest rate trends.
