---
title: "Gossamer Bio, Inc. (GOSS)"
description: "A clinical-stage biopharmaceutical company developing immunology and gene-therapy treatments; currently pre-revenue with a [burn rate](/balance-sheet/) as the primary financial metric."
...
For Gossamer, the traditional [stock](/stock/) metrics—[earnings per share](/earnings-per-share/), [price-to-earnings ratio](/price-to-earnings-ratio/), [return-on-equity](/return-on-equity/)—are meaningless or negative. Useful metrics are:
...
### Closely related
- [/gotu-stock/](/gotu-stock/) — Profitable platform business with positive margins
- [/goro-stock/](/goro-stock/) — Asset-based business with cyclical cash generation
