---
title: "VictoryShares Free Cash Flow Growth ETF (GFLW)"
description: "GFLW is a US equity exchange-traded fund that screens for profitable companies generating strong free cash flow, targeting sustainable dividend growth and capital appreciation."
keywords:
  - free cash flow
  - dividend growth
  - quality stocks
...
<table>
<tr><th>Ticker</th><td>GFLW (NASDAQ)</td></tr>
<tr><th>Fund sponsor</th><td>VictoryShares</td></tr>
<tr><th>Structure</th><td>Passively managed ETF</td></tr>
<tr><th>Underlying index</th><td>Victory Free Cash Flow US Large Cap Index</td></tr>
<tr><th>Holdings</th><td>~100 US large-cap stocks</td></tr>
<tr><th>Expense ratio</th><td>Low (under 0.40%)</td></tr>
<tr><th>Investment approach</th><td>Free cash flow screening and growth</td></tr>
</table>
</aside>

## What free cash flow actually means

Free cash flow is the cash a company generates minus what it spends to keep the business running and stay competitive. It is, in a word, the cash the company gets to keep. A bank might value a company on its earnings or its revenue, but the clearest picture of its health and its ability to pay you back comes from the cash it actually produces. Free cash flow is the metric that cuts through accounting choices, mark-ups, and one-time items to answer a simple question: does this business actually generate cash?

GFLW screens the large-cap US equity universe (companies with large market value) for those ranking well on free cash flow metrics and growth. The underlying Victory index then weights those companies and rebalances regularly. Unlike a fund that just picks the largest companies by market value regardless of quality, GFLW asks: which large companies are actually generating real cash, and which are growing that cash at a meaningful pace?

## How the fund is structured and managed
...
This fund works well for investors who believe profitable, cash-generative companies are better foundations for long-term wealth than trendy growth stories or value traps. It suits someone building a core US stock position who wants to tilt toward quality and stability rather than size alone. It is not a trading vehicle — it is a buy-and-hold core holding. It is also not a hedge or a way to time the market; it is simply a screened, diversified slice of the US large-cap market.
...
Start with the prospectus and fact sheet from VictoryShares, which lay out the index methodology, holdings, and strategy in full. Look at the list of top holdings — seeing what kinds of companies the screen favors is instructive. Track the expense ratio and make sure it has not drifted upward. Watch the rolling one-year, three-year, and five-year returns versus the broader large-cap US index to see whether the free-cash-flow screen adds value, and over how many [market cycles](/market-cycle/). And monitor the turnover — passive funds should turn over their holdings slowly; high turnover signals the underlying index is not stable or that the methodology has shifted.
