...
*General Catalyst Global Resilience Merger Corp. (**GCGR**) is a [special-purpose-acquisition-company](/special-purpose-acquisition-company/), or SPAC—a US-incorporated shell company that raised capital from public investors to finance the acquisition of or merger with an operating company. As a SPAC focused on "global resilience," the vehicle's stated geographic and thematic mandate is to identify and acquire businesses that benefit from or contribute to economic resilience across multiple regions; the specific target company, location, and business model remain to be determined.*
