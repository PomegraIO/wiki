---
title: "The GDL Fund (GDL)"
description: "The GDL Fund is a closed-end fund pursuing merger arbitrage and corporate reorganization strategies to generate returns independent of broad market direction."
keywords:
  - merger arbitrage
  - closed-end fund
  - corporate events
...
The GDL Fund (formerly known as the Gabelli Global Deal Fund) is a specialized [closed-end fund](/closed-end-fund/) that invests in corporate events — [mergers](/merger/), [acquisitions](/acquisition/), [tender offers](/tender-offer/), [spin-offs](/spin-off/), and [liquidations](/liquidation/). The fund does not simply buy stocks and hope they go up; instead, it bets on the spread between the announcement price of a deal and the expected closing price, a strategy called [merger arbitrage](/merger-arbitrage-definition/). Its customer is an investor seeking returns uncorrelated with rising or falling [stock markets](/stock-market/), willing to accept complexity and deal-specific risks in exchange for the possibility of steady, event-driven gains.

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>GDL (NASDAQ)</td></tr>
<tr><th>Manager</th><td>GAMCO Investors, Inc. / Gabelli Funds, LLC</td></tr>
<tr><th>Investment strategy</th><td>Merger arbitrage and corporate reorganizations</td></tr>
<tr><th>Primary holdings</th><td>Announced-deal securities, stubs, spin-offs, liquidations</td></tr>
<tr><th>Investment goal</th><td>Absolute returns across market conditions</td></tr>
<tr><th>Inception</th><td>Late 1990s / early 2000s</td></tr>
<tr><th>SEC CIK</th><td>0001378701</td></tr>
</table>
</aside>
...
Merger arbitrage is fundamentally different from conventional stock picking. It does not depend on whether the stock market goes up or down — a major [bear market](/bear-market/) does not hurt the arbitrageur if deals still close as expected. But it does depend on deal completion, which requires that financing come through, regulatory approvers smile, and no better counterbid emerges. If a deal breaks, the stock often falls sharply, wiping out the arbitrage profit and then some. During 2020's pandemic shock, deal spreads blew out as investors feared cancellations; GDL and similar arbitrage funds suffered losses because completion risk was suddenly real.
...
Evaluating GDL as an investment means understanding the current deal environment: How many announced deals are in the fund? What are the average spreads? Are there any particularly high-risk situations or deals likely to break? What was the break-rate history — what percentage of deals closed as expected? The fund's [annual report](/10-k/) and quarterly fact sheets lay out the portfolio composition and performance attribution. Look at how GDL's returns have moved with stock and bond markets; strong negative correlation is a sign it is delivering its event-driven promise, while positive correlation suggests it is drifting. Also track the [expense ratio](/expense-ratio/) — arbitrage funds have fees because the research and monitoring are intense, and high fees eat into what should be modest spreads. If GDL's fee exceeds its annual excess return, the strategy is not worth it.
