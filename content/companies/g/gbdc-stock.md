...
description: "Golub Capital BDC is a business development company that originates and holds loans to mid-market firms, earning spread between funding cost and loan yield."
keywords: [bdc, business-development-company, mid-market-lending, direct-lending, investment-returns, leverage]
---

*Golub Capital BDC, Inc. (GBDC), trading on [NASDAQ](/nasdaq/), is a [public company](/public-company/) and a [Business Development Company](/special-purpose-acquisition-company/) regulated as a [investment](/index-fund/) company under the [Securities and Exchange Commission](/securities-and-exchange-commission/). The firm originates and holds loans to middle-market corporations—typically companies with $50 million to $500 million in annual revenue that seek capital for [acquisitions](/acquisition/), [recapitalizations](/recapitalization/), or expansion. Its unit economics are governed by the spread: the difference between the yield it earns on loans and the cost of the capital it uses to fund those loans.*

<aside class="wiki-infobox"><table>
<tr><td>Ticker</td><td>GBDC</td></tr>
<tr><td>Listing</td><td>NASDAQ</td></tr>
<tr><td>SEC CIK</td><td>1476765</td></tr>
<tr><td>Sector</td><td>Finance</td></tr>
<tr><td>Industry</td><td>Business Development Company / Private Credit</td></tr>
...
Golub Capital originates loans through its network of originators, sponsors, and direct company relationships. A typical deal: a private equity sponsor owns a company and wants to fund a bolt-on acquisition. Golub Capital underwrites the deal—evaluates the target's revenue, [EBITDA](/ebitda/), management, industry dynamics—and commits a $30 million senior secured loan at a 4.5 percent spread to the cost of funds. The sponsor commits some equity to cushion the loan (a [debt-to-EBITDA ratio](/debt-to-ebitda-ratio/) of, say, 3.5x), and Golub holds the loan until maturity (typically 5 to 7 years).
...
Mid-market loans carry duration risk: if a company's business deteriorates in year four of a seven-year loan, Golub Capital is committed to holding the loan to its maturity. It cannot call the loan early absent a default, and it cannot force a sale. If the company enters distress, Golub's recovery—the amount it ultimately collects—depends on the company's [liquidation value](/liquidation-value/) and the seniority of its lien. For secured loans, this is usually 50 to 80 percent of par, leaving Golub to absorb the balance as loss.
