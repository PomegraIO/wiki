---
title: "Great Elm Capital Corp. (GECCH)"
description: "GECCH senior notes represent secured debt issued by Great Elm Capital Corp, a BDC investing across secured debt, CLO equity, and specialty finance, generating income from a diversified middle-market portfolio."
keywords:
  - BDC
  - specialty finance
  - CLO equity
...
<table>
<tr><th>Issuer</th><td>Great Elm Capital Corp.</td></tr>
<tr><th>Security type</th><td>Senior secured notes</td></tr>
<tr><th>Maturity</th><td>December 2029</td></tr>
<tr><th>Coupon rate</th><td>8.125%</td></tr>
<tr><th>Ticker</th><td>GECCH (NASDAQ)</td></tr>
<tr><th>Sector</th><td>Specialty finance / asset management</td></tr>
<tr><th>SEC CIK</th><td>0001675033</td></tr>
</table>
</aside>
...
|---|---|---|
| Secured debt interest | Contractual, monthly/quarterly | Highly predictable |
| Senior secured interest | Contractual, monthly/quarterly | Highly predictable |
| CLO equity distributions | Variable, dependent on underlying loan performance | Moderate predictability |
| Specialty finance equity | Dividends and capital gains | Low predictability |
...
The GECCH notes, being secured and senior in the capital structure, are protected by the company's asset base and operating earnings. But that protection is not absolute. A severe or prolonged credit downturn that forces outsized losses can eventually impair enough equity capital to threaten the seniority that makes these notes safe. The economic cycle directly determines the company's margin for error.
...
Third, watch earnings coverage of the notes. The company discloses quarterly interest expense and operating earnings; a coverage ratio of two times or higher suggests the company has comfortable margin to service its debt even if earnings moderate. A coverage ratio below 1.5x signals tightening conditions.

The maturity date of GECCH — December 2029 — means the company must have cash or refinancing available by then to retire the notes. Monitoring the company's refinancing patterns and access to capital markets provides a forward signal on whether management expects the credit environment to remain hospitable.

Great Elm's annual 10-K and quarterly earnings releases contain the granular data needed to track these factors. Nothing here recommends or advises purchase or sale; the notes trade in the market at prices reflecting the market's assessment of these dynamics.
