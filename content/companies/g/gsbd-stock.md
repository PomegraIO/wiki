...
description: "Goldman Sachs BDC is a closed-end business development company managing a diversified portfolio of loans and equity stakes in lower-middle-market firms."
keywords: [bdc, business development company, goldman sachs, credit, leverage, closed-end fund]
---

*[**Goldman Sachs BDC, Inc.**](/gsbd-stock/) (ticker **GSBD**, [SEC CIK 1572694](https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&CIK=1572694)) is a [business-development company](/special-purpose-acquisition-company/) sponsored and managed by one of Wall Street's largest and most established investment firms. The company deploys capital into loans, mezzanine debt, and equity investments targeting middle-market companies—firms with enterprise values between roughly $50 million and $1 billion. Its moat rests principally on the franchise, distribution, and operational reach of its parent sponsor, [Goldman Sachs](/goldman-sachs/) Asset Management, which channels deal flow, due diligence expertise, and portfolio-company support through GSBD's structure.*

<aside class="wiki-infobox"><table>
<tr><td>Ticker</td><td>GSBD</td></tr>
<tr><td>Listing</td><td>NASDAQ</td></tr>
<tr><td>SEC CIK</td><td>1572694</td></tr>
<tr><td>Sector</td><td>Financials</td></tr>
<tr><td>Industry</td><td>Asset Management / Credit</td></tr>
<tr><td>Type</td><td>Closed-end investment company (BDC)</td></tr>
</table></aside>

## The Sponsor Advantage in BDC Investing

Business development companies operate as publicly traded, closed-end investment vehicles that are allowed to use leverage and hold illiquid assets in ways that open-end [mutual funds](/mutual-fund/) cannot. This structural freedom permits them to chase yield and return through credit and equity instruments that trade infrequently and carry execution risk. The advantage of being sponsored by [Goldman Sachs](/gs-stock/) is both mundane and powerful: the parent firm's deal-sourcing platform, credit analysts, and senior-lending relationships funnel investment opportunities to GSBD before they reach the open market. A smaller, unaffiliated BDC must compete for deal access or build its own network. Goldman Sachs BDC inherits instantaneous access to the bank's relationship universe and its internal assessments of borrower creditworthiness.
...
The principal threats to its moat are structural: regulatory changes to BDC leverage or taxation, shifts in middle-market credit conditions that make loans less profitable, and competition from alternative credit providers ([hedge funds](/hedge-fund/), insurance companies, private-credit platforms) that escape the BDC regulatory box. If nontraditional lenders crowd out traditional BDCs in pricing or access, even Goldman Sachs' advantage diminishes.
...
- [Business-Development Company](/special-purpose-acquisition-company/)
- [Leverage](/enterprise-value/)

### Wider context
- [Asset Management](/stock/)
- [Credit and Lending](/bond/)
- [Public Markets](/stock-exchange/)
</div>
