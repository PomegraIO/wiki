---
title: "Greenidge Generation Holdings Inc. (GREEL)"
description: "Greenidge is a power plant operator and bitcoin miner that combines electricity generation with cryptocurrency mining to capture operating margin across both businesses."
keywords:
  - bitcoin mining
  - power generation
  - cryptocurrency
...
[Greenidge Generation](/gree-stock/) Holdings runs a straightforward business with a complicated reputation: it owns a [natural gas](/natural-gas/) power plant and uses most of the electricity that plant produces to power computers that mine [bitcoin](/bitcoin/). The company is vertically integrated, meaning it owns the power source and the mining equipment. No middlemen. No wholesale electricity purchases. If the plant generates 100 megawatts, Greenidge owns and operates the machines that consume most of it.

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>GREE (NASDAQ); GREEL (Senior Notes)</td></tr>
<tr><th>Founded</th><td>Power plant: late 1990s; mining operations began 2020</td></tr>
<tr><th>Headquarters</th><td>Dresden, New York</td></tr>
<tr><th>Sector</th><td>Power generation, cryptocurrency mining</td></tr>
<tr><th>Primary asset</th><td>106 MW natural gas power plant</td></tr>
<tr><th>Business model</th><td>Integrated power generation and bitcoin mining</td></tr>
<tr><th>SEC CIK</th><td>0001844971</td></tr>
</table>
</aside>
...
When bitcoin rallied in 2021 and again in 2024-2025, miners made exceptional returns. The high price of bitcoin made even expensive mining operations profitable. Conversely, when bitcoin price crashed in 2022, even efficient miners struggled. Greenidge reported losses in some quarters during the 2022 [bear market](/bear-market/).
...
Larger mining companies and tech-forward energy companies are entering the space. Mining no longer requires proprietary knowledge—the technology is open-source software and commodity hardware. What matters is capital availability and operational efficiency. Greenidge will compete on those dimensions against well-capitalized rivals with stronger [balance sheets](/balance-sheet/) and more diversified business models.
...
Greenidge files quarterly and [annual reports](/10-k/) with the SEC under CIK 0001844971. Key metrics include mining hashrate, power generation, bitcoin produced, cost per unit of power, and cash generated. Watch bitcoin price and mining difficulty; both drive profitability. The company's debt load and interest coverage matter; if bitcoin price crashes, can the company service its obligations? Environmental and regulatory developments in New York are critical to monitor. Finally, track the company's competitive positioning relative to other public and private mining operations. Greenidge is a simple company with simple metrics, but it is also a cyclical business entirely dependent on the bitcoin price and the permission to keep operating.