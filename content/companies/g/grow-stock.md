---
title: "U.S. Global Investors Inc. (GROW)"
description: "A boutique asset manager offering diversified international and thematic equity strategies for retail and institutional investors seeking non-U.S. market exposure."
keywords: ["asset management", "international equities", "ETF", "investment funds", "emerging markets", "retail investing"]
---
...
<tr><td><strong>Ticker</strong></td><td>GROW</td></tr>
<tr><td><strong>Listing</strong></td><td>NASDAQ</td></tr>
<tr><td><strong>SEC CIK</strong></td><td>754811</td></tr>
...
As a public company, U.S. Global must balance reinvestment (hiring analysts, marketing funds, building technology) with returning capital to shareholders. The firm funds operations from [management fees](/management-fee/); excess cash is available for [dividends](/dividend/), share buybacks, or organic growth. The capital structure is straightforward—[common equity](/common-stock/) financed from [retained earnings](/retained-earnings/) and client inflows, minimal [debt](/corporate-bond/) (the business model requires trust, not leverage). The [stock price](/stock/) reflects both current profitability and investor expectations about future asset growth.
...
Start with the firm's [10-K annual report](/10-k/) filed with the [SEC](/securities-and-exchange-commission/) using its CIK 754811. The 10-K discloses:
...
### Closely related
- [Groupon, Inc.](/grpn-stock/)
- [Gold Royalty Corp.](/groy-stock/)

### Wider context
- [Asset management fees and fund selection](/index-fund/)
- [Understanding fund prospectuses](/10-k/)
- [Shareholder returns and buybacks](/share-buyback/)
