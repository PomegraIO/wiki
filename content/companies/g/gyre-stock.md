---
title: "GYRE THERAPEUTICS, INC. (GYRE)"
description: "A clinical-stage biopharmaceutical company pursuing ophthalmology and regenerative medicine; economic viability depends entirely on successful drug development and regulatory approval—a binary, long-cycle, capital-intensive proposition."
keywords: ["biotech", "drug development", "ophthalmology", "regenerative medicine", "clinical trials", "FDA approval", "cik-1124105"]
---
...
<tr><td><strong>Ticker</strong></td><td>GYRE</td></tr>
<tr><td><strong>SEC Listing</strong></td><td>US public company</td></tr>
<tr><td><strong>CIK</strong></td><td>1124105</td></tr>
<tr><td><strong>Type</strong></td><td>Biopharmaceutical Company</td></tr>
<tr><td><strong>Stage</strong></td><td>Clinical/Development-stage</td></tr>
<tr><td><strong>Therapeutic Focus</strong></td><td>Ophthalmology, Regenerative Medicine</td></tr>
</table></aside>
...
How should an investor value a company that currently generates no revenue and may never do so? Traditional [valuation metrics](/price-to-earnings-ratio/) like [price-to-earnings ratio](/price-to-earnings-ratio/) or [price-to-sales ratio](/price-to-sales-ratio/) do not apply to development-stage biotech. Instead, investors use DCF (discounted cash flow) models that assign probabilities to various outcomes: probability of Phase 2 success (say, 60%), probability of Phase 3 success (say, 50%), probability of regulatory approval (say, 80%), and probability of commercial adoption. They then estimate peak sales and apply a [discount rate](/discount-rate/) to reflect the [time value](/time-value/) of money and the risk of failure.
...
An investor interested in GYRE should start by understanding the company's pipeline. What programs is it pursuing? What are the indications (diseases)? At what stage of development is each? The [10-K filing](/10-k/) with the SEC and quarterly press releases provide this information. Next, research the clinical and regulatory pathway for each indication. How many patients have the disease? What therapies currently exist? Is there unmet need? What would the FDA likely require in terms of clinical data for approval?
...
### Closely related
- Development-stage companies and [free cash flow](/free-cash-flow/) timing
- [balance sheet](/balance-sheet/) analysis for pre-revenue entities
- Regulatory frameworks and FDA approval pathways

### Wider context
- [initial public offering](/initial-public-offering/) of biotech companies
- [enterprise value](/enterprise-value/) and pipeline valuation
