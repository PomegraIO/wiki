...
description: "Global Business Travel operates a platform that manages corporate travel — booking flights and hotels, managing expenses, and providing data analytics to help large employers control travel costs."
keywords:
  - corporate travel
  - travel management
...
<table>
<tr><th>What it does</th><td>Manages corporate travel and expense reporting for businesses</td></tr>
<tr><th>How it makes money</th><td>Fees from corporate clients; commissions from airlines and hotels</td></tr>
<tr><th>Primary customer</th><td>Large multinational corporations and mid-market enterprises</td></tr>
<tr><th>Platform type</th><td>SaaS travel management system + booking and analytics</td></tr>
<tr><th>Ticker</th><td>GBTG (NASDAQ)</td></tr>
<tr><th>SEC CIK</th><td>0001820872</td></tr>
</table>
</aside>

Global Business Travel Group operates a software-and-services platform that handles corporate travel for multinational companies. Large employers hand over the job of booking travel, managing policies, submitting expenses, and analyzing spend patterns to GBTG. The company is a middleman between corporations, airlines, hotels, and the SaaS tools that tie it all together. It trades on [NASDAQ](/nasdaq/) under the ticker GBTG.
...
Scale matters in this business. A dominant travel management platform can negotiate better commissions with airlines and hotel chains than a smaller rival can. The platform becomes stickier when it integrates with a corporation's expense management, accounting, and HR systems. And economies of scale in the software platform — customer [acquisition](/acquisition/) costs spread across thousands of travelers — create structural advantages for larger players. GBTG competes against Concur (owned by SAP), [American Express](/axp-stock/) for business travel, and other specialized platforms, all vying for the same corporate clients.
