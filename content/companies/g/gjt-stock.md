---
title: "STRATS(SM) Trust for Allstate Corp Securities, Series 2006-3 (GJT)"
description: "GJT is a structured trust that holds Allstate debt and equity securities, designed to provide predetermined payoff patterns to investors in different tranches based on Allstate's financial performance."
keywords:
  - structured product
  - trust structure
  - Allstate
...
GJT trades infrequently and is lightly followed by equity analysts. The [bid-ask spread](/bid-ask-spread/) is often wide, meaning buying or selling a large position can be expensive. Institutional holders tend to be buy-and-hold players who understand the income stream and are comfortable with the Allstate [concentration risk](/concentration-risk/). Retail investors typically avoid GJT because the complexity is not worth the effort.
