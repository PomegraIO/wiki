---
title: "Grayscale CoinDesk Crypto 5 ETF (GDLC)"
description: "Grayscale's first multi-crypto exchange-traded product, GDLC holds the five largest digital assets by market capitalisation — Bitcoin, Ether, XRP, Solana, and Cardano — in a passively managed fund structure."
keywords:
  - cryptocurrency ETF
  - digital assets
  - Bitcoin
...
<table>
<tr><th>Ticker</th><td>GDLC (NYSE Arca)</td></tr>
<tr><th>Sponsor</th><td>Grayscale Investments, a subsidiary of Digital Currency Group</td></tr>
<tr><th>Index tracked</th><td>CoinDesk 5 Index</td></tr>
<tr><th>Launch (public)</th><td>September 19, 2025</td></tr>
<tr><th>Holdings</th><td>Bitcoin, Ether, XRP, Solana, Cardano</td></tr>
<tr><th>Fee structure</th><td>Annual expense ratio (check current prospectus)</td></tr>
<tr><th>SEC CIK</th><td>0001729997</td></tr>
</table>
</aside>

## Why the crypto ecosystem needs funds like this

The core problem GDLC solves is accessibility. [Bitcoin](/bitcoin/) and Ether can be purchased through cryptocurrency exchanges, but that path requires the investor to set up an account on a specialized platform, understand private key management, and assume custody of assets that live outside traditional banking. For many institutional investors and retail participants accustomed to trading stocks and [bonds](/bond/) through conventional [brokers](/broker/), that friction is prohibitive.

An exchange-traded product removes those barriers. It trades through any ordinary brokerage account — IRA, taxable, retirement account, institutional [custodian](/custodian/) — using the same infrastructure that moves shares of [Apple](/aapl-stock/) or [Treasury bonds](/treasury-bond/). The fund custodian holds the underlying digital assets, removing the custody burden from the investor. For a holder of GDLC, the experience is indistinguishable from owning any other exchange-traded product.
...
**Bitcoin.** The original cryptocurrency and the largest by [market cap](/market-capitalization/), Bitcoin is a decentralised ledger of transaction records secured through computational proof of work. It is treated widely as digital gold — a store of value uncorrelated with traditional markets.

**Ether.** The native token of the [Ethereum](/ethereum/) blockchain, which serves as both fuel for computational contracts and a fee currency. Ethereum's broader market capitalisation reflects its position as the leading platform for decentralised finance, staking, and on-chain applications.
