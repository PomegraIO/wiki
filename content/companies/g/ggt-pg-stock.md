---
title: "Gabelli Multimedia Trust Inc. (GGT-PG)"
description: "A closed-end investment trust specializing in multimedia and entertainment companies, offering investors diversified exposure to media properties through professionally managed holdings."
keywords:
  - closed-end fund
  - investment trust
...
[Gabelli Multimedia](/ggt-stock/) Trust Inc., trading as GGT-PG on the [New York Stock Exchange](/new-york-stock-exchange/), is a closed-end investment company focused on acquiring and holding equity and debt securities in multimedia, entertainment, and communications businesses. The company operates as a vehicle for professional investment management in a sector that most individual investors find difficult to navigate directly: the shifting landscape of media properties, content companies, and platform operators.

A [closed-end fund](/closed-end-fund/) differs fundamentally from an open-end [mutual fund](/mutual-fund/) or an exchange-traded fund. When an investor buys shares of Gabelli Multimedia Trust, they are buying a claim on a fixed pool of assets managed by Gabelli Asset Management. Unlike an [open-end fund](/open-end-fund/), which creates new shares when investors buy in and redeems shares when investors sell out, a closed-end fund has a fixed number of shares outstanding. The price of those shares fluctuates in the market based on supply and demand — not strictly on the fund's [net asset value](/net-asset-value/). This can create discounts (shares trade below the value of the underlying holdings) or premiums (shares trade above value), depending on investor sentiment.
...
The trust's unit economics differ from an operating company. Gabelli Multimedia does not produce anything; it owns a collection of securities. Revenue is generated through [dividend](/dividend/) and interest income from the underlying holdings, and through capital gains when securities are sold at a profit. Operating expenses consist primarily of [management fees](/management-fee/) (typically 0.5–1.5% of assets annually), advisory costs, and administrative overhead. The trust distributes most of this net income to shareholders as a dividend, and that dividend determines the fund's appeal to income-seeking investors.
