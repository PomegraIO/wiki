---
title: "Georgia Power Company (GPJA)"
description: "A major electric utility serving millions of customers across Georgia and surrounding regions, foundationally shaped by Southern utility regulation and long-term generation investments."
keywords: [electric utility, regulated utility, power generation, public utility, regional utility]
---

*Georgia Power Company (NYSE: GPJA) is one of the largest regulated electric utilities in the United States, supplying power to millions of residential, commercial, and industrial customers across Georgia and adjacent areas. The company's origins trace to the early twentieth-century consolidation of regional power providers and the establishment of the regulatory framework that still governs utilities today—a structure that guarantees the company a stable, permitted rate of return in exchange for reliable service and submission to state oversight. Georgia Power's business, and its founding proposition, reflects the fundamental premise of regulated utility capitalism: accept lower profit volatility and moderate returns in exchange for captive customer bases, predictable revenues, and social legitimacy.*

<aside class="wiki-infobox"><table>
  <tr><td>Ticker</td><td>GPJA</td></tr>
  <tr><td>Listing</td><td>NYSE</td></tr>
  <tr><td>SEC CIK</td><td>41091</td></tr>
  <tr><td>Sector</td><td>Utilities</td></tr>
  <tr><td>Industry</td><td>Electric Utilities</td></tr>
</table></aside>
...
Like all utilities, Georgia Power confronts the energy transition. States and the federal government increasingly mandate renewable energy portfolio standards, set carbon reduction targets, and phase out coal generation. These mandates are regulatory—they are coming whether the utility wants them or not. Georgia Power must transition its generation fleet, close older plants, and invest in new renewable and energy-storage capacity.

The transition is capital-intensive and politically complex. Closing a coal plant has employment and community consequences. Building renewable farms requires new transmission lines. Energy storage technology is still maturing. All of this happens within the regulated framework; Georgia Power must convince regulators that its transition plan is reasonable and recoverable, then execute it while maintaining reliability for millions of customers.
...
To research Georgia Power, examine its 10-K for discussion of regulatory proceedings, rate cases, generation capacity and retirements, and the allowed rate of return set by the PSC. These elements drive the company's near-term earnings more than operational efficiency or market share gains. The company's regulatory relationship is its business model.
