---
title: "PT GoTo Gojek Tokopedia Tbk/ADR (GGTKY)"
description: "GoTo is Indonesia's largest technology conglomerate, merging ride-hailing, food delivery, and e-commerce into a unified digital ecosystem serving Southeast Asia's largest economy."
keywords:
  - Indonesia
  - ride-hailing
  - e-commerce
...
These networks are notoriously difficult to monetize profitably. Uber and [Lyft](/lyft-stock/), despite global scale and a massive addressable market, have struggled for years to achieve sustained profitability in ride-hailing. DoorDash and competitors subsidize delivery to drive volume, accepting margin-crushing unit economics in the hope of reaching scale and density where delivery costs fall as a proportion of order value.
...
GoTo's main competitors in ride-hailing are smaller regional operators and potential new entrants ([Apple](/aapl-stock/), Google) who could partner with local operators or build from scratch. In e-commerce, Shopee and Lazada (both backed by Sea Limited and Alibaba respectively) compete for merchant and consumer attention. In fintech, traditional banks and international fintechs push back.
...
### Closely related
- [/stock/](/stock/) — Equity trading and ADR mechanics
- [/public-company/](/public-company/) — Framework for understanding multinational platform operators

### Wider context
- [/securities-and-exchange-commission/](/securities-and-exchange-commission/) — SEC filings (CIK 2059690)
