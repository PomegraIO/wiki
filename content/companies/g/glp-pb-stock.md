---
title: "GLOBAL PARTNERS LP (GLP-PB)"
description: "A master limited partnership that distributes gasoline, diesel, heating oil, and propane to retail customers and retailers across the Northeast and Midwest United States."
keywords:
  - energy distribution
...
[Global Partners](/glp-stock/) LP is an energy distributor. It buys gasoline, diesel, [heating oil](/heating-oil/), and propane in bulk and resells it to customers. This is not a glamorous business, but it is essential. The company moves fuel from refineries and import terminals to retail gas stations, heating-oil delivery customers, and propane retailers across the Northeast and Midwest United States.

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>GLP-PB (preferred shares)</td></tr>
<tr><th>Type</th><td>Master limited partnership</td></tr>
<tr><th>Business</th><td>Fuel and propane distribution</td></tr>
<tr><th>Geography</th><td>Northeast and Midwest U.S.</td></tr>
<tr><th>Customers</th><td>Retailers, heating oil customers, propane users</td></tr>
<tr><th>SEC CIK</th><td>0001323468</td></tr>
</table>
</aside>
...
The long-term trend in fuel distribution is headwind. Vehicle electrification and heating-system conversions (oil heating to heat pump) slowly reduce the demand for gasoline and heating oil. Propane demand is more stable, tied to geographic pockets where [natural gas](/natural-gas/) is unavailable. A fuel distributor that relies on gasoline and heating oil faces a long, slow contraction in available market size.

## How to research Global Partners

Start with the quarterly and [annual reports](/10-k/) (SEC CIK 0001323468). Key metrics to watch: retail fuel volumes (gallons sold per quarter), average margin per gallon, cash distributions paid to unit holders, debt levels, and working capital trends (the amount of cash tied up in inventory and payables).
