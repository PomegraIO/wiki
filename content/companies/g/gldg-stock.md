---
title: "GoldMining Inc. (GLDG)"
description: "A junior mining company developing gold deposits across the Americas, primarily focused on exploration-stage projects in mineral-rich regions before production."
keywords: ["gold", "mining", "exploration", "junior-miner", "americas", "development-stage"]
---
...
<tr><td>Ticker</td><td>GLDG</td></tr>
<tr><td>Listing</td><td>OTC</td></tr>
<tr><td>SEC CIK</td><td>1538847</td></tr>
<tr><td>Sector</td><td>Materials (Exploration)</td></tr>
<tr><td>Type</td><td>Gold exploration company</td></tr>
</table></aside>

## Exploration is Not Mining: The Proof Stage

A junior miner like GoldMining does not yet produce revenue. Its balance sheet is not a [profit-and-loss statement](/income-statement/) but a sequence of exploration and development costs. The company drills core samples to estimate how much gold sits at depth, under what geological conditions, and at what ore grade. It runs metallurgical tests to determine whether the ore can be processed profitably. It obtains environmental permits, maps the land, and begins feasibility studies. All of this costs tens of millions of dollars before a single ounce is extracted. If drilling proves the deposit too small or ore grades too low, the project is written down or abandoned. If drilling is successful, the company advances to the next stage: reserve estimation and preliminary mine design.
