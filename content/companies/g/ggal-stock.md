---
title: "GRUPO FINANCIERO GALICIA SA (GGAL)"
description: "Grupo Financiero Galicia is Argentina's largest private bank, providing retail and commercial banking, investment services, and insurance across Argentina and neighboring markets."
keywords:
  - Argentine bank
...
<table>
<tr><th>Ticker</th><td>GGAL (NYSE ADR)</td></tr>
<tr><th>Founded</th><td>1905, Buenos Aires, Argentina</td></tr>
<tr><th>Country of operation</th><td>Argentina (primary); also Paraguay, Uruguay</td></tr>
<tr><th>Sector</th><td>Diversified banking and financial services</td></tr>
<tr><th>Business segments</th><td>Retail banking, corporate banking, insurance, investments, brokerage</td></tr>
<tr><th>SEC CIK</th><td>0001114700</td></tr>
</table>
</aside>
...
Regulation and the political environment matter too. The [central bank](/central-bank/) sets [reserve requirements](/reserve-requirements/), interest-rate caps, and other rules that affect profitability. Galicia is the largest private bank, which gives it some leverage and size to weather policy changes, but regulatory changes can still hit the industry hard and unpredictably.

## Capital structure and dividend policy

Galicia is a publicly traded company with [American Depositary Receipts](/adr/) (ADRs) listed on the NYSE, making it accessible to international investors. The company is profitable and typically pays a [dividend](/dividend/), though the amount fluctuates based on earnings and the bank's need to retain capital.
...
The investment thesis for Galicia requires comfort with emerging-market volatility and [currency risk](/currency-risk/). The bank is well-managed and serves a large, essential market; but ownership of Argentine financial stocks has historically meant absorbing long periods of depreciation, capital controls, and inflation. Understanding this risk is as important as understanding the fundamentals.
