---
title: "GO Residential Real Estate Investment Trust (GONYF)"
description: "A newly public Canadian real estate investment trust focused on owning and operating luxury apartment buildings in Manhattan and other major U.S. metropolitan areas, distributing income from tenant rents to unitholders."
keywords:
  - REIT
...
GO [Residential Real Estate](/residential-real-estate/) Investment Trust is a real estate trust that owns apartment buildings in the United States. The key idea behind a [real estate investment trust](/real-estate-investment-trust/), or REIT, is simple: most people cannot afford to buy a large apartment building by themselves, and managing one requires specialized skills. A REIT pools money from many investors, buys buildings or other real estate, collects rent from tenants, and passes that income through to the investors who own units in the trust.

GO Residential is brand new. The trust was founded in 2025 and had its [initial public offering](/initial-public-offering/) in July of that year, raising $410 million at $15 per unit. The company currently owns five luxury apartment buildings in Manhattan, New York, with a total of about 2,000 apartments. The trust is incorporated in Canada and lists its units on the [Toronto Stock Exchange](/toronto-stock-exchange/).

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>GONYF (OTC); GO.U (Toronto Stock Exchange)</td></tr>
<tr><th>Founded</th><td>June 2025</td></tr>
<tr><th>Headquarters</th><td>Ontario, Canada (trust) / New York (properties)</td></tr>
<tr><th>Business</th><td>Ownership and operation of luxury apartment buildings</td></tr>
<tr><th>Portfolio</th><td>5 buildings, 2,015 apartments, Manhattan</td></tr>
<tr><th>IPO date</th><td>July 31, 2025</td></tr>
<tr><th>IPO proceeds</th><td>$410 million</td></tr>
<tr><th>SEC CIK</th><td>0002081438</td></tr>
</table>
</aside>
...
GO Residential is what's called an "internally managed" trust, meaning it employs its own staff to manage the apartments and buildings rather than hiring an external manager. This structure can be cheaper in the long run because the trust keeps the [management fees](/management-fee/) that an external manager would charge, but it requires the trust to maintain competent in-house teams.
...
The core vulnerability for unitholders is simple: every dollar GO Residential invests is invested in Manhattan apartments. There is no geographic [diversification](/diversification/), no product diversification (it does not own office buildings, retail spaces, or warehouses), and no exposure to markets beyond New York City.

This extreme focus can be a strength in a rising market. If Manhattan rents accelerate and apartment values climb, being fully invested in that market amplifies returns. But it is a severe weakness in a downturn. Any major disruption to Manhattan—a [recession](/recession/) that cuts employment, remote work that reduces demand for city apartments, or a shift in where talented people and companies choose to locate—would affect every single property GO Residential owns at the same time.
...
Start by reading the trust's prospectus (the filing it produced for the IPO), which details the five buildings, their age, condition, current tenancy rates (what percentage of apartments are occupied), and the rents they charge. Look at the [balance sheet](/balance-sheet/) to understand how much debt the trust carries relative to the value of its properties.
...
As with any security, GO Residential's units trade at market prices on the Toronto [Stock Exchange](/stock-exchange/) and over-the-counter. This is a description of how the trust works and where its risks lie, not a recommendation to buy or sell.
