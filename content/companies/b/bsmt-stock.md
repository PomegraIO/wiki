---
title: "Invesco BulletShares 2029 Municipal Bond ETF (BSMT)"
description: "BSMT is a municipal bond ETF holding tax-exempt debt maturing around 2029, featuring a defined wind-down structure and monthly distributions."
keywords:
  - municipal bonds
  - tax-exempt bonds
  - bullet bond fund
  - muni maturity ladder
  - public debt
  - fixed income
handwritten: true
---

*BSMT holds [municipal bonds](/municipal-bond/) scheduled to mature around 2029, generating tax-exempt income each month and automatically declining toward closure as the maturity date approaches.*

## Municipal Bonds: The Category

Municipal [bonds](/bond/) are debt issued by US states, cities, counties, and other public entities to finance infrastructure, schools, hospitals, and local services. They carry a distinctive tax advantage: the interest they pay is exempt from federal income tax and (usually) state and local income tax for in-state residents. That tax shelter makes them attractive to high-income investors even though they pay lower yields than equivalent taxable bonds. BSMT concentrates on investment-grade munis.

The breadth of BSMT's holdings spans dozens of states, hundreds of individual issuers, and many types of projects. General-obligation bonds (backed by the full taxing power of the issuer) mix with [revenue bonds](/revenue-bond/) (backed by specific revenue streams like tolls or utility fees). This diversity reduces the impact of any single state crisis, [recession](/recession/), or regional economic shock. No single issuer occupies a large position in the portfolio.
...
BSMT's [expense ratio](/expense-ratio/) is low — typically well below 0.20 percent annually — making it competitive with other municipal [bond ETFs](/bond-etf/) and far cheaper than actively managed municipal funds. The fund trades as an exchange-traded fund, so shares can be bought and sold during market hours with [bid-ask spreads](/bid-ask-spread/) that are usually tight because the fund has reasonable liquidity and popularity.

## Risks: Credit, Interest Rate, and Timing

[Credit risk](/credit-risk/) is the possibility that a municipal issuer defaults. While municipal defaults are less common than corporate defaults, they do happen. A state budget crisis, an unexpected drop in tax revenues, or a regional economic collapse can force a municipality into financial distress. BSMT's [diversification](/diversification/) across states and issuers reduces this risk but does not eliminate it. If a large issuer in the portfolio faces credit trouble, the fund's value can drop significantly.

[Interest-rate risk](/interest-rate-risk/) emerges if rates rise after you buy BSMT. As rates rise, the prices of existing bonds fall because new bonds will pay higher coupons. If you need to sell shares before 2029, you may realize a loss. Conversely, if rates fall, the bonds gain value. This risk is strongest early in the fund's life and weakens as 2029 approaches.

[Reinvestment risk](/reinvestment-risk/) is the risk that in 2029, when your principal is returned, [interest rates](/interest-rate/) may be lower and your reinvestment options less attractive than they are today. You cannot control this, which is why spreading across multiple maturity dates is often prudent.

[Concentration risk](/concentration-risk/) appears if the portfolio is overweight a particular state or issuer type. If the portfolio is heavily exposed to a region with declining industries, a localized crisis can hurt returns more than a diversified portfolio would.
...
Start with the prospectus and fact sheet from Invesco. The prospectus covers the fund's investment policy, the credit standards it uses, the maturity bands it targets, and the risks. The fact sheet provides the [current yield](/current-yield/), the expense ratio, recent performance, and a breakdown of holdings by state and type. Review the top holdings and research whether the issuers are creditworthy and stable. Check their [credit ratings](/credit-rating/) with a ratings agency or your [broker](/broker/). Monitor the fund's distribution history; stable distributions suggest stable credit, while sharply falling distributions might signal credit deterioration. Stay informed about broad municipal-bond market news and any significant changes in the credit profile of large issuers in the portfolio.
