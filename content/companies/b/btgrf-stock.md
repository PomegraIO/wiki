---
title: "BTS Group Holdings Public Co Limited/ADR (BTGRF)"
description: "A Thai-listed transportation and logistics conglomerate with majority ownership in Mass Rapid Transit Authority operations, trading as an ADR on US OTC markets."
keywords: ["mass transit", "public transportation", "Thailand", "infrastructure", "logistics"]
---
...
<tr><td>Ticker</td><td>BTGRF</td></tr>
<tr><td>Listing</td><td>Stock Exchange of Thailand (primary) / OTC ADR (US)</td></tr>
<tr><td>SEC CIK</td><td>1546538</td></tr>
<tr><td>Sector</td><td>Transportation & Infrastructure</td></tr>
<tr><td>Industry</td><td>Mass Rapid Transit / Public Transportation</td></tr>
...
This regulatory moat is durable as long as the Thai government upholds the concession terms and does not default on subsidy commitments. It also creates downside protection: even if operational efficiency declines or cost [inflation](/inflation/) squeezes margins, the firm cannot lose the business to rivals. A bus company faces price-cutting competitors; an airline faces route competition; BTS faces neither. Instead, its competitive problem is with the concession grantor—the government—and with the operational ability to move passengers at acceptable service levels.
...
- [btdpf-stock](/btdpf-stock/) — Infrastructure business ([residential real estate](/residential-real-estate/)) with similarly long-lived assets and regulatory dependencies.
- [bte-stock](/bte-stock/) — Commodity-sensitive business with lower regulatory barriers but comparable capital intensity.
