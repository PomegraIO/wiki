...
Barrel Energy's [balance sheet](/balance-sheet/) will show how the company finances operations: through cash generation, [debt](/corporate-bond/), or equity issuance. The [10-K](/10-k/) will disclose outstanding [debt](/corporate-bond/) — typically bank credit facilities and perhaps bonds — along with covenants that restrict the company's ability to pay [dividends](/dividend/) or borrow further if financial metrics (such as debt-to-EBITDA ratios) deteriorate. For energy companies, debt covenants often include maintenance of minimum working capital or maximum debt ratios. If commodity prices collapse and cash flow evaporates, Barrel Energy could face covenant violations, forced equity dilution, or reduced operational flexibility. The [10-K](/10-k/) will also disclose the company's credit rating (if rated) and refinancing risks — upcoming debt maturities that must be rolled over or repaid.
