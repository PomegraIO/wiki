...
description: "Casual-dining operator of Outback Steakhouse, Bonefish Grill, and Carrabba's; vulnerable to labor inflation, traffic volatility, and commodity costs."
keywords: ["casual dining", "restaurants", "labor costs", "commodity exposure", "discretionary spending"]
---

*[**BLOOMIN' BRANDS, INC.**](https://bloominbrands.com) (ticker **BLMN**, [CIK 1546417](/10-k/)) operates a portfolio of casual-dining restaurants including Outback Steakhouse, Bonefish Grill, Carrabba's Italian Grill, and Flemings Prime Steakhouse. The company's profitability is under structural pressure from rising labor and commodity costs, unpredictable customer traffic, and the secular shift toward at-home dining and delivery.*

<aside class="wiki-infobox"><table>
<tr><td>Ticker</td><td>BLMN</td></tr>
<tr><td>Listing</td><td>NASDAQ</td></tr>
<tr><td>SEC CIK</td><td>1546417</td></tr>
<tr><td>Sector</td><td>Consumer Discretionary</td></tr>
<tr><td>Industry</td><td>Casual Dining / Food Service</td></tr>
<tr><td>Type</td><td>Public Company (Restaurant Operator)</td></tr>
</table></aside>
...
### Closely related
- [blkb-stock](/blkb-stock/) — Software vendor also exposed to cost pressures and operational concentration
- [blln-stock](/blln-stock/) — Diagnostics firm facing reimbursement and pricing headwinds

### Wider context
- [free-cash-flow](/free-cash-flow/) — How labor and commodity cost volatility affects cash generation in restaurants
- [dividend](/dividend/) — Dividend sustainability under margin compression
