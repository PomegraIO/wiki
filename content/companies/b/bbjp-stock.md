---
title: "JPMorgan BetaBuilders Japan ETF (BBJP)"
description: "BBJP is a low-cost ETF tracking Japanese equities, offering exposure to Japan's technology, industrials, and financial sectors in a single, diversified fund."
keywords:
  - Japan
  - Japanese stocks
  - Asia equities
...
BBJP buys that premise. It is JPMorgan's passively managed ETF tracking Japanese equities, using the MSCI Japan Index as its north star. The fund holds roughly 300 of the largest publicly listed companies on Japanese exchanges — Toyota, [Sony](/sony-stock/), [Mitsubishi UFJ Financial](/mufg-stock/), Takeda Pharma, ASML's Dutch operation (actually, [ASML](/asml-stock/) is Dutch, not Japanese), Softbank, Fast Retailing (Uniqlo's parent), [Shin-Etsu Chemical](/shecf-stock/), and hundreds more. For a US-based investor seeking Japan exposure without picking stocks or paying active [management fees](/management-fee/), BBJP is the straightforward path. Japan is the world's third-largest economy and has long been an under-owned allocation among US investors despite having some of the world's most dominant industrial and technology franchises.

## What BBJP holds and the structure of the Japanese market

The MSCI Japan Index is the standard benchmark for Japanese large and mid-cap equities. It includes companies listed on the [Tokyo Stock Exchange](/tokyo-stock-exchange/) and other major Japanese exchanges, weighted by [market capitalization](/market-capitalization/). The largest holdings — industrials like Toyota, technology names like Sony, and financial giants like Mitsubishi UFJ and Nomura — carry the heaviest weights, but the index is reasonably diversified across sectors. Electronics and semiconductors account for a meaningful slice; industrials and machinery another; pharmaceuticals, chemicals, banks, and insurance round it out.
...
The Tokyo [Stock Exchange](/stock-exchange/) is liquid and well-regulated, and BBJP's holdings are highly tradeable. The fund itself trades on the [NASDAQ](/nasdaq/) in [US dollars](/us-dollar/), so a US investor does not need a yen-denominated brokerage account; just like buying any US-listed ETF.

## Currency and valuation dynamics

BBJP is unhedged, meaning it reflects the full yen-dollar exchange rate. If the yen strengthens against the dollar, BBJP shareholders benefit from the currency translation (in addition to any stock gains). If the yen weakens, that acts as a headwind. Over the past 15 years, the yen has weakened significantly from its peaks, so many Japan investors have experienced currency headwinds even when Japanese stocks themselves performed decently. This is a real consideration for any Japan allocation; any investor needs to have a conviction that yen weakness has limits or be comfortable owning the [currency risk](/currency-risk/) as a long-term position.
...
The MSCI Japan Index methodology is published by MSCI and details the selection and weighting rules. JPMorgan's fact sheet shows current holdings, sector weights, [dividend yield](/dividend-yield/), and fund performance. Monitoring the yen-dollar exchange rate, Japanese earnings growth, interest-rate differentials between the US and Japan, and [relative valuation](/relative-valuation/) between Japanese and US stocks provides context for how BBJP is likely to perform.
