---
title: "AB Conservative Buffer ETF (BUFC)"
description: "A downside-protected equity ETF using collars and puts to limit losses while retaining upside, designed for risk-averse investors seeking stock market exposure."
keywords:
  - downside protection
  - collar strategy
  - buffer ETF
...
<table>
<tr><th>Ticker</th><td>BUFC (NASDAQ)</td></tr>
<tr><th>Sponsor</th><td>AllianceBernstein</td></tr>
<tr><th>Fund type</th><td>Buffered equity ETF</td></tr>
<tr><th>Protection level</th><td>Conservative (roughly 15% downside buffer)</td></tr>
<tr><th>Upside cap</th><td>Moderate (roughly 15% annual cap)</td></tr>
<tr><th>Underlying index</th><td>S&P 500 or subset thereof</td></tr>
<tr><th>Rebalance period</th><td>Typically annually</td></tr>
<tr><th>Expense ratio</th><td>Moderate to high (typical range 0.50%–0.65% annually)</td></tr>
</table>
</aside>
...
The structure works through option strategies. The fund holds the underlying stock index but also buys [protective puts](/protective-put/) (options that pay off if the index falls, protecting downside) and sells [covered calls](/covered-call/) (options that cap upside by obligating the fund to sell shares if the index rises above a strike). The premium received from selling calls partly finances the cost of the protective puts. The result is a collar—a bounded range of outcomes over a defined period, typically one year.
...
They are less suitable for young, long-term investors who can weather drawdowns and should capture the full long-term [equity risk premium](/equity-risk-premium/). They are also not suitable for trend-following or momentum traders, whose returns are often magnified in the latter stages of a bull market—exactly when the cap kicks in.
