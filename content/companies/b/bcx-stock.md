---
title: "BlackRock Resources & Commodities Strategy Trust (BCX)"
description: "BCX is a closed-end investment trust managed by BlackRock that invests in natural-resource and commodities companies, offering investors equity exposure to energy, metals, and mining."
keywords:
  - commodities
  - natural resources
  - closed-end fund
...
BCX is a closed-end investment trust run by [BlackRock](/blk-stock/). It does one job: hold a portfolio of companies that extract or process natural resources — oil, gas, metals, minerals. The trust then sells shares to ordinary investors. If you want to own a basket of energy and mining stocks without picking them yourself, you buy BCX. The structure matters: as a closed-end fund (not open-ended like a [mutual fund](/mutual-fund/)), BCX shares trade on the [stock exchange](/stock-exchange/) just like company stock, and the price can drift above or below the actual value of the holdings — that spread between the trading price and the [net asset value](/net-asset-value/) is called the discount or premium. Investors sometimes pay less than net asset value for [closed-end funds](/closed-end-fund/), which can be a bargain if the discount later narrows.

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>BCX (NYSE)</td></tr>
<tr><th>Founded</th><td>2003</td></tr>
<tr><th>Manager</th><td>BlackRock</td></tr>
<tr><th>Investment type</th><td>Closed-end equity fund</td></tr>
<tr><th>Focus</th><td>Natural-resource companies and commodities equities</td></tr>
<tr><th>Strategy</th><td>Diversified exposure to energy, metals, mining, agriculture</td></tr>
<tr><th>SEC CIK</th><td>0001506289</td></tr>
</table>
</aside>

## What BlackRock does with your money in this fund

You give BCX money. BlackRock takes it and buys shares in companies: oil majors, mining houses, agriculture conglomerates, precious-metals producers. These are real operating businesses — Exxon, Glencore, [Rio Tinto](/rtntf-stock/), that kind of thing. The portfolio is fairly diversified across the resource sector so that one collapse in one commodity doesn't wreck the whole trust.
...
This matters because BCX shareholders expect regular distributions. When commodity prices are weak, resource companies cut their [dividends](/dividend/), and BlackRock may have to dip into capital just to maintain the distribution level. That looks like the trust is "paying out capital" — literally returning some of the investor's own money under the guise of income. Over long periods, that erodes value unless the portfolio assets are appreciating fast enough to offset the excess payout.

## How it makes money (and how it loses it)

BCX's returns come almost entirely from the appreciation (or [depreciation](/depreciation/)) of the companies it holds plus whatever dividends those companies pay. There are no "management" earnings or special strategies that generate return independent of the portfolio's market moves. The manager's job is to pick good resource companies, maintain reasonable [diversification](/diversification/), and sometimes use leverage thoughtfully to boost returns.
