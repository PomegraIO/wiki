---
title: "Benchmark Bankshares Inc. (BMBN)"
description: "Holding company for community banks operating in mid-sized US markets, competing via relationship banking against national and digital competitors."
keywords: ["community banking", "US regional banks", "small-business lending", "relationship banking", "bank consolidation", "deposit gathering"]
---
...
The deposit-rate environment is therefore a key constraint on Benchmark's profitability. When the [Federal Reserve](/federal-reserve/) holds rates low, deposits are cheap and community banks enjoy wider spreads (earning loan interest minus deposit costs). When rates rise, deposits become expensive. At the same time, the yield on the loan side of the [balance sheet](/balance-sheet/) depends on customers' creditworthiness and the rates the market will bear. If Benchmark's customers are small businesses and agriculture-dependent operators (as community banks often are), loan growth is correlated with local economic conditions, which are volatile and observable at sub-national granularity.
...
Benchmark must therefore allocate a higher percentage of its earnings to regulatory compliance and capital maintenance than larger competitors. This reduces the [return on assets](/return-on-assets/) and [return on equity](/return-on-equity/) available to shareholders. Over time, this efficiency disadvantage has forced smaller banks to either grow larger (through [acquisitions](/acquisition/)) or accept lower profitability relative to capital.
