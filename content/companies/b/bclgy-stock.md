---
title: "Baltic Classifieds Group PLC (BCLGY)"
description: "Digital classifieds platform serving Eastern Europe and the Baltics, with networks in Russia, Ukraine, Lithuania, and Central Asia."
...
<tr><td>Ticker</td><td>BCLGY (OTC ADR)</td></tr>
<tr><td>Listing</td><td>Nasdaq (BCMG.L or similar regional exchange), OTC in US</td></tr>
<tr><td>CIK</td><td>2127862</td></tr>
<tr><td>Sector</td><td>Industrials / Consumer Discretionary</td></tr>
<tr><td>Industry</td><td>Digital Marketplaces & Classifieds</td></tr>
...
1. **Geographic revenue breakdown** — what fraction of revenue is at risk due to geopolitics, and how diversified is the portfolio?
2. **Currency exposures and hedging policy** — quantify the company's FX sensitivity to major operating currencies.
3. **User growth and ARPU trends** — is the company growing the user base or monetizing better?
4. **Competitive position in key markets** — read any disclosed market-share data or competitive commentary closely.
5. **Profitability timeline for new platforms** — when does the company expect new geographic markets to turn profitable, and what are the key milestones?
6. **Regulatory compliance and data privacy** — are there any fines, pending legal action, or significant compliance initiatives underway?
...
### Closely related
- OLX Group — Larger pan-European classifieds operator (if article exists)
- Avito — Russian-focused classifieds (if article exists)
