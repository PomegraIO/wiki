---
title: "AGF U.S. Market Neutral Anti-Beta Fund (BTAL)"
description: "A hedge-fund-like ETF that aims to deliver returns uncorrelated to the stock market by going long quality stocks and short volatile ones, capturing mean reversion."
keywords:
...
<table>
<tr><th>Ticker</th><td>BTAL (NASDAQ)</td></tr>
<tr><th>Issuer</th><td>AGF Investments</th></tr>
<tr><th>Strategy type</th><td>Long-short market neutral</td></tr>
<tr><th>Market correlation target</th><td>Low to zero</td></tr>
<tr><th>Long side</th><td>Low-volatility, quality U.S. stocks</td></tr>
<tr><th>Short side</th><td>High-volatility, lower-quality stocks</td></tr>
<tr><th>Gross leverage</th><td>Approximately 100–130% long, 75–100% short</td></tr>
<tr><th>Expense ratio</th><td>Qualitatively elevated</td></tr>
</table>
</aside>

## The core strategy: long quality, short volatility
...
BTAL's entire rationale rests on two key ideas. First, that the low-volatility or quality premium — the historical outperformance of boring, profitable stocks over flashy, speculative ones — will persist and repeat. This has been true over many decades of market history, but it has also gone dormant in some multi-year stretches, especially periods when risk-on sentiment is extremely high and investors are willing to pay outrageous prices for speculative, unprofitable growth stories. Second, the fund assumes that short-selling in a market-neutral context will work as expected — that the shorts will behave as a hedge and that the borrowing markets will remain accessible and liquid.

Both assumptions have held much more often than they have failed, but neither is guaranteed. In markets where volatility rewrites the rules — as happened in late 2020 through 2021, when meme stocks and speculative names soared while boring quality stocks languished — the anti-beta strategy can lag badly. A long-only quality stock fund would have also underperformed, but BTAL's shorts would have bled money, amplifying the pain.
...
## Who this is for and due diligence

BTAL is designed for sophisticated investors seeking uncorrelated returns or a hedge to a large long-only equity portfolio, and who understand that "market neutral" does not mean "no volatility." It is not for conservative investors seeking stable income or capital preservation. It is not for buy-and-hold investors who believe in the long-term outperformance of equities and simply want to own that via an index fund.

To evaluate BTAL, read the fund's prospectus and the latest fact sheet to confirm the current gross leverage, the cost structure, and the portfolio construction methodology. Examine the fund's historical returns and compare them to the quality factor (often measured by a low-volatility stock index or a dedicated quality factor fund) and to zero (market neutrality). In good market years, how much did BTAL lag a broad stock index? In bad years, did it truly provide downside protection as advertised? These historical comparisons illuminate whether the fund has delivered on its promise or struggled with execution. Finally, consider the role BTAL would play in your overall portfolio. Is it meant to be a stabilizing hedge, an alternative return generator, or a tactical timing play? The answer determines whether you should hold it as a core position or a satellite.
