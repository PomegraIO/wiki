---
title: "Bank Pekao S.A. (BKPOY)"
description: "Bank Pekao is Poland's second-largest bank by assets, providing retail banking, corporate lending, and investment services — a major commercial bank serving Polish consumers and businesses."
keywords:
  - banking
  - Poland
  - retail banking
...
Bank Pekao (full name: Bank Polska Kasy Opieki S.A., though it trades simply as Pekao or "Pekao Bank") is one of Poland's two largest banks by assets and a dominant force in Polish retail and corporate banking. Headquartered in Warsaw and listed on the Warsaw [Stock Exchange](/stock-exchange/), the bank is also traded as an ADR on [NASDAQ](/nasdaq/) under the ticker BKPOY. Pekao serves millions of Polish retail customers through a large branch network, provides corporate lending and treasury services to Polish businesses, and operates investment banking and brokerage services. The bank is roughly the same size as its main competitor, Bank BGZ PKO, making them the two pillars of Polish banking.

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>BKPOY (NASDAQ ADR)</td></tr>
<tr><th>Exchange</th><td>Warsaw Stock Exchange (primary); NASDAQ (ADR)</td></tr>
<tr><th>Founded</th><td>1929 (as Pekao); modern public company structure post-1990</td></tr>
<tr><th>Headquarters</th><td>Warsaw, Poland</td></tr>
<tr><th>Country of operation</th><td>Primarily Poland; some CEE presence</td></tr>
<tr><th>Sector</th><td>Commercial and retail banking</td></tr>
<tr><th>Primary business segments</th><td>Retail banking, corporate banking, investment services</td></tr>
<tr><th>Position</th><td>One of the two largest banks in Poland</td></tr>
<tr><th>SEC CIK</th><td>0002075877</td></tr>
</table>
</aside>
...
This segment is also exposed to capital markets volatility. When [stock markets](/stock-market/) fall sharply or [bond](/bond/) spreads widen, trading volumes and transaction fees decline, and Pekao's investment banking revenue falls. The segment is a source of profit in normal times but is vulnerable to downturns.
...
The zloty is not the euro, which creates some insulation from EU [monetary policy](/monetary-policy/) but also [currency risk](/currency-risk/) for Pekao's (admittedly small) international operations. A sharp [depreciation](/depreciation/) of the zloty makes it harder for Polish borrowers who earn in zloty to repay foreign-currency loans, a [credit risk](/credit-risk/).
