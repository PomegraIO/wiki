...
description: "An exchange-traded fund that holds physical Bitcoin and trades on a traditional stock exchange, enabling direct cryptocurrency exposure without a crypto exchange account or private wallet."
keywords:
  - bitcoin etf
  - spot bitcoin
  - digital currency
...
When an investor buys BITB shares, that capital goes directly into the purchase of Bitcoin, which is held in custody by a qualified [custodian](/custodian/) approved for cryptocurrency holding. Bitwise, the fund's sponsor, publishes the fund's Bitcoin holdings daily, and the share price tracks the value of those holdings minus a small annual fee (typically around 0.20% to 0.25%). Investors do not take custody of the Bitcoin themselves — they own shares of a fund that owns the Bitcoin. That distinction removes the need to understand private keys, wallet security, or the [operational risks](/operational-risk/) of self-custody.
...
BITB holds actual Bitcoin on the blockchain, not [futures contracts](/futures-contract/) or derivatives. That means the fund's value moves one-for-one with Bitcoin's price (minus the annual fee). There is no [counterparty risk](/counterparty-risk/) from a futures exchange, no basis mismatch between the fund's price and spot Bitcoin, and no leverage. The fund is also simple to understand: if you know Bitcoin's price, you know what BITB should trade at.
