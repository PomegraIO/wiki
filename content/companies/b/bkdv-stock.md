---
title: "BNY Mellon Dynamic Value ETF (BKDV)"
description: "An exchange-traded fund that tracks stocks selected for value characteristics and weighted by dynamically adjusted criteria, sponsored by BNY Mellon and passively managed."
keywords:
  - value investing
  - dynamic weighting
  - equity ETF
...
<table>
<tr><th>Ticker</th><td>BKDV (NYSE Arca)</td></tr>
<tr><th>Sponsor</th><td>BNY Mellon</td></tr>
<tr><th>Fund type</th><td>Passive equity ETF</td></tr>
<tr><th>Strategy</th><td>Value-factor based</td></tr>
<tr><th>Geographic focus</th><td>United States</td></tr>
<tr><th>Index</th><td>Morningstar US Large-Cap Value Index</td></tr>
</table>
</aside>
...
The "dynamic" element in the fund's name refers to the way the index weights its holdings. Rather than equal-weighting all stocks or using market-cap weighting, the Morningstar index adjusts weights dynamically based on value metrics. A stock with a high dividend yield and a low earnings-to-price ratio receives a higher weighting than one with poorer value characteristics, even if both are in the large-cap universe. This tilt toward cheaper stocks is the core driver of the fund's returns.
...
Value-factor funds can underperform the broader market for extended periods. Growth stocks and momentum stocks frequently outpace value stocks in rallies, and the fund's concentrated tilt toward value characteristics amplifies that drawdown. Tracking error—the degree to which the fund's returns diverge from its index—is minimal for a passive fund, but the underlying index may lag or lead depending on market conditions. Investors should also understand that the fund is fully invested and does not hold cash, so its price moves directly with its holdings.
