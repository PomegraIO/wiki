---
title: "Build-A-Bear Workshop (BBW)"
description: "Experiential toy retailer founded in 1997, offering customizable plush animals and licensing partnerships with major IP franchises across global mall and partner locations."
keywords:
  - experiential retail
  - toy manufacturer
...
Tracking Build-A-Bear requires attention to several metrics that [10-K](/wiki/10-k/) filings illuminate. Comparable-store sales growth (same-store sales) in the Direct-to-Consumer segment is the most reliable gauge of health; strong comps imply both traffic and ticket-size expansion. Gross margin trends, especially tariff-adjusted, show pricing power and input-cost management. 
