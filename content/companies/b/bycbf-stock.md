---
title: "Barry Callebaut AG/ADR (BYCBF)"
description: "Swiss chocolate and cocoa ingredient supplier; SEC filing CIK 1706795."
keywords: ["chocolate", "cocoa", "ingredients", "food manufacturing", "Switzerland", "commodity supply"]
---
...
<tr><td>Ticker</td><td>BYCBF</td></tr>
<tr><td>Listing</td><td>US OTC Markets (ADR)</td></tr>
<tr><td>SEC CIK</td><td>1706795</td></tr>
<tr><td>Sector</td><td>Consumer Staples</td></tr>
<tr><td>Industry</td><td>Food & Ingredients</td></tr>
<tr><td>Type</td><td>Specialty Supplier</td></tr>
</table></aside>
...
Barry Callebaut's moat has a critical limitation: it is a processor and middleman in a commodity supply chain. Cocoa prices fluctuate based on global crop conditions, weather, and broader commodity markets. When cocoa prices rise sharply, Barry Callebaut may face margin pressure if it cannot pass all cost increases to customers immediately. Conversely, when cocoa prices fall, customers may demand price reductions. This volatility is inherent to commodity intermediation. Barry Callebaut's moat insulates it somewhat—large customers are less likely to switch suppliers during price cycles because of switching costs—but does not eliminate margin pressure. The company's defensibility is thus conditional on successful [commodity risk](/commodity-risk/) management and customer relationships that permit passing through cost changes without losing volume.
...
### Closely related
- [/byah-stock/](/byah-stock/) — another company with research-driven moat
- /commodity/ pricing and margins in ingredient supply

### Wider context
- [/stock/](/stock/) and [/public-company/](/public-company/) fundamentals
