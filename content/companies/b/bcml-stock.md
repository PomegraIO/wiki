...
1. **Commercial real estate (CRE) exposure**: Many community banks in California carry substantial CRE risk. If property values decline or [cap rates](/cap-rate/) widen, both borrowers' collateral and the bank's loss-given-default rise. The 10-K should show CRE as a percentage of the capital base; ratios above 300% are sometimes flagged as high.
...
Community banks experience pronounced swings with the credit cycle. In boom times, loan demand is strong, charge-offs are minimal, and the bank's earnings expand. In [recessions](/recession/), loan demand falls, charge-offs spike, and the bank's earnings collapse or turn negative. The 10-K's discussion of risks should address the economic environment and how BayCom is positioned.

For the Bay Area specifically, the region is economically diversified (tech, healthcare, finance, real estate) but also has exuberant asset prices and potential tech-employment volatility. An analyst should read press coverage and economic data on the Bay Area's job growth, commercial real estate [vacancy rates](/vacancy-rate-property/), and tech-sector momentum to understand BayCom's economic environment independently.
...
### Closely related
- How Banks Make Money: Net Interest Margin and Credit Risk
- Understanding Bank Capital Ratios and Regulatory Requirements
- Community Banks vs. Megabanks: Structure and Risk

### Wider context
- The Credit Cycle and Macroeconomic Conditions
- [Real Estate and Commercial Real Estate Lending](/commercial-real-estate/)
- [How to Read a Bank 10-K: Focus on Loans, Deposits, and Margins](/10-k/)
</div>
