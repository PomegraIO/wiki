---
title: "Brookfield Corp Preferred Shares (BKFPF)"
description: "BKFPF represents Brookfield's preferred shares, a fixed-income security issued by the Toronto-listed conglomerate. These preferred shares offer periodic distributions and rank senior to common equity in the capital structure."
keywords:
  - preferred shares
  - fixed income
  - distributions
...
Brookfield Corporation issues preferred shares alongside its common equity. These preferred shares (BKFPF being one series, though others exist under different tickers) are a distinct security from the [common stock](/common-stock/). They sit between [bonds](/bond/) and common equity in the company's capital structure and offer investors a periodic distribution rather than relying on capital appreciation or variable [dividends](/dividend/).

<aside class="wiki-infobox">
<table>
<tr><th>Issuer</th><td>Brookfield Corporation (BK.TO)</td></tr>
<tr><th>Security type</th><td>Preferred share (cumulative, usually)</td></tr>
<tr><th>Traded</th><td>OTC (BKFPF and variants)</td></tr>
<tr><th>Rank</th><td>Senior to common equity; junior to debt</td></tr>
<tr><th>Distribution</th><td>Fixed periodic, paid quarterly or monthly</td></tr>
<tr><th>Redemption</th><td>Callable by issuer under set terms</td></tr>
<tr><th>SEC CIK</th><td>0001001085 (same entity as common)</td></tr>
</table>
</aside>
...
Brookfield has issued multiple series of preferred shares, each with its own distribution rate, reset mechanics, and redemption terms. These are negotiated at issuance and do not change; a 5% preferred share pays roughly 5% of its [par value](/par-value/) annually (usually split into quarterly or monthly instalments) for as long as the company holds the security outstanding.

## Why Brookfield issues preferred shares

Large companies issue preferred shares to raise capital without diluting voting common shareholders or taking on standard debt. Preferred shares are a hybrid instrument: creditors prioritise them less than bonds (preferred holders wait until debt is paid) but more than common shareholders (preferred holders get paid before common shareholders see dividends). For Brookfield, already a capital-intensive business that regularly funds [acquisitions](/acquisition/), preferred shares are a useful tool to maintain a balanced capital structure.
...
Preferred-share prices move differently from common equity. When [interest rates](/interest-rate/) rise, preferred-share prices typically fall, because new preferred shares issued by other companies offer higher distributions and become more attractive. When a company's [credit risk](/credit-risk/) rises (e.g., if earnings look threatened), preferred shares fall because holders worry about distribution cuts or suspension.
...
Regulatory changes affecting toll roads, utilities, or renewable-power contracts could also affect earnings. Although Brookfield's [diversification](/diversification/) provides some insulation, a significant adverse event could force a dividend or distribution cut.
