---
title: "BlackRock Core Bond Trust (BHK)"
description: "BHK is a closed-end bond fund holding investment-grade corporate and government debt, aiming to deliver current income and total return through diversified credit exposure and active management."
keywords:
  - bond fund
...
[BlackRock](/blk-stock/) Core [Bond](/bond/) Trust is a closed-end [mutual fund](/mutual-fund/) focused on [investment-grade bonds](/investment-grade-bond/) — corporate debt, government securities, and other fixed-income instruments rated at least BBB or higher. As a closed-end fund, BHK issues a fixed number of shares that trade on an exchange like stock, and can trade at a premium or discount to the underlying value of its holdings. The fund's core appeal is simple: professional management of a diversified bond portfolio, consistent monthly distributions, and a structure that preserves the benefits of scale and cost-efficiency for long-term shareholders.

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>BHK (NYSE)</td></tr>
<tr><th>Type</th><td>Closed-end bond fund</td></tr>
<tr><th>Investment focus</th><td>Investment-grade bonds (corporate, government, other)</td></tr>
<tr><th>Manager</th><td>BlackRock Advisors LLC</td></tr>
<tr><th>SEC CIK</th><td>0001160864</td></tr>
<tr><th>Distribution model</th><td>Monthly dividends</td></tr>
<tr><th>Duration target</th><td>Intermediate (typically 4–7 years)</td></tr>
</table>
</aside>
...
The fund holds a mix of credit types. Government bonds (U.S. Treasuries, agency debt) anchor the portfolio with near-zero [credit risk](/credit-risk/) but modest yields. Investment-grade [corporate bonds](/corporate-bond/) from companies across sectors — industrials, financials, utilities, consumer goods, technology — form the bulk of the holdings. Mortgage-backed securities and asset-backed securities contribute yields and [diversification](/diversification/). Some high-quality [securitizations](/securitization/) round out the mix. The intent is to own bonds that will be repaid, avoiding the deepest credit risk while capturing meaningful yield above government rates.
...
Like all bond funds, BHK's returns come from the income on the held bonds minus the costs to run the fund, with capital gains or losses as rates and [credit spreads](/credit-spread/) fluctuate. The spread — the difference between what the bonds yield and what it costs BHK to fund those holdings — is the fundamental economic driver.
...
Leverage amplifies duration risk. If the unlevered bond portfolio declines 5 percent in value and the fund is 40 percent leveraged (a 40/60 [debt-to-equity ratio](/debt-to-equity-ratio/)), the equity holders see a larger percentage loss because their equity base is smaller. In a severe rising-rate scenario, this can be painful.

## Discount-to-NAV Risk and Market Conditions

Like all [closed-end funds](/closed-end-fund/), BHK trades on the exchange and can trade at a discount or premium to its [net asset value](/net-asset-value/). If the fund's NAV is 10 dollars per share but it trades at 9.50, it's trading at a 5 percent discount. This creates an odd situation: the underlying bonds haven't changed, but the share you buy today costs less than the fund's actual value. This can be an opportunity, but it's also a risk: the discount can widen, creating a loss for shareholders even if the NAV stays constant.

Discounts typically widen when the broader bond market is weak, credit spreads are widening, or investor confidence is shaken. Investors flee to liquid, transparent instruments like [bond ETFs](/bond-etf/), creating selling pressure on less liquid closed-end funds. In normal markets, BHK might trade at a small discount (1–3 percent); in stressed markets, discounts can reach 8–10 percent or more.
...
Anyone interested in BHK should start with the fund's prospectus and [annual reports](/10-k/), which detail the exact holdings, duration, credit-quality distribution, and leverage levels. The most important questions are: How much leverage is the fund using? What is the weighted-average rating of the portfolio? What is the [current yield](/current-yield/), and is it sustainable? Is the fund trading at a premium or discount, and is that tight or wide by historical standards?
