---
title: "Else Nutrition Holdings Inc. (BABYF)"
description: "A plant-based infant and pediatric nutrition company based in Israel, filing with the SEC under CIK 1807936, traded as BABYF."
keywords: ["nutrition", "infant formula", "plant-based", "pediatric health", "consumer products", "Israel"]
---

*[Else Nutrition Holdings Inc.](/babyf-stock/) (ticker **BABYF**) manufactures and distributes plant-based infant and pediatric nutrition products. Founded in Israel and structured as a publicly traded holding company, Else operates in a tightly regulated consumer-health category where [public company](/public-company/) transparency is critical: baby formula claims, sourcing, manufacturing safety, and clinical validation must be disclosed with unusual precision. The company files with the [SEC](/securities-and-exchange-commission/) under CIK 1807936, offering researchers a window into how a specialized nutrition startup navigates product liability, regulatory approval, and international distribution from small-cap status.*

<aside class="wiki-infobox"><table>
<tr><td><strong>Ticker</strong></td><td>BABYF</td></tr>
<tr><td><strong>Listing</strong></td><td>OTC Markets</td></tr>
<tr><td><strong>SEC CIK</strong></td><td>1807936</td></tr>
<tr><td><strong>Sector</strong></td><td>Consumer Staples / Health</td></tr>
<tr><td><strong>Industry</strong></td><td>Infant & Pediatric Nutrition</td></tr>
<tr><td><strong>Type</strong></td><td>Holding Company / Manufacturer</td></tr>
</table></aside>
...
### Closely related
- [IMAC Holdings, Inc.](/back-stock/) — another specialized operating company with regulatory and market-access complexity
- [Bridger Aerospace Group Holdings, Inc.](/baer-stock/) — small-cap industrial operator with niche market positioning

### Wider context
- [Public Company](/public-company/) — foundational structure of disclosure and accountability
- [10-K](/10-k/) — annual disclosure document required for all public companies
- [Securities and Exchange Commission](/securities-and-exchange-commission/) — the regulator that archives company filings and enforces disclosure standards
- [Stock](/stock/) — equity ownership and capital markets overview
