---
title: "Bank of America Corp /DE/ (BML-PG)"
description: "Bank of America is one of the largest and most diverse financial institutions in the United States, offering consumer banking, wealth management, and investment banking services across a continent-spanning branch network and global platform."
keywords:
  - consumer banking
  - wealth management
  - investment banking
...
<table>
<tr><th>Ticker</th><td>BAC (NYSE)</td></tr>
<tr><th>Founded</th><td>1874; modern form 1998 (merger of NationsBank and BankAmerica Corp)</td></tr>
<tr><th>Headquarters</th><td>Charlotte, North Carolina</td></tr>
<tr><th>Sector</th><td>Financial services / Banking</td></tr>
<tr><th>Primary regulator</th><td>Federal Reserve, Office of the Comptroller of the Currency</td></tr>
<tr><th>Systemically important</th><td>Yes — designated as SIFI (Systemically Important Financial Institution)</td></tr>
<tr><th>Geographic reach</th><td>~4,300 branches across the US; global operations in major centres</td></tr>
<tr><th>Main business segments</th><td>Consumer Banking, Wealth Management, Investment Banking</td></tr>
</table>
</aside>

[Bank of America](/bank-of-america/) is one of the largest financial institutions in the United States by assets, deposit base, and branch footprint. It operates three main business divisions: Consumer Banking (consumer deposits, mortgages, credit cards, auto loans), Wealth Management (asset management, private banking, trust services for the affluent), and Investment Banking (corporate advisory, capital markets, trading). The modern entity emerged from the 1998 [merger](/merger/) of NationsBank (based in Charlotte) and BankAmerica Corp (based in San Francisco), creating a coast-to-coast powerhouse.

The firm is regulated as a systemically important financial institution by the [Federal Reserve](/federal-reserve/), which means it is subject to annual stress tests, enhanced capital requirements, living-will resolution plans, and heightened scrutiny of its risk management. Unlike smaller regional banks, Bank of America cannot simply manage itself for maximum profit — every material business decision bumps against regulatory constraints that other financial firms do not face.
...
The regulatory environment shapes deposit profitability directly. When the Federal Reserve raises its benchmark [interest rate](/interest-rate/), competing banks raise the rates they offer on deposits, and Bank of America must do the same or lose funding. A period of high and stable rates generally widens the net interest margin because loan rates rise faster than deposit rates do. A period of falling rates squeezes the margin because the bank cannot cut deposit rates below zero and does not want to lose sticky depositors to competitors.
...
Bank of America's investment banking franchise is solid but not elite. In rankings of advice on the largest megadeals, the bank typically places second or third globally, behind [Goldman Sachs](/goldman-sachs/), and on par with JPMorgan. In capital markets, it is a meaningful force but not price-setting the way the largest players are.

## Capital, shareholder returns, and the policy constraint

Like all systemically important banks, Bank of America must hold capital well above regulatory minimums and must maintain a buffer to survive a severe [recession](/recession/) (the stress test). This constraint limits how much profit can be returned to shareholders. The bank's capital return policy — [dividends](/dividend/) and buybacks — is set annually by the Federal Reserve. If the bank fails the stress test, capital return is cut sharply. If it passes comfortably, the bank can announce a higher dividends or buyback program.
