...
description: "Brookfield Renewable Partners is a global renewable power platform owning and operating hydroelectric, wind, and solar assets across North America, South America, Europe, and Asia-Pacific."
keywords:
  - renewable energy
  - hydroelectric power
  - wind power
...
[Brookfield Renewable](/bepc-stock/) Partners, trading as BEP on the [New York Stock Exchange](/new-york-stock-exchange/), owns and operates renewable power-generation assets across the globe — a collection of hydroelectric dams, wind farms, and solar installations that generate electricity and sell it under long-term contracts to utilities and large customers. The company, structured as a limited partnership, distributes the majority of its cash flow to unitholders, making it popular among yield-focused investors. Yet its appeal is not limited to income: Brookfield Renewable owns some of the world's most valuable power-generation assets, and the transition toward clean energy is a structural tailwind that could drive long-term growth in both the value of those assets and the cash they generate.

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>BEP (NYSE), BEP.U (unhedged)</td></tr>
<tr><th>Founded</th><td>2011 (as restructured platform)</td></tr>
<tr><th>Headquarters</th><td>Toronto, Ontario</td></tr>
<tr><th>Sector</th><td>Renewable energy generation</td></tr>
<tr><th>Business model</th><td>Asset ownership and power generation</td></tr>
<tr><th>Primary asset types</th><td>Hydroelectric, wind, solar</td></tr>
<tr><th>Geographic reach</th><td>North America, South America, Europe, Asia-Pacific</td></tr>
<tr><th>SEC CIK</th><td>0001533232</td></tr>
</table>
</aside>
...
Brookfield has significantly expanded its wind and solar holdings through both [acquisitions](/acquisition/) and construction of new facilities. Wind farms and solar installations are newer than most of the hydro portfolio and require continuous capital investment, but they have the advantage of scalability — Brookfield can add capacity in new locations without the decades of permitting and construction that a hydro facility requires. Wind and solar projects typically operate under long-term power-purchase agreements (often 20 to 25 years) with utilities or large customers, locking in revenue with minimal [inflation](/inflation/) or demand risk.
