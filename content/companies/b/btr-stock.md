---
title: "Beacon Tactical Risk ETF (BTR)"
description: "BTR is a systematic risk management ETF issued by Beacon Capital Management that dynamically adjusts exposure to equities and fixed income based on quantitative risk measures. It is designed for investors seeking diversified returns with downside protection rather than buy-and-hold simplicity."
keywords:
  - tactical allocation
  - risk management
  - dynamic ETF
...
| What it is | A systematic tactical allocation fund |
|---|---|
| Issuer | Beacon Capital Management |
| Strategy | Dynamic equity/bond weighting based on risk signals |
| Core objective | Positive returns with lower volatility than equities |
| Expense ratio | Typically 35–50 basis points (0.35–0.50%) |
| Suitable for | Investors accepting active management to reduce drawdowns |
| Rebalancing | Frequent (monthly or quarterly) based on volatility/signals |
...
Beacon Capital Management's models incorporate multiple risk measures — realized volatility of equities, credit spreads (the additional yield investors demand for [corporate bonds](/corporate-bond/) versus Treasuries), [implied volatility](/implied-volatility/) from options markets, and historical correlations between asset classes. The fund might also track momentum and mean reversion signals, looking for inflection points where [market risk](/market-risk/) is shifting. Based on these inputs, the model generates a target portfolio — perhaps 55% stocks and 45% bonds this month, then 65% stocks and 35% bonds next month if volatility drops.
