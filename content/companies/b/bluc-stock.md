---
title: "Bluemonte Large Cap Core ETF (BLUC)"
description: "An exchange-traded fund tracking the largest U.S. companies with a core, diversified approach—designed for buy-and-hold investors seeking broad U.S. equity exposure."
keywords:
  - large-cap ETF
  - S&P 500
  - core equity
...
The dividend income from those five hundred companies flows through to you. The companies in a large-cap core fund have a mix of dividend policies — some pay nothing, reinvesting all earnings into the business; others return one, two, or three percent of their value to shareholders each year. Across the portfolio, the weighted-average [dividend yield](/dividend-yield/) is usually somewhere between one and three percent, depending on which part of the [market cycle](/market-cycle/) you are in. That income, combined with any price appreciation the stocks deliver, makes up your total return.

The [expense ratio](/expense-ratio/) on a large-cap core fund is typically the lowest of any investment category — often between 0.03 and 0.20 percent per year. That difference sounds small in percentage terms, but it compounds. A fund charging 0.20 percent versus 0.05 percent costs you a quarter-point of returns annually. Over a thirty-year career, that snowballs into a meaningful gap. BLUC's liquidity is deep — tens of millions of dollars trade hands every day — so the [bid-ask spread](/bid-ask-spread/) is tight, and buying or selling does not move the market or cost you much in transaction fees.

The risks in a large-cap core fund are the risks of the [stock market](/stock-market/) itself. When the stock market falls, so does BLUC. A [bear market](/bear-market/) can cut the fund's value in half. But that is the nature of equity ownership: you get the returns that equities offer — the long-run premium over [bonds](/bond/) and cash — and you accept the volatility that comes with it. Large-cap stocks are less volatile than small-cap stocks or individual speculative companies, but they are still stocks.

The largest companies are not immune to disruption or mismanagement. A company that once dominated its industry can fade if it fails to adapt to changing technology or customer preferences. [Apple](/aapl-stock/), [Microsoft](/msft-stock/), and Amazon replaced earlier titans of tech; those shifts play out in the fund automatically as the index adds winners and removes losers. But the companies that populate a large-cap core index have deep resources, diverse revenue streams, and competitive moats that have allowed them to survive and thrive through many [business cycles](/business-cycle/). Some will stumble; the portfolio as a whole, over the long term, has delivered returns that have enriched most of its holders.
