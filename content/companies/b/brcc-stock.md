---
title: "BRC Inc. (BRCC)"
description: "Black Rifle Coffee Company, a specialty coffee roaster and lifestyle brand serving military and veteran communities through direct sales and retail channels."
keywords: ["coffee roaster", "direct-to-consumer", "military brand", "specialty coffee", "e-commerce", "retail"]
---

*__BRC Inc. (BRCC)__ is a specialty coffee company positioned at the convergence of premium roasting, military-focused marketing, and direct-to-consumer distribution. The company sources green beans, roasts them in-house, and sells finished coffee and branded merchandise primarily to a community-defined customer base rather than competing on commodity price or broad retail shelf space.*

<aside class="wiki-infobox"><table>
<tr><td>Ticker</td><td>BRCC</td></tr>
<tr><td>Listing</td><td>NYSE</td></tr>
<tr><td>SEC CIK</td><td>1891101</td></tr>
<tr><td>Sector</td><td>Consumer Discretionary</td></tr>
<tr><td>Industry</td><td>Specialty Food & Beverage</td></tr>
...
The company files [10-K reports](/10-k/) with the [Securities and Exchange Commission](/securities-and-exchange-commission/), making its supply chain, customer concentration, and production capacity transparent to investors and analysts.

<div class="wiki-seealso">
### Closely related
- [Special-purpose acquisition company](/special-purpose-acquisition-company/) (BRCC went public via SPAC)
- [Free cash flow](/free-cash-flow/) (subscription model generates predictable cash)
- [Price-to-sales ratio](/price-to-sales-ratio/) (relevant for direct-to-consumer brands)

### Wider context
- Commodity markets and coffee futures
- [Return on equity](/return-on-equity/) (capital intensity of roasting)
</div>
