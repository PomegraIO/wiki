---
title: "Black Hawk Acquisition Corp. (BKHAU)"
description: "BKHAU is the unit ticker for Black Hawk Acquisition Corp., representing a bundled security combining common shares and warrants in a single traded instrument."
keywords:
  - SPAC units
  - blank-check company
  - warrant bundling
...
If you are researching Black Hawk, ignore the unit ticker once separation has occurred. Focus instead on the common shares (which carry [voting rights](/voting-rights/) and the claim on the merger consideration) and the warrant class (which carries leverage and exposure to upside if the merged company's stock price rises sharply). The unit is a temporary instrument, a convenient package for IPO distribution, not a security that retains ongoing relevance.
