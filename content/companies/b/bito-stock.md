---
title: "ProShares Bitcoin ETF (BITO)"
description: "A futures-based fund that tracks Bitcoin by holding contracts on the CME, rather than Bitcoin itself—the first SEC-approved way for most Americans to own Bitcoin through a traditional brokerage."
keywords:
  - Bitcoin futures
  - futures-based ETF
  - spot vs futures
...
BITO does not hold [Bitcoin](/bitcoin/). It holds Bitcoin [futures contracts](/futures-contract/), month after month, rolling them forward as they near expiration. ProShares is the operator; the contracts trade on the Chicago Mercantile Exchange (CME). Shareholders own an ETF that profits when Bitcoin futures rise and loses when they fall, but no shareholder has ever seen a physical Bitcoin.
