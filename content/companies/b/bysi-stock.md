---
title: "BeyondSpring Inc. (BYSI)"
description: "A clinical-stage oncology company advancing early-to-mid phase cancer therapeutics from discovery into human trials."
keywords: ["biotech", "oncology", "cancer therapy", "clinical development", "drug development", "pharma"]
---
...
<table>
<tr><td>Ticker</td><td>BYSI</td></tr>
<tr><td>Listing</td><td>Nasdaq</td></tr>
<tr><td>SEC CIK</td><td>1677940</td></tr>
<tr><td>Sector</td><td>Healthcare</td></tr>
<tr><td>Industry</td><td>Biopharmaceutical</td></tr>
<tr><td>Type</td><td>Development-stage public biotech</td></tr>
</table>
</aside>

## The Clinical Inflection Problem

Every drug company passes through a gauntlet. BeyondSpring entered public markets at a moment when it had already cleared preclinical work and begun dosing patients—the most capital-intensive and binary phase of the lifecycle. The company does not yet have an FDA-approved product for sale, which means it has no [revenue](/income-statement/) from therapeutics. Instead, it has burn: ongoing costs for manufacturing, regulatory affairs, clinical staff, and patient trials. This is the venture biotech arc in its starkest form: spend to demonstrate proof, or perish.
...
As a development-stage public company, BeyondSpring operates in a rhythm of milestone achievement and capital raising. The company cannot fund years of clinical work from operations; instead, it converts equity into cash, burning it in the clinic, and then returns to the [market](/stock-exchange/) for the next raise. Each [secondary offering](/common-stock/) dilutes existing shareholders unless the new capital enables a value-creating milestone.

The inversion in BeyondSpring's lifecycle is stark: a mature pharma company earns cash from drugs and reinvests in R&D. BeyondSpring invests in R&D and hopes to eventually earn cash from drugs. Until that inflection, [shareholder returns](/dividend/) are not possible. The firm's [balance sheet](/balance-sheet/) is dominated by cash and equivalents on one side and R&D accrual on the other, with no productive assets generating ongoing return.
