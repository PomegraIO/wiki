---
title: "iShares U.S. Large Cap Premium Income Active ETF (BALI)"
description: "An actively managed fund targeting large U.S. companies with strong income characteristics, using covered-call overlay to generate distributions."
keywords:
  - large cap
  - covered call
  - income strategy
...
BALI holds a portfolio of large U.S. stocks selected for yield and income potential. The manager has discretion to choose which blue-chip companies to own, subject to income-focused criteria. On top of those core holdings, the fund applies a covered-call overlay — systematically selling [call options](/call-option/) on the stocks it owns, collecting premiums, and passing that income to shareholders. This dual-layer approach creates a complex fund that aims for both stock appreciation and steady distributions.

The strategy is layered. First: the large-cap stocks themselves often pay [dividends](/dividend/), from modest to substantial depending on the sector and company. A utility, for example, might yield 3 to 4 percent in dividends alone. A technology company might yield 0.5 percent. Second: the covered-call premium adds another income stream. Together, the dividends plus the [option premiums](/option-premium/) target a higher income yield than a passive large-cap [index fund](/index-fund/) would naturally deliver.
