---
title: "Innovator Equity Managed 100 Buffer ETF (BFRZ)"
description: "BFRZ is a managed buffer ETF that provides U.S. large-cap equity exposure with an annual 100% cap on upside gains while protecting against all losses beyond a specified floor, appealing to investors seeking income above fixed limits."
keywords:
  - buffer ETF
  - equity protection
  - capped upside
...
The fund's [expense ratio](/expense-ratio/) reflects the ongoing cost of maintaining both the put protection and the call options that are sold. Unlike simple buy-and-hold, BFRZ requires active rebalancing as the underlying stock prices move away from the initial targets. Near the end of an outcome period, if the market has surged and the fund is approaching its cap, the manager must rebalance by potentially buying more puts or adjusting the call position to ensure the cap is respected. These actions cost money in spreads and commissions.
...
The downside is that capped upside is invisible during [bull markets](/bull-market/). If the broad market gains 30% in a year and BFRZ's cap is 15%, the opportunity cost of owning the fund (forgoing 15% of potential gains) is glaringly obvious. Shareholders who discover they regret the cap and exit the fund often do so at exactly the wrong time — after missing upside but before recapturing losses they were insured against.
...
Over time, examining multiple outcome periods shows the true cost-benefit trade-off. In strong years, the cap bites and the fund lags the broad market. In weak years, the floor protects and the fund outperforms. A series of strong years makes the fund look expensive relative to unhedged indices; a [recession](/recession/) validates the choice.
