...
SPAC units typically include a warrant—the right to buy additional shares at a set price. Warrants become valuable if the underlying stock rises above the warrant's strike price. However, warrants can also become worthless if the stock underperforms. Warrant valuations are complex and typically require financial modeling. For BCAR shareholders who received warrants, monitoring their [price-to-sales-ratio](/price-to-sales-ratio/) or intrinsic value relative to the stock price is important.
