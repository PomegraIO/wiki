---
title: "Bitwise 10 Crypto Index ETF (BITW)"
description: "An exchange-traded fund that tracks the 10 largest cryptocurrencies by market capitalization, offering diversified crypto exposure within a regulated, traditional-brokerage wrapper."
keywords:
  - cryptocurrency etf
  - crypto index
  - digital assets
...
| | |
|---|---|
| **Ticker** | BITW (NYSE Arca) |
| **Launched** | January 2024 |
| **Index** | Bitwise 10 Crypto Index |
| **Holdings** | 10 largest cryptocurrencies by market cap |
| **Largest holdings** | Bitcoin (~50%), Ethereum (~25%), others (~25%) |
| **Annual fee** | 0.20% (approximately) |
| **SEC CIK** | 0001723788 |
