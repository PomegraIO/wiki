---
title: "Leverage Shares 2X Long BIDU Daily ETF (BIDG)"
description: "A 2x leveraged daily-reset ETF on Baidu, the Chinese internet and AI company—double exposure to a single stock, reset each day, carrying volatility decay and concentration risk."
keywords:
  - baidu
  - leverage shares
...
| Metric | Value |
|---|---|
| **Underlying** | Baidu Inc. (BIDU) |
| **Leverage** | 2x daily reset |
| **Sponsor** | Leverage Shares |
| **Structure** | UK-regulated ETP, traded on US exchanges |
| **Expense ratio** | ~0.49% annually |
| **Holding period** | Days to a few weeks maximum |
| **Volume** | Moderate; wider spreads than index ETFs |
...
Concentration amplifies it. BIDG is a single-company bet in one sector (Chinese search and AI), exposed to one regulatory regime and one set of competitors. No [diversification](/diversification/) to buffer bad news.
...
BIDG magnifies each risk. Disappointing quarterly search growth does not just dent the stock; it cuts BIDG roughly twice as much. A Beijing regulatory crackdown ripples through with double force. This concentration and leverage stack to create significant [tail risk](/tail-risk/).

## The hidden cost: volatility decay

The stated [expense ratio](/expense-ratio/) of 0.49 percent annually understates the real cost. The killer is volatility decay—the invisible compounding loss that eats leveraged funds. Over a calendar quarter or longer, BIDG almost certainly underperforms 2x Baidu's return. Over a year, the gap widens significantly, even if Baidu itself performed well.

## Who should own this

BIDG is exclusively for traders with a tactical bullish thesis on Baidu lasting one to five trading days with a clear exit plan. Even a month-long hold is risky; anything longer fights the mathematics of daily reset and volatility decay. For longer [holding periods](/holding-period/), buy unlevered Baidu exposure instead.
