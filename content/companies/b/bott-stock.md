---
title: "Themes Humanoid Robotics ETF (BOTT)"
description: "BOTT tracks companies developing and deploying humanoid robots, offering broad exposure to the sector's hardware makers, software platforms, and component suppliers."
keywords:
  - humanoid robotics
  - robotics ETF
  - automation
...
| **What it is** | ETF tracking humanoid robotics companies |
|---|---|
| **Sponsor** | Themes Investment Ltd |
| **Structure** | Passive index tracker |
| **Underlying index** | Themes Humanoid Robotics Index |
| **Typical holdings** | Hardware makers, component suppliers, software platforms |
| **Expense ratio** | Typically 0.75%–0.85% (estimate) |
| **Liquidity** | Dependent on trading volume; newer fund |
| **Who it suits** | Investors with conviction on humanoid automation's near-term growth |
