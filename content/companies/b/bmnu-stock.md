---
title: "T-REX 2X Long BMNR Daily Target ETF (BMNU)"
description: "A leveraged ETF that aims to deliver twice the daily return of an unnamed underlying index using options and derivatives, designed for short-term traders and carrying significant volatility decay risk."
keywords:
  - leveraged ETF
  - 2x leverage
  - daily reset
...
Here is where leveraged ETFs cost you money in sideways or volatile markets. Imagine the underlying index falls 5% on Monday and rises 5% on Tuesday. After those two days, the index is back where it started — flat. But BMNU is not. On Monday it fell 10%, leaving it down 10% overall. On Tuesday it rose 10%, bringing it back up to 1% down overall (since 10% gain on a 90-value base is only 9 in absolute terms). So even though the underlying index was flat, BMNU is down 1%. That loss came from volatility, not from a directional miss — it is called volatility decay or path dependency.

The more volatile the underlying and the longer you hold, the worse the decay. In a calm, straight-up market, BMNU tracks 2x beautifully. In a whippy, sideways market, BMNU bleeds value. Serious volatility decay can make BMNU underperform even if the underlying goes up 20% — if those 20% gains came through ten volatile up-days and down-days rather than one smooth move.

## Who BMNU is actually for

BMNU is built for day traders and active traders with short time horizons measured in days or weeks, not months. A trader who believes the underlying is about to pop 3% and wants to ride that move for 24 hours can use BMNU to get 6% of upside on a smaller capital commitment. A trader hedging a long position for a single day can use BMNU as a temporary short without short-selling the underlying.

BMNU is not for retirement accounts. It is not for buy-and-hold portfolios. It is not for investors who cannot monitor their positions. Many experienced investors avoid leveraged ETFs entirely, citing the decay risk and the psychological temptation to hold them longer than they should.
