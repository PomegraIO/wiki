---
title: "Invesco BulletShares 2029 Corporate Bond ETF (BSCT)"
description: "An exchange-traded fund holding investment-grade corporate bonds scheduled to mature in 2029, structured around a specific target date for predictable principal return."
keywords:
  - maturity date
  - corporate bonds
  - ETF
...
Each holding is a contractual obligation: the issuer agrees to pay the bondholder periodic interest (the coupon) and return the principal at a specified maturity date. BSCT's portfolio is diversified across dozens of issuers to spread [credit risk](/credit-risk/). No single company is allowed to dominate the portfolio; [concentration limits](/concentration-limits/) prevent over-reliance on one issuer's solvency.
...
A bond's price moves inversely to [interest rates](/interest-rate/). If rates rise after you buy BSCT, the market value of its underlying bonds falls because new bonds paying higher coupons are now available. Conversely, if rates fall, your fund's older, higher-coupon bonds become more valuable.
