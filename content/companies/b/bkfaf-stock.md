---
title: "Brookfield Corp (BKFAF)"
description: "Brookfield is a Toronto-listed diversified holding company with operations in real estate, renewable energy, infrastructure, and asset management. It operates as a scale manager of long-lived, cash-generative assets across North America."
keywords:
  - holding company
  - real estate
  - renewable energy
...
<table>
<tr><th>Ticker</th><td>BKFAF (OTC); BKFRF (alternative OTC)</td></tr>
<tr><th>Listed</th><td>Toronto Stock Exchange (BK.TO)</td></tr>
<tr><th>Headquarters</th><td>Toronto, Ontario</td></tr>
<tr><th>Founded</th><td>1899 (as Dominion Iron & Steel; rebranded 1990s)</td></tr>
<tr><th>Sector</th><td>Diversified holding company; real estate, renewable energy, infrastructure</td></tr>
<tr><th>Business model</th><td>Long-term asset owner; distributes cash to shareholders</td></tr>
...
The company started as a Cape Breton steel mill in 1899 and has been steadily reshaped over the past century. Today it holds four major operating divisions: an industrial real estate business, a renewable-power developer and operator, an infrastructure manager covering roads and utilities, and a global asset-management platform that handles other people's capital. None of these divisions run at the scale of pure-play specialists in their fields, but together they form something durable: a company that buys assets other people do not want to hold for the long term, improves their operations, and gradually sells them to [infrastructure funds](/pe-infrastructure-fund/) and other permanent owners while keeping a steady stream of [management fees](/management-fee/) and development profits for itself.

The company is controlled by the Brookfield family through a holding structure that gives them voting control without proportional economic interest. This [dual-class structure](/dual-class-structure/) means founders and their descendants shape strategy long-term, a common model in Canadian conglomerates.
