---
title: "State Street SPDR Bloomberg 3-12 Month T-Bill ETF (BILS)"
description: "An ultra-short Treasury ETF holding US government bills maturing in three to twelve months, capturing higher yields than shorter-duration competitors."
keywords:
  - treasury bills
  - short-term bonds
  - duration risk
...
## Duration, volatility, and the three-month cliff

The main difference between BILS and BIL is duration — the sensitivity of the fund's price to interest-rate changes. BIL has essentially zero duration risk because bills mature so quickly. BILS, holding bills out to a year, has modest but measurable duration. If rates rise 1%, BILS's share price will fall a fraction of a percent. It is not dramatic, but it is real — BIL would be essentially flat.

This matters if your time horizon is very short or if you need the shares to be worth exactly what you paid for them. For cash held for three to six months or longer, BILS is stable enough. For overnight reserves or buffer cash, BIL is safer.

The yield-curve shape also matters. In a steep curve (short rates low, longer rates high), BILS's three-to-twelve-month band yields substantially more than BIL's one-to-three-month band — a meaningful trade-off for the tiny extra duration risk. In an inverted curve (long rates below short rates), BILS yields less than BIL — a perverse situation that has occurred in recent years and makes BILS less attractive relative to its shorter peer.
...
## When BILS makes sense

BILS is a better choice than BIL if:

- You can tolerate the modest duration risk (a small price move if rates shift suddenly).
- Current Treasury-bill rates are attractive, and you want a bit more yield than BIL offers.
- Your cash-holding horizon is three months to a year, not overnight.
...
**BIL** (one-to-three-month bills): BILS yields more. BIL is safer. Choose based on your curve view and horizon.
...
- Your expectations for Fed policy. If cuts are coming, BILS's yield will fall. If hikes are coming, rates will rise but your share price will decline.

Read the prospectus for the exact maturity bands and the fund's rebalancing methodology. Examine the fact sheet monthly to see the current holdings and confirm they align with your expectations — the fund should consistently hold bills across the three-to-twelve-month window.

BILS is not exciting, but that is the point. It is a reliable, liquid, tax-efficient way to capture Treasury yields on cash you cannot deploy longer-term. In a world of near-zero savings-account rates, that reliability is worth something.
