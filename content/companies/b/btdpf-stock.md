---
title: "Barratt Developments PLC/ADR (BTDPF)"
description: "A leading British housebuilder operating in the premium and standard residential segments, with a primary listing on the London Stock Exchange and ADR trading on US markets."
keywords: ["housebuilding", "real estate", "UK housing", "residential developer", "ADR"]
---

*[Barratt Developments PLC](/btdpf-stock/) (BTDPF) is one of the largest housebuilders in the United Kingdom, distinguished by its combined portfolio of premium and mainstream residential projects across England, Wales, and Scotland. Unlike smaller regional builders tied to single geographies or luxury developers focused exclusively on high-end markets, Barratt operates a dual-brand model that allows it to serve both aspirational and first-time buyers, generating breadth and resilience across economic cycles.*

<aside class="wiki-infobox"><table>
<tr><td>Ticker</td><td>BTDPF</td></tr>
<tr><td>Listing</td><td>OTC Markets (US ADR) / London Stock Exchange (primary)</td></tr>
<tr><td>SEC CIK</td><td>1516324</td></tr>
<tr><td>Sector</td><td>Real Estate</td></tr>
<tr><td>Industry</td><td>Residential Development & Construction</td></tr>
...
- [btgo-stock](/btgo-stock/) — Different sector (blockchain infrastructure vs. [residential real estate](/residential-real-estate/)), but similarly positioned as a leader in its niche.
- [bte-stock](/bte-stock/) — Commodity-linked business (energy) with cyclical margin dynamics similar to housebuilding.
