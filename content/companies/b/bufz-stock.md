---
title: "FT Vest Laddered Moderate Buffer ETF (BUFZ)"
description: "An options-based US equity fund employing a twelve-month rolling-reset ladder to provide defined downside protection and upside capping tied to the S&P 500."
keywords:
  - buffer strategy
  - defined outcome ETF
  - S&P 500
...
BUFZ holds an equal-weighted ladder of twelve underlying FT Vest U.S. Equity Moderate [Buffer ETFs](/buffer-etf/), each with its own calendar month [expiration date](/expiration-date/). This structure means that every month, one [tranche](/tranche/) of the ladder reaches its outcome period endpoint and is replaced with a fresh twelve-month option position, rolling forward the protection continuously. The ladder tracks the S&P 500 via proxy — specifically, the SPDR S&P 500 ETF Trust (SPY) — so investors get broad large-cap US equity exposure with a cost-of-ownership that includes both the active oversight and the pricing of the embedded protection layer.
