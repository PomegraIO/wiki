---
title: "BlackRock Health Sciences Term Trust (BMEZ)"
description: "BlackRock Health Sciences Term Trust is a closed-end investment fund managed by BlackRock that concentrates on healthcare and life-sciences equities, with a focus on dividend growth and capital appreciation."
keywords:
  - closed-end fund
  - healthcare equities
  - life sciences
...
<table>
<tr><th>Ticker</th><td>BMEZ (NYSE)</td></tr>
<tr><th>Manager</th><td>BlackRock Advisors LLC</td></tr>
<tr><th>SEC CIK</th><td>0001785971</td></tr>
<tr><th>Fund type</th><td>Closed-end management company (healthcare-focused)</td></tr>
<tr><th>Investment universe</th><td>Healthcare and life-sciences equities</td></tr>
<tr><th>Distribution policy</th><td>Monthly distributions, emphasis on yield</td></tr>
<tr><th>Inception</th><td>2021</td></tr>
<tr><th>Structure</th><td>Fixed capital; shares trade on secondary market</td></tr>
</table>
</aside>

## The closed-end fund structure and BlackRock's entry into healthcare

BlackRock Health Sciences Term Trust was launched in 2021 as a closed-end fund, a vehicle distinct from the open-end [mutual funds](/mutual-fund/) and exchange-traded funds BlackRock manages in far larger sizes. A closed-end fund raises capital once—through an [initial public offering](/initial-public-offering/)—and then operates with a fixed pool of assets. Unlike a mutual fund where investors can redeem shares daily, shareholders in a closed-end fund trade their shares on a [secondary market](/secondary-market/), like a stock. This structure has advantages: the manager knows the capital it has to invest and does not face redemption pressures; the fund can hold illiquid positions without fear of sudden withdrawals; and the leverage of borrowed capital can amplify returns.

The healthcare focus reflects a clear conviction among BlackRock's management. Healthcare and life sciences have been among the most durable wealth-creation sectors over decades. Pharmaceutical companies have pricing power through patents and regulatory barriers; biotechnology companies offer asymmetric upside if clinical trials succeed; medical-device makers benefit from secular aging demographics and rising healthcare spending. The sector also tends to deliver steady dividend income from large-cap incumbents like pharma giants, providing the yield that [closed-end funds](/closed-end-fund/) are often designed to maximize.
...
Return of capital is common in closed-end funds and is worth understanding. When a fund's yield exceeds what its portfolio generates naturally, it can return some of shareholders' capital each month. This feels like "income" to the recipient, but it is technically a partial return of their investment. Over time, return of capital reduces the fund's [net asset value](/net-asset-value/) per share unless the portfolio appreciates to offset it. This creates a tension: maintaining a popular high distribution may erode asset values. The fund's management navigates this by seeking capital appreciation sufficient to offset distributions, but that is not guaranteed.
...
Leverage is another distinguishing feature. BMEZ can borrow money to amplify its investment. If the fund borrows at a low rate and invests at a higher return, leverage amplifies shareholder returns. But it also amplifies losses and increases the fund's sensitivity to rate changes. When [interest rates](/interest-rate/) rise, the cost of leverage increases and can compress returns. When equity valuations fall sharply, leverage can trigger forced selling to maintain [collateral ratios](/collateral-ratio/).
...
[Market timing](/market-timing/) and leverage risk are manageable but present. Interest-rate changes affect both the cost of leverage and discount/premium dynamics. Economic downturns can pressure equity valuations generally and healthcare stocks specifically as investors rotate to defensive positions.
