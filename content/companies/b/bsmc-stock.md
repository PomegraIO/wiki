---
title: "Brandes U.S. Small-Mid Cap Value ETF (BSMC)"
description: "An actively managed ETF that invests in overlooked mid-sized US companies trading below their intrinsic worth — for value hunters willing to bet that discipline beats the market."
keywords:
  - value investing
  - small-cap
  - mid-cap
...
Brandes Investments, the fund sponsor, applies a disciplined value methodology. The team screens for companies trading below [intrinsic value](/intrinsic-value/) on metrics like price-to-book, price-to-earnings, and [free cash flow](/free-cash-flow/) yield. They dig into the financials and management to ensure the discount is not there because the business is broken but rather because the market is sleeping. Once they have a candidate list, they build a concentrated portfolio — usually 50 to 80 holdings — weighted by conviction and position size. You are not getting the entire small-mid cap universe; you are getting the managers' best ideas in this corner of the market.

## What are the real risks?

[Value investing](/value-investing/) is a philosophy that goes in and out of fashion. In periods when growth stocks dominate — when investors prize rapid revenue expansion over current earnings — [value funds](/value-fund/) underperform. That underperformance can last for years. A shareholder in a value fund has to be comfortable with periods where the fund looks bad relative to broader indexes or growth-tilted peers, betting that the cycle will eventually turn.

The fund also carries the [idiosyncratic risk](/idiosyncratic-risk/) of smaller and mid-sized companies. They are more sensitive to [recessions](/recession/), changes in [interest rates](/interest-rate/), and industry disruption. A regional bank or a specialty manufacturer can disappear entirely if the world shifts. [Diversification](/diversification/) across 50 to 80 names helps, but it is not the same cushion as owning the mega-caps that dominate the S&P 500.
...
Read the prospectus to understand the screening criteria and position-sizing rules. The fund's fact sheet will show the current top 10 holdings — a mix of names you have heard of and names you have not. Look at the fund's performance track record across a full market cycle, including both value rallies and value droughts. Compare its results to a small-mid-cap value index benchmark and to other actively managed small-mid-cap value funds. Check the [expense ratio](/expense-ratio/); it should reflect active management but not be excessive. Finally, look at the fund's turnover — how much it trades in a year — to get a sense of how much of its return is eaten by trading costs.
