---
title: "John Hancock Financial Opportunities Fund (BTO)"
description: "BTO is a closed-end fund managed by John Hancock Investment Management that invests in a diversified portfolio of domestic and international stocks, with a focus on companies positioned for long-term growth."
keywords:
  - closed-end fund
  - equity fund
  - dividend investment
...
Like all [actively managed funds](/actively-managed-fund/), BTO lives or dies on the skill of its managers and the sustainability of its edge. Actively managed funds, as a category, have underperformed passive [index funds](/index-fund/) over long periods, so the burden falls on BTO to justify its higher expenses and demonstrate that its managers have done something a simple index fund would not. The [expense ratio](/expense-ratio/) is higher than a passive ETF — typically in the 0.7 to 1.0 per cent range — reflecting the cost of the management team, research, and trading.

Closed-end funds often support their existence by distributing significant income to shareholders in the form of [dividends](/dividend/) or capital-gains distributions. BTO has historically paid distributions, creating appeal for income-focused investors. These distributions come from the fund's portfolio — dividend income earned by its stocks, and realized capital gains from selling positions at a profit. The distribution rate can fluctuate, and the fund may distribute more than it earns in a given year (using portfolio appreciation or returning capital), making the income stream less predictable than, say, a [bond's](/bond/) coupon. Investors drawn to BTO often are seeking a combination of growth and income, rather than pure appreciation.
