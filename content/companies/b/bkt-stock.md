---
title: "BlackRock Income Trust, Inc. (BKT)"
description: "A closed-end investment fund managed by BlackRock that invests in a diversified portfolio of income-generating securities including bonds and preferred stocks."
keywords:
  - closed-end fund
  - income fund
  - bond fund
...
<table>
<tr><th>Ticker</th><td>BKT (NYSE)</td></tr>
<tr><th>Fund type</th><td>Closed-end investment fund</td></tr>
<tr><th>Manager</th><td>BlackRock, Inc.</td></tr>
<tr><th>Strategy</th><td>Income generation from bonds and preferred stocks</td></tr>
<tr><th>Sector exposure</th><td>Fixed income / equities</td></tr>
<tr><th>Distribution policy</th><td>Monthly income distributions to shareholders</td></tr>
<tr><th>SEC CIK</th><td>0000832327</td></tr>
</table>
</aside>

[BlackRock](/blk-stock/) Income Trust is a closed-end investment fund (CEF) that pools investor capital and deploys it into a diversified portfolio of income-producing securities. The fund is managed by BlackRock, the world's largest asset manager, and serves retail investors who want exposure to a professionally managed portfolio of bonds, [preferred stocks](/preferred-stock/), and related instruments in exchange for a [management fee](/management-fee/). Shares of BKT trade on the [New York Stock Exchange](/new-york-stock-exchange/) like a stock, allowing investors to buy and sell shares throughout the day at prices set by market supply and demand.

The structural difference between a closed-end fund and an open-end mutual fund is important. A mutual fund is open-ended, meaning investors can buy and sell shares directly with the fund at [net asset value](/net-asset-value/) (NAV) on demand. A closed-end fund issues a fixed number of shares at inception and then manages that fixed pool of capital. New investors who want to buy shares must purchase them from existing shareholders on the [stock exchange](/stock-exchange/), not from the fund itself. This creates a potential disconnection: the market price of a closed-end fund's shares can diverge from the underlying NAV of the holdings, trading at a premium or discount. That divergence is unique to [closed-end funds](/closed-end-fund/) and creates both opportunities and risks for traders.

BKT's investment strategy is income-focused. The fund invests in [high-yield bonds](/high-yield-bond/) (also called junk bonds), investment-grade [corporate bonds](/corporate-bond/), preferred stocks, and other fixed-income securities that pay regular cash flows to their holders. The portfolio is designed to generate a stream of interest and dividend income that the fund distributes monthly to shareholders. The yield on the fund's holdings is the primary draw for investors, though the value of the fund shares can also appreciate or depreciate based on changes in [interest rates](/interest-rate/) and [credit spreads](/credit-spread/).
