...
description: "Banco Santander Brasil is one of Brazil's largest banks, offering retail and commercial banking to millions of customers. It is a subsidiary of the Spanish Santander group adapted to operate in one of the world's biggest emerging economies."
keywords:
  - brazilian banking
...
The Brazilian macroeconomic environment affects Santander's results substantially. Brazil is exposed to commodity-price swings, [currency volatility](/currency-volatility/) (the real against the dollar), inflation, and interest-rate changes set by the [central bank](/central-bank/). When the Brazilian economy is growing briskly, loan demand is strong and defaults are low — the bank earns good returns. During [recessions](/recession/) or periods of high inflation and currency weakness, loan demand falls, [default rates](/default-rate/) rise, and the bank's earnings suffer. This cyclicality is inherent to banking in an emerging market.
