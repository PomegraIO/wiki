---
title: "Brown Advisory Sustainable Value ETF (BASV)"
description: "BASV tracks large-cap U.S. stocks selected for value and environmental, social, and governance (ESG) criteria, offering a blend of dividend income and capital appreciation with a focus on business quality and long-term durability."
keywords:
  - ESG investing
  - value investing
...
The Brown Advisory Sustainable Value ETF ([NASDAQ](/nasdaq/): BASV) is a diversified exchange-traded fund that blends two investment philosophies: traditional [value investing](/value-investing/) (buying stocks that trade below their intrinsic worth) and environmental, social, and governance screening (prioritizing companies with sound practices in those domains). It holds roughly 50 to 70 large-cap U.S. equities selected by Brown Advisory, an investment manager founded in 1983 and focused on quality-driven strategies. The fund targets investors seeking both income and capital appreciation through a disciplined approach that fuses financial discipline with nonfinancial criteria.

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>BASV (NASDAQ)</td></tr>
<tr><th>Sponsor</th><td>Brown Advisory</td></tr>
<tr><th>Fund type</th><td>Equity ETF (U.S. large-cap)</td></tr>
<tr><th>Strategy</th><td>Value + ESG screening</td></tr>
<tr><th>Number of holdings</th><td>~50–70</td></tr>
<tr><th>Expense ratio</th><td>Low (typical for category)</td></tr>
<tr><th>Objective</th><td>Long-term capital appreciation and dividends</td></tr>
</table>
</aside>
...
BASV is a conventional [equity ETF](/equity-etf/), not an indexed fund. Brown Advisory's portfolio managers make the final decisions on which stocks to hold, within the fund's selection criteria, so performance may drift from a mechanical index. The [expense ratio](/expense-ratio/) is quoted on the fund's prospectus and fact sheet; as with most equity ETFs, it is measured in basis points (hundredths of a percentage), and the actual drag is modest relative to the [diversification](/diversification/) and professional management it buys.

The fund trades on the NASDAQ during regular market hours like any stock, with [bid-ask spreads](/bid-ask-spread/) and liquidity that reflect the underlying holdings' tradability. Shareholders can buy and sell intraday at market prices, and the fund publishes its full holdings and portfolio composition daily.
...
The fund suits buy-and-hold investors with a multi-year horizon, not active traders. Holdings in [value funds](/value-fund/) have historically been cyclical — popular when investors reward cheapness, less popular when growth dominates sentiment — so conviction in the approach matters more than trying to time entry and exit.
...
As with any equity ETF, the fund carries [market risk](/market-risk/) and [currency risk](/currency-risk/) (if held by international investors). An economic downturn, [sector rotation](/sector-rotation/), or deterioration in any single holding's fundamentals will be reflected in the [net asset value](/net-asset-value/).
...
Compare BASV's performance and holdings against peers in the sustainable value category, and check the fund's tracking of sector weights and [dividend yield](/dividend-yield/) relative to the broad U.S. market. The prospectus will clarify which ESG frameworks the fund uses and how valuations are assessed. Long-term holders should monitor whether the fund's philosophy remains consistent through manager changes and [market cycles](/market-cycle/).
