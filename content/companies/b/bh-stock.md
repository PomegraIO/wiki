...
Biglari has held the restaurant operation for two decades without significantly scaling it. The strategic value, from the holding company's perspective, may be threefold: the real estate underneath many units, the cash generation (modest though it may be), and the optionality to reposition or sell if circumstances shift. The [10-K](/wiki/10-k/) breaks out restaurant revenues and operating margins, letting investors track performance segment by segment.
