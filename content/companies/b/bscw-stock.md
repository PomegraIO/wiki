---
title: "Invesco BulletShares 2032 Corporate Bond ETF (BSCW)"
description: "An exchange-traded fund holding investment-grade corporate bonds maturing in 2032, designed for investors with a specific 2032 target date for capital return."
keywords:
  - corporate bonds
  - maturity date
  - ETF
...
Invesco's BulletShares family solved a problem that [bond](/bond/) investors have quietly faced for decades: most bond funds are built to exist forever, which is convenient for the fund company but inconvenient for the investor who knows exactly when they will need their money. BSCW is the 2032 maturity point in that family — a fund that holds investment-grade [corporate bonds](/corporate-bond/) timed to mature around 2032, then effectively dissolves as bonds are repaid and returned to shareholders.

## The fund's mandate and portfolio

BSCW tracks the Invesco BulletShares 2032 Corporate Bond Index, a basket of investment-grade corporate debt maturing in or near 2032. The fund holds 200 to 500 individual bonds from issuers across major economic sectors: financials, industrials, utilities, consumer goods, energy, healthcare, materials. All holdings carry ratings of BBB− or higher, the floor of what credit agencies define as [investment-grade — bonds](/investment-grade-bond/) issued by companies with a reasonable probability of servicing debt through maturity.
...
[Credit risk](/credit-risk/) is the primary concern. If an issuer in the portfolio faces financial distress and defaults, the fund's shareholders bear the loss. Investment-grade ratings reduce this probability but do not eliminate it, especially if economic conditions deteriorate sharply. The [diversification](/diversification/) across 200 to 500 issuers and many sectors helps mitigate [concentration risk](/concentration-risk/).

[Interest-rate risk](/interest-rate-risk/) exists but diminishes over time. If rates rise sharply after purchase, BSCW's share price falls because its bonds are worth less in that higher-rate environment. However, this risk declines as maturity approaches; a bond due in one year changes price far less than one due in ten years when rates move.

[Reinvestment risk](/reinvestment-risk/) is more subtle. As the fund receives coupon payments and principal repayments, it must reinvest at prevailing rates. If rates have fallen, reinvestment occurs at lower yields, dragging total return. This is the cost of owning a [bond ladder](/bond-ladder/) that matures at a defined date.
