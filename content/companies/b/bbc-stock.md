---
title: "Virtus Biotech Clinical Trials ETF (BBC)"
description: "An exchange-traded fund tracking companies involved in clinical drug trials, biotech services, and trial infrastructure. Provides exposure to the testing phase of pharmaceutical development."
keywords:
  - biotech
  - clinical trials
  - drug development
...
BBC is a secondary-market ETF, trading throughout the day on [NASDAQ](/nasdaq/) at prices set by buyers and sellers. Unlike some narrow or illiquid [sector ETFs](/sector-etf/), BBC is relatively liquid given that its core holdings include large, widely traded CROs. [Bid-ask spreads](/bid-ask-spread/) are typically modest, and [authorized participants](/authorized-participant/) can create or redeem shares to keep market price close to [net asset value](/net-asset-value/).

The fund's [expense ratio](/expense-ratio/) is typically 0.50 to 0.70 percent, higher than broad-market ETFs but reasonable for a specialized [sector fund](/sector-fund/) with active rebalancing. Many investors hold BBC as a thematic or tactical position — a bet on outsourced drug development — rather than as a permanent core holding. Because the fund holds equities, it is tax-inefficient relative to [bonds](/bond/) or Treasury instruments and makes most sense in tax-deferred accounts.

## Research pathway

Understanding BBC requires following the biotech and pharmaceutical sectors. Reading the [annual reports](/10-k/) and earnings calls of IQVIA, Syneos Health, and Charles River Laboratories reveals trends in trial spending, pricing power, and client concentration. Monitor FDA guidance changes and regulatory developments that could affect trial conduct or costs. Track the pharmaceutical pipeline — how many drugs are in late-stage trials, and at what cost? Announcements of major trial startups or cancellations move the needle for CROs. The quarterly report on healthcare spending and biotech R&D investment from industry groups like PhRMA provides context on the overall funding environment. A decline in venture capital funding for biotech startups, for instance, often precedes a slowdown in trial services demand, because startups are heavy users of CROs to run their early-stage trials.
