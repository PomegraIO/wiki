...
description: "Brookfield Infrastructure owns and operates essential infrastructure assets globally—utilities, toll roads, transmission lines, renewable energy—generating stable, inflation-indexed cash flows."
keywords:
...
The geographic [diversification](/diversification/) is substantial. Brookfield Infrastructure owns assets in North America, South America, Europe, Australia, and Asia. This spread reduces [concentration risk](/concentration-risk/) — weakness in one region is offset by strength in others — and gives the company exposure to infrastructure demand across different economic and regulatory environments.
...
Inflation is a double-edged sword. Many of Brookfield's revenues rise with inflation, which is an advantage. But so do operating costs and the cost of capital. The company also faces commodity exposure: the price of power affects renewable-energy returns, and [interest rates](/interest-rate/) affect the cost of refinancing debt. Brookfield uses debt strategically to fund acquisitions and boost returns, so rising rates pressure the [balance sheet](/balance-sheet/).
