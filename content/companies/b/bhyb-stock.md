---
title: "Xtrackers USD High Yield BB-B ex Financials ETF (BHYB)"
description: "An exchange-traded fund providing exposure to speculative-grade corporate bonds excluding financial firms, with a focus on higher-yielding debt."
keywords:
  - high-yield bonds
  - junk bonds
  - BB-B rated
...
The real driver of high-yield performance is credit spread — the extra yield investors demand to hold speculative-grade bonds relative to treasuries. Spreads widen (investors demand more compensation) when economic outlook deteriorates, volatility spikes, or credit concerns mount. Spreads tighten (investors accept less extra yield) during risk-on periods and economic expansion. BHYB's performance depends not just on interest-rate moves but on whether spreads expand or contract. A high-yield fund can decline even if the broader bond market rises, if credit spreads widen faster than treasury yields fall.
...
Review the fund's prospectus to understand the index methodology, the credit-quality distribution, the average coupon and yield, and the duration. Check the fund's historical performance through prior recessions to see how it behaved during credit stress. Examine the top 10 holdings to familiarize yourself with the kinds of issuers the fund holds. Compare the fund's yield and expense ratio against other high-yield bond funds to ensure competitive pricing and returns. Consider the economic cycle: entering high-yield during late-cycle expansions (when spreads are tight) is riskier than entering when spreads are wide and recession risk is elevated.
