---
title: "Brookfield Corp (BRCFF)"
description: "Brookfield Corp is a diversified global alternative asset operator spanning real estate, infrastructure, renewable energy, and asset management — held together by scale advantages in long-term capital deployment and operational improvement."
keywords:
...
<table>
<tr><th>Ticker</th><td>BRCFF (OTC)</td></tr>
<tr><th>Domicile</th><td>Canada (Ontario)</td></tr>
<tr><th>Sector</th><td>Alternative asset management / infrastructure / real estate</td></tr>
<tr><th>Operating segments</th><td>Real estate, infrastructure, renewable energy, asset management</td></tr>
<tr><th>Business model</th><td>Acquire, operate, and improve long-dated assets; manage third-party capital</td></tr>
<tr><th>Key advantage</th><td>Scale in capital markets, operational expertise, institutional access</td></tr>
...
Brookfield's structure reflects this reality. It owns and operates assets directly—[commercial real estate](/commercial-real-estate/) across North America, utility businesses in several countries, power generation facilities, and more. Alongside this, it has built an asset-management arm that pools capital from institutional investors (pension funds, insurers, [sovereign wealth funds](/sovereign-wealth-fund/)) and deploys it into the same types of assets, collecting [management fees](/management-fee/) and [carried interest](/carried-interest-compensation/). This dual model lets the company scale without raising as much equity itself: it can commit capital and operational capability alongside third-party money, earning returns on both the operating cash flows and the fees and carried interest.
...
Key metrics to track include [leverage ratios](/leverage-ratio-forex/) (Brookfield historically carries debt, and the cost of that debt matters), the composition of recurring versus transactional revenue (recurring is more stable), the performance of the asset-management business (growth in assets under management is important), and the [dividend yield](/dividend-yield/) and [payout ratio](/payout-ratio/) (the company has long paid a dividend that depends on the portfolio's cash generation). The company trades in multiple currencies and markets, so international exposure and capital-markets access are worth monitoring.
