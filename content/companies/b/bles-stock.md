---
title: "Inspire Global Hope ETF (BLES)"
description: "An ETF selecting global companies aligned with biblical values and ESG standards — screening for positive social and environmental impact alongside theological consistency, spanning developed and emerging markets."
keywords:
...
<table>
<tr><th>Sponsor</th><td>Inspire Investing</td></tr>
<tr><th>Index tracked</th><td>Inspire Global Hope Index</td></tr>
<tr><th>Structure</th><td>Simple ETF (no leverage or inverse mechanics)</td></tr>
<tr><th>Geographic scope</th><td>Global (developed and emerging markets)</td></tr>
<tr><th>Screening approach</th><td>Positive (ESG + values criteria) and negative (exclusion-based)</td></tr>
<tr><th>Primary expense form</th><td>Annual expense ratio</td></tr>
<tr><th>Trading venue</th><td>NASDAQ</td></tr>
<tr><th>Typical holdings count</th><td>Concentrated, fewer than broad indexes</td></tr>
</table>
</aside>
...
Inspire charges an annual [expense ratio](/expense-ratio/) that is reasonable for an actively screened, thematic fund. The cost is passed through to shareholders proportionally; the fee is independent of fund size or trading volume, so it does not fluctuate with market conditions.

The underlying companies in the fund often have strong cash flow and [dividend](/dividend/) policies. Many are established firms with durable businesses — the screens exclude high-risk or speculative sectors, which biases the portfolio toward companies with stable revenue and mature capital structures. Shareholders receive the dividends those companies distribute.
