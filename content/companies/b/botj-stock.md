---
title: "Bank of the James Financial Group Inc (BOTJ)"
description: "Community bank headquartered in Virginia, serving central Virginia through retail and commercial lending, deposits, and financial services."
keywords: ["community bank", "Virginia", "commercial bank", "deposits", "lending", "local bank"]
---
...
<tr><th>Ticker</th><td>BOTJ</td></tr>
<tr><th>Listing</th><td>NASDAQ</td></tr>
<tr><th>SEC CIK</th><td>1275101</td></tr>
...
Bank of the James' defensibility rests on information and relationship advantages in its [primary market](/primary-market/)—central Virginia. A community bank's loan officers know their customers, their industries, and the local competitive landscape in ways that a loan officer at [JPMorgan Chase](/jpmorgan-chase/) or a loan algorithm at an online lender cannot. This information advantage translates to better credit decisions (in theory) and customer loyalty. When a business owner or farmer has worked with Bank of the James for a decade, they develop trust, familiarity, and switching cost. Moving to a larger bank or an online alternative means starting from scratch and potentially facing higher costs or less favorable terms.
...
Community banks face a structural profitability challenge: they operate at a smaller scale than regional and national competitors, which means higher costs per dollar of assets. Loan origination, compliance, technology, and risk management all have fixed costs that are easier to absorb on a large [balance sheet](/balance-sheet/). Bank of the James must therefore rely on higher net interest margins (the difference between what it earns on loans and pays on deposits) to offset this cost disadvantage. As margins compress due to competition, profitability suffers.
