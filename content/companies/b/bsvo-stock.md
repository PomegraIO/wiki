---
title: "EA Bridgeway Omni Small-Cap Value ETF (BSVO)"
description: "A small-cap value equity fund that applies quantitative discipline to select deeply undervalued smaller companies, designed for long-term capital appreciation."
keywords:
  - small-cap value
  - value investing
...
<table>
<tr><th>Ticker</th><td>BSVO (NASDAQ)</td></tr>
<tr><th>Sponsor</th><td>Bridgeway Capital Management</td></tr>
<tr><th>Fund type</th><td>Exchange-traded equity fund</td></tr>
<tr><th>Strategy</th><td>Small-cap value</td></tr>
<tr><th>Selection method</th><td>Quantitative screening</td></tr>
<tr><th>Universe</th><td>U.S. small-cap stocks</td></tr>
<tr><th>Expense ratio</th><td>Low (near 0.40%–0.50% annually)</td></tr>
...
The Bridgeway Omni strategy attacks this space through systematic quantitative screening rather than traditional fundamental research. The fund builds a proprietary model that weighs multiple measures of value—price-to-earnings, price-to-book, [dividend yield](/dividend-yield/), and others—alongside indicators of quality, momentum, and risk. This quantitative discipline is meant to filter out value traps (the cheap stocks that deserve to be cheap) and surface genuine opportunities: low prices paired with acceptable business quality and reasonable catalysts for repricing.

## How the fund constructs its portfolio

The Omni approach casts a wider net than many small-cap [value funds](/value-fund/). Rather than restricting the universe to a single index definition of small-cap, it spans a range of [market capitalizations](/market-capitalization/), hence the "Omni" label. This flexibility allows the screening process to capture ideas slightly below the traditional small-cap threshold as well as micro-cap opportunities that conventional indices exclude entirely.
...
Additionally, because the fund holds smaller, less-liquid companies, its trading costs (the [bid-ask spread](/bid-ask-spread/) paid when buying or selling shares) can exceed those of large-cap funds, though the ETF structure mitigates this for most retail investors.
