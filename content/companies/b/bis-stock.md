...
description: "An inverse leveraged ETF delivering 2x daily inverse exposure to Nasdaq Biotechnology Index—a bearish tactical hedge for biotech, reset each day with built-in decay."
keywords:
  - biotechnology
  - inverse etf
  - short biotech
...
## Tactical hedging use cases

BIS serves three narrow purposes. A biotech portfolio manager hedging a long position might short BIS for days or weeks around regulatory risk. A trader betting on near-term biotech weakness might use BIS for 2x exposure without managing a margin account. A volatility trader might use BIS within a spread trade targeting specific price movements.

Beyond those tactical windows, BIS is a drag. An investor holding BIS for months as a hedge against long biotech exposure should instead sell part of the long position or buy put-option protection. Both achieve downside protection without daily decay eroding value.
