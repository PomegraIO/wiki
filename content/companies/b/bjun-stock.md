---
title: "Innovator U.S. Equity Buffer ETF - June (BJUN)"
description: "A quarterly outcome-based ETF offering U.S. equity exposure with a pre-set downside buffer and upside cap, resetting each June, designed for investors seeking defined-risk equity exposure."
keywords:
  - buffer ETF
  - outcome-based
  - downside protection
...
The [expense ratio](/expense-ratio/) is higher than a conventional index fund — typically in the range of 0.5 to 0.75 per cent annually — because the embedded options have a cost. Quarterly distributions of realized gains and losses on expired derivatives mean the fund is tax-inefficient compared to a simple equity index holder, a significant consideration for taxable accounts. The prospectus details the exact fee, the current buffer and cap for the active outcome period, and the risk of early [liquidation](/liquidation/); this document is essential reading before buying.
