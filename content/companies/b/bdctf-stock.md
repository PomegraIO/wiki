---
title: "BuildDirect.com Technologies Inc. (BDCTF)"
description: "E-commerce platform for building materials and home improvement products, connecting professional contractors and homeowners directly to manufacturers and distributors through a digital marketplace."
keywords: ["e-commerce", "building materials", "construction", "digital marketplace", "home improvement", "B2B2C"]
---
...
<table>
<tr><td><strong>Ticker</strong></td><td>BDCTF</td></tr>
<tr><td><strong>Listing</strong></td><td>OTC Markets</td></tr>
<tr><td><strong>SEC CIK</strong></td><td>1576159</td></tr>
<tr><td><strong>Sector</strong></td><td>Consumer Discretionary</td></tr>
<tr><td><strong>Industry</strong></td><td>Specialty Retail / E-Commerce</td></tr>
...
Analyzing BuildDirect requires understanding the underlying marketplace health, customer retention, and take-rate trends. In the 10-K, look for: gross merchandise value (GMV) growth, take rate per dollar of GMV, customer acquisition cost and payback period, repeat customer rates and cohort retention curves, and [operating-margin](/operating-margin/) progression. Compare these metrics to Home Depot's online growth, to other marketplace operators (Amazon Home & Garden, Wayfair), and to historical BuildDirect performance. Assess whether supplier concentration creates dependency risk (if the top 10 suppliers account for >50% of GMV, supplier churn threatens the business). Monitor for evidence of profitability progress: is the company approaching [free-cash-flow](/free-cash-flow/) positivity, or is it still in heavy investment mode?

<div class="wiki-seealso">
### Closely related
- [BuildDirect.com Technologies Inc. (BDCTF) 10-K filing](https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&CIK=0001576159&type=10-K)

### Wider context
- [/stock/](/stock/) — Understanding platform scale-up equity value
- [/operating-margin/](/operating-margin/) — Path to profitability in marketplace models
- [/free-cash-flow/](/free-cash-flow/) — When do platforms generate cash?
- [/mutual-fund/](/mutual-fund/) — Consumer discretionary and e-commerce fund holdings
</div>
