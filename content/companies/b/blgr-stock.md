---
title: "Bluemonte Large Cap Growth ETF (BLGR)"
description: "An ETF concentrating on large-cap growth stocks — companies with scale and the capacity to invest in expansion — aiming to capture the performance of mature companies with above-average earnings growth potential."
keywords:
  - growth stocks
  - large-cap
  - bluemonte
...
BLGR is a simple ETF with no leverage or inverse mechanics, so it carries no daily-reset decay risk. It trades on a major US exchange with high liquidity typical of large-cap funds. The structure is ordinary and transparent; the distinction lies in what the index selects.
...
A large-cap growth index is a specific bet. It excludes smaller companies, even if they are growing faster, because they fall below the size threshold. It excludes large companies that are mature or stagnant, because growth does not meet the standard. And it is biased toward proven operators — companies that have already demonstrated earnings growth — rather than turnarounds or recovery plays.

That bias creates concentration. Certain sectors tend to qualify: technology, consumer discretionary, healthcare, and industrials produce more large-cap growth candidates than others. The fund will be lighter in utilities, energy, and materials, which tend to grow more slowly by nature. This sector tilt is a feature, not a flaw, but it is worth understanding: BLGR will not resemble the broader market.

The companies selected must be large enough to be liquid and tradeable, so there is a minimum scale and an establishment requirement. Small companies with faster growth are excluded by definition. This means BLGR will systematically miss some of the highest-growth opportunities, trading that potential for stability and the chance to own proven winners.

## Risks of the growth profile

A growth-tilted portfolio is more sensitive to changes in expectations. When the market becomes pessimistic about future earnings or decides growth will be slower, large-cap growth stocks often fall harder than the market as a whole. Conversely, in periods when investors are optimistic about expansion and innovation, they outperform.
