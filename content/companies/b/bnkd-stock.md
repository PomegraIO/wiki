---
title: "MicroSectors U.S. Big Banks -3 Inverse Leveraged ETNs due February 17, 2045 (BNKD)"
description: "BNKD is an inverse leveraged exchange-traded note that aims to deliver 3 times the opposite return of major U.S. bank stocks daily, betting against the financial sector."
keywords:
  - inverse ETF
  - leveraged ETN
  - bearish bet
  - financial sector short
  - daily reset
  - decay risk
handwritten: true
---
...
BNKD charges an [expense ratio](/expense-ratio/) (typically 1% or higher for leveraged products), which comes out of the fund's daily [net asset value](/net-asset-value/). On top of that, the [bid-ask spread](/bid-ask-spread/) (the gap between the price you pay to buy and the price you get when you sell) can be wide if the fund is not heavily traded, further eroding returns. These costs stack on top of the volatility decay, making BNKD an expensive instrument to hold.
