---
title: "Balfour Beatty plc (BAFBF)"
description: "UK-listed infrastructure engineering and construction firm operating across rail, utilities, and civil engineering in the US and UK."
keywords: ["infrastructure", "engineering", "construction", "rail", "utilities", "FTSE"]
---

*[**Balfour Beatty**](https://en.wikipedia.org/wiki/Balfour_Beatty) (BAFBF) is a British multinational infrastructure engineering and construction contractor headquartered in London, with substantial operations in the United States and UK. The firm anchors itself in the long-cycle, capital-intensive segments of transport infrastructure—rail networks, power distribution, and civil engineering—where contract duration and regulatory stability create defensible business models. Its American depositary receipts trade over-the-counter.*

<aside class="wiki-infobox"><table>
<tr><td>Ticker</td><td>BAFBF (ADR)</td></tr>
<tr><td>Listing</td><td>OTC; primary listing FTSE (London)</td></tr>
<tr><td>SEC CIK</td><td>1506721</td></tr>
<tr><td>Sector</td><td>Industrials</td></tr>
<tr><td>Industry</td><td>Engineering & Construction</td></tr>
...
### Closely related
- [Public company](/public-company/) — framework for understanding Balfour Beatty's listing and governance
- Balfour Beatty investors — SEC filings under CIK 1506721
- [10-K](/10-k/) — annual reports detail backlog, segment margins, and contract wins

### Wider context
- [Stock](/stock/) — understanding share performance amid infrastructure cycle
- [Enterprise value](/enterprise-value/) — infrastructure contractors valued by backlog and margin sustainability
- [Free cash flow](/free-cash-flow/) — critical metric for assessing working-capital efficiency
- [Operating margin](/operating-margin/) — rail and utilities contracts typically yield 4–8% operating margins
