---
title: "B&M European Value Retail S.A./ADR (BMRRY)"
description: "B&M is a European discount retailer operating thousands of stores across the United Kingdom and continental Europe, proving that vast physical scale can sustain thin margins when operations run at ruthless efficiency."
keywords:
  - discount retail
  - european retail
  - store expansion
...
The company files [annual reports](/10-k/) and financial statements in the UK; American holders can access SEC filings for the ADR. The 10-K equivalent, filed with the [Financial Conduct Authority](/financial-conduct-authority/), shows the breakdown of sales by geography and category, trends in store count, gross margins, and the company's commentary on sourcing environment and competitive pressures. Quarterly trading updates offer the most current view of [inventory turnover](/inventory-turnover/), comp-store sales, and the flow of excess merchandise — the leading indicators of health for this model. Watch the gross margin trend closely: when it widens, the company is sourcing well and selling efficiently; when it compresses, it signals either a tightening supply of good discount inventory or mounting pricing pressure from competitors.
