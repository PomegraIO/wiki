---
title: "YieldMax BABA Option Income Strategy ETF (BABO)"
description: "An options-overlay ETF that sells covered calls on Alibaba shares to generate income, accepting reduced upside for a steady income stream."
keywords:
  - covered call
  - options overlay
  - income strategy
...
The main risk is that if Alibaba's stock rises sharply, you will have capped your gains or lost the position to early assignment. For investors who own Alibaba and are comfortable with that cap in exchange for monthly distributions, or who believe Alibaba will trade sideways, the covered-call approach can be sensible. For someone who expects a strong rally, a covered-call fund locks you out of much of the upside.

Assignment and share turnover can also create unexpected tax consequences in non-sheltered accounts. Every time shares are called away and repurchased, the fund recognizes gains and losses. Because most of the underlying gains are realized, the fund tends to generate short-term capital-gains distributions, which are taxed as ordinary income. A shareholder in a high tax bracket holding BABO in a taxable account should be aware that the tax bill can be substantial relative to the income received.
