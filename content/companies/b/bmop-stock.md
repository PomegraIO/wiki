---
title: "BNY Mellon Municipal Opportunities ETF (BMOP)"
description: "An actively managed municipal bond ETF seeking undervalued tax-exempt municipal debt across bond types and geographies, combining professional credit selection with the trading flexibility of an ETF."
keywords:
  - municipal bonds
  - active management
  - tax-exempt income
...
BMOP has geographic discretion to build overweight positions in states or cities it judges undervalued and reduce exposure where bonds are expensive. If New York City bonds trade at wide spreads due to temporary political turmoil but the city's underlying finances remain sound, a manager can recognize that bargain and buy. If a state is facing demographic decline and chronic revenue shortfalls, the manager can lighten exposure even if bonds are yield-rich. This geographic and credit selection is precisely where active management can add value if executed well.

The fund may also concentrate by sector. School bonds, transportation bonds, housing bonds, and utility bonds all carry distinct risks. A manager bearish on transportation (viewing fuel-tax revenues as threatened by electric vehicles) can reduce that exposure. One bullish on water infrastructure can overweight water-system bonds. This sector and subsector selectivity shapes the fund's risk profile and drives performance divergence from a broad municipal-bond index.

## Investment-grade and high-yield positioning
...
BMOP's managers also control duration—the average maturity and interest-rate sensitivity of the portfolio. Long-duration bonds are more sensitive to interest-rate changes: if rates rise 1%, a long-duration bond may fall 5% in value; a short-duration bond may fall only 2%. The managers may extend duration when they judge that rates have reached a peak, or shorten duration when they expect rates to rise further. The fund's current duration is disclosed in its fact sheet and can shift meaningfully as the managers adjust bets.

## Tax advantages and efficiency

The defining economic feature is the federal tax exemption. A municipal bond paying 3.5% is economically equivalent to a taxable bond paying roughly 5.5% for someone in the 36% federal tax bracket. BMOP passes through all federal tax-exempt interest to shareholders, so investors capture this advantage directly. However, the fund may realize capital gains when bonds are sold at profit, and those gains are taxable to shareholders. Active trading that generates capital gains erodes some of the tax advantage; well-managed funds keep turnover moderate to preserve efficiency.
...
BMOP is suitable for taxable-account investors in high federal tax brackets seeking tax-exempt fixed income. Before investing, compare BMOP's after-fee performance against passive municipal-bond index ETFs and the Bloomberg Municipal Bond Index over rolling five-year and ten-year periods. If BMOP has not outperformed after fees, passive indexing is likely better. Review the portfolio's credit-quality distribution and duration to ensure they match your risk tolerance. Finally, assess your personal tax situation: the federal exemption is valuable only if you are in a high federal bracket.
