---
title: "Blackstone Long-Short Credit Income Fund (BGX)"
description: "A closed-end fund managed by Blackstone that invests in secured loans and high-yield bonds using long and short positions to generate income. Trades on NYSE (BGX)."
keywords:
  - closed-end fund
  - credit investing
  - secured loans
...
Blackstone Long-Short Credit [Income Fund](/income-fund/) is a closed-end investment company whose strategy centers on exploiting credit opportunities across a spectrum of debt instruments. Trading on the [New York Stock Exchange](/new-york-stock-exchange/) under the ticker BGX, the fund pools investor capital to construct a portfolio of loans, [bonds](/bond/), and credit instruments while employing long and short positions to enhance income and manage risk. It is managed by GSO Capital Partners, Blackstone's debt-investing division, one of the world's largest credit-focused investment teams.

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>BGX (NYSE)</td></tr>
<tr><th>Fund type</th><td>Closed-end investment company</td></tr>
<tr><th>Manager</th><td>GSO Capital Partners / Blackstone</td></tr>
<tr><th>Primary objective</th><td>Current income, secondary capital appreciation</td></tr>
<tr><th>Core holdings</th><td>70%+ in secured loans; also unsecured loans, high-yield bonds</td></tr>
<tr><th>Strategy</th><td>Long positions and selective short positions in credit</td></tr>
<tr><th>SEC CIK</th><td>0001504234</td></tr>
</table>
</aside>
...
The fund's mandate requires maintaining at least 70% of assets in secured loans, reflecting the strategy's reliance on this asset class. These loans typically carry floating-rate coupons tied to a benchmark like [SOFR](/sofr/) or [LIBOR](/libor/), so when [interest rates](/interest-rate/) rise, the income from the portfolio rises too—a valuable hedge against [inflation](/inflation/) and rising-rate scenarios that harm fixed-rate bonds. Secured loans also benefit when corporate [default rates](/default-rate/) remain manageable; in downturns, the seniority of the first-lien claim protects investors from the worst losses.

## Credit diversification and unsecured debt

Beyond the secured loan foundation, BGX invests the remainder of its portfolio in unsecured high-yield [corporate bonds](/corporate-bond/) and, selectively, unsecured loans. [High-yield bonds](/high-yield-bond/) are corporate debt issued by companies with lower [credit ratings](/credit-rating/) or higher leverage. They offer significantly higher yields than [investment-grade bonds](/investment-grade-bond/) but carry higher default risk. The unsecured position means that in a bankruptcy, the bondholder stands behind secured creditors but ahead of equity holders.

This [diversification](/diversification/) across the credit spectrum gives the manager flexibility to rotate capital based on economic outlook and [relative valuations](/relative-valuation/). In periods when secured loans are expensive relative to high-yield bonds, the manager might shift allocation toward bonds. Conversely, when secured lending offers attractive returns for the risk, the portfolio leans there. The mix is dynamic and reflects the judgment of Blackstone's credit team about where value lies.
...
Leverage amplifies this risk. When credit is performing well and spreads compress, leverage enhances returns beautifully. When credit is performing poorly and spreads blow out, leverage turns good into catastrophic. A fund might be forced to sell assets into a declining market to meet redemptions or [margin calls](/margin-call-forex/), crystallizing losses.

## How to research BGX

Begin with the fund's most recent [annual report](/10-k/) (Form N-CSR, available on the SEC website under CIK 0001504234), which lists the portfolio holdings, income breakdown, leverage levels, and [management fees](/management-fee/). Examine the fund's factsheet for its current [net asset value](/net-asset-value/) per share, market price, any discount or premium, and the current distribution rate. Track the ratio of NAV to market price over time; a widening discount suggests market concern about the fund's prospects. Finally, watch quarterly reports and earnings announcements for commentary on credit spreads, default trends, and the manager's positioning. The health of high-yield credit spreads and default rates are [leading indicators](/leading-indicator/) of how BGX will perform in coming quarters.
