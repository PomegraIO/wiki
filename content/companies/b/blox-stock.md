---
title: "Nicholas Crypto Income ETF (BLOX)"
description: "An ETF designed to generate income from cryptocurrency holdings through staking and other yield-generating mechanisms — selecting cryptocurrencies that pay returns to holders and buying companies enabling crypto-based income."
keywords:
  - cryptocurrency
  - staking
  - crypto income
  - nicholas investments
  - etf
  - digital assets
handwritten: true
---
...
## How BLOX works and what it costs
...
## The composition and its changes

The fund's holdings change as cryptocurrencies cycle through different performance and adoption levels. Currently, it likely includes Ethereum, certain layer-2 blockchain tokens, and emerging proof-of-stake networks. The weighting among holdings shifts based on the fund's methodology.

BLOX faces a compositional challenge: it is concentrated in a small number of cryptocurrencies by necessity. Only a subset of cryptocurrencies offer staking; many of the most widely used do not. This concentration increases the impact of individual holdings on fund performance.
...
BLOX appeals to investors convinced of cryptocurrency's adoption and willing to accept its volatility in exchange for yield that traditional assets do not offer. It is not appropriate for investors who view cryptocurrency as purely speculative or unsuitable for their risk tolerance.

Understanding the fund begins with the prospectus and the current holdings, which show which cryptocurrencies the fund holds and how heavily each is weighted. Nicholas Investments publishes fact sheets explaining the methodology and the staking mechanism. Because the fund is in a rapidly evolving space, reviewing updates about changes to holdings, new cryptocurrencies added or removed, and shifts in staking protocols is important for current shareholders.

Staying informed about cryptocurrency regulation, blockchain technology development, and changes to staking economics provides context for the fund's performance. The relationship between staking income and cryptocurrency prices, the changing reward rates across networks, and the broader sentiment around cryptocurrency adoption all influence BLOX's returns over time.
