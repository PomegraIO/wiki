---
title: "BNY Mellon Ultra Short Income ETF (BKUI)"
description: "BKUI is an exchange-traded fund holding very short-duration bonds and debt instruments — seeking modest income with minimal interest-rate risk for stable value in portfolios."
keywords:
...
BKUI competes with similar offerings from Vanguard, iShares, and others. The key differences are small: the exact bonds held, the [expense ratio](/expense-ratio/), and how actively the manager trades. Most ultra-short bond funds hold similar securities and charge similar fees, so the choice often comes down to liquidity (how easily you can buy or sell the fund) and the [bid-ask spread](/bid-ask-spread/) (the difference between what buyers are willing to pay and what sellers ask). BKUI is a large fund with good trading volume, so transaction costs are typically low.

The risks are real but modest. [Credit risk](/credit-risk/): if a company whose bond is in the fund defaults, the fund loses money. This is rare among [investment-grade bonds](/investment-grade-bond/) but possible. [Interest-rate risk](/interest-rate-risk/): if rates fall, a [short-duration bond fund](/short-duration-bond-fund/) does not gain much. Your bonds mature or are called in (redeemed early by the issuer), and you are forced to reinvest the proceeds at the lower rates. [Liquidity risk](/liquidity-risk/): in a panic, the bond market can freeze, and buyers vanish. BKUI holds bonds traded in deep, liquid markets, but in a true crisis even those can widen. Lastly, if the fund's manager misjudges and loads the portfolio with bonds heading toward default, returns suffer — though BKUI's passive or semi-passive approach limits this.
