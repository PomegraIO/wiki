---
title: "Brookfield Corp (BKFOF)"
description: "Brookfield is a Canada-domiciled alternative asset manager and operator with core businesses in real estate, infrastructure, renewable energy, and asset management—organized around durable, long-dated cash flows."
keywords:
  - real estate
...
<table>
<tr><th>Ticker</th><td>BKFOF (OTC)</td></tr>
<tr><th>Domicile</th><td>Canada (Ontario)</td></tr>
<tr><th>Sector</th><td>Alternative asset operator / infrastructure / real estate</td></tr>
<tr><th>Operating model</th><td>Direct asset ownership + third-party capital management</td></tr>
<tr><th>Core focus</th><td>Long-duration assets with stable, contracted cash flows</td></tr>
<tr><th>Geographic footprint</th><td>North America, Europe, Asia, other regions</td></tr>
<tr><th>SEC CIK</th><td>0001001085</td></tr>
</table>
</aside>
...
The infrastructure business is characterized by:
...
This segment includes hydroelectric facilities (some decades old), wind farms, solar installations, and energy storage. Some assets operate under long-term power-purchase agreements with utilities or corporations; others operate in regulated markets where tariffs are set and stable. The business model is similar to utilities: capital-intensive up front, then decades of relatively stable, inflation-protected cash flows.

Hydroelectric facilities are particularly valuable because they have very long asset lives, low ongoing operating costs, and generate power at close to zero marginal cost once built. Wind and solar have become increasingly cost-competitive and offer the advantage of capital efficiency relative to traditional power plants. Energy storage is an emerging area as grids transition to renewable sources.

Renewable energy is a growth segment for the company as policy support, corporate sustainability commitments, and declining technology costs expand the addressable market. The strategic importance is high because long-term power-purchase agreements provide visibility over decades, making this an ideal asset for the company's patient-capital, long-duration philosophy.

Revenue is recurring and contracted or regulated in most cases.
...
## Capital structure and scale advantages

Brookfield's size enables several advantages:

- **Capital access:** Investment-grade credit quality and a large market presence mean the company can borrow and raise capital at favorable rates, in multiple currencies and formats, and at large scale. Smaller competitors cannot replicate this.
- **Operational expertise:** The company maintains specialized teams in utilities, real estate, transportation, and renewable energy, redeploys that expertise across geographies, and implements best practices at scale.
- **Deal capacity:** Large acquisitions are lumpy—a utility or major real estate portfolio is a billion-dollar-plus transaction. Brookfield's balance sheet and capital-raising ability allow it to pursue these repeatedly, whereas smaller competitors can only do so occasionally.
- **Leverage capability:** The stability of many Brookfield assets—utilities, toll roads, power plants under contract—makes them suitable for leverage. The company uses debt to amplify returns, a lever unavailable (or much more costly) to smaller operators.
