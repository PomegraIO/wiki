---
title: "Fidelity Advisor Funds II - Fidelity Advisor Focused Equity ETF (BRIF)"
description: "An actively managed US equity ETF that concentrates on a select list of undervalued or overlooked stocks within a disciplined, focused portfolio framework."
keywords:
  - focused equity
  - active management
  - US stocks
...
<div class="wiki-infobox-title">BRIF — key facts</div>

|   |   |
|---|---|
| **What it is** | An actively managed equity ETF |
| **Primary focus** | US equities selected via fundamental research |
| **Portfolio style** | Focused; typically 30–50 holdings |
| **Expense ratio** | Active-management pricing; verify in prospectus |
| **Objective** | Long-term capital appreciation |
| **Who runs it** | Fidelity Advisor team |
| **Best for** | Investors seeking concentrated, research-driven US exposure |

</aside>

BRIF is an actively managed exchange-traded fund that concentrates on a tightly curated set of US equity holdings selected through fundamental research and valuation discipline. Unlike broad [index funds](/index-fund/) that aim to own the entire market proportionally, BRIF's managers identify companies they believe to be undervalued or positioned for sustainable growth, then build a concentrated portfolio that may hold only 30 to 50 stocks at any given time. The objective is long-term capital appreciation through careful company selection rather than market-tracking or high portfolio turnover.
