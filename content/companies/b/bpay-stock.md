---
title: "iShares FinTech Active ETF (BPAY)"
description: "iShares FinTech Active ETF is a US-listed fund that tracks a curated portfolio of companies in financial technology, managed actively rather than by a mechanical index rule."
keywords:
  - fintech
  - active management
...
Active management means the fund is not bound to a specific index formula. The manager selects fintech companies based on research and conviction about which are most likely to outperform. This approach allows the fund to tilt toward smaller emerging fintech firms that may not yet qualify for a broad index, to overweight or underweight geographic regions, or to reduce positions in companies the manager believes are overvalued. The advantage is potential outperformance if the manager's picks are sound; the risk is that active managers can underperform their index benchmark, especially after accounting for the higher fees that active management typically commands.
...
BPAY is suited to investors who believe financial technology companies will outperform the broader market and who prefer to delegate the stock-picking to a professional manager rather than choosing individual fintech firms themselves. It may also appeal to investors already holding a broad market index fund who want to add a concentrated bet on digital finance. To understand what BPAY owns, start with the fund's fact sheet and prospectus, which disclose the top holdings, the sector breakdown, and the fund's specific investment objectives. Review the holdings list regularly; fintech is a fast-moving space and the portfolio evolves as the manager adjusts positions. Watch the fund's tracking against its stated benchmark (if it has one) to see whether the active management is paying off, and compare its expense ratio and performance to similar fintech-focused ETFs.
