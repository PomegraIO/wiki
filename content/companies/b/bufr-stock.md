---
title: "FT Vest Laddered Buffer ETF (BUFR)"
description: "An ETF with built-in downside protection capping annual losses at roughly 13%, while capturing upside in the broad S&P 500 through options-based buffering."
keywords:
  - buffered ETF
  - S&P 500
  - downside buffer
...
<table>
<tr><th>Fund name</th><td>FT Vest Laddered Buffer ETF</td></tr>
<tr><th>Ticker</th><td>BUFR</td></tr>
<tr><th>Sponsor</th><td>Equinix Fund Trust (managed by First Trust Advisors)</td></tr>
<tr><th>Index tracked</th><td>S&P 500</td></tr>
<tr><th>Strategy</th><td>Broad equity exposure with annual loss buffer</td></tr>
<tr><th>Buffer mechanism</th><td>Options overlay (put spreads and call sales)</td></tr>
<tr><th>Annual downside limit</th><td>~13% maximum loss</td></tr>
<tr><th>Structure</th><td>Plain vanilla ETF</td></tr>
<tr><th>Expense ratio</th><td>Approximately 0.85% annually</td></tr>
</table>
</aside>
...
From launch, BUFR has held a conceptually simple but mechanically sophisticated hedge: the fund owns (or holds proxies for) the 500 stocks in the S&P 500, and it overlays [put options](/put-option/) — the right to sell at a predetermined floor price — financed by selling [call options](/call-option/) that cap the upside. The ladder structure means multiple strikes and [expiration dates](/expiration-contracts/) are layered, so there is not one single cap or floor but a range, and it resets annually.

The mechanism has remained stable for over a decade, though the precise cap and floor shift each year based on volatility and prevailing [interest rates](/interest-rate/). In a calm year, puts are cheaper to buy (because [implied volatility](/implied-volatility/) is low), so the fund can offer a tighter cap to make returns more competitive. In a turbulent year, the cap may widen because the hedging cost is higher. This is not a bug — it is the mechanism working as designed.
...
BUFR is also not a hedge you layer on top of an existing S&P 500 position. You substitute it for your regular [index fund](/index-fund/), not in addition to it. And unlike some hedging tools, it is not designed to roll or rebalance daily — the annual reset is built in.
...
A second risk is opportunity cost in a strong [bull market](/bull-market/) lasting multiple years. If the S&P 500 rises 25% per year on average for five years, BUFR will have trailed it by roughly the cumulative cost of the overlay — meaningful real dollars. Investors often regret that trade, even when they were warned.
...
Start with the fund's prospectus and the most recent [annual report](/10-k/), which explain the options mechanics in legal language and disclose the current year's exact cap, floor, and reset date. The fund factsheet and performance history will show how BUFR has behaved relative to the S&P 500 in rising and falling markets. Morningstar and other fund research sites provide rolling returns, volatility measures, and realized [expense ratios](/expense-ratio/). Most importantly, think honestly about your own behaviour: if a 20% market fall would cause you to sell in a panic, then the cost of BUFR is likely worth it; if you have endured crashes calmly in the past, the hedging may be a regrettable drag on long-term wealth.
