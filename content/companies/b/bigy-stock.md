---
title: "YieldMax Target 12 Big 50 Option Income ETF (BIGY)"
description: "An options-based ETF that systematically sells call options on the 50 largest US companies to generate monthly income while holding the underlying stocks."
keywords:
  - option income
  - covered calls
  - yield enhancement
...
*The **YieldMax Target 12 Big 50 Option [Income ETF](/income-etf/)** (ticker BIGY) is a specialized exchange-traded fund that invests in the fifty largest US companies but uses a options-selling strategy to amplify income. Each month, the fund sells [call options](/call-option/) on these stocks — a practice known as covered-call writing — and keeps the premium income. The tradeoff is that if the stock price rises sharply, the shares may be called away, capping gains.*

## The mechanics: how covered calls work

BIGY holds a portfolio of the fifty biggest US companies by [market capitalization](/market-capitalization/) — the kind of mega-cap stocks in the S&P 500 that make up the core of many portfolios. But instead of holding them passively and collecting [dividends](/dividend/), the fund actively sells one-month call options against those positions.

A call option gives someone the right to buy the stock at a predetermined [strike price](/strike-price/). When BIGY sells a call, it collects an immediate premium from the buyer. That premium represents income. If the stock price stays below the strike at month end, the option expires worthless, the premium is pocketed, and the fund sells a new call the following month. If the price rises above the strike, the option is exercised, the stock is sold at the strike price, and the shares are called away — the fund loses the chance to participate in further gains above that level.
...
The fund's target is to generate a distribution yield around 12% per year through [option premiums](/option-premium/), paid monthly. That 12% target is far higher than the underlying stocks' [dividend yield](/dividend-yield/) alone, so it is the option premium that supplies the bulk of the income.
...
Conversely, in strong [bull markets](/bull-market/), [covered calls](/covered-call/) underperform. The fund is forced to surrender gains above the strike price, and its upside is capped. So the strategy works best when investors expect modest returns or higher volatility, not explosive rallies.
...
[Concentration risk](/concentration-risk/) is also worth noting. The fifty largest companies are fewer and more homogeneous than a total-market index. As of recent data, the largest five stocks make up a huge chunk of the top-fifty market cap. If those mega-caps falter, the fund falters more than a broader index would.

Volatility decay affects any fund that sells short-term options repeatedly. When the market is calm, [implied volatility](/implied-volatility/) falls, and option premiums shrink. A covered-call fund thrives on volatility; calm markets mean lower premium income, and thus lower distributions.

Finally, there is [reinvestment risk](/reinvestment-risk/) if you use the monthly distributions. If you deploy that income elsewhere and the fund's share price falls the next month, you have locked in the loss while spending the income — a common mistake for inexperienced income investors.

## Who BIGY suits

BIGY is designed for investors who want income from equities, expect modest returns or higher volatility, and are willing to cap their upside for higher [current yield](/current-yield/). It can also serve as a hedge within a diversified portfolio — the high income stream provides some return even if stock prices stagnate or decline moderately.
