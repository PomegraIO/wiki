---
title: "Innovator U.S. Equity Buffer ETF - February (BFEB)"
description: "An ETF that caps downside losses in exchange for capped upside, using options strategies to provide a defined floor and ceiling on monthly returns."
keywords:
  - buffer etf
  - downside protection
  - options collar
...
Liquidity on BFEB itself is a consideration; the trading volume and [bid-ask spreads](/bid-ask-spread/) should be checked before buying a large position. As an Innovator product, the fund benefits from the sponsor's size and operational track record, but smaller buffer ETFs sometimes trade with meaningful spreads.
