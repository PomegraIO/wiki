---
title: "Invesco BulletShares 2028 Municipal Bond ETF (BSMS)"
description: "BSMS is a municipal bond ETF targeting maturity in 2028, holding tax-exempt debt from states and municipalities with a structured decline toward wind-down."
keywords:
  - municipal bonds
  - tax-exempt income
  - bullet bond fund
...
*BSMS owns [municipal bonds](/municipal-bond/) scheduled to mature around 2028, providing tax-exempt income monthly while the fund naturally expires as its [bonds](/bond/) reach their payoff date.*
...
BSMS charges a low [expense ratio](/expense-ratio/), well below 0.20 percent annually, typical of the Invesco BulletShares suite. This is competitive with other municipal [bond ETFs](/bond-etf/) and far lower than active management of a similar portfolio would cost. The fund trades on a [stock exchange](/stock-exchange/), so shares can be bought or sold any business day during market hours. [Bid-ask spreads](/bid-ask-spread/) are typically tight — often less than 0.01 percent — because the fund is reasonably popular and liquid.

## Risks unique to munis and maturity-bound funds

The central risk is [credit risk](/credit-risk/): an issuer could default, fail to pay interest, or struggle to repay principal on time. This is less common in municipal bonds than in corporate bonds — municipalities have taxing power and decades of track records — but it happens. If a major issuer in BSMS's portfolio faces financial stress or defaults, the fund's value drops.

[Concentration risk](/concentration-risk/) appears if the portfolio is overweight a particular state or region. A state budget crisis, a regional [recession](/recession/), or a drop in real-estate values in a key jurisdiction can pressure returns. BSMS's [diversification](/diversification/) across states and issuers reduces this, but does not eliminate it.

[Interest-rate risk](/interest-rate-risk/) is real. If rates rise after you buy BSMS, the prices of existing bonds fall, because new bonds will pay higher coupons. If you need to sell shares before 2028, you may realize a loss. If rates fall, you gain. This risk is strongest early in the fund's life and weakens as the maturity date approaches — the bonds inexorably move toward [par value](/par-value/).

Finally, there is reinvestment risk: the risk that in 2028, when your money comes back, [interest rates](/interest-rate/) are lower and your reinvestment options are less attractive than they are today. You have no control over this, and it is one reason to diversify across multiple maturity dates rather than betting everything on a single year.
