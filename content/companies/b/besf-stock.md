---
title: "Bastion Energy ETF (BESF)"
description: "An exchange-traded fund providing diversified exposure to global energy companies, from oil and gas producers to renewables and infrastructure."
keywords:
  - energy sector
  - oil and gas
  - renewable energy
...
<div class="wiki-infobox-title">Bastion Energy ETF — key facts</div>

<img src="https://images.unsplash.com/photo-1473341304170-971dccb5ac1d?w=600&q=80" alt="Oil pumpjacks extracting crude from fields at sunset." />

<div class="wiki-infobox-caption">The energy sector spans extraction, transportation, and generation across fossil fuels and renewables.</div>

|   |   |
|---|---|
| **What it tracks** | Global energy company stocks and infrastructure |
| **Sponsor** | Bastion Capital or affiliated issuer |
| **Fund structure** | Standard ETF, no leverage |
| **Typical holdings** | Oil majors, integrated energy, renewable generators, utilities |
| **Expense ratio** | Low, in the range typical for broad sector ETFs |
| **Liquidity** | High; trades with tight spreads |
| **Distribution** | Quarterly or annual, from company dividends and distributions |
