---
title: "Brookstone Dividend Stock ETF (BAMD)"
description: "A dividend-focused ETF investing in large-cap stocks with a history of paying and raising cash dividends to shareholders, prioritising current income alongside capital appreciation."
keywords:
  - dividend stocks
  - dividend growth
  - large-cap dividends
...
Most dividend ETFs follow one of two approaches: they either screen for a minimum dividend yield (paying out at least, say, 1 percent) and weight equally, or they overweight high-yielding stocks. BAMD's exact methodology is spelled out in the prospectus, but the principle is the same: hold a concentrated portfolio of large-cap dividend payers and orient the weights toward the highest income available.

The trade-off of this approach is concentration. By focusing on high-yielding stocks, BAMD likely skews toward mature, slower-growing companies — those that can afford to pay out large percentages of earnings as dividends. It does not hold the growth megacaps that pay little or no dividend. This means BAMD will outperform a broad index in slow periods when yield is prized, but it may lag in booming periods when growth is king.
...
The dividend-paying universe has shifted dramatically over time. In the 1980s and 1990s, almost every large company paid a dividend. Starting in the 2000s, many growth companies stopped paying out and preferred buybacks instead. This made dividend funds like BAMD skew even more heavily toward old-economy, slow-growth sectors. A company that dropped its dividend decades ago would never enter BAMD's portfolio, but if it still paid dividends, it likely means it is mature and cautious rather than high-growth.

Conversely, as the growth mega-caps have matured and begun returning cash, some now pay dividends again. A highly successful company with stable cash flow might begin a modest dividend while still growing. BAMD's holdings reflect this evolution, so the fund evolves too.

## Who BAMD is for and isn't
...
Start with Brookstone's prospectus and fact sheet. What is the current dividend yield? How does it compare to a broad market index? What is the expense ratio? Are the holdings recognisable blue-chip names, or has the fund drifted into lower-quality payers?

Look at the sector breakdown: what percentage is in utilities, financials, consumer staples, etc.? If one sector dominates, understand you are making a concentrated bet, not buying a neutral dividend fund.
