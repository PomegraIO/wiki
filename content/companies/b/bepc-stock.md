...
description: "Brookfield Renewable operates one of the world's largest portfolios of renewable hydropower, wind, and solar assets, generating electricity and storage capacity across six continents."
keywords:
  - renewable energy
  - hydropower
  - wind power
...
Brookfield Renewable today has a strategy of organic growth—building new renewable projects at competitive costs—and selective acquisitions of existing plants. The company benefits from a tailwind: electricity demand is growing, governments are phasing out coal and [natural gas](/natural-gas/) plants, and corporate customers are increasingly signing long-term renewable-energy contracts to meet their own climate commitments. That demand translates to new power-purchase agreements, which the company converts into new projects.
...
Key metrics to track: capacity utilization by asset type (hydropower, wind, solar), the average contract length and inflation-escalation terms in the portfolio, [debt-to-equity ratio](/debt-to-equity-ratio/) (important given the capital-intensive business), and [return on equity](/return-on-equity/) (a measure of how efficiently the company deploys capital). The pace of new contract wins and acquisition pipeline signals future growth.
