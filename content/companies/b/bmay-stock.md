---
title: "Innovator U.S. Equity Buffer ETF – May (BMAY)"
description: "An actively managed ETF that provides downside protection on U.S. stocks via monthly options collars, with the May series targeting a specific buffer and cap structure."
keywords:
  - buffer ETF
  - downside protection
  - collar strategy
...
Each month, the May fund's manager constructs an options collar tied to the S&P 500. The collar consists of two sides. On the downside, the fund buys [put options](/put-option/) at a strike below the current index level; this put creates a floor, protecting shareholders against losses beyond that strike (the "buffer"). On the upside, the fund sells [call options](/call-option/), surrendering gains beyond a cap level in exchange for the premium that helps pay for the puts.
