...
Key items to monitor in earnings calls and updates: What is happening to feedstock pricing and Braskem's cost position relative to competitors? Are large customers signing new contracts, and at what margin levels? Is the company's debt level sustainable at current profitability levels, or is [refinancing risk](/refinancing-risk/) rising? Any signs of M&A activity or capacity expansions signal management confidence or desperation depending on the cycle. Currency swings matter too — Braskem reports in [US dollars](/us-dollar/) but earns much of its cash in Brazilian reais, so a weakening Brazilian currency is a headwind that must be hedged. 
