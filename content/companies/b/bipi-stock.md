---
title: "Brookfield Infrastructure Partners L.P. (BIPI)"
description: "A publicly traded partnership owning and operating critical infrastructure globally, competing for long-term cash flows against institutional investors, governments, and other infrastructure funds."
keywords:
  - infrastructure
  - toll roads
...
[Brookfield Infrastructure Partners](/bip-stock/) is fundamentally a competition for control of assets that matter. The company competes not by building better products or offering superior service, but by outbidding and out-executing other investors for ownership of toll roads, power lines, pipelines, ports, and data centres. Understanding how Brookfield wins and loses these competitions reveals both the durability and the fragility of the business model.

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>BIPI (NYSE)</td></tr>
<tr><th>Core function</th><td>Acquire and operate long-life infrastructure assets</td></tr>
<tr><th>Primary assets</th><td>Toll roads, transmission lines, pipelines, ports, data centres</td></tr>
<tr><th>Geographic reach</th><td>North America, South America, Europe, Australia, Asia</td></tr>
<tr><th>Investor base</th><td>Pension funds, endowments, insurance companies, retail investors</td></tr>
<tr><th>Main competitors</th><td>Pension funds, private equity, other infrastructure partnerships</td></tr>
<tr><th>Revenue source</th><td>User fees and regulated returns on asset operations</td></tr>
...
But regulatory protection cuts both ways. The same government that prevents competition can also change the rules. Political pressure to freeze toll rates during [recessions](/recession/), to impose environmental requirements that increase costs, or to alter profit-sharing arrangements can erode the economics of an asset.
...
Brookfield operates across six continents, which diversifies away from any single country's economic cycle. But it also exposes the partnership to political and [currency risk](/currency-risk/). A decision by a government to cap returns in the name of protecting citizens, or to seize assets without fair compensation, would directly impair unitholder value.
