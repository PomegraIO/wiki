---
title: "Invesco BulletShares 2030 Corporate Bond ETF (BSCU)"
description: "An exchange-traded fund holding investment-grade corporate bonds maturing in 2030, structured to return principal at a predictable date with current income."
keywords:
  - corporate bonds
  - maturity date
  - ETF
...
Over its tenure, BSCU has tracked market [interest rates](/interest-rate/) and credit conditions. When the [Federal Reserve](/federal-reserve/) has raised rates sharply, bond prices have fallen, and BSCU's [net asset value](/net-asset-value/) has declined because its underlying bonds are worth less. When rates have eased, bond prices have risen, and the fund's value has appreciated. These swings happen routinely in the bond market and are reflected in the fund's share price. Yet the structural constraint is consistent: the fund is always moving toward 2030.

## Current composition and mechanics

BSCU holds investment-grade [corporate bonds](/corporate-bond/) rated BBB− or better, tracking the Invesco BulletShares 2030 Corporate Bond Index. The portfolio spans 200 to 500 individual securities across economic sectors: financial institutions, industrials, energy, consumer goods, utilities, healthcare, materials. The fund distributes income to shareholders as it receives [coupon payments](/coupon-payment/) from its underlying bonds. It also experiences capital appreciation or loss as interest rates fluctuate.

The defining feature is the maturity window. All holdings mature in a range around 2030, not scattered across decades. This creates a concentrated [bond ladder](/bond-ladder/). As 2030 approaches, the fund's portfolio tilts more and more toward bonds in their final months or years, making the fund safer and less volatile but also less generous in yield.
...
This creates two consequences. First, a bond investor in BSCU experiences less portfolio turbulence than one in a [perpetual bond](/perpetual-bond/) fund, a tangible benefit for risk-averse investors. Second, BSCU yields less income than longer-dated bond funds, because shorter-duration bonds offer lower [coupon rates](/coupon-rate/). The fund trades yield for certainty: lower income now in exchange for predictable principal return later.
