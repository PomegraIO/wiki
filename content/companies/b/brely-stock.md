---
title: "Brazilian Rare Earths Limited (BRELY)"
description: "Brazilian Rare Earths Limited is an ADR representing a mining and processing company focused on rare-earth elements and minerals from Brazilian sources."
keywords: ["rare earths", "mining", "mineral processing", "Brazil", "supply chain", "strategic minerals"]
---

*__Brazilian Rare Earths Limited (BRELY)__ sits upstream in the rare-earth supply chain, extracting and processing ore from Brazilian deposits into concentrates and refined elements that industrial consumers and downstream processors depend upon. The company is positioned between mining operations and the manufacturers of magnets, batteries, electronics, and defense systems that demand a stable supply of rare-earth materials.*

<aside class="wiki-infobox"><table>
<tr><td>Ticker</td><td>BRELY</td></tr>
<tr><td>Listing</td><td>OTC Markets</td></tr>
<tr><td>SEC CIK</td><td>2018463</td></tr>
<tr><td>Sector</td><td>Materials</td></tr>
<tr><td>Industry</td><td>Mining & Minerals</td></tr>
...
The company files financial statements and operational disclosures with the [Securities and Exchange Commission](/securities-and-exchange-commission/) via its [10-K](/10-k/) reports, providing transparency on reserve estimates, production costs, customer concentration, and regulatory risks.

<div class="wiki-seealso">
### Closely related
- [Enterprise value](/enterprise-value/) (mining companies valued on reserves and production multiples)
- [Free cash flow](/free-cash-flow/) (capital intensity and commodity pricing)
- [Return on equity](/return-on-equity/) (long project payback periods)
