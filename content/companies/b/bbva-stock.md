---
title: "Banco Bilbao Vizcaya Argentaria, S.A. (BBVA)"
description: "BBVA is Spain's second-largest bank by assets, a European retail and commercial lender with deep operations across Spain, Mexico, South America, and Turkey — a globally dispersed regional franchisee playing defense in mature Western markets while hunting growth in emerging economies."
keywords:
  - spanish bank
  - european banking
  - emerging markets
...
BBVA is well-capitalized by regulatory standards, with a strong [Tier 1 capital](/tier-1-capital/) ratio and regular stress-test passes from the ECB. The bank has returned capital to shareholders through [dividends](/dividend/) (often paid quarterly) and occasional [share buybacks](/share-buyback/) when the stock has traded below management's view of [intrinsic value](/intrinsic-value/). Payouts have been cyclical — stronger in the aftermath of crises when the bank wanted to rebuild confidence, lower during downturns when capital needed to be preserved.
...
BBVA faces several structural challenges. The first is regulatory compression: European banking regulations (Dodd-Frank equivalent, capital requirements, stress tests, conduct rules) have tightened substantially over the past decade, raising the cost of capital and suppressing [return on equity](/return-on-equity/) for all large banks. BBVA, as a medium-sized European lender, feels those constraints acutely.

The second is macro sensitivity. A meaningful share of BBVA's profit comes from Mexico, Peru, and Colombia — economies subject to currency fluctuations, [political risk](/political-risk/), [inflation](/inflation/) spikes, and the occasional financial crisis. A sharp Mexican peso [depreciation](/depreciation/), or a recession in Peru, or a geopolitical shock in Turkey can significantly reduce consolidated earnings. This is the flip side of the emerging-market bet: upside comes with downside.
...
Anyone studying BBVA should begin with the annual 10-F filing filed with the U.S. [Securities and Exchange Commission](/securities-and-exchange-commission/) (CIK 0000842180), which details revenue by segment and geography and summarizes the bank's risk profile. BBVA files in English; it also publishes audited results in Spanish. Quarterly earnings calls, held in both languages, offer management commentary on credit trends, deposit flows, and the macro outlook for the company's key markets.
