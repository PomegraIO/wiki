...
This local underwriting is both a strength and a risk. BKSC can make loans that national banks' algorithms might reject, because the relationship banker knows the borrower personally and understands the local business environment. Conversely, BKSC's portfolio is not diversified across geographies; all its borrowers face the same regional economic cycles. A [recession](/recession/) in South Carolina affects every borrower on BKSC's books simultaneously. A diversified national bank spreads this risk across 50 states and multiple industries. BKSC cannot.
