---
title: "Roundhill BRKB WeeklyPay ETF (BRKW)"
description: "An options income fund that holds Berkshire Hathaway Class B shares and writes weekly call options to provide high-frequency income distributions."
keywords:
  - Berkshire Hathaway
  - weekly options
  - income strategy
...
BRKW is an exchange-traded fund that combines ownership of [Berkshire Hathaway](/brk-b-stock/) Class B shares with a systematic program of writing weekly [call options](/call-option/). The "WeeklyPay" branding reflects the fund's core proposition: instead of the monthly or quarterly [dividend](/dividend/) cycles typical of most equity funds, BRKW aims to distribute income every week. The strategy attempts to capture premium revenue from options trading rolled over on a short cycle, with the understanding that shareholders are trading the possibility of unlimited capital appreciation for regular, predictable distributions.
...
BRKW requires active management to execute the weekly option strategy. The fund charges an [expense ratio](/expense-ratio/) to cover portfolio management, option-writing execution, and administration. That fee is typically higher than the cost of holding Berkshire through a passive fund, and lower than some other actively managed strategies, though the precise number should be verified in the prospectus.
