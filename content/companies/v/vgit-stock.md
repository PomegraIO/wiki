---
title: "Vanguard Intermediate-Term Treasury ETF (VGIT)"
description: "A US government bond fund focused on Treasury securities with 3–10 years to maturity, designed to provide stable income with lower default risk than corporate bonds."
keywords:
  - Treasury bonds
  - government bonds
  - bond ETF
...
*A [Treasury bond](/treasury-bond/) is debt issued by the US government. When investors lend to Washington by buying Treasuries, they get interest payments and the certainty that the US government, with its tax authority and currency-printing powers, will repay. A Treasury fund lets you own a diversified portfolio of these [bonds](/bond/) across different maturities. The Vanguard Intermediate-Term Treasury ETF holds bonds in the sweet spot — not short-term, where yields are minimal, and not decades-long, where price swings are severe.*

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>VGIT (NASDAQ)</td></tr>
<tr><th>Sponsor</th><td>Vanguard Group</td></tr>
<tr><th>Fund type</th><td>Index ETF</td></tr>
<tr><th>Underlying index</th><td>Bloomberg U.S. 3–10 Year Treasury Index</td></tr>
<tr><th>Average maturity</th><td>5–7 years (typical range)</td></tr>
<tr><th>Average duration</th><td>6–7 years</td></tr>
<tr><th>Credit risk</th><td>Minimal (US government)</td></tr>
<tr><th>Primary holder type</th><td>Conservative investors, fixed-income allocations</td></tr>
</table>
</aside>
...
The fund's [expense ratio](/expense-ratio/) is minimal. Vanguard is known for low-cost [index funds](/index-fund/), and Treasury funds are among the cheapest to operate because there are no stock-picking costs — you just hold the index. The yield (interest paid out) varies with the overall Treasury [yield curve](/yield-curve/); when rates are high, the distribution is high, and vice versa.
...
[Interest-rate risk](/interest-rate-risk/) is the real risk. If you buy VGIT and rates rise significantly over the next year or two, the fund's value falls. If you need to sell before maturity, you lock in a loss. But if you hold it to maturity or stay invested through the cycle, you earn your promised [coupon rate](/coupon-rate/) regardless of what happened to prices in between.

[Inflation risk](/inflation-risk/) is structural. If unexpected [inflation](/inflation/) accelerates, the fixed [coupon payments](/coupon-payment/) the Treasuries pay are worth less in real (inflation-adjusted) terms. Treasuries are not a hedge against inflation; they are a hedge against economic downturns, when yields tend to fall and bond prices rise.
