---
title: "Vanguard International Dividend Appreciation ETF (VIGI)"
description: "An exchange-traded fund holding companies outside the U.S. that have increased dividend payments consistently, combining developed and emerging markets with dividend-growth screening."
keywords:
  - dividend growth
...
VIGI tracks an index of dividend-growth stocks outside the United States. The index is maintained by an outside provider and vetted for quality: eligible companies must have raised dividends for at least ten consecutive years and must meet screens for profitability and balance-sheet health. The fund is rebalanced regularly to maintain consistency with the underlying index. Vanguard's [expense ratio](/expense-ratio/) is around 40 basis points annually — reasonable for an active-indexed strategy in a global universe that includes less-liquid emerging-market names.

The fund trades on a U.S. exchange ([NASDAQ](/nasdaq/)) and settles in dollars, so a U.S. resident investor does not have to manage foreign-exchange transactions directly. The fund handles [currency hedging](/currency-hedging/) implicitly — exposures to the yen, euro, and others remain unhedged, so dollar weakness or strength will affect returns alongside the stock performance of the companies held.
