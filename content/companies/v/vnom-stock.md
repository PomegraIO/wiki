---
title: "Viper Energy, Inc. (VNOM)"
description: "Viper Energy is an independent oil and natural gas company exploring for and producing crude oil, natural gas, and natural gas liquids primarily in the Permian Basin of West Texas and New Mexico."
keywords:
...
<table>
<tr><th>Ticker</th><td>VNOM (NASDAQ)</td></tr>
<tr><th>Founded</th><td>2014</td></tr>
<tr><th>Headquarters</th><td>Stamford, Connecticut</td></tr>
<tr><th>Sector</th><td>Oil and natural gas exploration and production</td></tr>
<tr><th>Primary operations</th><td>Permian Basin (Texas and New Mexico)</td></tr>
<tr><th>Business model</th><td>Mineral interest ownership and royalty collection</td></tr>
<tr><th>Products</th><td>Crude oil, natural gas, natural gas liquids</td></tr>
<tr><th>SEC CIK</th><td>0002074176</td></tr>
</table>
</aside>
...
## The Permian Basin and Viper's position
...
Viper's revenue is directly proportional to two things: the volume of oil and gas produced from land where Viper owns royalties, and the price of that oil and gas at the time of production. Both are highly volatile.

Volume depends on how aggressively operators drill and produce. When energy prices are high and profitable, operators drill extensively. When prices are low, they curtail activity. Viper benefits from high drilling activity but has limited influence over that activity since operators, not Viper, make drilling decisions.
...
Viper owns interests in multiple properties across the Permian. The company does not disclose all details of its mineral holdings, but they include acreage where major operators like Pioneer Natural Resources, Devon Energy, and others hold leases and drill wells. By owning mineral interests on productive acreage where major operators work, Viper receives royalties from high-volume production.

The company's business is largely passive on an operational basis, but it is not entirely hands-off. Viper monitors the wells drilled, tracks production reports, ensures accurate royalty calculations, and manages the administrative side of collecting revenues. A dedicated team at Viper handles this work.
...
The primary risk is **commodity price volatility**. Viper has no control over oil and gas prices, so it is fundamentally exposed to energy markets. A significant drop in oil or gas prices directly reduces profitability.

**Operational risk** — the risk that wells underperform or are shut in for maintenance or safety — is borne partly by the operator but affects Viper's royalty income.
...
Viper and other oil and gas producers face a long-term structural question: as the world transitions toward renewable energy and electrification, will demand for oil and gas persist at current levels, decline gradually, or decline sharply? This is highly uncertain and depends on policy, technological progress, economic growth, and consumer behavior. Investors with long time horizons must factor this into their assessment of Viper's durability as a business.

## How to research Viper Energy as an investment
