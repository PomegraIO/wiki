---
title: "VISTEON CORP (VC)"
description: "Global automotive supplier specialized in digital cockpit electronics and software platforms for vehicle infotainment, driver assistance, and connectivity."
keywords:
  - automotive supplier
  - cockpit electronics
  - vehicle software
...
Visteon operates with relatively thin [operating margins](/operating-margin/), typical for automotive suppliers—usually in the single digits to low double digits. Capital intensity is moderate: manufacturing requires tooling and assembly lines, but the company has reduced its footprint through [divestitures](/divestiture/). [Free cash flow](/free-cash-flow/) matters more than raw profit; the company must reinvest constantly in next-generation platforms while honoring customer contracts with improving costs.
...
- **Listed on**: [NASDAQ](/nasdaq/) (ticker VC)
- **SEC filing**: [10-K](/wiki/10-k/) filed annually; CIK 1111335
