---
title: "Vir Biotechnology (VIR)"
description: "A clinical-stage immunology company developing antibody and T-cell-engager therapies for infectious diseases and oncology, focused on high-barrier-to-entry viral targets and tumor-associated antigens."
keywords:
...
**Vir Biotechnology is a privately funded immunology company building antibody and T-cell-engager therapeutics against infectious diseases and, increasingly, oncology targets.** The company was founded in 2016 with the thesis that monoclonal antibodies and engineered immune-cell therapies could address viral infections and cancers where conventional treatments were limited or absent. Unlike large pharmaceutical firms, Vir operates as a lean clinical-stage developer, outsourcing manufacturing and focusing internal effort on biology, assay development, and clinical strategy. The stock trades on [NASDAQ](/nasdaq/) under ticker VIR (CIK 1706431), and the business model depends entirely on clinical execution and investor capital allocation over the next three to five years, with no meaningful revenue from approved products yet in place.
...
Investors need to scrutinize Vir's latest [10-K filing](/wiki/10-k/) (CIK 1706431) to understand burn rate, cash on hand, and the timeline for cash sufficiency. Quarterly [cash flow statements](/cash-flow-statement/) reveal whether the company is approaching a need to raise capital soon. Milestone revenue from partnership agreements provides visibility into near-term inflows, but these are non-recurring and should not be confused with product revenue.
...
For anyone tracking Vir, the essential documents are the quarterly [10-K](/wiki/10-k/) and 10-Q filings. Key metrics to monitor include:
...
- **Partnership revenue:** Milestone and royalty deals with larger partners de-risk the [balance sheet](/balance-sheet/); track their terms and likelihood of being achieved.
