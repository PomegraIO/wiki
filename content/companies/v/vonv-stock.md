---
title: "Vanguard Russell 1000 Value ETF (VONV)"
description: "An exchange-traded fund tracking the Russell 1000 Value index — large-cap U.S. stocks selected for value characteristics. Low-cost core holding for value investing."
keywords:
  - value investing
  - Russell 1000 Value
  - large-cap stocks
...
Value stocks are disproportionately represented in sectors such as financials, industrials, energy, and consumer staples — areas where mature, profitable companies trade at modest valuations. Growth stocks, by contrast, cluster in technology, healthcare, and communications services. Because the Russell 1000 Value index is a filtered subset of the 1,000 largest companies, VONV holds no small-cap or micro-cap stocks; all positions are among the nation's largest corporations. This systematic exclusion of smaller companies and tech-heavy growth names is a core differentiator from broader alternatives.
...
VONV suits long-term investors who believe value stocks offer a meaningful return advantage over time and who are willing to endure periods of underperformance relative to growth-oriented peers. It is a core holding appropriate for the equity portion of a diversified portfolio, particularly within retirement accounts where the quarterly dividends are not subject to immediate tax. Because it is relatively concentrated in certain sectors and styles, combining it with a broad fund or a growth-oriented fund is more prudent than holding it alone.

Investors researching VONV should start with the fund's prospectus and fact sheet on Vanguard's website, which detail the exact index methodology, current holdings, and the annual turnover rate. The Russell 1000 Value index methodology — published freely by FTSE Russell, which maintains the indices — explains the classification system used to assign growth or value status. Comparing VONV's performance to similar funds like the iShares Russell 1000 Value ETF (IVE) or Vanguard's own value-focused Admiral Shares fund shows how expense ratios and minor implementation differences play out over time.
