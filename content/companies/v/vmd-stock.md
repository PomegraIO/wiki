---
title: "Viemed Healthcare (VMD)"
description: "A provider of in-home respiratory care and durable medical equipment services, specializing in non-invasive ventilation for severe COPD and other chronic respiratory conditions, primarily reimbursed through Medicare."
keywords:
...
<table>
<tr><th>Ticker</th><td>VMD (NASDAQ)</td></tr>
<tr><th>Sector</th><td>Healthcare services / durable medical equipment</td></tr>
<tr><th>Focus</th><td>In-home respiratory care, non-invasive ventilation, DME</td></tr>
<tr><th>Primary payer</th><td>Medicare (majority of revenue)</td></tr>
<tr><th>SEC CIK</th><td>1729149</td></tr>
<tr><th>Business model</th><td>Equipment supply, patient monitoring, service contracts</td></tr>
</table>
</aside>
...
Start with the company's annual [10-K](/wiki/10-k/) filing (SEC CIK 1729149), which details revenue by service line, geographic mix, Medicare versus other payers, and the sensitivity of the business to changes in reimbursement rates. The quarterly earnings calls are where management discusses patient census trends, pricing changes, and any shifts in referral patterns. Watch for commentary on Medicare rate changes, state regulatory actions, and the company's acquisition strategy or partnerships with larger healthcare systems.

Key metrics to track include the patient census (total patients on managed equipment), average revenue per patient, gross margins by service line, and the spread between acquisition cost and lifetime patient value. Because the business is highly dependent on Medicare, any changes to the [Centers for Medicare and Medicaid Services](/wiki/centers-for-medicare-and-medicaid-services/) fee schedules or compliance documentation should be part of any investor thesis. Viemed's shares trade on [NASDAQ](/nasdaq/), and as with any healthcare services company, the business is as much about reimbursement policy as it is about clinical or operational execution.
