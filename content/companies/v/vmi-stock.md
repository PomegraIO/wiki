---
title: "Valmont Industries (VMI)"
description: "A diversified manufacturer of engineered infrastructure products for utility and transportation, and the world's largest producer of mechanized center-pivot irrigation systems for agriculture."
keywords:
...
Valmont Industries is a [public company](/wiki/public-company/) that operates in two broad worlds: engineered infrastructure and agriculture. The infrastructure side sells utility structures, lighting and transportation products, and telecom towers—the metal poles and frameworks that support power lines, traffic signals, and communications networks. The agriculture business manufactures and sells mechanized center-pivot irrigation systems, primarily under the Valley brand, which are the long rotating booms you see crossing American farmland, spraying water in circular patterns.
