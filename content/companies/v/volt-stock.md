---
title: "Tema Electrification ETF (VOLT)"
description: "VOLT is an actively managed ETF holding companies building and powering the switch to electric vehicles and renewable energy — utilities, auto suppliers, charging infrastructure, battery makers, and grid modernisation firms globally."
keywords:
  - electrification
  - electric vehicles
  - renewable energy
...
*The **Tema Electrification ETF** (NYSEARCA: VOLT) bets on a long-term shift in how the world powers itself. It holds companies making electric vehicles, building charging networks, manufacturing batteries, managing the electrical grid, and generating renewable power. It's an [actively managed fund](/actively-managed-fund/) — a professional stock picker choosing individual companies rather than tracking an index — designed for investors who think electrification is not just a trend but the backbone of the next decades.*

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>VOLT (NYSE Arca)</td></tr>
<tr><th>Issuer</th><td>Tema</th></tr>
<tr><th>Fund type</th><td>Actively managed ETF</th></tr>
<tr><th>Strategy</th><td>Global electrification theme</th></tr>
<tr><th>Primary holdings</th><td>Auto makers, suppliers, battery firms, utilities, charging infrastructure</th></tr>
<tr><th>Geographic scope</th><td>Global (US, Europe, Asia, emerging markets)</th></tr>
<tr><th>Typical holding count</th><td>40–60 companies</th></tr>
<tr><th>Expense ratio</th><td>Moderate (roughly 0.70% annually)</th></tr>
</table>
</aside>

## What VOLT does

VOLT is not an [index fund](/index-fund/). A team at Tema picks individual stocks they believe will benefit most from the global shift to electrified transport and clean power. That might sound simple, but the underlying theme is massive — it includes the obvious players ([Tesla](/tsla-stock/), major auto makers switching to batteries) alongside less obvious ones (companies making magnets for electric motors, firms upgrading electrical grids to handle more renewables, rare-earth-element miners, semiconductor companies powering EV systems, logistics firms electrifying delivery fleets).
