---
title: "Via Transportation (VIA)"
description: "Via Transportation provides cloud-based software and operational services for public transit agencies, enabling microtransit, paratransit, and route planning across 650+ cities globally."
keywords:
  - transit-tech
  - saas-transportation
...
Yet the market is not automatic. Transit agencies move slowly, procurement is complex and political, and there's genuine uncertainty about whether software alone can solve the underlying problem of underfunded public mobility. Some analysts argue that Via is not primarily a software company at all, but a transportation operator that happens to be re-branded in software language—more in the mold of a contractor than [Salesforce](/crm-stock/) or [Adobe](/adbe-stock/). The company's path to profitability remains contested; it is losing money, and aggressive growth has come at the cost of margin pressure.
...
Sources:
- [Via Transportation, Inc. Latest Stock News & Market Updates](https://www.stocktitan.net/news/VIA/)
- [Via Transportation (VIA) Stock Price & Overview](https://stockanalysis.com/stocks/via/)
- [Via - 2026 Company Profile, Team, Funding, Competitors & Financials - Tracxn](https://tracxn.com/d/companies/via/__uWA28hf4xS_-93FRIx__4akCNox6LKn3KFlCsnXnBtc)
- [Via Transportation - Wikipedia](https://en.wikipedia.org/wiki/Via_Transportation)
- [What is Software-as-a-Service (SaaS) for public transportation?](https://ridewithvia.com/resources/articles/what-is-software-as-a-service-saas-for-public-transportation/)
- [Citymapper acquired by Via - Crunchbase Acquisition Profile](https://www.crunchbase.com/acquisition/via-transportation-acquires-citymapper-limited--d10e87a5)
- [Via Transportation, Transit Tech Firm, Raises $493M in IPO](https://www.govtech.com/biz/via-transportation-transit-tech-firm-raises-493m-in-ipo)
