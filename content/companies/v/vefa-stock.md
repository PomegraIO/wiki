---
title: "VanEck MSCI EAFE Analyst Sentiment ETF (VEFA)"
description: "An international stock fund focused on developed markets outside the US, selected for strong analyst sentiment and buy ratings from financial analysts."
keywords:
...
The fund starts with the MSCI EAFE Index (Europe, Australasia, Far East), one of the standard benchmarks for developed markets outside the US. That index covers roughly two thousand companies across countries like Japan, the United Kingdom, France, Germany, Australia, Switzerland, and others. It is a market-cap-weighted index, meaning the largest companies (by [market capitalization](/market-capitalization/)) make up the largest portfolio weights, just as they do in the S&P 500 back home.
...
The premise is straightforward: when many professional analysts who follow a stock closely recommend buying it, and few recommend selling, that consensus often reflects real information about the company's prospects. Analyst reports come from [brokers](/broker/) and research shops that follow earnings calls, talk to management, and track the competition; their ratings carry real signals. Of course, analysts can be wrong, and herds can form around bad ideas (the [dot-com bubble](/dot-com-bubble/) had plenty of buy ratings on companies that later crashed). But over long periods, the stocks with strong analyst sentiment have tended to outperform, at least by a small margin.
...
VEFA is a simple ETF, not a leveraged or inverse product. Shares trade on an exchange during market hours, and the fund is liquid enough that you can buy and sell easily. The [expense ratio](/expense-ratio/) is moderate — higher than a plain EAFE [index fund](/index-fund/) but not unreasonable for an actively managed tilt. Because the fund is still based on an index (MSCI EAFE, not selected from scratch by a human manager), the fees are lower than a traditional active international fund would be.

The fund can hold a small cash position and will distribute any [dividends](/dividend/) paid by the holdings, typically quarterly or semi-annually. Those distributions are ordinary income for tax purposes. Like all equity funds, VEFA generates capital gains if the underlying stocks rise and the fund eventually sells them, so it is more tax-efficient inside a retirement account, though not dramatically so.
