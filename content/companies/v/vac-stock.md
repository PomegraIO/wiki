...
description: "A leading vacation ownership and exchange operator managing over 120 resorts under luxury timeshare and fractional ownership brands, with recurring revenue from Interval International's exchange network."
keywords:
  - timeshare
  - vacation ownership
...
| **Founded** | 1984 (as Marriott Ownership Resorts, Inc.) |
| **Separated** | November 2011 (spun from Marriott International) |
| **CIK** | 1524358 |
| **Headquarters** | North America |
| **Primary Business** | Vacation ownership (timeshare/fractional); exchange & third-party resort management |
| **Key Brands** | Marriott Vacation Club, The Ritz-Carlton Destination Club, Grand Residences by Marriott, Sheraton Vacation Club, Westin Vacation Club |
| **Major Asset** | Interval International (exchange network connecting 3,200+ affiliated resorts) |
| **Property Count** | 120+ resorts globally |
| **Owner Base** | 700,000+ vacation club members |
...
MVW's revenue model rests on three pillars. The largest is **vacation ownership sales**, driven by direct sales to consumers at resort presentations, via online channels, and through [broker](/broker/) networks. Sales volume is highly cyclical, sensitive to consumer confidence, credit availability, and travel appetite. The company finances many purchases directly, earning interest income in the low-to-mid teens (APR), reducing [credit risk](/credit-risk/) through recourse to the underlying inventory.

The second pillar is **recurring fees and management revenue**. Owners pay annual club dues, property [management fees](/management-fee/), and exchange memberships. This stream, which contributes roughly 40% of adjusted [EBITDA](/ebitda/), smooths earnings against sales volatility. **Rental income** from vacation inventory that owners do not use themselves adds incremental cash.
...
A hallmark of MVW's strategic evolution has been the shift toward recurring revenue. Sales-driven revenue is lumpy and sensitive to credit markets, consumer confidence, and [interest rates](/interest-rate/). By emphasizing points-based club structures, increasing annual membership and [property management fees](/property-management-fee/), and building Interval International's advisory and management services, the company has smoothed its earnings stream. Approximately 40% of adjusted EBITDA now comes from recurring sources—club dues, exchange fees, management contracts—that persist even if new vacation ownership sales decline sharply.

This [diversification](/diversification/) was tested during the 2008–2009 financial crisis and again during the COVID-19 pandemic. In both episodes, MVW's ability to collect annual fees from existing owners and to earn management revenue from affiliated resorts outside its portfolio helped sustain liquidity and profitability when new sales temporarily collapsed.

## Pressures and Risks

Interest rates are a critical sensitivity. Higher borrowing costs reduce consumer affordability for vacation ownership purchases (most buyers finance) and compress financing spreads on loans MVW originates. When the [Federal Reserve](/federal-reserve/) maintains a restrictive stance, new vacation ownership unit sales and gross margins both tend to fall. [Securitization](/securitization/) markets for vacation ownership loans can tighten during credit stress, limiting funding availability and raising capital costs.
...
To understand MVW's current condition and outlook, begin with the [10-K](/wiki/10-k/), which details vacation ownership sales volumes, financing performance, Interval International fee revenue, and management's commentary on consumer trends and competitive dynamics. Watch for quarter-to-quarter trends in tour volume, sales conversion rates, and average selling price. Segment data on Vacation Ownership versus Exchange & Third-Party Management margins illuminates the company's profit mix.

The [balance sheet](/balance-sheet/) is complex: MVW carries debt and borrows to finance consumer purchases, so analyzing [net debt](/net-debt/), [leverage ratios](/leverage-ratio-forex/), and securitization funding are essential. Equity analysts and investor relations presentations often highlight net cash generated from operations and [free cash flow](/free-cash-flow/), which can diverge materially from GAAP earnings due to financing activities and [deferred revenue](/deferred-revenue/) patterns.

Key metrics to monitor include: new vacation ownership sales volumes, average selling price per unit, cost of [acquisition](/acquisition/) per sale, Interval International revenue and member growth, and the proportion of revenue coming from recurring sources. In earnings calls, management commentary on international market expansion, the penetration of points-based products, and competitive market share shifts offers insight into medium-term strategy.
