...
MVW's revenue model rests on three pillars. The largest is **vacation ownership sales**, driven by direct sales to consumers at resort presentations, via online channels, and through broker networks. Sales volume is highly cyclical, sensitive to consumer confidence, credit availability, and travel appetite. The company finances many purchases directly, earning interest income in the low-to-mid teens (APR), reducing [credit risk](/credit-risk/) through recourse to the underlying inventory.
