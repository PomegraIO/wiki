---
title: "Dollar Tree Inc. (DLTR)"
description: "Dollar Tree is the discount retailer behind the Dollar Tree and Family Dollar banners, reaching low-income shoppers with everyday essentials and name-brand merchandise at fixed price points, operating a high-volume, lean-margin business built on efficient supply chains."
keywords:
  - discount retail
  - fixed-price retail
  - family dollar
...
<div class="wiki-infobox-title">Dollar Tree Inc. — key facts</div>
<table>
<tr><th>Ticker</th><td>DLTR (NASDAQ)</td></tr>
<tr><th>Founded</th><td>1986, Chesapeake, Virginia</td></tr>
<tr><th>Founder</th><td>Douglas Perry</td></tr>
<tr><th>Sector</th><td>Discount retail, variety stores</td></tr>
<tr><th>Store banners</th><td>Dollar Tree, Family Dollar</td></tr>
<tr><th>Primary customer</th><td>Lower-income, rural, and urban value shoppers</td></tr>
<tr><th>Business model</th><td>High-volume, fixed or near-fixed pricing, rapid inventory turnover</td></tr>
<tr><th>SEC CIK</th><td>0000935703</td></tr>
</table>
</aside>
...
Dollar Tree competes against a range of formats: other dollar-store chains like [Dollar General](/dg-stock/) (which operates a similar model at even lower absolute prices through aggressive sourcing), traditional discount retailers like [Walmart](/wmt-stock/) and [Target](/tgt-stock/) (which have their own budget-friendly store formats), and increasingly against online retailers and marketplaces. The competitive moat is not price alone — it is the convenience of proximity, the habit and loyalty of frequent visits, and the simple predictability of the format.
...
The 10-K filing (SEC CIK 0000935703) breaks out performance by banner and by geography and discloses the critical [cost drivers](/cost-driver/): freight, labor, shrinkage (loss to theft and damage), and the terms of major supplier relationships. Watch for trends in comparable store sales (same-store sales), which reveal whether foot traffic and spend per visit are holding up; gross-margin pressure, which indicates whether sourcing discipline is slipping; and commentary on store openings and closures, which show where management sees profitable locations. The quarterly earnings calls are where sourcing challenges and customer trade-down behavior surface most clearly. As the company navigates the aftermath of the dollar-to-$1.25 transition and faces sustained wage and logistics headwinds, the key question is whether the customer base will absorb further price increases without abandoning the format.
