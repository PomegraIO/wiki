...
Examine accounts receivable and the [allowance for doubtful accounts](/allowance-for-doubtful-accounts/): slow payment from customers or customer financial distress signals cash trouble ahead. Finally, read the debt agreements and covenant compliance: if Dominari is approaching [debt limits](/debt-limit/) or covenant thresholds, capex and hiring will be constrained.
