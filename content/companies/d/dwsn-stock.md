...
description: "Seismic-data acquisition company providing onshore geophysical services to oil and gas exploration and development companies."
...
<tr><td>SEC CIK</td><td>799165</td></tr>
<tr><td>Sector</td><td>Energy Services</td></tr>
<tr><td>Industry</td><td>Seismic Data Acquisition; Contract Geophysics</td></tr>
...
Seismic acquisition is capital-intensive. Vibroseis trucks, recording equipment, data-processing systems, and field vehicles represent substantial [fixed assets](/balance-sheet/). Historically, the company financed this equipment through a combination of [equity](/common-stock/) (public offerings), [debt](/corporate-bond/) (bank loans and equipment financing), and [retained earnings](/stock/). In downturns, when demand is weak, the company faces a painful choice: maintain capacity (hoping demand returns) or downsize (selling or retiring equipment, laying off crews) and face higher costs if demand rebounds rapidly.

The [balance sheet](/balance-sheet/) of a seismic-services company typically shows large [fixed assets](/balance-sheet/) (property, plant, equipment) and significant [depreciation](/stock/) expenses. [Working capital](/stock/) is another concern: surveys require upfront payment for crew, fuel, and permitting; the company may not invoice clients until work is complete, creating a cash-flow gap that must be financed.
...
### Closely related
- [Oil and gas exploration](/stock/) — Primary customer base
- [Contract services](/stock/) — Business model category
- [Seismic imaging](/stock/) — Core technology

### Wider context
- [Energy industry](/stock/) — Market context
- [Commodity cycles](/stock/) — Demand driver
- [Capital expenditure](/stock/) — Customer budget constraint
