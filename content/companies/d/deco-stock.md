---
title: "State Street Galaxy Digital Asset Ecosystem ETF (DECO)"
description: "An exchange-traded fund tracking companies involved in cryptocurrency and blockchain infrastructure, including exchanges, miners, custody providers, and software firms."
keywords:
  - cryptocurrency
  - blockchain
  - digital assets
...
DECO is a thematic equity fund betting on digital-asset infrastructure rather than the assets themselves. [State Street](/stt-stock/) built the index to capture the full ecosystem: exchanges, mining operations, custody firms, blockchain developers. It is tech-forward, concentrated, and tethered to the boom-and-bust pulse of cryptocurrency adoption.

## Index construction and holdings

The [Galaxy Digital](/glxy-stock/) Asset Ecosystem Index selects companies with material exposure to cryptocurrency or [blockchain fundamentals](/blockchain-fundamentals/). This includes the obvious names — Coinbase and other major exchanges — alongside miner firms validating transactions and earning block rewards. Custody and payment-settlement companies are there. So too are blockchain software and infrastructure plays. Geography and [market cap](/market-capitalization/) are secondary to the index's core filter: exposure to digital-asset ecosystems.

The portfolio is therefore small and active. You might see 30 to 50 holdings, sometimes fewer. [Concentration risk](/concentration-risk/) is built in. A firm dominating crypto trading volume carries outsized weight. Holdings are younger, on average, than traditional finance — early-stage volatility and uncertainty are priced in.

## The cryptocurrency cycle and equity returns

Here is the critical tension. When [Bitcoin](/bitcoin/) and [Ethereum](/ethereum/) rally, trading volumes explode, mining becomes newly profitable, and the public companies operating in those markets see revenue and margin expansion. Equity investors crowd in, often pricing in hype. Returns for DECO can soar alongside digital-asset prices.
...
In [bear markets](/bear-market/), DECO can outperform because it captures only business fundamentals, not the speculative sentiment collapse of crypto itself. But during rallies, it often underperforms the assets directly because equity valuations have limits; pure digital assets do not. The fund sits uncomfortably between two worlds — tied to the crypto cycle but buffered from its extremes.

## Structure, costs, and trading

Standard ETF wrapper. Trades intraday. Holds equities, not cryptocurrency, eliminating custody complexity for the fund holder. [Expense ratio](/expense-ratio/) is moderate for a thematic strategy, reflecting specialised index work and State Street's maintenance costs. Liquidity depends on crypto sentiment. During rallies, spreads tighten and volume rises. During downturns, spreads can widen and trading slow.

Tax treatment mirrors any [equity ETF](/equity-etf/). Capital gains and [dividends](/dividend/) taxed as equities, not the regulatory fog surrounding direct crypto holdings.

## Key risks

Concentration first. A dozen major holdings carry the bulk of the index weight. A regulatory blow to one exchange, a technical failure at a mining operation, a sudden hack — any of these moves the fund sharply. No [diversification](/diversification/) buffer exists like it would in a broad-market index.
