...
When [Duke Energy](/duk-stock/) Corporation needs to raise capital without taking on debt that would breach regulatory [debt-to-equity ratios](/debt-to-equity-ratio/), it issues preferred shares — securities that sit between [bonds](/bond/) and common equity in the capital structure. DUK-PA represents the 5.75% Series A Cumulative Redeemable [Perpetual Preferred Stock](/perpetual-preferred/), traded on the open market as depositary shares. To understand what it is and why it exists, you must first understand the utility business model and the constraints it operates under.
