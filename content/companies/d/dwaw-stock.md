---
title: "AdvisorShares Dorsey Wright FSM All Cap World ETF (DWAW)"
description: "DWAW is an actively managed ETF that constructs a globally diversified portfolio by holding other ETFs selected via a relative-strength methodology across U.S. and international equities."
keywords:
  - fund of funds
...
<table>
<tr><th>Ticker</th><td>DWAW (NASDAQ)</td></tr>
<tr><th>Issuer</th><td>AdvisorShares</td></tr>
<tr><th>Structure</th><td>Actively managed fund of funds</td></tr>
<tr><th>Underlying holdings</th><td>Other ETFs, mostly iShares and BlackRock products</td></tr>
<tr><th>Geographic scope</th><td>U.S., developed markets, emerging markets</td></tr>
<tr><th>Selection method</th><td>Dorsey Wright relative strength screening</td></tr>
<tr><th>Expense ratio</th><td>Approximately 1.28% annually</td></tr>
<tr><th>Rebalance cadence</th><td>Periodic (per fund strategy)</td></tr>
</table>
</aside>

## The fund-of-funds architecture

The fund-of-funds structure is rare in retail investing and often misunderstood. A conventional ETF owns a basket of stocks or [bonds](/bond/). DWAW owns a basket of baskets — it holds 10 to 15 other ETFs (mostly iShares products from [BlackRock](/blk-stock/)) and allocates capital across them. The benefit is simplification: instead of owning 1,000 individual stocks, an investor buys one fund that owns 10 other funds, each of which owns 100 stocks. The downside is layered fees: DWAW itself charges 1.28 percent, and each underlying ETF charges its own fee (typically 0.05 to 0.25 percent), so total costs compound.

AdvisorShares uses this structure to implement a global [diversification](/diversification/) strategy filtered through relative strength. The manager screens all investable ETFs in their universe — iShares factor funds, geographic region funds, [sector funds](/sector-fund/) — and selects those showing the strongest recent momentum. The result is a globally diversified portfolio that dynamically rotates toward whatever segments (U.S. large-cap, emerging markets, developed-market value, etc.) are rising fastest.

## The global angle and geographic rotation

DWAW's prospectus permits holdings in U.S. equities of any cap size, developed-market equities (Europe, Japan, Australia, Canada), and emerging-market equities (Asia, Latin America). In practice, the fund's allocation shifts based on what is performing. When U.S. equities are leading, the fund holds more U.S. exposure. When emerging markets are in favor, the fund shifts capital there. This dynamic [geographic rotation](/geographic-rotation/) is intended to capture the strongest performers wherever they emerge around the world.

The geographic dimension adds complexity. Currency fluctuations matter — when the [U.S. dollar](/us-dollar/) strengthens, foreign returns suffer for dollar-based investors, and the fund's emerging-market exposure can deliver losses even if foreign stocks are rising. The fund does not appear to use [currency hedging](/currency-hedging/), so investors inherit full [currency risk](/currency-risk/) alongside equity risk.
