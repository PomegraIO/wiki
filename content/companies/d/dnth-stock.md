---
title: "Dianthus Therapeutics, Inc. (DNTH)"
description: "Dianthus Therapeutics is an early-stage biopharmaceutical company developing cell and gene therapies for genetic blood disorders and related conditions, with a pipeline of experimental treatments in clinical trials."
keywords:
  - biotechnology
  - cell therapy
  - gene therapy
...
The company also explores gene-therapy approaches, where a corrected gene is delivered to a patient's cells using viral vectors or other [delivery mechanisms](/delivery-mechanisms/), instructing the cells to produce the correct protein. Both modalities — cell and gene therapy — are still nascent in commercial medicine, and Dianthus is competing in a space where several other companies are pursuing similar targets with varying approaches.
...
The company has raised capital from investors — both institutional venture capital and strategic partners. These fundings provide the cash runway to conduct trials, hire talent, and advance the pipeline. The company's [balance sheet](/balance-sheet/) is crucial to its survival: the amount of cash on hand determines how long the company can operate before it must raise more capital, achieve a partnership, or shut down operations.
