---
title: "Dingdong (Cayman) Limited (DDL)"
description: "A Chinese on-demand fresh-grocery e-commerce platform offering hyperlocal delivery of vegetables, meat, seafood, and household essentials in major urban markets."
keywords:
  - dingdong
  - fresh groceries
  - e-commerce china
...
Investors typically follow: active user growth and frequency (orders per month per active user), average order value, gross margin by category, warehouse utilization rates, delivery economics (cost per delivery, density per warehouse), and unit-level profitability by city. The [10-K](/wiki/10-k/) filing details quarterly performance in geographic segments, cost of revenue breakdowns, and cash burn from expansion activities. Operating leverage is expected as the company matures, assuming density and retention improve.
