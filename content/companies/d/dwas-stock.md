---
title: "Invesco Dorsey Wright SmallCap Momentum ETF (DWAS)"
description: "DWAS is an ETF that buys small-cap U.S. stocks showing strong recent price momentum, using a technical analysis approach to identify companies whose stock charts are climbing."
keywords:
  - small-cap stocks
  - momentum investing
  - relative strength
...
<table>
<tr><th>Ticker</th><td>DWAS (NASDAQ)</td></tr>
<tr><th>Issuer</th><td>Invesco</td></tr>
<tr><th>Underlying index</th><td>Dorsey Wright SmallCap Technical Leaders Index</td></tr>
<tr><th>Holdings</th><td>Approximately 200 small-cap U.S. stocks</td></tr>
<tr><th>Selection method</th><td>Relative strength (momentum) screening</td></tr>
<tr><th>Rebalance frequency</th><td>Quarterly</td></tr>
<tr><th>Expense ratio</th><td>0.60% annually</td></tr>
<tr><th>Market cap range</th><td>Small-cap and micro-cap U.S. equities</td></tr>
</table>
</aside>
...
This is pure technical analysis. It ignores earnings, cash flow, or [balance sheet](/balance-sheet/) quality. All that matters is price movement. The assumption is that stocks can develop trends — momentum that persists week to week and month to month — and that riding those trends produces returns. Some decades, [momentum investing](/momentum-investing/) works spectacularly. Other decades, it whipsaws investors and lags badly. For small-cap stocks, the effect is often amplified because these companies are followed by fewer analysts and their prices can swing wildly on thin trading volume.
...
The fund is agnostic about fundamentals, so it can hold excellent companies in the early stages of a boom, but it can just as easily hold duds if they happen to be rising. Investors using this fund should do their own homework on the actual businesses if they want to avoid owning fundamentally broken companies that are rising purely on speculation or [herd behavior](/herd-behavior/). Alternatively, they can treat it as a pure momentum play and accept that some holdings will be damaged goods by the time the momentum reverses.
