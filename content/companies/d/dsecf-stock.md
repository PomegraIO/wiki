---
title: "Daiwa Securities Group Inc. (DSECF)"
description: "Japanese financial-services conglomerate spanning brokerage, investment banking, asset management, and trading; transaction fees and spreads are the primary unit-economics drivers."
keywords:
  - financial-services
...
*[Daiwa Securities](/dseey-stock/) Group Inc. (DSECF), a Japan-domiciled firm with American [CIK 1481045](/), is a major financial-services company and one of Japan's "Big Four" securities houses. Daiwa operates through brokerage (retail and institutional equities and fixed income), investment banking ([mergers](/merger/) and [acquisitions](/acquisition/), underwriting), trading (proprietary and client facilitation), and asset management divisions. The company's unit economics are fundamentally different from a product manufacturer: Daiwa earns revenue from the spread (the markup on each transaction) and from fees charged to investors and corporate clients.*

## The Spread as Core Unit

Daiwa's foundational revenue source is the spread—the gap between the price the firm pays for a security and the price it charges to customers, or the commission extracted on each transaction. When a retail investor buys 100 shares of a Japanese stock, the [broker](/broker/) (Daiwa) executes the order and charges a commission, typically 0.05% to 0.2% of the transaction value. On a $10,000 order, that is $5 to $20 in gross revenue to Daiwa.
...
The cost of asset management includes portfolio managers, research analysts, trading desks for fund execution, compliance and risk management, and marketing. A large, [actively managed fund](/actively-managed-fund/) might have operating costs of 0.3% to 0.4% of AUM, yielding net margin of 0.1% to 0.2% of AUM. A passively managed [index fund](/index-fund/) (which requires less active research) might have operating costs of 0.05% to 0.1% of AUM, yielding net margin of 0.2% to 0.3% of AUM.
...
Daiwa's overall profitability is the sum of: trading spreads (multiplied by trading volume), investment-banking fees (multiplied by deal activity and fees), asset-management fees (multiplied by AUM), proprietary-trading P&L (highly variable), and prime-brokerage and financing fees. In aggregate, Daiwa's revenue is cyclical and tied to Japanese and global financial-market activity. In strong [bull markets](/bull-market/) with active M&A and high trading volumes, Daiwa generates billions in annual revenue and substantial profits. In [bear markets](/bear-market/) or periods of financial stress, revenue and profits compress sharply.
...
<tr><th>Ticker</th><td>DSECF</td></tr>
<tr><th>Listing</th><td>OTC Markets (US); Tokyo Stock Exchange (Japan)</td></tr>
<tr><th>SEC CIK</th><td>1481045</td></tr>
<tr><th>Sector</th><td>Financials</td></tr>
<tr><th>Industry</th><td>Securities / Financial Services</td></tr>
...
- [DRVN (Driven Brands Holdings)](/drvn-stock/) — also operates on transaction fees and scale
- [How securities brokers earn revenue](/earnings-per-share/)
- [Understanding trading spreads and commissions](/price-to-sales-ratio/)

### Wider context

- [Investment banking and underwriting](/initial-public-offering/)
- [Asset management and fees](/mutual-fund/)
- [Regulatory capital requirements](/balance-sheet/)
