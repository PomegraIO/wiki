...
Like all REITs, Easterly is required to distribute at least 90% of taxable income to shareholders as [dividends](/dividend/). This constraint shapes the capital strategy: the company must balance [debt financing](/debt-financing/) of [acquisitions](/acquisition/) with the imperative to maintain [payout ratios](/payout-ratio/) that keep investors satisfied. Government-tenant properties support leverage because of lease stability, so DEA typically carries a [debt-to-assets ratio](/debt-to-assets-ratio/) in the 40–50% range.

Debt is raised in the public [bond](/bond/) and loan markets; rates matter significantly to the REIT's ability to acquire new properties at spread-positive returns. A rising-rate environment compresses REIT economics by increasing the [cost of debt](/cost-of-debt/) while loan yields decline. A falling-rate environment allows Easterly to refinance at lower costs and expand margins.
...
Interest-rate sensitivity is material: rising rates increase debt service and lower the [discount rate](/discount-rate/) applied to future cash flows, both of which reduce value. Regulatory changes affecting government procurement or real-property management can also alter the competitive or economic landscape.
