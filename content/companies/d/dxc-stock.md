...
This constraint is not temporary. Unlike a startup that takes debt to fund an acquisition and promises rapid growth to justify the debt, a mature services firm refinancing a major merger faces a structural debt service obligation that will persist for years. DXC's management must therefore balance three priorities: maintaining [dividend](/dividend/) payments to shareholders (itself a capital claim on the firm), servicing and reducing debt, and investing in new services and platforms to remain competitive.
...
The company's [10-K](/10-k/) filings disclose the maturity profile of debt: how much comes due in year one, year two, and beyond. A company with debt cliffs—large portions maturing in a single year—faces refinancing risk: if market conditions worsen or ratings fall, rolling over debt becomes expensive or impossible. A company with a staggered maturity schedule distributes refinancing risk over time.
