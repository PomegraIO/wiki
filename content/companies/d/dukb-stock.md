---
title: "Duke Energy Corporation (DUKB)"
description: "Duke Energy is a major regulated utility serving 8.7 million electric customers and 1.6 million gas customers across the Carolinas, Florida, and the Midwest — operating through a regional patchwork of generation, transmission, and distribution infrastructure."
keywords:
  - regulated utilities
  - electric generation
...
[Duke Energy](/duk-stock/) Corporation operates one of the largest integrated utility networks in the United States, supplying electricity and [natural gas](/natural-gas/) to millions of customers across six states. The company is not a single monolithic enterprise but rather a collection of regional utilities, each shaped by its own geography, generation capacity, and regulatory environment. This regional complexity is the key to understanding Duke Energy: what it is and how it makes money are inseparable from where it operates.

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>DUKB (NASDAQ)</td></tr>
<tr><th>Founded</th><td>1904 (modern company via mergers)</td></tr>
<tr><th>Sector</th><td>Regulated utilities — electric and gas</td></tr>
<tr><th>Headquarters</th><td>Charlotte, North Carolina</td></tr>
<tr><th>Service states</th><td>North Carolina, South Carolina, Florida, Ohio, Indiana, Kentucky</td></tr>
<tr><th>Customers served</th><td>~8.7 million electric, ~1.6 million gas</td></tr>
<tr><th>Business model</th><td>Regulated rate-of-return utility</td></tr>
...
This incentive structure is why regulated utilities sometimes appear to over-invest from a pure economic perspective. Regulators set a "allowed [return on equity](/return-on-equity/)" — typically 9–11% depending on the region — which becomes the company's target cost of capital for new investment. If Duke can borrow at 4% and earn 10% on regulated equity, the math favors building, even if a private company might not. This is by design: regulators want utilities to be well-maintained, and capital incentives are the lever they use.
