---
title: "Digital Realty Trust, Inc. (DLR-PL)"
description: "Digital Realty Trust Series PL Preferred Shares — fixed-income preferred equity in a data-center real estate investment trust operating 300+ facilities in 57 metropolitan areas across 31 countries."
keywords:
  - preferred shares
  - data centers
  - REIT
...
[Digital Realty](/dlr-stock/) Trust owns and operates data centres — massive buildings filled with computer servers, cooling systems, and networking equipment — that companies rent space in to run their computing, storage, and cloud services. The company owns around 300 data centres in major cities across North America, Europe, Asia, Australia, and South America. Think of it this way: if you use cloud services like Amazon Web Services or [Microsoft](/msft-stock/) Azure, or if you visit a website, the data flowing through servers in Digital Realty buildings. The DLR-PL preferred shares are a fixed-income security issued by Digital Realty, offering investors stable [dividend](/dividend/) payments backed by the company's real estate portfolio and long-term customer contracts.

<aside class="wiki-infobox">
<table>
<tr><th>Company type</th><td>Real estate investment trust (REIT)</td></tr>
<tr><th>Preferred ticker</th><td>DLR-PL</td></tr>
<tr><th>Fixed dividend</th><td>Varies by series (typically 5–6%)</td></tr>
<tr><th>Properties</th><td>~300 data centres globally</td></tr>
<tr><th>IT capacity</th><td>~3.0 gigawatts deployed</td></tr>
<tr><th>Customer count</th><td>~5,000 customers</td></tr>
<tr><th>Geographic reach</th><td>31 countries, 57 metropolitan areas</td></tr>
<tr><th>Primary business</th><td>Colocation and interconnection services</td></tr>
</table>
</aside>
...
A preferred share is a claim on the company's assets and cash flow, but it is junior to debt ([bonds](/bond/)) and senior to [common stock](/common-stock/). You get a fixed dividend — let us say 5.5% annually, paid quarterly. This is not a guess or dependent on the company's profits; it is contractual. As long as the company is solvent and has cash, you receive your 5.5% per year.

The preferred shares do not have a maturity date (some do; it depends on the series), so they could exist forever, or they could be redeemed at Digital Realty's discretion. If [interest rates](/interest-rate/) fall and new preferreds yield only 4%, it makes sense for the company to call (redeem) the 5.5% shares and refinance at a lower rate; your 5.5% shares get bought back at par.
...
Digital Realty's [balance sheet](/balance-sheet/) is substantial — the company owns or controls hundreds of real-estate properties worth tens of billions of dollars. The assets generate recurring colocation and interconnection revenue, which flows through as cash. A large portion of this cash is distributed to shareholders as dividends and distributions. Preferred shareholders get paid first (after debt), common shareholders get paid second, and the rest is reinvested in the business or used to acquire new properties.
