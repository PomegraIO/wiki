---
title: "BrandywineGLOBAL-Dynamic US Large Cap Value ETF (DVAL)"
description: "BrandywineGLOBAL Dynamic US Large Cap Value ETF is an actively managed fund that uses quantitative models to find undervalued large U.S. companies and rotates between broad and focused value strategies based on market conditions."
keywords:
  - value investing
  - large-cap stocks
  - quantitative models
...
<table>
<tr><th>Ticker</th><td>DVAL (NASDAQ)</td></tr>
<tr><th>Issuer</th><td>Franklin Templeton</td></tr>
<tr><th>Sub-advisor</th><td>BrandywineGLOBAL</td></tr>
<tr><th>Fund type</th><td>Actively managed large-cap value ETF</td></tr>
<tr><th>Primary holdings</th><td>Large U.S. publicly traded companies</td></tr>
<tr><th>Strategy</th><td>Quantitative value selection with dynamic shifting</td></tr>
...
Active management and quantitative models cost money. The [expense ratio](/expense-ratio/) is higher than a passive value [index fund](/index-fund/) would charge. You are paying for the team that builds and monitors the models, updates them as markets change, and makes the shifting decisions.
