---
title: "Drugs Made In America Acquisition Corp. (DMAAR)"
description: "The post-merger equity ticker of a SPAC vehicle focused on acquiring domestic pharmaceutical manufacturing operations."
keywords:
  - SPAC merger
  - post-merger
...
Anyone holding or considering DMAAR should locate the merger agreement (filed as a [proxy statement](/proxy-statement/) on SEC EDGAR, using CIK 0002028614 or the post-merger entity's new CIK) to understand the structure, the pro-forma financials presented to shareholders, and the [earnout provisions](/earnout-provision/) (if any) that tie founder compensation to future performance. They should read the most recent 10-K filing to understand the actual business, its revenue model, its capital needs, and its competitive position. The quarterly 10-Q reports reveal trends in revenue, margin, cash burn, and management's confidence in hitting projections. Management commentary on conference calls (if the company holds them) exposes which assumptions are holding and which are failing.
