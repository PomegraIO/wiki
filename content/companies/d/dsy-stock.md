---
title: "Big Tree Cloud Holdings Ltd (DSY)"
description: "Chinese software and cloud services provider serving enterprise customers; US-listed via NASDAQ under ADR structure."
keywords: ["cloud-services", "software", "china", "saas", "adr"]
---

*Big Tree Cloud Holdings Ltd, trading under ticker **DSY** and filing with the [SEC](/securities-and-exchange-commission/) under CIK 1999297, is a Chinese software and cloud services company listed on [NASDAQ](/nasdaq/) via [American Depositary Receipt](/adr/), offering cloud infrastructure, software licensing, and related IT services primarily to enterprise customers in China and the Asia-Pacific region.*

<aside class="wiki-infobox"><table>
<tr><td>Ticker (ADR)</td><td>DSY</td></tr>
<tr><td>Listing</td><td>NASDAQ</td></tr>
<tr><td>SEC CIK</td><td>1999297</td></tr>
<tr><td>Sector</td><td>Information Technology</td></tr>
<tr><td>Industry</td><td>Cloud Services & Software</td></tr>
<tr><td>Type</td><td>ADR / Chinese issuer</td></tr>
</table></aside>
...
Many growth-stage software companies operate at a loss while investing heavily in customer [acquisition](/acquisition/) and R&D, betting that scale will bring profitability. The 10-K discloses whether Big Tree Cloud is profitable or loss-making, and if loss-making, the trajectory. An early-stage company losing money and burning cash, with a clear path to profitability if it achieves a subscriber milestone, is different from a company that has plateaued at modest revenue, is not improving margins, and has no clear unit economics. Look for (1) [operating margins](/operating-margin/) (operating profit / revenue) over the past 2-3 years, (2) [free cash flow](/free-cash-flow/) (operating cash flow minus capex), and (3) cash balance and burn rate—how long can the company operate at current burn with existing cash? A company with negative free cash flow and declining cash balance is at risk of running out of capital and needing dilutive financing or a sale.

## The ADR structure and accounting disclosure

Big Tree Cloud files on Form 20-F, using [International Financial Reporting Standards](/international-financial-reporting-standards/) (IFRS) rather than US [Generally Accepted Accounting Principles](/generally-accepted-accounting-principles/) (GAAP). The 10-K/20-F includes reconciliation to US GAAP metrics where possible, but the narrative and many operational metrics may follow different conventions than US software companies. This makes year-over-year and peer comparison more difficult. Be thorough in reading the reconciliation and footnotes. Additionally, check the risk factors section (Item 1D in the 20-F) for any mention of Chinese regulatory investigations, restrictions on the company's operations, or auditor disputes—these are red flags that warrant deep investigation before investing.
...
### Closely related
- Cloud infrastructure and SaaS business models
- [Chinese tech regulation and US listing risks](/adr/)
