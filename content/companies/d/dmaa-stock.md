---
title: "Drugs Made In America Acquisition Corp. (DMAA)"
description: "DMAA is a blank-check company established to acquire, merge with, or invest in a domestic pharmaceutical or pharmaceutical-adjacent business with operations in the United States."
keywords:
  - blank-check company
  - SPAC
  - pharmaceutical
...
*A **blank-check company** — more formally known as a [special-purpose acquisition company](/special-purpose-acquisition-company/) or SPAC — is a shell corporation created for the explicit purpose of acquiring or merging with an existing business. Drugs Made In America [Acquisition](/acquisition/) Corp. (DMAA), incorporated in Delaware in 2024, represents this investment structure applied to the pharmaceutical sector with a stated focus on bringing or keeping drug manufacturing within the United States.*

Blank-check companies have become a recurring fixture in corporate finance. They are formed with minimal operating assets and a specific mandate: raise capital from public investors, then deploy that capital to acquire a privately held company and take it public through the merger. The advantage to the target company is speed — a traditional [initial public offering](/initial-public-offering/) requires years of regulatory preparation, but a merger with a SPAC can move much faster. The advantage to SPAC investors is supposed optionality: you are buying into a pool of capital managed by sponsors who claim an edge in finding and executing the right deal.
...
The broader risk of blank-check companies is a feature of the structure itself: misaligned incentives. Sponsors profit from announcing an acquisition, whether or not it creates shareholder value. Deadlines and pressure to deploy capital can push sponsors toward mediocre deals. And the complexity of SPAC [mergers](/merger/) — with sponsor shares, earnouts, and overhang from initial investors redeeming their shares — often creates a grimy cap table that hobbles the public company that emerges.
