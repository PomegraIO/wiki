---
title: "Simplify Tax Aware Diversified Income Strategy ETF (DINE)"
description: "An actively managed ETF that combines dividend-paying stocks with tactical tax-loss harvesting to deliver diversified income while minimizing tax drag for individual investors."
keywords:
  - dividend ETF
  - tax-aware strategy
  - income investing
...
Simplify Tax Aware Diversified Income Strategy ETF is an actively managed vehicle designed to deliver [dividend](/dividend/) income to individual investors while using [tax-loss harvesting](/tax-loss-harvesting/) — the strategic sale of losing positions to offset capital gains — to reduce the tax burden that income investing typically creates. Instead of passively tracking a single index, the fund's managers select dividend-payers across sectors and sizes, then actively trade around them to manage the tax impact of payouts and market movements.

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>DINE</td></tr>
<tr><th>Sponsor</th><td>Simplify Asset Management</td></tr>
<tr><th>Type</th><td>Actively managed equity ETF</td></tr>
<tr><th>Strategy</th><td>Dividend stocks with tax-loss harvesting</td></tr>
<tr><th>Approach</th><td>Tax-aware income optimization</td></tr>
<tr><th>Primary holdings</th><td>Dividend-paying equities across market caps</td></tr>
<tr><th>Suitable for</th><td>Taxable accounts, income-focused investors</td></tr>
</table>
</aside>
...
The fund's managers also have to be mindful of [wash-sale rules](/wash-sale/) — tax regulations that disallow a loss deduction if a substantially identical security is bought within 30 days of the sale. Tax-loss harvesting on a stock requires selling the stock and not buying it back within that window, which is where the substitution with a similar but not identical dividend-payer comes in.
