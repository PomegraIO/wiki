---
title: "DESTINATION XL GROUP, INC. (DXLG)"
description: "A specialty retail apparel company managing capital structure through same-store sales sensitivity, inventory financing, and a focus on profitability over growth-driven leverage."
...
DXLG's shareholder return approach depends on its financial strength. A profitable, low-leverage retailer can sustain a [dividend](/dividend/) or [share buyback](/share-buyback/) program. A retailer with rising debt or declining profitability may have little to return to shareholders.

Buybacks are often the preferred return mechanism for retail firms: they reduce share count, which boosts [earnings-per-share](/earnings-per-share/) math without requiring cash outflows to all shareholders (only those who sell shares). However, buybacks funded by debt are financially risky if sales weaken, as the company will have higher fixed costs (debt service) and fewer shares to distribute earnings over.
