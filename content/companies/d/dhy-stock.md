---
title: "CREDIT SUISSE HIGH YIELD CREDIT FUND (DHY)"
description: "A closed-end fund investing in high-yield bonds, generating distributions to shareholders from portfolio income and capital gains — a leveraged bet on corporate credit quality."
keywords:
  - high-yield bonds
  - closed-end fund
  - credit risk
...
**The closed-end structure:** Unlike an open-end [mutual fund](/mutual-fund/), DHY's share count is fixed (closed). Shares trade on the public market at prices that can diverge sharply from the fund's [net asset value](/net-asset-value/) (NAV). In periods of credit fear, DHY shares often trade at a steep discount to NAV, meaning you pay less than the underlying bonds are worth, which can be a bargain — or a signal that the market has priced in further deterioration. Understanding the discount or premium is key to valuation.

**Sector and concentration:** The fund's portfolio typically skews toward telecom, healthcare, media, and industrials — sectors that borrow heavily to finance operations or [acquisitions](/acquisition/). Concentrated bets in these sectors or in a few large issuers create [idiosyncratic risk](/idiosyncratic-risk/) on top of the systematic credit risk the fund is meant to capture.
