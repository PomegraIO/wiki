---
title: "Diversified Healthcare Trust (DHCNL)"
description: "Diversified Healthcare Trust is a real estate investment trust that acquires and leases healthcare properties — medical office, senior housing, and rehabilitation facilities — to healthcare operators and health systems across the United States."
keywords:
  - REIT
...
Diversified Healthcare Trust operates as a [real estate investment trust](/real-estate-investment-trust/) (REIT) with a portfolio of healthcare-related properties spread across multiple segments. Rather than build or operate healthcare facilities directly, the company acquires properties, leases them to healthcare operators and providers, and returns the lease income to shareholders as [dividends](/dividend/). The business is segmented by property type and tenant operator, a structure that reveals both the sources of revenue stability and the company's exposure to different healthcare market dynamics.

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>DHCNL (NYSE)</td></tr>
<tr><th>Business type</th><td>Real estate investment trust (REIT)</tr>
<tr><th>Core business</th><td>Own and lease healthcare properties</td></tr>
<tr><th>Main segments</th><td>Medical office, senior housing, rehabilitation facilities</td></tr>
<tr><th>Revenue model</th><td>Lease income from healthcare tenants</td></tr>
<tr><th>Capital structure</th><td>Equity plus mortgage debt</td></tr>
