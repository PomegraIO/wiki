---
title: "VanEck Digital Transformation ETF (DAPP)"
description: "An exchange-traded fund tracking companies advancing digital transformation across industries—cloud infrastructure, software, hardware enablers, and digital payment processors."
keywords:
...
<table>
<tr><th>Ticker</th><td>DAPP (NASDAQ)</td></tr>
<tr><th>Fund type</th><td>Index-based thematic ETF</td></tr>
<tr><th>Sponsor</th><td>VanEck</td></tr>
<tr><th>Theme</th><td>Digital transformation and enablement</td></tr>
<tr><th>Holdings</th><td>Approximately 40–60 global stocks</td></tr>
<tr><th>Geography</th><td>U.S. and international</td></tr>
<tr><th>Sector mix</th><td>Technology, semiconductor, financials, industrials</td></tr>
<tr><th>Expense ratio</th><td>Low to moderate</td></tr>
</table>
</aside>

## The digital transformation thesis

Digital transformation is an umbrella concept: moving business processes, infrastructure, and customer interactions from physical or analogue systems to digital ones. The fund interprets this broadly, including companies that sell the tools (cloud platforms, software suites), the hardware that underlies them (semiconductor makers, networking equipment), and the services that help companies make the transition (systems integrators, cybersecurity firms). It also includes payment processors and fintech companies that are digitizing financial transactions.

The portfolio spans geographies. Some holdings are U.S. household names — cloud giants, semiconductor leaders, payment processors. Others are European or Asian companies that are critical to digital infrastructure but less familiar to U.S. retail investors. The geographic and sector diversity is intentional, aiming to capture the reality that digital transformation is a global phenomenon affecting every region and many industries simultaneously.
...
Start with the fund's methodology document to understand exactly which companies qualify as digital-transformation enablers and how they are weighted. Look at the top 10 holdings and sector allocations to gauge whether the actual portfolio matches your intuition about digital transformation.

Compare DAPP's returns to both technology sector indices and to broader market indices over rolling periods. Watch for periods when DAPP significantly outperforms and underperforms, and understand what was happening in tech markets at those times. Monitor the turnover rate and the fund's inflow and outflow patterns; rapid changes in fund size can affect trading costs and the index's ability to rebalance efficiently.

Finally, consider how digital transformation risk aligns with your own portfolio. If you already own several technology-heavy funds, DAPP adds concentration rather than diversification. If you own none, it can be a sensible core holding for the technology sleeve.
