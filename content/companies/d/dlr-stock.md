...
description: "Digital Realty is a real estate investment trust that owns and leases data centres worldwide. As cloud computing and data storage have grown exponential, DLR has become one of the largest owners of the physical infrastructure underpinning the internet."
keywords:
  - data centre
...
Digital Realty is a landlord, but not of buildings where people work. It owns and leases data centres — the vast, secured facilities filled with servers, networking equipment, power systems, and cooling infrastructure that store data and run cloud computing services. When you upload a photo to Google or stream a video on [Netflix](/nflx-stock/), that data is processed and stored in buildings like the ones Digital Realty owns. The company operates data centres across the United States, Europe, Asia, and Australia. It is organised as a [real estate investment trust](/real-estate-investment-trust/), or REIT, which means it collects rent from customers and returns most of its cash flows to shareholders as [dividends](/dividend/). The business is structural: as long as the world keeps generating and processing data, Digital Realty has tenants who need space.

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>DLR (NYSE)</td></tr>
<tr><th>Headquarters</th><td>San Francisco, California</td></tr>
<tr><th>Founded</th><td>2002</td></tr>
<tr><th>Founder</th><td>Joshua Mills</td></tr>
<tr><th>Sector</th><td>Real estate investment trust / data centres</td></tr>
<tr><th>Main business</th><td>Data centre ownership and leasing</td></tr>
<tr><th>Property type</th><td>Hyper-scale and colocation data centres</td></tr>
<tr><th>SEC CIK</th><td>0001297996</td></tr>
</table>
</aside>
...
The rise of cloud computing transformed everything. For the first half of the 2000s, most data processing and storage lived on-premise — that is, in the company's own offices or data centres. But as cloud providers like Amazon Web Services, [Microsoft](/msft-stock/) Azure, and Google Cloud grew, more and more computing shifted to massive, cloud-operated data centres. These cloud providers needed enormous amounts of space and power, and they needed it everywhere — in every major city, every region of the world. Digital Realty was suddenly a landlord not just to small and medium enterprises, but to the largest tech companies on Earth.
