---
title: "Daura Capital Corp. (DGCOF)"
description: "Blank-check company incorporated to acquire or merge with a private business and effect its transition to public markets."
keywords: ["SPAC", "blank-check", "acquisition", "merger", "capital pool", "de-SPAC"]
---

*Daura Capital Corp. (**DGCOF**) is a [special-purpose acquisition company](/special-purpose-acquisition-company/)—a blank-check entity created solely to raise capital from public markets and deploy that pool toward acquiring a private company, thereby taking that target public. Until such a merger closes, Daura's economics are straightforward: it holds cash, invests that cash in Treasury securities to earn modest interest, and searches for an acquisition target.*

<aside class="wiki-infobox"><table>
<tr><td>Ticker</td><td>DGCOF</td></tr>
<tr><td>Listing</td><td>OTC Markets</td></tr>
<tr><td>SEC CIK</td><td>1809267</td></tr>
<tr><td>Type</td><td>Shell corporation (SPAC)</td></tr>
</table></aside>
