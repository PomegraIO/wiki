---
title: "DRDGOLD LTD (DRD)"
description: "South African gold miner recycling tailings and processing ore in the Witwatersrand Basin, serving a global market for physical gold."
...
<table>
<tr><td>Ticker</td><td>DRD</td></tr>
<tr><td>Exchange</td><td>NASDAQ</td></tr>
<tr><td>SEC CIK</td><td>1023512</td></tr>
...
- [stock](/stock/)
- commodity
- mining-operations (if in allowlist)
- [price-to-earnings-ratio](/price-to-earnings-ratio/)
- [free-cash-flow](/free-cash-flow/)

<h3>Wider context</h3>
- materials-sector (if in allowlist)
- emerging-markets (if in allowlist)
- commodity-cycles (if in allowlist)
</div>
