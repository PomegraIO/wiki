...
dLocal's business model hinges on operating locally in each target market. Rather than attempting to connect directly to every [central bank](/central-bank/) and banking system, dLocal builds relationships with local banks, payment networks, money services, and regulators in each country. In Mexico, for instance, the company works with SPEI (the interbank electronic transfer system) and local banks to offer a payment option to merchants. In Brazil, it integrates with Pix (Brazil's instant payment system) and local payment methods. In Colombia, it connects to SINPE and local credit card networks.
