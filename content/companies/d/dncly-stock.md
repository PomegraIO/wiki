---
title: "DeNA Co., Ltd. (DNCLY)"
description: "A Japanese game and entertainment company that runs mobile games, gaming platforms, and live-entertainment venues, regulated by Japanese gambling and content laws."
keywords:
  - mobile games
  - gaming platforms
  - live entertainment
...
The third is **platform revenue** — DeNA runs Mobage, a social and content platform for games. The company takes a cut (typically 30%) of every virtual-currency sale made through Mobage games, similar to how [Apple](/aapl-stock/) and Google take a cut of app-store sales. Mobage is shrinking relative to direct app downloads, because players prefer buying inside an app rather than through an intermediate platform, but it still generates meaningful revenue.
