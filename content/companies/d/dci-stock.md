---
title: "Donaldson Company (DCI)"
description: "A leading manufacturer of filtration systems and replacement parts across engine, industrial, and life-sciences markets since 1915."
keywords:
  - filtration systems
  - replacement parts
  - engine filtration
...
Start with the 10-K to understand the segment breakdown, OEM relationships, and aftermarket mix. Watch for gross margin trends, which signal competitive health and pricing power in replacement parts. Operating leverage matters—as the company scales aftermarket revenue, [operating margins](/operating-margin/) should expand because the fixed cost base is largely built. Cash flow from operations and [free cash flow](/free-cash-flow/) are reliable metrics because the recurring nature of aftermarket business produces consistent cash generation.

Pay attention to order backlogs and commentary on OEM customer activity, which signal near-term demand. The company often discloses major OEM programs or new contract wins, and these are [leading indicators](/leading-indicator/) of future aftermarket parts revenue. [Balance sheet](/balance-sheet/) metrics like debt-to-EBITDA and interest coverage matter in a capital-light business, and Donaldson typically carries modest leverage, reflecting its steady cash generation.
