---
title: "Spring Valley Acquisition Corp. IV (SVIV)"
description: "A special purpose acquisition company targeting power infrastructure and decarbonization — a capital shell awaiting a business combination deal, closed to fundamental operations."
keywords:
  - SPAC
...
Spring Valley [Acquisition](/acquisition/) Corp. IV is a Cayman Islands blank-check company — a special purpose acquisition company formed exclusively to find and execute a [merger](/merger/), asset acquisition, or similar combination with a target business. It has no operations, no customers, no revenue, and no products of its own. The company exists in a state of intentional suspension, all capital held in trust, all momentum directed toward a single future event: a [business combination](/business-combination-purchase/) announcement.

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>SVIV (NASDAQ)</td></tr>
<tr><th>Company Type</th><td>Special purpose acquisition company (SPAC)</td></tr>
<tr><th>Incorporation</th><td>Cayman Islands</td></tr>
<tr><th>IPO Date</th><td>February 2026</td></tr>
<tr><th>IPO Size</th><td>$230 million gross proceeds</td></tr>
<tr><th>Units Issued</th><td>23 million units at $10.00 each</td></tr>
<tr><th>Warrant Exercise Price</th><td>$11.50 per share</td></tr>
<tr><th>Focus Area</th><td>Power infrastructure and decarbonization</td></tr>
<tr><th>Business Combination Deadline</th><td>24 months from IPO closing</td></tr>
<tr><th>SEC CIK</th><td>0002098242</td></tr>
</table>
</aside>

## A fund with a ticker symbol

Spring Valley IV is best understood not as a company in the operational sense but as a fund with a publicly traded security. Investors who bought units in the IPO acquired a claim on the trust cash (earmarked for a future deal), warrant rights, and an indirect vote on whether to accept or reject whatever target the sponsor team identifies. The sponsor, like a private-equity general partner, has [carried interest](/carried-interest-compensation/) — additional equity stake if a deal closes — creating an incentive to complete something, whether or not it is an exceptional opportunity.
...
Until a target is announced, Spring Valley IV generates returns only through the interest and other earnings on trust cash — modest, typically a fraction of 1% annually. The entire value proposition depends on the eventual deal. That is why SPAC shareholders spend much of their [holding period](/holding-period/) simply waiting, reviewing SEC filings to track the sponsor's progress, and monitoring sector news to guess where the search might lead.
