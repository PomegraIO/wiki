---
title: "iShares ESG Aware USD Corporate Bond ETF (SUSC)"
description: "A passive index fund tracking investment-grade USD corporate bonds tilted toward issuers with favorable ESG ratings, seeking stability and income with broad market exposure."
keywords:
  - corporate bonds
  - ESG investing
  - investment-grade
...
<div class="wiki-infobox-title">SUSC at a glance</div>

| | |
|---|---|
| **What it tracks** | U.S. dollar-denominated, investment-grade corporate bonds from issuers with positive ESG ratings |
| **Index target** | Bloomberg U.S. Corporate Index, ESG-screened |
| **Sponsor** | BlackRock (iShares brand) |
| **Maturity range** | No specific limit; typically intermediate-term (2–10 years) |
| **Distribution frequency** | Monthly |
| **Expense ratio** | 0.18% annually |
| **Liquidity** | Good; trades on major exchanges |
| **Net assets** | Over $1 billion |
| **Dividend yield** | Approximately 4.4% |

</aside>

SUSC provides broad exposure to investment-grade corporate debt while tilting the portfolio toward companies with favorable environmental, social, and governance characteristics. Launched by [BlackRock](/blk-stock/) in 2017, the fund has grown to over $1 billion in assets, making it a mainstream entry point for corporate-bond investors seeking ESG alignment.

## How the fund works

SUSC is a passive, index-tracking fund. Rather than employing managers to pick winning [bonds](/bond/), it holds a portfolio designed to replicate the returns of the Bloomberg U.S. Corporate Index, but filtered to exclude or underweight companies with poor ESG ratings. The result is a portfolio that spans investment-grade [corporate bonds](/corporate-bond/) across sectors and credit qualities, with a consistent tilt away from issuers flagged as ESG laggards.
