...
description: "Synchrony Financial is a consumer finance company that issues and manages private-label and co-branded credit cards for retailers and financial institutions—a lender that gets paid when shoppers use plastic."
keywords:
  - consumer finance
  - credit cards
  - private-label cards
...
Synchrony is also concentrated among large retailers. Amazon, Home Depot, Lowe's, and a handful of others probably account for a significant share of revenue. If a major retailer ends a partnership or takes the program in-house, it's a material hit. That [concentration risk](/concentration-risk/) makes Synchrony vulnerable to strategic moves by its largest partners.
