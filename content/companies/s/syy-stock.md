...
description: "Sysco is the world's largest food distributor—a company that buys food from producers and sells it to restaurants, hospitals, schools, and other foodservice operations."
keywords:
  - food distribution
  - foodservice
  - supply chain
...
<table>
<tr><th>Ticker</th><td>SYY (NYSE)</td></tr>
<tr><th>Founded</th><td>1969, Houston, Texas</td></tr>
<tr><th>Headquarters</th><td>Houston, Texas</td></tr>
<tr><th>Primary business</th><td>Foodservice distribution</td></tr>
<tr><th>Customers</th><td>Restaurants, schools, hospitals, catering, casinos</td></tr>
<tr><th>Business model</th><td>Buy, warehouse, and deliver food and supplies</td></tr>
<tr><th>Scale</th><td>Serves roughly one million customer locations</td></tr>
<tr><th>SEC CIK</th><td>0000096021</td></tr>
</table>
</aside>
...
1. **Buys food and supplies** in bulk from producers (farms, meat processors, dairies, manufacturers of pre-prepared foods, beverage companies, packaging suppliers, kitchen equipment makers, etc.).
2. **Warehouses the goods** in regional distribution centers maintained at specific temperatures and humidity levels.
3. **Takes orders** from restaurant and institutional customers.
4. **Picks, packs, and ships** those orders on refrigerated trucks to hundreds of customer locations per day.
5. **Services and sells** not just commodity ingredients but also branded products, pre-prepared items, smallware (plates, utensils, napkins), and cleaning supplies.
