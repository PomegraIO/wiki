---
title: "STMicroelectronics N.V. (STMEF)"
description: "STMicroelectronics is a global semiconductor company designing and manufacturing microcontrollers, sensors, and application processors across consumer, automotive, industrial, and mobile applications."
keywords:
...
What distinguishes STMicroelectronics from both the largest chip designers and the pure-play foundries is its middle position. Unlike [Intel](/intc-stock/) or Qualcomm, which design chips and rely entirely on partners to manufacture them, STMicroelectronics designs and manufactures its own products. Unlike [Taiwan Semiconductor Manufacturing](/tsm-stock/) Company, which manufactures chips designed by others, STMicroelectronics controls both the design and the fab. That vertical integration carries trade-offs. It requires vast capital to maintain modern manufacturing plants—a single advanced fab can cost billions to build and equip. But it also allows the company to optimize both design and process in tandem, to protect its intellectual property, and to ensure supply security for critical products.
