---
title: "Sono-Tek Corp (SOTK)"
description: "Sono-Tek is an ultrasonic coating technology company founded in 1975, pioneering nozzle systems that apply thin, uniform films to industrial substrates with minimal waste across medical devices, semiconductors, and alternative energy sectors."
keywords:
  - ultrasonic nozzles
  - thin-film coating
...
<table>
<tr><th>Ticker</th><td>SOTK (Nasdaq)</td></tr>
<tr><th>Founded</th><td>1975, Milton, New York</td></tr>
<tr><th>Founder</th><td>Dr. Harvey Berger</td></tr>
<tr><th>Sector</th><td>Industrial manufacturing equipment / precision coatings</td></tr>
<tr><th>Core product</th><td>Ultrasonic coating nozzles and systems</td></tr>
<tr><th>Target markets</th><td>Medical devices, semiconductors, advanced manufacturing</td></tr>
<tr><th>SEC CIK</th><td>0000806172</td></tr>
</table>
</aside>
...
Sono-Tek's 10-K (SEC CIK 0000806172) details the quarterly sales by customer and application, which is essential reading because it reveals [concentration risk](/concentration-risk/) and demand trends. Watch the company's quarterly conference calls for commentary on order backlog, which is a leading indicator of revenue in the near term. Because system sales are lumpy, a single large order can pull forward a quarter's revenue, making year-over-year growth rates potentially misleading; looking at trailing twelve-month results smooths this volatility.

Key metrics to track are gross margin (which reflects manufacturing efficiency and pricing power), [return on assets](/return-on-assets/) (which shows how efficiently the company deploys its [balance sheet](/balance-sheet/)), and [free cash flow](/free-cash-flow/) (which indicates how much actual cash the business generates after capital investments). Sono-Tek has historically been profitable and generated positive cash flow, a rarity among small-cap manufacturers, but this depends on maintaining margins and controlling inventory as sales grow.
