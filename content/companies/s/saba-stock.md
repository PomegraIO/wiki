---
title: "Saba Capital Income & Opportunities Fund II (SABA)"
description: "A closed-end fund that invests in other closed-end funds and private vehicles pursuing income and alternative strategies, created when Saba Capital Management took over the Templeton Global Income Fund in 2023."
keywords:
  - closed-end fund
  - income strategy
  - CEF investing
...
<table>
<tr><th>Ticker</th><td>SABA (NYSE)</td></tr>
<tr><th>Fund Type</th><td>Closed-end management investment company</td></tr>
<tr><th>Investment Adviser</th><td>Saba Capital Management, L.P.</td></tr>
<tr><th>Adviser Founder</th><td>Boaz Weinstein (2009)</td></tr>
<tr><th>Investment Focus</th><td>Fund of funds; CEFs, private credit, real estate, equity</td></tr>
<tr><th>Distribution Goal</th><td>High current income with secondary capital appreciation</td></tr>
<tr><th>SEC CIK</th><td>0000828803</td></tr>
</table>
</aside>

## The transition that created SABA

Before becoming the Saba Capital Income & Opportunities Fund II, this vehicle was the Templeton Global [Income Fund](/income-fund/), a closed-end fund that had operated for decades under Franklin Templeton's management. In late 2023, the fund's governance changed hands entirely. Saba Capital Management took over as the investment adviser, and the fund's mandate shifted. The investment program moved away from Templeton's traditional global income approach toward Saba's quantitative and fundamental strategy of identifying and exploiting pricing inefficiencies across markets.
...
The stated mandate is high current income first, with capital appreciation as a secondary goal. This ordering matters. The fund targets distributions that exceed what a simple basket of [bonds](/bond/) or dividend-paying stocks might deliver, which typically requires either bearing more risk, harvesting complexity premiums (buying things that are harder to price accurately), or both.
...
The fund sits at an unusual point in the financial architecture. Downstream, it serves individual and institutional investors seeking current income and is accountable to its shareholder base. Upstream, it holds a portfolio of funds and private vehicles that themselves depend on underlying operating companies, loans, and real assets to generate returns. A [recession](/recession/) that reduces corporate earnings hits the funds SABA owns, which then impacts SABA's distributions. A [credit event](/credit-event-sovereign/) that impairs loan performance in a private credit fund flows through to SABA's net asset value.

The fund's income depends on the income generated by its portfolio holdings, which in turn depends on the health of the broader economy and financial system. SABA thus has significant leverage to economic cycles and [credit spreads](/credit-spread/). In benign environments, the nested structure and [diversification](/diversification/) can smooth volatility; in severe downturns, leverage and concentration within the underlying funds can amplify losses.
