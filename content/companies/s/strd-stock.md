---
title: "Strategy Inc (STRD)"
description: "A publicly traded software analytics company transformed into a bitcoin treasury vehicle through multiple preferred stock classes designed to fund large-scale cryptocurrency acquisitions."
keywords:
  - bitcoin treasury
  - software analytics
  - preferred stock
...
<table>
<tr><th>Company</th><td>Strategy Inc (formerly MicroStrategy)</td></tr>
<tr><th>Founder</th><td>Michael J. Saylor (1989)</td></tr>
<tr><th>Original sector</th><td>Business intelligence / analytics software</td></tr>
<tr><th>Current strategy</th><td>Bitcoin treasury accumulation and software</td></tr>
<tr><th>Bitcoin holdings</th><td>Significant and growing (as of recent reports)</td></tr>
<tr><th>STRD type</th><td>Preferred stock class for capital raising</td></tr>
</table>
</aside>

## From business intelligence software to bitcoin reserve
...
Strategy Inc still operates its core analytics software. The enterprise data governance problem—helping large organisations enforce consistent definitions and quality standards across fragmented data sources—is real and enduring. The software business generates sufficient cash to function as a standalone operation and to fund the company's overhead.

However, the software business is no longer the growth story or the primary focus. Analyst calls emphasise bitcoin acquisition rates and treasury holdings, not software revenue or user wins. The software business has become a cash generator that funds the bitcoin strategy rather than the strategic driver itself. This reframing is crucial to understanding the company's risk profile: if the software business were to decline substantially, the company would either need to slow bitcoin acquisitions or raise capital in alternative ways. Conversely, if bitcoin prices collapse, the software business' stability becomes the company's only reliable cash flow—and at current scale, that cash flow alone would not support the current capital structure.

## The risks are structural, not operational

The primary risk to STRD holders is not that the software business will fail—it is mature and stable. The risk is that the strategy itself fails. If bitcoin does not perform as the company expects, the entire capital structure becomes overleveraged. If capital markets tighten and the company cannot raise additional capital to sustain bitcoin purchases, it must cut acquisitions. If regulatory pressure on bitcoin or on the company's activities intensifies, it could affect both the software business and the treasury strategy.
...
For STRD investors, the relevant questions are: Does bitcoin appreciate in the long term? Can the company sustain capital raising to support continued acquisitions? How much leverage is prudent at the preferred level? These questions sit outside traditional company analysis. They are asset-class bets wrapped in a corporate vehicle. The software business is now secondary context rather than the primary story.

The company publishes its bitcoin holdings quarterly, which is the most material metric for assessing execution. The capital structure, debt levels, and cash available for new acquisitions are the other critical inputs. Beyond that, STRD's value turns on bitcoin's future and the company's ability to attract capital to pursue its strategy rather than on software operational metrics.
