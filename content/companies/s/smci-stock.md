...
description: "Super Micro makes computer servers and components for data centers, sold to cloud providers, enterprises, and hyperscalers that need high-performance, power-efficient hardware."
keywords:
  - server hardware
...
<table>
<tr><th>Ticker</th><td>SMCI (NASDAQ)</td></tr>
<tr><th>Founded</th><td>1993, San Jose, California</td></tr>
<tr><th>Headquarters</th><td>San Jose, California</td></tr>
<tr><th>Sector</th><td>Computer hardware / data center infrastructure</td></tr>
<tr><th>Customer base</th><td>Hyperscalers, enterprises, hosting providers</td></tr>
<tr><th>Business model</th><td>Manufacture and design of custom servers and components</td></tr>
<tr><th>SEC CIK</th><td>0001375365</td></tr>
</table>
</aside>
...
Super Micro does not make the chips that go inside servers (those are made by [Intel](/intc-stock/), AMD, [Nvidia](/nvda-stock/), and others). What Super Micro does is design the frame and power delivery system, the cooling, the storage connectivity, and the assembly of all the pieces into a finished machine. The company allows customers to configure servers to their exact specifications: how many processor sockets, how much memory, what kind of storage, what networking. This customization is powerful because a cloud provider does not need a generic server. It needs a server optimized for its particular workload, whether that is machine learning (which wants lots of GPU compute), database work (which wants lots of memory and fast storage), or web serving (which is different again).
