---
title: "Horizon Kinetics SPAC Active ETF (SPAQ)"
description: "An actively managed ETF that selects and invests in SPACs, blank-check companies, and the private companies that merge with them, seeking equity-like returns with active oversight."
keywords:
  - SPAC
  - blank-check company
...
*The [Horizon Kinetics](/hkhc-stock/) SPAC [Active ETF](/active-etf/) (ticker SPAQ) takes a direct and deliberate approach to a corner of capital markets that many investors find confusing or risky: it buys and manages a portfolio of Special Purpose [Acquisition](/acquisition/) Companies — blank-check firms created solely to acquire a private business and take it public — and the newly merged public companies that result.*

<aside class="wiki-infobox">

<div class="wiki-infobox-title">SPAC ETF — key facts</div>

<img src="https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=600&q=80" alt="Trading screen showing stock tickers and price data." />

<div class="wiki-infobox-caption">Active management requires constant reassessment of emerging and recently merged SPAC-backed companies.</div>

|   |   |
|---|---|
| **What it tracks** | SPACs before and after merger, and the private companies that merge with them |
| **Strategy type** | Active selection, not index-tracking |
| **Sponsor** | Horizon Kinetics |
| **Fund structure** | Standard ETF, long-only, daily trading |
| **Costs** | Actively managed — expense ratio higher than passive alternatives |
| **Who it targets** | Investors seeking exposure to private-to-public transitions |
| **Core risk** | Merger failure, post-merger underperformance, SPAC sponsor conflicts |

</aside>

## What a SPAC is, and why an ETF manages them

A Special Purpose Acquisition Company begins life as a shell — a legal entity created by sponsors and investors for a single purpose: to raise capital, then hunt for a suitable private company to acquire and merge with. In a traditional [initial public offering](/initial-public-offering/), a private firm goes public on its own; with a SPAC, the private firm merges into the shell and emerges as a public company without the underwriter-led roadshow. The SPAC itself disappears into the [merger](/merger/); shareholders of the SPAC become shareholders of the new public firm, which often retains the SPAC sponsor's name or a variation of it.
...
SPAQ is a conventional ETF traded on an exchange throughout the trading day. It is long-only — it does not use leverage or inverse strategies — and holds common equity, not debt or preferred shares. Shareholders own fund shares at [net asset value](/net-asset-value/) and can trade those shares at market prices. The fund has an [expense ratio](/expense-ratio/) reflecting its active-management costs, which will be materially higher than a passive index ETF's ratio.
...
It is not appropriate for conservative investors seeking stable [dividend](/dividend/) income or capital preservation. SPACs are inherently speculative, and an ETF holding them can experience extended drawdowns, particularly during periods when merger activity slows or recent mergers disappoint.
