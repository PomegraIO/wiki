...
description: "A leveraged inverse ETF providing three times the daily inverse return of the NASDAQ-100 index; used by traders to hedge tech-heavy portfolios or profit from short-term downturns, not a buy-and-hold investment."
keywords:
  - inverse ETF
  - leveraged
  - short NASDAQ
...
The critical constraint is daily reset. SQQQ recalibrates its positions every evening so that its [leverage ratio](/leverage-ratio-forex/) (3×) applies to the next day's movement alone. This matters enormously for any holding longer than a single day because of something called volatility decay.
...
The decay accelerates with volatility. In calm, trending markets, the effect is modest. In choppy, whipsaw-prone conditions, it is severe. This is why SQQQ's prospectus and every [broker](/broker/) platform warns that the fund is unsuitable for [holding periods](/holding-period/) longer than a few days and is likely to lose value even if the NASDAQ-100 ultimately falls over that extended horizon.

## Costs and risks

SQQQ trades on the NASDAQ during regular hours with tight [bid-ask spreads](/bid-ask-spread/), meaning investors can enter and exit quickly without large slippage. The [expense ratio](/expense-ratio/) is high relative to a plain [index fund](/index-fund/), reflecting both the cost of the leverage and the ongoing roll costs of the derivatives positions.
...
It is not a buy-and-hold investment. Financial advisors universally warn retail investors against holding inverse or [leveraged ETFs](/leveraged-etf/) for periods longer than a week, and most recommend days only. A long-term investor in a technology-heavy portfolio who is genuinely concerned about downside has better options: buying [put options](/put-option/) on the QQQ ETF (which captures NASDAQ-100 exposure) for a specific term, or simply trimming tech exposure and moving the proceeds to other asset classes.
