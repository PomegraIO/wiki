---
title: "Siemens Energy AG (SMEGF)"
description: "A German power generation and energy infrastructure company spun out from Siemens, navigating rapid change in global energy systems toward renewable and decentralised solutions."
keywords:
  - power generation
...
Siemens Energy is listed on the Frankfurt [Stock Exchange](/stock-exchange/) and trades as an ADR under SMEGF on [over-the-counter markets](/over-the-counter-market/) in the United States (SEC CIK 0001830056). The company has a significant debt load relative to earnings, a legacy of its spin-out from Siemens and a reflection of the capital requirements of its businesses.
