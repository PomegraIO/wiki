---
title: "Grayscale Stacks Trust (STCK)"
description: "A cryptocurrency trust that holds and manages Stacks, a blockchain layer built on top of Bitcoin designed to enable smart contracts and decentralized applications on the Bitcoin network."
keywords:
  - stacks
  - STX
  - bitcoin layer 2
...
Grayscale Stacks Trust (ticker: STCK on [NASDAQ](/nasdaq/), managed by the Grayscale subsidiary of Digital Currency Group) holds Stacks tokens and offers investors a regulated way to gain exposure to the Stacks network without managing cryptocurrency directly. Stacks is a blockchain layer that sits on top of [Bitcoin](/bitcoin/), designed to bring smart-contract capability and decentralized applications to the Bitcoin ecosystem. Grayscale's trust structure allows shares to trade on an exchange while the underlying Stacks are held in institutional-grade custody.

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>STCK (NASDAQ)</td></tr>
<tr><th>Sponsor</th><td>Grayscale Investments (Digital Currency Group)</td></tr>
<tr><th>Underlying asset</th><td>Stacks (STX) cryptocurrency</td></tr>
<tr><th>Fund structure</th><td>Cryptocurrency trust, closed-end</td></tr>
<tr><th>Trading mechanism</th><td>Secondary market only; share price premium/discount to NAV</td></tr>
<tr><th>SEC CIK</th><td>0002024996</td></tr>
</table>
</aside>
