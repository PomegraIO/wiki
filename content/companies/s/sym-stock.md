...
description: "Symbotic is an industrial automation company that designs and builds warehouse-automation systems, including robotics and software, for retail and logistics customers. A growth-stage operator in a rapidly expanding market for supply-chain optimization."
keywords:
...
<table>
<tr><th>Ticker</th><td>SYM (NASDAQ)</td></tr>
<tr><th>Founded</th><td>2011, Cuyahoga Falls, Ohio</td></tr>
<tr><th>Headquarters</th><td>Cuyahoga Falls, Ohio</td></tr>
<tr><th>CEO</th><td>Rick Faulkner</td></tr>
<tr><th>Main product</th><td>Goods-to-person picking systems, automated conveyors, software control platforms</td></tr>
<tr><th>Key customers</th><td>Large retailers (e.g., Walmart, Target); logistics operators; regional distributors</td></tr>
<tr><th>Delivery model</th><td>Integrated project contracts; custom design and construction</td></tr>
<tr><th>SEC CIK</th><td>0001837240</td></tr>
</table>
</aside>
...
This is why Symbotic is a project-services company, not a product company. Each installation is unique and fairly bespoke. A [Walmart](/wmt-stock/) distribution center in Ohio is not the same as a [Target](/tgt-stock/) fulfillment center in Texas, even if the core technology is similar. That model means Symbotic's revenue comes in through large, lumpy project contracts (millions of dollars per implementation) rather than a steady stream of identical product sales. It also means the company needs skilled engineers to design each system, which limits how fast it can scale.
...
Profitability on a project depends on how well Symbotic can control engineering and manufacturing costs. The gross margins on individual projects vary, but the company targets an [operating margin](/operating-margin/) of 10–15 percent at scale, typical for industrial integrators. The challenge is that projects are lumpy — when a big customer puts in an order, revenue and costs accelerate; between projects, the company incurs costs to maintain the team and prepare for the next phase.
...
Finally, consolidation is a risk. Symbotic is large enough to be visible but still small enough to be an [acquisition](/acquisition/) target for one of the multinational players. If ABB or Siemens decide that warehouse automation is sufficiently important to their future, they could buy the company and integrate it into their larger business. That possibility is a permanent cloud over the stock.
