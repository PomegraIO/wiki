---
title: "SAIHEAT Ltd (SAIHW)"
description: "SAIHEAT is a Singapore-based data center thermal management company developing heat recovery and liquid cooling systems for high-performance computing infrastructure and power generation technology."
keywords:
  - data center cooling
  - thermal management
  - heat recovery
...
SAIHEAT Limited, headquartered in Singapore and listed on the [NASDAQ](/nasdaq/) under the ticker SAIHW, operates at the intersection of data center infrastructure and energy recovery. The company builds and integrates thermal management systems designed to capture and repurpose waste heat from computing facilities, turning an operational cost into a usable resource. As computing demands intensify and energy constraints tighten, SAIHEAT's core challenge is converting a fundamental inefficiency of modern data centers—their substantial thermal output—into a competitive advantage through engineering.

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>SAIHW (NASDAQ)</td></tr>
<tr><th>Founded</th><td>Originally SAI.TECH Global Corporation; rebranded to SAIHEAT</td></tr>
<tr><th>Headquarters</th><td>Singapore</td></tr>
<tr><th>Sector</th><td>Data center infrastructure, thermal management</td></tr>
<tr><th>Primary focus</th><td>Liquid cooling and waste heat recovery systems</td></tr>
<tr><th>Business model</th><td>Hardware manufacturing and system integration</td></tr>
<tr><th>SEC CIK</th><td>0001847075</td></tr>
</table>
</aside>
...
For now, the company derives the bulk of its revenue from HEATWIT. In [fiscal year](/fiscal-year-definition/) 2024, SAIHEAT reported total revenues of approximately 5.5 million dollars, with mining-related revenue (liquid cooling solutions sold to cryptocurrency mining operations) growing sharply year-over-year. A major contract with [Bitdeer Technologies](/btdr-stock/) Group exemplifies this revenue model: SAIHEAT agreed to supply 40 megawatts of liquid-cooling containers to host mining equipment at a new data center, with deliveries commencing in spring 2025. Each container that ships represents an upfront payment, though the long-term stickiness of the customer relationship depends on solving the thermal problem reliably and cost-effectively.
