---
title: "GraniteShares Autocallable SMCI ETF (SCA)"
description: "SCA is a structured exchange-traded product that tracks Super Micro Computer shares through an autocallable note mechanism, providing modified exposure with conditional early redemption."
keywords:
...
<table>
<tr><th>Ticker</th><td>SCA</td></tr>
<tr><th>Type</th><td>Structured ETF (autocallable note)</td></tr>
<tr><th>Sponsor</th><td>GraniteShares</td></tr>
<tr><th>Underlying</th><td>Super Micro Computer (SMCI) stock</td></tr>
<tr><th>Structure</th><td>Conditional redemption mechanism</td></tr>
<tr><th>Primary risk</th><td>Early call risk and price discontinuity</td></tr>
<tr><th>Trading venue</th><td>Exchange-traded</td></tr>
</table>
</aside>

## What an autocallable structure means

GraniteShares has wrapped Super Micro Computer shares in something called an autocallable note. This is not a simple fund that buys and holds SMCI. Instead, it is a bond-like security that is tied to SMCI's price performance. The key feature is the autocall: if the stock hits a certain price level on a given observation date, the fund redeems itself early and pays you back.

This sounds like it might be good — you get paid out ahead of schedule. But autocallables are a complex instrument with a built-in tension: the feature that benefits the issuer (GraniteShares gets to close the position early when SMCI soars) cuts against the investor. If SMCI shoots up and triggers an autocall, you get called away at a fixed price, meaning you miss out on further upside. You were supposed to have a five-year investment, but if the stock does spectacularly well in year two, you are forced out.
...
## Why GraniteShares structures this way
...
The most important comparison is this: if you buy SCA, you are accepting capped upside and full downside risk, plus you are betting on GraniteShares' creditworthiness. If you buy SMCI directly, you have unlimited upside and participate symmetrically in downside, and you have no issuer risk. That trade-off is the core decision to make.