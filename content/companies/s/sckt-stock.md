---
title: "Socket Mobile, Inc. (SCKT)"
description: "Socket Mobile manufactures mobile data-capture devices — barcode scanners and card readers — designed to connect wirelessly to smartphones and tablets for enterprise and retail applications."
keywords:
...
<aside style="border: 1px solid #ddd; padding: 16px; margin: 20px 0; background-color: #f9f9f9;">
...
| **Core products** | SocketScan barcode scanners, card readers |
| **Primary markets** | Retail, field service, logistics, healthcare |
| **Business model** | Hardware sales; recurring SaaS management platform |
| **Ticker** | SCKT (NASDAQ) |
| **SEC CIK** | 0000944075 |
