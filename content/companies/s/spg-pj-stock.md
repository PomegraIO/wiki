---
title: "Simon Property Group Inc. (SPG-PJ)"
description: "Simon Property Group is the largest owner and operator of shopping malls and outlet centers in the United States, operating through a real estate investment trust structure with stable rental income from tenants."
keywords:
  - shopping malls
  - retail real estate
  - REIT
...
**How the rental model works.** Retailers lease space in Simon's properties under long-term leases, typically three to five years with renewal options. Rent is usually structured as a base rent (fixed) plus [percentage rent](/percentage-rent/) (a percentage of the tenant's sales above a threshold). The percentage rent is particularly valuable in good economic times when retailers are selling strongly; in [recessions](/recession/), the percentage rent declines but the base rent provides a floor. This structure aligns Simon's interests with the retailers' success — if the mall is thriving, both do well.
...
**The economics of a REIT.** Simon is structured as a REIT, which means it avoids corporate-level income tax by distributing most of its net income to shareholders as dividends. This tax advantage makes REITs attractive to income-seeking investors, and it is a major reason Simon trades as a REIT. The downside is that the company cannot retain large amounts of capital for growth or [acquisitions](/acquisition/) — most cash must go to shareholders. This limits Simon's financial flexibility.
