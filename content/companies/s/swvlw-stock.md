---
title: "Swvl Holdings Corp. (SWVLW)"
description: "Swvl is a Dubai-based intercity and intracity transportation platform offering app-based ride reservations and B2B mobility solutions, with primary operations in Egypt and expanding presence across multiple continents."
keywords:
  - transportation
  - mobility
  - Egypt
...
Swvl's shares trade on Nasdaq, and its price reflects investors' expectations about profitability, the durability of the Egypt market, and the company's ability to replicate its success in other geographies. The business is not immune to macroeconomic pressures—fuel prices, [inflation](/inflation/), and currency movements in emerging markets all flow through to the company's results. For investors, the key insight is that Swvl is fundamentally a geography-dependent business: it is only as strong as the markets where it operates and the partnerships it builds within them.
