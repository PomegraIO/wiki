---
title: "SBA Communications Corp. (SBAC)"
description: "SBA Communications owns and operates cell towers and wireless infrastructure across the United States and internationally — a critical middleman between wireless carriers and the mobile networks that reach customers."
keywords:
  - cell towers
...
SBA Communications is a tower company. It owns and operates thousands of cell towers and antenna structures that broadcast wireless signals across the United States, Puerto Rico, and a handful of other markets. The company does not run a wireless network or sell service to consumers. Instead, it leases space on its towers to the major carriers — Verizon, AT&T, T-Mobile, and others — who mount their antennas there and pay SBA a monthly rent. That business generates steady, predictable cash and has become one of the steadiest income engines in the telecommunications sector.

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>SBAC (NASDAQ)</td></tr>
<tr><th>Founded</th><td>1989, Lakewood, Florida</td></tr>
<tr><th>Sector</th><td>Wireless infrastructure</td></tr>
<tr><th>Primary assets</th><td>Cell towers, antenna structures</td></tr>
<tr><th>Business model</th><td>Monthly lease payments from carriers</td></tr>
<tr><th>Key customers</th><td>Verizon, AT&T, T-Mobile, other carriers</td></tr>
<tr><th>Geographic focus</th><td>United States, Puerto Rico, Mexico, Central America</td></tr>
<tr><th>SEC CIK</th><td>0001034054</td></tr>
</table>
</aside>
...
SBA's core asset is the tower itself. The company owns the physical structure — a steel lattice or guyed tower, or sometimes just a rooftop or wall that antennas can mount on — and owns the land it sits on. That is critical: the land is often rented on a long-term lease from the owner of the building or property, but SBA controls the tower.
...
SBA faces a few structural headwinds. First, growth in the U.S. tower market is slow. The market is mature, nearly fully built out, and dominated by three large players (SBA, Crown Castle, and American Tower) that collectively own more than half the towers in the country. New tower construction happens, but it is incremental.
...
Start with the company's 10-K (SEC CIK 0001034054) to understand the portfolio composition — how many towers in each region, what percentage of revenue comes from each carrier tenant, and how much revenue is at risk from expiring leases. The quarterly earnings calls surface trends in tenant additions (are carriers adding more antennas?), lease-renewal rates, and acquisition activity.

Key metrics include [funds from operations](/funds-from-operations/) (a cash-flow measure common in real estate and tower companies), the weighted-average lease term (how long until existing leases expire), and tenant concentration (what percentage of revenue comes from the top three carriers). A company with high tenant concentration is vulnerable if a major carrier changes strategy or reduces its footprint. One with a short weighted-average lease term faces a risk that renewal terms might be less favorable.

SBA also publishes metrics on tower augmentation — the number of existing towers where it added capacity to meet growing demand. That number signals whether the company can grow revenue from its existing asset base or whether it must build or acquire new towers to expand.
