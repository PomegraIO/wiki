---
title: "Strathcona Resources Ltd. (STHRF)"
description: "Strathcona Resources is a Canadian oil sands producer extracting bitumen from Alberta's Athabasca region, one of the world's largest proven crude oil reserves."
keywords:
  - oil sands
...
<table>
<tr><th>Ticker</th><td>STHRF (OTC Markets)</td></tr>
<tr><th>Founded</th><td>2021 (acquired operations from larger producers)</td></tr>
<tr><th>Headquarters</th><td>Calgary, Alberta, Canada</td></tr>
<tr><th>Sector</th><td>Oil and gas production</td></tr>
<tr><th>Primary asset</th><td>Athabasca oil sands mining and extraction operations</td></tr>
<tr><th>Primary product</th><td>Bitumen (converted to synthetic crude oil)</td></tr>
<tr><th>SEC CIK</th><td>0002068441</td></tr>
</table>
</aside>
...
Investors should start with the company's annual and quarterly reports filed in Canada and through its SEC filings (CIK 0002068441). Watch the company's unit production (barrels per day), its realized price per barrel (the actual cash received after sales), and its operating costs per barrel — the difference between price and cost is the daily margin. Track crude oil prices as a [leading indicator](/leading-indicator/): when Brent or [WTI crude](/wti-crude/) rises sharply, Strathcona's cash flow and profitability tend to follow within quarters.
