---
title: "Swisscom AG (SCMWY)"
description: "Swisscom is Switzerland's dominant mobile and fixed-line telecommunications provider, delivering cellular service, broadband, and TV to millions of customers across the country."
keywords:
  - telecommunications
  - switzerland
  - mobile networks
...
| What it is | Switzerland's largest telecommunications operator |
|---|---|
| Ticker | SCMWY (NYSE), SCMN (SIX Swiss Exchange) |
| Headquarters | Zurich, Switzerland |
| Founded | 1998 (privatized from Swiss PTT) |
| Sector | Telecommunications |
| Market | ~4 million mobile customers; ~2 million fixed-line subscribers |
| Business model | Mobile networks, fixed broadband, television, business services |
| Regulatory environment | Swiss OFCOM oversight; mature, stable market |
