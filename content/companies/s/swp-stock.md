---
title: "SWP Growth & Income ETF (SWP)"
description: "SWP is an actively managed U.S. equity ETF targeting dividend-paying stocks with growth potential, using a diversified portfolio and opportunistic covered-call strategies."
keywords:
...
*The SWP Growth & [Income ETF](/income-etf/) is an [actively managed fund](/actively-managed-fund/) for investors who want stocks that pay [dividends](/dividend/) but also have room to appreciate over time. Rather than following a preset index, the manager uses research and judgment to choose dividend-paying companies with solid earnings growth and reasonable valuations, and it supplements income through systematic covered-call writing—selling [call options](/call-option/) on the stocks it already holds to collect additional premium.*

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>SWP (NASDAQ)</td></tr>
<tr><th>Launch date</th><td>2024</td></tr>
<tr><th>Manager</th><td>Actively managed</td></tr>
<tr><th>Portfolio focus</th><td>Dividend-paying U.S. equities</td></tr>
<tr><th>Strategy focus</th><td>Growth plus covered-call income</td></tr>
<tr><th>Portfolio size</th><td>40–70 holdings</td></tr>
</table>
</aside>
...
The fund is willing to own [preferred stocks](/preferred-stock/) and convertible debt securities alongside [common stocks](/common-stock/), as long as they meet the income criterion. This flexibility allows exposure to other income-generating instruments without straying from the core equity thesis.

## Covered-call income

Where SWP differs from a passive dividend fund is its use of covered-call options. A [covered call](/covered-call/) is a strategy where you own a stock and sell someone the right to buy it at a fixed price by a certain date; in return, you keep the premium they pay. SWP does this opportunistically on some of the stocks in its portfolio, writing calls when the manager judges the market has moved far enough to justify giving up some upside in exchange for immediate income.
...
SWP trades as an ETF, meaning daily liquidity at market prices throughout the trading day, unlike a traditional [mutual fund](/mutual-fund/) that prices once per day at market close. The fund is passively traded, so an investor can enter and exit without paying active trading costs. The [expense ratio](/expense-ratio/) reflects the overhead of active management and option writing, which is higher than a passive dividend ETF but reflects the value the manager's research and tactical option income are meant to add.
