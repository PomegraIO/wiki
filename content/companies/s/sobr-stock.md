---
title: "SOBR Safe, Inc. (SOBR)"
description: "SOBR Safe is a transdermal alcohol-monitoring company offering wearable and stationary devices for fleet safety, workplace compliance, and criminal-justice probation monitoring."
keywords:
  - alcohol monitoring
...
Start with the 10-K filing and quarterly earnings reports. Look for growth in the active-device installed base—this is the [leading indicator](/leading-indicator/) of revenue. Watch for customer [concentration risk](/concentration-risk/): if a single probation system or fleet operator represents 20% or more of revenue, that's a concentration risk that should influence valuation. Track gross margin on recurring revenue: high-margin subscriptions are the company's profit engine.
