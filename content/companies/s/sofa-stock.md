---
title: "Direxion Daily SOFI Bull 2X ETF (SOFA)"
description: "SOFA is a daily-reset 2x leveraged ETF tracking SoFi, the digital personal-finance platform, designed for short-term traders seeking amplified daily exposure with the understanding that daily rebalancing creates volatility decay over longer periods."
keywords:
  - leveraged ETF
  - SoFi
  - fintech
...
*"Volatility decay is the hidden tax that catches leveraged-ETF holders unaware."* This maxim captures the core dynamic of SOFA, a daily-reset, 2x leveraged fund tracking SoFi, the fintech lending and banking platform. The fund is built to capture twice the daily percentage moves of SoFi shares, a structure that rewards tactical traders but punishes longer-term holders who fail to understand the mechanics.
...
Each trading day at market close, Direxion rebalances SOFA's holdings to ensure the fund enters the next trading day positioned to deliver exactly 2x the next day's move in SOFI. This daily reset is not discretionary or advisory; it is mechanical and automatic.

The daily reset creates a critical consequence: SOFA does not reliably deliver 2x the total return of SOFI over a multi-week or multi-month period. Instead, it compounds the 2x daily returns day by day. When SOFI's price is volatile — rising and falling sharply on different days — this daily compounding interacts with the price swings in a way that typically erodes value over time. The longer an investor holds SOFA and the more volatile SOFI becomes, the more pronounced this erosion tends to be.

## Volatility decay explained through a real scenario

Consider a hypothetical week in which SOFI trades choppily: down 5%, up 6%, down 4%, up 5%, up 3%. The stock ends the week up roughly 3.5% overall. SOFA, tracking 2x daily moves, falls 10% on day one, rises 12% on day two, falls 8% on day three, rises 10% on day four, and rises 6% on day five. Compounding those daily returns, SOFA ends the week down approximately 2% — a loss from volatility decay, even though SOFI gained.

This dynamic worsens in high-volatility environments. SoFi, as a fintech company, has experienced significant stock-price swings tied to interest-rate expectations, earnings surprises, and changes in the competitive or regulatory landscape for consumer lending. These swings compound to erode SOFA's value over time, even if SOFI's long-term trend is upward.
