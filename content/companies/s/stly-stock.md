---
title: "HG Holdings, Inc. (STLY)"
description: "A title insurance underwriter and real estate services provider serving homebuyers, lenders, and property professionals across the United States."
keywords:
  - title insurance
  - real estate
  - title underwriting
...
<table>
<tr><th>Ticker</th><td>STLY (NASDAQ)</td></tr>
<tr><th>Founded</th><td>1924 as Stanley Furniture Company</td></tr>
<tr><th>Renamed</th><td>2018, pivoted to title insurance and real estate</td></tr>
<tr><th>Sector</th><td>Title insurance, real estate services</td></tr>
<tr><th>Headquarters</th><td>Charlotte, North Carolina</td></tr>
<tr><th>Business Model</th><td>Title underwriting, escrow services, advisory</td></tr>
<tr><th>Key Metrics</th><td>$14.7M TTM revenue, 96.7% gross margin</td></tr>
<tr><th>SEC CIK</th><td>0000797465</td></tr>
</table>
</aside>
...
Scale is not everything in this business. Title insurance profits depend on underwriting discipline and the ability to manage [tail risk](/tail-risk/) (unexpected claims years after a closing), not on brand awareness or the network effects that dominate software or digital platforms. A small, focused title company can be perfectly profitable if it manages risk well and maintains operational discipline.
...
Also examine the composition of the customer base. If a single mortgage lender or real estate broker is responsible for an outsized share of volume, HG Holdings faces [concentration risk](/concentration-risk/) — losing that customer would be catastrophic. The advisory services segment is worth watching as well; it is high-margin work that could be a vector for growth if the company can attract clients beyond its existing title underwriting base.
