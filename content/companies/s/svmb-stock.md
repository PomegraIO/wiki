---
title: "Jingbo Technology, Inc. (SVMB)"
description: "Jingbo Technology is a Chinese software company specializing in smart parking systems—cloud-based platforms and IoT sensors that help parking operators manage facilities more efficiently. Its shares trade over-the-counter under the ticker SVMB."
keywords:
  - smart parking
...
Because Jingbo trades over-the-counter, it has looser disclosure requirements than companies on major exchanges. The company's [annual report](/10-k/) and SEC filings (CIK 0001647822) are the primary source of information, though they are often sparse. Key information to seek out includes the breakdown of revenue by product line (parking systems vs. e-commerce), the geographic breakdown of sales, the rate of customer acquisition and retention, and detailed disclosures of cash flow and burn rate.
