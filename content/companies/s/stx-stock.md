---
title: "Seagate Technology Holdings plc (STX)"
description: "Seagate is the world's largest independent maker of hard drives and data-storage systems for servers, personal computers, and surveillance — a cyclical manufacturer defending legacy markets against flash memory."
keywords:
  - hard drives
  - data storage
  - hard disk drives
...
Seagate Technology is the dominant independent manufacturer of hard disk drives (HDDs) in the world, serving data centres, personal computers, gaming consoles, and surveillance cameras with storage systems that have remained mechanically sophisticated and economically vital even as flash memory has reshaped the industry. The company trades on [NASDAQ](/nasdaq/) under the ticker STX and operates as a single-product company in an era when most large tech firms are sprawling conglomerates — a position that both sharpens its competitive edge and concentrates its risk.

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>STX (NASDAQ)</td></tr>
<tr><th>Founded</th><td>1979, Scotts Valley, California</td></tr>
<tr><th>Headquarters</th><td>Fremont, California (US operations); incorporated Bermuda / plc structure</td></tr>
<tr><th>Sector</th><td>Data storage hardware manufacturing</td></tr>
<tr><th>Primary product</th><td>Hard disk drives (HDDs), enterprise storage arrays</td></tr>
<tr><th>Key markets</th><td>Data centres, cloud infrastructure, PCs, consumer electronics</td></tr>
<tr><th>Business model</th><td>Volume manufacturing and sales of physical storage media</td></tr>
<tr><th>SEC CIK</th><td>0001137789</td></tr>
</table>
</aside>
...
Key metrics include inventory turns, which signal demand strength, and the [debt-to-EBITDA ratio](/debt-to-ebitda-ratio/), which shows how much financial flexibility management retains. The capital-expenditure guidance matters too — a declining capex usually signals management's pessimism about future demand. The stock's valuation is typically tied to the [dividend yield](/dividend-yield/) and the [free cash flow](/free-cash-flow/) per share, making it a holding for income-focused investors rather than growth, and that positioning shapes how news flows affect the price.
