...
description: "Shinhan is South Korea's largest financial-services conglomerate, spanning retail and commercial banking, insurance, and investment. A dominant player in a mature, competitive banking market, it is built on customer relationships and institutional scale."
keywords:
...
<table>
<tr><th>Ticker</th><td>SHG (OTCMKTS, Seoul Stock Exchange KRX)</td></tr>
<tr><th>Founded</th><td>2001 (as reorganization of legacy Shinhan Bank, 1982)</td></tr>
<tr><th>Headquarters</th><td>Seoul, South Korea</td></tr>
<tr><th>Primary subsidiaries</th><td>Shinhan Bank, Shinhan Securities, Shinhan Insurance, Shinhan Card, Shinhan Capital</td></tr>
<tr><th>Market position</th><td>Largest banking group in South Korea by assets</td></tr>
<tr><th>Main revenue streams</th><td>Net interest income, fee income, insurance, securities commissions</td></tr>
<tr><th>SEC CIK</th><td>0001263043</td></tr>
</table>
</aside>
...
The founding of the modern Shinhan in 2001 was the result of a [merger](/merger/) between the legacy Shinhan Bank (founded in 1982) and the former Cho Hung Bank, a combination that created the banking group in its current form. The newly merged entity inherited a large customer base, an extensive branch network across South Korea, and a reputation for sound management. Two decades of [acquisition](/acquisition/) and organic expansion have made Shinhan the undisputed largest by assets, market share, and profitability among Korean banks.
...
The company also faces regulatory attention. South Korea has rules on interest rates, fees, and lending practices, and regulators actively monitor large banks' [capital adequacy](/capital-adequacy/) and lending patterns, particularly around risky segments like household debt. When regulators tighten credit standards or cap loan-to-value ratios, Shinhan's growth slows along with everyone else's.
...
Shinhan Financial Group files with the U.S. [Securities and Exchange Commission](/securities-and-exchange-commission/) as a foreign private issuer (SEC CIK 0001263043), and its annual Form 20-F filing provides a comprehensive picture of the group's business, revenue breakdown by segment and geography, risk factors, and management commentary. South Korean financial statements are also published on the Seoul [Stock Exchange](/stock-exchange/) and through Shinhan's investor relations website, which carries English versions of key documents.
