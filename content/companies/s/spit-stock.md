---
title: "F/m Emerald Special Situations ETF (SPIT)"
description: "A small-cap and micro-cap focused exchange-traded fund designed to track special situations and undervalued opportunities in U.S. equities with high conviction positioning."
keywords:
  - small-cap ETF
  - special situations
  - market inefficiency
...
<table>
<tr><th>Ticker</th><td>SPIT (NASDAQ)</td></tr>
<tr><th>Sponsor</th><td>F/m (Frisch's Management)</td></tr>
<tr><th>Fund type</th><td>Actively managed ETF (not index-tracking)</td></tr>
<tr><th>Focus</th><td>U.S. small-cap and micro-cap special situations</td></tr>
<tr><th>Structure</th><td>Transparent daily holdings; traded like a stock</td></tr>
<tr><th>Strategy</th><td>Value-oriented; concentrated positions</td></tr>
<tr><th>Trading venue</th><td>NASDAQ stock exchange</td></tr>
</table>
</aside>
...
The appeal of SPIT lies in its willingness to find value where others do not — the small-cap universe is less densely covered by sell-side analysts than the large-cap market, which can create pockets of genuine inefficiency. A skilled manager with a patient time horizon and deep fundamental research can exploit these gaps. Small-cap stocks also tend to be more volatile and illiquid than their large-cap peers, which creates both opportunity (greater return potential) and risk (sharper price swings).

The central risk is manager skill, which is not permanent. A manager's track record may reflect a period of favorable market conditions, lucky timing, or a style that worked in one cycle but breaks in the next. Because SPIT is concentrated, single position exits and entries can swing the fund's returns and direction meaningfully. The fund is also not suitable for investors seeking a stable, diversified core holding — it is a satellite position, typically for those with higher risk tolerance and a longer time horizon.

## How to research it

Start with the fund's prospectus and latest fact sheet, which lay out the fund's objective, strategy, and historical expense ratios. Check the holdings list (updated daily on the fund sponsor's website) to see what the current portfolio looks like and whether the manager's positioning makes sense to you. Review the fund's performance track record, but remember that past results do not predict future performance — look instead for consistency of approach and evidence of disciplined entry and exit decisions. If the fund has changed managers, recent performance may not represent the same strategy. The bid-ask spread and trading volume on NASDAQ can signal how liquid the fund is on any given day, which matters if you plan to trade it in size.
