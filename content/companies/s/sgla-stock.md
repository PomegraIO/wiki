---
title: "Sino Green Land Corp. (SGLA)"
description: "Sino Green Land Corp is a small-cap company that has transitioned from recycled plastics manufacturing in Malaysia to a shell company seeking acquisition—a case study in corporate drift and the absence of moat."
keywords:
  - recycled plastics
  - PET bottle flakes
  - HDPE pellets
...
In recent years, Sino Green Land has explicitly repositioned itself as a shell company or vehicle for [acquisition](/acquisition/). Current filings state that the company does not have significant operations and intends to seek a [merger](/merger/), capital [stock exchange](/stock-exchange/), asset acquisition, stock purchase, reorganization, or other [business combination](/business-combination-purchase/) with one or more companies. This is a formal acknowledgment of irrelevance: the company exists as a legal entity and a public shell, but it has no business and no near-term plans to operate one. Instead, it is a listed vehicle awaiting a buyer or a merger target.
