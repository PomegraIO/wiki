---
title: "Defiance Daily Target 2x Short MSTR ETF (SMST)"
description: "SMST is a 2x daily inverse ETF designed to profit from declines in MicroStrategy shares, using daily rebalancing to target minus 200 percent return exposure — a tactical trading tool, not buy-and-hold."
keywords:
  - inverse ETF
  - leveraged inverse
  - short MSTR
...
SMST is a bet against a single stock. Its only purpose is to move in the opposite direction of MicroStrategy Inc. (ticker MSTR), and to do so with two times the leverage. If MSTR falls 2 percent in a day, SMST targets a 4 percent gain. If MSTR rises 1 percent, SMST targets a 2 percent loss. It is neither an investment vehicle nor a hedge for a long MSTR position; it is a trading tool for tactical speculation on near-term declines.

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>SMST (NASDAQ)</td></tr>
<tr><th>Sponsor</th><td>Defiance ETFs</td></tr>
<tr><th>Type</th><td>Daily inverse leveraged ETF</td></tr>
<tr><th>Underlying</th><td>MicroStrategy Inc. (MSTR)</td></tr>
<tr><th>Leverage</th><td>-2x (inverse, daily reset)</td></tr>
<tr><th>Holding horizon</th><td>Intraday to a few days</td></tr>
<tr><th>Rebalancing</th><td>Daily</td></tr>
<tr><th>Cost profile</th><td>Expense ratio plus daily trading costs</td></tr>
</table>
</aside>
...
Here is where inverse and leveraged products hurt themselves: volatility decay. Imagine MSTR trades like this over three days: up 10 percent, down 10 percent, up 10 percent. Mathematically, the stock ends roughly where it started, but investors in SMST will have lost money.
...
## How to research SMST

Read the prospectus carefully, especially the section on daily rebalancing and volatility decay. Understand that this fund is not meant to be held for more than a few days; if you cannot commit to that discipline, avoid it. Observe MSTR's actual volatility: high-volatility stocks kill inverse funds through decay, so check historical data on MSTR's daily swings. Understand that you are betting not on MSTR's long-term direction, but on a near-term decline sharp enough to overcome both decay and costs. If you cannot articulate a specific, near-term catalyst for MSTR to fall, SMST is not for you.
