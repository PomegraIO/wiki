---
title: "Skyward Specialty Insurance Group, Inc. (SKWD)"
description: "Skyward Specialty Insurance provides niche commercial insurance solutions for hard-to-place risks, competing through underwriting expertise and proprietary technology rather than scale or brand recognition."
keywords:
  - specialty insurance
...
<table>
<tr><th>Ticker</th><td>SKWD (NASDAQ)</td></tr>
<tr><th>Founded</th><td>2018 (as Skyward Specialty Insurance; merged with Apollo mid-2025)</td></tr>
<tr><th>Headquarters</th><td>Stamford, Connecticut and London, England</td></tr>
<tr><th>Sector</th><td>Property and casualty insurance (specialty lines)</td></tr>
<tr><th>Business model</th><td>Underwriting, reinsurance, fee-based management services</td></tr>
<tr><th>Revenue composition</th><td>Gross written premiums, investment income, ceding commissions</td></tr>
<tr><th>SEC CIK</th><td>0001519449</td></tr>
</table>
</aside>

## Why specialty insurance exists

The insurance industry has long pursued a particular vision of efficiency: centralise underwriting, standardize rules, sell by volume, and rely on actuarial pooling to [spread risk](/spread-risk/). This works well for straightforward, high-volume classes—the personal auto policy, [homeowners insurance](/homeowners-insurance/), workers' compensation in a standardised form. But somewhere between 20 and 30 percent of the commercial insurance market is too heterogeneous for that playbook.

A construction firm building a unique project, a technology startup offering a new service, a medical practice with an unusual revenue model—these are not repeated risks that fit into an existing underwriting matrix. A general insurer approaches these either by declining them or by padding the premium to cover all the ways it might go wrong. Skyward and carriers like it approach them differently: by hiring underwriters who have spent years thinking about construction projects, [technology risks](/technology-risk/), or medical liability, and giving them authority to make judgement calls rather than apply formulae.
...
Lloyd's of London is itself a specialty-insurance ecosystem—a marketplace where syndicates (independent underwriting entities) place business through [brokers](/broker/). Apollo was a managing general agent there, which means it sourced business for syndicates, managed underwriting teams, and took or placed risk. The acquisition positioned Skyward to tap underwriting talent and client relationships in the London market while bringing Apollo's platform into Skyward's operating system.

The combined entity now labels itself Skyward Group, with Skyward Specialty (U.S.) and Apollo (Lloyd's) as operating divisions. The integration work is in progress. The risk is execution: [acquisitions](/acquisition/) in insurance often disappoint because they fail to preserve the underwriting talent and client relationships that made the target valuable in the first place.
