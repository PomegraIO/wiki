---
title: "Themes Cybersecurity ETF (SPAM)"
description: "An exchange-traded fund that tracks companies in cybersecurity, data protection, and digital safety across infrastructure, software, and services sectors."
keywords:
  - cybersecurity
  - ETF
...
SPAM constructs its portfolio by selecting among publicly traded cybersecurity firms, broadly defined. Holdings typically include vendors in network security (firewalls, VPNs, zero-trust architecture), endpoint protection (antivirus, malware prevention), identity and access management (single sign-on, privileged-user control), cloud security, application security, and incident response. The fund also captures exposure to major technology firms that derive a material portion of revenue from security products or whose core business includes threat prevention.

The fund's active-management mandate means the portfolio is curated, not automatically derived from an index. The managers select among dozens of available cybersecurity stocks, tilting the weightings toward firms they view as best positioned for the coming years. This differs from passive index-tracking ETFs, which would hold a fixed basket and rebalance mechanically.
...
SPAM appeals to investors convinced that cybersecurity spending will grow as a percentage of overall IT budgets, driven by persistent threats, regulatory mandates, and digital transformation across industries. It offers a way to gain exposure to the theme without picking individual stocks. Active management means the fund is suited for investors who believe professional managers can outperform a static index of the sector, though this comes with higher fees and less transparency about holdings at any given moment.

The fund is not appropriate as a core equity holding for buy-and-hold investors seeking low-cost, diversified exposure — a broad market ETF is better for that purpose. It is most naturally used as a tactical or thematic position by investors with conviction on cybersecurity's role in future IT spending.
