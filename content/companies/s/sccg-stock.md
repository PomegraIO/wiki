---
title: "Sachem Capital Corp. (SCCG)"
description: "Fixed-rate cumulative preferred shares of Sachem Capital Corp., a private real estate lender, offering senior priority on distributions and cumulative dividend rights."
keywords:
  - preferred stock
  - cumulative dividend
  - private lending
...
SCCG is a class of [preferred stock](/preferred-stock/) issued by [Sachem Capital](/sach-stock/) Corp., a private real estate lender. Preferred shares occupy a middle rung of the capital structure: they have higher priority than common equity in receiving [dividends](/dividend/) and in bankruptcy distribution, but lower priority than debt. Sachem Capital's preferred shares are cumulative, meaning any dividend payments not made in a given period accrue and must be paid before common shareholders receive anything. The dividend rate is fixed at issuance, typically ranging between 7–10% depending on the series and market conditions when issued. For income investors, preferred shares in lending companies represent a hybrid between [bonds](/bond/) and equity: higher yield than bonds, but subject to [credit risk](/credit-risk/) and less liquid trading than established debt securities.

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>SCCG (NASDAQ)</td></tr>
<tr><th>Issuer</th><td>Sachem Capital Corp. (SEC CIK 0001682220)</td></tr>
<tr><th>Share type</th><td>Cumulative preferred stock</td></tr>
<tr><th>Dividend</th><td>Fixed, cumulative (rate set at issuance)</td></tr>
<tr><th>Liquidation preference</th><td>Senior to common equity, subordinate to debt</td></tr>
<tr><th>Redemption</th><td>Callable by issuer at specified price</td></tr>
<tr><th>Voting rights</th><td>Generally limited unless dividends suspended</td></tr>
</table>
</aside>

## The preferred share structure

Sachem Capital, like many financial services and real estate companies, has issued multiple series of preferred stock to raise capital and optimize its cost of funds. Each series has its own terms: a fixed dividend rate, a redemption (call) price at which the company can repurchase the shares, and sometimes conversion rights into [common stock](/common-stock/) or other features. When an investor buys SCCG, they are buying into a specific series of Sachem's preferred shares, entitled to its stated fixed dividend paid quarterly, and ranking ahead of Sachem common shares if the company faces financial stress.
