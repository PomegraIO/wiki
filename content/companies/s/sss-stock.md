---
title: "Cyber Hornet S&P 500 and Solana 75/25 Strategy ETF (SSS)"
description: "An exchange-traded fund blending 75% S&P 500 large-cap equity exposure with 25% Solana cryptocurrency exposure via futures, seeking to capture both traditional market and digital-asset upside."
keywords:
  - cryptocurrency ETF
...
The Cyber Hornet S&P 500 and Solana 75/25 Strategy ETF represents an attempt to bridge two historically separate asset classes within a single tradable wrapper. Launched by Cyber Hornet ETFs LLC and trading on [NASDAQ](/nasdaq/) under the ticker SSS, the fund targets investors who view traditional equities and cryptocurrencies not as either-or propositions but as complementary components of a diversified portfolio. The core mechanism is straightforward in concept: allocate three-quarters of the fund to the [S&P 500 index](/sp-500-index/) and one-quarter to Solana (SOL), the blockchain network that competes with [Ethereum](/ethereum/) as a platform for decentralized applications and financial contracts.

## The structure and how it works

The fund uses a full-replication approach for its equity portion, meaning it holds the actual stocks that make up the S&P 500. For its Solana exposure, the fund does not hold the cryptocurrency directly on its [balance sheet](/balance-sheet/); instead, it maintains a position through derivatives. Specifically, the fund may use Solana [futures contracts](/futures-contract/) or other derivative instruments to gain exposure to the price movement of SOL without the complications of on-chain custody. To manage regulatory and tax complexity, Solana exposure is held through a wholly-owned Cayman Islands subsidiary, a structure common among funds seeking cryptocurrency derivatives.
...
SSS appeals to investors who believe in the long-term potential of both large-cap U.S. equities and Solana as an investment but who lack the infrastructure or comfort to hold cryptocurrency directly. The S&P 500 component provides a familiar anchor — [diversification](/diversification/) across 500 large-cap stocks spanning nearly every U.S. economic sector — while the Solana piece offers upside exposure to the digital-asset ecosystem, albeit through a single blockchain network rather than a broad basket of cryptocurrencies.
...
Using futures for Solana exposure introduces additional mechanics. Futures contracts have [expiration dates](/expiration-contracts/) and carry [basis risk](/basis-risk/) — the gap between the futures price and the actual spot price of Solana. Rolling futures (closing an expiring contract and opening a new one) incurs transaction costs and can occasionally lock in a loss if the futures curve is backwardated (near-term contracts trade at a premium). These frictions are real but typically small relative to the volatility of the underlying Solana price.
