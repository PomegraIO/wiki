---
title: "SPAC and New Issue ETF (SPCK)"
description: "A themed ETF that follows Special Purpose Acquisition Companies and newly public companies from IPOs and SPAC mergers, seeking exposure to the private-to-public transition opportunity set."
keywords:
  - SPAC
  - IPO
  - new issues
...
*SPAC and New Issue ETF (ticker SPCK) is a thematic product designed for investors who believe that newly public companies and the blank-check firms hunting for [acquisition](/acquisition/) targets offer an attractive pool of opportunities — and that the inefficiencies and repricing that occur immediately after a company goes public or merges with a SPAC can be exploited by a disciplined fund.*

## SPACs: the shell before the merger

SPACs dominate one portion of SPCK's portfolio. Before a SPAC merges with a private company, it is simply a shell — a publicly traded entity trading at or near its issue price, waiting for an acquisition announcement. SPCK captures this phase by holding SPACs that have not yet identified a target or have announced a deal but not yet closed it. The risk at this stage is [merger](/merger/) failure or severe shareholder dissent, which can push SPAC prices lower and even return capital to shareholders at a loss.
...
SPCK's managers must decide when to hold and when to exit each newly public company. The fund's turnover is likely to be high, since the [holding period](/holding-period/) for each position is often only months.

## Structure and portfolio dynamics

SPCK is a standard ETF with daily trading and no leverage or inverse strategies. As a thematic fund, it will have higher turnover and higher [expense ratios](/expense-ratio/) than passive broad-market alternatives. The fund's holdings shift constantly as SPACs merge, IPOs are issued, and holdings mature into ordinary public companies and age out of the fund.

[Concentration risk](/concentration-risk/) is notable: a fund holding only recently public companies misses the stability of mature firms and can be hit hard during downturns when new issues underperform. The IPO market is also cyclical, collapsing in [recessions](/recession/) and booming in [bull markets](/bull-market/), so SPCK's asset base and opportunity set fluctuate sharply with market conditions.
