---
title: "Scilex Holding Co (SCLXW)"
description: "A specialized biopharmaceutical company developing and commercializing non-opioid therapies for pain management, with approved products and a late-stage clinical pipeline."
keywords:
  - pharmaceutical
  - pain management
  - non-opioid
...
GLOPERBA is used for the prophylaxis of gout flares — that is, reducing the frequency of acute gout attacks in patients with chronic gout. Gout is caused by the buildup of uric acid crystals in joints, and GLOPERBA works by reducing uric acid levels. This product also came from [acquisition](/acquisition/) and represents the company's entry into the rheumatologic space.
