---
title: "ProShares Trust II (SVXY)"
description: "SVXY is an inverse volatility ETF that bets against stock-market turbulence, using derivatives to profit when fear recedes — a financial engineering product issued by ProShares that tracks a complex, rebalanced strategy rather than owning traditional assets."
keywords:
  - inverse volatility
  - volatility ETF
  - VIX derivatives
...
<table>
<tr><th>Ticker</th><td>SVXY (NASDAQ)</td></tr>
<tr><th>Issuer</th><td>ProShares Trust II</td></tr>
<tr><th>Fund manager</th><td>ProShares</td></tr>
<tr><th>Asset type</th><td>Inverse volatility ETF</td></tr>
<tr><th>Underlying strategy</th><td>Short VIX futures, daily rebalanced</td></tr>
...
SVXY is held mostly by professional traders, [hedge funds](/hedge-fund/), and sophisticated retail investors who view it as a tactical bet on the volatility regime. Few hold it as a core portfolio position. The fund's existence depends on ongoing capital from investors who believe [short volatility](/short-volatility/) is an undercompensated risk — that the market overprices fear and that patient capital can profit from mean reversion.
