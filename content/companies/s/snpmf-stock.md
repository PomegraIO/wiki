---
title: "China Petroleum & Chemical Corp (SNPMF)"
description: "China's second-largest state-owned oil and chemicals company. Operates from wellhead through refining, petrochemicals, and retail distribution — a vertically integrated energy producer capturing margins at every step from extraction to pump."
keywords:
  - petroleum
  - refining
  - petrochemicals
...
What shields Sinopec's refineries from pure commodity competition is location and integration. Its plants are positioned to serve domestic demand across China, and because it also owns the crude supply and the retail network that sells the output, it can optimize the whole chain rather than chasing the tightest [bid-ask spread](/bid-ask-spread/) on each refined product. That vertical integration is the moat — not an unbreakable one, but a meaningful edge in a commodity-heavy business.
...
The appeal of this segment is that it is less cyclical than pure fuel demand — demand for plastic resin continues even in [recession](/recession/) — and it can command higher per-ton prices than gasoline. The challenge is that it is global and competitive, so Sinopec must keep costs low to remain a credible supplier in world markets.
