---
title: "2x Solana ETF (SOLT)"
description: "A leveraged exchange-traded fund targeting twice the daily return of Solana tokens through derivative strategies and daily rebalancing, designed for short-term traders seeking amplified exposure to SOL price movements."
keywords:
  - solana etf
  - leveraged crypto
  - daily reset
...
SOLT's [expense ratio](/expense-ratio/) is substantial — typically 0.85% or higher annually. This rate reflects several layers of cost: Direxion's [management fee](/management-fee/), the cost of derivatives positions and hedging, rebalancing friction incurred daily, and potentially borrowing costs if any of the leverage is sourced through borrowing.
