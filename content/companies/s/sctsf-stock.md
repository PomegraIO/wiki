---
title: "Scottie Resources Corp. (SCTSF)"
description: "Scottie Resources is a junior precious metals explorer focused on gold and silver prospects in Canada. An early-stage mining company with assets in exploration, dependent on commodity prices and exploration success."
keywords:
  - gold exploration
  - junior mining
  - precious metals
...
Scottie, like most juniors, funds its exploration program through a combination of [share issuance](/share-issuance/) and occasional strategic partnerships. When capital markets favor mining, the company can raise money at reasonable dilution; when appetite for junior mining wanes (as it does in [bear markets](/bear-market/) for commodities), raising capital becomes expensive and the company must slow spending or merge with another explorer.
...
This makes Scottie inherently volatile and speculative. The company has no earnings, no revenue, and no path to profitability unless exploration is successful and the company either develops a property itself or sells it. The [intrinsic value](/intrinsic-value/) of such a company is almost impossible to calculate — it depends on: (a) the probability that exploration will succeed, (b) the size and grade of any deposit found, (c) future commodity prices, and (d) the [discount rate](/discount-rate/) applied to uncertain future cash flows. All of these are highly subjective.
...
The price of gold sets a ceiling on how much investors will pay for early-stage exploration. In a [bull market](/bull-market/) for gold, Scottie shares can soar on modest results; in a bear market, no amount of drilling progress will prop up the share price.
