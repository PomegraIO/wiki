---
title: "State Street Corp (STT)"
description: "State Street is a global custodian and asset servicing bank that holds securities and cash on behalf of institutional investors, manages trillions in assets under custody, and operates at the hidden core of modern finance."
keywords:
  - custodial bank
  - asset servicing
...
Regulatory risk is persistent. Financial regulators worldwide scrutinize custodians because they are systemically important, and new rules — capital requirements, [stress testing](/stress-testing/), [anti-money laundering](/anti-money-laundering/), reporting — routinely raise compliance costs. Brexit added complexity to UK operations. Sanctions and restrictions on dealing with certain countries impose operational friction.

Competition from other custodians is real but limited in scale: [Bank of New York Mellon](/bk-stock/) and Northern Trust are the other two tier-one global custodians, but together the three hold the vast majority of global institutional assets. A new entrant cannot easily displace any of them.
