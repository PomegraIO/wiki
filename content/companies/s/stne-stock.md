---
title: "StoneCo Ltd. (STNE)"
description: "StoneCo is a fintech company that helps small and medium-sized businesses in Brazil process payments, accept credit cards, and access financial services — a middleman that earns a percentage of every transaction it handles."
keywords:
  - fintech
  - payment processing
  - brazil
...
The company's [annual report](/10-k/) (SEC CIK 0001745431) shows the breakdown of revenue by source (acquiring, lending, financial services) and the merchant metrics: number of active merchants, transaction volume, average revenue per merchant. These metrics reveal whether StoneCo is growing its installed base and extracting more value from each merchant.

Watch the lending business carefully. Look at the size of the loan portfolio, the [default rates](/default-rate/), and any write-downs. A lending book that is growing faster than the merchant base is a red flag; it suggests the company is taking more risk than it realizes.
...
Pay attention to the economic cycle in Brazil. When the economy is growing and unemployment is falling, StoneCo's merchants spend more, borrow more, and stick around longer. In [recessions](/recession/), all of that reverses. The stock price can swing dramatically with macroeconomic expectations.
