---
title: "iShares 0-5 Year Investment Grade Corporate Bond ETF (SLQD)"
description: "SLQD is a bond ETF tracking the entire market of short-duration investment-grade corporate bonds, offering steady income with lower interest-rate risk than longer-dated alternatives."
keywords:
  - corporate bonds
  - investment grade
  - short duration
...
*The **iShares 0-5 Year Investment Grade [Corporate Bond](/corporate-bond/) ETF** — ticker SLQD — is a passive [bond](/bond/) fund that tracks the universe of publicly issued corporate debt from investment-grade issuers with maturity dates between now and five years ahead, delivering a stream of coupons and principal repayments with reduced exposure to rising [interest rates](/interest-rate/).*
...
Second, price appreciation or [depreciation](/depreciation/). When a bond is held to maturity, the investor gets par (100% of face value) back. But between now and maturity, bonds trade, and their prices fluctuate with interest rates, credit conditions, and the creditworthiness of the issuer. If new bonds are issued paying higher coupons (because rates have risen), an existing bond paying a lower coupon will lose value.

Because SLQD holds a diversified basket of thousands of corporate bonds, no single issuer's [credit event](/credit-event-sovereign/) can materially move the fund. The bond index itself is rebalanced regularly as bonds mature and new issues are added. When a bond in the index approaches maturity, it is removed, and a new bond further out in the maturity spectrum is added in its place. This keeps the portfolio perpetually positioned in the 0-5 year window.

## Costs and investor profile

SLQD's [expense ratio](/expense-ratio/) is low — roughly 0.05% per year. On a USD 100,000 position, that is USD 50 annually in fees. The fund is also highly liquid: it trades millions of shares daily on [NASDAQ](/nasdaq/), and the [bid-ask spread](/bid-ask-spread/) is typically measured in basis points.

SLQD suits several investor profiles. Investors who already own a diversified stock portfolio but want to add a stable, income-generating component often use [bond ETFs](/bond-etf/) like SLQD for balance. Investors approaching or in retirement may hold SLQD as an income source with less volatility than equities. Investors tactically tilting away from longer-duration bonds in an environment where rates are expected to rise can use SLQD to maintain some fixed-income exposure while reducing duration risk.
...
No bond fund is risk-free. The principal risk is [credit risk](/credit-risk/): the issuer of a bond held by SLQD could default, losing value for bondholders. [Diversification](/diversification/) reduces this risk meaningfully — SLQD holds thousands of bonds from hundreds of issuers — but it does not eliminate it. In a severe [recession](/recession/) or credit crisis, [default rates](/default-rate/) across corporate bonds can spike. SLQD's BBB-rated holdings are particularly sensitive to economic stress.

[Reinvestment risk](/reinvestment-risk/) is another consideration. As bonds in SLQD mature or pay coupons, the fund must reinvest that capital in new bonds. If interest rates have fallen, those new bonds will pay lower coupons, reducing the fund's income. Over a five-year period, this can meaningfully affect total returns.
