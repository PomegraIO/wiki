---
title: "Semilux International Ltd. (SELX)"
description: "A Taiwan-based optical and 3D sensing technology company supplying laser modules, LiDAR components, and optical sensors to automotive, projection, and autonomous systems markets."
keywords:
  - optical components
  - laser modules
  - LiDAR sensors
...
Semilux faces multiple risk factors. First, the automotive supply chain is notoriously cyclical and concentrated. A handful of major automotive OEMs and Tier 1 suppliers control demand. If any customer reduces orders or shifts sourcing to a competitor, Semilux revenue falls sharply. Customer [concentration risk](/concentration-risk/) is substantial in automotive supply, and the company's customer list in the 10-K filing will reveal the magnitude of this exposure. Semilux has no direct sales to consumers; it is entirely dependent on maintaining relationships with a limited number of automotive manufacturers.
...
For those tracking Semilux, the key metrics are: revenue by product line (automotive optics, LiDAR, other), geographic revenue concentration, gross and [operating margins](/operating-margin/), capital expenditure and [depreciation](/depreciation/) trends, customer concentration (percentage of revenue from top customers), order backlog, and commentary on automotive adoption rates and LiDAR [market timing](/market-timing/). The company's quarterly and annual filings will also reveal debt levels, cash position, and any covenant restrictions. Regulatory filings may disclose major customer wins or losses, supply chain disruptions, or quality issues. Industry reports on automotive lighting adoption and autonomous vehicle rollout timelines provide external context for evaluating Semilux's addressable market assumptions.
