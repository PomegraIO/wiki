---
title: "TD SYNNEX CORP (SNX)"
description: "TD SYNNEX Corp is a global information technology distributor and software solutions provider, formed by the merger of Tech Data and SYNNEX, connecting technology vendors with resellers, integrators, and end customers."
keywords:
  - IT distribution
...
The first pressure is vendor concentration. A small number of vendors — Microsoft, Cisco, [Intel](/intc-stock/), [Apple](/aapl-stock/), Dell, HP — account for a disproportionate share of the industry's software and hardware sales. If any of these vendors decides to sell more directly or terms are unfavorable, TD SYNNEX's margins are squeezed. The company is constantly negotiating with vendors to maintain competitive incentives and volume rebates.

The second pressure is economic sensitivity. When technology spending by enterprises slows (as it does during [recessions](/recession/)), distributor volume declines sharply. IT hardware sales are discretionary for most businesses; a company in downturn will delay a server refresh or postpone a software license renewal. TD SYNNEX, being purely a distributor, has no products or services of its own; it is entirely dependent on the volume flowing through it.
...
The fourth is working capital intensity. A distributor must buy inventory upfront from vendors on extended payment terms, then sell to resellers on similarly extended terms, tying up cash for weeks or months. Rising [interest rates](/interest-rate/) increase the cost of working capital financing. Supply-chain disruptions (such as semiconductor shortages) have forced distributors to hold more expensive inventory, temporarily weakening cash flow.
...
TD SYNNEX files a Form 10-K annually with the [Securities and Exchange Commission](/securities-and-exchange-commission/) (SEC CIK 0001177394). The 10-K details revenue by product category and geography, describes the company's vendor and customer bases, and lays out competitive and [technology risks](/technology-risk/). Key metrics to monitor are gross margin trends (narrowing margins indicate vendor or competitor pressure), inventory turns (faster is better — lower working capital tied up), [Days Sales Outstanding](/days-sales-outstanding/) or DSO (a measure of how long the company waits for payment from resellers — lower is better for cash flow), and the growth of Advanced Solutions revenue (the higher-margin recurring segment).
