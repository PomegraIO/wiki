---
title: "OceanPal Inc. (SVRN)"
description: "OceanPal operates a small fleet of dry bulk carriers and tankers shipping commodities worldwide, and has recently pivoted to accumulating digital assets on the NEAR Protocol blockchain."
keywords:
  - shipping
  - dry bulk vessels
  - tanker
...
The NEAR ecosystem is nascent relative to Ethereum and [Bitcoin](/bitcoin/). Its long-term success is not guaranteed. The accumulation of NEAR tokens is a bet that the platform will thrive, applications will be built on it, and the token will appreciate materially.
