---
title: "iShares iBonds Dec 2055 Term Treasury ETF (IBGL)"
description: "An exchange-traded fund holding US Treasury bonds with a single maturity date in December 2055, offering investors a transparent, low-cost path to defined-maturity Treasury exposure."
keywords:
  - treasury ETF
  - term structure
  - bond fund
...
*The **iShares iBonds Dec 2055 Term Treasury ETF** (IBGL) holds a single basket of US [Treasury bonds](/treasury-bond/), all maturing December 15, 2055. Static portfolio. Fixed endpoint. No rolling, no management calls — just Treasuries in lockstep toward one day.*
...
The core risk is interest-rate movement if you need to exit before maturity. Rates rise, [bond](/bond/) prices fall — IBGL's value declines. Sell early and realise a loss. Hold to December 2055? Par is guaranteed. Price swings between now and then become noise.

[Inflation risk](/inflation-risk/) is real over 29 years. The coupon is fixed, the principal is nominal. [Inflation](/inflation/) erodes purchasing power. That matters for long-duration bonds.

[Credit risk](/credit-risk/): none. US government obligor. Liquidity: excellent — Treasuries trade constantly, spreads tight. [Expense ratio](/expense-ratio/) minimal, typically under 0.10 percent annually.

[BlackRock](/blk-stock/) iShares manages this passively. No judgment, no rebalancing within the maturity date. Bonds mature out, others enter to maintain the December 2055 target. Simple execution of a simple rule.
...
Trade-off versus broad Treasury [index funds](/index-fund/): a traditional fund holds many maturities simultaneously and constantly rolls into new bonds to maintain target duration. IBGL holds one maturity and does not roll. You gain certainty and simplicity; you lose flexibility. That is the contract.
