---
title: "iShares iBonds Dec 2044 Term Treasury ETF (IBGA)"
description: "IBGA holds U.S. Treasury bonds maturing in December 2044, giving investors a fund where all holdings mature on the same date — a known endpoint for your investment."
keywords:
  - Treasury bonds
  - term ETF
  - fixed income
...
<table>
<tr><th>Ticker</th><td>IBGA (Nasdaq)</td></tr>
<tr><th>Sponsor</th><td>iShares (BlackRock)</td></tr>
<tr><th>Underlying asset</th><td>U.S. Treasury bonds maturing December 2044</td></tr>
<tr><th>Maturity date</th><td>December 2044</td></tr>
<tr><th>Years to maturity</th><td>Approximately 18 years</td></tr>
<tr><th>Fund type</th><td>Term Treasury ETF</td></tr>
<tr><th>Expense ratio</th><td>Qualitatively very low</td></tr>
</table>
</aside>
...
An eighteen-year bond is sensitive to rate changes. If rates jump by 1%, the fund's price could fall 15% or more. That sounds scary, but it only matters if you sell. If you hold, you are fine.

## Who should own this fund

This fund is for people with money they will not touch for years. It is for investors who want safety first. The U.S. government will not default. Realistically, that is the only thing that could go wrong, and it is not going to happen.

The fund is not for people who need money soon or cannot tolerate price drops. It is not a replacement for a savings account. The yields are modest. But if you have a goal far in the future — retirement, a large purchase — and you want that money safe and earning modest interest, IBGA works.

It is also useful if you want to ladder your bond holdings. Own one fund maturing in 2044, another in 2043, another in 2045. Each year one matures and you reinvest the cash. It is simple and disciplined.
...
Ask yourself three questions. One: will I need this money in the next ten years? If yes, IBGA is risky. Two: can I tolerate seeing the fund's price fall 10–20% in a year if rates spike? If no, this is too aggressive for you. Three: do I have a specific goal in 2044, like retirement? If yes, IBGA makes sense.

If the answer to all three is in the right direction, IBGA is a straightforward holding. You know when you get your money back. You know it will arrive. Read iShares' prospectus to see the current bonds and their interest rates. Check the Treasury Department's website to see what new 18-year bonds are paying. Then decide if the rate is attractive enough for your time horizon.
