...
description: "IEF is a core fixed-income ETF holding US Treasury bonds with maturities between 7 and 10 years — a low-cost, liquid way to own intermediate-term government debt with minimal credit risk."
keywords:
  - Treasury bonds
  - intermediate bonds
  - fixed income
...
<table>
<tr><th>Ticker</th><td>IEF (NASDAQ)</td></tr>
<tr><th>Sponsor</th><td>iShares (BlackRock)</td></tr>
<tr><th>Fund type</th><td>Fixed-income ETF (index tracker)</td></tr>
<tr><th>Holdings</th><td>US Treasury bonds, 7–10 year maturities</td></tr>
<tr><th>Number of holdings</th><td>Typically 100–200+ individual bonds</td></tr>
<tr><th>Credit risk</th><td>None (US government guaranteed)</td></tr>
<tr><th>Duration</th><td>Roughly 7–8 years (price sensitivity to rate moves)</td></tr>
<tr><th>Expense ratio</th><td>Among the lowest in fixed income; negligible</td></tr>
<tr><th>Liquidity</th><td>Excellent; NASDAQ trading, tight spreads</td></tr>
</table>
</aside>
...
Scenario 1: Rates stay flat. IEF returns approximately its current yield. If yields are 3%, expect 3% annual return (distributed as coupon income). Boring. Stable.
...
Owning IEF is a directional bet on interest rates. If you believe rates will fall, it is bullish. If rates will rise, it is bearish. If rates will stay flat, it approximates the stated yield.

Inflation is implicit in this bet. When you buy a Treasury bond, you lock in a nominal yield. If inflation accelerates above that yield, you lose purchasing power. IEF holders are wagering that actual inflation will track below the embedded yield. If inflation stays low (1–2%), you win. If it spikes (5%+), the real return (nominal minus inflation) becomes negative.
...
IEF is often a complementary holding to stocks. Stocks rallied — portfolio tilts toward risk. Correction looming — rebalance into IEF to lock in gains and prepare for weakness. It is a volatility absorber.

It is also used for liability matching. Investor expecting to spend money in 8 years buys IEF; bonds mature on schedule, funds arrive when needed.

## The monitoring task: almost nothing
