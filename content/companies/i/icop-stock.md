---
title: "iShares Copper and Metals Mining ETF (ICOP)"
description: "ICOP is an exchange-traded fund holding shares in publicly listed copper and base metals mining companies worldwide — a way to gain exposure to mining producers and the commodity cycle through equities rather than futures or bullion."
keywords:
  - copper mining
  - metals ETF
  - mining stocks
...
<table>
<tr><th>Ticker</th><td>ICOP (NASDAQ)</td></tr>
<tr><th>Sponsor</th><td>iShares (BlackRock)</td></tr>
<tr><th>Fund type</th><td>Exchange-traded fund (sector)</td></tr>
<tr><th>Index tracked</th><td>S&P Global Metals & Mining Index (copper-focused)</td></tr>
<tr><th>Holdings</th><td>Typically 30–50 large and mid-cap mining companies</td></tr>
<tr><th>Primary metals</th><td>Copper, zinc, nickel, aluminum, molybdenum</td></tr>
<tr><th>Geographic exposure</th><td>Chile, Peru, Australia, Canada, China, Indonesia, others</td></tr>
<tr><th>Trading</th><td>NASDAQ; moderate to high liquidity for a sector fund</td></tr>
</table>
</aside>

## The mining economy embedded in equities
...
Third, mine-specific risks add noise. A major mine suffers a shutdown due to environmental accident, political pressure, or labor action. Ore grades decline as a mine ages. A project capital cost explodes past budget. Environmental permitting tightens or trade policy shifts. These idiosyncratic shocks hit individual holdings frequently, and a fund this diversified will always have a few surprises in play.
...
Finally, project risk is chronic. New mines take years and billions to develop. Cost overruns are the norm, not the exception. A mine sanctioned when copper prices are strong can become uneconomical before production starts if prices fall or costs explode. This pattern is documented across hundreds of projects.

## Who owns ICOP and when

ICOP appeals to investors who believe base metal demand will outpace supply, or who expect sustained global growth and capital spending. It works well as a cyclical allocation when the investor believes manufacturing and infrastructure spending are accelerating. It works poorly for conservative portfolios, retirees, or investors who cannot tolerate 20–40% annual swings.
