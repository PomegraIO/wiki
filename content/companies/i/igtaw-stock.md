---
title: "Inception Growth Acquisition Ltd (IGTAW)"
description: "Inception Growth Acquisition Ltd (IGTAW warrant) grants the right to buy common shares at a fixed price post-merger, bundled as a leveraged stake in the eventual SPAC acquisition outcome."
keywords:
  - SPAC warrant
  - call option
  - exercise price
  - leverage
  - post-merger security
handwritten: true
---

Inception Growth [Acquisition](/acquisition/) Ltd issues IGTAW warrants — equity options that give holders the right to purchase additional common shares at a pre-set price after a [merger](/merger/) closes. A warrant is a leveraged bet: you pay a fraction of the cost of owning the stock outright, but you gain full upside above the [exercise price](/exercise-price/), with no downside floor, no redemption right, and nothing if the SPAC fails to merge or the merged company's stock falls below the strike.

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>IGTAW (NASDAQ)</td></tr>
<tr><th>Security type</th><td>SPAC warrant / equity call option</td></tr>
<tr><th>Typical exercise price</th><td>$11.50 per share of common stock</td></tr>
<tr><th>Exercise window</th><td>Post-merger; usually 5 years or until expiration</td></tr>
<tr><th>Leverage</th><td>No floor; full downside risk if stock declines</td></tr>
<tr><th>No redemption right</th><td>Unlike common shares; warrant holders cannot exit at cost</td></tr>
<tr><th>SEC CIK</th><td>0001866838</td></tr>
</table>
</aside>

## How a warrant works

When you buy a warrant, you own the right but not the obligation to buy one common share at $11.50 per share at any time before the warrant expires (usually five years post-merger). If the merged company's stock trades at $20, the warrant is in the money by $8.50 and has [intrinsic value](/intrinsic-value/). If the stock trades at $8, the warrant is worthless and exercises to no effect. You lose your entire warrant premium; the sponsor or the company does not reimburse you.

This is the opposite of a redemption right. Common shareholders can exit a disappointing SPAC merger by redeeming and recovering their share of the trust. Warrant holders must hold or sell; they are stuck with the bet. That asymmetry is why warrants are risky, why they trade at a discount to their mathematical value most of the time (factoring in [time decay](/time-decay-theta/) and the probability of the stock trading above strike), and why retail investors often overestimate how much value they contain.

## Price dynamics: pre and post merger

Before the merger closes, IGTAW trades in separation from the [common stock](/common-stock/). The common typically trades near or slightly below the trust value (because redemptions compress it), while the warrant trades on speculation about the target. If the target looks solid, the warrant may soar to $2, $3, or higher, capitalizing on the prospect that the merged stock will trade well above $11.50. If the target disappoints, the warrant collapses. The spread between warrant price and intrinsic value is pure optionality — [time value](/time-value/), the market's estimate of how likely the stock is to finish in the money.
