---
title: "Invesco RAFI Strategic US ETF (IUS)"
description: "IUS is an exchange-traded fund that invests in large-cap US companies selected and weighted by fundamental metrics like sales and book value rather than market cap — a form of smart-beta indexing designed to tilt toward value and reduce concentration in mega-cap stocks."
keywords:
  - smart beta
...
The biggest difference shows up in the portfolio's heaviest holdings. A traditional cap-weighted index puts roughly a third of its weight in the ten largest companies — in recent years, mostly mega-cap tech. IUS, weighted by fundamentals, spreads its weight more evenly. A financial services firm that is large and profitable but whose stock price has not soared gets more room in IUS than it would in the S&P 500. This reduces [concentration risk](/concentration-risk/): instead of betting heavily on whether Apple, Microsoft, and [Nvidia](/nvda-stock/) keep outpacing the market, IUS spreads exposure more widely and picks up overlooked profitable businesses.
