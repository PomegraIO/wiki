---
title: "International Land Alliance Inc. (ILAL)"
description: "A land acquisition and development company focused on acquiring and managing real estate assets in Mexico, operating across multiple geographic markets and property types."
keywords: ["ILAL", "real estate development", "land acquisition", "Mexico property", "public company"]
---
...
<tr><td>Ticker</td><td>ILAL</td></tr>
<tr><td>Listing</td><td>Pink Sheets / OTC Markets</td></tr>
<tr><td>SEC CIK</td><td>1657214</td></tr>
<tr><td>Sector</td><td>Real Estate</td></tr>
<tr><td>Industry</td><td>Land Development & Acquisition</td></tr>
</table></aside>
...
The business structure imposed a unique capital discipline. Land holdings generate no [cash-flow](/free-cash-flow/) until they are monetized—sold, developed, or leased. That meant International Land Alliance had to raise capital either from equity markets (through public stock offerings or [private placements](/private-placement/)) or debt markets, and then service that capital structure while waiting for properties to appreciate or find tenants.

This patient-capital model required constant investor relations and regular communication about the value thesis. The company filed with the SEC and disclosed its holdings and strategy in annual [10-K](/10-k/) filings. However, the illiquidity of the asset base, combined with the Mexican geographic focus and the complexity of cross-border real estate valuation, meant the stock traded on smaller venues (OTC or pink-sheet markets) and attracted only investors comfortable with high uncertainty and thin liquidity.

The ability to raise dilutive equity without collapsing the stock price became essential. As long as the market believed land would eventually be monetized at a gain, the firm could issue new shares to fund additional [acquisitions](/acquisition/). The moment that belief broke—if property sales occurred at losses, if promised developments stalled, or if the peso weakened significantly—the company's financing model cracked.
