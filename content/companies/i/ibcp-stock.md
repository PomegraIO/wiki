---
title: "INDEPENDENT BANK CORP /MI/ (IBCP)"
description: "Michigan-based community bank holding company serving the Great Lakes region with commercial and consumer lending services."
...
<tr><td><strong>SEC CIK</strong></td><td>39311</td></tr>
...
Quarterly and annual earnings depend on three factors: net interest income (interest earned minus interest paid), fee income, and loan loss provisions. When [earnings per share](/earnings-per-share/) grow, it may signal either that the bank is earning wider margins or originating more loans. When earnings decline, it may signal either narrowing margins or rising credit losses. Investors and analysts compare IBCP's [return on equity](/return-on-equity/) and [return on assets](/return-on-equity/) to peers to assess whether management is deploying capital efficiently.
...
### Closely related
- [IBOC (International Bancshares Corp)](/iboc-stock/)
- [Bank holding company](/public-company/)
- [Deposit insurance](/balance-sheet/)
