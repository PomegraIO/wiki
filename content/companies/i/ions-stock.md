...
description: "Ionis is a drug-discovery company using antisense and RNAi technology to develop treatments for rare genetic and neurological diseases — a platform with potential to address conditions previously considered undruggable."
keywords:
...
<table>
<tr><th>Ticker</th><td>IONS (NASDAQ)</td></tr>
<tr><th>Founded</th><td>1978, Carlsbad, California</td></tr>
<tr><th>Sector</th><td>Biotechnology / drug discovery</td></tr>
<tr><th>Technology platform</th><td>Antisense oligonucleotides (ASO) and RNAi</td></tr>
<tr><th>Focus areas</th><td>Rare genetic, neurological, and metabolic diseases</td></tr>
<tr><th>SEC CIK</th><td>0000874015</td></tr>
</table>
</aside>
...
Key metrics to track: revenue growth (particularly from approved drugs), the number of candidates in each stage of development, and cash burn (how much cash the company spends relative to what it earns). Clinical trial readouts — announcements of Phase 2 or Phase 3 results — can move the stock significantly if they are positive or negative. The company's [balance sheet](/balance-sheet/) is important too: developing multiple drugs is capital-intensive, and the company must have enough cash to fund the pipeline through approval without needing to raise capital at unfavorable terms.
