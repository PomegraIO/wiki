---
title: "Applied Finance IVS International Large ETF (IVSI)"
description: "IVSI holds large-cap developed-market stocks outside the United States using a quantitative value and dividend-quality framework, targeting established international enterprises."
keywords:
...
<table>
<tr><th>Ticker</th><td>IVSI (NASDAQ)</td></tr>
<tr><th>Fund sponsor</th><td>Applied Finance Inc.</td></tr>
<tr><th>Inception</th><td>2012</td></tr>
<tr><th>Investment universe</th><td>Large-cap developed-market stocks ex-USA</td></tr>
<tr><th>Selection criteria</th><td>Quantitative value and dividend quality</td></tr>
<tr><th>Structure</th><td>Open-end ETF</td></tr>
<tr><th>Capital approach</th><td>Long-only, dividend-focused</td></tr>
</table>
</aside>

## The strategy: large caps with dividend discipline

IVSI holds stocks from the large-cap universe in developed countries outside the United States — Canada, the United Kingdom, Australia, Japan, and continental Europe. The fund applies a quantitative model that identifies two overlapping sets: companies trading at discounts to book or earnings value, and established firms with stable, sustainable [dividend](/dividend/) payments. The intersection is where IVSI concentrates — mature companies with solid [balance sheets](/balance-sheet/) that are trading inexpensively and rewarding shareholders with cash distributions.
...
Review the fund's prospectus and fact sheet for the exact quantitative criteria used to screen and rank candidates. The current top 10 holdings reveal where the model currently sees the best value-plus-dividend combination. Compare IVSI's [dividend yield](/dividend-yield/) and [price-to-earnings ratio](/price-to-earnings-ratio/) to competing international large-cap funds to see whether the quantitative approach is capturing higher quality or better value than alternatives.

Track the fund's sector exposure and geographic breakdown — large-cap international indices vary widely by region and industry, and IVSI's holdings will reflect where the model finds the best opportunities. Watch for signs that dividend sustainability is declining, either through a fall in the [payout ratio](/payout-ratio/) or through economic deterioration in key holdings.
