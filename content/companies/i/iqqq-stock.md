---
title: "ProShares Nasdaq-100 High Income ETF (IQQQ)"
description: "IQQQ holds the 100 largest non-financial Nasdaq-listed companies and sells call options against them monthly, generating income while capping upside potential."
keywords:
  - covered call ETF
  - Nasdaq-100
  - income strategy
...
ProShares Nasdaq-100 High [Income ETF](/income-etf/) (IQQQ) combines two strategies: holding the 100 largest non-financial companies listed on the [Nasdaq](/nasdaq/) and systematically selling [call options](/call-option/) on that portfolio. The Nasdaq-100 is dominated by tech and growth companies, typically the highest-growth segment of the equity market. By overlaying [covered calls](/covered-call/), the fund trades upside potential for monthly income distributions. It is designed for investors who want exposure to large-cap technology and growth companies but prefer monthly cash returns over the prospect of capital appreciation.

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>IQQQ (NYSE ARCA)</td></tr>
<tr><th>Sponsor</th><td>ProShares</td></tr>
<tr><th>Underlying Index</th><td>Nasdaq-100 (ex-financials)</td></tr>
<tr><th>Strategy</th><td>Covered call overlay</td></tr>
<tr><th>Distribution</th><td>Monthly</td></tr>
<tr><th>Rebalance</th><td>Quarterly (index), monthly (options)</td></tr>
</table>
</aside>

## What the Nasdaq-100 is

The Nasdaq-100 index comprises the 100 largest non-financial companies listed on the Nasdaq exchange. It is not the entire Nasdaq. It excludes investment companies, holding companies, and the financial sector. The index is heavily weighted to technology: [Apple](/aapl-stock/), [Microsoft](/msft-stock/), Amazon, [Nvidia](/nvda-stock/), [Tesla](/tsla-stock/), Meta, and similar giants dominate. It also includes a sizable chunk of consumer discretionary, biotechnology, and other growth-oriented sectors.
...
The Nasdaq-100 is where investors go to participate in fast-growing tech companies. These companies reinvest earnings, grow revenue rapidly, and often do not pay [dividends](/dividend/). Their appeal is capital appreciation. A traditional Nasdaq-100 investor expects to buy and hold, capturing 10-15 percent annual gains or more in strong years.
...
Shareholders need to understand: this is not a dividend and not a yield on earnings. It is return of capital from premium collected. In a strong [bull market](/bull-market/) where calls are constantly exercised above strike, distributions shrink. In a choppy, sideways market, distributions are robust.
...
ProShares charges an annual [expense ratio](/expense-ratio/) for fund management and option trading execution. This is paid out of premium collected, reducing net distributions to shareholders.
...
A secondary risk is that rapid tech evolution or a prolonged [bear market](/bear-market/) could pressure the Nasdaq-100 severely. The covered call provides limited downside cushion: you still lose money if the market falls sharply, though premium collected helps slightly.
