...
REIT law requires distribution of at least 90% of taxable income to shareholders, so reported GAAP earnings are artificially low (they exclude rent that was received in cash but depreciated on paper). ICRL reports Funds From Operations (FFO), a non-GAAP metric that adds back depreciation to GAAP net income, approximating true cash earnings available for distribution. FFO is the canonical metric for evaluating REIT profitability and dividend sustainability.
