---
title: "InPoint Commercial Real Estate Income, Inc. (ICRL)"
description: "Net-lease REIT deriving value from long-term tenant leases, property valuations, and leverage-amplified dividend yields."
keywords: ["REIT", "net lease", "commercial property", "FFO", "leverage", "dividend"]
---

*A **InPoint [Commercial Real Estate](/commercial-real-estate/) Income, Inc. (ICRL)** is a [real-estate-investment-trust](/real-estate-investment-trust/) (REIT) specializing in net-lease properties where tenants assume responsibility for property taxes, insurance, and maintenance costs. The company's balance sheet is a dual engine: long-lived real estate assets generating contractual rental income, and debt leverage that amplifies equity returns and enables [dividend distributions](/dividend-distribution/).*

<aside class="wiki-infobox"><table>
<tr><td><strong>Ticker</strong></td><td>ICRL</td></tr>
<tr><td><strong>Listing</strong></td><td>NASDAQ</td></tr>
<tr><td><strong>SEC CIK</strong></td><td>1690012</td></tr>
<tr><td><strong>Sector</strong></td><td>Real Estate Investment Trust (REIT)</td></tr>
<tr><td><strong>Type</strong></td><td>Net-Lease REIT</td></tr>
</table></aside>
...
ICRL regularly revalues its property portfolio, particularly when [acquisitions](/acquisition/) occur or when economic conditions shift materially. [Book value per share](/book-value-per-share/) is a primary metric for REIT investors, as it approximates the equity value embedded in the property base. However, book value underestimates true property value during inflationary periods or strong real estate markets, and may overstate it during downturns. Sophisticated REIT investors adjust book value for capitalization rates (the yield implied by property valuations) and compare them to current [market cap](/market-capitalization/) to identify trading discounts or premiums.
...
ICRL's revenue is rent—highly predictable, contractually fixed (in many cases), and backed by the credit of the tenant. The company maintains a "[rent roll](/rent-roll/)," a detailed schedule of each property, its lease terms, tenant name, [expiration date](/expiration-date/), and annual rent. This rent roll is the most important operational document for understanding ICRL's cash flow visibility.

Long-term net leases typically run 10–20 years with built-in rent escalators (often 2–3% annually) or periodic resets. A tenant with 15 years remaining on a lease provides 15 years of contracted cash flow. Multiple tenants expiring in a single year create leasing risk and vacancy risk—if any fails to renew, that property generates no rent until a new tenant is secured.

ICRL's balance sheet includes deferred rent receivables—amounts owed by tenants for rent abatements, construction allowances, or lease modifications—that are eventually collected or forgiven. These are non-cash assets that reduce future cash flow. Large deferred-rent positions indicate either generous tenant terms during acquisition or tenant-troubled properties where rent was reduced to avoid default.

## The FFO Metric and True Earnings

REIT law requires distribution of at least 90% of taxable income to shareholders, so reported GAAP earnings are artificially low (they exclude rent that was received in cash but depreciated on paper). ICRL reports [Funds From Operations](/funds-from-operations/) (FFO), a non-GAAP metric that adds back depreciation to GAAP net income, approximating true cash earnings available for distribution. FFO is the canonical metric for evaluating REIT profitability and dividend sustainability.

FFO includes rent income, operating expenses, interest on debt, and taxes, arriving at the cash available to distribute or retain. Dividend coverage—FFO divided by total dividends paid—indicates whether dividends are funded from operations or require capital deployment or debt. A REIT with FFO covering 80–100% of dividends is sustainable; one covering less than 70% is unsustainable and burning equity.
...
ICRL's debt agreements include covenants tying borrowing to balance-sheet metrics: debt-to-EBITDA, interest coverage, or loan-to-value. If ICRL's FFO declines due to tenant defaults or if property valuations fall, these covenants can be breached, requiring accelerated debt paydown or refinancing negotiation. Maintaining headroom on covenants is essential for financial flexibility.

Liquidity includes cash on hand, undrawn revolving credit lines, and the ability to access debt capital markets. A REIT with substantial liquidity can weather transient cash flow shortfalls or market disruptions; one with tight liquidity faces pressure to maintain property valuations and tenant performance.

## Depreciation, Taxes, and Retained Earnings

ICRL's depreciation expense is non-cash and reduces taxable income without consuming cash. This creates a wedge: FFO (which adds back depreciation) exceeds taxable income (which includes depreciation). ICRL can distribute cash to shareholders even while reporting taxable losses due to depreciation. This is a key source of tax advantages to REIT investors—distributions are partly classified as return of capital, reducing the tax basis of shares rather than generating current taxable income.

However, [retained earnings](/retained-earnings/) are minimal for REITs, as nearly all cash must be distributed. If ICRL needs to fund property improvements, tenant allowances, or debt repayment, it must either sell properties, issue new debt, or issue new equity. This is why REIT balance sheets are typically capital-constrained; the distribution requirement leaves little room for balance-sheet accumulation.

<div class="wiki-seealso">
### Closely related
- [ICHR (Ichor Holdings)](/ichr-stock/)
- [ICMB (Investcorp Credit Management BDC)](/icmb-stock/)
- [ICON (Icon Energy Corp)](/icon-stock/)
