---
title: "Invitation Homes Inc. (INVH)"
description: "Invitation Homes is the largest publicly traded single-family rental company in the United States, operating tens of thousands of homes leased to families across major metropolitan areas."
keywords:
...
<tr><th>Primary business</th><td>Ownership and management of single-family rental homes</td></tr>
<tr><th>Geographic reach</th><td>Major metropolitan areas across the United States</td></tr>
<tr><th>Business model</th><td>Acquisition, renovation, and lease of single-family homes</td></tr>
<tr><th>SEC CIK</th><td>0001687229</td></tr>
</table>
</aside>
...
Invitation Homes was founded in 2012 by executives with experience in real estate and finance, emerging as one of the earliest entrants to formalize this business at scale. The company went public in 2017 and has since grown through a combination of [acquisitions](/acquisition/) and selective new purchases. It has become the anchor investor in this sector, operating more single-family rental homes than any other publicly traded competitor.
...
The economics are straightforward: rental income less property-level operating costs (maintenance, property taxes, insurance, management) and capital costs yield the operational profit. Unlike a hotel or office-building operator, Invitation Homes benefits from [depreciation](/depreciation/) deductions on residential property for tax purposes, which is a meaningful lever on after-tax returns.
...
The company also benefits from **favorable demographics**. Urban sprawl, rising homeownership costs, preference for flexibility among younger renters, and regional migration patterns have all sustained demand for [single-family rentals](/single-family-rental/) in desirable metropolitan areas.
...
Key metrics to track: [funds from operations](/funds-from-operations/) (FFO), a measure of real estate company cash generation; same-property rent growth and occupancy; the [loan-to-value ratio](/loan-to-value-ratio/) (higher leverage increases risk and returns); and the average rent per property relative to local median home prices. Compare Invitation Homes' [dividend yield](/dividend-yield/) and price-to-FFO multiple to other large [residential real estate](/residential-real-estate/) operators. Follow housing market data in the company's key metropolitan areas — the pace of household formation, migration patterns, and rent-versus-own economics all influence demand for single-family rentals.
