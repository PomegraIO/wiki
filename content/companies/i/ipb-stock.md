---
title: "Merrill Lynch Depositor Inc Indexplus Trust Series 2003-1 (IPB)"
description: "IPB is a structured note trust that tracks a basket of equity indices with a protection feature designed to limit downside. A hybrid of index fund and structured product, now in runoff."
keywords:
  - structured products
...
IPB is a peculiar artifact of early-2000s financial engineering, when [structured products](/structured-product/) designed to offer upside equity exposure paired with downside protection were marketed aggressively to retail investors. The Merrill Lynch Depositor Inc Indexplus Trust Series 2003-1 was launched in 2003 to hold a basket of equity indices — primarily US stocks, some international exposure — with a contractual floor that guaranteed investors would not lose more than a certain percentage of their initial principal if the indices fell. The idea was appealing: get stock-market returns if equities rose, but sleep soundly knowing that a worst-case loss would be bounded. IPB encapsulated that promise in a tradeable note, so investors could buy it on the [stock exchange](/stock-exchange/) rather than through a bank's structured-product desk.
