---
title: "First Trust S-Network E-Commerce ETF (ISHP)"
description: "An ETF focused on e-commerce and internet retail, tracking companies in online merchandising, marketplaces, digital payments, and logistics that power online shopping."
keywords:
  - e-commerce
  - internet retail
  - online shopping
...
| Key Fact | Detail |
|---|---|
| **What it tracks** | E-commerce and online retail companies, digital payments, logistics |
| **Sponsor** | First Trust Advisors |
| **Underlying index** | S-Network E-Commerce Index |
| **Fund type** | Standard ETF (no leverage or inverse) |
| **Expense ratio** | Low, typical of sector ETFs |
| **Maturity range** | N/A (equity fund, not bonds) |
| **Who issues** | E-commerce platforms, marketplace operators, fintech, logistics firms |

</aside>

*The **First Trust S-Network E-Commerce ETF** (ISHP) holds companies engaged in the business of online retail and the infrastructure that powers it. It is not a pure play on any single e-commerce giant, but rather a basket of firms involved in merchandising, marketplaces, digital payments, and the logistics networks that deliver goods to customers' doors.*
...
## Why this sector, and what drives returns
...
E-commerce is genuinely competitive. Barriers to entry are high for the behemoths — Amazon, for instance, has built logistics and fulfillment infrastructure that would cost years and billions to replicate — but the market is fragmented enough that new entrants with better unit economics or niche dominance can still take share. Margins are often thin, especially in commodity retailing, and shipping costs are volatile.

Regulation is an emerging risk. Governments in the United States and Europe are scrutinising marketplace operators and their treatment of sellers, data privacy practices, and competition. Rules around taxation, labour classification, and data use could raise costs or constrain growth for members of this fund's portfolio.

Technological disruption is constant. Supply-chain innovations, changes in consumer behaviour (a permanent shift to brick-and-mortar, a move away from quick delivery as an expectation), and new entrants using different models could reshape the competitive landscape.
