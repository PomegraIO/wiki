---
title: "iShares Lithium Miners and Producers ETF (ILIT)"
description: "ILIT tracks global companies that extract, process, and refine lithium, betting on the material's role in batteries and energy storage as electrification accelerates."
keywords:
  - lithium ETF
  - mining ETF
  - battery metals
...
ILIT tracks an index of global lithium mining and processing companies. The fund typically holds 25–40 constituent stocks, drawn primarily from Australia, Chile, Argentina, Canada, and China — the countries where most lithium production is concentrated. Major holdings have included Albemarle, Sociedad Química y Minera de Chile (SQM), [Lithium Americas](/lac-stock/), and Livent, though the exact portfolio shifts as the index evolves and the sector consolidates.

The fund is structured as a traditional ETF, meaning it holds actual shares of the companies in its index rather than using derivatives. It trades on the [NASDAQ](/nasdaq/) under the ticker ILIT and has moderate to decent liquidity, though as a narrow-sector fund it will never have the depth of a broad-market tracker. The [expense ratio](/expense-ratio/) is competitive for a specialized ETF — typically in the 0.7–0.9% range — and the fund pays no [dividend](/dividend/); capital is reinvested in underlying company growth or reinvestment by the constituents.
