...
description: "Intuit is a software company serving small and mid-size businesses and consumers with financial management, tax, and accounting products, including QuickBooks, TurboTax, and Credit Karma."
keywords:
...
<table>
<tr><th>Ticker</th><td>INTU (NASDAQ)</td></tr>
<tr><th>Founded</th><td>1983, Menlo Park, California</td></tr>
<tr><th>Headquarters</th><td>Mountain View, California</td></tr>
<tr><th>Sector</th><td>Software (financial management, tax, accounting)</td></tr>
<tr><th>Primary customers</th><td>Small and mid-size businesses, consumers, accountants</td></tr>
<tr><th>Business model</th><td>Subscription software, freemium, advertising</td></tr>
<tr><th>SEC CIK</th><td>0000896878</td></tr>
</table>
</aside>
...
Competition is another ongoing risk. Xero, a New Zealand-based accounting software company, has grown rapidly in some international markets and has taken share from QuickBooks in certain segments. Financial-services platforms from Square, [PayPal](/pypl-stock/), and others are adding accounting and invoicing features that encroach on QuickBooks' territory. In tax filing, though competition from H&R Block and TaxAct exists, TurboTax's scale and brand leadership are formidable.
...
The [dividend](/dividend/) is modest, but the company returns capital to shareholders through buybacks. The pace of those buybacks, relative to [free cash flow](/free-cash-flow/), indicates management's view of the stock's valuation.
