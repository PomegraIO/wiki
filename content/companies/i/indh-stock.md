---
title: "WisdomTree India Hedged Equity Fund (INDH)"
description: "INDH tracks India's largest companies while hedging currency exposure back to the U.S. dollar, removing rupee fluctuation risk for dollar-based investors."
keywords:
  - India ETF
  - currency hedging
  - WisdomTree
...
<table>
<tr><th>Ticker</th><td>INDH (NASDAQ)</td></tr>
<tr><th>Sponsor</th><td>WisdomTree Investments</td></tr>
<tr><th>Structure</th><td>Currency-hedged ETF</td></tr>
<tr><th>Index tracked</th><td>WisdomTree India Hedged Equity Index</td></tr>
<tr><th>Holdings</th><td>Large-cap Indian companies, typically 75–125 stocks</td></tr>
<tr><th>Currency strategy</th><td>Daily rebalanced rupee hedge to U.S. dollar</td></tr>
<tr><th>Expense ratio</th><td>Approximately 0.48%</td></tr>
<tr><th>Dividend treatment</th><td>Minimal; Indian companies reinvest earnings</td></tr>
</table>
</aside>

Investors who want exposure to India's equity market face a choice: they can own Indian stocks directly, accepting that their [U.S. dollar](/us-dollar/) returns will fluctuate with both the Indian [stock market](/stock-market/) and the value of the [Indian rupee](/indian-rupee/) against the dollar. Or they can own a hedged fund like the WisdomTree India Hedged Equity Fund (INDH), which removes the rupee's ups and downs and isolates the return to just the Indian equity market itself.
...
Most Indian stocks are priced in rupees, and an American holding those stocks through a non-hedged fund faces [currency risk](/currency-risk/) — the return depends on both how much the stocks appreciate and whether the rupee strengthens or weakens against the dollar. Over long periods, currency movements can swing 20 or 30 percent, materially affecting total return.

A currency hedge (in this case, a forward currency contract) essentially locks in the rupee-to-dollar exchange rate. WisdomTree enters contracts to sell future rupee cash flows at a known dollar rate, neutralizing the exposure. This is not free: the cost of hedging depends on the interest-rate differential between India and the U.S. If U.S. rates are higher than Indian rates, the hedge costs the fund — the fund pays away the difference in a [forward contract](/forward-contract/). If Indian rates are higher, the hedge is slightly profitable. Over time, these costs and benefits net out unpredictably, but on average, funding a rupee hedge out of a higher-rate-currency bucket (dollars) tends to be a small drag on returns.

The daily rebalancing means the fund constantly adjusts the hedge as the [spot exchange rate](/spot-exchange-rate/) changes. Daily rebalancing is precise but costly — the fund incurs daily transaction costs to maintain the target hedge ratio, costs imbedded in the daily [net asset value](/net-asset-value/) (NAV).
