---
title: "INTERNATIONAL PAPER CO /NEW/ (IP)"
description: "A global forest products and packaging company with roots in early 20th-century timber operations; a leader in containerboard and specialty fiber products for industrial and consumer packaging."
keywords:
  - paper manufacturing
  - packaging materials
  - forest products
...
**International Paper is a multinational forest products and packaging company whose business centers on containerboard, corrugating medium, coated papers, and other specialty fibers.** It competes in a mature commodity-driven sector where volume, cost discipline, and supply chain efficiency determine profitability. The company inherited a century-long history of consolidation and modernization, and today operates mills, distribution networks, and manufacturing facilities across North America, Europe, Latin America, and Asia, serving food and beverage, e-commerce, industrial, and consumer goods producers.
...
International Paper's revenue flows from four main segments:

**Containerboard and Corrugated Products** form the core, serving the global packaging market for groceries, electronics, e-commerce shipments, and industrial goods. Containerboard (both linerboard and corrugating medium) is commodity-like in nature—price driven by global supply and demand, volatile with cycles in industrial production and consumer spending. The company also operates corrugated box plants and distribution operations that convert raw containerboard into finished packaging for customers.

**Uncoated Papers** include communication papers (office paper, book paper, publication papers), still demanded by offices, publishers, and commercial print shops, though this segment has faced secular headwinds as digital substitution reduces demand for physical paper.

**Specialty Fibers** encompasses bleached and unbleached kraft pulp, fluff pulp (used in absorbent products), and engineered papers for industrial and technical applications—higher-margin, less commoditized revenue streams.

**Illimited Managed Forests** (formerly part of consolidated operations, now significantly reduced) provides some revenue from timber harvesting and management, though International Paper no longer operates large contiguous forest tracts as it did historically.

Financially, the company lives and dies by containerboard volumes and prices. When economic activity slows, packaging demand falls and prices compress; conversely, periods of strong consumer spending and logistics growth lift utilization and margins. The business is capital-intensive—modern mills require multibillion-dollar investments and decades to pay off—and fixed costs are substantial, creating operational leverage on both upside and downside.

## Competitive Position and Industry Standing

International Paper is one of only two or three truly global containerboard producers of scale; others include WestRock and Huhtamaki (Europe/Asia). The industry remains concentrated, with the top five producers controlling roughly two-thirds of global containerboard capacity. Competitive advantages rest primarily on:
...
## Key Metrics and How to Research

Visit the 10-K annually to understand: containerboard volumes and prices (usually in segment detail); mill utilization rates; cash generation and capital spending; debt covenants; any significant acquisition or disposition activity.
