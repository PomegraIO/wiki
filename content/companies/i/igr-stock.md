...
Real estate generates income in a way most other businesses do not. A company that owns apartment buildings or shopping centers collects rent month after month — cash that, under U.S. tax law, must be distributed to shareholders as [dividends](/dividend/) if the company qualifies as a REIT. This rental income is more stable than a technology company's quarterly profits or a retailer's sales, and it tends to move independently from stock-market swings, which appeals to investors seeking steady returns rather than rapid capital growth.
