---
title: "iShares iBonds Dec 2031 Term Treasury ETF (IBTL)"
description: "IBTL is a fixed-maturity Treasury ETF holding U.S. Treasury securities all due December 2031, with an automatic declining-duration strategy that reduces interest-rate risk as the fund approaches maturity, terminating on a set date."
keywords:
  - Treasury ETF
  - fixed maturity
  - term fund
...
Why build a fund this way? Because investors often know when they will need money. A retiree leaving the workforce in 2031 needs Treasuries that will pay off in 2031. A pension plan with liabilities due that year wants to match them with assets maturing that year. A trust funding a distribution in 2031 benefits from holding securities coming due that same year. IBTL addresses that demand: it is a Treasury vehicle designed for investors with a calendar liability, not a perpetual portfolio.
...
The primary use is straightforward: an investor needs cash in 2031, and Treasury securities are the safest way to hold it. Rather than periodically guessing how long Treasury bonds to buy or managing a ladder of individual securities, the investor buys IBTL and lets the fund manage the duration decline. The declining-duration schedule is automatic and transparent; there is no active manager trying to beat the market or time interest rates. The investor knows the fund will mature on the promised date and return principal.
...
There is also a mathematical return to the declining-duration schedule in stable or falling rate environments. As a bond approaches maturity, its price appreciates—a phenomenon called "roll-down" or "price compression." A traditional bond fund captures roll-down on its perpetually longest bonds. IBTL, shifting progressively into shorter bonds, captures roll-down repeatedly as it shortens its portfolio. In flat or falling rate environments, this can produce returns that are difficult to capture another way.
...
Start with the fund's prospectus and fact sheet, available from BlackRock's iShares website. These documents lay out the declining-duration schedule in exact terms, list the current holdings, and detail the fee structure. Verify that all holdings are U.S. Treasuries maturing in December 2031—the fund's prospectus is the primary source of truth.

Monitor the fund's price versus its NAV. If IBTL trades at a substantial discount, it may be worth buying; a large premium might signal that buyers are paying too much. As the fund approaches maturity, the discount or premium should shrink toward zero.

Compare IBTL's economics against the alternatives. Look up the yields on actual U.S. Treasury securities maturing in December 2031 and calculate whether holding IBTL's fee plus the convenience is cheaper than buying Treasuries directly. For investors without a Treasury broker or with small capital, the fund is likely cheaper. For large, sophisticated investors who can buy Treasuries wholesale, direct ownership might be better.

IBTL works best for investors with a concrete obligation in 2031 and a preference for simplicity, transparency, and Treasury-backed certainty. It is not for investors seeking perpetual bond exposure, those betting on sharp rate declines, or those who may change their liquidity timeline before 2031.
