---
title: "Alpha Architect International Quantitative Value ETF (IVAL)"
description: "IVAL tracks developed-market value stocks outside North America using a systematic quantitative framework, targeting companies with strong fundamentals at low valuations."
keywords:
...
*The **Alpha Architect International Quantitative Value ETF** (ticker IVAL) is an exchange-traded fund that holds developed-market stocks outside North America, selected by a rules-based quantitative screening process designed to capture value and quality. It targets investors seeking exposure to international equities through a systematic, fundamentals-driven lens.*

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>IVAL (CBOE)</td></tr>
<tr><th>Fund sponsor</th><td>Alpha Architect</td></tr>
<tr><th>Inception</th><td>2014</td></tr>
<tr><th>Investment focus</th><td>Developed-market value stocks ex-North America</td></tr>
<tr><th>Selection method</th><td>Rules-based quantitative screening</td></tr>
<tr><th>Structure</th><td>Open-end ETF</td></tr>
<tr><th>Tracking method</th><td>Factor-driven (not index-replicating)</td></tr>
</table>
</aside>
...
## The value factor and the international lens
...
Because the fund concentrates on value stocks, it will lag during periods when value is out of favour — which can last years. Currency movements swing returns unpredictably; a weakening dollar boosts IVAL's returns for U.S. investors, while a strengthening dollar dampens them. The concentrated, rules-based selection also creates the risk of factor clustering — all selected stocks may falter together if market conditions shift sharply away from value.

The fund also carries small-cap and mid-cap risk. Quantitative value screens often pick up smaller, cheaper companies; these offer more growth potential but also higher volatility and less liquidity individually.
