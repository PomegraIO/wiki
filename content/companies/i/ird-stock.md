---
title: "Opus Genetics, Inc. (IRD)"
description: "Clinical-stage genetic testing and personalized medicine company developing rare disease diagnostics and therapeutic insights."
keywords: ["genetic testing", "rare disease", "diagnostics", "personalized medicine", "Opus Genetics", "clinical genomics"]
---
...
<tr><td>Ticker</td><td>IRD</td></tr>
<tr><td>Listing</td><td>Nasdaq</td></tr>
<tr><td>SEC CIK</td><td>1228627</td></tr>
<tr><td>Sector</td><td>Healthcare</td></tr>
<tr><td>Industry</td><td>Genetic Testing & Diagnostics</td></tr>
...
When reading the 10-K, the analyst should look for revenue per test and test volume trends. Is the company growing by expanding its panel breadth (more genes sequenced per test, higher cost per test) or by growing volume (more samples processed)? Both signal different things. Expanding panels means deeper integration into more disease areas and possibly higher per-test [gross-profit-margin](/gross-profit-margin/), but it also exposes the company to the risk of detecting incidental findings that create liability and interpretation headaches. Growing volume means market acceptance and better absorption of fixed costs, but it also suggests competition may be intensifying and pricing may compress.
...
### Closely related
- [iqmx-stock](/iqmx-stock/) — another technology company at the commercialization inflection point
- [irho-stock](/irho-stock/) — SPAC-structured company with capital-intensity dynamics
