---
title: "Inter & Co, Inc. (INTR)"
description: "Brazilian fintech and financial services company; revenue driven by transaction processing, lending, and wealth management fees."
...
<tr><td><strong>SEC CIK</strong></td><td>1864163</td></tr>
<tr><td><strong>Sector</strong></td><td>Financial Services</td></tr>
<tr><td><strong>Industry</strong></td><td>Digital Banking / Fintech</td></tr>
</table></aside>

## The fintech margin advantage

Inter & Co's economic model capitalizes on a core fintech advantage: lower unit costs of acquiring and serving customers compared to incumbent banks. Traditional Brazilian banks maintain physical branches, employ hundreds of thousands of workers, and carry expensive legacy technology systems. A digital-first fintech can onboard customers via mobile app at near-zero marginal cost, automate many services, and avoid the overhead of physical banking infrastructure. This cost advantage allows Inter to undercut incumbents on fees while maintaining or exceeding their margins—if it can scale fast enough and control its own expense growth.

The company generates revenue from multiple sources: transaction fees on payments and transfers, spreads on lending products (the difference between the rate at which Inter borrows and the rate at which it lends), account maintenance fees, wealth management and investment platform fees, and interchange revenue from debit or credit card processing. A mature fintech typically earns significant margins on lending and investment products but competes fiercely on transaction fees, where differentiation is minimal.
...
The payments business—allowing users to send money, pay bills, transfer between accounts—is a cornerstone of user engagement and stickiness but is increasingly commoditized. Transaction fees are compressed by regulation (Brazil has rules on remittance costs and interchange), by competition, and by users' expectation that basic payments should be free or nearly free. Inter's payments business generates revenue primarily through indirect channels: attracted users who then borrow, invest, or hold deposits.

However, transaction data from payments activity is valuable. Lenders use transaction history as a signal of creditworthiness. Asset managers use behavioral data to target investment and wealth-management products. By offering payments for minimal or no fee, Inter builds the user base and data foundation for higher-margin lending and investment products.
...
### Closely related
- [INTI (Inhibitor Therapeutics)](/inti-stock/)
- [INTJ (Intelligent Group Ltd)](/intj-stock/)
