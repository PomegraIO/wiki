...
description: "iShares Bitcoin Trust is a spot Bitcoin exchange-traded fund that offers direct exposure to Bitcoin's price movements, managed by BlackRock's iShares division."
keywords:
  - bitcoin ETF
  - spot bitcoin
...
"A way to own [Bitcoin](/bitcoin/) without owning a private key, without running a wallet, without the operational headache — just buy it like any stock."
...
The iShares Bitcoin Trust ETF inverts that burden. [BlackRock](/blk-stock/), the world's largest asset manager and operator of the iShares family of exchange-traded funds, created a pooled trust that holds Bitcoin directly and issues shares that trade on ordinary [stock exchanges](/stock-exchange/). An investor buys IBIT shares through any brokerage account the same way they would buy shares of an [Apple](/aapl-stock/) stock or a [bond](/bond/) fund. The trust holds the actual Bitcoin in custody, managed by qualified [custodians](/custodian/). The investor never touches private keys, never manages a wallet, never worries about secure storage. The share price of IBIT tracks the price of Bitcoin minus a small [management fee](/management-fee/).

## The structure and what it means for investors

IBIT is a spot Bitcoin trust, which means it holds actual Bitcoin rather than derivatives or future contracts. When an investor buys a share of IBIT, they acquire a fractional claim on Bitcoin held in trust. The trust's [Net Asset Value](/net-asset-value/) per share moves in near-lockstep with the Bitcoin price, subject only to the trust's ongoing management fee (roughly 0.2 percent annually) and minor tracking differences.

This is distinct from Bitcoin futures ETFs, which began trading in the United States in 2021. Those products track Bitcoin's price by holding Bitcoin [futures contracts](/futures-contract/) — agreements to buy or sell Bitcoin at a future date — rather than the cryptocurrency itself. Spot Bitcoin ETFs like IBIT hold the actual asset, which is simpler, more transparent, and aligns investor returns more directly with Bitcoin's market price.
...
Finally, understand that owning IBIT is a bet on Bitcoin's future price. The product offers no [dividend](/dividend/), no cash flow, and no hedge. It is a pure volatility play, suitable for investors with a long time horizon and substantial risk tolerance.
