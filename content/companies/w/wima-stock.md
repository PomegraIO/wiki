---
title: "WisdomTree International Adaptive Moving Average Fund (WIMA)"
description: "An actively managed fund targeting international equities using moving-average momentum rules; seeks to time entry and exit in developed markets outside the US."
keywords:
...
Turnover tends to be higher in momentum and timing strategies than in buy-and-hold approaches, leading to higher [expense ratios](/expense-ratio/) and potential tax consequences in taxable accounts. The fund's manager must continuously monitor moving averages, rebalance allocations, and trade, all of which costs money that comes out of returns.
