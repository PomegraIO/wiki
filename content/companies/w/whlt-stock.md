---
title: "Chase Packaging Corp (WHLT)"
description: "Chase Packaging manufactures rigid and flexible packaging materials for industrial and commercial use—a small capital-intensive supplier caught between raw-material cost volatility and customer consolidation, navigating margin pressure and the shift toward sustainability."
keywords:
...
<table>
<tr><th>Ticker</th><td>WHLT (NASDAQ)</td></tr>
<tr><th>Founded</th><td>1997</td></tr>
<tr><th>Headquarters</th><td>Berwyn, Pennsylvania</td></tr>
<tr><th>Sector</th><td>Packaging and containers manufacturing</td></tr>
<tr><th>Primary products</th><td>Rigid and flexible plastic packaging, containers, pouches</td></tr>
<tr><th>Customer base</th><td>Food processors, industrial suppliers, commercial end-users</td></tr>
<tr><th>SEC CIK</th><td>0001025771</td></tr>
</table>
</aside>

## The structure of a thin-margin business

Chase Packaging operates in contract manufacturing—it receives specifications from customers, sources or purchases raw materials, and runs them through conversion equipment (injection moulding, thermoforming, film lamination) to produce finished packaging. The business model depends on volume, tight cost control, and customer retention. Profitability is directly exposed to the cost of plastic resins and other feedstocks, which fluctuate with petroleum prices and polymer availability. When resin costs spike, the company either absorbs the margin hit or passes it through to customers—but pricing power is weak because customers shop constantly for better rates and have options.

The customer base is concentrated. The largest customers—food companies, consumer-goods manufacturers, and industrial suppliers—are themselves consolidating and using their scale to demand price reductions. This is the grinding dynamic of contract manufacturing: volumes are large enough to matter, but margins are thin, and a customer loss can be material to quarterly results.

## The shift to sustainable packaging

For years, packaging was a commodity business: meet the spec, deliver on time, compete on price. That foundation remains, but a new layer is forming. Customers are facing pressure from regulators and consumers to reduce plastic waste, to use recycled content, and to shift toward materials that are compostable or genuinely recyclable. Some of this is genuine environmental commitment; much of it is regulatory compliance, particularly in Europe, where Extended Producer Responsibility laws hold manufacturers accountable for the end-of-life disposal of their packaging.

Chase Packaging has been investing in capabilities around recycled-plastic resins, sustainable feedstock sourcing, and newer materials like compostable films. But transitioning a manufacturing footprint to handle new materials is capital-intensive—new moulds, new processes, equipment recalibration—and the price premium for sustainable packaging is eroding as competition for those segments increases. The company finds itself caught between falling prices for conventional packaging and the capital burden of building competence in newer categories.
...
Start with the annual 10-K filing (SEC CIK 0001025771), which breaks revenue by customer class and lists the company's largest customers by name and as a percentage of sales. Pay attention to gross-margin trends—they reveal pricing power relative to raw-material costs. Quarterly earnings calls will discuss customer win-loss activity, capacity utilisation, and any capital investments in new production lines. Watch for commentary on the mix shift toward sustainable packaging, which is the company's main hope for margin expansion. As always, the risk factors section of the 10-K is where management discloses the real structural challenges: customer concentration, raw-material cost volatility, and competitive pressure.
