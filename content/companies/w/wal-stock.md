...
description: "A diversified commercial bank holding company with specialized lending verticals and Western regional presence; navigated 2023 deposit stress while maintaining capital discipline."
keywords:
  - commercial banking
  - regional bank
  - specialized lending
...
- **Founded:** 1995
- **CIK:** 1212545
- **Operations:** Commercial banking, consumer banking, specialized lending
- **Primary Regions:** Arizona, California, Nevada, Colorado, New Mexico, Texas
...
A reader researching this company should start with the [10-K](/wiki/10-k/), paying particular attention to the loan portfolio breakdown by geography, property type, and borrower size. Key metrics to watch: the [net interest margin](/wiki/net-interest-margin/) (squeezed in a lower-rate environment), deposit composition (what fraction is uninsured and rate-sensitive), [loan-to-value ratios](/wiki/ltv-ratio/) in real estate segments, and charge-off trends during economic slowdowns. The loan loss allowance deserves scrutiny—is it appropriately conservative for a construction lender, or is management being aggressive?
