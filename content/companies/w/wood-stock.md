---
title: "iShares Global Timber & Forestry ETF (WOOD)"
description: "A diversified fund holding timber companies, forest-products firms, and forestry REITs globally; blends commodity exposure with real-estate ownership structures and inflation hedging characteristics."
keywords:
  - timber
  - forestry
  - commodities
...
Timber and forest products are often touted as [inflation](/inflation/) hedges. As inflation rises, the cost of raw materials and land rises with it, and companies with large in-ground reserves of timber may see values appreciate. During inflationary periods when traditional [bonds](/bond/) suffer and growth stocks stall, timber-exposed funds have sometimes outperformed. This appeal has drawn institutional allocators and pension funds seeking [diversification](/diversification/) and inflation protection, though the historical evidence is mixed and timing matters significantly.
...
The sector is relatively small and illiquid compared to major equity indices, so WOOD's [bid-ask spread](/bid-ask-spread/) and price impact can be wider than for mega-cap funds. Holdings are not household names, limiting media coverage and public information relative to technology or consumer stocks.

## Cost and tax profile

As a passive [index fund](/index-fund/) from [BlackRock](/blk-stock/), WOOD has an [expense ratio](/expense-ratio/) lower than active management would command, though modestly higher than ultra-low-cost broad equity funds. Passive management also means lower turnover and better tax efficiency than active trading strategies, an advantage in taxable accounts. The fund's [dividend yield](/dividend-yield/) can be material, reflecting the income generated by timber REITs and profitable timber operators, though [dividend](/dividend/) growth is dependent on commodity prices and interest-rate environments.
