---
title: "WisdomTree Cloud Computing Fund (WCLD)"
description: "An exchange-traded fund targeting companies that provide cloud infrastructure, cloud software, and related services — from hyperscale platforms to specialized cloud-native vendors."
keywords:
  - cloud computing ETF
...
<div class="wiki-infobox-title">WisdomTree Cloud Computing Fund — segments</div>
...
| **Objective** | Track cloud-computing companies |
| **Index tracked** | Proprietary Cloud Index (or similar equity benchmark) |
| **Structure** | Standard, non-leveraged ETF |
| **Expense ratio** | Competitive for thematic cloud-sector funds |
| **Liquidity** | Moderate; actively traded on NASDAQ |
...
## Specialized cloud-related vendors
