...
description: "Western Digital is the dominant maker of hard disk drives for cloud data centers and client computers, a business shaped by cyclical supply-demand swings and shaped most by its decision to spin off its NAND flash memory operations."
keywords:
  - hard disk drives
  - data center storage
  - hdd manufacturer
...
<table>
<tr><th>Ticker</th><td>WDC (NASDAQ)</td></tr>
<tr><th>Founded</th><td>1970, Santa Ana, California</td></tr>
<tr><th>Sector</th><td>Data storage hardware</td></tr>
<tr><th>Primary product</th><td>Hard disk drives (HDD)</td></tr>
<tr><th>Main customer base</th><td>Cloud providers, data centers, enterprise, consumer</td></tr>
<tr><th>SEC CIK</th><td>106040</td></tr>
</table>
</aside>
...
During strong years, utilization rates spike, waits for delivery lengthen, and HDD makers can raise prices to take advantage of scarcity. Their [gross margins](/wiki/gross-profit-margin/) and [operating margins](/wiki/operating-margin/) expand, and profits soar. But the industry responds by building more fabs and ramping production; in the weaker years that follow, supply overhangs demand, prices collapse, margins compress to single digits, and cash flow tanks. Western Digital's earnings have swung from $4+ per share in peak years to losses in down years. A [stock](/wiki/stock/) built on a business this cyclical will trade like a cyclical—strong in recovery, pressured in slowdowns—and the [price-to-earnings ratio](/wiki/price-to-earnings-ratio/) will be far lower than a stable, predictable company's.
...
Building and running HDD fabs is enormously capital intensive. Disk-drive manufacturing demands cleanrooms, precision robotics, and specialized testing equipment. A modern fab can run $2 billion to build and operate. Western Digital and Seagate (the only other major HDD maker) must maintain or expand capacity to stay competitive, even in soft markets, or risk ceding share to a rival who gains a cost advantage. That means both companies' [free cash flow](/wiki/free-cash-flow/) swings wildly: strong in booms, negative or deeply reduced in downturns.
