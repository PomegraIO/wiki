---
title: "WEX Inc. (WEX)"
description: "WEX is a global business-intelligence and payment-processing company operating in three core segments: fleet and mobility (fuel cards for trucks), benefits administration (healthcare and dependent-care reimbursement), and corporate-expense management — all built on data and payment networks."
keywords:
  - fleet cards
  - payment processing
  - healthcare benefits
...
<table>
<tr><th>Ticker</th><td>WEX (NYSE)</td></tr>
<tr><th>Founded</th><td>2005 (through merger of two predecessors)</td></tr>
<tr><th>Headquarters</th><td>Portland, Maine</td></tr>
<tr><th>Business Model</th><td>Payment processing, data analytics, benefits administration</td></tr>
<tr><th>Operating Segments</th><td>Fleet Solutions, Workplace Solutions, General Sector</td></tr>
<tr><th>Customer Type</th><td>Large enterprises and mid-market businesses</td></tr>
<tr><th>SEC CIK</th><td>0001309108</td></tr>
</table>
</aside>
...
WEX also operates in healthcare travel for medical tourism (processing payments when patients travel for procedures), vehicle leasing (processing payments from lessees to lessors), and toll-road payments in various geographies. None of these is as large or as systematized as Fleet or Workplace, but collectively they represent growth opportunities and revenue [diversification](/diversification/).
...
Track the company's net-debt level and interest coverage — WEX uses debt to fund [acquisitions](/acquisition/) and operations, so its financial stability depends on debt management. Watch for major customer wins or losses (large fleet operators or benefits-consulting firms can be sticky anchors). And monitor regulatory developments around flexible spending accounts and payment processing, since changes in those areas could reshape the addressable market significantly.
