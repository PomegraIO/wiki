---
title: "WESCO International (WCC)"
description: "A large distributor of electrical, communications, and utility products to industrial, construction, utility, and data-center customers, expanded through the Anixter acquisition."
keywords:
...
| Segment | Focus | Primary Customers | Margin Profile |
|---------|-------|-------------------|-----------------|
| Electrical | Lighting, wire, controls, distribution equipment | Industrial plants, contractors, utilities | Thin; volume-based |
| Communications & Security | Data-center cabling, fiber, broadcast, security | Data centers, telecom, broadcasters, enterprises | Higher on installation/integration |
| Utility Solutions | Transformers, metering, service | Electric utilities, cooperatives, municipalities | Stable; some recurring service |
...
Debt load and capital structure are important metrics to track. The Anixter acquisition was debt-financed, and WESCO has used leverage to fund buybacks and [dividends](/dividend/). In a downturn or period of rising rates, elevated leverage can become a constraint. The 10-K and quarterly earnings releases detail debt maturity schedules and covenants; watching for credit-rating changes is prudent for lenders and investors sensitive to [refinancing risk](/refinancing-risk/).

## What Matters in Earnings and Valuation

For a distributor like WESCO, the key metrics to watch are:

- **[Gross profit margin](/gross-profit-margin/)** — the percentage difference between what WESCO pays and what it sells for, the primary lever for profitability
