...
The fund also holds non-US inflation-linked bonds, which adjust to the inflation indices of their respective countries — the UK Retail Price Index, the eurozone harmonised index, and so forth. These international holdings add [diversification](/diversification/) and give the shareholder exposure to [inflation expectations](/inflation-expectations/) in other economies, which are not perfectly correlated with US inflation. Floating-rate securities in the portfolio reset their coupons periodically, typically every three or six months, tying the investor's income to short-term [interest rates](/interest-rate/) that tend to rise when inflation is accelerating.
