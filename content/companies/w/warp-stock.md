---
title: "VanEck Space ETF (WARP)"
description: "An exchange-traded fund tracking companies involved in space exploration, satellites, launch services, and related infrastructure — betting on the commercialization of space."
keywords:
  - space ETF
...
<div class="wiki-infobox-title">VanEck Space ETF — key facts</div>
...
| **Objective** | Track space-industry companies |
| **Index tracked** | Proprietary VanEck space index (or similar equity benchmark) |
| **Structure** | Standard, non-leveraged ETF |
| **Expense ratio** | Qualitatively modest (typical for thematic ETFs) |
