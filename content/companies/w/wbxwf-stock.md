---
title: "Wallbox N.V. (WBXWF)"
description: "A Barcelona-based manufacturer of electric vehicle charging hardware for residential and commercial use. Wallbox sells wall-mounted chargers, software platforms, and energy-management systems to EV owners and fleet operators worldwide."
keywords:
  - EV charging
...
<table>
<tr><th>Ticker</th><td>WBXWF (OTC Markets)</td></tr>
<tr><th>Founded</th><td>2014, Barcelona, Spain</td></tr>
<tr><th>Headquarters</th><td>Barcelona, Spain</td></tr>
<tr><th>Sector</th><td>Electric vehicle infrastructure / automotive components</td></tr>
<tr><th>Main product</th><td>Wall-mounted EV charging systems (hardware + software)</td></tr>
<tr><th>Business model</th><td>Hardware sales; software subscriptions; energy services</td></tr>
<tr><th>SEC CIK</th><td>0001866501</td></tr>
</table>
</aside>
...
Wallbox is listed on the OTC Markets in the United States (WBXWF) and on the Spanish exchange. Its [annual report](/10-k/) and financial filings with the SEC (CIK 0001866501) show revenue trends, gross margins, operating expenses, and cash flow — the fundamentals of a hardware business. Watch for the trajectory of software and subscription revenue as a percentage of total revenue; higher penetration suggests the company is moving toward higher-margin, recurring revenue.
