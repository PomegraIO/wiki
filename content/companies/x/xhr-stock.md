...
Like all hospitality operators, Xenia is highly sensitive to occupancy rates, average daily room rates (ADR), and the metric RevPAR (revenue per available room), which multiplies occupancy by ADR. In strong travel markets and during peak seasons, these metrics expand dramatically. In [recessions](/recession/) or periods of travel weakness, they compress sharply, immediately pressuring earnings. The [2020 pandemic](/wiki/covid-19-lockdowns/) demonstrated this fragility: hotel RevPAR collapsed as travel stopped, forcing many REITs to cut [dividends](/dividend/). Recovery was relatively swift in the leisure and business-travel reopening, but the volatility reminded investors of the industry's cyclicality.
