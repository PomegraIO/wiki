---
title: "Xtrackers Artificial Intelligence and Big Data ETF (XAIX)"
description: "A thematic ETF tracking companies positioned at the frontier of AI and big data technology, from semiconductor makers to cloud-infrastructure providers."
keywords:
...
| | |
|---|---|
| **Fund name** | Xtrackers Artificial Intelligence and Big Data ETF |
| **Ticker** | XAIX |
| **Sponsor** | Xtrackers (DWS subsidiary) |
| **Fund type** | Exchange-traded fund (ETF), plain vanilla |
| **Underlying index** | Proprietary AI and big-data thematic index |
| **Base currency** | USD |
| **Asset focus** | Technology companies (semiconductors, software, cloud, data analytics) |
| **Investment approach** | Passive (tracks index) |
| **Typical expense ratio** | Low, typical of passive equity ETFs |
