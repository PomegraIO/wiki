---
title: "XFLH Capital Corp (XFLH)"
description: "XFLH Capital Corp is a blank-check acquisition company that raised $100 million via public offering in early 2026 and is searching for an operating business to acquire, with a focus on opportunities in China."
keywords:
  - blank-check company
  - SPAC
  - acquisition shell
...
XFLH Capital Corp is a [special-purpose acquisition company](/special-purpose-acquisition-company/) — a legal structure that raises cash from public investors and then uses that capital to hunt for an operating business to merge with or acquire. The company itself does not run any operations. It exists as a vehicle: a blank cheque waiting to be written.

XFLH completed its [initial public offering](/initial-public-offering/) in February 2026, raising $100 million through the sale of 10 million units at $10 each. Each unit consists of one ordinary share and rights to receive additional shares if a [business combination](/business-combination-purchase/) closes. The stock began trading on the [New York Stock Exchange](/new-york-stock-exchange/) under ticker XFLH. The company is incorporated in the Cayman Islands and maintains minimal staff — a board, advisors, and a small team tasked with finding and evaluating targets.
...
The IPO raised $100 million for the trust account — capital reserved for the [acquisition](/acquisition/). An additional roughly $574,000 sits outside the trust for working capital and operating expenses. That is the runway. The acquisition needs to close within 15 months, and it needs to be substantial enough that shareholders vote to approve it rather than redeeming their shares and walking away.
...
Sponsors typically retain "[founder shares](/founder-shares/)" that have no [redemption rights](/redemption-rights-equity/), so their incentive is to close a deal — any deal — before the deadline. That misalignment between sponsor and public shareholders is a known risk in SPAC investing.

## What makes or breaks a SPAC investment

The success of any SPAC investment depends almost entirely on the target that is acquired. XFLH itself has no [intrinsic value](/intrinsic-value/) — it is literally a shell. The business combination is everything. Investors are betting not on the sponsors' skill in running the company (there is no company yet), but on their skill in finding a valuable target and negotiating a fair price.
