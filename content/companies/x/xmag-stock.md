---
title: "Defiance Large Cap ex-Mag 7 ETF (XMAG)"
description: "XMAG is a US-focused equity ETF designed to track large-cap stocks while systematically excluding the 'Magnificent Seven' mega-cap tech giants, addressing concentration risk in broad market indices."
keywords:
  - large-cap equity ETF
  - magnificent seven exclusion
  - concentration risk
  - US equities
  - factor strategy
handwritten: true
...
The expense ratio is quoted on the fund's fact sheet and generally sits in the single-digit basis point range — competitive with other factor or thematic [equity ETFs](/equity-etf/), though notably higher than the cheapest broad large-cap alternatives, which often charge 0.03 percent or less. The fund trades on a major US exchange with sufficient volume to trade near [net asset value](/net-asset-value/) during normal market hours, though during volatile or low-volume periods spreads can widen.
