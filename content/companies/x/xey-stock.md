---
title: "GraniteShares YieldBOOST Ether ETF (XEY)"
description: "XEY holds Ethereum cryptocurrency while using covered-call options to generate monthly income, combining crypto exposure with a systematic income strategy similar to equity covered-call funds."
keywords:
  - Ethereum ETF
  - cryptocurrency ETF
  - covered calls
...
*The **GraniteShares YieldBOOST Ether ETF** (XEY) is the [Ethereum](/ethereum/) equivalent of the [Bitcoin](/bitcoin/) covered-call fund XBTY. It holds the cryptocurrency Ethereum and writes covered-call options against the position to generate monthly income distributions. Like all crypto-yield products, it reflects the maturing market's attempt to make a non-dividend-paying asset generate cash flow for investors.*

<aside class="wiki-infobox">
<table>
<tr><th>Ticker</th><td>XEY</td></tr>
<tr><th>Fund family</th><td>GraniteShares</td></tr>
<tr><th>Inception</th><td>2021–2022</td></tr>
<tr><th>Underlying</th><td>Ethereum (ETH)</td></tr>
<tr><th>Fund structure</th><td>Exchange-traded fund</td></tr>
<tr><th>Strategy</th><td>Hold Ethereum, sell monthly covered calls</td></tr>
<tr><th>Objective</th><td>Ethereum price exposure plus options-based yield</td></tr>
</table>
</aside>
