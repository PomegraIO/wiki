---
title: "Leverage Shares 2X Long XYZ Daily ETF (XYZG)"
description: "A leveraged exchange-traded fund designed to deliver twice the daily return of XYZ, a single-stock underlying, with daily rebalancing and associated volatility decay risk."
keywords:
  - leveraged ETF
  - 2X leverage
  - single-stock ETF
...
*The **Leverage Shares 2X Long XYZ Daily ETF** (ticker: XYZG) is an exchange-traded fund that aims to deliver double the daily return of a single equity security (ticker: XYZ) through the use of leverage, achieved by holding the underlying stock plus financial derivatives, and resetting its leverage position at the close of each trading day.*

<aside class="wiki-infobox">
<table>
<tr><th>Fund type</th><td>Leveraged equity ETF, 2X daily reset</td></tr>
<tr><th>Underlying</th><td>Single stock (XYZ)</td></tr>
<tr><th>Leverage structure</th><td>Derivatives and cash borrowing</td></tr>
<tr><th>Rebalancing</th><td>Daily at market close</td></tr>
<tr><th>Issuer</th><td>Leverage Shares</td></tr>
<tr><th>Appropriate holding period</th><td>Days to weeks, not months or years</td></tr>
<tr><th>Primary risk</th><td>Volatility decay; path dependency</td></tr>
<tr><th>Expense ratio</th><td>Typically 0.80–1.20% annually</td></tr>
</table>
</aside>

## Structure and daily rebalancing mechanics
...
Over two days, XYZ is down 1% (from $100 to $99), but XYZG is down 4% (from 100 to 96). The leveraged fund has significantly underperformed twice the return simply because the daily rebalancing locked in gains and losses at points that compounded unfavourably.

This decay accelerates with volatility. If XYZ swings wildly, trading +5%, –3%, +4%, –6% over four days in a non-directional pattern, XYZG will lose ground every time, even if XYZ ends the period only slightly up or down. The volatility itself is the cost; leverage amplifies that cost.

## Real risks and who should own this
...
## How to research XYZG

Start with the fund's prospectus, which must spell out the daily reset mechanism, the rebalancing costs, and the risks of decay. Many prospectuses include example scenarios showing how the fund can underperform or outperform a 2X target depending on the path XYZ takes.

Check the fund's daily factsheet for the current XYZ holding, the leverage ratio, and the most recent performance. Compare the fund's total return to 2 times the underlying stock's return over several time periods: one day, one week, one month, and one year. The longer the period, the larger you should expect the gap to be in the fund's disfavour (unless XYZ happens to have moved in a strong one-directional trend with little volatility).

Any investor considering XYZG should have a specific, time-limited thesis. "I think XYZ will surge tomorrow" is reasonable. "I am building a long-term position in XYZ with leverage" is a trap; use actual margin or unleveraged holdings instead.
