---
title: "ERShares Private-Public Crossover ETF (XOVR)"
description: "XOVR is an ETF holding a curated basket of companies at the crossover point between private and public markets — firms growing fast and approaching IPO, or young public companies still in hypergrowth."
keywords:
  - crossover investing
  - growth stocks
  - pre-IPO companies
...
| | |
|---|---|
| **What it is** | An actively managed ETF holding crossover-phase companies |
| **Objective** | Capture growth from companies crossing private-to-public boundary |
| **Holdings composition** | Mix of pre-IPO private companies and recent IPO public companies |
| **Rebalance schedule** | Periodic, set by portfolio manager discretion |
| **Typical number of holdings** | 25–50, varies based on market conditions |
| **Expense ratio** | Disclosed in fact sheet; actively managed products typically higher |
| **Liquidity** | Standard ETF trading on major US exchanges |
| **Primary risk** | Concentration in growth stocks; illiquidity in private holdings |
