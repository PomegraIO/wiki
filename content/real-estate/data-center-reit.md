---
title: "Data Center REIT"
description: "A data-center REIT owns and operates server facilities and computing infrastructure, leasing space to cloud providers, technology companies, and internet services. Data-center REITs benefit from growing demand for cloud computing and artificial intelligence."
keywords:
  - data center REIT
  - server farm
  - cloud computing
...
|   |   |
|---|---|
| **What it is** | A REIT owning server facilities and computing infrastructure |
| **Also called** | Cloud REIT, infrastructure REIT |
| **Primary asset** | Data centers, colocation facilities |
| **Tenants** | Cloud providers, tech companies, content networks |
| **Revenue drivers** | Power consumption, space utilization, capacity growth |
| **Key metric** | Megawatts deployed, utilization rates, net-new capacity |
| **Growth tailwind** | Cloud adoption, AI infrastructure, edge computing |
| **Cap rates** | Typically lower (3–5%) — reflects strong demand |
