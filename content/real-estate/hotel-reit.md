---
title: "Hotel REIT"
description: "A hotel REIT owns and operates hospitality properties, including full-service hotels, limited-service hotels, and extended-stay properties. Hotel REITs generate returns from room revenue and are cyclical, benefiting from travel demand but vulnerable to recessions and demand shocks."
keywords:
  - hotel REIT
  - hospitality
  - lodging
...
|   |   |
|---|---|
| **What it is** | A REIT owning hotel and hospitality properties |
| **Also called** | Lodging REIT, hospitality REIT |
| **Property types** | Full-service, limited-service, extended-stay, resorts |
| **Revenue source** | Room revenue (nightly rates and occupancy) |
| **Key metrics** | Occupancy rate, average daily rate (ADR), RevPAR |
| **Cap rates** | 5–8% depending on location and brand |
| **Cyclicality** | High — highly sensitive to business and leisure travel |
| **Volatility** | High — revenues decline sharply in downturns |
