...
description: "A modified gross lease is a commercial lease in which the landlord pays the base rent and some operating costs, while the tenant pays additional charges for costs exceeding a baseline. It splits responsibility between landlord and tenant."
keywords:
...
|   |   |
|---|---|
| **What it is** | Landlord pays base rent + some costs; tenant pays overages |
| **Also called** | Gross lease with stops, modified net lease |
| **Typical cost split** | Landlord: base costs; tenant: costs above baseline |
| **Common in** | Urban office, retail, some industrial |
| **Landlord responsibility** | Operating costs up to a baseline year (e.g., Year 1) |
| **Tenant responsibility** | Any cost increases above the baseline |
| **Benefit to tenant** | Predictable costs; no surprise bills |
| **Benefit to landlord** | Inflation protection; cost control |
