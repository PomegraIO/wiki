...
description: "Commercial real estate encompasses office buildings, retail properties, industrial warehouses, hotels, and mixed-use developments. It is held by REITs, institutional investors, and owner-occupants for income and asset appreciation."
keywords:
...
|   |   |
|---|---|
| **What it is** | Property held for business and commercial purposes |
| **Property types** | Office, retail, industrial, hotels, mixed-use |
| **Typical holder** | REITs, institutions, corporations, investors |
| **Financing** | Commercial mortgages (4–10% of purchase price) |
| **Income source** | Tenant rents, triple-net lease payments |
| **Returns** | Rental income + appreciation |
| **Leverage** | 50–70% debt typical for institutional investors |
| **Cyclicality** | Tied to business cycles and sector-specific trends |
