---
title: "Self-Storage REIT"
description: "A self-storage REIT owns and operates storage facilities leased to individual and commercial customers. Self-storage REITs have strong economics, including high incremental margins, pricing power in tight markets, and stable recurring revenue."
keywords:
  - self-storage REIT
  - storage facility
  - storage rental
...
|   |   |
|---|---|
| **What it is** | A REIT owning self-storage facilities |
| **Also called** | Storage REIT, mini-storage landlord |
| **Asset type** | Climate-controlled or outdoor storage units |
| **Customers** | Individuals, businesses, movers, downsizers |
| **Revenue model** | Monthly rental fees per unit |
| **Cap rates** | 4–6% — reflects strong demand and pricing power |
| **Occupancy rates** | 85–95% in strong markets |
| **Pricing power** | High — supplies are scarce and sticky |
...
1. **Large REITs**: Public self-storage REITs (CubeSmart, Public Storage, Extra Space Storage) have scale advantages and are expanding aggressively.

2. **Mom-and-pop owners**: Thousands of small, independent storage facilities exist. REITs can achieve better economics through scale, but independent competitors can survive.

3. **Peer-to-peer and alternative models**: Apps like Neighbor connect people with excess space to customers seeking storage. This is nascent but could disrupt the traditional model.
