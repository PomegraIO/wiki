...
description: "An adjustable-rate mortgage (ARM) has an interest rate that changes periodically, typically starting low for an initial period (3, 5, or 7 years), then adjusting annually or periodically thereafter. ARMs offer lower initial rates but higher risk."
keywords:
  ...
  - mortgage reset
  - rate adjustment
image: "https://picsum.photos/seed/adjustable-rate-mortgage/900/600"
---
...
<img src="https://picsum.photos/seed/adjustable-rate-mortgage/900/600" alt="A mortgage statement showing rate adjustment schedule" />

<div class="wiki-infobox-caption">ARMs start with low rates that adjust over time, creating payment uncertainty.</div>

|   |   |
|---|---|
| **What it is** | A loan with initial fixed rate, then periodic adjustments |
| **Initial period** | 3, 5, 7, or 10 years (teaser rate) |
| **Rate after initial** | Adjusts annually or every few years |
| **Rate determined by** | Index (SOFR, Treasury) + margin set by lender |
| **Caps and floors** | Typically annual cap (2% increase max) and lifetime cap (6%) |
| **Benefit** | Lower initial rate and payment |
| **Risk** | Payments rise when rates reset; risk of affordability stress |
