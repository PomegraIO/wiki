...
description: "A fixed-rate mortgage is a home loan with an interest rate that remains constant for the entire loan term (usually 15 or 30 years). Fixed-rate mortgages offer payment predictability and protection against rising interest rates."
keywords:
  - fixed-rate mortgage
  - mortgage
  - home loan
...
|   |   |
|---|---|
| **What it is** | A loan with constant interest rate and payment for 15–30 years |
| **Interest rate** | Fixed (locked in at origination) |
| **Typical terms** | 15-year, 20-year, 30-year |
| **Monthly payment** | Fixed and constant throughout the loan |
| **Refinancing** | Borrower can refinance to a lower rate if rates fall |
| **Payment breakdown** | Early years: mostly interest; later years: mostly principal |
| **Default risk** | Borrower takes on inflation risk; lender takes on rate risk |
