...
description: "Investing in apartment buildings, duplexes, and other residential properties with multiple tenant units."
keywords:
...
| Factor | Description |
|---|---|
| **Unit Count** | 2–100+ units; typically 4+ labeled "apartment" |
...
A single-family rental is a *lifestyle* asset that happens to generate income. A multi-family property is a *commercial investment* that requires [operational discipline](/wiki/operational-risk/). The difference is structural:

**Economics of scale.** One broken water heater in a single-family home is a $2,000 repair on a $300,000 property (0.67%). The same break in a 100-unit complex costs $2,000 on a $30 million asset—economically negligible. This is why larger buildings can tolerate lower [cap rates](/wiki/cap-rate/): their size cushions vacancy and repairs.

**Leverage and financing.** Single-family rentals are typically financed with portfolio loans (a traditional residential mortgage). Multi-family assets are financed with [commercial mortgages](/wiki/commercial-real-estate/) underwritten on cash flow: the lender cares about your [debt-service coverage ratio](/wiki/dscr/) (DSCR), not just your personal credit score. A 1.25× DSCR loan means your net operating income must be 25% higher than your annual debt service—the math is strict and non-negotiable.
...
**Acquisition and underwriting.** An investor identifies a property (off-market deal, MLS listing, auction) and models its financials. The standard input is the trailing twelve-month (TTM) [NOI](/wiki/net-operating-income/) (gross rent minus operating expenses—not including [debt service](/wiki/debt-to-assets-ratio/)). The purchase price is divided by NOI to get the **[cap rate](/wiki/cap-rate-commercial/)**: if NOI is $500,000 and the price is $10 million, the [cap rate](/wiki/cap-rate/) is 5%. A 4% cap rate in a 6% environment looks cheap but may signal risk (bad management, deferred maintenance, weak tenant quality).
...
**Exit and recycling.** After 5–7 years, the investor either holds for income, refinances to pull out accumulated equity, or sells into a 1031 exchange to defer [capital gains tax](/wiki/capital-gains-tax/). A [1031 exchange](/wiki/1031-like-kind-exchange/) allows an investor to swap a multi-family asset for another one (or real estate of like kind) and defer [gains indefinitely](/wiki/basis-step-up-inheritance/).
...
**[Net operating income (NOI)](/wiki/net-operating-income/).** EGI minus [operating expenses](/wiki/operating-lease/): property tax, insurance, utilities, repairs, management, marketing, reserves for capital expenditure. NOI is the cash available to service debt and distribute to equity owners. It is the numerator for the [cap rate](/wiki/cap-rate/) calculation.

**Cash-on-cash return.** Annual net cash flow (NOI minus debt service, minus taxes) divided by the [equity](/wiki/equity-reit/) down payment. If you put $2 million down and the property generates $300,000 in annual cash after all obligations, your cash-on-cash is 15%.
...
**Interest rate sensitivity.** Rising [interest rates](/wiki/interest-rate/) compress [cap rates](/wiki/cap-rate/). If you buy at 5% and rates jump, your property is now worth less in a higher-cap-rate environment. Investors hedging this hold variable-rate debt and refinance ahead of rate spikes, or lock in 10-year mortgages and accept the lower rate.

**Recession and tenant quality.** A recession triggers job losses, higher vacancy, and rent collection issues. Class A properties (newer, high-end) in strong metros hold up; Class C (older, lower-income) properties see 10–15% vacancy spikes. This is why "value-add" investments in strong [metropolitan areas](/wiki/real-estate-fund/) with diverse job bases are safer.

**[Capex](/wiki/capex-budgeting/) timing.** Roof, HVAC, and parking lot replacements are lumpy $50K–$500K expenses. A savvy investor reserves 5–8% of gross rent annually for [capital expenditures](/wiki/capex-budgeting/), not listed in NOI. This is the difference between paper cash flow and real take-home cash.
...
### Closely related
- [Cap rate (commercial)](/wiki/cap-rate-commercial/) — the valuation metric for multi-family
- [1031 like-kind exchange](/wiki/1031-like-kind-exchange/) — tax deferral for investors
- [Commercial real estate](/wiki/commercial-real-estate/) — the asset class
- [Real estate investment trust](/wiki/real-estate-investment-trust/) — public multi-family exposure

### Wider context
- [Residential real estate](/wiki/residential-real-estate/)
- [Net operating income](/wiki/net-operating-income/)
- [Depreciation recapture](/wiki/depreciation-recapture-investor/)
- [Debt-service coverage ratio](/wiki/dscr/)
