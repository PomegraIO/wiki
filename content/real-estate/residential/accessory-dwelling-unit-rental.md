---
title: "Accessory Dwelling Unit Rental"
description: "Secondary units on a primary residence generating rental income while the owner occupies the main house."
keywords:
...
| Aspect | Detail |
|---|---|
| **Typical configuration** | 1–2 bedroom secondary unit |
| **Rental range** | $800–$2,500/month (varies by market) |
| **Owner status** | Owner-occupied primary residence + rental unit |
| **Tax treatment** | Depreciation allowed on ADU portion; primary residence exemption applies to main house |
| **Financing** | HELOC or cash-out refinance common |
| **Zoning** | Local restrictions vary; increasingly permitted |
| **Utilities** | Typically separate meters or shared |
...
The IRS treats the ADU as rental property: the owner claims [depreciation](/wiki/depreciation/) on the unit's portion of the building and land improvements. The main residence receives no depreciation (owner-occupied homes do not depreciate for tax purposes). The split requires a [basis allocation](/wiki/cost-basis/): if the house cost $500,000 and the ADU is 20% of the structure, the owner depreciates $100,000 over 27.5 years (~$3,636 annually).

This depreciation shelters rental income from taxation. If the ADU generates $10,000 gross rent and has $4,000 in expenses, taxable income is $6,000. But with $3,636 depreciation deduction, taxable income is only $2,364. This shelter can eliminate federal and state income tax on ADU income, though [passive loss limitations](/wiki/passive-loss-limitation-real-estate/) may apply if the owner has large passive losses elsewhere.

Upon sale, the owner owes [depreciation recapture tax](/wiki/depreciation-recapture-investor/) on the accumulated depreciation (up to 25% rate), but this is often deferred if the owner is not in peak earning years or if the property is inherited (stepped-up basis rules).
...
- [Multi-family property](/wiki/multifamily-property/) — Larger-scale rental residential
- [Residential real estate](/wiki/residential-real-estate/) — Broader category
- [Property tax](/wiki/property-tax/) — Local tax on primary and secondary dwelling units
- [Vacation rental property](/wiki/vacation-rental-property/) — Short-term rental alternative
