...
description: "A conforming loan is a mortgage that meets the lending standards set by Fannie Mae and Freddie Mac, including limits on loan amount, debt-to-income ratio, and credit requirements. Conforming loans are the most common mortgage type in the U.S."
keywords:
  - conforming loan
  - loan limit
  - Fannie Mae
...
|   |   |
|---|---|
| **What it is** | A mortgage meeting Fannie Mae/Freddie Mac standards |
| **Loan limit** | $766,550 (2024 baseline; varies by county) |
| **Max debt-to-income** | 43% (typically) |
| **Min credit score** | 620+ (conventional); 580+ (with FHA insurance) |
| **Down payment** | 5–20% (varies by lender) |
| **Mortgage insurance** | Required if down payment <20% |
| **Interest rate** | Lower than jumbo loans (lenders' preferred product) |
| **Secondary market** | Highly liquid; easily sold to Fannie Mae, Freddie Mac, MBS investors |
...
1. Originate a conforming loan.
2. Sell it to Fannie Mae, Freddie Mac, or a mortgage-backed securities (MBS) investor.
3. Recoup capital to lend again.
