...
description: "An interest-only mortgage allows the borrower to pay only interest for an initial period (typically 5–10 years), with no principal reduction. After the initial period, the borrower must pay principal plus interest or refinance."
keywords:
...
|   |   |
|---|---|
| **What it is** | A loan with interest-only payments for initial period |
| **Interest-only period** | Typically 5, 7, or 10 years |
| **Initial payment** | Lower (interest only, no principal) |
| **After IO period** | Fully amortizing (principal + interest) or refinance |
| **Benefit** | Lower initial payment, more cash flow flexibility |
| **Risk** | Payment shock; no equity buildup; refinancing risk |
| **Best for** | Investors, short-term owners, high-income borrowers |
| **Risky for** | First-time homebuyers, budget-constrained borrowers |
