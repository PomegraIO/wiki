...
description: "A single-family rental is a house rented to a tenant, held by an individual investor or institution for rental income and appreciation. Single-family rentals offer more control but less operational leverage than multifamily properties."
keywords:
...
|   |   |
|---|---|
| **What it is** | A detached house rented to a tenant or family |
| **Also called** | SFR, rental house, residential rental |
| **Investor type** | Individual landlords, institutional funds, REITs |
| **Revenue source** | Monthly rent from tenant |
| **Key metrics** | Occupancy, rent, repair costs, property appreciation |
| **Cap rates** | 5–8% depending on location and condition |
| **Leverage** | 75–80% for typical individual investors |
| **Management** | More hands-on than multifamily; more tenant interaction |
