...
description: "A multifamily property is a residential building with multiple units — typically apartment complexes with 5+ units. Multifamily properties generate returns through rent collection and are a core holding for residential REITs and real estate investors."
keywords:
  - multifamily
  - apartment building
  - rental income
...
|   |   |
|---|---|
| **What it is** | A residential building with 5+ independent units |
| **Also called** | Apartment complex, apartment building, multifamily |
| **Unit count** | 5 to 500+ units depending on size |
| **Typical investor** | REITs, institutional funds, private investors |
| **Revenue source** | Monthly rent from tenants |
| **Key metric** | Occupancy rate, average rent, net operating income |
| **Cap rates** | 4–6% in strong markets, higher in weak ones |
| **Leverage** | 60–70% debt typical for institutional investors |
