---
title: "Cap Rate"
description: "The cap rate (capitalization rate) is the annual net operating income of a property divided by its purchase price or market value. It is the fundamental metric for valuing income-producing real estate and comparing returns across properties."
keywords:
  - cap rate
  - capitalization rate
  - NOI
...
| **What it measures** | Unleveraged return on property investment |
| **Typical range** | 3–8% depending on market and property type |
| **Prime locations** | Lower cap rates (3–5%) — reflect high demand |
| **Weak markets** | Higher cap rates (7–10%) — reflect low demand |
| **Inverse relationship** | Low cap rate = high price relative to income |
| **High cap rate** | Low price relative to income (value opportunity or risk premium) |
