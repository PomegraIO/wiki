---
title: "FHA Loan"
description: "An FHA loan is a government-insured mortgage from the Federal Housing Administration, designed to make homeownership accessible with lower down payments (3.5% or more). FHA loans allow borrowers with lower credit scores and less cash to qualify."
keywords:
  - FHA loan
  - FHA mortgage
...
|   |   |
|---|---|
| **What it is** | A government-insured mortgage for primary residences |
| **Minimum down payment** | 3.5% (or higher depending on credit) |
| **Borrower credit requirement** | 580+ FICO (some with lower scores with larger down payment) |
| **Debt-to-income ratio** | Up to 50% (higher than conventional mortgages) |
| **Mortgage insurance** | Required for life of loan (FHA mortgage insurance premium, MIP) |
| **Interest rate** | Typically slightly higher than conventional (0.25–0.5% premium) |
| **Loan limits** | Varies by county (2024: $440K–$1.1M) |
| **Available for** | Primary residences, not investment properties |
