---
title: "Percentage Rent Breakpoint: Natural vs Artificial"
description: "Explains percentage rent breakpoint: natural breakpoint divides minimum rent by percentage rate; artificial breakpoint is negotiated; impact on tenant rent obligation."
keywords:
  - percentage rent breakpoint
  - natural breakpoint percentage rent
  - artificial breakpoint negotiation
  - percentage rent calculation
  - retail lease percentage rent
...
<div class="wiki-infobox-title">Percentage Rent Breakpoint — key facts</div>

<img src="/svg/real-estate.svg" alt="An abstract editorial mark for the topic." />

<div class="wiki-infobox-caption">The pivot point that resets rent if sales boom.</div>

|   |   |
|---|---|
| **Definition** | Sales level at which percentage rent equals (or exceeds) the minimum rent obligation |
| **Natural breakpoint** | Minimum rent ÷ percentage rate; purely mathematical |
| **Artificial breakpoint** | Negotiated above natural breakpoint; favors tenant |
| **Typical percentage range** | 3–8% of gross sales for retail; varies by sector and location |
| **Impact** | Every $1 increase in breakpoint saves tenant $0.03–$0.08/year in rent (assuming the percentage rate) |
| **Lease context** | Common in shopping centers, outlet malls, and some restaurants and fitness centers |
| **Landlord position** | Prefers lower breakpoints (percentage rent triggers sooner); natural breakpoint is baseline |
| **Tenant position** | Prefers higher artificial breakpoint (delays percentage rent or avoids it if sales stay low) |
...
| Annual Sales | Natural Breakpoint ($1.33M) | Artificial Breakpoint ($1.55M) | Difference |
|---|---|---|---|
