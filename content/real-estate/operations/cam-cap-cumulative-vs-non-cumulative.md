...
keywords:
  ...
  - cam expense cap tenant
  - landlord banking unused cam increases
  - cam base year calculation
...
<div class="wiki-infobox-title">CAM Cap Structures — key facts</div>

<img src="/svg/real-estate.svg" alt="An abstract editorial mark for real estate operations." />

<div class="wiki-infobox-caption">Cumulative caps compound tenant risk; non-cumulative caps offer annual relief.</div>

|   |   |
|---|---|
| **Cumulative cap** | Unused increases roll forward; total cap applies cumulatively over the lease term |
| **Non-cumulative cap** | Annual cap resets each year; unused increases are forfeited by the landlord |
| **Typical CAM cap range** | 3–5% per year in retail; 2–3% in office |
| **Base year** | Year 1 CAM expense; all future years compared to this baseline |
| **Tenant cost impact** | Cumulative: much higher long-term exposure; Non-cumulative: lower and more predictable |
...
- [Commercial real estate](/commercial-real-estate/) — the market for office and retail properties
