---
title: "Tenant Improvement Allowance: How It Works"
description: "Understand tenant improvement allowances: what landlords cover, how budgets are set and capped, and negotiation strategies for tenants."
keywords:
...
<div class="wiki-infobox-title">TI Allowance — key facts</div>

<img src="/svg/real-estate.svg" alt="An abstract editorial mark for the topic." />

<div class="wiki-infobox-caption">Landlord concessions that shape both the build-out and the lease economics.</div>

|   |   |
|---|---|
| **Typical range** | $10–$50 per square foot, depending on market and property class |
| **Usually expressed as** | "Landlord shall provide a $X TI allowance" or "per-square-foot cap" |
...
1. The tenant engages an architect to design the improvements and produce construction documents.
2. The tenant solicits bids from contractors and selects one (usually subject to landlord approval).
3. The landlord reviews and approves the design and contractor to ensure quality and compliance with lease terms.
4. Construction begins; the tenant (or its contractor) submits invoices to the landlord.
5. The landlord reimburses the tenant (or pays the contractor directly) from the TI allowance, typically in draws as milestones are hit.
...
- [Net operating income](/net-operating-income/) — how TI costs and tenant concessions affect the landlord's NOI and property valuation
- [Commercial real estate](/commercial-real-estate/) — the market context in which TI allowances are negotiated
- [Cap rate](/cap-rate/) — why landlords care about the total concession package and its impact on yield

### Wider context

- [Real estate investment trust](/real-estate-investment-trust/) — how REITs manage and account for large TI allowances across portfolios
- [Amortization](/amortization/) — how tenants and landlords spread improvement costs over time
- [Depreciation](/depreciation/) — the tax treatment of TI improvements (usually capitalized and depreciated over asset life)
- [Business cycle](/business-cycle/) — vacancy and allowance levels are cyclical, peaking when demand is weak
- [Return on invested capital](/return-on-invested-capital/) — how a landlord evaluates whether a TI investment is worth the cost of capital
