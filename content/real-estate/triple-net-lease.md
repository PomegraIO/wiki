...
description: "A triple-net (NNN) lease is a commercial lease in which the tenant pays rent plus property taxes, insurance, and maintenance costs. Triple-net leases transfer most operating risks and costs to the tenant, providing landlords with stable, predictable income."
keywords:
  - triple-net lease
  - NNN lease
  - net net net
...
|   |   |
|---|---|
| **What it is** | Tenant pays: rent + property taxes + insurance + maintenance |
| **Also called** | NNN lease, absolute net, net lease |
| **Typical tenant** | Corporations, established businesses, investment-grade firms |
| **Landlord risk** | Low — tenant bears operating cost risk |
| **Landlord revenue** | Fixed rent; grows if lease has escalators |
| **Typical escalator** | 2–3% annual increase |
| **Lease term** | 5–20 years, often with renewal options |
| **Tenant requirement** | Must be creditworthy; can accept operating cost risk |
...
1. **Base rent**: The negotiated rent per square foot.
2. **Proportional property taxes**: Their share based on square footage.
3. **Proportional insurance**: Their share of building insurance.
4. **Proportional maintenance and repairs**: Their share of building common areas, HVAC, roof, etc.
