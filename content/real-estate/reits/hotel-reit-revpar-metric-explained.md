---
title: "Hotel REIT RevPAR Metric Explained"
description: "Revenue per available room (RevPAR) is the standard metric for hotel performance: occupancy multiplied by average daily rate, directly driving REIT income."
keywords:
  - hotel reit revpar metric
...
<div class="wiki-infobox-title">RevPAR — key facts</div>

<img src="/svg/real-estate.svg" alt="An abstract editorial mark for real estate topics." />

<div class="wiki-infobox-caption">The metric that bridges occupancy and pricing power in hospitality.</div>

|   |   |
|---|---|
| **Formula** | RevPAR = (Occupancy Rate) × (Average Daily Rate), or Total Room Revenue ÷ Available Rooms |
| **Unit** | Dollars per available room per day (or per month/year) |
| **Two components** | Occupancy (% of rooms booked) and ADR (average price per booked room) |
| **Reporting frequency** | Daily, weekly, monthly, and annual by most hotel companies |
| **Key driver** | Directly translates to net operating income (NOI) and cash available for distributions |
| **Market indicator** | RevPAR growth across comparable hotels signals lodging demand strength |
...
- [Real Estate Investment Trust](/real-estate-investment-trust/) — The vehicle structure underlying hotel REITs
- [Net Operating Income](/net-operating-income/) — How RevPAR translates to NOI and distributions
- [Commercial Real Estate](/commercial-real-estate/) — Broader hotel and lodging asset class
- [Cap Rate](/cap-rate/) — Pricing metric often linked to RevPAR and NOI
- [Dividend Yield](/dividend-yield/) — REIT distributions as a percentage of share price
- [Due Diligence](/due-diligence/) — Evaluating a hotel property through RevPAR trends

### Wider context

- [Business Cycle](/business-cycle/) — How economic cycles drive business and leisure travel
- [Real Estate Cycle](/real-estate-cycle/) — Supply and demand dynamics in hospitality
- [Market Capitalization](/market-capitalization/) — How REIT value is determined
