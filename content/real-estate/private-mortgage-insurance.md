...
description: "Private mortgage insurance (PMI) is insurance that borrowers with down payments less than 20% must pay. PMI protects the lender against losses if the borrower defaults, and is typically 0.5–2% of the loan amount annually."
keywords:
...
|   |   |
|---|---|
| **What it is** | Insurance protecting lender against borrower default |
| **When required** | Down payment <20% (LTV >80%) |
| **Annual cost** | 0.5–2% of loan amount (varies by credit, LTV) |
| **Monthly payment** | Rolled into mortgage payment |
| **Removal** | Possible when borrower reaches 20% equity |
| **Protects** | Lender (not borrower) |
| **Provider** | Private insurance companies (Radian, MGIC, Genworth, etc.) |
...
|---|---|---|
| **Removal** | At 20% equity | For life of loan (generally) |
| **Cost** | 0.5–2% annually | 0.55–1.75% upfront + ~0.55% annually |
