...
description: "Residential real estate encompasses housing properties — apartments, single-family homes, condominiums, and other dwellings — held for rent or sale. It is both an asset class and a personal shelter, creating unique economic dynamics."
keywords:
...
|   |   |
|---|---|
| **What it is** | Property held for housing (owned or rented) |
| **Primary holder** | Individual homeowners; also REITs and investors |
| **Market size** | Roughly 40% of global real estate value |
| **Financing** | Mortgages, down payments from buyer savings |
| **Returns** | Rental income (if rented); appreciation if owned |
| **Tax treatment** | Preferential for owner-occupied (primary residence) |
| **Leverage** | Highly leveraged (80%+ debt for buyers) |
| **Cyclicality** | Driven by rates, employment, demographics |
