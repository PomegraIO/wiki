...
description: "Net operating income (NOI) is the annual profit from a real estate property after subtracting operating expenses from gross revenue. It is the fundamental metric for evaluating real estate cash flow and is used in cap rate calculations."
keywords:
...
| **What it includes** | Rental income, operating costs, maintenance, taxes |
| **What it excludes** | Debt service (interest, principal), income taxes, capital gains |
| **Time period** | Typically annualized |
| **Used in** | Cap rate calculation, valuation, cash flow analysis |
| **Quality factor** | Must be sustainable and auditable to be reliable |
