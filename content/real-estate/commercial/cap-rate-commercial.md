---
title: "Cap Rate Commercial"
description: "Capitalization rate on commercial real estate, the annual net operating income yield relative to purchase price."
keywords:
  - capitalization rate
  - cap rate
  - commercial property
...
*The **cap rate** (capitalization rate) on a commercial property equals the property's annual [net operating income (NOI)](/wiki/net-operating-income/) divided by the purchase price, expressing the cash-on-cash return that an investor receives in the first year, excluding financing and appreciation.*
...
| **Typical range** | 4–8% for stabilized properties (urban core to secondary markets) |
| **High cap rates** | 8%+ (distressed, secondary locations, higher risk) |
| **Low cap rates** | <4% (prime assets, scarcity, strong growth expectations) |
| **NOI** | Gross rental income − operating expenses (maintenance, property tax, insurance) |
| **Excludes** | Debt service, income taxes, appreciation, vacancy loss |
| **Inverse relationship** | Higher property prices → lower cap rates (more competitive) |
...
Cap rate is not the same as [cash-on-cash return](/wiki/cash-on-cash-return/), which accounts for leverage. If you buy the $10 million property with 50% debt, your cash outlay is $5 million. The same $600,000 NOI translates to a 12% cash-on-cash return. Cap rates isolate the unlevered yield; cash-on-cash return reveals the levered impact of [mortgage debt](/wiki/mortgage-reit/).

## Inverse relationship with price and market cycles

Cap rates are driven by competition and supply/demand. When institutional investors and private equity firms have abundant capital, they bid aggressively for commercial properties, pushing prices up and cap rates down. Conversely, when capital is scarce (rising [interest rates](/wiki/interest-rate/), [recession fears](/wiki/recession/)), buyers retreat, properties sit, and sellers lower prices, pushing cap rates higher to attract buyers.
...
**Primary vs. secondary markets:** Manhattan office might trade at 3–4% cap rates due to trophy-asset status, limited supply, and global capital demand. A secondary-market office building in Des Moines might yield 6–7%. Both are "correct" in their respective markets; the difference reflects [risk premium](/wiki/risk-on-risk-off/).

**Property types:** Industrial has tightened (3–5% cap rates) due to [e-commerce](/wiki/retail-property-challenges/) demand. Office has widened (5–7%) due to pandemic remote-work concerns and rising [interest rates](/wiki/interest-rate/). Multifamily (apartments) typically ranges 4–6%, with regional variation.

**Tenant quality:** A [property leased to a Fortune 500](/wiki/triple-net-lease/) company with investment-grade credit might yield 3.5%; the same building leased to small local businesses might yield 6%, reflecting higher [credit risk](/wiki/credit-risk/).
...
**Leverage impact:** Cap rates are unlevered; [mortgage debt](/wiki/mortgage-personal/) transforms the return. A 5% unlevered cap rate becomes 10%+ cash-on-cash with 50% debt and rising interest rates on remaining equity.
...
**Tax consequences:** Depreciation deductions, [cost segregation studies](/wiki/cost-segregation-study/), and [Section 1031 exchanges](/wiki/1031-like-kind-exchange/) generate tax-deferred returns that boost effective returns above cap rates.

<div class="wiki-seealso">

### Closely related
- [Net Operating Income](/wiki/net-operating-income/) — operating profit before interest and taxes
- [Cash-on-Cash Return](/wiki/cash-on-cash-return/) — levered yield accounting for debt
- [Commercial Real Estate](/wiki/commercial-real-estate/) — properties leased to businesses
