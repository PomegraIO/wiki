---
title: "Recourse vs Non-Recourse Commercial Loans"
description: "Understand the difference between recourse and non-recourse commercial real estate loans and how personal liability affects borrower risk."
keywords:
  - recourse vs non-recourse commercial loan
  - non-recourse real estate loan
  - commercial mortgage recourse
  - personal liability real estate
...
<div class="wiki-infobox-title">Recourse vs Non-Recourse — key facts</div>

<img src="/svg/real-estate.svg" alt="An abstract editorial mark for commercial real estate." />

<div class="wiki-infobox-caption">Recourse loans expose borrowers to personal liability; non-recourse loans cap loss at the property itself.</div>

|   |   |
|---|---|
| **Recourse** | Lender can pursue borrower's personal assets after foreclosure sale |
| **Non-recourse** | Lender's recovery is limited to the property collateral |
| **Borrower downside in default** | Personal asset seizure vs. loss of property only |
| **Deficiency judgment** | Possible in recourse loans; not in non-recourse |
| **Lender market power** | Smaller deals and weaker borrowers often get recourse terms |
| **Pricing impact** | Non-recourse loans carry higher interest rates (lender absorbs more risk) |
...
- [Interest-Only Period in a Commercial Mortgage](/interest-only-period-commercial-mortgage/) — how IO structures affect cash flow and default risk
- [Replacement Reserve in Commercial Property Underwriting](/replacement-reserve-commercial-property/) — capital requirement for major repairs in NOI
- [Loan-to-Value Ratio](/loan-to-value-ratio/) — how LTV shapes loan terms and default exposure
- [Debt Service Coverage Ratio](/debt-service-coverage-ratio/) — the income metric lenders use to assess repayment capacity
- [Lease Expiration Schedule and Rollover Risk](/lease-expiration-schedule-risk/) — how tenant concentration creates refinancing and income risk

### Wider context

- [Commercial Real Estate](/commercial-real-estate/) — overview of the commercial property sector
- [Foreclosure](/foreclosure/) — the mechanics of property seizure and sale
