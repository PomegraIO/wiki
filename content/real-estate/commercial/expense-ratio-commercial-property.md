---
title: "Expense Ratio for Commercial Properties"
description: "Expense ratio (OER) for commercial property measures operating costs as a percentage of gross income. Typical ranges vary by property type and directly affect NOI and cap rate."
keywords:
  - expense ratio commercial property
  - operating expense ratio commercial real estate
  - oer commercial property
...
<div class="wiki-infobox-caption">A central benchmark for income-property profitability and market value.</div>

|   |   |
|---|---|
| **Formula** | Operating Expenses ÷ Gross Operating Income |
| **Typical range** | 30–60% for stabilized properties; varies sharply by type |
| **Office buildings** | 35–50% (utilities, maintenance, staffing are high) |
| **Retail centers** | 20–40% (common areas are shared; tenant fit-out offloaded) |
| **Apartment complexes** | 30–45% (maintenance and staff cost; lower utility burden per unit) |
| **Industrial** | 10–20% (minimal staffing; basic maintenance and property tax dominate) |
...
- [Net Operating Income](/net-operating-income/) — the profit metric that results after subtracting expenses
- [Cap Rate](/cap-rate/) — the valuation multiple applied to NOI to establish property price
- [Commercial Real Estate](/commercial-real-estate/) — the broader asset class and its drivers
- [Real Estate Investment Trust](/real-estate-investment-trust/) — vehicles that manage large commercial property portfolios and publicly report OER metrics

### Wider context

- [Real Estate Cycle](/real-estate-cycle/) — economic phases that influence property values and expense pressure
- [Asset Allocation](/asset-allocation/) — framework for deciding real estate allocation in a diversified portfolio
- [Leverage Ratio Forex](/leverage-ratio-forex/) — borrowing concepts parallel in commercial real estate financing
