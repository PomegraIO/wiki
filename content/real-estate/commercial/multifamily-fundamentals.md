---
title: "Multifamily Fundamentals"
description: "Apartment buildings and residential rental properties; yield sources, occupancy economics, and investment metrics."
keywords:
  - multifamily
  - apartment buildings
  - rental properties
...
| Aspect | Detail |
|--------|--------|
| **Property types** | Walk-ups, garden apartments, mid-rises, high-rises, luxury, workforce |
| **Typical size** | 50–300+ units per property |
| **Average rent** | $500–$3,000/month depending on location and class |
| **Occupancy** | 90–95% stabilized; drops to 70–80% during downturns |
| **Key metric** | Net operating income (NOI) per unit or per square foot |
| **Cap rate** | 4–7% for institutional-quality properties in prime markets |
| **Lease term** | 12-month standard; turnover 30–50% annually |
| **Main expense** | Labor (property management, maintenance) and real estate taxes |

</aside>

## The multifamily business model

Multifamily properties generate [revenue](/wiki/revenue-multiple/) from two sources: **rental income** and **ancillary fees** (parking, pet fees, storage, utility reimbursement). The investment math is built on [net operating income (NOI)](/wiki/net-operating-income/):
...
**NOI: ~$800K** on $1.32M revenue. On a $10M acquisition price, the [cap rate](/wiki/cap-rate/) is 8%—typical for secondary markets with average credit.
...
This leverage is why multifamily [REITs](/wiki/real-estate-investment-trust/) are cyclically sensitive: in boom times, rising occupancy and rents drive [earnings growth](/wiki/earnings-power-value/); in downturns, rent declines and vacancies compress margins rapidly.
...
## Leverage and [cap rates](/wiki/cap-rate/)

Multifamily is typically leveraged 65–75%, with [mortgage](/wiki/mortgage-personal/) financing at 55–70% loan-to-value (LTV). A $10M acquisition might be financed with $7M debt and $3M equity.

**Debt service**: $7M at 5% interest, 25-year amortization = ~$400K annually
...
1. **Unit renovations**: Update kitchens, bathrooms, flooring to justify higher rents. Expense: $5K–$15K per unit. Rent gain: $100–$300/month per unit.

2. **Operational efficiency**: Renegotiate vendor contracts, reduce turnover costs, implement online leasing. Typical savings: 2–3% of operating expenses.

3. **Ancillary revenue**: Add parking fees, pet fees, utility billing. Upside: 5–15% revenue growth.

4. **Amenity upgrades**: Fitness centers, co-working, landscaping. Cost: $2M–$10M for large properties. Return: 3–5% rent premium.
...
Despite these controls, during [recessions](/wiki/recession/), tenant defaults and bad-debt expense rise. During COVID-19, eviction moratoriums forced many properties to absorb unpaid rent for months.
...
Versus other [real estate](/wiki/real-estate-investment-trust/) sectors:

- **Office**: Multifamily has no structural decline threat (unlike [office](/wiki/office-reit/) post-COVID)
...
Multifamily's stability and scale make it the largest REIT sector and the backbone of most [real estate mutual funds](/wiki/real-estate-fund/).

<div class="wiki-seealso">

### Closely related
- [Real estate investment trust](/wiki/real-estate-investment-trust/) — publicly traded companies owning real estate
- [Net operating income](/wiki/net-operating-income/) — earnings from property operations
- [Cap rate](/wiki/cap-rate/) — NOI divided by property value; the yield on real estate
- [Mortgage](/wiki/fixed-rate-mortgage/) — financing for real estate purchases

### Wider context
- [Residential real estate](/wiki/residential-real-estate/) — housing as an asset class
- [Commercial real estate](/wiki/commercial-real-estate/) — office, retail, and other non-residential properties
- [Real estate valuation](/wiki/real-estate-fund/) — pricing property based on income and comparable sales
- [Real estate investment](/wiki/value-add-real-estate/) — strategies for acquiring and improving properties
