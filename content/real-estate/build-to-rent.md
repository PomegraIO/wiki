---
title: "Build-to-Rent"
description: "Build-to-rent communities are newly constructed residential properties designed to be rented rather than sold. They offer investors modern properties in supply-constrained markets with attractive yields and long-term appreciation potential."
keywords:
  - build-to-rent
  - BTR
...
|   |   |
|---|---|
| **What it is** | Newly constructed rental communities (single or multifamily) |
| **Also called** | BTR, build-for-rent, new rental community |
| **Form** | Single-family BTR or multifamily BTR communities |
| **Investor** | Institutions, developers, REITs |
| **Revenue source** | Monthly rent from tenants |
| **Construction cycle** | 2–4 years from land to lease-up |
| **Cap rates at stabilization** | 4–6% depending on market |
| **Advantages** | Modern units, efficient operations, high-quality tenants |
