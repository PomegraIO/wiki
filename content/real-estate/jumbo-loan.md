---
title: "Jumbo Loan"
description: "A jumbo loan is a mortgage that exceeds the conforming loan limits set by Fannie Mae and Freddie Mac (typically >$766,550). Jumbo loans have stricter requirements, higher interest rates, and are used for expensive properties in high-cost markets."
keywords:
  - jumbo loan
  - jumbo mortgage
  - non-conforming loan
...
|   |   |
|---|---|
| **What it is** | A mortgage exceeding conforming loan limits |
| **Minimum loan amount** | Typically $766,550+ (varies by county) |
| **Maximum loan amount** | No statutory limit; lender-dependent |
| **Interest rate** | Higher than conforming loans (0.25–0.75% premium) |
| **Minimum down payment** | 10–20% (typically; stricter than conforming) |
| **Debt-to-income ratio** | 36–43% (stricter than conforming) |
| **Credit score requirement** | 700+ (stricter than conforming) |
| **Mortgage insurance** | Generally not available (down payment >10% required) |
| **Loan documentation** | More rigorous income, asset, and employment verification |
...
| **Interest rate** | Lower (benchmark) | Higher (0.5%+ premium) |
| **Down payment** | 5–20% | 10–20% (typically) |
| **Min FICO** | 620 | 700+ |
| **Debt-to-income** | 43% (typical) | 36–43% (stricter) |
| **Mortgage insurance** | PMI if <20% down | Generally unavailable |
| **Secondary market** | Highly liquid (GSEs) | Less liquid (private investors) |
