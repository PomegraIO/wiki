---
title: "How a Mortgage Recast Works"
description: "Learn how a mortgage recast works when you make a large principal payment. Understand fees, timing, and when recasting makes financial sense."
keywords:
  - mortgage recast
  - mortgage recasting process
  - principal payment recast
...
<div class="wiki-infobox-title">Mortgage Recast — key facts</div>

<img src="/svg/real-estate.svg" alt="An abstract editorial mark for the topic." />

<div class="wiki-infobox-caption">A recast reduces your monthly payment while keeping your payoff date fixed.</div>

|   |   |
|---|---|
| **Minimum payment required** | Typically $10,000–$20,000 in extra principal (varies by lender) |
| **Recast fee** | Usually $200–$500 (far lower than refinancing) |
| **Time to process** | 2–4 weeks after approval |
| **Impact on interest rate** | None; rate stays the same |
| **Impact on loan term** | None; final payoff date unchanged |
| **Monthly payment change** | Decreases based on new amortization schedule |
| **Eligibility** | Conventional mortgages typically; some restrictions on VA/FHA loans |
...
- [Amortization](/amortization/) — the core concept of spreading loan payments over time and how principal and interest are divided
- [Fixed-rate mortgage (personal)](/fixed-rate-mortgage-personal/) — mortgages with locked interest rates, the most common recast candidates
- [Refinancing](/refinancing-risk/) — the alternative when you want to change terms or capture a lower rate
- [Loan-to-value ratio](/loan-to-value-ratio/) — how lenders assess risk, affected by principal reductions

### Wider context

- [Interest rate](/interest-rate/) — the cost of borrowing that a recast does not change
- [Debt-to-equity ratio](/debt-to-equity-ratio/) — how extra principal payments improve your balance sheet
- [Cash conversion cycle](/cash-conversion-cycle/) — the timing of cash inflows that might fund a recast
