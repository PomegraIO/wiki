...
description: "The cash-on-cash return is the annual cash profit from a real estate investment divided by the cash invested. It measures the annual return on the investor's actual cash down payment, accounting for leverage."
keywords:
  - cash on cash return
  - leveraged return
  - real estate return
...
|   |   |
|---|---|
| **Formula** | Annual cash flow ÷ Cash invested (down payment) |
| **What it measures** | Annual return on invested equity, after debt service |
| **Includes** | Rental income minus expenses minus debt service |
| **Typical range** | 5–15% for residential; varies by leverage and market |
| **Affected by** | Leverage, interest rates, property cash flow, occupancy |
| **Advantage** | Shows return on actual money invested |
| **Limitation** | Ignores appreciation and doesn't account for total return |
...
At 5% interest, a 20-year mortgage on $400K costs $30K annually.
At 6% interest, the same mortgage costs $33K annually.
At 4% interest, it costs $27K annually.
