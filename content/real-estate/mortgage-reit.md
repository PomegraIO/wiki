---
title: "Mortgage REIT"
description: "A mortgage REIT holds a portfolio of mortgages or mortgage-backed securities and generates returns from the difference between its borrowing costs and the interest rates it earns. It distributes 90% of taxable income to shareholders as dividends."
keywords:
  - mortgage REIT
  - MBS
...
|   |   |
|---|---|
| **What it is** | A REIT holding mortgages or MBS |
| **Also called** | mREIT, financial REIT |
| **Asset base** | Mortgages, agency MBS, non-agency MBS |
| **Primary income** | Mortgage interest, prepayment fees |
| **How funded** | Borrowing (repos, credit lines), equity capital |
| **Key risk** | Interest rate risk, refinancing risk |
| **Yield** | Typically higher than equity REITs (4–8%) |
| **Tax treatment** | Dividend income taxed at ordinary rates |
