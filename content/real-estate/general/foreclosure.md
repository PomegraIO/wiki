---
title: "Foreclosure"
description: "A foreclosure is a legal process in which a lender takes possession of a property after a borrower defaults on mortgage payments. Foreclosure is the ultimate enforcement mechanism lenders use to recover losses from unpaid debts."
keywords:
  - foreclosure
  - default
  - repossession
...
|   |   |
|---|---|
| **What it is** | Legal process to seize and sell property after borrower default |
| **Trigger** | Borrower fails to pay mortgage for 3–6 months |
| **Notice period** | Varies by state (often 30–120 days) |
| **Process** | Default notice → pre-foreclosure period → auction → post-sale period |
| **Sale method** | Judicial (court-supervised) or non-judicial (lender-directed) |
| **Outcome for borrower** | Loss of property and equity; credit damage; possible deficiency judgment |
| **Outcome for lender** | Recovery of unpaid debt (if property value is sufficient) |
...
1. **Refinance**: If the borrower has equity and credit, refinancing to a more affordable loan can help.

2. **Loan modification**: Lenders sometimes modify loan terms (lower rates, extend amortization, reduce principal) to make payments affordable.

3. **Short sale**: Sell the property for less than owed, with lender approval. The lender forgives the shortfall.

4. **Deed in lieu of foreclosure**: The borrower transfers title to the lender in exchange for forgiving the debt.

5. **Forbearance**: The lender agrees to pause or reduce payments temporarily (often during unemployment or hardship).

6. **Bankruptcy**: Chapter 13 bankruptcy can delay foreclosure and restructure the debt.
