...
description: "The gross rent multiplier (GRM) is the property purchase price divided by annual gross rental income. It is a quick valuation shortcut: a GRM of 10 means the property costs 10x annual rent."
keywords:
...
| **Interpretation** | How many years of rent the price represents |
| **Typical range** | 5–15x depending on property type and market |
| **Advantages** | Simple, quick, ignores expense complexity |
| **Disadvantages** | Ignores operating costs, NOI quality, leverage |
| **Best used for** | Quick screening, market comparison |
| **Weakness** | Two properties with same GRM can have very different NOI |
