---
title: "Cap Rate vs Interest Rate Spread in Commercial Real Estate"
description: "The spread between a property's cap rate and financing rate determines profitability; positive leverage occurs when cap rate exceeds interest rate."
keywords:
  - cap rate vs interest rate
  - commercial real estate leverage
  - positive leverage commercial property
  - cap rate spread financing
...
Cap rate and interest rate are distinct metrics. Cap rate measures the income yield on the property based on [net operating income](/net-operating-income/); interest rate is the cost of borrowed capital.

</div>

<aside class="wiki-infobox">

<div class="wiki-infobox-title">Cap Rate vs Interest Rate — key facts</div>

<img src="/svg/real-estate.svg" alt="An abstract editorial mark for real estate financing." />

<div class="wiki-infobox-caption">The difference between property yield and borrowing cost determines whether leverage enriches or erodes returns.</div>

|   |   |
|---|---|
| **Positive leverage** | Cap rate > Interest rate; debt amplifies equity returns |
| **Negative leverage** | Cap rate < Interest rate; debt reduces equity returns |
| **Typical spreads** | 1–3% in stable markets; 0–2% or negative in hot markets |
| **Cap rate range** | 4–10%+ depending on property type and location |
| **Mortgage rates** | 4–7% for investment properties (varies with cycle) |
| **Investor focus** | Acquiring properties where spread is sufficiently wide |
...
1. **Unleveraged yield** (NOI ÷ purchase price = cap rate)
2. **Debt service coverage ratio** (NOI ÷ annual debt service) — typically 1.2× minimum
3. **Cash-on-cash return** (annual cash flow ÷ equity invested) — desired return target
4. **Cap rate vs. interest rate spread** — minimum 1–1.5% for comfort
...
- [Cap Rate](/cap-rate/) — Definition and calculation of property yield metrics
- [Hard Money Loans in Real Estate](/hard-money-loan-real-estate/) — Higher-cost financing affecting spread calculations
- [Net Operating Income](/net-operating-income/) — The numerator in cap rate; key to spread analysis
- [Debt-to-Equity Ratio](/debt-to-equity-ratio/) — How leverage ratio affects spread sensitivity
- [Interest Rate](/interest-rate/) — Financing costs and refinancing risk
- [Return on Equity](/return-on-equity/) — How spreads translate to shareholder returns
- [Debt Service Coverage Ratio](/interest-coverage-ratio/) — Ability to pay interest and principal

### Wider context

- [Commercial Real Estate](/commercial-real-estate/) — Broader real estate investment fundamentals
- [Real Estate Investment Trust](/real-estate-investment-trust/) — Passive alternative to direct property ownership
- [Business Cycle](/business-cycle/) — How economic expansion and contraction affect spreads
- [Leverage Ratio](/leverage-ratio-forex/) — General leverage and risk concepts
- [Liquidity Risk](/liquidity-risk/) — Ability to exit a real estate position
