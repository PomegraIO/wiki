---
title: "Seller Financing in Real Estate: How It Works"
description: "Seller financing lets a property owner act as lender, extending credit directly to the buyer via a promissory note and deed of trust."
keywords:
  - seller financing real estate how it works
  - owner financing
...
<div class="wiki-infobox-title">Seller Financing — key facts</div>

<img src="/svg/real-estate.svg" alt="An abstract editorial mark for real estate financing." />

<div class="wiki-infobox-caption">Direct credit extension from property owner to buyer, secured by the property itself.</div>

|   |   |
|---|---|
| **Legal instrument** | Promissory note + deed of trust / mortgage |
| **Interest rates** | Typically 5–10%, negotiated between parties |
| **Terms** | 5–15 years typical; can be shorter or longer |
| **Down payment** | 10–30% or more, negotiated |
| **Balloon payment** | Often used; large final payment at maturity |
| **Who benefits** | Buyers without bank financing; sellers seeking income |
| **Primary risk** | Seller becomes junior to property tax liens and property hazards |
...
## Legal documentation and professional help
...
- [Hard Money Loans in Real Estate](/hard-money-loan-real-estate/) — Alternative non-traditional financing for real estate
- [1031 Exchange: Boot and Taxable Proceeds](/1031-exchange-boot-taxable/) — Tax deferral in property exchanges; installment sales complement this strategy
- [Cap Rate vs Interest Rate Spread](/commercial-real-estate-cap-rate-vs-interest-rate/) — Financing cost impact on property returns
- [Mortgage-Backed Security](/mortgage-backed-security/) — How mortgages are pooled and sold; seller notes are not securitized
- [Deed of Trust](/real-estate-investment-trust/) — Security instrument holding the property lien
- [Capital Gains Tax](/capital-gains-tax-investor/) — Tax on property sale proceeds; installment sales defer recognition
- [Promissory Note](/bond/) — Formal promise to pay (the note is a form of debt)

### Wider context

- [Interest Rate](/interest-rate/) — The cost of borrowing; affects seller-financed rates
- [Counterparty Risk](/counterparty-risk/) — Buyer default risk the seller assumes
- [Liquidity Risk](/liquidity-risk/) — Seller financing ties up capital; illiquid compared to cash sale
- [Commercial Real Estate](/commercial-real-estate/) — Broader real estate investment fundamentals
- [Real Estate Investment Trust](/real-estate-investment-trust/) — Institutional alternative to direct property ownership
