---
title: "Hard Money Loans in Real Estate"
description: "Hard money loans are asset-based real estate financing used by investors and flippers for short-term purchases when conventional lenders won't approve."
keywords:
  - hard money loan real estate
  - hard money lender
  - asset-based lending
  - real estate short-term financing
  - loan-to-value ratio hard money
...
<div class="wiki-infobox-title">Hard Money Loans — key facts</div>

<img src="/svg/real-estate.svg" alt="An abstract editorial mark for real estate financing." />

<div class="wiki-infobox-caption">Asset-based lending secured by the property itself, favoring speed and flexibility over traditional underwriting.</div>

|   |   |
|---|---|
| **Typical loan-to-value (LTV)** | 65–75% of current property value |
| **Loan term** | 6 months to 3 years (usually 12–24 months) |
| **Interest rates** | 8–15% annually (vs. 6–8% for conventional mortgages) |
| **Primary users** | [Fix and flip](/), rental acquisitions, bridge loans |
| **Key advantage** | Fast approval (days to weeks) |
| **Key risk** | High cost; repayment contingent on property sale or refinance |
| **Lender type** | Private funds, real estate investment companies, individuals |
...
- [1031 Exchange: Boot and Taxable Proceeds](/1031-exchange-boot-taxable/) — How to defer taxes on real estate sales and reinvestment mechanics
- [Cap Rate vs Interest Rate Spread](/commercial-real-estate-cap-rate-vs-interest-rate/) — When positive leverage makes a deal profitable
- [Seller Financing in Real Estate](/seller-financing-real-estate-how-it-works/) — Alternative financing directly from the property owner
- [Loan-to-Value Ratio](/price-to-book-ratio/) — How collateral coverage affects borrowing terms
- [Commercial Real Estate](/commercial-real-estate/) — Overview of commercial property investing
- [Real Estate Investment Trust](/real-estate-investment-trust/) — Passive real estate ownership through REIT shares
- [Refinancing Risk](/refinancing-risk/) — When rising rates lock borrowers into unfavorable terms

### Wider context

- [Asset-Backed Lending](/real-estate-investment-trust/) — Collateral-based credit fundamentals
- [Mortgage-Backed Security](/mortgage-backed-security/) — How mortgages become tradeable securities
- [Interest Rate](/interest-rate/) — Price of borrowed money
- [Leverage Ratio](/leverage-ratio-forex/) — How borrowing amplifies returns and risk
- [Default Rate](/default-rate/) — Historical lender losses
