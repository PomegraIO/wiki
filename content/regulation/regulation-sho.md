...
description: "Regulation SHO is an SEC rule governing short selling. It requires brokers to locate shares before allowing a short sale and imposes penalties for failed deliveries."
keywords:
  - Regulation SHO
  - Reg SHO
  - short selling
...
|---|---|
| **Adopted** | June 2005 |
| **Key rule** | Rule 10a-1 (locate requirement) |
| **Core principle** | Broker must believe shares can be borrowed before allowing short |
| **Failed delivery** | Broker must buy in after 10 business days (or 13 for threshold securities) |
| **Scope** | All equities, both long and short selling |
