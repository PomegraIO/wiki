---
title: "Rule 10b-5 Enforcement"
description: "SEC's foundational anti-fraud rule and its application to insider trading prosecutions and market manipulation."
keywords:
  - rule-10b-5
  - insider-trading-law
...
| **Enacted** | 1942 |
| **Scope** | All market participants, trades, brokers |
| **Key Prohibitions** | False statements, omissions, manipulation |
| **Enforcement Body** | SEC; DOJ for criminal cases |
| **Penalties** | Civil fines, disgorgement, imprisonment (criminal) |
...
The rule's elegance lies in its breadth. It applies to anyone—insiders, tippers, outsiders, company officers, brokers—and to all transactions in securities, whether listed on an exchange or traded over-the-counter ([over-the-counter-market](/wiki/over-the-counter-market/)). Courts have held it covers [short-selling](/wiki/short-selling/), [merger-arbitrage](/wiki/merger-arbitrage/), and even online message boards.

## Insider trading prosecutions

The SEC and Department of Justice use Rule 10b-5 as the primary vehicle to prosecute [insider-trading](/wiki/insider-trading-law/). A classic insider-trading case alleges:

- The defendant possessed [material](/wiki/material-adverse-change/) non-public information (MNPI).
- The defendant traded on that information.
- The defendant obtained the information in breach of a [fiduciary-duty](/wiki/fiduciary-duty/) or duty of trust.
...
- Corporate insiders ([Section-16-reporting](/wiki/section-16-reporting/) officers trading ahead of announcements).
...
The rule bars both affirmative misstatements and material omissions. A company officer who tells investors "our pipeline is healthy" while omitting a failed trial can face liability for the half-truth. Similarly, a broker who recommends a stock without disclosing a [conflict-of-interest](/wiki/potential-gdp/) (e.g., the firm is a market-maker or advisor to the company) violates the omission prong.

This creates a heavy burden on public companies, advisors, and analysts to maintain [disclosure](/wiki/footnote-disclosure/) discipline.

## Manipulation and wash trades

Rule 10b-5's anti-manipulation language catches [wash-trades](/wiki/wash-trade-rules/) (fake buy-sell to pump volume), [spoofing](/wiki/order-routing-logic/) (placing and canceling orders to mislead), and layering (simultaneous buys and sells to create false liquidity). The SEC brought high-profile cases against [high-frequency-trading](/wiki/high-frequency-trading/) firms for such conduct.
...
- Corporate officers using [share-buyback](/wiki/share-buyback/) programs to inflate earnings while selling shares.

Settlements often result in [disgorgement](/wiki/clawback/) (return of ill-gotten gains), civil penalties, and [officer-and-director-bars](/wiki/beneficial-ownership-disclosure/).

<div class="wiki-seealso">

### Closely related
- [Insider Trading Definition](/wiki/insider-trading-definition/) — What constitutes illegal insider trading.
- [SEC Enforcement](/wiki/sec-enforcement/) — The SEC's enforcement actions.
- [Misappropriation Theory](/wiki/misappropriation-theory/) — A key insider-trading doctrine under Rule 10b-5.

### Wider context
- [Securities Regulation](/wiki/securities-exchange-act-of-1934/) — The foundational federal laws.
- [Regulation FD](/wiki/regulation-fd/) — Fair disclosure rule supplementing Rule 10b-5.
- [Blue Sky Laws](/wiki/blue-sky-laws/) — State securities regulations.
