---
title: "Regulation A"
description: "Regulation A is an SEC exemption allowing companies to raise up to $75 million in a year using a simplified public offering (Reg A+) without full Securities Act registration."
keywords:
  - Regulation A
  - Reg A+
  - mini-IPO
...
Regulation A is an exemption from full registration. For private offerings to accredited investors, see [Regulation D](/regulation-d). For crowdfunding offerings, see [Regulation Crowdfunding](/regulation-cf).
...
|   |   |
|---|---|
| **Tier 1 (Mini)** | Up to $20 million per year |
| **Tier 2 (Reg A+)** | Up to $75 million per year |
| **Disclosure requirement** | Form 1-A (simpler than S-1) |
| **SEC review** | Yes, but faster than S-1 |
| **State review** | Yes, securities law review in each state |
| **Investor limits** | None (can sell to public) |
| **Reporting after** | Annual and semiannual reports |

</aside>

## Origins and the JOBS Act expansion

Regulation A was created in 1992 to allow small companies to raise up to $1 million without full registration. It was lightly used — the burden of state-by-state compliance was high. The [JOBS Act](/jobs-act) of 2012 expanded Regulation A to $50 million (later to $75 million), simplified state review, and created "Regulation A+" as the tier for larger offerings.
...
The [SEC](/securities-and-exchange-commission) reviews the Form 1-A, issues comment letters, and eventually issues a "qualification." Once qualified, the company can begin selling securities. The review typically takes 2–3 months for Tier 1, 4–6 months for Tier 2. This is faster than a full IPO (typically 6–12 months).
...
- [JOBS Act](/jobs-act) — expanded Regulation A
- [Regulation D](/regulation-d) — private offering exemption
- [Regulation Crowdfunding](/regulation-cf) — crowdfunding exemption
- [Securities Act of 1933](/securities-act-of-1933) — the law Reg A exempts from
- [Initial public offering](/initial-public-offering) — the traditional alternative

### Wider context

- [Blue-sky laws](/blue-sky-laws) — state regulation still applies
- [Securities and Exchange Commission](/securities-and-exchange-commission) — reviews Reg A offerings
- [Accredited investor](/accredited-investor) — can invest in any Reg A
