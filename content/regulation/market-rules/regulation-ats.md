---
title: "Regulation ATS"
description: "SEC framework establishing the rights, obligations, and safeguards for alternative trading systems, including dark pools and proprietary networks."
keywords:
  - regulation ats
...
<div class="wiki-infobox-title">Regulation ATS — key facts</div>

<img src="/svg/regulation.svg" alt="An abstract editorial mark for market regulation." />

<div class="wiki-infobox-caption">The regulatory bridge between exchange rules and proprietary trading networks.</div>

|   |   |
|---|---|
| **What it is** | SEC regulation (17 CFR Part 300) establishing requirements for alternative trading systems |
| **Effective since** | 1998 (current form); updated substantially in 2005, 2023–2024 |
| **Coverage** | Dark pools, internal crossing networks, proprietary trading systems |
...
Not all securities trading happens on the New York Stock Exchange or the [NASDAQ](/nasdaq/). Since the 1990s, private electronic platforms called alternative trading systems have grown to handle roughly one-quarter of all US equities volume. These platforms—colloquially known as ["dark pools"](/alternative-trading-system/)—are owned by major [broker-dealers](/broker/), investment banks, and technology firms. They allow large institutional traders to buy and sell blocks of shares without broadcasting their orders to the broader market.

An institutional investor holding 1 million shares it wants to sell faces a dilemma: post the order on a public exchange and the market immediately flees (a cost called "price impact"); use a dark pool and the trade is invisible until executed, but the operator may fill it slowly or incompletely. Regulation ATS exists because dark pools occupy a middle ground: they are venues (like [exchanges](/stock-exchange/)), but privately operated (like brokerage networks). Without clear rules, they could become black boxes, exempt from transparency and vulnerable to abuse. Regulation ATS codifies what dark pools must do.
...
Regulation ATS Rule 300(b) states that an ATS cannot execute trades at prices worse than the [national best bid and offer](/). If the [NYSE](/new-york-stock-exchange/) is quoting a stock at $50.00 bid, $50.01 offer, an ATS cannot execute a buy order at $50.05—the order must either be executed at $50.01 or better, or routed to the NYSE.
...
- [Alternative Trading System](/alternative-trading-system/) — the venues governed by Regulation ATS
- [Stock Exchange](/stock-exchange/) — traditional regulated venues competing with dark pools under Regulation ATS
- [Broker-Dealer](/broker/) — operators of many dark pools and ATS platforms
- [Large Trader Reporting](/large-trader-reporting/) — SEC rule providing surveillance data on ATS volume
- [Algorithmic Trading](/algorithmic-trading/) — high-speed strategies that leverage dark pool opacity
