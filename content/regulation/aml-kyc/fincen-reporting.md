...
description: "Mandatory reporting by financial institutions to the US Financial Crimes Enforcement Network; core pillar of AML/KYC compliance."
keywords:
  - fincen reporting
...
- Broker-dealers and investment advisors (for securities transactions and [money laundering](/wiki/anti-money-laundering/))
...
## Integration with [AML compliance](/wiki/aml-compliance/)

FinCEN reporting is one pillar of a broader [anti-money laundering](/wiki/anti-money-laundering/) (AML) program. Banks must also conduct [Know-Your-Customer](/wiki/know-your-customer/) (KYC) due diligence, where they verify customer identity and beneficial ownership, assess risk, and monitor for changes. Enhanced due diligence (EDD) applies to high-risk customers. The data gathered in KYC informs SAR decisions: if a customer's transactions conflict with their stated business or risk profile, that inconsistency triggers suspicion.

## Regulatory examination and penalties

Bank regulators (the Office of the Comptroller of the Currency, Federal Reserve, FDIC) and FinCEN itself examine institutions for AML/SAR compliance. Failures can result in large fines. Wells Fargo paid over $3 billion in 2020 for failures to file SARs on suspicious transactions. HSBC paid $1.9 billion in 2012 for inadequate [AML compliance](/wiki/aml-compliance/). These penalties incentivize banks to be aggressive in filing SARs, sometimes leading to over-reporting.
...
### Closely related
- [AML Compliance](/wiki/aml-compliance/) — broader compliance program
- [Know Your Customer](/wiki/know-your-customer/) — KYC due diligence component
- [Currency Transaction Reporting](/wiki/currency-transaction-reporting/) — CTR filing requirement
- [Anti-Money Laundering](/wiki/anti-money-laundering/) — regulatory framework
