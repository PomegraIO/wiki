---
title: "CFTC Enforcement Action"
description: "A regulatory penalty or sanction issued by the Commodity Futures Trading Commission for violations of commodity and derivatives market rules."
keywords:
  - cftc enforcement
...
*A **CFTC enforcement action** is a formal sanction or penalty imposed by the U.S. [Commodity Futures Trading Commission](/wiki/commodity-futures-trading-commission/) for violations of commodity and derivatives market regulations. Enforcement actions range from warning letters to multimillion-dollar fines and bans from market participation.*
...
| **Jurisdiction** | Futures, options, swaps, commodities markets |
| **Types of violations** | Market manipulation, fraud, position limits breach, record-keeping failures |
| **Penalties** | Fines (capped at $1M+ per violation), bans, disgorgement of profits |
| **Timeline** | Investigations can span 2–5+ years; enforcement can be public or negotiated |
| **Precedent effect** | Large cases shape market interpretation of rules (e.g., swaps documentation) |
| **Defendant types** | Banks, hedge funds, traders, exchanges, clearing houses |
| **Publicity** | Public settlements are announced; fines disclosed; can damage reputation |

</aside>

## What the CFTC regulates

The [Commodity Futures Trading Commission](/wiki/commodity-futures-trading-commission/) oversees:
...
- **Swaps:** Over-the-counter derivatives contracts, including [interest-rate swaps](/wiki/interest-rate-swap/), [credit-default swaps](/wiki/credit-default-swap/), and commodity swaps.
- **Exchanges and clearing houses:** [CME Group](/wiki/cme-group/), [ICE](/wiki/ice-futures-exchange/), [CBOT](/wiki/cme-group/), and others must comply with CFTC rules.
...
**Recordkeeping and reporting failures:** Failing to report trades to [swaps data repositories](/wiki/derivatives-exchange-crypto/), providing false financial statements, or inadequate books and records.

**Unregistered market activity:** Operating as a [swap dealer](/wiki/over-the-counter-market/) or [futures commission merchant](/wiki/futures-contract/) without CFTC registration.
...
**LIBOR manipulation (2012–2015):** Banks including Barclays, UBS, and RBS manipulated [LIBOR](/wiki/libor/) (the benchmark interest rate used in trillions of dollars of swaps and loans). The CFTC and other regulators imposed billions in fines. The scandal led to LIBOR phase-out and replacement with [SOFR](/wiki/sofr/).
...
CFTC enforcement shapes market interpretation of rules. Before the [Dodd-Frank Act](/wiki/dodd-frank-act/) (2010), swaps were largely unregulated. Post-Dodd-Frank, the CFTC enforces swap dealer registration, trade reporting, and clearing requirements. Early enforcement cases established precedent for what "dealer" means and when swap reporting applies.
...
## Relationship to [self-regulatory organizations](/wiki/regulation-a/) (SROs)

[FINRA](/wiki/finra/), [NFA](/wiki/finra/) (National Futures Association), and exchanges also enforce rules. They may investigate and sanction members before CFTC becomes involved. A trader banned by an exchange is likely to face CFTC enforcement too.
...
### Closely related
- [CFTC Regulator](/wiki/cftc-regulator/) — Agency overview
- [Commodity Futures Trading Commission](/wiki/commodity-futures-trading-commission/) — Full organization
- [Dodd-Frank Act](/wiki/dodd-frank-act/) — Enforcement authority basis
- [Market Manipulation](/wiki/market-surveillance/) — Core violation

### Wider context
- [SEC Enforcement](/wiki/sec-enforcement/) — Parallel agency for securities
- [Futures Contract](/wiki/futures-contract/) — Primary instrument regulated
- [Swap](/wiki/interest-rate-swap/) — OTC derivative regulated by CFTC
- [Clearing House](/wiki/central-counterparty-clearing/) — CFTC-regulated infrastructure
- [LIBOR Manipulation](/wiki/libor/) — Landmark enforcement case
