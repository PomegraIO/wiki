---
title: "Regulation Best Interest vs Fiduciary Standard"
description: "Regulation Best Interest vs fiduciary standard: which standard applies to brokers versus advisers and practical differences in client protection."
keywords:
  - reg bi vs fiduciary standard
  - regulation best interest
  - fiduciary duty financial
  - broker vs adviser standards
...
<div class="wiki-infobox-title">Reg BI vs Fiduciary — key facts</div>

<img src="/svg/regulation.svg" alt="An abstract editorial mark for regulation topics." />

<div class="wiki-infobox-caption">Two standards for investment professionals; fiduciary is stricter and applies to advisers, not most brokers.</div>

|   |   |
|---|---|
| **Applies to** | Brokers (Reg BI); Investment Advisers / RIAs (Fiduciary) |
| **Client interest priority** | Brokers: must consider client interest AND own interest; Advisers: client interest comes first |
| **Conflicts of interest** | Brokers: allowed if disclosed and mitigated; Advisers: must avoid or eliminate |
| **Duty of care** | Brokers: reasonable investigation; Advisers: thorough analysis tailored to client |
| **Disclosure requirement** | Brokers: conflicts must be disclosed; Advisers: conflicts must be disclosed AND mitigated |
| **Standard origin** | Reg BI: SEC rule (2019); Fiduciary: common law + Investment Advisers Act of 1940 |
...
**Under Reg BI (broker):**
The broker investigates the customer's profile, confirms moderate risk tolerance, and recommends a portfolio: 50% in a [large-cap equity](/sp-500-index/) ETF with a 0.03% annual expense ratio, and 50% in an intermediate-term bond fund with a 0.60% annual expense ratio. The bond fund pays the broker's firm 0.25% annual revenue-sharing (a kickback from the fund sponsor). The broker discloses the revenue-sharing arrangement. The recommendation is documented as in the customer's best interest, given the customer's risk tolerance and time horizon. Reg BI is satisfied.
...
- [Fiduciary Duty](/broker/) — the legal obligation to act in a client's interest
- [Investment Adviser](/broker/) — the regulated profession subject to fiduciary duty
- [Broker-Dealer](/broker/) — the intermediary subject to Regulation Best Interest
- [SEC Rule 10b-5](/securities-and-exchange-commission/) — prohibition on fraud; foundational to all investment advice standards
- [FINRA](/finra/) — the self-regulator of brokers; enforces Reg BI compliance
- [Investment Advisers Act of 1940](/investment-company-act-of-1940/) — the statute establishing fiduciary duty for advisers

### Wider context

- [Securities Regulation](/securities-and-exchange-commission/) — the SEC's broader regulatory framework
- [Conflicts of Interest Disclosure](/broker/) — disclosure requirements for advisers and brokers
- [Management Fee](/management-fee/) — how advisers charge, different from broker commissions
- [Due Diligence](/due-diligence/) — the investigation standard underlying both Reg BI and fiduciary duty
