...
description: "Regulatory framework enforcing the Foreign Corrupt Practices Act (FCPA) and international anti-corruption standards, requiring companies to prevent corrupt payments to foreign officials."
keywords:
  - FCPA
  - anti-corruption
  - foreign officials
...
| Aspect | Detail |
|--------|--------|
| **Primary US law** | Foreign Corrupt Practices Act (1977) |
| **Scope** | US companies, foreign issuers on US exchanges, anyone transacting with US mail/wires |
| **Prohibited conduct** | Bribes to foreign officials for business advantage |
| **Penalties** | Up to $2M per violation + individual imprisonment (up to 20 years) |
| **Affirmative defense** | Lawful under foreign law OR reasonable facilitation payments |
| **Key enforcer** | SEC, DOJ |
| **Due diligence cost** | Typical large company program: $5M–$20M annually |
...
Before entering a relationship (hiring an agent, forming a [joint venture](/wiki/business-combination-purchase/), acquiring a company), firms must conduct **enhanced due diligence** on counterparties. FCPA enforcement guidance specifies that companies should understand:
...
1. **Written anti-bribery policy** articulating prohibitions and consequences
2. **Tone at the top**: board/executive commitment to compliance
3. **Training**: regular, documented training for all employees, especially sales and operations staff
4. **Auditing and monitoring**: routine reviews of high-risk transactions and vendors
5. **Disciplinary procedures**: clear consequences for violations
6. **Reporting mechanisms**: anonymous hotlines and safe channels for concerns
7. **Remediation**: swift investigation and corrective action when violations surface
...
- [Whistleblower Protection](/wiki/whistleblower-protection/) — reporting mechanisms

### Wider context
- [Compliance Testing Regime](/wiki/compliance-testing-regime/) — internal audit frameworks
- [Financial Regulation and Supervision](/wiki/financial-regulation-and-supervision/) — broader regulatory context
- [International Financial Reporting Standards](/wiki/international-financial-reporting-standards/) — accounting transparency requirements
- [SEC Enforcement](/wiki/sec-enforcement/) — regulatory agency
- [Rule 10b-5](/wiki/rule-10b-5/) — securities fraud prohibition (related enforcement landscape)
