---
title: "Bombay High Operating Rules"
description: "Compliance framework governing operations, safety, and environmental standards for oil and gas platforms in India's Bombay High offshore field."
keywords:
  - offshore compliance
  - oil platform regulations
...
| Element | Coverage |
|---|---|
| **Jurisdiction** | Bombay High field (offshore, western India) |
| **Regulator** | Directorate General of Hydrocarbons (DGH) |
| **Main areas** | Safety, environment, well integrity, reporting |
| **Non-compliance** | Fines, production suspension, license revocation |
| **Key standard** | OISD-119 (Drilling Operations) and OISD-100 (HSE) |
| **Monitoring** | Inspections, audits, incident reporting |
...
### Closely related
- [Bombay stock exchange](/wiki/bombay-stock-exchange/) — Listing rules for ONGC and other oil companies
- [Bombay High](/wiki/bombay-high-operating-rules/) — The field itself
- [Oil platform operations](/wiki/energy-complex-correlation/) — Broader sector context
- [Environmental liability](/wiki/environmental-liability/) — Regulatory exposure

### Wider context
- [Commodity futures trading commission](/wiki/commodity-futures-trading-commission/) — U.S. counterpart regulator
- [Crude oil](/wiki/crude-oil/) — Primary product
- [Natural gas](/wiki/natural-gas/) — Secondary product
- [Regulation and supervision](/wiki/financial-regulation-and-supervision/) — General governance framework
