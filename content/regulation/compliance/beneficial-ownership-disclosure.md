...
description: "Regulatory requirement identifying the natural persons who ultimately own or control assets held in corporate or trust structures."
keywords:
...
For the operational compliance process, see <a href="/wiki/customer-due-diligence/">/wiki/customer-due-diligence/</a>. For anti-money-laundering context, see <a href="/wiki/aml-compliance/">/wiki/aml-compliance/</a>.
</div>
...
| Aspect | Detail |
|--------|--------|
| **Requirement Level** | Global standard; U.S., EU, UK, and many others mandate beneficial ownership identification |
| **Definition** | Individual(s) who own ≥25% or exercise effective control, regardless of legal structure |
| **Who Must Disclose** | Corporations, LLCs, trusts, partnerships holding significant assets |
| **To Whom** | Regulatory authorities, financial institutions, sometimes public registries |
| **Verification** | Documentary evidence (ID, financial records, corporate filings) required |
| **Update Frequency** | Annually or upon material changes in ownership |
| **Penalties** | Civil fines, criminal prosecution, asset freezing, license revocation |
| **Privacy Concerns** | Tension between transparency and protection of beneficial owners' personal information |
| **Exempt Entities** | Publicly traded companies, government entities, non-profits (varies by jurisdiction) |
...
### Closely related
- <a href="/wiki/aml-compliance/">/wiki/aml-compliance/</a> — Anti-money-laundering requirements and practices
- <a href="/wiki/customer-due-diligence/">/wiki/customer-due-diligence/</a> — Know-your-customer procedures
- <a href="/wiki/sanctions-screening/">/wiki/sanctions-screening/</a> — Identifying sanctioned parties
- <a href="/wiki/enhanced-due-diligence/">/wiki/enhanced-due-diligence/</a> — Deep-dive compliance for high-risk entities
