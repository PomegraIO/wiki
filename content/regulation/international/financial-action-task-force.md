...
description: "International body setting anti-money laundering and counter-terrorism financing standards."
keywords:
  - FATF
...
*The **Financial Action Task Force** (FATF) is an intergovernmental organization of 39 member countries and 2 regional organizations that develops and promotes policies and standards for combating [money laundering](/wiki/anti-money-laundering/), terrorist financing, and proliferation financing. FATF standards are implemented through national regulatory regimes and are widely recognized as the global benchmark for financial compliance.*

<aside class="wiki-infobox">

| Element | Description |
|---|---|
| **Founded** | 1989, by G7 nations |
| **Members** | 39 countries + 2 regional organizations |
| **Secretariat** | Paris, hosted by OECD |
| **Primary output** | Recommendations (R.1–R.40), mutual evaluations |
| **Enforcement** | Peer review and public "grey list" / "black list" designations |
| **Key mandate** | Set standards; assess member compliance |
...
The FATF does not directly regulate or prosecute; it sets standards and assesses member compliance through mutual evaluations and peer reviews. Countries that fail FATF reviews face reputational damage and are added to the "grey list" (countries with strategic deficiencies in [AML](/wiki/aml-compliance/) compliance) or "black list" (countries actively engaged in money laundering or financing terrorism), triggering international pressure and financial isolation.

## The 40 Recommendations

FATF's core output is the **40 Recommendations**, a set of international standards for [AML compliance](/wiki/anti-money-laundering/) and counter-terrorism financing. The recommendations are organized by:
...
5. **International cooperation** — Mutual legal assistance, extradition, information sharing between [financial regulators](/wiki/financial-regulation-and-supervision/).

Each recommendation is non-binding in form but binding in effect: countries that fail to implement them risk international sanctions and exclusion from global [financial markets](/wiki/stock-exchange/).
...
FATF standards flow directly into [financial regulators'](/wiki/securities-and-exchange-commission/) compliance frameworks. Banks, [broker-dealers](/wiki/broker/), money services businesses, and casinos must implement enhanced due diligence for high-risk customers, file suspicious activity reports (SARs), and maintain transaction records for years. The compliance burden is substantial: large banks employ thousands of compliance officers and dedicate billions annually to AML systems.
...
Post-9/11, FATF expanded mandate to include counter-terrorism financing. This requires that financial institutions screen customers, transaction beneficiaries, and beneficial owners against [terrorist watch lists](/wiki/sanctions-screening/) maintained by the UN Security Council and national authorities. A transaction matching a terrorist designation must be frozen immediately and reported to [FinCEN](/wiki/fincen-reporting/) (US Financial Crimes Enforcement Network) or equivalent authorities.
...
FATF standards are periodically updated to address new risks. Recent additions focus on crypto assets and virtual asset service providers (VASPs), recognizing that [cryptocurrency](/wiki/bitcoin/) exchanges and wallet providers must apply the same CDD and reporting standards as traditional financial institutions. This has driven [crypto regulation](/wiki/crypto-custody-solutions/) globally.

<div class="wiki-seealso">

### Closely related
- [Anti-Money Laundering (AML)](/wiki/anti-money-laundering/) — Core FATF mandate
- [Customer Due Diligence](/wiki/customer-due-diligence/) — Primary FATF mechanism
- [Know Your Customer (KYC)](/wiki/kyc/) — Fundamental compliance requirement
- [Sanctions Screening](/wiki/sanctions-screening/) — Terrorist financing component
- [FinCEN Reporting](/wiki/fincen-reporting/) — US implementation of FATF standards

### Wider context
- [Financial Regulation and Supervision](/wiki/financial-regulation-and-supervision/) — Broader regulatory ecosystem
- [Financial Conduct Authority (FCA)](/wiki/financial-conduct-authority/) — National regulator implementing FATF
- [Beneficial Ownership Disclosure](/wiki/beneficial-ownership-disclosure/) — Transparency requirement
- [Crypto Custody Solutions](/wiki/crypto-custody-solutions/) — New frontier in FATF compliance
- [Emerging Markets Regulation](/wiki/state-securities-regulator/) — Varying capacity to comply
