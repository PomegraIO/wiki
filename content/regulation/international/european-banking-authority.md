...
description: "EU agency coordinating banking regulation across member states and third countries"
keywords:
  - european banking authority
  - banking regulation
  - eu finance
  - prudential oversight
  - financial supervisio
---
...
|---|---|
| **Established** | 2011 (successor to Committee of European Banking Supervisors) |
| **Headquarters** | Paris, France |
| **Parent authority** | European Supervisory Authorities (ESAs), part of the European System of Financial Supervision |
| **Geographic scope** | EU member states, EEA countries (Norway, Iceland, Liechtenstein) |
| **Number of banks** | ~8,000 credit institutions across member states |
| **Key role** | Rulemaking, coordination, stress testing, mediation |
| **Powers** | Binding technical standards, regulatory technical standards (RTS) |
| **Funding** | EU budget + bank levies |
| **Board chair** | José Manuel Campa (Spain) |
...
## Legal instruments: RTS, ITS, and guidelines
...
### Closely related
- [Basel III](/wiki/basel-iii/) — Global capital standards the EBA implements
- [European Central Bank](/wiki/european-central-bank/) — Complementary supervisory authority for large eurozone banks
- [Capital Adequacy](/wiki/capital-adequacy/) — Key EBA regulatory focus
- [Financial Conduct Authority](/wiki/financial-conduct-authority/) — Equivalent U.K. regulator (post-Brexit)
