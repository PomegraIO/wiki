...
description: "SIPC protects customers of brokerage firms if the firm fails. It covers securities and cash up to $500,000 per account, protecting clients against loss due to broker insolvency."
keywords:
  - SIPC
...
|   |   |
|---|---|
| **Organization type** | Non-profit membership corporation |
| **Established** | 1970 |
| **Members** | Approximately 5,500 brokerage firms |
| **Coverage** | Up to $500,000 per customer account |
| **Covered items** | Securities and cash held by the broker |
| **Not covered** | Commodity futures, forex, losses from bad investments |
| **Primary statute** | Securities Investor Protection Act (SIPA) |
