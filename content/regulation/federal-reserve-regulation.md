...
description: "The Federal Reserve has the authority to set monetary policy and to regulate banks that are members of the Federal Reserve system. It issues regulations that govern bank reserves, lending, and risk management."
keywords:
  - Federal Reserve
  - monetary policy
  - bank regulation
...
|   |   |
|---|---|
| **Type** | Central bank and regulator |
| **Established** | 1913 |
| **Structure** | Board of Governors + 12 regional Federal Reserve Banks |
| **Jurisdiction** | Member banks, bank holding companies, foreign banks |
| **Key regulation** | Regulation A (discount rate), Regulation D (reserve requirements, now optional) |
| **Governor appointment** | President, confirmed by Senate |
| **Key committees** | Federal Open Market Committee (FOMC) |
