---
title: "Regulation S"
description: "Regulation S is an SEC exemption allowing US companies to sell securities outside the United States without registering under US securities laws."
keywords:
  - Regulation S
  - Reg S
  - offshore offering
...
|   |   |
|---|---|
| **Scope** | Offshore offerings only (no US investors) |
| **Dollar limit** | None |
| **Resale restrictions** | Purchasers cannot resell into the US for initial period |
| **Disclosure requirement** | Minimal; depends on issuer's current reporting |
| **Primary users** | Foreign issuers, multinational companies |
| **Mechanism** | Issuer controls offering through distribution restrictions |
...
## Distribution restrictions and seasoning

To ensure that Reg S securities do not flood back into the US market, Reg S imposes restrictions on resale:

- **Initial distribution period** — a waiting period (typically 40 days for equities, 90 days for other securities) during which securities cannot be resold to US persons
- **Seasoning period** — for securities of non-US issuers, an additional holding period
- **Selling restrictions** — transferees must agree not to resell to US persons

These restrictions make Reg S securities initially illiquid (hard to resell), which is why investors demand a discount.
...
Reg S compliance is tricky because resale restrictions must be contractually enforced. If a European bondholder resells to a US resident, has Reg S been violated? Generally, no — the issuer is not responsible for the purchaser's subsequent resales. However, if the issuer knew that investors would circumvent restrictions, it loses the exemption.

Issuers also struggle with the question: who is a "US person"? The rule defines it (broadly, any US resident or US-incorporated entity), but identifying purchasers' residency is difficult in secondary markets.
