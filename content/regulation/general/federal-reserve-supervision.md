---
title: "Federal Reserve Supervision"
description: "Federal Reserve supervision is the examination and oversight of state-chartered banks and all bank holding companies to ensure they are safe and sound and comply with laws."
keywords:
  - Federal Reserve
  - bank supervision
  - bank examination
...
|   |   |
|---|---|
| **Primary regulator for** | State-member banks, all bank holding companies |
| **Authority** | Bank Holding Company Act (1970), National Bank Act (1863) |
| **Examination frequency** | Typically annual for large banks, every 18–24 months for smaller ones |
| **Key tool** | Bank Examination Report (FFIEC 41) |
| **Regional structure** | 12 Federal Reserve Districts, each with a supervisory team |
| **Stress testing** | Annual for large banks (CCAR, DFAST) |
