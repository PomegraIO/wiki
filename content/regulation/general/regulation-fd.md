---
title: "Regulation FD"
description: "Regulation Fair Disclosure (Reg FD) is an SEC rule requiring companies to disclose material information to all investors simultaneously, rather than briefing select institutional investors first."
keywords:
  - Regulation FD
  - Reg FD
  - fair disclosure
...
| **Coverage** | US public companies and foreign private issuers |
| **Core rule** | Disclose material information to all investors simultaneously |
| **Exemption** | Disclosures to insiders (officers, advisers) under confidentiality |
| **Safe harbor** | Issuer can limit liability if disclosure is unintentional |
