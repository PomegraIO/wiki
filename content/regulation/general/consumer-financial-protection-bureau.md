...
description: "The CFPB is a federal agency that protects consumers from unfair, deceptive, or abusive financial practices by banks, lenders, debt collectors, and other financial service providers."
keywords:
  - CFPB
...
|   |   |
|---|---|
| **Agency type** | Independent agency within the Federal Reserve |
| **Established** | July 2010 |
| **Jurisdiction** | Consumer financial products and services |
| **Covered entities** | Banks, credit unions, lenders, debt collectors, credit reporting agencies |
| **Primary statute** | Dodd-Frank Act (Title X) |
| **Director** | Appointed by the President, confirmed by the Senate |
| **Funding** | Funded by the Federal Reserve, not Congress (structural independence) |
