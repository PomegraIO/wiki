...
description: "Anti-money laundering (AML) laws require financial institutions to detect and report suspicious activity that might indicate money laundering or terrorism financing."
keywords:
...
|   |   |
|---|---|
| **Objective** | Prevent money laundering and terrorism financing |
| **Key requirement** | Know Your Customer (KYC), suspicious activity reporting |
| **Coverage** | Banks, brokers, advisers, casinos, insurance, real estate |
| **Global standard** | FATF (Financial Action Task Force) sets norms |
| **US law** | Bank Secrecy Act, Anti-Money Laundering Act (2020) |
| **Enforcement** | FinCEN, banking regulators, DOJ |
...
1. **Placement** — introducing dirty cash into the financial system (depositing at banks, converting to wire transfers)
2. **Layering** — moving money through multiple transactions and jurisdictions to obscure origin
3. **Integration** — reintroducing the money into the economy as seemingly legitimate (buying real estate, investing in businesses)
