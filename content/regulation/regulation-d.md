---
title: "Regulation D"
description: "Regulation D is the primary exemption from Securities Act registration for private offerings. It allows companies to raise capital from accredited and sophisticated investors without SEC approval."
keywords:
  - Regulation D
  - Reg D
  - private placement
...
|   |   |
|---|---|
| **Rule 504** | Up to $10 million; less restrictive on investors |
| **Rule 505** | Up to $5 million; up to 35 non-accredited investors |
| **Rule 506(b)** | Unlimited; 35 non-accredited, unlimited accredited (no solicitation) |
| **Rule 506(c)** | Unlimited; accredited investors only (can advertise) |
| **Filing required** | Form D (not approval, just notification) |
| **Resale restrictions** | Securities cannot be resold without registration (typically illiquid) |
