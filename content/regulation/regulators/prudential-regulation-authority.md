...
description: "The Bank of England subsidiary that sets capital, liquidity, and prudential rules for UK banks, insurers, and investment firms."
keywords:
  - uk regulation
...
<div class="wiki-infobox-title">Prudential Regulation Authority — key facts</div>

<img src="/svg/regulation.svg" alt="An abstract editorial mark for financial regulation and oversight." />

<div class="wiki-infobox-caption">The Bank of England's prudential watchdog.</div>

|   |   |
|---|---|
| **What it is** | A subsidiary of the Bank of England (established by the Financial Services Act 2012) |
| **Established** | 2013 (operational) |
| **Leadership** | Chief Executive, appointed by Bank of England; reports to the Governor |
| **Scope** | Prudential regulation of banks, building societies, insurers, investment firms, infrastructure firms |
| **Toolkit** | Capital requirements, liquidity standards, stress-testing, supervisory recommendations, enforcement actions |
| **Sister regulator** | Financial Conduct Authority (FCA), which handles conduct and market rules |
...
Globally, the PRA's model is influential. The US lacks a direct equivalent; the [Federal Reserve](/federal-reserve/) and [OCC](/office-of-the-comptroller-of-the-currency/) share prudential regulation, and no single entity handles capital rules for all banks. The EU, after the crisis, created the Single Supervisory Mechanism (SSM) within the European Central Bank, similar in spirit to the PRA. The model of embedding prudential regulation in the central bank is now standard among major jurisdictions.
