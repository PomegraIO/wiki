---
title: "FDIC Regulator"
description: "Federal Deposit Insurance Corporation that insures bank deposits and regulates member institutions to prevent insolvency."
keywords:
  - FDIC
  - deposit insurance
  - bank regulation
...
*The **Federal Deposit Insurance Corporation (FDIC)** is a US federal agency that insures [deposits](/wiki/fdic-regulator/) at member banks, protecting depositors up to a coverage limit ($250,000 per account as of 2024). The FDIC also examines and regulates member banks to reduce the risk of failure.*

<div class="wiki-hatnote">For the history of deposit insurance, see <a href="/wiki/savings-and-loan-crisis/">Savings and Loan Crisis</a>. For other bank regulators, see <a href="/wiki/federal-reserve-supervision/">Federal Reserve Supervision</a>.</div>

<aside class="wiki-infobox">

| Aspect | Detail |
|---|---|
| **Established** | 1933, during the [Great Depression](/wiki/great-depression/) |
| **Coverage limit** | $250,000 per depositor per bank (increased from $100,000 in 2008) |
| **Coverage scope** | Demand deposits (checking, savings), money market accounts, [CDs](/wiki/certificate-of-deposit/) |
| **Excluded** | Stocks, bonds, investment products, crypto, safety deposit boxes |
| **Member base** | ~4,700 banks and savings institutions (2024) |
| **Funding source** | Insurance premiums paid by member banks; zero direct taxpayer funding |
| **Examination authority** | On-site inspections; [capital adequacy](/wiki/capital-adequacy/) review; enforcement actions |

</aside>

## History and rationale

Before 1933, bank failures were common. When a bank failed, depositors lost their money—no insurance, no protection. The [banking crisis of 1933](/wiki/banking-crisis-of-1933/) saw thousands of bank runs and failures. Desperate depositors raced to withdraw funds before their bank's collapse, creating panic and cascading failures.
...
The original coverage limit was $2,500 per depositor. This has increased over time: to $10,000 (1966), $100,000 (1980), and $250,000 (2008, during the [financial crisis](/wiki/lehman-brothers-collapse/)). The increase to $250,000 was meant to protect small businesses and individuals during the crisis.

## How FDIC insurance works

When a member bank fails, the FDIC steps in:

1. **Declaration of closure**: The FDIC, in coordination with the primary regulator (the [Federal Reserve](/wiki/federal-reserve/) or [OCC](/wiki/office-of-the-comptroller-of-the-currency/)), closes the failed bank.
...
**Not covered**: [Stocks](/wiki/shares-of-stock/), [bonds](/wiki/bond-basics/), [mutual funds](/wiki/mutual-fund/), [ETFs](/wiki/etf/), [derivatives](/wiki/option-premium/), cryptocurrency, and safety deposit box contents are not covered by FDIC insurance. The FDIC insures only deposits (liabilities of the bank), not securities held or managed by the bank.
...
Beyond insurance, the FDIC directly regulates insured nonmember banks (those not members of the [Federal Reserve](/wiki/federal-reserve/)). For member banks, the FDIC shares regulatory authority with the Federal Reserve and the OCC.

The FDIC's examination process includes:

**Capital ratios**: The FDIC enforces [capital adequacy](/wiki/capital-adequacy/) standards, ensuring banks hold sufficient [Tier 1](/wiki/tier-1-capital/) and [Tier 2](/wiki/tier-2-capital/) capital to absorb losses. The minimum [capital ratio](/wiki/capital-adequacy/) is 10% (all-in); below this, the bank faces corrective action.
...
**CAMELS rating**: The FDIC assigns a composite rating (CAMELS: **C**apital, **A**ssets, **M**anagement, **E**arnings, **L**iquidity, **S**ensitivity) of 1–5 to each bank. A rating of 1–2 indicates a sound bank; 3 indicates fair strength; 4–5 indicates concern or critical weaknesses.
...
The FDIC is funded by insurance premiums paid by member banks, not by taxpayers. Premiums are assessed based on deposits and [risk](/wiki/risk-on-risk-off/). A riskier bank (higher CAMELS rating) pays higher premiums.

During the [2008 financial crisis](/wiki/lehman-brothers-collapse/), the FDIC's reserve fund depleted due to massive bank failures (Washington Mutual, IndyMac, etc.). The FDIC had to borrow from the Treasury to meet insurance obligations. A special assessment was imposed on banks to rebuild reserves.
...
### Closely related
- [Federal Deposit Insurance Corporation](/wiki/federal-deposit-insurance-corporation/)
- [Federal Reserve Supervision](/wiki/federal-reserve-supervision/)
- [Banking Crisis of 1933](/wiki/banking-crisis-of-1933/)
...
- [2008 Financial Crisis](/wiki/lehman-brothers-collapse/)
