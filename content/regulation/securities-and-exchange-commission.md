...
description: "The SEC is the primary US federal regulator of securities markets, corporate disclosure, and investment advisers. It enforces laws that prohibit fraud, manipulative trading, and misrepresentation to investors."
keywords:
  - SEC
...
For the statute that created the SEC, see [Securities Exchange Act of 1934](/securities-exchange-act-of-1934). For its international parallel in European markets, see [MIFID II](/mifid-ii).
...
| **Jurisdiction** | US securities markets, corporate disclosure, investment advisers |
| **Primary statutes** | [Securities Act of 1933](/securities-act-of-1933), [Securities Exchange Act of 1934](/securities-exchange-act-of-1934) |
| **Key divisions** | Corporation Finance, Trading and Markets, Enforcement, Investment Management |
| **Chairman** | Appointed by the President, confirmed by the Senate |
| **Enforcement tool** | Civil and administrative authority; criminal referrals to DOJ |

</aside>

## What the SEC does

The SEC's mandate is threefold. First, it sets the rules. The Commission issues [Regulation FD](/regulation-fd) (fair disclosure), [Regulation SHO](/regulation-sho) (short selling), [Rule 10b-5](/rule-10b-5) (fraud), and hundreds more. Second, it reviews. Every company that wants to sell stock or borrow on public markets must file detailed disclosures — Form S-1 for new offerings, Form 10-K for annual reports, Form 8-K for material events. SEC staff reads these, asks questions, and holds back approval until they are satisfied. Third, it enforces. When the SEC finds evidence of fraud, market manipulation, or material misstatement, it can bring civil charges, settle, and bar individuals from the industry. Serious crimes go to the Department of Justice.
...
The SEC is organized into five operating divisions. **Corporation Finance** reviews the public disclosures of companies and their insiders. **Trading and Markets** sets rules for exchanges, brokers, and trading systems. **Investment Management** oversees [mutual funds](/mutual-fund), [hedge funds](/hedge-fund), and [investment advisers](/investment-advisers-act-of-1940). **Enforcement** investigates and prosecutes violations. **Examinations** (part of Trading and Markets) conducts surprise inspections of brokers and advisers. Each division has rulemaking authority and works in parallel.

## How disclosure works

Disclosure is the SEC's primary weapon against fraud. The idea is simple: if investors see the truth, they can price it accurately. Any company with more than $10 million in assets or more than 500 shareholders must register with the SEC and file periodic reports. Before a new [initial public offering](/initial-public-offering), the company files an S-1 registration statement describing its business, risks, financials, management, and use of proceeds. The SEC reviews it, issues comments, and the company revises. Once declared "effective," shares can be sold. Every quarter thereafter (10-Q), every year (10-K), and upon material events (8-K), the company must file again. Officers certify these documents under penalty of perjury.
...
- [Securities Exchange Act of 1934](/securities-exchange-act-of-1934) — the statute that created the SEC
- [Securities Act of 1933](/securities-act-of-1933) — the SEC's primary disclosure statute
- [Rule 10b-5](/rule-10b-5) — the SEC's most-used fraud rule
- [Regulation FD](/regulation-fd) — SEC rule requiring equal disclosure
- [Insider trading law](/insider-trading-law) — what the SEC prosecutes most
- [Investment Advisers Act of 1940](/investment-advisers-act-of-1940) — SEC's authority over advisers

### Wider context

- [FINRA](/finra) — the self-regulatory body that enforces dealer rules
- [Initial public offering](/initial-public-offering) — when companies first face SEC disclosure
- [Public company](/public-company) — the entities the SEC oversees
- Fraud — the core violation the SEC polices
- [Stock market](/stock-market) — the system the SEC regulates
