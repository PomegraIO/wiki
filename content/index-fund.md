---
title: "Index fund"
description: "An index fund is a pooled investment fund that passively tracks a published list of securities. Pioneered by Jack Bogle, index funds offer low costs, broad diversification, and have outperformed the vast majority of active managers over long periods."
keywords:
  - index fund
  - passive investing
  - Jack Bogle
...
<div class="wiki-infobox-title">Index fund — key facts</div>

<img src="https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?w=600&q=80" alt="Index fund holdings representing broad market exposure" />

<div class="wiki-infobox-caption">An index fund holds, in miniature, everything those tickers represent.</div>

|   |   |
|---|---|
| **What it is** | Passively managed fund tracking an index |
| **Also called** | Passive fund, index tracker |
| **Strategy** | Buy and hold the index; no active picking |
| **Common indices** | S&P 500, total market, bond indices |
| **Expense ratio** | 0.03–0.20% annually (among lowest available) |
| **Holdings** | Hundreds to thousands of securities |
| **Rebalancing** | Quarterly or annual, mechanical |
| **Tax efficiency** | High (low turnover, low capital gains) |
| **Historical returns** | Competitive with or better than 90% of active managers |
| **Invented** | 1975 (by Jack Bogle at Vanguard) |
