---
title: "Swap"
description: "A swap is an agreement between two parties to exchange cash flows based on different terms, most commonly used to manage interest-rate or currency risk."
keywords:
  - swap
  - interest rate swap
  - currency swap
...
|   |   |
|---|---|
| **Types** | Interest-rate, currency, equity, credit, volatility |
| **Duration** | 2–30 years typically |
| **Customizable** | Yes; terms negotiated bilaterally |
| **Traded** | OTC; no exchange listing |
| **Margin** | Rare; credit lines substitute |
| **Settlement** | At maturity or quarterly (for interest) |
...
- [Interest rate swap](/interest-rate-swap/) — most common
- Currency swap — FX exposure
- [Credit-default-swap](/credit-default-swap/) — credit risk transfer
- [Equity swap](/swap/) — returns on equities
- [Volatility swap](/volatility-swap/) — bet on volatility

### Related concepts

- [Forward contract](/forward-contract/) — single-settlement version
- [Swaption](/swaption/) — option to enter a swap
- [Bond](/bond/) — often underlying for swaps
- [Yield curve](/yield-curve/) — determines swap pricing
...
- [Central clearing](/stock-exchange/) — post-2008 requirement
- [Fixed income](/bond/) — swaps essential to this market
