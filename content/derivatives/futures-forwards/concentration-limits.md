...
description: "Regulatory caps on the maximum size of a futures or derivatives position a trader can hold in a single contract or commodity."
keywords:
...
***Concentration limits** are regulatory constraints that cap the maximum number of contracts (or notional exposure) a single trader or trading entity may hold in a specific [futures contract](/wiki/futures-contract/) or commodity. Imposed by exchanges and the CFTC, they prevent any one player from accumulating dominance that could distort prices or threaten market stability.*
...
| Attribute | Detail |
|-----------|--------|
| **Regulator** | CFTC (U.S.), local exchanges |
| **Types** | Spot month, single-month, all-months limits |
| **Enforcement** | Real-time position monitoring, automatic liquidation if exceeded |
| **Exemptions** | Bona fide hedgers (farmers, processors) may request higher limits |
| **Violation penalty** | Fines, trading suspension, forced liquidation |
| **Purpose** | Prevent market manipulation and systemic risk |
...
This is not a soft guideline; it is a hard stop. A [hedge fund](/wiki/hedge-fund/) or trading desk that accidentally exceeds limits due to a corporate action (spin-off, merger) must apply for relief immediately.

## Concentration limits on major contracts

Examples (illustrative; limits change):

| Contract | Spot-Month Limit | Single-Month Limit | Reporting Level |
|----------|------------------|--------------------|-----------------|
| **Crude Oil (WTI)** | 10,000 contracts | 20,000 contracts | 5,000 contracts |
| **Wheat** | 600 contracts | 1,200 contracts | 500 contracts |
| **Gold** | 1,000 contracts | 5,000 contracts | 3,000 contracts |
| **Natural Gas** | 5,000 contracts | 10,000 contracts | 5,000 contracts |
...
Market makers and [proprietary traders](/wiki/principal-trading/) operate on tight margins, sometimes holding large positions intraday to provide liquidity. Concentration limits can complicate this. A large trader who holds positions to "make a market" (buy and sell around a fair price) may need a specific exemption from the exchange. Without it, they could be blocked from providing the liquidity the market needs.

The [Volcker Rule](/wiki/volcker-rule/), implemented post-2008, restricts U.S. banks from [proprietary trading](/wiki/principal-trading/) in securities and derivatives, creating a separate (though complementary) limit on bank position-taking.
...
- **Increase basis risk**: A hedger forced to use smaller positions or more contract months faces higher [basis risk](/wiki/basis-risk/).
...
- [Market manipulation](/wiki/market-surveillance/) — The threat that limits prevent.
- [Leverage ratio](/wiki/leverage-ratio-forex/) — How traders amplify exposure.
- [Counterparty risk](/wiki/counterparty-credit-risk/) — Why systemic risk matters.
- [Volcker rule](/wiki/volcker-rule/) — Complementary bank trading restrictions.
