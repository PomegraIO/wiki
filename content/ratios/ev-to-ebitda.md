...
description: "The EV/EBITDA ratio divides enterprise value by earnings before interest, taxes, depreciation, and amortization. It is widely used to compare companies with different capital structures and ages."
keywords:
  - ev/ebitda
  - enterprise value
  - ebitda
...
|   |   |
|---|---|
| **Also called** | Enterprise value-to-EBITDA multiple |
| **Formula** | Enterprise value ÷ EBITDA |
| **Where EV = ** | Market cap + debt − cash |
| **Where EBITDA = ** | EBIT + depreciation + amortization |
| **Unit** | Unitless (a multiple) |
| **What it answers** | How many times annual cash earnings is the company worth? |
| **Benchmark** | 8-12x is typical for mature companies |
| **Below 6x** | Potentially undervalued or distressed |
| **Above 15x** | Growth premium or overvaluation |
| **Data required** | Market cap, debt, cash, EBITDA |
...
1. You identify a target company.
2. You calculate its current EV/EBITDA multiple.
3. You compare it to recent M&A transactions and current trading multiples for peers.
4. You assess whether the multiple is at a discount, fair, or premium.
5. You then examine EBITDA margins, growth, and capital intensity to decide if the discount or premium is justified.
6. You model leverage (how much debt you would load onto the company) and verify that cash flow can support it.
