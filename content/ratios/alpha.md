---
title: "Alpha"
description: "Alpha is the excess return an investment generates above what would be expected given its level of risk. It is the value a professional manager claims to add through skill, judgment, and effort."
keywords:
  - alpha
  - excess return
  - active management
...
---
*An investment's **alpha** is the return it delivered above what you would have expected given its risk profile. Born from the capital asset pricing model, alpha is the Holy Grail of active management: the slice of return earned through genuine skill rather than market exposure or luck.*
...
<div class="wiki-infobox-title">Alpha — key facts</div>

<img src="/svg/ratios.svg" alt="A trading desk where the search for alpha plays out, one quote at a time." />

<div class="wiki-infobox-caption">A trading desk where the search for alpha plays out, one quote at a time.</div>

|   |   |
|---|---|
| **What it is** | Return above what risk alone predicts |
| **Also called** | Excess return, Jensen's alpha, abnormal return |
| **Measured against** | A benchmark (often a market index) |
| **Expressed as** | A percentage per year |
| **Positive alpha means** | Outperformance; value added by the manager |
| **Negative alpha means** | Underperformance; value destroyed |
| **Attributable to** | Skill, luck, or some mixture |
| **Typical for active managers** | Zero to slightly negative (before fees) |

</aside>

## The concept and the math
...
A manager who consistently delivers positive alpha is, by definition, adding value. A manager who delivers negative alpha is destroying it. Sounds simple. In practice, separating skill from luck is nearly impossible.

## Why alpha matters, and why it's so hard to find

The entire case for active management rests on alpha. If a manager could reliably beat their benchmark after fees, they would deserve their pay. For decades, the debate between active and passive investing has been, in effect, a debate about whether positive alpha is real or a mirage.
...
A critical insight lurks in the concept of alpha: even if a manager earns positive alpha, you cannot always tell whether it was skill or good fortune.

Imagine a casino with 10,000 roulette wheels. Each wheel runs 100 spins. By pure chance, some wheels will land red 60 times out of 100. The person running that wheel might claim skill. They would be wrong. Given enough participants and enough trials, an excess result is inevitable—it tells you nothing about their method.
...
Despite the grim odds, alpha does show up in certain pockets of the market:
