...
description: "Return on tangible equity divides net income by tangible shareholder equity (excluding intangible assets and goodwill), measuring returns on real assets only."
keywords:
...
|   |   |
|---|---|
| **Formula** | Net income ÷ tangible equity |
| **Unit** | Percentage |
| **Benchmark** | 10-15% excellent |
| **Data required** | Net income, total equity, intangible assets |
