...
description: "The price-to-sales ratio divides market capitalization by annual revenue. It bypasses earnings entirely, making it harder to manipulate and useful for comparing companies with vastly different profitability."
keywords:
...
|   |   |
|---|---|
| **Also called** | P/S ratio, price-to-revenue ratio |
| **Formula** | Market capitalization ÷ total revenue |
| **Unit** | Unitless (a multiple) |
| **What it answers** | How much are investors paying per dollar of sales? |
| **Benchmark** | P/S = 1.0 is fair for a profitable company |
| **Below 1.0** | Often undervalued or distressed |
| **Above 3.0** | Premium valuation; check profitability |
| **Data required** | Market cap, annual revenue (TTM or LTM) |
...
1. You screen for stocks with P/S under 2.0.
2. You then look at gross margins, operating margins, and net margins.
3. You check whether those margins are stable, improving, or declining.
4. You compare the company's margins to industry peers.
5. Only then do you decide whether the low P/S is a bargain or a trap.
