...
description: "Inventory turnover divides cost of goods sold by average inventory, measuring how many times per year a company sells and replaces its inventory."
keywords:
  - inventory turnover
...
|   |   |
|---|---|
| **Also called** | Inventory turns, stock turnover |
| **Formula** | COGS ÷ average inventory |
| **Unit** | Times per year |
| **What it answers** | How many times per year is inventory sold and replaced? |
| **Benchmark** | Varies widely by industry |
| **Very low (< 2)** | Slow inventory movement; obsolescence risk |
| **Low (2-4)** | Typical for capital-intensive or specialty goods |
| **Moderate (4-8)** | Healthy for many industries |
| **High (> 8)** | Very efficient; typical for groceries, fast-moving goods |
| **Data required** | COGS, beginning inventory, ending inventory |
