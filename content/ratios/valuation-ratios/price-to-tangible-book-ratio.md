...
description: "Stock price divided by tangible book value per share. A stricter asset-based valuation than price-to-book, excluding intangibles."
---

*Price-to-tangible-book measures how much you are paying for the hard assets a company owns—plants, inventory, cash, property—after stripping out intangible assets like brand value and [goodwill](/wiki/goodwill/). It is price-to-book for skeptics.*
...
Two stocks trading at 1.0 price-to-tangible-book are not equally valued if one owns a profitable auto plant and the other owns obsolete real estate. The ratio tells you the multiple of assets, not whether those assets earn good returns. Always check [return-on-assets](/wiki/return-on-assets/) and [return-on-equity](/wiki/return-on-equity/) alongside.
...
<ul>
  <li><a href="/wiki/price-to-book-ratio/">Price-to-book ratio</a> — the standard version, including intangibles.</li>
  <li><a href="/wiki/tangible-book-value-per-share/">Tangible book value per share</a> — the denominator in this ratio.</li>
  <li><a href="/wiki/return-on-assets/">Return on assets</a> — how profitably the company deploys those tangible assets.</li>
  <li><a href="/wiki/balance-sheet/">Balance sheet</a> — where tangible and intangible assets are listed.</li>
</ul>
<h3>Wider context</h3>
<ul>
  <li><a href="/wiki/intangible-assets/">Intangible assets</a> — brand, patents, and goodwill excluded from this valuation.</li>
  <li><a href="/wiki/goodwill/">Goodwill</a> — the intangible premium paid in acquisitions.</li>
  <li><a href="/wiki/deep-value-investing/">Deep value investing</a> — the approach often used to identify tangible-book bargains.</li>
</ul>
</div>
