---
title: "Adjusted Earnings Yield"
description: "Earnings per share (adjusted for one-time items and non-recurring charges) divided by stock price, expressed as a percentage."
---
...
Read the [10-K](/wiki/10-k/) reconciliation carefully. Some adjustments are fair; some are self-serving.
...
A company might have high adjusted earnings yield if you exclude one-time items, but [free cash flow](/wiki/free-cash-flow/) might be low if capex is heavy. Always triangulate: reported yield, adjusted yield, and FCF yield should all move in the same direction. If they diverge, something is off.
...
Do not accept adjusted earnings at face value, even from trusted sources. Read the reconciliation, check the [cash-flow-statement](/wiki/cash-flow-statement/) to see if adjusted items match cash flows, and form your own view of what is truly one-time.
...
<h3>Wider context</h3>
<ul>
  <li><a href="/wiki/cash-flow-statement/">Cash flow statement</a> — reconciliation of adjustments to real cash flows.</li>
  <li><a href="/wiki/10-k/">10-K</a> — where reconciliations are filed.</li>
  <li><a href="/wiki/fundamental-investing/">Fundamental investing</a> — the discipline using adjusted metrics.</li>
</ul>
</div>
