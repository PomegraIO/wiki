...
description: "Net profit margin divides net income by revenue, showing what percentage of sales remains as profit after all costs, taxes, and interest. It is the bottom-line profitability measure."
keywords:
  - net profit margin
  - net margin
  - profitability
...
|   |   |
|---|---|
| **Also called** | Net margin, profit margin |
| **Formula** | Net income ÷ revenue |
| **Unit** | Percentage |
| **What it answers** | What percentage of revenue becomes shareholder profit? |
| **Benchmark** | 5-12% typical for healthy businesses |
| **Below 2%** | Very thin margins; vulnerable to small disruptions |
| **2-5%** | Below average; high competition or cost pressure |
| **5-10%** | Healthy; typical for many mature businesses |
| **10-20%** | Strong; suggests competitive advantage or scale |
| **Above 20%** | Excellent; often tech, brand, or pharmaceutical |
| **Data required** | Net income, revenue |
...
Start with gross margin: revenue minus COGS.
Subtract operating expenses → operating margin.
Subtract interest expense → pre-tax income margin.
Subtract taxes → net margin.
