...
description: "DSCR divides operating cash flow by total debt service (interest plus principal), measuring whether a company generates sufficient cash to service all debt obligations."
keywords:
  - dscr
...
|   |   |
|---|---|
| **Also called** | Debt service coverage |
| **Formula** | Operating cash flow ÷ (interest + principal) |
| **Unit** | Times |
| **Benchmark** | 1.5 or higher healthy |
| **Below 1.0** | Unsustainable; company cannot service debt from operations |
| **1.0 to 1.25** | At risk; vulnerable to disruption |
| **1.25 to 1.5** | Tight but manageable |
| **Above 1.5** | Comfortable; strong debt service capacity |
| **Data required** | Operating cash flow, interest expense, principal due |
