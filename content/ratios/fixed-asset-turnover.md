...
description: "Fixed asset turnover divides revenue by average fixed assets, measuring how efficiently a company uses its property, plant, and equipment."
keywords:
...
| **Unit** | Times |
| **Benchmark** | 1.0 to 3.0 typical |
| **Below 1.0** | Capital-intensive; excess capacity |
| **1.0 to 2.0** | Moderate efficiency |
| **Above 2.0** | Efficient; capacity utilization |
| **Data required** | Revenue, beginning fixed assets, ending fixed assets |
