---
title: "Cash Ratio"
description: "The cash ratio divides cash and cash equivalents by current liabilities, measuring whether a company can pay short-term obligations from cash alone."
keywords:
  - cash ratio
  - liquidity
  - solvency
...
|   |   |
|---|---|
| **Also called** | Cash to current liabilities |
| **Formula** | Cash and equivalents ÷ current liabilities |
| **Unit** | Unitless (a ratio) |
| **What it answers** | Can the company pay all short-term debts from cash alone? |
| **Benchmark** | 0.2 to 0.5 is typical |
| **Below 0.1** | Minimal cash cushion |
| **0.1 to 0.3** | Normal; reliant on receivables and inventory |
| **0.3 to 0.5** | Strong cash position |
| **Above 0.5** | Fortress balance sheet; excess cash |
| **Data required** | Cash, current liabilities |
