...
description: "Operating margin divides operating income by revenue, showing what percentage of sales remains as profit after paying all operating expenses. It is a measure of core business profitability."
keywords:
  - operating margin
  - ebit margin
  - profitability
...
| **Unit** | Percentage |
| **What it answers** | What percentage of revenue becomes operating profit? |
| **Benchmark** | 10-15% typical for healthy businesses |
| **Below 5%** | Thin margins; vulnerable to cost spikes |
| **5-10%** | Competitive industry or cost pressure |
| **10-20%** | Strong; sustainable for many companies |
| **Above 20%** | Excellent; suggests competitive advantage |
| **Data required** | Revenue, operating income (EBIT) |
...
1. You calculate operating margin for a company and peers.
2. You examine the trend over 5-10 years.
3. You verify that any changes are explained by fundamentals (input costs, mix, scale), not accounting changes.
4. You compare to peers to assess competitive position.
5. You forecast future operating margin based on expected revenue, costs, and operational leverage.
6. You check whether the company is earning operating margin above its cost of capital (WACC).
