...
description: "Debt-to-assets divides total debt by total assets, measuring what fraction of the company's assets are financed by debt versus equity."
keywords:
...
|   |   |
|---|---|
| **Also called** | D/A ratio, debt ratio |
| **Formula** | Total debt ÷ total assets |
| **Unit** | Decimal or percentage |
| **Benchmark** | 0.3 to 0.6 typical |
| **Below 0.3** | Low leverage; conservative |
| **0.3 to 0.5** | Moderate; healthy for most industries |
| **0.5 to 0.7** | High leverage; increased financial risk |
| **Above 0.7** | Very high leverage; distress risk |
| **Data required** | Total debt, total assets |
