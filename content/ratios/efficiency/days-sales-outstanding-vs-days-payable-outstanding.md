---
title: "Days Sales Outstanding vs Days Payable Outstanding"
description: "How DSO and DPO ratios compare to reveal whether a business finances growth or extracts cash through working capital timing."
keywords:
...
<div class="wiki-infobox-title">DSO vs DPO — Quick Facts</div>

<img src="/svg/ratios.svg" alt="An abstract editorial mark for the topic." />

<div class="wiki-infobox-caption">Two sides of the cash-flow rhythm that define working-capital health.</div>

|   |   |
|---|---|
| **DSO** | Days from sale until cash arrives |
| **DPO** | Days from purchase until you pay |
| **Lower DSO** | Customers pay faster; cash in sooner |
| **Higher DPO** | Suppliers wait longer; you hold cash longer |
| **DSO > DPO** | You finance the gap; cash is tied up |
| **DSO < DPO** | Suppliers finance you; you lead on cash |
| **Cash conversion cycle** | DSO + DIO − DPO (how long cash is stuck in inventory & receivables) |
...
- [Cash Conversion Cycle](/cash-conversion-cycle/) — DSO plus inventory days minus DPO; the days cash is actually tied up in operations
- [Accounts Receivable](/accounts-receivable/) — how to recognize and measure customer debt
- [Accounts Payable](/accounts-payable/) — how to recognize and measure amounts owed to suppliers
- [Current Ratio](/current-ratio/) — the working-capital solvency metric affected by DSO and DPO
- [Inventory Turnover](/inventory-turnover/) — the third leg of the cash conversion cycle
...
- [Balance Sheet](/balance-sheet/) — where receivables and payables appear
