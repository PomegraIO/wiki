...
description: "Profitability after direct production costs, revealing manufacturing efficiency and pricing power."
keywords:
  - gross margin
  - production costs
  - cogs
...
*A **gross margin** is the percentage of revenue remaining after subtracting the [cost of goods sold](/wiki/cogs-percentage-sales/) (COGS), revealing the profit available to cover operating expenses, taxes, and capital returns. Analyzing it across time and peers uncovers shifts in manufacturing efficiency, pricing power, and competitive position.*

<aside class="wiki-infobox">

| Aspect | Detail |
|---|---|
| **Formula** | (Revenue − COGS) / Revenue, expressed as % |
| **Synonym** | Gross profit margin |
| **Typical Range** | 15% (discount retail) to 80%+ (software, pharma) |
| **What It Reveals** | Manufacturing cost control and pricing leverage |
| **Counterpart** | [Operating margin](/wiki/operating-margin/) (includes operating expenses) |
| **Watch For** | Shifts in input costs, mix of products, competitive pressure |
...
Gross margin often compresses first when input costs rise (raw materials, labor) faster than companies can raise prices. During commodity spikes, gross margins of industrial manufacturers and packaged-food companies typically fall 2–5 percentage points as their [COGS](/wiki/cogs-percentage-sales/) climbs.
...
When drilling into earnings, examine [gross profit](/wiki/gross-profit-margin/) in absolute dollars alongside the percentage. A company that grows revenue 20% but gross profit only 5% is losing margin *and* absolute profitability—worse than a company that holds margins flat.

For [valuation](/wiki/multiples-valuation/), margin trends matter more than absolute levels. A company with low but stable margins and strong [return on capital employed](/wiki/return-on-capital-employed/) may be more valuable than a higher-margin business with declining returns.

<div class="wiki-seealso">

### Closely related

- [Operating margin](/wiki/operating-margin/) — Profit after operating expenses, not just COGS.
- [Net profit margin](/wiki/net-profit-margin/) — Bottom-line profitability after all costs and taxes.
- [Cost of goods sold](/wiki/cogs-percentage-sales/) — The denominator in the calculation.

### Wider context

- [Profitability factor](/wiki/profitability-factor/) — Margin trends as a stock factor.
- [Dupont analysis](/wiki/dupont-analysis/) — Framework relating margins to returns on equity.
- [Earnings quality](/wiki/earnings-quality/) — Using margin trends to assess sustainability of profits.
