...
description: "Enterprise value is the total economic cost to buy a company, calculated as market cap plus debt minus cash. It is the foundation for leverage-neutral valuation multiples."
keywords:
  - enterprise value
  - ev
  - valuation
...
|   |   |
|---|---|
| **Also called** | EV, firm value, enterprise-wide value |
| **Formula** | Market cap + debt − cash |
| **Includes** | Common equity, preferred equity, debt, minority interests |
| **Excludes** | Operating cash flow, goodwill, intangible assets (unless in price) |
| **What it answers** | What is the total economic cost to acquire this company? |
| **Used in** | M&A, valuation, comparable company analysis |
| **Advantage over market cap** | Accounts for the company's capital structure |
| **Data required** | Stock price, shares, debt, cash |
