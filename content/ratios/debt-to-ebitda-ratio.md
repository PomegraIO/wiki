---
title: "Debt-to-EBITDA Ratio"
description: "Debt-to-EBITDA divides total debt by annual EBITDA, showing how many years of earnings it would take to pay off all debt."
keywords:
  - debt-to-ebitda
  - leverage
  - debt service
...
|   |   |
|---|---|
| **Also called** | Leverage ratio, net debt/EBITDA |
| **Formula** | Total debt ÷ EBITDA |
| **Unit** | Years (times) |
| **Benchmark** | 2.0 to 3.5 typical |
| **Below 1.5** | Very conservative |
| **1.5 to 2.5** | Healthy for most industries |
| **2.5 to 4.0** | Elevated leverage |
| **Above 4.0** | High distress risk |
| **Data required** | Total debt, annual EBITDA |
...
1. Calculate gross debt-to-EBITDA and net debt-to-EBITDA.
2. Compare to peers and industry benchmarks.
3. Project leverage at different EBITDA scenarios.
4. Monitor covenant compliance if the company has rated debt.
5. Assess maturity schedule. When does the debt come due?
