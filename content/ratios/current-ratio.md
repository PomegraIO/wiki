---
title: "Current Ratio"
description: "The current ratio divides current assets by current liabilities, measuring whether a company has enough liquid resources to pay its short-term obligations as they come due."
keywords:
  - current ratio
  - liquidity
  - working capital
...
| **What it answers** | Can the company pay its short-term debts with current assets? |
| **Benchmark** | 1.5 to 2.0 is healthy |
| **Below 1.0** | Insolvency risk; more liabilities than liquid assets |
| **1.0 to 1.5** | Tight; working capital is under pressure |
| **1.5 to 2.5** | Healthy; adequate liquidity buffer |
| **Above 3.0** | Excess cash; may indicate poor capital deployment |
| **Data required** | Current assets, current liabilities |
