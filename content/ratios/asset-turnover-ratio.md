...
description: "Asset turnover divides revenue by average total assets, measuring how efficiently a company uses its asset base to generate sales."
keywords:
  - asset turnover
  - efficiency
  - asset utilization
...
|   |   |
|---|---|
| **Also called** | Total asset turnover, asset efficiency |
| **Formula** | Revenue ÷ average total assets |
| **Unit** | Times (unitless) |
| **What it answers** | How many dollars of revenue per dollar of assets? |
| **Benchmark** | 0.5 to 2.0 typical |
| **Below 0.5** | Capital-intensive; low revenue per asset |
| **0.5 to 1.0** | Typical for asset-heavy businesses |
| **1.0 to 2.0** | Good efficiency; typical for many industries |
| **Above 2.0** | Excellent; capital-light or highly efficient |
| **Data required** | Annual revenue, beginning assets, ending assets |
...
1. You calculate asset turnover for a company and peers.
2. You examine the trend. Declining turnover despite revenue growth is concerning.
3. You compare to peers. Lower turnover signals either less efficiency or more capital intensity (which is acceptable if profitability is maintained).
4. You use asset turnover to estimate capital intensity and forecast future capital needs.
