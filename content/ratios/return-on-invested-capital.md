...
description: "Return on invested capital divides after-tax operating profit by all invested capital (equity plus debt), measuring how efficiently a company deploys all funding sources."
keywords:
...
|   |   |
|---|---|
| **Also called** | ROIC, WACC return, capital efficiency |
| **Formula** | NOPAT ÷ invested capital |
| **Where NOPAT = ** | Operating profit × (1 − tax rate) |
| **Where invested capital = ** | Equity + debt − cash |
| **Unit** | Percentage |
| **What it answers** | How much profit per dollar of all capital invested? |
| **Benchmark** | Above 10% is excellent |
| **Below cost of capital** | Value-destroying |
| **Above cost of capital** | Value-creating |
| **Data required** | Operating profit, tax rate, equity, debt, cash |
...
1. You calculate ROIC for a company.
2. You estimate the company's WACC (cost of capital).
3. If ROIC > WACC, the company is creating value. If ROIC < WACC, it is destroying value.
4. You examine the trend. Declining ROIC despite growth signals competitive deterioration.
5. You project future ROIC as competitive advantage erodes. Eventually, ROIC should approach WACC.
