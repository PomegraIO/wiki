...
description: "Accounts payable turnover divides cost of goods sold by average accounts payable, measuring how many times per year a company pays off its supplier invoices."
keywords:
...
| **Unit** | Times per year |
| **Benchmark** | Varies by industry and supplier power |
| **Higher** | Company pays suppliers quickly |
| **Lower** | Company stretches payments; extended terms |
| **Data required** | Annual COGS, beginning and ending payables |
...
DPO = 365 ÷ Turnover = 365 ÷ 7.7 = 47 days.
...
1. Calculate DSO (receivables collection time).
2. Calculate DIO (inventory holding time).
3. Calculate DPO (payable payment time).
4. CCC = DSO + DIO − DPO.
