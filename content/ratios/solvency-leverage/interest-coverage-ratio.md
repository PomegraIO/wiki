...
description: "The interest coverage ratio divides operating income (EBIT) by interest expense, measuring whether a company generates enough profit to pay its interest obligations comfortably."
keywords:
...
|   |   |
|---|---|
| **Also called** | Times interest earned, EBIT interest coverage |
| **Formula** | EBIT ÷ interest expense |
| **Unit** | Unitless (times) |
| **What it answers** | How many times can the company pay its interest from operating profit? |
| **Benchmark** | 5.0 or higher is healthy |
| **Below 2.5** | At risk; vulnerable to earnings decline |
| **2.5 to 5.0** | Adequate; but little room for error |
| **5.0 to 10.0** | Comfortable; strong debt service capacity |
| **Above 10.0** | Very strong; minimal distress risk |
| **Data required** | EBIT (operating income), annual interest expense |
...
1. You calculate interest coverage.
2. You examine the trend over 5-10 years.
3. If declining, you investigate: Is EBIT falling? Is the company taking on more debt?
4. You compare to peers and industry benchmarks.
5. If coverage is below 3.0, you examine cash flow and fixed-charge coverage.
6. You assess sensitivity: if EBIT falls 10%, is coverage still safe?
