...
description: "The debt-to-equity ratio divides total debt by shareholder equity, measuring the balance between debt and equity financing. It shows financial leverage and risk."
keywords:
...
|   |   |
|---|---|
| **Also called** | D/E ratio, leverage ratio |
| **Formula** | Total debt ÷ shareholder equity |
| **Unit** | Unitless (a ratio) |
| **What it answers** | How much debt per dollar of equity capital? |
| **Benchmark** | 0.5 to 1.5 is typical |
| **Below 0.5** | Low leverage; conservative balance sheet |
| **0.5 to 1.0** | Moderate leverage; healthy for most industries |
| **1.0 to 2.0** | High leverage; more financial risk |
| **Above 2.0** | Very high leverage; vulnerable to downturns |
| **Data required** | Total debt, total shareholder equity |
...
1. You calculate D/E for a company.
2. You compare it to peers and to the company's historical average.
3. If D/E is rising, the company is adding leverage; investigate why (acquisitions, buybacks, cash burn).
4. If D/E is high relative to peers, you examine interest coverage and cash flow to assess distress risk.
5. You evaluate whether the leverage is prudent (debt funding assets) or reckless (debt funding dividends).
