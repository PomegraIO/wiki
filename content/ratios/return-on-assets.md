...
description: "Return on assets divides net income by average total assets, showing how efficiently a company deploys all of its assets to generate profit."
keywords:
  - return on assets
  - roa
  - profitability
...
|   |   |
|---|---|
| **Also called** | ROA, return to assets |
| **Formula** | Net income ÷ average total assets |
| **Unit** | Percentage |
| **What it answers** | How much profit does the company generate per dollar of assets? |
| **Benchmark** | Varies by industry; 3-7% is typical |
| **Below 1%** | Inefficient or distressed |
| **1-3%** | Poor asset utilization |
| **3-7%** | Acceptable; typical for many industries |
| **Above 7%** | Strong asset deployment |
| **Data required** | Net income, beginning assets, ending assets |
...
**ROA** answers: How much profit per dollar of assets?
**ROE** answers: How much profit per dollar of equity?
**ROIC** answers: How much profit per dollar of all investor capital?
