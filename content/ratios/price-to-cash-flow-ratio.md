...
description: "The price-to-cash flow ratio divides market capitalization by operating cash flow. It focuses on actual cash generated, bypassing earnings accounting distortions entirely."
keywords:
  - price-to-cash flow
  - p/cf ratio
  - cash flow
...
|   |   |
|---|---|
| **Also called** | P/CF ratio, price-to-operating-cash-flow |
| **Formula** | Market capitalization ÷ operating cash flow (TTM) |
| **Unit** | Unitless (a multiple) |
| **What it answers** | How much are you paying per dollar of actual cash generated? |
| **Benchmark** | P/CF = 1.0 is very cheap; 10-15 is typical |
| **Below 5.0** | Potentially undervalued or distressed |
| **Above 20.0** | Premium valuation; verify the cash generation |
| **Data required** | Market cap, operating cash flow (LTM) |
...
1. You screen for stocks with P/CF below 10.
2. You then examine how stable operating cash flow has been over the past five years.
3. You compare operating cash flow to net income to see if earnings are backed by cash.
4. You look at free cash flow to account for capital spending.
5. Only then do you decide if the company is cheap or troubled.
