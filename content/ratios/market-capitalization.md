...
description: "Market capitalization (market cap) is the total market value of a company's outstanding shares, calculated as share price times share count. It is the most useful single measure of a company's size and the basis for market-cap-weighted indices."
keywords:
...
This entry covers market cap as a measure and concept. For how companies are classified by size, see large-, mid-, and small-cap [stocks](/stock); for how indices weight companies, see [index fund](/index-fund).

</div>

<aside class="wiki-infobox">

<div class="wiki-infobox-title">Market capitalization — key facts</div>

<img src="/svg/ratios.svg" alt="Market values of companies at different scales" />

<div class="wiki-infobox-caption">Market cap is what the market thinks an entire company is worth, today.</div>

|   |   |
|---|---|
| **What it is** | Share price × shares outstanding |
| **Also called** | Market value |
| **Units** | Dollars (or billions, trillions) |
| **Change frequency** | Every second the market is open |
| **Classification levels** | Mega, large, mid, small, micro |
| **Large-cap threshold** | ~\$10B and up (varies by source) |
| **Mid-cap threshold** | ~\$2B–\$10B |
| **Small-cap threshold** | ~\$300M–\$2B |
| **Diversification tool** | Multi-cap portfolios gain exposure across sizes |
| **Index basis** | S&P 500, Russell 1000 are cap-weighted |
...
This is why [price-to-earnings ratio](/price-to-earnings-ratio) and other valuation metrics matter more than the raw share price. A \$200 share of a mega-cap company might be cheaper (on a price-to-earnings basis) than a \$50 share of a smaller company.

## Large-cap, mid-cap, small-cap, and the rest

The stock market is often segmented by company size:

**Mega-cap** companies have market caps over \$500 billion (Apple, Microsoft, Saudi Aramco, Alphabet). These are the largest, most-established firms, and they dominate [stock indices](/index-fund).
...
Market cap changes constantly while markets are open, every time the [stock](/stock) price moves. A 2% decline in Apple's stock price lowers its market cap by \$60 billion (if it started at \$3 trillion).

Market cap also changes when the company issues new [stock](/stock) (diluting per-share ownership but not necessarily changing total value) or when it buys back shares (reducing share count, but not necessarily increasing total value — it is just spreading the same value across fewer shares).

Over very long periods, market cap reflects cumulative profit and the market's expectations of future profit. A company that grows earnings at 15% per year while maintaining the same [price-to-earnings ratio](/price-to-earnings-ratio) will see its market cap grow at roughly 15% per year.
...
An [index fund](/index-fund) or [ETF](/etf) holding the entire market automatically includes this diversification. A small-cap index fund holds hundreds of smaller companies; a large-cap fund holds the giants. An [asset allocation](/asset-allocation) strategy might hold percentages in each.

Conversely, a portfolio concentrated in a single mega-cap stock lacks diversification, even if it is "diversified" in the sense of owning just one holding. [Diversification](/diversification) requires both breadth (many holdings) and range (across different sizes, sectors, geographies).

## The relationship between market cap and price multiples

An important note: companies of different market-cap ranges trade at different valuations on average. Large-cap stocks tend to trade at moderate [price-to-earnings ratios](/price-to-earnings-ratio) (around 15–20); small-cap stocks are more volatile and trade at a wider range (sometimes cheap, sometimes expensive).
...
- [Stock](/stock) — the shares that comprise market cap
- [Stock exchange](/stock-exchange) — where market cap is determined
- [Price-to-earnings ratio](/price-to-earnings-ratio) — valuation metric independent of market cap
- [Index fund](/index-fund) — holds market-cap-weighted baskets
- [ETF](/etf) — market-cap-weighted or alternative weighting schemes
- [Public company](/public-company) — the entity with a market cap

### Wider context

- [Stock market](/stock-market) — total of all company market caps
- [Bull market](/bull-market) · [Bear market](/bear-market) — market caps rise and fall with these
- [Diversification](/diversification) — spreading across market-cap ranges
- [Asset allocation](/asset-allocation) — considering size in portfolio construction
- [Compound interest](/compound-interest) — growing market cap compounds over time
