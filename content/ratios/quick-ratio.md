---
title: "Quick Ratio"
description: "The quick ratio divides liquid assets (cash and receivables, excluding inventory) by current liabilities, measuring a company's ability to pay short-term debts from cash and near-cash assets only."
keywords:
  - quick ratio
  - acid-test ratio
  - liquidity
...
|   |   |
|---|---|
| **Also called** | Acid-test ratio, acid ratio |
| **Formula** | (Current assets − inventory) ÷ current liabilities |
| **Unit** | Unitless (a ratio) |
| **What it answers** | Can the company pay short-term debts from liquid assets only? |
| **Benchmark** | 1.0 or higher is healthy |
| **Below 0.5** | Very tight; reliant on inventory turnover |
| **0.5 to 1.0** | Acceptable; some reliance on inventory conversion |
| **1.0 to 1.5** | Healthy; strong liquidity from liquid assets |
| **Above 1.5** | Excellent; substantial cash position |
| **Data required** | Cash, receivables, current liabilities |
...
1. You calculate both current and quick ratios.
2. If they are similar, inventory is not a major liquidity factor.
3. If quick ratio is much lower, inventory dependency is high — investigate why and whether it is turning.
4. You examine whether quick ratio is above 1.0 (healthy) or below (tight).
5. You compare to peers and to the company's historical trend.
