...
description: "EV/Sales divides enterprise value by annual revenue, providing a valuation metric for unprofitable or low-margin companies."
keywords:
  - ev/sales
  - valuation multiple
  - enterprise value
...
|   |   |
|---|---|
| **Also called** | EV/revenue, enterprise multiple |
| **Formula** | Enterprise value ÷ revenue |
| **Unit** | Unitless (times) |
| **Benchmark** | 0.5 to 3.0 typical |
| **Below 1.0** | Cheap on revenue |
| **1.0 to 2.0** | Fair to moderate premium |
| **Above 3.0** | Growth premium |
| **Data required** | Market cap, debt, cash, revenue |
