---
title: "Rule of 40 for SaaS Companies"
description: "Rule of 40 SaaS profitability metric: revenue growth rate plus net profit margin should equal at least 40. Learn when to prioritize growth versus margin."
keywords:
  - rule of 40 saas
  - saas profitability metrics
  - growth rate profit margin
  - saas company valuation
  - saas financial performance
...
<div class="wiki-infobox-title">Rule of 40 for SaaS — key facts</div>

<img src="/svg/ratios.svg" alt="An abstract editorial mark for the topic." />

<div class="wiki-infobox-caption">A benchmark for evaluating whether SaaS companies have achieved healthy growth-to-profitability balance.</div>

|   |   |
|---|---|
| **Formula** | Revenue growth rate (%) + Net profit margin (%) ≥ 40 |
| **Who uses it** | Public SaaS investors, analysts, and company leadership |
| **Most relevant stage** | Growth-stage and mature SaaS companies (€5M–$500M+ ARR) |
| **Limitations** | Ignores unit economics, [customer acquisition](/)/[retention](/), debt, and cash burn |
| **Typical "good" breakdown** | 30% growth + 10% margin, or 20% growth + 20% margin |
| **Typical "bad" breakdown** | 50% growth – 15% margin, or 5% growth + 20% margin |
...
Most SaaS companies face the rule of 40 as a _dynamic choice_, not a fixed state. As you grow, you can emphasize one of two levers.
...
- A profitable, slow-growth company that generates lots of free cash is fine; the rule assumes you _want_ to grow.
...
- [Return on Equity](/return-on-equity/) — broader measure of profitability relative to shareholder capital
- [Free Cash Flow](/free-cash-flow/) — more direct measure of a company's ability to fund growth and return capital
- [Earnings Per Share](/earnings-per-share/) — common metric for tracking SaaS company profitability per share
- [Gross Profit Margin](/gross-profit-margin/) — shows profitability before operating costs
- [Operating Margin](/operating-margin/) — intermediate profitability metric before taxes and interest
