---
title: "ROE Industry Comparison"
description: "Analysis of how return on equity varies across business sectors, reflecting capital intensity and profitability differences."
keywords:
  - return on equity
  - industry comparison
  - roe-analysis
...
*A **ROE industry comparison** examines how [return on equity](/wiki/return-on-equity/) differs across sectors, reflecting each industry's capital structure, competitive dynamics, and profitability ceiling. High-ROE industries (software, media, insurance) require little capital per dollar of profit; low-ROE industries (utilities, banking, real estate) are capital-heavy and can tolerate lower returns.*

<aside class="wiki-infobox">

| Aspect | Detail |
|--------|--------|
| **High-ROE Sectors** | Software, media, pharma, insurance |
| **Low-ROE Sectors** | Utilities, banking, real estate, transportation |
| **Typical Range** | 5% (utilities) to 40%+ (software) |
| **Duration** | Stable over medium term but shifts with competition |
| **Key Driver** | Asset base size relative to net income |

</aside>

## Why ROE varies so dramatically by sector

[Return on equity](/wiki/return-on-equity/) is net income divided by shareholders' equity—how many dollars a company makes for every dollar of shareholder capital invested. But this ratio is governed by an industry's fundamental economics. A software company with a 30% [operating margin](/wiki/operating-margin/) and 20% [tax rate](/wiki/corporate-income-tax/) generates roughly 24% net margin. If it needs only $1 of equity to support $10 of revenue (because subscriptions are prepaid and receivables are short), ROE soars to 240%. A utility with a 10% operating margin and the same tax rate generates 8% net margin. But utilities need $3 of equity to support $10 of revenue (because of large capital-intensive assets). Their ROE is only 27%.
...
Within an industry, ROE swings with the [business cycle](/wiki/business-cycle/). During [expansion phases](/wiki/expansion-phase/), fixed assets are fully utilized, margins are high, and ROE surges. During [contraction](/wiki/contraction-phase/), asset utilization falls, margins compress, and ROE sinks. A cyclical industry (steel, construction) might show ROE ranging from 5% to 30% depending on where we are in the cycle. A defensive industry (utilities, consumer staples) shows ROE ranging from 8% to 12%.
...
ROE differences shape [valuation multiples](/wiki/multiples-valuation/). Software companies with sustainable ROE above their [cost of equity](/wiki/cost-of-equity/) (say, 15% ROE, 10% cost of equity) warrant high [P/E ratios](/wiki/price-to-earnings-ratio/); the excess return justifies the premium. Utilities with ROE near their cost of equity (8% ROE, 7% cost of equity) warrant low multiples; there is little excess return to justify a premium. [Value investors](/wiki/value-investing/) seek high-ROE companies trading at [low multiples](/wiki/price-to-earnings-ratio/), while [growth investors](/wiki/growth-investing/) accept higher multiples if ROE is rising.
...
### Closely related
- [Return on Equity](/wiki/return-on-equity/) — Net income divided by shareholders' equity
- [Operating Margin](/wiki/operating-margin/) — Operating income as a percentage of revenue
- [Asset Turnover Ratio](/wiki/asset-turnover-ratio/) — Revenue divided by total assets

### Wider context
- [DuPont Analysis](/wiki/dupont-analysis/) — Framework decomposing ROE into margin, turnover, and leverage
- [Return on Invested Capital](/wiki/return-on-invested-capital/) — ROIC; return relative to total capital deployed
- [Cost of Equity](/wiki/cost-of-equity/) — Required return for equity investors
