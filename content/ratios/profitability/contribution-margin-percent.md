---
title: "Contribution Margin Percent"
description: "Sales revenue minus variable costs, expressed as a percentage of sales, indicating how much of each dollar of sales is available to cover fixed costs and profit."
keywords:
...
| Item | Detail |
|---|---|
| **Formula** | (Sales − Variable Costs) / Sales, or equivalently, 1 − (Variable Costs / Sales) |
| **Alternative form** | Contribution margin per unit ÷ Price per unit |
| **Typical range** | 20% to 80%, depending on industry; higher = more profitable |
| **Interpretation** | Percentage of each sales dollar available after paying variable costs |
| **Distinction from gross margin** | Gross margin includes cost of goods sold; contribution margin isolates variable costs only |
| **Break-even insight** | Break-even volume = Fixed Costs / Contribution Margin per unit |
| **Operating leverage** | High contribution margin % = high leverage (small sales increases = large profit gains) |
| **Used by** | Management accountants, cost-volume-profit (CVP) analysis, pricing analysts |
...
Gross margin (often called "gross profit margin") is [Cost of Goods Sold](/wiki/cogs-percentage-sales/) (COGS) as a percent of sales. Contribution margin is variable costs as a percent of sales. The concepts are related but distinct:
