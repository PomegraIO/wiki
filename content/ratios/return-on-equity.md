...
description: "Return on equity divides net income by average shareholder equity, showing how much profit a company generates per dollar of shareholders' capital invested."
keywords:
  - return on equity
  - roe
  - profitability
...
|   |   |
|---|---|
| **Also called** | ROE, return to equity holders |
| **Formula** | Net income ÷ average shareholder equity |
| **Unit** | Percentage |
| **What it answers** | How much profit does the company generate per dollar of equity? |
| **Benchmark** | 15% or higher is excellent |
| **Below 5%** | Value-destroying or distressed |
| **5-10%** | Below average; destroys value if cost of equity is higher |
| **10-15%** | Acceptable; in line with long-term market returns |
| **Above 20%** | Excellent; suggests durable competitive advantage |
| **Data required** | Net income, beginning equity, ending equity |
