...
description: "Gross profit margin divides gross profit by revenue, showing what percentage of sales remains after paying for the cost of goods sold. It is a measure of pricing power and production efficiency."
keywords:
  - gross profit margin
  - gross margin
  - profitability
...
|   |   |
|---|---|
| **Also called** | Gross margin, gross profit rate |
| **Formula** | (Revenue − COGS) ÷ revenue |
| **Unit** | Percentage |
| **What it answers** | What percentage of revenue remains after direct production costs? |
| **Benchmark** | Varies by industry; 25-50% typical |
| **Below 20%** | Low pricing power or high production costs |
| **20-40%** | Typical for retail and manufacturing |
| **40-60%** | Strong; typical for software and services |
| **Above 60%** | Excellent; often software or branded luxury |
| **Data required** | Revenue, cost of goods sold |
...
1. **Pricing power:** Can the company charge more than its costs?
2. **Efficiency:** How well does the company manage production costs?
...
1. You calculate gross margin for a company and its peers.
2. You examine the trend over five years.
3. You look at operating margin and net margin to see how the company converts gross profit to bottom-line profit.
4. You compare the company's margins to peers to assess competitive position.
5. You investigate any unusual changes — they often have explainable causes (acquisitions, product mix, input cost spikes).
