...
description: "The price-to-free cash flow ratio divides market capitalization by free cash flow, which is operating cash flow minus capital expenditures. It shows what cash is actually available to shareholders."
keywords:
...
|   |   |
|---|---|
| **Also called** | P/FCF ratio, price-to-levered-free-cash-flow |
| **Formula** | Market capitalization ÷ free cash flow (TTM) |
| **Where FCF = ** | Operating cash flow − capital expenditures |
| **Unit** | Unitless (a multiple) |
| **What it answers** | How much are you paying per dollar of cash shareholders can receive? |
| **Benchmark** | P/FCF = 1.0 is extremely cheap; 15-25 is typical |
| **Below 10.0** | Potentially undervalued or cyclically depressed |
| **Above 40.0** | Premium valuation; verify sustainability |
| **Data required** | Market cap, operating cash flow (LTM), capital spending (LTM) |
