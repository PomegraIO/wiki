---
title: "Trough"
description: "The lowest point in the business cycle before economic recovery begins; marks the end of recession and onset of expansion."
keywords:
...
*A **trough** is the inflection point at the bottom of the [business cycle](/wiki/business-cycle/)—the moment when declining economic activity stops falling and begins to recover. It is the end of a [recession](/wiki/recession/) and the start of an [expansion](/wiki/expansion-phase/).*

<aside class="wiki-infobox">

| Aspect | Detail |
|--------|--------|
| **Definition** | Lowest real GDP and highest unemployment in a cycle |
| **Duration** | Business cycles vary; troughs can be abrupt or drawn out |
| **Identification** | Often recognized only in hindsight |
| **Lead indicators** | Some advance indicators bottom before the trough |
| **Tail risk** | Double-dip recessions mean a second trough |
| **Frequency** | U.S. cycles: roughly 8–10 years peak to peak |
| **Authority** | NBER officially dates U.S. troughs |
...
Troughs emerge from the interplay of automatic stabilizers and policy response. [Automatic stabilizers](/wiki/automatic-stabilizer/) (unemployment benefits, progressive taxes) kick in during downturns, supporting consumer income and demand. Discretionary [fiscal stimulus](/wiki/stimulus-package/) and [monetary easing](/wiki/expansionary-monetary-policy/) provide additional support.
...
### Closely related
- [Business Cycle](/wiki/business-cycle/) — The full pattern of expansion, peak, contraction, and trough.
- [Recession](/wiki/recession/) — The contraction phase before the trough.
- [Expansion Phase](/wiki/expansion-phase/) — Growth after the trough.
- [Peak Cycle](/wiki/peak-cycle/) — The high point of economic activity.
- [Automatic Stabilizer](/wiki/automatic-stabilizer/) — Fiscal mechanisms that cushion downturns.

### Wider context
- [Monetary Policy Tools](/wiki/monetary-policy-tools/) — Central bank responses to troughs.
- [Fiscal Stimulus](/wiki/stimulus-package/) — Government spending to boost demand.
- [Unemployment Rate](/wiki/unemployment-rate/) — Labor market slack at the trough.
- [Jobless Recovery](/wiki/jobless-recovery/) — Weak employment during expansion after trough.
- [Market Timing](/wiki/market-timing/) — Attempting to time entry near troughs.
