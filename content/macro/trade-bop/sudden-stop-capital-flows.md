---
title: "Sudden Stop in Capital Flows"
description: "The abrupt reversal of foreign capital inflows into emerging markets, causing currency depreciation and balance-of-payments crisis."
keywords:
...
<div class="wiki-infobox-title">Sudden Stop — key facts</div>

<img src="/svg/macro.svg" alt="An abstract editorial mark for the topic." />

<div class="wiki-infobox-caption">A sudden stop reverses years of inflows within months, shocking the currency and credit markets.</div>

|   |   |
|---|---|
| **Typical magnitude** | Net capital inflows drop by 5–10% of GDP in 6–12 months |
| **Currency effect** | Sharp depreciation (20–50% in crisis cases) |
| **Interest rate effect** | Local rates spike as the central bank defends the currency |
| **Trigger examples** | Global risk-off, local policy shock, contagion from peer crises |
| **Duration** | Weeks to months to recover; full recovery takes years |
| **Primary victims** | Emerging markets with large current account deficits, short-term debt |
...
- [Balance of payments](/balance-of-payments/) — the accounting framework where sudden stops appear as capital account reversals
- [Currency risk](/currency-risk/) — the exchange rate shock that accompanies a sudden stop
- Emerging market — the geography most vulnerable to sudden stops
- [Capital flows](/capital-flows/) — the broader pattern of international investment that sudden stops interrupt
- [Risk management approach monetary policy](/risk-management-approach-central-bank-policy/) — how policymakers respond to sudden-stop tail risk

### Wider context

- [Federal Reserve](/federal-reserve/) — rate changes in the U.S. often trigger global sudden stops
- [Interest rate](/interest-rate/) — the channel through which Fed tightening prompts outflows
- [Sovereign debt](/sovereign-debt/) — the asset being sold in sudden-stop episodes
