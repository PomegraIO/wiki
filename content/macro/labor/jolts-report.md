---
title: "JOLTS Report"
description: "The JOLTS report (Job Openings and Labor Turnover Survey) tracks job openings, hires, quits, and separations monthly. It provides a detailed view of labor market dynamics."
keywords:
  - JOLTS report
  - job openings
  - labor turnover
...
|   |   |
|---|---|
| **Full name** | Job Openings and Labor Turnover Survey |
| **Released** | Monthly, on BLS website |
| **Sample size** | ~16,000 establishments |
| **Measures tracked** | Job openings, hires, quits, separations, layoffs |
| **Base month** | Lag of 30 days (May data released in June) |
| **Key ratio** | Job openings / unemployed; >1 = tight market |
| **Data start date** | December 2000 |
| **Frequency** | Monthly |
