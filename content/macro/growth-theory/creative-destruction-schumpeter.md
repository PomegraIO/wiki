...
description: "Schumpeter's framework: innovation destroys obsolete firms and industries, creating dynamic economic progress."
keywords:
...
| Concept | Example |
|---|---|
| **Incumbent disrupted** | Kodak (photography film) displaced by digital sensors |
| **New structure emerges** | Netflix streaming replaces video rental stores |
| **Temporary monopoly** | Apple's dominance in smartphones (2010–2015) |
| **Next wave** | Android captures market share; Apple's moat narrows |
| **Market level** | Entire industries can vanish (telegraph, horse-drawn carriages) |
| **Timeframe** | 5–30 years; longer for capital-intensive sectors |
| **Friction** | Workers displaced, capital stranded; slowness in adjustment |
...
**Classical view** — markets reach equilibrium where price equals marginal cost, [profit margins](/wiki/profit-margin-ratio/) compress, and growth saturates.
...
- **Workers** in the old industry face [unemployment](/wiki/unemployment-rate/) and must retrain (slow, costly process).
...
- A smartphone maker (disrupting all prior handheld devices) trades at a high [P/E](/wiki/price-to-earnings-ratio/) because growth and [market share](/wiki/market-capitalization/) expansion are assumed.
- A textile mill (disrupted by automation and offshoring) trades at a low multiple because growth is zero and [margins](/wiki/gross-margin-analysis/) are compressed.

The [value investor](/wiki/value-investing/) buys cheap, disrupted industries hoping they stabilize or adapt. The [growth investor](/wiki/growth-investing/) buys disruptors, betting the destruction is so complete that a new industry forms with high returns.
...
**Artificial intelligence** — early stage of disruption. Office workers in coding, legal research, and data entry face potential [unemployment](/wiki/unemployment-rate/) as AI automates tasks. The new industries AI will create are uncertain, creating social tension.
...
- **Financialization** — modern capitalism sometimes kills firms through [leveraged buyout](/wiki/leveraged-buyout/) or short-selling pressure rather than genuine innovation, a perversion of Schumpeter's ideal.
