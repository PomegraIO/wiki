...
description: "Multifactor productivity (also called total-factor productivity) measures output growth that cannot be explained by increases in labor and capital inputs. It captures technological progress and organizational efficiency."
keywords:
...
The key insight: if output grew 3% but labor inputs grew 1% and capital inputs grew 2%, then multifactor productivity grew about 1% — the residual growth that "technology" must explain.
...
|   |   |
|---|---|
| **Also called** | Total-factor productivity (TFP), Solow residual |
| **Formula** | Output growth − (labor share × labor growth) − (capital share × capital growth) |
| **Measured** | As a residual; not directly observed |
| **Trend growth** | 0.5–1.5% annually (developed economies) |
| **Typical source** | Technological innovation, management practices |
| **Limitation** | Measured as residual; includes measurement error |
| **Reported by** | Bureau of Labor Statistics (US), OECD |
| **Frequency** | Annually (with lags) |
