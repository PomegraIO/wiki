...
description: "The Consumer Price Index (CPI) measures inflation in consumer prices. It tracks the monthly change in prices paid by households for goods and services."
keywords:
  - CPI
...
|   |   |
|---|---|
| **Basket size** | ~80,000 items tracked across US |
| **Release timing** | Monthly (around 12th of following month) |
| **Sample** | ~15,000 retail locations, ~50,000 rental units |
| **Base year** | 1982-84 = 100 |
| **Current level (2026)** | ~310 (meaning prices ~210% above 1982-84) |
| **Typical growth** | 2–3% annually (target is ~2%) |
| **Index variants** | Headline, core, trimmed-mean, sticky-price |
