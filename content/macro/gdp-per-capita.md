...
description: "GDP per capita is the average economic output per person in a country, calculated by dividing total GDP by the population. It is the standard metric for comparing living standards."
keywords:
  - GDP per capita
  - living standards
  - income per person
...
| **Most useful form** | Real GDP per capita at PPP |
| **Global range** | $1,000 to $100,000+ depending on country |
| **Growth metric** | Per-capita real growth = real GDP growth − population growth |
| **Typical use** | Development rankings, living standard proxy |
