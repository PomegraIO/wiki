...
description: "Structural unemployment is joblessness caused by mismatches between jobs available and workers' skills or location, rather than weak demand. It is a permanent feature of labor markets."
keywords:
...
|   |   |
|---|---|
| **Cause** | Skills/location mismatch, not weak demand |
| **Persistence** | High even in boom periods |
| **Typical level** | 1.5–3% in developed economies |
| **Examples** | Coal miner without retraining; job in tech hub, worker in declining town |
| **Not fixed by** | Monetary stimulus alone |
| **Fixed by** | Education, retraining, relocation, technological catch-up |
| **Policy response** | Supply-side reforms, education investment |
