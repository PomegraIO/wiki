...
description: "Gross Domestic Product (GDP) is the total market value of all goods and services produced within a country in a given period. It is the most widely used measure of economic size and health."
keywords:
  - GDP
...
|   |   |
|---|---|
| **Also called** | Economic output, aggregate output |
| **What it measures** | Total market value of production |
| **Geographic scope** | Within country borders |
| **Time period** | Usually annual or quarterly |
| **Main variants** | Nominal, real, per capita |
| **Reported by** | Bureau of Economic Analysis (US) |
| **Frequency** | Quarterly (preliminary, revised twice) |
| **Key formula** | C + I + G + (X − M) |
| **Typical use** | Economic growth, recessions, policy |
