...
description: "Initial jobless claims measure the number of people filing for unemployment insurance for the first time. It is the most timely labor market indicator."
keywords:
  - jobless claims
  - unemployment claims
  - weekly claims
...
|   |   |
|---|---|
| **Release timing** | Every Thursday for prior week |
| **Sample** | 100% of unemployment insurance filings |
| **Normal range** | 200-300k weekly |
| **Recession signal** | Sustained >400k (4-week average) |
| **Reporting lag** | Minimal (one day) |
| **Revisions** | Large revisions common in first month |
| **Cyclicality** | Procyclical; rises in recessions, falls in expansions |
