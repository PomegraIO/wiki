---
title: "Service Sector Output"
description: "Output from non-manufacturing activities like healthcare, finance, hospitality, and professional services."
keywords:
  - service sector
  - tertiary economy
  - gdp composition
...
| Metric | Developed Economy | Emerging Economy |
|---|---|---|
| Services % of GDP | 60–80% | 30–60% |
| Employment share | 70–80% | 40–60% |
| Typical sectors | Healthcare, finance, retail, tourism | Retail, hospitality, basic services |
| Output measurement | Value added (hard to quantify) | Price of service delivery |
| Inflation volatility | Moderate | High (especially labor) |
| Trade exposure | Lower | Variable (tourism, finance) |
...
This measurement ambiguity is consequential. [GDP](/wiki/gross-domestic-product/) calculations rely on service-sector estimates, and measurement errors ripple through inflation statistics, [productivity](/wiki/productivity/) assessments, and real-income estimates.
...
## Service sector inflation and the [Phillips curve](/wiki/phillips-curve/)
...
[Central banks](/wiki/central-bank/) trying to cool inflation often struggle with services because demand for services is sticky—people don't reduce healthcare or education much during recessions. [Monetary tightening](/wiki/contractionary-monetary-policy/) thus has limited impact on service prices; instead, it risks triggering [unemployment](/wiki/unemployment-rate/) and [recession](/wiki/recession/) in other sectors with more flexible demand.

In the 2021-2023 inflation episode, service-sector wage growth and prices proved sticky. Even as [good inflation](/wiki/producer-inflation/) (goods prices) cooled, service inflation remained elevated, complicating the Fed's path to 2% [core inflation](/wiki/core-inflation/).
...
[Monetary policy](/wiki/monetary-policy/) transmission to services is slower than to goods. Lower [interest rates](/wiki/interest-rate/) spur borrowing for durable goods (cars, homes); services demand is less rate-sensitive (people don't postpone healthcare or education as much). This matters for [forward guidance](/wiki/forward-guidance/): central banks projecting that monetary easing will stimulate demand may be disappointed if much demand is for labor-intensive services that respond slowly to rate cuts.

Additionally, the service sector's high employment concentration means service-sector dynamics drive [labor market](/wiki/labor-force-participation-rate/) tightness. When service employment is robust, unemployment falls, wage inflation accelerates, and [inflation](/wiki/inflation/) risks rise. Conversely, a service-sector weakness (e.g., retail, hospitality during COVID) triggers rapid unemployment and deflationary pressure.

<div class="wiki-seealso">

### Closely related
- [Gross Domestic Product](/wiki/gross-domestic-product/) — Total output including services
- [Value Added](/wiki/gross-profit-margin/) — How service output is measured
- [Productivity](/wiki/productivity/) — Growth challenges in services
- [Employment Population Ratio](/wiki/employment-population-ratio/) — Service-sector employment share
