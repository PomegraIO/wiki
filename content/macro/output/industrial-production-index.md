...
description: "A monthly measure of real output produced by manufacturing, mining, and utility sectors in an economy."
keywords:
...
| Item | Detail |
|---|---|
| **Measurement** | Real output (volume), not prices; indexed to a base year (e.g., 2017=100) |
| **Sectors** | Manufacturing (largest ~75%), mining (~5%), utilities (~20%) |
| **Frequency** | Monthly; released 10–15 days after month-end |
| **Timeliness** | One of the first economic data points published each month |
| **Volatility** | More volatile than employment or GDP; responsive to input shocks |
| **Lead indicator** | Often leads employment and consumption (by 1–3 months) |
| **Data source** | U.S.: Federal Reserve; EU: Eurostat; Japan: Ministry of Economy |
| **Relationship to GDP** | IPI is a component of GDP; manufacturing IPI correlates ~0.7 with real GDP growth |
