...
description: "Orders for long-lasting manufactured products like machinery, reflecting business confidence and capital spending."
keywords:
...
*Durable goods orders measure new orders placed with manufacturers of goods expected to last more than three years—machinery, aircraft, ships, vehicles, and equipment. Released monthly by the Census Bureau, this data signals business confidence in future demand and [capital expenditure](/wiki/capex-budgeting/) intentions. Excluding volatile transportation orders, the metric provides cleaner insight into underlying [business cycle](/wiki/business-cycle/) momentum.*

<aside class="wiki-infobox">

| Item | Details |
|------|---------|
| **Frequency** | Monthly release (Census Bureau) |
| **Lag** | ~2 weeks after month-end |
| **Volatility** | High; aircraft orders can skew monthly data |
| **Core metric** | Durable goods excluding transportation |
| **Interpretation** | Leading indicator of capital spending and growth |
| **Components** | Machinery, vehicles, aircraft, ships, electronics |
...
Orders are distinct from shipments. An order placed in January might not ship until June. Thus, orders lead shipments and, in turn, future [capital spending](/wiki/capex-budgeting/) and [GDP growth](/wiki/gross-domestic-product/). A surge in machinery orders in Q1 presages higher industrial output and employment in Q2–Q3. A collapse in orders signals recession risk.
...
Economists supplement durable goods orders with other [indicators](/wiki/industrial-production-index/): [industrial production](/wiki/industrial-production-index/), [capacity utilization](/wiki/capacity-utilization-rate/), capital goods shipments, and business surveys. Together, these paint a picture of business investment intentions and [economic momentum](/wiki/momentum-investing/).

<div class="wiki-seealso">

### Closely related
- [Capital Expenditure](/wiki/capex-budgeting/) — Future business spending signaled by orders
- [Business Cycle](/wiki/business-cycle/) — Cyclical pattern of expansion and contraction
- [Industrial Production](/wiki/industrial-production-index/) — Output of goods and factories
- [Capacity Utilization](/wiki/capacity-utilization-rate/) — Factory operating levels

### Wider context
- [Gross Domestic Product](/wiki/gross-domestic-product/) — Growth metric impacted by capex
- [Leading Indicators](/wiki/lagging-indicator/) — Forward-looking economic signals
- [Recession](/wiki/recession/) — Economic contraction that durable orders precede
- [Monetary Policy Tools](/wiki/central-bank-policy-tools/) — Policy response to investment signals
