...
description: "Personal consumption expenditure inflation excluding food and energy, a key measure of underlying inflation trends."
keywords:
  - core pce inflation
  - inflation measure
...
| Key fact | Detail |
|----------|--------|
| **Official name** | Personal Consumption Expenditure Price Index, excluding food and energy |
| **Release** | Monthly by Bureau of Economic Analysis (within GDP report) |
| **Components** | ~80% of consumer spending (excludes food, energy) |
| **Fed target** | 2% annual rate |
| **Breadth** | Broader than [CPI](/wiki/consumer-price-index/) (covers services more thoroughly) |
| **Weighting** | Chained weights (rebalanced monthly, more flexible) |
| **vs. headline** | Headline PCE includes food and energy |
| **Comparison** | Often preferred over [CPI](/wiki/consumer-price-index/) for monetary policy |

</aside>

## PCE vs. the Consumer Price Index

The US publishes two main [inflation](/wiki/inflation/) measures: [Consumer Price Index](/wiki/consumer-price-index/) (CPI) and PCE. Both track the cost of living, but they differ in scope and method.
...
**Deflation is toxic**: When prices fall, consumers delay purchases ("I'll buy the car next year when it's cheaper"), which collapses demand. Businesses delay investment. Wages fall to match prices, but they are sticky (workers resist cuts), creating unemployment. The Great Depression and Japan's lost decades were long periods of [deflation](/wiki/deflation/), which devastated growth.

**2% inflation is the "Goldilocks" zone**: It is high enough to deter hoarding and encourage spending. It allows for negative real rates (inflation exceeding interest rates), which helps reduce [debt](/wiki/debt-to-gdp-ratio/) burdens. It provides buffer room—if inflation dips below 2%, the Fed can cut rates without hitting zero. And it roughly matches long-run [productivity](/wiki/productivity/) growth.
...
1. **Stability**: It excludes volatile commodity prices, giving a clearer signal of underlying demand-side inflation.

2. **Coverage**: PCE includes services more thoroughly than CPI, and services have been the main inflation driver post-pandemic.

3. **Methodology**: Chained weighting (rebalancing as consumption shifts) is economically more accurate.

4. **Predictive power**: Core PCE momentum is a good predictor of future headline inflation.
...
When Core PCE runs above 2%, the Fed raises [interest rates](/wiki/interest-rate/) to cool demand and inflation. When Core PCE is near 2% or below, the Fed cuts rates or holds steady. The market watches Core PCE releases closely because they drive Fed [forward guidance](/wiki/forward-guidance/) and [rate expectations](/wiki/federal-funds-rate-impact/).
...
### Closely related
- [Personal Consumption Expenditures Price Index](/wiki/personal-consumption-expenditures-price-index/) — The official PCE index
- [Core Inflation](/wiki/core-inflation/) — Inflation excluding food and energy
- [Consumer Price Index](/wiki/consumer-price-index/) — Alternative inflation measure (CPI)
- [Inflation](/wiki/inflation/) — Broad concept of rising prices

### Wider context
- [Monetary Policy](/wiki/monetary-policy/) — Fed tools to control inflation
- [Federal Reserve](/wiki/federal-reserve/) — Keeper of the 2% inflation target
- [Interest Rate](/wiki/interest-rate/) — Fed's primary tool to fight inflation
- [Deflation](/wiki/deflation/) — The risk the Fed guards against
- [Forward Guidance](/wiki/forward-guidance/) — Fed communication about future policy
- [Shelter Inflation](/wiki/inflation/) — Largest component of Core PCE
