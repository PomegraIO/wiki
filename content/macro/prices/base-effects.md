---
title: "Base Effects"
description: "Statistical distortions in year-over-year inflation rates caused by unusually high or low prices from the prior-year period."
keywords:
  - inflation rates
...
| Aspect | Description |
|--------|-------------|
| **Mechanism** | Comparison to a specific prior-year level |
| **Peak effect** | Inflation appears to spike when prior-year was depressed |
| **Trough effect** | Inflation appears to fall when prior-year was elevated |
| **Duration** | Effect lasts approximately one year, then rolls off |
| **Visibility** | Most pronounced in volatile commodity categories |
| **Federal Reserve concern** | Can mask or exaggerate true underlying inflation trends |
...
### Closely related
- [Headline inflation](/wiki/headline-inflation/) — Total inflation including volatile components
- [Core inflation](/wiki/core-inflation/) — Inflation excluding energy and food
- [Inflation](/wiki/inflation/) — General rise in price level
- [Producer price index](/wiki/producer-price-index/) — Inflation measured at wholesale level

### Wider context
- [Monetary policy](/wiki/monetary-policy/) — Central bank tools and inflation targets
- [Disinflation](/wiki/disinflation/) — Fall in inflation rate
- [Deflation](/wiki/deflation/) — Sustained fall in price level
