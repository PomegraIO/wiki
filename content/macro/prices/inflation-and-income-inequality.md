---
title: "Inflation and Income Inequality"
description: "How inflation redistributes wealth between debtors and creditors, hurts lower-income households more, and widens income inequality."
keywords:
  - inflation and income inequality
  - how inflation affects income inequality
  - inflation distributional effects
  - inflation lower income households
image: /svg/macro.svg
---
...
<div class="wiki-infobox-title">Inflation's Distributional Impact</div>

<img src="/svg/macro.svg" alt="An abstract editorial mark for macroeconomic topics." />

<div class="wiki-infobox-caption">Inflation harms some groups far more than others, shifting wealth and purchasing power across the income distribution and by creditor status.</div>

|   |   |
|---|---|
| **Lower-income households** | Spend larger share of income on food, energy, transport; hit hardest by price spikes in necessities |
| **Fixed-income retirees** | Real purchasing power falls unless pensions are indexed; savings lose value |
| **Wage earners without bargaining power** | Real wages fall if raises lag inflation; unions and professionals fare better |
| **Borrowers (mortgaged homeowners, students)** | Real debt declines; inflation erodes loan balances; benefit if wages rise with inflation |
| **Savers and creditors** | Nominal returns shrink in real terms; bond holders lose; cash savings become worthless |
| **Net effect** | Inflation typically widens income inequality by hurting the poor and savers proportionally more |
...
- [Inflation](/inflation/) — The broad phenomenon and its economic causes and consequences
- [Inflation Measurement Problems and Biases](/inflation-measurement-problems/) — Why official inflation rates may misstate the true cost to lower-income households
- [Real Interest Rate](/real-interest-rate/) — The borrower-lender redistribution mechanism and its inequality implications
- [Monetary Policy](/monetary-policy/) — Central bank choices and their distributional consequences

### Wider context

- [Second-Round Inflation Effects](/second-round-inflation-effects/) — How inflation expectations and wage-setting behaviour amplify inequality
- [Federal Reserve](/federal-reserve/) — The central bank navigating inflation control and employment goals
- [Central Bank](/central-bank/) — The institution balancing inflation and distributional outcomes
- [Income Statement](/income-statement/) — Understanding household and firm finances in inflationary periods
