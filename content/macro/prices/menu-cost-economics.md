---
title: "Menu Costs in Economics Explained"
description: "Menu costs are the real costs firms incur to change prices—labor, printing, systems updates. They explain price stickiness and why inflation doesn't adjust instantly."
keywords:
  - menu costs economics
  - price stickiness menu costs
  - menu cost inflation
...
<div class="wiki-infobox-title">Menu Costs — key facts</div>

<img src="/svg/macro.svg" alt="An abstract editorial mark for the topic." />

<div class="wiki-infobox-caption">Small operational costs that create large macroeconomic frictions.</div>

|   |   |
|---|---|
| **Core definition** | Real costs (labor, systems, materials) to alter posted prices |
...
- [Inflation](/inflation/) — the macro phenomenon that menu costs help explain
- Price Stickiness — the direct result of menu costs in pricing behavior
- [Monetary Policy](/monetary-policy/) — the policy lever affected by price stickiness and menu costs
- [Deflation](/deflation/) — particularly prone to downward price stickiness owing to menu costs
