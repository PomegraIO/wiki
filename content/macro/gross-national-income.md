...
description: "Gross National Income (GNI) is the total income earned by a country's residents, adjusted for net international income flows and terms-of-trade changes. It is the modern replacement for GNP."
keywords:
  - GNI
...
| **Frequency** | Annual |
| **Real variant** | Real GNI (inflation-adjusted) |
| **Per-capita form** | GNI per capita (standard development metric) |
| **Key distinction from GDP** | Includes net factor income from abroad |
| **Key distinction from GNP** | Also adjusts for terms-of-trade changes |
