---
title: "Sales Tax"
description: "Consumption tax levied at the point of sale, creating cascading effects across supply chains."
keywords:
  - sales tax
  - consumption tax
  - tax incidence
...
| Aspect | Detail |
|--------|--------|
| Rate Range | 0–10% (US state/local) |
| Tax Base | Retail sales of goods; services vary |
| Collection | At point of sale by retailer |
| Cascade Effect | Taxes applied at each stage if not rebated |
| Regressivity | Higher burden on low-income households |
...
Many countries use a [value-added tax](/wiki/value-added-tax/) (VAT) to avoid cascade by rebating input taxes. A manufacturer pays tax on its full revenue but receives a rebate for taxes paid on inputs. The net tax is only on the "value added" at each stage. In contrast, a sales tax without perfect rebate mechanisms creates dead weight loss — resources spent to minimize tax burden (vertical integration, transfer pricing disputes, audit costs) that don't increase economic output.
...
### Wider context
- [Fiscal Policy](/wiki/fiscal-policy-contractionary/) — government revenue and spending
- [Economic Efficiency](/wiki/price-discovery/) — allocative effects of tax distortions
- [Consumption Function](/wiki/consumption-function/) — household spending behavior
- [Crowding Out](/wiki/crowding-out/) — effects of taxation on private investment
