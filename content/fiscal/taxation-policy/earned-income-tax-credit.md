...
description: "Refundable tax credit for low-income workers, reducing poverty and increasing work incentives."
keywords:
...
| **Eligibility** | Low earned income + meeting income/dependents caps |
| **Max Credit (2024)** | $3,733 (single, no children) to $3,995 (married, 3+ children) |
| **Phase-in** | 34% on first $15K of earnings (single, no children) |
| **Phase-out** | Gradually reduces at higher income levels |
| **Refundable** | Yes — excess credit paid out as refund |
| **Administration** | IRS via tax return or advance payments |
| **Congressional Intent** | Reduce poverty; incentivize work over welfare |
