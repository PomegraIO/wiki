...
description: "Primary tax on business profits that shapes capital allocation decisions, investment incentives, and corporate structure."
keywords:
...
| Factor | Detail |
|--------|--------|
| **US Federal Rate (2018–present)** | 21% (reduced from 35% in 2017 Tax Cuts and Jobs Act) |
| **State Rates** | Range from 0% (some states) to 12% (Iowa, Illinois); average ~6% |
| **Taxable Income** | Gross revenue minus deductible expenses (COGS, wages, interest, depreciation) |
...
A corporation reports gross revenue, subtracts [cost of goods sold (COGS)](/wiki/cogs-percentage-sales/), operating expenses, [depreciation](/wiki/depreciation/), [amortization](/wiki/amortization/), and [interest expense](/wiki/cost-of-debt/), arriving at taxable income. The corporation pays tax on that income at the statutory federal rate (21% in the US), plus any applicable state and local taxes.

Unlike [dividends](/wiki/dividend-tax/) or [capital gains](/wiki/capital-gains-tax/), corporate income tax is not graduated. A small firm and a large firm pay the same marginal rate on incremental profit. This is a contrast to individual [income tax](/wiki/marginal-tax-rate-investor/), which is progressive.

## Interest deductibility and leverage bias

The most consequential feature is that [interest expense](/wiki/cost-of-debt/) is fully deductible, while [dividend payments](/wiki/dividend/) to shareholders are not. This creates a bias toward [debt financing](/wiki/debt-financing/) over [equity financing](/wiki/equity-financing/).
...
[Depreciation](/wiki/depreciation/) is a deduction that reduces taxable income without a cash outflow, allowing companies to defer taxes on capital investments. [Bonus depreciation](/wiki/bonus-depreciation/) and [Section 179 deductions](/wiki/section-179-deduction/) accelerate depreciation in early years, providing additional tax relief for capital-intensive businesses.

These provisions incentivize [capital expenditure (capex)](/wiki/capex-budgeting/). A company investing in a factory can deduct the cost faster, reducing its tax bill and improving [cash flow](/wiki/cash-flow-statement/). The policy goal is to encourage productive investment; critics argue it is often gamed via sale-leasebacks and other tax minimization strategies.
...
The 2017 Tax Cuts and Jobs Act reduced the US corporate rate from 35% to 21% and provided [bonus depreciation](/wiki/bonus-depreciation/). The cut was intended to boost investment and growth. Stock markets rallied on the news; companies reported higher [earnings per share (EPS)](/wiki/earnings-per-share/) due to lower tax bills.

However, empirical evidence on whether lower corporate rates lead to sustained increases in capex is mixed. Some companies used tax savings to fund [share buybacks](/wiki/share-buyback/) and [dividends](/wiki/dividend-yield/) rather than reinvestment. Others did invest, but the relationship between the rate cut and actual growth was weaker than proponents had predicted.
...
The corporate tax rate affects [after-tax earnings](/wiki/after-tax-profit-margin/), which feed into [valuation multiples](/wiki/price-to-earnings-ratio/). A rate cut increases EPS without a change in operational performance, often leading to stock price increases. Conversely, a rate increase reduces EPS and can pressure valuations, absent a corresponding improvement in growth.
...
- [Depreciation](/wiki/depreciation/) — tax deduction reducing taxable income
