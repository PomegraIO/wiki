---
title: "Tax Incidence"
description: "How the economic burden of a tax falls between buyers and sellers through price adjustment."
keywords:
  - tax incidence
  - tax burden
  - price elasticity
...
<div class="wiki-infobox-title">Tax Incidence — key facts</div>

<img src="/svg/fiscal.svg" alt="An abstract editorial mark for taxation and fiscal policy." />

<div class="wiki-infobox-caption">The real tax burden falls on whoever has the least flexibility to change behaviour.</div>

|   |   |
|---|---|
| **What it is** | The actual split of a tax's economic cost between buyers and sellers |
| **Also called** | Incidence of taxation, tax burden |
| **Determined by** | Elasticity of supply and demand, not legal assignment |
| **Key principle** | The party with lower elasticity bears more of the burden |
| **Common application** | Sales taxes, payroll taxes, excise duties |
...
- [Deadweight Loss of Taxation](/deadweight-loss-taxation/) — The efficiency loss when a tax drives a wedge between supply and demand
- [Tax Expenditure](/tax-expenditure/) — Revenue forgone through deductions and credits, shifting burden to other taxpayers
- [Laffer Curve](/laffer-curve/) — The relationship between tax rates and total revenues collected
- [Corporate Income Tax](/corporate-income-tax/) — The tax on company profits and its distribution across stakeholders
- [Marginal Tax Rate (Investor)](/marginal-tax-rate-investor/) — The rate on the next pound of income and its effect on behaviour
- [Interest Coverage Ratio](/interest-coverage-ratio/) — How earnings pressure from taxes affects firm leverage
- [Cost of Equity](/cost-of-equity/) — The return investors require, affected by tax policy
...
- [Price Discovery](/price-discovery/) — How markets arrive at equilibrium prices
