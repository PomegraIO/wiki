...
description: "Multi-stage consumption tax collected at each production step; used by most developed economies."
keywords:
  - VAT
  - consumption tax
  - value added tax
...
| Aspect | Detail |
|---|---|
| **Primary Use** | Revenue generation for central/local governments |
| **Standard Rates** | 15–27% in developed economies; wide variation |
| **Adoption** | 170+ countries; ~160 use VAT; most developed economies |
| **US Status** | No federal VAT; sales tax is state-level alternative |
| **Collection Point** | Every business in the chain (minus refunds) |
| **Base** | Sales of goods and services |
...
- **No cascading burden**: Because input VAT is deductible, a business doesn't pay tax on tax. Under a naive [income tax](/wiki/corporate-income-tax/), a chain business pays tax on revenue, then again on the profit it makes selling that revenue—a form of double taxation.
...
- **Consistent revenue**: Unlike [income tax](/wiki/corporate-income-tax/), VAT isn't vulnerable to cyclical earnings collapses; consumption is steadier.

## Regional adoption patterns

**Europe and developed world**: The [European Union](/wiki/about/) has harmonized VAT across member states, with standard rates between 17% and 27%. The UK charges 20%, France 20%, Germany 19%. Australia, Canada, Japan, and most developed nations use VAT as their primary consumption tax.

**United States**: No federal VAT. Instead, states levy [sales tax](/wiki/sales-tax/) at the point of retail purchase (5%–10% typically). This is simpler for small businesses but less efficient; items consumed out-of-state or between businesses often escape tax entirely.
...
**"VAT is regressive"**: Partially true. Because poorer households consume more as a share of income, VAT takes a higher percentage of their wealth. Reduced rates on food and other essentials mitigate this, but VAT is less progressive than [income tax](/wiki/corporate-income-tax/).
...
VAT complements but doesn't replace [income tax](/wiki/corporate-income-tax/) or [capital gains tax](/wiki/capital-gains-tax/). In most developed economies, VAT covers 15–30% of central government revenue, with income tax and payroll taxes providing the bulk.
