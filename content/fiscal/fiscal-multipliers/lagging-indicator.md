...
description: "Economic data series that confirms business cycle trends after they have already occurred, used for retrospective analysis."
keywords:
  - lagging indicator
  - economic indicator
  - business cycle
...
|-----------|-------------|--------|
| Unemployment rate | 3–6 months | Bureau of Labor Statistics |
| Continuing jobless claims | 1–3 months | Weekly DOL release |
| Days sales outstanding | 1–2 months | Corporate balance sheets |
| Cost of capital (loan rates) | 2–4 weeks | Fed funds, mortgage rates |
| Plant & equipment orders | 1–3 months | ISM, manufacturing surveys |
| Commercial and industrial loans | 2–4 months | Fed credit data |
| Average prime rate | 1–2 months | Banking statistics |

</aside>

## Why lags are baked into labor and credit data

The most reliable lagging indicators involve employment and business credit, because both move with significant institutional friction. A manufacturer experiencing declining orders does not instantly lay off workers; it first depletes inventory, then reduces hours, then freezes hiring. Only after weeks do measured [unemployment](/wiki/unemployment-rate/) and [continuing jobless claims](/wiki/continuing-jobless-claims/) confirm that the cycle has turned negative. Similarly, when a [recession](/wiki/recession/) ends and hiring accelerates, the [unemployment rate](/wiki/unemployment-rate/) continues falling for months after the inflection, because employers are reluctant to re-hire full-time staff until they are confident demand is sustained.

[Continuing jobless claims](/wiki/continuing-jobless-claims/) are lagging by definition: they only count people *already* unemployed, not those entering unemployment in real time. The initial unemployment claims figure, released weekly, is more timely; the four-week moving average of initial claims is a compromise between noise and responsiveness.
...
- [Unemployment rate](/wiki/unemployment-rate/) (inverted — rising unemployment lags a recession).
- [Days sales outstanding](/wiki/days-sales-outstanding/) — how long businesses wait for payment, rising in downturns.
- [Manufacturing and trade inventories](/wiki/inventory-turnover/) to sales ratio — inventory buildup lags demand drops.
- Change in labor cost per unit of output — wages fall only after hiring drops.
- [Average prime rate](/wiki/prime-rate/) charged by banks — banks lower rates only after Fed action and credit demand weakens.
...
Portfolio managers and [algorithmic traders](/wiki/algorithmic-trading/) who rely on lagging indicators do so primarily for *confirmation*, not prediction. A trader might spot a leading-indicator weakness in yield-curve inversion or housing starts 6 months prior to recession onset. Once [unemployment](/wiki/unemployment-rate/) begins rising and [continuing jobless claims](/wiki/continuing-jobless-claims/) spike, the trader has confirmation that the leading signal was not a false alarm. This two-step process (leading signal → lagging confirmation) reduces whipsaws.
