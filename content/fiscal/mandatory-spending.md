...
description: "Mandatory spending consists of government expenditures that are set by law and continue automatically. It includes entitlements like Social Security, Medicare, and Medicaid, and is not subject to annual appropriations."
keywords:
  - mandatory spending
...
|   |   |
|---|---|
| **Definition** | Spending set by law, continuing without annual appropriation |
| **Major programs** | Social Security, Medicare, Medicaid |
| **Other examples** | Federal employee pensions, veterans benefits, unemployment insurance |
