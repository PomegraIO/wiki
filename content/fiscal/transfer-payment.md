...
description: "A transfer payment is a government payment to an individual that is not compensation for a good or service produced. Social Security, unemployment insurance, and welfare are transfer payments."
keywords:
  - transfer payment
  - government payment
  - income transfer
...
|   |   |
|---|---|
| **Definition** | Government payment for which no good/service produced |
| **Major types** | Social Security, unemployment, welfare, disability |
| **Funded by** | Taxes, payroll taxes, general revenue |
| **Recipients** | Eligible individuals (age, income, disability status) |
| **Economic nature** | Redistribution, not payment for production |
| **Percent of budget** | Roughly 35–40% |
| **vs. Government purchase** | Transfer does not add to GDP directly; purchase does |
| **Automatic adjustment** | Often adjust with economic conditions and inflation |
