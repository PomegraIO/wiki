---
title: "Public-Private Partnership Debt"
description: "Debt incurred through public-private partnerships that blurs the line between government and private borrowing."
keywords:
...
For explicit government borrowing, see <a href="/wiki/sovereign-debt/">/wiki/sovereign-debt/</a>.
</div>

<aside class="wiki-infobox">

| Aspect | PPP Debt | Traditional Government Debt |
|--------|----------|--------------------------|
| **Borrower** | Private company (nominally) | Government directly |
| **Payment Source** | User fees + government subsidy | Tax revenue, borrowing |
| **Risk Transfer** | Demand/operational risk to private party | Retained by government |
| **Accounting** | Often off-balance-sheet for government | On-balance-sheet |
| **Transparency** | Lower (contracts may be confidential) | Higher (public debt markets) |
| **Long-term Obligation** | 20–50 year contracts | Perpetual or indefinite |
...
- [Implicit debt](/wiki/implicit-debt/) — government liabilities not formally recorded
- [Contingent liabilities government](/wiki/contingent-liabilities-government/) — potential obligations contingent on events
- [Debt-to-GDP ratio](/wiki/debt-to-gdp-ratio/) — measure of government leverage
