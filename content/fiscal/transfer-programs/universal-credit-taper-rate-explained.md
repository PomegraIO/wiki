...
<div class="wiki-infobox-title">Universal Credit Taper — key facts</div>

<img src="/svg/fiscal.svg" alt="An abstract editorial mark for fiscal policy." />

<div class="wiki-infobox-caption">Every additional pound earned costs you 55 pence in benefits.</div>

|   |   |
|---|---|
| **Current taper rate** | 55% |
| **Previous system (Tax Credits)** | 41% (lower, but split across programs) |
| **Effective marginal tax rate** | 55% + 20% income tax + 8% NI = 83% for typical earner |
| **Work incentive threshold** | £645/month earnings before taper applies |
| **Affected population** | ~6 million claimants in UK |
...
- [Marginal tax rate investor](/marginal-tax-rate-investor/) — how high earners structure income across tax brackets
- Transfer programs — overview of direct cash support
- [Fiscal multiplier](/fiscal-multiplier/) — how spending cuts ripple through the economy
- [Labor productivity](/labor-productivity/) — relationship between work incentives and output

### Wider context

- [Budget deficit](/budget-deficit/) — how benefit spending affects public finances
- [Discretionary spending](/discretionary-spending/) — welfare as part of government budgets
- [Natural rate of unemployment](/natural-rate-of-unemployment/) — equilibrium joblessness and labor supply
- [Unemployment rate](/unemployment-rate/) — official measure of joblessness
