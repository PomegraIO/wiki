...
description: "Government benefit delivered as goods or services (food, healthcare, housing) rather than cash, chosen to constrain how recipients spend."
keywords:
  - in-kind transfer
  - non-cash benefit
  - food assistance
...
<div class="wiki-infobox-title">In-Kind Transfer — key facts</div>

<img src="/svg/fiscal.svg" alt="An editorial mark representing social transfers and benefit programmes." />

<div class="wiki-infobox-caption">Non-cash benefits that restrict recipients to pre-approved goods and services.</div>

|   |   |
|---|---|
| **Core definition** | Benefit provided as goods/services, not cash |
| **Also called** | Non-cash benefit, voucher programme, supply-side transfer |
| **Common forms** | Food stamps, school meals, subsidised housing, healthcare, childcare |
| **Key trade-off** | Administrative cost vs. recipient autonomy |
| **Efficiency problem** | May cost more to deliver and leaves recipient worse off than equivalent cash |
| **Political advantage** | Reduces political backlash over "misuse" of welfare money |
...
- [Unemployment rate](/unemployment-rate/) — labour-market condition that triggers in-kind and cash assistance
- [Inflation](/inflation/) — erodes the real value of fixed-amount food vouchers and housing credits
- [Recession](/recession/) — drives demand for emergency in-kind assistance and food programmes
- [Cost basis](/cost-basis/) — for recipients, determining tax treatment of in-kind benefits they receive
