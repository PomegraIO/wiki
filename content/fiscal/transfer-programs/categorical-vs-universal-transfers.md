---
title: "Categorical vs Universal Transfer Programs"
description: "Categorical vs universal transfer programs: targeted benefits for specific groups versus universal programs available to all citizens, weighing efficiency against stigma and cost."
keywords:
  - categorical vs universal transfers
  - targeted transfer programs
  - universal basic income
  - means testing welfare
  - administrative cost transfers
  - stigma welfare programs
...
<div class="wiki-infobox-title">Categorical vs Universal Transfers — key facts</div>

<img src="/svg/fiscal.svg" alt="An abstract editorial mark for the topic." />

<div class="wiki-infobox-caption">Categorical programs target scarce resources; universal programs spread costs but avoid stigma.</div>

|   |   |
|---|---|
| **Categorical examples** | Social Security (elderly), disability insurance, SNAP (families with low income) |
| **Universal examples** | Child allowances (some countries), public education, child care subsidies (Denmark) |
...
1. They reach everyone, including the poorest who avoid categorical programs due to stigma
2. They create no work disincentives, so recipients maintain higher earning power
3. They cost less administratively per dollar delivered
...
- [Benefit Clawback Rate Explained](/benefit-clawback-rate-explained/) — How targeting creates phase-out rates that discourage work
- [Notch vs Taper in Benefit Design](/notch-vs-taper-benefit-design/) — Comparing sharp eligibility cliffs against graduated reductions
- [Earned Income Disregard in Welfare Programs](/earned-income-disregard-welfare/) — How exempting initial earnings reduces clawback effects
- [Means Testing](/means-testing/) — Income verification procedures in categorical programs
...
- [Fiscal Multiplier](/fiscal-multiplier/) — How transfer spending affects broader economy
...
- [Budget Deficit](/budget-deficit/) — Fiscal costs of transfer program choices
