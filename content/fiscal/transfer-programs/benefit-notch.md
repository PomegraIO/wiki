---
title: "Benefit Notch"
description: "A sharp discrete drop in total benefit value at a specific income threshold, creating disincentive to earn more money."
keywords:
  - benefit notch
  - income threshold
  - welfare trap
...
For the broader category of phase-out and welfare-trap design, see [transfer payment](/transfer-payment/).

</div>

<aside class="wiki-infobox">

<div class="wiki-infobox-title">Benefit Notch — key facts</div>

<img src="/svg/fiscal.svg" alt="An editorial mark representing welfare design and transfer programmes." />

<div class="wiki-infobox-caption">An avoidable design flaw that creates perverse work incentives at eligibility cutoffs.</div>

|   |   |
|---|---|
| **Core characteristic** | Discrete, sudden drop in benefits at income threshold |
| **Mechanism** | Usually sharp eligibility cutoff or rapid phase-out |
| **Example outcome** | Lose USD 300/month in food assistance if income exceeds USD 2,000 |
| **Economic consequence** | Negative effective tax rate (earn more, take home less) |
| **Policy target** | Usually low-income households, families with children |
| **Frequency** | Common in means-tested welfare; largely avoidable with better design |
...
- [Marginal tax rate](/tax-bracket-investor/) — rate of tax at the margin; notches create negative marginal rates for work
- [Inflation](/inflation/) — erodes thresholds set in nominal terms, potentially worsening notches over time
- [Recession](/recession/) — increases notch-relevant benefits and can expand populations affected
- [Unemployment rate](/unemployment-rate/) — labour-market condition that interacts with notch design in eligibility and take-up
