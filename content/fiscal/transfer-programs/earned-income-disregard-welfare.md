---
title: "Earned Income Disregard in Welfare Programs"
description: "Earned income disregard exempts part of earned income from benefit calculations to reduce work disincentives and welfare cliffs without eliminating the safety net."
keywords:
  - earned income disregard
  - welfare work incentive
  - benefit calculation income
  - welfare disregard policy
  - reduce work disincentive
  - clawback reduction
...
<div class="wiki-infobox-title">Earned Income Disregard — key facts</div>

<img src="/svg/fiscal.svg" alt="An abstract editorial mark for the topic." />

<div class="wiki-infobox-caption">Disregarding initial earnings softens the penalty for work without eliminating means-testing.</div>

|   |   |
|---|---|
| **Definition** | Amount of earned income excluded from benefit calculation; common: $100–$500/month |
| **Effect on clawback** | Reduces marginal tax rate only on earnings above the disregard threshold |
| **Work response** | Increases hours worked by 5–10% among low-wage workers, strongest for secondary earners |
| **Cost impact** | Modest program cost increase; more people remain eligible longer as they earn |
| **Common programs** | TANF, SNAP, supplemental security income (SSI), some disability benefits |
| **Timing** | Typically renewed monthly; disregard resets at month-end |
...
- [Benefit Clawback Rate Explained](/benefit-clawback-rate-explained/) — How benefit phase-outs create implicit marginal tax rates and work disincentives
- [Notch vs Taper in Benefit Design](/notch-vs-taper-benefit-design/) — Comparing sharp cutoffs against graduated reductions to reduce work disincentives
- [Categorical vs Universal Transfer Programs](/categorical-vs-universal-transfers/) — Why means-tested categorical programs require disregards to improve incentives
- [Welfare Cliff](/welfare-cliff/) — The sharp income threshold where benefits disappear abruptly
- [Earned Income Tax Credit](/earned-income-tax-credit/) — Tax credit that supplements work income for low-earners
...
- [Budget Deficit](/budget-deficit/) — Fiscal costs of welfare program expansions
