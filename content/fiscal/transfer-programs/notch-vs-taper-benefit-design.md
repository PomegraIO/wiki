---
title: "Notch vs Taper in Benefit Design"
description: "Notch vs taper in benefit design: sharp eligibility cliffs versus graduated phase-outs, and their divergent effects on work incentives, fiscal cost, and poverty traps."
keywords:
  - notch vs taper benefit design
  - eligibility cliff benefits
  - benefit phase-out taper
  - welfare cliff income limit
...
<div class="wiki-infobox-title">Notch vs Taper — key facts</div>

<img src="/svg/fiscal.svg" alt="An abstract editorial mark for the topic." />

<div class="wiki-infobox-caption">Notches create welfare cliffs; tapers smooth the transition but over wider income ranges.</div>

|   |   |
|---|---|
| **Notch definition** | All-or-nothing eligibility: benefit drops to zero when income exceeds threshold |
| **Taper definition** | Graduated phase-out: benefit declines incrementally as income rises |
| **Work incentive at threshold** | Notch creates zero return (earn $1 more, lose all benefit); taper preserves positive return |
| **Program cost** | Notches are cheaper (fewer eligible recipients); tapers cost more (broader eligibility band) |
| **Income range** | Notch: single boundary line; taper: 30–50% of poverty line or higher (wide band) |
| **Behavioral response** | Notch can suppress work near threshold; taper improves labor supply, especially secondary earners |
| **Common examples** | Notch: categorical public housing lists; taper: SNAP, EITC phase-outs |
...
- [Benefit Clawback Rate Explained](/benefit-clawback-rate-explained/) — How phase-out rates create implicit marginal tax rates and work disincentives
- [Earned Income Disregard in Welfare Programs](/earned-income-disregard-welfare/) — How exempting initial earnings softens the impact of notches or tapers
- [Categorical vs Universal Transfer Programs](/categorical-vs-universal-transfers/) — Why means-tested categorical programs require notches or tapers
- [Welfare Cliff](/welfare-cliff/) — The sharp income drop when benefits end abruptly
- Implicit Marginal Tax Rate — Combined effect of income tax, payroll tax, and benefit clawback
- Poverty Trap — How clawback rates prevent escape from low-income status
- Labor Supply Elasticity — How net wages affect work decisions

### Wider context

- Transfer Payments — Government redistribution mechanisms
- [Earned Income Tax Credit](/earned-income-tax-credit/) — Tax credit that supplements work income via a taper structure
- [Fiscal Multiplier](/fiscal-multiplier/) — How transfer spending stimulates economic activity
- [Budget Deficit](/budget-deficit/) — Fiscal costs of transfer program design choices
