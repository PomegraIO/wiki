---
title: "Deregulation Movement"
description: "Removal of government controls from industries beginning in the 1970s, reshaping financial and transportation sectors."
keywords:
  - deregulation
  - regulatory reform
...
<div class="wiki-hatnote">For the repeal of Glass-Steagall, a key deregulation milestone, see <a href="/wiki/glass-steagall-repeal/">Glass-Steagall Repeal</a>.</div>

<aside class="wiki-infobox">

| Period | Key events |
|---|---|
| **1970s** | Airlines (1978), trucking (1980), railroads, telecommunications begin liberalization |
| **1980s** | [Savings and loan crisis](/wiki/savings-and-loan-crisis/) emerges; finance sector deregulation accelerates |
| **1990s** | Telecom Act (1996); energy derivatives deregulation; [Glass-Steagall](/wiki/glass-steagall-act/) repeal (1999) |
| **2000s** | Subprime mortgage deregulation; credit derivatives expansion |
| **Driving force** | Academic consensus (Chicago School, public choice theory); political momentum from Reagan, Thatcher, Hawke |
| **Consequence** | Efficiency gains offset by new systemic risks; [2008 financial crisis](/wiki/lehman-brothers-collapse/) and later energy/commodity volatility |
...
By the late 1970s, this intellectual consensus had shifted the entire center of gravity. [Inflation](/wiki/inflation/) and [stagflation](/wiki/stagflation/) in the 1970s also delegitimized Keynesian management; deregulation and supply-side economics offered an alternative frame.
...
Finance followed a different path and became the flashpoint. The early moves were defensive: as inflation and rising [interest rates](/wiki/interest-rate/) made fixed-rate bank deposits unattractive, regulations enforcing low savings rates (Regulation Q) became unworkable. [Money market funds](/wiki/money-market-fund/) emerged as an unregulated alternative and drained deposits from banks. Banks lobbied for deregulation.

What followed was a cascading series of moves:

- **1980:** Depository Institutions Deregulation and Monetary Control Act allowed banks and [savings and loans](/wiki/savings-and-loan-crisis/) to offer higher rates and enter new businesses. It also raised [FDIC](/wiki/fdic-regulator/) insurance limits, inadvertently incentivizing risk-taking.
- **1986–1989:** Deregulation of S&Ls led to a moral hazard catastrophe. S&Ls, previously conservative home lenders, began chasing high-yield securities and risky real estate bets. When the [real estate market](/wiki/residential-real-estate/) collapsed, the S&L industry failed, requiring a $125 billion government rescue.
...
- **2000:** The [Commodity Futures Modernization Act](/wiki/commodity-futures-trading-commission/) deregulated [derivatives](/wiki/derivatives-exchange-crypto/), including the [credit default swap](/wiki/credit-default-swap/) market. This enabled massive growth in synthetic credit instruments.
...
- **Finance (initially):** Lower borrowing costs; wider menu of financial products; entrepreneurial innovation in [derivatives](/wiki/derivative-accounting-hedging/) and [asset management](/wiki/asset-allocation/).

But financial deregulation also set the stage for successive crises:

- **Savings and loan crisis (1989–1991):** Estimated cost to taxpayers, $125 billion. Deregulation-enabled gambling on real estate and corporate bonds; [deposit insurance](/wiki/federal-deposit-insurance-corporation/) removed market discipline.
- **Long-Term Capital Management collapse (1998):** A sophisticated hedge fund, leveraged 25:1 or more, nearly triggered a financial system cascade when [Russian default](/wiki/russian-default-1998/) shocks hit simultaneously. An emergency Fed rescue prevented systemic failure.
- **[Subprime mortgage crisis](/wiki/subprime-mortgage-crisis/) (2007–2009):** Deregulated mortgage origination standards, combined with lax [credit rating](/wiki/credit-rating/) practices and proliferation of [mortgage-backed securities](/wiki/mortgage-backed-security/), created a bubble. Collapse triggered the [Great Recession](/wiki/great-depression/).

Each crisis prompted new regulation (Gramm-Leach-Bliley created the [Federal Reserve supervision](/wiki/federal-reserve-supervision/); [Dodd-Frank](/wiki/dodd-frank-act/) followed 2008), but the deregulation-reregulation cycle became self-reinforcing.

## The ideology hardens: "light-touch" regulation

By the 2000s, deregulation ideology had hardened into orthodoxy. Central banks and regulators adopted "light-touch" frameworks: markets are self-correcting; competition disciplines fraud; [risk](/wiki/risk-on-risk-off/) is priced efficiently. The [Basel](/wiki/basel-capital/) capital accords assumed that sophisticated banks would model and manage their own [credit risk](/wiki/credit-risk/) and [market risk](/wiki/market-risk/). Mortgage lending was left to market discipline, even as [mortgage-backed securities](/wiki/mortgage-backed-security/) proliferated.

When the 2008 crisis hit, this presumption collapsed. Suddenly, government intervention—Fed lending facilities, TARP bailouts, quantitative easing—became not just acceptable but essential. The pendulum swung back toward [Dodd-Frank regulation](/wiki/dodd-frank-implementation/) and stronger [capital adequacy](/wiki/capital-adequacy/) rules.
...
The honest view is that deregulation's effects were heterogeneous. Industries with strong competitive dynamics (airlines, long-distance telecom) benefited; markets prone to [information asymmetries](/wiki/market-risk/) and herding (mortgages, derivatives) destabilized. A blanket return to pre-1970s regulation is neither feasible nor desirable, but neither is the light-touch faith of the 2000s.

<div class="wiki-seealso">

### Closely related
- [Glass-Steagall Repeal](/wiki/glass-steagall-repeal/)
- [Savings and Loan Crisis](/wiki/savings-and-loan-crisis/)
- [Subprime Mortgage Crisis](/wiki/subprime-mortgage-crisis/)
- [Dodd-Frank Act](/wiki/dodd-frank-act/)

### Wider context
- [Federal Reserve](/wiki/federal-reserve/)
- [Securities and Exchange Commission](/wiki/securities-and-exchange-commission/)
- [Credit Default Swap](/wiki/credit-default-swap/)
- [Mortgage Backed Security](/wiki/mortgage-backed-security/)
