---
title: "Investment Company Act of 1940 Enactment"
description: "The New Deal-era law that created the regulatory framework for mutual funds and other pooled investment vehicles, imposing governance, disclosure, and fee restrictions that define the industry today."
keywords:
...
*The **Investment Company Act of 1940** is the federal law that established comprehensive rules for [mutual funds](/wiki/mutual-fund/), closed-end funds, and other pooled investment vehicles, mandating governance structures, fee disclosure, portfolio diversification limits, and fiduciary duties that remain the backbone of the investment fund industry.*

<div class="wiki-hatnote">

For the law creating the SEC and regulating all public securities trading, see [Securities Exchange Act of 1934 Enactment](/wiki/securities-exchange-act-of-1934-enactment/).

</div>

<aside class="wiki-infobox">

<div class="wiki-infobox-title">Investment Company Act of 1940 — key facts</div>

<img src="/svg/history.svg" alt="An abstract mark denoting financial history and regulatory evolution." />

<div class="wiki-infobox-caption">The law that transformed investment pools from unregulated gambling dens into professional, transparent, fiduciary institutions.</div>

|   |   |
|---|---|
| **When enacted** | August 22, 1940 |
| **Why** | Investment company abuse and leverage abuse caused massive investor losses in the 1920s–1930s |
| **Scope** | Regulates the structure, governance, and fees of mutual funds, closed-end funds, and similar pooled vehicles |
| **Key requirement** | Investment companies must register with the SEC and disclose their holdings and fees in a prospectus |
| **Fee caps** | Unreasonable compensation is prohibited; expense ratios are disclosed |
| **Board governance** | Independent directors must approve fund strategies, fees, and related transactions |
| **Diversification rule** | Diversified funds cannot concentrate more than 5% of assets in any single security |
...
By 1940, the public and Congress wanted answers. Unlike the [Securities Act of 1933](/wiki/securities-act-of-1933-enactment/) (focused on IPOs) and the [Securities Exchange Act of 1934](/wiki/securities-exchange-act-of-1934-enactment/) (focused on trading and ongoing disclosure), there was no comprehensive law governing the internal governance and fee structures of funds themselves. The 1940 Act filled that gap.
...
The 1940 Act was written to accommodate both closed-end funds (traded on an exchange, with a fixed number of shares) and open-end mutual funds (which issue and redeem shares on demand at [net asset value](/wiki/net-asset-value/)). It was the open-end structure that would dominate the American investment landscape.
...
Later, the Act was extended to cover [business development companies](/wiki/business-development-company/) (BDCs), which are essentially closed-end funds that invest in small companies and private loans. BDCs face similar diversification and leverage restrictions as other investment companies, though with some tailored flexibility for their illiquid holdings.
...
- [Mutual fund](/wiki/mutual-fund/) — the pooled investment vehicle governed by the 1940 Act
- [Net asset value](/wiki/net-asset-value/) — the daily share price of a mutual fund, computed under 1940 Act rules
- [Expense ratio](/wiki/expense-ratio/) — the annual cost of owning a fund, disclosed per the 1940 Act
- [Exchange-traded fund](/wiki/etf/) — a fund structure operating under the 1940 Act framework
- [Closed-end fund](/wiki/closed-end-fund/) — a fund with fixed shares, regulated under the 1940 Act
- [Fiduciary duty](/wiki/fiduciary-duty/) — the legal obligation to act in the beneficiary's interest

### Wider context

- [Securities Act of 1933 Enactment](/wiki/securities-act-of-1933-enactment/) — the law requiring disclosure at initial stock offerings
- [Securities Exchange Act of 1934 Enactment](/wiki/securities-exchange-act-of-1934-enactment/) — the law establishing the SEC and continuous public-company disclosure
- [Dodd-Frank Act](/wiki/dodd-frank-act/) — the 2010 law extending regulation to investment advisers and alternative funds
- [Hedge fund](/wiki/hedge-fund/) — a pooled fund operating outside 1940 Act protections
