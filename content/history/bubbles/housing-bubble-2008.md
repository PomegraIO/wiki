---
title: "Housing Bubble of 2008"
description: "The surge in US home prices and subsequent crash that triggered the 2008 financial crisis, driven by loose credit, subprime lending, and securitization."
keywords:
  - housing crash
  - subprime mortgages
  - financial crisis
...
*The **housing bubble of 2008** was a dramatic rise in US residential real estate prices followed by a collapse, precipitating the worst financial crisis since the Great Depression. Subprime lending, [securitization](/wiki/securitization/), and [leverage](/wiki/leverage-ratio-forex/) amplified losses across the financial system.*

<aside class="wiki-infobox">

| Metric | Peak/Trough |
|--------|-------------|
| US home prices (nominal) | Peaked Q2 2006; fell 33% by 2012 |
| Median home price | \$225k (2006) → \$155k (2012) |
| Subprime originations | \$650B (2006) of total \$1.2T mortgage issuance |
| Mortgage-backed security issuance | \$827B (2006, peak year) |
| Foreclosures | 2.8 million in 2010 (peak annual) |
| [VIX](/wiki/fear-index/) peak (2008) | 80+ (extreme fear) |
| Home equity extraction | \$500B+ annually (2005–2006) |
...
Recovery was slow. Housing prices recovered to 2006 nominal levels by 2013 (inflation-adjusted recovery took longer). Banks rebuilt capital through earnings and rights offerings. By 2010, the banking system was stabilizing, though unemployment remained elevated. The Fed kept [interest rates](/wiki/interest-rate/) near zero through 2015, supporting recovery. [Quantitative easing](/wiki/quantitative-easing/) (purchasing long-term Treasuries and MBS) further supported financial conditions.

## Systemic reforms and lessons

The [Dodd-Frank Act](/wiki/dodd-frank-act/) (2010) was enacted to prevent recurrence. It required [mortgage originators](/wiki/loan-origination-fees/) to retain skin in the game (maintaining risk on a portion of mortgages). It created the [Consumer Financial Protection Bureau](/wiki/consumer-financial-protection-bureau/) to regulate lending practices. It imposed [capital requirements](/wiki/capital-adequacy/) and [leverage limits](/wiki/leverage-ratio-forex/) on banks. It required central clearing of derivatives and pushed standardized swaps to exchanges.

The reforms were comprehensive but debated. Some argue they did not go far enough; others argue they constrained credit and slowed recovery. A decade later, similar underwriting laxity re-emerged in areas (corporate debt, auto loans), suggesting that competitive pressures and short-term incentives remain powerful. The crisis revealed that complexity (CDOs, synthetic [derivatives](/wiki/derivatives-exchange-crypto/)) obscured risk, that rating agencies had conflicts of interest (paid by issuers), and that leverage anywhere in the system amplifies risk everywhere.
...
### Closely related
- [Mortgage-Backed Security](/wiki/mortgage-backed-security/) — Securitized mortgages
- [Collateralized Debt Obligation](/wiki/collateralized-debt-obligation/) — Complex structured credit
- [Subprime Mortgage Crisis](/wiki/subprime-mortgage-crisis/) — Detailed crisis mechanics
- [Lehman Brothers Bankruptcy](/wiki/lehman-brothers-bankruptcy/) — Focal failure event

### Wider context
- [Dodd-Frank Act](/wiki/dodd-frank-act/) — Regulatory response
- [Quantitative Easing](/wiki/quantitative-easing/) — Fed crisis response
- [Financial Crisis](/wiki/asset-backed-security/) — Broader systemic failure
- [Leveraged Finance](/wiki/leverage-ratio-forex/) — Leverage and risk amplification
