---
title: "Currency Peg Collapse Mechanism"
description: "Why currency pegs collapse: reserve depletion, interest-rate pain, and speculative attacks force governments to abandon fixed exchange rates."
keywords:
  - currency peg collapse
  - why pegs break
  - speculative attack currency
  - reserve depletion mechanism
  - fixed exchange rate crisis
...
<div class="wiki-infobox-title">Peg Collapse — key factors</div>

<img src="/svg/history.svg" alt="An abstract editorial mark for the topic." />

<div class="wiki-infobox-caption">A fixed exchange rate requires constant defense once confidence erodes.</div>
...
1. A speculator borrows 1 billion baht at 5% interest.
2. The speculator sells the baht for dollars at the official peg rate (e.g., 25 baht/dollar).
3. The speculator waits for the inevitable devaluation.
...
- [Contagion Effect in Financial Crises](/contagion-effect-financial-crises/) — How peg collapse spreads regionally
- [Capital Flows](/capital-flows/) — Outflows that trigger peg defense and eventual collapse
- [Central Bank](/central-bank/) — Institution that defends and ultimately abandons the peg
- [Interest Rate](/interest-rate/) — Tool used to defend, and weapon that accelerates collapse
- [Sovereign Debt Restructuring Process](/sovereign-debt-restructuring-process/) — Often follows peg collapse and devaluation
- [IMF Bailout Conditions Explained](/imd-bailout-conditions-explained/) — Emergency lending during peg collapse

### Wider context

- [Recession](/recession/) — Often triggered by peg-defense austerity or post-devaluation shock
- [Fiscal Consolidation](/fiscal-consolidation/) — Discipline required to sustain a peg long-term
- [Credit Risk](/credit-risk/) — Rises sharply when peg collapse is anticipated
- [Inflation](/inflation/) — Spikes after devaluation
- [Commodity](/crude-oil/) — Price shocks often trigger peg collapses in commodity exporters
