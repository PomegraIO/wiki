---
title: "Dot-Com Crash: Anatomy of a Burst Bubble"
description: "The collapse of internet company valuations from 1999 to 2002, driven by speculative funding, valuation extremes, and the reversion of narratives about the 'New Economy'."
keywords:
  - dot-com bubble
...
<div class="wiki-infobox-title">Dot-Com Crash — key facts</div>

<img src="/svg/history.svg" alt="An abstract editorial mark for a financial event." />

<div class="wiki-infobox-caption">When growth without profits stops being a virtue.</div>

|   |   |
|---|---|
| **Timeline** | March 2000 to October 2002 |
| **Peak index** | NASDAQ rose 585% from 1995–2000 |
...
The [price-to-earnings](/price-to-earnings-ratio/) multiple compression was vicious. A stock valued at 100x earnings in 1999 fell not just because prices dropped but because earnings disappeared—either the company failed or it finally stabilized at losses rather than growth. The true decline in value was often 95–99%, not the nominal 70–80% of the index.
...
The crash redefined how valuations are discussed. The term "irrational exuberance" (coined by Alan Greenspan in 1996) became a shorthand for the entire episode. Analysts became more sceptical of "New Economy" stories, at least for a time. Traditional valuation metrics—[price-to-earnings](/price-to-earnings-ratio/), [price-to-book](/price-to-book-ratio/), [return on equity](/return-on-equity/)—reasserted themselves as the baseline. Venture capital became more disciplined about unit economics and path to profitability.
...
- [Irrational exuberance](/market-timing/) — how collective narratives drive prices far from fundamentals
- [Price-to-earnings ratio](/price-to-earnings-ratio/) — why old valuation metrics matter even for new companies
- [Venture capital](/private-equity-fund/) — the funding structure that amplified the bubble
- [Market capitalization](/market-capitalization/) — the measure of value that collapsed
- [Initial public offering](/initial-public-offering/) — how startups went public at the peak

### Wider context

- [Swiss Franc Shock of 2015](/swiss-franc-shock-2015/) — another consensus unravelling
- [Eurozone Interbank Freeze of 2011](/eurozone-interbank-freeze-2011/) — a different mechanism, same system stress
- [Bull market](/bull-market/) — what preceded the crash
- [Bear market](/bear-market/) — the multi-year aftermath
- [Concentration risk](/concentration-risk/) — why sector crashes hit hard
