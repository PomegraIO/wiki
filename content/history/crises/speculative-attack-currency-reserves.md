---
title: "Speculative Attack on Currency Reserves"
description: "How traders exploit weak currency pegs by shorting the currency until central-bank reserves dwindle and the peg breaks."
keywords:
...
- [Currency risk](/currency-risk/) — how exchange-rate swings affect international investors and firms
- [Interest rate](/interest-rate/) — why central banks raise rates in defense of a currency peg
- [Central bank](/central-bank/) — how central banks intervene in foreign-exchange markets
- [Carry trade](/carry-trade/) — exploiting interest-rate differentials, which can fuel speculative attacks
- [Capital flows](/capital-flows/) — how money moves between countries and destabilizes fixed rates

### Wider context

- [Recession](/recession/) — often the economic consequence of a currency crisis
- [Debt restructuring](/debt-restructuring/) — what happens when a crisis forces a country to default
- [Foreign exchange](/spot-exchange-rate/) — the mechanics of currency trading
- [Gold standard](/gold-standard/) — historical currency peg backed by bullion
- [Sovereign default](/sovereign-default/) — currency crises often precede sovereign debt defaults
