---
title: "Argentina Currency Crisis (2001)"
description: "Peso devaluation and bank freezes during economic collapse from currency-board overvaluation."
keywords:
...
*The **2001 Argentina crisis** was a sovereign-debt and currency catastrophe driven by a rigid [currency board](/wiki/currency-board/) peg that overvalued the peso, depleted foreign reserves, and ultimately collapsed. The crisis cascaded into [capital flight](/wiki/capital-flight-sovereign/), bank runs, [default](/wiki/sovereign-default/) on $95 billion in [external debt](/wiki/external-debt/), devaluation, and social unrest that toppled multiple governments in months.*
...
| Event | Date / Value |
|---|---|
| Currency board established | March 1991 |
| Peak reserves | ~$28 billion (1999) |
| Reserves at crisis start | ~$10 billion (Dec 2001) |
| Default announced | December 23, 2001 |
| Exchange rate at peg | 1 peso = 1 USD |
| Exchange rate post-devaluation | 3.5 pesos = 1 USD (Jan 2002) |
| GDP contraction | -10.9% (2002) |
| Bank account freeze duration | 16 months (corralito) |

</aside>

## The currency board mechanism and initial success

Argentina adopted a [currency board](/wiki/currency-board/) in March 1991 under Economy Minister Domingo Cavallo. The board pegged the peso to the US dollar at 1:1 and required that the central bank hold 100% of peso monetary base in US dollar reserves. The peg was legally binding and non-negotiable, removing the government's ability to [devalue](/wiki/real-exchange-rate/).
...
The peg worked as long as Argentina's [current account](/wiki/current-account-deficit/) remained manageable. But structural problems lurked. Argentina's economy had high wage levels (remnants of Peron-era labor power and manufacturing heritage). Manufacturing faced competition from low-wage Asian rivals. The fixed exchange rate made Argentine exports progressively more expensive in foreign-currency terms, while imports became cheaper.

## The reserve depletion and twin deficits

By the late 1990s, Argentina faced a [current-account deficit](/wiki/current-account-deficit/) as export volumes fell while import demand remained high. Additionally, the government ran large [fiscal deficits](/wiki/budget-deficit/)—spending exceeded revenue. The twin deficits (external and fiscal) required foreign borrowing to finance.

The central bank's dollar reserves began declining steadily. From ~$28 billion in 1999 to ~$18 billion by late 2000 to ~$10 billion by end of 2001. As reserves fell, the [money supply](/wiki/monetary-base/) contracted (because the currency board required a 1:1 backing). Contraction fed into [deflation](/wiki/deflation/) and recession: GDP growth turned negative in 1999. Unemployment climbed toward 20%.

The government attempted fiscal austerity (cutting spending, raising taxes) to signal commitment to the peg and restore confidence. But austerity deepened the recession. Tax revenues fell because of lower economic activity. The fiscal deficit widened despite spending cuts—a [procyclical](/wiki/fiscal-policy-contractionary/) policy trap that worsened the crisis.

## Capital flight and the bank run

As recession deepened and default risk rose, [capital flight](/wiki/capital-flight-sovereign/) accelerated. Wealthy Argentines moved assets abroad; foreign creditors refused to roll over maturing debt; international banks cut credit lines. The central bank burned through reserves attempting to defend the peg and supply foreign currency to the banking system.

Bank deposits began fleeing: residents withdrew cash and moved savings to foreign banks (via illegal transfers or physical smuggling). The banking system faced a classic [bank run](/wiki/banking-crisis-of-1933/). The government responded with a bank freeze, announced December 1, 2001. Argentines were barred from withdrawing more than 250 pesos per week from bank accounts. The government called this the *corralito* ("the little fence"—an apt metaphor).
...
The crisis rippled across South America. Brazil faced speculation on currency devaluation. Uruguay, heavily dependent on Argentine trade, faced banking crisis contagion. The region's belief in [dollarization](/wiki/dollarization/) and fixed pegs was shattered. Later, economists cited Argentina as evidence that hard pegs are prone to catastrophic failure in economies with structural imbalances.

The crisis also tarnished the [Washington Consensus](/wiki/trade-war/)—the policy framework of liberalization, privatization, and [capital account convertibility](/wiki/capital-control-policy/) that the IMF and World Bank had championed. Argentina had followed the consensus playbook; it had privatized utilities, liberalized trade, opened capital account, and pegged to a strong currency. Yet the economy collapsed anyway. Critics argued the Washington Consensus was flawed and had been imposed on emerging markets without attention to local conditions.
...
2. **Currency boards surrender monetary policy flexibility.** The central bank cannot expand money supply during a recession; it cannot lower [interest rates](/wiki/interest-rate/) below what the reserve backing allows. Domestic conditions don't matter; the peg is supreme.
...
The crisis influenced policy globally. Central banks in other emerging markets reduced their reliance on fixed pegs or currency boards. Chile, which had faced a crisis in the 1980s, implemented [inflation targeting](/wiki/inflation-targeting/) instead of a peg; it weathered the 2000s more smoothly. Brazil, after its 1999 currency crisis, similarly adopted flexible [exchange rates](/wiki/floating-exchange-rate/) and inflation targets.

<div class="wiki-seealso">

### Closely related
- [Sovereign Default](/wiki/sovereign-default/) — The debt event
- [Currency Board](/wiki/currency-board/) — The peg mechanism that broke
- [Capital Flight Sovereign](/wiki/capital-flight-sovereign/) — Reserve depletion preceding default
- [Currency Devaluation](/wiki/real-exchange-rate/) — The exchange-rate collapse

### Wider context
- [External Debt](/wiki/external-debt/) — The obligation on which Argentina defaulted
- [Austerity](/wiki/austerity/) — The fiscal policy that deepened crisis
- [Bank Runs](/wiki/banking-crisis-of-1933/) — The corralito and deposit flight
- [Latin American Debt Crisis](/wiki/latin-american-debt-crisis/) — Historical precedent
