---
title: "Swiss Franc Shock of 2015"
description: "The Swiss National Bank's surprise abandonment of its euro ceiling in January 2015, triggering massive losses for FX traders and currency brokers."
keywords:
  - swiss national bank
  - currency peg
  - fx trading
...
<div class="wiki-infobox-title">Swiss Franc Shock — key facts</div>

<img src="/svg/history.svg" alt="An abstract editorial mark for a financial event." />

<div class="wiki-infobox-caption">A central bank surprise that redefined tail-risk hedging in forex.</div>

|   |   |
|---|---|
| **Date** | 15 January 2015 |
| **Event** | SNB removed 1.20 EUR/CHF ceiling unannounced |
| **Immediate impact** | Franc jumped ~30% in hours |
| **Primary losers** | Leveraged FX traders, retail brokers (FXCM, Alpari) |
| **Catalyst** | ECB's quantitative easing announcement the day prior |
| **Historical significance** | Largest single-day currency move in modern era |
...
The damage swept across retail brokers. FXCM, a major retail FX platform, announced it could not cover customer losses and was forced to sell its retail business to smaller rival Gain Capital (later sold again). Alpari, another significant player, declared bankruptcy. For the first time in modern retail trading, customers realized that their broker's guarantee of [no negative account balance](over-the-counter-market/) was not always honoured—the peg's collapse had exposed counterparty risk.
...
- [Currency risk](/currency-risk/) — how exchange-rate moves create losses for traders and corporates
- [Leverage](/leverage-ratio-forex/) — the amplification mechanism that turns price moves into losses
- [Over-the-counter market](/over-the-counter-market/) — where FX trades happen and margin calls cascade
- [Central bank](/central-bank/) — how policy shifts ripple through markets
- [Forward guidance](/forward-guidance/) — the communication tool central banks use to manage expectations

### Wider context

- [Dot-Com Crash: Anatomy of a Burst Bubble](/dot-com-crash-anatomy/) — another surprise unwind of consensus beliefs
- [Thai Baht Crisis of 1997](/1997-thai-baht-crisis/) — a peg collapse that triggered broader contagion
- [Eurozone Interbank Freeze of 2011](/eurozone-interbank-freeze-2011/) — another moment when central banks had to intervene
- [Tail risk](/tail-risk/) — the events outside normal models that cause outsized losses
- [Volatility smile](/volatility-smile/) — why option traders price in extreme moves
