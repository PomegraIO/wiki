---
title: "Venezuelan Hyperinflation Crisis"
description: "How oil dependence, price controls, and currency mismanagement produced hyperinflation exceeding one million percent by 2018."
keywords:
  - hyperinflation
  - price controls
  - currency crisis
...
The government's response was to print money to cover the [budget deficit](/budget-deficit/), to subsidize imports of goods it could no longer produce, and to maintain employment in the bloated public sector. This money supply growth, combined with shrinking output and persistent price controls, created the preconditions for [hyperinflation](/inflation/).
...
The underlying mechanics followed the standard hyperinflation script: the government runs a massive fiscal deficit; the central bank finances it by creating money; money supply growth far outpaces output growth; [inflation](/inflation/) expectations become unanchored; the [currency](/us-dollar/) depreciates rapidly; imports become costly; supply contracts further; and [inflation](/inflation/) spirals. Each stage feeds the next.
...
The crisis also demonstrates the speed of [hyperinflation](/inflation/). In 1990, Venezuela was the richest country in Latin America by per-capita income. By 2020, it had the lowest real wages on the continent, and millions were malnourished. The deterioration took place over a mere eight years.

Finally, the crisis shows the limits of price controls in stabilising an economy. Price controls do not prevent [inflation](/inflation/); they prevent markets from clearing, creating shortages, waste, and corruption. The government's use of controls to mask the true extent of fiscal insolvency only delayed adjustment and deepened the eventual collapse.
...
- [Money supply](/m1/) — the mechanism of [inflation](/inflation/) acceleration

### Wider context

- [Oil price crash 2014](/oil-price-crash-2014/) — the commodity shock that triggered crisis
- [Petro-state dependence](/capital-flows/) — structural vulnerability to commodity shocks
- [Monetary policy](/monetary-policy/) — unmoored from fiscal discipline
- [Sovereign default](/sovereign-default/) — the nation's external debt distress
- Capital controls — the [currency](/us-dollar/) restrictions imposed
- Emerging markets — vulnerability to commodity and currency crises
