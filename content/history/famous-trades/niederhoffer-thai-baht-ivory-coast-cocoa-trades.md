---
title: "Victor Niederhoffer's Cocoa and Currency Trades Before His 1997 Collapse"
description: "How Niederhoffer cocoa and currency trades concentrated risk before the 1997 Asian crisis, amplifying losses beyond the Thai baht alone."
keywords:
  - niederhoffer cocoa currency trades
  - niederhoffer 1997 collapse
  - thai baht crisis losses
  - commodity trading blowup
  - concentrated position risk
  - hedge fund failure history
...
<div class="wiki-infobox-title">Niederhoffer's Commodity & Currency Bets — Risk concentration</div>

<img src="/svg/history.svg" alt="An abstract editorial mark for financial history." />

<div class="wiki-infobox-caption">Concentrated long positions in cocoa and Thai baht converged to generate losses that exceeded expectations for any single market.</div>

|   |   |
|---|---|
| **Primary exposures** | Thai baht, Ivorian cocoa, coconut, Brazilian real |
| **Type of risk** | [Concentration risk](/concentration-risk/) across correlated assets |
| **Trigger** | 1997 Asian currency crisis and flight to safety |
| **Amplification factor** | [Leveraged positions](/leverage-ratio-forex/) and [margin calls](/margin-call-forex/) |
| **Estimated loss** | $300+ million over a few months |
| **Key lesson** | Diversification across [market cycles](/market-cycle/) prevents single shocks from erasing capital |
...
But Niederhoffer's positions were not modest bets spread across a portfolio. They were concentrated wagers that dominated his fund's [return-on-equity](/return-on-equity/) and drawdown metrics. The cocoa position alone represented one of his largest single exposures, and he had also taken significant positions in coconut futures—an even more illiquid market, amplifying [execution risk](/execution-risk/).
...
What made Niederhoffer's losses catastrophic rather than merely painful was his use of leverage. His fund was [leveraged](/leverage-ratio-forex/) to amplify returns in normal markets. In a sustained shock, leverage becomes a liability. As positions moved against him, brokers issued [margin calls](/margin-call-forex/). To raise cash, Niederhoffer was forced to sell even positions he believed were fundamentally sound—including more cocoa and baht holdings.

This created a vicious cycle. Liquidation of his large positions pushed prices further against him. Other leveraged traders, facing similar margin pressure, were selling the same assets, deepening the price declines. [Liquidity risk](/liquidity-risk/) and [counterparty risk](/counterparty-risk/) amplified the direct loss from the baht and cocoa positions themselves.
...
True [diversification](/diversification/) would have included holdings that rally during stress—safe-haven bonds, for example, or short positions in risky assets that would have offset losses when risk-on collapsed. Niederhoffer's portfolio lacked that offsetting hedge. His fund held nearly all long, leveraged positions in markets that moved together.
...
- [Concentration risk](/concentration-risk/) — Why betting too much on any single market or asset class creates compounding losses
- [Market cycle](/market-cycle/) — How risk-on and risk-off regimes shift simultaneously across correlated assets
- [Leverage ratio (forex)](/leverage-ratio-forex/) — How borrowed capital magnifies both gains and losses
- [Margin call (forex)](/margin-call-forex/) — When brokers demand cash and force liquidations at the worst time
- [Liquidity risk](/liquidity-risk/) — Why exotic assets like coconut futures blow up faster than liquid ones

### Wider context

- [Carry trade](/carry-trade/) — The strategy of borrowing cheap currency to invest in risky assets; dominant in emerging markets before 1997
- Thai baht crisis of 1997 — The broader context and contagion
- [Hedge fund](/hedge-fund/) — How leverage and [counterparty risk](/counterparty-risk/) nearly destroyed the global financial system
- [Value investing](/value-investing/) — A contrarian discipline that emphasizes margin of safety and limited leverage
