...
For the broader history of the 1987 crash and its causes, see [Black Monday 1987](/black-monday-1987/); this entry focuses on Jones's trading decision and positioning.

</div>

<aside class="wiki-infobox">

<div class="wiki-infobox-title">Paul Tudor Jones — The Crash Predictor</div>

<img src="/svg/history.svg" alt="An abstract editorial mark for financial history." />

<div class="wiki-infobox-caption">The trader who predicted the 1987 crash and profited massively while others lost fortunes.</div>

|   |   |
|---|---|
| **Trader** | Paul Tudor Jones II |
| **Fund** | Tudor Investment Fund |
| **Founded** | 1983 |
| **October 1987 return** | +200% (tripled fund capital) |
| **Market return** | −22% |
| **Fund AUM post-crash** | ~$900 million (from ~$300 million) |
| **Position type** | [Short selling](/short-selling/), put options, index futures |
...
By the summer of 1987, the US stock market had already run up dramatically. The [S&P 500](/sp-500-index/) had gained over 40% in the two years since August 1985. Valuations were stretched. [Price-to-earnings ratios](/price-to-earnings-ratio/) were elevated by historical standards. The [Federal Reserve](/federal-reserve/), worried about inflation, had begun raising interest rates, creating headwinds for equities. Meanwhile, programme trading—the use of computer algorithms to execute large basket trades based on price movements—had become widespread, creating the potential for self-reinforcing cascades of selling if prices began to fall.
...
In the summer of 1987, Jones began positioning his fund. Rather than simply reducing equity exposure (which would have been conservative but unexciting), he became explicitly and heavily short. He shorted [equities](/stock/) outright—taking short positions in stocks he believed were most vulnerable. He bought [put options](/put-option/) on stock indices, paying a premium for the right to sell at predetermined strike prices if the market fell. He took short positions in [index futures](/futures-contract/) on the S&P 500 and other indices.
...
- [Short selling](/short-selling/) — the strategy Jones deployed
- [Put option](/put-option/) — the derivative instrument he bought for protection and profit
- [Index futures](/futures-contract/) — the leveraged bets he used to amplify exposure
- Market crash — the event his positioning captured
- [Black Monday 1987](/black-monday-1987/) — the broader context of the crash
- [Circuit breaker](/circuit-breaker/) — the regulatory reform that followed

### Wider context

- [Hedge fund](/hedge-fund/) — the vehicle Jones used to implement his strategy
- [Price-to-earnings ratio](/price-to-earnings-ratio/) — the valuation metric that signalled danger
- [Algorithmic trading](/algorithmic-trading/) — the mechanism that amplified the sell-off
