---
title: "Piero Sraffa and the Critique of Neoclassical Capital Theory"
description: "How Sraffa's Production of Commodities challenged marginal productivity theory and reignited the Cambridge Capital Controversy."
keywords:
  - piero sraffa
  - critique neoclassical
  - capital theory
...
<div class="wiki-infobox-title">Piero Sraffa — key facts</div>

<img src="/svg/people.svg" alt="An abstract editorial mark for people." />

<div class="wiki-infobox-caption">Sraffa proved that switching techniques and capital reversals were possible, shattering the neat capital-output relationships that underpinned neoclassical growth models.</div>

|   |   |
|---|---|
| **Key work** | *Production of Commodities by Means of Commodities* (1960) |
| **Main target** | Marginal productivity theory and neoclassical aggregation of capital |
| **Central argument** | Profits and wages cannot be derived from smooth marginal relationships; reswitching is possible |
| **Impact** | Reopened debate on how capital is measured and how returns are distributed |
| **Legacy** | Post-Keynesian and Marxist economists embraced his framework; mainstream largely moved past the debate |
| **Modern relevance** | Arguments resurface when capital aggregation, growth measurement, or distribution inequality are discussed |
...
- [Value investing](/value-investing/) — philosophy of buying underpriced assets based on fundamental worth
- [Return on equity](/return-on-equity/) — profit earned per dollar of shareholder capital
- [Cost of equity](/cost-of-equity/) — return required to compensate capital providers for risk
- [Economic growth](/gross-domestic-product/) — sustained increase in productive capacity and output
- [Income distribution](/unemployment-rate/) — division of national income among factors and groups
