...
keywords:
  ...
  - self-governance shared resources
...
<div class="wiki-infobox-title">Elinor Ostrom — key facts</div>

<img src="/svg/people.svg" alt="An abstract editorial mark for people." />

<div class="wiki-infobox-caption">Ostrom's field research and institutional analysis overturned the tragedy-of-the-commons assumption and won the Nobel Prize.</div>

|   |   |
|---|---|
| **Birth/death** | 1933–2012; American political economist |
| **Core question** | How do communities manage shared resources without government or markets? |
| **Main finding** | Tragedy is not inevitable; self-governance succeeds through design principles |
| **Key work** | *Governing the Commons* (1990); dozens of case studies across continents |
| **Recognition** | Nobel Prize in Economic Sciences, 2009 |
| **Legacy** | Spawned institutional analysis of commons; challenged assumption of state or market necessity |
...
- [Business Development Company](/business-development-company/) — a cooperative-like financial institution
- [Systemic Risk](/systemic-risk/) — modern commons dilemma in finance
- [Default Rate](/default-rate/) — one measure of commons failure in credit markets
- [Market-Maker Trading](/market-maker-trading/) — self-regulated professional commons
- [Securities and Exchange Commission](/securities-and-exchange-commission/) — institutional response to commons problems

### Wider context

- [Great Depression](/great-depression/) — historical commons failure and policy response
- [Fiscal Multiplier](/fiscal-multiplier/) — related question of how institutions affect economic outcomes
- [Business Cycle](/business-cycle/) — aggregate institutional failure
- [Centralized market](/currency-volatility/) — alternative to commons governance
