...
keywords:
  ...
  - renaissance medallion fund strategy
...
<div class="wiki-infobox-title">Renaissance vs Two Sigma — key facts</div>

<img src="/svg/people.svg" alt="An abstract editorial mark for the topic." />

<div class="wiki-infobox-caption">Two competing visions of systematic investing have reshaped global finance.</div>

|   |   |
|---|---|
| **Founded** | Renaissance: 1982; Two Sigma: 2001 |
| **Flagship fund** | Medallion (Renaissance); Absolute Return funds (Two Sigma) |
| **Typical holding period** | Renaissance: days–weeks; Two Sigma: hours–months |
| **Data sources** | Renaissance: price/volume; Two Sigma: satellite, credit, alternative |
| **Team model** | Renaissance: mathematicians/physicists; Two Sigma: engineers/ML specialists |
| **Management style** | Renaissance: secretive, insular; Two Sigma: collaborative, publishing culture |
...
- [Algorithmic trading](/algorithmic-trading/) — Automated trading strategies that both firms employ
- [Alpha](/alpha/) — The excess return that quant funds target
- [Hedge fund](/hedge-fund/) — Institutional structure of both Renaissance and Two Sigma
- [Factor investing](/factor-investing/) — Systematic strategies around market factors
- [Momentum investing](/momentum-investing/) — One sleeve of strategies employed by quant funds

### Wider context

- [Beta](/beta/) — Market risk; quant funds harvest alpha relative to beta
- [Sharpe ratio](/sharpe-ratio/) — Risk-adjusted return metric both funds optimize
- [Market efficiency](/price-discovery/) — The debate underlying whether systematic edge exists
- [Time value](/time-value/) — Central to short-holding-period strategies
- [Volatility smile](/volatility-smile/) — A pricing anomaly quant funds often exploit
