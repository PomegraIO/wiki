...
- [Hedge Fund](/hedge-fund/) — the broader category of private investment partnerships that charge performance fees
- [Alpha](/alpha/) — the excess return a strategy generates, which Medallion has historically delivered in abundance
- [Algorithmic Trading](/algorithmic-trading/) — the automated, model-driven approach that powers Renaissance's methods
- [Factor Investing](/factor-investing/) — systematic strategies based on statistical patterns, similar to Renaissance's foundation

### Wider context

- [Investment Grade Bond](/investment-grade-bond/) — the type of securities many institutions hold instead of hedge fund allocations
- [Hedge Fund](/hedge-fund/) — the industry structure and fee norms that shape capital deployment
- [Performance Fee](/performance-fee/) — how carry and profit-sharing align manager and investor interests
