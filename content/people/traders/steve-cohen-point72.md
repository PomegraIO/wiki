---
title: "Steve Cohen (Point72)"
description: "Proprietary and quantitative trader; founder of Point72 Asset Management; pioneer of systematic trading and talent recruitment."
keywords:
  - hedge-fund-founder
...
*[Steven A. Cohen](/wiki/steve-cohen-point72/) is a prominent proprietary trader and hedge fund manager who built **SAC Capital Advisors** (1992–2013) into one of the world's largest [hedge funds](/wiki/hedge-fund/), then founded [**Point72 Asset Management**](/wiki/steve-cohen-point72/) (2014–present). Known for extreme market knowledge, aggressive proprietary trading, and systematic recruitment of elite traders and developers.*

<aside class="wiki-infobox">

| Item | Detail |
|------|--------|
| **Founded SAC Capital** | 1992 |
| **Peak AUM (SAC)** | ~$15 billion (2013) |
| **SEC settlement** | 2013 ($1.2 billion); agreed to wind down |
| **Point72 launch** | 2014 |
| **Current AUM (Point72)** | ~$20+ billion |
| **Strategy focus** | Multi-strategy, quantitative, systematic |
| **Notable trait** | Technology investment, data science hiring |

</aside>

## Early career and proprietary trading roots

Cohen began trading for himself in 1986, making markets in stocks and later specializing in [arbitrage](/wiki/statistical-arbitrage/) and [merger arbs](/wiki/merger-arbitrage/). His edge was information flow and speed: he obsessively monitored order flow, research reports, and news. In the pre-electronic era, traders who could synthesize data faster than competitors won. Cohen built a reputation for razor-sharp trade timing and accumulation of small, consistent profits — not grand bets on big macro calls, but relentless daily trading across hundreds of securities.
...
1. **Information edge.** Proprietary data, research, and rapid analysis beat sentiment.
2. **Diversification of bets.** No single position or strategy carries the portfolio. Hundreds of small, correlated bets reduce [idiosyncratic risk](/wiki/idiosyncratic-risk/).
3. **Technology as differentiator.** In quantitative trading, better algorithms, faster infrastructure, and smarter data pipelines matter more than discretionary judgment.
4. **Talent over size.** Cohen values having the best traders and technologists, not the largest AUM.
...
In the post-Point72 era, Cohen also became an **activist investor** through his personal wealth. He took significant stakes in underperforming companies and pushed for operational improvements or board seats. His activism has been lower-key than some peers (e.g., [Bill Ackman](/wiki/bill-ackman/) or [Dan Loeb](/wiki/dan-loeb/)), but strategic and forceful.
...
- **vs. Paul Tudor Jones:** PTJ is macro-focused, specializing in indices and commodities; Cohen focuses on individual securities and [spreads](/wiki/spread-position/).
...
1. **Legitimization of proprietary trading** at hedge fund scale, with 20%+ fee structures and outsized compensation.
2. **Talent recruitment from outside finance**, showing that top mathematicians and engineers can contribute to trading.
3. **High-frequency arbitrage and the microstructure edge**, demonstrating that small, systematic inefficiencies compound into billions.

His scandal and redemption narrative also illustrates the regulatory and compliance risks of extreme information intensity. Post-Dodd-Frank and [MiFID II](/wiki/mifid-ii/), the information-advantage game has become more difficult; Cohen's pivot to quantitative and systematic methods reflects that evolution.

<div class="wiki-seealso">

### Closely related

- [Hedge Fund](/wiki/hedge-fund/) — SAC and Point72 are flagship examples
- [Merger Arbitrage](/wiki/merger-arbitrage/) — signature SAC strategy
- [Statistical Arbitrage](/wiki/statistical-arbitrage/) — quantitative approach
- [Proprietary Trading](/wiki/principal-trading/) — SAC's business model

### Wider context

- [George Soros](/wiki/george-soros/) — macro-focused peer trader
- [Paul Tudor Jones](/wiki/paul-tudor-jones/) — commodity/macro specialist
- [Hedge Fund Leverage](/wiki/hedge-fund-leverage-prime-broker/) — prime broker relationships
- [Insider Trading](/wiki/insider-trading-definition/) — regulatory context of SAC scandal
