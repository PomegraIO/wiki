...
*Mark Spitznagel is a financial engineer and hedge fund manager best known for developing systematic [tail-risk hedging](/wiki/tail-risk-hedging/) strategies that profit when markets crash—and for applying complex options mathematics to forecast and protect against economic extremes.*
...
|---|---|
| Birth year | 1969 |
| Affiliation | Universa Investments |
| Education | CUNY diploma (incomplete), self-taught |
| Public profile | Author, researcher |
| Notable trades | 2008 financial crisis, 2020 COVID crash |
...
This success led to Universa Investments, founded in 2007, which became the flagship vehicle for his [tail-risk hedging](/wiki/tail-risk-hedging/) philosophy. Universa manages billions and has crystallized returns through multiple major corrections.

## Tail-risk hedging as an asset class

Spitznagel's core insight is that buying insurance against [black-swan](/wiki/black-swan/) events—extreme negative returns—is economically rational, even if the insurance costs money in calm markets. He uses far out-of-the-money index [put options](/wiki/put-option/) to create a payoff that hedges 95% stock portfolios. The strategy costs perhaps 0.5% to 2% annually in hedging fees but can deliver 5x to 10x gains during the brief moments when markets crater. The long-term drag is worth it if you have the stomach for it.

His work sits at the intersection of [portfolio theory](/wiki/asset-allocation/), [options pricing](/wiki/option-premium/), and behavioral economics. Spitznagel argues that most investors are psychologically unwilling to buy insurance, viewing hedge costs as wasted money. But in a century, a handful of crashes wipe out decades of gains; tail insurance is the asymmetric bet that corrects for that rare catastrophe.

## Published work and intellectual influence

Spitznagel has written two books: *The Black Swan* was co-authored with [Nassim Taleb](/wiki/nassim-taleb/)—though authorship credits remain contested—and *The Dao of Capital*, which applies the economics of leverage and fragility to macro strategy. His academic papers on option-based hedging, crisis alpha, and extreme value theory have influenced institutional risk management. He often clashes publicly with mainstream academics and portfolio managers, arguing that they systematically underestimate tail risk and charge inadequate hedging premiums.
...
Spitznagel's work has made [tail-risk hedging](/wiki/tail-risk-hedging/) and [crisis alpha](/wiki/hedge-fund-catastrophic-loss/) legitimate sub-strategies within large pension funds and endowments. Universities, foundations, and sovereign wealth funds have allocated to variants of his approach. This has indirectly changed [implied volatility](/wiki/implied-volatility/) surfaces and [options pricing](/wiki/option-premium/), as institutional demand for puts has increased relative to calls.

His emphasis on [extreme value theory](/wiki/extremal-value-theory/) and fractal risk has also influenced academic work on financial crises and [value-at-risk](/wiki/value-at-risk/) modeling, even among researchers who do not fully embrace his hedging prescription.

<div class="wiki-seealso">

### Closely related
- [Tail-Risk Hedging](/wiki/tail-risk-hedging/) — his primary specialization.
- [Nassim Taleb](/wiki/nassim-taleb/) — co-author and frequent sparring partner.
- [Black Swan](/wiki/black-swan/) — conceptual foundation of Spitznagel's work.

### Wider context
- [Hedge Fund](/wiki/hedge-fund/) — the vehicle structure Spitznagel uses.
- [Put Option](/wiki/put-option/) — the core instrument in tail hedging.
- [Value-at-Risk](/wiki/value-at-risk/) — the risk measure his hedges address.
