...
description: "An early 20th-century trader and short-seller whose tape-reading and market psychology insights shaped modern trading theory."
keywords:
  - jesse livermore
  - trader
  - short-seller
...
| Aspect | Detail |
|--------|--------|
| **Birth** | 1877 (Acton, Massachusetts) |
| **Death** | 1940 (suicide at Sherry-Lehmann Hotel, New York) |
| **Career Era** | 1890s–1930s |
| **Method** | Tape reading, trend following, short selling |
| **Legacy** | Market psychology insights; *Reminiscences* (1923) |
| **Fortunes** | Made millions, lost fortunes multiple times |
...
- **Trend following**: Livermore was a [momentum investor](/wiki/momentum-investing/) in spirit. He followed established trends, letting winners run, and cut losers fast. "The market is always right"—his trading should align with the direction, not fight it.
...
1. Trade in the direction of the established trend.
2. Enter after a significant move, not at the beginning (avoid premature entry).
3. Let profits run; cut losses quickly.
4. Position size according to risk tolerance; never risk ruin on one trade.
5. Use support and [resistance](/wiki/support-and-resistance/) levels to determine entry and exit.
6. Avoid overtrading and taking profits too early.
7. Respect the market; it knows more than any individual.
...
### Wider context
- [Trend Following](/wiki/trend-following/) — Trading in the direction of established moves
- [Panic of 1907](/wiki/panic-of-1907/) — Historic crash that made Livermore's reputation
- [Price Discovery](/wiki/price-discovery/) — Market mechanism determining fair value through trading
