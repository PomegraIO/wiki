---
title: "Reflexivity Theory in Trading: How Soros Applies It"
description: "Soros reflexivity theory explained: how market prices distort fundamentals in feedback loops, and why traders use it to identify bubbles."
keywords:
  - soros reflexivity theory explained trading
  - reflexivity feedback loop markets
  - george soros market psychology
  - bubble identification trading
...
<div class="wiki-infobox-title">Soros Reflexivity — key facts</div>

<img src="/svg/people.svg" alt="An abstract editorial mark for the topic." />

<div class="wiki-infobox-caption">The theory that market prices distort reality, which then reshapes the reality they are supposed to reflect.</div>
...
The classical theory of markets assumes that prices converge toward underlying value—earnings, cash flows, [interest rates](/interest-rate/)—and that deviations correct themselves. Soros inverted this. In his view, prices actively influence the very fundamentals they are meant to reflect. An inflated stock valuation, for example, enables cheap capital raises, which fund growth and acquisitions, temporarily validating the inflated price. A currency boom makes that country's exports more expensive, which weakens exports and the economic data, but the currency keeps rising because capital inflows overshadow the weakening. The market bias reinforces itself until reality becomes too distorted to ignore.
...
1. **Fundamentals deteriorate visibly enough** that even optimists stop ignoring them
2. **Leverage reaches a breaking point** where a marginal price move forces liquidation
3. **Central banks tighten policy** or foreign investors withdraw capital
4. **Insider selling or early position unwinding** signals that even believers are exiting
...
- **Is leverage amplifying the cycle?** (Margin debt, [repo](/repurchase-agreement/), [derivatives](/derivatives-hedging/) used to increase exposure)
- **Are fundamentals deteriorating while price keeps rising?** (A widening gap suggests the bias is extreme)
- **Are insiders, corporations, or central banks behaving as though the bubble is mature?** (Director selling, [share buybacks](/share-buyback/) slow, rate hikes begin)
...
- [Carry trade](/carry-trade/) — currency borrowing strategy that reflexively amplifies through leverage
- Market efficiency — contrasting view that prices incorporate information correctly
- [Momentum investing](/momentum-investing/) — strategy that profits from self-reinforcing price moves
...
- [Currency risk](/currency-risk/) — exchange rate volatility in reflexive currency cycles

### Wider context

- [Japanese asset bubble of the 1980s](/japanese-asset-bubble-1980s/) — reflexivity in real estate and equity boom-bust
- [Mississippi Bubble of 1720](/mississippi-bubble-1720/) — early paper-money reflexive cycle
- [Silver Thursday: The Hunt Brothers' Silver Squeeze](/silver-thursday-1980-hunt-brothers/) — commodity reflexivity and leverage collapse
