...
description: "Intellectual founder of value investing whose analytical framework for finding stocks trading below intrinsic value shaped generations of investors and remains foundational to security analysis."
keywords:
  - graham
  - value investing
...
|   |   |
|---|---|
| **Full name** | Benjamin David Graham |
| **Born** | 1894, New York |
| **Died** | 1976, Aix-en-Provence, France |
| **Nationality** | American |
| **Known for** | Security analysis, value investing, margin of safety |
| **Best-known work** | *The Intelligent Investor*, *Security Analysis* |
| **Role** | Professor at Columbia University, manager of Graham-Newman Corporation |
| **Key idea** | Invest only when you have a margin of safety; focus on intrinsic value, not price |
