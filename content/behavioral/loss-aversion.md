---
title: "Loss aversion"
description: "Loss aversion is the tendency to feel the pain of a loss roughly twice as intensely as the pleasure of an equivalent gain, causing people to avoid risks that might result in losses even when the expected value is positive."
keywords:
  - loss aversion
  - risk aversion
  - behavioral finance
...
Central to prospect theory. For the bias toward the existing state, see [status quo bias](/status-quo-bias).
...
|   |   |
|---|---|
| **What it is** | Asymmetric emotional response to gains and losses |
| **Discovered by** | Kahneman & Tversky (1979) — foundational to prospect theory |
| **Coefficient** | Losses feel roughly 2.25x as painful as equivalent gains feel good |
| **Operates on** | Risk tolerance, portfolio decisions, selling discipline |
| **Investor impact** | Holding losers too long; underdiversified concentrated bets; avoiding beneficial risk |
| **Related phenomenon** | [Prospect theory](/prospect-theory), [sunk cost fallacy](/sunk-cost-fallacy), [disposition effect](/disposition-effect) |
...
This is distinct from [sunk cost fallacy](/sunk-cost-fallacy), though they often co-occur. Loss aversion is the emotional pain of realizing the loss; sunk cost is the logical error of treating past investment as relevant to future decisions.
...
## Loss aversion and [prospect theory](/prospect-theory)
...
- **Use a selling rule.** Pre-commit to selling when certain conditions are met — [stop-loss orders](/short-selling), rebalancing schedules, threshold-based rules — that bypass emotional loss aversion.
...
- [Status quo bias](/status-quo-bias) — preference for the current state
- [Mental accounting](/mental-accounting) — organizing money into silos

### Wider context

- [Risk](/beta) — how to think about volatility rationally
- [Overconfidence bias](/overconfidence-bias) — excessive certainty despite loss aversion
- [Regret aversion](/regret-aversion) — fear of regret interacting with loss aversion
- [Reflection effect](/reflection-effect) — risk-seeking behavior in losses
