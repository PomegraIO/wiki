...
description: "Confirmation bias is the tendency to search for, interpret, favor, and recall information in ways that confirm your pre-existing beliefs, making it hard to change your mind even when evidence suggests you should."
keywords:
  - confirmation bias
  - cognitive bias
  - belief perseverance
...
|   |   |
|---|---|
| **What it is** | Seeking and interpreting information to confirm existing beliefs |
| **Also called** | Belief perseverance, myside bias, motivated reasoning |
| **Operates on** | Information search, interpretation, memory, attention |
| **Investor impact** | Holding losing stocks too long; avoiding signs of deterioration; doubling down on failed bets |
| **Severity** | One of the most pervasive biases; affects experts and laypeople alike |
| **Counterforce** | Deliberately seeking disconfirming evidence; diverse viewpoints |
