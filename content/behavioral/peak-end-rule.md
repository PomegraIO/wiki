---
title: "Peak-end rule"
description: "Peak-end rule is the tendency to judge an experience based on its peak moment and its final moment, ignoring the duration and average experience, leading to biased memory and regret."
keywords:
  - peak-end rule
  - memory bias
  - peak moment
...
|   |   |
|---|---|
| **What it is** | Judging by peak and final moments, not average |
...
**Condition A:** 60 seconds in cold water (painful).
**Condition B:** 60 seconds in cold water, then 30 more seconds in slightly warmer water (still cold, but less so).
