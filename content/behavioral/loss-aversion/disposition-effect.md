...
description: "Disposition effect is the tendency to sell winning investments too quickly and hold losing investments too long, the opposite of the buy-low-sell-high strategy that rational investing demands."
keywords:
  - disposition effect
  - selling winners
  - holding losers
...
|   |   |
|---|---|
| **What it is** | Selling winners early; holding losers too long |
| **Opposite of** | Buy low, sell high |
| **Observed in** | Individual investors; fund managers; institutional behavior |
| **Investor impact** | Reduced returns; increased taxes; concentration in losers |
| **Severity** | Very large; costs investors billions annually |
| **Evidence** | Consistent finding across decades of research |
...
## Disposition effect and [sunk-cost fallacy](/sunk-cost-fallacy/)

The disposition effect and [sunk-cost fallacy](/sunk-cost-fallacy/) are related. Both involve the purchase price being a reference point: "I paid $100 for this stock; I do not want to realize a loss." But they are distinct mechanisms. Disposition effect also includes the attraction of realizing gains.

## Disposition effect and [regret aversion](/regret-aversion/)

The disposition effect is driven partly by [regret aversion](/regret-aversion/): the fear of regretting selling a winner that goes higher. This fear is so strong that it overpowers the rational decision to sell overvalued winners or hold winning positions.
...
- **Cut losses decisively.** Use [stop-loss orders](/short-selling/) or a selling rule to cut losing positions decisively. Do not hold hoping for recovery.
...
- [Loss aversion](/loss-aversion/) — core mechanism
- [Sunk-cost fallacy](/sunk-cost-fallacy/) — holding losers due to past price
- [Regret aversion](/regret-aversion/) — fear of regretted sales
- [Mental accounting](/mental-accounting/) — organizing into gains/losses accounts
- [Reference dependence](/prospect-theory/) — purchase price as reference point

### Wider context

- [Status quo bias](/status-quo-bias/) — preference to hold existing positions
- [Endowment effect](/endowment-effect/) — overvaluing owned positions
- Behavioral portfolio theory — how disposition effect shapes portfolios
- [Tax-loss harvesting](/short-selling/) — exploiting disposition effect for tax benefit
- [Mean reversion](/price-to-earnings-ratio/) — reversions create disposition-effect losses
