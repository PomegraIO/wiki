---
title: "Overtrading Bias"
description: "Excessive trading driven by illusion of control and overconfidence in one's ability to time markets."
keywords:
  - overtrading bias
  - illusion of control
  - excessive trading
...
*The **Overtrading Bias** is the tendency to trade excessively based on the false belief that frequent activity increases returns or that the trader has special insight. Driven by [illusion of control](/wiki/illusion-of-control/) and [overconfidence](/wiki/overconfidence-in-investing/), overtraders pay more in commissions and [market impact](/wiki/market-impact-cost/), suffer worse tax outcomes, and empirically underperform by 2–7% annually versus buy-and-hold investors.*

<aside class="wiki-infobox">

| Aspect | Detail |
|---|---|
| **Root cause** | Illusion of control; overconfidence in timing ability |
| **Manifestation** | Frequent unnecessary trades; high portfolio turnover |
| **Economic impact** | Costs: commissions, spreads, taxes, market impact |
| **Evidence** | Barber & Odean (2000): 1,700 households, 1% annual underperformance per percentile increase in turnover |
| **Inverse bias** | [Disposition effect](/wiki/disposition-effect/) (reluctance to realize losses) |
| **Who is affected** | Particularly retail/active traders; less common in professionals |
...
Research shows that [overconfidence](/wiki/overconfidence-in-investing/) is particularly high among:
...
Though commissions have collapsed to near-zero for active traders (discount brokers, retail platforms), the [bid-ask spread](/wiki/bid-ask-spread/) remains. Each round-trip (buy and sell) incurs the spread.
...
### Market impact
Large trades move prices. An overtrader accumulating a position in a thinly-traded stock incurs [market impact](/wiki/market-impact-cost/) on each trade. A 0.5% impact on ten trades is a 5% drag on returns.

### Tax drag
In taxable accounts, frequent trading triggers frequent [capital gains](/wiki/capital-gains-tax/), particularly [short-term gains](/wiki/short-term-capital-gain-tax/) taxed at ordinary income rates (up to 37% in the US). A buy-and-hold investor defers taxes and compounds gains more efficiently. In mutual fund portfolios, overtrading increases [fund turnover](/wiki/turnover-ratio/), which triggers distributions taxed to all shareholders (even those who didn't request the trading).
...
### Closely related
- [Illusion of control](/wiki/illusion-of-control/) — root psychological bias
- [Overconfidence bias](/wiki/overconfidence-in-investing/) — inflated self-assessment
- [Disposition effect](/wiki/disposition-effect/) — related bias (reluctance to sell losers)
