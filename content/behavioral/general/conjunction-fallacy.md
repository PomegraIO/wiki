...
description: "Conjunction fallacy is the false belief that a conjunction of two events (both A and B occurring) is more probable than one of the individual events (A occurring), which is logically impossible."
keywords:
  - conjunction fallacy
  - probability
  - representativeness
...
|   |   |
|---|---|
| **What it is** | Judging conjunction more probable than its parts |
