...
description: "Illusion of skill is the mistake of attributing successful outcomes to one's own skill when they are actually the result of luck in a domain where random variation dominates."
keywords:
  - illusion of skill
  - luck vs skill
  - attribution bias
...
|   |   |
|---|---|
| **What it is** | Attributing lucky outcomes to skill |
| **Also called** | Attribution bias, fundamental attribution error |
