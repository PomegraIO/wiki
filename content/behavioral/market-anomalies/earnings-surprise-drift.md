---
title: "Post-Earnings Surprise Drift"
description: "The slow market reaction to earnings surprises, creating momentum opportunities as prices gradually adjust."
keywords:
  - post-earnings drift
  - earnings surprise
  - momentum strategy
...
|---------|-----------------|
| **Time horizon** | 2 weeks to 6 months post-announcement |
| **Magnitude** | 1–5% average excess return over the drift period |
| **Drivers** | Anchoring, information diffusion, underreaction |
| **Tradeable** | Yes, via momentum strategies or factor funds |
| **Market cap sensitivity** | Stronger in smaller, lower-analyst-coverage stocks |
| **Persistence** | Documented since 1970s, still present but shrinking |
...
- **Automated trading**: Statistical [arbitrage](/wiki/statistical-arbitrage/) funds and [algorithmic trading](/wiki/algorithmic-trading/) systems exploit predictable drifts instantly.
...
PESD is one flavor of [momentum investing](/wiki/momentum-investing/), which exploits the tendency of past outperformers to continue outperforming. Beyond earnings surprises, momentum surfaces in:
...
### Closely related
- [Momentum investing](/wiki/momentum-investing/) — The strategy category that exploits price and earnings drift
- [Anchoring bias](/wiki/anchoring-bias/) — The cognitive bias that slows repricing of surprises
- [Earnings yield](/wiki/earnings-yield/) — The baseline return expected from earnings, against which surprises are measured
