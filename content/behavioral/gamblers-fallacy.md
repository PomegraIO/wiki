...
description: "Gamblers fallacy is the false belief that past results in a random process make certain outcomes more or less likely in the future, such as believing a string of losses makes a win more likely."
keywords:
  - gamblers fallacy
  - false belief
  - randomness
...
|   |   |
|---|---|
| **What it is** | Believing past results predict future outcomes in random sequences |
