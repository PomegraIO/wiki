...
description: "Base-rate neglect is the tendency to ignore the actual statistical frequency or baseline probability of a category when making judgments, and instead rely on specific information about an individual case."
keywords:
  - base rate
...
|   |   |
|---|---|
| **What it is** | Ignoring the actual statistical frequency of a category |
