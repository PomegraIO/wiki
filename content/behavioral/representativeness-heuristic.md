...
description: "The representativeness heuristic is the tendency to judge the probability that something belongs to a category based on how similar it is to the typical member of that category, while neglecting actual statistical base rates."
keywords:
  - representativeness
  - heuristic
  - cognitive bias
...
|   |   |
|---|---|
| **What it is** | Judging probability by similarity to a stereotype |
