...
description: "Recency and primacy effects are the tendency to overweight recent information (recency) or initial information (primacy) when making judgments, with their relative strength depending on the context."
keywords:
  - recency effect
  - primacy effect
  - first impression
...
|   |   |
|---|---|
| **What it is** | Overweighting first and most recent information |
| **Recency** | Last data point dominates current judgment |
| **Primacy** | First data point anchors subsequent judgment |
| **Context-dependent** | Which effect dominates depends on timing and cognitive load |
| **Investor impact** | Inconsistent judgment; forecast biases; career regrets |
| **Related phenomenon** | [Anchoring bias](/anchoring-bias), [recency bias](/recency-bias) |
...
The primacy effect is related to [anchoring bias](/anchoring-bias): the first number you see anchors your estimate. The first impression you form anchors your belief.
...
- **Use a decision framework independent of order.** A [valuation](/price-to-earnings-ratio) model or a decision rule provides the same output regardless of information order.
...
- [Anchoring bias](/anchoring-bias) — first impression anchors subsequent judgment
- [Primacy effect](/recency-and-primacy-effect) — first impression dominates
- [Serial position effect](/recency-and-primacy-effect) — items at beginning and end are remembered
- [Availability heuristic](/availability-heuristic) — recent or vivid information is available

### Wider context

- [Fund selection](/mutual-fund) — primacy and recency bias selecting managers
- [Market timing](/bull-market) — recency bias driving market cycles
- [Narrative fallacy](/narrative-fallacy) — primacy and recency in stories
- Behavioral asset pricing — order effects on prices
- [Overconfidence bias](/overconfidence-bias) — amplified by primacy of early success
