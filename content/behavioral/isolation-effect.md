...
description: "The isolation effect is the tendency to focus on the unique features of an option while ignoring common features shared with other options, leading to inconsistent choices when the same decision is presented differently."
keywords:
  - isolation effect
  - framing
...
Related to framing effect and cascade effect. For choices influenced by how options are presented, see [framing effect](/framing-effect).
...
|   |   |
|---|---|
| **What it is** | Focusing on differences while ignoring commonalities |
| **Discovered by** | Kahneman & Tversky (1981) |
| **Mechanism** | Highlighting differences changes salience and choice |
| **Operates on** | Stock selection, portfolio decisions, fund choice |
| **Investor impact** | Inconsistent allocation decisions; focus on fees/features instead of performance; overtrading |
| **Related phenomenon** | [Framing effect](/framing-effect), [certainty effect](/certainty-effect) |
...
**Risk/return focus without context.** A fund's [Sharpe ratio](/beta) (risk-adjusted return) is highlighted in the prospectus. Investors isolate this one metric and make decisions based on it, ignoring that the fund might have [correlation](/beta) with their existing holdings that reduces the benefit of adding it.
...
## Isolation and [mental accounting](/mental-accounting)

Isolation effect and [mental accounting](/mental-accounting) reinforce each other. When you mentally separate your portfolio into "conservative account" and "growth account," each account looks different in isolation, and you make different allocation decisions for each. In aggregate, the portfolio is suboptimal.

## Isolation effect vs. framing effect

The [framing effect](/framing-effect) is about how *presentation* (as a gain vs. loss) affects choice. The isolation effect is about what *components* of the choice you focus on. They overlap but are distinct. Framing changes meaning; isolation changes salience.
...
- **Separate the decision into stages.** First decide on [asset allocation](/asset-allocation) (broad categories: stocks, bonds, alternatives). Then decide on implementation (which specific funds/stocks). This compartmentalization prevents isolation of implementation details from the allocation decision.
...
- [Framing effect](/framing-effect) — presentation of options affects choice
- [Certainty effect](/certainty-effect) — overweighting certain features
- [Mental accounting](/mental-accounting) — organizing money into silos
- [Availability heuristic](/availability-heuristic) — what comes to mind affects judgment
- [Confirmation bias](/confirmation-bias) — focusing on confirming information

### Wider context

- [Asset allocation](/asset-allocation) — overall structure that isolation effect can undermine
- [Diversification](/diversification) — the hidden benefit that isolation obscures
- [Prospect theory](/prospect-theory) — the broader framework
- [Overconfidence bias](/overconfidence-bias) — excessive focus on highlighted metrics
