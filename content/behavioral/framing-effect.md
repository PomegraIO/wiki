...
description: "The framing effect is the tendency to make different choices depending on how options are presented, even when the underlying decision is identical — the same facts lead to different conclusions based on the frame."
keywords:
  - framing effect
  - choice architecture
  - presentation bias
...
|   |   |
|---|---|
| **What it is** | Different choices for identical problems presented differently |
