...
description: "Anchoring bias is the tendency to rely too heavily on an initial number when making subsequent estimates or decisions, causing that first figure to disproportionately influence the final judgment."
keywords:
  - anchoring
  - cognitive bias
  - valuation
...
|   |   |
|---|---|
| **What it is** | Overweighting an initial value in decision-making |
| **Discovered by** | Tversky & Kahneman (1974) |
| **Mechanism** | Insufficient adjustment away from the anchor |
| **Operates on** | Estimates, valuations, negotiations, price expectations |
| **Related phenomenon** | Adjustment heuristic, satisficing |
| **Investor impact** | Overpaying for stocks after high-priced IPO; undervaluing assets due to past prices |
| **Historical note** | One of the most robust findings in behavioral psychology |
