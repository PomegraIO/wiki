...
description: "Status quo bias is the tendency to prefer things to remain as they are, treating the current state as a reference point and judging changes as losses rather than as potential gains."
keywords:
  - status quo
  - bias
...
Related to loss aversion and default bias. For the opposite tendency (excessive change), see [default bias](/status-quo-bias).
...
|   |   |
|---|---|
| **What it is** | Preference for the current state |
| **Related to** | [Loss aversion](/loss-aversion), [endowment effect](/endowment-effect) |
| **Operates on** | Portfolio allocation, fund choice, rebalancing decisions |
| **Investor impact** | Under-rebalancing; failing to update allocations; inertia in response to changing circumstances |
| **Severity** | Very strong; even small inconvenience can prevent beneficial changes |
| **Evidence** | Observed across financial and non-financial decisions |
...
**Reference dependence.** The current state becomes the reference point. All alternatives are judged relative to it. Because of [loss aversion](/loss-aversion), you overweight losses relative to the current state and underweight gains.
...
**Concentrated holdings.** An investor inherited stock in her family's company. It is now a concentrated position that far exceeds her [diversification](/diversification) target. But the stock is the current state; diversifying feels like a betrayal or a loss. Status quo bias keeps her overweighted.
...
## Status quo bias vs. [loss aversion](/loss-aversion)

Status quo bias is the preference for the current state. [Loss aversion](/loss-aversion) is the asymmetric emotional response to losses. They are related but distinct. Loss aversion is the mechanism that drives status quo bias: the potential losses from change feel larger than the potential gains, so the current state is preferred.

## Status quo bias vs. [endowment effect](/endowment-effect)
...
- [Loss aversion](/loss-aversion) — the mechanism driving status quo bias
- [Endowment effect](/endowment-effect) — overvaluing what you own
- [Default bias](/status-quo-bias) — the reverse of status quo bias in choice architecture
- [Mental accounting](/mental-accounting) — organizing current state into silos
- [Regret aversion](/regret-aversion) — fear of regretting changes

### Wider context

- [Asset allocation](/asset-allocation) — optimal allocation vs. status quo
- [Rebalancing](/asset-allocation) — the antidote
- Behavioral portfolio theory — how status quo bias shapes portfolios
- [Prospect theory](/prospect-theory) — the broader framework
- [Narrow framing](/narrow-framing) — status quo bias within mental accounts
