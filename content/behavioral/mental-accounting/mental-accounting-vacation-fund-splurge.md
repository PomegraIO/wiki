---
title: "Why Vacation Funds Get Spent More Freely Than Emergency Funds"
description: "Why mental accounting makes vacation money feel easier to spend than emergency savings, even when the amounts are identical."
keywords:
  - mental accounting vacation fund
  - vacation spending behavior
  - money categorization bias
  - mental budgeting
  - spending psychology
...
<div class="wiki-infobox-title">Mental Accounting & Vacation Funds — key facts</div>

<img src="/svg/behavioral.svg" alt="An abstract editorial mark for behavioral finance." />

<div class="wiki-infobox-caption">The label on money shapes how freely we spend it.</div>
...
- [Mental accounting](/mental-accounting/) — the broad framework for how people categorize and spend money
- [Loss aversion](/loss-aversion/) — why the pain of losing money exceeds the pleasure of gaining it
- [Prospect theory](/prospect-theory/) — how people evaluate outcomes relative to a reference point
- Behavioral economics — the field studying how psychology shapes financial decisions

### Wider context

- [Buffer fund](/buffer-fund/) — why true emergency savings require numerical thresholds, not mental categories
- [Budgeting methods](/budgeting-methods/) — techniques for aligning spending to goals without relying on mental accounts alone
- [Savings rate](/savings-rate/) — how mental accounting affects whether people save consistently or inconsistently
