...
description: "Endowment effect is the tendency to assign greater value to something simply because you own it, treating the fact of ownership as a reason to value it more highly than you otherwise would."
keywords:
  - endowment effect
  - ownership bias
  - valuation asymmetry
...
Related to status quo bias and loss aversion. For preference to keep things as they are, see [status quo bias](/status-quo-bias/).
...
|   |   |
|---|---|
| **What it is** | Overvaluing something because you own it |
| **Discovered by** | Kahneman, Knetsch, Thaler (1990) |
| **Mechanism** | Loss aversion applied to owned objects |
| **Investor impact** | Overvaluing existing holdings; reluctance to rebalance; concentrated portfolios |
| **Severity** | Very strong; even experimental subjects show it in lab settings |
| **Related phenomenon** | [Status quo bias](/status-quo-bias/), [loss aversion](/loss-aversion/) |
...
The endowment effect is driven by [loss aversion](/loss-aversion/). Once you own something, losing it feels painful. The pain of losing the mug is greater than the pleasure of gaining the money you would receive for it. So you demand a high price to give it up.
...
**Holding losers.** An investor bought a stock at $100 and it has fallen to $50. Because she owns it, she overvalues it relative to its true worth (endowment effect) and is reluctant to sell. She holds not just because of [loss aversion](/loss-aversion/) (realizing the loss is painful), but also because of endowment effect (the stock, being hers, is worth more than an outside buyer would pay for it).

## Endowment effect and [disposition effect](/disposition-effect/)

The [disposition effect](/disposition-effect/) is the tendency to sell winners and hold losers. Endowment effect contributes: you overvalue all holdings you own, but especially concentrated or emotional holdings. Selling them feels like a loss, so you hold them. This can lock you into concentrated, underperforming positions.

## Endowment effect and [narrow framing](/narrow-framing/)
...
- **Separate emotion from valuation.** Ask: what is the objective [market](/stock-market/) price of this holding? Do not add a premium just because you own it.
...
- **Use mechanical rules.** A rebalancing rule or [stop-loss order](/short-selling/) removes the emotional endowment effect. The rule says sell; you sell.
...
- [Loss aversion](/loss-aversion/) — the mechanism behind endowment effect
- [Status quo bias](/status-quo-bias/) — preference to keep owned things
- [Disposition effect](/disposition-effect/) — selling winners, holding losers
- [Mental accounting](/mental-accounting/) — separate accounts amplify endowment effect
- [Narrow framing](/narrow-framing/) — endowment effect strongest in narrow frames

### Wider context

- [Diversification](/diversification/) — the antidote to endowment-driven concentration
- Behavioral portfolio theory — how endowment effect shapes portfolios
- [Prospect theory](/prospect-theory/) — reference dependence and endowment
- [Rebalancing](/asset-allocation/) — mechanically overcoming endowment effect
- [Portfolio concentration](/beta/) — driven partly by endowment effect
