...
description: "Ambiguity aversion is the tendency to prefer choices with known probabilities over choices with unknown or ambiguous probabilities, even when the unknown option has a higher expected value."
keywords:
  - ambiguity aversion
  - uncertainty
  - known vs unknown
...
|   |   |
|---|---|
| **What it is** | Preferring known probabilities to unknown ones |
| **Opposite of** | Ambiguity seeking (rare) |
| **Illustrates as** | Ellsberg paradox |
| **Investor impact** | Home bias; concentration in familiar stocks; avoidance of emerging markets |
| **Related phenomenon** | Familiarity bias, home bias |
| **Severity** | Strong; affects diversification decisions |
...
**Gamble A:** Win if you draw a red ball (30% chance known).
**Gamble B:** Win if you draw a black ball (chance unknown, could be 0% to 60%).
