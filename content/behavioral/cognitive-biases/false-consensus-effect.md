...
description: "The tendency to overestimate how many other people share your beliefs, values, or behaviors."
keywords:
  - cognitive bias
  - overestimation
  - social perception
...
*The false consensus effect is a [cognitive bias](/wiki/anchoring-bias/) in which people overestimate the extent to which others agree with them or share their beliefs, values, and behaviors. You believe most people think as you do, vote as you do, or would make the same choices in your situation—even when evidence suggests otherwise.*
...
| **Core error** | Overestimating agreement with your views |
| **Related to** | Confirmation bias, consensus bias |
| **Discovered** | Lee Ross, 1977 |
| **Frequency** | Appears across cultures and contexts |
| **Consequence** | Poor predictions of others' behavior |
...
The false consensus effect overlaps with [confirmation bias](/wiki/confirmation-bias/), the tendency to seek information that confirms your existing views. If you believe most people are bullish on a stock, you naturally seek out bullish commentary and investor testimonials, which reinforces your belief. Disagreement gets filtered out as noise. Over time, confirmation bias and false consensus effect amplify each other into a cycle of self-deception.

[Groupthink](/wiki/herding-in-markets/) is a related organizational failure. When teams overestimate consensus and squelch dissent, they lose the corrective force of minority views. This leads to bad decisions that seemed obvious at the time because everyone in the room agreed. Most major corporate disasters involve some element of groupthink enabled by the false consensus effect.

<div class="wiki-seealso">

### Closely related
- [Confirmation Bias](/wiki/confirmation-bias/) — Seeking information that confirms your beliefs
- [Availability Bias](/wiki/availability-bias-investing/) — Relying on easily recalled examples
- [Anchoring Bias](/wiki/anchoring-bias/) — Over-relying on first information encountered
- [Representativeness Heuristic](/wiki/representativeness-heuristic/) — Judging by similarity to a prototype
- [Status Quo Bias](/wiki/status-quo-bias/) — Preferring the current state

### Wider context
- [Behavioral Finance](/wiki/herding-in-markets/) — How psychology shapes market behavior
- [Groupthink](/wiki/herding-investors/) — Group consensus overriding critical judgment
- [Contrarian Investing](/wiki/contrarian-investing/) — Betting against consensus views
- [Bubbles and Manias](/wiki/bubbles-and-manias/) — Market extremes driven by overestimation
