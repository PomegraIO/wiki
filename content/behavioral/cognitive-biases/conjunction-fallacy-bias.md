...
description: "Cognitive bias treating specific scenarios as more probable than the general category they belong to."
keywords:
  - conjunction fallacy
  - cognitive bias
  - probability
...
| Element | Detail |
|---------|--------|
| **Type** | Probability misjudgment |
| **Root Cause** | Representativeness heuristic; vividness bias |
| **Effect on Markets** | Overweighting of detailed narratives; underweighting base rates |
| **First Documented** | Tversky & Kahneman (1983) |
| **Related Bias** | [Base-rate neglect](/wiki/base-rate-neglect/) |
| **Market Impact** | Portfolio concentration; narrative-driven trading |
| **Investor Harm** | Overconfidence in specific forecasts vs. historical averages |
...
- **Underweighting [base rates](/wiki/base-rate-neglect/):** A fund manager profiles a company as a "high-quality compounder" with strong fundamentals. The rich description makes the probability of future outperformance *feel* high, even though [base rates](/wiki/base-rate-neglect/) show most actively-managed funds underperform passive indices.
...
[Availability bias](/wiki/availability-bias-investing/) compounds the problem. A detailed scenario, once imagined vividly, becomes "available" to memory and feels more likely. The [narrative fallacy](/wiki/narrative-fallacy/) suggests that human brains are wired to construct coherent stories; a detailed conjunction is a more satisfying story than a vague probability.
...
Conjunction fallacy is a close cousin of [base-rate neglect](/wiki/base-rate-neglect/). The base rate is the unconditional probability: "What % of bank tellers are people?" ~50%. "What % of tech IPOs return 10x?" ~0.5%. When a detailed description shows up, people ignore the base rate and anchor on representativeness.
...
- **Reversion to index returns:** Use [passive strategies](/wiki/passively-managed-fund/) as the null hypothesis. An active bet must overcome both the base rate of underperformance and the specific risk of implementation failure.

## When conjunction fallacy cuts the other way

Rarely, the fallacy works against overoptimism. A trader might underestimate the probability of a market crash that requires a conjunction of conditions: Fed error + geopolitical shock + corporate defaults. Each alone is plausible; the conjunction feels remote. Yet once in a cycle, the conjunction strikes. This is related to [tail risk](/wiki/tail-risk/) and [black swan](/wiki/black-swan/) dynamics.

<div class="wiki-seealso">

### Closely related
- [Representativeness Heuristic](/wiki/representativeness-heuristic/) — Core mechanism driving the fallacy
- [Base-Rate Neglect](/wiki/base-rate-neglect/) — Ignoring unconditional probability
- [Availability Bias](/wiki/availability-bias-investing/) — Vividness making scenarios feel probable
...
- [Risk Management](/wiki/risk-parity-strategy/) — Methods to counter overconfidence in specific scenarios
