---
title: "Hot Hand Bias"
description: "Cognitive bias of believing that past success predicts future success, even when outcomes are statistically independent."
keywords:
  - hot hand bias
  - gambler's fallacy
  - overconfidence
...
| Factor | Detail |
|--------|--------|
| **Root Cause** | Pattern recognition in human cognition |
| **Related Fallacy** | Gambler's fallacy (opposite: "luck must change") |
| **Evidence Type** | Confirmation bias; cherry-picking success stories |
| **Market Impact** | Momentum chasing; inflated risk-taking after wins |
| **Correction** | Probabilistic thinking; reviewing aggregate results |
| **Severity in Trading** | High; directly leads to position sizing errors |
| **Scientific Finding** | Documented extensively in behavioral finance research |
...
- **Backtest and probabilize:** Test whether your strategy's past winners predict future winners. Use [Monte Carlo simulation](/wiki/monte-carlo-valuation/) to understand the range of outcomes your strategy can produce.
...
### Closely related
- [Gambler's Fallacy](/wiki/gamblers-fallacy/) — belief that cold streaks revert
- [Overconfidence Bias](/wiki/overconfidence-bias/) — inflated belief in own ability
- [Recency Bias](/wiki/recency-bias/) — overweighting recent events
- [Confirmtion Bias](/wiki/confirmation-bias/) — seeking evidence that confirms belief
