---
title: "Passive Loss Limitation Real Estate"
description: "The $25,000 annual deduction limit for passive real estate losses and the rules that govern its application."
keywords:
...
| **Type of property** | Applies to rental real estate; not vacation homes or personal residences |
...
The $25,000 deduction can be used against any income (wage, dividend, business). But to deduct suspended losses, you typically need [passive income](/wiki/passive-activity-loss-limits/) — income from other passive activities (e.g., limited partnership distributions, rental income from other properties).
...
1. **Qualify as real estate professional** — document 750+ hours per year in real estate work; gain full loss deduction.
2. **Entity structuring** — S-corps and partnerships can sometimes be structured to allow full deduction (depends on material participation rules).
3. **Suspend losses strategically** — hold passive real estate across multiple properties, generating both gains and losses in some years to offset suspended losses.
4. **Installment sales** — sell appreciated properties on installment to recognize gains (and offset suspended losses) over multiple years.
5. **Partnership structures** — passive investors in real estate partnerships with active general partners may be able to use partnership losses more flexibly.

<div class="wiki-seealso">

### Closely related
- [Real estate investment trust](/wiki/real-estate-investment-trust/) — an alternative to direct real estate ownership
...
- [Rental property](/wiki/residential-reit/) — the primary vehicle for passive real estate investment
- [Capital gains tax](/wiki/capital-gains-tax-investor/) — treatment of real estate sales
- [Tax loss harvesting](/wiki/tax-loss-harvesting/) — broader strategy for managing losses
- [Installment sale](/wiki/installment-sale-real-estate/) — structuring real estate sales to spread gains
