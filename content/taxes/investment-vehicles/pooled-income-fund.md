...
description: "A charity-managed investment pool that pays donors a variable income share in exchange for a remainder gift and provides an immediate deduction on the actuarial present value of the future charitable remainder."
keywords:
  - pooled income fund
...
<div class="wiki-infobox-title">Pooled Income Fund — key facts</div>

<img src="/svg/taxes.svg" alt="An abstract editorial mark for taxation and structured finance." />

<div class="wiki-infobox-caption">A shared charitable pool that pays variable income and delivers a current tax deduction.</div>

|   |   |
|---|---|
| **What it is** | A commingled investment fund managed by a qualified public charity for the benefit of donors and the charity |
| **Donor contribution** | Irreversible gift of cash or appreciated securities; typically $10,000 to $100,000+ |
| **Income stream** | Variable annual payout based on actual pool earnings; proportional share of net income |
| **Payment frequency** | Quarterly or annually; no minimum payout rate (unlike [charitable remainder trusts](/)) |
| **Deduction timing** | Immediate charitable deduction for present value of remainder interest; does not reduce deduction over time |
| **Remainder interest** | Charity receives remaining pool balance at donor's death (or term end) |
| **Tax treatment** | Deduction subject to ordinary income and net investment income tax; no capital gains tax on appreciated securities contributed |
| **Duration** | Life beneficiary model or term-certain (maximum 20 years) |
...
- [Spousal Lifetime Access Trust](/spousal-lifetime-access-trust/) — an irrevocable structure for family wealth transfer with deferred taxation
- [Intentionally Defective Grantor Trust](/intentionally-defective-grantor-trust/) — another deferred-tax vehicle combining grantor and non-grantor status
- [Oil and Gas Limited Partnership Tax](/oil-gas-limited-partnership-tax/) — an alternative pass-through structure with upfront deductions
- [Dividend](/dividend/) — the ordinary income alternative to charitable pooled vehicles
- [Cost Basis](/cost-basis/) — the calculation of gain on appreciated securities contributed to a PIF
