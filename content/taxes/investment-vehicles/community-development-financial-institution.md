---
title: "Community Development Financial Institution"
description: "CDFI lending to underserved communities for tax incentives and impact investing."
keywords:
  - CDFI
...
| Element | Details |
|---|---|
| **Definition** | Lender serving underserved communities |
| **Certifier** | US Treasury Department (CDFI Fund) |
| **Beneficiaries** | Low-income communities, minorities, rural areas |
| **Capital sources** | Government grants, tax credits, private investment |
| **Investor incentive** | New Markets Tax Credit (NMTC), 39% credit |
| **Time horizon** | 7-year hold required for NMTC |
...
1. **Targeted community focus:** The CDFI must serve low-income populations or areas, defined by income thresholds (typically <80% of area median income) or by serving persistently poor or distressed areas.

2. **Development impact:** The CDFI must have a genuine mission to improve economic conditions and quality of life in the communities served, not merely profit-maximize.

3. **Financing availability:** The CDFI must address a gap—provide credit or capital that mainstream lenders won't offer.
...
1. **Primary CDFIs:** Direct lenders and investors in underserved communities (community banks, credit unions).
2. **CDFI intermediaries:** Organizations that aggregate capital and distribute it to smaller CDFIs (e.g., community development corporations).
3. **Investors:** Individuals, foundations, and corporations seeking tax credits and impact returns.
4. **Government:** Treasury CDFI Fund, SBA, HUD, and state/local governments providing grants and preferential funding.
