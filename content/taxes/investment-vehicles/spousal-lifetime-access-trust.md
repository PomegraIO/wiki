...
description: "A revocable trust vehicle that removes assets from an estate using the lifetime exemption while the beneficiary spouse retains indirect access to trust capital through an independent trustee's discretion."
keywords:
...
<div class="wiki-infobox-title">Spousal Lifetime Access Trust — key facts</div>

<img src="/svg/taxes.svg" alt="An abstract editorial mark for taxation and structured finance." />

<div class="wiki-infobox-caption">A gift that removes assets from an estate while keeping indirect wealth access in the family.</div>

|   |   |
|---|---|
| **What it is** | An irrevocable trust that receives a lifetime-exemption gift and holds assets for the grantor's spouse and descendants |
| **Gift-tax treatment** | Grantor uses lifetime exemption ($13+ million); no annual gift tax return unless assets exceed limits |
| **Grantor's access** | Technically none; spouse may receive distributions at trustee discretion |
| **Spouse's access** | Receives distributions at independent trustee's discretion; commonly has limited power of appointment |
| **Remainder beneficiaries** | Children or other descendants; assets avoid estate tax at spouse's death |
| **Portability interaction** | If spouse dies without using assets, unused lifetime exemption may port to grantor |
| **Drafting requirement** | Independent trustee essential; grantor cannot serve or have excessive influence |
| **Estrangement risk** | If grantor and spouse later divorce, grantor has limited recourse to trust assets |
...
- [Intentionally Defective Grantor Trust](/intentionally-defective-grantor-trust/) — an alternative that allows the grantor to retain certain powers while removing estate value
- [Pooled Income Fund](/pooled-income-fund/) — a charitable alternative with fixed-income features and deduction benefits
- [Oil and Gas Limited Partnership Tax](/oil-gas-limited-partnership-tax/) — another tax-deferred wealth transfer mechanism
- [Retained Earnings](/retained-earnings/) — how entity-level wealth accumulates tax-deferred before distribution
- [Dividend](/dividend/) — the alternative mechanism for wealth extraction without a trust vehicle
