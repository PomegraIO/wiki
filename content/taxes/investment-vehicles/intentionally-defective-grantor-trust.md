...
description: "A trust structure that is treated as owned by the grantor for income-tax purposes (preserving grantor deduction eligibility) but excluded from the grantor's taxable estate (permitting tax-free wealth transfer to heirs)."
keywords:
...
<div class="wiki-infobox-title">Intentionally Defective Grantor Trust — key facts</div>

<img src="/svg/taxes.svg" alt="An abstract editorial mark for taxation and structured finance." />

<div class="wiki-infobox-caption">A dual-status trust that pays grantor income tax but escapes grantor's estate.</div>
...
By contrast, a low-growth or income-heavy asset (a [bond](/bond/) ladder, a dividend [mutual fund](/mutual-fund/)) is less efficient in an IDGT because the grantor bears high ordinary income-tax rates on distributions, eroding the benefit.
...
A charitable remainder structure ([pooled income fund](/pooled-income-fund/) or [charitable remainder trust](/)) generates an immediate deduction but requires charitable remainder, so it is not suitable for family wealth transfer.
