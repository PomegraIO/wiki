---
title: "Kiddie Tax Unearned Income Threshold and How It Works"
description: "The kiddie tax applies when a child's unearned income exceeds the annual threshold, taxing it at the parent's marginal rate. Learn how the floor is indexed and when it triggers."
keywords:
  - kiddie tax unearned income threshold
  - kiddie tax amount
  - kiddie tax rules
  - unearned income children
  - kiddie tax phase-out
image: /svg/taxes.svg
---
...
<div class="wiki-infobox-title">Kiddie Tax Unearned Income Threshold — key facts</div>

<img src="/svg/taxes.svg" alt="An abstract editorial mark for the topic." />

<div class="wiki-infobox-caption">Investment income above an annual floor gets taxed at the parent's rate.</div>
