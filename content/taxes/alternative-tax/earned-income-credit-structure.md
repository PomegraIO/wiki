---
title: "Earned Income Credit Structure"
description: "Tax credit formula that expands with earnings up to a plateau, then phases out at higher incomes, delivering maximum benefit to low-wage workers while reducing marriage penalties."
keywords:
  - EITC
...
| Aspect | Detail |
|--------|--------|
| **Eligibility** | Income under threshold (~$61K single, ~$97K married, 2024) |
| **Maximum credit** | $3,733 (1 child), $6,164 (2+ children); varies by year |
| **Phase-in rate** | 34% (1 child) to 40% (3+); per additional $1 earned |
| **Plateau** | Income range where credit is maximized |
| **Phase-out rate** | 21% (1 child) to 21% (3+); inverse of phase-in |
| **Refundable** | Yes; excess credit refunded to taxpayer |
| **Filing requirement** | Must file tax return to claim (IRS outreach needed) |
...
Add state and local taxes plus [SNAP](/wiki/earned-income-credit-structure/) phase-out, and the effective marginal rate can reach 60–70%, creating "welfare cliffs" where earning more income costs more in lost benefits. Economists recognize this as a barrier to work; some propose smoothing the transitions.
