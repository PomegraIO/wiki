---
title: "Net Investment Income Tax on Rental Property Income"
description: "Understand when the 3.8% net investment income tax applies to rental income. Learn about material participation, grouping elections, and how NIIT is calculated."
keywords:
  - net investment income tax rental property
  - niit rental income
  - 3.8% tax rental property
  - material participation rental
...
<div class="wiki-infobox-title">NIIT on Rental Property Income — key facts</div>

<img src="/svg/taxes.svg" alt="An abstract editorial mark for the topic." />

<div class="wiki-infobox-caption">3.8% surtax on rental income above a high-income threshold—unless material participation or grouping applies.</div>

|   |   |
|---|---|
| **Tax rate** | 3.8% on net investment income |
| **Income threshold (2024)** | $200,000 (single), $250,000 (married) |
| **Modified AGI test** | MAGI above threshold triggers NIIT on eligible income |
| **Rental income treatment** | Subject to NIIT unless material participation met |
| **Material participation** | ≥500 hours/year work, or ≥100 hours and > others' time |
| **Grouping election** | Can group rental with active business to escape NIIT |
| **Tax base** | Lesser of net investment income or excess MAGI |
