---
title: "Additional Medicare Tax for Self-Employed Individuals"
description: "How the 0.9% additional Medicare tax applies to self-employment income above a threshold. Learn the calculation and how it differs from regular SECA tax."
keywords:
  - additional medicare tax self employed income
  - 0.9% medicare tax self-employed
...
<div class="wiki-infobox-title">Additional Medicare Tax for Self-Employed — key facts</div>

<img src="/svg/taxes.svg" alt="An abstract editorial mark for the topic." />

<div class="wiki-infobox-caption">A high-income surtax on self-employment earnings; separate from regular Medicare tax.</div>

|   |   |
|---|---|
| **Tax rate** | 0.9% on earnings above threshold |
| **Income threshold (2024)** | $200,000 (single), $250,000 (married) |
| **Tax base** | Net self-employment earnings, not gross |
| **Combined with regular Medicare** | Yes; total Medicare tax rises from 2.9% to 3.8% above threshold |
| **Employers pay** | W-2 employees' threshold is $200,000/$250,000; employer withholds/pays |
| **Self-employed** | Pay full 0.9% on net earnings above threshold |
| **Form filed** | Form 8959; reported on Form 1040 |
| **Indexed threshold** | No; fixed at $200,000 and $250,000 (non-indexed) |
...
| | Regular SE Tax | Additional Medicare Tax |
|---|---|---|
| **Rate** | 2.9% (Medicare only) | 0.9% |
| **Base** | All net SE earnings | Only SE earnings above threshold |
| **Threshold** | None; applies to all | Yes; $200,000 single |
| **Interaction** | Taxes the full amount | Stacks on top of regular tax |
| **Self-employed vs. W-2** | Different calculations | Threshold the same; employer withholds for W-2 |
