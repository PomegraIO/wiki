---
title: "AMT vs Regular Tax: Which One You Actually Pay"
description: "Understand how the alternative minimum tax works: you pay whichever is higher—regular income tax or tentative minimum tax. See how the crossover works."
keywords:
  - amt vs regular tax which applies
...
<div class="wiki-infobox-title">AMT vs Regular Tax — key facts</div>

<img src="/svg/taxes.svg" alt="An abstract editorial mark for the topic." />

<div class="wiki-infobox-caption">Two tax systems run in parallel; you owe the larger result.</div>

|   |   |
|---|---|
| **What you pay** | Higher of regular tax or tentative minimum tax |
| **Regular tax** | Calculated on taxable income with standard/itemized deductions |
| **AMT income (AMTI)** | Taxable income adjusted for AMT preferences and add-backs |
| **AMT exemption** | Shields lower portion of AMTI; phases out at high income levels |
| **AMT tax rate** | 26% or 28%, depending on bracket |
| **When you owe it** | When tentative minimum tax exceeds regular tax |
