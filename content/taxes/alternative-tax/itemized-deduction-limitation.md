---
title: "Itemized Deduction Limitation"
description: "Tax caps and phase-outs that restrict the deduction of state and local taxes (SALT) and other personal expenses for high-income filers."
keywords:
  - salt cap
  - itemized deductions
  - tax phase-out
...
*The **itemized deduction limitation** refers to statutory caps and [phase-out rules](/wiki/tax-bracket-investor/) that reduce the value of personal expense deductions—particularly [state and local taxes (SALT)](/wiki/sales-tax/)—for households above certain income thresholds, a provision that has reshaped tax planning for affluent filers.*

<aside class="wiki-infobox">

| Feature | Detail |
|---------|--------|
| **SALT cap (current)** | $10,000 per year for joint filers ($5,000 single) |
| **Effective from** | Tax years 2018–2025 (Tax Cuts and Jobs Act) |
| **Sunset date** | December 31, 2025 (scheduled expiration) |
| **Deductions affected** | State income tax, local property tax, local sales tax |
| **Filing status impact** | Stricter for single filers than married filing jointly |
| **Interaction** | Reduces incentive to itemize vs. claiming standard deduction |
...
The deduction limitation matters only for filers who [itemize](/wiki/itemized-deduction-investor/) rather than taking the [standard deduction](/wiki/standard-deduction-investor/). The standard deduction was significantly raised by the Tax Cuts and Jobs Act itself, nearly doubling to $27,700 for joint filers in 2023. For many middle-income households, the new standard deduction exceeds total [charitable contributions](/wiki/charitable-contribution-deduction/) plus SALT, making itemization pointless.
...
**Bunching charitable giving:** High-income donors accelerate charitable contributions into a single year, pushing total itemized deductions over the standard deduction threshold, then claim standard deduction in off years. [Donor-advised funds](/wiki/charitable-contribution-deduction/) (DAFs) enable multi-year bunching.
...
**Business structure shifts:** Some high-income earners convert from W-2 employment to [pass-through entities](/wiki/k-1-investor/) (S-corps, partnerships) to claim [business deductions](/wiki/business-combination-purchase/) instead of personal deductions, though this carries operational complexity and the SALT cap may still apply depending on structure.

## Expiration and future uncertainty

The SALT cap is scheduled to sunset on December 31, 2025, reverting to unlimited deductibility unless Congress acts. This creates planning uncertainty. A filer facing a large one-time income event (sale of business, exercise of [restricted stock units](/wiki/restricted-stock-units/)) must guess whether 2026 will bring unlimited SALT deductions again or a new cap. States with high income taxes have lobbied for repeal, framing the cap as a federal overreach into state fiscal autonomy.
...
### Closely related
- [SALT Cap](/wiki/sales-tax/) — state and local tax limitations on federal deductibility
- [Itemized Deduction Investor](/wiki/itemized-deduction-investor/) — structure of personal tax deductions
- [Standard Deduction Investor](/wiki/standard-deduction-investor/) — alternative to itemizing
- [Alternative Minimum Tax Investor](/wiki/alternative-minimum-tax-investor/) — parallel tax system for high earners

### Wider context
- [Federal Tax System](/wiki/marginal-tax-rate-investor/) — progressive income tax structure
- [Charitable Contribution Deduction](/wiki/charitable-contribution-deduction/) — deduction for donations
- [Mortgage Interest Deduction](/wiki/home-equity-loan/) — deduction for home loan interest
- [Tax Planning](/wiki/tax-loss-harvesting/) — strategies to minimize tax liability
