---
title: "Research Credit Phase In"
description: "Claiming R&D tax credits for qualified experimental activities and phasing in the benefit over eligible spending thresholds."
keywords:
  - research credit
  - R&D credit
  - qualified expenses
...
| Aspect | Detail |
|--------|--------|
| **Credit type** | Nonrefundable federal income tax credit (partially refundable for small businesses) |
| **Eligible activities** | Development of new/improved products, processes, techniques, software, formulas |
| **Covered expenses** | Wages for qualified personnel, materials, contractor costs, supplies (not land) |
| **Phase-in method** | Credit accrues as qualified spending exceeds base-year or fixed-base percentage |
| **Credit rates** | 20% of incremental spending (reduced credit option); 14% alternative calculation |
| **Carryback/carryforward** | One-year carryback, unlimited carryforward (subject to business credits limit) |
| **Employer impact** | Reduces [payroll tax](/wiki/payroll-tax/) base if wages are credited; phase-in prevents double-dip |
