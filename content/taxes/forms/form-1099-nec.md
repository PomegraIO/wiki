---
title: "Form 1099-NEC"
description: "Reporting form for nonemployee compensation and contract payments issued to independent contractors."
keywords:
  - 1099-nec reporting
...
For self-employment income from pass-through entities like S corporations or partnerships, see <a href="/wiki/k-1-investor/">/wiki/k-1-investor/</a>.
</div>
...
A business that pays a contractor, freelancer, or service provider $600 or more in a calendar year must file a 1099-NEC with the IRS unless the payee is a corporation (with narrow exceptions). This includes payments to plumbers, accountants, writers, consultants, and any vendor providing services as a non-employee. The requirement applies regardless of whether payment was by check, credit card, digital wallet, or cash (though cash is easier to hide and creates audit risk). Payment via [payment processing networks](/wiki/payment-system-stability/) like PayPal or Stripe may auto-report to 1099-NEC even before the contractor is officially issued the form.

## Distinctions from wages and W-2

A [W-2](/wiki/form-w-2g/) is issued to employees; a 1099-NEC is issued to contractors. The difference matters legally and tax-wise. Employees have payroll taxes (Social Security, Medicare) withheld by their employer; contractors are self-employed and owe [self-employment tax](/wiki/earned-income-tax-credit/) (roughly 15.3%) on top of income tax. Employees are entitled to benefits (health insurance, retirement matching, workers' compensation); contractors are not. The IRS aggressively scrutinizes worker classification. Misclassifying an employee as a contractor is a serious violation that can result in back payroll taxes, penalties, and interest.

## Reporting NEC income on your tax return

If you receive a 1099-NEC, you report that income on [Schedule C](/wiki/schedule-d/) (Profit or Loss from Business) if you are self-employed, or on the relevant line of your [Form 1040](/wiki/1099-int/) if you are an investor. You can then deduct business expenses—home office, equipment, supplies, professional services—to arrive at net self-employment income. From that, you owe [self-employment tax](/wiki/earned-income-tax-credit/). You also report the income on [Form 1040](/wiki/1099-int/) for federal income tax. If you expect to owe more than $1,000 in taxes from 1099 income, you may need to make [estimated quarterly tax payments](/wiki/marginal-tax-rate-investor/) (Form 1040-ES) to avoid penalties.
...
If you are primarily 1099 self-employed, [tax planning](/wiki/marginal-tax-rate-investor/) is critical. You can deduct legitimate business expenses, contribute to a [SEP IRA](/wiki/sep-ira/) or [Solo 401(k)](/wiki/solo-401k/) (reducing [taxable income](/wiki/tax-bracket-investor/)), and use [tax loss harvesting](/wiki/tax-loss-harvesting/) on investment accounts. Health insurance premiums are [deductible](/wiki/deferred-tax-asset/). Home office deductions can be substantial. The key is to track every expense and keep receipts. The IRS expects self-employed individuals to maintain meticulous records given the compliance burden.

<div class="wiki-seealso">

### Closely related
- [Form W-2G](/wiki/form-w-2g/) — reporting gambling and prize winnings
- [Form 1099-INT](/wiki/1099-int/) — reporting interest income
- [Form 1099-DIV](/wiki/1099-div/) — reporting dividend income
- [K-1 investor](/wiki/k-1-investor/) — pass-through entity income reporting

### Wider context
- [Earned income tax credit](/wiki/earned-income-tax-credit/) — credit for lower-income self-employed individuals
- [Self-employment tax](/wiki/earned-income-tax-credit/) — Social Security and Medicare for contractors
- [Tax bracket investor](/wiki/tax-bracket-investor/) — how marginal rates affect self-employed income planning
- [Schedule D](/wiki/schedule-d/) — where to report business income and losses
