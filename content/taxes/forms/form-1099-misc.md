...
description: "IRS form used to report miscellaneous income and payments received by individuals and sole proprietors, including freelance fees, rent, and prizes."
keywords:
  - form 1099-misc
  - 1099-misc
...
| Box | Purpose | Threshold for Reporting |
|-----|---------|------------------------|
| **1** | Rents | $600 |
| **2** | Royalties | $10 (any amount) |
| **3** | Other income | Varies |
| **4** | Federal tax withheld | Any amount |
| **5** | Fishing boat proceeds | $600 |
| **6** | Medical/health care payments | $600 |
| **7** | Nonemployee compensation | $600 |
| **8** | Substitute payments in lieu of dividends/interest | Any amount |
...
Income reported on a 1099-MISC is subject to [self-employment tax](/wiki/sep-ira-self-employed/) (15.3%—12.4% for Social Security and 2.9% for Medicare) unless it is rental income (which is not). A freelancer earning $60,000 on 1099-MISC forms must pay ~$9,180 in self-employment tax plus federal [income tax](/wiki/federal-funds-rate/). This is why 1099 income is often considered "gross"—the recipient bears the full payroll tax burden that an employer would normally split.

## Reconciliation with Schedule C and Schedule E

A [self-employed](/wiki/solo-401k/) person receiving 1099-MISC forms for nonemployee compensation reports the income on [Schedule C](/wiki/schedule-d/) (self-employment income) when filing their [1040](/wiki/estate-tax/). Rental income from 1099-MISC goes to [Schedule E](/wiki/property-tax/). The IRS matches the 1099 data to these schedules; omitting or underreporting income flagged by a 1099-MISC is a red flag for [audits](/wiki/audit-opinion/).
...
States also require 1099-MISC income to be reported on state tax returns. Most states follow federal rules and treat 1099-MISC income as taxable income (subject to [state income tax](/wiki/sales-tax/) and [self-employment tax](/wiki/sep-ira-self-employed/)). A few states have special rules or exemptions (e.g., certain royalty income), so check your state's filing requirements.

## Withholding and backup withholding

The payer may withhold federal [income tax](/wiki/federal-funds-rate/) on a 1099-MISC if required (e.g., under "backup withholding" if the recipient failed to provide a correct [taxpayer identification number](/wiki/gift-tax/)). Withheld amounts are reported in Box 4 of the form and can be claimed as a credit on the recipient's [1040](/wiki/estate-tax/). This reduces the cash payment to the recipient but ensures compliance.
...
### Closely related
- [Form 1099-NEC](/wiki/form-1099-nec/) — Form for nonemployee compensation (replacing most 1099-MISC Box 7 reporting)
- [Schedule C](/wiki/schedule-d/) — Self-employment income reporting on tax returns
- [Schedule E](/wiki/property-tax/) — Rental and royalty income reporting
