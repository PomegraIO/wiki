---
title: "Form 1098-H"
description: "Tax form reporting health insurance costs paid by self-employed individuals for potential income tax deduction."
keywords:
  - form 1098-H
...
| Aspect | Detail |
|--------|--------|
| **Issued by** | Insurance provider or government health insurance program |
| **Form type** | Information return; not a tax return |
| **Reports** | Qualified health insurance premiums paid during tax year |
| **Who receives** | Self-employed individuals; also some part-time workers, seasonal workers |
| **Deductibility** | Above-the-line deduction on Form 1040 (not subject to AGI limits) |
| **Related forms** | Form 8885 (Health Coverage Tax Credit); Form 1099-H (where applicable) |
...
The key rule is: the self-employed health insurance deduction reduces self-employment income for purposes of calculating self-employment tax and adjusted gross income (AGI). It is an "above-the-line" deduction, meaning it reduces AGI before the [standard deduction](/wiki/standard-deduction-investor/). This is valuable because a lower AGI unlocks other benefits (child tax credits, education credits, etc.).

## Interaction with subsidies and credits

A self-employed person's health insurance costs have three layers:

1. **Actual premium paid** to the insurance company
2. **Advance premium tax credit (APTC)** paid by the government to the insurer
3. **Reconciliation** done at tax time if estimated income was wrong
...
The self-employed health insurance deduction interacts with [health savings accounts (HSAs)](/wiki/hsa/). An individual can:
...
- [Health Savings Account (HSA)](/wiki/hsa/) — tax-advantaged account for health costs
