...
description: "Long-term capital gain tax is the preferential federal tax on profit from assets held over one year. Rates are 0%, 15%, or 20%, significantly lower than ordinary income rates."
keywords:
...
For assets held one year or less, see [short-term capital gain tax](/short-term-capital-gain-tax/). For the broader framework, see [capital gains tax for investors](/capital-gains-tax-investor/).
...
|   |   |
|---|---|
| **What it is** | Tax on gains from assets held over 1 year |
| **Holding period threshold** | More than 365 days |
| **Federal tax rate** | 0%, 15%, or 20% (depending on income) |
| **0% bracket upper limit** | ~$47,000 (single), $94,000 (married) in 2024 |
| **15% bracket range** | Middle-income earners (majority) |
| **20% bracket** | Highest earners |
...
**20% rate.** The highest earners pay 20% on long-term gains. This applies to single filers with income above $518,000 and married couples above $1.03 million, plus an additional 3.8% [net investment income tax](/net-investment-income-tax/) for the wealthiest.

## Why long-term rates matter

The gap between short-term and long-term rates is enormous. An investor in the 24% [tax bracket](/tax-bracket-investor/) pays 24% on short-term gains but only 15% on long-term gains—a 37.5% reduction in tax. Over a lifetime, this gap compounds. Long-term investing is not just more tax-efficient; it is dramatically more tax-efficient.

## The one-year rule

The one-year holding period is measured from the acquisition date to the sale date. If you buy a [stock](/stock/) on January 15, you must hold it until January 16 of the following year for the gain to qualify as long-term. Selling one day early locks in the short-term rate. This simple threshold can be worth thousands of dollars.

## Interaction with cost basis and harvesting

Your long-term gain depends on your [cost basis](/cost-basis/)—your adjusted purchase price. Methods like [specific identification](/specific-identification-basis/), [FIFO](/fifo-tax/), or [average cost](/average-cost-basis/) can minimize the gain. Long-term losses can offset long-term gains without limit, and excess long-term losses can offset short-term gains or up to $3,000 of ordinary income per year.
...
- [Holding period](/holding-period/) — the one-year threshold
- [Cost basis](/cost-basis/) — determines your gain amount
- [Schedule D](/schedule-d/) — reporting long-term gains

### Wider context

- [Tax bracket](/tax-bracket-investor/) — your marginal rate on ordinary income
...
- [Dividend](/dividend/) — often also taxed at long-term rates
- [Asset allocation](/asset-allocation/) — planning with tax efficiency in mind
