...
<div class="wiki-infobox-title">Capital Gains and State Residency — key facts</div>

<img src="/svg/taxes.svg" alt="An abstract editorial mark for taxes." />

<div class="wiki-infobox-caption">Timing of the move relative to the sale determines tax exposure in each state.</div>

|   |   |
|---|---|
| **Primary factor** | Source of income (property location), not purchase or sale location |
| **Resident taxation** | All capital gains; also non-resident gains on in-state property |
| **Non-resident taxation** | Only gains from property physically located in that state |
| **Real estate in State A** | State A taxes the gain even if you're now a resident of State B |
| **Stock or intangibles** | Typically taxed by state of residence only |
| **Timing the move** | Move before sale → your new state may tax it; after sale → varies |
| **Part-year resident** | Both old and new state may attempt to tax depending on source |
...
- [Cost Basis](/cost-basis/) — Foundation for calculating the taxable gain
- [Tax Bracket](/tax-bracket-investor/) — How gains push income into higher brackets
- [Depreciation Recapture](/depreciation-recapture-investor/) — Real estate-specific gains subject to higher rates
- [Tax Loss Harvesting](/tax-loss-harvesting/) — Offsetting capital gains with losses

### Wider context

- [State Income Tax](/corporate-income-tax/) — General state taxation principles
- [Residency Rules](/federal-reserve/) — How states define domicile (varies)
- [Business Relocation](/acquisition/) — Similar sourcing principles for business income
- [International Tax](/national-debt/) — How gains on foreign property are treated
