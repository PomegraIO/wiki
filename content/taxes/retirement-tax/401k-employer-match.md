...
description: "Free employer contributions to an employee's 401k retirement plan, typically conditional on the employee deferring a percentage of salary—the largest employer subsidy of retirement saving."
keywords:
  - 401k match
...
*The **401k Employer Match** is the employer's voluntary contribution to an employee's [401k plan](/wiki/401k-plan/), usually made contingent on the employee contributing a certain percentage of salary. A common formula is "50% match on the first 6% of salary," meaning if you defer 6% of your gross pay, your employer contributes 3% of pay into your account—a pure gift, with no upfront tax. For the median employee, employer matching is the single largest source of retirement savings besides their own paycheck deferrals, yet millions of workers fail to capture it by not contributing enough to get the full match.*

<aside class="wiki-infobox">

| Aspect | Detail |
|--------|--------|
| **Typical formula** | 50% to 100% match on first 3–6% of salary |
| **Vesting** | Often immediate, but sometimes 3–5 year [cliff](/wiki/cliff-vesting/) or graded schedule |
| **Tax treatment** | Employer contributions are pre-tax; not counted as [taxable income](/wiki/marginal-tax-rate-investor/) |
| **Annual limit** | Combined employee + employer contributions capped at $69,000 (2024) |
| **Forfeiture risk** | Unvested match is lost if you leave before vesting; vested match stays with you |
| **IRS testing** | Plans must pass [discrimination tests](/wiki/concentration-limits/) to ensure highly compensated employees don't disproportionately benefit |
...
Employer contributions are not always yours to keep immediately. Many plans impose a [vesting schedule](/wiki/vesting-schedule-employer/): a period during which your contributions are yours, but employer contributions belong to the plan. Leaving before you vest means you forfeit the unvested match.
...
A [cliff vesting](/wiki/cliff-vesting/) schedule is harsh: if you leave after 2 years 11 months, you forfeit the entire match. Graded vesting is kinder to job-hoppers; you always keep something. The law allows plans to vest over up to 6 years in a graded schedule or 3 years in a cliff.

## The discrimination testing problem

[401k plans](/wiki/401k-plan/) are subject to "discrimination tests" under the Internal Revenue Code. The plan must ensure that highly compensated employees (HCEs—defined roughly as earning >$150,000 or in the top 20% of earners) are not saving disproportionately more than regular employees. If too many HCEs max out their contributions while rank-and-file workers save little, the plan fails the test, and the company must return excess HCE deferrals or reduce the HCE match rate.
...
Employer match contributions are not subject to income tax at the time they are made. If your employer contributes $3,000 to your 401k match, you do not report $3,000 as [taxable income](/wiki/marginal-tax-rate-investor/). Only when you withdraw the money in retirement do you pay [ordinary income tax](/wiki/ordinary-dividend/).

This is why the match is so valuable: the employer's money compounds tax-free inside the 401k. If you earned $3,000 in salary instead, you'd pay 25% [marginal tax](/wiki/marginal-tax-rate-investor/) ($750), leaving only $2,250 to invest, which then compounds and is taxed again on withdrawals. The match's tax deferral is worth 25–40% depending on your bracket and post-retirement tax rate.

## Capturing match and portfolio decisions

Some employees feel the match is "not enough" and avoid 401k contributions because they want to invest in taxable accounts instead (to buy individual stocks, crypto, or real estate). This is nearly always a mistake unless you're extremely high-income and all other savings vehicles ([backdoor Roth](/wiki/backdoor-roth/), [mega backdoor Roth](/wiki/mega-backdoor-roth/), [taxable brokerage](/wiki/direct-indexing-vehicle/)) are maxed. The match is free money and should be captured first.

<div class="wiki-seealso">

### Closely related
- [401k Plan](/wiki/401k-plan/) — Overview of 401k mechanics and contribution limits
- [401k Match](/wiki/401k-match/) — Direct synonym; the employer matching contribution
- [Vesting Schedule Employer](/wiki/vesting-schedule-employer/) — When employer contributions become yours
- [Cliff Vesting](/wiki/cliff-vesting/) — All-or-nothing vesting schedules in retirement plans
