...
description: "IRS-mandated annual withdrawal from tax-deferred retirement accounts beginning at age 73, with penalties for non-compliance and exceptions for certain account types."
keywords:
...
| Rule | Detail |
|------|--------|
| Starting Age | 73 (2023+, raised from 72 by SECURE Act 2.0) |
| Calculation | Account balance Dec 31 prior year ÷ IRS life-expectancy factor |
| Annual Deadline | December 31 of each year |
| Penalty for Non-Compliance | 25% excise tax on shortfall (10% for good-faith errors) |
| Accounts Subject | Traditional IRA, 401k, 403b, 457, SEP-IRA, SIMPLE IRA |
| Accounts Exempt | Roth IRA (not owner, but heirs), employer Roth 401k |
| Spousal Rollover | Surviving spouse can roll to own IRA, extending RMDs |
| Aggregation Rule | Multiple IRAs must be aggregated; 401k plans separately |
...
Example: A 73-year-old with a $500,000 [traditional IRA](/wiki/ira-traditional/) balance on Dec 31 must withdraw $500,000 ÷ 26.5 = $18,868 by December 31 of the current year.
...
- A retiree with five old [401(k)s](/wiki/401k-plan/) from different employers must calculate and withdraw an RMD from each.
- But if they have three [traditional IRAs](/wiki/ira-traditional/), they can calculate the total RMD across all three and withdraw it all from one IRA.

Sophisticated retirees consolidate [401(k)s](/wiki/401k-plan/) into a single rollover IRA to simplify RMD logistics.
...
A widow rolling over a deceased spouse's $2 million [traditional IRA](/wiki/ira-traditional/) can defer RMDs on that balance until she reaches 73, rather than being forced to withdraw it over 10 years.

## Roth IRA special status

**Roth IRAs are exempt from RMDs during the owner's lifetime.** The account holder can keep a [Roth IRA](/wiki/roth-ira/) growing tax-free indefinitely and never withdraw from it. This is a major tax-planning advantage; high-net-worth individuals often convert [traditional IRAs](/wiki/ira-traditional/) to [Roth IRAs](/wiki/roth-ira/) early in retirement to eliminate future RMD obligations.
...
1. **Bunch withdrawals into years with low income**: Withdraw a large RMD in a year with a major charitable contribution or other deduction to reduce [marginal tax rates](/wiki/marginal-tax-rate-investor/).
...
## High-balance RMD trap and [estate planning](/wiki/estate-tax/)

A retiree with a very large [traditional IRA](/wiki/ira-traditional/) (say, $5 million) faces increasingly large RMDs as they age and life expectancy factors shrink. At age 85 with a 5M balance and a life expectancy factor of ~9.6, the RMD is $520,000, a substantial forced withdrawal. This large RMD can push the retiree into a higher [tax bracket](/wiki/tax-bracket-investor/), trigger [net investment income tax](/wiki/net-investment-income-tax/), and create [Medicare surtax](/wiki/medicare-surtax/) exposure.

Strategic [Roth conversions](/wiki/roth-conversion-personal/) in earlier retirement years can reduce the account balance subject to RMDs later, mitigating this trap.

<div class="wiki-seealso">

### Closely related
- [Required minimum distribution (personal)](/wiki/required-minimum-distribution-personal/) — Detailed planning guidance
- [Traditional IRA](/wiki/ira-traditional/) — Primary RMD-subject account
- [401(k) plan](/wiki/401k-plan/) — Employer plan subject to RMDs
- [Roth IRA](/wiki/roth-ira/) — RMD-exempt alternative
