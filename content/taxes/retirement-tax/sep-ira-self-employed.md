---
title: "SEP IRA Self-Employed"
description: "A simplified pension plan for self-employed workers and small business owners allowing large annual tax-deductible contributions."
keywords:
  - sep ira
...
*A **SEP IRA (Simplified Employee Pension)** is a retirement savings vehicle designed for self-employed individuals and small business owners, permitting tax-deductible contributions of up to 25% of net self-employment income (capped at $70,000 annually in 2024), making it a flexible and high-contribution alternative to traditional [IRAs](/wiki/ira-traditional/).*

<aside class="wiki-infobox">

| Feature | Detail |
|---------|--------|
| **Contribution limit (2024)** | 25% of net SE income, max $70,000 |
| **Contribution limit (2025)** | Indexed to inflation; approximately $70,500–$71,000 |
| **Self-employed rate** | 20% (after SE tax adjustment) for sole proprietors |
| **Deadline** | Tax filing deadline (April 15 + extensions) |
| **Setup cost** | Minimal; forms available free from brokers |
| **Account ownership** | Individual (each owner has separate account) |
| **Investment control** | Broad (stocks, bonds, funds, REITs, CDs) |
| **Withdrawal rules** | Same as traditional IRA (10% penalty before 59.5, RMDs at 73) |

</aside>

## Why SEP IRAs work for self-employed workers

Self-employed workers lack access to employer 401(k) plans. A freelancer earning $100,000 in net SE income can contribute only $7,000 to a regular [traditional IRA](/wiki/ira-traditional/) (2024 limit). A SEP IRA allows that same freelancer to contribute roughly $20,000 (25% of $100,000, after adjustment for SE tax), deferring far more income from federal and state taxation.
...
Self-employment income is subject to a 15.3% [self-employment tax](/wiki/earned-income-tax-credit/) (Social Security + Medicare). A freelancer earning $100,000 in gross revenue owes roughly $15,300 in SE tax. Net SE income for retirement purposes is reduced by *half* the SE tax: $100,000 − $7,650 = $92,350.
...
A competing vehicle, the [Solo 401(k)](/wiki/solo-401k-mechanics/), also serves solo self-employed workers. How do they compare?
...
[Roth conversion](/wiki/roth-conversion-personal/) strategies also apply: a self-employed person can fund a traditional SEP and later convert funds to a Roth SEP IRA, paying taxes on the conversion but getting tax-free growth thereafter. This is useful in low-income years (e.g., starting a new business) when conversion tax is minimal.
...
This requirement makes SEP IRAs impractical for businesses with employees, pushing owners toward [Solo 401(k)](/wiki/solo-401k-mechanics/) or [401(k) plans](/wiki/401k-plan/) where employer contributions can be discretionary or formulaic.
...
- **Before age 59.5:** 10% penalty + ordinary income tax (with narrow exceptions for disability, education, first-time home purchase under [Roth rules](/wiki/roth-ira/), etc.).
- **At 73 and older:** [Required minimum distributions](/wiki/required-minimum-distribution-personal/) based on life expectancy tables must be taken annually.
- **Rollovers:** SEP funds can be rolled into other IRAs or [401(k) plans](/wiki/401k-plan/) without tax.

No special tax-deferred exchanges (like [1031 exchanges](/wiki/1031-like-kind-exchange/) for real estate) apply; the account is purely retirement-savings sheltered.
...
### Closely related
- [Solo 401(k) Mechanics](/wiki/solo-401k-mechanics/) — alternative for high-income self-employed
- [Traditional IRA](/wiki/ira-traditional/) — baseline retirement account with lower limits
- [Roth IRA](/wiki/roth-ira/) — tax-free-growth alternative
