---
title: "Solo 401k Mechanics"
description: "How a solo 401k plan allows self-employed workers to save up to $66,000 annually with employer and employee contributions."
keywords:
  - solo 401k mechanics
...
| Attribute | Detail |
|-----------|--------|
| **Participant** | Self-employed, with no eligible employees |
| **2024 limit** | Up to $69,000 (or $76,500 age 50+) |
| **Contributions** | Employee deferral + employer contribution |
| **Catch-up age** | 50 and above |
| **Loan provision** | Up to $50,000 or 50% of balance |
| **Required minimum distribution** | Begins at 73 |
| **Filing requirement** | Form 5500-SF if assets > $250K |

</aside>

## Why self-employed workers choose Solo 401ks

A self-employed consultant, freelancer, or sole proprietor faces retirement-savings constraints. A traditional [IRA](/wiki/ira-traditional/) has a $7,000 annual limit (2024). A [SEP IRA](/wiki/sep-ira-self-employed/) can accept 25% of net self-employment income, but requires that income to be meaningful. A Solo 401k, by contrast, permits two distinct contributions that stack:
...
Unlike [traditional IRAs](/wiki/ira-traditional/), Solo 401ks permit loans to the participant. You may borrow up to the lesser of $50,000 or 50% of your account balance, with a five-year repayment period (unless the loan is used for primary residence purchase, which may extend it). Loan interest is paid to your own account, meaning you recover that interest inside the plan.

Distributions before age 59½ trigger a 10% early withdrawal penalty and [ordinary income tax](/wiki/ordinary-dividend/), except in cases of disability, medical hardship, or Rule of 55 (if the plan is separated from an employer plan). [Required Minimum Distributions (RMDs)](/wiki/required-minimum-distribution-personal/) begin at age 73 under current law.
...
Note that [Backdoor Roth](/wiki/backdoor-roth-mechanics/) conversions of traditional Solo 401k balances require careful coordination with pro-rata rules if you hold other IRAs.
...
- [401k plan](/wiki/401k-plan/) — The employer-sponsored version for large firms.
- [SEP IRA](/wiki/sep-ira-self-employed/) — A simpler (but lower-limit) option for self-employed.
- [IRA traditional](/wiki/ira-traditional/) — The baseline retirement account structure.
- [Roth IRA](/wiki/roth-ira/) — Post-tax savings alternative.
- Self-employment income — How net profit is computed.

### Wider context

- Retirement-tax — Tax treatment across all retirement accounts.
- [Capital gains tax](/wiki/capital-gains-tax/) — How plan investments are taxed (inside plans: deferred).
- [Itemized deduction](/wiki/itemized-deduction-investor/) — Whether to itemize or take the standard deduction.
- Estimated tax — Quarterly payment obligations for self-employed.
