...
description: "Support and resistance are price levels where buying interest (support) or selling interest (resistance) is expected to emerge, causing price to pause or reverse."
keywords:
  - support
  - resistance
  - price level
...
| **Origin** | Psychological/technical levels where traders cluster orders |
| **Identification** | Where price has bounced (support) or turned back (resistance) |
| **Strength** | Stronger after multiple tests; stronger at round numbers |
| **Breakout** | When price closes decisively above resistance, it may become new support |
| **Reversal** | When price bounces off support or resistance, a reversal may follow |
| **False break** | Price can breach a level only to reverse back; fakeouts are common |
