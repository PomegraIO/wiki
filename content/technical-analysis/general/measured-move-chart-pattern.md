---
title: "Measured Move in Chart Patterns"
description: "The measured move chart pattern projects a minimum price target after a breakout by using the pattern's height as the expected move distance."
keywords:
  - measured move chart pattern
  - chart pattern price target
  - pattern breakout projection
...
<div class="wiki-infobox-title">Measured Move — key facts</div>

<img src="/svg/technical-analysis.svg" alt="An abstract editorial mark for technical analysis." />

<div class="wiki-infobox-caption">Pattern height becomes the expected move distance.</div>

|   |   |
|---|---|
| **Core rule** | Pattern height = expected move distance from breakout |
| **Application** | Works on rectangles, triangles, head-and-shoulders, flags |
| **Direction** | Upside move = pattern height added to neckline or breakout point; downside = subtracted |
| **Confidence level** | Minimum target; price can exceed it, often does |
| **Frequency** | Approximate; many breakouts fall short or overshoot |
| **Best used with** | Volume confirmation, support/resistance levels, momentum |
