---
title: "Wedge pattern"
description: "A wedge pattern consists of two converging trendlines (like a triangle) but with a directional bias, signalling either reversal or continuation depending on context."
keywords:
  - wedge
  - pattern
  - consolidation
...
|   |   |
|---|---|
| **Structure** | Two converging lines, both sloped (not parallel) |
| **Rising wedge** | Both lines slope upward; bullish appearance, often bearish signal |
| **Falling wedge** | Both lines slope downward; bearish appearance, often bullish signal |
| **Context matters** | Within uptrend or downtrend determines reversal vs. continuation |
| **Duration** | Weeks or months; longer patterns more significant |
| **Volume** | Declines as wedge develops; surges on breakout |
| **Breakout direction** | Can be either; context-dependent |
| **Reliability** | Moderate; improved with confirmation |
| **False signals** | Possible; require volume confirmation |
