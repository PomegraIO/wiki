...
keywords:
  ...
  - volume climax technical analysis
  - volume climax down
  - selling climax technical signal
---
...
1. **Absolute volume**: Trading volume in a single session is 2× to 5× the average, or at multi-month/multi-year extremes.
2. **Proximity to a price extreme**: The spike occurs at the lowest low in N weeks or the highest high in N weeks (N typically 10–50 weeks, depending on the timeframe).
3. **Acceleration**: Volume increases *within* the session (early volume is heavy, not just an anomalous open).
4. **Directionality**: All or nearly all of the volume is on one side of the market (nearly all selling at a bottom, nearly all buying at a top).
...
- [Support and Resistance](/support-and-resistance/) — price levels where reversals often occur
- [Momentum Investing](/momentum-investing/) — the behavior that drives volume spikes and their exhaustion
- Technical Analysis — broader framework for chart patterns and price action
- [Market Maker Trading](/market-maker-trading/) — how order flow and liquidity relate to price reversals
- [Volatility](/volatility-smile/) — spikes in volume often accompany spikes in volatility

### Wider context

- [Moving Average](/moving-average/) — confirmation indicators alongside volume analysis
- [Trend Following](/trend-following/) — opposite of reversal-seeking; when climax signals fail
- [Overconfidence Bias](/overconfidence-bias/) — psychological driver of buying and selling climaxes
- [Algorithmic Trading](/algorithmic-trading/) — how machine trading can trigger or suppress volume spikes
- [Price Discovery](/price-discovery/) — how extreme volume reflects disruption in normal market pricing
