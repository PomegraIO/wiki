---
title: "Spinning top"
description: "A spinning top is a candlestick with a small body and wicks extending both above and below, signalling market indecision and lack of clear direction."
keywords:
  - spinning top
  - candlestick
  - indecision
...
|   |   |
|---|---|
| **Body size** | Small; typically 1/3 of full range or less |
| **Body position** | Near middle of range |
| **Wicks** | Both directions; can be balanced or unequal |
| **Interpretation** | Indecision, consolidation, pause in trend |
| **Colour** | Can be green or red; less important than size |
| **Context significance** | More meaningful in strong trends than in flat markets |
| **Reliability** | Low as standalone signal; requires confirmation |
| **False signals** | Common; spinning tops appear frequently |
| **Wick distinction** | If unequal, longer wick hints at next direction |
