...
description: "A candlestick chart is a style of price chart that displays the open, high, low, and close prices for each time period as a vertical bar with rectangular 'body' and thin 'wicks'."
keywords:
  - candlestick
  - chart
  - price
...
|   |   |
|---|---|
| **What it shows** | Open, high, low, close prices per period |
| **Time axis** | Horizontal (left to right) |
| **Price axis** | Vertical (bottom to top) |
| **Candle body** | Rectangle between open and close |
| **Upper wick** | Line from body to the period's high |
| **Lower wick** | Line from body to the period's low |
| **Bullish candle** | Close > open; typically green |
| **Bearish candle** | Close < open; typically red |
| **Time period** | Minute, hour, day, week, month, or custom |
| **Origin** | Japan, Edo period (1600s–1800s) |
