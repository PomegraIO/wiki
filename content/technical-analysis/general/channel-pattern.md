...
description: "A channel pattern is formed by two parallel trendlines—one connecting highs, one connecting lows—showing price oscillating within a bounded zone."
keywords:
  - channel
  - pattern
  - support
...
|   |   |
|---|---|
| **Structure** | Two parallel trendlines (support and resistance) |
| **Ascending channel** | Higher lows, higher highs; uptrend within bounds |
| **Descending channel** | Lower lows, lower highs; downtrend within bounds |
| **Horizontal channel** | Flat highs, flat lows; ranging market |
| **Oscillation** | Price bounces between support and resistance |
| **Breakout** | Close above upper line or below lower line |
| **Direction of breakout** | Often leads to move in breakout direction |
| **False breaks** | Possible; require volume/follow-up confirmation |
| **Trade setups** | Buy at support, sell at resistance (within channel) |
