---
title: "Head and Shoulders Pattern: The Neckline Explained"
description: "The neckline in a head-and-shoulders pattern is the key line that generates the trade signal. Learn how to draw it, why its slope matters, and how to confirm the breakout."
keywords:
  - head and shoulders neckline explained
  - neckline reversal pattern
  - head shoulders pattern trading
  - neckline break signal
...
<div class="wiki-infobox-title">Head and Shoulders Neckline — key facts</div>

<img src="/svg/technical-analysis.svg" alt="An abstract editorial mark for technical analysis." />

<div class="wiki-infobox-caption">The neckline break triggers the reversal trade.</div>

|   |   |
|---|---|
| **Definition** | Line connecting the two shoulder lows |
| **Signal** | Break below the neckline confirms downtrend reversal |
| **Slope impact** | Flat is most reliable; upward slope weakens bearish signal; downward slope strengthens it |
| **Confirmation** | Retest of neckline after break; ideally bounces and resumes downtrend |
| **Profit target** | Pattern height measured from head to neckline, projected downward from neckline break |
| **False breaks** | Close above neckline on high volume can invalidate pattern and reverse the signal |
