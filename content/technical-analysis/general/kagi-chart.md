---
title: "Kagi chart"
description: "A kagi chart displays price movement as vertical lines that change thickness and direction based on price reversals, a price-based chart that ignores time."
keywords:
  - kagi
  - technical analysis
  - price-based chart
...
|   |   |
|---|---|
| **Basis** | Price movement and reversals, not time |
| **Line direction** | Vertical; changes when reversal occurs |
| **Thin line** | Continuation in current direction |
| **Thick line** | Line crosses a previous high/low (reversal strength) |
| **Reversal trigger** | Price moves opposite direction by set amount |
| **Time axis** | Absent; irrelevant to the chart |
| **Advantage** | Clear reversal identification, support/resistance |
| **Disadvantage** | Unusual appearance, difficult to read initially |
| **Best for** | Identifying support/resistance, reversal strength |
| **Poor for** | Real-time decisions, entry/exit timing |
