...
description: "A descending triangle is a bearish chart pattern with a falling upper trendline (resistance) and a flat lower trendline (support), converging toward a downward breakout."
keywords:
  - descending triangle
  - pattern
  - bearish
...
For converging patterns broadly, see [symmetrical triangle](/technical-analysis/symmetrical-triangle). The bullish equivalent is the [ascending triangle](/technical-analysis/ascending-triangle).
...
|   |   |
|---|---|
| **Upper line** | Falling (resistance); lower highs |
| **Lower line** | Flat (support); horizontal lows |
| **Direction** | Converging; range narrows |
| **Breakout direction** | Downward; below the lower line |
| **Psychological signal** | Sellers gaining; buyers holding a line |
| **Volume** | Typically declines as pattern develops; surges on breakout |
| **Time to breakout** | Usually within days to weeks |
| **Reliability** | Higher than single-line patterns; bearish bias |
| **Failure rate** | Can fail if price breaks above resistance instead |
...
An [ascending triangle](/technical-analysis/ascending-triangle) is the bullish opposite: a rising lower line and flat upper line, converging toward an upward breakout. The logic inverts: buyers are gaining strength (rising lows) while sellers defend a flat level.
...
- [Ascending triangle](/technical-analysis/ascending-triangle) — bullish inverse
