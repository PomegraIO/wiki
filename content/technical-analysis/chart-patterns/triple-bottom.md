---
title: "Triple bottom"
description: "A triple bottom is a bullish reversal pattern consisting of three approximately equal lows separated by two rallies, indicating exhaustion of a downtrend."
keywords:
  - triple bottom
  - pattern
  - reversal
...
|   |   |
|---|---|
| **Structure** | Three troughs at approximately same level |
| **Peaks** | Two highs between the three troughs |
| **Trough distances** | Separated by time (weeks/months) |
| **Reversal signal** | Close above both peak highs |
| **Volume** | Declines with each bounce (consolidation) |
| **Significance** | Higher than double bottom; rarer |
| **Measuring objective** | Peak height above troughs = upside target |
| **Reliability** | Moderate to high; support strength |
| **False signals** | Less common than double bottoms |
