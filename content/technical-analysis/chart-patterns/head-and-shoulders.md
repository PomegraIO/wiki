...
description: "Head and shoulders is a bearish reversal pattern consisting of three peaks—a lower left shoulder, a taller head, and a lower right shoulder—with equal lows connecting them."
keywords:
  - head and shoulders
  - pattern
  - reversal
...
|   |   |
|---|---|
| **Structure** | Three peaks: shoulder, head, shoulder |
| **Neckline** | Approximately horizontal line through two lows |
| **Head height** | Higher than both shoulders |
| **Shoulders** | Approximately equal heights |
| **Reversal signal** | Price closes below neckline |
| **Volume pattern** | Typically declines from left shoulder to right |
| **Measuring objective** | Head height above neckline = downside target |
