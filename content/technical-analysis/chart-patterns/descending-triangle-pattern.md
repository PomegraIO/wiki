...
description: "Chart pattern with flat support and declining resistance, typically predicting downward breakout."
keywords:
  - descending triangle
  - chart pattern
  - technical analysis
...
| Aspect | Detail |
|--------|--------|
| **Pattern Type** | Continuation or reversal (bearish bias) |
| **Support Level** | Flat, horizontal, at lower end of pattern |
| **Resistance Line** | Sloping downward from upper left to lower right |
| **Duration** | Typically 2–6 weeks, though can span months |
| **Breakout Direction** | Downward in ~60–70% of cases |
| **Volume** | Usually decreases as triangle narrows; spike on breakout |
| **Price Target** | Distance from triangle height projected downward from breakout point |
| **Risk Factor** | False breakouts occur; price sometimes recovers above resistance |
| **Most Common Timeframe** | Intraday to weekly charts; less reliable on daily+ charts |
...
1. **Volume profile**: Breakouts accompanied by rising volume are more reliable than breakouts on declining volume. A breakout on light volume is more likely to reverse.
2. **Prior context**: A triangle in a strong downtrend is more bearish than a triangle in a neutral environment.
3. **Support strength**: The cleaner and more horizontal the support line, the more significant the breakout is likely to be.
4. **Timeframe**: Patterns on daily and weekly charts are more reliable than intraday patterns, which are noisier and subject to intraday mean reversion.
...
1. Identifying the pattern (flat support, declining resistance).
2. Placing a short entry just below support with a tight stop-loss above resistance.
3. Setting a profit target at the height of the triangle projected downward.
4. Exiting if price breaks above the declining resistance line, invalidating the pattern.
...
Professional traders combine descending triangles with other signals: [momentum indicators](/wiki/macd-indicator/), [volume analysis](/wiki/on-balance-volume/), and broader market context. A descending triangle in a sector undergoing fundamental deterioration is more actionable than one in an otherwise healthy sector.

<div class="wiki-seealso">

### Closely related
- <a href="/wiki/ascending-triangle-pattern/">/wiki/ascending-triangle-pattern/</a> — The bullish mirror pattern
- <a href="/wiki/symmetrical-triangle-breakout/">/wiki/symmetrical-triangle-breakout/</a> — Pattern with converging lines of equal steepness
- <a href="/wiki/support-and-resistance/">/wiki/support-and-resistance/</a> — Key price levels in technical analysis
...
- <a href="/wiki/mean-reversion-investing/">/wiki/mean-reversion-investing/</a> — Contrarian approach to reversals
