...
description: "Price move through convergence point of falling resistance and rising support."
keywords:
...
| Element | Details |
|---|---|
| **Pattern** | Converging trendlines (both slopes equal magnitude) |
| **Formation time** | Days to weeks; creates compressed volatility |
| **Breakout signal** | Close beyond upper or lower trendline |
| **Volume requirement** | Increased volume on breakout; confirms validity |
| **Target projection** | Height of triangle at base, measured from breakout point |
| **Reliability** | 60–70% breakout success; direction unpredictable |
...
**Options strategy:** Buy an out-of-the-money call (for upside) and an [OTM put](/wiki/out-of-the-money-expiration/) (for downside) before the apex, betting on volatility expansion. A straddle at the triangle's apex profits from large moves in either direction.
...
### Closely related
- [Ascending Triangle](/wiki/ascending-triangle/) — Bullish variant
...
- [Volume Breadth Analysis](/wiki/volume-breadth-divergence/) — Confirmation indicator
- [Momentum Factor](/wiki/momentum-factor/) — Economics of breakout persistence
- [Volatility Smile](/wiki/volatility-smile/) — Options pricing during compression
- [Market Timing](/wiki/market-timing/) — Risk of pattern-based strategies
