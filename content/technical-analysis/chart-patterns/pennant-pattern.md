...
description: "A pennant pattern is a continuation pattern consisting of a sharp move (the pole) followed by a small triangle-shaped consolidation (the pennant), before resumption of the original trend."
keywords:
  - pennant
  - pattern
  - continuation
...
|   |   |
|---|---|
| **Pole** | Sharp, substantial price move (5-20%+) |
| **Pennant** | Small converging triangle after pole |
| **Height** | Pennant typically 4-8% of pole height |
| **Duration** | Pole days/weeks; pennant typically 5-15 days |
| **Lines** | Converging upper and lower lines forming apex |
| **Volume** | High on pole; very low in pennant; surges on breakout |
| **Breakout direction** | Original pole direction |
| **Reliability** | Very high; strong continuation signal |
| **Measuring** | Pole height = continuation distance from breakout |
| **False signals** | Very rare if pattern is well-formed |
