...
description: "A rectangle pattern is a chart formation with two flat horizontal lines forming a bounded consolidation zone, signalling eventual breakout in either direction."
keywords:
  - rectangle
  - pattern
  - consolidation
...
|   |   |
|---|---|
| **Structure** | Two flat parallel horizontal lines |
| **Width** | Typically weeks; wider rectangles are stronger |
| **Breakout direction** | Neutral; can be up or down |
| **Number of bounces** | Three or more off each boundary |
| **Volume** | Declines during formation; surges on breakout |
| **Measuring objective** | Width of rectangle = move from breakout point |
| **Reliability** | Moderate; breakout direction unpredictable |
| **False breaks** | Possible; volume and confirmation matter |
| **Context** | Can be bullish continuation (within uptrend) or bearish (within downtrend) |
