...
description: "Chart pattern with a flat upper resistance line and rising lower support line, suggesting bullish continuation or reversal."
keywords:
  - ascending triangle
  - chart pattern
  - technical analysis
...
| Feature | Description |
|---|---|
| **Formation** | Flat ceiling, rising floor |
| **Convergence** | Lines meet after 2–4 weeks typically |
| **Breakout Signal** | Close above upper resistance (bullish) |
| **Breakdown Signal** | Close below lower support (bearish, less common) |
| **Volume** | Often increases on breakout |
| **Price Target** | Height of triangle added to breakout point |
