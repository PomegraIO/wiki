...
description: "An ascending triangle is a bullish chart pattern with a rising lower trendline (support) and a flat upper trendline (resistance), converging toward a breakout."
keywords:
  - ascending triangle
  - pattern
  - bullish
...
| **Upper line** | Flat (resistance); horizontal highs |
| **Direction** | Converging; range narrows |
| **Breakout direction** | Upward; above the upper line |
| **Psychological signal** | Buyers gaining; sellers holding a line |
| **Volume** | Typically declines as pattern develops; surges on breakout |
| **Time to breakout** | Usually within days to weeks |
| **Reliability** | Higher than single-line patterns; bullish bias |
| **Failure rate** | Can fail if price breaks below support instead |
