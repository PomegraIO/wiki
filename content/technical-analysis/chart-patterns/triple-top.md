---
title: "Triple top"
description: "A triple top is a bearish reversal pattern consisting of three approximately equal peaks separated by two valleys, indicating exhaustion of an uptrend."
keywords:
  - triple top
  - pattern
  - reversal
...
|   |   |
|---|---|
| **Structure** | Three peaks at approximately same height |
| **Valleys** | Two lows between the three peaks |
| **Peak distances** | Separated by time (weeks/months) |
| **Reversal signal** | Close below both valley lows |
| **Volume** | Declines with each failed rally (exhaustion) |
| **Significance** | Higher than double top; rarer |
| **Measuring objective** | Valley height below peaks = downside target |
| **Reliability** | Moderate to high; exhaustion signal |
| **False signals** | Less common than double tops |
