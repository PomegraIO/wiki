---
title: "Double top"
description: "A double top is a bearish reversal pattern consisting of two approximately equal peaks separated by a valley, signalling an end to an uptrend."
keywords:
  - double top
  - pattern
  - reversal
...
|   |   |
|---|---|
| **Structure** | Two peaks at approximately same height |
| **Peak separation** | Multiple days or weeks |
| **Valley low** | Support level between peaks |
| **Peak distance** | Close enough that they appear related |
| **Reversal signal** | Price closes below valley low |
| **Volume** | Typically declines on second peak (less conviction) |
| **Measuring objective** | Valley height below peaks = downside target |
| **Reliability** | Moderate; less reliable than H&S |
| **False signals** | Possible; fakeouts below valley common |
