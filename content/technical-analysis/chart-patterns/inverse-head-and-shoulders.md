...
description: "Inverse head and shoulders is a bullish reversal pattern consisting of three troughs—a lower right shoulder, a deeper head, and a lower right shoulder—with equal highs connecting them."
keywords:
...
|   |   |
|---|---|
| **Structure** | Three troughs: shoulder, head, shoulder |
| **Neckline** | Approximately horizontal line through two highs |
| **Head depth** | Lower than both shoulders |
| **Shoulders** | Approximately equal depths |
| **Reversal signal** | Price closes above neckline |
| **Volume pattern** | Typically declines from left shoulder to right |
| **Measuring objective** | Head depth below neckline = upside target |
| **Reliability** | Moderate to high relative to other patterns |
