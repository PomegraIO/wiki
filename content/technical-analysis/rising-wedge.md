---
title: "Rising wedge"
description: "A rising wedge is a chart pattern with two upward-sloping converging lines, often signalling a bearish reversal when in an uptrend."
keywords:
  - rising wedge
  - pattern
  - reversal
...
|   |   |
|---|---|
| **Structure** | Two upward-sloping converging lines |
| **Upper line** | Rising resistance |
| **Lower line** | Rising support |
| **Convergence** | Lines meet at apex |
| **In uptrend context** | Reversal pattern; bearish signal |
| **At uptrend top** | Exhaustion signal; downward break expected |
| **Breakout signal** | Above upper line (bullish) or below lower line (bearish) |
| **Most likely break** | Downward if exhaustion; upward if continuation |
