---
title: "Evening star"
description: "An evening star is a three-candle bearish reversal pattern consisting of a large bullish candle, a gap up with a small candle, and a large bearish candle. It signals exhaustion of an uptrend."
keywords:
  - evening star
  - candlestick
  - reversal
...
| **First candle** | Large bullish (green), part of ongoing uptrend |
| **Second candle** | Small body; gaps above first candle's high |
| **Third candle** | Large bearish (red); closes into first candle |
| **Gap requirement** | Second candle should open above first candle's high |
| **Interpretation** | Bullish trend exhausted, bearish reversal |
| **Reliability** | Modest; requires additional confirmation |
| **Context** | After significant uptrend, at resistance |
| **False signals** | Possible, especially in strong uptrends |
