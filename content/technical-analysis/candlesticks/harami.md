---
title: "Harami"
description: "A harami is a two-candle pattern where a small candle's range sits entirely within the previous candle's range, signalling indecision and potential consolidation before a reversal."
keywords:
  - harami
  - candlestick
  - pattern
...
|   |   |
|---|---|
| **Number of candles** | Exactly two |
| **Definition** | Second candle fits entirely within first candle's range |
| **Key measurements** | Second high < first high; second low > first low |
| **Bullish harami** | Large red candle followed by smaller candle (any colour) |
| **Bearish harami** | Large green candle followed by smaller candle (any colour) |
| **Interpretation** | Indecision, momentum loss, consolidation |
| **Context matters** | After strong moves; at resistance/support |
| **False signals** | Can occur in choppy markets; requires confirmation |
| **Reversal likelihood** | Modest; depends on context and follow-up |
