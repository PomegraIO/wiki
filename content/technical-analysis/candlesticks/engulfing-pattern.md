...
description: "An engulfing pattern is a two-candle formation where a large candle completely contains the range of the preceding smaller candle, signalling a reversal of the prior trend."
keywords:
  - engulfing
  - candlestick
  - reversal
...
| **Definition** | Second candle's range envelops first candle's range |
| **Bullish engulfing** | Red candle followed by larger green candle |
| **Bearish engulfing** | Green candle followed by larger red candle |
| **Key requirement** | Second candle must open below/above and close beyond first candle |
| **Wicks** | Wicks can be present; what matters is the body relationship |
| **Reversal strength** | Stronger after sharp moves; stronger at key levels |
| **False signals** | Possible; occur in noise and within trends |
| **Reliability** | Modest to moderate; higher with additional confirmation |
