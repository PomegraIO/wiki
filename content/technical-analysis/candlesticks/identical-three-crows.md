---
title: "Identical Three Crows: A Bearish Candlestick Variant Explained"
description: "The identical three crows candlestick pattern—three black candles with matching opening prices—signals especially strong selling momentum and is stricter than Three Black Crows."
keywords:
  - identical three crows candlestick
  - three black crows variant
  - bearish candlestick pattern
  - equal-open bearish pattern
  - three candle reversal
  - technical analysis bearish signal
...
<div class="wiki-infobox-title">Identical Three Crows — Key Facts</div>

<img src="/svg/technical-analysis.svg" alt="An abstract editorial mark for technical analysis." />

<div class="wiki-infobox-caption">A rare, tightly structured bearish formation.</div>

|   |   |
|---|---|
| **Pattern type** | Bearish reversal or strong downtrend continuation |
| **Number of candles** | Three consecutive black candles |
| **Critical rule** | Each candle opens at approximately the same price |
| **Body behavior** | Each candle closes lower than the prior; bodies may be similar |
| **Context** | Appears in uptrends near resistance or in established downtrends |
| **Key difference from Three Black Crows** | Strict equal-open requirement |
| **Strength implication** | Selling strength is synchronized and relentless |
| **Confirmation** | Continued weakness or break below support |
