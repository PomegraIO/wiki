---
title: "Hanging man"
description: "A hanging man is a candlestick with a small body and a long lower wick, identical in shape to a hammer but appearing after an uptrend. It signals potential bearish reversal, indicating that sellers may overwhelm buyers."
keywords:
  - hanging man
  - candlestick
  - reversal
...
| **Lower wick** | Long; 2x or more the body length |
| **Upper wick** | Short or absent |
| **Colour** | Usually red or green; colour is secondary to context |
| **Interpretation** | Bearish reversal signal, rallies exhausted |
| **Context** | Forms after an uptrend or at resistance |
| **Reliability** | Higher after a sustained rally; lower in flat markets |
| **Distinction from hammer** | Position in trend: top (hanging man) vs. bottom (hammer) |
| **False signals** | Requires confirmation; can be false in very strong uptrends |
