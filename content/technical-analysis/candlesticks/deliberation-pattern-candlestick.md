---
title: "Deliberation Pattern: A Three-Candle Bearish Warning"
description: "The deliberation candlestick pattern—three white candles with shrinking bodies near a high—signals potential reversal and exhaustion in an uptrend."
keywords:
  - deliberation pattern candlestick
  - three white candles
  - bearish reversal signal
  - candlestick exhaustion pattern
...
<div class="wiki-infobox-title">Deliberation Pattern — Key Facts</div>

<img src="/svg/technical-analysis.svg" alt="An abstract editorial mark for technical analysis." />

<div class="wiki-infobox-caption">A three-candle warning of weakening momentum in an uptrend.</div>

|   |   |
|---|---|
| **Pattern type** | Bearish reversal or exhaustion signal |
| **Number of candles** | Three consecutive white candles |
| **Location** | Near resistance or after a prolonged uptrend |
| **Body behavior** | Each candle has a smaller body than the last |
| **Opening logic** | Each candle opens within the previous body |
| **Closing signal** | Prices cluster; gaps close or trades sideways |
| **Confirmation** | Bearish reversal (break below the pattern) |
