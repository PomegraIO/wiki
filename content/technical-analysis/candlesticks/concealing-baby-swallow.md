---
title: "Concealing Baby Swallow: A Rare Bullish Reversal Pattern"
description: "The concealing baby swallow candlestick pattern—a four-candle bullish formation in downtrends with strict identification rules—signals potential trend reversal."
keywords:
  - concealing baby swallow candlestick
  - bullish reversal pattern
  - four candle pattern
  - downtrend reversal signal
  - rare candlestick formation
  - technical analysis reversal
...
<div class="wiki-infobox-title">Concealing Baby Swallow — Key Facts</div>

<img src="/svg/technical-analysis.svg" alt="An abstract editorial mark for technical analysis." />

<div class="wiki-infobox-caption">A rare, strictly defined four-candle bullish reversal signal.</div>

|   |   |
|---|---|
| **Pattern type** | Bullish reversal in a downtrend |
| **Number of candles** | Four candles with specific structure |
| **First two candles** | Long black candles (strong selling) |
| **Last two candles** | Short white candles, confined within the second black body |
| **Strictness level** | High—specific opens and closes required |
| **Frequency** | Rare in live trading |
| **Confirmation signal** | Breakout above the second black candle's high |
| **Risk/reward** | High confidence when identified correctly |
