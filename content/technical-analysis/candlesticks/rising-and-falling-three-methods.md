...
description: "A five-candle continuation pattern in which a long trend candle brackets three small counter-trend candles, followed by a breakout in the original trend direction—signalling continued momentum."
keywords:
  - candlestick pattern
  - technical analysis
...
<div class="wiki-infobox-title">Rising and Falling Three Methods — key facts</div>

<img src="/svg/technical-analysis.svg" alt="An abstract editorial mark for technical analysis and candlestick patterns." />

<div class="wiki-infobox-caption">A long trend candle bracketing three small counter-trend candles, then a breakout in the original trend direction.</div>

|   |   |
|---|---|
| **What it is** | Five candles total; candle 1 is long and trending; candles 2–4 are small and against the trend; candle 5 breaks out past candle 1 in the trend direction |
| **Also called** | Three methods; gap three methods (when gaps are present); trend continuation with small candles |
| **Rising version** | Candle 1 is long up; candles 2–4 are small down; candle 5 closes above candle 1's high |
| **Falling version** | Candle 1 is long down; candles 2–4 are small up; candle 5 closes below candle 1's low |
| **Reliability** | Moderately strong; very reliable when candles 2–4 stay within candle 1's range and candle 5 breaks cleanly |
| **Typical context** | Mid-trend consolidation; signals continuation after brief resistance |
