---
title: "Marubozu"
description: "A marubozu is a candlestick with no upper or lower wick—or virtually none—with the open and high at the same level (or very close) and the close and low at the same level. It signals strong conviction and momentum in one direction."
keywords:
  - marubozu
  - candlestick
  - conviction
...
|   |   |
|---|---|
| **Definition** | No upper or lower wicks (or negligible) |
| **Bullish marubozu** | Open = low, close = high; green candle |
| **Bearish marubozu** | Open = high, close = low; red candle |
| **Body size** | The full range of the period |
| **Wicks** | Absent or minimal |
| **Interpretation** | Strong conviction, one side in control |
| **Context significance** | In an uptrend: bullish; in downtrend: bearish |
| **Reliability** | Higher than most single-candle patterns |
| **Volume role** | High volume confirms the conviction |
