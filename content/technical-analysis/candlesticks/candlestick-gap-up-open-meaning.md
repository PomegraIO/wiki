---
title: "Gap-Up Open on a Candlestick Chart: What It Means"
description: "A gap-up open on a candlestick chart occurs when the opening price jumps above the prior session's high. Understand what gap-up opens signal and how follow-through confirms them."
keywords:
  - gap up open candlestick
  - gap up opening meaning
  - candlestick gaps
  - price gap overnight
  - gap continuation
...
<div class="wiki-infobox-title">Gap-Up Open — Key Facts</div>

<img src="/svg/technical-analysis.svg" alt="An abstract editorial mark for technical analysis." />

<div class="wiki-infobox-caption">A price jump at the open that reveals overnight buying interest.</div>

|   |   |
|---|---|
| **Definition** | Opening price > prior session's high |
| **Cause** | Overnight news, earnings, economic data, or order imbalance |
| **Initial signal** | Buying interest before market open |
| **Confirmation** | Strong close and follow-up sessions; volume matters |
| **Gap fill risk** | Unconfirmed gaps often fill (reverse) within days |
| **Common in** | Stocks with earnings announcements, indices on economic data |
| **Candlestick appearance** | White or black candle starting above the prior high |
