---
title: "Three Outside Up and Down"
description: "A three-candle continuation pattern where the second candle engulfs the first, and the third candle closes further in the engulfing direction—confirming sustained directional momentum."
keywords:
  - candlestick pattern
  - technical analysis
...
<div class="wiki-infobox-title">Three Outside Up and Down — key facts</div>

<img src="/svg/technical-analysis.svg" alt="An abstract editorial mark for technical analysis and candlestick patterns." />

<div class="wiki-infobox-caption">An engulfing pattern (two candles) validated by a third candle that closes further in the engulfing direction.</div>

|   |   |
|---|---|
| **What it is** | Three-candle pattern; second candle completely engulfs the first; third candle closes past the second in the engulfing direction |
| **Also called** | Engulfing continuation; outside day continuation |
| **Bullish setup** | First candle down; second candle up (engulfs the first); third candle up (closes above second's close) |
| **Bearish setup** | First candle up; second candle down (engulfs the first); third candle down (closes below second's close) |
| **Reliability** | Moderate to moderately strong; more reliable than engulfing alone when confirmed |
| **Typical context** | Trend reversals or strong continuation moves; signals resumed directional conviction |
