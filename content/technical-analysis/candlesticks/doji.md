---
title: "Doji"
description: "A doji is a candlestick in which the open and close prices are approximately equal, resulting in a thin or absent body with wicks extending above and below. It signals market indecision."
keywords:
  - doji
  - candlestick
  - indecision
...
|   |   |
|---|---|
| **Definition** | Open ≈ close, long wicks both directions |
| **Body size** | Minimal or non-existent |
| **Wick structure** | Often balanced above and below |
| **Interpretation** | Market indecision, balance of power |
| **Context matters** | At support/resistance, after climax, before reversals |
| **Reliability** | Mixed; most reliable when at key price levels |
| **Common variations** | Long-legged doji, gravestone doji, dragonfly doji |
| **False signals** | Frequent; requires confirmation |
