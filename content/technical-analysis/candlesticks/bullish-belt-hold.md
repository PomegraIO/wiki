---
title: "Belt Hold"
description: "A single-candle pattern that opens at its extreme and closes near the opposite end, signalling an abrupt shift in market sentiment—a reversal or continuation marker depending on context."
keywords:
  - candlestick pattern
  - technical analysis
...
<div class="wiki-infobox-title">Belt Hold — key facts</div>

<img src="/svg/technical-analysis.svg" alt="An abstract editorial mark for technical analysis and candlestick patterns." />

<div class="wiki-infobox-caption">A single candle that opens at one extreme and closes near the opposite, marking a sharp sentiment flip.</div>

|   |   |
|---|---|
| **What it is** | Single candle; opens at its high (bearish) or low (bullish); closes near the opposite end |
| **Also called** | Belt hold line; shaved candle (loosely); gap reversal (when it opens above or below prior close) |
| **Bullish setup** | Opens at the low; closes near the high; typically after a downtrend or down candle |
| **Bearish setup** | Opens at the high; closes near the low; typically after an uptrend or up candle |
| **Reliability** | Moderate; stronger when preceded by extended move in the opposite direction |
| **Typical context** | Reversal signals; can also appear as continuation after a brief pullback |
