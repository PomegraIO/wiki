---
title: "Three Inside Up and Down"
description: "A three-candle pattern where the second candle is contained within the first, and the third candle confirms the direction of the inside pair—extending the reversal or continuation signal."
keywords:
  - candlestick pattern
  - technical analysis
  - harami continuation
...
<div class="wiki-infobox-title">Three Inside Up and Down — key facts</div>

<img src="/svg/technical-analysis.svg" alt="An abstract editorial mark for technical analysis and candlestick patterns." />

<div class="wiki-infobox-caption">A two-candle reversal (harami) validated by a third candle moving in the signal's direction.</div>

|   |   |
|---|---|
| **What it is** | Three-candle pattern; second candle inside the first; third candle closes past the second in the harami's direction |
| **Also called** | Harami continuation; inside day continuation |
| **Bullish setup** | First candle down (long); second candle up (small, inside); third candle up (closes above second's close) |
| **Bearish setup** | First candle up (long); second candle down (small, inside); third candle down (closes below second's close) |
| **Reliability** | Moderate; more reliable than harami alone, less certain than engulfing patterns |
| **Typical context** | Mid-trend; signals continuation or early reversal validation after indecision |
...
A long first candle shows conviction in one direction. The tiny second candle, nestled inside the first, creates visual contrast and signals that the prior direction has lost its grip. Crucially, the pattern acknowledges that many traders who see a harami don't act immediately—they wait for confirmation. The third candle gives it to them. By closing beyond the harami's close, it signals that the sellers or buyers (whichever were outnumbered on day two) have now regained control.

This is a *continuation* pattern because it typically occurs after an established trend has already reversed or is about to. It is less about predicting an entirely new move and more about saying, "The old trend has stalled; the new move is now resuming." The three-candle sequence is also psychologically coherent: strong directional move, loss of confidence, renewed conviction.

## Spotting it in different contexts

In an uptrend that is starting to roll over, you might see a strong down candle (the first), followed by a small up candle (the harami—hope from the bulls), followed by another down candle that closes lower. That's the bearish version: sellers have taken control, and the move down is likely to extend.

The bullish mirror applies after a downtrend starts to recover: a strong up candle, a small down candle, then a strong up candle that closes higher. Sellers were unable to hold the rally, and the recovery continues.

The pattern is cleaner when the first candle is notably longer than the second; a near-equal pair is less convincing. Similarly, the third candle should close decisively past the second, not just barely edge out. A close that merely equals the second candle's close is ambiguous—you want clear evidence of resumed directional pressure.
