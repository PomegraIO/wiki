...
| Aspect | Detail |
|--------|--------|
| **Scope** | Usually NYSE, NASDAQ, or Russell 3000 |
| **Window** | 52 weeks (one year) |
| **Frequency** | Daily, published with market close |
| **Interpretation** | Divergence signals caution; alignment confirms strength |
| **Overbought signal** | Many new highs, few new lows = stretched market |
| **Oversold signal** | Many new lows, few new highs = market bottom |
...
- **[Advance-decline line](/wiki/market-breadth-advances-declines/)**: The cumulative count of advancing stocks minus declining stocks. It trends upward in healthy markets and downward in distressed ones.
...
### Closely related
- [Market Breadth Advances Declines](/wiki/market-breadth-advances-declines/) — Daily advancing and declining stock counts.
- [Breadth Thrust Indicator](/wiki/breadth-thrust-indicator/) — Sudden jump in breadth marking a bottom.
- [Support and Resistance](/wiki/support-and-resistance/) — Price levels that historically matter.
- [Accumulation Distribution](/wiki/accumulation-distribution/) — Breadth-based momentum indicator.
