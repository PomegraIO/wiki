...
<div class="wiki-infobox-title">New Highs–New Lows — key facts</div>

<img src="/svg/technical-analysis.svg" alt="An abstract editorial mark for the topic." />

<div class="wiki-infobox-caption">When new lows expand amid a rally, breadth is deteriorating.</div>

|   |   |
|---|---|
| **Raw data** | Daily count of stocks at 52-week highs and lows |
| **Typical use** | Ratio of highs to lows, or smoothed difference line |
| **Bull signal** | High-to-low ratio expanding; lows shrinking during uptrend |
| **Bear signal** | Lows expanding; highs compressing during downtrend |
| **Timeframe** | Most useful on daily or weekly; monthly less granular |
| **False signals** | Can lag price by 1–3 weeks; less reliable in range-bound markets |
| **Best paired with** | [Advance-decline line](/momentum-investing/), [percentage above 200-day MA](/percentage-stocks-above-200-day-moving-average/), price trends |
...
- **[Percentage of stocks above 200-day MA](/percentage-stocks-above-200-day-moving-average/):** shows what fraction of the market is in a sustained uptrend.
...
- [Percentage of Stocks Above the 200-Day Moving Average](/percentage-stocks-above-200-day-moving-average/) — another core breadth gauge with longer-term signal value
- [Breadth Divergence in a Bull Market](/breadth-divergence-bull-market/) — how to use new highs–new lows to spot when price and breadth diverge
- [Breadth Thrust Signal: How Rare](/breadth-thrust-signal-how-rare/) — the bullish flip: when new highs suddenly surge with conviction
- [Advance-Decline Line](/momentum-investing/) — a complementary breadth measure covering all stocks
- [Moving Average](/momentum-investing/) — understanding 52-week reference frames

### Wider context

- [Technical Analysis](/momentum-investing/) — the broader discipline of price and volume interpretation
- [Bull Market](/bull-market/) — the uptrend where breadth deterioration matters most
- [Momentum Investing](/momentum-investing/) — using breadth to build and defend convictions
- [Volatility](/volatility-smile/) — how breadth compression often precedes volatility spikes
- [Market Capitalization](/market-capitalization/) — understanding how size affects index movement and breadth
