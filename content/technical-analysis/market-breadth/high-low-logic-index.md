...
<div class="wiki-infobox-title">High-Low Logic Index — key facts</div>

<img src="/svg/technical-analysis.svg" alt="An abstract editorial mark for technical analysis." />

<div class="wiki-infobox-caption">A breadth lens that focuses on how many losers are hitting 52-week bottoms relative to all extremes.</div>

|   |   |
|---|---|
| **What it is** | Ratio: new 52-week lows ÷ (new highs + new lows), expressed as a percentage |
| **Created by** | Norman Fosback, technical analyst and market researcher |
| **Normal range** | Typically 20–30% in healthy markets; above 50% signals stress |
| **Interpretation** | High readings = breadth weakness; more new lows relative to total extremes; often contrarian bullish when extreme |
| **Signal strength** | Most useful at turning points or divergences with price |
| **Time horizon** | Days to several weeks forward |
...
The High-Low Logic Index works best alongside the [advance/decline line](/advance-decline-line/), [NYSE TICK](/nyse-tick-indicator/), and [Hindenburg Omen](/hindenburg-omen/). A day with an extreme High-Low Logic reading (70%+ new lows) *plus* a negative advance/decline *plus* a second [Hindenburg Omen](/hindenburg-omen/) in a week is a serious convergence of bearish breadth—far more convincing than any single measure alone.
...
Professional technicians treat the High-Low Logic Index as one dial on a dashboard. It doesn't stand alone. It confirms or questions what the [price-to-earnings ratio](/price-to-earnings-ratio/), [yield curve](/yield-curve/), [credit spreads](/credit-spread/), and sector leadership are telling you. When all arrows point the same direction—breadth weak, valuations stretched, spreads widening—the case for caution is strong. When breadth signals conflict with price momentum, it's time to dig deeper.
...
- [Hindenburg Omen](/hindenburg-omen/) — breadth divergence flagging simultaneous highs and lows; a more extreme version of what High-Low Logic measures
- [Advance/Decline Line](/advance-decline-line/) — cumulative breadth over time; the foundational measure of how many stocks participate
- [NYSE TICK Indicator](/nyse-tick-indicator/) — real-time intraday breadth pulse; complements daily new-highs/lows analysis
- [Upside/Downside Volume Ratio](/upside-downside-volume-ratio/) — volume confirmation of breadth moves; shows conviction
...
- [Support and Resistance](/support-and-resistance/) — levels where breadth extremes often cluster
