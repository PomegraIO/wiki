...
description: "A technical pattern where price falls, bounces, falls again to the same level, and bounces a second time, signaling strong support."
keywords:
  - double bottom
  - support level
  - technical pattern
...
| **Time frame** | Days to weeks; longer patterns more significant |
| **Confirmation** | Volume typically increases on second bounce |
| **Neckline** | Resistance level between the two bounces (break triggers rally) |
| **Prerequisite** | Clear downtrend preceding the bottoms |
| **Similar patterns** | V-shaped recovery, triple bottom, rounding bottom |
...
- **Divergence from other indicators**: A double bottom with no uptick in [relative strength index (RSI)](/wiki/rsi-relative-strength/) or [moving averages](/wiki/moving-average/) is less convincing than one that is confirmed by momentum divergence.
...
3. **Contrast with momentum**: If a stock has double-bottomed but [MACD](/wiki/macd-indicator/) is negative or [RSI](/wiki/rsi-relative-strength/) is below 40, the reversal conviction is weakened. The pattern is most powerful when multiple indicators align.

## Relationship to broader support and resistance

A double bottom at a key [support level](/wiki/support-zone-floor/)—particularly one that has held across multiple tests over months or years—carries more weight than an arbitrary support level. A double bottom at the 200-day [moving average](/wiki/moving-average/) carries more weight than one at a random price. Technical analysts pay attention to whether the double-bottom support aligns with other identified [support and resistance](/wiki/support-and-resistance/) zones.

Additionally, a double bottom at a [psychological level](/wiki/price-anchoring/) (like $100 or $1000) may draw extra interest from retail and algorithmic traders, potentially strengthening the support.
...
- [Double top](/wiki/double-top/) — The bearish inverse pattern.
- [Triangle pattern](/wiki/ascending-triangle/) — Another reversal pattern.
- [Cup and handle](/wiki/cup-and-handle/) — A related continuation pattern.
- [Rounding bottom](/wiki/rounding-bottom/) — A slower, broader version of reversal.
