---
title: "Support and Resistance in a Sideways Market"
description: "In sideways (range-bound) markets, horizontal support and resistance levels form clear boundaries. Breakouts are common, but false breaks and fakeouts multiply."
keywords:
  - support and resistance sideways market
...
<div class="wiki-infobox-title">Support and Resistance in Sideways Markets — key facts</div>

<img src="/svg/technical-analysis.svg" alt="An abstract editorial mark for the topic." />

<div class="wiki-infobox-caption">Sideways markets make levels obvious but breakouts unreliable.</div>

|   |   |
|---|---|
| **What sideways means** | Price oscillates within a narrow band; no clear uptrend or downtrend |
| **Support level** | Price floor that buyers defend repeatedly |
| **Resistance level** | Price ceiling that sellers defend repeatedly |
| **Width of range** | Usually 2–5% of price in mature assets; can be tighter |
| **Typical duration** | Weeks to months; can signal accumulation or indecision |
| **Fakeout frequency** | High; price breaks level, reverses, and traps momentum traders |
| **Volume behavior** | Often low; picks up on breakout attempts; retreats on reversals |
...
**The Temptation:**
A trader observes the pattern and thinks: "The range is obvious. I'll buy just above $100 and sell just below $105, earn 4.8% over and over."
...
**Why It Failed:**
No catalyst drove the move above $105. The breakout had no follow-through. Sellers were waiting at the old resistance level (now seen as an exit opportunity) and overwhelmed the few buyers chasing the breakout.
...
### [Support and Resistance](/support-and-resistance/) Role Reversal
...
1. Recognize the range and trade it efficiently for small profits.
2. Watch for the catalyst or volume shift that signals a breakout is coming.
3. Be prepared to pivot strategies when the sideways phase ends.
...
- [Support and Resistance](/support-and-resistance/) — foundational technical analysis concept
- [Price Discovery](/price-discovery/) — how true prices emerge from order flow
- [Market Maker Trading](/market-maker-trading/) — insider perspective on fakeouts and stop-loss hunting
- [Trend Following](/trend-following/) — trading strategy that avoids sideways markets
- [Moving Average](/moving-average/) — identifies trend direction and confirms range-bound conditions
