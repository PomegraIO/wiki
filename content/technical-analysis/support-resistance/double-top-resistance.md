---
title: "Double Top Resistance"
description: "Two consecutive price peaks at approximately the same level, followed by a decline—a technical pattern signaling potential reversal and future resistance if the price recovers."
keywords:
  - double top
  - resistance level
  - chart pattern
...
| Aspect | Detail |
|--------|--------|
| **Pattern components** | Two peaks at ~same price; valley (trough) between them |
| **Timeframe** | Weeks to months (daily charts); hours to days (intraday) |
| **Frequency** | Common and reliable pattern across equities, futures, forex |
| **Breakdown target** | Price declines roughly the distance of peak–trough (projection) |
| **Volume signature** | Volume typically lighter on second peak (weaker conviction) |
| **Similar pattern** | [Double bottom](/wiki/double-bottom/) is the bullish reversal mirror image |
| **False positives** | Patterns can fail if volume is high on second peak (no reversal) |
...
**Hourly and intraday chart double tops** appear frequently in [algorithmic trading](/wiki/algorithmic-trading/) and [high-frequency trading](/wiki/high-frequency-trading/) strategies. Hourly double tops can signal 2–5% moves within a single trading day.

**Longer-term (weekly or monthly) double tops** often signal major reversals. The peak-to-trough distance is larger (in percentage terms), so the projection is more significant. A double top on a monthly chart might signal a decline of 20%+ and a shift to a [bear market](/wiki/bear-market/).

Double tops appear reliably in all markets: equity indices ([S&P 500](/wiki/sp-500-index/), [NASDAQ](/wiki/nasdaq/)), individual stocks, [commodity futures](/wiki/commodity-futures-rolling/) (crude oil, gold), [forex pairs](/wiki/currency-pair/) ([EUR/USD](/wiki/eur-gbp-euro-sterling/)), and [cryptocurrencies](/wiki/cryptocurrency-exchange/).

## Double tops vs. other reversal patterns

A double top is distinct from:
- **[Head and shoulders](/wiki/head-and-shoulders/)**: Three peaks (high–higher–high); much more bearish than a double top.
- **[Rounding top](/wiki/rounding-top/)**: Gradual curve downward over weeks; no sharp peaks.
- **[Inverse head and shoulders](/wiki/inverse-head-and-shoulders/)**: A bullish reversal with three valleys, mirror image of head and shoulders.
...
Not all double tops lead to reversals. In a strong uptrend, a double top might fail (the pattern breaks up instead), and the asset continues higher. This is particularly true in [bull markets](/wiki/bull-market/) where buyers are aggressive and pullbacks are shallow. Conversely, in a [bear market](/wiki/bear-market/), false breakdowns (where price falls below the trough but quickly recovers) can trap short-sellers.

Sophisticated traders manage this by:
- Setting a [stop-loss](/wiki/stop-order/) just above the first peak; if the price clears that, the pattern has failed.
...
In the 1980s–1990s, trading systems based on double top patterns had high hit rates (60–70% of reversals succeeded). In the post-2000s, with increased [passive indexing](/wiki/index-fund/) and [automated trading](/wiki/algorithmic-trading/), the pattern's success rate has arguably declined as algorithms front-run and fade moves more efficiently.

## Double tops in different market regimes

In [high-volatility](/wiki/volatility-index-futures/) regimes (VIX > 25), false double tops are more common because price action is choppy and does not respect technical levels. In low-volatility regimes (VIX < 12), double tops are more reliable because orderly price action is more likely to respect support and resistance.

<div class="wiki-seealso">

### Closely related
- [Double Bottom Support](/wiki/double-bottom-support/) — The bullish mirror image of double top
- [Support and Resistance](/wiki/support-and-resistance/) — Overview of technical levels and how they form
- [Head and Shoulders](/wiki/head-and-shoulders/) — A more complex three-peak reversal pattern
