---
title: "Support Zone Floor"
description: "Price level where buying interest consistently emerges; technical barrier that tends to cap downside movement."
keywords:
...
| Aspect | Description |
|---|---|
| **Formation** | Repeated price bounces from the same level, or psychological round numbers |
| **Strength** | Stronger if touched 3+ times without breaking; older levels are often stronger |
| **Width** | Typically 1-2% band, not a single price point |
| **Duration** | Can persist for weeks, months, or years depending on timeframe |
| **Breakage** | Once support breaks, it often becomes resistance; momentum accelerates downward |
| **Volume Clue** | High volume on bounces confirms support; low volume makes it fragile |
...
### Closely related
- [Resistance Zone Ceiling](/wiki/resistance-zone-ceiling/) — The complement to support; where selling pressure emerges.
- [Dynamic Support Resistance](/wiki/dynamic-support-resistance/) — Support and resistance that move with price (e.g., trailing stop-losses).
- [Trendline](/wiki/trendline/) — A line connecting support (or resistance) touches; helps identify future support levels.
- [Breakout Trading](/wiki/breakout-trading/) — Exploits support and resistance breaks as trade signals.
