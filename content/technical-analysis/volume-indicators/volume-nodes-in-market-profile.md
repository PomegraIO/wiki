---
title: "Volume Nodes in Market Profile: High and Low Node Trading"
description: "Volume nodes in market profile: high-volume nodes (HVN) and low-volume nodes (LVN), how price stalls at support and resistance, and acceleration through thin areas."
keywords:
  - volume-nodes-market-profile
...
<div class="wiki-infobox-title">Volume Nodes — key facts</div>

<img src="/svg/technical-analysis.svg" alt="An abstract editorial mark for the topic." />

<div class="wiki-infobox-caption">Price behavior differs sharply where trading volume concentrates versus where it thins out.</div>

|   |   |
|---|---|
| **Definition** | Price levels identified by abnormally high or low trade volume |
| **HVN (high-volume node)** | Zone where price stalls; often support or resistance |
| **LVN (low-volume node)** | Zone where price accelerates; thin market, few transactions |
| **Basis** | Market profile charting method; Volume Profile indicator |
| **Time frame** | Relevant across intraday, swing, and longer-term charts |
| **Indicator type** | Support/resistance derived from actual order flow |
...
High-volume nodes represent active [price discovery](/price-discovery/)—the process by which buyers and sellers find an equilibrium price through actual trading. An HVN is a "fair value" area where the market settled, at least temporarily. Low-volume nodes often occur where [liquidity](/liquidity-risk/) thinned, perhaps because one side of the market stepped away or participants moved to a different price level faster than usual. Market-making theory predicts that LVNs are less liquid; fewer [market makers](/market-maker-trading/) may be willing to provide tight spreads in a gap. This lack of liquidity can amplify price movement through LVNs—a small buy or sell order can move the price more when the order book is thin. Traders and [brokers](/broker/) watching volume profile can gauge market health and liquidity at each level, adjusting order strategy accordingly.

## Limitations and Market Context

Volume nodes are statistical artifacts of recent price action and do not guarantee future price behavior. An HVN that was meaningful over a single day may dissolve if market conditions or fundamentals shift sharply. Gaps in the profile (LVNs) are sometimes created by illiquidity or a mismatch between order flow, not a reason to expect price to accelerate there later. Macro events, earnings surprises, or major [central bank](/central-bank/) announcements can invalidate the assumptions embedded in a historical profile. Additionally, volume profile can be gamed: in some markets, sophisticated players may layer orders at key levels to create the appearance of volume, then pull them when price approaches. Retail traders should use volume nodes as one signal among many—alongside price [momentum](/momentum-investing/), broader [volatility](/historical-volatility/) context, and [trend-following](/trend-following/) indicators—rather than as a deterministic rule.
...
- [Support and resistance](/support-and-resistance/) — price levels where reversals or consolidations often occur
- [Market maker trading](/market-maker-trading/) — how liquidity is supplied at different price levels
- [Price discovery](/price-discovery/) — the process by which markets find fair value
- [Momentum investing](/momentum-investing/) — trading based on price trends and velocity
- [Liquidity risk](/liquidity-risk/) — the cost and difficulty of transacting in size

### Wider context

- [Historical volatility](/historical-volatility/) — measure of past price swings
- [Broker](/broker/) — intermediary facilitating transactions
- [Derivative hedging](/derivatives-hedging/) — using options or futures to manage risk
- [Central bank](/central-bank/) — institution controlling money supply and rates
