...
<div class="wiki-infobox-title">Intraday volume — The typical pattern</div>

<img src="/svg/technical-analysis.svg" alt="An abstract editorial mark for technical analysis." />

<div class="wiki-infobox-caption">Volume clusters at open and close, dips in the middle.</div>

|   |   |
|---|---|
| **Highest volume** | Market open (first 30 minutes) and final 30 minutes before close |
| **Lowest volume** | 11:00 AM to 1:00 PM (typical US equity markets) |
| **Why** | Gap orders, overnight news, institutional rebalance, expiration clustering |
| **Exceptions** | Options/futures expiry days, earnings announcements, macroeconomic data |
| **Trader type** | Open/close driven by institutional, algorithmic; midday driven by retail |

</aside>

## The U-Shaped Intraday Volume Curve

In virtually all major equity, [futures](/futures-contract/), and options markets, **volume does not distribute evenly across the trading day**. Instead, it follows a distinctive U-shaped pattern that repeats with enough regularity to serve as a reference point for traders interpreting market activity.
...
**Portfolio rebalancing** by funds tied to [index](/index-fund/) closing prices: if a fund or algorithm targets a specific weight at day's end, it needs to execute by 4:00 PM to lock in a closing price.

**Options expiration clustering**: if it is the third Friday of the month (equity options expiration), or any expiration day for [futures](/futures-contract/) or other [derivatives](/derivatives-hedging/), the final hour sees a flood of rolling and closing trades.
...
The closing price also carries symbolic weight: it is the price reported in news headlines, used in portfolio valuations, and used to compute [moving averages](/moving-average/) for technical signals. This makes the closing hour a key inflection point for both fundamental and technical traders.
...
**Volatility expansions**, such as a [circuit breaker](/circuit-breaker/) halt or a flash crash, can turn the pattern upside down. An unexpected gap on a VIX spike might bring heavy volume at midday as investors rush to hedge.
...
- [Market-maker trading](/market-maker-trading/) — Makers adjust spreads based on intraday volatility and expected volume
- [Algorithmic trading](/algorithmic-trading/) — Algorithms execute in ways that follow and sometimes amplify the U-shape
- Technical analysis — Framework within which intraday volume is interpreted
- [Volatility](/historical-volatility/) — Intraday volatility also tends to be highest at open and close

### Wider context

- [Stock exchange](/stock-exchange/) — Venues where intraday volume patterns are observed
- [Bid-ask spread](/bid-ask-spread/) — Widest at open, narrowest at midday
- [Futures contract](/futures-contract/) — Show similar U-shaped patterns in volume
- [Options](/option/) — Options volume clustering at expiry overrides typical patterns
- [Trend following](/trend-following/) — Algos that pile in at the close can amplify momentum
