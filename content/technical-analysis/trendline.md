---
title: "Trendline"
description: "A trendline is a straight line drawn on a chart connecting two or more price points, used to identify and confirm the direction and slope of a price trend."
keywords:
  - trendline
  - trend
  - uptrend
...
|   |   |
|---|---|
| **Uptrend line** | Connects rising lows; support in uptrend |
| **Downtrend line** | Connects falling highs; resistance in downtrend |
| **Minimum points** | Two (but three is more reliable) |
| **Slope** | Steeper slopes = faster trends; shallow = slower |
| **Break signal** | Price closing below uptrend or above downtrend may signal reversal |
| **False breaks** | Common; require confirmation |
| **Time axis** | Horizontal; trendline extends into future |
| **Advantage** | Simple, visual, dynamic support/resistance |
| **Disadvantage** | Subjective; different traders draw different lines |
