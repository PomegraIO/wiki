---
title: "Hammer candle"
description: "A hammer candle is a candlestick with a small body at the top and a long lower wick, resembling a hammer. It signals that buyers defended a lower price level and is often interpreted as a bullish reversal signal."
keywords:
  - hammer
  - candlestick
  - reversal
...
For single-candle patterns more broadly, see [candlestick pattern](/technical-analysis/candlestick-pattern). The opposite pattern is the [shooting star](/technical-analysis/shooting-star).
...
|   |   |
|---|---|
| **Body position** | Upper part of the candle's range |
| **Lower wick** | Long; typically 2x or more the body length |
| **Upper wick** | Short or absent |
| **Colour** | Usually green (bullish), but red hammers occur |
| **Interpretation** | Bullish reversal, support defended |
| **Reliability** | Higher when at support, after downtrend |
| **Context** | Forms after decline, at support/resistance |
| **False signals** | Can occur in consolidation; requires confirmation |
| **Similar pattern** | [Dragonfly doji](/technical-analysis/doji) — balanced wicks |
...
A hammer forming at a known [support level](/technical-analysis/support-and-resistance) (a prior swing low, a key moving average, a round number) is also more tradeable. The level itself is a "line in the sand" where buyers have defended before; a hammer reinforces that that defence held.
...
The **long lower wick with a small body near the middle** is more hammer-like than a **long lower wick with the body at the very top**. The latter is closer to the appearance of a [gravestone doji](/technical-analysis/doji) (inverted).

## Hammer versus hanging man

The hammer and [hanging man](/technical-analysis/hanging-man) have identical shapes—a small body with a long lower wick. The only difference is context: a hammer forms at the bottom of a downtrend and is bullish, while a hanging man forms at the top of an uptrend and is bearish. This illustrates a cardinal rule of candlestick analysis: **shape alone is insufficient; context determines meaning**.
...
- [Hanging man](/technical-analysis/hanging-man) — same shape, bearish context
- [Shooting star](/technical-analysis/shooting-star) — upper wick reversal
...
- [Support and resistance](/technical-analysis/support-and-resistance) — where hammers gain meaning
...
- [Relative strength index](/technical-analysis/relative-strength-index) — momentum confirmation
