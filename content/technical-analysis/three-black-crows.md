...
description: "Three black crows is a bearish continuation pattern of three consecutive bearish candles, each opening within the prior candle's body and closing near its low, showing steady selling pressure."
keywords:
  - three black crows
  - candlestick
  - continuation
...
| **Candle colour** | All red (bearish) |
| **Opening positions** | Each opens within previous body |
| **Closing positions** | Each closes near its low |
| **Size progression** | Ideally equal or slightly increasing |
| **Wicks** | Short or absent on bottom; may have small upper wicks |
| **Interpretation** | Continuation, strong downtrend |
| **Context** | Within a downtrend; at resistance |
| **Reliability** | Higher than reversal patterns; confirms trend |
| **False signals** | Rare within established downtrends |
