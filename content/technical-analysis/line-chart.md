---
title: "Line chart"
description: "A line chart plots only closing prices as a single continuous line, the simplest form of price visualization and often the clearest for identifying long-term trends."
keywords:
  - line chart
  - close price
  - technical analysis
...
|   |   |
|---|---|
| **What it shows** | Closing price only |
| **Visual format** | Continuous line connecting closes |
| **Time axis** | Horizontal (left to right) |
| **Price axis** | Vertical (bottom to top) |
| **Open price** | Not shown |
| **High price** | Not shown |
| **Low price** | Not shown |
| **Advantage** | Simplicity, clarity, noise reduction |
| **Disadvantage** | Misses gaps, intraday ranges, patterns |
| **Best for** | Long-term trends, uncluttered view |
| **Poor for** | Pattern recognition, volatility analysis |
