...
description: "A cup and handle is a bullish continuation pattern consisting of a rounded bottom (the cup) followed by a shallow pullback (the handle), signalling resumption of an uptrend."
keywords:
  - cup and handle
  - pattern
  - bullish
...
|   |   |
|---|---|
| **Context** | Within uptrend; continuation signal |
| **Cup shape** | U-shaped, rounded bottom (not V-shaped) |
| **Cup depth** | Typically 1/3 or less of the cup's width |
| **Handle** | Shallow pullback on right side of cup |
| **Handle depth** | Less deep than the cup |
| **Breakout signal** | Close above the cup's rim (top) |
| **Volume** | Declines in cup and handle; surges on breakout |
| **Measuring objective** | Cup height above breakout level = upside target |
| **Reliability** | Moderate to high for continuation patterns |
| **Time horizon** | Weeks to months; longer patterns more reliable |
...
## Cup and handle within larger trends
