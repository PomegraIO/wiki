---
title: "Shooting star"
description: "A shooting star is a candlestick with a small body at the bottom and a long upper wick, resembling a star falling from the sky. It signals potential bearish reversal, indicating that buyers failed to sustain higher prices."
keywords:
  - shooting star
  - candlestick
  - reversal
...
|   |   |
|---|---|
| **Body position** | Lower part of the candle's range |
| **Upper wick** | Long; typically 2x or more the body length |
| **Lower wick** | Short or absent |
| **Colour** | Usually red (bearish), but green shooting stars occur |
| **Interpretation** | Bearish reversal, rally exhaustion |
