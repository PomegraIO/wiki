...
description: "A rounding bottom is a bullish reversal pattern with a U-shaped price formation, showing gradual reversal from downtrend to uptrend without sharp reversals."
keywords:
  - rounding bottom
  - reversal
  - bullish
...
|   |   |
|---|---|
| **Shape** | Smooth U or saucer; no sharp V |
| **Time** | Weeks to months; slow reversal |
| **Volume** | Typically low during formation; increases on recovery |
| **Reversal signal** | Sustained close above prior resistance |
| **Depth** | Often significant (20-40% retracement) |
| **Bottom shape** | Rounded, not sharp; suggests accumulation |
| **Reliability** | Moderate to high for reversals |
| **Measuring** | Height of pattern = upside target from bottom |
