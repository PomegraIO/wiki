...
description: "A symmetrical triangle is a chart pattern with converging upper and lower trendlines of equal slope, signalling price will eventually break out in either direction."
keywords:
...
|   |   |
|---|---|
| **Upper line** | Falling at steady angle; lower highs |
| **Lower line** | Rising at steady angle; higher lows |
| **Convergence** | Equal rate; symmetrical |
| **Breakout direction** | Unpredictable; neutral pattern |
| **Volume** | Typically declines in pattern; surges on breakout |
| **Time to breakout** | Usually completes in days or weeks |
| **Reliability** | Moderate; breakout follows if confirmed |
| **Context sensitivity** | Breakout direction often follows broader trend |
| **False breaks** | Possible; volume and confirmation matter |
