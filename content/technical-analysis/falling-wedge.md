---
title: "Falling wedge"
description: "A falling wedge is a chart pattern with two downward-sloping converging lines, often signalling a bullish reversal when in a downtrend."
keywords:
  - falling wedge
  - pattern
  - reversal
...
For wedges broadly, see [wedge-pattern](/technical-analysis/wedge-pattern). The opposite pattern is [rising-wedge](/technical-analysis/rising-wedge).
...
|   |   |
|---|---|
| **Structure** | Two downward-sloping converging lines |
| **Upper line** | Declining resistance |
| **Lower line** | Declining support |
| **Convergence** | Lines meet at apex |
| **In downtrend context** | Continuation pattern; further down expected |
| **At downtrend bottom** | Reversal pattern; bullish signal |
| **Breakout signal** | Above upper line (bullish) or below lower line (bearish) |
| **Most likely break** | Upward if at downtrend exhaustion; downward if continuation |
| **Volume** | Declines during formation; surges on breakout |
| **Reliability** | Moderate to high depending on context |
...
A [rising-wedge](/technical-analysis/rising-wedge) is the opposite pattern: both lines slope upward but converge. A rising wedge in an uptrend often signals exhaustion and reversal downward.
...
- [Rising-wedge](/technical-analysis/rising-wedge) — upward-sloping converging lines
...
- [Double-bottom](/technical-analysis/double-bottom) — bullish reversal alternative

### Context

- [Support and resistance](/technical-analysis/support-and-resistance) — wedge boundaries
- [Trendline](/technical-analysis/trendline) — identifying downtrend
