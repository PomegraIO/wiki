---
title: "Rounding top"
description: "A rounding top is a bearish reversal pattern with an inverted U-shaped price formation, showing gradual reversal from uptrend to downtrend."
keywords:
  - rounding top
  - reversal
  - bearish
...
|   |   |
|---|---|
| **Shape** | Inverted U or saucer; no sharp inverted V |
| **Time** | Weeks to months; slow reversal |
| **Volume** | Typically declines during formation |
| **Reversal signal** | Sustained close below prior support |
| **Height** | Often significant (20-40% of prior rally) |
| **Top shape** | Rounded, not sharp; suggests distribution |
| **Reliability** | Moderate to high for reversals |
| **Measuring** | Height of pattern = downside target from top |
