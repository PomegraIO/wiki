---
title: "Morning star"
description: "A morning star is a three-candle reversal pattern consisting of a large bearish candle, a gap down with a small candle, and a large bullish candle. It signals a shift from bearish to bullish momentum."
keywords:
  - morning star
  - candlestick
  - reversal
...
| **First candle** | Large bearish (red), part of ongoing downtrend |
| **Second candle** | Small body; gaps below first candle's low |
| **Third candle** | Large bullish (green); closes into first candle |
| **Gap requirement** | Second candle should open below first candle's low |
| **Interpretation** | Bearish trend exhausted, bullish reversal |
| **Reliability** | Modest; requires additional confirmation |
| **Context** | After significant downtrend, at support |
| **False signals** | Possible, especially in choppy markets |
