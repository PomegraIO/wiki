---
title: "Day trading"
description: "Day trading is a strategy of buying and selling securities intraday, opening and closing positions within a single trading session to avoid overnight risk and exploit minute-by-minute price movements."
keywords:
  - day trading
  - intraday trading
  - same-day trading
...
For overnight holding, see [swing trading](/swing-trading/). For longer-term trading, see [position trading](/position-trading/). For ultra-short-term, see [scalping](/scalping/).
...
|   |   |
|---|---|
| **Holding period** | Minutes to hours; liquidated by day's end |
| **Time commitment** | Full-time during market hours |
| **Capital required** | $25,000+ (pattern day trader rule) |
| **Tools** | Real-time quotes, charting, order execution |
| **Risk** | Intraday volatility, slippage, emotions, costs |
| **Regulatory** | Pattern day trader rules (3 round-trips in 5 days) |
| **Success rate** | Extremely low; 90%+ of retail day traders lose |
...
1. **Avoid overnight gaps.** Overnight news, international events, or [Fed](/federal-reserve/) announcements can gap stocks 5%+ or more. Day traders avoid this by not holding overnight.
...
- [Swing-trading](/swing-trading/) — slightly longer holding period
- [Scalping](/scalping/) — ultra-short intraday trading
- [Position trading](/position-trading/) — multi-day to multi-week holding
- [Market timing](/market-timing/) — intraday entry-exit decisions
- [Technical analysis](/stock-market/) — the methodology

### Wider context

- [Stock](/stock/) — the underlying instrument
- [Volatility](/alpha/) — intraday price movement
- [Bid-ask spread](/stock-exchange/) — cost factor
- [Short-selling](/short-selling/) — common day-trading tool
