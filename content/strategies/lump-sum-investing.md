...
description: "Lump-sum investing is a strategy of investing available capital all at once, rather than spreading it across multiple purchases, betting that the market's long-term upward bias outweighs timing risk."
keywords:
  - lump sum investing
  - investing capital at once
...
For the alternative (fixed-amount regular investing), see [dollar-cost averaging](/dollar-cost-averaging/). For behavioral context, see [market timing](/market-timing/).
...
|   |   |
|---|---|
| **Core idea** | Deploy available capital immediately; market rises over time |
| **Timing** | One-time investment, immediate |
| **Advantage** | Captures full market upside; simplicity |
| **Disadvantage** | Risk of investing just before a crash |
| **Holding period** | Long-term |
| **Research** | Academic evidence favors lump-sum slightly |
| **Reality** | Many investors lack lump-sum availability |
...
- [Dollar-cost averaging](/dollar-cost-averaging/) — the alternative approach
- [Market timing](/market-timing/) — trying to time lump-sum deployment
- [Asset allocation](/asset-allocation/) — lump-sum as part of rebalancing
- [Index-fund](/index-fund/) — common lump-sum vehicle
- [Compound interest](/compound-interest/) — long-term lump-sum effect

### Wider context

- [Stock](/stock/) — the underlying instrument
- [Bear market](/bear-market/) — timing risk
- [Bull market](/bull-market/) — lump-sum advantage
- [Volatility](/alpha/) — short-term risk
