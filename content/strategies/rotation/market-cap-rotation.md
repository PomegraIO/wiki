...
keywords:
  ...
  - tactical allocation
  - style rotation
description: "Rotating between large-cap and small-cap stocks; driven by economic cycles and relative valuations."
---
...
| Aspect | Detail |
|---|---|
| **Core idea** | Allocate more to small when growth is accelerating; to large when slowing |
| **Valuation signal** | Small-cap P/E, large-cap P/E, relative spreads |
| **Economic indicator** | GDP growth, earnings growth expectations, yield curve |
| **Performance drivers** | Interest rates, [beta](/wiki/beta/), [earnings surprises](/wiki/earnings-surprise-drift/) |
| **Frequency** | Tactical (quarterly to annual rebalancing); active timing |
| **Risk** | Timing risk; rotation doesn't always follow expectations |
...
### Early recovery
Economic growth is accelerating from a trough. Corporate earnings are improving, particularly for smaller companies (more sensitive to growth, higher [beta](/wiki/beta/)).
...
**Large-cap advantage:**
- Defensive characteristics: stable dividends, [pricing power](/wiki/pricing-committee/), global diversification.
...
### Recession
Earnings collapse. Small-caps decline faster ([higher beta](/wiki/beta/)), but large-caps provide cushion via dividends and balance sheet strength. By recession trough, small-caps are cheap; large-caps have compressed but held up relatively.
...
### Factor exposure via [smart beta](/wiki/smart-beta-etf/)
Size is one of the classic [factors](/wiki/factor-investing/). Smart beta ETFs isolate size exposure:
- **Size premium funds**: Tilt toward small-cap, capturing the historical size premium.
- **Dynamic allocation**: Adjust exposure based on [valuation](/wiki/multiples-valuation/), value, or momentum.

### Options and derivatives
More sophisticated traders use [options](/wiki/option/) to express views without committing capital:
...
[Momentum investing](/wiki/momentum-investing/) can overpower rotation logic. If large-caps are trending up strongly (positive momentum, strong earnings), they may outperform small-caps despite worse valuations and a slowing economy.
...
- **Tax efficiency**: Frequent rotation triggers [capital gains](/wiki/capital-gains-tax/). In taxable accounts, tax-loss harvesting and patient execution are important.
...
- **Liquidity**: Small-cap ETFs are liquid but less so than large-cap. Large rotations may have [market impact](/wiki/market-impact-cost/).

<div class="wiki-seealso">

### Closely related
- [Large-cap stock](/wiki/sp-500-index/) — primary vehicle for overweight
- [Small-cap investing](/wiki/small-cap-etf/) — complementary vehicle
- [Value vs. growth rotation](/wiki/dividend-vs-growth-rotation/) — related rotation
- [Business cycle](/wiki/business-cycle/) — driver of rotation
