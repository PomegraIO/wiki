...
description: "Sector rotation is a strategy of shifting portfolio exposure among industry sectors based on the stage of the economic cycle, betting that different sectors outperform at different times."
keywords:
  - sector rotation
  - economic cycle
  - sector timing
...
For geographic rotation, see [geographic-rotation](/geographic-rotation/). For style rotation, see [style-rotation](/style-rotation/). For macro analysis underlying rotation, see [top-down investing](/top-down-investing/).
...
|   |   |
|---|---|
| **Core idea** | Different sectors lead at different cycle stages |
| **Time horizon** | 3–12 months typically |
| **Typical cycle** | Early recovery → mid expansion → late expansion → contraction |
| **Rebalancing** | Quarterly or semi-annually |
| **Conviction required** | Medium; requires macro forecast |
| **Success factor** | Accurate cycle timing |
| **Risk** | Rotation can be late; leadership can shift unexpectedly |
...
1. **Forecasts the economic cycle.** When will the next recession hit? Will growth accelerate? Will [inflation](/inflation/) rise?
2. **Maps sectors to cycle stages.** Identifies which sectors should outperform in the predicted environment.
3. **Rebalances systematically.** Shifts weight from underperforming sectors to expected leaders.
4. **Monitors and adjusts.** Watches economic data and re-forecasts quarterly or semi-annually.
...
- [Geographic-rotation](/geographic-rotation/) — country/region tilts
- [Style-rotation](/style-rotation/) — value/growth timing
- [Capital-rotation](/capital-rotation/) — intra-portfolio shifting
- [Top-down investing](/top-down-investing/) — the macro foundation
- [Business cycle](/recession/) — the underlying driver

### Wider context

- [Stock market](/stock-market/) — the venue
- [Economic cycles](/recession/) — the timing signal
- [Interest-rate](/interest-rate/) — sector driver
- [Inflation](/inflation/) — sector driver
