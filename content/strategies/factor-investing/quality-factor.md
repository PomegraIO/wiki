...
description: "Quality-factor investing systematically targets stocks of profitable, financially healthy, well-managed companies, betting that these business qualities drive long-term excess returns."
keywords:
  - quality factor
  - quality stocks
...
For the broader factor framework, see [factor investing](/factor-investing/). For systematic quality via indices, see [smart-beta](/smart-beta/). For profitability specifically, see [profitability-factor](/profitability-factor/).
...
|   |   |
|---|---|
| **Core idea** | High-quality businesses deliver superior returns |
| **Key metrics** | Return on equity, debt-to-equity, earnings stability, dividend consistency |
| **Time horizon** | Long-term (5+ years) |
| **Historical outperformance** | Modest but consistent over decades |
| **Volatility** | Often lower than broad market |
| **Drawback** | Quality stocks command premium valuations |
| **Academic support** | Well-documented factor, though debates about mechanism remain |
...
- [Factor investing](/factor-investing/) — the broader factor framework
- [Profitability-factor](/profitability-factor/) — the profitability metric specifically
- [Value-factor](/value-factor/) — alternative systematic approach
- [Momentum-factor](/momentum-factor/) — another systematic factor
- [GARP](/garp/) — hybrid quality and growth approach

### Wider context

- [Stock](/stock/) — the underlying instrument
- [Dividend](/dividend/) — quality signal
- [Earnings per share](/earnings-per-share/) — profit metric
- [Price-to-earnings ratio](/price-to-earnings-ratio/) — valuation context
