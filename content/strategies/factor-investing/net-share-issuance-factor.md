---
title: "Net Share Issuance Factor"
description: "Why companies that raise equity underperform those that buy back stock — a systematic predictor of equity returns."
keywords:
  - share issuance
  - equity dilution
  - share buyback
...
<div class="wiki-infobox-title">Net Share Issuance Factor — key facts</div>

<img src="/svg/strategies.svg" alt="An abstract editorial mark for the topic." />

<div class="wiki-infobox-caption">A factor that rewards shareholder loyalty and punishes dilution-prone capital raisers.</div>

|   |   |
|---|---|
| **What it is** | Outperformance of low-issuance stocks relative to high-issuance stocks over 12 months |
| **Also called** | Equity-issuance anomaly; dilution factor; Loughran-Ritter effect |
| **Return drag source** | Issuance timing, information asymmetry, overvaluation at raise time |
| **Signal strength** | Very strong (4–6% annualized spread, historically) |
| **How it's measured** | Net new shares issued as a percentage of prior-year shares outstanding |
| **Holding horizon** | 12 months; signal persists beyond (multi-year alpha possible) |
| **Correlation with other [factors](/factor-investing/)** | Moderate positive with [investment](/investment-factor-asset-growth/) (both mark capital allocation failure) |
...
For long-only investors, buying only the low-issuance decile captures roughly 200–300 basis points of the factor premium annually, forgoing the short-side leverage but also avoiding short-borrow and short-sale costs. This approach pairs naturally with a passive [equity-ETF](/equity-etf/) core, with the low-issuance overlay as a satellite.

The signal also improves with longer measurement windows. Using three-year cumulative issuance rather than one-year issuance reduces noise and can tighten the historical spread, though at the cost of slower signal turnover and higher [trading costs](/bid-ask-spread/).

## Why the anomaly endures

Despite decades of published research, the issuance factor has not been arbitraged away. The reason is structural. Most [active funds](/actively-managed-fund/) operate within mandates that restrict short-selling or require holding large-cap, highly-traded names — precisely where shorting issuers is expensive. [Passive indexing](/index-fund/) does not screen on issuance; it buys all stocks, including heavy issuers, by market cap. The factor's strongest returns accrue to those willing to short-sell illiquid, smaller issuers and hold patiently through periods when growth stocks rally (2015–2020), when issuers may outperform on momentum.
...
- [Factor Investing](/factor-investing/) — Capturing systematic return anomalies through disciplined, rules-based selection
- [Investment Factor](/investment-factor-asset-growth/) — Asset growth as a parallel signal of capital allocation failure
- [Share Buyback](/share-buyback/) — Reducing share count as a confidence signal and source of shareholder returns
- [Dividend](/dividend/) — Direct cash return to shareholders, a competing use of capital to issuance
- [Price-to-Earnings Ratio](/price-to-earnings-ratio/) — Valuation context for assessing whether issuance prices are stretched
- [Secondary Offering](/secondary-offering/) — Public equity issuance by existing shareholders, often a tell of overvaluation
- [Initial Public Offering](/initial-public-offering/) — The ultimate timing event, where issuance risk is highest

### Wider context

- [Acquisition](/acquisition/) — When issuance funds M&A, the effects compound and return drag accelerates
- [Market Timing](/market-timing/) — The broader challenge of entry and exit discipline in public equities
- [Overconfidence Bias](/overconfidence-bias/) — The psychological driver behind poorly-timed issuance decisions
- Information Asymmetry — Why insiders' issuance choices reveal private knowledge
- [Liquidity Risk](/liquidity-risk/) — Secondary offerings and dilution impact on trading spread and demand
