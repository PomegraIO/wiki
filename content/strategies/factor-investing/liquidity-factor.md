...
description: "How stocks with lower market liquidity earn a systematic premium that compensates investors for transaction costs and exit risk."
keywords:
  - liquidity factor
  - bid-ask spread
...
*The **liquidity factor** describes a persistent return premium earned by stocks with lower trading [liquidity](/wiki/liquidity-risk/)—wider [bid-ask spreads](/wiki/bid-ask-spread/), lower trading volume, and higher costs to enter or exit positions. The premium compensates investors for friction, opportunity cost, and the risk of being unable to exit quickly when needed, making it a pure reward for bearing transaction-cost and exit risk.*
...
Illiquid stocks pose several challenges for investors. First, they are expensive to trade: the [bid-ask spread](/wiki/bid-ask-spread/) is wider, meaning the immediate cost to buy and immediately resell is larger. Second, they carry opportunity cost: if you need to exit but few buyers exist, you must wait or accept a lower price. Third, they carry tail risk: in a market panic or sector downturn, liquidity evaporates fastest in already-illiquid stocks, making forced sales particularly costly.
...
**Turnover ratio:** The annual trading volume divided by [market capitalization](/wiki/market-capitalization/). Higher turnover indicates more active trading and lower friction.
...
Academic research, beginning in the early 2000s, documented a striking pattern: a self-financed portfolio that buys illiquid stocks and sells liquid stocks delivers a return premium of 2–6 percentage points per year, net of trading costs. This premium is one of the most robust [factor investing](/wiki/factor-investing/) findings.
...
Importantly, the liquidity premium is real and distinct from size and value effects. A researcher cannot explain the liquidity return by simply controlling for [market capitalization](/wiki/market-capitalization/) or [price-to-book ratio](/wiki/price-to-book-ratio/); the liquidity signal carries independent explanatory power.
...
- [Bid-ask spread](/wiki/bid-ask-spread/) — the direct cost of trading illiquid stocks
- [Liquidity risk](/wiki/liquidity-risk/) — the core driver of the liquidity-factor premium
- [Factor investing](/wiki/factor-investing/) — systematic framework encompassing liquidity and other anomalies
- [Market maker](/wiki/market-maker-trading/) — intermediary whose presence tightens spreads and improves liquidity
- [Carry factor in equities](/wiki/carry-factor-equities/) — complementary return source often seen in less-liquid names
- [Accruals anomaly](/wiki/accruals-anomaly/) — quality-based factor that works well with illiquidity screening
...
- [Factor decay](/wiki/factor-decay/) — risk that published premiums shrink as capital crowds in
