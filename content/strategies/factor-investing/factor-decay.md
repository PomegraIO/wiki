---
title: "Factor Decay"
description: "How a factor's return premium diminishes after publication as arbitrage capital flows in and signal half-life shortens."
keywords:
  - factor decay
  - anomaly decay
  - factor publication
...
When practitioners then implement the published strategies, they are implementing strategies that have already been culled for out-of-sample noise. Real-world returns cannot be as high as in-sample returns by definition. Add in [transaction costs](/wiki/transaction-cost-analysis/), management fees, and slippage, and the decay relative to published numbers is guaranteed.
...
Awareness of factor decay has matured the factor investing industry. Modern [factor-based ETFs](/wiki/etf/) and managers do not promise historical factor returns. Instead, they frame factors as persistent sources of return with time-varying premia, complementary to each other, and subject to market and economic cycles.

The best-run [factor investing](/wiki/factor-investing/) programs combine:

1. Multiple uncorrelated factors to diversify decay risk
2. Regular rebalancing to avoid overweighting decaying factors
3. Monitoring of forward-looking indicators (valuation, crowding, capacity) rather than relying on historical returns
4. Openness to alpha research and emerging anomalies
...
- [Factor investing](/wiki/factor-investing/) — the framework within which decay is a central concern
