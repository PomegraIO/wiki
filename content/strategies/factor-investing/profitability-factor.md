...
description: "Profitability-factor investing is a systematic strategy that emphasizes highly profitable companies, betting that durable earnings power drives long-term returns."
keywords:
...
For the broader factor framework, see [factor investing](/factor-investing/). For quality-holistic assessment, see [quality-factor](/quality-factor/). For fundamental analysis, see [fundamental investing](/fundamental-investing/).
...
|   |   |
|---|---|
| **Core idea** | High-profitability businesses outperform |
| **Key metrics** | Return on equity, return on assets, operating margin, gross margin |
| **Time horizon** | Long-term (5–10+ years) |
| **Historical outperformance** | Documented and consistent across decades |
| **Volatility** | Often similar to or lower than broad market |
| **Mechanism** | Competitive moat, capital efficiency, sustainable advantage |
...
- [Quality-factor](/quality-factor/) — holistic quality assessment
- [Factor investing](/factor-investing/) — the broader framework
- [Fundamental investing](/fundamental-investing/) — analysis-based approach
- [Return on equity](/price-to-earnings-ratio/) — the core metric
- [Earnings per share](/earnings-per-share/) — profit per share

### Wider context

- [Stock](/stock/) — the underlying instruments
- [Dividend](/dividend/) — profitability enables dividends
- [Price-to-earnings ratio](/price-to-earnings-ratio/) — valuation context
- [Asset allocation](/asset-allocation/) — profitability-focused positioning
