...
description: "Investment-factor investing is a systematic strategy that favors companies with low capital expenditure relative to earnings, betting that disciplined capital allocation drives returns."
keywords:
  - investment factor
  - capital discipline
  - capex ratio
...
For the broader factor framework, see [factor investing](/factor-investing/). For profitability, see [profitability-factor](/profitability-factor/). For quality holistically, see [quality-factor](/quality-factor/).
...
|   |   |
|---|---|
| **Core idea** | Low-investment businesses (relative to earnings) outperform |
| **Key metrics** | Asset growth rate, capex-to-earnings, reinvestment rate |
| **Time horizon** | Long-term (5–10+ years) |
| **Historical outperformance** | Documented across decades and markets |
| **Mechanism** | Avoid value traps, reward profitability, incentive alignment |
| **Sector bias** | Favors asset-light, cash-generative businesses |
...
- [Profitability-factor](/profitability-factor/) — the profitability metric
- [Factor investing](/factor-investing/) — the broader framework
- [Fundamental investing](/fundamental-investing/) — analysis-driven approach
- [Value investing](/value-investing/) — related concept

### Wider context

- [Stock](/stock/) — the underlying instruments
- [Earnings per share](/earnings-per-share/) — profit metric
- [Dividend](/dividend/) — capital return mechanism
