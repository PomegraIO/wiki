---
title: "Carry Factor in Equities"
description: "How expected dividend yield and earnings yield define an equity carry signal analogous to FX carry across stock markets."
keywords:
  - carry factor
  - dividend yield
  - earnings yield
...
A comprehensive equity carry framework typically combines both. A stock with a 4% [dividend yield](/wiki/dividend-yield/) and 5% retained earnings yield offers roughly 9% of total carry—the pull-to-par or expected return before capital appreciation.
...
Critically, equity carry is not simply a proxy for [value investing](/wiki/value-investing/). A [price-to-earnings ratio](/wiki/price-to-earnings-ratio/) is a valuation metric; a yield is a cash return metric. A cheap stock (low P/E) might have low yield if its earnings are expected to grow; a high-yield stock might be fairly valued if the market expects stable or declining profitability. The carry signal captures the latter.
...
- [Dividend yield](/wiki/dividend-yield/) — the primary metric for measuring equity carry payoff
- [Earnings yield](/wiki/earnings-yield/) — earnings-based carry metric capturing full return-generating capacity
- [Factor investing](/wiki/factor-investing/) — the systematic framework encompassing carry and other return sources
- [Dividend](/wiki/dividend/) — the cash distribution underlying carry mechanics
- [Accruals anomaly](/wiki/accruals-anomaly/) — quality factor complementing carry to filter better businesses
- [Liquidity factor](/wiki/liquidity-factor/) — another systematic return driver distinct from carry
...
- [Factor decay](/wiki/factor-decay/) — why published carry returns may diminish as capital flows increase
