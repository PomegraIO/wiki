...
description: "Dividend-aristocrats are a select group of S&P 500 companies that have increased their dividends for at least 25 consecutive years, representing the gold standard of dividend reliability."
keywords:
  - dividend aristocrats
  - dividend champions
  - 25-year dividend growth
  - blue-chip dividends
...
For broader dividend growth, see [dividend-growth investing](/dividend-growth-investing/). For maximum yield, see [high-yield investing](/high-yield-investing/). For the full spectrum, see [dividend investing](/dividend-investing/).
...
| **Count** | Roughly 60–70 stocks at any time |
| **Minimum requirement** | 25 consecutive years of increases (any amount) |
| **Typical count** | Fewer than 100 stocks globally meet this bar |
| **Holding period** | Long-term (10+ years) |
| **Typical yield** | 2–3.5%, often lower than broader market |
| **Psychological appeal** | Proven sustainability, compounding power |

</aside>

## The aristocrat advantage

To qualify as a dividend-aristocrat, a company must have raised its [dividend](/dividend/) for 25 consecutive years — through recessions, wars, financial crises, and sector upheaval. This is an iron-clad proof of commitment and financial health.
...
- [Dividend-growth investing](/dividend-growth-investing/) — the broader category
- [Dividend investing](/dividend-investing/) — the full spectrum
- [High-yield investing](/high-yield-investing/) — alternative dividend approach
- [Quality-factor](/quality-factor/) — systematic quality screening
- [Compound interest](/compound-interest/) — the math of dividend growth

### Wider context

- [Dividend](/dividend/) — the mechanism
- [Stock](/stock/) — the underlying instrument
- [Market-capitalization](/market-capitalization/) — size context
- [Asset allocation](/asset-allocation/) — positioning aristocrats in a portfolio
