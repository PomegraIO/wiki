...
The name comes from the idea of "fading" a trend—staying out of it until it exhausts itself, then trading the reversion. This distinguishes fade trading from [momentum investing](/momentum-investing/), which *follows* the trend. Faders are intentionally swimming against the current.
...
Market structure matters: fade strategies gained prominence among professional traders when [High-frequency trading](/algorithmic-trading/) and electronic markets made intraday reversals faster and more violent. In an era of slower tape and human market makers, sharp single-day moves were less common.
...
## Fade Trading and [Market maker trading](/market-maker-trading/)
...
- [Momentum investing](/momentum-investing/) — the opposite philosophical bet, following trends rather than fading them.
- [Range trading strategy](/range-trading-strategy/) — also relies on mean reversion but within a defined horizontal band, not on single-day extremes.
- [Breakout trading strategy explained](/breakout-trading-strategy-explained/) — when reversion fails and the move is genuine, breakout traders are positioned to profit.
- [Stop loss and risk management](/market-order/) — critical to fade trading success since fades fail frequently.
- [Volatility smile](/volatility-smile/) — patterns in implied volatility that can signal when mean-reversion trades have edge.

### Wider context

- [Behavioral finance](/prospect-theory/) — emotional overreaction is the psychological foundation of fade trading.
- [Market microstructure](/over-the-counter-market/) — the mechanics of how large orders create temporary dislocations that revert.
- [Liquidity risk](/liquidity-risk/) — fade traders rely on being able to exit during the reversion window.
- [Algorithmic trading](/algorithmic-trading/) — how automated systems have made intraday reversals sharper and faster.
