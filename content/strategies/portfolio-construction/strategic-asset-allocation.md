...
description: "Long-term target allocation of portfolio among asset classes based on goals, time horizon, and risk tolerance."
keywords:
  - asset allocation
...
*A **strategic asset allocation (SAA)** is a long-term plan for dividing a portfolio among major asset classes (stocks, bonds, cash, alternatives) based on the investor's financial goals, time horizon, risk tolerance, and return expectations. Unlike [tactical allocation](/wiki/tactical-asset-allocation/), SAA is meant to be stable and rebalanced periodically, not adjusted for market timing.*
...
| **Typical review frequency** | Annual or after major life change |
| **Rebalancing** | Back to target weights when drifts exceed threshold |
| **Asset classes** | Equities, bonds, cash, real estate, commodities, alternatives |
| **Role in returns** | Accounts for ~90% of portfolio variance (Brinson/Fachler) |
| **Adjustment drivers** | Aging, income changes, goal changes, market crashes |
| **Common allocations** | 60/40, 80/20, 50/50 (stocks/bonds), plus alternatives |
...
| Age / Stage | Stocks | Bonds | Alternatives | Notes |
|---|---|---|---|---|
...
The modern SAA framework rests on Modern Portfolio Theory (Markowitz, 1950s) and the [Capital Asset Pricing Model](/wiki/capital-asset-pricing-model/) (CAPM, 1960s): optimal portfolio lies on the "efficient frontier" where returns are maximized for a given risk level.
...
[Target-date funds](/wiki/target-date-fund/) are convenient and useful, but they are one-size-fits-all; they don't account for your other wealth, income, or specific goals.
