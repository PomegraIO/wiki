...
description: "Deep-value investing is an extreme form of value investing that hunts for stocks trading at severe discounts, often with minimal upside catalysts, betting on contrarian mean reversion."
keywords:
  - deep value
...
For the standard version of value investing, see [value investing](/value-investing/). For the systematic factor approach, see [value-factor](/value-factor/). For the contrarian psychology, see [contrarian investing](/contrarian-investing/).
...
|   |   |
|---|---|
| **Core idea** | Buy the most despised stocks at the steepest discounts |
| **Typical P/E target** | Single-digit, or deeply negative valuations |
| **Key risk** | Value trap — the discount may be deserved |
| **Holding period** | 2–10+ years, often volatile |
| **Emotional requirement** | High conviction and resistance to ridicule |
| **Historical approach** | Graham's net-net, modern screens, Joel Greenblatt |
| **Typical success rate** | Modest to poor on individual picks, better as a basket |

</aside>

## The deep-value thesis

Deep-value investors believe that extreme pessimism and seller panic occasionally drive stocks to prices that bear no reasonable relationship to the underlying business reality. A company in temporary trouble, a sector out of favour, or simply an overlooked small-cap can trade at a [price-to-earnings ratio](/price-to-earnings-ratio/) of 3, 4, or 5 — or even at a discount to its cash on the balance sheet. At such extremes, even if the business remains mediocre, the mathematical recovery potential is enormous.
...
- **Benjamin Graham's net-net.** Stocks trading below liquidation value — total current assets minus all liabilities. This is almost never profitable in liquid [stock markets](/stock-market/), but it sets a floor on downside risk.
...
- [Value investing](/value-investing/) — the parent strategy
- [Contrarian investing](/contrarian-investing/) — the psychological driver
- [Mean-reversion investing](/mean-reversion-investing/) — the statistical bet
- [Value-factor](/value-factor/) — systematic deep-value screening
- [Bottom-up investing](/bottom-up-investing/) — the analytical approach

### Wider context

- [Bear market](/bear-market/) — when deep-value opportunities often emerge
- [Price-to-earnings ratio](/price-to-earnings-ratio/) — the valuation metric
- [Diversification](/diversification/) — essential for managing deep-value risk
- [Stock market](/stock-market/) — the venue for the hunt
