---
title: "Affordability-Focused Value Strategy"
description: "Investment approach targeting cheap assets relative to intrinsic value, emphasizing margin of safety and protection against valuation errors."
keywords:
  - value investing
  - margin of safety
  - intrinsic value
...
This strategy descends directly from [benjamin-graham](/wiki/benjamin-graham/) and [value-investing](/wiki/value-investing/) doctrine. Graham formalized the idea in "The Intelligent Investor" (1949), distinguishing between price (what you pay) and value (what you get). The most successful exponent is [warren-buffett](/wiki/warren-buffett/), who has deployed variants of this framework for six decades.

<div class="wiki-hatnote">For Graham's foundational work, see [benjamin-graham](/wiki/benjamin-graham/). For Buffett's interpretation, see [warren-buffett](/wiki/warren-buffett/).</div>
...
| **Valuation method** | Intrinsic value estimation (DCF, comps, asset-based) |
| **Discount required** | 25–50% or higher, depending on risk tolerance |
| **Risk assumption** | Business and valuation risk; market-risk is priced in the discount |
| **Typical holding period** | 3–10 years until value recognized |
| **Rebalancing** | Sell when price converges to fair value |
| **Cyclicality** | Works best in trough of cycle; underperforms in euphoric markets |
...
**[Book-value-investing](/wiki/book-value-investing/).** Explicit focus on price-to-book ratio; buy stocks trading at 60% of book value.

**[Asset-play-strategy](/wiki/asset-play-strategy/).** Buy companies trading below sum-of-parts value, exploiting the discount between conglomerate stock price and what the pieces would be worth if sold separately.

**[Deep-value-investing](/wiki/deep-value-investing/).** Extreme end of the spectrum; only stocks in the cheapest decile of valuation metrics are eligible. High risk but often high return.

**[Merger-arbitrage](/wiki/merger-arbitrage/).** A form of event-driven affordability investing: buy a target company at the announced deal price (discounted due to deal uncertainty), capturing the spread as deal completion approaches.

## Performance and cycles

Affordability value strategies outperform over full market cycles but often underperform in the final euphoric stage of a bull market. In 2017–2020, value significantly trailed [growth-investing](/wiki/growth-investing/) and momentum strategies. Value returned in 2021–2023 as the market repriced growth stocks downward. This cyclicality is inherent: value thrives when the market swings from greed back to fear, but it suffers during greed's peak.
...
- [book-value-investing](/wiki/book-value-investing/) — Asset-based variant
- [contrarian-investing](/wiki/contrarian-investing/) — Related discipline
- [asset-play-strategy](/wiki/asset-play-strategy/) — Event-driven variant
- [discounted-cash-flow-valuation](/wiki/discounted-cash-flow-valuation/) — Valuation method
