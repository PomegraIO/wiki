---
title: "Equal-Weight vs Market-Cap-Weight Portfolio"
description: "Compare equal-weight and cap-weight index construction: diversification, small-cap tilt, rebalancing costs, and performance implications."
keywords:
  - equal weight vs market cap weight portfolio
  - equal-weight index
  - cap-weight index construction
...
<div class="wiki-infobox-title">Equal-Weight vs Market-Cap-Weight — key facts</div>

<img src="/svg/strategies.svg" alt="An abstract editorial mark for portfolio construction." />

<div class="wiki-infobox-caption">Two index approaches with opposite trade-offs between simplicity and small-cap exposure.</div>

|   |   |
|---|---|
| **Equal-weight definition** | Each holding owns an identical percentage; requires frequent rebalancing |
| **Cap-weight definition** | Each holding owns a percentage equal to its market cap; self-balancing |
| **Rebalancing frequency** | Equal-weight: regular (often quarterly); cap-weight: minimal or none |
| **Small-cap exposure** | Equal-weight: overweight; cap-weight: matches market composition |
| **Concentration** | Equal-weight: lowest within an index; cap-weight: highest |
| **Tax efficiency** | Cap-weight: generally more efficient; equal-weight: higher turnover |
...
- [Market Capitalization](/market-capitalization/) — how weight is calculated in cap-weight indices
- [Index Fund](/index-fund/) — passive ownership of cap-weighted market baskets
- Small-Cap Premium — empirical evidence on small-stock outperformance
- [Sector Rotation](/sector-rotation/) — alternative tilting approach to market exposure
- [Asset Allocation](/asset-allocation/) — broader framing of portfolio construction choices

### Wider context

- [Value Investing](/value-investing/) — fundamental approach that sometimes favors smaller, overlooked stocks
- [Diversification](/diversification/) — core principle behind spreading risk across holdings
- [Tax-Loss Harvesting](/tax-loss-harvesting/) — technique for managing tax drag in taxable accounts
