...
description: "Dividend-growth investing is a strategy of buying stocks with a track record of rising dividends, betting that inflation protection and capital appreciation will follow."
keywords:
  - dividend growth
  - rising dividends
...
For the ultimate dividend-growth stocks, see [dividend-aristocrats](/dividend-aristocrats/). For maximum current yield, see [high-yield investing](/high-yield-investing/). For the broader dividend approach, see [dividend investing](/dividend-investing/).
...
|   |   |
|---|---|
| **Core idea** | Buy rising dividends, not maximum yield |
| **Key metric** | Years of consecutive dividend growth, growth rate |
| **Minimum hold** | 10+ years (ideally 20+) |
| **Income growth** | 5–10%+ per year is common |
| **Psychological appeal** | Visible progress; income outpaces inflation |
| **Sector bias** | Utilities, consumer staples, industrials, healthcare |
| **Tax advantage** | Dividends compound within retirement accounts tax-free |

</aside>

## The power of rising dividends

A [stock](/stock/) paying a 2% dividend today that grows at 8% per year will yield 4% in 9 years, 6% in 18 years, and 8% in 27 years — not because the stock price rose, but because the absolute dollar dividend kept climbing. For an investor who bought 20 years ago, the effective yield is now 6% or 8% on their original purchase price.
...
- **Opportunity cost.** A 2% starting yield is low relative to the broader [stock market](/stock-market/). Capital may compound faster in higher-yielding or higher-growth equities.
...
- [Dividend-aristocrats](/dividend-aristocrats/) — the elite dividend growers
- [Dividend investing](/dividend-investing/) — the broader category
- [High-yield investing](/high-yield-investing/) — maximum yield focus
- [Compound interest](/compound-interest/) — the mathematics of compounding dividends
- [Inflation](/inflation/) — the force that dividend growth hedges

### Wider context

- [Dividend](/dividend/) — the mechanism
- [Yield-curve](/yield-curve/) — broader yield context
- [Stock](/stock/) — the underlying instrument
- [Asset allocation](/asset-allocation/) — sizing dividend growers in a portfolio
