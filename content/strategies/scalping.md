---
title: "Scalping"
description: "Scalping is an ultra-short-term trading strategy of holding positions for seconds to minutes, seeking to profit from tiny price movements and bid-ask spreads."
keywords:
  - scalping
...
For slightly longer holding periods, see [day-trading](/day-trading/). For short-to-medium-term, see [swing trading](/swing-trading/). For longer-term trading, see [position trading](/position-trading/).
...
| **Time commitment** | Intense focus during market hours |
| **Capital required** | Moderate to high (due to leverage used) |
| **Profit per trade** | Often $5–50 per round-trip |
| **Volume required** | Very high; 50–100+ round-trips daily |
| **Tools** | Real-time data, Level II quotes, direct market access |
| **Risk** | Leverage, slippage, commissions, technology failure |
...
1. **Identifies a setup.** A [stock](/stock/) with tight bid-ask spread, high volume, and visible imbalances in buying/selling pressure.
...
- [Day-trading](/day-trading/) — slightly longer holding period
- [Swing-trading](/swing-trading/) — longer still
- [Position trading](/position-trading/) — multi-day to multi-week
- [Technical analysis](/stock-market/) — entry-exit methodology
- [Market-making](/stock-exchange/) — similar to scalping

### Wider context

- [Stock](/stock/) — the underlying instrument
- [Bid-ask spread](/stock-exchange/) — the scalper's primary cost
