---
title: "Range trading"
description: "Range trading is a strategy of profiting from stocks trading within established price ranges, buying near support and selling near resistance, betting that prices oscillate within the range."
keywords:
  - range trading
  - range-bound trading
...
For breakout trading (when ranges break), see [breakout trading](/breakout-trading/). For trend-following, see [trend-following](/trend-following/). For mean reversion, see [mean-reversion investing](/mean-reversion-investing/).
...
|   |   |
|---|---|
| **Core idea** | Price oscillates within a range; buy low, sell high |
| **Entry signal** | Price approaches support; buys when bouncing |
| **Exit signal** | Price approaches resistance; sells when rallying |
| **Holding period** | Days to weeks |
| **Success rate** | High within true ranges; fails if range breaks |
| **Risk** | Breakout through support or resistance; rangebound trap |
| **Suitability** | Choppy, sideways markets; poor in strong trends |

</aside>

## How range trading works

A [stock](/stock/) in a **true range** exhibits:
...
- [Breakout-trading](/breakout-trading/) — identifying when ranges break
- [Mean-reversion investing](/mean-reversion-investing/) — oscillation betting
- [Trend-following](/trend-following/) — when ranges fail
...
- [Volatility](/alpha/) — range amplitude
- [Sideways market](/stock-market/) — the ideal regime
- [Trading](/swing-trading/) — execution context
