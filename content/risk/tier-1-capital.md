...
description: "Tier 1 capital is the highest quality capital a bank holds — primarily common equity and retained earnings — that is fully available to absorb losses before the bank faces regulatory restrictions or insolvency."
keywords:
  - Tier 1 capital
...
|   |   |
|---|---|
| **What it is** | Core capital of highest quality; absorbs losses first |
| **Components** | Common Equity (CET1); Additional Tier 1 (AT1) contingent convertibles |
| **Basel III minimum** | CET1: 4.5%; Total Tier 1: 6% of risk-weighted assets |
| **Quality** | Most loss-absorbing; cannot be recalled in crisis |
| **Retained earnings** | Profits not paid out as dividends; contribute to Tier 1 |
| **Hybrid instruments** | AT1 bonds convert to equity if capital falls below threshold |
| **Dividend restrictions** | If Tier 1 falls below conservation buffer, dividends are restricted |
...
A bank with 10% Tier 1 capital has 10x leverage, so profits are leveraged 10x.
A bank with 15% Tier 1 capital has 6.7x leverage, so profits are leveraged less.
