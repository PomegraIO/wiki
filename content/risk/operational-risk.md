...
description: "Operational risk is the potential for loss stemming from failed or inadequate internal processes, people, systems, or external events such as fraud, legal action, or natural disaster."
keywords:
  - operational risk
  - process failure
  - fraud risk
...
This entry covers losses from processes and events within an institution. For the risk that an external counterparty fails to perform, see [counterparty-risk](/counterparty-risk); for risk of unforeseen catastrophe, see [tail-risk](/tail-risk).
...
|   |   |
|---|---|
| **What it is** | Loss from failed processes, systems, people, or external events |
| **Sources** | Fraud, error, system outage, regulation, litigation, natural disaster |
| **Regulated under** | Basel capital standards require banks to hold capital against it |
| **Can be reduced by** | Internal controls, automation, redundancy, insurance, outsourcing |
| **Cannot be eliminated** | All organizations carry some operational risk |
| **Cost of ignoring** | Fines, reputation damage, insolvency, criminal liability |
| **Measured by** | Historical loss data, [scenario analysis](/scenario-analysis) |

</aside>

## The wide net of operational risk

Unlike [market-risk](/market-risk) and [credit-risk](/credit-risk), which are market-facing and relatively easy to define, operational risk is everything else. The taxonomy includes:
...
- **Model risk.** A [value-at-risk](/value-at-risk) model is wrong, leading to catastrophic losses because risk was mismeasured — see [model-risk](/model-risk).
- **Third-party failure.** A vendor, outsourcer, or subcontractor fails to perform, and no contingency plan is in place.

Many of these overlap; the boundary between [model-risk](/model-risk) and operational risk is blurred. The key is that operational risk is not about the market moving against you; it is about something inside your organization or supply chain breaking.

## Why operational risk matters

Historically, major financial disasters have been as much operational as they have been about [market-risk](/market-risk) or [credit-risk](/credit-risk). The 2012 collapse of MF Global was operational risk — client funds were misappropriated. The 2008 crisis exposed massive operational failures at major banks: inadequate risk controls, bad models, and ignored warning signs. The 2021 ransomware attack on Colonial Pipeline was operational risk with economy-wide impact.

Regulators have made operational risk increasingly important. Under [Basel capital](/basel-capital) standards, banks must calculate a capital requirement for operational risk in addition to [credit](/credit-risk) and [market-risk](/market-risk). The calculation is crude — it is usually a percentage of gross income — but it signals that regulators view operational risk as material and preventable through good discipline.
...
For a [hedge fund](/hedge-fund) or large [mutual fund](/mutual-fund), operational risk management includes custody arrangements (keeping client assets at an unaffiliated bank), audits (independent verification of valuations and holdings), and business continuity planning (what happens if key staff are gone tomorrow).
...
- [Model risk](/model-risk) — loss from faulty models or models run wrongly
- [Basel capital](/basel-capital) — international standards require capital for operational risk
- [Counterparty risk](/counterparty-risk) — related risk that a counterparty fails
- [Value-at-risk](/value-at-risk) — common tool in operational risk assessment
- [Stress testing](/stress-testing) — assessing operational resilience under stress

### Broader context

- [Systemic risk](/systemic-risk) — when operational failures spread across the system
- [Tail risk](/tail-risk) — exposure to extreme operational shocks
- [Scenario analysis](/scenario-analysis) — assessing losses under operational failure scenarios
- Risk-weighted assets — how regulators quantify and capital-weight operational risk
- [Central bank](/central-bank) — oversight of operational risk at banks
