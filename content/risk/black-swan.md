---
title: "Black Swan"
description: "A black swan is an unpredictable, extreme event with massive consequences — something that was believed impossible until it happened, fundamentally changing understanding of risk."
keywords:
  - black swan
  - unpredictable event
  - tail event
...
|   |   |
|---|---|
| **What it is** | Extreme, unpredictable event with massive consequences |
| **Properties** | Surprise; extreme impact; post-hoc explainability |
| **Cannot be predicted** | By definition; if foreseeable, it is not a black swan |
| **Impact on portfolios** | Can destroy years of gains; can break diversification |
| **Examples** | 9/11 attacks; 2008 financial crisis; COVID-19 pandemic; 1987 crash |
| **Survivability** | Some portfolios survive; others are decimated depending on positioning |
| **Hedge cost** | Prohibitively expensive to hedge all tail events |
