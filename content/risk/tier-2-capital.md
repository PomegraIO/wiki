...
description: "Tier 2 capital is supplementary capital — mainly subordinated debt, loan loss reserves, and other instruments — that ranks below Tier 1 but above unsecured creditors and deposits in a bank's capital structure."
keywords:
  - Tier 2 capital
  - subordinated debt
...
|   |   |
|---|---|
| **What it is** | Supplementary capital; subordinated debt and reserves |
| **Components** | Subordinated debt (5-10 year maturity); loan loss reserves; some hybrid instruments |
| **Basel III maximum** | Tier 2 can be up to 50% of Tier 1 |
| **Seniority** | Junior to Tier 1; senior to unsecured liabilities and deposits |
| **Cost** | Cheaper than Tier 1 (equity) but more expensive than unsecured debt |
| **Loss absorption** | Full loss-absorption happens only if bank is in resolution (failing) |
| **Interest coverage** | Must be sustainable; issuer cannot skip interest like on equity |
