---
title: "Rollover Risk"
description: "The risk that a borrower cannot refinance or renew maturing short-term debt, forcing default or a distressed refinancing at unfavorable terms."
keywords:
  - rollover risk
  - debt refinancing
  - short-term debt
...
| Key fact | Detail |
|---|---|
| **Trigger** | Debt maturity (days to months away) + tight credit conditions |
| **Severity** | Liquidity crisis (short-term) to solvency crisis (if default occurs) |
| **Common borrowers** | Banks (funding gap), corporates with high short-term debt, sovereign nations |
| **Measurement** | Debt maturing in next 12 months / Liquid assets; similar to [current-ratio](/wiki/current-ratio/) |
| **Mitigation** | Extend maturity, build cash reserves, maintain credit lines |
| **Historical precedent** | 2008 financial crisis, Argentina 2001, Lebanese banking sector 2019+ |
...
1. Pay a much higher rate (widened [credit-spread](/wiki/credit-spread/)).
2. Default.
3. Sell assets (including the long-term project) at fire-sale prices to repay in cash.
...
Greece in 2011–2015 had massive short-term rollover risk when the eurozone debt crisis erupted. Greek bonds that matured had to be rolled, but no investors would buy them without punitive rates (20%+) and European Central Bank support (via Short-Term Liquidity Facility mechanisms). The rollover risk spilled into a [sovereign default](/wiki/sovereign-default/) crisis.
...
**Maintain credit quality**: A company with a strong [credit-rating](/wiki/credit-rating/) (A or better) and low [leverage](/wiki/debt-to-equity-ratio/) can refinance even in stressed conditions, though at a higher [spread](/wiki/credit-spread/). A junk-rated or highly levered firm cannot.
...
1. **Cost**: Long-term, fixed-rate debt is more expensive than short-term, floating-rate debt.
2. **Flexibility**: Short-term debt is riskier but easier to repay (or refinance) if the business needs cash for unexpected downturns.
3. **Refinancing risk**: A ladder of maturities reduces lumpiness; a large maturity in year 2 is a vulnerability.
...
### Closely related
- [Liquidity risk](/wiki/liquidity-risk/) — Inability to meet short-term obligations
- [Credit risk](/wiki/credit-risk/) — Risk of borrower default
- [Debt maturity structure](/wiki/debt-maturity-structure/) — Management of maturity ladders
- [Refinancing risk](/wiki/refinancing-risk/) — Risk that refinancing costs are higher than expected

### Wider context
- [Sovereign default](/wiki/sovereign-default/) — Extreme rollover risk outcome
- [Commercial paper](/wiki/commercial-paper/) — A major rollover risk vehicle
- [Repo](/wiki/repurchase-agreement/) — Bank funding mechanism subject to rollover risk
- [Credit spread](/wiki/credit-spread/) — How refinancing cost rises as rollover risk increases
