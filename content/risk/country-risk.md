---
title: "Country Risk"
description: "Country risk is the possibility of loss on an investment due to adverse political, economic, or social events in a specific country, distinct from the underlying business risk of the investment itself."
keywords:
  - country risk
  - sovereign risk
  - political risk
...
|   |   |
|---|---|
| **What it is** | Risk of loss from political or economic instability in a country |
| **Includes** | Expropriation, capital controls, default, war, civil unrest, coup |
| **Distinct from** | Business risk (risk of the underlying company) |
| **Affects** | All investments in that country; cannot be diversified away locally |
| **Measured by** | Credit ratings, CDS spreads, political risk indices |
| **Priced into** | Higher yields on emerging market assets |
| **High in** | Emerging markets, nations with weak institutions, war zones |
| **Low in** | Developed democracies with stable institutions and rule of law |
