---
title: "Basel Capital"
description: "Basel capital refers to the Basel Accords — international agreements on bank capital standards, most recently Basel III, which set minimum capital ratios and risk-weighting frameworks for global banks."
keywords:
  - Basel capital
  - Basel Accords
  - Basel III
...
|   |   |
|---|---|
| **What it is** | International capital standards for banks |
| **Authority** | Basel Committee on Banking Supervision (BCBS) |
| **Current version** | Basel III (agreed 2010; phased in 2013-2019; "Basel III Endgame" under discussion) |
| **Scope** | Minimum capital ratios; risk-weighted-assets; liquidity standards |
| **Compliance** | Mandatory for banks in 180+ jurisdictions |
| **Key metrics** | CET1, Tier 1, Total capital; liquidity-coverage-ratio; leverage-ratio |
| **Enforcement** | Central banks; fines and restrictions for non-compliance |
...
- +2.5% CET1 (counter-cyclical buffer, in boom times)
= 10.5% CET1 total (~13-14% total capital with Tier 2).
