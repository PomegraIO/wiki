...
description: "Liquidity risk is the danger that an investment position cannot be sold quickly without suffering a significant loss. It arises when the market for an asset is thin, has few buyers, or trades at a wide bid-ask spread."
keywords:
  - liquidity risk
  - illiquidity
  - bid-ask spread
...
|   |   |
|---|---|
| **What it is** | Risk of inability to sell at fair value |
| **Root cause** | Insufficient buyers or sellers in the market |
| **Measure** | Bid-ask spread, market depth, time to liquidate |
| **Worst case** | Fire sale at dramatic discount |
| **Common in** | Small-cap stocks, corporate bonds, emerging markets, derivatives |
| **Less common in** | Large-cap equities, Treasuries, FX majors |
| **Can worsen during** | Market stress, crises, flights to safety |
| **Can be managed by** | Position sizing, diversification, buffer capital |
