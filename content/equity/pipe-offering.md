---
title: "PIPE offering"
description: "A PIPE offering (private investment in public equity) is a private sale of shares by a public company to institutional investors at a negotiated price, typically at a discount to market."
keywords:
  - PIPE
...
|   |   |
|---|---|
| **What it is** | Private sale of public company shares |
| **Buyers** | Institutional investors (accredited) |
| **Pricing** | Typically 10–20% discount to market |
| **Timeline** | 1–2 weeks from announcement to close |
| **Underwriting** | Usually unregistered; Rule 144 restricted period |
| **Size** | $100 million to $1+ billion |
| **Cost to company** | Lower fees than traditional offering |
| **Dilution** | Higher due to discount |
...
1. **Investor outreach**: Company contacts large institutional investors (private equity, hedge funds, mutual funds, etc.).

2. **Negotiation**: Company proposes to sell shares at, say, $80 per share (15% discount to the current $94 market price). Investors indicate interest.

3. **Agreement**: Once investors commit to the purchase, the parties sign subscription agreements specifying:
   - Number of shares.
   - Price per share.
   - Closing conditions.
   - Registration rights (when the investor can sell the shares publicly).

4. **Closing**: Typically within 1–2 weeks, the transaction closes. Investors wire funds; company delivers shares.

5. **Registration**: The company typically agrees to register the shares for public trading (either on Form S-1 or a Form S-3), which allows the investor to sell at some later point.
