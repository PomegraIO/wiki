---
title: "Founder shares"
description: "Founder shares are equity stakes granted to company founders, typically carrying superior voting rights or favorable economic terms, or sometimes restricted by vesting schedules and transfer restrictions."
keywords:
  - founder shares
  - founder equity
  - founders' equity
...
|   |   |
|---|---|
| **What it is** | Equity stakes granted to company founders |
| **Grant timing** | Upon incorporation or shortly after |
| **Vesting** | Often subject to [cliff vesting](/cliff-vesting/) over 4 years |
| **Typical cliff** | 1 year, then monthly vesting thereafter |
| **Voting rights** | Often superior (10 votes vs. 1) in multi-class structures |
| **Transfer** | Usually restricted until vesting complete |
| **Dilution** | Diluted by subsequent rounds of funding |
...
In venture-backed companies (the startup model), founder shares are subject to a **[vesting schedule](/vesting-schedule/)**. The logic is that the founder's shares are compensation for their labor going forward; if the founder leaves after six months, they should not be fully vested in a stake that was intended to compensate them for years of service.

A typical four-year vesting schedule with a one-year [cliff](/cliff-vesting/) works like this:
...
- **[Dual-class voting](/dual-class-shares/)** gives each founder share 10 votes versus 1 vote per public share, preserving founder control even after the company is public.
...
Founder shares typically cannot be sold until after the company is acquired or goes public, at which point there is often a [lock-up period](/lock-up-period/) during which the founder (like other insiders) is prohibited from selling. For founders who built a company over 10 years before acquisition, founder shares represent the vast majority of their wealth, and the lock-up — often 6 months post-IPO — is a critical moment.
...
- [Vesting schedule](/vesting-schedule/) — the time lock on founder shares
- [Cliff vesting](/cliff-vesting/) — the common founder vesting structure
- [Dual-class shares](/dual-class-shares/) — often used to preserve founder control
- [Share class](/share-class/) — founder shares as a class
- [Restricted stock](/restricted-stock/) — similar vesting structures for employees

### Wider context

- [Employee stock options](/employee-stock-options/) — junior to founder shares
- [Restricted stock units](/restricted-stock-units/) — modern alternative to stock options
- [Initial public offering](/initial-public-offering/) — when founder shares become liquid
- [Lock-up period](/lock-up-period/) — post-IPO restriction on founder sales
- [Public company](/public-company/) — destination for founder equity
