...
| **Vesting** | Often subject to [cliff vesting](/equity/cliff-vesting/) over 4 years |
...
In venture-backed companies (the startup model), founder shares are subject to a **[vesting schedule](/equity/vesting-schedule/)**. The logic is that the founder's shares are compensation for their labor going forward; if the founder leaves after six months, they should not be fully vested in a stake that was intended to compensate them for years of service.

A typical four-year vesting schedule with a one-year [cliff](/equity/cliff-vesting/) works like this:
...
- **[Dual-class voting](/equity/dual-class-shares/)** gives each founder share 10 votes versus 1 vote per public share, preserving founder control even after the company is public.
...
Founder shares typically cannot be sold until after the company is acquired or goes public, at which point there is often a [lock-up period](/equity/lock-up-period/) during which the founder (like other insiders) is prohibited from selling. For founders who built a company over 10 years before acquisition, founder shares represent the vast majority of their wealth, and the lock-up — often 6 months post-IPO — is a critical moment.
...
- [Vesting schedule](/equity/vesting-schedule/) — the time lock on founder shares
- [Cliff vesting](/equity/cliff-vesting/) — the common founder vesting structure
- [Dual-class shares](/equity/dual-class-shares/) — often used to preserve founder control
- [Share class](/equity/share-class/) — founder shares as a class
- [Restricted stock](/equity/restricted-stock/) — similar vesting structures for employees

### Wider context

- [Employee stock options](/equity/employee-stock-options/) — junior to founder shares
- [Restricted stock units](/equity/restricted-stock-units/) — modern alternative to stock options
- [Initial public offering](/initial-public-offering/) — when founder shares become liquid
- [Lock-up period](/equity/lock-up-period/) — post-IPO restriction on founder sales
