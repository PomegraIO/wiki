...
description: "A transfer agent is a financial institution that maintains a company's shareholder registry, handles share transfers, manages dividend distributions, and processes stock issuances and buybacks."
keywords:
  - transfer agent
  - registry agent
  - shareholder ledger
...
|   |   |
|---|---|
| **Function** | Maintains shareholder registry and processes transactions |
| **Owner record** | Keeps official list of registered shareholders |
| **Share transfers** | Processes buyer and seller transfers |
| **Dividend payments** | Collects from company; distributes to holders |
| **Proxy voting** | Sends proxy materials; collects ballots |
| **Required** | Public companies must have at least one |
| **Major providers** | Computershare, Equinix, American Stock Transfer |
| **Cost** | Paid by company per-transaction and per-account |
