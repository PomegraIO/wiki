---
title: "Warrant"
description: "A warrant is a security giving the holder the right to purchase shares of the underlying company at a fixed price within a specified period, similar to a long-dated option."
keywords:
  - warrant
  - stock warrant
  - warrant exercise
...
|   |   |
|---|---|
| **What it is** | Right to purchase company shares |
| **Exercise price** | Fixed; set at issuance |
| **Expiration** | Fixed date (often 5–10 years) |
| **Traded** | Can be bought and sold separately |
| **Dilution** | Upon exercise; shares are issued |
| **Leverage** | High; small price moves have large % returns |
| **Typical use** | Issued with debt or in PIPE deals |
| **Tax treatment** | Capital gains on exercise gain |
...
1. Warrant holder pays the strike price to the company.
2. Company issues new shares to the warrant holder.
3. Warrant is cancelled.
4. Company's cash increases; share count increases.
...
- [Public company](/public-company/) — issues warrants
