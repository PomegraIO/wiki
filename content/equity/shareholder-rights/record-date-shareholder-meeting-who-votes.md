---
title: "Record Date for Shareholder Meetings: Who Gets to Vote"
description: "The record date for a shareholder meeting is the cutoff date determining voting eligibility. Shares bought after that date cannot vote; the seller keeps the voting right."
keywords:
  - record date shareholder meeting
  - who can vote shareholder meeting
  - record date voting rights
  - shareholder meeting voting eligibility
...
<div class="wiki-infobox-title">Record Date for Shareholder Voting — key facts</div>

<img src="/svg/equity.svg" alt="An abstract editorial mark for the topic." />

<div class="wiki-infobox-caption">Voting rights freeze at a point in time, independent of when you actually own the shares.</div>

|   |   |
|---|---|
| **Record date** | Fixed date set by the board; typically 30–60 days before the shareholder meeting |
| **Who votes** | Shareholders of record (on the register) as of close of business on the record date |
| **Cutoff for buyer** | Must settle (own) shares **before** the record date to vote |
| **Cutoff for seller** | Loses voting rights once settlement occurs before the record date, even if they bought the shares minutes earlier |
| **Ex-rights date** | Trade settlement date minus one day (the "ex" date when new buyers lose voting rights) |
...
By freezing the register on a single date, the company eliminates this ambiguity. The [transfer agent](https://en.wikipedia.org/wiki/Transfer_agent)—the entity maintaining the shareholder ledger—captures a photograph of ownership as of that moment. Only those on that photograph may vote.
...
- [Proxy Statement](/proxy-statement/) — the ballot and disclosures sent to shareholders ahead of the record date
- [Voting Rights](/voting-rights/) — the legal framework governing shareholder suffrage
- [Common Stock](/common-stock/) — the security class with voting rights at shareholder meetings
- Shareholder Meeting — the event for which the record date determines eligibility

### Wider context

- [Public Company](/public-company/) — the corporate structure organized around shareholder voting
- [Hostile Takeover](/hostile-takeover/) — a situation where record dates and proxy contests intersect
- [Board of Directors](/board-of-directors/) — the body elected by voting shareholders
- [Merger](/merger/) — a corporate action often requiring shareholder approval on a record date
