...
description: "An American depositary receipt (ADR) is a security representing shares of a foreign company that trades in US markets, allowing US investors to own foreign stock without foreign trading accounts."
keywords:
  - ADR
...
|   |   |
|---|---|
| **What it is** | US security representing foreign stock |
| **Underlying** | Foreign company shares held by depositary |
| **Currency** | USD-denominated |
| **Trading** | NYSE, NASDAQ, or OTC in US markets |
| **Conversion** | ADR ↔ underlying shares via depositary |
| **Dividends** | Paid in USD; converted from foreign currency |
| **Sponsored** | Company-sponsored or unsponsored (Level I–III) |
| **Investor base** | US institutional and retail |
