---
title: "Public float"
description: "Public float is the total market value of a company's shares that are publicly traded and available for purchase by the general public, excluding shares held by insiders and restricted holders."
keywords:
  - public float
  - float
...
|   |   |
|---|---|
| **What it is** | Market value of freely tradeable shares |
| **Calculation** | Public shares × current stock price |
| **Excludes** | Insider holdings, restricted stock, lock-ups |
| **Threshold** | $75 million for NASDAQ; varies by exchange |
| **Uses** | Size classification; regulatory filings; capital requirements |
| **Volatility** | Changes with stock price daily |
| **Regulation** | SEC defines public float for filer status |
