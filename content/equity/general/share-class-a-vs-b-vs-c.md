---
title: "Share Class A vs B vs C: Differences for Investors"
description: "How share classes differ: voting rights, conversion features, liquidity, and economic rights for common multi-class structures."
keywords:
  - share class a vs b vs c
  - multi-class share structure
  - share class voting rights
  - class a vs class b shares differences
...
<div class="wiki-infobox-title">Share Classes — key facts</div>

<img src="/svg/equity.svg" alt="An abstract editorial mark for the topic." />

<div class="wiki-infobox-caption">Multi-class structures allow companies to raise capital while preserving founder control through voting asymmetry.</div>

|   |   |
|---|---|
| **Class A** | Often 10 or 20 votes per share; held by founder/insiders; non-voting or conversion-restricted |
| **Class B** | Medium voting rights (1–10 votes per share); sometimes restricted to key shareholders |
| **Class C** | Common stock: 1 vote per share; widely traded; may have lower dividends or deferred rights |
| **Economic rights** | All classes typically share pro-rata in profits/assets (equal per-share dividends) |
| **Conversion** | Class A may convert to Class C; Class B usually not convertible |
| **Liquidity** | Class C often the only public-market tradable class |
| **Control** | Class A voting super-majority preserves founder veto over major decisions |
...
**Class B contingent rights:**
Sometimes Class B shares carry a provision: if a founder leaves or loses a board seat, Class B holders gain additional voting rights, preventing a single dissenter from blocking decisions.
...
| Structure | Voting | Liquidity | Founder control | Public acceptance |
|-----------|--------|-----------|-----------------|-------------------|
| Single-class | 1 vote / share | One tradable class | Diluted by capital raises | High |
| Dual-class (A/C) | 10/1 votes | Class C traded | Strong founder veto | Medium |
| Tiered (A/B/C) | 10/5/1 votes | Class C traded | Founder + insider management | Medium |
| Non-voting class | 0 votes / C; 10/1 A/B | Class C traded | Founder + insider control | Low |
...
- [Voting Rights](/voting-rights/) — power to elect the board and approve major decisions
- [Dividend Distribution](/dividend-distribution/) — how cash is allocated across share classes
- [Board of Directors](/board-of-directors/) — elected by voting shareholders; composition driven by class ownership
- [Stock](/stock/) — the underlying equity security with variable rights
- [Preferred Stock](/preferred-stock/) — another tier of equity with senior rights to common
- [Merger](/merger/) — transformative action requiring voting approval; founder control can block

### Wider context

- [Initial Public Offering](/initial-public-offering/) — multi-class structures established during IPO
- [Hostile Takeover](/hostile-takeover/) — prevented by founder super-voting control
- [Proxy Fight](/proxy-fight/) — attempt to unseat board in single-class company; blocked by super-voting in multi-class
- Liquidation Preference Equity — how proceeds are distributed in bankruptcy/sale
- [Public Company](/public-company/) — multi-class structures unique to publicly traded firms
