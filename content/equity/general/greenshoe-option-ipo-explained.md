---
title: "Greenshoe Option in an IPO Explained"
description: "The greenshoe option lets IPO underwriters buy extra shares to stabilize the stock price above the offering price in the first weeks."
keywords:
  - greenshoe option ipo explained
  - over-allotment option ipo
  - ipo price stabilization
  - ipo underwriter mechanism
  - ipo greenshoe
  - lock-up period
image: /svg/equity.svg
---

*The **greenshoe option in an IPO** is an agreement that lets the lead [underwriter](/broker/) buy additional shares (typically 15% of the base offering) at the original offering price from the issuer within 30 days of listing. The underwriter uses this cushion to buy back shares in the open market if the price drops, stabilizing the stock and protecting early investors from a pop-and-crash cycle—and protecting the underwriter's reputation and fees.*

<aside class="wiki-infobox">

<div class="wiki-infobox-title">Greenshoe Option in an IPO — key facts</div>

<img src="/svg/equity.svg" alt="An abstract editorial mark for equity." />

<div class="wiki-infobox-caption">A 15% buffer that buys the underwriter time to stabilize the debut price.</div>

|   |   |
|---|---|
| **Size** | Typically 10–15% of base shares offered, on top of the base allocation |
| **Exercise price** | The original offering price (not market price) |
| **Exercise window** | 30 days after listing, sometimes extended to 45–60 days |
| **Exercise trigger** | When trading drops below offering price |
| **Benefit to underwriter** | Covers short position and earns stabilization profit if price recovers |
| **Benefit to issuer** | More orderly debut, less downside pressure, broader investor base |
| **Risk** | If price stays above offering price, greenshoe is not exercised (dilution avoided) |

</aside>

## Why IPO Underwriters Need a Stabilization Tool

When a company [IPO](/initial-public-offering/)s, the underwriter commits to selling a specific number of shares at a fixed offering price to institutional and retail buyers. On day one of trading, demand and supply collide in the open market, and the price can swing wildly. In the best case, demand overwhelms supply and the stock pops 20% or more. In a weaker case, selling pressure from investors taking profits or from weak demand can sink the price below the offering price within hours.
...
The greenshoe's most important function is psychological and mechanical: it telegraphs to the market that the lead underwriter has dry powder and commitment to defend the offering price. In efficient markets, this credible bid support narrows the [bid-ask spread](/bid-ask-spread/) and can deter panic selling.
...
- [Initial Public Offering](/initial-public-offering/) — the process in which greenshoe is embedded
- [Call Option](/call-option/) — the financial instrument logic that underlies the greenshoe
