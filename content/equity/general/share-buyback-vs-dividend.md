---
title: "Share Buyback vs Dividend: How Companies Return Cash to Shareholders"
description: "How share buybacks and dividends differ in mechanics, tax consequences, and long-term shareholder impact."
keywords:
  - share buyback vs dividend
  - dividends vs share repurchase
  - buyback dividend comparison
  - shareholder cash return methods
...
<div class="wiki-infobox-title">Share Buyback vs Dividend — key facts</div>

<img src="/svg/equity.svg" alt="An abstract editorial mark for the topic." />

<div class="wiki-infobox-caption">Two fundamental ways a company returns capital: one via equity reduction, the other via cash distribution.</div>

|   |   |
|---|---|
| **Buyback** | Company repurchases its own shares; reduces share count; typically tax-efficient for long-term holders |
| **Dividend** | Company pays cash to all shareholders per share; creates immediate tax liability for all holders |
| **EPS effect** | Buyback raises EPS (fewer denominator shares); dividend does not change EPS directly |
| **Who benefits** | Buyback: shareholders not selling; Dividend: all shareholders proportionally |
| **Timing** | Buyback is voluntary and flexible; dividend often signaled as recurring |
| **Share count** | Buyback shrinks outstanding shares; dividend leaves share count unchanged |
...
**Scenario 1: Buyback**
ABC spends $10 million repurchasing shares at $10 per share, retiring 1 million shares.
...
**Scenario 2: Dividend**
ABC pays $0.10 per share in dividends (totaling $10 million).
...
- [Earnings Per Share](/earnings-per-share/) — how buybacks mechanically raise EPS
- [Dividend Payout Ratio](/dividend-payout-ratio/) — the percentage of earnings paid as dividends
- [Dividend Yield](/dividend-yield/) — annual dividend as a percentage of stock price
- [Capital Gains Tax for Investors](/capital-gains-tax-investor/) — tax treatment of buyback sales
- Treasury Stock Method — accounting for repurchased shares
- [Warrant Exercise as a Corporate Action](/warrant-exercise-corporate-action/) — a different corporate action affecting share count

### Wider context

- [Leverage Ratio Forex](/leverage-ratio-forex/) — how debt-funded buybacks affect financial leverage
- [Return on Equity](/return-on-equity/) — whether buybacks improve ROE or just manipulate it
- [Cost of Debt](/cost-of-debt/) — interest paid on debt used to fund buybacks
- [Retained Earnings](/retained-earnings/) — profits not paid out as dividends or used for buybacks
- [Public Company](/public-company/) — corporate structure allowing buybacks and dividends
