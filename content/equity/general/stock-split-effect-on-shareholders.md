---
title: "How a Stock Split Affects Shareholders"
description: "Stock split mechanics: how forward and reverse splits change share count and price without altering total equity value."
keywords:
  - stock split effect on shareholders
  - what happens stock split
  - forward stock split reverse split
...
<div class="wiki-infobox-caption">A mechanical adjustment to share count and price; the company's total value and your ownership stake do not change.</div>

|   |   |
|---|---|
| **Forward split** | 2-for-1 or 3-for-1: each share becomes 2 or 3; price per share falls proportionally |
| **Reverse split** | 1-for-2 or 1-for-10: every 2 or 10 shares consolidate into 1; price per share rises |
| **Total value** | Your total equity value (shares × price) stays the same before and after |
| **Ownership %** | Your proportional stake in the company does not change |
| **EPS impact** | EPS adjusts retroactively; dilution does not occur (unlike warrant exercise) |
| **Dividend per share** | Usually adjusted proportionally; yield remains the same |
| **Tax** | Not a taxable event in most jurisdictions (no realized gain) |
...
1. **Psychological pricing**: A stock trading at $5 per share feels more affordable than one at $100, even though the proportional cost is the same. Lower prices may attract retail investors and brokers, increasing trading volume and liquidity.

2. **Options and compensation**: Splits align employee stock option grants and restricted stock units to typical grant ranges. A $150 stock price makes it expensive to grant 1,000 options per employee; a split to $75 makes that grant size more standard.

3. **Reverse splits to cure delisting**: A company whose stock has fallen below a minimum price (e.g., the NASDAQ minimum of $1 per share) may reverse-split to restore price and avoid delisting.

4. **Signaling**: A forward split signals that management believes the stock will continue to rise, justifying the increase in share count. A reverse split signals a turnaround attempt or a technical fix to restore credibility.
...
- [Earnings Per Share](/earnings-per-share/) — how EPS is adjusted for stock splits
- [Warrant Exercise as a Corporate Action](/warrant-exercise-corporate-action/) — a dilutive corporate action (unlike a split)
- [Share Buyback vs Dividend](/share-buyback-vs-dividend/) — corporate actions that do alter ownership
- [Dividend Yield](/dividend-yield/) — unchanged after a split when dividends are adjusted
- [Market Capitalization](/market-capitalization/) — the true measure of company value, unaffected by splits
- Shareholder — your stake remains the same after a split

### Wider context

- [Stock Exchange](/stock-exchange/) — exchanges enforce minimum price thresholds triggering reverse splits
- [Cost Basis](/cost-basis/) — adjusted for tax purposes after a split
- [Long-Term Capital Gain Tax](/long-term-capital-gain-tax/) — gain calculation uses adjusted cost basis
- [Capital Flows](/capital-flows/) — split-driven trading volume changes
- [Volatility Smile](/volatility-smile/) — option pricing adjustments around splits
