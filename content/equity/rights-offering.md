...
description: "A rights offering is a corporate action offering existing shareholders the right to buy newly issued shares at a discount, allowing them to maintain their ownership percentage or invest more."
keywords:
  - rights offering
  - preemptive right
  - subscription right
...
|   |   |
|---|---|
| **What it is** | Offer of shares to existing shareholders at discount |
| **Subscription ratio** | e.g., 1 new share per 5 held |
| **Discount** | 10–30% below market price |
| **Timeline** | 3–6 weeks for subscription period |
| **Exercise choice** | Shareholders choose to buy or not |
| **Transferable** | Rights can often be sold to other investors |
| **Dilution** | Prevented if shareholders exercise pro-rata |
| **Capital to company** | Raised from share sales and dilution |
...
1. **Announcement**: Company announces that each shareholder will receive a "right" for every 5 shares held. The right can be exercised to buy 1 new share at $95.

2. **Rights issuance**: A shareholder holding 100 shares receives 20 rights (100 / 5 = 20).

3. **Subscription period**: Shareholders have, say, 3 weeks to exercise their rights (buy new shares). They can:
...
4. **Allocation and pricing**: If all shareholders exercise (fully subscribed), the company issues 200 million new shares and raises $19 billion. If subscription is low, the company may have unsubscribed shares that must be allocated (typically to investment banks or existing shareholders pro-rata).

5. **Share adjustment**: Existing shareholders who did not exercise are diluted (their ownership percentage declines). Shareholders who exercised maintain their percentage.
