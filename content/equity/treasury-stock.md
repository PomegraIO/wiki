...
description: "Treasury stock is shares of common or preferred stock repurchased by the company and held in its own treasury, reducing shares outstanding and earnings-per-share mechanically without changing business value."
keywords:
  - treasury stock
  - treasury shares
  - share buyback
...
|   |   |
|---|---|
| **What it is** | Shares repurchased and held by the issuer |
| **Share count effect** | Reduces shares outstanding |
| **Dividend effect** | No dividend paid on treasury shares |
| **Voting effect** | Treasury shares do not vote |
| **EPS effect** | Mechanical boost from lower denominator |
| **Balance sheet** | Shown as negative equity (contra-equity account) |
| **Reissuance** | Can be reissued, sold, or retired |
...
- [Public company](/public-company/) — issues and repurchases its own stock
