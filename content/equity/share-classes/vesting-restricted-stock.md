...
<aside class="wiki-infobox">
  <div class="wiki-infobox-title">Vesting Restricted Stock — key facts</div>
  <table>
    <tr><th>Restriction</th><td>Cannot be transferred or sold until vesting conditions are met</td></tr>
    <tr><th>Typical schedule</th><td>4-year vest with 1-year cliff</td></tr>
    <tr><th>Forfeiture</th><td>Unvested shares are forfeited if recipient departs</td></tr>
...
<ul>
  <li><a href="/wiki/restricted-shares/">Restricted Shares</a> — shares with vesting or transfer restrictions.</li>
  <li><a href="/wiki/vesting-schedule/">Vesting Schedule</a> — the timeline over which restricted shares become fully earned.</li>
  <li><a href="/wiki/employee-stock-options/">Employee Stock Options</a> — options, an alternative to vesting restricted stock for employee compensation.</li>
  <li><a href="/wiki/restricted-stock-units/">Restricted Stock Units</a> — contractual promises of shares (instead of actual restricted shares) with vesting.</li>
</ul>
<h3>Wider context</h3>
<ul>
