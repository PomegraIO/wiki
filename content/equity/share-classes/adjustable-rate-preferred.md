...
- **[Floating-rate preferred](/wiki/floating-rate-preferred/)** typically means benchmark-based (SOFR + spread), reset automatically and predictably.
...
<aside class="wiki-infobox">
  <div class="wiki-infobox-title">Adjustable Rate Preferred Stock — key facts</div>
  <table>
    <tr><th>Dividend</th><td>Resets periodically; not fixed</td></tr>
    <tr><th>Reset mechanisms</th><td>Benchmark formula, auction, issuer discretion, or combinations</td></tr>
    <tr><th>Reset frequency</th><td>Daily (auction), quarterly, semi-annually, or annually</td></tr>
    <tr><th>Common contexts</th><td>Banks, insurance companies, closed-end funds</td></tr>
  </table>
</aside>
...
Adjustable preferred may be redeemable or convertible to [common stock](/wiki/common-stock/). Redemption by the issuer is attractive when rates fall—the issuer redeems the adjustable preferred and refinances at lower rates. Conversion is attractive to investors if the common stock has appreciated sharply.
...
<h3>Wider context</h3>
<ul>
  <li><a href="/wiki/sofr/">SOFR</a> — the Fed's benchmark rate, used in many modern adjustable instruments.</li>
  <li><a href="/wiki/interest-rate-risk/">Interest Rate Risk</a> — the sensitivity of fixed-income values to changing rates.</li>
  <li><a href="/wiki/liquidity-risk/">Liquidity Risk</a> — risk of being unable to sell an asset quickly at fair value.</li>
</ul>
</div>
