...
description: "The process by which a corporation creates and distributes new shares to investors, employees, or the public, increasing the total shares outstanding."
---
...
<aside class="wiki-infobox">
  <div class="wiki-infobox-title">Share Issuance — key facts</div>
  <table>
    <tr><th>Definition</th><td>Creation and distribution of new equity shares</td></tr>
    <tr><th>Impact</th><td>Dilutes existing ownership; raises capital (except secondary offerings)</td></tr>
    <tr><th>Governance</th><td>Requires board authorization; sometimes shareholder approval</td></tr>
    <tr><th>Common forms</th><td>IPO, private funding round, employee equity, acquisition</td></tr>
  </table>
</aside>

## IPO and public issuance

An [initial public offering (IPO)](/wiki/initial-public-offering/) is a company's first issuance of shares to the public:
...
Investors protect against dilution via [anti-dilution provisions](/wiki/anti-dilution-provisions/):
...
<ul>
  <li><a href="/wiki/initial-public-offering/">Initial Public Offering</a> — company's first public share issuance.</li>
  <li><a href="/wiki/share-buyback/">Share Buyback</a> — repurchase of shares, offsetting dilution from issuance.</li>
  <li><a href="/wiki/common-stock/">Common Stock</a> — the typical share class issued to founders and employees.</li>
  <li><a href="/wiki/preferred-stock/">Preferred Stock</a> — senior share class typically issued to investors in fundraising rounds.</li>
</ul>
<h3>Wider context</h3>
<ul>
