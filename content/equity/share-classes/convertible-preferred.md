...
description: "Convertible preferred stock is a hybrid security that combines features of preferred stock with the right to convert into common stock, typically offering fixed dividends with upside potential."
keywords:
...
|   |   |
|---|---|
| **What it is** | Preferred stock with conversion right |
| **Dividend** | Fixed percentage, senior to common |
| **Conversion ratio** | Fixed; e.g., 10 preferred = 1 common share |
| **Conversion timing** | Holder chooses when to convert (or forced at trigger) |
| **Liquidation preference** | Senior to common, like preferred |
| **Anti-dilution** | Often included to protect conversion value |
| **Price floor** | Preferred acting as minimum value floor |
| **Upside** | Unlimited if stock appreciates |
