...
description: "Dual-class shares are two distinct categories of common stock issued by the same company, typically differing in voting power, allowing founders to retain control of a public company."
keywords:
  - dual-class shares
  - multi-class stock
  - founder control
...
|   |   |
|---|---|
| **What it is** | Two-class structure with unequal votes |
| **Class A (public)** | Lower votes (often 1 per share), trades publicly |
| **Class B (founder)** | Higher votes (often 10 per share), held by founder/family |
| **Dividend** | Typically equal per share across classes |
| **Conversion** | Often converts to Class A upon certain transfers |
| **Controlling shareholder** | Class B holder with superior voting power |
| **Examples** | Alphabet, Meta, Amazon, Berkshire Hathaway |
...
- **Class A shares** trade on a [stock exchange](/stock-exchange/) and are owned by public shareholders, institutional funds, and employees. Each Class A share carries one vote at shareholder meetings.
