...
description: "A stock dividend is a distribution of new shares to shareholders in proportion to their existing holdings, increasing share count while reducing the per-share price."
keywords:
  - stock dividend
  - share dividend
  - stock distribution
...
|   |   |
|---|---|
| **What it is** | Distribution of new shares to shareholders |
| **Common sizes** | 5–20% (small stock dividends) |
| **Effect on share count** | Increases by dividend percentage |
| **Effect on price** | Declines proportionally |
| **Effect on market cap** | No change |
| **Tax treatment** | Not taxable at receipt (unless rare exceptions) |
| **Reason** | Preserve cash, return value to shareholders |
| **Similar to** | Stock split or dividend reinvestment |
...
A **[cash dividend](/dividend/)** requires the company to send money to shareholders — a cash outlay that reduces the company's balance sheet. A **stock dividend** requires issuing new shares — a bookkeeping entry that dilutes ownership but does not reduce cash.
...
When a company issues a stock dividend, the [earnings per share](/earnings-per-share/) is adjusted downward proportionally. This is automatic in financial reporting; the company reports EPS on a split-adjusted basis so year-over-year comparisons are meaningful.
