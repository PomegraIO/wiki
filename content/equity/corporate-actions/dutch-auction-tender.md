...
description: "A Dutch auction tender offer is a formal share repurchase in which a company offers to buy back a specified number of shares at a price set by an auction process, allowing shareholders to bid different prices."
keywords:
  - Dutch auction
  - tender offer
...
|   |   |
|---|---|
| **What it is** | Formal share repurchase via auction bidding |
| **Process** | Shareholders bid prices; company sets clearing price |
| **Timeline** | Typically 5–20 business days |
| **Participation** | Voluntary; shareholders choose whether to tender |
| **Price discovery** | Market-driven; clearing price reflects shareholder views |
| **Pro-rata allocation** | At clearing price if oversubscribed |
| **Advantage** | Efficient price; transparency |
| **Disadvantage** | Complex; less common than open-market |
