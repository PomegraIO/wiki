...
description: "The date on which a company's board of directors officially announces a dividend or other distribution to shareholders."
---

*The declaration date is the date when a company's board of directors formally announces a [dividend](/wiki/dividend/) or other distribution to shareholders. On this date, the company becomes legally obligated to make the payment. The board specifies the dividend amount per share, the record date, and the payment date.*

<div class="wiki-hatnote">The first of four important dates in the dividend process. Followed by the <a href="/wiki/ex-dividend-date/">ex-dividend date</a>, <a href="/wiki/record-date/">record date</a>, and payment date.</div>
...
On the declaration date, the company's board meets and votes to declare a [dividend](/wiki/dividend/). The board announces:

- **Dividend amount per share.** The cash payment (e.g., $0.50 per share) or the number of new shares (for a [stock dividend](/wiki/stock-dividend/)).
...
The board also discusses whether the dividend is regular or [special](/wiki/special-dividend/), and whether it signals a change to the company's long-term dividend policy.
...
The declaration of a [dividend](/wiki/dividend/) can trigger different stock-price reactions depending on what the market expected:
...
- **Unexpected dividend.** If a company announces a first-time dividend or [special dividend](/wiki/special-dividend/), the stock may rise sharply, as the market interprets it as a sign of financial strength and management confidence.
...
The declaration date is distinct from the [ex-dividend date](/wiki/ex-dividend-date/). The declaration date is when the dividend is officially announced and becomes a legal obligation. The ex-dividend date is the date on which the stock begins trading without the right to the upcoming dividend.
...
- **Special dividend.** "In addition to our regular quarterly dividend, the board has declared a [special dividend](/wiki/special-dividend/) of $2.00 per share."
...
For shareholders, the declaration date is important because it triggers a series of subsequent dates that determine dividend eligibility. Once the dividend is declared, shareholders know they can receive it if they own shares before the [ex-dividend date](/wiki/ex-dividend-date/).

Long-term shareholders typically ignore the declaration date and subsequent dates; they receive dividends automatically. Traders and investors who buy shares specifically to capture dividends focus on the [ex-dividend date](/wiki/ex-dividend-date/) as the key date.
...
<ul>
  ...
  <li><a href="/wiki/ex-dividend-date/">Ex-dividend date</a> — the date a stock trades without the right to the next dividend.</li>
  <li><a href="/wiki/record-date/">Record date</a> — the date when share ownership is finalized for dividend eligibility.</li>
  <li><a href="/wiki/special-dividend/">Special dividend</a> — one-time, non-recurring dividend distribution.</li>
</ul>
<h3>Wider context</h3>
<ul>
