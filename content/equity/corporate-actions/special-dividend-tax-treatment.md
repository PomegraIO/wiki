---
title: "Special Dividend Tax Treatment for Shareholders"
description: "Special dividends are typically taxed as qualified dividends if they meet holding periods, but return-of-capital distributions may defer taxation. Learn the rules."
keywords:
  - special dividend taxation
  - how special dividends taxed
  - qualified dividend special dividend
  - return of capital dividend
image: /svg/equity.svg
---

*A **special dividend** is taxed according to whether it is a cash return from earnings (taxed as a qualified or ordinary [dividend](/equity/dividend/) if conditions are met) or a return of capital (which defers taxes by reducing your cost basis). The tax treatment depends on the company's earnings status and your holding period, not the label the company gives the distribution.*

<aside class="wiki-infobox">

<div class="wiki-infobox-title">Special Dividend Taxation — key facts</div>

<img src="/svg/equity.svg" alt="An abstract editorial mark for the topic." />

<div class="wiki-infobox-caption">Tax depends on earnings source and holding period, not the special label.</div>

|   |   |
|---|---|
| **Qualified dividend** | Long-term [capital gains](/equity/capital-gains-tax-investor/) tax rates if you hold 60 days around ex-date |
| **Ordinary dividend** | Taxed as ordinary income (higher rates) if paid from earnings but conditions unmet |
| **Return of capital** | Reduces cost basis first; defers tax until you sell shares |
| **Reporting** | Form 1099-DIV from broker; company specifies on ex-date notification |
| **Holding period** | 60 days in 121-day window around ex-date (common stock) |

</aside>

## Qualified vs. ordinary special dividends

The IRS does not tax a special dividend differently from a regular [dividend](/equity/dividend/) just because a company labels it "special." What matters is whether the distribution qualifies for favorable tax rates—and that hinges on two things: earnings availability and your holding period.

If a company has current or accumulated earnings and profits, and you held the stock for 60 days within a 121-calendar-day window centered on the ex-date, the special dividend qualifies for the long-term [capital gains](/equity/capital-gains-tax-investor/) tax rate. For most taxpayers, that is 0%, 15%, or 20%, far lower than ordinary income brackets. Miss the holding period, or receive the distribution from a non-U.S. corporation that does not meet specific requirements, and the entire special dividend is taxed as ordinary income—at your marginal tax rate, which can be 24%, 32%, 35%, or 37% for federal purposes.
...
The broker receives the same disclosure and reports it on your [Form 1099-DIV](/regulation/sec-forms/), in boxes for qualified dividends versus ordinary dividends. If your broker's report conflicts with your understanding, contact them—misreporting can trigger downstream filing errors.
...
Many shareholders lose the holding-period test by accident. If you buy shares, receive the special dividend, and then sell within days, the holding period resets. Similarly, if you have shares in a [covered call](/equity/covered-call/) position (sold call options), some or all of the holding period may not count toward the 60-day requirement, depending on when the call was sold and when it expires.

## Tax reporting and Form 1099-DIV

After a special dividend is paid, your broker reports it on [Form 1099-DIV](/regulation/sec-forms/). The form breaks down dividends into boxes:
...
- [Dividend](/equity/dividend/) — Regular and special dividend mechanics and history.
- [Capital Gains Tax for Investors](/equity/capital-gains-tax-investor/) — Long-term versus short-term rates and holding periods.
- [Dividend Payout Ratio](/equity/dividend-payout-ratio/) — How companies decide dividend sustainability and frequency.
- [Covered Call](/equity/covered-call/) — Holding period complications when selling call options.
- [Share Buyback](/equity/share-buyback/) — Alternative to dividends for returning capital; different tax treatment.

### Wider context

- [Common Stock](/equity/common-stock/) — Basic equity ownership and dividend rights.
- [Form 1099-DIV](/regulation/sec-forms/) — Tax form reporting dividends and capital distributions.
- [Schedule D](/regulation/sec-forms/) — Tax form for reporting capital gains and losses.
- [Tax Bracket for Investors](/equity/tax-bracket-investor/) — How marginal tax rates affect after-tax dividend returns.
