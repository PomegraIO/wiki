...
description: "A corporate action in which a company reduces the number of its outstanding shares by combining multiple shares into one, increasing the price per share."
---
...
<div class="wiki-hatnote">Also called a "reverse stock split" when the consolidation is used to increase share price. See <a href="/wiki/reverse-stock-split/">reverse stock split</a> for the strategic context.</div>
...
**Meet stock exchange listing standards.** The [NYSE](/wiki/new-york-stock-exchange/) and [NASDAQ](/wiki/nasdaq/) require listed companies to maintain a minimum share price (typically $1). A company approaching that minimum may consolidate to avoid delisting.
...
A share consolidation is the opposite of a [stock split](/wiki/stock-split/). A stock split divides shares (1-for-2 becomes 2-for-1, doubling shares), while a consolidation combines shares, reducing the share count. Both are mathematically neutral to shareholders' total value.
...
<ul>
  <li><a href="/wiki/reverse-stock-split/">Reverse stock split</a> — consolidation done to increase share price.</li>
  <li><a href="/wiki/stock-split/">Stock split</a> — opposite of consolidation; divides shares to increase accessibility.</li>
