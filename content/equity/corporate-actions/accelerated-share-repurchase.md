...
description: "An accelerated share repurchase (ASR) is a financial instrument that allows a company to buy back a large number of its shares immediately from an investment bank, with deferred payment or hedging."
keywords:
  - ASR
...
|   |   |
|---|---|
| **What it is** | Accelerated large-scale share buyback |
| **Execution** | Investment bank fronts shares, company pays over time |
| **Timeline** | Immediate delivery, settlement in weeks/months |
| **Size** | Typically $500 million to $2 billion+ |
| **Bank hedge** | Bank shorts stock or uses derivatives to hedge |
| **Company benefit** | Large buyback without market impact |
| **Bank fee** | Usually 2–3% of transaction value |
| **Shareholder benefit** | Mechanical EPS accretion on day one |
...
**EPS accretion on day one**: Because the company records treasury stock immediately, [earnings per share](/earnings-per-share/) is reduced immediately by the share count, providing an EPS boost on the income statement even before cash settlement.
