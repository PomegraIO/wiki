...
description: "A program allowing shareholders to automatically reinvest dividend payments in additional shares of the company, often at a discount."
---

*A dividend reinvestment plan (DRIP) is a program in which shareholders can elect to automatically reinvest their [dividend](/wiki/dividend/) payments by purchasing additional shares of the company, rather than receiving cash. DRIPs often offer a small discount (5–10%) to the current market price, providing a low-cost way for investors to increase holdings.*
...
Shareholders enroll in a company's DRIP through their broker or directly with the company's transfer agent. On the [payment date](/wiki/payment-date/), instead of receiving cash, the shareholder's dividend is used to purchase additional shares at a discount.

**Example:** You own 100 shares of Company XYZ, which declares a $1 quarterly [dividend](/wiki/dividend/). Normally, you would receive $100 in cash. With a DRIP, your $100 dividend buys new shares at a 10% discount. If the stock trades at $50 per share, the DRIP price is $45 per share. Your $100 dividend purchases 2.22 shares ($100 ÷ $45), which are added to your account.
...
**Dividend calculation.** On the [record date](/wiki/record-date/), the company calculates dividends owed. Shareholders enrolled in the DRIP have their dividend amounts set aside.

**Pricing.** The DRIP price is calculated on the [payment date](/wiki/payment-date/) (or an average price over a period). The discount is typically 5–10% to the market price.
...
1. **Dividend taxation.** The reinvested dividend is taxable income in the year received, at the same rate as if the shareholder had received cash ([qualified dividend](/wiki/qualified-dividend/) rates if eligible).
...
Mutual funds and ETFs also offer [dividend](/wiki/dividend/) reinvestment, which is automatic but does not include a discount. Shareholders are taxed on the dividend and buy at market price. The benefit is simplicity; the drawback is no discount.
...
<ul>
  ...
  <li><a href="/wiki/compound-interest/">Compound interest</a> — earning returns on returns.</li>
  <li><a href="/wiki/dollar-cost-averaging/">Dollar-cost averaging</a> — regular investment at varying prices.</li>
</ul>
<h3>Wider context</h3>
<ul>
