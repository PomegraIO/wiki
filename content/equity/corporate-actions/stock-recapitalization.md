---
title: "Stock Recapitalization"
description: "A corporate action in which a company creates new classes of stock or restructures its existing stock classes to change voting rights or economic terms."
---
...
1. **Creating new share classes.** The company issues shares with different voting rights or economic rights. For example:
...
2. **Converting existing shares.** The company's existing shares (if any) are converted into one of the new classes. For example, shares held by early investors may be converted to Class A or Class B shares based on the holder's role or investment round.

3. **Shareholder approval.** The recapitalization typically requires shareholder approval (or approval by shares of the class being altered).
...
Both classes have equal economic claims—they receive the same [dividends](/wiki/dividend/) and have equal rank in [liquidation](/wiki/liquidation/). The difference is purely in voting power, not in economic value.
...
- **Differential dividends.** Shares with different dividend priorities (similar to [preferred stock](/wiki/preferred-stock/)).
...
1. **Agency problem.** Founders with super-voting rights but minority economic interest may pursue strategies that benefit them personally but harm overall shareholders.

2. **Shareholder conflicts.** Different classes of shareholders have different interests and may conflict on key decisions (mergers, dividends, board composition).

3. **Index fund restrictions.** Many index funds and institutional investors avoid or underweight companies with multi-class structures, reducing demand for the stock.

4. **Regulatory restrictions.** The SEC and stock exchanges have rules limiting the degree of voting-power separation. As of 2024, the [NYSE](/wiki/new-york-stock-exchange/) restricts new dual-class structures.
...
**Stock recapitalization versus [merger](/wiki/merger/).** A stock recapitalization is an internal restructuring; no other company is involved.

**Stock recapitalization versus [acquisition](/wiki/acquisition/).** An acquisition brings in a new owner; a stock recapitalization simply changes the terms of existing shares.

**Stock recapitalization versus [preferred stock](/wiki/preferred-stock/).** Preferred stock typically has priority [dividends](/wiki/dividend/) and liquidation rights; stock classes in a recapitalization have equal economic rights but different voting rights.
...
<ul>
  <li><a href="/wiki/dual-class-share-structure/">Dual-class share structure</a> — shares with different voting rights.</li>
  <li><a href="/wiki/preferred-stock/">Preferred stock</a> — equity class with priority rights.</li>
  <li><a href="/wiki/non-voting-shares/">Non-voting shares</a> — shares without voting rights.</li>
  <li><a href="/wiki/recapitalization/">Recapitalization</a> — restructuring of capital structure.</li>
</ul>
<h3>Wider context</h3>
<ul>
