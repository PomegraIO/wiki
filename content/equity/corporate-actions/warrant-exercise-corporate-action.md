---
title: "Warrant Exercise as a Corporate Action"
description: "How warrant exercise works as a corporate action: mechanics, dilution, notice periods, and shareholder impact."
keywords:
  - warrant exercise corporate action
  - dilution warrant exercise
  - warrant exercise mechanics
  - listed warrant exercise notice
...
<div class="wiki-infobox-title">Warrant Exercise — key facts</div>

<img src="/svg/equity.svg" alt="An abstract editorial mark for the topic." />

<div class="wiki-infobox-caption">A scheduled or triggered event in which warrant holders convert their position into newly issued shares.</div>

|   |   |
|---|---|
| **What it is** | Conversion of a long-term call option into new shares at exercise price |
| **Who acts** | Warrant holder decides; company processes and issues new shares |
| **Dilution effect** | Existing shareholders' ownership % declines; EPS typically falls per share |
| **Notice period** | Usually 5–15 business days before exercise deadline |
| **New shares issued** | Number of warrants exercised × shares per warrant |
| **Impact on stock price** | Often negative due to dilution; offset depends on company value changes |
...
1. **Exercise notice submission**: The holder submits an exercise notice to the warrant agent (usually the company's share registrar or a custodian) stating the number of warrants being converted.

2. **Payment and settlement**: The holder pays the exercise price (set at warrant issuance, often $2–$10 per share) for each warrant-equivalent share. This cash flows to the company's treasury.

3. **New share issuance**: The company's registrar issues the equivalent number of new common shares and credits them to the holder's account. These are freshly minted shares, not redistributed from a pool.

4. **Cap table update**: The number of outstanding shares increases immediately. For a company with 10 million shares outstanding, exercising 1 million warrants at 1 share per warrant increases outstanding shares to 11 million.
...
- [Share Buyback vs Dividend](/share-buyback-vs-dividend/) — alternative methods for companies to return or deploy capital
- [Earnings Per Share](/earnings-per-share/) — how dilution reduces EPS per share
- [Convertible Bond](/convertible-bond/) — another security that dilutes when converted into shares
- [Stock Split Effect on Shareholders](/stock-split-effect-on-shareholders/) — a different corporate action that increases share count without dilution
- [Merger](/merger/) — major corporate action that can result in share exchanges
- [Capital Gains Tax for Investors](/capital-gains-tax-investor/) — tax implications of warrant exercise and share sales

### Wider context

- [Option](/option/) — understanding how warrants relate to standard options
- [Share Class A vs B vs C](/share-class-a-vs-b-vs-c/) — how warrant holders' voting rights compare to different share classes
- [Securities and Exchange Commission](/securities-and-exchange-commission/) — regulator overseeing warrant disclosures and corporate actions
- [Debt-to-Equity Ratio](/debt-to-equity-ratio/) — warrant exercise impact on capital structure metrics
