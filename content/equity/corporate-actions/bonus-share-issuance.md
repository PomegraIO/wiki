---
title: "Bonus Share Issuance"
description: "Corporate action distributing additional shares to existing shareholders at no charge, funded by reserves or retained earnings."
keywords:
  - bonus shares
  - bonus issuance
  - stock dividend
...
| Aspect | Details |
|---|---|
| **Funding Source** | Retained earnings, reserves (not new capital) |
| **Cost to Shareholder** | Zero (free shares) |
| **Shares Issued** | Ratio (e.g., 1:1, 2:1, 3:2) |
| **Key Date** | Record date (who is eligible) |
| **Share Price Effect** | Divides by the bonus ratio (2:1 bonus → price halves) |
| **Total Market Cap** | No change (total value unchanged) |
...
**Make shares more affordable.** A company trading at $200 per share might want to lower the nominal price to attract retail investors. A 2:1 bonus brings the price down to $100, increasing [retail participation](/wiki/retail-property-challenges/). Lower share prices often trade at higher volumes.
...
**Tax efficiency (in some jurisdictions).** In countries where [dividends](/wiki/dividend/) are taxed and bonus shares are not (or taxed differently), a bonus issue is tax-efficient. However, most modern tax codes treat bonus shares similarly to [stock dividends](/wiki/stock-dividend/).
...
**[Stock split](/wiki/stock-split/):** The company divides each share into multiple shares (e.g., 1 share becomes 2 shares). This is purely administrative—the per-share price is adjusted downward. No accounting change to equity. Stock splits do not have a "funding source" because they are just a division.

**[Stock dividend](/wiki/stock-dividend/):** Similar to bonus shares but the source is often current earnings (not accumulated reserves). Legally, it may be accounted differently, but economically it is similar to a bonus.
...
**Dividend coverage.** If a company has strong [free cash flow](/wiki/free-cash-flow/) and issues a bonus in addition to dividends, it is a positive signal. If it issues a bonus instead of dividends, it may signal cash flow stress or a desire to preserve cash.
...
- [Share dilution](/wiki/share-dilution/)
- [Retained earnings](/wiki/retained-earnings/)
- [Shareholder rights](/wiki/shares-of-stock/)
