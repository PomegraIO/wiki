---
title: "Demerger"
description: "A corporate action in which a company is split into two or more separate, independent entities, typically through a spin-off or similar transaction."
---

*A demerger is the separation of a company into two or more independent entities. The operation is the opposite of a [merger](/wiki/merger/), which combines two companies. In a demerger, shareholders of the original company receive shares of the newly separated entities, and the original company ceases to exist or is significantly reduced in scope.*

<div class="wiki-hatnote">The term "demerger" is primarily used in Commonwealth jurisdictions (UK, Canada, Australia). In the U.S., the equivalent operation is usually called a <a href="/wiki/spin-off/">spin-off</a> or <a href="/wiki/split-up/">split-up</a>.</div>
...
- **[Spin-off](/wiki/spin-off/).** The parent company remains and shareholders receive shares of the spun-off division.
- **[Split-off](/wiki/split-off/).** Shareholders exchange parent shares for shares of the separated divisions.
- **[Split-up](/wiki/split-up/).** The parent is completely dissolved and shareholders receive shares in multiple independent companies.

## Strategic motivations for demergers

**Unlock value.** A conglomerate trading at a [conglomerate discount](/wiki/conglomerate-discount/) can unlock value by separating into focused companies. Each focused company can be valued on its own merits—growth divisions get growth multiples, stable divisions get stability multiples—rather than being discounted as part of a conglomerate.
...
A demerger is the inverse of a [merger](/wiki/merger/). A [merger](/wiki/merger/) combines two separate companies into one; a demerger separates one company into two or more. Both are major corporate restructurings.

A demerger also differs from a [divestiture](/wiki/divestiture/), where a company sells off a division to an external buyer. In a demerger, shareholders receive shares directly from the separated divisions; in a [divestiture](/wiki/divestiture/), the company receives cash.
...
In the U.S., a demerger ([spin-off](/wiki/spin-off/)) can be tax-free under Section 355 of the Internal Revenue Code, provided it meets strict requirements (80% retention of control, active business, etc.).

## Impact on shareholders

Shareholders typically benefit from demergers if the [conglomerate discount](/wiki/conglomerate-discount/) is real and the separated companies are more efficiently operated:
...
<ul>
  <li><a href="/wiki/spin-off/">Spin-off</a> — demerger structure where parent remains and shareholders receive subsidiary shares.</li>
  <li><a href="/wiki/split-off/">Split-off</a> — demerger where shareholders exchange parent shares for separated entity shares.</li>
  <li><a href="/wiki/split-up/">Split-up</a> — demerger that completely dissolves the parent company.</li>
  <li><a href="/wiki/divestiture/">Divestiture</a> — sale of a subsidiary to an external buyer.</li>
</ul>
<h3>Wider context</h3>
<ul>
