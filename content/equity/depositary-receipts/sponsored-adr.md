---
title: "Sponsored ADR"
description: "A sponsored ADR is an American depositary receipt that is initiated and controlled by the underlying foreign company, which is responsible for regulatory compliance and investor relations."
keywords:
  - sponsored ADR
  - ADR program
...
|   |   |
|---|---|
| **Initiator** | Foreign company (not bank) |
| **Control** | Company controls program terms |
| **Cost to company** | Higher (company pays depositary fees and compliance) |
| **Investor base** | Institutional and retail; more professional |
| **SEC oversight** | Higher (especially for Level II–III) |
| **Regulatory filings** | Company responsible for SEC compliance |
| **Trading venue** | NYSE, NASDAQ, or OTC (depending on level) |
| **Conversion** | Fully supported; depositary handles |
...
1. **Appoints a depositary**: Selects J.P. Morgan, BNY Mellon, or Citibank as the official depositary.

2. **Negotiates terms**: Company and depositary agree on:
...
3. **Files with SEC**: For Level II or III, company files required documents (Form F-6 registration statement, financial statements in US GAAP, etc.).

4. **Lists on exchange**: ADRs trade on NYSE or NASDAQ (Level II) or OTC (Level I).

5. **Investor relations**: Company manages investor communication, earnings calls, and Q&A specific to ADR holders.

6. **Regulatory compliance**: Company is responsible for ongoing SEC compliance, financial reporting, and Sarbanes-Oxley compliance (for Level II–III).
