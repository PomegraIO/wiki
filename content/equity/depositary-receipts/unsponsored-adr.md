---
title: "Unsponsored ADR"
description: "Depositary receipt issued without the foreign company's participation or approval."
keywords:
  - unsponsored ADR
  - ADR
  - depositary receipt
...
*An **Unsponsored ADR** is a [depositary receipt](/wiki/american-depository-receipt-adr/) that a US bank issues without the foreign company's consent. The bank buys shares of the foreign stock and wraps them in ADRs, which trade on US exchanges. The foreign company has no involvement, no fee arrangement, and typically no influence over the ADR's terms.*
...
| Aspect | Detail |
|---|---|
| **Issuance** | Bank initiates without company approval |
| **Company Involvement** | None; company does not profit |
| **Common Use** | Small-cap or lesser-known foreign companies |
| **Underlying Shares** | Must be tradable on foreign exchange |
| **Trading Venue** | OTC markets, rarely NYSE/NASDAQ |
| **Investor Access** | Retail; less liquid than sponsored |
| **Disclosure** | Minimal; limited company cooperation |
...
From the investor's perspective, an unsponsored ADR trades like any security—ticker symbol, pricing, dividends—but with key differences from a [sponsored ADR](/wiki/sponsored-adr/).

## Sponsored vs. unsponsored: The critical differences

| Aspect | Sponsored | Unsponsored |
|---|---|---|
| **Initiation** | Company requests; company benefits | Bank unilaterally initiates |
| **Company involvement** | Full participation; input on terms | None; no control |
| **Fee arrangement** | Company and bank negotiate | Company does not benefit |
| **ADR levels** | Often Level 2 or 3 (listed exchanges) | Usually Level 1 (OTC) |
| **Disclosure** | Company provides investor relations | Minimal; limited company cooperation |
| **Liquidity** | Generally higher | Typically lower |
| **Dividends** | Coordinated through company | Bank must locate dividends from shareholders |
| **Voting rights** | Typically facilitated | May be limited or unavailable |
...
- **Regulatory efficiency**: A bank can unilaterally issue ADRs without SEC approval or company negotiation. Sponsored ADRs require [SEC](/wiki/securities-and-exchange-commission/) registration.
...
In a [sponsored ADR](/wiki/sponsored-adr/), the company facilitates shareholder voting on proxies: annual meetings, board elections, mergers, etc. ADR holders can vote their shares via the bank, and results flow back to the foreign company.
...
**Level 2 and 3 ADRs** require [SEC](/wiki/securities-and-exchange-commission/) registration and are listed on NASDAQ or NYSE. These are almost always sponsored ADRs, because the company's cooperation is needed for SEC filing and ongoing disclosure.
...
### Closely related
- [American Depositary Receipt (ADR)](/wiki/adr/) — parent concept
- [Sponsored ADR](/wiki/sponsored-adr/) — preferred alternative
- [ADR issuance](/wiki/adr-issuance/) — mechanics
- [ADR trading](/wiki/adr-trading/) — liquidity and execution
