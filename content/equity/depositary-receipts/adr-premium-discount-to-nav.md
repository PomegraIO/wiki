...
keywords:
  ...
  - adr price vs ordinary share
  - arbitrage adr underlying shares
  - adr valuation divergence
image: /svg/equity.svg
---

*An [American Depositary Receipt](/adr/) can trade at a **premium or discount** to the implied value of its underlying ordinary shares, even though it represents an identical economic claim. The gap emerges from convenience costs, [currency risk](/adr-currency-risk/) perception, and supply-demand imbalances in separate markets.*

<aside class="wiki-infobox">

<div class="wiki-infobox-title">ADR Premium and Discount — key facts</div>

<img src="/svg/equity.svg" alt="An abstract editorial mark for the topic." />

<div class="wiki-infobox-caption">ADRs and underlying shares should move in tandem, but friction and market dynamics create persistent gaps.</div>

|   |   |
|---|---|
| **Premium** | ADR trades above implied share value |
| **Discount** | ADR trades below implied share value |
| **Main drivers** | Currency volatility, [liquidity](/liquidity-risk/), fees, news timing |
| **Typical range** | −3% to +5%, occasionally wider |
| **Arbitrage window** | Large gaps attract conversion and short selling; gaps close |
| **Implication for investor** | Buying high-premium ADR means overpaying vs. home-market share |

</aside>

## Why two prices for one share?

An [ADR](/adr/) is a certificate issued by a US depositary bank; it trades on a US exchange in US dollars. The underlying ordinary share trades on a foreign exchange in foreign currency. Although they represent the same economic ownership, they trade in different markets, at different times, with different buyers and sellers. This separation naturally creates pricing misalignment.
...
**Illiquidity of the ADR** depresses price. If a company's ADR is thinly traded (small US investor base, or a foreign company with limited US following), the [bid-ask spread](/bid-ask-spread/) widens and the effective price falls. A small investor selling a large ADR position may accept a discount to move the shares quickly.
...
**For dividend and [total return](/return-on-equity/) calculations**, the premium or discount is a one-time effect. The long-term economic return depends on the company's growth and [dividend yield](/dividend-yield/), not on whether you paid a 2% premium. But for timing an entry or exit, it matters.

## Currency and fee interactions

The premium and discount often move with [currency volatility](/currency-volatility/). If the foreign currency strengthens, the ordinary share becomes more expensive in US dollar terms, making the ADR relatively cheaper (narrowing any premium or creating a discount). If the foreign currency weakens, the ordinary share becomes cheaper to US investors, and the ADR may command a premium.
...
Short-term investors should monitor premiums and discounts; they are meaningful for entry and exit points. Long-term investors can largely ignore them. The company's earnings growth and [return on equity](/return-on-equity/), not the ADR premium, will drive your wealth over a decade. A 3% premium is noise in a 10-year horizon.
...
- [American Depositary Receipt](/adr/) — US certificate representing foreign shares
- [How ADR Conversion Works](/adr-conversion-process/) — redeeming ADRs for underlying ordinary shares
- [Currency Risk in ADR Investing](/adr-currency-risk/) — exchange-rate effects on ADR returns
- [Bid-Ask Spread](/bid-ask-spread/) — difference between buy and sell prices
- [Liquidity Risk](/liquidity-risk/) — difficulty selling quickly at fair price

### Wider context

- Arbitrage — profiting from price differences across markets
- [Dividend Yield](/dividend-yield/) — annual dividend as a percentage of share price
- [Stock Exchange](/stock-exchange/) — marketplace for buying and selling securities
- [Currency Risk](/currency-risk/) — loss from exchange-rate moves
- [Custodian](/custodian/) — organisation holding securities on behalf of owners
