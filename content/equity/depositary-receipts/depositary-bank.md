---
title: "Depositary Bank"
description: "The financial institution that issues and manages depositary receipts on behalf of foreign companies, handling the mechanics of share custody, dividend distribution, and investor servicing."
keywords:
  - depositary bank
  - adr issuance
...
The depositary bank is not the actual holder of the foreign shares on its own balance sheet. Rather, it contracts with a [local custodian](/custodian-bank-adr/) in the company's home market to physically hold or book-enter the ordinary shares. The depositary bank, meanwhile, sits at the top of this structure, managing the investor-facing operations, issuing receipts, and ensuring the mechanics of the program function smoothly.
...
The timing and mechanics of this process are set out in the [fund prospectus](/fund-prospectus/) or depositary agreement. The depositary bank may take a small fee for this service—typically a few cents per receipt per year. Investors should be aware that currency conversion happens at the depositary bank's chosen rate; they bear any slippage between the theoretical and actual exchange rate used.
...
- [Depositary Receipt](/adr/) — the tradeable security issued by a depositary bank, representing a claim to underlying foreign shares
- [Custodian Bank in ADR Programs](/custodian-bank-adr/) — the local institution holding the underlying ordinary shares in the foreign market
- [Rule 144A ADR](/rule-144a-adr/) — private-placement depositary receipts sold only to qualified institutional buyers
- [Regulation S Depositary Receipt](/regulation-s-adr/) — depositary receipts issued to non-US investors offshore without SEC registration
- [Fund Prospectus](/fund-prospectus/) — the disclosure document governing the terms and conditions of a depositary receipt program

### Wider context

- [American Depositary Receipt](/adr/) — the most common form of depositary receipt, used to bring foreign shares to US markets
- [Securities and Exchange Commission](/securities-and-exchange-commission/) — the US regulator overseeing depositary receipt programs
- [Stock](/stock/) — the underlying ordinary shares that a depositary receipt represents
- [Initial Public Offering](/initial-public-offering/) — an alternative route to US capital markets that avoids depositary arrangements
- [Custodian](/custodian/) — financial institutions that hold assets on behalf of others
