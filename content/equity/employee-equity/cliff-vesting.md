---
title: "Cliff vesting"
description: "Cliff vesting is a vesting schedule structure in which a large portion of equity becomes fully vested after a waiting period (typically one year), with remaining equity vesting gradually thereafter."
keywords:
  - cliff vesting
  - cliff
  - vesting cliff
...
|   |   |
|---|---|
| **What it is** | Vesting structure with initial hard threshold |
| **Standard cliff** | 1 year (can be 6 months, 18 months, or other) |
| **Vesting at cliff** | Often 25% of total grant |
| **After cliff** | Monthly vesting of remaining shares |
| **Total duration** | Typically 4 years (can vary) |
| **Forfeiture if leave before cliff** | 100% (all shares forfeit) |
| **Forfeiture after cliff** | Pro-rata (partial equity forfeit, partial earned) |
