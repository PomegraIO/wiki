---
title: "Incentive stock option"
description: "An incentive stock option (ISO) is an employee stock option that qualifies for preferential tax treatment under US tax law, allowing long-term capital gains rates on exercise gain if holding periods are met."
keywords:
  - ISO
...
|   |   |
|---|---|
| **What it is** | Tax-qualified employee stock option |
| **Strike price** | Grant-date FMV, no discount |
| **Tax at exercise** | Ordinary income (subject to AMT) |
| **Tax at sale** | Long-term capital gains if holding periods met |
| **Long-term holding period** | 1+ year post-exercise, 2+ years post-grant |
| **Grant limit** | $100,000 per employee per calendar year |
| **Eligible holder** | Employee only (not contractor) |
| **Exercise period** | Usually 10 years post-grant |
| **AMT** | Alternative Minimum Tax may apply |
