---
title: "How a Tender Offer Works for Employee Stockholders"
description: "Learn how a tender offer affects employees with company stock, including eligibility, proration, timing, and tax consequences."
keywords:
  - tender offer
  - employee stockholders
  - secondary sale
  - acquisition tender offer
  - tender offer how it works for employees with stock
  - stock tender
...
<div class="wiki-infobox-title">Tender Offer for Employees — key facts</div>

<img src="/svg/equity.svg" alt="An abstract editorial mark for the topic." />

<div class="wiki-infobox-caption">Secondary and acquisition tender offers create liquidity windows; tax consequences are usually capital gains.</div>

|   |   |
|---|---|
| **Tender window** | Typically 20–40 days to submit shares |
| **Eligibility** | Usually vested shares only; sometimes restricted by blackout periods |
| **Offer price** | Set in advance; usually per-share cash or stock equivalent |
| **Minimum acceptance** | Company sets a floor; offer may fail if not met |
| **Proration** | If oversubscribed, your shares may be cut; pro-rata reduction common |
| **Tax treatment** | Usually [long-term capital gain](/long-term-capital-gain-tax/) if held >1 year |
| **Secondary vs. acquisition** | Secondary: direct from company; acquisition: from acquirer's cash or stock |
...
- [Capital Gains Tax Investor](/capital-gains-tax-investor/) — How gains on equity sales are taxed
...
- [Long-Term Capital Gain Tax](/long-term-capital-gain-tax/) — The preferential rate for >1 year holds
- [Cost Basis](/cost-basis/) — Calculating your gain on sale
- [Merger](/merger/) — The typical exit vehicle alongside acquisition tender offers

### Wider context

- [Acquisition](/acquisition/) — The broader business context
- Liquidity Event — Tender offers as a form of partial exit
- [Secondary Offering](/secondary-offering/) — Public-market equivalent; similar structure
- [Market Order](/market-order/) — How you sell shares on a public exchange (less relevant; tender offers are structured sales)
- [Diversification](/diversification/) — Why concentrating in one stock is risky
