---
title: "Equity Pool"
description: "The total number of shares authorized for issuance as employee equity awards under a company's stock option or RSU plan, limiting the company's ability to grant equity without shareholder approval."
---
...
Post-IPO equity is issued at the IPO price. An engineer granted options at IPO at $50/share has a known [grant date price](/wiki/grant-date-price/). There's no uncertainty like in private companies.

## Pool dynamics across funding stages

| Stage | Typical pool size | Reason |
|-------|-------------------|--------|
| Pre-seed | 5–15% of authorized shares | Tiny; founders only |
| Seed | 10–20% | Small team, conservative |
| Series A | 15–20% | Growing team; significant grants |
| Series B+ | 10–15% | Diluted by previous rounds; scaling |
| Pre-IPO | 10–20% | Conservative; preparing for public market |
| Public | 10–15% (evergreen provision) | Automatic replenishment; long-term management |
...
<ul>
  <li><a href="/wiki/stock-option-plan/">Stock option plan</a> — defines the pool.</li>
  <li><a href="/wiki/employee-stock-options/">Employee stock options</a> — consume pool shares.</li>
  <li><a href="/wiki/restricted-stock-units/">Restricted stock units</a> — also consume pool shares.</li>
  <li><a href="/wiki/equity-grant-letter/">Equity grant letter</a> — specifies the individual grant from the pool.</li>
  <li><a href="/wiki/equity-refresh-grant/">Equity refresh grant</a> — future grants from the remaining pool.</li>
</ul>
<h3>Wider context</h3>
<ul>
