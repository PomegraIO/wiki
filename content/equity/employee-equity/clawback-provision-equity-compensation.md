---
title: "Clawback Provisions in Equity Compensation"
description: "Understand clawback provisions in equity compensation: when employers reclaim vested awards, SEC Rule 10D-1 requirements, and private company triggers."
keywords:
  - clawback provision
  - equity compensation clawback
  - clawback vested shares
  - sec rule 10d-1
  - executive clawback
...
<div class="wiki-infobox-title">Clawback Provisions — key facts</div>

<img src="/svg/equity.svg" alt="An abstract editorial mark for the topic." />

<div class="wiki-infobox-caption">Clawbacks let employers reclaim vested equity; public companies face SEC-mandated rules; private companies have wider discretion.</div>

|   |   |
|---|---|
| **SEC Rule 10D-1** | Mandatory for listed companies; applies to officers, directors, PEOs; triggered by accounting restatement |
| **Recovery period** | 3 years lookback from restatement; applies to incentive compensation |
| **Private company clawbacks** | Typically in equity plans or employment agreements; triggered by resignation, termination for cause, or sale-related clawbacks |
| **Mechanics** | Employer demands return of shares, offsets salary, or forfeits unvested awards |
| **Tax treatment** | May trigger repayment of deferred income taxes; varies by structure |
| **Vesting status** | Clawbacks apply to vested equity; unvested equity simply forfeits |
| **Common triggers** | Financial restatement, fraud, breach of non-compete, voluntary departure, sale-related adjustments |
...
## Sale-related clawbacks and escrow arrangements
...
- [Equity Compensation](/equity-compensation/) — Broader framework; clawbacks are a risk adjustment
- Employment Agreement — Where clawback terms are codified
- [Dodd-Frank Act](/dodd-frank-act/) — Legislation requiring Rule 10D-1 clawbacks
- [Merger](/merger/) — Often triggers escrow and clawback structures
