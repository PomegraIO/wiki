...
description: "Restricted stock is common or preferred stock granted as compensation to employees or executives, subject to vesting schedules and transfer restrictions, converting to unrestricted shares upon vesting."
keywords:
  - restricted stock
  - restricted shares
  - RSA
...
|   |   |
|---|---|
| **What it is** | Common stock with vesting and transfer restrictions |
| **Ownership** | Immediate but restricted |
| **Voting** | Yes, from day one (on unvested shares) |
| **Dividends** | Yes, paid on unvested shares (dividend reinvestment) |
| **Vesting schedule** | Typically 4 years with 1-year cliff |
| **Transfer restriction** | Until vesting complete (usually) |
| **Forfeiture** | Upon departure before full vesting |
| **Tax treatment** | Ordinary income on vesting; capital gains on sale |
