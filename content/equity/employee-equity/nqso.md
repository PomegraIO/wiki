...
description: "A non-qualified stock option (NQSO) is an employee stock option that does not meet IRS qualification requirements, making the exercise gain taxable as ordinary income."
keywords:
  - NQSO
...
|   |   |
|---|---|
| **What it is** | Non-qualified employee stock option |
| **Strike price** | No restriction; can be discounted or at FMV |
| **Tax at exercise** | Ordinary income on exercise gain |
| **Tax rate** | 37% top ordinary rate (vs. 20% capital gains) |
| **Annual limit** | None; unlimited grant size |
| **Eligible holder** | Employee or contractor |
