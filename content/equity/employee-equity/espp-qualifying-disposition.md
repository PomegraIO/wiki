---
title: "ESPP Qualifying Disposition: Rules and Tax Treatment"
description: "Understand ESPP qualifying disposition rules, holding periods, and how the gain splits between ordinary income and capital gain."
keywords:
...
<div class="wiki-infobox-title">ESPP Qualifying Disposition — key facts</div>

<img src="/svg/equity.svg" alt="An abstract editorial mark for the topic." />

<div class="wiki-infobox-caption">Hold for 1 year + 2 years from grant to unlock capital-gain treatment on part of the gain.</div>

|   |   |
|---|---|
| **Holding period** | 1 year from purchase + 2 years from grant date (whichever is longer) |
| **Ordinary income** | The discount: lesser of (1) grant–purchase discount or (2) appreciation at sale |
| **Long-term capital gain** | Remaining gain above ordinary income; taxed at preferential rates |
| **Disqualifying sale** | Sell before holding period; entire gain is ordinary income |
| **Reporting** | Form 3921 (issued by plan); reported on Schedule D + Form 8949 |
| **Buildup phase** | Usually 6–12 months; purchase price fixed at 85–90% of fair market value |
| **Tax advantage** | Only qualified disposition unlocks capital-gain treatment |
...
- [ESPP](/espp/) — The plan structure; rules and mechanics
- [Long-Term Capital Gain Tax](/long-term-capital-gain-tax/) — The preferential rate on ESPP gains
- [Cost Basis](/cost-basis/) — Calculating your purchase price and holding period
...
- [Schedule D](/schedule-d/) — Tax form for reporting capital gains

### Wider context

- [Capital Gains Tax Investor](/capital-gains-tax-investor/) — How equity gains are taxed across vehicle types
- Vesting — How equity is earned over time; separate from ESPP holding periods
- [Tax Loss Harvesting](/tax-loss-harvesting/) — Offsetting gains on sales of underwater ESPP positions
- [Marginal Tax Rate Investor](/marginal-tax-rate-investor/) — The bracket that determines your ordinary income tax on the discount
- [Diversification](/diversification/) — Why holding concentrated ESPP shares is risky
