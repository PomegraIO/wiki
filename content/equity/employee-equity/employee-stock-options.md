...
description: "Employee stock options (ESOs) are the right to purchase company shares at a fixed strike price after a vesting period, allowing employees to benefit from stock price appreciation."
keywords:
...
|   |   |
|---|---|
| **What it is** | Right to buy shares at fixed strike price |
| **Strike price** | Grant-date FMV (usually), set at grant |
| **Vesting** | Typically 4 years with 1-year cliff |
| **Exercise price** | Same as strike price |
| **Exercise period** | Usually 5–10 years after grant |
| **Benefit** | Stock price appreciation above strike |
| **Tax types** | Incentive stock options (ISOs) and non-qualified (NQSOs) |
| **Cashless exercise** | Broker-assisted same-day sale-to-cover |
