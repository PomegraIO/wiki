...
description: "Restricted stock units (RSUs) are a form of equity compensation that grant employees the right to receive shares upon vesting, rather than granting actual shares immediately."
keywords:
  - RSU
...
|   |   |
|---|---|
| **What it is** | Promise to issue shares at vesting |
| **Ownership** | None until vesting and settlement |
| **Voting** | None until vesting and settlement |
| **Dividends** | None (though some grants include dividend equivalents) |
| **Vesting schedule** | Typically 4 years with 1-year cliff |
| **Settlement** | Upon vesting, shares issued automatically |
| **Tax at vesting** | Ordinary income on FMV at vesting |
| **Advantage** | No forfeiture risk, no tax complications |
