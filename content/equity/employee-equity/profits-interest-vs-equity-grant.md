---
title: "Profits Interest vs Equity Grant in a Partnership"
description: "Understand the difference between a profits interest vs equity grant in partnerships and LLCs: tax timing, economic rights, and practical implications."
keywords:
  - profits interest
  - equity grant
  - partnership compensation
  - llc equity
  - profits interest vs equity grant partnership
  - carried interest
...
<div class="wiki-infobox-title">Profits Interest vs Equity Grant — key facts</div>

<img src="/svg/equity.svg" alt="An abstract editorial mark for the topic." />

<div class="wiki-infobox-caption">Partnership and corporate equity compensate differently; profits interests defer taxes longer.</div>

|   |   |
|---|---|
| **Profits interest** | Future profit growth only; standard taxed on sale |
| **Equity grant (stock)** | Past + future value; ordinary income on vesting or exercise |
| **Tax deferral** | Profits interest often longer (no Section 83(b) required) |
| **Liquidity** | Equity (stock) typically more liquid; partnership interests less so |
| **Path to ownership** | Profits interest doesn't require cash outlay; stock grant usually does |
| **Common in** | Private equity, hedge funds, law firms, real estate; stock in public companies |
...
- [Carried Interest](/carried-interest/) — Profits interest in investment partnerships; the "2 and 20" model
- [Equity Financing](/equity-financing/) — How partnerships and corporations raise capital
- [Tax Loss Harvesting](/tax-loss-harvesting/) — Offsetting gains on equity sales
- Shareholder — Rights and obligations of equity owners

### Wider context

- Partnership — Legal structure underlying profits interests
- [Capital Gains Tax](/capital-gains-tax-investor/) — How gains on equity are taxed
- [Marginal Tax Rate](/marginal-tax-rate-investor/) — The bracket that determines your tax cost
- Vesting — How equity is earned over time
- [Liquidation Preference](/liquidation-preference/) — How payouts are ordered in a dissolution
