...
description: "An at-the-market offering (ATM) is a continuous program through which a public company sells shares into the open market at prevailing prices, raising capital gradually over time."
keywords:
  - ATM
...
|   |   |
|---|---|
| **What it is** | Ongoing share issuance at market prices |
| **Duration** | Open-ended (until company terminates) |
| **Pricing** | At or near current market price |
| **Capital raised** | Gradually over time |
| **Underwriter** | Single bank agent manages sales |
| **Underwriter fee** | Lower than traditional offering (0.5–1%) |
| **Market impact** | Minimal; shares sold gradually |
| **Frequency** | Can be suspended or accelerated |
...
1. **Registration**: Company files with SEC to register the ATM program.

2. **Agent appointment**: Company appoints an investment bank as the "agent" or "sales agent" to manage the program.

3. **Gradual issuance**: Over weeks, months, or years, the agent sells shares on the company's behalf at the current market price.

4. **Capital deployment**: The company receives proceeds and uses them for operations, acquisitions, debt repayment, or balance sheet management.

5. **Program termination**: The company can terminate the ATM program at any time or allow it to expire after $1 billion is raised.
