...
description: "A lock-up period is a contractual or regulatory restriction preventing insiders (founders, employees, early investors) from selling their shares for a specified time, typically six months post-IPO."
keywords:
  - lock-up period
  - IPO lock-up
  - trading restriction
...
|   |   |
|---|---|
| **What it is** | Ban on insider share sales post-IPO |
| **Typical duration** | 6 months (can be 12+ months) |
| **Who is locked up** | Founders, employees, early investors, insiders |
| **Exceptions** | Gifts, estate settlements, certain hedges |
| **Enforcement** | Contractually binding; violation triggers penalties |
| **Expiration effect** | Often triggers stock price decline (selling pressure) |
| **Extensions** | Sometimes extended by mutual agreement |
