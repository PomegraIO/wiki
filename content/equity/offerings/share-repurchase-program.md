...
description: "An authorization by a company's board to buy back its own stock over time, reducing the share count and returning capital to shareholders without issuing a dividend."
---

*A share repurchase program (or buyback authorization) is a board decision to allow the company to purchase its own shares on the open market or via negotiated transactions, up to a specified dollar amount or number of shares. The company repurchases shares to reduce share count, increase [earnings per share](/wiki/earnings-per-share/), or signal to the market that management believes the stock is undervalued. A repurchase program is open-ended and executed opportunistically over weeks or months, contrasting with structured mechanisms like [accelerated share repurchases](/wiki/accelerated-share-repurchase/) or [Dutch auction tenders](/wiki/dutch-auction-repurchase/).*
...
Once repurchased, the shares become treasury stock: authorized but not outstanding. The company may later reissue treasury shares for employee stock options, acquisitions, or other corporate purposes. Treasury shares do not participate in dividends, do not have voting rights, and do not dilute [earnings per share](/wiki/earnings-per-share/) calculations.
...
1. **Volume constraint**: The repurchase cannot exceed 25 percent of the stock's average daily trading volume.
2. **Timing constraint**: Repurchases must occur in the latter half of the trading day, avoiding the opening auction.
3. **Broker constraint**: The company must use a single designated broker per day.
4. **Price constraint**: The repurchase price cannot exceed the highest current independent bid price.
...
Repurchased shares are recorded as a deduction from equity (treasury stock). The repurchase reduces the number of shares outstanding, which mechanically increases [earnings per share](/wiki/earnings-per-share/). If net income is $100 million and the company has 50 million shares outstanding, EPS is $2. If the company repurchases 5 million shares, EPS becomes $100 million / 45 million = $2.22, an 11 percent increase.
...
<ul>
<li><a href="/wiki/accelerated-share-repurchase/">Accelerated share repurchase</a> — a structured variant executing a large buyback in weeks.</li>
<li><a href="/wiki/dutch-auction-repurchase/">Dutch auction repurchase</a> — a variant using price discovery to set the repurchase price.</li>
<li><a href="/wiki/treasury-stock/">Treasury stock</a> — the accounting classification of repurchased shares.</li>
</ul>
<h3>Wider context</h3>
<ul>
