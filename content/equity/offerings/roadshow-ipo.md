---
title: "Roadshow (IPO)"
description: "Management presentations to institutional investors during an IPO process to market the company and gauge demand."
keywords:
  - roadshow
  - ipo
...
| **Venues** | 20–40 cities (New York, London, San Francisco, etc.) |
| **Participants** | CFO, CEO, maybe COO and board members |
| **Audience** | Institutional investors (not retail) |
| **Feedback** | Investors signal demand and pricing expectations |
| **Timing** | Occurs after SEC registration statement filed, before pricing |
| **Geographic spread** | Often US-focused, plus major financial hubs |
| **Investor meetings** | 30–50 per day per city (breakfast, lunch, afternoon) |
...
5. **Trading** — shares begin trading on exchange (IPO day).
...
1. **Presentation** (30–45 minutes) — CFO walks through:
   - Business overview and market size
   - Revenue model and growth trajectory
   - [Margins](/wiki/gross-margin-analysis/) and unit economics
   - Competition and differentiation
   - Financial projections (3–5 years forward)
   - Use of proceeds from the IPO
   - Management bios

2. **Q&A** (30–45 minutes) — investors ask:
   - How real are the growth projections?
   - What are the key risks?
   - How does the company compare to public peers on [valuation](/wiki/multiples-valuation/)?
   - What is the competitive moat?
   - [Management quality](/wiki/management-certification/)?

3. **One-on-one conversations** — smaller groups or pairs meet the CFO or CEO for deeper dives.

## The [book building](/wiki/book-building-process/) feedback loop
...
- **Selective access** — roadshow attendees are [qualified institutional buyers](/wiki/qualified-institutional-buyer/) (mostly). Retail investors don't attend. This limits the information dissemination and gives early institutional investors an information advantage.
...
1. **Final pricing meeting** — underwriters, company, and SEC (informally) agree on final price.
2. **Book closure** — underwriters finalize which investors get how many shares. Large institutions who expressed strong demand and attendance at roadshow events get priority allocation.
3. **Underpricing** — the company intentionally prices below what demand could support (e.g., roadshow feedback suggests $25 could sell, but IPO prices at $20). This leaves "money on the table" but ensures a strong first-day pop and goodwill with institutional buyers.
...
### Closely related
- [Initial public offering (IPO)](/wiki/initial-public-offering/) — the full IPO process
