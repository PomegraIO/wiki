---
title: "Share buyback"
description: "A share buyback is a corporate action in which a company repurchases its own outstanding shares from the market, reducing share count and returning cash to shareholders."
keywords:
  - share buyback
  - stock buyback
  - share repurchase
...
|   |   |
|---|---|
| **What it is** | Company purchases its own shares |
| **Typical payout** | 5–10% of cash flow annually |
| **Effect on share count** | Reduces shares outstanding |
| **Effect on EPS** | Mechanical boost from lower denominator |
| **Effect on market cap** | No change (cash spent equals shares repurchased) |
| **Execution** | Open market purchase or tender offer |
| **Tax treatment** | No tax to non-selling shareholders; sellers pay capital gains |
| **Frequency** | Ongoing programs or one-time special buybacks |
...
The market cap is unchanged (the company just converted cash to shares). However, earnings are divided by fewer shares, boosting [earnings per share](/earnings-per-share/).

## Why companies buy back stock

1. **Return cash to shareholders**: An alternative to a [dividend](/dividend/). Rather than sending cash out, the company buys shares, letting shareholders who want cash sell their shares (and pay capital gains tax, potentially favorable compared to dividend income tax). Shareholders who want to hold reinvest at a lower entry point.
...
Buybacks mechanically boost [earnings per share](/earnings-per-share/), even if the company's total earnings are unchanged. Many analysts, investors, and executives fixate on EPS growth as a sign of health.
