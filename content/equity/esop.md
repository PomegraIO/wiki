...
description: "An employee stock ownership plan (ESOP) is a qualified retirement plan that invests primarily in employer stock, allowing employees to build equity ownership in their company."
keywords:
  - ESOP
...
|   |   |
|---|---|
| **What it is** | Qualified retirement plan holding company stock |
| **Investor** | Individual employees (collectively) |
| **Holdings** | Primarily employer stock |
| **Tax treatment** | Qualified retirement plan (tax-deferred) |
| **Contributions** | Made by company or funded by acquisition financing |
| **Valuation** | Annual independent appraisal required |
| **Distribution** | Upon retirement, termination, or death |
| **Leverage** | Can borrow to acquire stock (leveraged ESOP) |
