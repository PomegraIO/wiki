...
description: "The estimated cash value of a company's assets if sold immediately and the company is wound down, typically the lowest valuation for a solvent business."
keywords:
  - liquidation value
  - asset value
  - breakup value
...
1. **List all assets.** From the balance sheet: cash, accounts receivable, inventory, equipment, real estate, goodwill, intangibles.

2. **Estimate liquidation values.** What would each asset fetch if sold today in a hurry?
...
3. **Sum asset liquidation values.** Total recoverable from asset sales.

4. **Subtract liabilities.** All debt, trade payables, accruals, contingent liabilities, severance obligations, taxes.

5. **Net liquidation value.** What remains for equity holders.
