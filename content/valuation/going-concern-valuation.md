...
description: "A valuation approach that values a company as a living, ongoing business with indefinite life and future cash generation, as opposed to liquidation or broken-up value."
keywords:
  - going concern
  - continuity value
  - intrinsic value
...
1. **Forecast cash flows.** Project 5–10 years of revenue, margins, capex, working capital.
2. **Choose a discount rate.** Cost of equity or WACC, depending on whether you are valuing equity or firm.
3. **Calculate terminal value.** Assume perpetual growth from the final explicit year onward.
4. **Discount and sum.** PV all cash flows plus terminal value.
...
1. Lower the growth rate.
2. Raise the discount rate (reflect higher risk).
3. Use scenario analysis: going-concern base case with 50% probability, restructuring/distressed scenarios with lower probabilities.
4. Reduce terminal value or set a near-term horizon if you expect business to end.
