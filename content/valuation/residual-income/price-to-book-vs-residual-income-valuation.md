---
title: "Price-to-Book vs Residual Income Valuation"
description: "Compare using price-to-book multiples with residual income modeling to identify when the shortcut is adequate and when deeper analysis reveals hidden overvaluation or undervaluation."
keywords:
...
<div class="wiki-infobox-title">Price-to-Book vs Residual Income Valuation — key facts</div>

<img src="/svg/valuation.svg" alt="An abstract editorial mark for valuation." />

<div class="wiki-infobox-caption">P/B is a snapshot; residual income is a motion picture of competitive advantage.</div>

|   |   |
|---|---|
| **Price-to-book (P/B)** | Stock price divided by book value per share; quick gauge of relative value |
| **Residual income model** | Projects excess returns (profit above cost of equity) and discounts to present value |
| **P/B calculation** | Simple ratio; useful for rapid comparison across peers |
| **RIM calculation** | Requires forecasting return on equity, cost of equity, and growth assumptions |
| **Advantage of P/B** | Easy to compute; anchors on a hard accounting number |
| **Advantage of RIM** | Reflects expected earnings power and competitive moat; reveals hidden value |
| **When P/B works** | Mature, stable industries with similar capital efficiency across competitors |
| **When RIM is essential** | Tech, pharma, or any high-growth sector where moat and durability matter |
...
If a company's [cost of equity](/cost-of-equity/) is 10% and it earns a 15% [return on equity](/return-on-equity/) (ROE), it is generating 5% of excess return—residual income. That outperformance is valuable and merits a P/B above 1.0. If ROE is 8%, it is destroying value (earning below cost) and deserves a P/B below 1.0.
...
- [Value Investing](/value-investing/) — The philosophy that emphasizes finding mispriced businesses
- [Relative Valuation](/relative-valuation/) — The use of multiples (like P/B) to compare peer valuations
- [Market Capitalization](/market-capitalization/) — The market value of equity in the price-to-book numerator
- [Earnings Quality](/earnings-quality/) — An assessment of how sustainable current returns are
