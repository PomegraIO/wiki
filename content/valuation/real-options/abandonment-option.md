...
description: "Value of the ability to divest, exit, or terminate an underperforming project or business division."
keywords:
  - real options
  - project valuation
  - exit value
...
| Aspect | Description |
|---|---|
| **Trigger** | Project underperformance or adverse conditions |
| **Payoff** | Salvage value + avoided future cash outflows |
| **Value source** | Ability to stop bleeding capital |
| **Compare** | Holding to maturity vs. exiting early |
| **Salvage value** | Residual asset value upon exit |
| **Flexibility benefit** | Downside protection on failed projects |
...
### Closely related
- [Real options](/wiki/real-options-valuation/) — Value of flexibility in projects
- [Expansion option](/wiki/expansion-option/) — Right to scale up a project
- [Switching option](/wiki/switching-option/) — Right to change operations
- [Growth option](/wiki/growth-option/) — Right to invest in future opportunities
