...
description: "The value of being able to increase output or scale a business as a form of real option."
keywords:
...
*An **expansion option** is the right, but not obligation, to increase output, enter new markets, or scale a business in the future if conditions favor it. Like a financial [call option](/wiki/call-option/), an expansion option has value because you can exercise it if it becomes profitable while abandoning it if it does not. This value is often ignored in traditional [discounted cash flow](/wiki/discounted-cash-flow-valuation/) analysis but is critical to a company's strategic worth.*

<aside class="wiki-infobox">

| Aspect | Expansion Option |
|--------|------------------|
| **Source** | Right to scale operations if favorable |
| **Underlying Asset** | Future market growth or demand |
| **Strike Price** | Cost to expand production capacity |
| **Payoff** | Incremental profit from additional output |
| **Valuation Approach** | Real option, not just [NPV](/wiki/npv-with-real-options/) |
| **Examples** | Plant buildout, market entry, capacity |
...
Expansion options do not exist in isolation. A company considering a factory expansion also holds an [abandonment option](/wiki/abandonment-option/) (if demand crashes, shut down early and recover salvage value) and a [growth option](/wiki/growth-option/) (ramp to higher capacity if market expands). The value of the entire portfolio of options—expand, shrink, or exit—is what drives strategic valuation beyond just [DCF](/wiki/discounted-cash-flow-valuation/).

## Quantifying expansion option value

Real-option models use [binomial trees](/wiki/binomial-option-pricing/) or [Monte Carlo simulation](/wiki/monte-carlo-options-pricing/) to estimate the value of expansion. The key inputs are the cost to expand, the probability of favorable conditions, and the payoff if expansion succeeds. A company might find that traditional NPV says a proposed plant expansion is worth only $5 million, but real-option analysis says $12 million—the extra $7 million is the value of the option to expand further if conditions are better than expected.
...
### Closely related
- [Real option value](/wiki/real-option-value/) — general framework for valuing strategic flexibility
- [Abandonment option](/wiki/abandonment-option/) — the right to exit a project early
- [Growth option](/wiki/growth-option/) — right to increase scale if conditions improve
- [NPV with real options](/wiki/npv-with-real-options/) — integrating option value into valuation
