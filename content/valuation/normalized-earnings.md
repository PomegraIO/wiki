...
description: "Adjusted historical earnings that remove one-time items, cyclical effects, and accounting anomalies to show the sustainable earning power of a business."
keywords:
  - normalized earnings
  - adjusted earnings
...
1. **Add back non-cash charges that were reduced due to one-time items.** Impairment charges (non-cash loss), restructuring charges (mostly severance, non-cash or one-time), stock-based compensation adjustments if they are extraordinarily high.

2. **Remove non-recurring gains.** Gains on asset sales, investment gains, litigation wins.

3. **Adjust for cyclical position.** If the company is in a peak year (commodity prices high), estimate normalized earnings assuming mid-cycle commodity prices. If in a trough, assume mid-cycle. This is art.

4. **Correct for accounting anomalies.** If revenue was accelerated in a prior year, adjust.

5. **Normalize for working capital changes.** If a big customer payment timing swings earnings, adjust.
