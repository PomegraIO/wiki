...
description: "Valuing a private company by applying trading and transaction multiples from public-market comparables, adjusted for size, control, and liquidity differences."
keywords:
...
<div class="wiki-infobox-title">Guideline Public Company Method — key facts</div>

<img src="/svg/valuation.svg" alt="An abstract editorial mark for valuation methodology." />

<div class="wiki-infobox-caption">Public-market multiples are adjusted for size, control, and liquidity gaps to value a private firm.</div>

|   |   |
|---|---|
| **What it is** | Public-company multiples adjusted for private-company factors |
| **Also called** | Comparable company analysis, market approach, trading multiples method |
| **When used** | Established private companies with public-company peers |
| **Key multiples** | EV-to-EBITDA, EV-to-revenue, price-to-earnings, price-to-book |
| **Peer selection** | Industry, size, growth rate, profitability; 3–10 comparable companies |
| **Adjustments** | Control premium, minority discount, liquidity discount, marketability discount |
| **Control premium** | Typically 20–40% to convert public (minority) to control value |
| **Liquidity discount** | 20–50% depending on private-company illiquidity and concentration |
| **Output** | Enterprise value, typically a range to reflect peer variation |
...
- [First Chicago Method](/first-chicago-method/) — Scenario analysis for uncertain or high-growth businesses.
- [Excess Earnings Method](/excess-earnings-method/) — Separately values tangible and intangible assets.
- [Capitalization of Earnings Method](/capitalization-of-earnings-method/) — Cap-rate approach for steady-state earnings.
- [Merger](/merger/) — Major context in which guideline valuations are applied.
- [Relative Valuation](/relative-valuation/) — The broader approach of which this method is a part.

### Wider context

- [Price-to-Earnings Ratio](/price-to-earnings-ratio/) — Public multiple used as the starting point.
- [Enterprise Value](/enterprise-value/) — The metric being derived from multiples.
- [Control Premium](/control-premium/) — Adjustment for full ownership of a private firm.
- [Fair Value](/fair-value/) — The standard of value in most transactions.
- [Discounted Cash Flow Valuation](/discounted-cash-flow-valuation/) — Alternative income approach; Guideline Company is relative/market-based.
