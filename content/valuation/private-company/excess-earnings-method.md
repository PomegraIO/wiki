...
description: "A valuation approach that separates a business into its tangible assets and a capitalized stream of earnings above what those assets should generate."
keywords:
  - goodwill valuation
  - intangible assets
  - tangible asset return
...
<div class="wiki-infobox-title">Excess Earnings Method — key facts</div>

<img src="/svg/valuation.svg" alt="An abstract editorial mark for valuation methodology." />

<div class="wiki-infobox-caption">Separates business value into tangible returns and capitalized intangible earnings.</div>

|   |   |
|---|---|
| **What it is** | Tangible asset value plus capitalized excess earnings |
| **Also called** | Excess earnings approach, adjusted-asset method, goodwill valuation method |
| **When used** | Professional services, small private businesses, asset-light companies |
| **Key inputs** | Fair value of tangible assets, normalized annual earnings, normal return rate, cap rate |
| **Formula** | Tangible Value + [(Excess Earnings) ÷ Cap Rate] |
| **Normal return** | Usually 8–15% applied to tangible assets; depends on asset type and risk |
| **Cap rate** | 20–40% for intangible value; reflects uncertainty and illiquidity |
| **Output** | Total enterprise value in today's dollars |
...
- [First Chicago Method](/first-chicago-method/) — Scenario-weighted DCF for uncertain futures.
- [Capitalization of Earnings Method](/capitalization-of-earnings-method/) — Simpler single-cap-rate approach.
- [Guideline Public Company Method](/guideline-public-company-method/) — Market-multiple approach with adjustment factors.
- [Goodwill](/goodwill/) — The intangible asset component being valued separately.
- [Intangible Assets](/intangible-assets/) — Customer relationships, trade names, and know-how valued here.

### Wider context

- [Fair Value](/fair-value/) — The standard being applied in most Excess Earnings disputes.
- [Discounted Cash Flow Valuation](/discounted-cash-flow-valuation/) — Foundational income approach; Excess Earnings is a simplified variant.
- [Return on Assets](/return-on-assets/) — Used to establish the normal return on tangible capital.
- [Private Equity Fund](/private-equity-fund/) — Uses multiple methods including Excess Earnings in acquisition due diligence.
- [Going Concern](/going-concern/) — Assumes the business continues; asset liquidation requires a different approach.
