---
title: "Discount for Lack of Marketability Explained"
description: "Discount for lack of marketability (DLOM) quantifies why private company shares are worth less than comparable public shares. Learn the methods, ranges, and empirical research behind the discount."
keywords:
  - discount for lack of marketability private company
  - DLOM valuation
  - illiquidity discount
  - private share valuation
  - marketability discount methods
...
<div class="wiki-infobox-title">Discount for Lack of Marketability — key facts</div>

<img src="/svg/valuation.svg" alt="An abstract editorial mark for the topic." />

<div class="wiki-infobox-caption">A standard adjustment that bridges the gap between private and public company valuations.</div>

|   |   |
|---|---|
| **DLOM Range** | 20%–40% for typical private companies; can exceed 50% in illiquid industries |
| **Common Method** | Restricted stock studies; put/call parity; SEC Rule 10b5-1 holding periods |
| **Primary Use** | Appraisals, estate & gift tax valuations, ESOP valuations, financial reporting |
| **Key Driver** | Time to liquidity and certainty of exit |
| **Inverse Relationship** | Higher growth or near-exit scenarios reduce DLOM; distressed or long-hold situations increase it |
| **Company Size** | Smaller private companies face larger discounts; larger, cash-generative firms face smaller discounts |
...
Using [option pricing models](/black-scholes-model/) (Black-Scholes, binomial), appraisers can model the value of that embedded put. Assumptions include:
...
**ESOP Valuations:** If a company sponsors an [employee stock ownership plan](/stock/), the plan trustee must value shares for contribution and distribution. DLOM is standard; typical values are 25–35%.

**Estate & Gift Tax:** When an owner dies, heirs must report the taxable value of their [inherited shares](/capital-gains-tax-investor/). The IRS accepts DLOM-adjusted valuations if supported by a competent appraisal. Discounts of 25–40% are routine; the IRS scrutinizes larger discounts.

**Financial Reporting:** Under [ASC 606](/asc-606/) and other accounting standards, companies must value [equity](/equity-financing/) issued to employees using [fair value](/fair-value/) methods. This often includes a DLOM.
...
- [Fair Value](/fair-value/) — the foundational concept underpinning DLOM
- [Relative Valuation](/relative-valuation/) — using public comparables to value private companies
- [Restricted Stock](/stock/) — the empirical source of DLOM research
- [Black-Scholes Model](/black-scholes-model/) — option pricing framework used to calculate DLOM
- [Normalizing Adjustments in Private Company Valuation](/normalizing-adjustments-private-company-valuation/) — other standard adjustments to private valuations
- [Minority Discount](/discount-for-lack-of-control/) — related illiquidity discount for non-controlling stakes

### Wider context

- [Valuation](/discounted-cash-flow-valuation/) — broader valuation principles
- [Capital Gains Tax](/capital-gains-tax-investor/) — tax implications of ownership and sale
- [Estate Planning](/tax-bracket-investor/) — application of DLOM in inheritance contexts
- [Equity Financing](/equity-financing/) — how private company shares are issued and valued
- [Private Equity](/private-equity-fund/) — how investors apply DLOM in acquisition pricing
