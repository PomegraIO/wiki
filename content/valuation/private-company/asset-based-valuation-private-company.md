---
title: "Asset-Based Valuation for Private Companies"
description: "Asset-based valuation estimates private company value by marking assets and liabilities to fair value, used when earnings are unreliable or assets are key to value."
keywords:
  - asset based valuation private company
...
<div class="wiki-infobox-title">Asset-Based Valuation — key facts</div>

<img src="/svg/valuation.svg" alt="An abstract editorial mark for the topic." />

<div class="wiki-infobox-caption">Balance sheet values reset to market; net result is enterprise value.</div>

|   |   |
|---|---|
| **Formula** | Enterprise Value = Fair Value of Assets − Fair Value of Liabilities |
| **Asset restatement** | From historical cost to current market value |
| **Liability restatement** | From book value to amount required to settle |
| **When to use** | Capital-intensive businesses, no profitable track record, real estate-heavy |
| **Key assumption** | Assets can be independently valued and sold |
| **Advantage** | Tangible, verifiable value; works for startups with negative earnings |
| **Limitation** | Ignores earnings power and goodwill; assumes assets are sellable |
...
1. The EBITDA is understated or unsustainable (investigate)
2. The assets are underutilized or overstated (investigate)
3. The two methods genuinely diverge because the buyer sees earnings potential the seller doesn't
...
- [EBITDA Multiple in Private Company Valuation](/ebitda-multiple-private-company-valuation/) — Earnings-based method often compared to asset approach
- [Revenue Multiple Valuation for Private Companies](/revenue-multiple-valuation-private-company/) — Alternative for growth or pre-profitability firms
- [Minority Interest Discount in Private Company Stakes](/minority-interest-discount-private-company/) — Discounts applied to minority stakes valued by any method
- [Balance Sheet](/balance-sheet/) — The financial statement restated in asset-based valuation
- [Fair Value](/fair-value/) — The target value for each asset and liability
- [Goodwill](/goodwill/) — Intangible asset typically written to zero in asset-based approach

### Wider context

- [Real Estate Investment Trust](/real-estate-investment-trust/) — Listed company example of asset-based valuation
- [Discounted Cash Flow Valuation](/discounted-cash-flow-valuation/) — Complementary earnings-based method
- [Liquidation](/liquidation/) — Context in which asset-based value is a floor
