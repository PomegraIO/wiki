---
title: "Capitalization of Earnings Method"
description: "A straightforward valuation that divides a company's normalized annual earnings by a risk-adjusted capitalization rate to estimate enterprise value."
keywords:
...
For valuation of rapidly growing or highly volatile businesses, see [First Chicago Method](/first-chicago-method/).
...
<div class="wiki-infobox-title">Capitalization of Earnings Method — key facts</div>

<img src="/svg/valuation.svg" alt="An abstract editorial mark for valuation methodology." />

<div class="wiki-infobox-caption">A single earnings figure capitalized by a risk-appropriate rate yields enterprise value.</div>

|   |   |
|---|---|
| **What it is** | Annual normalized earnings divided by a risk-adjusted cap rate |
| **Also called** | Income approach, earnings capitalization, perpetuity method |
| **When used** | Mature, stable private businesses with predictable earnings |
| **Key inputs** | Normalized annual earnings, capitalization rate |
| **Formula** | Enterprise Value = Earnings ÷ Cap Rate |
| **Cap rate range** | 10–40% depending on risk; higher for volatile or illiquid firms |
| **Earnings source** | EBITDA, net income, or free cash flow; must be normalized and sustainable |
| **Adjustment** | One-time items, owner perks, and working-capital changes must be backed out |
...
The choice of which earnings metric to use also matters. Some analysts prefer [EBITDA](ebitda) (earnings before interest, taxes, depreciation, and amortization) because it strips out financing and tax decisions that are specific to the owner's circumstances. Others prefer [net income](net-income) because it is audited and already accounts for legitimate operating costs. Still others use [free cash flow](free-cash-flow)—operating cash flow minus capital expenditure—to emphasize actual liquidity available to the investor.
...
Most practitioners derive the cap rate by looking at the [cost of equity](cost-of-equity) for the business. For a public company, the [cost of equity](cost-of-equity) can be estimated using the capital asset pricing model (CAPM): risk-free rate plus [beta](beta) times the market risk premium. For a private company, there is no observable beta, so analysts typically add a "private company premium" (30–50% above public-company cost of equity) to account for illiquidity and concentration risk.
...
For high-growth or highly uncertain businesses, the [first Chicago method](first-chicago-method) is superior because it explicitly models different scenarios and time horizons. The [excess earnings method](excess-earnings-method) also handles uncertainty better by separating tangible and intangible components.

The method also assumes no growth. The perpetuity formula is PV = Earnings ÷ (Cap Rate - Growth Rate). If you believe earnings will grow, you can modify the cap rate downward to account for it, but this is not the method's natural strength. A [discounted cash flow](discounted-cash-flow-valuation) model with explicit year-by-year growth assumptions is more appropriate for growing businesses.

## Comparing to other approaches

The [guideline public company method](guideline-public-company-method) applies observable public-market multiples; it is useful when good comparables exist. The [excess earnings method](excess-earnings-method) separately values tangible assets and intangibles; it is ideal for asset-light businesses or those with significant goodwill. The [first Chicago method](first-chicago-method) uses scenario analysis; it handles uncertainty well. Capitalization of Earnings is best for mature, stable, straightforward businesses where earnings are predictable and no major disruption is imminent.
...
- [First Chicago Method](/first-chicago-method/) — Scenario-weighted approach for uncertain valuations.
- [Excess Earnings Method](/excess-earnings-method/) — Separates tangible and intangible value.
- [Guideline Public Company Method](/guideline-public-company-method/) — Uses public-market multiples as a benchmark.
- [Discounted Cash Flow Valuation](/discounted-cash-flow-valuation/) — Foundational income approach; Cap of Earnings is a perpetuity simplification.
- [Cost of Equity](/cost-of-equity/) — The required return embedded in the cap rate.

### Wider context

- [Fair Value](/fair-value/) — The standard of value typically sought in most valuation engagements.
- [Return on Equity](/return-on-equity/) — Reflects the earnings yield an investor expects.
- [Private Equity Fund](/private-equity-fund/) — Uses cap rate methods in leveraged buyout underwriting.
- [Business Cycle](/business-cycle/) — Normalized earnings assume business is in a typical-cycle year.
- [Going Concern](/going-concern/) — Assumes the business operates indefinitely at normalized earnings.
