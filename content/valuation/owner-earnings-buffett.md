...
description: "A concept of sustainable earnings coined by Warren Buffett, calculated as earnings plus depreciation minus capex minus working capital changes, representing true cash available to owners."
keywords:
  - owner earnings
  - Buffett
...
1. **Depreciation is deducted but is not cash.** Add it back.
2. **Capex is cash spent but not deducted from earnings.** Subtract it—it is a cash claim.
3. **Working capital ties up cash.** If receivables, inventory, or payables grow, that cash is tied up. Subtract the change.
