...
description: "The Dow Jones Industrial Average (DJIA) is a price-weighted index of 30 large-cap US companies selected by Dow Jones. Despite including only 30 companies, the Dow is one of the most widely tracked US stock market benchmarks and is often used as a proxy for overall market health."
keywords:
  - Dow Jones
  - DJIA
  - Dow 30
...
| **Weighting method** | Price-weighted (not market-cap-weighted) |
| **Founded** | 1896 |
| **Maintained by** | Dow Jones Indices (S&P Dow Jones Indices) |
| **Selection criteria** | Large-cap, blue-chip, established companies |
| **Current level** | ~40,000 (as of 2024) |
| **Notable holdings** | Apple, Microsoft, Boeing, Coca-Cola, McDonald's, Disney |
| **Media prominence** | Highest among all stock indices |
