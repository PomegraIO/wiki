---
title: "Lit Venue"
description: "A lit venue is a trading platform that publicly displays pre-trade quotes and order book information in real time, allowing all market participants to see available prices and liquidity. Lit venues include exchanges and certain alternative trading systems."
keywords:
  - lit venue
  - transparent trading
  - order book
...
|   |   |
|---|---|
| **Order visibility** | Full real-time display of bid-ask and order book |
| **Typical users** | Retail and institutional investors, market makers |
