...
description: "After-hours trading is the trading of stocks after the official close of the stock exchange. In the US, after-hours trading typically occurs between 4:00 PM and 8:00 PM Eastern Time, after the NYSE and NASDAQ close. It allows investors to trade on earnings results and overnight news, but with lower liquidity and wider spreads."
keywords:
  - after-hours trading
  - evening trading
  - after market close
...
|   |   |
|---|---|
| **Typical hours** | 4:00 PM to 8:00 PM Eastern Time |
| **Volume** | 5–10% of daily volume |
| **Bid-ask spreads** | 2–5x wider than regular hours |
| **Typical participants** | Institutions, earnings traders, retail with extended-hours access |
| **Liquidity** | Low; thin order books |
| **Venues** | Broker platforms, electronic communication networks |
| **Common catalyst** | Earnings releases, economic data, company announcements |
