---
title: "CAC 40 Index"
description: "France's primary stock market index comprising 40 large-cap companies listed on Euronext Paris."
keywords:
  - CAC 40
  - French stock index
  - Euronext Paris
...
| **Market cap covered** | ~€3 trillion (as of 2024) |
| **Index type** | Weighted by free-float market capitalization |
| **Inception date** | June 15, 1987 |
| **Base level** | 1,000 points (at inception) |
| **Calculation currency** | Euros |
| **Composition frequency** | Annual review (March, September) |
...
The CAC 40 is closely correlated with the [DAX](/wiki/dax-index/) (Germany), [FTSE 100](/wiki/ftse-100-index/) (UK), and broader European equity performance. However, it exhibits some idiosyncratic sensitivity: to French fiscal policy, labor market conditions, and the fortunes of luxury goods and banking sectors.
...
- CAC 40 [ETFs](/wiki/etf/) (both accumulating and distributing)
- CAC 40 futures and [options](/wiki/option/)
- European equity funds with overweight France

## Currency risk and hedging

The CAC 40 is priced in euros. An investor outside the Eurozone (e.g., U.S.-based, UK-based, Swiss) faces [currency risk](/wiki/currency-risk/). If the euro weakens against the investor's home currency, CAC 40 gains are reduced when converted back. Conversely, euro strength amplifies returns.

Some CAC 40 [ETFs](/wiki/etf/) offer both unhedged (currency exposure) and euro-hedged versions (currency risk removed) for non-euro investors. The choice depends on the investor's currency view and portfolio strategy.
...
- [DAX index](/wiki/dax-index/) — Germany's equivalent benchmark
- [FTSE 100 index](/wiki/ftse-100-index/) — UK's primary index
- [BNP Paribas](/wiki/bnp-paribas/) — A major CAC 40 component
- [Market capitalization](/wiki/market-capitalization/) — The weighting method
