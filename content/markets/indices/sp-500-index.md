...
| **Market representation** | ~80% of total US market cap |
| **Average annual return (historical)** | ~10% (including dividends) |
| **Largest holdings** | Apple, Microsoft, Amazon, Google (Alphabet), Tesla |
| **Sector breakdown** | Technology ~30%, Healthcare ~12%, Financials ~12%, others |
| **Managed by** | Standard & Poor's (division of S&P Global) |
