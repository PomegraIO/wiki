...
description: "China's primary stock market index measuring performance of all A-shares listed on the Shanghai Stock Exchange."
keywords:
  - shanghai composite
  - china stock market
  - stock index
...
*The Shanghai Composite Index is the principal [stock index](/wiki/index-fund/) of mainland China, tracking all A-shares (domestically listed equities) trading on the Shanghai Stock Exchange (SSE). Founded in 1991, the index is the bellwether for China's economic health and investor sentiment toward the world's second-largest economy.*

<aside class="wiki-infobox">

| Key Fact | Detail |
|---|---|
| **Exchange** | Shanghai Stock Exchange (SSE), established 1990 |
| **Base Date** | December 19, 1990 |
| **Base Level** | 100 index points |
| **Composition** | ~2,000 A-shares; caps at 980 securities as of 2023 |
| **Weighting** | Market-cap weighted |
| **Sector Composition** | Financials (~30%), industrials, consumer, energy |
| **Trading Hours** | 9:30 AM – 3:00 PM Shanghai time |
| **Settlement** | T+1 (trade date plus one business day) |
| **Currency** | Chinese Yuan (CNY, Renminbi) |
| **Market Cap** | ~$7 trillion USD equivalent (2024) |
...
The Shanghai Composite is also distinctly different from the Hang Seng Index (Hong Kong's primary index). The Hang Seng includes both Hong Kong-listed companies and Hong Kong-listed shares of mainland Chinese firms ([H-shares](/wiki/adr-issuance/)). The Shanghai Composite is pure mainland A-share exposure and does not include [Hong Kong](/wiki/hong-kong-stock-exchange/) or [New York](/wiki/new-york-stock-exchange/) listings.
...
The Shanghai Composite has experienced multiple [bubble](/wiki/bubbles-and-manias/) cycles. In 2007, the index reached 6,100; by 2008, it had collapsed to 1,600 (a 74% loss). In 2015, the index peaked at 5,178, only to crash to 2,638 within six months. These cycles reflect momentum trading, retail investor participation (Chinese brokerage accounts often charge zero commissions), and credit cycles in the real economy.

The [price-to-earnings ratio](/wiki/price-to-earnings-ratio/) of the Shanghai Composite has ranged from lows of 8–10 (2018–2019) to highs of 25–30 (2014–2015). On a [price-to-book](/wiki/price-to-book-ratio/) basis, the index often trades at 1.0–1.5×, much cheaper than developed-market [indices](/wiki/index-fund/), reflecting slower GDP growth, demographic headwinds (aging population), and slower [equity risk premium](/wiki/equity-risk-premium/) expectations in China relative to the US.

## Sector and economic exposure

The Shanghai Composite's financial-heavy weighting (banks, insurers, brokers) makes it a barometer of Chinese credit cycles. During periods of monetary tightening, the index falls as [interest rates](/wiki/interest-rate/) rise and [loan](/wiki/loan-origination-fees/) growth slows. During monetary easing, the index rises. The 2024 reopening of China's economy post-COVID stimulus fueled a rally, while 2023's property-sector weakness (Evergrande defaults, developer insolvencies) weighed heavily on the index and [mortgage](/wiki/mortgage-personal/)-related financial stocks.

The index also has significant exposure to energy and materials (coal, oil, rare-earth metals), making it sensitive to commodity price cycles and global trade flows. [Import-export](/wiki/trade-deficit-era/) slowdowns in developed economies have triggered Shanghai Composite declines, as Chinese manufacturers lose demand.

## Currency risk and the yuan

Foreign investors holding Shanghai Composite-listed shares face [currency risk](/wiki/currency-risk/): if the Chinese yuan depreciates relative to the US dollar, a gain in the index in yuan terms may be offset by currency losses. The yuan is partially liberalized but remains subject to capital controls. The [People's Bank of China](/wiki/peoples-bank-of-china/) periodically devalues the yuan to support exports, and in 2015–2016 allowed a sharp 7% depreciation. For foreign investors, this creates an additional layer of volatility beyond pure equity risk.
...
China's working-age population peaked around 2015 and is now declining. This demographic headwind implies slower economic growth and slower [earnings growth](/wiki/earnings-per-share/) for Shanghai Composite constituents. Additionally, China's [property market](/wiki/commercial-real-estate/)—which historically drove 20–30% of GDP growth—is in secular decline after two decades of bubble-driven construction. For investors in the Shanghai Composite, these structural trends imply moderate long-term returns (3–5% annually in yuan terms) rather than the high double-digit returns of China's 2000–2015 boom.

<div class="wiki-seealso">

### Closely related
- [Hang Seng Index](/wiki/hang-seng-index/) — Hong Kong stock market index
- [Stock exchange](/wiki/stock-exchange/) — Trading venue for equities
- [Emerging markets fund](/wiki/emerging-markets-fund/) — Diversified exposure to developing economies
- [Index fund](/wiki/index-fund/) — Passive investment tracking an index

### Wider context
- [Stock market](/wiki/stock-market/) — Venue for equity trading
- [Market capitalization](/wiki/market-capitalization/) — Size-weighting in indices
- [Currency risk](/wiki/currency-risk/) — Impact of exchange rates on returns
- [Geopolitical energy](/wiki/geopolitical-energy/) — Political risk affecting investments
