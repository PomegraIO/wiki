...
|   |   |
|---|---|
| **US timing** | 4:00 PM Eastern Time |
| **Duration** | Typically 10–30 seconds |
| **Method** | Price that clears the most volume |
| **Participants** | All orders at or near the close; market makers |
| **Volume** | Often 5–10% of daily volume |
| **Price stability** | Often creates an orderly close |
| **Importance** | Used for benchmarks, indices, fund pricing |
| **Halts** | Trading can be halted before the close |
