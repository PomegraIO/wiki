...
description: "The opening auction is the process by which a stock exchange matches buy and sell orders accumulated overnight to establish the opening price. It occurs at the start of each trading day, typically lasting a few minutes, and often produces the largest price move of the day."
keywords:
  - opening auction
  - market open
  - opening price
...
|   |   |
|---|---|
| **US timing** | 9:30 AM Eastern Time |
| **Duration** | Typically 2–5 minutes |
| **Method** | Price that clears the most volume |
| **Participants** | All overnight orders; market makers and brokers |
| **Volume** | Often 5–15% of daily volume |
| **Typical outcome** | 1–3% price move; larger moves possible |
| **Halts** | Trading halts can delay the open |
| **Regularity** | Every trading day except holidays |
