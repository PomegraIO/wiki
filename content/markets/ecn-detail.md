...
description: "An Electronic Communication Network (ECN) is a computerized system that automatically matches buy and sell orders for securities. ECNs were among the first alternative trading systems and remain a major component of US market structure, operating with minimal human intervention."
keywords:
  - ECN
...
|   |   |
|---|---|
| **Founding era** | 1990s (early) |
| **Operating model** | Fully electronic, no human brokers |
| **Speed** | Millisecond or faster |
| **Major examples** | Instinet, Island (now Nasdaq), Archipelago (now NYSE) |
| **Current role** | Integrated into exchanges or operating as independent ATSs |
| **Liquidity source** | Retail orders, institutional orders, market makers |
...
1. Traders submit buy and sell orders via electronic systems.
2. The ECN's matching algorithm compares orders:
...
3. As new orders arrive, the system seeks matches.
4. Trades execute automatically without human review.
