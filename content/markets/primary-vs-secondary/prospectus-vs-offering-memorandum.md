---
title: "Prospectus vs Offering Memorandum"
description: "A prospectus is the SEC-registered disclosure document for public securities offerings; an offering memorandum is the unregistered alternative for private placements."
keywords:
...
*The **prospectus vs offering memorandum difference** is regulatory: a **prospectus** is the formal, SEC-filed disclosure used in [public offerings](/initial-public-offering/)—audited financials, risk factors, legal opinion, all publicly available. An **offering memorandum** is the private disclosure doc used in [private placements](/private-placement/)—lighter regulation, no filing with the SEC, and only shown to accredited investors.*

<aside class="wiki-infobox">

<div class="wiki-infobox-title">Prospectus vs Offering Memorandum — key facts</div>

<img src="/svg/markets.svg" alt="An abstract editorial mark for the topic." />

<div class="wiki-infobox-caption">Two paths to raise capital: public transparency vs private selectivity.</div>

|   |   |
|---|---|
| **SEC filing** | Prospectus: required via [S-1](/), [S-3](/), [S-4](/); Offering memorandum: none |
| **Who can buy** | Prospectus: any investor; Offering memorandum: accredited or qualified only |
| **Disclosure depth** | Prospectus: extensive, audited financials, registered underwriter opinion; Offering memo: company discretion, unaudited OK |
| **Public access** | Prospectus: EDGAR database, fully public; Offering memorandum: confidential, NDA-bound |
| **Typical raise size** | Prospectus: $100M–$1B+; Offering memorandum: $10M–$100M+ |
| **Underwriter role** | Prospectus: investment bank underwrites, due diligence, stabilizes; Offering memo: placement agent or issuer direct |
| **Liability regime** | Prospectus: [Securities Act](/section-179-deduction/) Section 12(b)(2) liability; Offering memo: Reg D safe harbor |
| **Time to market** | Prospectus: 3–6 months+ (SEC review); Offering memo: 2–4 weeks typical |

</aside>

## The prospectus: registered public offering

A **prospectus** is the formal disclosure document filed with the [Securities and Exchange Commission](/securities-and-exchange-commission/) (SEC) when a company offers securities to the public. It is part of a registration statement (typically Form [S-1](/), S-3, or S-4) and describes:
...
**Liability:** Under [Securities Act](/securities-act-of-1933/) Section 12(b), if the prospectus contains material misstatements or omissions, investors can sue the issuer, underwriters, officers, and the registrar. This creates strong incentive for accuracy and full disclosure.

## The offering memorandum: private placement

An **offering memorandum** is an issuer's private disclosure document used in [Regulation D](/regulation-a/) and other exempt offerings—typically private placements of securities to accredited investors. It is not filed with the SEC.
...
Securities offered without a prospectus or offering memorandum (e.g., intra-company transfers, gifts, or securities-broker dealer sales of existing holdings) do not trigger the requirement. Accredited investor sales under [Regulation D](/regulation-a/) Rule 506(b) require no general solicitation, meaning the company cannot advertise; under 506(c), the company can advertise but must verify accreditation.

[Regulation A Tier II](/regulation-a/) allows non-accredited investors to buy, making it a hybrid: lighter than a prospectus (no SEC underwriter opinion required), but with caps ($75M annual limit) and ongoing reporting.
...
- [Private Placement](/private-placement/) — the funding round documented by offering memorandum
