---
title: "IPO Quiet Period: Rules and Restrictions"
description: "SEC IPO quiet period rules restrict marketing and communications by issuers and underwriters before and after initial public offerings."
keywords:
  - ipo quiet period rules
  - sec quiet period ipo
  - ipo blackout period
  - ipo restrictions communications
...
<div class="wiki-infobox-title">IPO Quiet Period — Key Facts</div>

<img src="/svg/markets.svg" alt="An abstract editorial mark for markets and trading." />

<div class="wiki-infobox-caption">A critical compliance window that shapes communication strategy around every public offering.</div>

|   |   |
|---|---|
| **Duration** | Pre-filing through 40 calendar days after listing (or 25 days for smaller offerings) |
| **Who it binds** | Issuers, underwriters, dealers, analysts, and any party with "access to material nonpublic information" |
| **Core rule** | Prohibition on certain offers, advertisements, and recommendations during restricted periods |
| **Key exceptions** | Limited offering-related announcements, factual disclosure, quiet filings |
| **Enforcement** | FINRA, SEC; civil and criminal penalties possible |
| **Lifts (full safe harbor)** | After 25 or 40 days, covered persons may publish research normally |
