...
description: "The NASDAQ Composite is a market-capitalization-weighted index of all stocks listed on the NASDAQ exchange, including roughly 3,000 companies. It is heavily weighted toward technology and growth stocks, making it more volatile than the S&P 500."
keywords:
  - NASDAQ
  - NASDAQ Composite
  - tech stocks
...
| **Exchange** | NASDAQ |
| **Sector concentration** | Technology ~50%, Healthcare ~15%, Financials ~10%, other sectors |
| **Volatility** | High; 2–3x more volatile than S&P 500 |
| **Key holdings** | Apple, Microsoft, Nvidia, Amazon, Meta, Tesla |
| **Annualized return (historical)** | ~11–12% (slightly higher than S&P 500, higher volatility) |
