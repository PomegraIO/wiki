...
|   |   |
|---|---|
| **Trigger** | 10% price move in 5 minutes (large-caps); higher for small-caps |
| **Duration of halt** | 5 minutes |
| **Resume mechanism** | Intraday auction |
| **Scope** | Individual stock |
| **Automatic** | Yes; triggered without exchange approval |
| **Frequency** | Dozens to hundreds per year across all stocks |
| **Announcement** | Instant dissemination to all market participants |
