...
description: "A Swap Execution Facility (SEF) is a regulated trading venue where standardized derivatives (interest-rate swaps, credit default swaps, currency swaps) must be executed. SEFs were created after the 2008 financial crisis to bring transparency and standardization to derivatives trading."
keywords:
  - SEF
...
| **Mandate** | Dodd-Frank Act (2010) |
| **Effective date** | 2014 (phased implementation) |
| **Typical instruments** | Interest-rate swaps, credit default swaps, FX swaps |
| **Transparency** | Pre- and post-trade pricing displayed |
| **Clearing requirement** | Standardized swaps must clear through clearinghouses |
| **Major operators** | Bloomberg, Tradeweb, TP ICAP, others |
| **Market share** | Majority of SEF-eligible swaps trading |
