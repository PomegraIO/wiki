---
title: "Reg NMS"
description: "Regulation NMS (National Market System) is a set of SEC rules that modernized the US stock market structure after the 2005 securities market reforms. It established requirements for trade-through protection, best execution, fair access to quotes, and market data standards."
keywords:
  - Reg NMS
  - regulation NMS
...
|   |   |
|---|---|
| **Adoption date** | 2005 (SEC adopted); 2007 (effective) |
| **Primary purpose** | Fair, transparent national market system |
| **Key rules** | Trade-through, best execution, fair access |
| **Scope** | All US-listed stocks and options |
| **Regulator** | SEC |
| **Compliance responsibility** | Exchanges, ATSs, brokers |
