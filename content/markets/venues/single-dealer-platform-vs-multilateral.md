---
title: "Single-Dealer Platform vs Multilateral Trading Venue"
description: "Understand how single-dealer platforms differ from multilateral venues: one bank quotes prices versus multiple competing dealers on exchanges and alternative trading systems."
keywords:
  - single-dealer platform vs multilateral trading venue
...
*A **single-dealer platform** lets investors trade only with one bank's pricing; a **multilateral trading venue** connects multiple dealers whose quotes compete on price. The choice affects spreads, transparency, and whether you see alternative quotes at all.*

<aside class="wiki-infobox">

<div class="wiki-infobox-title">Single-Dealer vs Multilateral — key facts</div>

<img src="/svg/markets.svg" alt="An abstract editorial mark for the topic." />

<div class="wiki-infobox-caption">One bank provides all liquidity versus many dealers competing for your order.</div>

|   |   |
|---|---|
| **Quoter count** | One dealer vs. multiple dealers |
| **Spread competitiveness** | Single best quote vs. price competition |
...
These platforms emerged because some securities—particularly illiquid bonds and bespoke derivatives—do not trade on centralized exchanges. Banks built proprietary systems to control and monetize the distribution of these less-liquid instruments.

## Multilateral Trading Venues: How Price Competition Works
...
Single-dealer platforms appeal to banks because they capture wider spreads. When a client cannot shop around, the bank faces no direct price competition and can quote a less generous spread than it would on a multilateral venue where rivals are watching.
...
Multilateral venues work best for liquid, standardized products. A stock or commodity futures contract can be traded by hundreds of dealers and thousands of participants; the network effects of competition are powerful. Spreads narrow, volumes rise, and price discovery improves.
...
In practice, a single-dealer platform typically requires clients to have a credit relationship with the sponsoring bank and may impose minimum order sizes to discourage unprofitable flow.
...
## Strategic Choice: When Each Makes Sense

**Single-dealer platforms** make sense when a product is highly bespoke or illiquid, when one bank has a meaningful relationship advantage, or when a client values customization and credit certainty over price transparency.

**Multilateral venues** dominate when standardization is high, liquidity is sufficient to support multiple makers, and regulatory rules demand transparency. The liquidity advantage is self-reinforcing: traders flock to the venue with the tightest spreads, which attracts more makers, which widens the participation moat.

The market is not static. As illiquid markets become liquid and more multilateral venues enter a space, single-dealer platforms lose traffic. Conversely, when new exotic products are invented, single-dealer platforms are often the first distribution channel until a multilateral venue eventually forms.
...
- [Market maker](/market-maker-trading/) — How dealers profit by offering liquidity on both sides.
- [Bid-ask spread](/bid-ask-spread/) — The cost difference between buying and selling.
- [Price discovery](/price-discovery/) — How transparent venues reveal true asset values.
- [Alternative trading system](/alternative-trading-system/) — Electronic venues that compete with exchanges.
- [Over-the-counter market](/over-the-counter-market/) — Trading networks outside formal exchanges.
- [Exchange vs OTC market](/exchange-versus-otc-market-differences/) — How centralized trading differs from bilateral dealing.

### Wider context

- [Counterparty risk](/counterparty-risk/) — Credit exposure when dealing with a single bank.
- [Dodd-Frank Act](/dodd-frank-act/) — U.S. regulation of trading venues and derivatives.
- [Securities and Exchange Commission](/securities-and-exchange-commission/) — Federal regulator of market structure.
- [Liquidity risk](/liquidity-risk/) — The cost and difficulty of exiting a position.
