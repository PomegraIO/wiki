---
title: "Exchange vs OTC Market: Key Differences Explained"
description: "Learn the key differences between centralized exchanges and over-the-counter markets: transparency, counterparty risk, and price discovery determine which venue suits each trade."
keywords:
  - difference between exchange and otc market
  - exchange vs otc
...
<div class="wiki-infobox-title">Exchange vs OTC — key facts</div>

<img src="/svg/markets.svg" alt="An abstract editorial mark for the topic." />

<div class="wiki-infobox-caption">Centralized venues with cleared trades versus decentralized networks where you deal directly.</div>

|   |   |
|---|---|
| **Price visibility** | Real-time public quotes | Negotiated, opaque |
| **Counterparty** | Central counterparty clearer | Direct dealer or bank |
...
- [Over-the-counter market](/over-the-counter-market/) — Dealer-based trading networks outside exchanges.
- [Counterparty risk](/counterparty-risk/) — Credit exposure when trading with a specific dealer or bank.
- [Bid-ask spread](/bid-ask-spread/) — Price gap between buying and selling on any venue.
- [Price discovery](/price-discovery/) — How transparent markets reveal fair value.
- [Alternative trading system](/alternative-trading-system/) — Electronic venues competing with traditional exchanges.
- [Single-dealer platform vs multilateral](/single-dealer-platform-vs-multilateral/) — Proprietary dealer venues versus multi-dealer marketplaces.

### Wider context

- [Stock exchange](/stock-exchange/) — How equities are listed and traded.
- [Futures contract](/futures-contract/) — Standardized derivative traded on exchanges.
- [Swap](/swap/) — Interest-rate and currency derivatives typically traded OTC.
- [Dodd-Frank Act](/dodd-frank-act/) — U.S. regulation requiring central clearing of certain derivatives.
- [Securities and Exchange Commission](/securities-and-exchange-commission/) — Federal regulator of exchanges and broker-dealers.
