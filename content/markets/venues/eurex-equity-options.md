...
*The **Eurex Equity Options** market is operated by Eurex, the largest derivatives exchange in Europe and one of the world's largest by notional volume. Eurex lists [options](/wiki/option/) contracts on European blue-chip stocks (SAP, Siemens, ASML, LVMH), European equity indices ([DAX](/wiki/dax-index/), [STOXX 600](/wiki/index-a-z/)), bond futures, and commodities, serving institutional investors, hedge funds, and retail traders across the EU, UK, and globally. The exchange is owned by the [Deutsche Börse Group](/wiki/frankfurt-stock-exchange-deutsche-borse/) and offers both [call](/wiki/call-option/) and [put](/wiki/put-option/) contracts with daily settlement through [Eurex Clearing](/wiki/clearing-member-risk/).*

<aside class="wiki-infobox">

| Aspect | Detail |
|--------|--------|
| **Owner** | Deutsche Börse Group (Frankfurt, Germany) |
| **Founding** | 1990 (as DTB, European Options Exchange); merged with SOFFEX (Swiss derivatives) in 1998 |
| **Trading hours** | 8:00 AM – 10:00 PM CET (electronic); with extended Asia-Pacific sessions |
| **Settlement** | Central counterparty clearing through Eurex Clearing; daily mark-to-market |
| **Equity options** | European stocks, indices; mostly European contract month (monthly or quarterly expirations) |
| **Largest contracts** | DAX index options; EURO STOXX 50 index options; single-stock options (SAP, Siemens, etc.) |
| **Market share** | ~25–30% of European listed equity options volume; competes with Eurex (Intercontinental Exchange) and others |
| **Regulation** | ESMA (European Securities and Markets Authority); MiFID II-compliant |
...
- **Term structure**: Longer-term options (3–6 months) trade at slightly lower [implied volatility](/wiki/implied-volatility/) than short-term (1 month), reflecting a belief that high volatility is temporary and will normalize.

Eurex's liquid options market allows traders to execute volatility trades: buying low-volatility instruments and selling high-volatility ones, or using [spreads](/wiki/vertical-spread/) to isolate exposure to skew.
...
Eurex's global derivatives volume (~2 billion contracts annually) exceeds the CBOE's (~1.5 billion) on a notional basis, but the [CBOE](/wiki/cboe-options-exchange/) dominates in **US equity options** by a wide margin. Eurex dominates in **European equity options**. The split reflects geographic liquidity and regulatory preferences: European traders naturally gravitate to Eurex because it is their local exchange with tight integration to local market infrastructure.

<div class="wiki-seealso">

### Closely related
- [Eurex](/wiki/eurex/) — The exchange operator and its broader offerings
- [Call Option](/wiki/call-option/) — Right to buy; foundational Eurex contract
- [Put Option](/wiki/put-option/) — Right to sell; foundational Eurex contract
- [Options Clearing Corporation](/wiki/options-clearing-corporation/) — The US counterparty CCP (OCC); Eurex Clearing is the EU equivalent

### Wider context
- [Cboe Options Exchange](/wiki/cboe-options-exchange/) — The largest US-listed options exchange
- [Central Counterparty Clearing](/wiki/central-counterparty-clearing/) — How Eurex Clearing manages default risk
- [Volatility Smile](/wiki/volatility-smile/) — The skewed implied volatility pattern visible on Eurex options
- [MiFID II Trading](/wiki/mifid-ii-trading/) — EU regulation governing Eurex and all European venues
