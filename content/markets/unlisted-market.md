---
title: "Unlisted Market"
description: "An unlisted market is a trading venue for securities that have not met the listing standards of a major stock exchange. Unlisted securities typically trade on alternative platforms with fewer disclosure requirements and lower trading volumes."
keywords:
  - unlisted market
  - unlisted securities
...
|   |   |
|---|---|
| **What it is** | Trading venue for non-exchange-listed securities |
| **Typical participants** | Retail traders, micro-cap investors, specialists |
| **Securities** | Small-cap stocks, penny stocks, shell companies |
| **Typical venues** | OTC Markets Group, alternative venues, dark pools |
| **Disclosure** | Minimal; some companies file with SEC, others do not |
| **Liquidity** | Low; wide spreads, thin order books |
| **Price discovery** | Limited; quotes may be stale or unreliable |
| **Regulation** | Varies; some unregulated or self-regulated |
