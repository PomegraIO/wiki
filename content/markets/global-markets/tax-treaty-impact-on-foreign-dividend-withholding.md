---
title: "How Tax Treaties Reduce Foreign Dividend Withholding"
description: "Explains how bilateral tax treaties lower the withholding rate on foreign dividends and the steps to claim treaty relief on cross-border investment income."
keywords:
  - tax treaty impact on foreign dividend withholding
  - dividend withholding tax reduction
  - treaty relief at source
  - foreign tax credit dividend
...
<div class="wiki-infobox-title">Tax Treaties and Dividend Withholding — key facts</div>

<img src="/svg/markets.svg" alt="An abstract editorial mark for the topic." />

<div class="wiki-infobox-caption">Treaties negotiate withholding rates down; claiming relief requires proper paperwork before dividend payment.</div>

|   |   |
|---|---|
| **Typical statutory rate** | 20–35% (country-specific; the "default" before treaty) |
| **Common treaty rate** | 5–15% (depends on ownership and treaty terms) |
| **Forms needed (US)** | W-8BEN or W-8BEN-E to claim treaty benefits |
| **Filing deadline** | Before the dividend payment date (advance notice to payor) |
| **Claiming excess withholding** | Foreign tax credit in your home country |
| **Treaty override** | Treaties typically take precedence over domestic tax law |
...
- [Dividend](/dividend/) — The income being taxed; cash distributions to shareholders
...
- [Double taxation](/double-taxation/) — The problem treaties are designed to solve
- [Qualified dividend](/qualified-dividend/) — Different tax treatment for certain domestic dividends (U.S. context)
