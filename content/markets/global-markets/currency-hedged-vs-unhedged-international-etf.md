---
title: "Currency-Hedged vs Unhedged International ETFs"
description: "Why currency-hedged international ETFs protect against exchange rate moves but often cost returns, with worked examples comparing outcomes."
keywords:
...
<div class="wiki-infobox-title">Currency-Hedged vs Unhedged International ETFs — key facts</div>

<img src="/svg/markets.svg" alt="An abstract editorial mark for markets." />

<div class="wiki-infobox-caption">The choice depends on currency views and willingness to pay for peace of mind.</div>

|   |   |
|---|---|
| **Unhedged** | You capture both stock returns and currency moves; simpler, lower cost |
| **Hedged** | You eliminate currency swings; costs 20–40 bps annually in fees and slippage |
| **When to hedge** | If you believe the foreign currency will weaken or you want to isolate stock-picking risk |
| **When to skip hedging** | If you believe the foreign currency will strengthen or can tolerate currency volatility |
| **Cost of hedging** | Often 0.2%–0.4% per year (20–40 basis points), eating into returns |
| **Historical pattern** | Currency movements are unpredictable; hedging often reduces returns over long horizons |
...
- [Currency risk](/currency-risk/) — why exchange rates matter to international investors
- [Currency volatility](/currency-volatility/) — how much exchange rates swing
- [Forward contract](/forward-contract/) — the instrument used to execute currency hedges
- [Swap](/swap/) — alternative hedging instrument using interest rate or currency swaps
- [ETF](/etf/) — the wrapper holding the international stocks and the hedge

### Wider context

- [International financial reporting standards](/international-financial-reporting-standards/) — accounting standards affecting foreign companies you invest in
- [Capital flows](/capital-flows/) — what drives currency movements
- [Interest rate](/interest-rate/) — determines the cost of currency hedging via forward rate bias
- [Diversification](/diversification/) — why international exposure matters despite currency risk
