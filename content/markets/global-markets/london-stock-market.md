---
title: "London Stock Market"
description: "The UK's primary stock exchange and one of Europe's leading financial centers; home to global capital formation."
keywords:
  - London stock market
  - LSE
  - FTSE
...
*The **London Stock Market**, operated by the London Stock Exchange (LSE), is the primary venue for equity trading in the United Kingdom and one of the world's largest and oldest capital markets. It hosts the [FTSE 100](/wiki/ftse-100-index/), the UK's blue-chip index, alongside thousands of smaller-cap stocks, and is a gateway to European and global capital formation.*

<aside class="wiki-infobox">

| Aspect | Detail |
|---|---|
| **Operator** | London Stock Exchange (LSE Group) |
| **Founded** | 1801 (legacy dates to 1773) |
| **Primary Index** | FTSE 100 (large-cap); also FTSE 250, FTSE All-Share |
| **Market Segments** | Main Market (blue-chip), AIM (growth/small-cap) |
| **Trading Hours** | 08:00–16:30 GMT (incl. pre- and post-auction) |
| **Listings** | ~2,000 companies; ~£3 trillion market cap |
| **Currency** | GBP primary; dual-listings in EUR, USD |
...
- Full [audit](/wiki/audit-opinion/) and quarterly disclosure.
...
Dedicated venues for investment trusts, exchange-traded funds, and structured products. London is a global hub for [ETF](/wiki/etf/) trading, particularly for UCITS-compliant funds.

## The FTSE Index family

The **[FTSE 100](/wiki/ftse-100-index/)** (Financial Times Stock Exchange 100) is the primary barometer of UK market health. It comprises the 100 largest companies by market capitalization, heavily weighted toward large, multinational corporations (banks, oil & gas, pharmaceuticals, mining).
...
### Market makers
Designated [market makers](/wiki/market-makers/) on London provide liquidity by posting bid and offer prices (standing ready to buy or sell). They profit from the [bid-ask spread](/wiki/bid-ask-spread/) and bear inventory risk.
...
The London Clearing House (LCH) operates as the central counterparty for equities (CCG service) and derivatives, managing [settlement risk](/wiki/settlement-risk/) and collateral.
...
Inclusion in the [FTSE 100](/wiki/ftse-100-index/) or FTSE 250 triggers passive index fund purchases, providing a permanent bid. Exclusion can trigger sharp selling. This indexing effect has grown with the rise of [index funds](/wiki/index-fund/) and [ETFs](/wiki/etf/), creating both liquidity and short-term pricing distortions.

## Practical for investors

**Retail access**: UK residents can trade LSE via any authorized broker (Interactive Brokers, Hargreaves Lansdown, etc.). International investors can trade via Global Depository Receipts ([GDRs](/wiki/gdr/)) or direct access brokers.

**Volatility and [foreign exchange](/wiki/forex-leverage/) exposure**: GBP/USD movements affect sterling-denominated returns for foreign investors. Hedging currency exposure is common for multi-currency portfolios.
...
### Wider context
- [Stock exchange](/wiki/stock-exchange/) — broader concept
- [Financial Conduct Authority](/wiki/financial-conduct-authority/) — regulator
- [Post-war reconstruction](/wiki/post-war-reconstruction/) — historical context
- [European capital markets](/wiki/capital-flows/) — regional role
