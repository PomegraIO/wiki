---
title: "MSCI Index Reclassification Effects"
description: "How MSCI market-status upgrades and downgrades trigger capital flows and change investors' access to and valuation of country indexes."
keywords:
  - msci index reclassification effects
...
<div class="wiki-infobox-title">MSCI Index Reclassification — Key Facts</div>

<img src="/svg/markets.svg" alt="An abstract editorial mark for the topic." />

<div class="wiki-infobox-caption">Reclassification changes a country's weight in global portfolios overnight.</div>

|   |   |
|---|---|
| **Reclassification types** | Frontier → Emerging; Emerging → Developed; Downgrade reversals |
...
- [Index Fund](/index-fund/) — passive investing mechanics and rebalancing
- [ETF](/etf/) — exchange-traded index funds and capital inflows
- [Capital Flows](/capital-flows/) — international money movements
- [Currency Risk](/currency-risk/) — currency effects of capital inflows

### Wider context

- [Market Capitalization](/market-capitalization/) — country-size metrics and index weighting
- [Liquidity Risk](/liquidity-risk/) — frontier vs developed market accessibility
- [Price-to-Earnings Ratio](/price-to-earnings-ratio/) — valuation compression in reclassifications
- [Valuation](/intrinsic-value/) — fundamental vs index-driven price movements
