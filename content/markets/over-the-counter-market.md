...
|   |   |
|---|---|
| **What it is** | Decentralized, dealer-based trading system |
| **Primary securities** | Bonds, currencies, derivatives, unlisted stocks |
| **Market participants** | Banks, brokers, dealers, institutions, retail investors |
| **Price discovery** | Bilateral negotiation; dealer quotes |
| **Market transparency** | Limited; trades reported with delay or not at all |
| **Regulation** | SEC, FINRA (US); equivalent bodies globally |
| **Market size** | Estimated $500+ trillion in notional derivatives outstanding |
| **Clearing** | Bilateral or central counterparty; varies by instrument |
