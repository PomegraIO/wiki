---
title: "Merger Arbitrage Fund"
description: "Fund that captures deal spreads by buying acquisition targets and shorting acquirers while waiting for merger completion."
keywords:
  - merger arbitrage
  - deal spread
  - acquisition
...
*A **merger arbitrage fund** buys shares of companies targeted for [acquisition](/acquisition/) and simultaneously shorts the acquirer, locking in the spread between the target's current price and the negotiated deal price. The fund profits if the deal closes at or near its original terms, but faces losses if the transaction falls apart or faces unexpected hurdles.*

<aside class="wiki-infobox">

<div class="wiki-infobox-title">Merger Arbitrage Fund — key facts</div>

<img src="/svg/funds.svg" alt="An abstract editorial mark for fund categories." />

<div class="wiki-infobox-caption">Event-driven investing that isolates deal-completion risk from stock-market risk.</div>

|   |   |
|---|---|
| **What it is** | [Mutual fund](/mutual-fund/) or [hedge fund](/hedge-fund/) that profits from [merger](/merger/) and acquisition gaps |
| **Also called** | Risk arbitrage fund; event-driven fund (subset) |
| **Main positions** | Long acquisition targets, short acquirers, or both |
| **Primary risk** | Deal failure; regulatory rejection; financing collapse |
| **Time horizon** | Weeks to months until deal closes |
| **Return driver** | Spread tightening as deal closure approaches |
...
In an efficient market, all predictable gains would evaporate instantly. Yet spreads remain. One reason is risk aversion: most equity investors have no appetite for deal risk and avoid the position entirely. Another is operational cost. A fund cannot simply buy the target; it must model tax consequences, financing risks, and [counterparty risk](/counterparty-risk/) around closing. The [management fee](/management-fee/) and operational friction consume part of the spread, leaving a genuine but modest after-fee return.

Large institutional investors, especially pension funds and [mutual funds](/mutual-fund/), rarely build merger arbitrage teams. It requires deep expertise and willingness to endure blow-up events. [Hedge funds](/hedge-fund/) dominate the space because they can afford that specialization and their clients tolerate occasional losses.

## Leverage, liquidity, and crowding

Merger arbitrage funds often employ leverage to amplify returns from thin spreads. A $100 million fund buying a 2% spread might borrow $50 million to hold $150 million in positions, aiming to generate 3% net returns. This works until deal risk spikes unexpectedly or multiple deals collapse in quick succession. Leveraged funds can face sudden forced selling if [counterparties](/counterparty-risk/) demand margin payments.
...
Merger arbitrage returns show low correlation with broad [stock](/stock/) and [bond](/bond/) markets during normal periods. A market decline need not harm a merger arbitrage fund—if the deal still closes, returns are unaffected by equity weakness. However, during market dislocations or crises, spreads often widen sharply as risk appetite evaporates and deal financing becomes harder. A financial crisis can turn a profitable position into a significant loss overnight.
...
- [Hedge Fund](/hedge-fund/) — alternative investment structure permitting specialized strategies
- [Alternative Trading System](/alternative-trading-system/) — venues where arbitrage traders execute large blocks
- [Leverage Ratio (Forex)](/leverage-ratio-forex/) — use of borrowed capital to amplify returns
- [Market Risk](/market-risk/) — systematic risk that even arbitrage positions cannot entirely eliminate
