---
title: "RVPI (Residual Value to Paid-In) in Private Equity"
description: "RVPI measures unrealized fund value relative to capital deployed. Learn how it signals portfolio maturity, realization risk, and fund exit activity."
keywords:
  - rvpi residual value to paid in
  - private equity fund performance
  - unrealized value private equity
...
<div class="wiki-infobox-title">RVPI — key facts</div>

<img src="/svg/funds.svg" alt="An abstract editorial mark for the topic." />

<div class="wiki-infobox-caption">A metric of unrealized gain or loss in a fund's remaining portfolio.</div>

|   |   |
|---|---|
| **Calculation** | Remaining portfolio value ÷ Capital invested to date |
| **Typical early-stage range** | 1.5× to 3.0× (optimistic marks) |
| **Late-stage concern** | High RVPI (>1.5×) near fund end date suggests realization risk |
| **Not the full story** | Ignore mark-to-market inflations; focus with DPI and MOIC together |
| **Update frequency** | Quarterly or annually, depends on fund reporting |
...
- [Leveraged Buyout (LBO)](/leveraged-buyout/) — Buyout fund structure and exit expectations that influence RVPI timelines.
- Fair Value and Mark-to-Market Accounting — The framework underlying portfolio valuations in RVPI.
- [Secondary Market in Private Equity](/secondary-market/) — How fund interests trade and inform portfolio company valuations.
...
- [Real Estate Investment Trust (REIT)](/real-estate-investment-trust/) — Listed alternative to private equity for real assets.
