...
*A **recallable distribution** is a provision that allows a private equity [GP](/private-equity-fund/) to claw back (recall) previously distributed proceeds from LPs to fund new investments, cover shortfalls, or pay liabilities. When triggered, LPs must return the cash within a narrow window—typically 10–15 days—or face penalties including loss of voting rights or removal from future distributions.*

<aside class="wiki-infobox">

<div class="wiki-infobox-title">Recallable distributions — timing and mechanics</div>

<img src="/svg/funds.svg" alt="An abstract editorial mark for funds." />

<div class="wiki-infobox-caption">A clawback transforms a received distribution into a contingent liability for the LP.</div>

|   |   |
|---|---|
| **Notice period** | 10–15 days to fund (varies by partnership agreement) |
| **Payback terms** | No interest accrual; immediate cash transfer |
| **What triggers recall** | New investments, operational shortfalls, liabilities, [fee](/management-fee/) gaps |
| **LP remedy if unable** | Late fees (0.5–1% per annum), removal from future distributions, potential legal action |
| **Reserve obligation** | LPs must hold 10–30% of distributions in liquid form |
| **Frequency** | Typical in early-stage and mid-market funds; less common in mature buyout funds |

</aside>

## Why GPs include recall rights

In the early stages of a [private equity fund](/private-equity-fund/), the GP often makes most of its exits and distributions in the fund's final years. However, a GP may discover attractive investment opportunities mid-fund that require capital, or encounter portfolio company losses requiring additional capital support. Rather than hold cash idle in the fund (which would depress [returns](/return-on-invested-capital/)), the GP can distribute it to LPs and reserve the right to recall portions if needed.
...
LPs must remit the cash to a designated account. Late payments trigger penalties—usually 0.5–1% per annum on the overdue amount—plus potential loss of voting rights or removal from future distribution schedules. In severe cases, the LP may be in material breach, exposing it to legal action or forced [liquidation](/liquidation/) of its fund interest.
...
The [distribution waterfall](/distribution-waterfall/) determines how proceeds flow when a holding exits. A typical waterfall is:
...
Large LPs often carve out special terms via side letters. Smaller LPs accept standard terms or negotiate collectively through the [LP advisory committee](/pe-lpac-role/).
...
- [Distribution Waterfall](/distribution-waterfall/) — the cascade of proceeds from LP capital return through GP carried interest
- [Capital Call](/capital-call/) — distinct obligation to contribute new capital, not return distributed capital
- [Management Fee](/management-fee/) — fund expenses that may trigger recalls if underestimated
- [LP Advisory Committee](/pe-lpac-role/) — governs dispute resolution on recalls and valuations
- [Carried Interest](/carried-interest/) — GP economics that may incentivize strategic recalls

### Wider context

- [Private Equity Fund](/private-equity-fund/) — overall fund structure and risk factors
- Limited Partnership Agreement — document containing recall terms
- [Cash Flow Statement](/cash-flow-statement/) — how LPs model distributions net of recall risk
