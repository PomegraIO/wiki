...
description: "A hedge fund that combines multiple trading strategies across different asset classes and approaches, diversifying risk and capturing opportunities across market regimes."
---
...
The core thesis of multi-strategy investing is alpha diversification: each strategy captures alpha (excess returns) from a different source. [Long-short equity](/wiki/hedge-fund-long-short-equity/) strategies capture stock-picking edge. [Fixed-income arbitrage](/wiki/hedge-fund-fixed-income-arbitrage/) captures spread mispricings. [Quantitative](/wiki/hedge-fund-quantitative/) strategies capture statistical patterns. [Event-driven](/wiki/hedge-fund-event-driven/) strategies capture deal-completion edge. These alpha sources are not perfectly correlated; in fact, they often have negative correlation. When equity markets are crashing and long-short equity is struggling, spreads may widen and create opportunities for credit strategies. When stocks are rallying and long-short equity is thriving, event-driven might be quiet.
...
**Aggregate portfolio risk**: The overall [value-at-risk](/wiki/value-at-risk/) and leverage of the fund, across all strategies.
...
<ul>
  ...
  <li><a href="/wiki/hedge-fund-long-short-equity/">Long-short equity hedge fund</a> — one strategy within multi-strategy funds.</li>
  <li><a href="/wiki/hedge-fund-quantitative/">Quantitative hedge fund</a> — another component strategy.</li>
  <li><a href="/wiki/alpha/">Alpha</a> — the excess returns each strategy seeks to generate.</li>
</ul>
<h3>Wider context</h3>
<ul>
