---
title: "Hedge Fund Redemption Notice Periods Explained"
seo_title: "Hedge Fund Redemption Notice Period: How It Works"
description: "A redemption notice period makes hedge fund investors request withdrawals 15–90 days ahead. Why funds require notice and what a missed deadline means."
keywords:
  - redemption notice period hedge fund
  - hedge fund withdrawal notice
  - redemption request deadline
  - hedge fund liquidity rules
  - advance notice requirement
image: /svg/funds.svg
---

*A **redemption notice period** is the advance warning an investor must give before withdrawing capital from a hedge fund. Typical periods range from 15 to 90 days, sometimes longer. Failing to meet the deadline means your redemption request is deferred to the next available window—which could be weeks or months away. Notice periods exist because hedge funds often hold illiquid securities that take time to liquidate; they also give managers advance planning time to manage [cash flows](/cash-flow-statement/) and [liquidity risk](/liquidity-risk/).*

<aside class="wiki-infobox">

<div class="wiki-infobox-title">Redemption Notice Periods — key facts</div>

<img src="/svg/funds.svg" alt="An abstract editorial mark for the topic." />

<div class="wiki-infobox-caption">A contractual advance-warning window that decouples investor exit timing from fund redemption timing.</div>

|   |   |
|---|---|
| **Typical length** | 15 to 90 days before the end of a redemption window |
| **Common redemption windows** | Monthly or quarterly |
| **Purpose** | Allow managers to raise cash and plan for outflows |
| **Interaction with lock-ups** | Separate; notice periods apply to already-unlocked capital |
| **Missed deadline result** | Redemption deferred to the next redemption window |
| **Part of fund documents** | Specified in [private placement memorandum](/private-placement/) (PPM) |
...
A few aggressive or closed-ended funds require even longer notice (180 days or 1 year) as part of a [hard lock-up](/hedge-fund-soft-lock-vs-hard-lock/) or gating provision. These are rare and typically disclosed prominently in fund marketing.
...
A notice period also creates an interesting timing risk. You decide in January that you want to exit on March 31. By late January, when you formally submit notice, the fund may have already had a strong month of returns. You are locked in to a redemption price based on March 31 [net asset value](/net-asset-value/), not today's value. Conversely, if the fund suffers losses in March, you are protected by your advance decision—you get the redemption regardless of March performance.
...
- [Hedge Fund Soft Lock-Up vs Hard Lock-Up](/hedge-fund-soft-lock-vs-hard-lock/) — lock-up provisions that restrict exit before notice period even applies
- [Hedge Fund](/hedge-fund/) — overview of hedge fund structure and redemption mechanics
- [Liquidity Risk](/liquidity-risk/) — risk that assets cannot be sold quickly at fair prices
- [Net Asset Value](/net-asset-value/) — valuation used to calculate redemption proceeds
- [Private Placement](/private-placement/) — offering document (PPM) specifying notice requirements

### Wider context

- [Cash Flow Statement](/cash-flow-statement/) — financial statement tracking cash movements
- [Hedge Fund Minimum Investment Requirements](/hedge-fund-minimum-investment/) — entry thresholds paired with redemption terms
- [Redemption Rights (Equity)](/redemption-rights-equity/) — investor right to redeem shares in a fund
- [Open-End Fund](/open-end-fund/) — fund structure allowing ongoing redemptions
- [Closed-End Fund](/closed-end-fund/) — fund with restricted redemption opportunities
