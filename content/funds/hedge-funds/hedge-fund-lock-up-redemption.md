---
title: "Hedge fund lock-up and redemption"
description: "The restrictions on when and how investors can withdraw capital from a hedge fund, typically requiring lock-up periods and scheduled redemption windows."
---
...
A hedge fund is not like a [mutual fund](/wiki/mutual-fund/) where you can call your broker and sell your shares in seconds. Investing in a hedge fund requires committing capital for an extended period with strict rules on when you can get it back. These restrictions are codified in lock-up and redemption terms that are negotiated at the time of investment and spelled out in the fund's offering documents.
...
<h3>Wider context</h3>
<ul>
  <li><a href="/wiki/fund-of-funds/">Fund of funds</a> — aggregates hedge funds with varying redemption terms.</li>
  <li><a href="/wiki/interval-fund/">Interval fund</a> — a public mutual fund variant with restricted redemptions.</li>
  <li><a href="/wiki/performance-fee/">Performance fee</a> — the compensation structure aligned with lock-up restrictions.</li>
</ul>
</div>
