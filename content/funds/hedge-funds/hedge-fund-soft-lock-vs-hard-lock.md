...
keywords:
  ...
  - hedge fund hard lock-up
  - hedge fund lock-up period
  - hedge fund early exit penalty
image: /svg/funds.svg
---
...
<div class="wiki-infobox-title">Soft vs Hard Lock-Up — key facts</div>

<img src="/svg/funds.svg" alt="An abstract editorial mark for the topic." />

<div class="wiki-infobox-caption">Lock-ups anchor capital; soft ones add a penalty fee; hard ones allow no exit at all.</div>

|   |   |
|---|---|
| **Soft lock-up** | Early exit allowed; investor pays penalty fee (1%–5%) |
| **Hard lock-up** | No exit until term expires; zero exceptions |
| **Typical duration** | 1–2 years; some extend to 3–5 years or longer |
| **Why they exist** | Stabilize assets; permit long-term strategy execution |
| **After term expires** | Standard [redemption rules](/hedge-fund-redemption-notice-period/) and [notice periods](/hedge-fund-redemption-notice-period/) apply |
| **Documented in** | [Private placement memorandum](/private-placement/) (PPM) and subscription documents |

</aside>

## The Purpose of Lock-Ups

A hedge fund is built on a strategy that requires stable capital over time. A [leveraged buyout](/leveraged-buyout/) fund may spend 2 years acquiring a company, 3 years restructuring operations, and another 2–3 years exiting via sale or IPO. If investors could withdraw halfway through, the fund would lose capital exactly when it is most committed to the underlying investment. The strategy collapses.
...
Hard lock-ups are typical in [private equity funds](/private-equity-fund/) (especially buyout funds), venture capital funds, and specialized illiquid strategies. They are less common in hedge funds that invest in liquid securities (equities, bonds), where a soft lock-up is usually sufficient.
...
## Interaction with [Redemption Notice Periods](/hedge-fund-redemption-notice-period/)
...
Conversely, a fund might offer a lower [management fee](/management-fee/) to investors accepting longer lock-ups. The trade-off is: give up flexibility, receive lower ongoing costs.
...
- [Hedge Fund Redemption Notice Periods Explained](/hedge-fund-redemption-notice-period/) — advance notice requirements, separate from lock-ups
- [Hedge Fund Minimum Investment Requirements](/hedge-fund-minimum-investment/) — capital thresholds paired with lock-up terms
- [Hedge Fund](/hedge-fund/) — overview of structure, fees, and redemption mechanics
- [Net Asset Value](/net-asset-value/) — share price used to calculate redemption proceeds
- [Private Placement](/private-placement/) — offering document specifying lock-up terms

### Wider context

- [Liquidity Risk](/liquidity-risk/) — risk of being unable to sell or redeem at fair value
- [Leveraged Buyout](/leveraged-buyout/) — acquisition strategy relying on stable capital
- [Private Equity Fund](/private-equity-fund/) — long-term illiquid investment vehicle
- [Management Fee](/management-fee/) — ongoing charge by fund managers
- [Redemption Rights (Equity)](/redemption-rights-equity/) — investor right to redeem shares
