...
description: "A Business Development Company (BDC) is a publicly traded closed-end fund that lends to and invests in small and mid-sized private companies. BDCs offer high yields (7-10%) but with illiquidity and credit risk."
keywords:
...
|   |   |
|---|---|
| **What it is** | A closed-end fund lending to and investing in private companies |
| **Also called** | BDC, private credit vehicle |
| **Issued by** | Specialized managers (Ares, Blackstone, Carlyle, Golub Capital) |
...
1. **Dividend sustainability.** Is the dividend paid from earnings or return of capital?
