...
description: "The date when a mutual fund started operations and began accepting investor capital, marking the beginning of its track record."
---
...
Paradoxically, newer funds often charge lower fees to attract assets from scratch. A newly launched [index-fund](/wiki/index-fund/) might launch with a 0.03% [expense-ratio](/wiki/expense-ratio/) to compete for assets, whereas an older incumbent fund charges 0.10% because of legacy expenses and customer stickiness. Investors should not penalize newer index funds; the lack of history is irrelevant for passive strategies tracking an index.
