...
description: "A portfolio approach that combines a large core holding in a broad, low-cost index fund with smaller satellite positions in specialized or actively managed funds."
---

<div class="wiki-hatnote">
For the broader portfolio construction philosophy, see <a href="/wiki/asset-allocation/">Asset Allocation</a>.
</div>
...
The core of a core-satellite portfolio is usually a broad, low-cost index fund. For US equities, this might be a [total stock market ETF](/wiki/index-fund/) like Vanguard's VTI or State Street's SCHB, covering all 3,500+ US stocks. For bonds, it might be the Bloomberg Total Bond Market Index. For global stocks, it might be a [developed markets](/wiki/international-etf/) plus [emerging markets](/wiki/emerging-markets-fund/) combination.

The core typically represents 60–80% of the portfolio. It's intentionally boring and passive. The core's job is to ensure you capture broad market returns at minimal cost, with no [tracking error](/wiki/etf-tracking-error/) above 10 basis points.
...
Examples include:
- A [dividend-focused ETF](/wiki/dividend-focused-etf/) if you believe dividend growth will outperform.
- A [value ETF](/wiki/value-investing/) if you believe cheap stocks will recover.
- A [small-cap ETF](/wiki/equity-etf/) if you believe small-cap stocks will outperform large-cap.
- A [factor ETF](/wiki/factor-etf/) targeting momentum, quality, or other characteristics.
- An [active ETF](/wiki/active-etf/) if you have conviction in the manager.
- A [thematic ETF](/wiki/thematic-etf/) targeting AI, cybersecurity, or other growth trends.
...
A core-satellite approach offers some tax advantages in a taxable account. The core portion, held long-term in a low-turnover index fund, generates minimal capital gains. The satellites can be managed more actively with [tax-loss harvesting](/wiki/tax-loss-harvesting/) if they underperform.
...
Satellite positions can be passive (like a [dividend aristocrats ETF](/wiki/dividend-aristocrats/)) or active (like a stock-picker's fund). Passive satellites are cheaper (0.05–0.20% [expense ratio](/wiki/expense-ratio/)) but offer mechanical factor exposure, which may or may not align with your actual beliefs.
...
Rebalancing is a form of "buying low and selling high," which improves risk-adjusted returns. However, rebalancing incurs costs: transaction costs (if trading ETFs), potential [tax](/wiki/capital-gains-tax-investor/) consequences (in taxable accounts), and behavioral challenges (it's hard to sell winners).
...
Similarly, satellites can create redundancy. If you hold a [small-cap value ETF](/wiki/equity-etf/), a [value ETF](/wiki/value-investing/), and a [dividend-growth ETF](/wiki/dividend-focused-etf/), there's significant overlap. Each holds many of the same small, cheap, dividend-paying stocks. You've created three overlapping positions that aren't as diversified as you think.
...
The key is discipline: pick satellites with low [expense ratios](/wiki/expense-ratio/), avoid overlap with the core, and rebalance periodically. Don't add too many satellites—three to five is plenty. Each satellite should be a distinct bet with its own clear thesis.

<div class="wiki-seealso">
<h2>See also</h2>
<h3>Closely related</h3>
<ul>
<li><a href="/wiki/asset-allocation/">Asset Allocation</a> — the framework underlying core-satellite.</li>
<li><a href="/wiki/index-fund/">Index Fund</a> — the core holding.</li>
<li><a href="/wiki/factor-etf/">Factor ETF</a> — common satellite positions.</li>
<li><a href="/wiki/active-etf/">Active ETF</a> — alternative satellite approach.</li>
<li><a href="/wiki/tax-loss-harvesting/">Tax-Loss Harvesting</a> — tax benefit of satellites.</li>
</ul>
<h3>Wider context</h3>
<ul>
