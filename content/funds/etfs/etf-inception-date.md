...
description: "The date an ETF was created and began offering shares to investors, indicating the fund's track record length and historical performance availability."
---
...
Many investors prefer established ETFs for this reason. A boring, old [S&P 500 ETF](/wiki/sp-500-index/) from 1993 has proven it works. A new AI-focused thematic ETF is untested.
...
An older ETF often has lower fees than a newer one. Early competition for [S&P 500 ETFs](/wiki/sp-500-index/) drove fees down to near-zero (0.03% for Vanguard's VOO, 0.03% for State Street's IVV). A new [S&P 500 ETF](/wiki/sp-500-index/) launched today would struggle to gain assets at 0.10% when established competitors charge 0.03%.

This is why older ETFs sometimes outperform newer ones not because of strategy skill, but because of fee history. A fund that charged 0.20% for 10 years, then dropped to 0.10%, has a lower blended historical [expense ratio](/wiki/expense-ratio/) than a new fund charging 0.10% from day one.
...
<li><a href="/wiki/expense-ratio/">Expense Ratio</a> — fees change over an ETF's life.</li>
<li><a href="/wiki/index-fund/">Index Fund</a> — performance often tied to inception and survivorship.</li>
<li><a href="/wiki/mutual-fund/">Mutual Fund</a> — similar inception-date effects apply.</li>
<li><a href="/wiki/fund-of-funds/">Fund of Funds</a> — related concept of fund aggregation.</li>
</ul>
<h3>Wider context</h3>
<ul>
