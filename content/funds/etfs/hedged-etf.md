---
title: "Hedged ETF"
description: "An ETF that reduces or eliminates exposure to a specific risk—typically currency risk or downside market risk—through the use of hedging strategies and derivatives."
---

*A hedged ETF is an ETF that takes explicit steps to reduce unwanted risk. Currency-hedged [international ETFs](/wiki/international-etf/) use [currency forwards](/wiki/currency-future/) to eliminate [currency risk](/wiki/currency-risk/), delivering pure exposure to foreign stocks. Downside-hedged ETFs use [options](/wiki/option/) or [put spreads](/wiki/put-option/) to cushion against market declines. Hedging comes with a cost, but for investors who want specific exposure without certain risks, it's valuable.*

## Currency hedging in international ETFs

When you own an unhedged [international ETF](/wiki/international-etf/), you get exposure to both the foreign stocks and the foreign currencies. If you own a Japanese stock ETF, your return depends on Japan's stock prices and the yen-dollar exchange rate.

A currency-hedged version of the same ETF holds the same Japanese stocks but uses [currency forwards](/wiki/currency-future/) to lock in today's yen-dollar rate. If the yen weakens 10% (bad for your dollar returns), the forward offsetts the loss. You get pure stock exposure without currency fluctuations.
...
Some ETFs use options strategies to reduce downside risk. A simple hedged ETF might hold the portfolio and buy [put options](/wiki/put-option/) on the index, giving you the right to sell at a fixed price. If the market crashes 30%, your puts protect you—you can sell at a higher price than the market.

The cost is the [option premium](/wiki/option-premium/)—say, 2% annually. In a normal year with 8% returns, you net 6% (8% minus 2% hedge cost). In a crash year with -30% returns, your puts protect you and you might lose only -5% (because the puts are worth 25% in a -30% crash).
...
Some ETFs use [put spreads](/wiki/put-option/) or dynamic hedging to reduce portfolio volatility without complete downside protection. These are complex strategies, and the results are mixed.

A [put spread](/wiki/put-option/) is buying a [put option](/wiki/put-option/) (insurance) and selling a higher-strike put (to pay for the insurance). This provides some downside protection but not complete. A dynamic hedge adjusts the hedge ratio based on market volatility, increasing the hedge when volatility is high and reducing it when it's low.

These strategies work in theory but have execution challenges and costs. Most [hedged equity ETFs](/wiki/etf/) underperform unhedged alternatives in bull markets (due to hedge costs) and outperform in bear markets (due to downside protection). The net result is usually slightly lower returns over full cycles.

## For whom hedged ETFs make sense

Hedged ETFs are appropriate for:

**Currency hedging**: Investors with [international ETF](/wiki/international-etf/) positions who don't want currency exposure. A US investor comfortable with Japan stock risk but not yen risk should use a currency-hedged Japan ETF.
...
In practice, dynamic hedging incurs rebalancing costs and taxes (in non-tax-advantaged accounts). An ETF that hedges and unhedges continuously creates [turnover](/wiki/asset-turnover-ratio/) and capital gains.
...
Currency-hedged [international ETFs](/wiki/international-etf/) are common and reasonably priced. Vanguard offers VXUS (unhedged) and VSP (currency-hedged). iShares offers EFA (unhedged) and EWJ (Japan, unhedged) and EWJ-H (Japan, currency-hedged).

The hedged versions charge 10–20 basis points more in [expense ratios](/wiki/expense-ratio/) to cover the cost of the hedging. For investors who truly don't want currency exposure, this cost is justified.
