---
title: "Leveraged Buyout Fund"
description: "A leveraged buyout (LBO) fund is a private equity fund that acquires companies using significant debt financing. LBOs aim to improve operations and exit via sale or IPO, with returns amplified by leverage."
keywords:
  - leveraged buyout
  - LBO
  - buyout fund
...
|   |   |
|---|---|
| **What it is** | A PE fund buying companies with heavy debt financing |
| **Also called** | LBO fund, buyout fund, debt-financed acquisition |
| **Typical leverage** | 60–75% debt, 25–40% equity |
| **Fund managers** | KKR, Blackstone, Carlyle, Apollo, etc. |
| **Acquisition size** | $100M–$5B+ |
| **Holding period** | 3–7 years |
| **Exit method** | Sale, IPO, secondary sale |
| **Target return** | 25%–35% annually |
| **Key success factor** | Operational improvement sufficient to service debt |
