...
<div class="wiki-infobox-title">Recallable Distributions — key facts</div>

<img src="/svg/funds.svg" alt="An abstract editorial mark for the topic." />

<div class="wiki-infobox-caption">A hybrid between distribution and capital call, designed to smooth cash management and protect the fund's deployment capacity.</div>

|   |   |
|---|---|
| **Definition** | Cash distributed to LPs but callable back by the fund within a set window |
| **Typical Recall Window** | 90 days to 2 years from distribution |
| **Trigger** | Follow-on investment, expense shortfall, or portfolio support |
| **LP Obligation** | Must return capital if recalled; typically with no interest |
| **Accounting** | Treated as provisional or contingent until recall window expires |
| **Fund Reserve** | Common in continuation funds and secondaries to reduce dry powder |
| **Risk to LP** | Reinvested proceeds may have to be liquidated on short notice |
...
- [Capital Flows](/capital-flows/) — the movement of LP capital into and out of funds
- Capital Call — standard LP funding obligation
- [Closed-End Fund](/closed-end-fund/) — fund structure where recallables are common
- [Fund Prospectus](/fund-prospectus/) — where recallable terms are defined
- [Continuation Fund](/continuation-fund/) — funds that heavily use recallable distributions
- Limited Partnership Agreement — the legal document governing recalls

### Wider context

- [Private Equity Fund](/private-equity-fund/) — broader fund mechanics and LP obligations
- [Evergreen Fund vs Closed-End Fund](/evergreen-fund-vs-closed-end-fund/) — comparison of fund structures
- Liquidation Preference — how LP returns are prioritized
- [Distribution](/dividend-distribution/) — general dividend and return mechanics
