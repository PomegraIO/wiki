---
title: "Fund Share Class"
description: "Different share types within same mutual or ETF fund with varying fee structures and minimum investments."
keywords:
  - fund share class
  - mutual fund
  - fee structure
...
| Feature | Class A | Class B | Class C | Class I |
|---------|---------|---------|---------|---------|
| **Front-load fee** | 4–6% | 0% | 0% | 0% |
| **Back-load fee (CDSC)** | None/small | 5% (declining) | 1% (declining) | None |
| **Annual expense ratio** | ~1.0% | ~1.5% | ~1.3% | ~0.5%+ |
| **Minimum investment** | $1,000–$10K | $1,000–$5K | $1,000–$5K | $100K–$1M+ |
| **Best for** | Long-term holders | Likely movers | Short-term hold | Large investors |
...
Exchange-traded funds (ETFs) typically have only one share class — all investors pay the same [expense ratio](/wiki/fund-expense-ratio/). This is a major advantage over mutual funds; there's no need to navigate Class A vs. B confusion.
...
ETFs, by design, are more tax-efficient across the board because of the [creation-redemption mechanism](/wiki/etf-creation-redemption/), which avoids forced turnover.
...
### Closely related
- [Mutual Fund](/wiki/mutual-fund/) — Vehicle that uses share classes
- [Fund Expense Ratio](/wiki/fund-expense-ratio/) — Annual cost across share classes
- [Expense Tracking Tools](/wiki/expense-tracking-tools/) — Monitor fees over time
- [ETF](/wiki/etf/) — Simpler alternative with single share class
