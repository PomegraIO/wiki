---
title: "Evergreen Fund vs Closed-End Fund"
description: "Evergreen funds operate on perpetual timelines with rolling capital calls, while closed-end funds have fixed terms and defined investment periods. Understand the structural and economic tradeoffs."
keywords:
  - evergreen fund vs closed end fund
  - evergreen fund structure
  - closed-end fund term
  - fund lifecycle management
  - perpetual capital structure
image: "/svg/funds.svg"
---
...
<div class="wiki-infobox-title">Evergreen vs Closed-End — key facts</div>

<img src="/svg/funds.svg" alt="An abstract editorial mark for the topic." />

<div class="wiki-infobox-caption">Two opposing fund structures with fundamentally different capital timing and horizon assumptions.</div>

|   |   |
|---|---|
| **Evergreen Fund** | Perpetual life; rolling capital calls; continuous deployment |
| **Closed-End Fund** | Fixed term (typically 10 years); discrete investment period; defined exit window |
| **Capital Calls** | Staggered over the entire fund life | Front-loaded into first 3–5 years |
| **Distributions** | Ongoing as deals exit; recycled into new deals | Bunched at end of fund life and extension periods |
| **Reinvestment Risk** | Minimized; exited capital finds new deals immediately | Significant; cash sitting idle waiting for new fund |
| **Predictability** | Lower; investors never know when distributions arrive | Higher; clear timeline and expected exit windows |
| **Fee Duration** | Longer; management fees continue indefinitely (or for decades) | Defined; fees end when fund term expires |
...
- [Closed-End Fund](/closed-end-fund/) — the fixed-term structure and mechanics
- [Open-End Fund](/open-end-fund/) — perpetual, liquid daily NAV vehicles (retail mutual funds)
- [Private Equity Fund](/private-equity-fund/) — typically closed-end with fixed terms
- [Fund Prospectus](/fund-prospectus/) — where the term and deployment rules are formally set
- [Capital Flows](/capital-flows/) — the timing and direction of LP capital into funds
- [Performance Fee](/performance-fee/) — how manager economics differ across structures

### Wider context

- [Mutual Fund](/mutual-fund/) — retail open-end funds and their perpetual model
- [Leveraged Buyout](/leveraged-buyout/) — LBO funds are typically closed-end
- [Hedge Fund](/hedge-fund/) — structure variations across hedge vehicle types
- [Real Estate Investment Trust](/real-estate-investment-trust/) — REIT structures and lifecycle
- [Net Asset Value](/net-asset-value/) — how fund values are computed and distributed
