...
description: "A management fee is a flat annual percentage charge that a fund manager levies on assets under management. A management fee of 1% means the fund charges $1,000 per year for every $100,000 invested, regardless of fund performance."
keywords:
  - management fee
  - annual fee
  - AUM fee
...
|   |   |
|---|---|
| **What it is** | A flat annual percentage charge on AUM |
| **Also called** | Base fee, advisory fee, AUM fee |
| **Measured as** | Percentage per year (e.g., 0.75%) |
| **Unit** | Basis points (1 bp = 0.01%) |
| **Typical range** | 0.01%–2.00% per year |
| **Charged on** | Average assets under management |
| **Payment** | Deducted from fund daily; you pay indirectly |
| **Applies to** | All funds (regardless of performance) |
...
| Year | Fund A (0.10%) | Fund B (0.75%) | Difference |
|------|----------------|----------------|-----------|
