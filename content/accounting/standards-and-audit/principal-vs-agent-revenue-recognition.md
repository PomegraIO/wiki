...
description: "Principal vs agent revenue recognition: how to determine whether a company records revenue gross or net, and which factors drive that judgment."
keywords:
  - principal vs agent revenue recognition
  - principal agent revenue
  - asc 606 principal agent
  - gross vs net revenue
  - revenue recognition judgment
image: /svg/accounting.svg
---

*A company acting as a **principal** records revenue at the gross amount it charges customers; an **agent** records only the commission or fee it earns, not the full transaction value. Under [ASC 606](/asc-606/), the distinction depends on whether the company controls the good or service before transferring it to the customer.*

<aside class="wiki-infobox">

<div class="wiki-infobox-title">Principal vs Agent Revenue Recognition — key facts</div>

<img src="/svg/accounting.svg" alt="An abstract editorial mark for the topic." />

<div class="wiki-infobox-caption">A judgment call with large income statement implications.</div>

|   |   |
|---|---|
| **Principal** | Records revenue at gross amount; responsible for fulfillment and customer satisfaction |
| **Agent** | Records revenue as net commission or fee; arranges transaction but does not control the good/service |
| **Key test** | Does the company control the promised good or service before transferring it to the customer? |
| **Financial impact** | Principal: higher revenue and costs; agent: lower revenue, higher profit margin |
| **Examples** | Principal: retailer buying goods then selling them. Agent: travel agency booking flights, real-estate broker arranging sale |
| **ASC 606 guidance** | Five-step revenue model; control of the promised performance obligation determines classification |

</aside>

## Why the Distinction Matters

The principal-versus-agent classification has enormous implications for reported revenue. A hotel reservation platform that handles $1 billion in annual bookings might record $100 million (10%) if classified as an agent (earning a commission) or $1 billion if classified as a principal (selling rooms to customers). The classification affects not just the top line but also cost of sales, [gross profit margin](/gross-profit-margin/), and downstream metrics like return on assets.

Investors and analysts pay close attention. A company cannot boost its reported revenue by simply shifting from an agent model to a principal model without changing the underlying economics. [Auditors](/audit-sampling-methods-explained/) scrutinize this judgment heavily during financial statement reviews.
...
[ASC 606](/asc-606/) lists five indicators to help auditors and management assess control:

1. **Responsibility for fulfillment**: Does the company fulfill the promise or rely on another party? A principal typically bears fulfillment risk.
2. **Inventory risk**: Does the company hold inventory and bear loss if goods are damaged, stolen, or obsolete? Yes = principal.
3. **Customer relationships and pricing discretion**: Can the company set or negotiate the price charged to customers? Yes = principal.
4. **Performance obligations and credit risk**: Is the company responsible if the customer doesn't pay? Yes = principal.
5. **Return rights and customer satisfaction**: Who handles returns, warranties, and complaints? The principal does.
...
The principal-versus-agent judgment must be documented in the [revenue recognition policy](/revenue-recognition/) and applied consistently. Auditors will challenge classifications that seem aggressive—e.g., a company claiming principal status when it lacks pricing control or has no fulfillment responsibility.
...
- [ASC 606 Revenue Recognition](/asc-606/) — the foundational standard for revenue judgment
- [Audit Sampling Methods Explained](/audit-sampling-methods-explained/) — how auditors test revenue transactions
- [Significant Deficiency vs Material Weakness in Internal Controls](/significant-deficiency-vs-material-weakness/) — control failures in revenue processes
- [Audit Trail in Double-Entry Accounting](/double-entry-audit-trail/) — transaction documentation supporting revenue classification
- [Revenue Recognition](/revenue-recognition/) — broader framework and policy disclosure

### Wider context

- [Generally Accepted Accounting Principles](/generally-accepted-accounting-principles/) — GAAP standards and revenue principles
- [Securities and Exchange Commission](/securities-and-exchange-commission/) — oversees revenue disclosure adequacy
- [Income Statement](/income-statement/) — where principal vs agent classification affects reported revenue
