---
title: "Going concern"
description: "Going concern is the accounting assumption that a company will continue operating indefinitely. If there is substantial doubt about this, auditors qualify their opinion and companies must disclose."
keywords:
  - going concern
...
|   |   |
|---|---|
| **What it is** | Assumption of indefinite future operations |
| **Critical for** | Asset valuation, depreciation estimation |
| **Alternative** | Liquidation value (if not a going concern) |
| **Audit view** | Must assess substantial doubt |
| **Disclosure** | Footnotes if substantial doubt exists |
| **Opinion impact** | Qualified opinion if substantial doubt |
