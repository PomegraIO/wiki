...
description: "The systematic expensing of finite-life intangible assets over their useful life."
keywords:
  - amortization
  - intangible assets
  - accounting method
...
*Intangible asset amortization is the accounting process of systematically allocating the cost of an intangible asset with a finite life over the periods that benefit from its use. Like [depreciation](/wiki/depreciation/) for physical assets, amortization reduces the asset's book value and charges an expense to the income statement, matching the asset's consumption with the periods it generates revenue.*

<aside class="wiki-infobox">

| Element | Detail |
|---|---|
| **Applies to** | Patents, trademarks, software, licenses, customer lists |
| **Life determined by** | Legal term, regulatory period, or useful life estimate |
| **Method** | Straight-line or accelerated |
| **Accounting standard** | GAAP, IFRS requirement |
| **Contrast** | Indefinite-life intangibles (brands) are not amortized |
| **Expense recognition** | Reduces operating income over asset life |
...
### Closely related
- [Depreciation](/wiki/depreciation/) — Systematic write-down of physical assets
- [Goodwill](/wiki/goodwill/) — Premium paid in acquisition; indefinite-life asset
- [Goodwill Impairment](/wiki/goodwill-impairment/) — Write-down when goodwill loses value
- [Intangible Assets](/wiki/intangible-assets/) — Non-physical resources with economic value
- [Asset Impairment](/wiki/asset-impairment/) — Reduction in asset value when earning power declines

### Wider context
- [Balance Sheet](/wiki/balance-sheet/) — Financial position statement showing assets
- [Income Statement](/wiki/income-statement/) — Profit and loss statement
- [Acquisition](/wiki/acquisition/) — Purchase of another company or assets
- [EBITDA](/wiki/ebitda/) — Earnings before depreciation and amortization
