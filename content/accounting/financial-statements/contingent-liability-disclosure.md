...
description: "Required disclosure of possible obligations from pending events, such as litigation, regulatory investigations, or warranty claims."
keywords:
...
| Key Fact | Detail |
|----------|--------|
| **Definition** | Possible obligation from past/present event; settlement depends on uncertain future event |
| **Accounting treatment** | Liability (if probable + measurable); disclosure only (if reasonably possible); ignored (if remote) |
| **Probability threshold** | "Probable" = likely to occur; "reasonably possible" = less certain; "remote" = unlikely |
| **Measurement** | Best estimate of settlement amount, or range if uncertain |
| **Disclosure location** | Notes to financial statements, often labeled "Commitments and Contingencies" |
| **Examples** | Pending litigation, warranty claims, environmental cleanup, regulatory fines |
| **Investor relevance** | Can reveal hidden risks and material obligations not yet in financial statements |

</aside>

## Accounting treatment: three tiers

Under both US [GAAP](/wiki/generally-accepted-accounting-principles/) (ASC 450) and [IFRS](/wiki/international-financial-reporting-standards/) (IAS 37), contingent liabilities fall into three categories:
...
1. **Assess materiality.** Is the aggregate exposure material relative to equity, cash, or annual earnings? A $10 million contingent liability for a $200 million market-cap company is high-risk; for a $50 billion company, it may be immaterial.

2. **Identify concentration.** Is liability concentrated in one matter (a single large lawsuit) or distributed (many small claims)? Concentration is riskier because one unfavorable ruling is catastrophic.

3. **Gauge probability.** What does legal counsel say? "We believe an unfavorable outcome is probable" is dire; "we believe an unfavorable outcome is remote" is reassuring. "Reasonably possible" is ambiguous — it could go either way.

4. **Monitor changes.** In successive 10-K filings, new contingencies appear or old ones resolve. A steady stream of new contingencies signals operational or legal risks.

5. **Cross-reference with MD&A.** Management's Discussion and Analysis should discuss material contingencies in narrative form, providing context that footnotes may not. Investors should reconcile them.

## Why accrual vs. disclosure matters for cash flow

A company accruing a liability records an expense on the [income statement](/wiki/income-statement/) but not a cash outflow (initially). The liability sits on the balance sheet. When the company eventually pays (settle a lawsuit, pay an environmental fine), cash leaves and the liability is reversed.

This distinction matters for [cash flow analysis](/wiki/cash-flow-statement/): a company with large accruals building on the balance sheet has a ticking clock. Eventually, those liabilities will require cash payment, affecting free cash flow. A company disclosing reasonably-possible contingencies has not yet hit the cash impact, but investors should model it as a potential future drag on cash generation.
