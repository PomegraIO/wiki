---
title: "Deferred Tax Asset vs Deferred Tax Liability Explained"
description: "Understand when a company records a deferred tax asset versus a deferred tax liability, including timing differences in depreciation, warranties, and revenue recognition."
keywords:
  - deferred tax asset
  - deferred tax liability
  - timing differences
  - temporary differences accounting
  - tax accounting vs book accounting
---

*A **deferred tax asset** arises when a company pays or accrues taxes now but will deduct the expense for book purposes later, creating a claim on future tax savings. A **deferred tax liability** arises when a company deducts an expense for tax purposes now but records it as revenue or defers recognition for book purposes, creating an obligation to pay higher taxes later. Both stem from timing differences between tax accounting (how the IRS measures income) and book accounting (how [GAAP](/generally-accepted-accounting-principles/) or [IFRS](/international-financial-reporting-standards/) measure financial results). Understanding the distinction is critical for reading balance sheets and assessing a company's true earnings quality.*

<aside class="wiki-infobox">

<div class="wiki-infobox-title">Deferred Tax Assets and Liabilities — key facts</div>

<img src="/svg/accounting.svg" alt="An abstract editorial mark for accounting." />

<div class="wiki-infobox-caption">Timing mismatches between tax law and accounting standards create temporary tax differences.</div>

|   |   |
|---|---|
| **Deferred tax asset** | Represents tax savings the company will realize in the future |
| **Deferred tax liability** | Represents additional tax the company will owe in the future |
| **Root cause** | Differences in the timing of revenue and expense recognition |
| **Common source (asset)** | Loss carryforwards, warranty accruals, bad debt reserves |
| **Common source (liability)** | Accelerated depreciation, revenue recognized earlier for tax than books |
| **Valuation allowance** | An asset reserve if future tax benefit is uncertain |
| **Tax rate** | Both measured using the company's expected future marginal tax rate |

</aside>

## Timing Differences: The Source of Deferrals

Tax law and accounting standards do not always agree on **when** to recognize revenue and expenses. The IRS may allow a deduction for depreciation this year, while [GAAP](/generally-accepted-accounting-principles/) requires a company to spread the same depreciation over ten years. The result is a timing difference: the amount recognized differs by period, even though the total over time is the same.
...
**Warranty accruals.** A manufacturer sells products with a one-year warranty. Under [GAAP](/generally-accepted-accounting-principles/), the company accrues an estimated warranty expense in the year of sale, matching the cost to the revenue. The IRS, however, does not allow the deduction until the warranty claim is actually paid. A company with a $500,000 accrual and a 25% tax rate records a $125,000 deferred tax asset; when actual warranty costs are paid, that asset is released and the tax benefit is realized.
...
**Lease accounting.** Under [ASC 606](/asc-606/) and [IFRS 16](/international-financial-reporting-standards/), companies record right-of-use assets and corresponding lease liabilities, with lease expenses spread evenly. Tax law may allow different timing of deductions, creating temporary differences and deferred liabilities.
...
This creates earnings volatility unrelated to operations. A tax rate change can swing [earnings per share](/earnings-per-share/) materially.
...
- [Generally Accepted Accounting Principles](/generally-accepted-accounting-principles/) — The US accounting standard that defines timing differences
...
- [Accumulated Depreciation](/accumulated-depreciation/) — The deduction-timing vehicle that often creates deferred liabilities
- [Revenue Recognition](/revenue-recognition/) — The timing of revenue that often differs between tax and book
- [Earnings Quality](/earnings-quality/) — An assessment influenced by deferred tax items and accruals
- [Corporate Income Tax](/corporate-income-tax/) — The tax rate applied to measure deferred items
