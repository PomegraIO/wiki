---
title: "Equity Method Accounting"
description: "Accounting method for investments in which the investor significantly influences (but does not control) the investee."
keywords:
  - equity method
...
*The **equity method** is used to account for an investment when the investor owns between roughly 20% and 50% of the investee's shares and exerts significant influence (but not control). Rather than recording the investment at cost or fair value, the investor records its share of the investee's [net income](/wiki/income-statement/) on its own [income statement](/wiki/income-statement/) and its share of [equity](/wiki/shareholders-equity/) on its [balance sheet](/wiki/balance-sheet/), adjusted quarterly or annually.*

<aside class="wiki-infobox">

| Factor | Detail |
|--------|--------|
| **Ownership Threshold** | Typically 20–50%; control presumed above 50% |
| **Influence Indicators** | Board representation, participation in management, material transactions |
| **Income Recorded** | Investor's pro-rata share of investee net income |
| **Dividend Treatment** | Reduces carrying value (not income) |
| **Balance Sheet** | Investment shown as single line-item asset |
| **Equity Pickup** | "Equity in earnings of [Investee]" on P&L |
| **Goodwill** | Recorded at acquisition if purchase price > fair value of net assets |
...
If ownership exceeds 50% (or control is achieved through other means, such as board control), the investment becomes a [consolidation](/wiki/consolidation-accounting/) — a full-fledged subsidiary, and the investor [consolidates](/wiki/consolidated-statements/) the investee's entire balance sheet and income statement.
...
When the investee's accounting methods differ from the investor's, the investor makes adjustments. If the investee uses [LIFO](/wiki/lifo-tax/) inventory but the investor uses [FIFO](/wiki/fifo-tax/), the investor adjusts the equity pickup to eliminate the difference. The goal is consistency across the consolidated picture.
...
## Dividends and [distributions](/wiki/dividend-distribution/)

Dividends received are *not* income under the equity method; they reduce the carrying value of the investment. This is a critical distinction from [cost accounting](/wiki/cost-basis/). A 30% investor in a company earning $50 million picks up $15 million in income (even if no dividend is paid). If a $5 million dividend is paid, the investor records $1.5 million as a reduction in the investment balance, not as dividend income.

## Tax implications

In the US, a domestic corporation generally receives a [dividends-received deduction (DRD)](/wiki/dividend-tax/) for dividends from a 20%+ owned foreign corporation, reducing taxable income. The equity method for financial reporting does not directly affect taxes; however, the carrying value of the investment affects basis and eventual [capital gains](/wiki/capital-gains-tax/) when the investment is sold.
...
### Closely related
- [Consolidation Accounting](/wiki/consolidation-accounting/) — full ownership (> 50%)
- [Fair Value Accounting](/wiki/fair-value/) — alternative for non-consolidated investments
- [Balance Sheet](/wiki/balance-sheet/) — where investment appears
- [Income Statement](/wiki/income-statement/) — where earnings pickup appears
- [Goodwill](/wiki/goodwill/) — acquisition premium

### Wider context
- [GAAP](/wiki/generally-accepted-accounting-principles/) — US accounting standards
- [IFRS](/wiki/international-financial-reporting-standards/) — global standards
- [Impairment Testing](/wiki/asset-impairment/) — goodwill evaluation
- [Related Party Transactions](/wiki/related-party-disclosure/) — affiliate dealings
- [Cash Flow Statement](/wiki/cash-flow-statement/) — equity pickup impact
