...
description: "Prepayment received but not yet earned as income, recorded as liability until service delivery."
keywords:
  - deferred revenue
  - liability
  - revenue recognition
...
| Element | Detail |
|---------|--------|
| **Journal Entry (Receipt)** | Debit cash; credit deferred revenue (liability) |
| **Journal Entry (Earning)** | Debit deferred revenue; credit revenue (income statement) |
| **Balance Sheet Location** | Current liabilities (if earned within 12 months); long-term if beyond |
| **Impact on Reported Profit** | None at receipt; reduces profit as revenue is earned |
| **Common in** | SaaS, insurance, publishing, memberships |
| **Accounting Rule** | ASC 606 / IFRS 15 (revenue recognition standard) |
| **Related Concept** | [Accrued revenue](/wiki/accrued-interest/) (opposite: earned but unpaid) |
...
[Accrual accounting](/wiki/accrual-accounting/) demands that revenue be recorded when *earned*, not when cash is received. A software company selling a 3-year license for $30,000 upfront must recognize $10,000 per year, not all $30,000 at signing. Deferred revenue is the mechanism that forces this timing match.
...
Deferred revenue is split between [current liabilities](/wiki/current-ratio/) and long-term liabilities based on when it will be earned:
...
However, deferred revenue is not pure cash in the bank. It's a promise. If the company fails to deliver service (bankruptcy, product failure), the customer is entitled to a refund. [Refund rights](/wiki/contingent-liability/) reduce the true economic value of deferred revenue.

## Relationship to operating cash flow

A key distinction: [operating cash flow](/wiki/cash-flow-statement/) and accrual revenue can diverge significantly in subscription models. A company might show $50 million in revenue but $120 million in operating cash flow, because customers are paying 2–3 years in advance. This mismatch confuses investors comparing [cash flow](/wiki/free-cash-flow/) to accounting profit.
...
Deferred revenue is the *mirror image* of [accrued revenue](/wiki/accrued-interest/). Accrued revenue is revenue earned but not yet paid. Example: a contractor finishes work on December 31 but doesn't invoice until January. Accrued revenue (an asset) is recorded in December; cash follows in January.
...
### Closely related
- [Revenue Recognition](/wiki/revenue-recognition/) — Timing of when revenue is recorded
- [ASC 606](/wiki/asc-606/) — Current standard for revenue recognition
- [Accrual Accounting](/wiki/accrual-accounting/) — Foundation of deferred revenue treatment
- [Accrued Revenue](/wiki/accrued-interest/) — Mirror concept: earned but unpaid
