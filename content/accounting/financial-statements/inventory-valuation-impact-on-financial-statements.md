---
title: "Inventory Valuation Impact on Financial Statements"
description: "How inventory valuation methods (FIFO, LIFO, weighted average) affect cost of goods sold, gross profit, taxes, and balance sheet inventory values."
keywords:
...
<div class="wiki-infobox-title">Inventory Methods — key facts</div>

<img src="/svg/accounting.svg" alt="An abstract editorial mark for accounting topics." />

<div class="wiki-infobox-caption">Three standard methods produce different results, particularly in volatile price environments.</div>

|   |   |
|---|---|
| **FIFO (First-In, First-Out)** | Earliest inventory costs go to COGS first; remaining inventory valued at recent costs |
| **LIFO (Last-In, First-Out)** | Latest inventory costs go to COGS first; remaining inventory valued at older costs |
| **Weighted Average Cost** | Blends all purchases; smooths COGS and inventory value |
| **Tax impact** | LIFO typically lowers taxable income in inflation; FIFO inflates it |
| **Reporting** | All three are GAAP-compliant; choice is disclosed in notes |
| **Balance sheet effect** | Changes inventory asset value and therefore total assets |
...
A company sitting on a large LIFO reserve faces a hidden tax liability: if it ever sells down that old inventory (or switches to FIFO), the deferred taxes become due. This is sometimes called a "LIFO layer" concern and factors into [acquisition](/acquisition/) and merger evaluations.
...
- [FIFO](/fifo/) — First-in, first-out method and mechanics
- [LIFO](/lifo/) — Last-in, first-out method and tax advantages
- Cost of Goods Sold — How inventory cost flows to the income statement
- [Gross Profit Margin](/gross-profit-margin/) — How inventory valuation affects this key metric
- [Income Statement](/income-statement/) — Where COGS and inventory changes appear
- [Balance Sheet](/balance-sheet/) — Where inventory asset is reported
- [Generally Accepted Accounting Principles](/generally-accepted-accounting-principles/) — The framework governing method choice
- [Depreciation Recapture Investor](/depreciation-recapture-investor/) — Related tax-basis considerations

### Wider context

- [Revenue Recognition](/revenue-recognition/) — When sales and inventory are matched
- [Accrual Accounting](/accrual-accounting/) — The matching principle underlying COGS
