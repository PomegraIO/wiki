...
description: "Comprehensive income is the total change in shareholders' equity from all sources during a period, including net income and other comprehensive income items not in the income statement."
keywords:
...
|   |   |
|---|---|
| **What it is** | Total change in equity from all sources |
| **Includes** | Net income + Other comprehensive income |
| **Source** | Income statement + separate items |
| **Disclosure** | Separate statement (one or two statement format) |
| **OCI items** | Unrealized gains, foreign currency, hedges |
| **Flows to** | Accumulated other comprehensive income (AOCI) |
