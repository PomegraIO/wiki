...
description: "Consolidation combines parent-company and subsidiary financial statements into a single set of accounts, eliminating intercompany transactions."
keywords:
  - consolidation
  - parent company
  - subsidiary
...
When one company owns a subsidiary—typically 50% or more of voting stock—the parent must report the subsidiary's assets, liabilities, revenues, and expenses as if they were a single economic entity. This is required under both [GAAP](/wiki/generally-accepted-accounting-principles/) and [IFRS](/wiki/international-financial-reporting-standards/).
...
Third, if the parent owns less than 100% of the subsidiary, a **[noncontrolling interest](/wiki/noncontrolling-interest/)** (also called minority interest) appears on the balance sheet and income statement. If Parent owns 80% and outside investors own 20%, that 20% claim is recorded separately. The outside owners have a real stake in the subsidiary's results.
...
Consolidation occurs when the parent gains control, typically via [acquisition](/wiki/acquisition/). From that date forward, the subsidiary is consolidated. If the subsidiary is sold, consolidation ceases on the sale date. [Spin-offs](/wiki/spin-off/) and [demergers](/wiki/demerger/) reverse consolidation, separating one unified company back into two independent balance sheets.

<div class="wiki-seealso">

### Closely related
- [Goodwill](/wiki/goodwill/) — The premium paid in an acquisition above asset value.
- [Goodwill Impairment](/wiki/goodwill-impairment/) — Writing down overpaid acquisitions.
- [Equity Method Accounting](/wiki/equity-method-accounting/) — Accounting for significant but non-controlling stakes.
- [Acquisition](/wiki/acquisition/) — Merging one company into another.
- [Consolidated Statements](/wiki/consolidated-statements/) — The finished consolidated financial reports.

### Wider context
- [Business Combination Purchase](/wiki/business-combination-purchase/) — Legal and accounting mechanics of M&A.
- [Intangible Assets](/wiki/intangible-assets/) — Non-physical assets like brands and patents.
- [Balance Sheet](/wiki/balance-sheet/) — Statement of assets, liabilities, and equity.
- [Income Statement](/wiki/income-statement/) — Statement of revenues and expenses.
- [Material Adverse Change](/wiki/material-adverse-change/) — Covenant language in merger agreements.
