---
title: "Derecognition of Financial Assets"
description: "When financial assets can be removed from the balance sheet. Conditions for derecognition under accounting standards."
keywords:
  - derecognition of financial assets
  - when to remove asset from balance sheet
  - ifrs 9 derecognition
  - transferred receivable accounting
  - sale vs secured borrowing
image: /svg/accounting.svg
---

*A company can remove a financial asset—such as a receivable or loan—from its [balance sheet](/balance-sheet/) only when it has surrendered control of that asset. **Derecognition of financial assets** is the formal removal, and it requires meeting strict criteria: the rights to cash flows must have expired, been transferred substantially, or the company must have transferred control to another party. The key distinction is between a genuine sale (which qualifies for derecognition) and a secured loan backed by the asset (which does not).*

<aside class="wiki-infobox">

<div class="wiki-infobox-title">Derecognition — Key Facts</div>

<img src="/svg/accounting.svg" alt="An abstract editorial mark for the topic." />

<div class="wiki-infobox-caption">Control is the threshold; possession is not the same as control.</div>

|   |   |
|---|---|
| **Core rule** | Remove from balance sheet only if control of asset and cash flows has been transferred |
| **Standards that apply** | [IFRS 9](/international-financial-reporting-standards/) (IFRS) and ASC 860 (U.S. GAAP) |
| **Sale vs. secured loan** | Sale = derecognition; pledge as collateral = no derecognition |
| **Partial transfers** | If control is shared, asset stays on balance sheet at reduced carrying amount |
| **Common example** | Factoring a receivable: if the factor assumes credit risk, derecognition likely applies |
| **Documentation burden** | Must demonstrate control transfer; weak documentation = no derecognition |

</aside>

## The Control Test

Derecognition hinges on whether the transferor has lost *control* of the asset. Under both [IFRS 9](/international-financial-reporting-standards/) and U.S. GAAP (ASC 860), control means:
...
A company that sells a receivable to a bank transfers the right to future customer payments, the obligation to service the account, and (critically) no longer controls collection. That is a sale, and derecognition applies. By contrast, a company that borrows money and pledges the receivable as collateral retains control—it still collects the payments and uses them to repay the loan. Derecognition does not apply; the receivable stays on the [balance sheet](/balance-sheet/).
...
[IFRS 9](/international-financial-reporting-standards/) sets three conditions, any one of which permits derecognition:
...
When a company transfers part of an asset or retains partial control, [IFRS 9](/international-financial-reporting-standards/) requires a more nuanced approach:
...
- **Compare carrying amount to fair value** to allocate any [gain or loss](/earnings-per-share/) on the transfer.
...
A mortgage bank originates 100 mortgages, pools them, and sells them to a special-purpose entity (SPE) that issues bonds to investors. The bank receives cash equal to the principal and immediately removes the mortgages from its [balance sheet](/balance-sheet/) (derecognition). The bank may also agree to service the mortgages—collect payments, handle defaults—for a fee. The servicing contract is a **continuing involvement**, but it does not prevent derecognition if the bank cannot repurchase the loans or control the SPE's decisions.

In contrast, if the mortgage bank retains first-loss risk (it absorbs the first 5% of loan losses before the SPE's debt holders take a hit), it has retained a significant economic interest and may not qualify for full derecognition. [IFRS 9](/international-financial-reporting-standards/) would require the bank to either keep a portion of the mortgages on its balance sheet or record an explicit [liability](/accounts-payable/) for the first-loss guarantee.

## The Balance Sheet Implication

From a reader's perspective, derecognition is important because it affects the apparent size and [leverage](/debt-to-equity-ratio/) of a company. A financial institution that securitizes loans and derecognizes them can report a smaller [balance sheet](/balance-sheet/) and lower debt-to-equity ratios. Investors must look beyond the [balance sheet](/balance-sheet/) to understand whether the company has truly transferred risk or merely rearranged it. Footnote disclosures and supplementary metrics (like "assets under management" or "loans serviced") are vital to seeing the full picture.
...
- [Balance Sheet](/balance-sheet/) — Financial statement affected by derecognition
- [International Financial Reporting Standards](/international-financial-reporting-standards/) — IFRS 9 governs derecognition
- [Accounts Receivable](/accounts-receivable/) — Common asset type subject to derecognition
- [Revenue Recognition](/revenue-recognition/) — Related accounting principle for timing recognition
- [Securitization](/securitization/) — Practical example of derecognition

### Wider context

- [Generally Accepted Accounting Principles](/generally-accepted-accounting-principles/) — U.S. GAAP alternative framework
- [Financial Assets](/derecognition-of-financial-assets/) — Broader category
- [Fair Value](/fair-value/) — Measurement of transferred assets
