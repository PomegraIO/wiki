...
description: "Writing down intangible assets when acquisition premium declines in fair value."
keywords:
  - goodwill accounting
  - intangible assets
...
*[**Goodwill impairment**](/wiki/goodwill-impairment-testing/) occurs when the fair value of an [acquisition](/wiki/acquisition/) falls below the amount the acquirer paid for it, forcing the acquirer to write down (reduce) the [goodwill](/wiki/goodwill/) (intangible premium) on its [balance sheet](/wiki/balance-sheet/). The charge flows through [earnings](/wiki/earnings-per-share/), depressing reported [profit](/wiki/net-profit-margin/) and often signaling a failed strategic bet.*
...
| Aspect | Definition or Range |
|---|---|
| Accounting standard | [ASC 350](/wiki/asc-606/) (US GAAP), [IFRS 3](/wiki/goodwill-impairment-testing/) |
...
[GAAP](/wiki/generally-accepted-accounting-principles/) and [IFRS](/wiki/international-financial-reporting-standards/) require the acquirer to record the purchased intangibles separately (patents, customer lists, brand, deferred revenue). Goodwill is the "plug"—whatever premium remains after tangible and separately identifiable intangibles are valued. Goodwill is then listed as an [asset](/wiki/asset-play-strategy/) on the acquirer's balance sheet.
...
**Overpaid acquisition**: Some acquisitions are overpriced from the start—driven by [hubris](/wiki/overconfidence-in-investing/), board-room pressure, or misaligned incentives. As reality becomes clear, impairment follows.
...
Goodwill impairment is sometimes used (intentionally or unintentionally) to smooth earnings. A company that beat expectations this year might take a goodwill impairment charge next year to lower comparables. The impairment reduces reported [net income](/wiki/net-profit-margin/), but it's a non-cash charge (doesn't affect [operating cash flow](/wiki/operating-cash-flow-ratio/)), and future years benefit from a lower amortization base.

Regulators and auditors scrutinize goodwill impairment testing to prevent abuse. Aggressive [DCF](/wiki/discounted-cash-flow-valuation/) assumptions (low discount rates, high perpetual growth) can justify avoiding or deferring impairments. Conservative assumptions (high discount rates) accelerate impairments. Auditors push back when assumptions seem unreasonable.

## Goodwill impairment and balance-sheet health

Analysts use goodwill impairments as a negative signal about management's acquisition discipline and judgment. Large impairments suggest prior overpayment, integration failure, or environmental shifts the company didn't anticipate. A company with a history of impairments is viewed with skepticism on future [M&A](/wiki/merger-arbitrage/).

[Book value per share](/wiki/tangible-book-value-per-share/) can be distorted by goodwill. A company with high goodwill and thin operating margins may have a [P/B ratio](/wiki/price-to-book-ratio/) above 2, but significant hidden impairment risk. When impairment hits, [book value](/wiki/goodwill-impairment-testing/) plummets, shocking investors who relied on P/B metrics.
...
### Closely related
- [Goodwill](/wiki/goodwill/) — The intangible asset being tested
- [Acquisition](/wiki/acquisition/) — The transaction creating goodwill
- [Asset Impairment](/wiki/asset-impairment/) — Broader category
- [Intangible Assets](/wiki/intangible-assets/) — Identifiable intangibles (patents, customer lists)

### Wider context
- [Balance Sheet](/wiki/balance-sheet/) — Where goodwill resides
- [Discounted Cash Flow Valuation](/wiki/discounted-cash-flow-valuation/) — Method used in impairment testing
- [Earnings Per Share](/wiki/earnings-per-share/) — Impact of impairment charges
- [Merger Arbitrage](/wiki/merger-arbitrage/) — Context where integration failures occur
