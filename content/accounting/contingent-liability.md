...
description: "A contingent liability is a potential obligation that may become actual depending on the outcome of an uncertain future event. It may be recorded or disclosed in footnotes."
keywords:
...
|   |   |
|---|---|
| **What it is** | Potential future obligation from past event |
| **Recording** | Only if probable and estimable |
| **Disclosure** | Footnote if possible but not probable |
| **Examples** | Lawsuits, warranties, environmental claims |
| **Judgment** | Probability and amount are estimates |
| **Audit focus** | Area of high scrutiny |
