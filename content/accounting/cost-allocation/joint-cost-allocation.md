---
title: "Joint Cost Allocation"
description: "The accounting process of distributing shared production costs among multiple outputs when a single production process yields multiple products."
keywords:
...
| Aspect | Detail |
|--------|--------|
| **When incurred** | Before the split-off point; cannot be traced to individual products |
| **Split-off point** | The moment the process separates into distinct product streams |
| **Allocation methods** | Physical-units, sales-value, net-realizable-value, constant gross-margin |
| **Key challenge** | No objectively "correct" allocation; choice is somewhat arbitrary |
| **Impact** | Affects product-line profitability, pricing, and production decisions |
...
### Closely related
- [Absorption Costing](/wiki/absorption-costing/) — The accounting system that includes allocated joint costs in product cost
- [Variable Costing](/wiki/variable-costing/) — An alternative that excludes fixed and joint costs from product cost
- [Activity-Based Costing](/wiki/activity-based-costing/) — A refined method of allocating indirect costs to products
- [Cost Pool](/wiki/cost-pool-allocation/) — A collection of costs to be allocated to cost objects
