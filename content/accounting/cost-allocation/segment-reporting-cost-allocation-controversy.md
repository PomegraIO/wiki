---
title: "Cost Allocation Controversy in Segment Reporting"
description: "How arbitrary overhead allocations distort segment profitability and what IFRS 8 and ASC 280 require."
keywords:
  - segment reporting cost allocation
  - corporate overhead allocation
  - ifrs 8 asc 280 allocation
  - segment profit distortion
...
<div class="wiki-infobox-title">Segment Allocation Controversy — key facts</div>

<img src="/svg/accounting.svg" alt="An abstract editorial mark for the topic." />

<div class="wiki-infobox-caption">Allocation method matters more than actual numbers—different methods can swing segment profit by 15–40% with no fraud involved.</div>
...
| **Audit risk** | High; auditors must validate reasonableness but rarely compel changes unless allocation is demonstrably misleading |
...
1. The basis of organization (by geography, product, or customer).
2. The types of products/services included in each segment.
3. The allocation basis used for corporate expenses.
4. A reconciliation of segment revenue and profit to the consolidated figures.
...
- [Accrual Accounting](/accrual-accounting/) — Matching of costs to periods and activities
- [Revenue Recognition](/revenue-recognition/) — How segment revenue is defined and measured
- [Operating Margin](/operating-margin/) — Segment profit as a percentage of segment revenue

### Wider context

- [Income Statement](/income-statement/) — Consolidated earnings structure and segment profitability
- Financial Statement Analysis — How to read through allocation distortions
- [Earnings Quality](/earnings-quality/) — Whether reported profits reflect economic reality
- [Conglomerate Discount](/conglomerate-discount/) — Why diversified companies often trade at lower valuations
- [Due Diligence](/due-diligence/) — Deep investigation of segment economics in M&A
