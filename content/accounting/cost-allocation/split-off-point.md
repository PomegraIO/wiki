---
title: "Split Off Point"
description: "Stage in joint production where commingled inputs diverge into separately identifiable products; critical for cost allocation decisions."
keywords:
  - split-off point
  - joint products
  - cost allocation
...
| Key Fact | Detail |
|---|---|
| **Definition marker** | Where joint inputs become distinct products |
| **Cost behavior before** | Inseparable; all inputs are joint |
| **Cost behavior after** | Separable; traceable to individual products |
| **Accounting treatment** | Costs after split-off use [activity-based costing](/wiki/activity-based-costing/) or direct assignment |
| **Joint costs before** | [Absorption costing](/wiki/absorption-costing/) with allocation base |
| **Common examples** | Oil refining (crude → gasoline, heating oil, kerosene); dairy (milk → cheese, whey, buttermilk) |
| **Impact on COGS** | Changes allocation method and product profitability analysis |
...
### Closely related
- [Absorption Costing](/wiki/absorption-costing/) — method for assigning joint costs
- [Activity-Based Costing](/wiki/activity-based-costing/) — alternative allocation approach
- [Joint Cost Allocation](/wiki/joint-cost-allocation/) — formal framework for split-off
