...
description: "The statement of changes in equity explains what happened to shareholders' equity during the period — profits earned, dividends paid, share buybacks, and other transactions."
keywords:
...
|   |   |
|---|---|
| **What it is** | Reconciliation of equity from period start to end |
| **Starts with** | Opening equity balance |
| **Adds** | Net income, issuance of shares, other gains |
