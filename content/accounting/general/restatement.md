---
title: "Restatement"
description: "A restatement occurs when a company revises and re-releases prior financial statements because they contained errors or violated accounting standards."
keywords:
  - restatement
  - accounting error
...
This entry covers restatements in general. For how the auditor responds, see [audit-opinion](/audit-opinion/). For the underlying errors, see earnings-management.
...
|   |   |
|---|---|
| **What it is** | Revised prior-period financial statements |
| **Reason** | Error or accounting violation discovered |
| **Scope** | Can affect one or multiple prior periods |
| **Trigger** | Auditor discovery, internal review, regulatory inquiry |
| **Market reaction** | Negative; stock price often falls |
| **Regulatory** | SEC must be notified; 8-K filed |
...
- [Depreciation](/depreciation/) calculated incorrectly
- Revenue recognized in wrong period
- Expense omitted due to oversight
- [Goodwill](/goodwill/) impairment not recognized

Errors can be honest mistakes, especially in complex areas like revenue recognition for long-term contracts or [fair-value](/fair-value/) measurement of Level 3 assets.
...
A software company recognized $100 million of revenue in 2022 on long-term contracts that should have been recognized over three years. The auditor discovered the error in early 2023 before the 2022 [10-K](/10-k/) was filed.
...
**Accounting policy changes** are not restatements. If a company legitimately changes [depreciation](/depreciation/) methods (from [straight-line](/straight-line-depreciation/) to declining-balance) and applies the change prospectively, no restatement is needed.
...
- [Audit-opinion](/audit-opinion/) — may be affected by errors
...
- [10-K](/10-k/) — contains restated financial statements
