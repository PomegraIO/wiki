---
title: "Purchase Price Allocation in Acquisitions"
description: "How acquirers allocate the purchase price in acquisitions to identifiable assets and liabilities at fair value, with the residual becoming goodwill under ASC 805 and IFRS 3."
keywords:
...
*When one company buys another, **purchase price allocation in acquisitions** is the disciplined process of assigning the total deal price to every identifiable asset and liability at fair value, with any shortfall becoming [goodwill](/goodwill/). This allocation is not negotiable—it follows ASC 805 (US GAAP) or IFRS 3 (international), and it shapes the acquirer's balance sheet and future earnings for years.*

<div class="wiki-hatnote">

This article covers the accounting mechanics of purchase price allocation. For the business rationale behind paying more than book value, see [goodwill](/goodwill/). For how acquisitions affect the income statement, see [acquisition](/acquisition/).

</div>

<aside class="wiki-infobox">

<div class="wiki-infobox-title">Purchase Price Allocation — key facts</div>

<img src="/svg/accounting.svg" alt="An abstract editorial mark for the topic." />

<div class="wiki-infobox-caption">The step-by-step fair-value carve-up that underpins acquisition accounting.</div>

|   |   |
|---|---|
| **Definition** | Assignment of total purchase price to identifiable assets, liabilities, and contingencies at fair value; residual = goodwill |
| **Governing standard** | ASC 805 (US), IFRS 3 (international) |
| **Time window** | Must be finalized within 12 months of acquisition close (provisional accounting allowed initially) |
| **Scope** | Applies to business combinations (not asset purchases or mergers with no consideration exchanged) |
| **Fair value source** | Market prices where available; appraisals, DCF, comparable transactions otherwise |
| **Goodwill treatment** | Not amortized; tested annually for [impairment](/goodwill/) |
| **Tax impact** | Section 338(h)(10) elections can trigger step-up; otherwise tax basis may differ from book |
...
If part of the purchase price is contingent—for example, the acquirer will pay a $50 million earnout if the target hits revenue targets in year 2—that earnout is included in the purchase price at its [fair value](/fair-value/). Fair value of an earnout is typically estimated by probability-weighting the possible payout scenarios and discounting to present value. If there is a 60% chance the earnout will be paid in full ($50M) and a 40% chance it will be zero, the fair value is $30 million (0.6 × $50M), and that $30 million is included in the purchase price for PPA purposes.

If the earnout is later revised (because actual results differ from expectations), the adjustment flows through [goodwill](/goodwill/) under US GAAP, not the gain or loss on the acquisition.
...
## The Link to Impairment Testing
...
- [Goodwill](/goodwill/) — why overpayment happens and how it is tested for impairment
- [Acquisition](/acquisition/) — the business combination process and accounting mechanics
- [Business combination purchase](/business-combination-purchase/) — the regulatory framework for merger accounting
- [Intangible assets](/intangible-assets/) — types of non-physical assets and their amortization
...
- [Securities and Exchange Commission](/securities-and-exchange-commission/) — enforces GAAP compliance in acquisition disclosures
- [Generally accepted accounting principles](/generally-accepted-accounting-principles/) — the standard framework for US acquisition accounting
- [International financial reporting standards](/international-financial-reporting-standards/) — IFRS 3 is the non-US equivalent
- [Balance sheet](/balance-sheet/) — the financial statement most affected by PPA
- [Income statement](/income-statement/) — future amortization of intangibles flows through here
