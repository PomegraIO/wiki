...
description: "The allowance for doubtful accounts is a contra-asset that reduces accounts receivable on the balance sheet to reflect amounts expected not to be collected."
keywords:
...
|   |   |
|---|---|
| **What it is** | Reserve for uncollectible receivables |
| **Balance sheet** | Contra-asset (reduces accounts receivable) |
| **Estimated based on** | Historical experience, current conditions, future outlook |
| **Method (new)** | CECL (expected credit loss) |
| **Method (prior)** | Incurred loss |
| **Recorded as** | Bad debt expense on income statement |
