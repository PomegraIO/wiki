---
title: "Cash and Cash Equivalents: What Qualifies"
description: "What qualifies as cash equivalents on a balance sheet: maturity limits, credit quality, and IFRS vs GAAP rules explained."
keywords:
  - cash equivalents definition
  - three month maturity rule
  - balance sheet cash classification
...
<div class="wiki-infobox-title">Cash Equivalents — key facts</div>

<img src="/svg/accounting.svg" alt="An abstract editorial mark for accounting topics." />

<div class="wiki-infobox-caption">The three-month rule and credit quality separate cash equivalents from ordinary short-term investments.</div>

|   |   |
|---|---|
| **Core criterion** | Maturity ≤ 3 months from purchase date |
| **Credit quality** | Minimal default risk; investment-grade or better |
| **Fair value** | Negligible change in value before maturity |
| **Common examples** | T-bills, money market funds, commercial paper (top-tier), repo agreements |
| **Non-examples** | Bond funds, 6-month CDs, preferred stock, equity holdings |
| **Accounting standard** | FASB/IAS with no special treatment (netted with cash, not separate) |
...
- [Balance Sheet](/balance-sheet/) — the statement on which cash equivalents appear as a current asset
- [Money Market Fund](/money-market-fund/) — the most common cash-equivalent investment vehicle
- [Treasury Bill](/treasury-bill/) — the archetypal cash equivalent
- [Net Asset Value](/net-asset-value/) — how money market funds maintain stable value
- [Time Value](/time-value/) — why maturity duration affects fair value risk
- [Cash Flow Statement](/cash-flow-statement/) — how cash equivalents affect operating cash flows

### Wider context

- [Working Capital](/cash-conversion-cycle/) — liquidity planning that relies on cash-equivalent classification
- [Current Assets](/balance-sheet/) — the balance sheet section where cash equivalents sit
- [Accounting Standards](/generally-accepted-accounting-principles/) — FASB/IFRS frameworks that define the rule
- [Credit Rating](/credit-rating/) — the tool used to assess default risk
