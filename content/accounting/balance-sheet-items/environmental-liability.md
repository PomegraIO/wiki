...
description: "Obligation recognized on the balance sheet to remediate pollution or environmental damage caused by a business; includes cleanup costs and regulatory compliance."
keywords:
...
| Key Fact | Detail |
|---|---|
| **Definition** | Obligation to remediate contamination or environmental damage |
| **Recognition trigger** | Probable remediation AND reliably estimable cost |
| **Accounting standard** | ASC 410 (Environmental Obligations) |
| **Common sources** | Landfill operations, chemical manufacturing, petroleum refining, mining |
| **Measurement** | Discounted present value of future remediation costs |
| **Disclosure** | Contingent liabilities if not accrued; risks of unknown contamination |
| **Materiality threshold** | Varies; some environmental costs are immaterial, others exceed market cap |
| **Tax deductibility** | Limited; environmental liabilities are often non-deductible |
