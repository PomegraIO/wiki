...
description: "The FASB is the private, independent board that sets accounting standards in the United States. It develops GAAP and is recognized by the SEC as the official standard-setter."
keywords:
  - FASB
...
|   |   |
|---|---|
| **What it is** | The official US accounting standard-setter |
| **Founded** | 1973 |
| **Governance** | Financial Accounting Foundation Board |
| **Chair** | Elected by the Foundation (serves full-time) |
| **Standard form** | Accounting Standards Codification (ASC) |
| **Update form** | Accounting Standards Updates (ASUs) |
| **Recognized by** | SEC as the official standard-setter |
