---
title: "Goodwill"
description: "Goodwill is the amount paid above the fair value of identifiable assets in a business acquisition. It is tested for impairment annually rather than amortized."
keywords:
  - goodwill
  - acquisition premium
  - intangible asset
...
|   |   |
|---|---|
| **What it is** | Excess purchase price over identifiable assets |
| **Balance sheet** | Intangible asset (non-current) |
| **Arises from** | Business acquisition or combination |
| **Amortization** | No, indefinite useful life |
| **Impairment testing** | Annual (or more if triggered) |
| **Writedown** | Goodwill impairment |
