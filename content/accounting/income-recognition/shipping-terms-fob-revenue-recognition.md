...
keywords:
  ...
  - transfer of control accounting
  - asc 606 shipping terms
...
<div class="wiki-infobox-title">FOB & Revenue Recognition — key facts</div>

<img src="/svg/accounting.svg" alt="An abstract editorial mark for accounting." />

<div class="wiki-infobox-caption">Shipping terms determine the transfer of control and the revenue recognition timing.</div>

|   |   |
|---|---|
| **FOB Origin** | Buyer assumes control at shipment; seller recognizes revenue when goods leave warehouse |
| **FOB Destination** | Seller retains control until delivery; revenue recognized only when buyer receives goods |
| **Key Standard** | [ASC 606](/asc-606/) requires revenue recognition when control of performance obligation transfers |
| **In transit risk** | Under FOB origin, buyer bears transit loss; under FOB destination, seller does |
| **Practical impact** | Can shift revenue into different fiscal periods and affect year-end cutoff accuracy |
...
- [ASC 606](/asc-606/) — The accounting standard that defines when revenue is recognized based on transfer of control
- [Revenue Recognition](/revenue-recognition/) — Principles governing when a company may record a sale
- [Accrual Accounting](/accrual-accounting/) — The method that ties revenue and expense recognition to the economic event, not cash
- [Accounts Receivable](/accounts-receivable/) — Amounts owed by customers, recorded when revenue is recognized

### Wider context

- [Income Statement](/income-statement/) — Financial statement showing revenue, expenses, and profit
- Financial Reporting — Framework and standards for preparing financial statements
- [Cash Flow Statement](/cash-flow-statement/) — Shows timing of cash inflows and outflows, which may differ from revenue recognition timing
