...
description: "An operating lease is a lease where the lessor retains ownership of the asset. Under ASC 842, most operating leases are now recorded on the balance sheet as right-of-use assets."
keywords:
  - operating lease
  - lease accounting
  - ASC 842
...
|   |   |
|---|---|
| **What it is** | Lease where lessor retains ownership |
| **Term** | Short-term (typically less than asset life) |
| **Lessor** | Retains ownership and risk |
| **Lessee** | Right to use, no ownership |
| **Before ASC 842** | Off-balance-sheet (only rent expense) |
| **After ASC 842** | On balance sheet (ROU asset + liability) |
| **Effective** | 2019 (public companies), 2020+ (others) |
