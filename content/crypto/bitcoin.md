---
title: "Bitcoin"
description: "Bitcoin is the first and largest cryptocurrency by market capitalisation, created in 2009. It runs on a decentralised peer-to-peer network secured by proof-of-work mining, with a fixed supply capped at 21 million coins."
keywords:
  - bitcoin
  - cryptocurrency
  - blockchain
...
This entry covers Bitcoin the currency and network. For the broader cryptocurrency ecosystem, see [cryptocurrency](/cryptocurrency-exchange/); for the blockchain technology underlying it, see [blockchain fundamentals](/blockchain-fundamentals/).
...
|   |   |
|---|---|
| **What it is** | A decentralised digital currency |
| **Issued by** | No central authority; created by miners |
...
| **Circulating supply** | ~21 million (as of 2025) |
...
**Pseudonymity, not anonymity.** Bitcoin transactions are published on a public ledger and can be traced if someone knows which address you control. This differs from [Monero](/monero/), which uses cryptographic privacy features to obscure amounts and parties.
...
As of 2025, Bitcoin is the largest cryptocurrency by [market capitalisation](/market-capitalization/), with thousands of independent miners and nodes securing the network globally. The vast majority of Bitcoin trading occurs on [centralised exchanges](/centralized-exchange/), though [peer-to-peer trading](/decentralized-exchange/) is also common.
...
- [Blockchain fundamentals](/blockchain-fundamentals/) — the technology underlying Bitcoin
- [Proof-of-work](/proof-of-work/) — Bitcoin's security mechanism
- [Mining Bitcoin](/mining-bitcoin/) — how new Bitcoins are created
- [Bitcoin halving](/bitcoin-halving/) — the scheduled supply reduction
- [Hash rate](/hash-rate/) — a measure of mining power
- [Cryptocurrency exchange](/cryptocurrency-exchange/) — where Bitcoin trades

### Wider context

- [Distributed ledger](/distributed-ledger/) — the architecture of Bitcoin
- [Public blockchain](/public-blockchain/) — Bitcoin as an open, permissionless network
- Double-spend — the problem Bitcoin solved
- [Monero](/monero/) — an alternative with privacy features
