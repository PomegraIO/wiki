...
description: "A cryptocurrency exchange is a platform where users can buy, sell, and trade cryptocurrencies. Exchanges can be centralised (operated by a company) or decentralised (peer-to-peer with smart contracts)."
keywords:
...
|   |   |
|---|---|
| **What it is** | Platform for buying, selling, trading cryptocurrencies |
| **Types** | Centralised and decentralised |
| **Fee** | 0.1–0.5% per trade (varies) |
| **Liquidity** | Depends on trading volume and pairs offered |
| **Custodian** | CEX: the exchange; DEX: user-custody via wallet |
| **Trading speed** | CEX: fast; DEX: slower (blockchain speed) |
| **Major CEX** | Binance, Coinbase, Kraken, OKX |
| **Major DEX** | Uniswap, Curve, SushiSwap |
