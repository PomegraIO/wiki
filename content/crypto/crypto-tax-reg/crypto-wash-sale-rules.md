---
title: "Crypto Wash Sale Rules"
description: "Whether wash-sale restrictions—which prohibit repurchasing a security within 30 days of a loss—apply to cryptocurrency, an area of unresolved tax treatment."
keywords:
  - cryptocurrency tax
  - wash sale rule
  - tax loss harvesting
...
*The **crypto wash sale rules** question is whether the 30-day repurchase restriction on [wash sales](/wiki/wash-sale/) applies to cryptocurrency. The IRS has not explicitly ruled, creating ambiguity for crypto traders managing tax losses.*

<aside class="wiki-infobox">

| Aspect | Detail |
|--------|--------|
| Traditional rule | Cannot repurchase a loss position within 30 days |
| Applicability to crypto | Unresolved; not explicitly addressed by IRS |
| Risk of non-compliance | Potential disallowance of loss deductions upon audit |
| Practitioner consensus | Tentatively applies to crypto, but uncertain |
| Planning strategy | Avoid repurchasing within 30 days of a realized loss |
| Substantiation | Document all sales and repurchases meticulously |

</aside>

## The wash-sale rule and its original scope

The [wash-sale rule](/wiki/wash-sale-30-day-rule/), codified in IRC Section 1091, prohibits a taxpayer from deducting a loss on a stock or bond if they repurchase the same security within 30 days before or after the sale. The purpose is to prevent "loss harvesting" (realizing a loss for a deduction) while maintaining economic exposure (immediately buying back). If you sell 100 shares of Apple at a \$10,000 loss and buy 100 shares back within 30 days, the loss is disallowed and added to your [cost basis](/wiki/cost-basis/) in the new purchase.
...
IRC Section 1091 specifies "stocks and securities." The statute does not explicitly list [cryptocurrency](/wiki/bitcoin/); it was enacted in 1932, long before digital currencies existed. The question then becomes whether crypto assets are "securities" within the meaning of the tax code. The answer hinges on whether crypto is classified as a capital asset (subject to Section 1091) or property or a commodity (exempt from Section 1091).

The IRS [Notice 2014-21](/wiki/form-1099-misc/) states that cryptocurrency is [property](/wiki/property-tax/) for federal income tax purposes. Property owners can realize gains and losses. But does "property" status mean that Section 1091 applies? The statute refers to "securities," a narrower class. The IRS has not issued guidance explicitly applying or exempting wash-sale rules from crypto.
...
### Closely related
- [Wash Sale](/wiki/wash-sale/) — Core equity wash-sale concept
- [Wash Sale 30-Day Rule](/wiki/wash-sale-30-day-rule/) — Mechanics of the restriction
- [Tax-Loss Harvesting](/wiki/tax-loss-harvesting/) — Strategy dependent on wash-sale treatment
- [Capital Gains Tax](/wiki/capital-gains-tax-investor/) — Taxation of realized losses

### Wider context
- [Cryptocurrency](/wiki/bitcoin/) — Digital assets and their tax treatment
- [Crypto Margin Trading Tax](/wiki/crypto-margin-trading-tax/) — Leverage and tax consequences
- [Crypto Wallet Tax](/wiki/crypto-wallet-tax/) — Holding and transfer taxation
- [Cost Basis](/wiki/cost-basis/) — Tracking accumulated losses and basis
