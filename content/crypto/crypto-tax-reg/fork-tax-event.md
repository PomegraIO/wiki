---
title: "Fork Tax Event"
description: "Tax consequences when a blockchain forks and creates new tokens, triggering potential ordinary income recognition."
keywords:
  - blockchain fork
  - fork tax event
  - bitcoin cash
...
|---|---|
| Trigger | Blockchain fork creating new token that holder receives |
| Tax classification | Ordinary income (most authorities) |
| Timing | Income recognized on fork date, at fair market value of new token |
| Basis | Step-up in basis on recognition date |
| Reporting | May require Form 8949 and Schedule D if held >1 year |
| Major forks | Bitcoin Cash (2017), Bitcoin Gold (2017), Ethereum Classic (split from Ethereum) |
| Exchange treatment | Some exchanges airdrop; others do not; impacts accessibility and recognition |
| Cost basis | New token has cost basis equal to FMV on fork date |
| Controversy | IRS guidance is limited; taxpayers debate classification |
