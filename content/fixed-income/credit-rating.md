---
title: "Credit Rating"
description: "A credit rating is an assessment of a borrower's ability and willingness to repay debt. Ratings agencies assign letter grades from AAA (highest quality) to D (default)."
keywords:
  - credit rating
  - bond rating
  - credit quality
...
|   |   |
|---|---|
| **What it is** | Assessment of debt repayment ability |
| **Scale** | AAA/Aaa (best) to D (default) |
| **Investment-grade** | AAA/Aaa to BBB-/Baa3 |
| **Speculative-grade** | BB+/Ba1 to B-/B3 |
| **Rating agencies** | Moody's, S&P, Fitch (big three) |
| **Rating frequency** | Annual or event-driven |
| **Outlooks** | Positive, negative, stable |
| **Basis** | Financial analysis, market conditions, management |
