...
<div class="wiki-infobox-title">CLO Reset vs Refinancing — key facts</div>

<img src="/svg/fixed-income.svg" alt="An abstract editorial mark for fixed-income markets." />

<div class="wiki-infobox-caption">Reset extends life and reprices the stack; refinancing replaces maturing debt.</div>

|   |   |
|---|---|
| **Reset purpose** | Extend reinvestment period; reactivate manager economics |
| **Reset timing** | Late in the CLO's life, when principal is paying down |
| **Reset scope** | Extends deal maturity 5–10 years; reprices all tranches |
| **Refinancing purpose** | Replace debt coupons due to rate changes or maturity |
| **Refinancing timing** | Any time, but often in early years or refinance windows |
| **Refinancing scope** | Reprices specific tranches; deal life often unchanged |
| **Manager preference** | Resets more valuable (reinvestment period = fees); refinancings neutral |
...
| Aspect | Reset | Refinancing |
|---|---|---|
| **Primary goal** | Extend reinvestment period; reactivate manager fees | Replace maturing debt; adjust coupons |
| **Scope of repricing** | All tranches | Only maturing or specific tranches |
| **Deal maturity change** | Usually extended 5–10 years | Typically unchanged |
| **Reinvestment period change** | Extended or reactivated | Unchanged |
| **Manager economics** | Greatly improved; fees resume in full | Unchanged |
| **Equity impact** | Can be positive (more reinvestment) or dilutive (reset coupons raise cost) | Usually neutral unless rate environment improves |
| **When it happens** | Late deal life, as portfolio pays down | Any time; often driven by interest-rate environment |
| **Investor vote required** | Yes (usually); may require supermajority | Varies; sometimes trustee-level |
...
- [Collateralized loan obligation](/real-estate-investment-trust/) — the vehicle undergoing reset or refinancing
- [Securitization](/securitization/) — the process by which CLOs are created
- Tranche — the debt layers that are repriced in a reset or refinanced
- [Coupon rate](/coupon-rate/) — adjusted in both resets and refinancings to match current rates
- [Interest rate swap](/interest-rate-swap/) — often used by CLO managers to hedge rate risk in a reset or refinancing

### Wider context

- [Floating-rate debt](/corporate-bond/) — typical structure of CLO tranches subject to repricing
- [Asset-backed security](/mortgage-backed-security/) — broader category encompassing CLOs
- [Subordination](/debt-restructuring/) — the waterfall of CLO tranches determines who bears reset risk
- [Credit spread](/credit-spread/) — the premium over SOFR that determines CLO coupon levels
- [Refinancing risk](/refinancing-risk/) — the risk that refinancing becomes expensive or unavailable
