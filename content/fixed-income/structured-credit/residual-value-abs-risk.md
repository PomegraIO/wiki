---
title: "Residual Value Risk in Auto and Equipment ABS"
description: "Residual value risk is the danger that leased assets will be worth less than forecast at lease end, eroding ABS subordination and causing losses."
keywords:
  - residual value risk abs
...
<div class="wiki-infobox-title">Residual Value Risk in ABS — key facts</div>

<img src="/svg/fixed-income.svg" alt="An abstract editorial mark for fixed income." />

<div class="wiki-infobox-caption">When leased equipment declines faster or further than forecast, losses cascade through the ABS structure.</div>

|   |   |
|---|---|
| **Definition** | Gap between guaranteed residual value and actual market value at lease end |
| **Who bears it** | Originator, then junior tranches, then senior tranches if loss is large enough |
| **Separate from** | Credit risk (obligor default on rent or lease payments) |
| **Common triggers** | Commodity price drops, accelerated obsolescence, market saturation, wear and tear |
| **Impact on ABS** | Reduces cash recovery; shortfalls must be absorbed by subordination |
| **Time horizon** | Crystallizes at lease maturity (often 2–8 years after securitization) |
| **Hedging options** | Residual value insurance, lease buyback agreements, loss carve-outs |
...
1. Monthly lease payments (principal and interest)
2. Residual value recovery when leases mature and cars are sold
...
An ABS is structured in [tranches](/tranche/) with different seniority. A typical structure might be:
...
Stress testing is standard: "If residuals fall by 5%, 10%, or 15%, which tranches are affected?" This is a risk metric analogous to [stress testing](/stress-testing/) credit risk, but isolated to the asset-value leg.
...
- [Duration](/duration/) — affects residual value timing and present-value impact
- [Stress Testing](/stress-testing/) — the framework for assessing residual value downside
- [Basis Risk](/basis-risk/) — related concept that forecast assumptions (residual, prepayment) diverge from reality
- [Real Estate Investment Trust](/real-estate-investment-trust/) — an alternative vehicle for equipment and real-asset backing
