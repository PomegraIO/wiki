...
keywords:
  ...
  - waterfall structure
  - clo economics
  - fee alignment equity
---

*A [collateralized loan obligation (CLO)](/mortgage-backed-security/) has two tiers of management fees: **senior fees** paid first regardless of performance, and **subordinated fees** paid only after equity investors hit a return hurdle. This waterfall aligns the manager's upside with equity holders, creating incentive compatibility in credit selection and portfolio management.*

<aside class="wiki-infobox">

<div class="wiki-infobox-title">CLO Manager Fees — key facts</div>

<img src="/svg/fixed-income.svg" alt="An abstract editorial mark for fixed income and bonds." />

<div class="wiki-infobox-caption">Two-tier fees that reward equity outperformance.</div>

|   |   |
|---|---|
| **Senior fee** | 0.30–0.50% of outstanding collateral per annum, always paid |
| **Subordinated fee** | 0.20–0.50% per annum, contingent on equity returns |
| **Typical hurdle (equity IRR)** | 8–10% annual threshold |
| **Paid from** | Senior fees from note interest; subordinated from equity excess cash flow |
| **Manager incentive** | Maximize credit quality to reach equity hurdle and earn subordinated fee |
| **Typical fee split** | 50–70% senior, 30–50% subordinated |
| **Reinvestment phase** | Senior fee may accrue and roll forward; subordinated fee often deferred until paydown phase |

</aside>

## How the Fee Waterfall Works

A CLO issues multiple [tranches](/tranche/) of [notes](/treasury-bond/): senior AAA-rated notes, mezzanine BB or B-rated notes, and an equity tranche. The CLO manager invests the proceeds in a diversified portfolio of corporate [loans](/loan-origination-fees/). As loans pay [interest](/interest-rate/), the collateral generates cash flow.

The waterfall dictates the order of payment. Senior note holders receive their [coupon](/coupon-payment/) first. Next, the manager extracts the **senior management fee**, typically 0.30–0.50% of the outstanding loan balance per year. This fee is nearly guaranteed because it comes off the top of collateral cash flow; it is paid as long as the CLO is solvent.
...
Senior fees are relatively certain because they rank before equity and even before subordinated note payments. In the [reinvestment phase](/mortgage-backed-security/) (typically the first 5–7 years), senior fees are generally paid in full; the collateral yield is designed to support all senior obligations comfortably.

Subordinated fees are more volatile. During reinvestment, subordinated fees may accrue and be deferred—not paid, but recorded as a deferred fee obligation. If the CLO remains healthy, the deferred fees are paid during the [paydown phase](/mortgage-backed-security/) (years 8–12 or later), once initial [maturity](/expiration-date/) calls begin and collateral shrinks.
...
Some managers negotiate an **equity kicker**: a percentage ownership in equity returns above a hurdle. A manager might own 10% of all excess equity cash flow above a 12% IRR hurdle. This ties manager economics more tightly to equity upside and is common in [private equity funds](/private-equity-fund/).
...
- [Collateralized loan obligation](/mortgage-backed-security/) — the overall structure, collateral composition, and tranche waterfall
- [Tranche](/tranche/) — how CLOs partition risk and return into senior, mezzanine, and equity slices
- [Coupon payment](/coupon-payment/) — fixed periodic interest paid to bondholders
- [IRR and return on invested capital](/return-on-invested-capital/) — measuring the rate of return on equity stakes
- Waterfall (finance) — the order and priority in which cash is distributed

### Wider context

- [Structured product](/structured-product/) — securities designed with custom payoff profiles
- [Asset-backed security](/mortgage-backed-security/) — bonds secured by underlying loan collateral
- [Credit risk](/credit-risk/) — the risk that borrowers default on obligations
