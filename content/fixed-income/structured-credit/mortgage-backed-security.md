...
description: "A mortgage-backed security is a debt security collateralized by a pool of residential mortgages. Investors receive cash flows from mortgage payments, reducing credit risk through diversification."
keywords:
...
|   |   |
|---|---|
| **What it is** | Debt collateralized by residential mortgages |
| **Collateral** | Pool of 1,000–10,000+ individual mortgages |
| **Cash flows** | Principal and interest from homeowner payments |
| **Prepayment risk** | Refinancing when rates fall |
| **Duration** | 3–10 years (uncertain due to prepayment) |
| **Credit risk** | Home price and unemployment risk |
| **Typical yield** | Treasury yield + 50–150 basis points |
| **Issued by** | Banks, mortgage originators, government agencies |
| **Market size** | Over $10 trillion outstanding |
