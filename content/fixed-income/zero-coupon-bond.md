...
description: "A zero-coupon bond is a debt security that makes no periodic interest payments and instead is sold at a deep discount to its face value, with the entire return realized at maturity."
keywords:
  - zero-coupon bond
  - zero bond
  - discount bond
...
|   |   |
|---|---|
| **What it is** | Bond with no periodic coupon payments |
| **How sold** | At substantial discount to face value |
| **Return source** | The difference between purchase price and face value |
| **Tax treatment** | Federal tax owed on accrued interest annually |
| **Maturity** | Typically 5–30 years |
| **Price volatility** | Extremely high (longest duration) |
| **Suitable for** | Long-term investors, tax-deferred accounts |
| **Typical issuers** | Treasury (STRIPS), corporations, investment funds |
