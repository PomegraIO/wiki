---
title: "Consequences of a Bond Being Downgraded to Junk"
description: "When a bond loses investment-grade status, forced selling cascades through the market—fund mandates shift, indices exclude it, and liquidity evaporates."
keywords:
  - bond downgrade to junk
  - investment grade to junk downgrade consequences
  - forced selling cascade bonds
  - credit rating downgrade effects
  - high-yield bond market impact
...
<div class="wiki-infobox-title">Downgrade to Junk — key facts</div>

<img src="/svg/fixed-income.svg" alt="An abstract editorial mark for fixed-income securities." />

<div class="wiki-infobox-caption">The fall from investment-grade means expulsion from indices and mandates, creating a forced-seller panic.</div>

|   |   |
|---|---|
| **Grade threshold** | BBB- is lowest investment-grade; BB+ is highest junk |
| **Index inclusion** | Triggers immediate removal from IG indices like Bloomberg Aggregate |
| **Selling timeline** | Most forced selling occurs within 1–4 weeks post-downgrade |
| **Price impact** | Yields typically widen 200–500+ basis points instantly |
| **Liquidity drain** | Bid-ask spreads widen; trading volume evaporates |
| **Issuer cost** | Refinancing becomes difficult and expensive for months |
...
- [Credit Rating](/credit-rating/) — How ratings are assigned and what each grade means
- [Junk Bond](/junk-bond/) — High-yield debt and its trade-offs
- [Investment-Grade Bond](/investment-grade-bond/) — Bonds above the downgrade threshold
- [Credit Spread](/credit-spread/) — The yield premium demanded for credit risk
- [Interest Coverage Ratio](/interest-coverage-ratio/) — Key metric for downgrade risk
- [Debt-to-EBITDA Ratio](/debt-to-ebitda-ratio/) — Leverage metric influencing ratings

### Wider context

- [Bond](/bond/) — Core fixed-income security
- [Bond ETF](/bond-etf/) — Passive index tracking and forced selling
- [Cost of Debt](/cost-of-debt/) — Issuer's borrowing cost post-downgrade
- [Refinancing Risk](/refinancing-risk/) — Rolling debt at adverse rates
- [Default Rate](/default-rate/) — Probability of non-payment after downgrade
