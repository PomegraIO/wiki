---
title: "How a Credit Rating Downgrade Affects Bond Prices"
description: "How a credit rating downgrade affects bond prices: the mechanics of yield rise, market price decline, and what happens to existing bondholders."
keywords:
  - credit rating downgrade
  - bond price impact
  - how does downgrade affect bond
...
<div class="wiki-infobox-title">Credit Rating Downgrade & Bond Price — key facts</div>

<img src="/svg/fixed-income.svg" alt="An abstract editorial mark for fixed income bonds." />

<div class="wiki-infobox-caption">A downgrade raises required yield; prices and yields move inversely.</div>

|   |   |
|---|---|
| **Core mechanism** | Investors demand higher yield → lower price to achieve it |
| **Price direction** | Falls (inverse relationship with yield) |
| **Coupon payment** | Unchanged (locked at issuance) |
| **Duration effect** | Longer-maturity bonds fall harder in price |
| **Speed of impact** | Often immediate or within hours of downgrade announcement |
| **Who loses** | Existing bondholders; new buyers get higher yield |
...
- [Credit rating](/credit-rating/) — the agency assessment that triggers downgrades
- [High-yield bond](/high-yield-bond/) — the riskier category where downgrades concentrate losses
- [Credit spread](/credit-spread/) — the premium over risk-free rate that widens on downgrade
- [Duration](/duration/) — the metric determining price sensitivity to yield moves
- [Yield to maturity](/yield-to-maturity/) — the return an investor requires on a bond
- [Credit default swap](/credit-default-swap/) — derivatives that spike in price after downgrades
- [Bond](/bond/) — the fundamental fixed-income instrument affected by rating cuts

### Wider context

- [Interest rate risk](/interest-rate-risk/) — the broader principle behind bond price volatility
- [Counterparty risk](/counterparty-risk/) — the default risk that downgrades reflect
- [Corporate bond](/corporate-bond/) — the issuer type most subject to rating cuts
- [Market pricing](/price-discovery/) — how secondary markets absorb downgrade news
