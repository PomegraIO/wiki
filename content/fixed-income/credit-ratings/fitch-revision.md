---
title: "Fitch Revision"
description: "An adjustment to a Fitch Ratings outlook or credit rating that signals the rating agency's changing view of an issuer's credit risk."
keywords:
...
| Metric | Detail |
|---|---|
| **Scale** | AAA (highest) to D (default) |
| **Outlook categories** | Positive, Stable, Negative, Evolving |
...
Fitch's [credit rating](/wiki/credit-rating/) methodology starts with **quantitative analysis**: examining [leverage ratios](/wiki/debt-to-equity-ratio/), [interest coverage](/wiki/interest-coverage-ratio/), [cash flow](/wiki/cash-flow-statement/) trends, and [refinancing](/wiki/refinancing-risk/) schedules. A [company](/wiki/public-company/) with [debt-to-EBITDA](/wiki/debt-to-ebitda-ratio/) of 3.0x and interest coverage of 5.0x might be investment-grade; one with 8.0x leverage and 1.2x coverage is speculative (junk).
...
## [Rating](/wiki/credit-rating/) categories and risk
...
**Systemic importance**: Because [bank](/wiki/bank-reserve-injection/) [capital](/wiki/capital-adequacy/) rules reference ratings (e.g., a [bank](/wiki/bank-reserve-injection/) holding AA-rated [bonds](/wiki/bond/) faces lower [capital requirements](/wiki/capital-adequacy/) than BB-rated), a [rating](/wiki/credit-rating/) downgrade of a major issuer can force [banks](/wiki/bank-reserve-injection/) to raise [capital](/wiki/capital-adequacy/) rapidly, amplifying [systemic risk](/wiki/systemic-risk/).
...
## Impact on [bond](/wiki/bond/) pricing

A Fitch [rating](/wiki/credit-rating/) revision has immediate consequences. Research shows:

- A downgrade within investment-grade typically moves [spreads](/wiki/credit-spread/) 20–60 bps wider.
- A downgrade to speculative-grade moves [spreads](/wiki/credit-spread/) 100–300+ bps wider.
- An upgrade typically has muted (though positive) impact, suggesting that [rating cuts](/wiki/credit-rating/) are priced in faster than [upgrades](/wiki/rating-migration/).

[Traders](/wiki/trading-halts/) and [portfolio managers](/wiki/asset-allocation/) monitor Fitch's [rating watch lists](/wiki/rating-watch/) to anticipate revisions and position ahead of announcements. A company placed on [negative rating watch](/wiki/rating-watch/) by Fitch can expect a [bond](/wiki/bond/) [sell-off](/wiki/liquidation/) even before the downgrade is confirmed.

<div class="wiki-seealso">

### Closely related
- [Credit Rating](/wiki/credit-rating/) — The core rating Fitch assigns; revisions change the rating
- [Rating Outlook](/wiki/rating-outlook/) — The forward-looking indicator Fitch uses before a rating revision
- [Credit Spread](/wiki/credit-spread/) — The yield premium that widens when Fitch downgrades

### Wider context
- [Fitch Ratings](/wiki/fitch-ratings/) — The agency that publishes revisions
- [Bond Rating Downgrade](/wiki/bond-rating-downgrade/) — The mechanics of when and how bonds are downgraded
- [Systemic Risk](/wiki/systemic-risk/) — How coordinated rating downgrades can amplify financial crises
