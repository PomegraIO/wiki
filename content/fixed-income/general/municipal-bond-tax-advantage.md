...
description: "Federal income tax exemption on interest from bonds issued by states, cities, and local authorities; a subsidy that benefits higher-income investors most."
keywords:
  - municipal bonds
  - tax-exempt bonds
...
*Interest income from a [municipal bond](/wiki/municipal-bond/) issued by a state or local authority is typically exempt from **federal income tax**—and often from state and local income tax if you live in the issuing state. This tax break makes municipal bonds attractive to high-income investors, even at lower nominal yields.*

<aside class="wiki-infobox">

| Aspect | Detail |
|--------|--------|
| **Exemption scope** | Federal income tax; often state and local too |
| **Issuer types** | States, cities, counties, public authorities |
| **Bond types** | General obligations, revenue bonds |
| **Tax bracket threshold** | Attractive above 32% marginal federal rate |
| **After-tax yield premium** | Grows with investor's marginal tax rate |
| **Tradeoffs** | Lower nominal yield vs. taxable bonds |
| **Market size** | ~$4 trillion U.S. municipal market |
...
Default risk is another tradeoff. Historically, municipal bond default rates are low—much lower than corporate bonds, thanks to the essential services municipalities provide (water, power, police). But [credit quality](/wiki/credit-rating/) varies widely. A muni issued by a fiscally healthy state is safer than one from a distressed city with pension liabilities.
...
1. Wealthy investors still have higher marginal rates (federal + SALT) than the statutory rate.
2. Demand from institutions (insurance, endowments, high-wealth families) is steady.
3. Supply of new bonds has been constrained by low issuance.
...
[Municipal bond rating agencies](/wiki/muni-bond-rating-methodology/) (S&P, Moody's, Fitch) rate the credit quality of bonds. A general obligation (GO) bond backed by the full taxing power of a state is usually high-grade. A revenue bond backed only by a specific project (toll road, water system) is riskier.
...
### Closely related
- [Municipal Bond](/wiki/municipal-bond/) — The bonds themselves, issued by states and localities.
- [Tax-Exempt Bond](/wiki/tax-exempt-bond/) — General treatment of tax exemption.
- [Municipal Bond Insurance](/wiki/municipal-bond-insurance/) — Credit enhancement for munis.
- [Revenue Bond](/wiki/revenue-bond/) — Bonds repaid from project revenue, not general taxes.
- [General Obligation Bond](/wiki/general-obligation-bond/) — Bonds backed by full taxing authority.
