---
title: "Revenue Bond"
description: "A revenue bond is a municipal bond backed exclusively by the revenue from a specific project or utility. The issuing government's taxing power is not pledged as security."
keywords:
  - revenue bond
  - project revenue
  - municipal debt
...
For municipal bonds backed by taxing power, see [general obligation bond](/general-obligation-bond). For the broader category, see [municipal bond](/municipal-bond). For corporate debt with project-based financing, see [corporate bond](/corporate-bond).
...
|   |   |
|---|---|
| **What it is** | Project-revenue-backed municipal bond |
| **Security** | Revenue from specific project only |
| **Tax pledge** | No taxing power backing |
| **Default risk** | Higher than [GO bonds](/general-obligation-bond) |
| **Typical projects** | Utilities, toll roads, airports, parking, stadiums |
| **Maturity** | 5–30 years |
| **Coupon** | Semi-annual fixed interest |
| **Yields** | 50–150 bps higher than GO bonds |
| **Tax exemption** | Federal income tax exempt; usually state/local exempt |
...
This project-specific risk is why revenue bonds trade at higher yields than [general obligation bonds](/general-obligation-bond) from the same issuer. A city's water-revenue bonds might yield 4.5% while its GO bonds yield 3%, compensating investors for the greater risk.
...
These covenants are more restrictive than typical [corporate bond](/corporate-bond) indentures because the security base is narrower. Investors rely on contractual protections to a greater degree than they do with [general obligation bonds](/general-obligation-bond).
...
Private investors, pension funds, and insurers are major holders of revenue bonds. Unlike [general obligation bonds](/general-obligation-bond), which retail investors often hold individually, revenue bonds tend to be held through [mutual funds](/mutual-fund) and [ETFs](/etf) because individual investors lack expertise to evaluate project risk.
...
This level of diligence is often beyond retail investors' capability, making [index funds](/index-fund) or professionally managed [mutual funds](/mutual-fund) more appropriate for many.

## Comparison to general obligation bonds

A [general obligation bond](/general-obligation-bond) from the same city is senior to its revenue bonds — if the city faces financial stress, GO bondholders are paid before revenue bondholders. This structural subordination is why revenue bonds yield more.

However, a [general obligation bond](/general-obligation-bond) from a financially distressed city might carry more risk than a revenue bond from a well-run, profitable utility — credit quality depends on specific circumstances, not just bond type.
...
- [General obligation bond](/general-obligation-bond) — taxing-power-backed municipal debt
- [Municipal bond](/municipal-bond) — the broader category
- [Corporate bond](/corporate-bond) — similar structure but taxable
- [Credit rating](/credit-rating) — assesses revenue bond creditworthiness
- [Yield to maturity](/yield-to-maturity) — the return compensating for risk

### Wider context

- [Bond](/bond) — debt securities generally
- [Credit spread](/credit-spread) — why revenue bonds yield more than GO bonds
- [Diversification](/diversification) — why many revenue bonds in portfolio reduces risk
- [Recession](/recession) — stress tests project revenues
