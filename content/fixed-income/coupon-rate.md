---
title: "Coupon Rate"
description: "The coupon rate is the annual interest rate that a bond issuer promises to pay to bondholders, expressed as a percentage of the bond's face value."
keywords:
  - coupon rate
  - coupon payment
  - bond interest
...
|   |   |
|---|---|
| **What it is** | Fixed annual interest rate on a bond |
| **Expression** | Percentage of face value |
| **Payment frequency** | Semi-annual (most common) or annual |
| **Fixed** | Yes; does not change over bond's life |
| **Example** | 5% coupon on $1,000 = $50 annual payment |
| **Determined** | At issuance; reflects prevailing interest rates |
| **Coupon vs. price** | Fixed coupon; market price varies inversely with rates |
| **Zero-coupon bonds** | No periodic coupon; discount to par |
...
Most bonds pay coupons semi-annually. A 5% annual coupon becomes two semi-annual payments of 2.5% of face value ($25 per $1,000 face value). The dates are fixed (e.g., January 15 and July 15 each year).

## Coupon vs. yield: the distinction
...
## Coupon vs. current yield vs. yield to maturity
...
Some bonds have floating-rate coupons that adjust periodically (typically quarterly) based on a reference rate (LIBOR, Treasury rates, etc.) plus a fixed spread.

A floating-rate bond might have a coupon of "3-month LIBOR + 200 basis points." If 3-month LIBOR is 2%, the coupon is 4%. If LIBOR rises to 3%, the coupon becomes 5%.

Floating-rate bonds provide protection against rising rates (the coupon rises as rates rise) but limited upside if rates fall. They are attractive for investors expecting rate increases.
