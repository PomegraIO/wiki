...
description: "TIPS are Treasury securities whose principal is adjusted for inflation based on the Consumer Price Index. They protect investors against erosion of purchasing power from unexpected inflation."
keywords:
  - TIPS
...
|   |   |
|---|---|
| **What it is** | Inflation-adjusted Treasury security |
| **Maturities** | 5, 10, and 20 years |
| **Principal adjustment** | Based on Consumer Price Index monthly |
| **Coupon type** | Fixed real yield (not nominal) |
| **Price reflects** | Real interest rates + inflation expectations |
| **Minimum investment** | $100 |
| **Tax treatment** | Phantom income on principal adjustments |
| **Typical holder** | Inflation-hedging investors, pension funds |

</aside>

## How TIPS work: principal adjustment and real yields
...
## Investment uses and limitations
