---
title: "Savings Bond"
description: "Savings bonds are non-negotiable Treasury-issued securities designed for individual savers. They accrue value at a guaranteed rate, cannot be traded, and are held in registered form to ensure ownership."
keywords:
  - savings bond
  - treasury savings
...
|   |   |
|---|---|
| **What it is** | Non-negotiable government savings security |
| **Issued by** | U.S. Department of the Treasury |
| **Series** | EE-Bonds and I-Bonds (modern form) |
| **Key features** | Fixed maturity, formula-based accrual, non-transferable |
| **Redemption** | Only through U.S. Treasury; cannot be traded |
| **Holding period** | 30 years (full maturity); penalties for early redemption |
| **Tax treatment** | Federal tax deferred; exempt from state/local tax |
| **Purchase method** | TreasuryDirect or banks (electronic) |
| **Typical holder** | Individual savers, educators, parents |
