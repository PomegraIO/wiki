...
description: "Short-term securities backed by pools of receivables or other assets, offering higher yields than unsecured paper."
keywords:
...
*An **asset-backed commercial paper** (ABCP) is a short-term security, typically 9 to 270 days, backed by a pool of financial assets—accounts receivable, auto loans, credit card receivables, or trade financing. By collateralizing unsecured [commercial paper](/wiki/commercial-paper/) with actual receivables, issuers reduce their borrowing costs below unsecured rates.*

<aside class="wiki-infobox">

| Characteristic | Detail |
|---|---|
| Maturity | 9 to 270 days (money market instrument) |
| Backing | Pool of receivables or other assets |
| Issuer | Banks, financial institutions, special-purpose entities |
| Yield | Higher than unsecured CP; lower than long-term bonds |
| Rating | Typically A-1/P-1 or equivalent |
| Liquidity | Secondary market active but narrower than Treasuries |
| Credit enhancement | Overcollateralization, reserve accounts, guarantees |
| Regulatory oversight | Treated as commercial paper under SEC Rule 2a-7 |

</aside>

## The basic structure

ABCP exists at the intersection of [commercial paper](/wiki/commercial-paper/) markets and [securitization](/wiki/securitization/). A bank, equipment leaser, or credit card company originates a pool of receivables—the contract to pay money owed. Rather than hold these receivables on its books or finance them with long-term bonds, the originator transfers them to a special-purpose entity (SPE), which immediately issues short-term paper backed by those assets.
...
**Mortgage loans** can back ABCP, though [mortgage-backed securities](/wiki/mortgage-backed-security/) are more common for longer-term instruments. The short maturity of ABCP makes it less suited to 30-year mortgages unless there is active servicing and early amortization.
...
### Closely related
- [Commercial Paper](/wiki/commercial-paper/) — short-term unsecured debt for which ABCP is the asset-backed variant
- [Securitization](/wiki/securitization/) — the general practice of bundling assets and issuing claims backed by them
- [Asset-Backed Security](/wiki/asset-backed-security/) — longer-term version of the same securitization idea
- [Credit Enhancement](/wiki/credit-enhancement/) — techniques (overcollateralization, guarantees) that protect investors
