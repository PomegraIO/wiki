---
title: "Master Note Facility"
description: "Flexible short-term borrowing arrangement with variable coupons, often used by corporations to manage cash flow."
keywords:
...
Because rates reset frequently, the lender faces minimal [interest rate risk](/wiki/interest-rate-risk/). The borrower gets certainty of access and flexibility: it can draw in tranches, let notes mature, or roll them continuously.
...
**Relationship banking**: Master note facilities are often part of broader banking relationships. A company might have a $200 million term loan, a $100 million revolving [credit facility](/wiki/credit-rating/), and a $200 million master note facility with a core group of banks. These relationships provide stability and a single point of contact for refinancing negotiations.

## Coupon mechanics and rate resets

Most master notes reset coupons based on [SOFR](/wiki/sofr/) (the primary reference rate since LIBOR's departure in 2021). The coupon is **SOFR + spread**, where the spread is negotiated when the facility is first arranged and is fixed for the term.
...
- **Financial institutions**: Major banks use master note facilities with each other and with central banks for [repo](/wiki/repurchase-agreement/) funding and short-term liquidity management.
- **US Treasury**: The Treasury uses master note facilities to manage regular cash borrowing within its [debt ceiling](/wiki/debt-ceiling/) authority, issuing bills and notes continuously.
...
**Market dislocation**: During credit crises (2008, COVID-19), even strong companies face funding challenges. The Federal Reserve's establishment of [commercial paper funding facilities](/wiki/federal-reserve/) during COVID reflected the reality that master note facilities and CP markets can seize up, requiring emergency central bank intervention.

**Leverage tracking**: Money drawn on a master note facility counts toward [debt-to-equity](/wiki/debt-to-equity-ratio/) ratios and other leverage metrics used by [credit rating agencies](/wiki/credit-rating/). High utilization can signal stress and invite ratings scrutiny.

<div class="wiki-seealso">

### Closely related

- [Commercial paper](/wiki/commercial-paper/) — Similar short-term debt, but unsecured and market-issued.
- [Floating-rate bond](/wiki/floating-rate-bond/) — Similar coupon resets; but typically longer-dated.
- [Repurchase agreement](/wiki/repurchase-agreement/) — Secured short-term funding alternative.

### Wider context

- [Short-term debt](/wiki/bond-maturity-corporate/) — Broader category including master notes.
- [SOFR](/wiki/sofr/) — Primary reference rate for modern master note coupons.
- [Credit facility](/wiki/credit-rating/) — Broader term for committed lending arrangements.
