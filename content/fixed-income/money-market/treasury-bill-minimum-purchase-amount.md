...
keywords:
  ...
  - TreasuryDirect minimum
  - how much money to buy treasury bills
  - treasury bill purchase requirements
---
...
<div class="wiki-infobox-title">Treasury Bill Minimums — key facts</div>

<img src="/svg/fixed-income.svg" alt="An abstract editorial mark for the topic." />

<div class="wiki-infobox-caption">Small amounts, big safety.</div>

|   |   |
|---|---|
| **TreasuryDirect minimum** | $100 in face value |
| **Secondary market brokers** | Often $1,000 to $5,000 (varies by firm) |
| **Online discount brokers** | Many have no stated minimum or $0 |
| **Banks and advisors** | May require $5,000 or more |
| **Face value tiers** | $100, $1,000, $5,000, $10,000+ (at TreasuryDirect) |
| **Price paid vs face value** | Always less; discount reflects the yield |

</aside>

## The $100 TreasuryDirect minimum

TreasuryDirect, the U.S. Treasury's direct purchase platform, allows you to buy [Treasury bills](/treasury-bill/) in $100 increments in face value. This means you can purchase exactly $100, $200, $300, and so on—no rounding required. For individual savers and small investors, this low threshold is the most accessible entry point to [Treasury securities](/treasury-bond/).
...
Here's how it works. Suppose a 13-week [Treasury bill](/treasury-bill/) with $100 face value is yielding 5% per annum. The discount on that bill is the interest you would earn over 13 weeks. Since 13 weeks is one-quarter of a year, the discount is roughly:
...
**Money market funds.** If you want exposure to T-bills without committing to a specific minimum, you can buy shares of a [money market fund](/money-market-fund/) that invests in Treasury bills. Fund minimums vary widely but are often $1,000 to $3,000 per account.
...
This introduces reinvestment and [interest-rate risk](/interest-rate-risk/) if you don't hold to maturity. For risk-averse savers, holding to maturity is common, so the $100 minimum and discount structure simply mean: invest $99-ish today, get $100 in a few months, with no risk of price loss.
...
- [Treasury Bill](/treasury-bill/) — short-term U.S. government securities and how they work
- [Money Market Fund](/money-market-fund/) — funds investing in Treasury bills and other short-term instruments
- [Discount Rate](/discount-rate/) — how present value is calculated for future payments
- [Yield to Maturity](/yield-to-maturity/) — total return from holding a bond to maturity
- [Short-term Debt](/treasury-bill/) — ultra-safe lending to the U.S. government
- [Interest Rate Risk](/interest-rate-risk/) — price losses if you sell before maturity

### Wider context

- [Fixed-Income](/bond/) — the broader category of debt securities
- [Treasury Bond](/treasury-bond/) — longer-term Treasury securities
- [Coupon Payment](/coupon-payment/) — how most bonds pay interest (T-bills do not)
- [Primary Market](/primary-market/) — where new securities are first issued and auctioned
