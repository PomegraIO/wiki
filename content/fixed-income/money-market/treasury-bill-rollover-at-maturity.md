...
keywords:
  ...
  - t-bill maturity reinvestment
  - treasurydirect roll process
  - t-bill automatic renewal
image: "/svg/fixed-income.svg"
---

*When a [Treasury bill](/treasury-bill/) reaches its maturity date, the U.S. government repays your principal with interest. Rolling over means reinvesting that money into a new T-bill instead of letting the cash sit idle. At [TreasuryDirect](/treasury-bill/), automatic reinvestment is built-in and requires a single choice at purchase; at a brokerage, you manage the rollover actively or set standing instructions with your broker.*

<aside class="wiki-infobox">

<div class="wiki-infobox-title">T-bill Rollover — key facts</div>

<img src="/svg/fixed-income.svg" alt="An abstract editorial mark for the topic." />

<div class="wiki-infobox-caption">Two paths: automatic reinvestment at TreasuryDirect, active choice at a brokerage.</div>

|   |   |
|---|---|
| **TreasuryDirect automatic roll** | Reinvests into same term (4-week, 13-week, 26-week); no action required; must be set at purchase |
| **TreasuryDirect maturity payout** | Principal + interest paid to linked bank account; reinvestment stops |
| **Brokerage rollover** | Sell at maturity, buy new T-bill; or place standing instruction with broker |
| **Timing** | Funds arrive 1 business day after T-bill settles (typically next day) |
| **Rate risk** | Rolling into new T-bill exposes you to current market rates, which may be higher or lower |
| **Tax treatment** | Interest is federally taxable in the year received; state/local tax-exempt |

</aside>

## What Happens at T-Bill Maturity

When you own a [Treasury bill](/treasury-bill/)—typically a 4-week, 13-week, or 26-week instrument—the U.S. Treasury repays you the bill's face value (par) plus the discount you bought it at, which is your accrued interest.
...
[TreasuryDirect](/treasury-bill/) is the Treasury's direct-to-investor platform. When you purchase a T-bill there, you are offered two choices: have your money reinvested automatically at maturity, or receive a payout.
...
1. Treasury payment is processed; your principal + interest is credited.
2. At TreasuryDirect, if you chose automatic reinvestment, the system immediately subscribes to the next available T-bill of the same term.
3. The new T-bill settles typically the next business day (or the Monday after if maturity falls on a Friday).
4. Your new T-bill is issued and begins accruing interest toward the next maturity date.

There is typically no gap—you move from one T-bill to the next seamlessly if you choose automatic reinvestment. If you are managing the rollover manually at a brokerage, you might have a brief window (a day or two) where the cash is not earning T-bill returns; it sits in your sweep account at whatever rate your brokerage offers (typically near [fed funds](/federal-funds-rate/) but sometimes lower).
...
If rates are expected to fall and you want to lock in a higher yield, you might buy a longer-term [Treasury note](/treasury-bond/) or bond instead of rolling a T-bill into another short-term bill. Or if you need the cash for spending, you simply choose maturity payment and let the proceeds stay in your account.
...
- [Treasury Bill](/treasury-bill/) — the short-term security being rolled
- [Money Market Fund](/money-market-fund/) — an alternative vehicle for very short-term investing
- [Interest Rate Risk](/interest-rate-risk/) — how reinvestment rates affect your returns
- [Settlement](/treasury-bill/) — how T-bill transactions clear and fund moves
- [Yield to Maturity](/yield-to-maturity/) — the return you lock in when you buy a T-bill

### Wider context

- [Federal Funds Rate](/federal-funds-rate/) — influences short-term Treasury yields and rollover rates
- [Cash Conversion Cycle](/cash-conversion-cycle/) — business treasury management that mirrors this discipline
- [TreasuryDirect](/treasury-bill/) — the government's direct T-bill platform
- [Liquidity](/treasury-bill/) — why T-bills are popular for funds needing quick access to cash
