---
title: "Term Funding Facility"
description: "A central bank lending program that provides credit to banks and financial institutions at terms longer than overnight, typically weeks to months."
keywords:
  - term funding
...
*A **term funding facility** (TFF) is a [central bank](/wiki/central-bank/) lending program that extends credit to banks for maturities longer than the overnight [federal funds rate](/wiki/federal-funds-rate/). Rather than banks borrowing overnight and rolling the loan daily, the TFF allows them to lock in a fixed rate for days, weeks, or months, reducing rollover risk during stress periods.*

<aside class="wiki-infobox">

| Key fact | Detail |
|---|---|
| **Typical maturity** | 7 days to 12 months; varies by program design |
| **Collateral** | Eligible securities (Treasury, agency, investment-grade corporates) |
| **Rate** | Fed sets a fixed rate or administered rate; usually near or above the overnight rate |
| **Borrowers** | Commercial banks, credit unions, eligible financial institutions |
| **Purpose** | Reduce [liquidity risk](/wiki/liquidity-risk/), stabilize term funding markets |
| **Examples** | Fed's Primary Dealer Credit Facility (PDCF), Term Auction Facility (TAF) |
...
When the Fed operates a term funding facility, it is effectively injecting [base money](/wiki/base-money-creation/) into the financial system. Banks borrow from the Fed and use the proceeds to buy Treasury bills, extend credit, or pay off maturing debt. This liquidity injection ripples through [monetary-policy-transmission](/wiki/monetary-policy-transmission/). More liquidity in the banking system → lower short-term rates → lower long-term rates → lower borrowing costs for businesses and consumers.
...
Operating a term funding facility costs money. The Fed takes on [credit-risk](/wiki/credit-risk/) (some borrowers might default) and [interest-rate-risk](/wiki/interest-rate-risk/) (if rates rise sharply, the fixed-rate loans lose value). Most term facilities are profitable, but they carry tail risk.
...
Term funding facilities are distinct from [open-market-operations](/wiki/open-market-operations/) (OMOs), where the Fed buys and sells securities directly. An OMO is the primary tool for setting the overall level of [base money](/wiki/base-money-creation/). A term funding facility is a secondary tool for targeting specific points on the [yield curve](/wiki/yield-curve/) or signaling commitment to abundant liquidity.

<div class="wiki-seealso">

### Closely related
- [Discount window](/wiki/discount-window/) — The standing central bank lending facility
- [Central bank](/wiki/central-bank/) — The institution providing term funding
- [Quantitative easing](/wiki/quantitative-easing/) — Large-scale asset purchases (a complementary tool)
- [Monetary policy tools](/wiki/monetary-policy-tools/) — The broader toolkit

### Wider context
- [Liquidity risk](/wiki/liquidity-risk/) — The risk term funding mitigates
- [Overnight indexed swap](/wiki/overnight-indexed-swap/) — Pricing reference for term rates
- [Repo](/wiki/repurchase-agreement/) — Private term funding market (parallel to central bank TFFs)
- [Monetary transmission](/wiki/monetary-transmission-mechanism/) — How term funding ripples through the economy
