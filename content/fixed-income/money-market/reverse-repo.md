...
description: "A reverse repurchase agreement is the opposite side of a repo transaction, in which a party purchases securities with an agreement to sell them back at a higher price."
keywords:
  - reverse repo
...
|   |   |
|---|---|
| **What it is** | Collateralized cash lending |
| **Typical maturity** | Overnight to 3 months |
| **Collateral** | Securities (Treasuries, bonds, etc.) |
| **Cash return mechanism** | Repurchase price > purchase price |
