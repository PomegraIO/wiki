...
keywords:
  ...
  - federal funds rate transmission
  - overnight repo rate
  - money market rates
image: /svg/fixed-income.svg
---

*The **Fed funds rate** is the interest rate at which banks lend reserve balances to each other overnight. When the Federal Reserve changes this target rate, it creates a ripple effect through money market yields—the returns on [money-market-fund](/money-market-fund/), [Treasury bills](/treasury-bill/), and short-term lending instruments that retail investors rely on for stable, liquid returns.*
...
When the Fed raises its target from 4.00% to 4.25%, for example, banks' cost of borrowing overnight increases. This higher cost spreads immediately to every other overnight rate—especially [SOFR](/sofr/) (the Secured Overnight Financing Rate, which has replaced LIBOR as the backbone of short-term markets) and the overnight [repo](/repurchase-agreement/) rate.
...
[Treasury bills](/treasury-bill/) (T-bills with maturities of a few weeks to a year) respond to Fed rate changes almost immediately. The secondary market reprices them in real time. When the Fed raises its target, Treasury bill yields jump within hours or minutes.

T-bills trade daily, so their [yield-to-maturity](/yield-to-maturity/) adjusts continuously. A 3-month T-bill trading at a 4.50% yield in a 4.25% Fed funds environment will trade at, say, 4.75% if the Fed raises to 5.00%—all else equal.

This is the opposite of longer-term bonds, which fall in price when rates rise and create [interest-rate-risk](/interest-rate-risk/) for holders. T-bills mature so soon that rate changes barely affect their price; you capture the new rate almost immediately when your bill matures and you reinvest the proceeds.
...
Timing matters. If you hold cash in a money market fund and the Fed is widely expected to cut rates, you might lock in the current yield on a [Treasury bill](/treasury-bill/) (which you own outright and cannot lose principal on) rather than wait for reinvestment at a lower rate. If rates are expected to rise, waiting to reinvest avoids locking in a temporary low yield.

[Federal Reserve](/federal-reserve/) policy operates with a lag. The yield you earn reflects the Fed's past decisions, not its expected future ones. Markets do price in expected future decisions, which is why Treasury yields often move ahead of actual Fed moves—the [yield curve](/yield-curve/) is a forecast as much as a historical record.
...
- [Money-market-fund](/money-market-fund/) — structure, yields, and role as a cash equivalent
- [Treasury-bill](/treasury-bill/) — definition, maturity, and pricing mechanics
- [SOFR](/sofr/) — the Fed's preferred overnight reference rate
- [Yield-curve](/yield-curve/) — how short-term rates anchor the longer term
- [Federal-reserve](/federal-reserve/) — structure and policy tools
- [Interest-rate](/interest-rate/) — fundamentals and risk

### Wider context

- [Monetary-policy](/monetary-policy/) — how central banks influence the economy
- [Liquidity-risk](/liquidity-risk/) — the cost of accessing cash quickly
- [Credit-spread](/credit-spread/) — how investors price credit risk
- [Inflation-expectations](/inflation-expectations/) — the driver behind Fed rate paths
- [Bond](/bond/) — fixed-income fundamentals
