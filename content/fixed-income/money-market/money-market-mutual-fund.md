...
description: "A fund investing in short-term, low-risk instruments for stable principal and modest returns."
keywords:
  - money market fund
...
*A **money market mutual fund** invests exclusively in short-term, high-quality debt securities—[Treasury bills](/wiki/treasury-bill/), [commercial paper](/wiki/commercial-paper/), [certificates of deposit](/wiki/certificate-of-deposit/), [repurchase agreements](/wiki/repurchase-agreement/)—with maturities under 13 months. The goal is to preserve principal (making money-market funds a cash equivalent) while earning a modest yield above money-market rates. With weighted-average maturity (WAM) typically 40–90 days, money-market funds have negligible interest-rate risk and are suitable for investors seeking stability and liquidity, not capital appreciation.*

<aside class="wiki-infobox">

| Feature | Detail |
|---------|--------|
| **Primary holdings** | T-bills, commercial paper, bankers' acceptances, repos |
| **Average maturity** | 40–90 days (very short) |
| **Credit quality** | Investment-grade only (typically A-1/P-1 or better) |
| **Volatility** | Near-zero; principal stable |
| **Yield** | 4–5% (2024–2025 levels); tracks SOFR/Federal Funds Rate |
| **Liquidity** | Same-day redemptions; cash-like |
| **Risk** | Credit risk (counterparty default); minimal rate risk |
...
Institutional investors often use money-market funds as vehicles for [repurchase agreements](/wiki/repurchase-agreement/) (repos), where the fund earns overnight rates while simultaneously lending cash to dealers and borrowing collateral. This is more sophisticated and generates slightly higher yields (0.5–1% above simple T-bill returns) at the cost of counterparty and operational risk.

<div class="wiki-seealso">

### Closely related
- [Money Market Fund](/wiki/money-market-fund/) — Synonym for money-market mutual fund
- [Certificate of Deposit](/wiki/certificate-of-deposit/) — Fixed-term cash alternative
- [Commercial Paper](/wiki/commercial-paper/) — Short-term corporate debt money-market funds hold
...
- [Liquidity Risk](/wiki/liquidity-risk/) — The risk money-market funds face in crises
