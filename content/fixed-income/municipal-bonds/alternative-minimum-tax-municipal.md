---
title: "Alternative Minimum Tax and Municipals"
description: "Treatment of certain municipal bonds under the AMT income calculation and loss of tax-exempt status."
keywords:
...
| Item | Impact on AMT |
|------|----------------|
| **Specified municipal bond interest** | Included as preference item |
| **Regular municipal bonds** | Generally excluded from AMT |
| **Private activity bonds** | Often trigger AMT |
| **Upper-income taxpayers** | More likely to owe AMT |
| **Exemption phase-out** | Higher income → lower/zero exemption |
| **Rate** | 26% or 28% of AMT income |
