---
title: "Tax-Exempt Bond"
description: "Municipal bonds exempt from federal and often state income tax, popular for tax-efficient income."
keywords:
  - municipal bond
  - tax-exempt interest
  - muni bond
...
*A **tax-exempt bond** (or [**municipal bond**](/wiki/municipal-bond/)) is issued by a state, local government, or qualified governmental entity and pays interest that is exempt from federal income tax and typically exempt from state income tax in the issuer's state. For a high-income investor in the 37% federal + 10% state bracket, a 4% tax-exempt bond provides equivalent after-tax return to a 6.3% taxable bond—a powerful incentive. Tax exemption is the sole source of municipal bond demand; stripped of tax benefit, municipals would yield less than Treasuries.*

<aside class="wiki-infobox">

| Bond Type | Issuer | Interest | Tax Status |
|-----------|--------|----------|-----------|
| **General obligation** | State/local government | Backed by full taxing power | Federal exempt; state exempt (issuer's state) |
| **Revenue bond** | Government enterprise (utility, toll road) | Backed by project revenue | Same exemption |
| **Private-activity bond** | Issued by government but for private benefit | Varying | Often subject to AMT |
| **Taxable municipal** | State/local issuer | Market rates | Fully taxable; rare unless AMT-trapped |
...
Municipal bonds are less liquid than Treasuries or corporates. Bid-ask spreads for even well-rated bonds are 0.5–1.0% (50–100 basis points), versus 0.01–0.05% for Treasuries. This means a municipal bond investor who sells before maturity pays a significant round-trip cost. For long-term buy-and-hold investors (holding to maturity), this is not a concern; for active traders, municipal liquidity is a drawback. This is why municipal [funds](/wiki/mutual-fund/) and [ETFs](/wiki/etf/) are popular—they pool holdings and trade more efficiently than individual investors can.
...
### Closely related
- [Municipal Bond](/wiki/municipal-bond/) — General entry on municipals
- [General Obligation Bond](/wiki/general-obligation-bond/) — GO bonds backed by taxing power
- [Revenue Bond](/wiki/revenue-bond/) — Bonds backed by project revenue
- [Bond Yield Spread](/wiki/bond-yield-spread/) — How spreads reflect tax advantage

### Wider context
- [Bond Basics](/wiki/bond-basics/) — Core municipal bond concepts
- [Alternative Minimum Tax](/wiki/alternative-minimum-tax-investor/) — Tax that can apply to municipals
- [Tax-Loss Harvesting](/wiki/tax-loss-harvesting/) — Using municipal sales for tax benefits
- [Call Risk](/wiki/call-risk/) — Refinancing risk affecting municipals
- [Bond Ladder](/wiki/bond-ladder/) — Municipal income strategy
- [Municipal Bond Insurance](/wiki/municipal-bond-insurance/) — Insuring against default
