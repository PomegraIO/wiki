---
title: "Transportation Revenue Bonds"
description: "Bonds backed by toll roads, airports, ports, and transit revenues rather than general tax authority."
keywords:
  - municipal bonds
  - revenue bonds
  - toll roads
...
*A **transportation revenue bond** is a [municipal bond](/wiki/municipal-bond/) whose debt service is backed by revenues from a specific transportation facility—tolls from a road, landing fees from an airport, port charges, or fares from a transit system. Unlike [general obligation bonds](/wiki/general-obligation-bond/), which rely on the issuer's general tax authority and taxing power, revenue bonds are project-specific and depend entirely on the revenue stream of the facility.*
...
| Aspect | Detail |
|--------|--------|
| **Backing** | User revenues (tolls, fares, landing fees, port charges) |
| **Recourse** | Limited to the project; no general tax pledge |
| **Common issuers** | State DOTs, airport authorities, port authorities, transit agencies |
| **Examples** | Golden Gate Bridge tolls, O'Hare Airport bonds, I-95 toll roads |
| **Yield** | Typically higher than GO bonds due to revenue risk |
| **Credit drivers** | Traffic/usage growth, economic conditions, competition |
...
**Ports** issue bonds backed by container fees, cargo handling, and berth charges. Revenue depends on international trade volume and is cyclical. A port serving mainly imports of consumer goods is exposed to [recession](/wiki/recession/) risk.
...
### Closely related
- [Revenue Bond](/wiki/revenue-bond/) — the broader class of municipal bonds backed by project cash flows
- [General Obligation Bond](/wiki/general-obligation-bond/) — backed by issuer's full tax authority, not a single revenue stream
- [Essential Service Revenue Bonds](/wiki/essential-service-revenue-bonds/) — backed by utilities (water, power); more stable than transportation
- [Municipal Bond](/wiki/municipal-bond/) — the tax-advantaged debt issuances by states and localities
