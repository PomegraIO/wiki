...
description: "A high-yield bond is a debt security rated below investment-grade (BB or lower) that offers substantially higher yields to compensate investors for greater default risk."
keywords:
  - high-yield bond
  - junk bond
  - speculative grade
...
|   |   |
|---|---|
| **What it is** | Speculative-grade debt (BB or lower) |
| **Credit rating** | BB to D (default) |
| **Default risk** | Material; 2–4% per annum in normal periods |
| **Recovery rates** | 20–40% on average after default |
| **Typical yield** | 4–12% or higher |
| **Spread over Treasuries** | 300–800+ basis points |
| **Maturity** | 5–20 years |
| **Liquidity** | Lower than investment-grade |
| **Typical issuers** | Leveraged firms, private equity-backed companies |
...
High-yield bonds are the bread and butter of leveraged buyout (LBO) financing. A private equity firm acquiring a company typically layers debt into the capital structure: bank loans (senior), high-yield bonds (unsecured), and equity. The goal is to drive returns through financial engineering and operational improvement.

This model works well when the business generates stable cash flow and the private equity firm can improve operations. It fails spectacularly when the business suffers or the economy deteriorates. The high leverage of LBO-backed issuers makes them particularly vulnerable to cyclical downturns.
...
Over the long run, high-yield bonds have offered returns of 4–6% annually, compared to 2–3% for Treasuries. The excess is compensation for default risk. However, in down years (recessions, financial crises), high-yield bonds can underperform significantly, with total returns of -10% to -20% or worse.

The chart of high-yield spreads over time shows a "risk-off" trade: when fear is high, spreads widen, and high-yield bonds fall. Investors need the stomach for volatility to hold high-yield bonds through a full cycle.
