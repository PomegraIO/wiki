---
title: "Yield Curve Control: How Central Banks Cap Long Rates"
description: "Yield curve control is a central bank policy tool that targets specific maturity yields, capping long rates to stimulate borrowing and spending."
keywords:
  - yield curve control
  - central bank policy
...
- [Parallel Shift in the Yield Curve](/yield-curve-parallel-shift/) — how broad rate moves interact with YCC
- [Currency Risk](/currency-risk/) — the currency-depreciation consequence of YCC
- [Inflation Risk](/inflation-risk/) — the tension between YCC and rising inflation
- [Debt-to-GDP Ratio](/debt-to-gdp-ratio/) — fiscal backdrop for YCC sustainability
