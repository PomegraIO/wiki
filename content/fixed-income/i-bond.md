---
title: "Series I Savings Bond"
description: "A Series I Savings Bond is a Treasury-issued savings product with a return consisting of a fixed rate plus an inflation component. I-Bonds are non-transferable, carry a 30-year maturity, and offer tax-deferred growth."
keywords:
  - i-bond
  - savings bond
...
|   |   |
|---|---|
| **What it is** | Treasury savings security with inflation protection |
| **Issued by** | U.S. Department of the Treasury |
| **Denomination** | Electronic only; $25–$10,000 per transaction |
| **Return structure** | Fixed rate + inflation component |
| **Inflation rate** | Adjusted every 6 months (May and November) |
| **Maturity** | 30 years |
| **Early redemption penalty** | 3 months of accrued interest if redeemed before 5 years |
| **Tax treatment** | Federal tax deferred; exempt from state/local tax |
| **Transfer** | Non-transferable; must be held by original purchaser |
