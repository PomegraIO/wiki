---
title: "Putable Bond"
description: "A putable bond is a debt security that grants the bondholder the right to sell the bond back to the issuer at par (or a stated price) on specified dates."
keywords:
  - putable bond
  - put option
  - bond redemption
...
|   |   |
|---|---|
| **What it is** | Bond redeemable by holder before maturity |
| **Put price** | Typically at par (100) or premium |
| **Put date(s)** | Specific date(s) when holder can exercise |
| **Coupon** | Lower than comparable straight bonds |
| **Yield to put** | Return if bond put on first put date |
| **Holder protection** | Can exit at par if credit or rates deteriorate |
| **Issuer cost** | Must have cash available to redeem |
| **Typical issuers** | Less common; mainly higher-risk corporate bonds |
| **Market usage** | Used to lower borrowing costs for weak issuers |
