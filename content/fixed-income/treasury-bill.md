...
description: "A Treasury bill is a short-term debt security issued by the U.S. government, maturing in one year or less. T-Bills are issued at a discount and redeemed at face value, with the difference representing the investor's return."
keywords:
  - treasury bill
  - t-bill
  - short-term debt
...
|   |   |
|---|---|
| **What it is** | Short-term government debt security |
| **Maturity range** | 4 weeks to 1 year |
| **Common maturities** | 4, 8, 13, 26, and 52 weeks |
| **Issued by** | U.S. Department of the Treasury |
| **How sold** | At a discount to par value |
| **Redeemed at** | Full face value |
| **Interest mechanism** | Discount (not coupon payments) |
| **Risk level** | Virtually zero (backed by U.S. government) |
| **Typical holder** | Banks, money managers, corporations |

</aside>

## How T-Bills are structured and sold

Treasury bills are zero-coupon securities — they pay no periodic interest. Instead, the Treasury auctions them at a discount to their face value, and investors receive the full face value when the bill matures. The difference between the purchase price and the maturity value is the investor's return.
