---
title: "Par Value"
description: "Par value is the face value of a bond — the amount the issuer promises to repay at maturity. It is the principal on which coupon payments are calculated."
keywords:
  - par value
  - face value
  - principal
...
|   |   |
|---|---|
| **What it is** | Amount repaid at maturity |
| **Also called** | Face value, principal, redemption value |
| **Typical denominations** | $1,000, $5,000, $10,000 (institutional bonds) |
| **Coupon basis** | Coupon rate × par value = annual payment |
| **Market price** | Can trade above (premium) or below (discount) par |
| **At maturity** | Bondholder receives par regardless of market price |
| **Terminology** | "Par bond" = trading at par; "premium" = above par; "discount" = below par |
