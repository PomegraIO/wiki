...
description: "A perpetual bond is a debt security with no maturity date that pays a fixed coupon forever. The issuer never redeems the principal and is obligated to pay coupons indefinitely."
keywords:
  - perpetual bond
  - perpetual debt
  - consol
...
|   |   |
|---|---|
| **What it is** | Debt security with no maturity date |
| **Coupon** | Fixed semi-annual interest, indefinitely |
| **Principal redemption** | Never; issuer is not obligated to redeem |
| **Duration** | Very high (approaching infinite duration) |
| **Price sensitivity** | Extreme to interest-rate changes |
| **Valuation** | Coupon ÷ current market yield |
| **Callable** | Often callable by issuer |
| **Typical issuer** | Banks, insurance companies, governments |
| **Tax treatment** | Federal income tax on coupon (not taxable as return of principal) |
