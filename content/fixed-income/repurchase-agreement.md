...
description: "A repurchase agreement is a short-term, collateralized borrowing transaction in which a seller agrees to repurchase securities at a higher price on a specified future date."
keywords:
  - repo
...
|   |   |
|---|---|
| **What it is** | Collateralized short-term borrowing |
| **Typical maturity** | Overnight to 3 months |
| **Collateral** | Securities (Treasuries, corporate bonds, etc.) |
| **Interest mechanism** | Repo rate = (repurchase price - sale price) ÷ sale price |
| **Typical rate** | Varies with collateral and market conditions |
| **Haircut** | Discount applied to collateral value |
| **Participants** | Banks, broker-dealers, money managers, central banks |
| **Market size** | Trillions of dollars daily |
| **Use case** | Financing inventory, short-selling, lending securities |
