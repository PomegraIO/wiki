---
title: "Bond Issue Size"
description: "The total principal amount of bonds a company issues in a single offering, affecting market liquidity, trading spreads, and investor accessibility."
---
...
For the issuance process, see <a href="/wiki/corporate-bond/">Corporate bond</a>. For how size affects trading, see <a href="/wiki/credit-spread-corporate/">Credit spread</a>.
</div>

<aside class="wiki-infobox">
  <div class="wiki-infobox-title">Bond Issue Size — key facts</div>
  <table>
    <tr><th>Typical range</th><td>$100M to $2B per offering</td></tr>
    <tr><th>Liquidity impact</th><td>Larger issues trade more actively</td></tr>
    <tr><th>Spread impact</th><td>Smaller issues trade wider (less liquid)</td></tr>
  </table>
</aside>
...
Smaller bond issuers (or those with weaker credit) often start with small issues ($100–200 million) to gauge market demand and establish a [credit rating](/wiki/credit-rating/). Once the company proves itself (bonds trade well, no credit stress), the company can issue larger follow-on bonds at tighter spreads. This is a bootstrap strategy: establish credibility, then scale.

Conversely, [investment-grade](/wiki/investment-grade-bond/) companies with strong ratings and deep investor bases issue large size from day one. A AAA-rated company might issue $1–2 billion per offering because demand is assured.
...
<ul>
  <li><a href="/wiki/credit-spread-corporate/">Credit spread</a> — smaller issues trade at wider spreads.</li>
  <li><a href="/wiki/bond-indenture/">Bond indenture</a> — specifies the issue size and terms.</li>
  <li><a href="/wiki/liquidity-risk/">Liquidity risk</a> — affects trading of small issues.</li>
</ul>
<h3>Wider context</h3>
<ul>
