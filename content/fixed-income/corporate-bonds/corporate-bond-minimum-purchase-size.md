...
keywords:
  ...
  - bond minimum investment
  - odd lot bonds
  - corporate bond retail access
...
<div class="wiki-infobox-title">Minimum Purchase Size — key facts</div>

<img src="/svg/fixed-income.svg" alt="An abstract editorial mark for fixed-income markets." />

<div class="wiki-infobox-caption">Standard denominations and lot conventions shape retail access.</div>

|   |   |
|---|---|
| **Standard Par Value** | $1,000 per bond |
| **Practical Minimum** | Often $5,000–$25,000 (5–25 bonds) |
| **Institutional Block** | $100,000–$500,000 typical |
| **Odd-Lot Definition** | Less than $100,000 face value |
| **Odd-Lot Pricing** | Higher [bid-ask-spread](/bid-ask-spread/), lower liquidity |
| **Secondary Market** | Sometimes $100–$500 minimum via brokerage |
...
In the [secondary-market](/secondary-market/) (trading between investors), bonds are traded in informal lot sizes. A **round lot** is typically $100,000 or $1 million face value. Anything smaller is an **odd lot**.

Odd-lot bonds trade with wider [bid-ask-spread](/bid-ask-spread/) because dealers have more difficulty finding counterparties. If you own $25,000 of a particular bond and want to sell, you are selling an odd lot. The dealer buys from you at a discount (lower price) and sells to another investor at a higher price, pocketing the wide spread. A round-lot trade might have a 5–10 basis-point spread; an odd-lot might have 25–50 basis-point spread.
...
For [high-yield bond](/high-yield-bond/) offerings, minimums are sometimes lower ($1,000–$5,000), but fewer retail brokers participate. For large institutional deals, retail access is often unavailable.
...
A retail investor calling a broker to buy corporate bonds will usually find that minimums are lower in the secondary market than in primary offerings, but still present. Many brokers will sell you a single $1,000 bond, but the [bid-ask-spread](/bid-ask-spread/) will be wide. To get better pricing, you must buy multiples: $5,000, $10,000, or $25,000.
...
For investors with less than $5,000 or $10,000, corporate bond [mutual-fund](/mutual-fund/) or [ETF](/etf/) exposure is more practical. A bond fund holds hundreds of individual corporate bonds and distributes shares for as little as $100 to $1,000 (depending on the fund).
...
- [Bid-Ask Spread](/bid-ask-spread/) — How trading spreads affect your cost to buy and sell
- [Corporate Bond](/corporate-bond/) — Overview of the corporate bond market
- [Investment-Grade vs High-Yield Bonds](/investment-grade-vs-high-yield-bonds/) — Why minimums differ by rating
- [Over-the-Counter Market](/over-the-counter-market/) — How corporate bonds trade without a central exchange
- [Mutual Fund](/mutual-fund/) — Alternative for investors below the direct-ownership minimum
- [ETF](/etf/) — Exchange-traded funds for diversified bond exposure
- [Liquidity Risk](/liquidity-risk/) — Why odd-lot positions are riskier to exit

### Wider context

- [Bond](/bond/) — Foundational bond concepts
- [Secondary Market](/secondary-market/) — How existing bonds are traded
- [Primary Market](/primary-market/) — New bond offerings and underwriting
- Fixed-Income Investing — Broader portfolio strategy
- [Par Value](/par-value/) — Why bonds are denominated in standard sizes
