...
description: "Earnings per share (EPS) is a company's net profit divided by its outstanding shares. It is the single most-watched metric on earnings day and a key input into stock valuation."
keywords:
  - earnings per share
  - EPS
  - diluted earnings
...
<div class="wiki-infobox-title">Earnings per share — key facts</div>

<img src="https://images.unsplash.com/photo-1554224128-8c2b4d4a30db?w=600&q=80" alt="An income statement showing net income and share count" />

<div class="wiki-infobox-caption">An income statement: every reported EPS starts here.</div>

|   |   |
|---|---|
| **What it is** | Company profit ÷ shares outstanding |
| **Formula** | Net income / weighted average shares |
| **Two versions** | Basic EPS, Diluted EPS |
| **When reported** | Quarterly and annually |
...
1. **Higher net income.** The business is earning more money.
2. **Fewer shares outstanding.** The company has bought back stock.
