---
title: "Dual Listing"
description: "A dual listing is when a company lists its shares on multiple stock exchanges in different jurisdictions, typically to access different investor bases and raise capital in multiple markets. The same shares trade on multiple exchanges."
keywords:
  - dual listing
  - cross-listing
  - stock exchange
...
|   |   |
|---|---|
| **What it is** | Shares listed on multiple stock exchanges in different jurisdictions |
| **Also called** | Cross-listing |
| **Typical structure** | Same shares trade on multiple exchanges simultaneously |
| **Examples** | US + UK, US + Canada, Canada + US, Asia + US |
| **Purpose** | Access capital in multiple markets; broaden investor base; increase liquidity |
| **Advantages** | Greater liquidity; international visibility; access to capital |
| **Challenges** | Regulatory complexity; currency exposure; split trading liquidity |
