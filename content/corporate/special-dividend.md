...
description: "A special dividend is a one-time, non-recurring dividend payment to shareholders in addition to regular quarterly dividends. Special dividends are typically funded by asset sales, excess cash, or debt and are used to return capital to shareholders or signal financial strength."
keywords:
  - special dividend
  - dividend
  - capital return
...
|   |   |
|---|---|
| **What it is** | One-time, non-recurring dividend payment |
| **Also called** | Extraordinary dividend, extra dividend |
| **Funding source** | Asset sale, excess cash, debt, or operational windfalls |
| **Trigger** | Asset sale, spin-off, debt-financed capital return, or excess cash buildup |
...
1. **Board declaration.** The board announces a special dividend of, say, $1 per share.
2. **Funding.** The company identifies the source — cash on hand, proceeds from an asset sale, or borrowed funds.
3. **Record date.** Shareholders who own shares on a specified date are eligible to receive the dividend.
4. **Payment.** The company distributes cash to shareholders (typically $1 per share × outstanding shares = total payout).
5. **Stock price adjustment.** The stock price typically falls by approximately the dividend amount on or after the ex-dividend date (when new buyers are not entitled to the dividend), reflecting the fact that the company's cash (and thus value) has been distributed.
