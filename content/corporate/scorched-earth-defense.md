---
title: "Scorched-Earth Defense"
description: "A scorched-earth defense is an extreme takeover strategy in which a target company deliberately damages itself or its assets to become less attractive to a hostile bidder. It may involve asset sales, debt accumulation, or dividend payments designed to hobble the acquirer."
keywords:
...
|   |   |
|---|---|
| **What it is** | Deliberate damage to company to deter hostile acquisition |
| **Methods** | Asset sales, debt increase, special dividends, executive changes |
| **Goal** | Make company economically unviable for acquirer |
| **Frequency** | Rare; extreme and destructive |
| **Costs** | Permanent damage to company value and operations |
| **Credibility** | Low; boards reluctant to follow through |
| **Legal risk** | May violate fiduciary duties if pursued recklessly |
