---
title: "Management Incentive Plan"
description: "An equity or option pool granted by PE sponsors to portfolio-company managers, aligning their financial interests with the sponsor's exit returns."
keywords:
...
<div class="wiki-infobox-title">Management Incentive Plan — key facts</div>

<img src="/svg/corporate.svg" alt="An abstract editorial mark for corporate finance and dealmaking." />

<div class="wiki-infobox-caption">Aligning executive incentives with PE hold and exit economics.</div>

|   |   |
|---|---|
| **What it is** | Equity or option pool granted to portfolio-company management |
| **Typical size** | 10–25% of fully diluted equity; often carved from sponsor equity upfront |
| **Vesting schedule** | Typically 4–7 year cliff at exit, or annual cliff over hold period |
| **Valuation at grant** | Often valued at favourable strike prices or discounts relative to entry valuation |
| **Trigger to vesting** | Usually tied to exit event (sale, IPO, [dividend recapitalisation](/)) or change of control |
| **Tax treatment** | Often structured as incentive stock options (ISOs) or restricted stock to defer and minimize taxes |
| **Motivation** | Retain top talent, align interests with value creation, reduce drag of executive departures |
...
Most MIPs are structured as a percentage of total [fully diluted equity](/). If a [club deal](/club-deal/) has two sponsors (each 45% equity) and retains 10% for management, the MIP pool is divided among the CEO, CFO, COO, and other senior leaders. The CEO typically receives the largest share—4–7% of total equity—with subordinates receiving smaller allocations.
...
Change-of-control clauses matter in [club deals](/club-deal/) where one sponsor might want to buy out the other. If a dispute arises and Sponsor A proposes to take out Sponsor B's equity, does management's vesting accelerate? Most MIPs say no—the management equity remains subject to a future full exit event. This prevents management from claiming windfall proceeds if only partial sponsor ownership changes.
...
When a portfolio company exits, the waterfall is typically: (1) debt repayment, (2) preferred returns to sponsors (if any), (3) pro-rata distribution of remaining value to all equity holders by ownership percentage, and (4) any promote or carry allocated to the operating partner (if the deal is a [club](/club-deal/)).
...
- [Leveraged Buyout Sponsor](/lbo-sponsor/) — The PE firm that designs and implements the MIP
- [Club Deal](/club-deal/) — Multi-sponsor acquisitions where management incentive pools are negotiated with multiple co-investors
- [Add-On Acquisition](/portco-add-on-acquisition/) — Bolt-on deals where management execution determines success and MIP alignment is critical
- [Equity Financing](/equity-financing/) — Management equity as part of the overall capital structure
- [Share Buyback](/share-buyback/) — Related mechanism for aligning employee and shareholder interests in public companies

### Wider context

- [Earnings Per Share](/earnings-per-share/) — Dilution effects of MIP pools on per-share economics
