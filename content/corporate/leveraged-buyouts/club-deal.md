---
title: "Club Deal"
description: "A large private equity acquisition in which multiple PE sponsors co-invest alongside each other in a single target company, sharing risk and returns."
keywords:
  - club deal
  - co-investment
  - private equity
...
*A **club deal** is a large [leveraged buyout](/lbo-sponsor/) in which two or more private equity sponsors co-invest as equal or near-equal partners in a single target company, rather than one firm buying it outright. The group structure lets sponsors share the acquisition risk, deploy capital more efficiently, and pursue targets that would strain any single firm's balance sheet.*

<aside class="wiki-infobox">

<div class="wiki-infobox-title">Club Deal — key facts</div>

<img src="/svg/corporate.svg" alt="An abstract editorial mark for corporate finance and dealmaking." />

<div class="wiki-infobox-caption">Joint acquisition structure balancing scale and autonomy.</div>

|   |   |
|---|---|
| **What it is** | Two or more PE sponsors buying a company together as co-owners |
| **Typical size** | Large acquisitions ($500m–$5bn+) where single-sponsor leverage is constrained |
| **Control structure** | Partners hold equal or agreed voting stakes; typically joint governance board |
| **Common motivation** | Spread [financing](/debt-financing/) burden, pursue larger targets, or syndicate high-risk deals |
| **Exit coordination** | Partners usually commit to joint exit (sale, IPO, dividend recap) after 3–7 years |
| **Governance challenge** | Multiple sponsors can create decision deadlock or misaligned interests |
...
A club deal makes financial sense when the target company is too large for any single [LBO sponsor](/lbo-sponsor/) to finance alone without breaching its leverage thresholds or tying up too much of its committed capital. A sponsor with a $3bn fund might buy a $500m EBITDA business (generating ~$1.5bn–$2bn enterprise value) solo, but a $4bn–$5bn target requires either raising a larger fund or partnering.
...
- [Debt Financing](/debt-financing/) — Bank and bond financing for LBOs and club deals
- [Equity Financing](/equity-financing/) — Sponsor capital commitment to acquisitions
- [Merger](/merger/) — The core corporate transaction underlying club deals
- [Acquisition](/acquisition/) — The acquisition framework and deal anatomy
- [Concentration Risk](/concentration-risk/) — The risk of over-exposure to a single deal or sector
