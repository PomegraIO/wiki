...
| Component | Function |
|-----------|----------|
| **Escrow amount** | Typically 10–20% of purchase price; held from purchase price |
| **Escrow period** | Typically 12–24 months; varies by rep category (tax reps often 6–7 years) |
| **Indemnifiable items** | Breach of reps (financials, contracts, litigation, compliance) and breach of covenants |
| **Claim threshold** | Individual claim minimum (e.g., $25,000) and aggregate basket (e.g., claims don't reduce escrow until total > $100,000) |
| **Cap on indemnity** | Usually the escrow amount; sellers may negotiate higher "double-cap" or "basket" structures |
| **Escrow agent** | Neutral third party (typically a bank or escrow company) holding the funds and adjudicating disputes |
...
- [Earnout](/wiki/earnout-provision/) — Contingent payment alternative to escrow
- [Due Diligence](/wiki/due-diligence/) — The pre-close process that informs indemnification scope
- [Corporate Transaction](/wiki/material-adverse-change/) — Broader framework of deal structure
