...
description: "Seller's statements about company accuracy, condition, assets, and liabilities in an M&A transaction, subject to indemnification if false."
keywords:
...
*In a [merger](/wiki/merger/) or [acquisition](/wiki/acquisition/), the seller makes **representations and warranties** — formal statements asserting that the company's assets, liabilities, financial condition, contracts, litigation, and regulatory compliance are true and accurate. If any representation proves false after closing, the buyer has [indemnification](/wiki/indemnification-escrow/) claims against the seller, typically funded via an escrow account or insurance policy.*
...
4. **Lender requirement:** Banks financing a [leveraged buyout](/wiki/leveraged-buyout/) demand detailed reps to ensure the buyer has understood the asset.
...
- **Financial statements:** [Balance sheets](/wiki/balance-sheet/) and [income statements](/wiki/income-statement/) are accurate and comply with GAAP/IFRS; no undisclosed liabilities.
...
- **Employees and benefits:** Workforce is disclosed; no [underfunded pension obligations](/wiki/pension-obligation/), hidden employment claims.
...
- Common issues: transfer pricing, deferred [tax liabilities](/wiki/deferred-tax-liability/), unclaimed deductions, [R&D tax credits](/wiki/research-credit-phase-in/), [cost-basis](/wiki/cost-basis/) computation.
...
### Closely related
- [Acquisition](/wiki/acquisition/) — the transaction context
- [Merger](/wiki/merger/) — the deal structure
- [Indemnification escrow](/wiki/indemnification-escrow/) — the financial mechanism backing reps

### Wider context
- [Material adverse change](/wiki/material-adverse-change/) — related closing condition
- [Leveraged buyout](/wiki/leveraged-buyout/) — M&A financing context where reps are crucial to lenders
- [Deal contingency](/wiki/deal-contingency/) — other conditions affecting closing
