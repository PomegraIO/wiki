---
title: "Retained Earnings vs Paid-In Capital"
description: "How retained earnings and paid-in capital differ in origin, legal constraints, and what each reveals about a company's financial history and dividend capacity."
keywords:
  - retained earnings vs paid-in capital difference
...
*The two main components of [shareholders' equity](/common-stock/) are **retained earnings** and **paid-in capital**, and they have fundamentally different origins and legal treatments. Retained earnings are profit the company keeps after paying dividends; paid-in capital is what shareholders originally invested. The distinction matters because only retained earnings can freely fund dividends, while paid-in capital is usually restricted.*

<aside class="wiki-infobox">

<div class="wiki-infobox-title">Retained Earnings vs Paid-In Capital — Key Differences</div>

<img src="/svg/corporate.svg" alt="An abstract editorial mark for the topic." />

<div class="wiki-infobox-caption">Both sit on the equity side of the balance sheet, but signal different company histories.</div>

|   |   |
|---|---|
| **Retained earnings** | Cumulative profit retained by the company since inception |
| **Paid-in capital** | Amount investors paid for shares at issuance (premium above par value) |
| **Source** | Internal profit; reinvestment of earnings | External investment; equity capital raised |
| **Dividend policy** | Usually the only source for cash dividends | Usually restricted or forbidden by law |
| **Share buybacks** | Can be funded from retained earnings or cash | Generally treated same as dividends in some jurisdictions |
| **Typical size ratio** | Often larger in mature companies | Often larger in startups or recent IPOs |

</aside>

## The Origin of Each Component

When a company issues stock, investors pay a price per share. That price includes both the [par value](/par-value/)—a legal minimum set in the corporate charter—and any amount above par, called the premium. Par value is typically nominal (often $0.01 per share), while the premium reflects the true market price investors are willing to pay. Both par value and premium are lumped together as **paid-in capital** on the balance sheet.

Retained earnings, by contrast, are not invested by shareholders. They are profit the company earned through operations minus any [dividends](/dividend/) or [share buybacks](/share-buyback/) paid to shareholders. Each quarter, the company's net income either flows into [retained earnings](/retained-earnings-vs-paid-in-capital/) (if not paid out) or is distributed to shareholders. Over time, a profitable company that reinvests its earnings builds a large retained earnings balance. An unprofitable company or one that distributes all profits via dividends has zero or negative retained earnings.
...
- [Share Buyback](/share-buyback/) — mechanism and balance-sheet impact of repurchases
- [Accelerated Share Repurchase Explained](/accelerated-share-repurchase-explained/) — structured buyback mechanics
- [Dividend](/dividend/) — how dividends relate to retained earnings
- [Common Stock](/common-stock/) — shareholders' equity and ownership structure
- [Balance Sheet](/balance-sheet/) — where retained earnings and paid-in capital appear

### Wider context

- [Equity Financing](/equity-financing/) — new share issuances and paid-in capital creation
- [Return on Equity](/return-on-equity/) — profitability relative to shareholder capital
- [Capital Structure](/capital-asset-pricing-model/) — debt vs equity and cost of capital
- [Stockholder Rights](/voting-rights/) — legal framework around distributions and capital allocation
