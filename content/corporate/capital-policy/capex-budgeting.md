---
title: "Capital Expenditure Budgeting"
description: "The process of planning, evaluating, and allocating funds for long-term asset purchases, plant and equipment, and infrastructure that will generate returns over multiple years."
keywords:
  - capex
  - capital budgeting
  - investment
...
| Key Fact | Detail |
|---|---|
| **Time horizon** | Typically 3–10+ years; some projects span decades |
| **Evaluation tools** | NPV, IRR, payback period, profitability index |
| **Typical threshold** | Large companies may require $1M+ to go through formal budgeting |
| **Frequency** | Annual budgeting cycle; some projects approved ad hoc |
| **CFO responsibility** | Chief Financial Officer typically oversees capital budgeting |
| **Board approval** | Large CapEx often requires board/shareholder approval |
...
Capital budgeting differs from operational budgeting. An operational budget (marketing spend, salaries, rent) is consumed within a year and shows up on the [income statement](/wiki/income-statement/) as an expense. A capital expenditure becomes an [asset](/wiki/asset-impairment/) on the [balance sheet](/wiki/balance-sheet/) and is expensed gradually over its useful life via [depreciation](/wiki/depreciation/).
...
NPV = $30M/(1.10) + $30M/(1.10)^2 + ... + $30M/(1.10)^5 - $100M
    = $113.7M - $100M
...
**Payback Period**: How long it takes for the project's cash flows to recover the initial investment. A $100M factory that generates $30M annually has a payback period of ~3.3 years. Simple to calculate but ignores cash flows after payback and the [time value of money](/wiki/compound-interest/).
...
Traditional capital budgeting assumes a static "now or never" decision: invest $100M or don't. In reality, companies often have flexibility: invest a small amount now to learn; scale up later if conditions are favorable. This is the concept of [real options](/wiki/real-options-valuation/). A company might invest in a pilot production line ($10M) to test a new manufacturing process, then decide whether to build the full-scale factory ($100M) based on pilot results. The pilot's value is not just its direct cash flows but the learning it enables.
