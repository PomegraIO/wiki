---
title: "How a Stock Split Affects an Existing Buyback Program"
description: "Stock splits automatically adjust both the dollar authorization and share count limits of board-approved buyback programs proportionally."
keywords:
  - stock split effect on buyback program
...
<div class="wiki-infobox-title">Stock Split & Buyback Adjustments — Key Facts</div>

<img src="/svg/corporate.svg" alt="An abstract editorial mark for the topic." />

<div class="wiki-infobox-caption">Splits preserve buyback authorization in substance, not nominal terms.</div>

|   |   |
|---|---|
| **Dollar authorization** | Usually unchanged; split does not alter total dollars available |
| **Share count authorization** | Adjusted proportionally; 2-for-1 split doubles authorized repurchase shares |
| **Per-share price** | Split adjusts all prior price limits and targets proportionally |
| **Repurchase activity** | Can often continue uninterrupted through the split |
| **Mechanical adjustment** | Automatic; no new board resolution typically required |
| **SEC disclosure** | Split and adjusted authorization are disclosed in proxy materials |
...
| Authorized share count | 200 million shares | 400 million shares |
| Price cap (if stated) | Up to $100/share average | Up to $50/share average |
| Shares repurchased to date (example) | 50 million | 100 million |
| Dollar spent (example) | $2.5 billion | $2.5 billion |
| Remaining authorization (shares) | 150 million | 300 million |
...
| Metric | Before 1-for-2 Reverse Split | After 1-for-2 Reverse Split |
|--------|------------------------------|------------------------------|
| Authorized dollar amount | $2 billion | $2 billion |
| Authorized share count | 200 million shares | 100 million shares |
| Price cap (if stated) | Up to $25/share average | Up to $50/share average |
| Shares repurchased to date (example) | 50 million | 25 million |
| Remaining authorization (shares) | 150 million | 75 million |
...
- [Share Buyback](/share-buyback/) — mechanics and authorization of repurchase programs
- [Accelerated Share Repurchase Explained](/accelerated-share-repurchase-explained/) — structured buyback execution
- [Earnings Per Share](/earnings-per-share/) — share count effects on EPS
- [Retained Earnings vs Paid-In Capital](/retained-earnings-vs-paid-in-capital/) — balance-sheet impact of splits and buybacks
- [Common Stock](/common-stock/) — share issuance and structure

### Wider context

- [Shareholder Rights](/voting-rights/) — voting and dividend effects of splits
- [Capital Structure](/capital-asset-pricing-model/) — equity composition and split mechanics
- [Securities and Exchange Commission](/securities-and-exchange-commission/) — disclosure and approval of splits
- [Recapitalization](/recapitalization/) — corporate restructuring involving share adjustments
