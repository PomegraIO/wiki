---
title: "Split-Off"
description: "A split-off is a corporate action in which a company distributes a subsidiary to shareholders in exchange for shares of the parent company. Unlike a spinoff where shareholders receive both parent and subsidiary shares, shareholders in a split-off must choose between parent and subsidiary shares."
keywords:
  - split-off
...
|   |   |
|---|---|
| **What it is** | Shareholders exchange parent shares for subsidiary shares (choice) |
| **Result** | Two independent public companies |
| **Shareholder choice** | Retain parent OR exchange for subsidiary (not both) |
| **Effect on parent shares** | Reduced shares outstanding (net of exchanges) |
| **Tax treatment** | Generally tax-free if meets Section 368 criteria |
| **Timing** | 6–12 months from announcement to completion |
| **vs. Spinoff** | Spinoff = automatic distribution; split-off = shareholder choice |
...
| Aspect | Split-Off | Spinoff |
|---|---|---|
| **Distribution** | Shareholders choose; not automatic | Automatic pro-rata distribution |
| **Ownership post-action** | Own parent OR subsidiary | Own both parent AND subsidiary |
| **Parent shares after** | Reduced (shareholders who exit) | Unchanged in number (but price may adjust) |
| **Complexity** | Moderate (election mechanics) | Lower (automatic distribution) |
| **Timing** | Flexible (shareholders choose pace) | One-time distribution |
| **Use case** | When parent wants to reduce float | When both units should remain linked |
