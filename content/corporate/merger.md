---
title: "Merger"
description: "A merger is a transaction in which two companies combine into a single legal entity. The larger or surviving company typically retains its name, while the other ceases to exist as an independent entity."
keywords:
  - merger
  - M&A
  - consolidation
...
|   |   |
|---|---|
| **What it is** | Combination of two companies into a single entity |
| **Also called** | Consolidation, combination |
| **Legally** | Target ceases to exist; surviving company absorbs it |
| **Tax treatment** | Can be tax-free or taxable depending on structure |
