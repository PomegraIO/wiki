---
title: "Proxy Advisor"
description: "A proxy advisor is a firm that analyzes shareholder voting issues and provides recommendations to institutional investors on how to vote their shares. The major proxy advisors wield significant influence over corporate governance outcomes."
keywords:
  - proxy advisor
...
|   |   |
|---|---|
| **What it is** | Firm providing voting recommendations on corporate governance issues |
| **Clients** | Institutional investors (pension funds, mutual funds, hedge funds) |
| **Major firms** | ISS (Institutional Shareholder Services), Glass Lewis |
| **Reach** | Collectively advise on trillions of dollars in voting power |
| **Services** | Research, voting recommendations, engagement facilitation |
| **Influence** | Often decisive in close votes and proxy contests |
| **Regulation** | Growing SEC oversight of proxy advisor disclosure and conflicts |
