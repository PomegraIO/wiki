...
description: "An initial public offering (IPO) is the first sale of a company's stock to the public. IPOs involve bookbuilding, lock-ups, underwriters, and are often underpriced. Direct listings are an alternative."
keywords:
  - IPO
...
<div class="wiki-infobox-title">Initial public offering — key facts</div>

<img src="/svg/corporate.svg" alt="The moment of a company's public listing" />

<div class="wiki-infobox-caption">The moment a private company becomes a public one. Almost everything about it changes.</div>

|   |   |
|---|---|
| **What it is** | First public sale of a company's stock |
| **Also called** | Going public |
| **Participants** | Company, underwriters, investment banks, investors |
| **Price discovery** | Bookbuilding process |
| **Lock-up period** | 6 months (typical), insiders cannot sell |
| **First day performance** | Commonly +15–25% (often gains concentrated here) |
| **Underwriters take** | 3–7% "underwriting spread" |
| **Alternatives** | Direct listing, SPAC merger |
| **Regulation** | SEC oversight; company must file S-1 prospectus |
| **Typical minimum size** | \$100M–\$300M in proceeds |
