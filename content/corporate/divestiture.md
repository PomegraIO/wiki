---
title: "Divestiture"
description: "A divestiture is the sale or disposal of a subsidiary, division, or asset by a company. A divestiture can be a simple asset sale, a sale of shares in a subsidiary, or a spin-off to shareholders. Divestitures are used to raise capital, focus operations, comply with regulations, or exit underperforming businesses."
keywords:
  - divestiture
  - asset sale
  - sale of subsidiary
...
1. **Decision and planning.** Board approves decision to divest; company hires investment bankers to run the sale process.

2. **Buyer identification.** Bankers identify potential buyers: strategic buyers (competitors or related businesses), financial buyers (PE firms), or other parties interested in the division.

3. **Auction process.** Buyers are given information (data room access) and invited to submit non-binding indications of interest. Promising bidders are selected for final rounds.

4. **Negotiation and sale agreement.** Winner is selected and terms (price, representations, warranties, indemnification) are negotiated.

5. **Closing.** Transaction closes; seller receives cash (or seller financing / equity in buyer) and transfers the division to the buyer.

6. **Post-close integration.** Buyer integrates the acquired division into its own operations.
