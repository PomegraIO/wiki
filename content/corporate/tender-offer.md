---
title: "Tender Offer"
description: "A tender offer is a public bid by one company to purchase shares directly from another company's shareholders at a specified price and within a set timeframe. It is the primary mechanism for acquiring a public company's shares."
keywords:
  - tender offer
  - share purchase
  - buyback
...
|   |   |
|---|---|
| **What it is** | Public bid to buy shares at a fixed price within a stated period |
| **Initiated by** | An acquiring company or the company itself (share buyback) |
| **Directed to** | The target company's public shareholders |
| **Price** | Fixed per-share amount, typically premium to market |
