...
description: "A reverse stock split is a corporate action in which a company reduces the number of outstanding shares by consolidating multiple shares into one. In a 1-for-10 reverse split, every 10 shares become 1 share, increasing the per-share price 10-fold while decreasing the share count."
keywords:
  - reverse stock split
  - reverse split
  - consolidation
...
|   |   |
|---|---|
| **What it is** | Consolidation of multiple shares into one share |
| **Typical ratios** | 1-for-10, 1-for-20, 1-for-100 (varies widely) |
| **Effect on value** | No effect; total value unchanged |
| **Effect on ownership** | No change; each shareholder's % ownership unchanged |
| **Effect on share price** | Price multiplied by reverse split ratio |
...
1. Company stock falls to penny status
2. Company announces 1-for-10 reverse split, moving to $1+ stock price
3. Stock continues to fall
4. Company announces another 1-for-20 reverse split
5. Pattern repeats, with shareholders progressively diluted
...
**Corporate mechanics:**
1. Board proposes reverse split
2. Shareholders vote
3. Record date set
4. Shares consolidated on ex-date
5. Cash paid out for fractional shares
