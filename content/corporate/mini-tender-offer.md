...
description: "A mini-tender offer is a tender offer for less than 5% of a company's outstanding shares, used by activists or raiders to accumulate a stake without triggering regulatory disclosure requirements. They are now heavily restricted."
keywords:
  - mini-tender offer
  - stake accumulation
  - activist
...
This entry covers mini-tender offers as a disclosure avoidance mechanism. For tender offers in general, see [tender offer](/tender-offer); for disclosure rules, see Schedule 13D; for stake accumulation, see shareholder activism.
...
|   |   |
|---|---|
| **What it is** | [Tender offer](/tender-offer) for less than 5% of outstanding shares |
| **Purpose** | Accumulate stake while avoiding disclosure |
| **Typical size** | 2–4% of shares |
| **Historical advantage** | No Schedule 13D filing required below 5% |
| **Regulatory status** | Now subject to mini-tender offer rules (Rule 13e-4(h)) |
| **Disclosure required** | Yes, under mini-tender rule, even below 5% |
| **Modern use** | Rare; less effective after regulatory changes |
...
By the time the raider's stake exceeded 5% and disclosure became mandatory, the raider had already assembled a sizeable position and could launch a [hostile takeover](/hostile-takeover) bid or demand a seat on the board. The target had little time to prepare a defence.
...
With disclosure now mandatory, the stealth advantage of mini-tenders evaporated. Once the target receives notice of a mini-tender, it can adopt a [poison pill](/poison-pill), seek a [white knight](/white-knight), or simply go public with a defence.

## Mini-tender offers today

Mini-tender offers are rare today. They are now used, if at all, by activists who want to accumulate a modest stake (say, 2–3%) to gain credibility for a [proxy fight](/proxy-fight) or shareholder campaign, but they no longer offer the stealth advantage that made them attractive to raiders in the 1980s.
...
Today, most use of mini-tender offers comes from activists who want to build a platform for engagement. An activist might offer to buy 2–3% of a company to start a dialogue with the board on strategic issues. The mini-tender, combined with a [proxy fight](/proxy-fight) for board representation, becomes a coordinated pressure campaign rather than a prelude to an outright hostile takeover.
...
- [Proxy fight](/proxy-fight) — alternative mechanism for activists to gain influence
- [Poison pill](/poison-pill) — defence available after mini-tender disclosure

### Wider context

- [Hostile takeover](/hostile-takeover) — the original context for mini-tender offers
- Controlling shareholder — position built through accumulation
- [Proxy advisor](/proxy-advisor) — guides shareholders on mini-tender decisions
