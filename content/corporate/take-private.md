---
title: "Take-Private"
description: "A take-private transaction is the acquisition and delisting of a public company, converting it to private ownership. Take-privates are typically structured as leveraged buyouts and are driven by either management buyouts, activist pressure, or strategic acquisitions by larger companies."
keywords:
  - take-private
  - go-private
  - delisting
...
This entry covers take-private transactions as an exit or ownership transition. For the financing structure, see [leveraged buyout](/leveraged-buyout/); for the public-to-private process, see [going-private transaction](/going-private/); for alternatives, see [initial public offering](/initial-public-offering/) and [reverse merger](/reverse-merger/).
...
|   |   |
|---|---|
| **What it is** | [Acquisition](/acquisition/) of public company with intent to delist |
| **Also called** | Go-private transaction |
| **Typical buyer** | Private equity firm, founder/management, strategic buyer |
| **Financing** | Often [leveraged buyout](/leveraged-buyout/) |
| **Premium** | Typically 25–50% above pre-announcement stock price |
| **Motivation** | Escape public market pressure; implement long-term strategy |
...
Once the transaction closes, the company is delisted from the stock exchange, and all shares are owned by the buyer (or by the buyer and remaining shareholders in a [management buyout](/management-buyout/)).
...
Take-privates are often financed as [leveraged buyouts](/leveraged-buyout/), with debt providing 50–70% of the purchase price. The buyer arranges:

- Senior bank debt (secured, lower cost)
- [High-yield bonds](/high-yield-bond/) (unsecured, higher cost)
...
- If the deal is in a [leveraged buyout](/leveraged-buyout/), the company is saddled with debt that limits flexibility
...
- Market risk; if a subsequent [IPO](/initial-public-offering/) or sale occurs in a down market, equity returns are reduced
...
2. **Be taken public again** ([IPO](/initial-public-offering/)). After operational improvements, the company may offer better returns to public investors.
3. **Be sold** to another buyer (strategic or PE).
4. **Undergo a [secondary buyout](/secondary-buyout/).** The original PE owner sells to another PE firm.
...
- [Going-private transaction](/going-private/) — related public-to-private structure
- [Leveraged buyout](/leveraged-buyout/) — financing structure for take-privates
- [Management buyout](/management-buyout/) — take-private by management
- [Acquisition](/acquisition/) — the transaction mechanism
- [Merger](/merger/) — related transaction type

### Wider context

- [Initial public offering](/initial-public-offering/) — opposite of take-private
- [Reverse merger](/reverse-merger/) — alternative return to public markets
- Private equity — typical buyer in take-privates
- Board of directors — approves take-private
- [Change of control provision](/change-of-control-provision/) — triggered in take-privates
