---
title: "Dual-Class Share Structure"
description: "A dual-class share structure is when a company issues multiple classes of common stock with different voting rights. Typically, Class A shares have 10 votes per share while Class B shares have 1 vote per share, allowing founders to retain voting control despite not owning a majority of economic equity."
keywords:
  - dual-class shares
...
|   |   |
|---|---|
| **What it is** | Multiple share classes with different voting rights |
| **Typical structure** | Class A (10 votes/share, founders) + Class B (1 vote/share, public) |
| **Purpose** | Founders retain control without owning majority |
| **Famous examples** | Alphabet, Meta, Amazon, Tesla, Berkshire Hathaway |
| **Governance concern** | Minority shareholders have limited influence |
| **Activist pressure** | Shareholders push to eliminate in favor of one-share-one-vote |
| **Convertibility** | Some classes are convertible to others; some are not |
