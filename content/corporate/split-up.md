---
title: "Split-Up"
description: "A split-up is a corporate action in which a parent company completely divides into two or more independent companies, with the parent company ceasing to exist. All shareholders receive shares in the new companies, but the original parent company is dissolved."
keywords:
  - split-up
  - complete separation
  - dissolution
...
|   |   |
|---|---|
| **What it is** | Complete division of parent into multiple independent companies |
| **Result** | Parent ceases to exist; shareholders own multiple new companies |
| **Number of companies** | Typically 2–4 (but can be more) |
| **Shareholder distribution** | Pro-rata distribution of new company shares; parent shares cancelled |
| **Tax treatment** | Generally tax-free if meets Section 368 criteria |
| **Complexity** | Very high (complete separation of all operations) |
| **Frequency** | Rare; typically for conglomerates breaking apart |
...
| Aspect | Split-Up | Spinoff |
|---|---|---|
| **Parent survival** | Parent ceases to exist | Parent continues |
| **Shareholder result** | Own multiple new companies (no parent) | Own parent + new company |
| **Complexity** | Very high | Moderate |
| **Tax-free criteria** | Same as spinoff | Section 368(a)(1)(D) |
| **Number of resulting companies** | 2+ new, parent dissolves | 1 parent continues + 1+ new |
