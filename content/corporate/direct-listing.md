...
description: "A direct listing is a method for a private company to go public by listing its shares directly on a stock exchange, allowing shareholders to sell shares without a capital raise by the company. Direct listings are faster and cheaper than traditional initial public offerings."
keywords:
  - direct listing
...
|   |   |
|---|---|
| **What it is** | Listing existing shares directly on stock exchange without IPO |
| **Capital raise** | None (unless secondary shares are included) |
| **Timeline** | 3–6 months, faster than IPO |
...
| Factor | Direct Listing | IPO |
|---|---|---|
| **Capital raise** | Optional (secondary) | Required (primary) |
| **Speed** | Faster (3–6 months) | Slower (6–12 months) |
| **Cost** | Lower (~1–2% fees) | Higher (~5–7% fees) |
| **Underwriter support** | Minimal | Extensive |
| **Price stability** | Less stable | More stable (underwriter support) |
| **Share allocation** | Market-determined | Underwriter-allocated |
| **Best for** | Mature, profitable companies | Growth companies needing capital |
