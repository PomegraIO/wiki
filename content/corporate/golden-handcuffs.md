...
description: "Golden handcuffs are deferred compensation packages, often in the form of restricted stock or stock options, designed to retain executives by rewarding them financially for staying with the company over a long-term vesting period."
keywords:
  - golden handcuffs
...
|   |   |
|---|---|
| **What it is** | Deferred equity compensation tied to continued employment |
| **Common forms** | Restricted stock, stock options, restricted stock units (RSUs) |
