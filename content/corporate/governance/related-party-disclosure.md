...
description: "Mandatory transparency about transactions between a company and its insiders, directors, or affiliated entities."
keywords:
  - related party
  - disclosure
...
| Type | Example | Risk |
|---|---|---|
| **Officer compensation** | CEO stock options, severance | Excessive pay harming shareholders |
| **Affiliate sales** | Subsidiary buys from parent at markup | Price fixing; profit shifting |
| **Director transactions** | Board member's company rents to firm | Unfair terms favoring director |
| **Loan to insider** | CEO gets personal loan at below-market rate | Constructive dividend; tax evasion |
| **Real estate deals** | Company buys office from major shareholder | Overpriced acquisition |
| **Service contracts** | Firm hires director's consulting firm | Inflated fees |
| **Stock transactions** | Insider buys/sells company shares | Insider trading risk |
...
Disclosure isn't a ban on related-party transactions; it's a transparency requirement. Many legitimate related-party deals occur (e.g., a company paying market-rate rent to a building owned by an insider). The key is transparency and approval by the [audit committee](/wiki/audit-committee/) or independent directors.
...
- **Salary and bonuses** — disclosed in proxy statements and [compensation committee](/wiki/compensation-committee/) reports
- **Equity grants** — stock options, [restricted stock](/wiki/restricted-stock/), [RSUs](/wiki/restricted-stock-units/)
- **Severance and change-of-control payments** — [golden parachutes](/wiki/golden-parachute/), [change of control](/wiki/change-of-control/) bonuses
- **Perquisites** — airplane use, country club membership, housing allowances

These are required to be disclosed in the proxy statement in a [Compensation Discussion & Analysis](/wiki/say-on-pay/) (CD&A) section.
...
- **Executive loans** — company loans to officers at below-market rates (now mostly prohibited under [Sarbanes-Oxley](/wiki/sarbanes-oxley-act/))
...
- **Undisclosed transactions** — related-party deals that weren't disclosed in the [10-K](/wiki/10-k/)
- **Round-tripping** — company pays insider for service, insider pays money back to company in disguised form
- **Timing** — transactions announced right after insider buys or sells company stock (possible [insider trading](/wiki/insider-trading-definition/))
...
## Related-party transactions and [shareholder voting](/wiki/proxy-voting/)
...
- [Fiduciary duty](/wiki/fiduciary-duty/) — duty owed by directors to avoid self-dealing
