---
title: "Say-on-Pay Vote Thresholds That Trigger Engagement"
description: "The specific vote percentages at which say-on-pay vote results require formal engagement between companies and shareholders."
keywords:
  - say on pay vote threshold
  - say on pay vote engagement
  - proxy vote engagement triggers
  - shareholder say-on-pay
  - compensation vote thresholds
...
<div class="wiki-infobox-title">Say-on-Pay Thresholds — key facts</div>

<img src="/svg/corporate.svg" alt="An abstract editorial mark for the topic." />

<div class="wiki-infobox-caption">Vote outcomes below 80% typically trigger investor engagement protocols.</div>

|   |   |
|---|---|
| **Common engagement threshold** | Below 75–80% "for" votes |
| **Advisory nature** | Say-on-pay votes are non-binding in the U.S. |
| **Who acts** | Proxy advisors, large asset managers, institutional investors |
| **Board response** | Formal engagement or compensation policy revisions |
| **Declining support signal** | Year-on-year drop of 10+ percentage points |
| **Baseline expectation** | 85%+ support for uncontroversial pay programs |
...
- [Proxy statement](/proxy-statement/) — the formal document in which say-on-pay votes are disclosed and explained
- [Board of directors](/board-of-directors/) — the body accountable to shareholders for compensation policy
- [Proxy fight](/proxy-fight/) — contested shareholder vote that can escalate from weak say-on-pay support
- [Poison pill](/poison-pill/) — defensive tactic sometimes adopted after failed say-on-pay votes
- [Real estate syndication depreciation tax benefits](/real-estate-syndication-depreciation-tax-benefit/) — a different shareholder engagement context

### Wider context

- [Shareholder activism](/proxy-fight/) — the broader landscape of investor pressure on governance
- [Corporate income tax](/corporate-income-tax/) — how executive pay is taxed at the company level
- [Stock exchange](/stock-exchange/) — venues where proxy votes are administered
- [Corporate bond](/corporate-bond/) — creditors also monitor executive compensation for risk management
