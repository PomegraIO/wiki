...
description: "Management's evaluation and attestation of the effectiveness of internal controls over financial reporting, required by Sarbanes-Oxley."
keywords:
  - internal controls
...
| Key Fact | Detail |
|----------|--------|
| **Regulatory requirement** | SOX Section 404; applies to US public company [10-K](/wiki/10-k/) filings |
...
1. The risk being controlled (e.g., revenue overstatement due to side agreements).
2. The control procedure (e.g., all sales contracts reviewed by legal before revenue recording).
3. The frequency (daily, monthly, quarterly).
4. The owner (who performs it).
5. Evidence of execution (approval stamps, reconciliation sign-offs, audit trail).
...
**Management certification.** The CEO and CFO must certify in the 10-K that they have assessed the effectiveness of internal controls and that they believe the controls are effective. They must also disclose any [material weakness](/wiki/material-weakness/) or [significant deficiency](/wiki/significant-deficiency/) in controls.
