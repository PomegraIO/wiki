...
description: "A board subcommittee responsible for identifying, evaluating, and recommending director candidates for shareholder election and assessing board composition."
---
...
<div class="wiki-hatnote">For the voting on directors, see <a href="/wiki/proxy-voting/">proxy voting</a>. For shareholder campaigns to nominate directors, see <a href="/wiki/proxy-access/">proxy access</a>.</div>

<aside class="wiki-infobox">
  <div class="wiki-infobox-title">Nominating Committee — key facts</div>
  <table>
    <tr><th>Independence</th><td>Must be independent; cannot include the CEO</td></tr>
    <tr><th>Size</th><td>Typically 3–4 directors</td></tr>
    <tr><th>Key duties</th><td>Identify director candidates, vet independence, recommend slate for election</td></tr>
    <tr><th>Board evaluation</th><td>Often conducts annual board self-evaluation</td></tr>
  </table>
</aside>
...
1. **Identifying candidates** for director openings (through networks, search firms, or recommendations from shareholders).
2. **Evaluating candidates** for independence, competence, financial expertise, and diversity.
3. **Recommending the slate** of nominees for the annual shareholder meeting.
4. **Evaluating the board itself**—its composition, diversity, diversity of backgrounds and expertise, and overall governance practices.
...
A key nominating committee job is vetting director independence. Independence is important for the [audit committee](/wiki/audit-committee/) and [compensation committee](/wiki/compensation-committee/), which by law must be fully independent. The nominating committee itself must also be independent.
...
1. **Director recruitment**: Finding qualified candidates willing to serve is increasingly difficult. Board liability insurance is expensive, regulatory demands are rising, and talented executives have less time.

2. **Diversity versus competence**: Balancing diversity goals with competence and experience requirements can be tension-filled. Some committees feel pressed to prioritize diversity over expertise.

3. **Independence versus relationships**: Maintaining true independence is hard in small communities or industries where directors inevitably have relationships with the company.

4. **Intergenerational change**: Boards often become stale because long-serving directors resist retirement. Some companies now mandate term limits or retirement ages.

<div class="wiki-seealso">
<h2>See also</h2>
<h3>Closely related</h3>
<ul>
  <li><a href="/wiki/board-of-directors/">Board of Directors</a> — the body the committee nominates.</li>
  <li><a href="/wiki/proxy-voting/">Proxy Voting</a> — the shareholder election of nominees.</li>
  <li><a href="/wiki/proxy-access/">Proxy Access</a> — rules allowing shareholders to nominate directors.</li>
  <li><a href="/wiki/audit-committee/">Audit Committee</a> — committee that benefits from strong independent candidates.</li>
</ul>
<h3>Wider context</h3>
<ul>
