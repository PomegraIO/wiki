---
title: "Document Destruction Policy"
description: "Guidelines for retaining versus destroying business records, balancing operational efficiency with legal compliance and litigation risk."
keywords:
...
| **Board/shareholder minutes** | Permanent | Corporate governance proof, [securities law](/wiki/securities-exchange-act-of-1934/) |
...
| **Securities/investor relations** | Permanent | [SEC](/wiki/securities-and-exchange-commission/) regulations, shareholder disputes |
...
This suspension (called a **litigation hold**) preserves evidence and prevents [spoliation](/wiki/anti-bribery-compliance/) (destruction of evidence). Failure to implement a hold when required can result in [sanctions](/wiki/anti-bribery-compliance/) or default judgment (court assumes destroyed documents supported the other side).
...
**Destruction during active litigation**: If a company destroys relevant documents *after* a lawsuit is filed, it faces [sanctions](/wiki/anti-bribery-compliance/). Penalties can include:
- Contempt of court charges.
- Adverse inference (court instructs jury to assume destroyed documents would have harmed the company).
- Monetary [sanctions](/wiki/anti-bribery-compliance/).
...
1. **Err on the side of retention**, especially for companies with litigation exposure (life sciences, finance, construction, healthcare).

2. **Set realistic periods**: A 20-year retention period looks cautious but becomes costly and creates storage/security burden. 7–10 years is often a reasonable balance.

3. **Centralize email**: Move email off local computers to a managed platform (Office 365, Google Workspace) where retention policies can be enforced systematically.

4. **Document destruction activities**: Keep a log (or automated reports) showing when documents were destroyed, by whom, and for what category. This proof is essential if litigation later disputes compliance.

5. **Annual certification**: Have department heads certify annually that they have implemented the policy and no documents have been destroyed during a litigation hold period.

6. **Audit third parties**: If using outside vendors for storage or destruction, verify they implement the policy correctly.

7. **Train employees**: Many document destructions are unintentional (an employee clearing their desk, deleting old emails without thinking). Regular training on the policy reduces accidents.

## Regulatory and industry-specific requirements

**Securities firms** ([SEC](/wiki/securities-and-exchange-commission/) Rule 17a-3, -4): Must keep customer records 6 years (accessible), then 4 more years in storage. Broker trading blotters, general ledgers, etc., for 6 years.
...
### Closely related
- [Board of Directors](/wiki/board-of-directors/) — Body overseeing corporate governance, including document policies
- [Internal Control Assessment](/wiki/internal-control-assessment/) — Evaluation of document and record controls
- [Sarbanes-Oxley Act](/wiki/sarbanes-oxley-act/) — Legislation mandating corporate governance and document retention standards
