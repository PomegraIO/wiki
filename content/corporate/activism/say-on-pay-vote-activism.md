---
title: "Say-on-Pay Vote as an Activism Tool"
description: "How activist investors use say-on-pay votes to signal dissatisfaction with executive compensation and drive governance change at public companies."
keywords:
  - say on pay vote
  - executive compensation activism
...
*A **say-on-pay vote** is a nonbinding shareholder referendum on executive compensation packages. Activists use low support totals—often under 70%—to publicize management missteps and force boards to either justify pay policies or negotiate concessions on broader governance issues.*

<aside class="wiki-infobox">

<div class="wiki-infobox-title">Say-on-Pay Vote — key facts</div>

<img src="/svg/corporate.svg" alt="An abstract editorial mark for the topic." />

<div class="wiki-infobox-caption">Advisory shareholder vote on executive pay: legal in the US since 2010, now a flashpoint for governance activism.</div>

|   |   |
|---|---|
| **Vote type** | Nonbinding shareholder referendum |
| **US mandate** | Required at least every 3 years under Dodd-Frank |
| **Pass threshold** | Typically 50%+ votes in favor |
| **Activist leverage** | Visible dissent signals without removing directors |
| **Board obligation** | Must explain response to low support within 120 days |
| **Typical support** | 85%+ at healthy, well-governed firms |
| **Activist target** | Votes below 70% can trigger governance negotiations |

</aside>

## Why Activists Target Say-on-Pay Votes

Executive pay has become one of the starkest measures of corporate [governance](/wiki/proxy-statement/) health. A low say-on-pay tally—say 65% or 55% approval—signals that large shareholders, including institutional funds, question either the level of compensation or its alignment with performance. Activists exploit this signal in two ways.

First, a failed or near-failed vote draws media attention and public pressure. A CEO earning $30 million while the company underperforms the market becomes a story. Board members face scrutiny as compensation failures in their fiduciary duty. Second, and more strategically, activists use the vote result to demand a seat at the table. Even if the vote is nonbinding—the company can ignore it—a 60% approval rate forces the board into an awkward position: defend pay practices in a public 120-day response letter, or negotiate with the activist on other [board](/wiki/board-of-directors/) composition, [audit committee](/wiki/audit-committee/) independence, or executive search procedures.
...
## Thresholds, Trends, and Outcomes

Say-on-pay votes have become far more sophisticated since their introduction under [Dodd-Frank](/wiki/dodd-frank-act/) in 2010. Early votes were often rubber-stamp affairs; boards rarely worried about pay components. Over the past decade, institutional investors—particularly large [asset managers](/wiki/active-etf/) managing [index funds](/wiki/index-fund/) and actively managed strategies—have become less tolerant of misalignment.
...
## Designing Say-on-Pay to Block Activism
...
- [Proxy statement](/proxy-statement/) — The legal disclosure document containing say-on-pay resolutions
- [Board of directors](/board-of-directors/) — The decision-making body that approve executive pay
- Shareholder activism — Broader strategies activists use to influence company policy
- Proxy advisory firms — Organizations that recommend votes on pay and governance
- [Dodd-Frank Act](/dodd-frank-act/) — US regulation mandating say-on-pay votes
- Total shareholder return — The performance metric often tied to executive pay
- Chief executive officer — The executive role whose pay is under scrutiny

### Wider context

- [Hostile takeover](/hostile-takeover/) — Another activist strategy for board influence
- [Return on equity](/return-on-equity/) — A performance metric companies use in pay designs
- Capital allocation — Strategy activists critique if executive pay misaligns with capital discipline
