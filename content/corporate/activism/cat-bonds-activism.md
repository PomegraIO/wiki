---
title: "Catastrophe Bond Activism"
description: "Environmental and safety advocates targeting insurers and reinsurers through catastrophe bond shareholder campaigns"
keywords:
  - catastrophe bonds
...
|---|---|
| **Primary activists** | Environmental NGOs, climate advocacy groups, insurance watchdogs |
| **Target firms** | Large reinsurers (Munich Re, Swiss Re, Axis) and primary insurers |
| **Mechanism** | Shareholder proposals, public campaigns, media pressure, boycotts |
| **Stated goal** | Restrict cat bond use for high-carbon and climate-vulnerable projects |
| **Counterargument** | Cat bonds lower insurance costs, improving risk resilience |
| **Regulatory angle** | Links to climate disclosure and transition planning rules |
| **Scale** | Growing since 2018, accelerated post-2020 |
...
Cat bond activism follows the classic model of [shareholder activism](/wiki/activist-investor-typology/), but with a climate twist:
...
## Links to regulation and transition risk
