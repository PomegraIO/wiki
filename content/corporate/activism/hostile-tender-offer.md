---
title: "Hostile Tender Offer"
description: "A direct appeal to shareholders to acquire their shares, bypassing the board to gain control of a company."
keywords:
...
| Element | Description |
|---------|-------------|
| **Initiator** | Acquirer (often activist or larger competitor) |
| **Target** | Public company with board opposition |
| **Mechanism** | Offer price public; shareholders decide directly |
| **Timeline** | 20–60 days (minimum under SEC rules) |
| **Success rate** | ~30% historically; conditional on activist pressure |
| **Typical stake** | 5–10% public disclosure, then escalation |
...
Hostile takeovers are often preceded by [activist investor](/wiki/activist-investor-typology/) campaigns. An activist builds a 5–10% stake and demands board changes, strategy shifts, or a sale. If the board resists, the activist may encourage a third party to launch a hostile bid, or the activist itself may bid.
...
### Closely related
- [Activist investor typology](/wiki/activist-investor-typology/) — Role of activists in driving hostile bids
- [Poison pill](/wiki/poison-pill/) — Primary defense against hostile takeovers
- [Tender offer](/wiki/tender-offer/) — The formal mechanism of a hostile bid
- [Change of control](/wiki/change-of-control/) — The outcome of a successful hostile acquisition
