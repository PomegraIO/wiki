---
title: "White Knight"
description: "A white knight is a friendly bidder brought in to rescue a company from a hostile takeover attempt. The white knight makes a competing offer that is more attractive to the target's board and shareholders than the hostile bidder's offer."
keywords:
  - white knight
  - friendly bidder
  - hostile takeover
...
|   |   |
|---|---|
| **What it is** | Friendly bidder brought in to outbid a hostile acquirer |
| **Initiated by** | Target's board (not the white knight itself) |
