...
description: "The London Stock Exchange is the largest stock exchange in Europe by market capitalization and one of the oldest in the world. Founded in 1801 and headquartered in the City of London, the LSE lists over 3,000 companies and is the primary venue for UK and many Commonwealth equities."
keywords:
  - LSE
...
The London Stock Exchange began as an informal gathering place for merchants and traders dealing in government bonds and trading company shares. Its formal establishment in 1801 made it the world's oldest continuously operating stock exchange — predating the [New York Stock Exchange](/new-york-stock-exchange) by nearly a century.
...
The LSE operates two primary listing segments: the Main Market and the Alternative Investment Market (AIM). The Main Market hosts large-cap, mature companies with strict listing standards — typically established [public companies](/public-company) and multinational corporations. The FTSE 100 index comprises the 100 largest Main Market stocks.
...
- [Euronext](/euronext) — the largest continental European exchange
- [Frankfurt Stock Exchange](/frankfurt-stock-exchange-deutsche-borse) — Germany's primary exchange
- [Stock market](/stock-market) — the system of all equities
- FTSE 100 — the main LSE index
- [Initial public offering](/initial-public-offering) — how companies list

### Wider context

- [Public company](/public-company) — corporations listing on the LSE
- [Broker](/broker) — intermediaries executing trades
- [Market capitalization](/market-capitalization) — the measure of firm size
- [Asset allocation](/asset-allocation) — how investors position in LSE stocks
- [Diversification](/diversification) — holding multiple LSE stocks
