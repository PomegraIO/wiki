---
title: "JPX – Japan Exchange Group"
description: "Japan Exchange Group is Japan's primary exchange operator, managing the Tokyo Stock Exchange and other trading venues. JPX lists Japanese corporations across all sectors and serves as the gateway to Japan's equity and derivatives markets."
keywords:
  - JPX
...
|   |   |
|---|---|
| **Founded** | 2013 (as consolidated group) |
| **Headquarters** | Tokyo, Japan |
| **Type** | Exchange operator |
| **Regulator** | Financial Services Agency (FSA) |
| **Operator** | Japan Exchange Group Inc. |
| **Operating venues** | TSE, Osaka Exchange, derivatives, clearing |
