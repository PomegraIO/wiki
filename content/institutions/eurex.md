---
title: "Eurex"
description: "Eurex is Europe's leading derivatives exchange, operating futures and options on equities, indices, interest rates, and other underlyings. Headquartered in Frankfurt and operated by Deutsche Börse, Eurex serves institutional investors and traders across Europe and globally."
keywords:
  - Eurex
...
The consolidation was motivated by the same logic that drove the creation of [Euronext](/euronext) in equities: fragmented national derivatives markets were inefficient and unable to compete globally with [CME Group](/cme-group) and other major US derivatives venues. Eurex's creation was part of a broader effort to create pan-European financial infrastructure.

## Equity index and stock options

Eurex operates the most liquid European equity index futures and options markets. The DAX index futures (based on the [Frankfurt Stock Exchange](/frankfurt-stock-exchange-deutsche-borse) DAX) is the primary European equity index derivatives contract. Eurex also trades options and futures on other European indices (Eurostoxx 50, FTSE 100) and on individual stocks across Europe.
...
Eurex operates the most significant European [interest rate](/interest-rate) derivatives market, with futures contracts on German government bonds (Bunds), French OATs, Italian BTPs, and other European fixed-income instruments. These contracts are heavily used by [bond](/bond) traders, banks, and [central banks](/central-bank) managing interest rate risk.

The euro interest rate derivatives market on Eurex is one of the world's most liquid and is essential to European [asset allocation](/asset-allocation) strategies.
...
- [Deutsche Börse](/frankfurt-stock-exchange-deutsche-borse) — parent and equity exchange
- Derivatives — core products
- Futures — primary contracts
- [CME Group](/cme-group) — major competitor
- [CBOE Options Exchange](/cboe-options-exchange) — options competitor
