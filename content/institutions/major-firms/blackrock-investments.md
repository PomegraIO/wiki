---
title: "BlackRock Investments"
description: "World's largest asset management company, managing trillions in client assets globally."
keywords:
  - blackrock
  - asset management
  - index funds
...
*A **BlackRock Investments** reference denotes the world's largest asset manager by assets under management (AUM). As of 2024, BlackRock manages over $10 trillion globally across passive index funds, active strategies, alternatives, and advisory services. The firm is the dominant force in passive [index investing](/wiki/index-fund/), thanks to its iShares ETF platform, and increasingly influential through its [ESG](/wiki/esg-divestment-activism/) policies and investment platforms like Aladdin. BlackRock's scale gives it outsized influence over corporate governance and capital markets.*

<aside class="wiki-infobox">

| Metric | Scale |
|---|---|
| **AUM** | >$10 trillion (2024) |
| **ETFs managed** | ~3,000+ across iShares and other lines |
| **Active strategies** | ~$2 trillion |
| **Passive strategies** | ~$7 trillion |
| **Clients** | Institutional, retail, pension funds, governments |
| **Key platform** | Aladdin (risk analytics and portfolio management) |

</aside>

## Origins and the index revolution

BlackRock was founded in 1988 by Larry Fink and others, initially as a fixed-income and risk analytics firm. In the 1990s, BlackRock acquired and expanded its asset management business. The pivotal moment came with the acquisition and growth of iShares, the [exchange-traded fund](/wiki/etf/) (ETF) platform. As index investing gained acceptance among institutional and retail investors—driven by lower fees, tax efficiency, and the recognition that most active managers underperform—iShares became a cash machine for BlackRock.
...
BlackRock's scale gives it voting power over corporate boards. As a major shareholder in nearly every public company through its index funds, BlackRock influences [proxy voting](/wiki/proxy-voting/) and shareholder proposals. The firm has used this leverage to advocate for [ESG](/wiki/esg-divestment-activism/) practices, board diversity, and climate disclosures.
...
### Closely related
- [Index Fund](/wiki/index-fund/) — BlackRock's primary offering
- [ETF](/wiki/etf/) — iShares platform and products
- [Passive Investing](/wiki/passively-managed-fund/) — Core business model

### Wider context
- [Asset Allocation](/wiki/asset-allocation/) — Client service
- [Proxy Voting](/wiki/proxy-voting/) — Governance influence mechanism
- [ESG Divestment Activism](/wiki/esg-divestment-activism/) — BlackRock's advocacy
