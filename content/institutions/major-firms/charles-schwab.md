...
description: "Leading discount brokerage and financial services provider that democratized retail investing through low commissions and broad market access."
keywords:
  - charles schwab
  - discount brokerage
  - retail investing
...
| Aspect | Detail |
|--------|--------|
| **Founding** | 1971 by Charles Schwab; public 1986; acquired TD Ameritrade 2020 |
| **Revenue model** | Originally commissions; evolved to asset-based fees and banking spreads |
| **Major milestones** | 1975 discount commissions; 1981 options clearing; 1985 automated phone trading; 1998 internet trading |
| **Key products** | Brokerage, banking, advisory, ETFs, research |
| **Market position** | ~$8 trillion in client assets (2023); largest U.S. retail brokerage |
| **Competition** | Fidelity, Merrill Lynch, E-TRADE, Interactive Brokers |
...
In 2020, Schwab acquired TD Ameritrade for $26 billion, capping a decade of industry consolidation. TD Ameritrade was itself a discount broker (spun out from Ameritrade Holdings in the 1990s) with significant retail market share and a strong thinkorswim platform (used by [day-trading](/wiki/day-trading/) and active traders).

The acquisition consolidated Schwab's position as the dominant U.S. retail broker, with the combined entity serving ~13 million retail accounts and managing ~$8 trillion in [asset-allocation](/wiki/asset-allocation/). It also eliminated a competitor and allowed Schwab to migrate TD Ameritrade's customer base to Schwab's platforms over time, creating a unified technology stack.

## Product ecosystem and services

Modern Schwab offers:

**Brokerage and trading**: Commission-free stock, options, and [ETF](/wiki/etf/) trading. The company's platforms (Schwab.com, mobile apps, Street Smart Edge for professional traders) are user-friendly and feature-rich.

**Retirement accounts**: [IRA](/wiki/ira-traditional/) custodial services, [401k](/wiki/401k-plan/) rollovers, and advisory services for retirement planning.
...
2. **Investment advisory fees**: RIA services and managed account programs charge 0.5–1% annually on [assets-under-management](/wiki/asset-turnover-ratio/), generating recurring revenue.
...
4. **Margin lending and securities lending**: Clients borrow on [margin](/wiki/forex-margin/) at spreads; Schwab also lends client securities to short-sellers, earning fees.
...
**Robo-advisor and fintech competition**: Platforms like [Robinhood](/wiki/stock-market/) (zero-commission, highly gamified, options trading) and robo-advisors (low cost, automated [asset-allocation](/wiki/asset-allocation/)) appeal to younger, more tech-savvy investors.
