---
title: "HSBC Bank"
description: "Global banking and financial services conglomerate with operations across investment banking, retail, and commercial banking."
keywords:
  - hsbc
  - hsbc bank
  - investment banking
...
| **Year founded** | 1865 (as Hongkong and Shanghai Banking Corporation) |
| **Assets** | ~$2.9 trillion (as of 2024) |
| **Employees** | ~235,000 globally |
| **Primary divisions** | Wealth and Personal Banking, Commercial Banking, Global Banking and Markets |
| **Key markets** | Hong Kong, UK, US, France, Mexico, UAE, Singapore |
| **Regulatory status** | Systemically important bank (G-SIB); subject to enhanced prudential standards |
...
**Global Banking and Markets** — Investment banking (M&A advisory, debt and equity underwriting), [fixed-income](/wiki/fixed-income-etf/) and equity markets, derivatives, [prime brokerage](/wiki/prime-broker/).
...
- **Interest rate sensitivity** — The bank benefits from rising [interest rates](/wiki/interest-rate/) (net interest margin expansion) but faces pressure in low-rate environments.
- **European weakness** — HSBC's large UK and European footprint is exposed to [slow growth](/wiki/secular-stagnation/), negative rates, and competitive pressure from local banks and fintech competitors.
- **Regulatory burden** — As a G-SIB, HSBC faces strict [capital requirements](/wiki/basel-iii/), leverage limits, and stress-testing regimes that constrain profitability and risk-taking relative to smaller competitors.
- **Compliance costs** — HSBC has been hit by major fines for [AML (anti-money laundering) violations](/wiki/anti-money-laundering/), leading to multibillion-dollar settlements and costly compliance overhauls.

HSBC's return on equity (ROE) has lagged [investment-grade peers](/wiki/investment-grade-bond/) at 9–11%, partly due to regulatory constraints and partly due to legacy cost structures.
...
- **Emerging-market banking** — Leading underwriter and arranger for [emerging-market bonds](/wiki/emerging-market-currency-pairs/) and syndicated loans. This leverages its Asian and Middle East presence.
...
- **Fixed income** — Large government and [corporate bond](/wiki/corporate-bond/) operations, with significant market-making capabilities.

The Global Banking and Markets division generates roughly 40% of HSBC's profit, though it is also the most volatile and capital-intensive (subject to [value-at-risk](/wiki/value-at-risk/) and [leverage](/wiki/leverage-ratio-forex/) constraints).

## Capital Structure and Shareholders

HSBC is a publicly traded company (listed on London Stock Exchange and Hong Kong Stock Exchange). Major shareholders include index funds (BlackRock, Vanguard), institutional investors (pension funds, insurance companies), and individual retail investors. The bank pays a modest [dividend](/wiki/dividend/) yield (typically 3–4%) and has periodically returned capital through [share buybacks](/wiki/share-buyback/).

The bank is subject to strict [capital adequacy requirements](/wiki/basel-iii/). As of 2024, HSBC maintains a Common Equity Tier 1 (CET1) ratio of ~13%, above regulatory minimums (8–11%, depending on jurisdiction), allowing for dividend and buyback capacity.
...
- **Geopolitical exposure** — Significant operations in Hong Kong amid U.S.-China tensions; exposure to [sanctions](/wiki/sanctions-screening/) compliance and regulatory clawback risk.
- **Credit risk** — Large commercial and consumer loan portfolio exposed to economic downturns.
- **Market risk** — [Interest rate](/wiki/interest-rate-option/) and [currency](/wiki/currency-risk/) exposure as a global bank.
...
### Closely related
- [Investment banking](/wiki/goldman-sachs/) — HSBC's major revenue source
- [Trade finance](/wiki/banker-acceptance/) — HSBC's historical strength
- [Global banking](/wiki/jpmorgan-chase/) — peer comparison
- [Capital adequacy](/wiki/basel-iii/) — regulatory constraint on HSBC
- [Anti-money laundering](/wiki/anti-money-laundering/) — compliance challenge
