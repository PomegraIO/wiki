...
<div class="wiki-infobox-title">SWF vs Pension Fund — Key differences</div>

<img src="/svg/institutions.svg" alt="An abstract editorial mark for the topic." />

<div class="wiki-infobox-caption">Same scale, different accountabilities and obligations.</div>

|   |   |
|---|---|
| **Ownership** | SWF: government; Pension: workers and employers |
| **Funded by** | SWF: national budget, resource revenues; Pension: payroll contributions |
| **Liability type** | SWF: discretionary reserves; Pension: defined obligations to members |
| **Time horizon** | SWF: indefinite (intergenerational); Pension: 30–50 years (demographic) |
| **Return pressure** | SWF: flexible, can withstand losses; Pension: must match benefit payouts |
| **Governance** | SWF: political oversight; Pension: trust law, fiduciary duty |
...
In practice, pension funds lean toward liquid public equities and bonds. Sovereign funds are overweight alternatives—[private equity funds](/private-equity-fund/), [hedge funds](/hedge-fund/), real estate, and infrastructure—because they can afford to lock capital away for 10+ years.
...
- Pension Fund — structure and benefit obligations
- [Private Equity Fund](/private-equity-fund/) — major allocation for both, especially SWFs
- [Hedge Fund](/hedge-fund/) — alternative strategy for diversification
- [Real Estate Investment Trust](/real-estate-investment-trust/) — common holding for institutional investors
- [Asset Allocation](/asset-allocation/) — how mandates drive portfolio structure

### Wider context

- [Investment Company Act of 1940](/investment-company-act-of-1940/) — US regulatory framework
- Institutional Investor — broader category of large money managers
- Fiscal Policy — state revenue and spending that feed SWFs
- [Demographic Risk](/demographic-risk/) — the constraint on pension fund liabilities
