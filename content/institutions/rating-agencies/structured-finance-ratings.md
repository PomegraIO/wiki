---
title: "Structured Finance Ratings"
description: "Credit ratings assigned by agencies to securitized instruments such as mortgage-backed and collateralized debt obligations; distinct from corporate ratings."
keywords:
...
*A **Structured Finance Rating** is a credit assessment assigned by agencies such as S&P, Moody's, or Fitch to a securitized product—[mortgage-backed security](/wiki/mortgage-backed-security/), [collateralized debt obligation](/wiki/collateralized-debt-obligation/), [asset-backed security](/wiki/asset-backed-security/)—reflecting the probability that investors in that tranche will receive promised cash flows. These ratings differ from corporate ratings in structure, recovery analysis, and observed accuracy.*

<aside class="wiki-infobox">

| Key Fact | Detail |
|---|---|
| **Focus** | Cash-flow adequacy and subordination protection |
| **Input data** | Underlying loan pools, default and prepayment assumptions, loss severity |
| **Tranche structure** | Ratings vary by subordination (AAA senior, BBB junior, below-investment mezzanine) |
| **Rating methodologies** | Stress tests, Monte Carlo simulations, historical default data |
| **Fee model** | Issuers pay raters ("issuer pays" model, creating conflicts) |
| **Failed prediction** | 2008 crisis: AAA-rated securitizations collapsed to junk status |
| **Post-crisis reform** | Dodd-Frank reduced reliance on ratings; Volcker Rule limited proprietary trading |
| **Agencies** | S&P, Moody's, Fitch dominate; smaller players (DBRS, Kroll) have niche roles |

</aside>

## Core difference from corporate ratings

Corporate credit ratings assess a company's ability to service debt from operating cash flow. A company rated AAA is unlikely to default on bonds. Structured finance ratings assess a pool of underlying assets and the waterfall of cash flows to different tranches. An AAA tranche of a [mortgage-backed security](/wiki/mortgage-backed-security/) is protected by lower tranches that absorb losses first; even if 20% of mortgages default, the AAA tranche may receive full payment because losses are subordinated. The rating is conditional: "AAA given the assumed default and prepayment rates, and given that subordination holds."
...
### Closely related
- [Mortgage-Backed Security](/wiki/mortgage-backed-security/) — primary structured finance product
- [Collateralized Debt Obligation](/wiki/collateralized-debt-obligation/) — complex securitization
- [Asset-Backed Security](/wiki/asset-backed-security/) — related securitization
- [Credit Rating](/wiki/credit-rating/) — corporate rating analog
