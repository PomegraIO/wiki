...
<div class="wiki-infobox-title">Split Credit Ratings — Key Facts</div>

<img src="/svg/institutions.svg" alt="An abstract editorial mark for institutions and market infrastructure." />

<div class="wiki-infobox-caption">When rating agencies disagree, the most conservative rating usually drives pricing and index rules.</div>

|   |   |
|---|---|
| **What causes them** | Agencies use different methodologies, timelines, and information sets |
| **Scale example** | One agency rates BBB, another rates BB (5 notches apart) |
| **Frequency** | ~5–15% of rated issuers have splits; wider splits are rarer |
| **Impact on pricing** | Usually minimal if split is 1 notch; significant if gap is 2+ notches |
| **Index inclusion** | Most indices use conservative rule: single lowest rating or "split treatment" protocol |
| **Investment mandate** | Funds restricted to investment-grade may exclude split-rated debt depending on policy |
| **Market sign** | A split can signal agency disagreement on whether issuer is truly stable |
| **Most common agencies** | Moody's tends to be more optimistic; S&P and Fitch sometimes more conservative |

</aside>

## Why Rating Agencies Disagree

The three major agencies—[Moody's](/credit-rating/), S&P, and Fitch—use similar frameworks but apply them differently. Each has its own rating committee, team of analysts, and proprietary analytical models. They don't always reach the same conclusion.
...
The dividing line between investment-grade (BBB and above) and [junk bond](/junk-bond/) (BB and below) is economically significant. Many institutional investors—[mutual funds](/mutual-fund/), pension funds, insurance companies—have mandates requiring them to hold only [investment-grade bonds](/investment-grade-bond/). A split straddling this boundary creates real friction.
...
This threshold effect means a split at the boundary can be more disruptive than a two-notch split entirely within investment-grade. An issuer rated BBB by Moody's and BB by S&P might be excluded from broad [bond ETFs](/bond-etf/) that demand investment-grade status, depressing its price and yield.

## Market Reaction and Pricing

A split rating alone doesn't change fundamentals; the company's actual business remains unchanged. But markets often interpret a split as a signal of disagreement or analysis difficulty. A sophisticated investor might reason: "If the agencies can't agree, I need more margin of safety," leading to higher [yield spreads](/credit-spread/).
...
However, if the split is just one notch and both agencies rate the issuer as solidly investment-grade or solidly [junk](/junk-bond/), market impact is usually muted. Traders won't pay a large premium or discount for a one-notch debate between Moody's and S&P within the same broad category.
...
Bond [indices](/stock-market/) determine which securities are eligible for inclusion based on ratings criteria. Most indices use a **split-rating rule** to handle disagreement.
...
- [Credit Rating](/credit-rating/) — rating symbols, notches, and agency methods
- [Investment-Grade Bond](/investment-grade-bond/) — what qualifies as investment-grade
- [Junk Bond](/junk-bond/) — below-investment-grade debt
- [Credit Spread](/credit-spread/) — yield premium for credit risk
- [Bond](/bond/) — issuance, trading, and credit analysis

### Wider context

- [Bond ETF](/bond-etf/) — index rules and rating criteria
- [Mutual Fund](/mutual-fund/) — investment mandates and restrictions
- [Securities and Exchange Commission](/securities-and-exchange-commission/) — regulatory oversight of agencies
- [Default Rate](/default-rate/) — empirical performance of rated securities
