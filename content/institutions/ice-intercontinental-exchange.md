...
description: "Intercontinental Exchange is a leading global derivatives, commodities, and data company, headquartered in Atlanta. Operating multiple trading venues, ICE acquired the New York Stock Exchange in 2012 and is one of the largest exchange operators globally."
keywords:
  - ICE
...
| **Type** | Derivatives, commodities, and data company |
| **Regulator** | SEC, CFTC, multiple international regulators |
| **Operator** | Intercontinental Exchange Inc. |
| **Key venues** | NYSE, ICE Futures, ICE Clear |
| **Daily volume** | Billions of dollars |
| **Trading venue** | Electronic |
| **Hours** | 24-hour (continuous) |
