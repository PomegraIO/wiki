---
title: "How Index Providers Make Money"
description: "Licensing fees charged to asset managers for benchmarking and replicating stock indexes."
keywords:
  - how index providers make money
  - index licensing fees
  - index provider revenue model
  - benchmarking licensing
...
<div class="wiki-infobox-title">Index Provider Revenue Model — key facts</div>

<img src="/svg/institutions.svg" alt="An abstract editorial mark for the topic." />

<div class="wiki-infobox-caption">Index providers generate recurring revenue by licensing index methodologies and data to funds and institutions.</div>

|   |   |
|---|---|
| **Primary revenue** | Licensing fees; basis point charge on AUM or flat annual fee per product. |
| **Licensees** | Asset managers (mutual funds, ETFs), insurance companies, banks, exchanges, pension funds. |
| **Fee structure** | Typically 0.5–3 basis points of AUM, or $50,000–$500,000+ per year per product, depending on size and index type. |
| **Secondary revenue** | Data licensing, analytics, index governance services. |
| **Major players** | S&P Dow Jones Indices, MSCI, FTSE Russell, Nasdaq, ICE Data Services. |
| **Business model** | High margins; low marginal cost to license one more index to one more fund. |
...
The most common model is a percentage of the [AUM](/wiki/return-on-invested-capital/) in funds using that index. A typical basis point structure:
...
1. **Use of the index name**: The licensee can call their fund "S&P 500 Index Fund" or similar.
2. **Methodology and rebalancing**: The licensee gets the index rules, the constituent list, and the rebalancing schedule.
3. **Real-time data feeds**: The licensee receives updates on index changes, weights, and performance.
4. **Index governance services**: If an index committee meets to vote on constituent changes, the licensee can participate or get voting rationale.
5. **Performance calculation**: Many index providers calculate and publish index returns for the fund to report.
...
Index providers typically enjoy very high [operating margin](/wiki/operating-margin/)—60–80% of revenue drops to pre-tax profit once the index machinery is in place. There is no inventory, no shipping, and the incremental cost of one more licensee is negligible.
...
- [Index Fund](/wiki/index-fund/) — funds that pay licensing fees to index providers
- [Expense Ratio](/wiki/expense-ratio/) — the cost to end investors, which includes licensing fees
- [Index Reconstitution Frequency](/wiki/index-reconstitution-frequency/) — affects the maintenance cost and licensing complexity
- [Float-Adjusted Market Cap in Index Construction](/wiki/float-adjusted-market-cap/) — a methodology that index providers license
- [Index Exclusion Criteria](/wiki/index-exclusion-criteria/) — rules that index providers maintain and license
- [ETF](/wiki/etf/) — products built on licensed indexes

### Wider context

- [S&P 500 Index](/wiki/sp-500-index/) — the most widely licensed index
- [Market Capitalization](/wiki/market-capitalization/) — the metric underlying index construction and licensing
- [Benchmark](/wiki/index-fund/) — the role indexes play in performance measurement
- [Operating Margin](/wiki/operating-margin/) — the typical high profitability of index provider businesses
