...
description: "The predictable price and volume surge that occurs when a company is announced as a new addition to a major stock index."
keywords:
  - index addition
  - price impact
  - index rebalancing
...
When a company is added to the [S&P 500](/wiki/sp-500-index/) or another major benchmark, every [index fund](/wiki/index-fund/) that tracks that benchmark must mechanically add it to their holdings. A fund managing hundreds of billions of dollars tracking the S&P 500 cannot avoid the addition; it must buy. If dozens of such funds are all forced to buy simultaneously, supply and demand tighten, and the stock price rises.
...
[Index fund](/wiki/index-fund/) and [ETF](/wiki/etf/) managers have no discretion. Their mandate is to track the index as closely as possible. If the index now includes a stock, the fund must own it. Passive [asset managers](/wiki/asset-allocation/) cannot say, "We think this stock is overpriced, so we'll skip it." They must buy.
...
The difference likely depends on why the stock was added. A company added because it has grown organically to meet the index's [market-cap](/wiki/market-capitalization/) threshold probably deserves its higher price. A company added because it merged with an index constituent or because the index methodology changed may be overvalued by comparison.

## Traders exploit the effect

The inclusion effect is one of the few semi-predictable stock-price patterns, and [algorithmic traders](/wiki/algorithmic-trading/) and hedge funds exploit it:
...
The index inclusion effect reveals something important about how markets work. In principle, financial markets are supposed to be [efficient](/wiki/price-discovery/)—prices should reflect all available information instantly. But in practice, mechanical forces (forced index buying, [margin calls](/wiki/margin-call-forex/), or algorithmic stop-loss selling) can push prices away from fundamental value temporarily. The inclusion effect is a benign example; it shows how predictable inflows can create short-term mispricing that savvy investors can anticipate.
...
- [Index Fund](/wiki/index-fund/) — fund that tracks a published index's constituents and weights
- [Stock Index](/wiki/stock-market/) — published index of stocks serving as benchmark or fund track
- [Index Committee](/wiki/index-committee/) — governance body deciding which stocks are added or removed
- [ETF](/wiki/etf/) — exchange-traded fund that may track indexes and participate in inclusion/exclusion trades
- [Algorithmic Trading](/wiki/algorithmic-trading/) — computerized strategy that can exploit predictable price patterns

### Wider context

- [Price Discovery](/wiki/price-discovery/) — process by which market prices converge toward fundamental value
- [Market Capitalization](/wiki/market-capitalization/) — firm size metric determining most index eligibility criteria
- [Volatility](/wiki/historical-volatility/) — standard deviation of returns; often spikes around index rebalances
- [Bid-Ask Spread](/wiki/bid-ask-spread/) — cost of trading that may widen during rebalance surges
