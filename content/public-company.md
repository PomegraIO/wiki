...
description: "A public company is a corporation whose ownership shares trade on a public stock exchange and are freely available for purchase by any investor. Public companies face extensive regulatory requirements, including annual audits, quarterly disclosures, and shareholder voting rights."
keywords:
  - public company
  - publicly traded
  - public listing
...
<div class="wiki-infobox-title">Public company — key facts</div>

<img src="https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=600&q=80" alt="A modern office building housing a public corporation" />

<div class="wiki-infobox-caption">Every name on a stock ticker is a public company — and a great deal of paperwork behind it.</div>

|   |   |
|---|---|
| **What it is** | A corporation whose shares trade on a public exchange |
| **Also called** | Publicly traded, public listed, publicly held |
| **Ownership** | Dispersed across many shareholders |
| **Shares are** | Registered with the SEC, freely tradable |
| **Governed by** | Federal securities law, stock exchange rules, state corporate law |
| **Required filings** | 10-K (annual), 10-Q (quarterly), 8-K (material events) |
| **Audit** | Annual independent audit by certified public accountant |
| **Board of directors** | Elected by shareholders, may be contested |
| **Sarbanes-Oxley** | Mandatory audits, executive certifications, audit committee |
