...
description: "A currency future is an exchange-traded contract to buy or sell a specific quantity of one currency for another at a predetermined price and date. Futures are standardized, margin-based, and settle daily. They are the exchange-traded alternative to OTC forwards."
keywords:
  - currency future
  - FX future
  - currency contract
...
|   |   |
|---|---|
| **What it is** | Exchange-traded currency forward contract |
| **Where traded** | CME (Chicago), EUREX, Singapore Exchange, etc. |
| **Contract size** | Standardized; varies by pair (e.g., 100,000 EUR per contract) |
| **Minimum** | Standardized minimum position (usually 1 contract) |
