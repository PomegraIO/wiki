---
title: "Carry Trade"
description: "A carry trade is a strategy of borrowing in a low-interest-rate currency and investing in a higher-interest-rate currency, profiting from the interest-rate differential. Carry trades are profitable until they unwind, often violently during crises."
keywords:
  - carry trade
...
|   |   |
|---|---|
| **Strategy** | Borrow low, invest high; pocket the differential |
| **Funding currency** | Low-rate currency (JPY, CHF historically) |
| **Investment currency** | High-rate currency (AUD, NZD, BRL, USD in 1990s–2000s) |
| **Profit source** | Interest-rate differential, typically 3–6% annually |
| **Loss trigger** | Funding currency appreciates sharply (unwinding) |
| **Risk** | Convex; small gains, then catastrophic losses |
| **Leverage** | Often 10:1 or higher, amplifying both gains and losses |
