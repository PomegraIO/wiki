---
title: "Crawling Peg"
description: "A crawling peg is an exchange-rate system in which the pegged rate adjusts automatically at regular intervals, usually to offset inflation differentials. Instead of a sudden devaluation, the currency depreciates gradually by design."
keywords:
  - crawling peg
  - moving peg
...
|   |   |
|---|---|
| **What it is** | Peg that adjusts automatically at regular intervals |
| **Frequency** | Monthly, quarterly, or annual adjustments common |
| **Amount** | Designed to offset inflation differential |
| **Predictability** | Markets know when and by how much the peg moves |
| **Credibility** | More credible than soft pegs because adjustment is expected |
| **Examples** | Chile (1980s–1990s), Colombia, Brazil (periods) |
| **Alternative names** | Adjustable peg, moving peg, scheduled devaluation |
