---
title: "Purchasing Power Parity (Forex)"
description: "Theory that exchange rates converge to equalize purchasing power across currencies, linking long-run currency movements to inflation differentials."
keywords:
...
| Version | Definition |
|---------|-----------|
| Absolute PPP | Spot rate = price ratio of identical basket |
| Relative PPP | Change in spot rate = inflation differential |
| Trading use | Identify overvalued/undervalued currencies |
| Time horizon | Long-run (5–10 years); not short-term |
| Assumptions | Tradable goods, no barriers, law of one price |
| Empirical record | Weak in short run; better in very long run |
| Alternatives | [Interest rate parity](/wiki/interest-rate-parity/); PPP is complementary |
...
For these reasons, PPP works better as a **long-run anchor** (10+ years) than a trading signal (1–5 years). In the short run, [interest rate differentials](/wiki/interest-rate-parity/), risk sentiment, and [carry trades](/wiki/carry-trade/) dominate.
...
PPP and [interest rate parity](/wiki/interest-rate-parity/) are complementary:
...
1. **Data quality**: Different countries measure CPI differently; PPP baskets vary. A US/UK PPP rate calculated one way might differ significantly using another methodology.

2. **Time horizon uncertainty**: You're confident the rupee is 25% undervalued vs. PPP, but it could stay cheap for 5 years. Carry costs (interest expense if you're short dollars long rupees) erode profits.

3. **Non-stationary real rates**: PPP assumes a constant real exchange rate in the long run. If productivity growth differs persistently between countries, the real rate may shift, invalidating the PPP equilibrium.

4. **Policy intervention**: Central banks often resist PPP-predicted depreciation (e.g., selling foreign reserves to prop up the currency), delaying convergence indefinitely.
...
### Wider context
- [Foreign Exchange Reserve](/wiki/foreign-exchange-reserve/) — central bank tool
- [Currency Peg](/wiki/currency-peg/) — fixed parity alternative
- [Capital Flows](/wiki/capital-flows/) — driver of actual rates
- [Inflation Targeting](/wiki/inflation-targeting/) — monetary policy anchor
