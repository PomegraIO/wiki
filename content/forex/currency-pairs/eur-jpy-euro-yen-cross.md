---
title: "EUR/JPY: The Euro–Yen Cross Rate"
description: "EUR/JPY cross-rate pair tracks ECB and BOJ policy divergence, functioning as a risk-sentiment barometer for global markets and carry-trade positioning."
keywords:
  - eur jpy cross rate
  - euro yen pair
...
<div class="wiki-infobox-title">EUR/JPY — key facts</div>

<img src="/svg/forex.svg" alt="An abstract editorial mark for forex trading." />

<div class="wiki-infobox-caption">A cross rate that reflects ECB hawkishness and BOJ easing, amplifying risk swings.</div>

|   |   |
|---|---|
| **Quote convention** | Euros per 1 yen (or yen per 1 euro, depending on dealer) |
| **Primary drivers** | ECB, BOJ, risk appetite, [carry-trade](/carry-trade/) flows |
| **Volatility rank** | Moderate-to-high among G10 crosses; spikes on policy surprises |
| **Typical daily range** | 50–150 pips in normal conditions |
| **Key spreads** | Tight: major forex platforms; wider: emerging-market brokers |

</aside>

## Why EUR/JPY Matters

The EUR/JPY pair does two jobs at once. First, it reflects the **interest-rate wedge** between the [eurozone](/european-central-bank/) and Japan: the European Central Bank has held rates positive and often above zero, while the Bank of Japan maintained negative [interest rates](/interest-rate/) and yield-curve control for years. That rate differential creates a natural incentive for carry trades—borrowing yen at minimal cost and investing the proceeds in euro-denominated assets or equities. When that trade is popular, EUR/JPY rises; when it unwinds, the pair crashes.
...
The structural underpinning of EUR/JPY is the **central-bank policy gap**. After the 2008 financial crisis, the BOJ was first to cut rates to near-zero and then into negative territory; it maintained that stance for over a decade, keeping the yen capped and the borrowing cost for carry trades minimal. Meanwhile, the ECB, despite low rates for years, eventually began hiking into 2022–2023 to fight inflation, pushing eurozone [real interest rates](/real-interest-rate/) higher than Japan's.
...
In ordinary market conditions, EUR/JPY trades 50–150 pips per day, roughly in line with other major [currency pairs](/currency-pair-gap-risk-weekend/). The pair is liquid on all major platforms; spreads in the spot market are typically 1–2 pips, widening during Asia-Pacific and New York overlap sessions.

The pair exhibits **strong trend-following behavior** over longer timeframes (weekly to monthly) because interest-rate differentials and risk appetite are themselves persistent. Short-term intraday moves, however, are often driven by technicals, [option-premium](/option-premium/) expirations, or headline reactivity. Traders often look to EUR/JPY as a **barometer before trading equities**: a sharp intraday decline in EUR/JPY can signal that market participants are shifting out of risk assets, making it a useful leading indicator for equity index weakness.

## Key Economic Data and Sensitivity

EUR/JPY moves sharply on:

- **ECB policy meetings and inflation data.** A hawkish ECB decision or hotter-than-expected eurozone [CPI](/consumer-price-index/) tends to strengthen the pair.
...
- **Risk-on/risk-off reversals.** Equity volatility indices, [VIX](/volatility-smile/) spikes, and credit spreads all correlate with EUR/JPY weakness during sell-offs.
...
- [GBP/JPY: Sterling–Yen Volatility Characteristics](/gbp-jpy-sterling-yen-volatility/) — Another yen cross with pronounced carry-trade dynamics
- [Carry Trade](/carry-trade/) — How borrowing in low-yielding currencies creates EUR/JPY demand
- [Central Bank Policy](/central-bank/) — ECB and BOJ decisions that drive the pair's long-term trajectory
- [Currency Pair Gap Risk in Weekends](/currency-pair-gap-risk-weekend/) — Why EUR/JPY can gap sharply at session opens
- [Interest-Rate Risk](/interest-rate-risk/) — How divergent rate expectations reshape cross rates
- [Risk Sentiment and Flight-to-Safety](/recession/) — Why yen strength correlates with equity sell-offs

### Wider context

- [Forex Market Structure](/stock-exchange/) — How spot, forwards, and derivatives trade across currency pairs
- [Currency Volatility](/currency-volatility/) — Drivers of intraday and longer-term swings in major pairs
- [Monetary Policy](/monetary-policy/) — How central banks use rates and guidance to manage expectations
- [Capital Flows](/capital-flows/) — Macroeconomic flows that reprrice currency crosses
