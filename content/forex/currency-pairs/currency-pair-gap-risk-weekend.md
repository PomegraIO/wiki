...
**Major pairs** (EUR/USD, GBP/USD, USD/JPY) typically gap 30–100 pips. The large [liquidity](liquidity-risk) and tight [spreads](bid-ask-spread) in these pairs mean that even if weekend news is significant, it gets distributed across a larger universe of traders, so the gap is cushioned.
...
**Crosses between yen and other G10 currencies** (EUR/JPY, GBP/JPY) are also prone to larger gaps because [carry-trade](carry-trade) positions often build up in these pairs; a single weekend headline (ECB policy shift, [risk-sentiment](momentum-investing) reversal) can trigger large unwinds at the open.
...
- **Equity or bond-market crashes.** A global equity sell-off over the weekend drives money toward the yen, Swiss franc, or US dollar, causing correlated gaps across [currency pairs](currency-pair-gap-risk-weekend).
...
**1) Not holding leveraged positions into the weekend.** The simplest approach: close any [margin-dependent](leverage-ratio-forex) position Friday afternoon. For most active traders, the weekly return is not worth the gap risk.

**2) Using weekend-proof products.** [Options](/option/) with weekend expiration dates provide defined risk: a trader can buy a call or put that expires Saturday, capping their loss to the [option premium](/option-premium/). Some dealers offer weekend-specific options for major pairs.

**3) Forwards and swaps.** A trader can lock in a [forward](forward-contract) exchange rate over the weekend, eliminating gap risk. This trades the gap risk for a known [interest-rate spread](interest-rate-swap).
...
Even without a geopolitical shock, gaps can widen the [bid-ask spread](/bid-ask-spread/) on reopen. Friday's tight 1-2-pip spread on EUR/USD may become 5-10 pips Sunday evening as dealers rebuild their risk inventory and uncertainty is higher. A trader's stop-loss order can execute 8 pips worse than intended simply because there is less liquidity to absorb the order.

For pairs that trade on weekends in small size (crypto-linked pairs, index futures), the reopen spread is often even wider because fewer dealers are active, and those that are have wider [inventory costs](/inventory-turnover/).
...
- [EUR/JPY: The Euro–Yen Cross Rate](/eur-jpy-euro-yen-cross/) — A pair prone to large weekend gaps during sentiment reversals
- [GBP/JPY: Sterling–Yen Volatility Characteristics](/gbp-jpy-sterling-yen-volatility/) — Another carry-heavy pair vulnerable to gap risk
- [Bid-Ask Spread](/bid-ask-spread/) — How spreads widen during low-liquidity periods
- [Leverage and Margin in Forex](/leverage-ratio-forex/) — Why leveraged positions amplify gap losses
- [Options and Protective Strategies](/option/) — Hedging gap risk with defined-risk instruments
- Geopolitical Risk and Currency Markets — How political shocks drive currency gaps

### Wider context

- [Forex Market Structure](/stock-exchange/) — Session times and liquidity across regions
- [Currency Volatility](/currency-volatility/) — Intraday and longer-term price swings
- [Risk Management](/position-sizing/) — Sizing and stop-loss strategies
- [Capital Flows and Currency Repricing](/capital-flows/) — How news drives rapid repricing
