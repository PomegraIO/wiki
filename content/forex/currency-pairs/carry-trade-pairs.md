---
title: "Carry Trade Pairs"
description: "Currency pairs selected to exploit interest-rate differentials, where investors borrow in low-yield currencies and invest in high-yield currencies."
keywords:
  - currency trading
...
*A **carry-trade pair** is a [currency pair](/wiki/currency-pair/) chosen specifically to profit from interest-rate differentials. An investor borrows funds in a low-interest-rate currency (e.g., Japanese yen) and converts them to a high-interest-rate currency (e.g., Australian dollar or Turkish lira), then invests the proceeds in bonds or deposits. The profit is the interest-rate spread, minus any [currency depreciation](/wiki/currency-volatility/).*

<aside class="wiki-infobox">

| Element | Role |
|---|---|
| **Funding currency** | Low interest rate (JPY, CHF, EUR) |
| **Investment currency** | High interest rate (AUD, NZD, TRY, MXN, BRL) |
| **Profit source** | Interest-rate differential per annum |
| **Risk** | Currency depreciation can wipe out interest gains |
| **Volume** | Billions in aggregate; leveraged carry is popular |
| **Volatility trigger** | Risk-off environment unwinds carry trades quickly |
...
In a frictionless world, [interest-rate parity](/wiki/interest-rate-parity/) would eliminate carry opportunities. If the interest-rate differential is 3.5% (AUD – JPY), then covered interest-rate parity predicts that the forward AUD/JPY exchange rate should be 3.5% lower (AUD is expected to depreciate 3.5% over the year to offset the interest gain). In that case, a trader locking in the forward rate would earn zero.
...
The [flashcrash](/wiki/flash-crash-2010/) potential is real. In March 2020, the COVID-19 shock triggered simultaneous carry-trade unwinding, margin calls, and forced selling. [Central bank](/wiki/central-bank/) intervention (including currency-swap lines) was necessary to stabilize markets.

This is why institutional investors treat carry as a risk-management problem, not just a return generator. A hedge fund with a 3.5% carry-trade position is also exposed to the risk of a 10–20% crash if risk-off sentiment emerges. Hedging via [FX options](/wiki/fx-option/) or [volatility](/wiki/volatility-swap/) positions is common.
...
### Closely related
- [Carry trade](/wiki/carry-trade/) — The broader strategy
- [Currency pair](/wiki/currency-pair/) — The instrument
- [Interest-rate parity](/wiki/interest-rate-parity/) — The theoretical relationship
- [FX volatility surface](/wiki/fx-volatility-surface/) — Pricing of currency hedges

### Wider context
- [Foreign exchange reserve](/wiki/foreign-exchange-reserve/) — Central-bank tool for intervention
- [Currency hedging](/wiki/currency-hedging/) — Risk management for currency positions
- [Emerging markets fund](/wiki/emerging-markets-fund/) — Broader asset-class exposure
- [Risk-on risk-off](/wiki/risk-on-risk-off/) — Macro sentiment driver
