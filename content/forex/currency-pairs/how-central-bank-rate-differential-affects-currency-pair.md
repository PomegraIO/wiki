---
title: "How Interest Rate Differentials Drive Currency Pairs"
description: "How interest rate differentials between central banks move currency pairs through capital flows, carry trades, and expectation channels."
keywords:
  - interest rate differential currency pair
  - how interest rate differential affects currency pair
  - central bank policy rate and currency
  - carry trade interest rates
  - currency appreciation lower rates
image: "/svg/forex.svg"
---
...
3. Invest dollars at 5%
4. Pocket the 3% spread
...
Central banks control the **overnight rate** (federal funds rate, ECB deposit rate). But the entire [yield curve](https://en.wikipedia.org/wiki/Yield_curve) — spanning overnight to 30-year rates — influences currency pairs. 
...
- [Carry trade](/carry-trade/) — the investment strategy that exploits interest rate differentials
- [Forward guidance](/forward-guidance/) — how central banks shape expected future rates and currency expectations
- [Currency risk](/currency-risk/) — how exchange-rate moves create losses or gains for international investors
- [Monetary policy](/monetary-policy/) — the broader mechanisms by which central banks influence economies
- [Spot rate](/spot-rate/) — the immediate exchange rate, which rate differentials move

### Wider context

- [Central bank](/central-bank/) — institutions that set interest rates and target currency stability
- [Interest rate](/interest-rate/) — the price of borrowing, the foundation of rate differentials
- [Market pricing](/price-discovery/) — how traders incorporate new information into currency rates
- [Forex market](/stock-exchange/) — the decentralized global marketplace where currencies trade
