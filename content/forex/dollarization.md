---
title: "Dollarization"
description: "Dollarization is the adoption of a foreign currency (usually the US dollar) as a country's medium of exchange. Official dollarization replaces the domestic currency entirely; unofficial dollarization occurs when residents use foreign currency alongside the domestic currency."
keywords:
  - dollarization
...
|   |   |
|---|---|
| **What it is** | Adoption of US dollar (or foreign currency) as own currency |
| **Official** | Central bank replaces domestic currency |
| **Unofficial** | Residents use dollars despite legal domestic currency |
| **No central bank power** | Cannot print or control money supply |
| **Seigniorage loss** | Revenue from money creation goes to the US |
| **Examples** | Ecuador (official), El Salvador (official), Zimbabwe (unofficial) |
| **Advantage** | Eliminates inflation; credible commitment |
| **Disadvantage** | Loss of all monetary policy; dependence on US |
