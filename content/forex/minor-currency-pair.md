---
title: "Minor Currency Pair"
description: "Minor currency pairs, also called cross-rates, are currency pairs that do not involve the US dollar. They include pairs like EUR/GBP, AUD/JPY, and GBP/CHF. While less liquid than majors, minors trade actively and serve key cross-border transactions."
keywords:
  - minor currency pair
  - cross-rate
  - FX cross
...
|   |   |
|---|---|
| **What it is** | Two major currencies with no dollar involved |
| **Also called** | Cross-rate, cross pair |
| **Examples** | EUR/GBP, AUD/JPY, GBP/CHF, EUR/CHF |
| **Market share** | ~10% of daily FX volume |
| **Spreads** | Moderate; wider than majors, tighter than exotics |
| **Liquidity** | Good; less than majors, more than exotics |
| **How priced** | Often constructed from two dollar pairs |
| **Trade hours** | Liquid in overlapping regional sessions |
