...
description: "A non-deliverable forward (NDF) is a currency forward contract that settles in cash rather than through physical delivery of the currencies. NDFs are used to hedge exposure to currencies that are restricted or illiquid, particularly in emerging markets."
keywords:
  - NDF
...
|   |   |
|---|---|
| **What it is** | A forward contract settled in cash, not currency |
| **Used for** | Hedging restricted or illiquid currencies |
| **Settlement** | Difference between forward rate and spot rate, in dollars |
| **Common pairs** | USD/CNH, USD/INR, USD/BRL, USD/MXN |
| **Maturity** | Typically 3 to 12 months |
| **Pricing** | Spot plus interest-rate differential, like standard forwards |
| **Market** | Over-the-counter; large institutional sizes only |
