---
title: "Leverage Ratio (Forex)"
description: "The ratio of notional position size to account equity in currency trading, which determines margin requirements and drawdown exposure."
keywords:
  - leverage ratio
  - forex
  - margin
...
*The **leverage ratio** in forex is the ratio of notional position size to account equity. A ratio of 50:1 means a trader with $10,000 in equity controls $500,000 notional value. Leverage amplifies both gains and losses, determines [margin call](/wiki/margin-call-forex/) thresholds, and is heavily regulated; U.S. forex dealers are capped at 50:1 for major pairs and 20:1 for emerging-market currencies.*

<aside class="wiki-infobox">

| Aspect | Value/Description |
|--------|------------------|
| Formula | Notional position size ÷ Account equity |
| U.S. retail cap | 50:1 (majors); 20:1 (minors/exotics) |
| Institutional leverage | Up to 100:1 or higher |
| Common retail ratio | 20:1 to 50:1 |
| Margin requirement | 1 ÷ leverage ratio (e.g., 50:1 = 2% margin) |
| Drawdown risk | Scales linearly with leverage |
...
### Closely related
- [Margin Call (Forex)](/wiki/margin-call-forex/) — forced liquidation trigger
- [Value at Risk](/wiki/value-at-risk/) — loss quantification
- [Drawdown Risk Measure](/wiki/drawdown-risk-measure/) — equity erosion metric
- [Position Sizing](/wiki/order-types/) — capital allocation discipline

### Wider context
- [Forex Margin](/wiki/forex-margin/) — required deposit per notional
- [CFTC Regulator](/wiki/cftc-regulator/) — U.S. leverage limit authority
- [Currency Pair](/wiki/currency-pair/) — underlying instruments
- [Bid-Ask Spread (Forex)](/wiki/bid-ask-spread-forex/) — slippage cost at leverage
- [Risk Appetite](/wiki/market-risk/) — willingness to lever
