---
title: "Currency Wars"
description: "Competitive attempts by central banks to devalue their currencies to boost exports and employment, without regard to spillover effects on trading partners."
keywords:
...
*A **currency war** is a period of escalating [currency devaluation](/wiki/currency-intervention/) by countries competing for trade advantage. Each country attempts to weaken its currency (make exports cheaper, imports dearer) to support domestic [employment](/wiki/unemployment-rate/) and growth, often triggering retaliation from trading partners and harming global trade and investment.*

<aside class="wiki-infobox">

| Aspect | Detail |
|--------|--------|
| **Economic impact** | Boosts exports, raises import costs, shifts demand between countries |
| **Trade effect** | Lower currency → cheaper exports → higher export volumes |
| **Motivation** | Support domestic jobs and growth, especially during recessions |
| **Spillover** | Harms trading partners, creates retaliatory policies |
| **Policy tools** | [Central bank](/wiki/central-bank/) intervention, [quantitative easing](/wiki/quantitative-easing/), capital controls |
| **Historical examples** | 1930s, 2010s post-crisis era |
...
4. **Raise inflation** — imported goods cost more, pushing [inflation](/wiki/inflation/) higher, which can erode real [debt](/wiki/debt-to-equity-ratio/) and attract capital

## Historical context: the 2010s

The phrase "currency war" gained prominence after the 2008 financial crisis, when central banks deployed [quantitative easing](/wiki/quantitative-easing/) (large-scale asset purchases that expand the [money supply](/wiki/monetary-base/)) to combat deflation and [recession](/wiki/recession/). The unintended side effect: lower [interest rates](/wiki/central-bank-interest-rates/) made each country's currency less attractive to investors seeking yield, so currencies weakened.
...
- **Brazil** and emerging markets of [capital controls](/wiki/capital-control-policy/) to limit inflows and weaken currencies
...
The result is a **race to the bottom**: all countries devalue simultaneously, nullifying each other's gains and harming global trade. In the 1930s, a true currency war preceded the Great Depression as countries abandoned the [gold standard](/wiki/gold-standard/), devalued competitively, and imposed tariffs. Global trade collapsed.
...
### Closely related
- [Currency Intervention](/wiki/currency-intervention/) — central bank actions to influence exchange rates
- [Currency Devaluation](/wiki/currency-peg/) — lowering the official or market value of a currency
- [Quantitative Easing](/wiki/quantitative-easing/) — central bank asset purchases that expand money supply
