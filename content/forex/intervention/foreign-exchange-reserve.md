...
description: "Accumulated foreign assets held by a central bank for market stabilization and sovereign backing."
keywords:
...
| Aspect | Detail |
|---|---|
| **Custodian** | Central bank (e.g., Federal Reserve, ECB, PBOC) |
| **Composition** | US dollars, euros, gold, SDRs, bonds, other foreign assets |
| **Size by country** | China (~$3.2T), Japan (~$1.3T), Germany (~$275B) |
| **Primary use** | Currency stabilization, intervention, confidence |
| **Adequacy measure** | Months of imports; portfolio of external liabilities |
| **Strategic debate** | Currency wars; when intervention is justified |
...
1. **Foreign currency deposits**: USD (primary), EUR, GBP, JPY, CHF. USD is most common because it's the global reserve currency.
2. **Foreign government bonds**: US Treasuries, German bunds, Japanese government bonds. These earn interest and are liquid.
3. **Gold**: Physical bullion held in vaults (Fort Knox in the US, vaults in London and Switzerland for others).
4. **Special Drawing Rights (SDRs)**: Claims on the IMF usable for balance-of-payments support.
5. **Other liquid assets**: Foreign stocks (rare), corporate bonds, central bank swaps, supranational bonds (World Bank, Asian Development Bank).
...
If a country faces sudden capital outflows (investors fleeing political risk, external shocks), the central bank can deploy reserves to meet foreign debt obligations and prevent default. For example, during the [Asian Financial Crisis (1997)](/wiki/asian-financial-crisis/), the IMF and central banks deployed reserves to stabilize currency and prevent banking collapse.

### 3. Backing the currency
Historically, currencies were backed by gold (the [gold standard](/wiki/gold-standard/)). Though fiat currencies are no longer gold-backed, reserves still provide confidence that a central bank can meet its obligations and defend the currency. Large reserves signal strength; depleted reserves raise default risk.
...
1. **Sell USD from its reserves** and simultaneously **buy pesos** in the foreign exchange market.
2. This increases demand for pesos, supporting the exchange rate.
3. If the intervention is large enough and credible, speculators may reverse course, ending the selling pressure.
...
1. **Sell yen** from domestic reserves and **buy USD**.
2. This increases USD supply in the market and increases demand for yen (creating downward pressure on the yen-dollar rate, weakening the yen).
...
The [G20](/wiki/about/) and IMF guidelines state that intervention should target **smoothing excessive volatility**, not engineering permanent devaluation. In practice, the line is blurry, and major countries (particularly China) are sometimes accused of reserve manipulation to keep their currencies artificially weak.
...
The post-WWII [Bretton Woods](/wiki/bretton-woods-agreement/) system pegged currencies to gold and the dollar. Though the gold standard collapsed in 1971, the dollar's reserve role persisted. Some economists debate whether this system is sustainable or destined to fragment into regional blocs.

## Relation to other concepts

- **[Currency intervention](/wiki/currency-intervention/)**: Active deployment of reserves to stabilize or move the exchange rate.
- **[Currency peg](/wiki/currency-peg/)**: Maintaining a fixed exchange rate requires reserves.
- **[Balance of payments](/wiki/current-account-deficit/)**: Reserve flows are part of the capital account.
- **[Monetary policy](/wiki/monetary-policy/)**: Sterilized intervention affects money supply.

<div class="wiki-seealso">

### Closely related
- [Currency intervention](/wiki/currency-intervention/) — active use of reserves
- [Foreign exchange (forex)](/wiki/forex-leverage/) — market where reserves are deployed
- [Currency peg](/wiki/currency-peg/) — requires reserves to maintain
- [Central bank](/wiki/central-bank/) — custodian of reserves

### Wider context
- [Balance of payments](/wiki/current-account-deficit/) — reserves offset deficits
- [Bretton Woods](/wiki/bretton-woods-agreement/) — historical reserve system
- [IMF bailout](/wiki/imf-bailout/) — draws on country reserves
- [Capital controls](/wiki/capital-control-policy/) — often used alongside reserves
