...
description: "A currency board is an institutional arrangement that constrains a central bank to maintain a fixed exchange rate by requiring 100% reserve backing in the anchor currency. Currency boards eliminate discretionary monetary policy but prevent devaluation."
keywords:
  - currency board
  - institutional peg
  - 100 percent reserve
...
|   |   |
|---|---|
| **What it is** | Institutional peg with mandatory reserve backing |
| **Reserve requirement** | 100% foreign currency backing of domestic money supply |
| **Legal constraint** | Cannot issue currency without matching reserves |
| **Devaluation** | Legally impossible without dismantling the board |
| **Monetary policy** | Eliminated; automatic adjustment via money supply |
| **Interest rates** | Must follow anchor currency; no autonomy |
| **Examples** | Hong Kong, Estonia, Bulgaria, Bosnia |
| **Advantage** | Maximum credibility; no devaluation risk |
