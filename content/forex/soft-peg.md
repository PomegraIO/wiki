---
title: "Soft Peg"
description: "A soft peg is a currency peg that the central bank commits to defend but will adjust if economic conditions deteriorate. Soft pegs offer flexibility but less certainty than hard pegs, and are vulnerable to speculative attacks."
keywords:
  - soft peg
  - adjustable peg
  - crawling peg
...
|   |   |
|---|---|
| **What it is** | Peg the central bank will adjust if needed |
| **Credibility** | Market assumes it may be devalued |
| **Flexibility** | Central bank reserves right to change |
| **Cost of doubt** | Higher interest rates (risk premium) to defend |
| **Vulnerability** | Attacks if capital flees and reserves dwindle |
| **Examples** | Pre-1997 Thailand, pre-1994 Mexico, many emerging markets |
| **Duration** | Months to years; unstable in crises |
