---
title: "Margin"
description: "Margin in FX is the deposit required from a trader to hold a leveraged position. It is not a fee or a loan; it is a fraction of the notional exposure held in a collateral account. When losses consume the margin, the broker forces liquidation."
keywords:
  - margin
  - forex margin
  - margin requirement
...
|   |   |
|---|---|
| **What it is** | Deposit required to hold leveraged position |
| **Not a fee** | It remains your money; you earn interest on it (sometimes) |
| **Not a loan** | No interest charged (usually) |
| **Calculation** | Position size ÷ leverage ratio |
| **Example** | 50:1 leverage requires 2% in margin |
| **Margin call** | Triggered at typical 2–5% remaining margin |
| **Liquidation** | Broker force-closes positions if margin falls below minimum |
