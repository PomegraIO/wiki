---
title: "FX Swap"
description: "An FX swap is a simultaneous purchase and sale of a currency at two different rates and dates. A company buys currency spot and sells it forward, locking in an interest-rate cost. FX swaps are used for short-term hedging and funding."
keywords:
  - FX swap
  - currency swap
  - spot and forward
...
Not to be confused with an interest-rate swap (a different instrument, used for hedging interest-rate risk). For currency options, see [currency option](/currency-option/).
...
|   |   |
|---|---|
| **What it is** | Simultaneous spot and forward transaction |
| **Legs** | Spot (immediate) and forward (future) |
| **Purpose** | Financing, liquidity, funding arbitrage |
| **Direction** | Can be long spot/short forward or vice versa |
| **Cost** | Determined by interest-rate differential |
| **Market** | Interbank OTC; trillions daily volume |
| **Counterparties** | Banks to banks, banks to corporates |
...
1. **Spot leg:** The bank sells euros for dollars at the current [spot rate](/spot-exchange-rate/), say EUR/USD = 1.0850. It receives dollars.
2. **Forward leg:** Simultaneously, the bank agrees to sell dollars for euros at the 3-month [forward rate](/forward-exchange-rate/), say 1.0750. It commits to returning euros.
...
**Central banks** use FX swaps to provide dollar liquidity to their domestic banking system. During the 2008 financial crisis and again in March 2020 (pandemic), the [Federal Reserve](/federal-reserve/) offered unlimited FX swaps to other central banks. These were emergency financing tools.
...
**Exporters and importers** use FX swaps less often than [forward contracts](/fx-forward/), but sometimes do when they need to park currency for a few months.
...
- [Spot exchange rate](/spot-exchange-rate/) — the first leg of a swap
- [Forward exchange rate](/forward-exchange-rate/) — the second leg of a swap
- [FX Forward](/fx-forward/) — similar but different structure
- Interest rate parity — determines swap points
- [Interest rate](/interest-rate/) — the differential drives swap costs

### Wider context

- [Central bank](/central-bank/) — major user of FX swaps
- Currency intervention — sometimes uses swaps
- [Carry trade](/carry-trade/) — can exploit swap point anomalies
