---
title: "Petrocurrency vs Petrodollar: Key Differences"
description: "Understand the distinction between petrocurrencies (currencies of major oil exporters) and the petrodollar system (oil priced in dollars globally)."
keywords:
  - petrocurrency vs petrodollar
  - petrocurrency definition
  - petrodollar system
  - oil exporting currency
  - reserve currency petrodollar
image: /svg/forex.svg
---

*The **petrocurrency vs petrodollar** distinction matters because they describe different phenomena. A petrocurrency is any currency that gains strength from a country's petroleum exports; the petrodollar system is the global arrangement where crude oil trades in US dollars. One is a property of an exporting nation's money; the other is a pricing convention that underpins global energy markets.*

<aside class="wiki-infobox">

<div class="wiki-infobox-title">Petrocurrency vs Petrodollar — key facts</div>

<img src="/svg/forex.svg" alt="An abstract editorial mark for the topic." />

<div class="wiki-infobox-caption">Two overlapping but distinct concepts in energy and currency markets.</div>

|   |   |
|---|---|
| **Petrocurrency** | Any currency strengthened by oil export revenues (e.g. Norwegian krone, Saudi riyal) |
| **Petrodollar** | The US dollar as the standard medium for global crude oil settlement |
| **Key origin** | Petrocurrency is a natural consequence of resource wealth; petrodollar emerged formally post-1945 US–Saudi agreement |
| **Mutual reinforcement** | Petrodollars inflate the dollar's demand and the US dollar's reserve role amplifies petrocurrency effects |
| **Geographic scope** | Petrocurrencies are national; the petrodollar system is global |
| **Reversibility** | Petrocurrency strength can fade if commodity prices collapse; the petrodollar requires coordinated reshuffling of global oil trade |
...
The **petrodollar system** is a different animal. It refers to the arrangement whereby crude oil is priced and settled in US dollars on global markets. This is partly a convention (traders chose dollars because they were stable and liquid) and partly a consequence of post-World War II geopolitics.
...
Conflating the two leads to confused policy and forecasting. Some observers argue that the petrodollar system is collapsing because petrocurrencies are diversifying (e.g., China's renminbi rising, Saudi Arabia signing trade deals in local currency). But those are changes in how individual petrocurrencies perform, not changes in the petrodollar system itself. Oil is still priced in dollars; the distinction is simply that exporters now hold more of their reserves in other currencies.
...
- [Exorbitant Privilege Explained](/exorbitant-privilege-explained/) — US dollar's unique borrowing and seigniorage advantages as the dominant reserve currency
- [Currency Composition of Official Foreign Exchange Reserves](/currency-composition-of-official-foreign-exchange-reserves/) — How central banks allocate reserves across currencies, including petrodollar holdings
- [Bancor: Keynes's Proposed International Currency](/bancor-keynes-international-currency-proposal/) — Failed 1944 alternative to dollar-centred global currency system
- [Currency Risk](/currency-risk/) — How exchange rate fluctuations affect investment returns and trade
- [Central Bank](/central-bank/) — How monetary authorities manage reserves and currency stability
