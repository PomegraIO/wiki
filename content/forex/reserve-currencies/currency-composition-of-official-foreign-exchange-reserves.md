...
description: "COFER tracks how central banks allocate their foreign exchange reserves across currencies, revealing shifts in reserve diversification and confidence in global currency hierarchies."
keywords:
  - currency composition official foreign exchange reserves
  - cofer imf
...
<div class="wiki-infobox-title">COFER — key facts</div>

<img src="/svg/forex.svg" alt="An abstract editorial mark for the topic." />

<div class="wiki-infobox-caption">The IMF's window into global reserve currency trends and central bank risk management.</div>

|   |   |
|---|---|
| **COFER stands for** | Currency Composition of Official Foreign Exchange Reserves |
| **Published by** | International Monetary Fund (quarterly) |
| **Covers** | Central bank and other official foreign exchange holdings across ~180 countries |
| **Main currencies tracked** | US dollar, euro, yen, pound sterling, Swiss franc, Chinese yuan, other |
| **Data availability** | Public quarterly releases since 1999; earlier data from IMF archives |
| **Key metric** | Percentage and absolute value of reserves held in each currency |
| **Interpretation** | Shifts signal reserve diversification, confidence in reserve currencies, and geopolitical currency alignments |

</aside>

## What COFER Measures

Central banks and other official institutions (like sovereign wealth funds with reserve components) hold foreign exchange reserves — buffers of foreign currency, precious metals, and special drawing rights (SDRs) — to manage [currency risk](/currency-risk/), finance imports, and provide firepower in balance-of-payments crises. COFER is the International Monetary Fund's public catalogue of how those reserves are distributed.
...
A single central bank might hold 60% of reserves in [US dollars](/us-dollar/), 20% in euros, 10% in yen, and 10% in other currencies or gold. Why diversify if the dollar is the safest?

First, diversification reduces [currency risk](/currency-risk/). If a bank holds only dollars and the dollar appreciates sharply, the real purchasing power of reserves denominated in other currencies erodes. A euro-based importer, for instance, may find that dollar reserves are worth less in euro terms.
...
## Reading COFER Trends

The COFER dataset is a sensitive indicator of shifts in global finance. Several trends have become visible:

**Dollar still dominant but plateauing.** The dollar's share of global reserves has held around 59–62% for the last decade, stable from much higher levels in the 1990s. This suggests the dollar retains [exorbitant privilege](/exorbitant-privilege-explained/) but is not gaining ground.
...
Academics and analysts use COFER to test theories about the [international monetary system](/central-bank/). The persistence of dollar dominance, despite relative US economic decline, is partly explained by the absence of viable alternatives — a concept related to [exorbitant privilege](/exorbitant-privilege-explained/) and, historically, to debates over whether an international reserve currency like [Keynes's bancor](/bancor-keynes-international-currency-proposal/) might have prevented such concentration.
...
COFER will likely continue to show gradual diversification as emerging-market currencies gain liquidity and as central banks seek to reduce concentration risk. However, the structural advantages of the [US dollar](/us-dollar/) — deep, liquid [asset markets](/balance-sheet/), rule of law, and network effects (everyone else holds dollars) — are sticky. Unless a coordinated alternative emerges (a possibility mooted by proposals for a supranational currency, echoing [Keynes's 1944 bancor concept](/bancor-keynes-international-currency-proposal/)), the dollar's dominance is likely to persist, even if its share gradually declines.
...
- [Exorbitant Privilege Explained](/exorbitant-privilege-explained/) — The borrowing and seigniorage advantage of the US dollar's reserve-currency role
- [Petrocurrency vs Petrodollar](/petrocurrency-vs-petrodollar/) — Oil's role in dollar demand and the petrodollar system
- [Bancor: Keynes's Proposed International Currency](/bancor-keynes-international-currency-proposal/) — Alternative supranational currency architecture rejected in 1944
- [Central Bank](/central-bank/) — Role of monetary authorities in managing reserves and currency stability
- [Currency Risk](/currency-risk/) — How exchange-rate movements affect reserve valuations
