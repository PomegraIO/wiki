...
description: "The currency of Australia, classified as a resource currency sensitive to China trade cycles, commodity prices, and interest-rate differentials versus major currencies."
keywords:
  - australian dollar
  - aud
  - resource currency
...
*The **Australian Dollar** (AUD, ticker AUD/USD) is the official currency of Australia and a major [reserve currency](/wiki/foreign-exchange-reserve/) in Asia-Pacific markets. It is classified as a [commodity currency](/wiki/commodity-currency-pairs/) highly sensitive to global commodity prices and China's economic cycles.*
...
|--------|--------|
| Country | Australia |
| Ticker | AUD/USD (primary pair) |
| Classification | Commodity currency, high-yield carry |
| Primary driver | China trade, commodity prices, interest rates |
| Central bank | Reserve Bank of Australia (RBA) |
| Major pairs | AUD/USD, AUD/JPY, EUR/AUD |
| Trading volume | 4th largest currency (5%+ of forex volume) |
| Benchmark rates | RBA cash rate (policy rate) |
...
The AUD/USD pair is the most liquid and widely traded. It represents the direct value of the Australian Dollar against the US Dollar. The [USD/AUD](/wiki/aud-usd-aussie-dollar/) (inverse pair) is quoted in Australia and Asia. The AUD/JPY is a popular carry-trade pair, exploiting the interest-rate differential between Australia and Japan (where rates are near zero). The EUR/AUD is traded in European markets.

Exporters (Australian mining firms, agricultural companies) often hedge AUD weakness by selling AUD [forward](/wiki/fx-forward/) at locked-in rates, protecting export revenues from FX depreciation. Importers (companies buying US or European goods) hedge by buying AUD forward, locking in costs. Central banks and sovereign wealth funds hold AUD as a diversification tool and hedge against China-specific risk.

## Volatility and liquidity characteristics

The AUD is more volatile than the USD or EUR but less volatile than emerging-market currencies. Daily moves of 1–2% are common; moves exceeding 2% are significant. The volatility is driven by commodity price shocks, China data releases, and RBA policy surprises. Liquidity is high in major pairs (AUD/USD) and lower in cross pairs (AUD/CHF). The [bid-ask spread](/wiki/bid-ask-spread-forex/) in AUD/USD is typically 0.5–2 pips for retail traders, tighter for institutional flows.

The currency exhibits "risk-on/risk-off" behavior. During periods of global risk appetite (low [volatility](/wiki/volatility-smile/)), carry-trade unwinds are less likely, and AUD strengthens on commodity optimism. During risk-off periods (market stress, [equity sell-offs](/wiki/bear-market/)), carry traders unwind by selling AUD and buying safe-haven currencies (USD, JPY, CHF). The AUD has been called a "risk sentiment indicator" because of this correlation.
