---
title: "Spread"
description: "A spread in FX is the difference between the bid and ask prices of a currency pair. On major pairs, spreads are typically 1–2 pips; on exotic pairs, 10–50+ pips. The spread is the immediate cost of entering and exiting a trade."
keywords:
  - spread
  - bid-ask spread
  - FX costs
...
|   |   |
|---|---|
| **Definition** | Ask price minus bid price |
| **Measured in** | Pips |
| **Major pairs** | 0.5–2 pips (wholesale); 1–3 pips (retail) |
| **Minor pairs** | 2–5 pips |
| **Exotic pairs** | 10–50+ pips |
| **Fixed vs. variable** | Variable spreads widen in volatile markets |
| **Instant cost** | Spread × lot size × pip value |
