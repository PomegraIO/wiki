---
title: "Coffee"
description: "Coffee is the world's second-most-traded commodity (after crude oil) and is derived from coffee beans cultivated in tropical regions. Prices are volatile and weather-dependent."
keywords:
  - coffee
  - commodity
  - beverage
...
|   |   |
|---|---|
| **What it is** | The roasted and ground seeds of coffee cherries (berries) |
| **Global consumption** | ~9 million tonnes of green (unroasted) coffee annually |
| **Primary varieties** | Arabica (~60%, higher quality) and Robusta (~40%, higher yield) |
| **Major producers** | Brazil (~35%), Vietnam (~20%), Colombia (~8%), Indonesia (~8%), others (~29%) |
| **Trading venues** | ICE (London) and NYBOT (New York) for both Arabica and Robusta futures |
| **Typical price** | Arabica: $1.50–2.50/lb; Robusta: $0.70–1.50/lb |
| **Seasonal pattern** | Slight seasonality from harvest cycles in different regions |
| **Price volatility** | 40–60% annual moves common; highly volatile |
| **Global trade value** | ~$30 billion annually; major trade commodity |
...
- [Cocoa](/cocoa/) — competing tropical specialty commodity
- [Sugar](/sugar/) — often consumed with coffee
- Commodity bubble — coffee exhibits extreme cycles
- ICE Futures — primary coffee trading venue
- [Brazil](/central-bank/) — dominates global supply

### Wider context

- Agricultural commodity — specialty crop
- [Weather risk](/inflation/) — frost and drought spike prices
- [Climate change](/central-bank/) — threatens traditional growing regions
- [Inflation](/inflation/) — coffee spikes affect CPI
- Speculation — traders amplify price moves
- [Farmer poverty](/asset-allocation/) — volatile prices hurt small producers
