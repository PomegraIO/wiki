---
title: "Orange Juice"
description: "Orange juice is a commodity derived from oranges, traded in futures markets as frozen concentrate. Its price is highly volatile and vulnerable to frost and disease."
keywords:
  - orange juice
  - commodity
  - citrus
...
|   |   |
|---|---|
| **What it is** | Citrus juice from oranges; traded as frozen concentrate (FCOJ) |
| **Trading venue** | ICE (New York) for FCOJ futures |
| **Typical price** | $0.50–2.00 per pound of concentrate; extremely volatile |
| **Major producers** | Brazil (~70% of global supply), USA (~20%), others (~10%) |
| **US production** | Florida (~90% of US OJ); trees take 4–7 years to mature |
| **Crop cycle** | Plant to production is 4–7 years; long supply lag |
| **Price volatility** | Extreme; 50–100% annual moves common |
| **Supply risk** | Frost (Florida) and disease (citrus greening) can destroy yields |
| **Contract size** | 15,000 pounds of concentrate per contract |
...
- [Frost risk](/inflation/) — Florida's primary price driver
- [Citrus disease](/recession/) — structural headwind for Florida
...
- [Weather risk](/inflation/) — frost spikes prices sharply
- [Disease risk](/recession/) — citrus greening threatens supply
- Speculation — traders amplify price moves
- [Inflation](/inflation/) — OJ spikes affect beverage costs
