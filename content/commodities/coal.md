---
title: "Coal"
description: "Coal is a fossil fuel burned primarily for electricity generation and steel production. Its use is declining in developed countries due to climate concerns, but grows in emerging markets."
keywords:
  - coal
  - fossil fuel
  - electricity
...
|   |   |
|---|---|
| **What it is** | A solid fossil fuel (carbon + minerals + water) formed from ancient plants |
| **Types** | Thermal coal (electricity) and coking coal (steel); prices differ 2–3x |
| **Global consumption** | ~8 billion tonnes annually (though declining in developed countries) |
| **Primary uses** | Electricity generation (~65%), steel production (~25%), other (~10%) |
| **Major producers** | China (~50%), India (~12%), US (~5%), Australia (~5%) |
| **Major consumers** | China (~55%), India (~15%), US (~8%), Japan (~3%) |
| **Trading hubs** | Newcastle (Australia), not centralized like crude oil |
| **Typical price** | Thermal coal $60–200/tonne; coking coal $150–400/tonne |
| **Transport-dependent** | Sea freight costs are ~30% of delivered price for Australia coal |
| **Carbon content** | ~2 tonnes CO₂ per tonne of coal burned |
...
Developed economies have transitioned away from coal (US, Europe, Japan) toward [natural gas](/natural-gas/) and renewables. However, total global coal consumption peaked only recently (2013) and remains near those levels, sustained by emerging-market growth.
...
China produces half of global coal and consumes 55% of it. China's dominance in coal production and consumption means global coal prices are set by Chinese supply-demand, similarly to how [copper](/copper/) prices are dominated by Chinese demand.
...
- **US**: Coal generation fell from 50% of electricity (2005) to ~20% (2023) due to cheap [natural gas](/natural-gas/) and renewable incentives.
...
This decline reflects the [economics](/interest-rate/) of renewables (now cheaper than coal in most regions), environmental regulation (carbon taxes, cap-and-trade), and public pressure.
...
However, coal prices are less volatile than oil or [natural gas](/natural-gas/), because coal demand is slower-moving and less weather-sensitive.

## How coal trades

Coal is not traded on major futures exchanges like oil or [natural gas](/natural-gas/). Instead, coal is traded OTC via negotiations between miners, traders, and utilities.
...
- [Natural gas](/natural-gas/) — cleaner alternative to coal
- [Steel](/steel/) — coking coal is essential to steel production
- [Iron ore](/iron-ore/) — reduced by coking coal in blast furnaces
- [Electricity as commodity](/electricity-as-commodity/) — primary end-use
- Mining stock — leveraged coal exposure

### Wider context

- [Renewable energy](/central-bank/) — replacing coal in developed countries
- [Carbon emissions](/inflation/) — coal's primary environmental cost
- [Inflation](/inflation/) — coal prices affect electricity costs
- [Recession](/recession/) — coal demand collapses in downturns
- [China](/central-bank/) — dominates supply and demand
- [Energy transition](/central-bank/) — long-term structural decline
