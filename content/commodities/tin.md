---
title: "Tin"
description: "Tin is a base metal whose primary uses are solder and tinplate. It is among the rarest base metals and its supply is geographically concentrated in Southeast Asia."
keywords:
  - tin
  - base metal
  - solder
...
|   |   |
|---|---|
| **What it is** | A base metal element (Sn, atomic number 50) |
| **Primary uses** | Solder (~40%), tinplate (~25%), bronze/alloys (~15%), other (~20%) |
| **Annual production** | ~350,000 tonnes |
| **Annual demand** | ~350,000 tonnes |
| **Currency unit** | Tonne, quoted on London Metal Exchange |
| **Typical price** | $7–15 per pound (among highest-priced base metals) |
| **Major producers** | Indonesia (~35%), Myanmar (~20%), China (~12%), Peru (~8%) |
| **Recycling rate** | ~25% of supply (low compared to other metals) |
| **Supply volatility** | High; vulnerable to mine disruptions |
| **Geographic concentration** | Southeast Asia produces ~60% of global supply |
...
Because global tin demand is only ~350,000 tonnes annually (tiny compared to [copper](/copper/) or [aluminum](/aluminum/)), a disruption of 5–10% of supply can trigger sharp price spikes. Conversely, rapid supply increases (from new mine capacity or import liberalization) can crash prices.
...
Unlike [lead](/lead/) (85% recycled) or [aluminum](/aluminum/) (50% recycled), tin recycling is limited at roughly 25% of supply. This reflects the difficulty and cost of recovering tin from complex electronics (separation is expensive) and the lack of large, concentrated scrap sources like aluminum cans or batteries.
...
- [Copper](/copper/) — primary base-metal comparison
- [Lead](/lead/) — solder companion metal
- [Zinc](/zinc/) — tinplate coating alternative
- [Aluminum](/aluminum/) — alternative for beverage cans
- London Metal Exchange — primary tin trading venue
- Mining stock — leveraged tin exposure
- [Electronics demand](/stock-market/) — primary driver of solder use

### Wider context

- [Supply concentration](/central-bank/) — Indonesia and Myanmar risk
- Volatility — tin is among the most volatile base metals
- [Recycling](/diversification/) — low rates limit supply cushion
- [Conflict minerals](/inflation/) — ethical and regulatory concerns
- Commodity bubble — tin cycles dramatically
- [Emerging markets](/bull-market/) — electronics demand driver
