---
title: "Lean Hogs"
description: "Lean hogs is a commodity contract for pigs raised for pork production. Prices are driven by feed costs, particularly corn, and pork demand from consumers."
keywords:
  - lean hogs
  - pork
  - livestock
...
This entry covers lean hogs as a commodity contract. For competing meat, see [live cattle](/live-cattle/); for feed input, see [corn](/corn/).
...
|   |   |
|---|---|
| **What it is** | Live pigs for pork production (feeder piglets to finished hogs) |
| **Trading venue** | CME Group (CBOT) with very high liquidity |
| **Contract size** | 40,000 pounds (roughly 150–200 hogs) for lean hog futures |
| **Typical price** | $70–90 per 100 pounds; highly cyclical |
| **Global production** | ~1.5 billion pigs slaughtered annually; China is largest consumer |
| **Production cycle** | 5–6 months from birth to slaughter (vs. 18+ months for cattle) |
| **Feed cost** | ~50% of pork production cost (lower than cattle due to efficiency) |
| **Primary feed** | [Corn](/corn/) and [soybean meal](/soybean-meal/) |
| **China market** | Consumes 50%+ of global pork; African swine fever outbreaks spike prices |
| **Seasonal pattern** | Mild; some peaks in spring and fall |
...
Feed costs are ~50% of pork production costs, lower than for beef due to superior feed conversion. [Corn](/corn/) and [soybean meal](/soybean-meal/) are the primary inputs.
...
- [Live cattle](/live-cattle/) — competing meat commodity
- [Corn](/corn/) — primary feed input
- [Soybean meal](/soybean-meal/) — protein feed supplement
- CME Group — primary lean hog futures venue
- [China](/central-bank/) — dominates global pork demand

### Wider context

- Agricultural commodity — livestock production
- [Feed costs](/corn/) — driver of pork economics
- [Meat demand](/stock-market/) — primary price driver
- [Disease risk](/recession/) — African swine fever disrupts supply
- Herd cycles — hog cycles are rapid (18–24 months)
- [China](/central-bank/) — consumption dominance creates leverage
