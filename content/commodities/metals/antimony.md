---
title: "Antimony"
description: "Brittle metalloid element used extensively in semiconductor manufacturing, flame retardants, and specialty alloys for industrial applications."
keywords:
  - antimony metal
  - semiconductors
  - flame retardants
...
| **Density** | 6.68 g/cm³ |
| **Melting point** | 630°C |
| **Chief ore** | Stibnite (Sb₂S₃) |
| **Primary producers** | China, Vietnam, Myanmar, Russia |
| **Annual production** | ~150,000 metric tons |
| **Main end uses** | Flame retardants (40%), electronics (25%), alloys (20%) |
...
### Closely related
- [Rare Earth Metals](/wiki/rare-earth-metals/) — similar geopolitical supply issues
- [Copper](/wiki/copper/) — major commodity with deeper [futures](/wiki/futures-contract/) market
- [Iron Ore](/wiki/iron-ore/) — compare supply concentration and trading
- [Commodity Futures](/wiki/commodity-futures-trading-commission/) — trading mechanics
- [Semiconductor](/wiki/asic-mining/) — antimony's chief end market

### Wider context
- [Commodity Swap](/wiki/commodity-swap/) — [hedging](/wiki/commodity-price-hedging/) structure
- [Commodity Price Hedging](/wiki/commodity-price-hedging/) — risk management
- [Basis Risk](/wiki/basis-risk/) — relevant to antimony forwards
- [Commodity Index Fund](/wiki/commodity-index-fund/) — commodity exposure vehicles
- [Mining-Related Investment](/wiki/mining-bitcoin/) — exposure through stocks
