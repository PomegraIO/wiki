---
title: "Hafnium"
description: "Refractory metal used in nuclear reactor control rods and high-temperature aerospace applications."
keywords:
  - hafnium
  - refractory metal
...
| Primary Source | Zircon ore separation |
| Control Rod Role | Neutron absorber in fission reactors |
| Commercial Form | Sponge, powder, ingots |
| Annual Production | ~100 metric tons globally |
...
Hafnium and zirconium are chemically inseparable in nature — they always occur together in zircon (zirconium silicate), the principal ore. Extracting pure hafnium requires expensive solvent extraction or fractional crystallization techniques. A ton of zircon ore yields only a small quantity of hafnium oxide; this fundamental scarcity keeps hafnium prices elevated relative to other transition metals and constrains global supply. Most hafnium is recovered as a byproduct when zircon is processed for zirconium metal production, so hafnium output depends on demand for zirconium in ceramics and nuclear fuel cladding.
...
The supply chain runs from zircon mining → ore concentration → chemical extraction (hafnium chloride or fluoride) → reduction to metal sponge → consolidation into ingots and final shapes. Investors encounter hafnium via:

- **Mining companies** that produce zircon and tin-bearing sands (e.g., major ilmenite–zircon producers in Africa and Australia).
- **Specialty chemical refiners** that fractionally crystallize hafnium from zirconium, a capital-intensive operation.
- **Aerospace contractors** hedging raw-material exposure via forward contracts.
- **Commodity futures and over-the-counter contracts**, though trading volume is thin compared to copper or aluminum.
