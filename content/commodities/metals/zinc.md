---
title: "Zinc"
description: "Zinc is a base metal essential to galvanizing steel and brass production. Its price is sensitive to construction cycles and is a key component of weatherproofing applications."
keywords:
  - zinc
  - base metal
  - galvanizing
...
|   |   |
|---|---|
| **What it is** | A base metal element (Zn, atomic number 30) |
| **Primary uses** | Galvanizing steel (~50%), brass alloys (~15%), die-castings (~15%), other (~20%) |
| **Annual production** | ~13 million tonnes |
| **Annual demand** | ~13 million tonnes |
| **Currency unit** | Tonne, quoted on London Metal Exchange |
| **Typical price** | $0.8–2 per pound |
| **Major producers** | China (~25%), Australia (~15%), Peru (~8%), Canada (~7%) |
| **Construction share** | ~50% of demand (galvanizing for steel protection) |
| **Recycling rate** | ~30% of supply comes from recycled scrap |
...
Brass — an alloy of [copper](/copper/) and zinc — accounts for roughly 15% of zinc demand. Brass is valued for its corrosion resistance and aesthetics, and is widely used in plumbing fixtures, valves, ammunition casings, and decorative applications. Brass demand is far less cyclical than galvanizing demand.
...
Unlike [copper](/copper/) (dominated by Chile and Peru) or [nickel](/nickel/) (dominated by Indonesia), zinc supply is more fragmented. China, Australia, Peru, and Canada are the major producers, with no single country commanding more than 25% of supply. This fragmentation reduces geopolitical concentration risk but also makes supply shocks less predictable.

Zinc ore is often mined as a byproduct of [copper](/copper/) and [lead](/lead/) operations. When those metals are depressed in price, zinc mining may slow, constraining supply. Conversely, a surge in [copper](/copper/) mining increases zinc supply as a byproduct.

## Recycling limitations

Zinc recycling is limited compared to [aluminum](/aluminum/). Roughly 30% of supply comes from recycled scrap, mostly from brass and galvanized steel. The remaining 70% must come from mining.
...
- [Copper](/copper/) — often mined alongside zinc
- [Lead](/lead/) — companion byproduct metal
- [Steel](/steel/) — galvanized steel is zinc's primary market
- [Aluminum](/aluminum/) — alternative lightweight metal
- London Metal Exchange — primary zinc trading venue
- Mining stock — leveraged zinc exposure
- [Brass](/aluminum/) — zinc-copper alloy for plumbing

### Wider context

- [Recession](/recession/) — construction demand collapses in downturns
- [China](/central-bank/) — dominates supply and demand
- [Construction cycle](/bull-market/) — primary demand driver
- [Infrastructure investment](/asset-allocation/) — long-term demand support
