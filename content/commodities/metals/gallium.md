---
title: "Gallium"
description: "Semiconductor element critical for solar cells, integrated circuits, and optoelectronic devices, extracted as a byproduct from bauxite and zinc mining."
keywords:
  - gallium
  - semiconductor metal
  - solar cells
...
|---|---|
| **Atomic Number** | 31 |
| **Density** | 5.9 g/cm³ (solid); liquid at 30°C |
| **Primary Use** | Integrated circuits (optoelectronic, RF) |
| **Secondary Use** | Photovoltaic solar cells |
| **Extraction** | Byproduct of bauxite and zinc mining |
| **Major Producers** | China, Russia, Germany, Ukraine |
| **Market Form** | High-purity ingots (99.9999% pure) |
| **Supply Constraints** | Limited primary ore; byproduct economics |
...
### Closely related
- [Semiconductors](/wiki/asic-mining/) — primary application
- [Integrated Circuits](/wiki/blockchain-fundamentals/) — end-use product
- [Solar Cells](/wiki/renewable-displacement/) — space and concentrated photovoltaics
- [Rare Earth Metals](/wiki/rare-earth-metals/) — similar supply dynamics
