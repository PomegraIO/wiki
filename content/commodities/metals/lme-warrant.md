...
*An **LME warrant** is a transferable title document issued by an [LME](/london-metal-exchange/)-approved warehouse operator, proving ownership of a specific quantity and grade of base metal held in custody. It bridges the [London Metal Exchange](/london-metal-exchange/)'s futures markets to the physical assets that underpin them, allowing traders to claim delivery or trade the metal's ownership without physical movement.*

<aside class="wiki-infobox">

<div class="wiki-infobox-title">LME Warrant — key facts</div>

<img src="/svg/commodities.svg" alt="An abstract editorial mark for commodities markets." />

<div class="wiki-infobox-caption">The legal ownership certificate for metal held in approved warehouses, tradeable separately from the futures contract.</div>

|   |   |
|---|---|
| **What it is** | Warehouse receipt and title document for base metals |
| **Issuer** | LME-accredited warehouse operators (independent storage facilities) |
| **Metals covered** | Copper, aluminium, zinc, lead, nickel, tin |
| **Trading venue** | Bilaterally over-the-counter; often settled through LME clearing |
| **Ownership proof** | Legal title to metal; transferable via endorsement |
| **Redemption** | Holder can demand physical metal or sell the warrant |
| **Published data** | Daily warrant stocks and movements reported by the LME |

</aside>

## From Futures Contract to Physical Metal

When an [LME futures contract](/futures-contract/) settles at expiration, the buyer has a choice: accept cash settlement or demand physical delivery. If delivery is elected, the exchange transfers a warrant—or sometimes a set of warrants if the lot size exceeds a single warehouse batch—to the buyer's account. The warrant certifies that *this specific metal, at this specific location, in this specific grade and quantity* is held in trust by the warehouse operator.
...
1. Buy physical copper or warrants from a warehouse
2. Sell the LME three-month futures contract
3. Wait for contract expiration or roll it forward
4. Deliver the warrant at settlement, collecting the futures price
5. Pocket the spread, net of storage and financing costs
...
- [London Metal Exchange](/london-metal-exchange/) — the exchange setting benchmark prices and managing warrant accreditation
- [Futures Contract](/futures-contract/) — the standardised derivative contracts settled via warrant delivery
- [Gold Lease Rate](/gold-lease-rate/) — the cost of financing precious metals, analogous to base-metal carry economics
- Cash-and-Carry Trade — arbitrage between spot and futures prices using warrants
- [Contango](/contango/) — forward prices exceeding spot, rewarding warrant holders with carry returns

### Wider context

- Commodity Market — the global system for trading physical and derivative commodities
- [Price Discovery](/price-discovery/) — how markets converge on equilibrium via arbitrage
- [Over-the-Counter Market](/over-the-counter-market/) — bilateral warrant trading between dealers
- [Backwardation](/backwardation/) — when spot prices exceed forward, tightening physical inventory
