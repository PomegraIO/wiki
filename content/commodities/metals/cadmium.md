---
title: "Cadmium"
description: "Toxic transition metal used historically in rechargeable batteries, electroplating, and industrial pigments; now heavily regulated in many jurisdictions."
keywords:
  - toxic metal
...
|---|---|
| **Atomic number** | 48 |
| **Primary sources** | Zinc ore, copper ore (byproduct) |
| **Chief uses** | Ni–Cd batteries, electroplating, pigments |
| **Toxicity** | Chronic exposure damages kidneys, bones |
| **EU status** | Largely banned (RoHS, WEEE directives) |
| **Price driver** | Industrial demand, recycling supply |
...
Cadmium futures trade on the London Metal Exchange (LME), though volumes are modest compared to [copper](/wiki/copper/) or [zinc](/wiki/zinc/). Primary cadmium is produced as a refinery byproduct during [zinc](/wiki/zinc/) smelting; rising zinc demand indirectly boosts cadmium supply. Recycling of Ni-Cd batteries and electroplating waste also supplies the market, and recycling rates are rising as regulation tightens.
...
- [Commodity storage costs](/wiki/commodity-storage-costs/) — Warehousing and treatment overhead
- [Rare earth metals](/wiki/rare-earth-metals/) — Other regulated industrial metals
- [Industrial production index](/wiki/industrial-production-index/) — Proxy for metal demand
