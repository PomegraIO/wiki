...
*The cost to store physical gold varies dramatically depending on whether you choose allocated vaults, pooled vaults, or banks, and whether you layer insurance on top. Understanding these structures and their pricing lets you calculate the true carrying cost of owning bullion instead of gold futures or an [ETF](/etf/).*

<aside class="wiki-infobox">

<div class="wiki-infobox-title">Gold Storage Costs — key facts</div>

<img src="/svg/commodities.svg" alt="An abstract editorial mark for the topic." />

<div class="wiki-infobox-caption">Storage costs range from pennies per ounce annually in pooled vaults to dollars per ounce in allocated arrangements.</div>

|   |   |
|---|---|
| **Pooled vault annual fee** | 0.1% to 0.5% of gold's value (lowest cost) |
| **Allocated vault annual fee** | 0.5% to 2% of gold's value (insurance included often) |
| **Bank safe deposit box** | $50–$500 per year flat (no insurance) |
| **Insurance cost** | 0.05% to 0.3% annually if bought separately |
| **Minimum positions** | Pooled: none; allocated: 100+ oz; banks: variable |
| **Best for** | Pooled: passive holdings; allocated: estate planning, custody demands |
...
To evaluate storage, annualize the cost as a percentage of gold's value and compare it to alternatives like [gold ETFs](/gold-standard/), which charge [expense ratios](/expense-ratio/) of 0.1% to 0.4% but hold futures contracts or bars in custodial accounts you cannot physically withdraw.
...
- [Commodity Markets](/crude-oil/) — how physical bullion relates to futures and spot prices
- [Spot Exchange Rate](/spot-exchange-rate/) — instantaneous gold pricing
- [Basis Risk](/basis-risk/) — cost difference between spot and stored gold
- [ETF](/etf/) — alternative structure for gold exposure
- [Expense Ratio](/expense-ratio/) — annual fund costs as percentage of assets

### Wider context

- [Central Bank](/central-bank/) — major holders of official gold reserves
- [Inflation](/inflation/) — historical reason for gold accumulation
- [Currency Risk](/currency-risk/) — vaults in different jurisdictions expose you to exchange moves
- [Custody](/custodian/) — broader concept of asset safekeeping
