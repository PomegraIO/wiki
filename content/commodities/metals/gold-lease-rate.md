...
<div class="wiki-infobox-title">Gold Lease Rate — key facts</div>

<img src="/svg/commodities.svg" alt="An abstract editorial mark for commodities markets." />

<div class="wiki-infobox-caption">The cost of borrowing gold from central banks, typically collateralised by financial guarantees or other assets.</div>

|   |   |
|---|---|
| **What it is** | Annual interest rate on borrowed gold bullion |
| **Borrower profile** | Bullion banks, mining companies, jewellery fabricators |
| **Lender profile** | Central banks, official institutions, large private holders |
| **Typical rate range** | 0.5% to 2% per annum (highly variable) |
| **Fixing mechanism** | Over-the-counter bilateral negotiations; no central auction |
| **Settlement** | Usually spot or short-dated forward delivery |
| **Collateral** | Typically financial securities or other metal, not cash |
| **Term length** | 1 month to 10+ years; often rolled or terminated |
...
- [LBMA Good Delivery](/lbma-good-delivery/) — the accreditation standard for bars lent and traded in the lease market
- [London Metal Exchange](/london-metal-exchange/) — the base-metals analogue, where [contango](/contango/) and carry costs link to lease-like rates
- [Interest Rate](/interest-rate/) — the return on cash, which competes with gold-carry profitability
- [Contango](/contango/) — forward prices exceeding spot, rewarding gold-carry trades and leasing
- [Central Bank](/central-bank/) — the primary lender of gold reserves at the lease rate

### Wider context

- [Hedge Fund](/hedge-fund/) — institutional investors executing gold-carry trades and other arbitrage strategies
- Hedging — how mining companies manage price risk via gold leases and forwards
- [Price Discovery](/price-discovery/) — how lease rates reflect supply-demand balance in physical bullion
- [Inflation](/inflation/) — gold's inflation hedge role, competing for capital against nominal interest-bearing assets
