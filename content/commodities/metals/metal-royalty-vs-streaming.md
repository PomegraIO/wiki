---
title: "Metal Royalty vs Streaming: How They Differ"
description: "A metal royalty vs streaming agreement difference lies in payment structure: royalties take a percentage of revenue; streaming companies prepay for metal at a fixed cost."
keywords:
  - metal royalty vs streaming
  - royalty agreement
  - streaming agreement
  - gold streaming
  - mining investment
...
<div class="wiki-infobox-title">Royalties and Streaming Agreements — key facts</div>

<img src="/svg/commodities.svg" alt="An abstract editorial mark for the topic." />

<div class="wiki-infobox-caption">Two ways financiers gain metal exposure without operating mines.</div>

|   |   |
|---|---|
| **Payment trigger** | Royalty: production volume or revenue; Streaming: contracted volume at fixed price |
| **Upfront capital** | Royalty: usually minimal; Streaming: $100M–$500M+, sometimes billions |
| **Price exposure** | Royalty: high leverage to spot prices; Streaming: limited, capped at contract price |
| **Duration** | Royalty: life of mine; Streaming: often 10–40+ years |
| **Typical rate** | Royalty: 2–5% of revenue or metal; Streaming: $300–$700/oz gold, $0.10–$0.25/lb copper |
| **Investor returns** | Royalty: 8–15% IRR on production growth; Streaming: 12–20%+ on capital deployed |
| **Operator flexibility** | Royalty: minimal impact on ops; Streaming: obligates metal delivery at low price |
...
- [Commodity Futures](/futures-contract/) — trading mechanism for metals; contrasts with streaming fixed pricing
- [Capital Flows](/capital-flows/) — streaming is a capital flow from finance to mining companies
- [Hedge Fund](/hedge-fund/) — some streaming companies operate hedge fund structures
- [Market Risk](/market-risk/) — both structures expose investors to commodity market volatility
- [Concentration Risk](/concentration-risk/) — streaming and royalties often concentrate on single assets
