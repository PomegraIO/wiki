...
*The **Gold Forward Offered Rate** (GOFO) was a key benchmark measuring the cost to borrow gold in the forward market. Derived from the gold lease rate and [LIBOR](/libor/), GOFO reflected the spread between lending gold and lending cash, signalling physical supply tightness when it went negative—a rare and closely watched signal in the central banking and commodity trading world.*

<aside class="wiki-infobox">

<div class="wiki-infobox-title">Gold Forward Rate (GOFO) — key facts</div>

<img src="/svg/commodities.svg" alt="An abstract editorial mark for the topic." />

<div class="wiki-infobox-caption">GOFO was published daily by the London Bullion Market Association; negative readings suggested physical gold was scarce and expensive to borrow.</div>

|   |   |
|---|---|
| **Formula** | GOFO = [LIBOR](/libor/) − [Gold Lease Rate](/gold-lease-rate/); measured in basis points (0.01%). |
| **Publication** | Daily by the London Bullion Market Association (LBMA) until its discontinuation in 2015. |
| **Interpretation** | Positive GOFO: normal; gold lenders are paid (via gold lease rate) less than cash lenders, reflecting gold supply abundance. Negative GOFO: gold is in short supply; lenders demand premium to lend gold instead of cash. |
| **Typical range** | 10–100 basis points in calm markets; occasionally hit 150–200 bps in stress periods. |
| **Negative episodes** | Late 1990s (central bank sales uncertainty), 2008 (financial crisis hoarding), 2011–2013 (physical demand surge), 2020 (pandemic supply disruption). |
| **Discontinuation** | LBMA stopped publishing GOFO in August 2015, citing low liquidity in the underlying gold lease market. |
...
- [Gold Lease Rate](/gold-lease-rate/) — cost of borrowing physical gold
- [LIBOR](/libor/) — benchmark interest rate component
- [Gold](/gold/) — supply, demand, storage
