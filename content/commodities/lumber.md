---
title: "Lumber"
description: "Lumber (softwood timber) is a construction material commodity whose price is driven by residential construction cycles and the strength of homebuilding demand."
keywords:
  - lumber
  - timber
  - construction
...
|   |   |
|---|---|
| **What it is** | Softwood timber from pine, spruce, and fir trees; structural framing |
| **Global production** | ~400 million cubic meters annually |
| **Primary use** | Residential construction (~60%), industrial (~20%), other (~20%) |
| **Major producers** | Canada (~30%), US (~25%), Russia (~15%), others (~30%) |
| **Trading mechanism** | Futures on CME (Random Length Lumber contract); regional spot markets |
| **Typical price** | $400–1,400 per thousand board feet; highly cyclical |
| **Price swings** | Common to see 50–100% annual moves (housing cycle driven) |
| **Crop cycle** | Timber takes 40–60 years to mature; supply is inelastic short-term |
| **Substitutes** | Engineered lumber, steel framing, concrete; price competitiveness matters |
...
- Construction commodity — related building materials
- [Housing starts](/stock-market/) — primary demand driver
- [Residential construction](/asset-allocation/) — end-use demand
- CME Group — primary lumber futures venue
- [Canada](/central-bank/) — largest global lumber exporter

### Wider context

- [Recession](/recession/) — housing downturns crash lumber prices
- [Homebuilding](/stock-market/) — primary demand driver
- Commodity bubble — extreme price cycles
- [Inflation](/inflation/) — lumber spikes affect construction costs
- [Environmental regulation](/central-bank/) — supply constraints
- [Supply chain](/interest-rate/) — lumber shortages affect construction timelines
