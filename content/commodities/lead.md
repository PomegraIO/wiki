---
title: "Lead"
description: "Lead is a base metal whose primary use is battery production, especially for automotive starting batteries. Its price is linked to vehicle production and recycling rates are high."
keywords:
  - lead
  - base metal
  - battery
...
|   |   |
|---|---|
| **What it is** | A base metal element (Pb, atomic number 82) |
| **Primary uses** | Automotive batteries (~65%), industrial batteries (~10%), other (~25%) |
| **Annual production** | ~13 million tonnes (mostly recycled) |
| **Annual demand** | ~13 million tonnes |
| **Currency unit** | Tonne, quoted on London Metal Exchange |
| **Typical price** | $0.6–1.5 per pound |
| **Recycling rate** | ~85% of supply (highest of all major metals) |
| **Major producers** | China (~50%), Australia (~10%), India (~7%), US (~5%) |
| **Mine supply** | ~2 million tonnes annually (rest from recycling) |
| **Automotive exposure** | ~65% of demand (starting batteries) |
...
- [Zinc](/zinc/) — often mined alongside lead
- [Copper](/copper/) — base metal comparison
- [Nickel](/nickel/) — battery application comparison
- [Lithium](/lithium/) — advanced battery technology alternative
- London Metal Exchange — primary lead trading venue
- Mining stock — leveraged exposure to lead production
- [Recycling](/diversification/) — the dominant supply source for lead

### Wider context

- [Electric vehicle](/central-bank/) — long-term threat to automotive lead demand
- [Recycling efficiency](/asset-allocation/) — lead's most important property
- [Health concerns](/inflation/) — environmental factors affecting lead use
- Commodity bubble — lead cycles with auto production
- [Recession](/recession/) — vehicle production falls in downturns
