---
title: "Aluminum"
description: "Aluminum is the most abundant metallic element in Earth's crust and a base metal essential to transportation, packaging, and construction. Its production is energy-intensive and price-sensitive to electricity costs."
keywords:
  - aluminum
  - base metal
  - lightweight
...
This entry covers aluminum as a traded commodity. For the companies that refine and roll aluminum, see mining stock; for price discovery, see London Metal Exchange.
...
|   |   |
|---|---|
| **What it is** | A base metal element (Al, atomic number 13) |
| **Abundance** | Most abundant metal in Earth's crust (~8% of crust) |
| **Primary uses** | Transportation (aircraft, vehicles), packaging, construction, electrical |
| **Annual production** | ~65 million tonnes |
| **Annual demand** | ~65 million tonnes |
| **Currency unit** | Tonne (metric ton), quoted on London Metal Exchange and COMEX |
| **Typical price** | $1.5–3 per pound |
| **Major producers** | China (~35%), Russia (~12%), Canada (~9%), Australia (~7%) |
| **Recycling rate** | ~50% of supply comes from recycled material |
| **Energy cost fraction** | 25–35% of production cost; driven by electricity prices |
...
Aluminum is 100 times more abundant than [copper](/copper/) in Earth's crust, yet its price often exceeds copper's by 20–30%. This paradox reflects the energy requirement and the value of the refined product.
...
This diversity of end-uses makes aluminum demand more stable than [copper](/copper/) demand. A construction slowdown hurts [copper](/copper/) far more than aluminum, because aluminum still has significant non-construction demand.
...
Retail access is primarily via commodity-index funds, mining stocks focused on aluminum production, or aluminum-specific [ETFs](/etf/). Direct futures exposure is available but less common for retail investors than [copper](/copper/) or precious metals.
...
- [Copper](/copper/) — primary industrial-metals comparison
- [Zinc](/zinc/) — another base metal used in construction
- [Lead](/lead/) — often smelted alongside aluminum
- [Iron ore](/iron-ore/) — the largest industrial metal
- [Steel](/steel/) — the dominant structural metal
- London Metal Exchange — primary aluminum trading venue
- Mining stock — leveraged exposure via producers
- [Bauxite ore](/iron-ore/) — the raw material for aluminum refining

### Wider context

- Commodity bubble — aluminum cycles with industrial demand
- [Electricity costs](/interest-rate/) — the largest driver of aluminum production economics
- [Recycling](/diversification/) — critical to aluminum supply
- [Lightweight transportation](/stock-market/) — long-term demand driver for aluminum
- [Carbon regulation](/inflation/) — increasingly affects aluminum pricing
- [China](/central-bank/) — dominates global aluminum production
