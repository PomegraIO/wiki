---
title: "Livestock Spreads"
description: "Profitable trading opportunities between different livestock futures contracts based on price relationships and seasonal patterns."
keywords:
  - commodity trading
  - livestock futures
  - spread trading
...
| Type | Basis |
|---|---|
| **Cattle crush spread** | Live cattle price vs. feed cost |
| **Hog crack spread** | Live hogs vs. feed (corn/soybean meal) |
| **Feeder-live spread** | Feeder cattle vs. live cattle future prices |
| **Calendar spread** | Different contract months of same animal |
| **Cross-commodity spread** | Livestock vs. grains or energy |
| **Profit driver** | Relative value mismatch between related contracts |
...
### Closely related
- [Live cattle](/wiki/live-cattle/) — Primary livestock futures contract
- [Feeder cattle futures](/wiki/feeder-cattle-futures/) — Contract for younger cattle
- [Lean hogs](/wiki/lean-hogs/) — Hog futures contract
- [Commodity spread](/wiki/spread-trading-futures/) — Price difference trading in commodities
