---
title: "How Drought Affects Cattle Prices"
description: "The path from drought-forced herd liquidation through the cattle cycle to supply tightening and higher feeder and fed-cattle prices."
keywords:
  - how drought affects cattle prices
  - cattle cycle drought
  - herd liquidation supply tightening
  - feeder cattle prices
image: "/svg/commodities.svg"
---

*Drought affects cattle prices through a multi-year sequence: as forage dries up, ranchers sell breeding cattle and calves, flooding the market and causing immediate price weakness. But liquidation shrinks the national herd, which takes years to rebuild. By the time pasture returns and ranchers start retaining replacements, cattle scarcity drives prices higher. This delayed, inverted pattern—where disaster first crashes prices then amplifies them—makes drought a structural driver of the **cattle cycle** and a key source of [volatility](/historical-volatility/) in live cattle and feeder cattle markets.*

<aside class="wiki-infobox">

<div class="wiki-infobox-title">Drought and Cattle Prices — key facts</div>

<img src="/svg/commodities.svg" alt="An abstract editorial mark for the topic." />

<div class="wiki-infobox-caption">Drought forces rapid herd liquidation, then supply scarcity drives prices higher years later.</div>

|   |   |
|---|---|
| **Immediate effect** | Ranchers sell breeding herds and calves, flooding market and crashing prices |
| **Herd reduction** | National cattle herd can shrink 5–15% over 12–24 months of severe drought |
| **Liquidation overhang** | Oversupply from culling keeps prices depressed for 6–18 months after drought onset |
| **Rebuilding lag** | Calves born today mature to breeding cattle in 2–4 years; herd expansion takes 3–5+ years |
| **Supply tightening** | As herd shrinks and forage recovers, cattle scarcity emerges, driving live and feeder prices up |
| **Historical example** | 2011–2013 Texas drought eliminated 1.5M+ breeding cattle, leading to higher prices 2014–2016 |
...
1. Retain heifer calves (instead of selling them) as replacement breeding stock
2. Keep those heifers until they mature (18–24 months)
3. Breed them to produce the next generation
...
- [Business Cycle](/business-cycle/) — Broader economic cycles that interact with commodity cycles
- [Volatility](/historical-volatility/) — Risk and price swings in agricultural markets
- [Price Discovery](/price-discovery/) — How futures markets aggregate information about supply
- [Risk Management](/derivatives-hedging/) — Hedging strategies for ranchers and feedlots
