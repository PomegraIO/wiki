---
title: "Feeder Cash Basis"
description: "The price spread between live feeder cattle and feeder cattle futures contracts, reflecting storage costs and market expectations."
keywords:
  - feeder cattle basis
  - futures spread
  - livestock markets
...
*The **feeder cash basis** is the difference between the spot price of live feeder cattle (young cattle ready to be fattened) and the price of feeder cattle futures contracts trading on the [CME](/wiki/cme-group/). When the cash price is $130/cwt and futures are $135/cwt, the basis is negative $5. Cattle ranchers and feedlots use the basis to hedge their inventory and time sales, while arbitrageurs trade the spread itself.*

<aside class="wiki-infobox">

| Characteristic | Detail |
|---|---|
| Definition | Cash price minus futures price |
| Units | Dollars per hundredweight (cwt) |
| Typical range | ±$2 to $8 per cwt, depends on seasonality |
| Driver | Carry costs, market sentiment, supply expectations |
| Contract | CME feeder cattle futures; standard 42,000 lbs |
| Hedging application | Ranchers lock in futures price, sell at cash, pocket basis difference |
| Arbitrage | When basis widens, some traders buy cash and sell futures |
| Seasonality | Basis typically widens (becomes negative) heading into winter |
...
- [Commodity Basis Risk](/wiki/basis-risk/) — the risk that basis moves unexpectedly
- [Carry Costs](/wiki/cost-of-carry/) — what drives the mechanical basis
- [CME Group](/wiki/cme-group/) — the exchange where feeder cattle futures trade
