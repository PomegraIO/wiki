...
*A **poultry commodity market** is the cash market for chicken (broilers) and turkey where producers, processors, and distributors transact at negotiated prices. Unlike [cattle](/wiki/live-cattle/) and [hogs](/wiki/lean-hogs/), which have standardized [futures contracts](/wiki/futures-contract/), poultry is priced in cash markets through direct negotiation or price feeds, with limited derivatives trading.*

<aside class="wiki-infobox">

| Key fact | Detail |
|---|---|
| **Primary products** | Whole broilers, breasts, thighs, wings (cut-up parts are majority of trade) |
| **Pricing mechanism** | Cash negotiation, price feeds (e.g., USDA, Urner Barry reports) |
| **Standard units** | Cents per pound, live weight or ready-to-cook (RTC) weight |
| **Spot transaction** | Weekly or bi-weekly delivery; cash settlement common |
| **Futures availability** | Ice Futures and CME have poultry contracts, but low volume; mostly OTC |
| **Supply chain** | Vertically integrated producers (Tyson, Pilgrim's, Sanderson) dominate |

</aside>

## Why poultry lacks standardized futures

Poultry futures have never achieved the volume or liquidity of [cattle](/wiki/live-cattle/) or [hogs](/wiki/lean-hogs/) futures. The core reason is **vertical integration**. The top five U.S. poultry producers (Tyson Foods, Pilgrim's Pride, Perdue, Sanderson Farms, Koch Foods) control both production and processing. They own the birds from hatch to processing, eliminating the need to hedge price risk in futures. A cattle rancher raises cattle and sells to a packer—two separate entities with opposing risk profiles. Poultry is one entity doing both.
...
A poultry producer managing margin watches [corn](/wiki/corn/) and [soybean](/wiki/soybeans/) futures. If soy meal prices surge, they know production costs will rise and can raise broiler prices ahead of the cost increase. This creates a pricing lead-lag relationship that traders exploit.
...
### Closely related
- [Livestock commodity markets](/wiki/livestock-hedging-strategies/) — The broader category
- [Live cattle](/wiki/live-cattle/) — A major livestock commodity with futures
- [Lean hogs](/wiki/lean-hogs/) — Another key livestock commodity
- [Corn](/wiki/corn/) — Primary feed input for poultry

### Wider context
- [Cash market](/wiki/cash-basis-accounting/) — The structure of poultry transactions
- [Commodity futures trading](/wiki/commodity-futures-rolling/) — Alternative for standardized commodities
- [Basis](/wiki/basis/) — Relationship between cash and futures prices
- [Volatility smile](/wiki/fx-volatility-smile-curve/) — Pricing dynamics in imperfect markets
