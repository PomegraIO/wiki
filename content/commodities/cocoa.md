---
title: "Cocoa"
description: "Cocoa is the commodity derived from cacao beans used for chocolate production. Supply is concentrated in West Africa and prices are highly volatile."
keywords:
  - cocoa
  - cacao
  - chocolate
...
|   |   |
|---|---|
| **What it is** | Commodity derived from cacao bean fermentation and processing |
| **Global production** | ~5 million tonnes annually |
| **Primary use** | Chocolate production (~90%); cocoa powder and butter |
| **Major producers** | Côte d'Ivoire (~40%), Ghana (~20%), Indonesia (~15%), others (~25%) |
| **Trading venue** | ICE (London) for cocoa futures |
| **Typical price** | $2,000–4,000 per tonne; extremely volatile |
| **Crop cycle** | Cacao tree takes 3–4 years to mature; production lasts decades |
| **Disease risk** | Frosty pod disease and other diseases can destroy crops |
| **Supply concentration** | 80%+ from West Africa (Côte d'Ivoire + Ghana) |
| **Farmer margins** | Small-farm production; farmers receive ~10–20% of final chocolate price |

</aside>

## The specialty crop

Cocoa is a specialty commodity with few uses outside of chocolate production. Unlike [corn](/corn/) or [soybeans](/soybeans/) (which have multiple uses), cocoa demand is almost entirely driven by chocolate and confectionery consumption.
...
This disease risk creates a supply vulnerability: unlike [corn](/corn/) (replanted annually), cacao takes 3–4 years to reach maturity. A disease-driven yield loss persists for years.
...
- [Coffee](/coffee/) — competing tropical specialty commodity
- [Sugar](/sugar/) — used in chocolate
- Commodity bubble — cocoa exhibits extreme cycles
- ICE Futures — primary cocoa trading venue
- [West Africa](/central-bank/) — dominates supply

### Wider context

- Agricultural commodity — specialty crop
- [Weather risk](/inflation/) — drought spikes prices
- [Disease risk](/recession/) — crop losses disrupt supply
- [Inflation](/inflation/) — cocoa spikes affect chocolate prices
- [Geopolitics](/central-bank/) — West Africa supply concentration
- [Sustainability](/asset-allocation/) — labor and environmental concerns
