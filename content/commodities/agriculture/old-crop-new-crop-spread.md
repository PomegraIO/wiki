...
<div class="wiki-infobox-title">Old-Crop / New-Crop Spread — key facts</div>

<img src="/svg/commodities.svg" alt="An abstract editorial mark for commodities trading." />

<div class="wiki-infobox-caption">The cost of holding grain from this year into next, baked into futures prices.</div>

|   |   |
|---|---|
| **What it is** | Price difference between current-year and next-year harvest contracts |
| **Also called** | Calendar spread, carry spread, harvest spread |
| **Measured in** | Cents per bushel (for corn, soybeans); dollars per tonne (international) |
| **Primary drivers** | Physical storage cost, financing costs, insurance, crop-loss risk, expected supply |
| **Typical structure** | Contango (new crop trades at premium); occasionally backwardation (old crop premium) |
| **Common trades** | Buying old crop, selling new crop; rolling positions forward |
...
This relationship is called [contango](/contango/)—a situation where forward prices are higher than spot prices, creating a "roll yield" for long-term holders. The opposite, called backwardation, occurs when old crop trades at a premium; this signals supply tightness or immediate demand.
...
- [Contango](/contango/) — the normal market structure where forward prices exceed spot prices
- [Calendar spread](/calendar-spread/) — the general strategy of buying and selling different futures expirations
- [Commodity futures contract](/futures-contract/) — the CBOT corn, soybean, and wheat contracts underlying the spread
- [Basis](/basis/) — the relationship between spot and futures prices at a specific location
- [Ethanol-Corn Crush Spread](/ethanol-corn-crush/) — another agricultural spread using corn as an input

### Wider context

- Agricultural commodities — the broader ecosystem for grain trading
- [Futures markets](/stock-market/) — the exchange mechanism for these contracts
- Hedging — how farmers and merchants use old-crop / new-crop spreads to manage risk
- [Price discovery](/price-discovery/) — how spread levels communicate market expectations
- [Forward contract](/forward-contract/) — the underlying principle of locking in future prices
