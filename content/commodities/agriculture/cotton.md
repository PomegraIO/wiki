---
title: "Cotton"
description: "Cotton is a natural fiber commodity used for textiles and clothing. Its price is driven by competing synthetic fibers and agricultural supply shocks."
keywords:
  - cotton
  - natural fiber
  - textile
...
|   |   |
|---|---|
| **What it is** | A natural fiber from the cotton plant; processed into yarn and fabric |
| **Global production** | ~25 million tonnes annually (lint) |
| **Major producers** | India (~25%), China (~22%), USA (~15%), Pakistan (~8%), others (~30%) |
| **Trading venue** | ICE (New York) for cotton futures; highly liquid |
| **Typical price** | $0.70–1.20 per pound; moderate volatility |
| **Primary use** | Apparel (~70%), home textiles (~20%), industrial (~10%) |
| **Competing fiber** | Polyester (~52% of fiber market vs. cotton's ~25%) |
| **Seasonal pattern** | Slight seasonality from Northern Hemisphere harvest (Aug–Nov) |
| **Supply elasticity** | Moderate; acreage responds to prices over 1–2 year lags |
...
- [Polyester](/copper/) — competing synthetic fiber
- Commodity bubble — cotton exhibits moderate cycles
- ICE Futures — primary cotton trading venue
- [India](/central-bank/) — largest cotton producer

### Wider context

- Agricultural commodity — agricultural supply subject to weather
- [Apparel consumption](/stock-market/) — primary demand driver
- [Synthetic materials](/copper/) — long-term substitution threat
- [Weather risk](/inflation/) — drought and excess rain affect yields
- [Sustainability](/asset-allocation/) — organic premium reflects values
