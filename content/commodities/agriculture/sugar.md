---
title: "Sugar"
description: "Sugar is a commodity derived from sugar cane and sugar beets, traded globally via futures. Its price is volatile and vulnerable to weather shocks and policy changes."
keywords:
  - sugar
  - commodity
  - sweetener
...
|   |   |
|---|---|
| **What it is** | A crystalline sweetener extracted from sugar cane or sugar beets |
| **Global production** | ~180 million tonnes annually |
| **Major producers** | Brazil (~40% of exports), India, EU, Thailand, others |
| **Trading venue** | ICE (London and New York) for raw and refined sugar |
| **Typical price** | $0.10–0.20 per pound; highly volatile |
| **Seasonal pattern** | Crush season is May–Nov (Brazil); harvest is Feb–Mar (India) |
| **Consumption uses** | Beverages (~25%), confectionery (~25%), baked goods (~20%), industrial (~30%) |
| **Brazil export share** | ~40% of global sugar exports; weather dominates prices |
| **Policy distortion** | Major subsidies in EU, Japan; tariffs in many countries |
...
- [Ethanol](/gasoline/) — competes for sugar cane feedstock
- [Corn](/corn/) — competing feedstock for sweeteners (HFCS)
...
- [Policy intervention](/federal-reserve/) — subsidies distort prices
- [Weather](/inflation/) — Brazil drought spikes prices
- [Inflation](/inflation/) — sugar prices affect food costs
- [Health trends](/stock-market/) — declining sugar consumption in developed countries
