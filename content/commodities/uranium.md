---
title: "Uranium"
description: "Uranium is the fuel for nuclear power plants and is seeing renewed demand as governments pursue carbon-free energy. Supply is geopolitical-concentrated and prices have risen sharply since 2020."
keywords:
  - uranium
  - nuclear power
  - fuel cycle
...
This entry covers uranium as a traded commodity. For uranium's role in nuclear weapons and nonproliferation, consult geopolitical analysis; for nuclear energy policy, see energy transition frameworks.
...
|   |   |
|---|---|
| **What it is** | A heavy metal element (U, atomic number 92) |
| **Primary uses** | Nuclear power plant fuel (~85%), research (~5%), military (~10%) |
| **Annual supply** | ~65,000 tonnes of natural uranium (uranium oxide) |
| **Annual demand** | ~65,000 tonnes (supply-demand balanced, shifting to deficit) |
| **Currency unit** | Pound of U₃O₈ (uranium oxide), or kilogram of uranium |
| **Typical price** | $80–130 per pound (highly variable) |
| **Major producers** | Kazakhstan (~40%), Canada (~15%), Namibia (~10%), others (~35%) |
| **Enrichment capacity** | Russia (~45%), France (~20%), China (~15%), others (~20%) |
| **Recycling rate** | <5% (reprocessing is limited) |
| **Supply-demand** | Currently balanced; deficit emerging with new reactor buildout |
...
- [Nuclear power](/central-bank/) — the primary end-use
- [Energy transition](/inflation/) — policy driver of uranium demand
- [Critical minerals](/central-bank/) — uranium in strategic categories
- Mining stock — leveraged uranium exposure
- [Kazakhstan](/interest-rate/) — supplies 40% of global uranium
- [Russia](/federal-reserve/) — dominates enrichment capacity

### Wider context

- [Geopolitics](/inflation/) — supply concentration creates vulnerability
- [Energy security](/asset-allocation/) — nuclear is baseload power
- [Carbon emissions](/inflation/) — nuclear power is zero-carbon
- Supply deficit — emerging as demand rises
- [Policy risk](/interest-rate/) — nuclear power faces political headwinds
- [Long-term contracts](/yield-curve/) — most uranium supply is locked in
