---
title: "Corn"
description: "Corn is the world's largest produced crop by mass, used for animal feed, human food, and ethanol fuel. Its price is volatile and driven by weather, global supply, and China demand."
keywords:
  - corn
...
This entry covers corn as a traded commodity. For other grains, see [wheat](/wheat/) or [soybeans](/soybeans/); for animal feed dynamics, see [livestock](/live-cattle/).
...
|   |   |
|---|---|
| **What it is** | A grain crop (maize); the world's largest crop by mass |
| **Global production** | ~600 million tonnes annually |
| **Primary uses** | Animal feed (~60%), human food (~15%), ethanol (~10%), industrial (~15%) |
| **Major producers** | USA (~35%), China (~20%), EU (~7%), Brazil (~7%), others (~31%) |
| **Trading venue** | CBOT (Chicago Board of Trade, part of CME Group) |
| **Contract size** | 5,000 bushels (127 tonnes); highly liquid |
| **Typical price** | $3–8 per bushel ($2.70–7.20 per tonne) |
| **Seasonal pattern** | Lows after harvest (Aug–Oct); highs before new crop (May–Jul) |
| **Crop cycle** | Plant (Apr–May), grow (Jun–Aug), harvest (Sep–Nov), store (Dec–Mar) |
| **Major consumer** | China (~25% of global consumption; mostly imported) |
...
Corn's dominance reflects its versatility: it grows in diverse climates, yields well with fertilizer and pesticides, and is a complete protein when combined with [soybeans](/soybeans/). It feeds humans and animals and fuels vehicles.

## Animal feed demand

The largest end-use for corn is animal feed, particularly for [cattle](/live-cattle/), [hogs](/lean-hogs/), and poultry. A global trend toward meat consumption — especially in emerging markets — drives corn demand growth.

The relationship is direct: [cattle](/live-cattle/) prices depend on [corn](/corn/) prices (feed costs); [corn](/corn/) prices depend on animal production levels (demand for feed). When [cattle](/live-cattle/) prices are high, farmers expand herds, raising corn demand. When corn prices spike, ranchers reduce herd sizes to cut feed costs.
...
Corn acreage is not fixed; farmers choose each year between corn, [soybeans](/soybeans/), and other crops based on expected prices. High corn prices incentivize high plantings the next year; low prices reduce plantings.
...
- [Wheat](/wheat/) — competing grain crop
- [Soybeans](/soybeans/) — rotated with corn; animal feed alternative
- [Soybean meal](/soybean-meal/) — competitor for animal feed demand
- [Live cattle](/live-cattle/) — primary end-use for corn (via feed)
- [Lean hogs](/lean-hogs/) — major corn-fed animal
- CBOT — primary corn futures venue

### Wider context

- Agricultural commodity — part of broader crop complex
- [Inflation](/inflation/) — corn spikes affect food and fuel prices
- [Weather](/compound-interest/) — primary supply driver
- [China](/central-bank/) — largest consumer; import-dependent
- [Ethanol](/gasoline/) — policy-driven demand
- [Animal feed](/live-cattle/) — 60% of demand
