---
title: "Gold"
description: "Gold is a precious metal prized for its purity, divisibility, and scarcity. It serves as a hedge against inflation and currency debasement, a store of wealth, and a component of industrial and jewelry demand."
keywords:
  - gold
  - precious metal
  - hedge
...
|   |   |
|---|---|
| **What it is** | A precious metal element (Au, atomic number 79) |
| **Primary uses** | Jewelry, central-bank reserves, industrial, dentistry |
| **Most traded form** | Spot bullion (troy ounce) |
| **Currency unit** | Troy ounce (31.1 grams) |
| **Key trading venues** | London Metal Exchange, COMEX, OTC spot market |
...
- [Silver](/silver/) — another precious metal, more volatile
- [Platinum](/platinum/) — a rarer precious metal used industrially
...
- [Inflation](/inflation/) — gold's primary tailwind
- [Inflation](/inflation/) and [deflation](/recession/) — the two states where gold moves most sharply
- [Asset allocation](/asset-allocation/) — how gold fits into a portfolio
- [Central bank](/central-bank/) — the largest holder of gold
- [Hedge](/hedge-fund/) — using gold to offset portfolio risk
- [Bear market](/bear-market/) — when gold often rallies
- [Diversification](/diversification/) — the role of gold in a diversified portfolio
