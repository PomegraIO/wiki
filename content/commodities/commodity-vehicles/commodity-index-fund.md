---
title: "Commodity Index Fund"
description: "A diversified passive investment vehicle that tracks a basket of commodities through futures, providing broad exposure to metals, energy, and agriculture."
keywords:
...
***A commodity index fund** is a passive investment vehicle—usually an ETF or mutual fund—that replicates a published [commodity index](/wiki/commodity-index-fund/) by holding futures contracts, [forward contracts](/wiki/forward-contract/), or physical commodities. It provides retail and institutional investors broad, diversified exposure to multiple commodities without buying individual contracts.*
...
| Attribute | Detail |
|-----------|--------|
| **Underlying** | Commodity futures or physical holdings |
| **Index examples** | S&P GSCI, Bloomberg Commodity, DBCI |
| **Components** | Energy, metals, agriculture, livestock |
| **Expense ratio** | 0.3–0.8% annually (lower for ETFs) |
| **Roll cost** | Contango creates drag as contracts mature |
| **Tax efficiency** | ETFs more efficient than mutual funds |
| **Rebalancing** | Monthly or quarterly, rules-based |
...
4. **Collects yield**: Some indices weight commodities by open-interest (volume), others by economic significance or production. Reinvesting any [convenience yield](/wiki/convenience-yield-commodity/) or collateral interest adds to returns.
...
| Index | Methodology |
|-------|-------------|
| **S&P GSCI** | Production-weighted; adjusts annually |
| **Bloomberg Commodity** | Fixed weight per commodity, rebalanced monthly |
| **DBCI (Deutsche Börse)** | Equally weighted, rebalanced monthly |
| **Reuters/CRB** | Lighter weighting to energy; broader basket |
...
- [Commodity ETF](/wiki/commodity-etf/) — Sector-specific commodity exposure.
- [Commodity futures rolling](/wiki/commodity-futures-rolling/) — How funds manage contract expirations.
- [Commodity carry trade](/wiki/commodity-carry-trade/) — Strategies profiting from basis differences.
- [Commodity-term-structure](/wiki/commodity-term-structure/) — Contango vs. backwardation dynamics.
- [Inflation-hedging](/wiki/inflation-hedging/) — Commodities' inflation protection role.

### Wider context

- [Asset allocation](/wiki/asset-allocation/) — Commodities' role in diversified portfolios.
- [Factor investing](/wiki/factor-investing/) — Commodities as a systematic factor.
- [ETF](/wiki/etf/) — The broader class of index-tracking vehicles.
- [Futures contract](/wiki/futures-contract/) — Underlying mechanism.
