---
title: "Soybean Oil"
description: "Soybean oil is a commodity vegetable oil used for cooking, food processing, and biodiesel fuel. Its price is linked to soybeans but trades independently as a commodity."
keywords:
  - soybean oil
  - vegetable oil
  - biodiesel
...
This entry covers soybean oil as a commodity. For the parent crop, see [soybeans](/soybeans/); for competing oils, see [palm oil or canola](/copper/).
...
|   |   |
|---|---|
| **What it is** | Oil extracted from soybeans; primary vegetable oil commodity |
| **Global supply** | ~65 million tonnes annually |
| **Primary uses** | Cooking and food (~70%), biodiesel (~25%), industrial (~5%) |
| **Trading venue** | CBOT (highly liquid futures) |
| **Typical price** | $0.35–0.60 per pound ($770–1,300 per tonne) |
| **Yield from soybeans** | ~20% by weight; 80% becomes soybean meal |
| **Major producer** | From same countries as [soybeans](/soybeans/): USA, Brazil, Argentina, China |
| **Major consumer** | China (~25%), India (~15%), EU (~10%), others |
| **Linked commodity** | Prices track soybeans but with volatility from biodiesel demand |
| **Seasonal pattern** | Follows soybean harvest; somewhat volatile |
...
Soybean oil is a byproduct of [soybean meal](/soybean-meal/) processing. The "crush spread" — profit from buying soybeans and selling meal plus oil — includes both products.

However, soybean oil prices can diverge from [soybeans](/soybeans/) if demand for oil shifts relative to meal demand. High biodiesel demand drives soybean oil prices up without affecting meal; this widens the crush spread and encourages processing.
...
- [Soybeans](/soybeans/) — the parent crop
- [Soybean meal](/soybean-meal/) — the co-product
- [Palm oil](/copper/) — competing vegetable oil
- [Biodiesel](/gasoline/) — major demand driver
- CBOT — primary soybean oil futures venue
- [Food inflation](/inflation/) — oil price spikes raise food costs

### Wider context

- Vegetable oils — broader commodity class
- [Energy transition](/central-bank/) — biodiesel faces long-term headwinds
- [Food prices](/inflation/) — oil is input to food processing
- [Environmental impact](/inflation/) — deforestation concerns
- [Trade policy](/interest-rate/) — export restrictions affect prices
