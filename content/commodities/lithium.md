---
title: "Lithium"
description: "Lithium is a critical metal essential to battery anodes and is experiencing explosive demand growth from electric vehicles and energy storage. Supply is constrained and geographically concentrated."
keywords:
  - lithium
  - critical metal
  - battery
...
This entry covers lithium as a traded commodity. Lithium supply and demand are central to energy-transition strategy for every major economy.
...
|   |   |
|---|---|
| **What it is** | A critical alkali metal element (Li, atomic number 3) |
| **Primary uses** | Batteries (~70%), ceramics (~10%), pharmaceuticals (~5%), other (~15%) |
| **Annual supply** | ~500,000 tonnes of lithium carbonate equivalent |
| **Annual demand** | ~450,000 tonnes (tight market, growing deficit) |
| **Currency unit** | Tonne of lithium carbonate; also per kilogram |
| **Typical price** | $10,000–20,000 per tonne (highly volatile) |
| **Major producers** | Australia (~55%), Chile (~25%), China (~10%), Argentina (~8%) |
| **Battery demand share** | ~65% of current supply; growing to 85%+ by 2030 |
| **Supply sources** | Hard-rock mining (Australia) and brine extraction (Chile, Argentina) |
| **Recycling rate** | <5% (primitive battery recycling infrastructure) |
| **Demand growth rate** | 15–20% annually (fastest of any commodity) |
...
The top three producers (Australia, Chile, Argentina) account for 88% of global supply. This concentration is slightly less extreme than [cobalt](/cobalt/), but still concerning.
...
Lithium is increasingly traded on futures markets (CME, ICE), making it more liquid than [cobalt](/cobalt/) but less liquid than major base metals. Prices exhibit significant volatility, responding to supply disruptions, demand forecasts, and policy announcements.
...
- [Cobalt](/cobalt/) — battery cathode metal
- [Nickel](/nickel/) — battery cathode metal
- [Copper](/copper/) — battery current collector
- [Rare earth metals](/rare-earth-metals/) — another critical commodity
- [Critical minerals](/central-bank/) — strategic government concern
- Mining stock — leveraged lithium exposure
- [Battery technology](/stock-market/) — demand driver

### Wider context

- [Electric vehicle](/central-bank/) — primary demand driver
- [Energy storage](/inflation/) — growing demand source
- [Geopolitics](/central-bank/) — supply concentration risk
- Supply deficit — the central lithium story
- [Recycling](/diversification/) — future supply source
- [Government policy](/federal-reserve/) — increasingly intervenes in lithium markets
- [Trade restrictions](/interest-rate/) — emerging supply-chain barriers
