---
title: "Live Cattle"
description: "Live cattle is a commodity contract for feeder and finished cattle, traded on the CME Group. Cattle prices are driven by feed costs and meat demand from consumers and foodservice."
keywords:
  - live cattle
  - livestock
  - meat
...
This entry covers live cattle as a commodity contract. For beef as a meat product, see livestock commodities; for competing meats, see [lean hogs](/lean-hogs/).
...
|   |   |
|---|---|
| **What it is** | Live cattle for meat production (feeder and finished cattle) |
| **Trading venue** | CME Group (CBOT) with high liquidity |
| **Contract size** | 40,000 pounds (20 cattle) for live cattle futures |
| **Typical price** | $130–150 per 100 pounds; cyclical |
| **Global supply** | ~300 million cattle globally; ~30 million slaughtered annually in USA |
| **Major producers** | USA, Brazil, Australia, Argentina, China |
| **Feed cost share** | 60–70% of finished cattle production cost (feed is bulk of cost) |
| **Primary feed** | [Corn](/corn/) and [soybean meal](/soybean-meal/) in feedlots; pasture grass for feeder cattle |
| **Seasonal pattern** | Mild; slaughter peaks in spring and fall |
| **Linked commodities** | [Corn](/corn/), [soybean meal](/soybean-meal/), feeder cattle |

</aside>

## The feed conversion machine

Cattle are biological machines that convert feed ([corn](/corn/), [soybean meal](/soybean-meal/), grass) into beef. A steer in a feedlot eats 20–25 pounds of [corn](/corn/) and supplement daily for 4–6 months, gaining 3–4 pounds per day.

The economics are straightforward: cattle producers buy cattle at a price, feed them [corn](/corn/) (or graze on pasture) for months, and sell them at slaughter. Profitability depends on the spread between the price paid for cattle, the cost of feed, and the price received at slaughter.

## Feed cost dominance

Feed costs are 60–70% of the cost of finished cattle production. When [corn](/corn/) prices spike, feedlot economics deteriorate, and producers reduce herd sizes or reduce the amount of grain-feeding per animal.

When [corn](/corn/) prices are low, feedlot margins widen, and producers expand herds. This creates a direct linkage: high [corn](/corn/) prices → low cattle prices; low [corn](/corn/) prices → high cattle prices.
...
## Meat demand and consumer trends
...
The relationship is approximately: finished cattle price = feeder cattle price + cost of gain (feed conversion cost). High [corn](/corn/) prices raise the cost of gain, reducing finished cattle prices relative to feeder cattle prices.
...
- [Lean hogs](/lean-hogs/) — competing meat commodity
- [Corn](/corn/) — primary feed input (60% of cost)
- [Soybean meal](/soybean-meal/) — protein feed supplement
...
- [Feed costs](/corn/) — dominates cattle economics
- [Meat demand](/stock-market/) — primary price driver
- [Recession](/recession/) — meat consumption falls in downturns
- [Environmental regulation](/inflation/) — threatens long-term beef demand
- [Alternative proteins](/asset-allocation/) — long-term substitution threat
