...
description: "Rare earth metals are a group of 17 elements essential to renewable energy, defense systems, and advanced electronics. Supply is dominated by China, creating acute geopolitical dependency."
keywords:
  - rare earth metals
  - critical metals
  - neodymium
...
This entry covers rare earth metals as a strategic commodity group. Individual elements (neodymium, dysprosium, terbium) are traded, but the category's geopolitical importance dominates any financial discussion.
...
|   |   |
|---|---|
| **What they are** | 17 lanthanide elements plus scandium and yttrium (19 total) |
| **Most important** | Neodymium, dysprosium, terbium (for permanent magnets) |
| **Primary uses** | Wind turbines (~30%), EVs/motors (~20%), electronics (~20%), aerospace/defense (~15%), other (~15%) |
| **Annual supply** | ~150,000 tonnes of rare earth oxides |
| **Annual demand** | ~150,000 tonnes (tight market) |
| **Global production** | China (~70%), Myanmar (~10%), US (~3%), others (~17%) |
| **Processing capacity** | China (~85% of global refining) |
| **Major exporters** | China, Myanmar, US |
| **Recycling rate** | <1% (extremely low) |
| **Strategic importance** | Classified as "critical" by US, EU, Japan, Australia |
...
- [Lithium](/lithium/) — another critical battery metal
- [Cobalt](/cobalt/) — critical battery metal
- [Nickel](/nickel/) — battery metal with supply constraints
- [Critical minerals](/central-bank/) — broader strategic category
- Mining stock — leveraged exposure to rare earth producers
- [China](/central-bank/) — dominates global rare earth supply

### Wider context

- [Renewable energy](/central-bank/) — primary demand driver
- [Electric vehicle](/stock-market/) — accelerating demand
- [Geopolitics](/inflation/) — China supply dominance creates risk
- Supply concentration — the defining challenge
- [Strategic stockpiling](/federal-reserve/) — government demand
- [Recycling](/diversification/) — long-term but not near-term solution
