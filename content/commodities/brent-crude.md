---
title: "Brent Crude"
description: "Brent crude is the global benchmark for crude oil prices, derived from North Sea production and used to price the majority of international crude oil trade."
keywords:
  - Brent crude
  - oil benchmark
  - North Sea
...
This entry covers Brent crude as a price benchmark and trading instrument. For North American oil pricing, see [WTI crude](/wti-crude/); for crude oil fundamentals, see [crude oil](/crude-oil/).
...
|   |   |
|---|---|
| **What it is** | Light, low-sulfur crude from North Sea fields (UK, Norway) |
| **Quality metrics** | ~38 API gravity, ~0.4% sulfur (light and sweet) |
| **Trading venue** | ICE (Intercontinental Exchange) London |
| **Contract specifications** | 1,000 barrels per contract; daily settlement |
| **Global pricing share** | ~70% of international crude trades reference Brent |
| **Typical price premium** | Usually trades $1–5 above [WTI crude](/wti-crude/) |
| **Primary users** | European and Asian refineries, global traders |
| **Delivery mechanism** | Floating cargo (delivery to any BFOQ terminal) |
| **Daily volume** | Lower than [WTI](/wti-crude/) but still highly liquid |
| **Key rival** | [WTI crude](/wti-crude/) (North American benchmark) |
...
[WTI crude](/wti-crude/) and Brent often trade at different prices, creating the "WTI-Brent spread." Historically, Brent trades at a premium to WTI ($5–10 per barrel higher) due to its proximity to Asian and European markets (reducing transport costs relative to US refineries).
...
Brent futures trade on ICE with lower absolute volume than [WTI](/wti-crude/) on NYMEX, but with sufficient liquidity for large traders and hedge funds. The contract specifications (delivery of "any BFOQ crude," allowing flexibility) create some complexity.
...
- [Crude oil](/crude-oil/) — the underlying commodity
- [WTI crude](/wti-crude/) — North American oil benchmark
- [Gasoline](/gasoline/) — primary refined product
- [Heating oil](/heating-oil/) — refined heating product
...
- [Inflation](/inflation/) — oil price spikes drive global inflation
- [Recession](/recession/) — oil price shocks trigger economic downturns
- [Geopolitics](/central-bank/) — Middle East and Russia control supply
- [Energy transition](/central-bank/) — long-term demand decline
- Supply shock — geopolitical events spike prices
- [Global trade](/stock-market/) — crude oil is the largest commodity by value
