---
title: "How a Demand Shock Shifts a Commodity Futures Curve"
description: "Step-by-step walkthrough of how a sudden demand shock moves spot, nearby, and deferred legs of a commodity futures curve differently."
keywords:
  - demand shock commodity curve
  - commodity futures curve shifting
  - spot price nearby deferred
  - contango backwardation demand
  - futures curve shape change
...
<div class="wiki-infobox-title">Demand Shock on Futures Curve — key facts</div>

<img src="/svg/commodities.svg" alt="An abstract editorial mark for the topic." />

<div class="wiki-infobox-caption">A sudden demand surge crushes nearby futures harder than far-dated ones, pivoting the entire curve.</div>

|   |   |
|---|---|
| **Shock type** | Unexpected surge or collapse in end-user or speculative demand |
...
- [Contango and Backwardation](/contango/) — The normal term structure of commodity futures and what drives it
- [Basis and Basis Risk](/basis/) — The gap between spot and futures, and why it matters in demand shocks
- [Futures Contract](/futures-contract/) — How commodity futures work and why traders use them
- [Derivative Hedging](/derivatives-hedging/) — How producers and consumers use the curve to lock in prices
- [Price Discovery](/price-discovery/) — How futures markets reveal new information instantly

### Wider context

- Commodity Market — Structure and participants in global commodity trading
- [Carry Trade](/carry-trade/) — How financiers exploit term structure and roll along the curve
- [Market-Maker Trading](/market-maker-trading/) — How dealers profit from bid-ask spreads during demand shocks
- [Liquidity Risk](/liquidity-risk/) — Why wide spreads and thin markets amplify price swings
- [Inventory Turnover](/inventory-turnover/) — How corporate holding decisions feed back into prices
