---
title: "Roll Yield"
description: "Profit or loss earned by rolling out of an expiring commodity futures contract into a later-dated contract."
keywords:
  - roll yield
  - futures rolling
  - commodity contango
...
| Item | Detail |
|---|---|
| **Definition** | Profit/loss from exiting front-month, entering back-month contract |
| **Positive (backwardation)** | Later contracts trade at lower prices; rolling yields profit |
| **Negative (contango)** | Later contracts trade at higher prices; rolling incurs cost |
| **Magnitude** | Can range from −5% to +15% annually, depending on commodity |
| **Timing** | Occurs at contract expiration; contracts expire quarterly or monthly |
| **Volatility** | Curve shape changes with supply conditions, seasonal factors, hedging |
| **Annualized** | Roll yield is often expressed as annual percentage or cents per unit |

</aside>

## How rolling works

A [futures contract](/wiki/futures-contract/) has an expiration date. The December crude oil contract, for example, expires in December. An investor holding crude exposure cannot hold the contract to expiration (would require physical delivery or cash settlement); instead, they "roll" forward by selling the expiring contract and buying the next contract.
...
- [Commodity Term Structure](/wiki/commodity-term-structure/) — The curve shape determining roll yield

### Wider context
- [Commodity Index Fund](/wiki/commodity-index-fund/) — Vehicles that capture roll yield
- [Commodity Hedging](/wiki/commodity-price-hedging/) — Hedger perspective on roll costs
- [Futures Contract](/wiki/futures-contract/) — Underlying contract mechanism
- [Commodity Spreads](/wiki/spread-trading-futures/) — Related trading strategy
