---
title: "Soybean Meal"
description: "Soybean meal is the primary animal feed protein globally and is the dominant commodity extracted from soybeans. Its price tracks livestock feed demand and soybean crush economics."
keywords:
  - soybean meal
  - animal feed
  - protein
...
This entry covers soybean meal as a commodity. For the parent crop, see [soybeans](/soybeans/); for competing feed protein, see [soybean oil](/soybean-oil/) or [corn](/corn/).
...
|   |   |
|---|---|
| **What it is** | Protein-rich residue from soybean oil extraction (45–48% protein) |
| **Global supply** | ~250 million tonnes annually (from ~350M tonnes of soybeans) |
| **Primary uses** | Livestock feed (~95%: poultry, swine, [cattle](/live-cattle/)) |
| **Trading venue** | CBOT (extremely liquid futures) |
| **Typical price** | $300–500 per tonne |
| **Crush ratio** | Meal is ~80% by weight of soybean; oil is ~20% |
| **Major consumer** | China (~60% of global meal consumption) |
| **Seasonal pattern** | Follows soybean harvest; storage and release throughout year |
| **Linked commodity** | Prices track both soybeans and [soybean oil](/soybean-oil/) (crush spread) |

</aside>

## The primary livestock protein

Soybean meal is the dominant protein source for modern livestock production. [Cattle](/live-cattle/) fed on grain diets are supplemented with soybean meal to achieve the balance of proteins required for rapid growth.

The alternative is [corn](/corn/) gluten meal or other protein sources, but soybean meal is superior in amino acid profile and digestibility, making it the industry standard.
...
- [Soybean oil](/soybean-oil/) — the co-product
- [Corn](/corn/) — competing animal feed
- [Live cattle](/live-cattle/) — primary end-use
- [Lean hogs](/lean-hogs/) — major meal consumer
- CBOT — primary soybean meal futures venue

### Wider context

- [Livestock production](/live-cattle/) — depends on meal supply
- [China](/central-bank/) — dominates global meal demand
- [Feed conversion](/compound-interest/) — meat production efficiency
- [Inflation](/inflation/) — feed costs drive meat prices
- Commodity bubble — meal prices cycle
