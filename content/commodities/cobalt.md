---
title: "Cobalt"
description: "Cobalt is a critical metal for battery production, jet engines, and catalysts. Its supply is concentrated in the Democratic Republic of Congo, creating acute geopolitical risk."
keywords:
  - cobalt
  - critical metal
  - battery
...
This entry covers cobalt as a traded commodity. The geopolitical concentration of cobalt supply makes it a strategic concern for governments and corporations planning battery supply chains.
...
|   |   |
|---|---|
| **What it is** | A critical transition metal element (Co, atomic number 27) |
| **Primary uses** | Batteries (~50%), superalloys for jet engines (~25%), catalysts (~10%), other (~15%) |
| **Annual supply** | ~140,000 tonnes |
| **Annual demand** | ~140,000 tonnes (tight market) |
| **Currency unit** | Tonne; also quoted in US dollars per pound |
| **Typical price** | $4–12 per pound (highly volatile) |
| **Major producers** | DRC (~70%), Russia (~7%), Australia (~7%), others (~16%) |
| **Battery demand share** | ~40% of current supply; growing to 60%+ by 2030 |
| **Recycling rate** | ~5% (extremely low; most used material is consumed) |
| **Supply concentration** | DRC is 70% of global supply — extreme geopolitical risk |
...
Unlike [lead](/lead/), cobalt recycling rates are extremely low (roughly 5% of supply). Most cobalt in batteries is locked up in active batteries or landfilled in discarded devices. Recycling infrastructure for battery cobalt is in its infancy; most EV batteries produced in the last 5 years are still in service.
...
- [Nickel](/nickel/) — battery cathode companion metal
- [Lithium](/lithium/) — battery anode metal, equally critical
- [Copper](/copper/) — battery current-collector metal
- [Lead](/lead/) — alternative battery chemistry (declining)
- [Rare earth metals](/rare-earth-metals/) — another critical-metal category
- [Critical minerals](/central-bank/) — government supply-chain security concern
- Mining stock — leveraged cobalt exposure

### Wider context

- [Electric vehicle](/stock-market/) — structural demand growth
- [Geopolitics](/inflation/) — DRC supply concentration risk
- Supply concentration — critical risk factor
- [Battery technology](/central-bank/) — cobalt-free chemistries in development
- [Recycling](/diversification/) — currently low; could grow significantly
- Commodity bubble — cobalt prone to extreme cycles
