---
title: "Steel"
description: "Steel is an iron-carbon alloy that is the world's dominant structural metal, used in construction, vehicles, machinery, and infrastructure. Its price reflects iron ore and coal costs plus manufacturing."
keywords:
  - steel
  - iron
  - construction
...
This entry covers steel as a traded commodity. Steel also exists in dozens of specialized alloys (stainless, tool steel, high-strength) with vastly different prices and applications; this entry focuses on commodity carbon steel.
...
|   |   |
|---|---|
| **What it is** | An iron-carbon alloy (typically 0.2–2% carbon by weight) |
| **Primary forms** | Flat products (sheets, coils), long products (bars, beams), semi-finished (blooms, slabs) |
| **Primary uses** | Construction (~30%), automotive (~15%), machinery (~10%), other (~45%) |
| **Annual production** | ~2 billion tonnes (largest metal industry on Earth) |
| **Annual demand** | ~2 billion tonnes |
| **Currency unit** | Tonne; pricing per tonne |
| **Typical price** | $400–1000 per tonne (highly variable) |
| **Major producers** | China (~50%), India (~7%), Russia (~5%), Japan (~5%) |
| **Major consumers** | China (~50%), followed by India, EU, Japan, US |
| **Cost structure** | ~60% iron ore, ~20% [coal](/coal/), ~20% labor/overhead/profit |
...
Steel is made by melting [iron ore](/iron-ore/) at extremely high temperatures (using [coal](/coal/) as fuel and reducing agent) in a blast furnace, then refining the molten metal in a basic oxygen furnace (BOF) to reduce carbon to desired levels. Alternative methods (electric arc furnaces fed with scrap steel) also produce steel.

Raw material costs — [iron ore](/iron-ore/) and [coal](/coal/) — comprise 60–70% of the cost of producing steel. As long as [iron ore](/iron-ore/) and [coal](/coal/) are commodities, steel will be as well. Manufacturing efficiency and labor costs vary but are secondary factors.

This cost structure means steel prices are driven primarily by [iron ore](/iron-ore/) and [coal](/coal/) prices, which in turn are driven by Chinese demand.
...
Roughly 30% of steel demand comes from construction and infrastructure. This makes steel prices highly cyclical — booming during economic expansions and crashing during [recessions](/recession/).

When Chinese property development booms, Chinese steelmakers run mills 24/7 and source [iron ore](/iron-ore/) from across the world. When Chinese property crashes, mills shut down, and iron ore prices fall. This cycle is the dominant driver of global steel and iron ore prices.

## Automotive demand and electrification

Automotive production accounts for roughly 15% of steel demand. The shift to electric vehicles creates ambiguity: EVs use slightly less steel than combustion vehicles (no engine, transmission, exhaust system), but use more [aluminum](/aluminum/) and composite materials.
...
Recycled steel is melted in electric arc furnaces (EAF) and requires no [iron ore](/iron-ore/), reducing energy and emissions. As a result, EAF-based steel production is growing, though it requires scrap input.

The abundance of recycled steel means primary steel production is constrained by scrap availability in developed countries, reducing mining dependency for [iron ore](/iron-ore/).
...
High-performance alloys exist (stainless steel with [nickel](/nickel/) and chromium, tool steel with tungsten, high-strength steel with molybdenum) that command premiums. These specialty steels are crucial for automotive, aerospace, and industrial applications.
...
Steel's defining risk is cyclicality. A global [recession](/recession/) or Chinese property crash causes steel prices to fall 50%+ within months, as construction halts and mills reduce output.
...
- [Iron ore](/iron-ore/) — primary raw material for steel
- [Coal](/coal/) — the other major raw material for steel
- [Nickel](/nickel/) — used in stainless steel
- [Aluminum](/aluminum/) — lightweight alternative to steel
- Mining stock — leveraged exposure to steel inputs
- [China](/central-bank/) — dominates global steel supply and demand

### Wider context

- [Construction cycle](/bull-market/) — primary demand driver
- [Recession](/recession/) — steel demand collapses in downturns
- [Carbon emissions](/inflation/) — environmental impact of steel production
- [Recycling](/diversification/) — critical to steel supply sustainability
- [China](/central-bank/) — policy decisions drive global prices
- Commodity bubble — steel cycles with construction booms
