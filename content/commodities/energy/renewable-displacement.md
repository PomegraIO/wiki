...
description: "Structural demand destruction for fossil fuels caused by wind and solar generation substituting for traditional power sources, reshaping energy markets."
keywords:
  - renewable energy
  - demand destruction
  - fossil fuels
...
*A **renewable displacement** is the decline in demand for fossil fuels—particularly coal and natural gas—caused by the expansion of [renewable](/wiki/renewable-displacement/) generation (wind, solar, hydroelectric). It represents a structural shift, not a cyclical pullback, reshaping long-term energy economics.*

<aside class="wiki-infobox">

| Aspect | Impact |
|--------|--------|
| Primary displacement | Coal (electricity generation); natural gas (peaking) |
| Mechanism | Renewable capacity grows, displacing marginal generation |
| Timeline | 2010–present and accelerating |
| Market symptoms | Low wholesale [electricity](/wiki/electricity-as-commodity/) prices, stranded coal assets |
| Affected commodities | Coal, natural gas, uranium (indirect) |
| Geographic variance | Europe >50% renewable; US ~20%; China ~30% |
| Long-term trajectory | Renewables expected to supply 50%+ by 2040 |

</aside>

## The mechanics of displacement

Electricity grids operate on [merit order](/wiki/commodity-term-structure/) dispatch: the cheapest available power is used first, with expensive sources brought in only when needed. Historically, coal plants (high capital cost, low fuel cost) ran baseload (24/7), and natural gas plants (lower capital, higher fuel cost) ran as peaking capacity during high-demand hours. As renewable capacity (wind, solar) is added, the merit order changes. Wind and solar have zero marginal fuel cost, so they run whenever available, even at negative prices if necessary.
...
The [natural gas](/wiki/natural-gas/) market faces a structural headwind. US LNG export demand is supported by European demand (particularly post-2022 Russian supply cutoff), but that is transitional. As Europe builds renewable capacity and storage, LNG demand will fall. Prices that spiked to \$10+/MMBtu in 2022 have normalized to \$3–5/MMBtu, and long-term contracts (10+ year LNG projects) are less economical than in prior decades.
