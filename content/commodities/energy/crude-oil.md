---
title: "Crude Oil"
description: "Crude oil is the primary energy source for global transportation and is refined into gasoline, diesel, heating oil, and chemicals. Its price is set by OPEC, geopolitics, and global demand."
keywords:
  - crude oil
  - energy
  - petroleum
...
This entry covers crude oil as a commodity. For US-specific pricing, see [WTI crude](/wti-crude/); for global benchmarks, see [Brent crude](/brent-crude/); for refined products, see [gasoline](/gasoline/), [heating oil](/heating-oil/), or diesel.
...
|   |   |
|---|---|
| **What it is** | Unrefined petroleum (hydrocarbon mixture) from underground reservoirs |
| **Primary uses** | Transportation fuel (~40%), heating (~10%), chemicals (~20%), electricity (~5%), other (~25%) |
| **Global production** | ~100 million barrels per day (bpd) |
| **Global demand** | ~100 million bpd |
| **Price benchmarks** | [WTI crude](/wti-crude/) (US), [Brent crude](/brent-crude/) (global) |
| **Typical price range** | $40–120 per barrel |
| **Major producers** | USA (~20%), Saudi Arabia (~13%), Russia (~11%), Canada (~6%) |
| **Major consumers** | USA (~20%), China (~16%), India (~6%), Japan (~4%) |
| **OPEC share** | ~30% of global supply |
| **Strategic reserves** | Major economies maintain reserves (US SPR = ~400 million barrels) |
...
The centrality of crude oil to economic activity means its price moves have outsized impact on inflation, consumer spending, and corporate profits. A crude oil price spike from $50 to $100 per barrel raises global inflation by 0.5–1%, reduces consumer purchasing power, and triggers [recessions](/recession/) if sustained.
...
Two primary price benchmarks exist. [WTI crude](/wti-crude/) (West Texas Intermediate) is the US-focused benchmark; [Brent crude](/brent-crude/) is the global benchmark used for most international trade.
...
- [WTI crude](/wti-crude/) — US oil price benchmark
- [Brent crude](/brent-crude/) — global oil price benchmark
- [Gasoline](/gasoline/) — primary refined product
- [Heating oil](/heating-oil/) — refined product for heating
- [Natural gas](/natural-gas/) — alternative energy source
- OPEC — controls production levels
- CME Group — primary US futures venue

### Wider context

- [Inflation](/inflation/) — crude oil price spikes drive inflation
- [Recession](/recession/) — high crude prices trigger economic slowdowns
- [Geopolitics](/central-bank/) — Middle East supply dominates global markets
- [Energy transition](/stock-market/) — long-term demand decline
