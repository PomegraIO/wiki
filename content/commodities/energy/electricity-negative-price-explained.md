...
| **Who it affects** | Power generators (pay to stay online), [asset owners](asset-allocation), [utilities](utilities) managing [reserves](reserve-requirements) |
...
**Merchants and traders** with real-time [flexibility](financial-reporting-standards)—especially those operating batteries—can profit: buy during negative prices, sell at positive prices during peak hours.
