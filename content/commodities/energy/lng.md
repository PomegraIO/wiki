---
title: "LNG"
description: "LNG (Liquefied Natural Gas) is natural gas cooled to -162°C for transport in specialized ships. It is the only way to trade natural gas globally and commands premium prices in Asia."
keywords:
  - LNG
...
This entry covers LNG as a traded commodity and strategic asset. For [natural gas](/natural-gas/) fundamentals and US pricing, see [natural gas](/natural-gas/); for industrial demand, see [electricity as commodity](/electricity-as-commodity/).
...
|   |   |
|---|---|
| **What it is** | Natural gas cooled to -162°C; volume shrinks 600x for transport |
| **Major producers** | Australia (~25%), Qatar (~25%), US (~12%), Indonesia (~6%) |
| **Major importers** | Japan (~10% of global), South Korea (~5%), Taiwan (~5%), Europe (~15% recent) |
| **Typical price** | $5–30 per MMBtu (spot; varies 3x+ annually) |
| **Contract types** | Long-term (10–20 years, indexed to crude), spot market (few months) |
| **Liquefaction cost** | $2–4 per MMBtu (capital-intensive to build liquefaction plants) |
| **Transport cost** | $1–3 per MMBtu depending on distance |
| **Trading dynamics** | Spot market growing but most LNG still under long-term contract |
| **Supply growth** | New projects coming online in Australia, US, Tanzania |

</aside>

## The global gas solution

[Natural gas](/natural-gas/) is chemically locked in underground reservoirs and extracted via wells. However, transporting gas via pipeline is economical only over medium distances (500–2,000 miles). For longer distances — transcontinental or transoceanic — liquefaction is required.
...
This infrastructure-intensive process — liquefaction plant, tanker ships, regasification terminals — has costs of $2–4 per MMBtu. These costs are why LNG prices are typically $2–5 higher per MMBtu than US [natural gas](/natural-gas/).
...
Asian LNG prices (Japan, South Korea, Taiwan, China) typically trade $3–10 per MMBtu above US Henry Hub [natural gas](/natural-gas/) prices, reflecting transport costs and regional supply scarcity.

Japan, which imports essentially all its [natural gas](/natural-gas/) as LNG, is thus exposed to global LNG price swings. Winter 2021–2022 saw Japanese wholesale electricity prices spike as LNG spot prices soared, creating a crisis for energy-intensive industries.
...
- **Cheap feedstock**: Access to low-cost [natural gas](/natural-gas/) (either local production or import via pipeline).
...
The LNG spot market is growing, with traders using specialized exchanges to buy and sell cargoes (a "cargo" = one tanker = ~130,000 m³). However, spot trading remains fragmented and less transparent than crude oil or [natural gas](/natural-gas/) futures.
...
- **Energy transition**: [Natural gas](/natural-gas/) as a bridge fuel to renewables.
...
- [Natural gas](/natural-gas/) — the underlying commodity
- [Coal](/coal/) — alternative electricity fuel
- [Electricity as commodity](/electricity-as-commodity/) — LNG drives electricity generation
- [Crude oil](/crude-oil/) — competing fuel and pricing index
- Energy ETF — retail energy exposure

### Wider context

- [Geopolitics](/central-bank/) — supply concentration creates risk
- [Energy transition](/central-bank/) — LNG is bridge fuel to renewables
- [Asia](/inflation/) — largest LNG consumer
- [Europe](/interest-rate/) — shifting to LNG from Russian pipelines
