---
title: "Rice"
description: "Rice is the world's primary staple food, consumed by over 3 billion people. Its price is volatile and subject to export bans and weather shocks in major producing countries."
keywords:
  - rice
  - grain
  - staple food
...
|   |   |
|---|---|
| **What it is** | A grain crop; the world's primary staple food |
| **Global production** | ~700 million tonnes annually |
| **Primary uses** | Human food (~95%), animal feed (~5%) |
| **Major producers** | China (~28%), India (~22%), Indonesia (~7%), Bangladesh (~7%), Vietnam (~5%) |
| **Consumption** | 60% of population in Asia; staple food for 3+ billion people |
| **Trading venues** | Limited futures trading (some contracts exist but illiquid) |
| **Typical price** | $350–1,000 per tonne; spot market quotations |
| **Market structure** | Mostly government-controlled or regulated; limited free trading |
| **Export restrictions** | Frequent bans and quotas to protect domestic supply |
| **Price volatility** | Moderate to high; driven by export bans and weather |
...
Unlike [wheat](/wheat/) or [corn](/corn/), rice has limited futures trading. ICE trades some rice contracts, but liquidity is low. Most rice trading occurs via bilateral negotiations between exporters and importers.
...
- [Wheat](/wheat/) — competing staple grain
- [Corn](/corn/) — grain commodity
- [Food security](/asset-allocation/) — rice is strategic food
- [Asia](/central-bank/) — dominates supply and demand
- [India](/interest-rate/) — largest producer; export restrictions affect prices

### Wider context

- Staple food — rice feeds 3+ billion people
- [Export restrictions](/interest-rate/) — governments ban exports to protect supply
- [Food crisis](/inflation/) — rice price spikes cause social unrest
- [Geopolitics](/central-bank/) — Asian supply concentration
- [Weather risk](/compound-interest/) — drought spikes prices
