---
title: "Silver"
description: "Silver is a precious metal that combines industrial demand with store-of-value characteristics. It is more volatile than gold but often offers stronger upside during precious-metals rallies."
keywords:
  - silver
  - precious metal
  - industrial demand
...
|   |   |
|---|---|
| **What it is** | A precious metal element (Ag, atomic number 47) |
| **Primary uses** | Electronics, solar panels, industrial chemicals, jewelry, coins |
| **Ratio to gold** | ~70–80 silver ounces per 1 gold ounce (varies over time) |
| **Key trading venues** | COMEX, London Metal Exchange, OTC market |
| **Currency unit** | Troy ounce (31.1 grams) |
| **Typical annual supply** | ~25,000 tonnes (largely as byproduct of copper and lead mining) |
| **Demand drivers** | Electronics, solar, jewelry, [hedge](/hedge-fund/) demand |
| **Volatility vs. gold** | 1.5–3x higher |
| **Storage cost** | ~0.2–0.5% per year |
...
The [gold-to-silver ratio](/gold/) — how many ounces of silver it takes to equal one ounce of gold — therefore fluctuates between 40 and 100, versus a historical average near 60. When the ratio is high (silver is cheap relative to gold), it often signals industrial demand has been crushed or that monetary fears are dominating. When the ratio is low (silver has appreciated sharply relative to gold), it often reflects a surge in safe-haven demand or speculation.

## Supply: a byproduct problem

Unlike gold, which is mined primarily for its own sake, roughly 70% of silver supply comes as a byproduct of [copper](/copper/), [zinc](/zinc/), and [lead](/lead/) mining. This means silver supply does not respond to silver prices — it responds to the profitability of copper and zinc operations.

When copper prices collapse and [copper](/copper/) mines cut production, silver supply falls along with it, even if silver prices are screaming higher. This lag is one reason silver can experience sharp upside moves: the supply response is decoupled from price signals in the short run.
...
For retail investors, silver bullion ETFs hold physical bars in vaults and offer the simplest path to ownership. Leveraged silver bets are also available via mining stocks, though these add [company-specific risk](/stock/) to the metal price.
...
Finally, the ratio volatility cuts both ways. Silver can rally 50% in a year during a precious-metals supercycle; it can also crash 60% during an industrial downturn. This is exciting for traders but exhausting for [asset allocation](/asset-allocation/) purposes.
...
- [Gold](/gold/) — the senior precious metal
- [Platinum](/platinum/) — another precious metal, rarer than silver
- [Copper](/copper/) — a base metal with overlapping demand
- [Zinc](/zinc/) — another major byproduct source of silver
...
- [Inflation](/inflation/) — key demand driver for precious metals
- Volatility — silver's defining characteristic
- Commodity bubble — silver cycles between euphoria and despair
- [Bear market](/bear-market/) — when industrial demand collapses
- [Diversification](/diversification/) — limited use of silver in modern portfolios
