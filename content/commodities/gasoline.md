---
title: "Gasoline"
description: "Gasoline is a refined petroleum product used as fuel for vehicles and is the most economically important refined product. Its price directly affects consumer purchasing power and inflation."
keywords:
  - gasoline
  - fuel
  - refined product
...
This entry covers gasoline as a commodity. For crude oil fundamentals, see [crude oil](/crude-oil/); for other refined products, see [heating oil](/heating-oil/) or [diesel](/heating-oil/).
...
|   |   |
|---|---|
| **What it is** | A refined petroleum distillate, primary transportation fuel |
| **Trading contract** | RBOB (Reformulated Blendstock for Oxygenate Blending) on NYMEX |
| **Contract specs** | 42,000 gallons per contract; daily settlement |
| **Currency unit** | Dollars per gallon, quoted in cents |
| **Typical price** | $2–4 per gallon (varies dramatically by region and time) |
| **Global consumption** | ~1.4 billion gallons per day |
| **Major producers** | US, Russia, China, Saudi Arabia |
| **Production tied to** | Refinery capacity; crude oil is ~60% of cost |
| **Volatility** | Lower than crude oil (refining spreads absorb some volatility) |
| **Retail vs. wholesale** | Retail pump prices include tax (~50¢/gallon US avg) and distribution |
...
A $1 increase in gas prices costs a typical American household an extra $500–1,000 per year; this translates to consumer spending cuts in other categories. Gasoline price spikes therefore create negative wealth effects and [inflation](/inflation/) concerns that ripple through the economy.
...
Gasoline prices track [crude oil](/crude-oil/) prices closely because crude is roughly 60% of refining costs. When crude rises, gasoline rises. The difference between crude input cost and gasoline output price is called the "crack spread" and reflects refinery profitability.
...
The primary gasoline futures contract on NYMEX is RBOB (Reformulated Blendstock for Oxygenate Blending), which trades at lower volumes than [crude oil](/crude-oil/) or [heating oil](/heating-oil/) but with sufficient liquidity for hedging.
...
- [Crude oil](/crude-oil/) — the feedstock for gasoline
- [Heating oil](/heating-oil/) — refined product from same refinery process
- [WTI crude](/wti-crude/) — US crude benchmark
- [Brent crude](/brent-crude/) — global crude benchmark
- NYMEX — primary US futures venue
- Energy ETF — retail access to energy commodities

### Wider context

- [Inflation](/inflation/) — gasoline spikes drive inflation
- [Recession](/recession/) — economic downturns reduce fuel demand
- [Consumer spending](/stock-market/) — high gas prices reduce purchasing power
- [Geopolitics](/central-bank/) — oil supply shocks spike gasoline prices
- [Energy transition](/central-bank/) — electric vehicles reduce long-term demand
