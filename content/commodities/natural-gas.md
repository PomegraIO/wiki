---
title: "Natural Gas"
description: "Natural gas is a fossil fuel burned for electricity, heating, and industrial processes. Its price is regional, with Asian LNG prices commanding premiums over US pipeline gas."
keywords:
  - natural gas
  - energy
  - heating
...
This entry covers natural gas as a commodity. For liquefied natural gas and global trade, see [LNG](/lng/); for crude oil comparison, see [crude oil](/crude-oil/).
...
|   |   |
|---|---|
| **What it is** | A hydrocarbon gas (primarily CH₄ methane) from underground reservoirs |
| **Primary uses** | Electricity generation (~50%), heating (~20%), industrial (~30%) |
| **Global supply** | ~4 trillion cubic meters annually |
| **Trading hubs** | US Henry Hub, Europe Title Transfer Facility (TTF), Asian LNG |
| **US pricing (Henry Hub)** | $2–15 per MMBtu (highly variable) |
| **Typical range** | Varies 3–5x annually due to seasonal and supply shocks |
| **Major producers** | US (~20%), Russia (~17%), Iran (~6%), Qatar (~5%) |
| **Regional markets** | US (pipeline), Europe (pipeline), Asia (LNG) operate separately |
| **Seasonal volatility** | High; winter heating demand drives sharp spikes |
| **LNG premium** | Asian LNG prices typically 20–50% higher than US Henry Hub |
...
Retail access is primarily via energy-sector [ETFs](/etf/) or commodity-index funds; direct natural gas futures carry high leverage and are suitable only for experienced traders.
...
- [LNG](/lng/) — liquefied natural gas for global trade
- [Coal](/coal/) — alternative electricity fuel
- [Crude oil](/crude-oil/) — competing energy source
- [Electricity as commodity](/electricity-as-commodity/) — electricity generation demand
- NYMEX — US futures venue
- Energy ETF — retail access to natural gas

### Wider context

- [Inflation](/inflation/) — natural gas spikes drive inflation
- [Recession](/recession/) — economic downturns reduce energy demand
- [Geopolitics](/central-bank/) — Russia-Europe supply dependency
- [Energy transition](/central-bank/) — long-term demand headwinds
- [Electricity generation](/stock-market/) — primary demand driver
- [Winter weather](/inflation/) — seasonal demand volatility
