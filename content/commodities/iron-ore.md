---
title: "Iron Ore"
description: "Iron ore is the primary feedstock for steel production and the world's largest industrial commodity by mass. Its price is tightly coupled to Chinese construction activity."
keywords:
  - iron ore
  - steel
  - mining
...
This entry covers iron ore as a traded commodity. For steel end-products, see [steel](/steel/); for mining companies and leverage, see mining stock.
...
|   |   |
|---|---|
| **What it is** | The primary mineral source of iron (Fe); primarily hematite and magnetite |
| **Primary use** | Steel production (~98% of iron ore supply) |
| **Annual supply** | ~2.5 billion tonnes |
| **Annual demand** | ~2.5 billion tonnes (by far the largest commodity by mass) |
| **Currency unit** | Tonne; pricing quotations per tonne |
| **Typical price** | $80–200 per tonne (highly variable) |
| **Major producers** | Australia (~40%), Brazil (~20%), China (~10%), India (~8%) |
| **Major consumers** | China (~70%), followed by India, EU, Japan |
| **Quality metrics** | Iron content %, silica %, alumina % (affect smelting cost) |
| **Shipping** | Bulk cargo; price includes freight from mine to port |

</aside>

## The largest industrial commodity

Iron ore by mass is the largest traded commodity on Earth — 2.5 billion tonnes annually, dwarfing every other commodity. This reflects iron's centrality to industrial civilization. Steel — an alloy of iron and [carbon](/wheat/) — is the structural metal of civilization: buildings, bridges, ships, vehicles, machines, and weapons all depend on steel.
...
Iron ore comprises roughly 60–70% of steel production costs (the remainder is [coal](/coal/), labor, and overheads). Steel prices therefore tend to move in line with iron ore, though with some noise from labor and coal cost changes.
...
Iron ore is the most cyclical of all commodities, moving with construction and economic growth. A global [recession](/recession/) causes iron ore to crash 50%+ within months, as construction halts and steel mills reduce output.
...
- [Steel](/steel/) — the primary end-product
- [Coal](/coal/) — the other major input to steel
- [Copper](/copper/) — another cyclical industrial commodity
- Mining stock — leveraged exposure to iron ore producers
- Shanghai Futures Exchange — primary iron ore trading venue
- [China](/central-bank/) — dominates global demand

### Wider context

- [Construction cycle](/bull-market/) — primary demand driver
- [China](/central-bank/) — dictates global iron ore prices
- [Recession](/recession/) — iron ore prices crash in downturns
- [Shipping costs](/interest-rate/) — material cost factor
- Commodity bubble — iron ore exhibits extreme cycles
- [Economic growth](/stock-market/) — the primary price driver
