---
title: "WTI Crude"
description: "WTI crude is the US benchmark for crude oil prices, derived from oil produced in Texas, Oklahoma, and Kansas. It is the most actively traded crude oil futures contract globally."
keywords:
  - WTI crude
...
This entry covers WTI crude as a price benchmark and trading instrument. For crude oil fundamentals, see [crude oil](/crude-oil/); for the global benchmark, see [Brent crude](/brent-crude/).
...
|   |   |
|---|---|
| **What it is** | Light, low-sulfur crude oil from US onshore fields (Permian, Eagle Ford, Bakken) |
| **Quality metrics** | ~38–40 API gravity, ~0.3% sulfur (light and sweet) |
| **Trading venue** | CME Group New York Mercantile Exchange (NYMEX) |
| **Contract specifications** | 1,000 barrels per contract; daily settlement |
| **Liquidity** | Highest of all crude oil benchmarks; billions in daily volume |
| **Price premium to Brent** | Typically $0–5 per barrel (WTI can trade above or below Brent) |
| **Primary users** | US refineries, global traders, hedge funds |
| **Delivery point** | Cushing, Oklahoma (largest crude oil storage hub in North America) |
| **Typical price range** | Moves $10–50 per barrel in single sessions during crises |
| **Leverage** | 1 contract = 1,000 barrels; highly leveraged for retail traders |
...
[Brent crude](/brent-crude/) — the global crude benchmark — trades on ICE and is priced differently from WTI. Brent is produced from fields in the North Sea; WTI is US onshore and shale. The two benchmarks often trade at different prices, creating the "WTI-Brent spread."
...
- [Brent crude](/brent-crude/) — the global oil benchmark
...
- [Inflation](/inflation/) — oil price spikes drive inflation
- [Recession](/recession/) — high oil prices trigger downturns
- [Geopolitics](/central-bank/) — Middle East supply dominates
- [Shale revolution](/stock-market/) — transformed US energy
