---
title: "Rhodium"
description: "Rhodium is an extremely rare platinum-group metal used primarily in catalytic converters and industrial catalysis. It is the most expensive precious metal per ounce and the least liquid for investors."
keywords:
  - rhodium
...
|   |   |
|---|---|
| **What it is** | A platinum-group metal element (Rh, atomic number 45) |
| **Rarity** | ~100 times rarer than gold in Earth's crust |
| **Primary uses** | Catalytic converters, industrial catalysis, glass manufacturing |
| **Annual supply** | ~20–30 tonnes (as byproduct of platinum and nickel mining) |
| **Annual demand** | ~25–35 tonnes |
| **Price per ounce** | Often highest of all precious metals; $100–300+ per ounce |
| **Currency unit** | Gram or kilogram (too rare for troy-ounce trading) |
| **Key trading venues** | Over-the-counter only; no futures market |
| **Liquidity** | Extremely low; difficult to trade large quantities |
| **Major sources** | South Africa (~80%), Russia (~15%), Canada (~5%) |

</aside>

## Extreme rarity and illiquidity

Rhodium occupies a unique niche in the commodity world: it is simultaneously the rarest precious metal (by a wide margin) and the least tradable. There is no futures market, no [ETF](/etf/), and no retail market. The physical product is so scarce and prices so volatile that legitimate spot quotations are hard to find.
...
Roughly 70% of rhodium demand comes from catalytic converters, where it plays a small but essential role. Rhodium is superior to both [palladium](/palladium/) and [platinum](/platinum/) at oxidizing nitrogen oxides (NOx) — the pollutant that triggered Volkswagen's emissions-cheating scandal — but is so expensive that it is used only in small quantities, often just 3–5 grams per converter.
...
There are no rhodium [ETFs](/etf/), no listed futures contracts, and no retail market. A retail investor interested in owning rhodium has essentially no option except to contact specialized dealers and negotiate the purchase of grams or small quantities of powder or ingots.
...
Like [palladium](/palladium/), rhodium supply is geographically concentrated. South Africa produces roughly 80% of global supply, with Russia contributing most of the remainder. Any disruption in South African mining (labor strikes, environmental restrictions, civil unrest) or Russian supply (sanctions, warfare) creates immediate supply shocks with no alternative source to tap.
...
Rhodium recycling from used catalytic converters is technically straightforward but economically challenging. Catalytic converters contain multiple PGMs ([palladium](/palladium/), [platinum](/platinum/), rhodium), and the refining process must separate them carefully. Because rhodium content is small (usually <10% of the PGM weight), the recovery economics only work if volumes are large and precious-metals prices are high.

Recycling rates for rhodium are lower than for [platinum](/platinum/) or [palladium](/palladium/), meaning primary mining must always remain a critical supply source. A long-term structural decline in catalytic converter production (from vehicle electrification) would reduce recycling rates even further, creating a cliff in supply recovery.
...
- [Palladium](/palladium/) — the dominant catalyst metal in converters
- [Platinum](/platinum/) — the elder platinum-group metal
- [Gold](/gold/) — for comparison of rarity and investor access
- [Silver](/silver/) — another rare metal with far greater liquidity
- Mining stock — indirect exposure via South African or Russian producers
- [Rare earth metals](/rare-earth-metals/) — another extreme-scarcity commodity class
...
- [Emissions regulation](/central-bank/) — drives automotive catalyst demand
- Electric vehicle — long-term threat to catalyst demand
- [Geopolitics](/central-bank/) — South Africa and Russia control supply
