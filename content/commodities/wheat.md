---
title: "Wheat"
description: "Wheat is the world's second-largest grain crop and primary staple food for human consumption. Its price is volatile and heavily influenced by Russian and Ukrainian supply."
keywords:
  - wheat
  - grain
  - staple food
...
This entry covers wheat as a traded commodity. For other grains, see [corn](/corn/) or [rice](/rice/); for geopolitical dynamics, see [Russia-Ukraine](/central-bank/).
...
|   |   |
|---|---|
| **What it is** | A grain crop; the primary staple food globally |
| **Global production** | ~700 million tonnes annually |
| **Primary uses** | Human food (bread, pasta, cereals) (~65%), animal feed (~25%), industrial (~10%) |
| **Major producers** | China (~15%), Russia (~13%), India (~12%), USA (~8%), Ukraine (~6%) |
| **Trading venue** | CBOT (wheat futures, less liquid than corn) |
| **Typical price** | $5–12 per bushel ($180–430 per tonne) |
| **Crop cycle** | Winter wheat planted Sept–Oct; spring wheat planted Mar–May |
| **Major consumer** | China (~20% of global consumption, mostly domestic) |
| **Geopolitical risk** | Russia-Ukraine supply (25% of global exports) is vulnerable to conflict |
| **Export markets** | Russia, Ukraine, USA, EU, Canada are major exporters to Asia, Africa |

</aside>

## The human staple

Wheat is fundamentally different from [corn](/corn/). While [corn](/corn/) is primarily animal feed, wheat is a staple human food. Roughly 1.5 billion people depend on wheat as their primary carbohydrate source.
...
Global wheat stocks are thinner than for [corn](/corn/), providing less buffer against supply shocks. Policy decisions to release strategic reserves (by major producers or the US) can temporarily suppress prices.
...
- [Corn](/corn/) — competing grain crop
- [Rice](/rice/) — other major staple grain
- [Soybeans](/soybeans/) — often rotated with wheat
- CBOT — primary wheat futures venue
- [Russia](/central-bank/) — dominates wheat supply
- [Ukraine](/interest-rate/) — major wheat exporter

### Wider context

- [Geopolitics](/central-bank/) — Russia-Ukraine conflict threatens supply
- [Food security](/asset-allocation/) — wheat is staple food for billions
- [Inflation](/inflation/) — wheat spikes affect food inflation
- [Weather](/compound-interest/) — primary supply driver
- [Trade restrictions](/central-bank/) — export bans raise prices
- Commodity bubble — wheat cycles with supply
