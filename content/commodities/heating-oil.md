---
title: "Heating Oil"
description: "Heating oil is a refined petroleum product used for residential and commercial heating. Its futures contract on NYMEX is a major energy benchmark and is sensitive to winter weather."
keywords:
  - heating oil
  - refined product
  - winter demand
...
This entry covers heating oil as a commodity and futures contract. For crude oil, see [crude oil](/crude-oil/); for refined gasoline, see [gasoline](/gasoline/); for natural gas, see [natural gas](/natural-gas/).
...
|   |   |
|---|---|
| **What it is** | A refined petroleum distillate used for heating (also called #2 diesel fuel) |
| **Primary uses** | Residential heating (~40%), commercial heating (~30%), diesel fuel (~30%) |
| **Trading venue** | NYMEX (part of CME Group) |
| **Contract specifications** | 42,000 gallons (1,000 barrels) per contract |
| **Currency unit** | Dollars per gallon; typically quoted in cents |
| **Typical price range** | $1.50–3.50 per gallon (highly variable) |
| **Seasonal pattern** | Sharp rise in Sept–Nov as winter approaches; peak in Dec–Jan |
| **Weather sensitivity** | Abnormally cold winters drive spot prices sharply higher |
| **Global market** | Primarily North American; European heating oil prices differ |
| **Refinery output** | Refineries produce heating oil from crude; output is fixed ratio to gasoline |
...
Heating-oil prices therefore track [crude oil](/crude-oil/) prices closely but with additional volatility from seasonal demand swings. When crude rises, heating oil rises; when crude falls, heating oil falls. But in winter, heating-oil prices can rise faster than crude as seasonal demand kicks in.
...
- Energy-sector [ETFs](/etf/) (diversified exposure)
...
- [Crude oil](/crude-oil/) — the feedstock for heating oil
- [Gasoline](/gasoline/) — refined product from same refining process
- [Natural gas](/natural-gas/) — alternative heating fuel
- [Diesel fuel](/heating-oil/) — similar product, transportation-focused
- NYMEX — primary trading venue
- Energy ETF — retail access to refined products

### Wider context

- [Winter weather](/inflation/) — primary demand driver
- [Seasonal patterns](/yield-curve/) — pronounced annual cycles
- [Inflation](/inflation/) — heating oil spikes affect inflation
- [Recession](/recession/) — economic downturns reduce heating demand
- Supply shock — refinery outages spike prices
